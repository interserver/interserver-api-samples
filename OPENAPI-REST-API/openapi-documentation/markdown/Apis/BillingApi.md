...
# **getAffiliateSignups**
> getAffiliateSignups_200_response getAffiliateSignups(st)
...
> SuccessTextResponse patchBillingCreditCardVerify(id, patchBillingCreditCardVerify\_request)
...
|------------- | ------------- | ------------- | -------------|
| **id** | **Integer**| The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. | [default to null] |
| **patchBillingCreditCardVerify\_request** | [**patchBillingCreditCardVerify_request**](../Models/patchBillingCreditCardVerify_request.md)|  | |
