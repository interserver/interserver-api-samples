...
|------------ | ------------- | ------------- | -------------|
| **id** | **Integer** | Server ID this result corresponds to. | [optional] [default to null] |
| **asset** | **Integer** | Asset ID that was queried for the server (omitted on errors before asset selection). | [optional] [default to null] |
