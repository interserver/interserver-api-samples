...
public interface WebhostingApi  {
    ...
    @Operation(summary = "Place a new webhosting order, create the invoice, and queue provisioning", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    public ServiceOrderPostResponse addWebsite(@Valid WebsiteOrderPostRequest body);
    ...
    @Path("/websites/order")
    @Produces({ "application/json" })
    @Operation(summary = "Read the webhosting order catalog — plans, packages, promo offers, pricing", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read website IPs, current reverse DNS, and additional-IP pricing", tags={ "Webhosting" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20026 getWebsiteBuyIp(@PathParam("id") Integer id);
    ...
    @Path("/websites/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Read full configuration and status detail for one webhosting service", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List all billing invoices and recurring charges scoped to one website", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    @Operation(summary = "List the caller's webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List off-site cpmove backups stored in Swift — list or inline-download archive", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get a one-time auto-login URL for the website's control panel", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the webhosting welcome email with control-panel credentials and URL", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read current reverse-DNS (PTR) records for the website's IPs", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Buy an additional IP for the website OR update reverse DNS records", tags={ "Webhosting" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20027 postWebsiteBuyIp(@Valid IdBuyIpBody body, @PathParam("id") Integer id);
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "DNS update result.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse20027.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20027 postWebsiteBuyIp(@Multipart(value = "ips")  Map<String, String> ips, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Submit a request for InterServer staff to migrate a website from another host", tags={ "Webhosting" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20028 postWebsiteMigration(@Valid IdMigrationBody body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Bulk-update reverse-DNS (PTR) records for one or more website IPs", tags={ "Webhosting" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate a webhosting order and preview cost — dry run, no charge", tags={ "Webhosting" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Validate Website order response"),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void putWebsites(@Valid WebsiteOrderPutRequest body);
    ...
    @Path("/websites/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "POST mutation hook for the website detail page (use dedicated ops where possible)", tags={ "Webhosting" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/websites/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Schedule termination of a webhosting service — wipes panel account at cycle end", tags={ "Webhosting" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20025 webhostingCancel(@PathParam("id") String id);
}
