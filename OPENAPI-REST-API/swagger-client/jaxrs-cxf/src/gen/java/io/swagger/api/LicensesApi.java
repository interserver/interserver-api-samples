...
public interface LicensesApi  {
    ...
    @Operation(summary = "Order a new software license and create the recurring invoice", tags={ "Licenses" })
    @ApiResponses(value = { 
    ...
    public ServiceOrderPostResponse addLicense(@Valid LicenseOrderRequest body);
    ...
    @Path("/licenses/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get full details for one license including status, IP, and links", tags={ "Licenses" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List all billing invoices tied to one software license service", tags={ "Licenses" })
    @ApiResponses(value = { 
    ...
    @Path("/licenses")
    @Produces({ "application/json" })
    @Operation(summary = "List all software licenses owned by the authenticated customer", tags={ "Licenses" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the license welcome email with the key and activation steps", tags={ "Licenses" })
    @ApiResponses(value = { 
    ...
    @Path("/licenses/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get available license types, packages, and pricing for ordering", tags={ "Licenses" })
    @ApiResponses(value = { 
    ...
    @Path("/licenses/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel a license service and stop future billing (irreversible)", tags={ "Licenses" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Rebind a license to a new IP address (may incur a vendor fee)", tags={ "Licenses" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate a software license order before placing it (dry run preview)", tags={ "Licenses" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Validate Licenses order response"),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void putLicenses(@Valid LicenseOrderRequest body);
    ...
    @Path("/licenses/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update mutable fields on a license service (e.g. assigned IP)", tags={ "Licenses" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
