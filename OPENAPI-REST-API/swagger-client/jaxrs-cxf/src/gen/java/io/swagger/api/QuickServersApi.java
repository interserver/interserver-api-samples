...
public interface QuickServersApi  {
    ...
    @Operation(summary = "Place a QuickServer order, generating a real invoice and queuing provisioning", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    public ServiceOrderPostResponse addQs(@Valid QsOrderRequest body);
    ...
    @Path("/qs/{id}/backups")
    @Produces({ "application/json" })
    @Operation(summary = "Permanently delete a QuickServer backup file from object storage", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Block outbound SMTP traffic on a QuickServer to halt mail abuse", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Disable the virtual CD/DVD drive device on a QuickServer", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Disable disk-quota enforcement at OS level on a QuickServer", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/eject_cd")
    @Produces({ "application/json" })
    @Operation(summary = "Eject the currently mounted ISO from a QuickServer's virtual CD drive", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Enable disk-quota enforcement at OS level on a QuickServer", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/restart")
    @Produces({ "application/json" })
    @Operation(summary = "Reboot a QuickServer with a graceful OS-level restart", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/start")
    @Produces({ "application/json" })
    @Operation(summary = "Power on a QuickServer that is currently stopped or pending boot", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/stop")
    @Produces({ "application/json" })
    @Operation(summary = "Power off a QuickServer with a graceful shutdown command", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Generate a 24-hour pre-signed download URL for a QuickServer backup", tags={ "QuickServers" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20012 downloadQsBackup(@Valid IdBackupsBody body, @PathParam("id") Integer id, @QueryParam("all") String all);
    ...
    @Path("/qs/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get QuickServer order form metadata and available plans/templates", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Path("/qs/{id}/backup")
    @Produces({ "application/json" })
    @Operation(summary = "Queue creation of a new QuickServer backup snapshot (note: GET triggers job)", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/backups")
    @Produces({ "application/json" })
    @Operation(summary = "List available QuickServer backups across Swift, MinIO, and ZFS storage", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get current QuickServer hostname plus change rules and platform support", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get metadata for QuickServer root/OS password change requirements", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List timezones the QuickServer can be set to via change_timezone", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get metadata for changing the Webuzo control panel admin password", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Path("/qs/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get full details for one QuickServer including credentials and links", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List ISO images available to mount on a QuickServer's virtual CD", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Path("/qs/{id}/invoices")
    @Produces({ "application/json" })
    @Operation(summary = "List billing invoices charged for one QuickServer service", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Path("/qs")
    @Produces({ "application/json" })
    @Operation(summary = "List QuickServer rapid-deploy dedicated servers on the account", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List OS templates available for a QuickServer reinstall", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get options for QuickServer randomized root password reset", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get reverse DNS (PTR) records for all of a QuickServer's IPs", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get current VNC console connection details for a QuickServer", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get bandwidth usage for the QuickServer's current billing period", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get the full QuickServer dashboard view payload (rich format)", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the QuickServer welcome email with login credentials", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Path("/qs/{id}/change_hostname")
    @Produces({ "application/json" })
    @Operation(summary = "Change a QuickServer's system hostname (OpenVZ/Virtuozzo only)", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/change_root_password")
    @Produces({ "application/json" })
    @Operation(summary = "Change QuickServer root/administrator password to a chosen value", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Change the system timezone on a QuickServer to a catalog entry", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/change_webuzo_password")
    @Produces({ "application/json" })
    @Operation(summary = "Change Webuzo control panel admin password live (synchronous, not queued)", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/insert_cd")
    @Produces({ "application/json" })
    @Operation(summary = "Mount an ISO image as the QuickServer's virtual CD via URL", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/reinstall_os")
    @Produces({ "application/json" })
    @Operation(summary = "Reinstall the operating system on a QuickServer (DESTRUCTIVE — wipes disk)", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/reset_password")
    @Produces({ "application/json" })
    @Operation(summary = "Reset QuickServer root password to a server-generated random value", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Update reverse DNS (PTR) records for a QuickServer's IPs", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Path("/qs/{id}/setup_vnc")
    @Produces({ "application/json" })
    @Operation(summary = "Configure the source IP allowed to reach a QuickServer's VNC console", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/qs/{id}/traffic_usage")
    @Produces({ "application/json" })
    @Operation(summary = "Query QuickServer bandwidth usage via POST (filtered variant)", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Path("/qs/{id}/view_desktop")
    @Produces({ "application/json" })
    @Operation(summary = "Submit changes and re-fetch the QuickServer dashboard view payload", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Restore a QuickServer from a backup (DESTRUCTIVE — overwrites disk)", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate a QuickServer order without charging or provisioning", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Validate QuickServer Order response"),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void putQs(@Valid QsOrderRequest body);
    ...
    @Path("/qs/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel a QuickServer service at the end of the current billing cycle", tags={ "QuickServers" })
    @ApiResponses(value = { 
    ...
    @Path("/qs/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update QuickServer order metadata or stored settings without OS impact", tags={ "QuickServers" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
