...
public interface SslCertificatesApi  {
    ...
    @Operation(summary = "Place a new SSL certificate order - creates invoice and queues issuance", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    public ServiceOrderPostResponse addSsl(@Valid SslOrderRequest body);
    ...
    @Path("/ssl/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get available SSL certificate packages and pricing for placing a new order", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Path("/ssl/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get full details for one SSL certificate by id - status, expiration, links", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List all billing invoices and charges tied to one SSL certificate by id", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Path("/ssl")
    @Produces({ "application/json" })
    @Operation(summary = "List all SSL certificates on the authenticated customer account with status and hostname", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the SSL welcome email with cert credentials and install instructions", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate an SSL certificate order without charging - dry-run before addSsl", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Validate SSL Order response"),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void putSsl(@Valid SslOrderRequest body);
    ...
    @Path("/ssl/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel an SSL certificate service - stops renewals at end of billing cycle", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Path("/ssl/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update mutable settings on an existing SSL certificate order by id", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
