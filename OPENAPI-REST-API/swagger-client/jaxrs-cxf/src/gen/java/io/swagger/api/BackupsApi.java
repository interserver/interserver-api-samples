...
public interface BackupsApi  {
    ...
    @Operation(summary = "Place a new off-site backup storage order and generate the invoice", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Path("/backups/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel an off-site backup storage subscription", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Path("/backups/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get details of a specific off-site backup storage service", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List invoices for a single backup-storage subscription", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Open a single sign-on session URL for the backup storage panel", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Path("/backups")
    @Produces({ "application/json" })
    @Operation(summary = "List off-site backup storage subscriptions on the authenticated account", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the welcome email for an off-site backup storage service", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Path("/backups/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get backup-storage order form metadata and pricing tiers", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Path("/backups/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update stored metadata for a backup-storage subscription", tags={ "Backups" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate a backup-storage order and preview pricing without charging", tags={ "Backups" })
    @ApiResponses(value = { 
