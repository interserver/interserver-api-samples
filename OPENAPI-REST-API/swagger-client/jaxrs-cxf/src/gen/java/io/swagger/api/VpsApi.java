...
public interface VpsApi  {
    ...
    @Operation(summary = "Place a new VPS order, create the invoice, and queue provisioning", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps/{id}/backups")
    @Produces({ "application/json" })
    @Operation(summary = "Permanently delete a VPS backup file by name (irreversible)", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Block outbound SMTP (port 25) on the VPS to prevent spam/abuse", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Remove the virtual CD/DVD device entirely from the VPS configuration", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Disable per-user disk quota enforcement inside the VPS guest OS", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Eject the mounted ISO from the VPS virtual CD drive (keep the drive)", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Enable per-user disk quota enforcement inside the VPS guest OS", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/vps/{id}/restart")
    @Produces({ "application/json" })
    @Operation(summary = "Reboot the VPS — preferred over stop+start for software changes", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/vps/{id}/start")
    @Produces({ "application/json" })
    @Operation(summary = "Power on a stopped VPS instance", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/vps/{id}/stop")
    @Produces({ "application/json" })
    @Operation(summary = "Power off a running VPS — billing continues until cancellation", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup", tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20012 downloadVpsBackup(@Valid IdBackupsBody2 body, @PathParam("id") Integer id, @QueryParam("all") String all);
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Download URL for the backup file.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse20012.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20012 downloadVpsBackup(@Multipart(value = "file")  String file, @PathParam("id") Integer id, @QueryParam("all") String all);
    ...
    @Path("/vps/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get the VPS order catalog — platforms, OS templates, locations, pricing", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps/{id}/backup")
    @Produces({ "application/json" })
    @Operation(summary = "Trigger a manual on-demand snapshot/backup of the VPS", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public QueueResponse getVpsBackup(@PathParam("id") Integer id);
    ...
    @Path("/vps/{id}/backups")
    @Produces({ "application/json" })
    @Operation(summary = "List existing backups for the VPS across Swift, MinIO, and ZFS", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get current additional disk size and per-GB monthly cost for the VPS", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps/{id}/buy_ip")
    @Produces({ "application/json" })
    @Operation(summary = "Read current additional IPs, cap, and per-IP monthly cost for the VPS", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read the VPS's current hostname before changing it", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Current hostname information for the VPS."),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void getVpsChangeHostname(@PathParam("id") Integer id);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Pre-flight check before changing the VPS root password", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Password requirements and current state."),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void getVpsChangeRootPassword(@PathParam("id") Integer id);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List IANA timezones supported by the VPS guest OS", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get full details for one VPS — IPs, hostname, OS, slices, status, addons", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List ISO templates that can be mounted in the VPS virtual CD drive", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Available CD/ISO images for the VPS."),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void getVpsInsertCd(@PathParam("id") Integer id);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List all billing invoices associated with this specific VPS", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps")
    @Produces({ "application/json" })
    @Operation(summary = "List all VPS services on the customer's account", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List OS templates compatible with this VPS's hypervisor for reinstall", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Pre-flight check before resetting the VPS root password to a random value", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Password reset requirements and current state."),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void getVpsResetPassword(@PathParam("id") Integer id);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read the current PTR (reverse-DNS) records for every IP on the VPS", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read current VNC console connection info for the VPS", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps/{id}/slices")
    @Produces({ "application/json" })
    @Operation(summary = "Read current slice count, min/max range, and prorated per-slice upgrade cost", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read bandwidth traffic usage data for the VPS", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the welcome email containing VPS IP, hostname, and root credentials", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/vps/{id}/buy_hd_space")
    @Produces({ "application/json" })
    @Operation(summary = "Buy or resize the VPS additional-disk addon and create a prorated invoice", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps/{id}/buy_ip")
    @Produces({ "application/json" })
    @Operation(summary = "Purchase one additional IP for the VPS and create the invoice", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Set a specific new root/Administrator password on the VPS", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Set the system timezone on the VPS guest OS", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Rotate the Webuzo control panel admin password (re-auth required)", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Mount an ISO image in the VPS virtual CD drive from a URL", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/vps/{id}/reset_password")
    @Produces({ "application/json" })
    @Operation(summary = "Reset the VPS root password to a server-generated random value", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Bulk-update PTR (reverse-DNS) records for one or more VPS IPs", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps/{id}/setup_vnc")
    @Produces({ "application/json" })
    @Operation(summary = "Provision or refresh the VNC console endpoint for the VPS", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response message from sending a service queue.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = QueueResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/vps/{id}/slices")
    @Produces({ "application/json" })
    @Operation(summary = "Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps/{id}/traffic_usage")
    @Produces({ "application/json" })
    @Operation(summary = "Search/filter VPS bandwidth usage with custom criteria (reserved)", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Filtered traffic usage search results."),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void postVpsTrafficUsage(@PathParam("id") Integer id);
    ...
    @Path("/vps/{id}/view_desktop")
    @Produces({ "application/json" })
    @Operation(summary = "Refresh the remote-desktop session connection info after IP/hostname changes", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate a VPS order configuration and quote the cost — dry run, no charge", tags={ "VPS" })
    @ApiResponses(value = { 
    ...
    @Path("/vps/{id}/buy_hd_space")
    @Produces({ "application/json" })
    @Operation(summary = "Preview cost to set additional VPS disk to a target GB size — dry run", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Pricing preview for the requested HD space size."),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void putVpsBuyHdSpace(@PathParam("id") Integer id);
    ...
    @Path("/vps/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update editable settings on a VPS service record", tags={ "VPS" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/vps/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel a VPS service at the end of the current billing cycle", tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20024 vPSCancel(@PathParam("id") Integer id);
}
