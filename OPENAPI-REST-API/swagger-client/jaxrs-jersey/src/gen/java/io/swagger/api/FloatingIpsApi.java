...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    public Response addFloatingIp(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) FloatingIpOrderRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.addFloatingIp(body,securityContext);
    }
    @DELETE
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response putFloatingIps(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) FloatingIpOrderRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.putFloatingIps(body,securityContext);
    }
    @POST
    @Path("/{id}")
