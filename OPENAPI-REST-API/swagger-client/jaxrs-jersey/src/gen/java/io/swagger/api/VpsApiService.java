...
public abstract class VpsApiService {
    ...
    public abstract Response getVpsBackup(Integer id,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getVpsChangeHostname(Integer id,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getVpsChangeRootPassword(Integer id,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getVpsInsertCd(Integer id,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getVpsResetPassword(Integer id,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response postVpsTrafficUsage(Integer id,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response putVpsBuyHdSpace(Integer id,SecurityContext securityContext) throws NotFoundException;
