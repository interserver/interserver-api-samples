...
namespace IO.Swagger.Api
{
    ...
    public interface IQuickServersApi
    {
        ...
        InlineResponse20012 DownloadQsBackup (IdBackupsBody body, int? id, string all);
        /// <summary>
        /// Generate a 24-hour pre-signed download URL for a QuickServer backup Returns a temporary signed URL to fetch the backup directly from object storage. Path param: &#x60;id&#x60;. Body (JSON or form): &#x60;file&#x60; (the backup &#x60;name&#x60; from &#x60;getQsBackups&#x60;). Only available for &#x60;minio&#x60;-type backups; &#x60;swift&#x60; and &#x60;zfs&#x60; backups return an error directing the caller to contact support. URL expires in 24 hours. Returns: &#x60;{ text, url }&#x60;. Errors: 401, 404 if not owned, error message for unsupported backup type or sharing failure. Siblings: &#x60;getQsBackups&#x60; (list, get &#x60;name&#x60;), &#x60;deleteQsBackup&#x60;, &#x60;postQuickServerRestore&#x60;.
        /// </summary>
        ...
        /// <param name="all">Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given QuickServer.</param>
        /// <returns>InlineResponse20012</returns>
        InlineResponse20012 DownloadQsBackup (string file, int? id, string all);
        /// <summary>
    ...
    public class QuickServersApi : IQuickServersApi
    {
        ...
        public ServiceOrderPostResponse AddQs (QsOrderRequest body)
        {
            ...
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling AddQs");
 ...
 if (file != null) queryParams.Add("file", ApiClient.ParameterToString(file)); // query parameter
        ...
        /// <param name="all">Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given QuickServer.</param>
        /// <returns>InlineResponse20012</returns>
        public InlineResponse20012 DownloadQsBackup (IdBackupsBody body, int? id, string all)
        {
            // verify the required parameter 'body' is set
        ...
        /// <param name="all">Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given QuickServer.</param>
        /// <returns>InlineResponse20012</returns>
        public InlineResponse20012 DownloadQsBackup (string file, int? id, string all)
        {
            // verify the required parameter 'file' is set
        ...
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling GetQsBackup");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetQsBackup: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetQsBackup: " + response.ErrorMessage, response.ErrorMessage);
...
if (password != null) formParams.Add("password", ApiClient.ParameterToString(password)); // form parameter
        ...
        {
            // verify the required parameter 'body' is set
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling PutQs");
