...
namespace IO.Swagger.Api
{
    ...
    public interface IVPSApi
    {
        ...
        InlineResponse20012 DownloadVpsBackup (IdBackupsBody2 body, int? id, string all);
        /// <summary>
        /// Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup Generates a time-limited download link for a MinIO/S3-backed VPS backup so the customer can fetch it off-platform. Runs &#x60;mc share download - -expire&#x3D;24h&#x60; against the resolved backup path and returns the resulting public URL — valid for 24 hours from issue. Only &#x60;minio&#x60;-typed backups are downloadable; &#x60;swift&#x60; and &#x60;zfs&#x60; backups have direct download disabled (returns an error directing the customer to support). Sibling ops: &#x60;getVpsBackups&#x60; (list to find &#x60;name&#x60;), &#x60;postVpsRestore&#x60; (restore in place — no download needed), &#x60;deleteVpsBackup&#x60;, &#x60;getVpsBackup&#x60; (create new).  **Path param:** - &#x60;id&#x60; (integer, required) — VPS id from &#x60;getVpsList.vps_id&#x60;.  **Body (JSON or multipart, required):** - &#x60;file&#x60; (string, required) — exact &#x60;name&#x60; from &#x60;getVpsBackups&#x60;.  **Returns:** - &#x60;text&#x60; (string) — &#x60;URL available for the next 24 hours&#x60;. - &#x60;url&#x60; (string) — pre-signed download URL (HTTPS).  **Auth:** Session/API key. Ownership enforced via parent VPS.  **Errors:** - &#x60;401&#x60; — unauthenticated. - &#x60;404 Invalid VPS Passed&#x60; — &#x60;id&#x60; not owned by caller. - &#x60;No file specified&#x60; — &#x60;file&#x60; body field missing. - **Swift backup:** &#x60;Downloads for this type have been disabled. Please contact support if you need this backup.&#x60; - **ZFS backup:** same disabled message. - **MinIO share failure:** &#x60;Error sharing file &lt;name&gt;&#x60;.  **Related calls:** - **Prerequisite:** &#x60;getVpsBackups&#x60; (find a backup with &#x60;type &#x3D;&#x3D; \&quot;minio\&quot;&#x60;). - **Alternative:** &#x60;postVpsRestore&#x60; (restore in place — no download). - **Cleanup after download:** &#x60;deleteVpsBackup&#x60;. 
        /// </summary>
        ...
        /// <param name="all">Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given VPS.</param>
        /// <returns>InlineResponse20012</returns>
        InlineResponse20012 DownloadVpsBackup (string file, int? id, string all);
        /// <summary>
...
if (comment != null) formParams.Add("comment", ApiClient.ParameterToString(comment)); // form parameter
 ...
 if (file != null) queryParams.Add("file", ApiClient.ParameterToString(file)); // query parameter
        ...
        /// <param name="all">Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given VPS.</param>
        /// <returns>InlineResponse20012</returns>
        public InlineResponse20012 DownloadVpsBackup (IdBackupsBody2 body, int? id, string all)
        {
        ...
        /// <param name="all">Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given VPS.</param>
        /// <returns>InlineResponse20012</returns>
        public InlineResponse20012 DownloadVpsBackup (string file, int? id, string all)
        {
            // verify the required parameter 'file' is set
        ...
        /// <param name="id">VPS ID number</param>
        /// <returns>QueueResponse</returns>
        public QueueResponse GetVpsBackup (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling GetVpsBackup");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsBackup: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsBackup: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="id">VPS ID number</param>
        /// <returns></returns>
        public void GetVpsChangeHostname (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling GetVpsChangeHostname");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsChangeHostname: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsChangeHostname: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="id">VPS ID number</param>
        /// <returns></returns>
        public void GetVpsChangeRootPassword (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling GetVpsChangeRootPassword");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsChangeRootPassword: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsChangeRootPassword: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="id">VPS ID number</param>
        /// <returns></returns>
        public void GetVpsInsertCd (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling GetVpsInsertCd");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsInsertCd: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsInsertCd: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="id">VPS ID number</param>
        /// <returns></returns>
        public void GetVpsResetPassword (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling GetVpsResetPassword");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsResetPassword: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetVpsResetPassword: " + response.ErrorMessage, response.ErrorMessage);
...
if (password != null) formParams.Add("password", ApiClient.ParameterToString(password)); // form parameter
        ...
        /// <param name="id">VPS ID number</param>
        /// <returns></returns>
        public void PostVpsTrafficUsage (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling PostVpsTrafficUsage");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling PostVpsTrafficUsage: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling PostVpsTrafficUsage: " + response.ErrorMessage, response.ErrorMessage);
...
if (comment != null) formParams.Add("comment", ApiClient.ParameterToString(comment)); // form parameter
        ...
        /// <param name="id">VPS ID number</param>
        /// <returns></returns>
        public void PutVpsBuyHdSpace (int? id)
        {
            // verify the required parameter 'id' is set
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling PutVpsBuyHdSpace");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling PutVpsBuyHdSpace: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling PutVpsBuyHdSpace: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="id">VPS ID number</param>
        /// <returns>InlineResponse20024</returns>
        public InlineResponse20024 VPSCancel (int? id)
        {
            // verify the required parameter 'id' is set
