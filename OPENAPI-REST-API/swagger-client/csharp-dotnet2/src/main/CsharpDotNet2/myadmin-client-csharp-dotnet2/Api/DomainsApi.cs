...
namespace IO.Swagger.Api
{
    ...
    public class DomainsApi : IDomainsApi
    {
        ...
        public ServiceOrderPostResponse AddDomain (Dictionary<string, Object> body)
        {
            ...
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling AddDomain");
...
if (ipAddress != null) formParams.Add("ipAddress", ApiClient.ParameterToString(ipAddress)); // form parameter
        ...
        {
            // verify the required parameter 'body' is set
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling PatchDomains");
        ...
        {
            // verify the required parameter 'name' is set
            if (name == null) throw new ApiException(400, "Missing required parameter 'name' when calling PostDomainSearch");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling PostDomainSearch: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling PostDomainSearch: " + response.ErrorMessage, response.ErrorMessage);
        ...
        {
            // verify the required parameter 'body' is set
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling PutDomains");
