...
namespace IO.Swagger.Api
{
    ...
    public class LicensesApi : ILicensesApi
    {
        ...
        public ServiceOrderPostResponse AddLicense (LicenseOrderRequest body)
        {
            ...
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling AddLicense");
        ...
        {
            // verify the required parameter 'body' is set
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling PutLicenses");
