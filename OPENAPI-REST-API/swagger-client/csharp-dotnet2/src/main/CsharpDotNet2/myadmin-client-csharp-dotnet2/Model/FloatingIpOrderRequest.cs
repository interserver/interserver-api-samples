...
namespace IO.Swagger.Model {
  ...
  public class FloatingIpOrderRequest {
    ...
    /// </summary>
    /// <value>Floating IP plan service type id from getNewFloatingIp.serviceTypes (must be buyable).</value>
    ...
    /// </summary>
    /// <value>Free-form note saved on the service row (used on addFloatingIp).</value>
