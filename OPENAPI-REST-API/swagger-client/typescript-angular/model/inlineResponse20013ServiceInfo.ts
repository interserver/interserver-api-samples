...
export interface InlineResponse20013ServiceInfo { 
    scrub_ip_id?: string;
    ...
    scrub_ip_status?: InlineResponse20013ServiceInfo.ScrubIpStatusEnum;
    scrub_ip_invoice?: string;
    scrub_ip_currency?: string;
    scrub_ip_coupon?: string;
    scrub_ip_comment?: string;
}
export namespace InlineResponse20013ServiceInfo {
