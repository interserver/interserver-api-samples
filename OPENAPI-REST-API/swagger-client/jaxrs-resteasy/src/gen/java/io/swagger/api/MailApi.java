...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addMail(body,securityContext);
    }
    @POST
    @Path("/{id}/rules")
...
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteMailAlert(body,id,securityContext);
    }
    @DELETE
    @Path("/{id}/alerts")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response deleteMailAlert(@Parameter(description = "", required=true)@FormParam("alert_id")  Integer alertId, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteMailAlert(alertId,id,securityContext);
    }
    @DELETE
    @Path("/{id}/rules/{rule}")
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.putMail(body,securityContext);
    }
    @GET
...
, @PathParam("id") Integer id, @PathParam("rule") String rule,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateRule(body,id,rule,securityContext);
    }
    @PUT
    @Path("/{id}/rules/{rule}")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.updateRule(user,type,data,id,rule,securityContext);
    }
    @GET
    @Path("/{id}/log")
