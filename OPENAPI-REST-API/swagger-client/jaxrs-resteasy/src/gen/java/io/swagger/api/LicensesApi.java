...
@Parameter(description = "" ,required=true) LicenseOrderRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addLicense(body,securityContext);
    }
    @GET
    @Path("/{id}")
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.putLicenses(body,securityContext);
    }
    @POST
    @Path("/{id}")
