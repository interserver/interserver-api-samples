...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response patchBillingCreditCardVerify(
@Parameter(description = "" ,required=true) IdVerifyBody body
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.patchBillingCreditCardVerify(body,id,securityContext);
    }
    @PATCH
    @Path("/creditcards/{id}/verify")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response patchBillingCreditCardVerify(@Parameter(description = "", required=true)@FormParam("cc_ccv2")  String ccCcv2, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.patchBillingCreditCardVerify(ccCcv2,id,securityContext);
    }
    @POST
    @Path("/creditcards/{id}/verify")
    @Consumes({ "application/json", "multipart/form-data" })
