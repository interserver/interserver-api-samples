...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getAffiliateDownload(  @QueryParam("st") String st,  @QueryParam("ex") String ex,  @QueryParam("year") Integer year,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getAffiliateDownload(st,ex,year,securityContext);
    }
    @GET
    @Path("/rich_report")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getAffiliateSignups(  @QueryParam("st") String st,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getAffiliateSignups(st,securityContext);
    }
    @GET
    @Path("/traffic_graph")
