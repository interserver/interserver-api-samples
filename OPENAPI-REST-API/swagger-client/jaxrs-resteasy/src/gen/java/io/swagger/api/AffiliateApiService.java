...
public interface AffiliateApiService {
      ...
      Response getAffiliateDownload(String st,String ex,Integer year,SecurityContext securityContext) throws NotFoundException;
      ...
      Response getAffiliateSignups(String st,SecurityContext securityContext) throws NotFoundException;
