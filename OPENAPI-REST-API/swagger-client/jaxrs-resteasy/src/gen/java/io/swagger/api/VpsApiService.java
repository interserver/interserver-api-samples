...
public interface VpsApiService {
      ...
      Response getVpsBackup(Integer id,SecurityContext securityContext) throws NotFoundException;
      ...
      Response getVpsChangeHostname(Integer id,SecurityContext securityContext) throws NotFoundException;
      Response getVpsChangeRootPassword(Integer id,SecurityContext securityContext) throws NotFoundException;
      ...
      Response getVpsInsertCd(Integer id,SecurityContext securityContext) throws NotFoundException;
      ...
      Response getVpsResetPassword(Integer id,SecurityContext securityContext) throws NotFoundException;
      ...
      Response postVpsTrafficUsage(Integer id,SecurityContext securityContext) throws NotFoundException;
      ...
      Response putVpsBuyHdSpace(Integer id,SecurityContext securityContext) throws NotFoundException;
