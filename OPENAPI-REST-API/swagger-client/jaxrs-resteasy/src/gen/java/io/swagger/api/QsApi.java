...
@Parameter(description = "" ,required=true) QsOrderRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addQs(body,securityContext);
    }
    @DELETE
    @Path("/{id}/backups")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getQsBackup( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getQsBackup(id,securityContext);
    }
    @GET
    @Path("/{id}/backups")
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.putQs(body,securityContext);
    }
    @DELETE
    @Path("/{id}")
