...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addServer(body,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response serverBulkIpmiPowerGet( @NotNull  @QueryParam("ids") String ids,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.serverBulkIpmiPowerGet(ids,securityContext);
    }
    @GET
    @Path("/{id}/ipmi_live")
