...
@Parameter(description = "" ,required=true) Map<String, Object> body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addDomain(body,securityContext);
    }
    @POST
    @Path("/{id}/dnssec")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response deleteDomainDnssec( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteDomainDnssec(id,securityContext);
    }
    @DELETE
    @Path("/{id}/nameservers")
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.patchDomains(body,securityContext);
    }
    @POST
    @Path("/{id}/renew")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postDomainSearch( @PathParam("name") String name,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postDomainSearch(name,securityContext);
    }
    @POST
    @Path("/{id}/transfer")
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.putDomains(body,securityContext);
    }
    @POST
    @Path("/{id}/contact")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateDomainInfo( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
