...
void main() {
  ...
  group('tests for MailApi', () {
    ...
    //
    //Future<ServiceOrderPostResponse> addMail(MailOrderRequest body) async
    ...
    //
    //Future<SuccessTextResponse> deleteMailAlert(IdAlertsBody body, int alertId, int id) async
    ...
    //
    //Future<InlineResponse2009> mailCancel(int id) async
    ...
    //
    //Future putMail(MailOrderRequest body) async
    ...
    //
    //Future<GenericResponse> updateRule(DenyRuleNew body, String user, String type, String data, int id, String rule) async
