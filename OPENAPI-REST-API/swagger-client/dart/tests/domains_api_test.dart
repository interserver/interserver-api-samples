...
void main() {
  ...
  group('tests for DomainsApi', () {
    ...
    //
    //Future<ServiceOrderPostResponse> addDomain(Map body) async
    ...
    //
    //Future<InlineResponse2003> cancelDomain(int id) async
    ...
    //
    //Future patchDomains(Map body) async
    ...
    //
    //Future putDomains(Map body) async
