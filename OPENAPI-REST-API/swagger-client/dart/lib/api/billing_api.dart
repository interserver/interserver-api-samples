...
if (automaticUse != null)
  ...
  Future getAffiliateDownload({ String st, String ex, int year }) async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "/affiliate/download".replaceAll("{format}","json");
    ...
    Map<String, String> formParams = {};
    if(st != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "st", st));
    }
    if(ex != null) {
      queryParams.addAll(_convertParametersForCollectionFormat("", "ex", ex));
    }
    if(year != null) {
  ...
  Future<InlineResponse2001> getAffiliateSignups({ String st }) async {
    Object postBody = null;

    // verify required params are set

    // create path and map variables
    String path = "/affiliate/signups".replaceAll("{format}","json");
  ...
  Future<InlineResponse20010> initiatePayment(String method, String invoices) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/billing/pay/{method}/{invoices}".replaceAll("{format}","json").replaceAll("{" + "method" + "}", method.toString()).replaceAll("{" + "invoices" + "}", invoices.toString());
  ...
  Future<SuccessTextResponse> patchBillingCreditCardVerify(IdVerifyBody body, int id) async {
    Object postBody = body;
