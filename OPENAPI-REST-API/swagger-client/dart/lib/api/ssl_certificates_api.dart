...
class SSLCertificatesApi {
  ...
  Future<ServiceOrderPostResponse> addSsl(SslOrderRequest body) async {
  ...
  Future putSsl(SslOrderRequest body) async {
    Object postBody = body;
  ...
  Future<InlineResponse20023> sslCancel(int id) async {
    Object postBody = null;
