...
class ServersApi {
  ...
  Future<InlineResponse20021> addServer(ServerOrderPostRequest body) async {
  ...
  Future<InlineResponse20029> buyItNowServerOrder() async {
  ...
  Future<ServerBulkIpmiPowerResponse> serverBulkIpmiPowerGet(String ids) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'ServerBulkIpmiPowerResponse') as ServerBulkIpmiPowerResponse ;
    } else {
      return null;
    }
  }
...
if (action != null)
  ...
  Future<InlineResponse20022> serversCancel(int id) async {
    Object postBody = null;
