...
class FloatingIPsApi {
  ...
  Future<ServiceOrderPostResponse> addFloatingIp(FloatingIpOrderRequest body) async {
  ...
  Future<InlineResponse2004> floatingIpsCancel(int id) async {
  ...
  Future putFloatingIps(FloatingIpOrderRequest body) async {
    Object postBody = body;
