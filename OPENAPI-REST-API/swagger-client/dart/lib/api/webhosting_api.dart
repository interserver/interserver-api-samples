...
class WebhostingApi {
  ...
  Future<ServiceOrderPostResponse> addWebsite(WebsiteOrderPostRequest body) async {
  ...
  Future<InlineResponse20026> getWebsiteBuyIp(int id) async {
    Object postBody = null;
  ...
  Future<InlineResponse20027> postWebsiteBuyIp(IdBuyIpBody body, int id) async {
    Object postBody = body;
  ...
  Future<InlineResponse20028> postWebsiteMigration(IdMigrationBody body, int id) async {
    Object postBody = body;
...
if (domainRegPassword != null)
  ...
  Future putWebsites(WebsiteOrderPutRequest body) async {
    Object postBody = body;
  ...
  Future<InlineResponse20025> webhostingCancel(String id) async {
    Object postBody = null;
