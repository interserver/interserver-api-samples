...
var body = new Map(); // Map | 

try {
    var result = api_instance.addDomain(body);
    print(result);
} catch (e) {
...
try {
    var result = api_instance.deleteDomainDnssec(id);
    print(result);
} catch (e) {
...
try {
    api_instance.patchDomains(body);
} catch (e) {
