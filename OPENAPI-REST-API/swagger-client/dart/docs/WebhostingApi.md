...
var body = new WebsiteOrderPostRequest(); // WebsiteOrderPostRequest | 

try {
    var result = api_instance.addWebsite(body);
    print(result);
} catch (e) {
...
var api_instance = new WebhostingApi();
var body = new WebsiteOrderPutRequest(); // WebsiteOrderPutRequest | 

try {
    api_instance.putWebsites(body);
} catch (e) {
