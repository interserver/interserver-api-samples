...
try {
    var result = api_instance.getAccountCurrencies();
    print(result);
} catch (e) {
...
try {
    var result = api_instance.getAccountLocales();
    print(result);
} catch (e) {
...
# **patchOauthTwoFactor**
> InlineResponse2008 patchOauthTwoFactor(body, accountId, code)
...
# **postOauthCallback**
> InlineResponse2007 postOauthCallback(provider, body, provider)
