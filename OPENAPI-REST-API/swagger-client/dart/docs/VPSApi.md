...
# **downloadVpsBackup**
> InlineResponse20012 downloadVpsBackup(body, file, id, all)
...
try {
    var result = api_instance.getVpsBackup(id);
    print(result);
} catch (e) {
...
try {
    api_instance.getVpsChangeHostname(id);
} catch (e) {
...
try {
    api_instance.getVpsChangeRootPassword(id);
} catch (e) {
...
try {
    api_instance.getVpsInsertCd(id);
} catch (e) {
...
try {
    api_instance.getVpsResetPassword(id);
} catch (e) {
...
try {
    api_instance.postVpsTrafficUsage(id);
} catch (e) {
...
try {
    api_instance.putVpsBuyHdSpace(id);
} catch (e) {
