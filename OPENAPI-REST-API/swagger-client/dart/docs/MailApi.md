...
try {
    var result = api_instance.addMail(body);
    print(result);
} catch (e) {
...
# **deleteMailAlert**
> SuccessTextResponse deleteMailAlert(body, alertId, id)
...
try {
    var result = api_instance.deleteMailAlert(body, alertId, id);
    print(result);
} catch (e) {
...
try {
    var result = api_instance.updateRule(body, user, type, data, id, rule);
    print(result);
} catch (e) {
