...
var api_instance = new BillingApi();
var st = st_example; // String | Filter by status.
var ex = ex_example; // String | Export format: csv, xls, xlsx, or pdf. Defaults to csv.
var year = 56; // int | Year to filter the report. Defaults to the current year.
...
var api_instance = new BillingApi();
var st = st_example; // String | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.

try {
    var result = api_instance.getAffiliateSignups(st);
    print(result);
} catch (e) {
...
> SuccessTextResponse patchBillingCreditCardVerify(body, ccCcv2, id)
...
try {
    var result = api_instance.patchBillingCreditCardVerify(body, ccCcv2, id);
    print(result);
} catch (e) {
