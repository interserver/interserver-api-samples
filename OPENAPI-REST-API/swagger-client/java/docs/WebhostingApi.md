...
<a name="addWebsite"></a>
# **addWebsite**
> ServiceOrderPostResponse addWebsite(body)
...
//import com.interserver.myadmin.api.WebhostingApi;
...
WebsiteOrderPostRequest body = new WebsiteOrderPostRequest(); // WebsiteOrderPostRequest | 
try {
    ServiceOrderPostResponse result = apiInstance.addWebsite(body);
...
------------- | ------------- | ------------- | -------------
 **body** | [**WebsiteOrderPostRequest**](WebsiteOrderPostRequest.md)|  |
...
# **getWebsiteBuyIp**
> InlineResponse20026 getWebsiteBuyIp(id)
...
try {
    InlineResponse20026 result = apiInstance.getWebsiteBuyIp(id);
    System.out.println(result);
} catch (ApiException e) {
...
# **postWebsiteBuyIp**
> InlineResponse20027 postWebsiteBuyIp(body, id)
...
Integer id = 56; // Integer | The website service ID. Use `website_id` from `GET /websites`.
try {
    InlineResponse20027 result = apiInstance.postWebsiteBuyIp(body, id);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="postWebsiteBuyIp"></a>
# **postWebsiteBuyIp**
> InlineResponse20027 postWebsiteBuyIp(ips, id)
...
Integer id = 56; // Integer | The website service ID. Use `website_id` from `GET /websites`.
try {
    InlineResponse20027 result = apiInstance.postWebsiteBuyIp(ips, id);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling WebhostingApi#postWebsiteBuyIp");
    e.printStackTrace();
...
> InlineResponse20028 postWebsiteMigration(body, id)
...
Integer id = 56; // Integer | The website service ID. Use `website_id` from `GET /websites`.
try {
    InlineResponse20028 result = apiInstance.postWebsiteMigration(body, id);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="postWebsiteMigration"></a>
# **postWebsiteMigration**
> InlineResponse20028 postWebsiteMigration(custPortal, regEmail, password, ctrlPanel, ftpUsername, ftpPassword, siteBusyMig, splReqMig, domainReg, dataMig, domainRegPortal, domainRegEmail, domainRegPassword, id)
...
Integer id = 56; // Integer | The website service ID. Use `website_id` from `GET /websites`.
try {
    InlineResponse20028 result = apiInstance.postWebsiteMigration(custPortal, regEmail, password, ctrlPanel, ftpUsername, ftpPassword, siteBusyMig, splReqMig, domainReg, dataMig, domainRegPortal, domainRegEmail, domainRegPassword, id);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling WebhostingApi#postWebsiteMigration");
    e.printStackTrace();
...
WebhostingApi apiInstance = new WebhostingApi();
WebsiteOrderPutRequest body = new WebsiteOrderPutRequest(); // WebsiteOrderPutRequest | 
try {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**WebsiteOrderPutRequest**](WebsiteOrderPutRequest.md)|  |
...
# **webhostingCancel**
> InlineResponse20025 webhostingCancel(id)
...
String id = "id_example"; // String | The website service ID. Use `website_id` from `GET /websites`.
try {
    InlineResponse20025 result = apiInstance.webhostingCancel(id);
    System.out.println(result);
} catch (ApiException e) {
