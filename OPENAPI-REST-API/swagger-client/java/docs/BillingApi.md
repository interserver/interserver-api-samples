...
//import com.interserver.myadmin.api.BillingApi;
...
BillingApi apiInstance = new BillingApi();
String st = "st_example"; // String | Filter by status.
String ex = "ex_example"; // String | Export format: csv, xls, xlsx, or pdf. Defaults to csv.
Integer year = 56; // Integer | Year to filter the report. Defaults to the current year.
try {
...
BillingApi apiInstance = new BillingApi();
String st = "st_example"; // String | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.
try {
    InlineResponse2001 result = apiInstance.getAffiliateSignups(st);
    System.out.println(result);
} catch (ApiException e) {
...
BillingApi apiInstance = new BillingApi();
IdVerifyBody body = new IdVerifyBody(); // IdVerifyBody | 
Integer id = 56; // Integer | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
try {
    SuccessTextResponse result = apiInstance.patchBillingCreditCardVerify(body, id);
    System.out.println(result);
} catch (ApiException e) {
...
Integer id = 56; // Integer | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
try {
    SuccessTextResponse result = apiInstance.patchBillingCreditCardVerify(ccCcv2, id);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling BillingApi#patchBillingCreditCardVerify");
    e.printStackTrace();
