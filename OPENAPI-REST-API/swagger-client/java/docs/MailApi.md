...
//import com.interserver.myadmin.api.MailApi;
...
MailOrderRequest body = new MailOrderRequest(); // MailOrderRequest | 
try {
...
MailApi apiInstance = new MailApi();
IdAlertsBody body = new IdAlertsBody(); // IdAlertsBody | 
Integer id = 56; // Integer | The mail service ID. Use `mail_id` from `GET /mail`.
try {
...
Integer id = 56; // Integer | The mail service ID. Use `mail_id` from `GET /mail`.
try {
    SuccessTextResponse result = apiInstance.deleteMailAlert(alertId, id);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling MailApi#deleteMailAlert");
    e.printStackTrace();
...
MailApi apiInstance = new MailApi();
DenyRuleNew body = new DenyRuleNew(); // DenyRuleNew | 
Integer id = 56; // Integer | The mail service ID. Use `mail_id` from `GET /mail`.
String rule = "rule_example"; // String | The ID of the deny rule to update.
try {
...
String rule = "rule_example"; // String | The ID of the deny rule to update.
try {
    GenericResponse result = apiInstance.updateRule(user, type, data, id, rule);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling MailApi#updateRule");
    e.printStackTrace();
