...
//import com.interserver.myadmin.api.PublicApi;
...
# **getAccountLocales**
> Map&lt;String, InlineResponseMap200&gt; getAccountLocales()
...
PublicApi apiInstance = new PublicApi();
try {
    Map<String, InlineResponseMap200> result = apiInstance.getAccountLocales();
    System.out.println(result);
} catch (ApiException e) {
...
try {
    InlineResponse2006 result = apiInstance.getOauthRedirect(provider);
    System.out.println(result);
} catch (ApiException e) {
...
try {
    InlineResponse2008 result = apiInstance.patchOauthTwoFactor(body);
    System.out.println(result);
} catch (ApiException e) {
...
try {
    InlineResponse2008 result = apiInstance.patchOauthTwoFactor(accountId, code);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling PublicApi#patchOauthTwoFactor");
    e.printStackTrace();
...
try {
    InlineResponse2007 result = apiInstance.postOauthCallback(provider, body);
    System.out.println(result);
} catch (ApiException e) {
...
try {
    InlineResponse2007 result = apiInstance.postOauthCallback(provider, provider2);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling PublicApi#postOauthCallback");
    e.printStackTrace();
