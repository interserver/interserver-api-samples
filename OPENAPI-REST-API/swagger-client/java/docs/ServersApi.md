...
//import com.interserver.myadmin.api.ServersApi;
...
ServerOrderPostRequest body = new ServerOrderPostRequest(); // ServerOrderPostRequest | 
try {
...
ServersApi apiInstance = new ServersApi();
String ids = "ids_example"; // String | Comma-separated list of Server IDs to query (e.g. `2313,2314,2315`). May also be passed as repeated `ids[]` query parameters.
try {
