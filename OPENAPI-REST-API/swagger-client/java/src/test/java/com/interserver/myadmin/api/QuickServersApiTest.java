...
public class QuickServersApiTest {
    ...
    public void addQsTest() throws Exception {
        ...
        ServiceOrderPostResponse response = api.addQs(body);
    ...
    public void downloadQsBackupTest() throws Exception {
        ...
        Integer id = null;
        String all = null;
        InlineResponse20012 response = api.downloadQsBackup(body, id, all);
     ...
     */
    @Test
    public void getQsBackupTest() throws Exception {
        Integer id = null;
        QueueResponse response = api.getQsBackup(id);
    ...
    public void quickserversCancelTest() throws Exception {
        Integer id = null;
        InlineResponse20011 response = api.quickserversCancel(id);
