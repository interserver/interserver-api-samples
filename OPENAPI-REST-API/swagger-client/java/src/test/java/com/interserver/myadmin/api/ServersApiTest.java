...
public class ServersApiTest {
    ...
    public void addServerTest() throws Exception {
        ...
        InlineResponse20021 response = api.addServer(body);
    ...
    public void buyItNowServerOrderTest() throws Exception {
        InlineResponse20029 response = api.buyItNowServerOrder();
     ...
     */
    @Test
    public void serverBulkIpmiPowerGetTest() throws Exception {
        String ids = null;
    ...
    public void serversCancelTest() throws Exception {
        Integer id = null;
        InlineResponse20022 response = api.serversCancel(id);
