...
public class MailApiTest {
    ...
    public void addMailTest() throws Exception {
        ...
        ServiceOrderPostResponse response = api.addMail(body);
    ...
    public void deleteMailAlertTest() throws Exception {
        ...
        Integer id = null;
        SuccessTextResponse response = api.deleteMailAlert(body, id);
    ...
    public void mailCancelTest() throws Exception {
        Integer id = null;
        InlineResponse2009 response = api.mailCancel(id);
    ...
    public void updateRuleTest() throws Exception {
        ...
        Integer id = null;
        String rule = null;
        GenericResponse response = api.updateRule(body, id, rule);
