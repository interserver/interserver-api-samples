...
public class WebhostingApiTest {
    ...
    public void addWebsiteTest() throws Exception {
        ...
        ServiceOrderPostResponse response = api.addWebsite(body);
    ...
    public void getWebsiteBuyIpTest() throws Exception {
        Integer id = null;
        InlineResponse20026 response = api.getWebsiteBuyIp(id);
    ...
    public void postWebsiteBuyIpTest() throws Exception {
        ...
        Integer id = null;
        InlineResponse20027 response = api.postWebsiteBuyIp(body, id);
    ...
    public void postWebsiteMigrationTest() throws Exception {
        ...
        Integer id = null;
        InlineResponse20028 response = api.postWebsiteMigration(body, id);
    ...
    public void webhostingCancelTest() throws Exception {
        String id = null;
        InlineResponse20025 response = api.webhostingCancel(id);
