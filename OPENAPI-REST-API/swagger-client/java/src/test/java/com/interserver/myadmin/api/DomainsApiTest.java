...
public class DomainsApiTest {
    ...
    public void addDomainTest() throws Exception {
        ...
        ServiceOrderPostResponse response = api.addDomain(body);
    ...
    public void cancelDomainTest() throws Exception {
        Integer id = null;
        InlineResponse2003 response = api.cancelDomain(id);
     ...
     */
    @Test
    public void postDomainSearchTest() throws Exception {
        String name = null;
