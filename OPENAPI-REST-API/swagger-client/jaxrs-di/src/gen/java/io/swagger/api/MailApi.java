...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    public Response addMail(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) MailOrderRequest body
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response deleteMailAlert(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) IdAlertsBody body
,@Parameter(in = ParameterIn.PATH, description = "The mail service ID. Use `mail_id` from `GET /mail`.",required=true) @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response deleteMailAlert(@Parameter(description = "", required=true)  @FormParam("alert_id")  Integer alertId,@Parameter(in = ParameterIn.PATH, description = "The mail service ID. Use `mail_id` from `GET /mail`.",required=true) @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response putMail(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) MailOrderRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateRule(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) DenyRuleNew body
,@Parameter(in = ParameterIn.PATH, description = "The mail service ID. Use `mail_id` from `GET /mail`.",required=true) @PathParam("id") Integer id,@Parameter(in = ParameterIn.PATH, description = "The ID of the deny rule to update.",required=true) @PathParam("rule") String rule,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateRule(@Parameter(description = "", required=true)  @FormParam("user")  String user,@Parameter(description = "", required=true, schema=@Schema(allowableValues={ "domain", "email", "startswith", "destination" })
)  @FormParam("type")  String type,@Parameter(description = "", required=true)  @FormParam("data")  String data,@Parameter(in = ParameterIn.PATH, description = "The mail service ID. Use `mail_id` from `GET /mail`.",required=true) @PathParam("id") Integer id,@Parameter(in = ParameterIn.PATH, description = "The ID of the deny rule to update.",required=true) @PathParam("rule") String rule,@Context SecurityContext securityContext)
    throws NotFoundException {
