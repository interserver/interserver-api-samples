...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    public Response addSsl(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) SslOrderRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.addSsl(body,securityContext);
    }
    @GET
    @Path("/order")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response putSsl(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) SslOrderRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.putSsl(body,securityContext);
    }
    @DELETE
    @Path("/{id}")
