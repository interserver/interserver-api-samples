...
namespace Interserver.MyAdmin.Client.Model
{
        ...
        public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(bool? success = default(bool?), string text = default(string))
        {
            // to ensure "success" is required (not null)
            if (success == null)
            {
                throw new InvalidDataException("success is a required property for InlineResponse20011 and cannot be null");
            }
            else
            {
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for InlineResponse20011 and cannot be null");
            }
            else
            {
                this.text = text;
