...
namespace Interserver.MyAdmin.Client.Model
{
        ...
        public partial class InlineResponse20024 :  IEquatable<InlineResponse20024>, IValidatableObject
    {
        ...
        public InlineResponse20024(bool? success = default(bool?), string text = default(string))
        {
            // to ensure "success" is required (not null)
            if (success == null)
            {
                throw new InvalidDataException("success is a required property for InlineResponse20024 and cannot be null");
            }
            else
            {
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for InlineResponse20024 and cannot be null");
            }
            else
            {
                this.text = text;
