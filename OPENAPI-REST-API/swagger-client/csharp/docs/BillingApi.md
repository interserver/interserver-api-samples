...
namespace Example
{
    public class GetAffiliateDownloadExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            var apiInstance = new BillingApi();
            var st = st_example;  // string | Filter by status. (optional) 
            var ex = ex_example;  // string | Export format: csv, xls, xlsx, or pdf. Defaults to csv. (optional) 
            var year = 56;  // int? | Year to filter the report. Defaults to the current year. (optional) 
            ...
            {
                Debug.Print("Exception when calling BillingApi.GetAffiliateDownload: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetAffiliateSignupsExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            var apiInstance = new BillingApi();
            var st = st_example;  // string | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results. (optional) 
            ...
            {
                Debug.Print("Exception when calling BillingApi.GetAffiliateSignups: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class PatchBillingCreditCardVerifyExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            var apiInstance = new BillingApi();
            var body = new IdVerifyBody(); // IdVerifyBody | 
            var id = 56;  // int? | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
            ...
            {
                Debug.Print("Exception when calling BillingApi.PatchBillingCreditCardVerify: " + e.Message );
            }
        }
    }
}
