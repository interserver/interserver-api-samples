# Interserver.MyAdmin.Client.Model.SslOrderRequest
## Properties
...
**csr_type** | **string** | Whether the CSR is server-generated or customer-provided. | [optional] [default to CsrTypeEnum.Generated]
