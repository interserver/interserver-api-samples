...
# **DownloadVpsBackup**
> InlineResponse20012 DownloadVpsBackup (IdBackupsBody2 body, int? id, string all = null)
...
namespace Example
{
    public class DownloadVpsBackupExample
    {
        public void main()
        {
            ...
            {
                // Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
                InlineResponse20012 result = apiInstance.DownloadVpsBackup(body, id, all);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class GetVpsBackupExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            {
                // Trigger a manual on-demand snapshot/backup of the VPS
                QueueResponse result = apiInstance.GetVpsBackup(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling VPSApi.GetVpsBackup: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetVpsChangeHostnameExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            {
                Debug.Print("Exception when calling VPSApi.GetVpsChangeHostname: " + e.Message );
            }
        }
    }
}
...
[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)
<a name="getvpschangerootpassword"></a>
...
namespace Example
{
    public class GetVpsChangeRootPasswordExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            {
                Debug.Print("Exception when calling VPSApi.GetVpsChangeRootPassword: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetVpsInsertCdExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            {
                Debug.Print("Exception when calling VPSApi.GetVpsInsertCd: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class GetVpsResetPasswordExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            {
                Debug.Print("Exception when calling VPSApi.GetVpsResetPassword: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class PostVpsTrafficUsageExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            {
                Debug.Print("Exception when calling VPSApi.PostVpsTrafficUsage: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class PutVpsBuyHdSpaceExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            {
                Debug.Print("Exception when calling VPSApi.PutVpsBuyHdSpace: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class VPSCancelExample
    {
        public void main()
        {
            ...
            {
                // Cancel a VPS service at the end of the current billing cycle
                InlineResponse20024 result = apiInstance.VPSCancel(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
