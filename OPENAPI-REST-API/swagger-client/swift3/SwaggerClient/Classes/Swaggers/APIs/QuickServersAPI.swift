...
open class QuickServersAPI: APIBase {
     ...
     */
    open class func addQs(body: QsOrderRequest, completion: @escaping ((_ data: ServiceOrderPostResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "queueId" : 14670065
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func downloadQsBackup(body: IdBackupsBody, id: Int32, all: All_downloadQsBackup? = nil, completion: @escaping ((_ data: InlineResponse20012?, _ error: ErrorResponse?) -> Void)) {
  ...
  "url" : "url"
     ...
     */
    open class func downloadQsBackupWithRequestBuilder(body: IdBackupsBody, id: Int32, all: All_downloadQsBackup? = nil) -> RequestBuilder<InlineResponse20012> {
        var path = "/qs/{id}/backups"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func downloadQsBackup(file: String, id: Int32, all: All_downloadQsBackup? = nil, completion: @escaping ((_ data: InlineResponse20012?, _ error: ErrorResponse?) -> Void)) {
  ...
  "url" : "url"
     ...
     - returns: RequestBuilder<InlineResponse20012> 
     */
    open class func downloadQsBackupWithRequestBuilder(file: String, id: Int32, all: All_downloadQsBackup? = nil) -> RequestBuilder<InlineResponse20012> {
        var path = "/qs/{id}/backups"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
  ...
  "version" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getQsBackup(id: Int32, completion: @escaping ((_ data: QueueResponse?, _ error: ErrorResponse?) -> Void)) {
        getQsBackupWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "queueId" : 14670065
     ...
     - returns: RequestBuilder<QueueResponse> 
     */
    open class func getQsBackupWithRequestBuilder(id: Int32) -> RequestBuilder<QueueResponse> {
  ...
  "queueId" : 14670065
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func putQs(body: QsOrderRequest, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func quickserversCancel(id: Int32, completion: @escaping ((_ data: InlineResponse20011?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Rapid Deploy Servers is canceled."
     ...
     */
    open class func quickserversCancelWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse20011> {
        var path = "/qs/{id}"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
