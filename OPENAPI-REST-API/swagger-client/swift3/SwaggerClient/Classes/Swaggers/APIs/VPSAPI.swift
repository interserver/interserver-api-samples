...
open class VPSAPI: APIBase {
  ...
  "queueId" : 14670065
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func downloadVpsBackup(body: IdBackupsBody2, id: Int32, all: All_downloadVpsBackup? = nil, completion: @escaping ((_ data: InlineResponse20012?, _ error: ErrorResponse?) -> Void)) {
  ...
  "url" : "url"
     ...
     */
    open class func downloadVpsBackupWithRequestBuilder(body: IdBackupsBody2, id: Int32, all: All_downloadVpsBackup? = nil) -> RequestBuilder<InlineResponse20012> {
        var path = "/vps/{id}/backups"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func downloadVpsBackup(file: String, id: Int32, all: All_downloadVpsBackup? = nil, completion: @escaping ((_ data: InlineResponse20012?, _ error: ErrorResponse?) -> Void)) {
  ...
  "url" : "url"
     ...
     - returns: RequestBuilder<InlineResponse20012> 
     */
    open class func downloadVpsBackupWithRequestBuilder(file: String, id: Int32, all: All_downloadVpsBackup? = nil) -> RequestBuilder<InlineResponse20012> {
        var path = "/vps/{id}/backups"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
  ...
  "vpsSliceVmwareCost" : 10
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVpsBackup(id: Int32, completion: @escaping ((_ data: QueueResponse?, _ error: ErrorResponse?) -> Void)) {
        getVpsBackupWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "queueId" : 14670065
     ...
     - returns: RequestBuilder<QueueResponse> 
     */
    open class func getVpsBackupWithRequestBuilder(id: Int32) -> RequestBuilder<QueueResponse> {
  ...
  "date" : 1632968243
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVpsChangeHostname(id: Int32, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
        getVpsChangeHostnameWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(error)
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func getVpsChangeHostnameWithRequestBuilder(id: Int32) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVpsChangeRootPassword(id: Int32, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
        getVpsChangeRootPasswordWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(error)
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func getVpsChangeRootPasswordWithRequestBuilder(id: Int32) -> RequestBuilder<Void> {
  ...
  "da_link" : 1
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVpsInsertCd(id: Int32, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
        getVpsInsertCdWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(error)
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func getVpsInsertCdWithRequestBuilder(id: Int32) -> RequestBuilder<Void> {
  ...
  "templates" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getVpsResetPassword(id: Int32, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
        getVpsResetPasswordWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(error)
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func getVpsResetPasswordWithRequestBuilder(id: Int32) -> RequestBuilder<Void> {
  ...
  "queueId" : 14670065
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postVpsTrafficUsage(id: Int32, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
        postVpsTrafficUsageWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(error)
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func postVpsTrafficUsageWithRequestBuilder(id: Int32) -> RequestBuilder<Void> {
        var path = "/vps/{id}/traffic_usage"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
  ...
  "rootpass" : "string"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func putVpsBuyHdSpace(id: Int32, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
        putVpsBuyHdSpaceWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(error)
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func putVpsBuyHdSpaceWithRequestBuilder(id: Int32) -> RequestBuilder<Void> {
        var path = "/vps/{id}/buy_hd_space"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
  ...
  "text" : "Ok"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func vPSCancel(id: Int32, completion: @escaping ((_ data: InlineResponse20024?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "VPS is canceled."
     ...
     */
    open class func vPSCancelWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse20024> {
        var path = "/vps/{id}"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
