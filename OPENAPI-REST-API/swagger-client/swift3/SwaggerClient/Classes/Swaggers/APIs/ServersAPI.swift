...
open class ServersAPI: APIBase {
     ...
     */
    open class func addServer(body: ServerOrderPostRequest, completion: @escaping ((_ data: InlineResponse20021?, _ error: ErrorResponse?) -> Void)) {
  ...
  "order" : 6
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func buyItNowServerOrder(completion: @escaping ((_ data: InlineResponse20029?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "You were successfull."
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func serverBulkIpmiPowerGet(ids: String, completion: @escaping ((_ data: ServerBulkIpmiPowerResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "You were successfull."
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func serversCancel(id: Int32, completion: @escaping ((_ data: InlineResponse20022?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Servers is canceled."
     ...
     */
    open class func serversCancelWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse20022> {
        var path = "/servers/{id}"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
