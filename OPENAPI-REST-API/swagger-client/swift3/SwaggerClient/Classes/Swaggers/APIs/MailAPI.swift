...
open class MailAPI: APIBase {
     ...
     */
    open class func addMail(body: MailOrderRequest, completion: @escaping ((_ data: ServiceOrderPostResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Ok"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteMailAlert(body: IdAlertsBody, id: Int32, completion: @escaping ((_ data: SuccessTextResponse?, _ error: ErrorResponse?) -> Void)) {
        deleteMailAlertWithRequestBuilder(body: body, id: id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "Ok"
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func deleteMailAlertWithRequestBuilder(body: IdAlertsBody, id: Int32) -> RequestBuilder<SuccessTextResponse> {
        var path = "/mail/{id}/alerts"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteMailAlert(alertId: Int32, id: Int32, completion: @escaping ((_ data: SuccessTextResponse?, _ error: ErrorResponse?) -> Void)) {
        deleteMailAlertWithRequestBuilder(alertId: alertId, id: id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "Ok"
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func deleteMailAlertWithRequestBuilder(alertId: Int32, id: Int32) -> RequestBuilder<SuccessTextResponse> {
        var path = "/mail/{id}/alerts"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
  ...
  "volume" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func mailCancel(id: Int32, completion: @escaping ((_ data: InlineResponse2009?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Mail is canceled."
     ...
     */
    open class func mailCancelWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse2009> {
        var path = "/mail/{id}"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
  ...
  "text" : "Ok"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func putMail(body: MailOrderRequest, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Ok"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateRule(body: DenyRuleNew, id: Int32, rule: String, completion: @escaping ((_ data: GenericResponse?, _ error: ErrorResponse?) -> Void)) {
        updateRuleWithRequestBuilder(body: body, id: id, rule: rule).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "The command completed successfully."
     ...
     - returns: RequestBuilder<GenericResponse> 
     */
    open class func updateRuleWithRequestBuilder(body: DenyRuleNew, id: Int32, rule: String) -> RequestBuilder<GenericResponse> {
        var path = "/mail/{id}/rules/{rule}"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateRule(user: String, type: ModelType_updateRule, data: String, id: Int32, rule: String, completion: @escaping ((_ data: GenericResponse?, _ error: ErrorResponse?) -> Void)) {
        updateRuleWithRequestBuilder(user: user, type: type, data: data, id: id, rule: rule).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "The command completed successfully."
     ...
     - returns: RequestBuilder<GenericResponse> 
     */
    open class func updateRuleWithRequestBuilder(user: String, type: ModelType_updateRule, data: String, id: Int32, rule: String) -> RequestBuilder<GenericResponse> {
        var path = "/mail/{id}/rules/{rule}"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
