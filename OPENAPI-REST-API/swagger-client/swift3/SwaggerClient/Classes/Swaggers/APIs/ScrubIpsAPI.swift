...
open class ScrubIpsAPI: APIBase {
     ...
     */
    open class func cancelScrubIp(id: Int32, completion: @escaping ((_ data: InlineResponse20014?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Scrub Ips is canceled."
     ...
     */
    open class func cancelScrubIpWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse20014> {
  ...
  "text" : "New firewall Rule has been created."
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteFilter(body: CreateFilter, id: Int32, completion: @escaping ((_ data: InlineResponse20018?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Filter is deleted."
     ...
     */
    open class func deleteFilterWithRequestBuilder(body: CreateFilter, id: Int32) -> RequestBuilder<InlineResponse20018> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func disableScrub(id: Int32, completion: @escaping ((_ data: InlineResponse20016?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Scrub is disabled on your IP."
     ...
     */
    open class func disableScrubWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse20016> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func enableScrub(id: Int32, completion: @escaping ((_ data: InlineResponse20015?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Scrub is enabled on your IP."
     ...
     */
    open class func enableScrubWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse20015> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getOrderDetail(completion: @escaping ((_ data: InlineResponse20019?, _ error: ErrorResponse?) -> Void)) {
  ...
  "ips" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getScrubIpDetails(id: Int32, completion: @escaping ((_ data: InlineResponse20013?, _ error: ErrorResponse?) -> Void)) {
  ...
  "filter_firewall" : {
     ...
     */
    open class func getScrubIpDetailsWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse20013> {
        var path = "/scrub_ips/{id}"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
  ...
  "order_details" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func putScrubIps(body: ScrubIpPlaceOrder, completion: @escaping ((_ data: InlineResponse20020?, _ error: ErrorResponse?) -> Void)) {
  ...
  "errors" : [ "errors", "errors" ]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func scrubIpsDeleteGeoRule(body: DeleteGeoFirewallRule, id: Int32, completion: @escaping ((_ data: InlineResponse20017?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Firewall Rule has been deleted."
     ...
     */
    open class func scrubIpsDeleteGeoRuleWithRequestBuilder(body: DeleteGeoFirewallRule, id: Int32) -> RequestBuilder<InlineResponse20017> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func scrubIpsDeleteRule(body: DeleteFirewallRule, id: Int32, completion: @escaping ((_ data: InlineResponse20017?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Firewall Rule has been deleted."
     ...
     - returns: RequestBuilder<InlineResponse20017> 
     */
    open class func scrubIpsDeleteRuleWithRequestBuilder(body: DeleteFirewallRule, id: Int32) -> RequestBuilder<InlineResponse20017> {
