...
open class DomainsAPI: APIBase {
     ...
     */
    open class func addDomain(body: [String:Any], completion: @escaping ((_ data: ServiceOrderPostResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "You were successfull."
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func cancelDomain(id: Int32, completion: @escaping ((_ data: InlineResponse2003?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Domains is canceled."
     ...
     */
    open class func cancelDomainWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse2003> {
        var path = "/domains/{id}"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteDomainDnssec(id: Int32, completion: @escaping ((_ data: SuccessTextResponse?, _ error: ErrorResponse?) -> Void)) {
        deleteDomainDnssecWithRequestBuilder(id: id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "Ok"
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func deleteDomainDnssecWithRequestBuilder(id: Int32) -> RequestBuilder<SuccessTextResponse> {
        var path = "/domains/{id}/dnssec"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
  ...
  "tldServices" : { }
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchDomains(body: [String:Any], completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Ok"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postDomainSearch(name: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Ok"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func putDomains(body: [String:Any], completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Ok"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateDomainInfo(id: Int32, completion: @escaping ((_ data: SuccessTextResponse?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Ok"
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func updateDomainInfoWithRequestBuilder(id: Int32) -> RequestBuilder<SuccessTextResponse> {
        var path = "/domains/{id}"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
