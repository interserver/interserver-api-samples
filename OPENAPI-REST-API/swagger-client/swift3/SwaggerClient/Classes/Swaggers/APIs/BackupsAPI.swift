...
open class BackupsAPI: APIBase {
  ...
  "cj_params" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func cancelBackup(id: Int32, completion: @escaping ((_ data: InlineResponse2002?, _ error: ErrorResponse?) -> Void)) {
  ...
  "text" : "Backups is canceled."
     ...
     */
    open class func cancelBackupWithRequestBuilder(id: Int32) -> RequestBuilder<InlineResponse2002> {
        var path = "/backups/{id}"
        let idPreEscape = "\(id)"
