...
open class PublicAPI: APIBase {
     ...
     */
    open class func getAccountCurrencies(completion: @escaping ((_ data: [String]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAccountLocales(completion: @escaping ((_ data: [String:InlineResponseMap200]?, _ error: ErrorResponse?) -> Void)) {
  ...
  "ips" : "1 Vlan Ip (/30)"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getOauthRedirect(provider: String, completion: @escaping ((_ data: InlineResponse2006?, _ error: ErrorResponse?) -> Void)) {
  ...
  "redirect_url" : "redirect_url"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchOauthTwoFactor(body: OauthBody2, completion: @escaping ((_ data: InlineResponse2008?, _ error: ErrorResponse?) -> Void)) {
  ...
  "login" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchOauthTwoFactor(accountId: Int32, code: String, completion: @escaping ((_ data: InlineResponse2008?, _ error: ErrorResponse?) -> Void)) {
  ...
  "login" : true
     ...
     - returns: RequestBuilder<InlineResponse2008> 
     */
    open class func patchOauthTwoFactorWithRequestBuilder(accountId: Int32, code: String) -> RequestBuilder<InlineResponse2008> {
        let path = "/oauth"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = body.encodeToJSON()
        var url = URLComponents(string: URLString)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postOauthCallback(provider: String, body: OauthBody? = nil, completion: @escaping ((_ data: InlineResponse2007?, _ error: ErrorResponse?) -> Void)) {
  ...
  "linked" : true
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postOauthCallback(provider: String, provider2: String? = nil, completion: @escaping ((_ data: InlineResponse2007?, _ error: ErrorResponse?) -> Void)) {
