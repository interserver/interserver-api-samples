...
open class BillingAPI: APIBase {
  ...
  "height" : "125"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAffiliateDownload(st: String? = nil, ex: Ex_getAffiliateDownload? = nil, year: Int32? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
     ...
     */
    open class func getAffiliateDownloadWithRequestBuilder(st: String? = nil, ex: Ex_getAffiliateDownload? = nil, year: Int32? = nil) -> RequestBuilder<Void> {
  ...
  "default" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAffiliateSignups(st: String? = nil, completion: @escaping ((_ data: InlineResponse2001?, _ error: ErrorResponse?) -> Void)) {
  ...
  "rows" : [ { }, { } ]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func initiatePayment(method: Method_initiatePayment, invoices: String, completion: @escaping ((_ data: InlineResponse20010?, _ error: ErrorResponse?) -> Void)) {
  ...
  "items" : { }
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchBillingCreditCardVerify(body: IdVerifyBody, id: Int32, completion: @escaping ((_ data: SuccessTextResponse?, _ error: ErrorResponse?) -> Void)) {
        patchBillingCreditCardVerifyWithRequestBuilder(body: body, id: id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "Ok"
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func patchBillingCreditCardVerifyWithRequestBuilder(body: IdVerifyBody, id: Int32) -> RequestBuilder<SuccessTextResponse> {
        var path = "/billing/creditcards/{id}/verify"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchBillingCreditCardVerify(ccCcv2: String, id: Int32, completion: @escaping ((_ data: SuccessTextResponse?, _ error: ErrorResponse?) -> Void)) {
        patchBillingCreditCardVerifyWithRequestBuilder(ccCcv2: ccCcv2, id: id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "Ok"
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func patchBillingCreditCardVerifyWithRequestBuilder(ccCcv2: String, id: Int32) -> RequestBuilder<SuccessTextResponse> {
        var path = "/billing/creditcards/{id}/verify"
        let idPreEscape = "\(id)"
        let idPostEscape = idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: idPostEscape, options: .literal, range: nil)
