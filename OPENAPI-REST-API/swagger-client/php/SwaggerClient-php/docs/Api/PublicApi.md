# InterserverApiClient\PublicApi
...
$apiInstance = new InterserverApiClient\Api\PublicApi(
...
try {
    $result = $apiInstance->getAccountCurrencies();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PublicApi->getAccountCurrencies: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getAccountLocales**
> map[string,\InterserverApiClient\Model\InlineResponseMap200] getAccountLocales()
...
try {
    $result = $apiInstance->getAccountLocales();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PublicApi->getAccountLocales: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**map[string,\InterserverApiClient\Model\InlineResponseMap200]**](../Model/InlineResponseMap200.md)
...
# **getCaptcha**
> \InterserverApiClient\Model\CaptchaResponse getCaptcha()
...
[**\InterserverApiClient\Model\CaptchaResponse**](../Model/CaptchaResponse.md)
...
# **getInfo**
> \InterserverApiClient\Model\ServicesInfo getInfo()
...
[**\InterserverApiClient\Model\ServicesInfo**](../Model/ServicesInfo.md)
...
# **getLoginInfo**
> \InterserverApiClient\Model\LoginInfo getLoginInfo()
...
[**\InterserverApiClient\Model\LoginInfo**](../Model/LoginInfo.md)
...
# **getOauthRedirect**
> \InterserverApiClient\Model\InlineResponse2006 getOauthRedirect($provider)
...
[**\InterserverApiClient\Model\InlineResponse2006**](../Model/InlineResponse2006.md)
...
# **patchOauthTwoFactor**
> \InterserverApiClient\Model\InlineResponse2008 patchOauthTwoFactor($body)
...
$body = new \InterserverApiClient\Model\OauthBody2(); // \InterserverApiClient\Model\OauthBody2 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\OauthBody2**](../Model/OauthBody2.md)|  |

### Return type

[**\InterserverApiClient\Model\InlineResponse2008**](../Model/InlineResponse2008.md)
...
# **patchOauthTwoFactor**
> \InterserverApiClient\Model\InlineResponse2008 patchOauthTwoFactor($account_id, $code)
...
try {
    $result = $apiInstance->patchOauthTwoFactor($account_id, $code);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PublicApi->patchOauthTwoFactor: ', $e->getMessage(), PHP_EOL;
}
...
# **postOauthCallback**
> \InterserverApiClient\Model\InlineResponse2007 postOauthCallback($provider, $body)
...
$provider = "provider_example"; // string | The OAuth provider name (e.g. `Google`).
$body = new \InterserverApiClient\Model\OauthBody(); // \InterserverApiClient\Model\OauthBody | 
...
------------- | ------------- | ------------- | -------------
 **provider** | **string**| The OAuth provider name (e.g. &#x60;Google&#x60;). |
 **body** | [**\InterserverApiClient\Model\OauthBody**](../Model/OauthBody.md)|  | [optional]

### Return type

[**\InterserverApiClient\Model\InlineResponse2007**](../Model/InlineResponse2007.md)
...
# **postOauthCallback**
> \InterserverApiClient\Model\InlineResponse2007 postOauthCallback($provider, $provider2)
...
# **submitLogin**
> \InterserverApiClient\Model\LoginSuccessResponse submitLogin($login, $passwd, $remember, $g_recaptcha_response, $tfa)
...
$g_recaptcha_response = new \InterserverApiClient\Model\LoginSubmissionExampleGrecaptcharesponse(); // \InterserverApiClient\Model\LoginSubmissionExampleGrecaptcharesponse | 
 ...
 **passwd** | **string**|  |
 **remember** | **string**|  |
 **g_recaptcha_response** | [**\InterserverApiClient\Model\LoginSubmissionExampleGrecaptcharesponse**](../Model/.md)|  |
 **tfa** | **string**|  |

### Return type

[**\InterserverApiClient\Model\LoginSuccessResponse**](../Model/LoginSuccessResponse.md)
...
# **submitLogin**
> \InterserverApiClient\Model\LoginSuccessResponse submitLogin($body)
...
$body = new \InterserverApiClient\Model\LoginSubmissionExample(); // \InterserverApiClient\Model\LoginSubmissionExample | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\LoginSubmissionExample**](../Model/LoginSubmissionExample.md)|  |
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\LoginSubmissionExample**](../Model/LoginSubmissionExample.md)|  | [optional]
