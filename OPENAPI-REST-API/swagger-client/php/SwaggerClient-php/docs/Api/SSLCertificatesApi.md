...
# **addSsl**
> \InterserverApiClient\Model\ServiceOrderPostResponse addSsl($body)
...
$apiInstance = new InterserverApiClient\Api\SSLCertificatesApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \InterserverApiClient\Model\SslOrderRequest(); // \InterserverApiClient\Model\SslOrderRequest | 

try {
    $result = $apiInstance->addSsl($body);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\SslOrderRequest**](../Model/SslOrderRequest.md)|  |
...
# **getSslInvoices**
> \InterserverApiClient\Model\ChargeInvoiceRows getSslInvoices($id)
...
# **getSslWelcomeEmail**
> \InterserverApiClient\Model\SuccessTextResponse getSslWelcomeEmail($id)
...
# **sslCancel**
> \InterserverApiClient\Model\InlineResponse20023 sslCancel($id)
...
[**\InterserverApiClient\Model\InlineResponse20023**](../Model/InlineResponse20023.md)
...
# **updateSslInfo**
> \InterserverApiClient\Model\SuccessTextResponse updateSslInfo($id)
