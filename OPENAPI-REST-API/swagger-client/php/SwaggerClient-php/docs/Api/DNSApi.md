...
# **addDnsDomain**
> \InterserverApiClient\Model\SuccessTextResponse addDnsDomain($domain, $ip)
...
$apiInstance = new InterserverApiClient\Api\DNSApi(
...
# **addDnsDomain**
> \InterserverApiClient\Model\SuccessTextResponse addDnsDomain($body)
...
$body = new \InterserverApiClient\Model\DnsNewDomain(); // \InterserverApiClient\Model\DnsNewDomain | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\DnsNewDomain**](../Model/DnsNewDomain.md)|  |
...
$type = new \InterserverApiClient\Model\DnsRecordType(); // \InterserverApiClient\Model\DnsRecordType | 
...
------------- | ------------- | ------------- | -------------
 **name** | **string**|  |
 **type** | [**\InterserverApiClient\Model\DnsRecordType**](../Model/.md)|  |
 **content** | **string**|  |
 **ttl** | **int**|  |
 **prio** | **int**|  |
...
$body = new \InterserverApiClient\Model\DnsNewRecord(); // \InterserverApiClient\Model\DnsNewRecord | 
$id = "id_example"; // string | The DNS Domain ID.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\DnsNewRecord**](../Model/DnsNewRecord.md)|  |
 **id** | **string**| The DNS Domain ID. |
...
# **deleteDnsDomain**
> \InterserverApiClient\Model\SuccessTextResponse deleteDnsDomain($id)
...
# **deleteDnsRecord**
> \InterserverApiClient\Model\SuccessTextResponse deleteDnsRecord($domain_id, $record_id)
...
# **getDnsDomain**
> \InterserverApiClient\Model\DnsRecord[] getDnsDomain($id)
...
[**\InterserverApiClient\Model\DnsRecord[]**](../Model/DnsRecord.md)
...
# **getDnsList**
> \InterserverApiClient\Model\DnsListItem[] getDnsList()
...
[**\InterserverApiClient\Model\DnsListItem[]**](../Model/DnsListItem.md)
...
# **updateDnsRecord**
> \InterserverApiClient\Model\SuccessTextResponse updateDnsRecord($name, $type, $content, $ttl, $prio, $disabled, $ordername, $auth, $domain_id, $record_id)
...
try {
    $result = $apiInstance->updateDnsRecord($name, $type, $content, $ttl, $prio, $disabled, $ordername, $auth, $domain_id, $record_id);
    print_r($result);
} catch (Exception $e) {
...
# **updateDnsRecord**
> \InterserverApiClient\Model\SuccessTextResponse updateDnsRecord($body, $domain_id, $record_id)
...
$body = new \InterserverApiClient\Model\DnsUpdateRecord(); // \InterserverApiClient\Model\DnsUpdateRecord | The request data to update a dns record.
$domain_id = 56; // int | The DNS domain ID. Use the `id` from `GET /dns` to identify the domain.
$record_id = 56; // int | The DNS record ID within the domain. Use the record `id` from `GET /dns/{id}` to identify the record.

try {
    $result = $apiInstance->updateDnsRecord($body, $domain_id, $record_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DNSApi->updateDnsRecord: ', $e->getMessage(), PHP_EOL;
}
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\DnsUpdateRecord**](../Model/DnsUpdateRecord.md)| The request data to update a dns record. |
 **domain_id** | **int**| The DNS domain ID. Use the &#x60;id&#x60; from &#x60;GET /dns&#x60; to identify the domain. |
 **record_id** | **int**| The DNS record ID within the domain. Use the record &#x60;id&#x60; from &#x60;GET /dns/{id}&#x60; to identify the record. |
