...
# **addServer**
> \InterserverApiClient\Model\InlineResponse20021 addServer($body)
...
$apiInstance = new InterserverApiClient\Api\ServersApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \InterserverApiClient\Model\ServerOrderPostRequest(); // \InterserverApiClient\Model\ServerOrderPostRequest | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\ServerOrderPostRequest**](../Model/ServerOrderPostRequest.md)|  |

### Return type

[**\InterserverApiClient\Model\InlineResponse20021**](../Model/InlineResponse20021.md)
...
# **buyItNowServerOrder**
> \InterserverApiClient\Model\InlineResponse20029 buyItNowServerOrder()
...
[**\InterserverApiClient\Model\InlineResponse20029**](../Model/InlineResponse20029.md)
...
# **getMPServers**
> \InterserverApiClient\Model\BuyItNowList getMPServers()
...
[**\InterserverApiClient\Model\BuyItNowList**](../Model/BuyItNowList.md)
...
# **getNewServer**
> \InterserverApiClient\Model\ServerOrder getNewServer()
...
[**\InterserverApiClient\Model\ServerOrder**](../Model/ServerOrder.md)
...
# **getServerInfo**
> \InterserverApiClient\Model\Server getServerInfo($id)
...
[**\InterserverApiClient\Model\Server**](../Model/Server.md)
...
# **getServerInvoices**
> \InterserverApiClient\Model\ChargeInvoiceRows getServerInvoices($id)
...
# **getServerList**
> \InterserverApiClient\Model\ServerRow[] getServerList()
...
[**\InterserverApiClient\Model\ServerRow[]**](../Model/ServerRow.md)
...
# **getServerReverseDns**
> \InterserverApiClient\Model\ReverseDnsEntries getServerReverseDns($id)
...
> \InterserverApiClient\Model\SuccessTextResponse getServersWelcomeEmail($id)
...
# **placeBuyNowServer**
> \InterserverApiClient\Model\ServersBuyNowResponse placeBuyNowServer($body)
...
$body = new \InterserverApiClient\Model\OrderBuyNowServerBody(); // \InterserverApiClient\Model\OrderBuyNowServerBody | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\OrderBuyNowServerBody**](../Model/OrderBuyNowServerBody.md)|  | [optional]

### Return type

[**\InterserverApiClient\Model\ServersBuyNowResponse**](../Model/ServersBuyNowResponse.md)
...
> \InterserverApiClient\Model\TextResponse postServerReverseDns($body, $id)
...
# **postServerReverseDns**
> \InterserverApiClient\Model\TextResponse postServerReverseDns($ips, $id)
...
> \InterserverApiClient\Model\ServerBulkIpmiPowerResponse serverBulkIpmiPowerGet($ids)
...
[**\InterserverApiClient\Model\ServerBulkIpmiPowerResponse**](../Model/ServerBulkIpmiPowerResponse.md)
...
# **serverIpmiLiveGet**
> \InterserverApiClient\Model\ServerIpmiLiveInfo serverIpmiLiveGet($id)
...
[**\InterserverApiClient\Model\ServerIpmiLiveInfo**](../Model/ServerIpmiLiveInfo.md)
...
# **serverIpmiLivePost**
> \InterserverApiClient\Model\ServerIpmiLiveInfo serverIpmiLivePost($asset, $ip, $id)
...
# **serverIpmiLivePost**
> \InterserverApiClient\Model\ServerIpmiLiveInfo serverIpmiLivePost($body, $id)
...
$body = new \InterserverApiClient\Model\ServerIpmiLiveRequest(); // \InterserverApiClient\Model\ServerIpmiLiveRequest | 
$id = 56; // int | Server ID number
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\ServerIpmiLiveRequest**](../Model/ServerIpmiLiveRequest.md)|  |
 **id** | **int**| Server ID number |
...
# **serverIpmiPowerGet**
> \InterserverApiClient\Model\TextResponse serverIpmiPowerGet($id)
...
# **serverIpmiPowerPost**
> \InterserverApiClient\Model\TextResponse serverIpmiPowerPost($asset, $action, $id)
...
# **serverIpmiPowerPost**
> \InterserverApiClient\Model\TextResponse serverIpmiPowerPost($body, $id)
...
$body = new \InterserverApiClient\Model\ServerIpmiPowerRequest(); // \InterserverApiClient\Model\ServerIpmiPowerRequest | 
$id = 56; // int | Server ID number
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\ServerIpmiPowerRequest**](../Model/ServerIpmiPowerRequest.md)|  |
 **id** | **int**| Server ID number |
...
# **serversCancel**
> \InterserverApiClient\Model\InlineResponse20022 serversCancel($id)
...
[**\InterserverApiClient\Model\InlineResponse20022**](../Model/InlineResponse20022.md)
...
# **updateServerInfo**
> \InterserverApiClient\Model\SuccessTextResponse updateServerInfo($id)
