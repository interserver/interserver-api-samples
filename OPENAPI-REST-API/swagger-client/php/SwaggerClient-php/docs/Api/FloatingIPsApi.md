# InterserverApiClient\FloatingIPsApi
...
# **addFloatingIp**
> \InterserverApiClient\Model\ServiceOrderPostResponse addFloatingIp($body)
...
$apiInstance = new InterserverApiClient\Api\FloatingIPsApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \InterserverApiClient\Model\FloatingIpOrderRequest(); // \InterserverApiClient\Model\FloatingIpOrderRequest | 

try {
    $result = $apiInstance->addFloatingIp($body);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\FloatingIpOrderRequest**](../Model/FloatingIpOrderRequest.md)|  |
...
# **floatingIpsCancel**
> \InterserverApiClient\Model\InlineResponse2004 floatingIpsCancel($id)
...
[**\InterserverApiClient\Model\InlineResponse2004**](../Model/InlineResponse2004.md)
...
> \InterserverApiClient\Model\ChargeInvoiceRows getFloatingIpInvoices($id)
...
> \InterserverApiClient\Model\SuccessTextResponse getFloatingIpsWelcomeEmail($id)
...
> \InterserverApiClient\Model\SuccessTextResponse postFloatingIpsChangeIp($ip, $id)
...
# **postFloatingIpsChangeIp**
> \InterserverApiClient\Model\SuccessTextResponse postFloatingIpsChangeIp($body, $id)
...
> \InterserverApiClient\Model\SuccessTextResponse updateFloatingIpInfo($id)
