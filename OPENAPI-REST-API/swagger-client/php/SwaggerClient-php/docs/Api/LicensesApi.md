# InterserverApiClient\LicensesApi
...
# **addLicense**
> \InterserverApiClient\Model\ServiceOrderPostResponse addLicense($body)
...
$apiInstance = new InterserverApiClient\Api\LicensesApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \InterserverApiClient\Model\LicenseOrderRequest(); // \InterserverApiClient\Model\LicenseOrderRequest | 

try {
    $result = $apiInstance->addLicense($body);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\LicenseOrderRequest**](../Model/LicenseOrderRequest.md)|  |
...
# **getLicenseInfo**
> \InterserverApiClient\Model\License getLicenseInfo($id)
...
[**\InterserverApiClient\Model\License**](../Model/License.md)
...
# **getLicenseInvoices**
> \InterserverApiClient\Model\ChargeInvoiceRows getLicenseInvoices($id)
...
# **getLicenseList**
> \InterserverApiClient\Model\LicenseRow[] getLicenseList()
...
[**\InterserverApiClient\Model\LicenseRow[]**](../Model/LicenseRow.md)
...
> \InterserverApiClient\Model\SuccessTextResponse getLicensesWelcomeEmail($id)
...
# **getNewLicense**
> \InterserverApiClient\Model\LicensesOrder getNewLicense()
...
[**\InterserverApiClient\Model\LicensesOrder**](../Model/LicensesOrder.md)
...
# **licensesCancel**
> \InterserverApiClient\Model\InlineResponse2005 licensesCancel($id)
...
[**\InterserverApiClient\Model\InlineResponse2005**](../Model/InlineResponse2005.md)
...
# **postLicenseChangeIp**
> \InterserverApiClient\Model\SuccessTextResponse postLicenseChangeIp($body, $id)
...
$body = new \InterserverApiClient\Model\IpObject(); // \InterserverApiClient\Model\IpObject | 
$id = 56; // int | The license service ID. Use `license_id` from `GET /licenses`.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\IpObject**](../Model/IpObject.md)|  |
 **id** | **int**| The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;. |
...
# **postLicenseChangeIp**
> \InterserverApiClient\Model\SuccessTextResponse postLicenseChangeIp($ip, $id)
...
# **updateLicenseInfo**
> \InterserverApiClient\Model\SuccessTextResponse updateLicenseInfo($id)
