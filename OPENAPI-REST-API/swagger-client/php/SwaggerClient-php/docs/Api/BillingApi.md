# InterserverApiClient\BillingApi
...
> \InterserverApiClient\Model\SuccessTextResponse addBillingCreditCard($body)
...
$apiInstance = new InterserverApiClient\Api\BillingApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \InterserverApiClient\Model\BillingAddCcRequest(); // \InterserverApiClient\Model\BillingAddCcRequest | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\BillingAddCcRequest**](../Model/BillingAddCcRequest.md)|  |
...
# **addBillingCreditCard**
> \InterserverApiClient\Model\SuccessTextResponse addBillingCreditCard($name, $address, $city, $state, $country, $zip, $cc, $cc_exp, $cc_ccv2)
...
try {
    $result = $apiInstance->addBillingCreditCard($name, $address, $city, $state, $country, $zip, $cc, $cc_exp, $cc_ccv2);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->addBillingCreditCard: ', $e->getMessage(), PHP_EOL;
}
...
# **addBillingPrepay**
> \InterserverApiClient\Model\SuccessTextResponse addBillingPrepay($body)
...
$body = new \InterserverApiClient\Model\BillingPrepayRequest(); // \InterserverApiClient\Model\BillingPrepayRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\BillingPrepayRequest**](../Model/BillingPrepayRequest.md)|  |
...
# **addBillingPrepay**
> \InterserverApiClient\Model\SuccessTextResponse addBillingPrepay($module, $amount, $automatic_use)
...
try {
    $result = $apiInstance->addBillingPrepay($module, $amount, $automatic_use);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->addBillingPrepay: ', $e->getMessage(), PHP_EOL;
}
...
> \InterserverApiClient\Model\SuccessTextResponse deleteBillingCreditCard($id)
...
> \InterserverApiClient\Model\SuccessTextResponse deleteBillingInvoice($id)
...
# **deleteBillingPrepay**
> \InterserverApiClient\Model\SuccessTextResponse deleteBillingPrepay($id)
...
# **getAffiliateBanners**
> \InterserverApiClient\Model\AffiliateBannerRow[] getAffiliateBanners()
...
[**\InterserverApiClient\Model\AffiliateBannerRow[]**](../Model/AffiliateBannerRow.md)
...
> getAffiliateDownload($st, $ex, $year)
...
$year = 56; // int | Year to filter the report. Defaults to the current year.

try {
    $apiInstance->getAffiliateDownload($st, $ex, $year);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->getAffiliateDownload: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \InterserverApiClient\Model\TextResponse getAffiliateRichReport()
...
> \InterserverApiClient\Model\StatusMonthlyBreakdown getAffiliateSalesGraph($days)
...
[**\InterserverApiClient\Model\StatusMonthlyBreakdown**](../Model/StatusMonthlyBreakdown.md)
...
# **getAffiliateSignups**
> \InterserverApiClient\Model\InlineResponse2001 getAffiliateSignups($st)
...
try {
    $result = $apiInstance->getAffiliateSignups($st);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->getAffiliateSignups: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\InterserverApiClient\Model\InlineResponse2001**](../Model/InlineResponse2001.md)
...
> \InterserverApiClient\Model\MonthlyCounts getAffiliateTrafficGraph($days)
...
[**\InterserverApiClient\Model\MonthlyCounts**](../Model/MonthlyCounts.md)
...
> \InterserverApiClient\Model\AffiliateTrafficRow[] getAffiliateWebTraffic()
...
[**\InterserverApiClient\Model\AffiliateTrafficRow[]**](../Model/AffiliateTrafficRow.md)
...
> \InterserverApiClient\Model\SuccessTextResponse getBillingCreditCardVerify($id)
...
# **getBillingInvoice**
> \InterserverApiClient\Model\BillingInvoiceDetail getBillingInvoice($id)
...
[**\InterserverApiClient\Model\BillingInvoiceDetail**](../Model/BillingInvoiceDetail.md)
...
# **getBillingInvoices**
> \InterserverApiClient\Model\BillingInvoiceList getBillingInvoices()
...
[**\InterserverApiClient\Model\BillingInvoiceList**](../Model/BillingInvoiceList.md)
...
# **initiatePayment**
> \InterserverApiClient\Model\InlineResponse20010 initiatePayment($method, $invoices)
...
[**\InterserverApiClient\Model\InlineResponse20010**](../Model/InlineResponse20010.md)
...
> \InterserverApiClient\Model\SuccessTextResponse patchBillingCreditCardVerify($body, $id)
...
$body = new \InterserverApiClient\Model\IdVerifyBody(); // \InterserverApiClient\Model\IdVerifyBody | 
$id = 56; // int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.

try {
    $result = $apiInstance->patchBillingCreditCardVerify($body, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->patchBillingCreditCardVerify: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\IdVerifyBody**](../Model/IdVerifyBody.md)|  |
 **id** | **int**| The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. |
...
# **patchBillingCreditCardVerify**
> \InterserverApiClient\Model\SuccessTextResponse patchBillingCreditCardVerify($cc_ccv2, $id)
...
try {
    $result = $apiInstance->patchBillingCreditCardVerify($cc_ccv2, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->patchBillingCreditCardVerify: ', $e->getMessage(), PHP_EOL;
}
...
> \InterserverApiClient\Model\SuccessTextResponse postBillingCreditCardVerify($body, $id)
...
$body = new \InterserverApiClient\Model\BillingVerifyCcRequest(); // \InterserverApiClient\Model\BillingVerifyCcRequest | 
$id = 56; // int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\BillingVerifyCcRequest**](../Model/BillingVerifyCcRequest.md)|  |
 **id** | **int**| The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. |
...
# **postBillingCreditCardVerify**
> \InterserverApiClient\Model\SuccessTextResponse postBillingCreditCardVerify($idx, $cc_ccv2, $cc_amount1, $cc_amount2, $terms, $id)
...
try {
    $result = $apiInstance->postBillingCreditCardVerify($idx, $cc_ccv2, $cc_amount1, $cc_amount2, $terms, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->postBillingCreditCardVerify: ', $e->getMessage(), PHP_EOL;
}
...
> \InterserverApiClient\Model\TextResponse updateAffiliateDockSetup($affiliate_dock_title, $affiliate_dock_description, $referrer_coupon)
...
# **updateAffiliateDockSetup**
> \InterserverApiClient\Model\TextResponse updateAffiliateDockSetup($body)
...
$body = new \InterserverApiClient\Model\AffiliateDockSetup(); // \InterserverApiClient\Model\AffiliateDockSetup | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\AffiliateDockSetup**](../Model/AffiliateDockSetup.md)|  |
...
> \InterserverApiClient\Model\TextResponse updateAffiliatePaymentSetup($affiliate_paypal, $affiliate_payment_method)
...
# **updateAffiliatePaymentSetup**
> \InterserverApiClient\Model\TextResponse updateAffiliatePaymentSetup($body)
...
$body = new \InterserverApiClient\Model\AffiliatePaymentSetup(); // \InterserverApiClient\Model\AffiliatePaymentSetup | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\AffiliatePaymentSetup**](../Model/AffiliatePaymentSetup.md)|  |
...
> \InterserverApiClient\Model\SuccessTextResponse updateBillingCreditCard($id)
...
> \InterserverApiClient\Model\SuccessTextResponse updateBillingPaymentMethod($body)
...
$body = new \InterserverApiClient\Model\BillingPaymentMethodRequest(); // \InterserverApiClient\Model\BillingPaymentMethodRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\BillingPaymentMethodRequest**](../Model/BillingPaymentMethodRequest.md)|  |
...
# **updateBillingPaymentMethod**
> \InterserverApiClient\Model\SuccessTextResponse updateBillingPaymentMethod($payment_method, $cc_auto)
...
try {
    $result = $apiInstance->updateBillingPaymentMethod($payment_method, $cc_auto);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateBillingPaymentMethod: ', $e->getMessage(), PHP_EOL;
}
