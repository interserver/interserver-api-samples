...
# **addDomain**
> \InterserverApiClient\Model\ServiceOrderPostResponse addDomain($body)
...
$apiInstance = new InterserverApiClient\Api\DomainsApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \InterserverApiClient\Model\map(); // map[string,object] | 
...
# **addDomainDnssec**
> \InterserverApiClient\Model\SuccessTextResponse addDomainDnssec($body, $id)
...
$body = new \InterserverApiClient\Model\DomainDnssecRequest(); // \InterserverApiClient\Model\DomainDnssecRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\DomainDnssecRequest**](../Model/DomainDnssecRequest.md)|  |
...
# **addDomainDnssec**
> \InterserverApiClient\Model\SuccessTextResponse addDomainDnssec($algorithm, $digest_type, $digest, $key_tag, $id)
...
$digest_type = array(56); // int[] | 
$digest = array("digest_example"); // string[] | 
$key_tag = array(56); // int[] | 
$id = 56; // int | The domain service ID. Use `domain_id` from `GET /domains`.

try {
    $result = $apiInstance->addDomainDnssec($algorithm, $digest_type, $digest, $key_tag, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DomainsApi->addDomainDnssec: ', $e->getMessage(), PHP_EOL;
}
 ...
 **digest_type** | [**int[]**](../Model/int.md)|  |
 **digest** | [**string[]**](../Model/string.md)|  |
 **key_tag** | [**int[]**](../Model/int.md)|  |
 **id** | **int**| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. |
...
# **addDomainNameserver**
> \InterserverApiClient\Model\TextResponse addDomainNameserver($body, $id)
...
$body = new \InterserverApiClient\Model\DomainNameserverPostRequest(); // \InterserverApiClient\Model\DomainNameserverPostRequest | 
$id = 56; // int | The domain service ID. Use `domain_id` from `GET /domains`.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\DomainNameserverPostRequest**](../Model/DomainNameserverPostRequest.md)|  |
 **id** | **int**| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. |
...
# **addDomainNameserver**
> \InterserverApiClient\Model\TextResponse addDomainNameserver($name, $ip_address, $id)
...
try {
    $result = $apiInstance->addDomainNameserver($name, $ip_address, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DomainsApi->addDomainNameserver: ', $e->getMessage(), PHP_EOL;
}
...
# **cancelDomain**
> \InterserverApiClient\Model\InlineResponse2003 cancelDomain($id)
...
[**\InterserverApiClient\Model\InlineResponse2003**](../Model/InlineResponse2003.md)
...
# **deleteDomainDnssec**
> \InterserverApiClient\Model\SuccessTextResponse deleteDomainDnssec($id)
...
try {
    $result = $apiInstance->deleteDomainDnssec($id);
    print_r($result);
} catch (Exception $e) {
...
> \InterserverApiClient\Model\TextResponse deleteDomainNameserver($id, $index)
...
# **getDomainContact**
> \InterserverApiClient\Model\DomainContactDetails getDomainContact($id)
...
[**\InterserverApiClient\Model\DomainContactDetails**](../Model/DomainContactDetails.md)
...
# **getDomainDnssec**
> \InterserverApiClient\Model\DomainDnssecRecords getDomainDnssec($id)
...
[**\InterserverApiClient\Model\DomainDnssecRecords**](../Model/DomainDnssecRecords.md)
...
# **getDomainInfo**
> \InterserverApiClient\Model\Domain getDomainInfo($id)
...
[**\InterserverApiClient\Model\Domain**](../Model/Domain.md)
...
# **getDomainInvoices**
> \InterserverApiClient\Model\ChargeInvoiceRows getDomainInvoices($id)
...
# **getDomainLookup**
> \InterserverApiClient\Model\DomainLookupResponse getDomainLookup($name)
...
[**\InterserverApiClient\Model\DomainLookupResponse**](../Model/DomainLookupResponse.md)
...
> \InterserverApiClient\Model\DomainNameserverGetResponse getDomainNameservers($id)
...
[**\InterserverApiClient\Model\DomainNameserverGetResponse**](../Model/DomainNameserverGetResponse.md)
...
# **getDomainRenewal**
> \InterserverApiClient\Model\SuccessTextResponse getDomainRenewal($id)
...
# **getDomainSearch**
> \InterserverApiClient\Model\DomainSearchResponse getDomainSearch($name)
...
[**\InterserverApiClient\Model\DomainSearchResponse**](../Model/DomainSearchResponse.md)
...
# **getDomainTransfer**
> \InterserverApiClient\Model\SuccessTextResponse getDomainTransfer($id)
...
> \InterserverApiClient\Model\SuccessTextResponse getDomainWhoisPrivacy($id)
...
# **getDomainsList**
> \InterserverApiClient\Model\DomainRow[] getDomainsList()
...
[**\InterserverApiClient\Model\DomainRow[]**](../Model/DomainRow.md)
...
> \InterserverApiClient\Model\SuccessTextResponse getDomainsWelcomeEmail($id)
...
# **getNewDomain**
> \InterserverApiClient\Model\DomainOrder getNewDomain()
...
[**\InterserverApiClient\Model\DomainOrder**](../Model/DomainOrder.md)
...
# **postDomainRenewal**
> \InterserverApiClient\Model\SuccessTextResponse postDomainRenewal($id)
...
try {
    ...
    echo 'Exception when calling DomainsApi->postDomainSearch: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **postDomainTransfer**
> \InterserverApiClient\Model\SuccessTextResponse postDomainTransfer($id)
...
# **updateDomainContact**
> \InterserverApiClient\Model\SuccessTextResponse updateDomainContact($body, $id)
...
$body = new \InterserverApiClient\Model\DomainContactDetails(); // \InterserverApiClient\Model\DomainContactDetails | 
$id = 56; // int | The domain service ID. Use `domain_id` from `GET /domains`.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\DomainContactDetails**](../Model/DomainContactDetails.md)|  |
 **id** | **int**| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. |
...
# **updateDomainContact**
> \InterserverApiClient\Model\SuccessTextResponse updateDomainContact($status, $state, $org_name, $country, $postal_code, $email, $fax, $address2, $address3, $address1, $city, $phone, $first_name, $last_name, $id)
...
try {
    $result = $apiInstance->updateDomainContact($status, $state, $org_name, $country, $postal_code, $email, $fax, $address2, $address3, $address1, $city, $phone, $first_name, $last_name, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DomainsApi->updateDomainContact: ', $e->getMessage(), PHP_EOL;
}
...
# **updateDomainInfo**
> \InterserverApiClient\Model\SuccessTextResponse updateDomainInfo($id)
...
> \InterserverApiClient\Model\TextResponse updateDomainNameservers($body, $id)
...
$body = new \InterserverApiClient\Model\DomainNameserverPutRequest(); // \InterserverApiClient\Model\DomainNameserverPutRequest | 
$id = 56; // int | The domain service ID. Use `domain_id` from `GET /domains`.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\DomainNameserverPutRequest**](../Model/DomainNameserverPutRequest.md)|  |
 **id** | **int**| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. |
...
# **updateDomainNameservers**
> \InterserverApiClient\Model\TextResponse updateDomainNameservers($nameserver, $id)
...
# **updateDomainWhoisPrivacy**
> \InterserverApiClient\Model\SuccessTextResponse updateDomainWhoisPrivacy($body, $id)
...
$body = new \InterserverApiClient\Model\DomainWhoisPrivacyRequest(); // \InterserverApiClient\Model\DomainWhoisPrivacyRequest | 
$id = 56; // int | The domain service ID. Use `domain_id` from `GET /domains`.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\DomainWhoisPrivacyRequest**](../Model/DomainWhoisPrivacyRequest.md)|  |
 **id** | **int**| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. |
...
# **updateDomainWhoisPrivacy**
> \InterserverApiClient\Model\SuccessTextResponse updateDomainWhoisPrivacy($func, $csrf_token, $domain_firstname, $domain_lastname, $domain_email, $domain_address, $domain_address2, $domain_address3, $domain_city, $domain_state, $domain_zip, $domain_country, $domain_phone, $domain_fax, $domain_company, $domain_extra, $id)
...
try {
    $result = $apiInstance->updateDomainWhoisPrivacy($func, $csrf_token, $domain_firstname, $domain_lastname, $domain_email, $domain_address, $domain_address2, $domain_address3, $domain_city, $domain_state, $domain_zip, $domain_country, $domain_phone, $domain_fax, $domain_company, $domain_extra, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DomainsApi->updateDomainWhoisPrivacy: ', $e->getMessage(), PHP_EOL;
}
