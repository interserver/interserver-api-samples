...
# **addVps**
> \InterserverApiClient\Model\ServiceOrderPostResponse addVps($body)
...
$apiInstance = new InterserverApiClient\Api\VPSApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \InterserverApiClient\Model\VpsOrderPostRequest(); // \InterserverApiClient\Model\VpsOrderPostRequest | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\VpsOrderPostRequest**](../Model/VpsOrderPostRequest.md)|  | [optional]
...
# **addVps**
> \InterserverApiClient\Model\ServiceOrderPostResponse addVps($os_distro, $slices, $vps_platform, $controlpanel, $period, $location, $os_version, $hostname, $coupon, $rootpass, $comment)
...
try {
    $result = $apiInstance->addVps($os_distro, $slices, $vps_platform, $controlpanel, $period, $location, $os_version, $hostname, $coupon, $rootpass, $comment);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VPSApi->addVps: ', $e->getMessage(), PHP_EOL;
}
...
# **deleteVpsBackup**
> \InterserverApiClient\Model\SuccessTextResponse deleteVpsBackup($id, $file, $all)
...
# **doVpsBlockSmtp**
> \InterserverApiClient\Model\QueueResponse doVpsBlockSmtp($id)
...
# **doVpsDisableCd**
> \InterserverApiClient\Model\QueueResponse doVpsDisableCd($id)
...
# **doVpsDisableQuota**
> \InterserverApiClient\Model\QueueResponse doVpsDisableQuota($id)
...
# **doVpsEjectCd**
> \InterserverApiClient\Model\QueueResponse doVpsEjectCd($id)
...
# **doVpsEnableQuota**
> \InterserverApiClient\Model\QueueResponse doVpsEnableQuota($id)
...
# **doVpsRestart**
> \InterserverApiClient\Model\QueueResponse doVpsRestart($id)
...
# **doVpsStart**
> \InterserverApiClient\Model\QueueResponse doVpsStart($id)
...
# **doVpsStop**
> \InterserverApiClient\Model\QueueResponse doVpsStop($id)
...
# **downloadVpsBackup**
> \InterserverApiClient\Model\InlineResponse20012 downloadVpsBackup($body, $id, $all)
...
$body = new \InterserverApiClient\Model\IdBackupsBody2(); // \InterserverApiClient\Model\IdBackupsBody2 | 
$id = 56; // int | VPS ID number
$all = "all_example"; // string | Set to `1` to list all backups across all services, not just the ones for the given VPS.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\IdBackupsBody2**](../Model/IdBackupsBody2.md)|  |
 **id** | **int**| VPS ID number |
 **all** | **string**| Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given VPS. | [optional]
...
# **downloadVpsBackup**
> \InterserverApiClient\Model\InlineResponse20012 downloadVpsBackup($file, $id, $all)
...
# **getNewVps**
> \InterserverApiClient\Model\VpsOrder getNewVps()
...
[**\InterserverApiClient\Model\VpsOrder**](../Model/VpsOrder.md)
...
# **getVpsBackup**
> \InterserverApiClient\Model\QueueResponse getVpsBackup($id)
...
# **getVpsBackups**
> \InterserverApiClient\Model\VpsBackupRows getVpsBackups($id, $all)
...
# **getVpsInfo**
> \InterserverApiClient\Model\Vps getVpsInfo($id)
...
[**\InterserverApiClient\Model\Vps**](../Model/Vps.md)
...
# **getVpsInvoices**
> \InterserverApiClient\Model\ChargeInvoiceRows getVpsInvoices($id)
...
# **getVpsList**
> \InterserverApiClient\Model\VpsRow[] getVpsList()
...
[**\InterserverApiClient\Model\VpsRow[]**](../Model/VpsRow.md)
...
# **getVpsReinstallOs**
> \InterserverApiClient\Model\VpsTemplatesList getVpsReinstallOs($id)
...
# **getVpsReverseDns**
> \InterserverApiClient\Model\ReverseDnsEntries getVpsReverseDns($id)
...
# **getVpsTrafficUsage**
> \InterserverApiClient\Model\VpsTrafficResponse getVpsTrafficUsage($id)
...
[**\InterserverApiClient\Model\VpsTrafficResponse**](../Model/VpsTrafficResponse.md)
...
# **getVpsWelcomeEmail**
> \InterserverApiClient\Model\SuccessTextResponse getVpsWelcomeEmail($id)
...
> \InterserverApiClient\Model\QueueResponse postVpsChangeHostname($hostname, $id)
...
# **postVpsChangeHostname**
> \InterserverApiClient\Model\QueueResponse postVpsChangeHostname($body, $id)
...
$body = new \InterserverApiClient\Model\HostnameObject(); // \InterserverApiClient\Model\HostnameObject | 
$id = 56; // int | VPS ID number
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\HostnameObject**](../Model/HostnameObject.md)|  |
 **id** | **int**| VPS ID number |
...
> \InterserverApiClient\Model\QueueResponse postVpsChangeRootPassword($password, $id)
...
# **postVpsChangeRootPassword**
> \InterserverApiClient\Model\QueueResponse postVpsChangeRootPassword($body, $id)
...
# **postVpsChangeTimezone**
> \InterserverApiClient\Model\QueueResponse postVpsChangeTimezone($timezone, $id)
...
# **postVpsChangeTimezone**
> \InterserverApiClient\Model\QueueResponse postVpsChangeTimezone($body, $id)
...
> \InterserverApiClient\Model\QueueResponse postVpsChangeWebuzoPassword($password, $id)
...
# **postVpsChangeWebuzoPassword**
> \InterserverApiClient\Model\QueueResponse postVpsChangeWebuzoPassword($body, $id)
...
# **postVpsInsertCd**
> \InterserverApiClient\Model\QueueResponse postVpsInsertCd($url, $id)
...
# **postVpsInsertCd**
> \InterserverApiClient\Model\QueueResponse postVpsInsertCd($body, $id)
...
$body = new \InterserverApiClient\Model\UrlRequest(); // \InterserverApiClient\Model\UrlRequest | 
$id = 56; // int | VPS ID number
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\UrlRequest**](../Model/UrlRequest.md)|  |
 **id** | **int**| VPS ID number |
...
# **postVpsReinstallOs**
> \InterserverApiClient\Model\QueueResponse postVpsReinstallOs($template, $password, $local_password, $id)
...
try {
    $result = $apiInstance->postVpsReinstallOs($template, $password, $local_password, $id);
    print_r($result);
} catch (Exception $e) {
 ...
 **local_password** | [**string**](../Model/.md)|  |
 **id** | **int**| VPS ID number |
...
# **postVpsReinstallOs**
> \InterserverApiClient\Model\QueueResponse postVpsReinstallOs($body, $id)
...
$body = new \InterserverApiClient\Model\TemplateRequest(); // \InterserverApiClient\Model\TemplateRequest | 
$id = 56; // int | VPS ID number
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\TemplateRequest**](../Model/TemplateRequest.md)|  |
 **id** | **int**| VPS ID number |
...
> \InterserverApiClient\Model\QueueResponse postVpsResetPassword($id)
...
# **postVpsRestore**
> \InterserverApiClient\Model\QueueResponse postVpsRestore($body, $id)
...
$body = new \InterserverApiClient\Model\RestoreRequest(); // \InterserverApiClient\Model\RestoreRequest | VPS Restore request
$id = 56; // int | VPS ID number
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\RestoreRequest**](../Model/RestoreRequest.md)| VPS Restore request |
 **id** | **int**| VPS ID number |
...
# **postVpsRestore**
> \InterserverApiClient\Model\QueueResponse postVpsRestore($backup, $password, $id)
...
# **postVpsReverseDns**
> \InterserverApiClient\Model\TextResponse postVpsReverseDns($body, $id)
...
# **postVpsReverseDns**
> \InterserverApiClient\Model\TextResponse postVpsReverseDns($ips, $id)
...
# **postVpsSetupVnc**
> \InterserverApiClient\Model\QueueResponse postVpsSetupVnc($id)
...
# **putVps**
> \InterserverApiClient\Model\VpsOrderPutResponse putVps($body)
...
$body = new \InterserverApiClient\Model\VpsOrderPutRequest(); // \InterserverApiClient\Model\VpsOrderPutRequest | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\InterserverApiClient\Model\VpsOrderPutRequest**](../Model/VpsOrderPutRequest.md)|  | [optional]

### Return type

[**\InterserverApiClient\Model\VpsOrderPutResponse**](../Model/VpsOrderPutResponse.md)
...
# **putVps**
> \InterserverApiClient\Model\VpsOrderPutResponse putVps($os_distro, $slices, $vps_platform, $controlpanel, $period, $location, $os_version, $hostname, $coupon, $rootpass, $comment)
...
try {
    $result = $apiInstance->putVps($os_distro, $slices, $vps_platform, $controlpanel, $period, $location, $os_version, $hostname, $coupon, $rootpass, $comment);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VPSApi->putVps: ', $e->getMessage(), PHP_EOL;
}
...
# **updateVpsInfo**
> \InterserverApiClient\Model\SuccessTextResponse updateVpsInfo($id)
...
# **vPSCancel**
> \InterserverApiClient\Model\InlineResponse20024 vPSCancel($id)
...
[**\InterserverApiClient\Model\InlineResponse20024**](../Model/InlineResponse20024.md)
