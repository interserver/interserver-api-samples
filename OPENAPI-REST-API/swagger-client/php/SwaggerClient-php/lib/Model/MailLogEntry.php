...
class MailLogEntry implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sending_zone'] = isset($data['sending_zone']) ? $data['sending_zone'] : null;
        $this->container['body_size'] = isset($data['body_size']) ? $data['body_size'] : null;
        ...
        $this->container['mx_hostname'] = isset($data['mx_hostname']) ? $data['mx_hostname'] : null;
    }
     ...
     * Sets message_id
     *
     * @param string $message_id The `Message-ID` header value.  Can be used with the `messageId` filter for subsequent lookups.
     *
     * @return $this
     */
     ...
     * Sets sending_zone
     *
     * @param string $sending_zone The sending zone assigned by the relay for outbound delivery.
     *
     * @return $this
     */
    public function setSendingZone($sending_zone)
    {
     ...
     * Sets body_size
     *
     * @param int $body_size Size of the message body in bytes.
     *
     * @return $this
     */
     ...
     * Sets lock_time
     *
     * @param string $lock_time Millisecond-precision timestamp of the last queue lock acquisition.
     *
     * @return $this
     */
     ...
     * Sets mx_hostname
     *
     * @param string $mx_hostname The MX hostname the relay connected to for delivery.  Corresponds to the `mx` filter parameter.
     *
     * @return $this
     */
    public function setMxHostname($mx_hostname)
    {
