...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    public Response getAffiliateDownload(  @QueryParam("st") 

 @Parameter(description = "Filter by status.")  String st
,  @QueryParam("ex") 

 @Parameter(description = "Export format: csv, xls, xlsx, or pdf. Defaults to csv.")  String ex
,  @QueryParam("year") 

 @Parameter(description = "Year to filter the report. Defaults to the current year.")  Integer year
) {
        return Response.ok().entity("magic!").build();
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    public Response getAffiliateSignups(  @QueryParam("st") 

 @Parameter(description = "Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results.")  String st
) {
        return Response.ok().entity("magic!").build();
    }
    @GET
