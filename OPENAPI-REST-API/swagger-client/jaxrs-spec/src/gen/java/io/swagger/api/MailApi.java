...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    public Response addMail(@Valid MailOrderRequest body) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    public Response deleteMailAlert(@Valid IdAlertsBody body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    public Response deleteMailAlert(@FormParam(value = "alert_id")  Integer alertId, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    public Response putMail(@Valid MailOrderRequest body) {
        return Response.ok().entity("magic!").build();
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    public Response updateRule(@Valid DenyRuleNew body, @PathParam("id")

 @Parameter(description = "The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.") Integer id
, @PathParam("rule")

 @Parameter(description = "The ID of the deny rule to update.") String rule
) {
        return Response.ok().entity("magic!").build();
    }
    @PUT
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    public Response updateRule(@FormParam(value = "user")  String user,@FormParam(value = "type")  String type,@FormParam(value = "data")  String data, @PathParam("id")
