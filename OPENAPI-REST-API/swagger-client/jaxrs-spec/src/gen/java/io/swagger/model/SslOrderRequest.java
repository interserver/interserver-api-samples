...
public class SslOrderRequest   {
  ...
  private @Valid Integer ssl = null;

  private @Valid String hostname = null;

  private @Valid String approverEmail = null;

  private @Valid Integer frequency = 12;
...
public enum CsrTypeEnum {
  ...
  private @Valid CsrTypeEnum csrType = CsrTypeEnum.GENERATED;

  private @Valid String csr = "";
  ...
  private @Valid String department = "Administration";

  private @Valid String agency = null;

  private @Valid String businessCategory = null;
