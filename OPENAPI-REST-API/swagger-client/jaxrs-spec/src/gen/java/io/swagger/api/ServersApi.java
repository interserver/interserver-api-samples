...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    public Response addServer(@Valid ServerOrderPostRequest body) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    public Response serverBulkIpmiPowerGet( @NotNull  @QueryParam("ids") 

 @Parameter(description = "Comma-separated list of Server IDs to query (e.g. &#x60;2313,2314,2315&#x60;). May also be passed as repeated &#x60;ids[]&#x60; query parameters.")  String ids
) {
        return Response.ok().entity("magic!").build();
    }
    @GET
