...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    public Response patchBillingCreditCardVerify(@Valid IdVerifyBody body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    public Response patchBillingCreditCardVerify(@FormParam(value = "cc_ccv2")  String ccCcv2, @PathParam("id")
