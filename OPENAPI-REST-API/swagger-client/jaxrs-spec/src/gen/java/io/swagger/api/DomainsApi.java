...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    public Response addDomain(@Valid Map<String, Object> body) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    public Response patchDomains(@Valid Map<String, Object> body) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/{id}/renew")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    public Response postDomainSearch( @PathParam("name")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    public Response putDomains(@Valid Map<String, Object> body) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/{id}/contact")
