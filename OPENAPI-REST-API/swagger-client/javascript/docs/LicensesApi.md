...
let body = new InterServerManagementApi.LicenseOrderRequest(); // LicenseOrderRequest | 

apiInstance.addLicense(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.putLicenses(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
