...
let body = new InterServerManagementApi.QsOrderRequest(); // QsOrderRequest | 

apiInstance.addQs(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
# **downloadQsBackup**
> InlineResponse20012 downloadQsBackup(body, file, id, opts)
...
apiInstance.getQsBackup(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.putQs(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
