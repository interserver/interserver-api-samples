...
let body = new InterServerManagementApi.SslOrderRequest(); // SslOrderRequest | 

apiInstance.addSsl(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.putSsl(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
