...
let body = new InterServerManagementApi.WebsiteOrderPostRequest(); // WebsiteOrderPostRequest | 

apiInstance.addWebsite(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
# **postWebsiteBuyIp**
> InlineResponse20027 postWebsiteBuyIp(body, ips, id)
...
> InlineResponse20028 postWebsiteMigration(body, custPortal, regEmail, password, ctrlPanel, ftpUsername, ftpPassword, siteBusyMig, splReqMig, domainReg, dataMig, domainRegPortal, domainRegEmail, domainRegPassword, id)
...
let apiInstance = new InterServerManagementApi.WebhostingApi();
let body = new InterServerManagementApi.WebsiteOrderPutRequest(); // WebsiteOrderPutRequest | 

apiInstance.putWebsites(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
