...
let body = new InterServerManagementApi.MailOrderRequest(); // MailOrderRequest | 

apiInstance.addMail(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
# **deleteMailAlert**
> SuccessTextResponse deleteMailAlert(body, alert_id, id)
...
let apiInstance = new InterServerManagementApi.MailApi();
let body = new InterServerManagementApi.IdAlertsBody(); // IdAlertsBody | 
let alert_id = 56; // Number | 
let id = 56; // Number | The mail service ID. Use `mail_id` from `GET /mail`.

apiInstance.deleteMailAlert(body, alert_id, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.putMail(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
<a name="updateRule"></a>
# **updateRule**
> GenericResponse updateRule(body, user, type, data, id, rule)
...
let apiInstance = new InterServerManagementApi.MailApi();
let body = new InterServerManagementApi.DenyRuleNew(); // DenyRuleNew | 
let user = "user_example"; // String | 
let type = "type_example"; // String | 
let data = "data_example"; // String | 
let id = 56; // Number | The mail service ID. Use `mail_id` from `GET /mail`.
...
apiInstance.updateRule(body, user, type, data, id, rule, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
