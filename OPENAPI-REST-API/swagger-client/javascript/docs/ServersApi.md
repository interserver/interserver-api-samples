...
let body = new InterServerManagementApi.ServerOrderPostRequest(); // ServerOrderPostRequest | 

apiInstance.addServer(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.serverBulkIpmiPowerGet(ids, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
