...
apiInstance.addDomain(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.deleteDomainDnssec(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.patchDomains(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.postDomainSearch(name, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.putDomains(body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
