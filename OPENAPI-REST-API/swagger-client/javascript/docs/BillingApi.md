...
apiInstance.getAffiliateDownload(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
# **getAffiliateSignups**
> InlineResponse2001 getAffiliateSignups(opts)
...
apiInstance.getAffiliateSignups(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> SuccessTextResponse patchBillingCreditCardVerify(body, cc_ccv2, id)
...
let apiInstance = new InterServerManagementApi.BillingApi();
let body = new InterServerManagementApi.IdVerifyBody(); // IdVerifyBody | 
let cc_ccv2 = "cc_ccv2_example"; // String | 
let id = 56; // Number | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.

apiInstance.patchBillingCreditCardVerify(body, cc_ccv2, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
