...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FloatingIpOrderRequest', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.FloatingIpOrderRequest();
      });

      it('should create an instance of FloatingIpOrderRequest', function() {
        // TODO: update the code to test FloatingIpOrderRequest
        expect(instance).to.be.a(InterServerManagementApi.FloatingIpOrderRequest);
      });
