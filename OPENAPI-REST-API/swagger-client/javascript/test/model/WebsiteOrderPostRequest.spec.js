...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WebsiteOrderPostRequest', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.WebsiteOrderPostRequest();
      });

      it('should create an instance of WebsiteOrderPostRequest', function() {
        // TODO: update the code to test WebsiteOrderPostRequest
        expect(instance).to.be.a(InterServerManagementApi.WebsiteOrderPostRequest);
      });
