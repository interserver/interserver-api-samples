...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LicenseOrderRequest', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.LicenseOrderRequest();
      });

      it('should create an instance of LicenseOrderRequest', function() {
        // TODO: update the code to test LicenseOrderRequest
        expect(instance).to.be.a(InterServerManagementApi.LicenseOrderRequest);
      });
