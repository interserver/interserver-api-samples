...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20013FilterFirewall', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.InlineResponse20013FilterFirewall();
      });

      it('should create an instance of InlineResponse20013FilterFirewall', function() {
        // TODO: update the code to test InlineResponse20013FilterFirewall
        expect(instance).to.be.a(InterServerManagementApi.InlineResponse20013FilterFirewall);
      });
