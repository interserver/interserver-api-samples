...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MailOrderRequest', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.MailOrderRequest();
      });

      it('should create an instance of MailOrderRequest', function() {
        // TODO: update the code to test MailOrderRequest
        expect(instance).to.be.a(InterServerManagementApi.MailOrderRequest);
      });
