...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServerOrderPostRequest', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.ServerOrderPostRequest();
      });

      it('should create an instance of ServerOrderPostRequest', function() {
        // TODO: update the code to test ServerOrderPostRequest
        expect(instance).to.be.a(InterServerManagementApi.ServerOrderPostRequest);
      });
      ...
      it('should have the property servername (base name: "servername")', function() {
        // TODO: update the code to test the property servername
        expect(instance).to.have.property('servername');
        // expect(instance.servername).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property tos (base name: "tos")', function() {
        // TODO: update the code to test the property tos
        expect(instance).to.have.property('tos');
        // expect(instance.tos).to.be(expectedValueLiteral);
      });
