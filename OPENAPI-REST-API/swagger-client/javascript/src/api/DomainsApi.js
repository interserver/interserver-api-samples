    ...
    */
    ...
    addDomain(body, callback) {
      ...
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addDomain");
      }
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    deleteDomainDnssec(id, callback) {
     ...
     */
    patchDomains(body, callback) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling patchDomains");
      }
    ...
    /**
     * Callback function to receive the result of the postDomainSearch operation.
     * @callback moduleapi/DomainsApi~postDomainSearchCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} name The base domain name to search (for example &#x60;example&#x60; or &#x60;example.com&#x60;).
     * @param {module:api/DomainsApi~postDomainSearchCallback} callback The callback function, accepting three arguments: error, data, response
     */
    postDomainSearch(name, callback) {
     ...
     */
    putDomains(body, callback) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling putDomains");
      }
