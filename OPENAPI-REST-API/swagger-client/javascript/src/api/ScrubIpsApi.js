...
export default class ScrubIpsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the putScrubIps operation.
     * @callback moduleapi/ScrubIpsApi~putScrubIpsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/ScrubIpPlaceOrder} body 
     * @param {module:api/ScrubIpsApi~putScrubIpsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    putScrubIps(body, callback) {
      
      let postBody = body;
      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling putScrubIps");
      }
