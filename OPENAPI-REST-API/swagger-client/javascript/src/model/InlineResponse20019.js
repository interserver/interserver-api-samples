  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('packageCosts'))
        obj.packageCosts = InlineResponse20019PackageCosts.constructFromObject(data['packageCosts']);
      if (data.hasOwnProperty('serviceTypes'))
        obj.serviceTypes = ApiClient.convertToType(data['serviceTypes'], [InlineResponse20019ServiceTypes]);
      if (data.hasOwnProperty('ips'))
        obj.ips = ApiClient.convertToType(data['ips'], [InlineResponse20019Ips]);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/InlineResponse20019PackageCosts} packageCosts
 */
InlineResponse20019.prototype.packageCosts = undefined;

/**
 * @member {Array.<module:model/InlineResponse20019ServiceTypes>} serviceTypes
 */
InlineResponse20019.prototype.serviceTypes = undefined;

/**
 * @member {Array.<module:model/InlineResponse20019Ips>} ips
 */
InlineResponse20019.prototype.ips = undefined;
