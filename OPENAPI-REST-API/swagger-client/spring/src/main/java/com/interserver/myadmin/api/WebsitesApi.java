...
public interface WebsitesApi {
    ...
    Logger log = LoggerFactory.getLogger(WebsitesApi.class);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    default ResponseEntity<ServiceOrderPostResponse> addWebsite(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody WebsiteOrderPostRequest body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default WebsitesApi interface so no example is generated");
        }
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    default ResponseEntity<WebsitesOrder> getNewWebsite() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}/buy_ip",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<InlineResponse20026> getWebsiteBuyIp(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Website> getWebsiteInfo(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}/invoices",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<ChargeInvoiceRows> getWebsiteInvoices(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites",
        ...
        method = RequestMethod.GET)
    default ResponseEntity<List<WebsiteRow>> getWebsiteList() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}/backups",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<WebsiteBackups> getWebsitesBackups(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}/login",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<WebsiteLoginResponse> getWebsitesLogin(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}/welcome_email",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<SuccessTextResponse> getWebsitesWelcomeEmail(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}/reverse_dns",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<ReverseDnsEntries> gettWebsiteReverseDns(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}/buy_ip",
        ...
        method = RequestMethod.POST)
    default ResponseEntity<InlineResponse20027> postWebsiteBuyIp(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}/migration",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    default ResponseEntity<InlineResponse20028> postWebsiteMigration(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody IdMigrationBody body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"ticket\" : 0,\n  \"text\" : \"text\"\n}", InlineResponse20028.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}/reverse_dns",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    default ResponseEntity<TextResponse> postWebsitesReverseDns(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    default ResponseEntity<Void> putWebsites(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody WebsiteOrderPutRequest body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default WebsitesApi interface so no example is generated");
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    @RequestMapping(value = "/websites/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> updateWebsiteInfo(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") String id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    default ResponseEntity<InlineResponse20025> webhostingCancel(@Parameter(in = ParameterIn.PATH, description = "The website service ID. Use `website_id` from `GET /websites`.", required=true, schema=@Schema()) @PathVariable("id") String id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
