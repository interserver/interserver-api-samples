...
public interface DomainsApi {
    ...
    Logger log = LoggerFactory.getLogger(DomainsApi.class);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    default ResponseEntity<ServiceOrderPostResponse> addDomain(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Map<String, Object> body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default DomainsApi interface so no example is generated");
        }
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/dnssec",
        ...
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> addDomainDnssec(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/nameservers",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    default ResponseEntity<TextResponse> addDomainNameserver(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    default ResponseEntity<InlineResponse2003> cancelDomain(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/dnssec",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    default ResponseEntity<SuccessTextResponse> deleteDomainDnssec(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/nameservers",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    default ResponseEntity<TextResponse> deleteDomainNameserver(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    default ResponseEntity<DomainContactDetails> getDomainContact(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/dnssec",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<DomainDnssecRecords> getDomainDnssec(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Domain> getDomainInfo(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/invoices",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<ChargeInvoiceRows> getDomainInvoices(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/lookup/{name}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<DomainLookupResponse> getDomainLookup(@Parameter(in = ParameterIn.PATH, description = "The full domain name to look up (for example `example.com`).", required=true, schema=@Schema()) @PathVariable("name") String name
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/nameservers",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<DomainNameserverGetResponse> getDomainNameservers(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/renew",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<SuccessTextResponse> getDomainRenewal(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/search/{name}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<DomainSearchResponse> getDomainSearch(@Parameter(in = ParameterIn.PATH, description = "The base domain name to search (for example `example` or `example.com`).", required=true, schema=@Schema()) @PathVariable("name") String name
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/transfer",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<SuccessTextResponse> getDomainTransfer(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/whois",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<SuccessTextResponse> getDomainWhoisPrivacy(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<List<DomainRow>> getDomainsList() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/welcome_email",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<SuccessTextResponse> getDomainsWelcomeEmail(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/order",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<DomainOrder> getNewDomain() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    default ResponseEntity<Void> patchDomains(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Map<String, Object> body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default DomainsApi interface so no example is generated");
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/renew",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> postDomainRenewal(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/search/{name}",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    default ResponseEntity<Void> postDomainSearch(@Parameter(in = ParameterIn.PATH, description = "The base domain name to search (for example `example` or `example.com`).", required=true, schema=@Schema()) @PathVariable("name") String name
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default DomainsApi interface so no example is generated");
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/transfer",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> postDomainTransfer(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    default ResponseEntity<Void> putDomains(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Map<String, Object> body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default DomainsApi interface so no example is generated");
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/contact",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> updateDomainContact(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> updateDomainInfo(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/nameservers",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.PUT)
    default ResponseEntity<TextResponse> updateDomainNameservers(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/whois",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> updateDomainWhoisPrivacy(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
