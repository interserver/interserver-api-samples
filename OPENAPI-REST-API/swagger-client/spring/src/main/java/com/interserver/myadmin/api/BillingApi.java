...
public interface BillingApi {
    ...
    Logger log = LoggerFactory.getLogger(BillingApi.class);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    default ResponseEntity<SuccessTextResponse> addBillingCreditCard(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody BillingAddCcRequest body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default BillingApi interface so no example is generated");
        }
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/prepays",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> addBillingPrepay(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody BillingPrepayRequest body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    default ResponseEntity<SuccessTextResponse> deleteBillingCreditCard(@Parameter(in = ParameterIn.PATH, description = "The credit card ID to remove. Use IDs from `GET /billing/creditcards`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/invoices/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    default ResponseEntity<SuccessTextResponse> deleteBillingInvoice(@Parameter(in = ParameterIn.PATH, description = "The invoice ID to delete. Only unpaid invoices can be deleted.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/prepays/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    default ResponseEntity<SuccessTextResponse> deleteBillingPrepay(@Parameter(in = ParameterIn.PATH, description = "The prepay balance ID to delete.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    default ResponseEntity<Object> getBillingCart() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/creditcards/{id}/verify",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<SuccessTextResponse> getBillingCreditCardVerify(@Parameter(in = ParameterIn.PATH, description = "The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/invoices/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<BillingInvoiceDetail> getBillingInvoice(@Parameter(in = ParameterIn.PATH, description = "The invoice ID. Use IDs from `GET /billing/invoices` or from order responses.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/invoices",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<BillingInvoiceList> getBillingInvoices() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/prepays",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Object> getBillingPrePays() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{ }", Object.class), HttpStatus.NOT_IMPLEMENTED);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    default ResponseEntity<SuccessTextResponse> patchBillingCreditCardVerify(@Parameter(in = ParameterIn.PATH, description = "The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody IdVerifyBody body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/creditcards/{id}/verify",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> postBillingCreditCardVerify(@Parameter(in = ParameterIn.PATH, description = "The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/creditcards/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> updateBillingCreditCard(@Parameter(in = ParameterIn.PATH, description = "The credit card ID. Use IDs from `GET /billing/creditcards` or the response from `POST /billing/creditcards`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    @RequestMapping(value = "/billing/payment_method",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> updateBillingPaymentMethod(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody BillingPaymentMethodRequest body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
