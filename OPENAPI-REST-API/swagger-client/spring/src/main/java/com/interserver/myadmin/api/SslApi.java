...
public interface SslApi {
    ...
    Logger log = LoggerFactory.getLogger(SslApi.class);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    default ResponseEntity<ServiceOrderPostResponse> addSsl(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody SslOrderRequest body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default SslApi interface so no example is generated");
        }
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    default ResponseEntity<Object> getNewSsl() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    @RequestMapping(value = "/ssl/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Object> getSslInfo(@Parameter(in = ParameterIn.PATH, description = "SSL certificate ID number.", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    @RequestMapping(value = "/ssl/{id}/invoices",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<ChargeInvoiceRows> getSslInvoices(@Parameter(in = ParameterIn.PATH, description = "SSL Cert ID number", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    @RequestMapping(value = "/ssl",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Void> getSslList() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default SslApi interface so no example is generated");
        }
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    @RequestMapping(value = "/ssl/{id}/welcome_email",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<SuccessTextResponse> getSslWelcomeEmail(@Parameter(in = ParameterIn.PATH, description = "SSL Cert ID number", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    default ResponseEntity<Void> putSsl(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody SslOrderRequest body
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default SslApi interface so no example is generated");
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    default ResponseEntity<InlineResponse20023> sslCancel(@Parameter(in = ParameterIn.PATH, description = "SSL Cert ID number", required=true, schema=@Schema()) @PathVariable("id") Integer id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    @RequestMapping(value = "/ssl/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    default ResponseEntity<SuccessTextResponse> updateSslInfo(@Parameter(in = ParameterIn.PATH, description = "SSL certificate ID number.", required=true, schema=@Schema()) @PathVariable("id") String id
) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
