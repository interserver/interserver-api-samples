...
public interface DomainsApi  {
    ...
    @Operation(summary = "Place a new domain registration or transfer order, generate billing invoice", tags={  })
    @ApiResponses(value = { 
    ...
    public ServiceOrderPostResponse addDomain(Map<String, Object> body);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Register DNSSEC DS records on the domain at OpenSRS", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Register a new nameserver host with glue IP at the registry (registered nameserver)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/domains/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel a domain order in the billing system to stop auto-renewals", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/domains/{id}/dnssec")
    @Produces({ "application/json" })
    @Operation(summary = "Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/domains/{id}/nameservers")
    @Produces({ "application/json" })
    @Operation(summary = "Remove one registered nameserver glue record from the domain", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response with a text message field.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read the current registrant/admin/tech/billing contact field set for a domain", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/domains/{id}/dnssec")
    @Produces({ "application/json" })
    @Operation(summary = "Read the DNSSEC DS record set currently registered with the registrar", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/domains/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Read full billing, registrar, and service detail for one domain", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List all billing invoices scoped to one domain order", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Check availability, premium status, and pricing for a specific domain", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/domains/{id}/nameservers")
    @Produces({ "application/json" })
    @Operation(summary = "List registered nameserver hosts and glue IP addresses for a domain", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read renewal pricing, expiry, and whether a renewal invoice already exists", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get registrar-suggested domain alternatives and bulk availability for a search term", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read OpenSRS transfer status for an in-progress domain transfer order", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read Whois privacy availability, current state, and add-on pricing for a domain", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/domains")
    @Produces({ "application/json" })
    @Operation(summary = "List every domain registration on the account with billing and registration metadata", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the domain welcome email with registration details and management instructions", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/domains/order")
    @Produces({ "application/json" })
    @Operation(summary = "Read the buyable domain TLD service catalog and Whois privacy pricing", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate posted domain-order field values before committing — dry run", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Validate Domain order response"),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void patchDomains(Map<String, Object> body);
    ...
    @Path("/domains/{id}/renew")
    @Produces({ "application/json" })
    @Operation(summary = "Submit a domain renewal request and generate the renewal invoice", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/domains/search/{name}")
    @Produces({ "application/json" })
    @Operation(summary = "Get the full order form data for a hostname in one round-trip (search → order preview)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/domains/{id}/transfer")
    @Produces({ "application/json" })
    @Operation(summary = "Re-poll OpenSRS transfer status for a domain order via POST", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Preview per-TLD field requirements for a domain order — no commit", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Validate Domain Order response"),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public void putDomains(Map<String, Object> body);
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Update registrant/admin contact details and push them to OpenSRS", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/domains/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "POST mutation hook for the domain detail page (use dedicated ops where possible)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Replace the full authoritative-nameserver delegation list at the registrar", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response with a text message field.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Order, enable, or cancel the Whois privacy add-on for a domain", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
