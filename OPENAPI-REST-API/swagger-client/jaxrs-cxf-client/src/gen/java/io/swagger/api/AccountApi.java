...
public interface AccountApi  {
    ...
    @Operation(summary = "Unlink a third-party OAuth/social provider (Google, GitHub, etc.) from the account", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/account/2fa")
    @Produces({ "application/json" })
    @Operation(summary = "Disable two-factor authentication and remove the TOTP secret", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Remove one IP range from the account allow-list (PATCH on /account/iplimits)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/account")
    @Produces({ "application/json" })
    @Operation(summary = "Read full account profile, billing address, and security settings", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/account/2fa")
    @Produces({ "application/json" })
    @Operation(summary = "Fetch TOTP secret to enroll a 2FA authenticator app (Google Authenticator etc.)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/home")
    @Produces({ "application/json" })
    @Operation(summary = "Aggregate dashboard payload — service counts, recent activity, alerts", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/search")
    @Produces({ "application/json" })
    @Operation(summary = "Global autocomplete across the caller's services, domains, and records", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/logout")
    @Produces({ "application/json" })
    @Operation(summary = "Destroy the current API/web session — token becomes unusable", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Sign out of the upstream OAuth provider session (does not unlink the account)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/account/apikey")
    @Produces({ "application/json" })
    @Operation(summary = "Rotate the account's REST/MCP API key — old key is invalidated immediately", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Toggle account-wide safety locks for password reset and OS reinstall", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Update contact and billing-address fields on the customer profile", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Add an IP CIDR/range to the account's API+web allow-list (lockout-safe)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Change the account login password (verifies current, kills other sessions)", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Set the account-level SSH public key auto-installed on new VPS/dedicated orders", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Verify TOTP code and enable two-factor authentication on the account", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
