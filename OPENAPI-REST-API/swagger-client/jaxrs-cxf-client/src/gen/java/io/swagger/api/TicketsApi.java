...
public interface TicketsApi  {
    ...
    @Operation(summary = "Open a new helpdesk ticket, optionally linked to a service and attachments", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Close an open support ticket via simple GET request (no body required)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/tickets/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Close a customer ticket via DELETE verb (closes only, never destroys data)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/tickets/new")
    @Produces({ "application/json" })
    @Operation(summary = "Fetch services and product options to populate the new-ticket form", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/tickets/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get full ticket details including subject, status, and the reply thread", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Ticket Information", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ViewTicketResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "200", description = "Default response") })
    ...
    @Path("/tickets")
    @Produces({ "application/json" })
    @Operation(summary = "List the authenticated account's support tickets with status and date filters", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/tickets/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Append a reply (and optional attachment, server-access fields) to a ticket", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Ticket Information", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ViewTicketResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "200", description = "Default response") })
    ...
    @Path("/tickets")
    @Produces({ "application/json" })
    @Operation(summary = "Search the authenticated account's tickets by subject, email, or mask ID", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/tickets/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update a ticket's properties such as subject or status (stub, not implemented)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Ticket Information", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ViewTicketResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "200", description = "Default response") })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Post a simple text reply to an existing ticket thread (no attachments)", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Update a ticket's custom field values (server-access details, etc.)", tags={  })
    @ApiResponses(value = { 
