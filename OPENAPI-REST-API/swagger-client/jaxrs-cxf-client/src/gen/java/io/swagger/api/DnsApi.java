...
public interface DnsApi  {
    ...
    @Operation(summary = "Create a new authoritative DNS zone seeded with apex A + NS + SOA records", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Add a DNS record (A, AAAA, MX, TXT, CNAME, NS, SRV, CAA, ...) to a zone", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/dns/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Permanently delete a DNS zone and every record it contains", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Permanently delete one DNS record from a zone — zone itself is preserved", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/dns/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "List every DNS record in one zone with the IDs needed to edit or delete them", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/dns")
    @Produces({ "application/json" })
    @Operation(summary = "List DNS zones hosted on the account with each zone's apex A-record IP", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Replace values on an existing DNS record (name, type, content, ttl, priority)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
