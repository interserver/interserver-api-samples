...
public interface ServersApi  {
    ...
    @Operation(summary = "Place a custom dedicated server order, creating a real billable invoice", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get configurable options for a Rapid Deploy / coupon dedicated server", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/servers/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get custom dedicated server ordering options, regions, and pricing", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/servers/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get full hardware, network, and lifecycle details for a dedicated server", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List billing invoices (charges + payments) tied to one dedicated server", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/servers")
    @Produces({ "application/json" })
    @Operation(summary = "List all dedicated servers owned by the authenticated customer", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List current reverse-DNS (PTR) records for a dedicated server's IPs", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the dedicated server welcome email with setup credentials", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Place a Rapid Deploy / coupon dedicated server order; creates real invoice", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Update reverse-DNS (PTR) hostnames on a dedicated server's IPs", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read IPMI chassis power status for many dedicated servers in one call", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read current IPMI Live whitelist + KVM gateway URL for a dedicated server", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Whitelist an IP for IPMI Live KVM gateway access (3-hour lease)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response from the Servers IPMI Live information request.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerIpmiLiveInfo.class))),
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read IPMI chassis power status for a dedicated server (single)", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "DESTRUCTIVE — change chassis power state on a bare-metal server", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Response with a text message field.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TextResponse.class))),
        @ApiResponse(responseCode = "400", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/servers/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel a dedicated server service at the end of the current billing cycle", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/servers/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update settings on a dedicated server order (shares handler with view)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
