...
public interface MailApi  {
    ...
    @Operation(summary = "Place a new Mail Baby order, generate invoice, and queue provisioning", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Create a new deny rule to auto-block matching submissions", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Create a new Mail Baby alert for delivery, bounce, or quota events", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Delete a Mail Baby alert by alert_id (hard delete — no recovery)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public SuccessTextResponse deleteMailAlert(IdAlertsBody body, @PathParam("id") Integer id);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Delete a Mail Baby deny rule by rule ID (hard delete — no recovery)", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Delist a sender email from rspamd / mailchannels / mailbaby block lists", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}/alerts")
    @Produces({ "application/json" })
    @Operation(summary = "List configured delivery/bounce/quota alerts for one Mail Baby service", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}/blocks")
    @Produces({ "application/json" })
    @Operation(summary = "List recent local-blocklist hits and spam-trap captures for the mail user", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}/delist")
    @Produces({ "application/json" })
    @Operation(summary = "Read blocklist diagnostics and find senders eligible for delisting", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read delivered vs bounced totals broken down by sender (or by recipient domain)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Read full detail for one Mail Baby service including SMTP credentials", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List billing invoices linked to this Mail Baby service", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/mail")
    @Produces({ "application/json" })
    @Operation(summary = "List every Mail Baby SMTP relay service on the account", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the Mail Baby welcome email with SMTP credentials and setup info", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/mail/order")
    @Produces({ "application/json" })
    @Operation(summary = "Read the Mail Baby order catalog — plans, package costs, service-type metadata", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}/rules")
    @Produces({ "application/json" })
    @Operation(summary = "List configured deny rules (sender/recipient blocks) for a Mail Baby service", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}/stats")
    @Produces({ "application/json" })
    @Operation(summary = "Read Mail Baby usage counts, send volume totals, top destinations, and projected cost", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel a Mail Baby service and stop the recurring invoice", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Delist a sender from rspamd / mailchannels / mailbaby block lists", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate Mail Baby order, quote pricing, and verify coupon — no charge", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Rotate the SMTP password and email the new credential to the account owner", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json", "application/x-www-form-urlencoded" })
    @Produces({ "application/json" })
    @Operation(summary = "Send email via Mail Baby SMTP relay with attachments, CC/BCC, and multi-recipient", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "application/x-www-form-urlencoded" })
    @Produces({ "application/json" })
    @Operation(summary = "Send a simple single-recipient email through the Mail Baby SMTP relay", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Email queued successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = GenericResponse.class))),
        @ApiResponse(responseCode = "400", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Update an existing Mail Baby alert by alert_id", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/mail/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "POST mutation hook for the Mail Baby service detail page", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Update an existing Mail Baby deny rule's type and match data", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public GenericResponse updateRule(DenyRuleNew body, @PathParam("id") Integer id, @PathParam("rule") String rule);
    ...
    @Path("/mail/{id}/log")
    @Produces({ "application/json" })
    @Operation(summary = "Search and paginate per-message Mail Baby delivery log entries", tags={  })
    @ApiResponses(value = { 
