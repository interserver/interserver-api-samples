...
public interface PublicApi  {
    ...
    @Operation(summary = "List enabled currency codes accepted for billing and preferences", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List supported UI locales with English and native display names", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/captcha")
    @Produces({ "application/json" })
    @Operation(summary = "Fetch a base64 JPEG captcha challenge for human verification", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List enabled countries keyed by ISO-2/ISO-3/numeric code", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/info")
    @Produces({ "application/json" })
    @Operation(summary = "Discover available modules, service packages, categories, and types", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/login")
    @Produces({ "application/json" })
    @Operation(summary = "Fetch logo, captcha, language, and stats for rendering a login page", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List Rapid Deploy (Buy-It-Now) marketplace dedicated servers with live pricing", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/oauth")
    @Produces({ "application/json" })
    @Operation(summary = "Begin OAuth login flow — redirect user to provider for authentication", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse2006 getOauthRedirect(@QueryParam("provider")String provider);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List all PHP timezone identifiers usable on accounts and services", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Submit 2FA code to finish OAuth login when account has 2FA enabled", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/ping")
    @Produces({ "application/json" })
    @Operation(summary = "Liveness check — returns the JSON string \"pong\" to confirm API is up", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Complete OAuth login by linking provider to existing or new account", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse2007 postOauthCallback(@QueryParam("provider")String provider, OauthBody body);
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OAuth callback result.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2007.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse2007 postOauthCallback(@QueryParam("provider")String provider, @Multipart(value = "provider", required = false)  String provider2);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Authenticate with email + password and return a session token", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Create a new customer account (email + password + captcha + ToS)", tags={  })
    @ApiResponses(value = { 
