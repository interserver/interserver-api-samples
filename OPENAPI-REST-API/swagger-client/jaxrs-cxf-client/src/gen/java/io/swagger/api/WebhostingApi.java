...
public interface WebhostingApi  {
    ...
    @Operation(summary = "Place a new webhosting order, create the invoice, and queue provisioning", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/websites/order")
    @Produces({ "application/json" })
    @Operation(summary = "Read the webhosting order catalog — plans, packages, promo offers, pricing", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read website IPs, current reverse DNS, and additional-IP pricing", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/websites/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Read full configuration and status detail for one webhosting service", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List all billing invoices and recurring charges scoped to one website", tags={  })
    @ApiResponses(value = { 
    ...
    @Operation(summary = "List the caller's webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List off-site cpmove backups stored in Swift — list or inline-download archive", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get a one-time auto-login URL for the website's control panel", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the webhosting welcome email with control-panel credentials and URL", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Read current reverse-DNS (PTR) records for the website's IPs", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Buy an additional IP for the website OR update reverse DNS records", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20027 postWebsiteBuyIp(IdBuyIpBody body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Submit a request for InterServer staff to migrate a website from another host", tags={  })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse20028 postWebsiteMigration(IdMigrationBody body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Bulk-update reverse-DNS (PTR) records for one or more website IPs", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate a webhosting order and preview cost — dry run, no charge", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/websites/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "POST mutation hook for the website detail page (use dedicated ops where possible)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/websites/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Schedule termination of a webhosting service — wipes panel account at cycle end", tags={  })
    @ApiResponses(value = { 
