...
public interface FloatingIpsApi  {
    ...
    @Operation(summary = "Place a real Floating IP order, create billing records, and provision the service", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Cancel a Floating IP service and release the IP — destructive, billing stops", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/floating_ips/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Fetch full details for one Floating IP service, including current target IP", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List all billing invoices charged against a specific Floating IP service", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/floating_ips")
    @Produces({ "application/json" })
    @Operation(summary = "List all Floating IP services on the authenticated customer's account", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend the Floating IP welcome / setup email to the account contact", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/floating_ips/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get pricing and service-type options for ordering a new Floating IP", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Re-point a Floating IP to a different target IP on one of the customer's services", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate a Floating IP order and price it without charging the customer", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/floating_ips/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update a Floating IP service's editable settings (label / metadata)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
