...
public interface ScrubIpsApi  {
    ...
    @Operation(summary = "Cancel a Scrub IP service and stop its recurring DDoS billing", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Apply a predefined scrubbing filter (DNS/HTTP/synproxy) to a port", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Add a geographic firewall rule (block/allow by country code or ASN)", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Add an L3/L4 firewall rule (allow/drop by IP, port, and protocol)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "Create firewall rule for scrub ip", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse201.class))),
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Remove a scrubbing filter by matching filter_type and port", tags={  })
    @ApiResponses(value = { 
    ...
    public InlineResponse20018 deleteFilter(CreateFilter body, @PathParam("id") Integer id);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Disable DDoS scrubbing and remove the BGP announcement on the IP", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Enable DDoS scrubbing (BGP announcement) on the service's protected IP", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get plans, pricing, and eligible IPs for a new Scrub IP order", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/scrub_ips/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get full Scrub IP service detail (rules + geo + filters)", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List enabled traffic filter profiles available for createFilter", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List recurring and one-time invoices billed for this Scrub IP service", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get last 50000 packet/event log entries for the protected IP", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/scrub_ips")
    @Produces({ "application/json" })
    @Operation(summary = "List all Scrub IP DDoS protection services on the authenticated account", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Place a new Scrub IP DDoS protection order and generate an invoice", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate a Scrub IP order and return effective pricing without billing", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Delete a geo firewall rule by rule_id from getScrubIpDetails", tags={  })
    @ApiResponses(value = { 
    ...
    public InlineResponse20017 scrubIpsDeleteGeoRule(DeleteGeoFirewallRule body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Delete an L3/L4 firewall rule by rule_id from getScrubIpDetails", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Delete firewall rule for scrub ip", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse20017.class))),
        @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse4002.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse5003.class))) })
    public InlineResponse20017 scrubIpsDeleteRule(DeleteFirewallRule body, @PathParam("id") Integer id);
}
