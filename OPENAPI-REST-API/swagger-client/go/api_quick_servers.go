...
/*
QuickServersApiService Place a QuickServer order, generating a real invoice and queuing provisioning
...
*/
func (a *QuickServersApiService) AddQs(ctx context.Context, body QsOrderRequest) (ServiceOrderPostResponse, *http.Response, error) {
	var (
...
/*
QuickServersApiService Permanently delete a QuickServer backup file from object storage
...
/*
QuickServersApiService Block outbound SMTP traffic on a QuickServer to halt mail abuse
...
/*
QuickServersApiService Disable the virtual CD/DVD drive device on a QuickServer
...
/*
QuickServersApiService Disable disk-quota enforcement at OS level on a QuickServer
...
/*
QuickServersApiService Eject the currently mounted ISO from a QuickServer&#x27;s virtual CD drive
...
/*
QuickServersApiService Enable disk-quota enforcement at OS level on a QuickServer
...
/*
QuickServersApiService Reboot a QuickServer with a graceful OS-level restart
...
/*
QuickServersApiService Power on a QuickServer that is currently stopped or pending boot
...
/*
QuickServersApiService Power off a QuickServer with a graceful shutdown command
...
/*
QuickServersApiService Generate a 24-hour pre-signed download URL for a QuickServer backup
...
func (a *QuickServersApiService) DownloadQsBackup(ctx context.Context, body IdBackupsBody, id int32, localVarOptionals *QuickServersApiDownloadQsBackupOpts) (InlineResponse20012, *http.Response, error) {
	var (
...
/*
QuickServersApiService Get QuickServer order form metadata and available plans/templates
...
/*
QuickServersApiService Queue creation of a new QuickServer backup snapshot (note: GET triggers job)
...
@return QueueResponse
*/
func (a *QuickServersApiService) GetQsBackup(ctx context.Context, id int32) (QueueResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
QuickServersApiService List available QuickServer backups across Swift, MinIO, and ZFS storage
...
/*
QuickServersApiService Get current QuickServer hostname plus change rules and platform support
...
/*
QuickServersApiService Get metadata for QuickServer root/OS password change requirements
...
/*
QuickServersApiService List timezones the QuickServer can be set to via change_timezone
...
/*
QuickServersApiService Get metadata for changing the Webuzo control panel admin password
...
/*
QuickServersApiService Get full details for one QuickServer including credentials and links
...
/*
QuickServersApiService List ISO images available to mount on a QuickServer&#x27;s virtual CD
...
/*
QuickServersApiService List billing invoices charged for one QuickServer service
...
/*
QuickServersApiService List QuickServer rapid-deploy dedicated servers on the account
...
/*
QuickServersApiService List OS templates available for a QuickServer reinstall
...
/*
QuickServersApiService Get options for QuickServer randomized root password reset
...
/*
QuickServersApiService Get reverse DNS (PTR) records for all of a QuickServer&#x27;s IPs
...
/*
QuickServersApiService Get current VNC console connection details for a QuickServer
...
/*
QuickServersApiService Get bandwidth usage for the QuickServer&#x27;s current billing period
...
/*
QuickServersApiService Get the full QuickServer dashboard view payload (rich format)
...
/*
QuickServersApiService Resend the QuickServer welcome email with login credentials
...
/*
QuickServersApiService Change a QuickServer&#x27;s system hostname (OpenVZ/Virtuozzo only)
...
/*
QuickServersApiService Change QuickServer root/administrator password to a chosen value
...
/*
QuickServersApiService Change the system timezone on a QuickServer to a catalog entry
...
/*
QuickServersApiService Change Webuzo control panel admin password live (synchronous, not queued)
...
/*
QuickServersApiService Mount an ISO image as the QuickServer&#x27;s virtual CD via URL
...
/*
QuickServersApiService Reinstall the operating system on a QuickServer (DESTRUCTIVE — wipes disk)
...
/*
QuickServersApiService Reset QuickServer root password to a server-generated random value
...
/*
QuickServersApiService Update reverse DNS (PTR) records for a QuickServer&#x27;s IPs
...
/*
QuickServersApiService Configure the source IP allowed to reach a QuickServer&#x27;s VNC console
...
/*
QuickServersApiService Query QuickServer bandwidth usage via POST (filtered variant)
...
/*
QuickServersApiService Submit changes and re-fetch the QuickServer dashboard view payload
...
/*
QuickServersApiService Restore a QuickServer from a backup (DESTRUCTIVE — overwrites disk)
...
/*
QuickServersApiService Validate a QuickServer order without charging or provisioning
...
*/
func (a *QuickServersApiService) PutQs(ctx context.Context, body QsOrderRequest) (*http.Response, error) {
	var (
...
/*
QuickServersApiService Cancel a QuickServer service at the end of the current billing cycle
...
*/
func (a *QuickServersApiService) QuickserversCancel(ctx context.Context, id int32) (InlineResponse20011, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
QuickServersApiService Update QuickServer order metadata or stored settings without OS impact
