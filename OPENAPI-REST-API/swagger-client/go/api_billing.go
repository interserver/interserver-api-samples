...
/*
BillingApiService Store a credit card on the account — may return a verification flow
...
/*
BillingApiService Create a prepay deposit and return an invoice id to fund it
...
/*
BillingApiService Remove a stored credit card from the account
...
/*
BillingApiService Cancel a pending unpaid invoice — and its pending service or repeat invoice
...
/*
BillingApiService Delete an unfunded prepay or strip its unpaid funding invoices
...
/*
BillingApiService List affiliate banner image assets with filename and dimensions
...
/*
BillingApiService Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BillingApiGetAffiliateDownloadOpts - Optional Parameters:
     * @param "St" (optional.String) -  Filter by status.
     * @param "Ex" (optional.String) -  Export format: csv, xls, xlsx, or pdf. Defaults to csv.
     * @param "Year" (optional.Int32) -  Year to filter the report. Defaults to the current year.

*/

type BillingApiGetAffiliateDownloadOpts struct {
    St optional.String
    Ex optional.String
    Year optional.Int32
}

func (a *BillingApiService) GetAffiliateDownload(ctx context.Context, localVarOptionals *BillingApiGetAffiliateDownloadOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/affiliate/download"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.St.IsSet() {
		localVarQueryParams.Add("st", parameterToString(localVarOptionals.St.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Ex.IsSet() {
		localVarQueryParams.Add("ex", parameterToString(localVarOptionals.Ex.Value(), ""))
	}
...
/*
BillingApiService Read a combined affiliate performance summary (HTML payload)
...
/*
BillingApiService Read aggregated affiliate sales time-series (monthly buckets) for chart rendering
...
/*
BillingApiService Read affiliate signup stats and per-customer conversion data
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BillingApiGetAffiliateSignupsOpts - Optional Parameters:
     * @param "St" (optional.String) -  Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results.
@return InlineResponse2001
*/

type BillingApiGetAffiliateSignupsOpts struct {
    St optional.String
}

func (a *BillingApiService) GetAffiliateSignups(ctx context.Context, localVarOptionals *BillingApiGetAffiliateSignupsOpts) (InlineResponse2001, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/affiliate/signups"
...
/*
BillingApiService Read aggregated affiliate referral click/visit time-series for chart rendering
...
/*
BillingApiService List the 20 most recent affiliate referral visits with IP, referrer, timestamp
...
/*
BillingApiService Read the current shopping cart contents, totals, and available payment methods
...
/*
BillingApiService Probe whether a stored card still needs micro-charge verification
...
/*
BillingApiService Read full invoice detail — line items, totals, paid status, customer info
...
/*
BillingApiService List every invoice on the account with summary totals and paid/unpaid status
...
/*
BillingApiService List prepay deposits on the account — remaining balance and auto-use flags
...
/*
BillingApiService Pay invoices through the chosen gateway — returns the next-step action
...
*/
func (a *BillingApiService) InitiatePayment(ctx context.Context, method string, invoices string) (InlineResponse20010, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/billing/pay/{method}/{invoices}"
...
/*
BillingApiService Place two micro-charges on the card to start CVV verification (step 1 of 2)
...
@return SuccessTextResponse
*/
func (a *BillingApiService) PatchBillingCreditCardVerify(ctx context.Context, body IdVerifyBody, id int32) (SuccessTextResponse, *http.Response, error) {
	var (
...
/*
BillingApiService Submit two micro-charge amounts to finalize card verification (step 2 of 2)
...
/*
BillingApiService Configure the affiliate landing dock title, description, and referrer coupon
...
/*
BillingApiService Configure how affiliate commissions get paid out (PayPal or internal prepay)
...
/*
BillingApiService Refresh stored card expiration and re-trigger MaxMind fraud scoring
...
/*
BillingApiService Set the account&#x27;s default payment method for recurring/auto charges
