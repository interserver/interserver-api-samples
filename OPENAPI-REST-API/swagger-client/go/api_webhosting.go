...
/*
WebhostingApiService Place a new webhosting order, create the invoice, and queue provisioning
...
*/
func (a *WebhostingApiService) AddWebsite(ctx context.Context, body WebsiteOrderPostRequest) (ServiceOrderPostResponse, *http.Response, error) {
	var (
...
/*
WebhostingApiService Read the webhosting order catalog — plans, packages, promo offers, pricing
...
/*
WebhostingApiService Read website IPs, current reverse DNS, and additional-IP pricing
...
*/
func (a *WebhostingApiService) GetWebsiteBuyIp(ctx context.Context, id int32) (InlineResponse20026, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
WebhostingApiService Read full configuration and status detail for one webhosting service
...
/*
WebhostingApiService List all billing invoices and recurring charges scoped to one website
...
/*
WebhostingApiService List the caller&#x27;s webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services
...
/*
WebhostingApiService List off-site cpmove backups stored in Swift — list or inline-download archive
...
/*
WebhostingApiService Get a one-time auto-login URL for the website&#x27;s control panel
...
/*
WebhostingApiService Resend the webhosting welcome email with control-panel credentials and URL
...
/*
WebhostingApiService Read current reverse-DNS (PTR) records for the website&#x27;s IPs
...
/*
WebhostingApiService Buy an additional IP for the website OR update reverse DNS records
...
*/
func (a *WebhostingApiService) PostWebsiteBuyIp(ctx context.Context, body IdBuyIpBody, id int32) (InlineResponse20027, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
WebhostingApiService Submit a request for InterServer staff to migrate a website from another host
...
*/
func (a *WebhostingApiService) PostWebsiteMigration(ctx context.Context, body IdMigrationBody, id int32) (InlineResponse20028, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
WebhostingApiService Bulk-update reverse-DNS (PTR) records for one or more website IPs
...
/*
WebhostingApiService Validate a webhosting order and preview cost — dry run, no charge
...
*/
func (a *WebhostingApiService) PutWebsites(ctx context.Context, body WebsiteOrderPutRequest) (*http.Response, error) {
	var (
...
/*
WebhostingApiService POST mutation hook for the website detail page (use dedicated ops where possible)
...
/*
WebhostingApiService Schedule termination of a webhosting service — wipes panel account at cycle end
...
*/
func (a *WebhostingApiService) WebhostingCancel(ctx context.Context, id string) (InlineResponse20025, *http.Response, error) {
	var (
