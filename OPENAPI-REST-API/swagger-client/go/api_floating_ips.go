...
/*
FloatingIPsApiService Place a real Floating IP order, create billing records, and provision the service
...
*/
func (a *FloatingIPsApiService) AddFloatingIp(ctx context.Context, body FloatingIpOrderRequest) (ServiceOrderPostResponse, *http.Response, error) {
	var (
...
/*
FloatingIPsApiService Cancel a Floating IP service and release the IP — destructive, billing stops
...
*/
func (a *FloatingIPsApiService) FloatingIpsCancel(ctx context.Context, id int32) (InlineResponse2004, *http.Response, error) {
	var (
...
/*
FloatingIPsApiService Fetch full details for one Floating IP service, including current target IP
...
/*
FloatingIPsApiService List all billing invoices charged against a specific Floating IP service
...
/*
FloatingIPsApiService List all Floating IP services on the authenticated customer&#x27;s account
...
/*
FloatingIPsApiService Resend the Floating IP welcome / setup email to the account contact
...
/*
FloatingIPsApiService Get pricing and service-type options for ordering a new Floating IP
...
/*
FloatingIPsApiService Re-point a Floating IP to a different target IP on one of the customer&#x27;s services
...
/*
FloatingIPsApiService Validate a Floating IP order and price it without charging the customer
...
*/
func (a *FloatingIPsApiService) PutFloatingIps(ctx context.Context, body FloatingIpOrderRequest) (*http.Response, error) {
	var (
...
/*
FloatingIPsApiService Update a Floating IP service&#x27;s editable settings (label / metadata)
