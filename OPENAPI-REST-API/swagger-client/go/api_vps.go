...
/*
VPSApiService Place a new VPS order, create the invoice, and queue provisioning
...
/*
VPSApiService Permanently delete a VPS backup file by name (irreversible)
...
/*
VPSApiService Block outbound SMTP (port 25) on the VPS to prevent spam/abuse
...
/*
VPSApiService Remove the virtual CD/DVD device entirely from the VPS configuration
...
/*
VPSApiService Disable per-user disk quota enforcement inside the VPS guest OS
...
/*
VPSApiService Eject the mounted ISO from the VPS virtual CD drive (keep the drive)
...
/*
VPSApiService Enable per-user disk quota enforcement inside the VPS guest OS
...
/*
VPSApiService Reboot the VPS — preferred over stop+start for software changes
...
/*
VPSApiService Power on a stopped VPS instance
...
/*
VPSApiService Power off a running VPS — billing continues until cancellation
...
/*
VPSApiService Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
...
func (a *VPSApiService) DownloadVpsBackup(ctx context.Context, body IdBackupsBody2, id int32, localVarOptionals *VPSApiDownloadVpsBackupOpts) (InlineResponse20012, *http.Response, error) {
	var (
...
/*
VPSApiService Get the VPS order catalog — platforms, OS templates, locations, pricing
...
/*
VPSApiService Trigger a manual on-demand snapshot/backup of the VPS
...
@return QueueResponse
*/
func (a *VPSApiService) GetVpsBackup(ctx context.Context, id int32) (QueueResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
VPSApiService List existing backups for the VPS across Swift, MinIO, and ZFS
...
/*
VPSApiService Get current additional disk size and per-GB monthly cost for the VPS
...
/*
VPSApiService Read current additional IPs, cap, and per-IP monthly cost for the VPS
...
/*
VPSApiService Read the VPS&#x27;s current hostname before changing it
...
*/
func (a *VPSApiService) GetVpsChangeHostname(ctx context.Context, id int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
VPSApiService Pre-flight check before changing the VPS root password
...
*/
func (a *VPSApiService) GetVpsChangeRootPassword(ctx context.Context, id int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
VPSApiService List IANA timezones supported by the VPS guest OS
...
/*
VPSApiService Get full details for one VPS — IPs, hostname, OS, slices, status, addons
...
/*
VPSApiService List ISO templates that can be mounted in the VPS virtual CD drive
...
*/
func (a *VPSApiService) GetVpsInsertCd(ctx context.Context, id int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
VPSApiService List all billing invoices associated with this specific VPS
...
/*
VPSApiService List all VPS services on the customer&#x27;s account
...
/*
VPSApiService List OS templates compatible with this VPS&#x27;s hypervisor for reinstall
...
/*
VPSApiService Pre-flight check before resetting the VPS root password to a random value
...
*/
func (a *VPSApiService) GetVpsResetPassword(ctx context.Context, id int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
VPSApiService Read the current PTR (reverse-DNS) records for every IP on the VPS
...
/*
VPSApiService Read current VNC console connection info for the VPS
...
/*
VPSApiService Read current slice count, min/max range, and prorated per-slice upgrade cost
...
/*
VPSApiService Read bandwidth traffic usage data for the VPS
...
/*
VPSApiService Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS
...
/*
VPSApiService Resend the welcome email containing VPS IP, hostname, and root credentials
...
/*
VPSApiService Buy or resize the VPS additional-disk addon and create a prorated invoice
...
/*
VPSApiService Purchase one additional IP for the VPS and create the invoice
...
/*
VPSApiService Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP
...
/*
VPSApiService Set a specific new root/Administrator password on the VPS
...
/*
VPSApiService Set the system timezone on the VPS guest OS
...
/*
VPSApiService Rotate the Webuzo control panel admin password (re-auth required)
...
/*
VPSApiService Mount an ISO image in the VPS virtual CD drive from a URL
...
/*
VPSApiService Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)
...
/*
VPSApiService Reset the VPS root password to a server-generated random value
...
/*
VPSApiService Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
...
/*
VPSApiService Bulk-update PTR (reverse-DNS) records for one or more VPS IPs
...
/*
VPSApiService Provision or refresh the VNC console endpoint for the VPS
...
/*
VPSApiService Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)
...
/*
VPSApiService Search/filter VPS bandwidth usage with custom criteria (reserved)
...
*/
func (a *VPSApiService) PostVpsTrafficUsage(ctx context.Context, id int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
VPSApiService Refresh the remote-desktop session connection info after IP/hostname changes
...
/*
VPSApiService Validate a VPS order configuration and quote the cost — dry run, no charge
...
/*
VPSApiService Preview cost to set additional VPS disk to a target GB size — dry run
...
*/
func (a *VPSApiService) PutVpsBuyHdSpace(ctx context.Context, id int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
VPSApiService Update editable settings on a VPS service record
...
/*
VPSApiService Cancel a VPS service at the end of the current billing cycle
...
*/
func (a *VPSApiService) VPSCancel(ctx context.Context, id int32) (InlineResponse20024, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
