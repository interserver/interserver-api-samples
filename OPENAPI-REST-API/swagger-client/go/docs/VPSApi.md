...
# **DownloadVpsBackup**
> InlineResponse20012 DownloadVpsBackup(ctx, body, file, id, optional)
...
# **GetVpsBackup**
> QueueResponse GetVpsBackup(ctx, id)
...
> GetVpsChangeRootPassword(ctx, id)
...
# **VPSCancel**
> InlineResponse20024 VPSCancel(ctx, id)
