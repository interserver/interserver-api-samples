...
> []string GetAccountCurrencies(ctx, )
...
# **GetAccountLocales**
> map[string]InlineResponseMap200 GetAccountLocales(ctx, )
...
# **GetOauthRedirect**
> InlineResponse2006 GetOauthRedirect(ctx, provider)
...
# **PatchOauthTwoFactor**
> InlineResponse2008 PatchOauthTwoFactor(ctx, body, accountId, code)
...
# **PostOauthCallback**
> InlineResponse2007 PostOauthCallback(ctx, provider, optional)
