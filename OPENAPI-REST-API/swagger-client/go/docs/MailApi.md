...
# **AddMail**
> ServiceOrderPostResponse AddMail(ctx, body)
...
# **DeleteMailAlert**
> SuccessTextResponse DeleteMailAlert(ctx, body, alertId, id)
...
# **MailCancel**
> InlineResponse2009 MailCancel(ctx, id)
...
# **UpdateRule**
> GenericResponse UpdateRule(ctx, body, user, type_, data, id, rule)
