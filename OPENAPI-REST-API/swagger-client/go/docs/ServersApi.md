...
# **AddServer**
> InlineResponse20021 AddServer(ctx, body)
...
# **BuyItNowServerOrder**
> InlineResponse20029 BuyItNowServerOrder(ctx, )
...
> ServerBulkIpmiPowerResponse ServerBulkIpmiPowerGet(ctx, ids)
...
# **ServersCancel**
> InlineResponse20022 ServersCancel(ctx, id)
