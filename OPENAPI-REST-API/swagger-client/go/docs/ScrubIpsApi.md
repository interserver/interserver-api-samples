...
# **CancelScrubIp**
> InlineResponse20014 CancelScrubIp(ctx, id)
...
# **DeleteFilter**
> InlineResponse20018 DeleteFilter(ctx, body, id)
...
# **DisableScrub**
> InlineResponse20016 DisableScrub(ctx, id)
...
# **EnableScrub**
> InlineResponse20015 EnableScrub(ctx, id)
...
# **GetOrderDetail**
> InlineResponse20019 GetOrderDetail(ctx, )
...
# **GetScrubIpDetails**
> InlineResponse20013 GetScrubIpDetails(ctx, id)
...
# **PutScrubIps**
> InlineResponse20020 PutScrubIps(ctx, body)
...
> InlineResponse20017 ScrubIpsDeleteGeoRule(ctx, body, id)
...
# **ScrubIpsDeleteRule**
> InlineResponse20017 ScrubIpsDeleteRule(ctx, body, id)
