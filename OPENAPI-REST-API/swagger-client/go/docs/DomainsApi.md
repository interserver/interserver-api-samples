...
# **AddDomain**
> ServiceOrderPostResponse AddDomain(ctx, body)
...
# **CancelDomain**
> InlineResponse2003 CancelDomain(ctx, id)
...
# **DeleteDomainDnssec**
> SuccessTextResponse DeleteDomainDnssec(ctx, id)
