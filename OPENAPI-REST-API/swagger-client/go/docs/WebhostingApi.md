...
# **AddWebsite**
> ServiceOrderPostResponse AddWebsite(ctx, body)
...
# **GetWebsiteBuyIp**
> InlineResponse20026 GetWebsiteBuyIp(ctx, id)
...
# **PostWebsiteBuyIp**
> InlineResponse20027 PostWebsiteBuyIp(ctx, body, ips, id)
...
> InlineResponse20028 PostWebsiteMigration(ctx, body, custPortal, regEmail, password, ctrlPanel, ftpUsername, ftpPassword, siteBusyMig, splReqMig, domainReg, dataMig, domainRegPortal, domainRegEmail, domainRegPassword, id)
...
# **WebhostingCancel**
> InlineResponse20025 WebhostingCancel(ctx, id)
