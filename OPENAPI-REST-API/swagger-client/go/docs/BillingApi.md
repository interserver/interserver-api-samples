...
> GetAffiliateDownload(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***BillingApiGetAffiliateDownloadOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a BillingApiGetAffiliateDownloadOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **optional.String**| Filter by status. | 
 **ex** | **optional.String**| Export format: csv, xls, xlsx, or pdf. Defaults to csv. | 
 **year** | **optional.Int32**| Year to filter the report. Defaults to the current year. | 
...
# **GetAffiliateSignups**
> InlineResponse2001 GetAffiliateSignups(ctx, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***BillingApiGetAffiliateSignupsOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a BillingApiGetAffiliateSignupsOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **optional.String**| Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. | 
...
# **InitiatePayment**
> InlineResponse20010 InitiatePayment(ctx, method, invoices)
...
> SuccessTextResponse PatchBillingCreditCardVerify(ctx, body, ccCcv2, id)
