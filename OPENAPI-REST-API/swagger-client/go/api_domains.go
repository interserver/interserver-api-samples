...
/*
DomainsApiService Place a new domain registration or transfer order, generate billing invoice
...
*/
func (a *DomainsApiService) AddDomain(ctx context.Context, body ModelMap) (ServiceOrderPostResponse, *http.Response, error) {
	var (
...
/*
DomainsApiService Register DNSSEC DS records on the domain at OpenSRS
...
/*
DomainsApiService Register a new nameserver host with glue IP at the registry (registered nameserver)
...
/*
DomainsApiService Cancel a domain order in the billing system to stop auto-renewals
...
*/
func (a *DomainsApiService) CancelDomain(ctx context.Context, id int32) (InlineResponse2003, *http.Response, error) {
	var (
...
/*
DomainsApiService Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)
...
@return SuccessTextResponse
*/
func (a *DomainsApiService) DeleteDomainDnssec(ctx context.Context, id int32) (SuccessTextResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DomainsApiService Remove one registered nameserver glue record from the domain
...
/*
DomainsApiService Read the current registrant/admin/tech/billing contact field set for a domain
...
/*
DomainsApiService Read the DNSSEC DS record set currently registered with the registrar
...
/*
DomainsApiService Read full billing, registrar, and service detail for one domain
...
/*
DomainsApiService List all billing invoices scoped to one domain order
...
/*
DomainsApiService Check availability, premium status, and pricing for a specific domain
...
/*
DomainsApiService List registered nameserver hosts and glue IP addresses for a domain
...
/*
DomainsApiService Read renewal pricing, expiry, and whether a renewal invoice already exists
...
/*
DomainsApiService Get registrar-suggested domain alternatives and bulk availability for a search term
...
/*
DomainsApiService Read OpenSRS transfer status for an in-progress domain transfer order
...
/*
DomainsApiService Read Whois privacy availability, current state, and add-on pricing for a domain
...
/*
DomainsApiService List every domain registration on the account with billing and registration metadata
...
/*
DomainsApiService Resend the domain welcome email with registration details and management instructions
...
/*
DomainsApiService Read the buyable domain TLD service catalog and Whois privacy pricing
...
/*
DomainsApiService Validate posted domain-order field values before committing — dry run
...
*/
func (a *DomainsApiService) PatchDomains(ctx context.Context, body ModelMap) (*http.Response, error) {
	var (
...
/*
DomainsApiService Submit a domain renewal request and generate the renewal invoice
...
/*
DomainsApiService Get the full order form data for a hostname in one round-trip (search → order preview)
...
*/
func (a *DomainsApiService) PostDomainSearch(ctx context.Context, name string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DomainsApiService Re-poll OpenSRS transfer status for a domain order via POST
...
/*
DomainsApiService Preview per-TLD field requirements for a domain order — no commit
...
*/
func (a *DomainsApiService) PutDomains(ctx context.Context, body ModelMap) (*http.Response, error) {
	var (
...
/*
DomainsApiService Update registrant/admin contact details and push them to OpenSRS
...
/*
DomainsApiService POST mutation hook for the domain detail page (use dedicated ops where possible)
...
@return SuccessTextResponse
*/
func (a *DomainsApiService) UpdateDomainInfo(ctx context.Context, id int32) (SuccessTextResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DomainsApiService Replace the full authoritative-nameserver delegation list at the registrar
...
/*
DomainsApiService Order, enable, or cancel the Whois privacy add-on for a domain
