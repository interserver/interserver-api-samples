...
@Parameter(description = "" ,required=true) ServerOrderPostRequest body
) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response serverBulkIpmiPowerGet( @NotNull 
@Parameter(description = "Comma-separated list of Server IDs to query (e.g. `2313,2314,2315`). May also be passed as repeated `ids[]` query parameters.",required=true)  @QueryParam("ids") String ids
) {
