...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getAffiliateDownload( 
@Parameter(description = "Filter by status.")  @QueryParam("st") String st
,  
@Parameter(description = "Export format: csv, xls, xlsx, or pdf. Defaults to csv.", schema=@Schema(allowableValues={ "csv", "xls", "xlsx", "pdf" })
)  @QueryParam("ex") String ex
,  
@Parameter(description = "Year to filter the report. Defaults to the current year.")  @QueryParam("year") Integer year
) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getAffiliateSignups( 
@Parameter(description = "Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.")  @QueryParam("st") String st
) {
