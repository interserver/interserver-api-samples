...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response addServer(@Parameter(description = "" ,required=true) ServerOrderPostRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response serverBulkIpmiPowerGet( @NotNull @QueryParam("ids") String ids,@Context SecurityContext securityContext);
