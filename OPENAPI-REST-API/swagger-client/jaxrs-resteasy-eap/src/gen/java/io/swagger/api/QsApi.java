...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response addQs(@Parameter(description = "" ,required=true) QsOrderRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsBackup( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response putQs(@Parameter(description = "" ,required=true) QsOrderRequest body,@Context SecurityContext securityContext);
