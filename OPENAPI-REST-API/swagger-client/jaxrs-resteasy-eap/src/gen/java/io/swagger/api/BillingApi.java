...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response patchBillingCreditCardVerify(@Parameter(description = "" ,required=true) IdVerifyBody body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response patchBillingCreditCardVerify(@Parameter(description = "", required=true)@FormParam("cc_ccv2")  String ccCcv2, @PathParam("id") Integer id,@Context SecurityContext securityContext);
