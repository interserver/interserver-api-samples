...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    Response addMail(@Parameter(description = "" ,required=true) MailOrderRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    Response deleteMailAlert(@Parameter(description = "" ,required=true) IdAlertsBody body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    Response deleteMailAlert(@Parameter(description = "", required=true)@FormParam("alert_id")  Integer alertId, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    Response putMail(@Parameter(description = "" ,required=true) MailOrderRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    Response updateRule(@Parameter(description = "" ,required=true) DenyRuleNew body, @PathParam("id") Integer id, @PathParam("rule") String rule,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Mail" })
    ...
    Response updateRule(@Parameter(description = "", required=true)@FormParam("user")  String user,@Parameter(description = "", required=true, schema=@Schema(allowableValues={ "domain", "email", "startswith", "destination" })
)@FormParam("type")  String type,@Parameter(description = "", required=true)@FormParam("data")  String data, @PathParam("id") Integer id, @PathParam("rule") String rule,@Context SecurityContext securityContext);
