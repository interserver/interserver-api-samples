...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Licenses" })
    ...
    Response addLicense(@Parameter(description = "" ,required=true) LicenseOrderRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Licenses" })
    ...
    Response putLicenses(@Parameter(description = "" ,required=true) LicenseOrderRequest body,@Context SecurityContext securityContext);
