...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    Response addSsl(@Parameter(description = "" ,required=true) SslOrderRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "SSL-Certificates" })
    ...
    Response putSsl(@Parameter(description = "" ,required=true) SslOrderRequest body,@Context SecurityContext securityContext);
