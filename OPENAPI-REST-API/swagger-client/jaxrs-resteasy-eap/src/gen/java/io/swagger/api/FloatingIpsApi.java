...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    Response addFloatingIp(@Parameter(description = "" ,required=true) FloatingIpOrderRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    Response putFloatingIps(@Parameter(description = "" ,required=true) FloatingIpOrderRequest body,@Context SecurityContext securityContext);
