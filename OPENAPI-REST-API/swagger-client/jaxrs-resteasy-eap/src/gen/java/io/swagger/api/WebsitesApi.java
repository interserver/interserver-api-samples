...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    Response addWebsite(@Parameter(description = "" ,required=true) WebsiteOrderPostRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Webhosting" })
    ...
    Response putWebsites(@Parameter(description = "" ,required=true) WebsiteOrderPutRequest body,@Context SecurityContext securityContext);
