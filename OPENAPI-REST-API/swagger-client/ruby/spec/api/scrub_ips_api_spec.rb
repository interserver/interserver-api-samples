...
# Unit tests for InterserverApiClient::ScrubIpsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ScrubIpsApi' do
  before do
    # run before each test
    @instance = InterserverApiClient::ScrubIpsApi.new
  end
  ...
  describe 'test an instance of ScrubIpsApi' do
    it 'should create an instance of ScrubIpsApi' do
      expect(@instance).to be_instance_of(InterserverApiClient::ScrubIpsApi)
    end
  end
