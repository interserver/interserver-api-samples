...
# Unit tests for InterserverApiClient::PublicApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PublicApi' do
  before do
    # run before each test
    @instance = InterserverApiClient::PublicApi.new
  end
  ...
  describe 'test an instance of PublicApi' do
    it 'should create an instance of PublicApi' do
      expect(@instance).to be_instance_of(InterserverApiClient::PublicApi)
    end
  end
  ...
  # @return [Array<String>]
  describe 'get_account_currencies test' do
    it 'should work' do
  ...
  describe 'get_account_locales test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
