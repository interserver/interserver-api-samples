...
# Unit tests for InterserverApiClient::QuickServersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QuickServersApi' do
  before do
    # run before each test
    @instance = InterserverApiClient::QuickServersApi.new
  end
  ...
  describe 'test an instance of QuickServersApi' do
    it 'should create an instance of QuickServersApi' do
      expect(@instance).to be_instance_of(InterserverApiClient::QuickServersApi)
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @return [QueueResponse]
  describe 'get_qs_backup test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
