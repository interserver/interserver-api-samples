...
# Unit tests for InterserverApiClient::BackupsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BackupsApi' do
  before do
    # run before each test
    @instance = InterserverApiClient::BackupsApi.new
  end
  ...
  describe 'test an instance of BackupsApi' do
    it 'should create an instance of BackupsApi' do
      expect(@instance).to be_instance_of(InterserverApiClient::BackupsApi)
    end
  end
