...
# Unit tests for InterserverApiClient::LicensesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LicensesApi' do
  before do
    # run before each test
    @instance = InterserverApiClient::LicensesApi.new
  end
  ...
  describe 'test an instance of LicensesApi' do
    it 'should create an instance of LicensesApi' do
      expect(@instance).to be_instance_of(InterserverApiClient::LicensesApi)
    end
  end
