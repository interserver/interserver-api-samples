...
# Unit tests for InterserverApiClient::TicketsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TicketsApi' do
  before do
    # run before each test
    @instance = InterserverApiClient::TicketsApi.new
  end
  ...
  describe 'test an instance of TicketsApi' do
    it 'should create an instance of TicketsApi' do
      expect(@instance).to be_instance_of(InterserverApiClient::TicketsApi)
    end
  end
