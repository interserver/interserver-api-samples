...
# Unit tests for InterserverApiClient::SSLCertificatesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SSLCertificatesApi' do
  before do
    # run before each test
    @instance = InterserverApiClient::SSLCertificatesApi.new
  end
  ...
  describe 'test an instance of SSLCertificatesApi' do
    it 'should create an instance of SSLCertificatesApi' do
      expect(@instance).to be_instance_of(InterserverApiClient::SSLCertificatesApi)
    end
  end
