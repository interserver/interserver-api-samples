...
# Unit tests for InterserverApiClient::ServersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ServersApi' do
  before do
    # run before each test
    @instance = InterserverApiClient::ServersApi.new
  end
  ...
  describe 'test an instance of ServersApi' do
    it 'should create an instance of ServersApi' do
      expect(@instance).to be_instance_of(InterserverApiClient::ServersApi)
    end
  end
