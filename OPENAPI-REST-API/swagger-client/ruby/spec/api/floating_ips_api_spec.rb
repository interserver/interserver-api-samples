...
# Unit tests for InterserverApiClient::FloatingIPsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FloatingIPsApi' do
  before do
    # run before each test
    @instance = InterserverApiClient::FloatingIPsApi.new
  end
  ...
  describe 'test an instance of FloatingIPsApi' do
    it 'should create an instance of FloatingIPsApi' do
      expect(@instance).to be_instance_of(InterserverApiClient::FloatingIPsApi)
    end
  end
