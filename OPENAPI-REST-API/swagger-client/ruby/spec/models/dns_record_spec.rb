...
# Unit tests for InterserverApiClient::DnsRecord
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DnsRecord' do
  before do
    # run before each test
    @instance = InterserverApiClient::DnsRecord.new
  end
  ...
  describe 'test an instance of DnsRecord' do
    it 'should create an instance of DnsRecord' do
      expect(@instance).to be_instance_of(InterserverApiClient::DnsRecord)
    end
  end
