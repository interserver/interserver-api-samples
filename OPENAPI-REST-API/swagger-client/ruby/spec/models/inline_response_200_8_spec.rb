...
# Unit tests for InterserverApiClient::InlineResponse2008
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2008' do
  before do
    # run before each test
    @instance = InterserverApiClient::InlineResponse2008.new
  end
  ...
  describe 'test an instance of InlineResponse2008' do
    it 'should create an instance of InlineResponse2008' do
      expect(@instance).to be_instance_of(InterserverApiClient::InlineResponse2008)
    end
  end
