...
# Unit tests for InterserverApiClient::InlineResponse2006
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2006' do
  before do
    # run before each test
    @instance = InterserverApiClient::InlineResponse2006.new
  end
  ...
  describe 'test an instance of InlineResponse2006' do
    it 'should create an instance of InlineResponse2006' do
      expect(@instance).to be_instance_of(InterserverApiClient::InlineResponse2006)
    end
  end
