...
# Unit tests for InterserverApiClient::InlineResponse20010
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20010' do
  before do
    # run before each test
    @instance = InterserverApiClient::InlineResponse20010.new
  end
  ...
  describe 'test an instance of InlineResponse20010' do
    it 'should create an instance of InlineResponse20010' do
      expect(@instance).to be_instance_of(InterserverApiClient::InlineResponse20010)
    end
  end
