...
# Unit tests for InterserverApiClient::InlineResponse20029
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20029' do
  before do
    # run before each test
    @instance = InterserverApiClient::InlineResponse20029.new
  end
  ...
  describe 'test an instance of InlineResponse20029' do
    it 'should create an instance of InlineResponse20029' do
      expect(@instance).to be_instance_of(InterserverApiClient::InlineResponse20029)
    end
  end
