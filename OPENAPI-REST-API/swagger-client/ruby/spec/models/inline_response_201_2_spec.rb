...
# Unit tests for InterserverApiClient::InlineResponse2012
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2012' do
  before do
    # run before each test
    @instance = InterserverApiClient::InlineResponse2012.new
  end
  ...
  describe 'test an instance of InlineResponse2012' do
    it 'should create an instance of InlineResponse2012' do
      expect(@instance).to be_instance_of(InterserverApiClient::InlineResponse2012)
    end
  end
