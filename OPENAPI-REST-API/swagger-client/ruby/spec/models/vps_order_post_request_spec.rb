...
# Unit tests for InterserverApiClient::VpsOrderPostRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VpsOrderPostRequest' do
  before do
    # run before each test
    @instance = InterserverApiClient::VpsOrderPostRequest.new
  end
  ...
  describe 'test an instance of VpsOrderPostRequest' do
    it 'should create an instance of VpsOrderPostRequest' do
      expect(@instance).to be_instance_of(InterserverApiClient::VpsOrderPostRequest)
    end
  end
