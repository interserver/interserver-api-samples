...
module InterserverApiClient
  class QuickServersApi
    ...
    def add_qs(body, opts = {})
      data, _status_code, _headers = add_qs_with_http_info(body, opts)
      data
    end
    ...
    def add_qs_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuickServersApi.add_qs ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling QuickServersApi.add_qs"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def put_qs(body, opts = {})
      put_qs_with_http_info(body, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def put_qs_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: QuickServersApi.put_qs ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling QuickServersApi.put_qs"
      end
      # resource path
      local_var_path = '/qs/order'
