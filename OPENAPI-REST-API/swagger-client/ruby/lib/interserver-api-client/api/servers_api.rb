...
module InterserverApiClient
  class ServersApi
    ...
    def add_server(body, opts = {})
      data, _status_code, _headers = add_server_with_http_info(body, opts)
      data
    end
    ...
    def add_server_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServersApi.add_server ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ServersApi.add_server"
      end
      # resource path
    ...
    def server_bulk_ipmi_power_get_with_http_info(ids, opts = {})
      ...
      return_type = opts[:return_type] || 'ServerBulkIpmiPowerResponse' 
