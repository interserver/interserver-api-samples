...
module InterserverApiClient
  class WebhostingApi
    ...
    def add_website(body, opts = {})
      data, _status_code, _headers = add_website_with_http_info(body, opts)
      data
    end
    ...
    def add_website_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhostingApi.add_website ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling WebhostingApi.add_website"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def put_websites(body, opts = {})
      put_websites_with_http_info(body, opts)
      nil
    end
    ...
    def put_websites_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhostingApi.put_websites ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling WebhostingApi.put_websites"
      end
      # resource path
      local_var_path = '/websites/order'
