...
module InterserverApiClient
  class LicensesApi
    ...
    def add_license(body, opts = {})
      data, _status_code, _headers = add_license_with_http_info(body, opts)
      data
    end
    ...
    def add_license_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LicensesApi.add_license ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling LicensesApi.add_license"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def put_licenses(body, opts = {})
      put_licenses_with_http_info(body, opts)
      nil
    end
    ...
    def put_licenses_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LicensesApi.put_licenses ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling LicensesApi.put_licenses"
      end
      # resource path
      local_var_path = '/licenses/order'
