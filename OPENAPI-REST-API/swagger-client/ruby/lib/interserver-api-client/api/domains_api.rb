  ...
  class DomainsApi
    ...
    def add_domain_with_http_info(body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DomainsApi.add_domain"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def patch_domains(body, opts = {})
      patch_domains_with_http_info(body, opts)
      nil
    end
    ...
    def patch_domains_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainsApi.patch_domains ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DomainsApi.patch_domains"
      end
      # resource path
      local_var_path = '/domains/order'
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def put_domains(body, opts = {})
      put_domains_with_http_info(body, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def put_domains_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DomainsApi.put_domains ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DomainsApi.put_domains"
      end
      # resource path
      local_var_path = '/domains/order'
