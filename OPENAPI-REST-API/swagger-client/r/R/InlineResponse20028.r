  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`text`)) {
        InlineResponse20028Object[['text']] <- self$`text`
      }
      if (!is.null(self$`ticket`)) {
        InlineResponse20028Object[['ticket']] <- self$`ticket`
      }
    ...
    fromJSON = function(InlineResponse20028Json) {
      ...
      if (!is.null(InlineResponse20028Object$`text`)) {
        self$`text` <- InlineResponse20028Object$`text`
      }
      if (!is.null(InlineResponse20028Object$`ticket`)) {
        self$`ticket` <- InlineResponse20028Object$`ticket`
      }
    },
