...
api_instance = interserver_api_client.VPSApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.VpsOrderPostRequest() # VpsOrderPostRequest |  (optional)
...
# **download_vps_backup**
> InlineResponse20012 download_vps_backup(body, id, all=all)
...
# create an instance of the API class
api_instance = interserver_api_client.VPSApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.IdBackupsBody2() # IdBackupsBody2 | 
id = 56 # int | VPS ID number
all = 'all_example' # str | Set to `1` to list all backups across all services, not just the ones for the given VPS. (optional)
...
# create an instance of the API class
api_instance = interserver_api_client.VPSApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.RestoreRequest() # RestoreRequest | VPS Restore request
id = 56 # int | VPS ID number
...
# create an instance of the API class
api_instance = interserver_api_client.VPSApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.ReverseDnsEntries() # ReverseDnsEntries | 
id = 56 # int | VPS ID number
...
# create an instance of the API class
api_instance = interserver_api_client.VPSApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.VpsOrderPutRequest() # VpsOrderPutRequest |  (optional)
...
# **v_ps_cancel**
> InlineResponse20024 v_ps_cancel(id)
