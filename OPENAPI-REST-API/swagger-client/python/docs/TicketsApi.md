...
api_instance = interserver_api_client.TicketsApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.TicketNew() # TicketNew | 
...
body = interserver_api_client.ReplyTicketRequest() # ReplyTicketRequest |  (optional)
...
api_instance = interserver_api_client.TicketsApi(interserver_api_client.ApiClient(configuration))
id = 1.2 # float | The ticket ID number.
body = interserver_api_client.UpdateTicket() # UpdateTicket |  (optional)
