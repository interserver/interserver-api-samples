...
api_instance = interserver_api_client.DomainsApi(interserver_api_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = interserver_api_client.DomainsApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.DomainDnssecRequest() # DomainDnssecRequest | 
...
# create an instance of the API class
api_instance = interserver_api_client.DomainsApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.DomainNameserverPostRequest() # DomainNameserverPostRequest | 
id = 56 # int | The domain service ID. Use `domain_id` from `GET /domains`.
...
# create an instance of the API class
api_instance = interserver_api_client.DomainsApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.DomainContactDetails() # DomainContactDetails | 
id = 56 # int | The domain service ID. Use `domain_id` from `GET /domains`.
...
# create an instance of the API class
api_instance = interserver_api_client.DomainsApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.DomainNameserverPutRequest() # DomainNameserverPutRequest | 
id = 56 # int | The domain service ID. Use `domain_id` from `GET /domains`.
...
# create an instance of the API class
api_instance = interserver_api_client.DomainsApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.DomainWhoisPrivacyRequest() # DomainWhoisPrivacyRequest | 
id = 56 # int | The domain service ID. Use `domain_id` from `GET /domains`.
