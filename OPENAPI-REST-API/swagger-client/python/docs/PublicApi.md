...
api_instance = interserver_api_client.PublicApi(interserver_api_client.ApiClient(configuration))
...
# **get_account_locales**
> dict(str, InlineResponseMap200) get_account_locales()
...
# **get_oauth_redirect**
> InlineResponse2006 get_oauth_redirect(provider)
...
> InlineResponse2008 patch_oauth_two_factor(body)
...
# create an instance of the API class
api_instance = interserver_api_client.PublicApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.OauthBody2() # OauthBody2 | 
...
# **post_oauth_callback**
> InlineResponse2007 post_oauth_callback(provider, body=body)
...
api_instance = interserver_api_client.PublicApi(interserver_api_client.ApiClient(configuration))
provider = 'provider_example' # str | The OAuth provider name (e.g. `Google`).
body = interserver_api_client.OauthBody() # OauthBody |  (optional)
...
g_recaptcha_response = interserver_api_client.LoginSubmissionExampleGrecaptcharesponse() # LoginSubmissionExampleGrecaptcharesponse | 
tfa = 'tfa_example' # str | 
...
# create an instance of the API class
api_instance = interserver_api_client.PublicApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.LoginSubmissionExample() # LoginSubmissionExample |  (optional)
