...
# **add_website**
> ServiceOrderPostResponse add_website(body)
...
api_instance = interserver_api_client.WebhostingApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.WebsiteOrderPostRequest() # WebsiteOrderPostRequest | 
...
# **get_website_buy_ip**
> InlineResponse20026 get_website_buy_ip(id)
...
# **post_website_buy_ip**
> InlineResponse20027 post_website_buy_ip(body, id)
...
# create an instance of the API class
api_instance = interserver_api_client.WebhostingApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.IdBuyIpBody() # IdBuyIpBody | 
id = 56 # int | The website service ID. Use `website_id` from `GET /websites`.
...
> InlineResponse20028 post_website_migration(body, id)
...
# create an instance of the API class
api_instance = interserver_api_client.WebhostingApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.IdMigrationBody() # IdMigrationBody | 
id = 56 # int | The website service ID. Use `website_id` from `GET /websites`.
...
# create an instance of the API class
api_instance = interserver_api_client.WebhostingApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.WebsiteOrderPutRequest() # WebsiteOrderPutRequest | 
...
# **webhosting_cancel**
> InlineResponse20025 webhosting_cancel(id)
