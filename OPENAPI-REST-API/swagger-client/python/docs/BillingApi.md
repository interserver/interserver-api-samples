...
api_instance = interserver_api_client.BillingApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.BillingAddCcRequest() # BillingAddCcRequest | 
...
# create an instance of the API class
api_instance = interserver_api_client.BillingApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.BillingPrepayRequest() # BillingPrepayRequest | 
...
> InlineResponse2001 get_affiliate_signups(st=st)
...
# **initiate_payment**
> InlineResponse20010 initiate_payment(method, invoices)
...
> SuccessTextResponse patch_billing_credit_card_verify(body, id)
...
# create an instance of the API class
api_instance = interserver_api_client.BillingApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.IdVerifyBody() # IdVerifyBody | 
id = 56 # int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.

try:
    # Place two micro-charges on the card to start CVV verification (step 1 of 2)
    api_response = api_instance.patch_billing_credit_card_verify(body, id)
    pprint(api_response)
except ApiException as e:
...
# create an instance of the API class
api_instance = interserver_api_client.BillingApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.BillingVerifyCcRequest() # BillingVerifyCcRequest | 
id = 56 # int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
...
# create an instance of the API class
api_instance = interserver_api_client.BillingApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.BillingPaymentMethodRequest() # BillingPaymentMethodRequest | 
