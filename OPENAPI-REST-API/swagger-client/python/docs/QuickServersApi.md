# interserver_api_client.QuickServersApi
...
# **add_qs**
> ServiceOrderPostResponse add_qs(body)
...
api_instance = interserver_api_client.QuickServersApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.QsOrderRequest() # QsOrderRequest | 

try:
    # Place a QuickServer order, generating a real invoice and queuing provisioning
    api_response = api_instance.add_qs(body)
    pprint(api_response)
...
# **download_qs_backup**
> InlineResponse20012 download_qs_backup(body, id, all=all)
...
# create an instance of the API class
api_instance = interserver_api_client.QuickServersApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.IdBackupsBody() # IdBackupsBody | 
id = 56 # int | QuickServer ID number
all = 'all_example' # str | Set to `1` to list all backups across all services, not just the ones for the given QuickServer. (optional)
...
try:
    # Queue creation of a new QuickServer backup snapshot (note: GET triggers job)
    api_response = api_instance.get_qs_backup(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling QuickServersApi->get_qs_backup: %s\n" % e)
```
...
# create an instance of the API class
api_instance = interserver_api_client.QuickServersApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.RestoreRequest() # RestoreRequest | QuickServer Restore request
id = 56 # int | QuickServer ID number
...
# **quickservers_cancel**
> InlineResponse20011 quickservers_cancel(id)
