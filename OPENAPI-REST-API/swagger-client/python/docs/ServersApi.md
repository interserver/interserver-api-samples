...
api_instance = interserver_api_client.ServersApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.ServerOrderPostRequest() # ServerOrderPostRequest | 
...
# create an instance of the API class
api_instance = interserver_api_client.ServersApi(interserver_api_client.ApiClient(configuration))
body = interserver_api_client.OrderBuyNowServerBody() # OrderBuyNowServerBody |  (optional)
...
# create an instance of the API class
api_instance = interserver_api_client.ServersApi(interserver_api_client.ApiClient(configuration))
ids = 'ids_example' # str | Comma-separated list of Server IDs to query (e.g. `2313,2314,2315`). May also be passed as repeated `ids[]` query parameters.
