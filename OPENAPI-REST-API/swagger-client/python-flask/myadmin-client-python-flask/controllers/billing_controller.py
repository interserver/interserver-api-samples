...
def get_affiliate_download(st=None, ex=None, year=None):  # noqa: E501
...
def get_affiliate_signups(st=None):  # noqa: E501
...
def patch_billing_credit_card_verify(body, id):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        body = IdVerifyBody.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def patch_billing_credit_card_verify(cc_ccv2, id):  # noqa: E501
    """Place two micro-charges on the card to start CVV verification (step 1 of 2)
