...
public class AffiliateController  {
  ...
  /*
    public ResponseContext getAffiliateBanners(RequestContext request ) {
...
, Integer year 
  ...
  */
  ...
  /*
    public ResponseContext getAffiliateSalesGraph(RequestContext request , Integer days 
) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
  ...
  */
  ...
  /*
    public ResponseContext getAffiliateTrafficGraph(RequestContext request , Integer days 
) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
  ...
  /*
    public ResponseContext getAffiliateWebTraffic(RequestContext request ) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */

  /*
    public ResponseContext updateAffiliateDockSetup(RequestContext request ,  String affiliateDockTitle
...
,  String referrerCoupon
  ...
  */
  ...
  /*
    public ResponseContext updateAffiliatePaymentSetup(RequestContext request ,  String affiliatePaypal
,  String affiliatePaymentMethod
  ...
  */
  ...
  /*
    public ResponseContext updateAffiliatePaymentSetup(RequestContext request , AffiliatePaymentSetup body 
) {
        return new ResponseContext().status(Status.INTERNAL_SERVER_ERROR).entity( "Not implemented" );
    }
  */
