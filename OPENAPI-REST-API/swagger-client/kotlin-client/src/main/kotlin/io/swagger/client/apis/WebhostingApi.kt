...
import io.swagger.client.models.WebsiteOrderPostRequest
import io.swagger.client.models.WebsiteOrderPutRequest
...
class WebhostingApi(basePath: kotlin.String = "https://my.interserver.net/apiv2") : ApiClient(basePath) {
    ...
    fun addWebsite(body: WebsiteOrderPostRequest): ServiceOrderPostResponse {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun getWebsiteBuyIp(id: kotlin.Int): InlineResponse20026 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun postWebsiteBuyIp(body: IdBuyIpBody, id: kotlin.Int): InlineResponse20027 {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun postWebsiteBuyIp(ips: kotlin.collections.Map<kotlin.String, kotlin.String>, id: kotlin.Int): InlineResponse20027 {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun postWebsiteMigration(body: IdMigrationBody, id: kotlin.Int): InlineResponse20028 {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
     ...
     * @return void
     */
    fun putWebsites(body: WebsiteOrderPutRequest): Unit {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun webhostingCancel(id: kotlin.String): InlineResponse20025 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
