...
class DomainsApi(basePath: kotlin.String = "https://my.interserver.net/apiv2") : ApiClient(basePath) {
    ...
    fun addDomain(body: kotlin.collections.Map<kotlin.String, kotlin.Any>): ServiceOrderPostResponse {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun cancelDomain(id: kotlin.Int): InlineResponse2003 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun deleteDomainDnssec(id: kotlin.Int): SuccessTextResponse {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.DELETE,
     ...
     * @return void
     */
    fun patchDomains(body: kotlin.collections.Map<kotlin.String, kotlin.Any>): Unit {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
     ...
     * @return void
     */
    fun postDomainSearch(name: kotlin.String): Unit {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
     ...
     * @return void
     */
    fun putDomains(body: kotlin.collections.Map<kotlin.String, kotlin.Any>): Unit {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun updateDomainInfo(id: kotlin.Int): SuccessTextResponse {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
