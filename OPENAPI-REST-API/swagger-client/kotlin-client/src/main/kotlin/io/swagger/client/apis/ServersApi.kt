...
import io.swagger.client.models.ServerBulkIpmiPowerResponse
...
import io.swagger.client.models.ServerOrderPostRequest
...
class ServersApi(basePath: kotlin.String = "https://my.interserver.net/apiv2") : ApiClient(basePath) {
    ...
    fun addServer(body: ServerOrderPostRequest): InlineResponse20021 {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun buyItNowServerOrder(): InlineResponse20029 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun serverBulkIpmiPowerGet(ids: kotlin.String): ServerBulkIpmiPowerResponse {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
            put("ids", listOf(ids.toString()))
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/servers/bulk/ipmi_power", query = localVariableQuery
        )
        val response = request<ServerBulkIpmiPowerResponse>(
                localVariableConfig
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as ServerBulkIpmiPowerResponse
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun serversCancel(id: kotlin.Int): InlineResponse20022 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
