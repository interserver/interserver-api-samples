...
import io.swagger.client.models.FloatingIpOrderRequest
...
class FloatingIPsApi(basePath: kotlin.String = "https://my.interserver.net/apiv2") : ApiClient(basePath) {
    ...
    fun addFloatingIp(body: FloatingIpOrderRequest): ServiceOrderPostResponse {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun floatingIpsCancel(id: kotlin.Int): InlineResponse2004 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
     ...
     * @return void
     */
    fun putFloatingIps(body: FloatingIpOrderRequest): Unit {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
