...
class VPSApi(basePath: kotlin.String = "https://my.interserver.net/apiv2") : ApiClient(basePath) {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun downloadVpsBackup(body: IdBackupsBody2, id: kotlin.Int, all: kotlin.String? = null): InlineResponse20012 {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
            if (all != null) {
                put("all", listOf(all.toString()))
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun downloadVpsBackup(file: kotlin.String, id: kotlin.Int, all: kotlin.String? = null): InlineResponse20012 {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun getVpsBackup(id: kotlin.Int): QueueResponse {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
     ...
     * @return void
     */
    fun getVpsChangeHostname(id: kotlin.Int): Unit {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/vps/{id}/change_hostname".replace("{" + "id" + "}", "$id"), query = localVariableQuery
        )
        val response = request<Any?>(
                localVariableConfig
        )
     ...
     * @return void
     */
    fun getVpsChangeRootPassword(id: kotlin.Int): Unit {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/vps/{id}/change_root_password".replace("{" + "id" + "}", "$id"), query = localVariableQuery
        )
        val response = request<Any?>(
                localVariableConfig
        )
     ...
     * @return void
     */
    fun getVpsInsertCd(id: kotlin.Int): Unit {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/vps/{id}/insert_cd".replace("{" + "id" + "}", "$id"), query = localVariableQuery
        )
        val response = request<Any?>(
                localVariableConfig
        )
     ...
     * @return void
     */
    fun getVpsResetPassword(id: kotlin.Int): Unit {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
     ...
     * @return void
     */
    fun postVpsTrafficUsage(id: kotlin.Int): Unit {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
     ...
     * @return void
     */
    fun putVpsBuyHdSpace(id: kotlin.Int): Unit {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.PUT,
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun vPSCancel(id: kotlin.Int): InlineResponse20024 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.DELETE,
