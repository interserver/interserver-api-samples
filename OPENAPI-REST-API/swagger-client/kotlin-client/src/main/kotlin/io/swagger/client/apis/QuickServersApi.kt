...
import io.swagger.client.models.QsOrderRequest
...
class QuickServersApi(basePath: kotlin.String = "https://my.interserver.net/apiv2") : ApiClient(basePath) {
    ...
    fun addQs(body: QsOrderRequest): ServiceOrderPostResponse {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun downloadQsBackup(body: IdBackupsBody, id: kotlin.Int, all: kotlin.String? = null): InlineResponse20012 {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
            if (all != null) {
                put("all", listOf(all.toString()))
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun downloadQsBackup(file: kotlin.String, id: kotlin.Int, all: kotlin.String? = null): InlineResponse20012 {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun getQsBackup(id: kotlin.Int): QueueResponse {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
     ...
     * @return void
     */
    fun putQs(body: QsOrderRequest): Unit {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun quickserversCancel(id: kotlin.Int): InlineResponse20011 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.DELETE,
