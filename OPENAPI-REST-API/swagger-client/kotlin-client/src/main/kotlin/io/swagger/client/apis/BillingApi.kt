...
import io.swagger.client.models.IdVerifyBody
...
class BillingApi(basePath: kotlin.String = "https://my.interserver.net/apiv2") : ApiClient(basePath) {
     ...
     * @return void
     */
    fun getAffiliateDownload(st: kotlin.String? = null, ex: kotlin.String? = null, year: kotlin.Int? = null): Unit {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
            if (st != null) {
                put("st", listOf(st.toString()))
            }
            if (ex != null) {
                put("ex", listOf(ex.toString()))
            }
            if (year != null) {
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/affiliate/download", query = localVariableQuery
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun getAffiliateSignups(st: kotlin.String? = null): InlineResponse2001 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
            if (st != null) {
                put("st", listOf(st.toString()))
            }
        ...
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/affiliate/signups", query = localVariableQuery
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun initiatePayment(method: kotlin.String, invoices: kotlin.String): InlineResponse20010 {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/billing/pay/{method}/{invoices}".replace("{" + "method" + "}", "$method").replace("{" + "invoices" + "}", "$invoices"), query = localVariableQuery
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun patchBillingCreditCardVerify(body: IdVerifyBody, id: kotlin.Int): SuccessTextResponse {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun patchBillingCreditCardVerify(ccCcv2: kotlin.String, id: kotlin.Int): SuccessTextResponse {
        val localVariableBody: kotlin.Any? = mapOf("cc_ccv2" to "$ccCcv2")
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
        }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/json")
        localVariableHeaders["Accept"] = "application/json"
