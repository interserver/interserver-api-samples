...
# **downloadVpsBackup**
> InlineResponse20012 downloadVpsBackup(body, id, all)
...
val all : kotlin.String = all_example // kotlin.String | Set to `1` to list all backups across all services, not just the ones for the given VPS.
try {
    val result : InlineResponse20012 = apiInstance.downloadVpsBackup(body, id, all)
    println(result)
} catch (e: ClientException) {
...
<a name="downloadVpsBackup"></a>
# **downloadVpsBackup**
> InlineResponse20012 downloadVpsBackup(file, id, all)
...
val all : kotlin.String = all_example // kotlin.String | Set to `1` to list all backups across all services, not just the ones for the given VPS.
try {
    val result : InlineResponse20012 = apiInstance.downloadVpsBackup(file, id, all)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling VPSApi#downloadVpsBackup")
    e.printStackTrace()
...
try {
    ...
    println("4xx response calling VPSApi#getVpsBackup")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling VPSApi#getVpsBackup")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling VPSApi#getVpsChangeHostname")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling VPSApi#getVpsChangeHostname")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling VPSApi#getVpsChangeRootPassword")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling VPSApi#getVpsChangeRootPassword")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling VPSApi#getVpsInsertCd")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling VPSApi#getVpsInsertCd")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling VPSApi#getVpsResetPassword")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling VPSApi#getVpsResetPassword")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling VPSApi#postVpsTrafficUsage")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling VPSApi#postVpsTrafficUsage")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling VPSApi#putVpsBuyHdSpace")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling VPSApi#putVpsBuyHdSpace")
    e.printStackTrace()
}
```
...
<a name="vPSCancel"></a>
# **vPSCancel**
> InlineResponse20024 vPSCancel(id)
...
val id : kotlin.Int = 56 // kotlin.Int | VPS ID number
try {
    val result : InlineResponse20024 = apiInstance.vPSCancel(id)
    println(result)
} catch (e: ClientException) {
