...
val apiInstance = BillingApi()
val st : kotlin.String = st_example // kotlin.String | Filter by status.
val ex : kotlin.String = ex_example // kotlin.String | Export format: csv, xls, xlsx, or pdf. Defaults to csv.
val year : kotlin.Int = 56 // kotlin.Int | Year to filter the report. Defaults to the current year.
try {
    apiInstance.getAffiliateDownload(st, ex, year)
} catch (e: ClientException) {
    println("4xx response calling BillingApi#getAffiliateDownload")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling BillingApi#getAffiliateDownload")
    e.printStackTrace()
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **kotlin.String**| Filter by status. | [optional]
 **ex** | **kotlin.String**| Export format: csv, xls, xlsx, or pdf. Defaults to csv. | [optional] [enum: csv, xls, xlsx, pdf]
 **year** | **kotlin.Int**| Year to filter the report. Defaults to the current year. | [optional]
...
<a name="getAffiliateSignups"></a>
# **getAffiliateSignups**
> InlineResponse2001 getAffiliateSignups(st)
...
val apiInstance = BillingApi()
val st : kotlin.String = st_example // kotlin.String | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.
try {
    val result : InlineResponse2001 = apiInstance.getAffiliateSignups(st)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling BillingApi#getAffiliateSignups")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling BillingApi#getAffiliateSignups")
    e.printStackTrace()
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **kotlin.String**| Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. | [optional]
...
# **initiatePayment**
> InlineResponse20010 initiatePayment(method, invoices)
...
val invoices : kotlin.String = invoices_example // kotlin.String | A comma-separated list of invoice IDs or invoice Tags to pay. These IDs are returned by order endpoints (e.g. `/backups/order`, `/vps/order`) and by `/billing/invoices`. Invoice tags accepted are SERVICE<module><id>, RINV<module><repeat invoice id>, INV<module><invoice id>, PREPAY<prepay id><invoice id>, and <invoice id>.
try {
    val result : InlineResponse20010 = apiInstance.initiatePayment(method, invoices)
    println(result)
} catch (e: ClientException) {
 ...
 **invoices** | **kotlin.String**| A comma-separated list of invoice IDs or invoice Tags to pay. These IDs are returned by order endpoints (e.g. &#x60;/backups/order&#x60;, &#x60;/vps/order&#x60;) and by &#x60;/billing/invoices&#x60;. Invoice tags accepted are SERVICE&lt;module&gt;&lt;id&gt;, RINV&lt;module&gt;&lt;repeat invoice id&gt;, INV&lt;module&gt;&lt;invoice id&gt;, PREPAY&lt;prepay id&gt;&lt;invoice id&gt;, and &lt;invoice id&gt;. |
...
<a name="patchBillingCreditCardVerify"></a>
# **patchBillingCreditCardVerify**
> SuccessTextResponse patchBillingCreditCardVerify(body, id)
...
val apiInstance = BillingApi()
val body : IdVerifyBody =  // IdVerifyBody | 
val id : kotlin.Int = 56 // kotlin.Int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
try {
    val result : SuccessTextResponse = apiInstance.patchBillingCreditCardVerify(body, id)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling BillingApi#patchBillingCreditCardVerify")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling BillingApi#patchBillingCreditCardVerify")
    e.printStackTrace()
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**IdVerifyBody**](IdVerifyBody.md)|  |
 **id** | **kotlin.Int**| The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. |
...
<a name="patchBillingCreditCardVerify"></a>
# **patchBillingCreditCardVerify**
> SuccessTextResponse patchBillingCreditCardVerify(ccCcv2, id)
...
val id : kotlin.Int = 56 // kotlin.Int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
try {
    val result : SuccessTextResponse = apiInstance.patchBillingCreditCardVerify(ccCcv2, id)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling BillingApi#patchBillingCreditCardVerify")
    e.printStackTrace()
