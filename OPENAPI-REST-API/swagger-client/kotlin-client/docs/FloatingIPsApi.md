...
val body : FloatingIpOrderRequest =  // FloatingIpOrderRequest | 
try {
    val result : ServiceOrderPostResponse = apiInstance.addFloatingIp(body)
    println(result)
...
try {
    val result : InlineResponse2004 = apiInstance.floatingIpsCancel(id)
    println(result)
} catch (e: ClientException) {
