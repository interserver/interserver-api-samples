...
val body : SslOrderRequest =  // SslOrderRequest | 
try {
    val result : ServiceOrderPostResponse = apiInstance.addSsl(body)
    println(result)
...
val id : kotlin.Int = 56 // kotlin.Int | SSL Cert ID number
try {
    val result : InlineResponse20023 = apiInstance.sslCancel(id)
    println(result)
} catch (e: ClientException) {
