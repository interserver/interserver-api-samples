...
> kotlin.Array&lt;kotlin.String&gt; getAccountCurrencies()
...
try {
    val result : kotlin.Array<kotlin.String> = apiInstance.getAccountCurrencies()
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PublicApi#getAccountCurrencies")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PublicApi#getAccountCurrencies")
    e.printStackTrace()
}
```
...
# **getAccountLocales**
> kotlin.collections.Map&lt;kotlin.String, InlineResponseMap200&gt; getAccountLocales()
...
val apiInstance = PublicApi()
try {
    val result : kotlin.collections.Map<kotlin.String, InlineResponseMap200> = apiInstance.getAccountLocales()
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PublicApi#getAccountLocales")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PublicApi#getAccountLocales")
    e.printStackTrace()
}
```
...
try {
    val result : InlineResponse2006 = apiInstance.getOauthRedirect(provider)
    println(result)
} catch (e: ClientException) {
...
# **patchOauthTwoFactor**
> InlineResponse2008 patchOauthTwoFactor(body)
...
try {
    val result : InlineResponse2008 = apiInstance.patchOauthTwoFactor(body)
    println(result)
} catch (e: ClientException) {
...
<a name="patchOauthTwoFactor"></a>
# **patchOauthTwoFactor**
> InlineResponse2008 patchOauthTwoFactor(accountId, code)
...
try {
    val result : InlineResponse2008 = apiInstance.patchOauthTwoFactor(accountId, code)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PublicApi#patchOauthTwoFactor")
    e.printStackTrace()
...
# **postOauthCallback**
> InlineResponse2007 postOauthCallback(provider, body)
...
try {
    val result : InlineResponse2007 = apiInstance.postOauthCallback(provider, body)
    println(result)
} catch (e: ClientException) {
...
<a name="postOauthCallback"></a>
# **postOauthCallback**
> InlineResponse2007 postOauthCallback(provider, provider2)
...
try {
    val result : InlineResponse2007 = apiInstance.postOauthCallback(provider, provider2)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PublicApi#postOauthCallback")
    e.printStackTrace()
