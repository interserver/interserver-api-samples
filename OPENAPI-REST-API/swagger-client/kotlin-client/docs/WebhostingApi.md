...
val body : WebsiteOrderPostRequest =  // WebsiteOrderPostRequest | 
try {
    val result : ServiceOrderPostResponse = apiInstance.addWebsite(body)
    println(result)
...
try {
    val result : InlineResponse20026 = apiInstance.getWebsiteBuyIp(id)
    println(result)
} catch (e: ClientException) {
...
val id : kotlin.Int = 56 // kotlin.Int | The website service ID. Use `website_id` from `GET /websites`.
try {
    val result : InlineResponse20027 = apiInstance.postWebsiteBuyIp(body, id)
    println(result)
} catch (e: ClientException) {
...
val id : kotlin.Int = 56 // kotlin.Int | The website service ID. Use `website_id` from `GET /websites`.
try {
    val result : InlineResponse20027 = apiInstance.postWebsiteBuyIp(ips, id)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebhostingApi#postWebsiteBuyIp")
    e.printStackTrace()
...
val id : kotlin.Int = 56 // kotlin.Int | The website service ID. Use `website_id` from `GET /websites`.
try {
    val result : InlineResponse20028 = apiInstance.postWebsiteMigration(body, id)
    println(result)
} catch (e: ClientException) {
...
val id : kotlin.Int = 56 // kotlin.Int | The website service ID. Use `website_id` from `GET /websites`.
try {
    val result : InlineResponse20028 = apiInstance.postWebsiteMigration(custPortal, regEmail, password, ctrlPanel, ftpUsername, ftpPassword, siteBusyMig, splReqMig, domainReg, dataMig, domainRegPortal, domainRegEmail, domainRegPassword, id)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebhostingApi#postWebsiteMigration")
    e.printStackTrace()
...
val apiInstance = WebhostingApi()
val body : WebsiteOrderPutRequest =  // WebsiteOrderPutRequest | 
try {
...
val id : kotlin.String = id_example // kotlin.String | The website service ID. Use `website_id` from `GET /websites`.
try {
    val result : InlineResponse20025 = apiInstance.webhostingCancel(id)
    println(result)
} catch (e: ClientException) {
