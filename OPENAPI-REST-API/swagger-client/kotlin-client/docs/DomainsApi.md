...
<a name="addDomain"></a>
# **addDomain**
> ServiceOrderPostResponse addDomain(body)
...
val body : kotlin.collections.Map<kotlin.String, kotlin.Any> =  // kotlin.collections.Map<kotlin.String, kotlin.Any> | 
try {
    val result : ServiceOrderPostResponse = apiInstance.addDomain(body)
    println(result)
...
------------- | ------------- | ------------- | -------------
 **body** | [**kotlin.collections.Map&lt;kotlin.String, kotlin.Any&gt;**](kotlin.collections.Map.md)|  |
...
# **cancelDomain**
> InlineResponse2003 cancelDomain(id)
...
val id : kotlin.Int = 56 // kotlin.Int | The domain service ID. Use `domain_id` from `GET /domains`.
try {
    val result : InlineResponse2003 = apiInstance.cancelDomain(id)
    println(result)
} catch (e: ClientException) {
...
try {
    ...
    println("4xx response calling DomainsApi#postDomainSearch")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DomainsApi#postDomainSearch")
    e.printStackTrace()
}
```
