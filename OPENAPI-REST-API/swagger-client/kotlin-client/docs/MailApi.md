...
<a name="addMail"></a>
# **addMail**
> ServiceOrderPostResponse addMail(body)
...
val body : MailOrderRequest =  // MailOrderRequest | 
try {
    val result : ServiceOrderPostResponse = apiInstance.addMail(body)
    println(result)
...
# **deleteMailAlert**
> SuccessTextResponse deleteMailAlert(body, id)
...
val apiInstance = MailApi()
val body : IdAlertsBody =  // IdAlertsBody | 
val id : kotlin.Int = 56 // kotlin.Int | The mail service ID. Use `mail_id` from `GET /mail`.
try {
    val result : SuccessTextResponse = apiInstance.deleteMailAlert(body, id)
    println(result)
} catch (e: ClientException) {
...
<a name="deleteMailAlert"></a>
# **deleteMailAlert**
> SuccessTextResponse deleteMailAlert(alertId, id)
...
val id : kotlin.Int = 56 // kotlin.Int | The mail service ID. Use `mail_id` from `GET /mail`.
try {
    val result : SuccessTextResponse = apiInstance.deleteMailAlert(alertId, id)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling MailApi#deleteMailAlert")
    e.printStackTrace()
...
<a name="mailCancel"></a>
# **mailCancel**
> InlineResponse2009 mailCancel(id)
...
val id : kotlin.Int = 56 // kotlin.Int | The mail service ID. Use `mail_id` from `GET /mail`.
try {
    val result : InlineResponse2009 = apiInstance.mailCancel(id)
    println(result)
} catch (e: ClientException) {
...
<a name="updateRule"></a>
# **updateRule**
> GenericResponse updateRule(body, id, rule)
...
val apiInstance = MailApi()
val body : DenyRuleNew =  // DenyRuleNew | 
val id : kotlin.Int = 56 // kotlin.Int | The mail service ID. Use `mail_id` from `GET /mail`.
val rule : kotlin.String = rule_example // kotlin.String | The ID of the deny rule to update.
try {
    val result : GenericResponse = apiInstance.updateRule(body, id, rule)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling MailApi#updateRule")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MailApi#updateRule")
    e.printStackTrace()
}
```
 ...
 **id** | **kotlin.Int**| The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;. |
 **rule** | **kotlin.String**| The ID of the deny rule to update. |
...
<a name="updateRule"></a>
# **updateRule**
> GenericResponse updateRule(user, type, `data`, id, rule)
...
val rule : kotlin.String = rule_example // kotlin.String | The ID of the deny rule to update.
try {
    val result : GenericResponse = apiInstance.updateRule(user, type, `data`, id, rule)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling MailApi#updateRule")
    e.printStackTrace()
