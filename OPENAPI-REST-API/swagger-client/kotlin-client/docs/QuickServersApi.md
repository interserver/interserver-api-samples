...
val body : QsOrderRequest =  // QsOrderRequest | 
try {
    val result : ServiceOrderPostResponse = apiInstance.addQs(body)
    println(result)
...
val all : kotlin.String = all_example // kotlin.String | Set to `1` to list all backups across all services, not just the ones for the given QuickServer.
try {
    val result : InlineResponse20012 = apiInstance.downloadQsBackup(body, id, all)
    println(result)
} catch (e: ClientException) {
...
val all : kotlin.String = all_example // kotlin.String | Set to `1` to list all backups across all services, not just the ones for the given QuickServer.
try {
    val result : InlineResponse20012 = apiInstance.downloadQsBackup(file, id, all)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling QuickServersApi#downloadQsBackup")
    e.printStackTrace()
...
try {
    ...
    println("4xx response calling QuickServersApi#getQsBackup")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling QuickServersApi#getQsBackup")
    e.printStackTrace()
}
```
...
val id : kotlin.Int = 56 // kotlin.Int | QuickServer ID number
try {
    val result : InlineResponse20011 = apiInstance.quickserversCancel(id)
    println(result)
} catch (e: ClientException) {
