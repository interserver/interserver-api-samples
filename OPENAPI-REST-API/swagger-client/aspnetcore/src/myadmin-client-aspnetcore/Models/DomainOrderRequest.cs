...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class DomainOrderRequest : Dictionary<String, Object>, IEquatable<DomainOrderRequest>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DomainOrderRequest)obj);
        }

        /// <summary>
        /// Returns true if DomainOrderRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of DomainOrderRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainOrderRequest other)
        {
        ...
        public static bool operator ==(DomainOrderRequest left, DomainOrderRequest right)
        {
