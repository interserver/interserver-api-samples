...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class IdAlertsBody : IEquatable<IdAlertsBody>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((IdAlertsBody)obj);
        }

        /// <summary>
        /// Returns true if IdAlertsBody instances are equal
        /// </summary>
        /// <param name="other">Instance of IdAlertsBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdAlertsBody other)
        {
        ...
        public static bool operator ==(IdAlertsBody left, IdAlertsBody right)
        {
