...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponseMap200 : IEquatable<InlineResponseMap200>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InlineResponseMap200)obj);
        }

        /// <summary>
        /// Returns true if InlineResponseMap200 instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponseMap200 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponseMap200 other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (LocalName != null)
                    hashCode = hashCode * 59 + LocalName.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(InlineResponseMap200 left, InlineResponseMap200 right)
        {
