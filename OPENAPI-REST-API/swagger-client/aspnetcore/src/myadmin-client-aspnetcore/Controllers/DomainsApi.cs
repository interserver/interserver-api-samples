...
{ 
    ...
    { 
        ...
        public virtual IActionResult AddDomain([FromBody]Dictionary<string, Object> body)
        { 
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(InlineResponse2003), description: "Domains Cancel")]
        [SwaggerResponse(statusCode: 401, type: typeof(InlineResponse401), description: "Unauthorized")]
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(SuccessTextResponse), description: "A response indicating the operation completed successfully with a text message.")]
        [SwaggerResponse(statusCode: 401, type: typeof(InlineResponse401), description: "Unauthorized")]
        public virtual IActionResult DeleteDomainDnssec([FromRoute][Required]int? id)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(SuccessTextResponse));
        ...
        [SwaggerResponse(statusCode: 401, type: typeof(InlineResponse401), description: "Unauthorized")]
        public virtual IActionResult PatchDomains([FromBody]Dictionary<string, Object> body)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
        ...
        /// </summary>
        /// <remarks>Returns the complete order-form payload — pricing, service catalog entry, per-TLD order fields — for the hostname in a single POST. Equivalent to calling &#x60;getDomainLookup&#x60; + &#x60;getNewDomain&#x60; + &#x60;putDomains&#x60; and merging the results, but with one round-trip. The path &#x60;name&#x60; is moved server-side into &#x60;$_POST[&#x27;hostname&#x27;]&#x60; and passed to &#x60;getOrderDomainData(true)&#x60;. Sibling ops: &#x60;getDomainSearch&#x60;, &#x60;getDomainLookup&#x60;, &#x60;getNewDomain&#x60;, &#x60;addDomain&#x60;.  **Path param:** - &#x60;name&#x60; (string, required) — hostname (e.g. &#x60;example.com&#x60;).  **Body:** None.  **Returns:** Combined order-data response — pricing, service catalog entry, form fields ready to populate for &#x60;addDomain&#x60;.  **Auth:** Session/API key (path is &#x60;client_api&#x60;, but called publicly).  **Errors:** - &#x60;4xx&#x60; — hostname cannot be resolved to a TLD service.  **Related calls:** - **Place order:** &#x60;addDomain&#x60; with the returned fields. </remarks>
        /// <param name="name">The base domain name to search (for example &#x60;example&#x60; or &#x60;example.com&#x60;).</param>
        /// <response code="200">Domain availability and pricing check results.</response>
        /// <response code="401">Unauthorized</response>
        [HttpPost]
        [Route("/apiv2/domains/search/{name}")]
        [Authorize(AuthenticationSchemes = ApiKeyAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("PostDomainSearch")]
        [SwaggerResponse(statusCode: 401, type: typeof(InlineResponse401), description: "Unauthorized")]
        public virtual IActionResult PostDomainSearch([FromRoute][Required]string name)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200);
        ...
        [SwaggerResponse(statusCode: 401, type: typeof(InlineResponse401), description: "Unauthorized")]
        public virtual IActionResult PutDomains([FromBody]Dictionary<string, Object> body)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200);
        ...
        /// </summary>
        /// <remarks>Account-level write-back hook for the domain service record. Runs the same &#x60;View::go()&#x60; handler as &#x60;getDomainInfo&#x60; — it does NOT push registrar-side changes by itself. **For specific changes use the dedicated endpoints** — they push to OpenSRS where appropriate. Sibling ops: &#x60;getDomainInfo&#x60;, &#x60;updateDomainContact&#x60;, &#x60;updateDomainNameservers&#x60;, &#x60;addDomainDnssec&#x60;, &#x60;updateDomainWhoisPrivacy&#x60;.  **Path param:** - &#x60;id&#x60; (integer, required) — &#x60;domain_id&#x60; from &#x60;getDomainsList&#x60;.  **Body:** Form fields matching the domain service record.  **Returns:** &#x60;SuccessTextResponse&#x60;.  **Auth:** Session/API key. Ownership enforced.  **Errors:** - &#x60;401&#x60; — unauthenticated. - &#x60;404&#x60; — &#x60;id&#x60; not owned by caller.  **Prefer these dedicated endpoints:** - **Registrant/admin contact:** &#x60;updateDomainContact&#x60; (pushes to OpenSRS). - **Nameservers:** &#x60;updateDomainNameservers&#x60;, &#x60;addDomainNameserver&#x60;, &#x60;deleteDomainNameserver&#x60;. - **DNSSEC:** &#x60;addDomainDnssec&#x60;, &#x60;deleteDomainDnssec&#x60;. - **Whois privacy:** &#x60;updateDomainWhoisPrivacy&#x60;. - **Renew:** &#x60;postDomainRenewal&#x60;. - **Cancel:** &#x60;CancelDomain&#x60;. </remarks>
        /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
        /// <response code="200">A response indicating the operation completed successfully with a text message.</response>
        /// <response code="401">Unauthorized</response>
        [HttpPost]
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(SuccessTextResponse), description: "A response indicating the operation completed successfully with a text message.")]
        [SwaggerResponse(statusCode: 401, type: typeof(InlineResponse401), description: "Unauthorized")]
        public virtual IActionResult UpdateDomainInfo([FromRoute][Required]int? id)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(SuccessTextResponse));
        ...
        /// </summary>
        /// <remarks>Atomically replaces the domain&#x27;s authoritative-nameserver delegation list via OpenSRS &#x60;nsAdvancedUpdt&#x60; with &#x60;op_type&#x3D;assign&#x60;. **Domain must be unlocked.** Use this to switch DNS providers (e.g. point at InterServer &#x60;cdns1&#x60;/&#x60;cdns2&#x60;, Cloudflare, AWS Route53, etc.). **Replaces the full set in one call** — partial updates are not supported through this endpoint. To register a new glue record (host + IP) at the registry, use &#x60;addDomainNameserver&#x60;. Sibling ops: &#x60;getDomainNameservers&#x60;, &#x60;addDomainNameserver&#x60;, &#x60;deleteDomainNameserver&#x60;, &#x60;addDnsDomain&#x60; (host a zone at InterServer).  **Path param:** - &#x60;id&#x60; (integer, required) — &#x60;domain_id&#x60; from &#x60;getDomainsList&#x60;.  **Body fields (JSON or multipart, schema &#x60;DomainNameserverPutRequest&#x60;):** - &#x60;nameserver[]&#x60; (array of strings, required) — FQDN strings (e.g. &#x60;[\&quot;ns1.example.com\&quot;, \&quot;ns2.example.com\&quot;]&#x60;). Trimmed; empty entries dropped server-side.  **Returns:** &#x60;SuccessTextResponse&#x60; on registrar &#x60;is_success&#x3D;1&#x60;.  **Auth:** Session/API key. Ownership enforced.  **Errors:** - &#x60;401&#x60; — unauthenticated. - &#x60;404&#x60; — &#x60;id&#x60; not owned by caller. - &#x60;409&#x60; — &#x60;domain_status !&#x3D; \&quot;active\&quot;&#x60; or domain locked. - Registrar errors surfaced as 4xx.  **Related calls:** - **Read current set:** &#x60;getDomainNameservers&#x60;. - **Register a glue record:** &#x60;addDomainNameserver&#x60;. - **Host the DNS zone at InterServer:** &#x60;addDnsDomain&#x60; (DNS tag). </remarks>
        /// <param name="body"></param>
        /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
        /// <response code="200">Response with a text message field.</response>
        /// <response code="401">Unauthorized</response>
