...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <remarks>Returns the catalog of pre-built banner images affiliates can embed on partner sites — same catalog for every account (not per-affiliate). Use to render a creative-asset picker in the affiliate dashboard. Each row carries the image filename and dimensions so the client can build correctly-sized &#x60;&lt;img&gt;&#x60; tags. Read-only. Sibling ops: &#x60;getAffiliateRichReport&#x60;, &#x60;getAffiliateSalesGraph&#x60;, &#x60;getAffiliateTrafficGraph&#x60;, &#x60;getAffiliateWebTraffic&#x60;, &#x60;getAffiliateSignups&#x60;, &#x60;updateAffiliateDockSetup&#x60;.  **Path/Query/Body:** None.  **Returns:** Array of &#x60;AffiliateBannerRow&#x60;: - &#x60;image&#x60; (string) — filename (e.g. &#x60;12946798.gif&#x60;); served from the affiliate asset bucket. - &#x60;width&#x60; (string) — pixels. - &#x60;height&#x60; (string) — pixels.  **Auth:** Session/API key.  **Errors:** - &#x60;401&#x60; — unauthenticated. </remarks>
        ...
        /// <response code="200">Affiliate report file download. The response Content-Type matches the requested format (text/csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, or application/pdf).</response>
        /// <response code="401">Unauthorized</response>
        [HttpGet]
        [Route("/apiv2/affiliate/download")]
        [Authorize(AuthenticationSchemes = ApiKeyAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("GetAffiliateDownload")]
        [SwaggerResponse(statusCode: 401, type: typeof(InlineResponse401), description: "Unauthorized")]
        public virtual IActionResult GetAffiliateDownload([FromQuery]string st, [FromQuery]string ex, [FromQuery]int? year)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
        ...
        /// </summary>
        /// <remarks>Returns aggregated sales time-series data — monthly buckets with sale counts/totals — for the requested look-back window. Use to render a sales trend chart in the affiliate dashboard. Bucket granularity is fixed at monthly by &#x60;sales_graph_lte_data&#x60;; increasing &#x60;days&#x60; extends the window, it does not change bucket size. Sibling ops: &#x60;getAffiliateTrafficGraph&#x60; (clicks), &#x60;getAffiliateRichReport&#x60; (combined summary), &#x60;getAffiliateSignups&#x60;, &#x60;getAffiliateDownload&#x60;.  **Query params:** - &#x60;days&#x60; (integer, optional, default &#x60;365&#x60;) — look-back window in days.  **Returns:** &#x60;StatusMonthlyBreakdown&#x60; — buckets keyed by month with aggregated sale counts and amounts.  **Auth:** Session/API key.  **Errors:** - &#x60;401&#x60; — unauthenticated. </remarks>
        ...
        /// </summary>
        /// <remarks>Returns the 20 most recent raw referral visits from the &#x60;affiliate_traffic&#x60; table — visitor IP, full referral URL, and timestamp per row. Use to audit traffic sources, identify top referrers, or investigate suspicious click patterns. Hard-coded limit 20 (no pagination); for longer-term analysis use &#x60;getAffiliateTrafficGraph&#x60; or export via &#x60;getAffiliateDownload&#x60;. Sibling ops: &#x60;getAffiliateTrafficGraph&#x60;, &#x60;getAffiliateSignups&#x60;, &#x60;getAffiliateRichReport&#x60;, &#x60;getAffiliateDownload&#x60;.  **Path/Query/Body:** None.  **Returns:** Array of &#x60;AffiliateTrafficRow&#x60;: - &#x60;traffic_id&#x60; (string) — row id (most-recent-first). - &#x60;traffic_ip&#x60; (string) — visitor IP (IPv4 or IPv6). - &#x60;traffic_url&#x60; (string) — referral landing URL. - &#x60;traffic_affiliate&#x60; (string) — affiliate (&#x3D; session &#x60;account_id&#x60;). - &#x60;traffic_referrer&#x60; (string) — HTTP Referer (may be empty). - &#x60;traffic_timestamp&#x60; (string) — &#x60;YYYY-MM-DD HH:MM:SS&#x60; in account timezone.  **Auth:** Session/API key.  **Errors:** - &#x60;401&#x60; — unauthenticated. </remarks>
        ...
        /// <response code="401">Unauthorized</response>
        [HttpGet]
        [Route("/apiv2/billing/pay/{method}/{invoices}")]
        [Authorize(AuthenticationSchemes = ApiKeyAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("InitiatePayment")]
        [SwaggerResponse(statusCode: 200, type: typeof(InlineResponse20010), description: "Payment initiation response with redirect or form data.")]
        [SwaggerResponse(statusCode: 401, type: typeof(InlineResponse401), description: "Unauthorized")]
        ...
        [Authorize(AuthenticationSchemes = ApiKeyAuthenticationHandler.SchemeName)]
        [ValidateModelState]
        [SwaggerOperation("PatchBillingCreditCardVerify")]
        [SwaggerResponse(statusCode: 200, type: typeof(SuccessTextResponse), description: "A response indicating the operation completed successfully with a text message.")]
        [SwaggerResponse(statusCode: 401, type: typeof(InlineResponse401), description: "Unauthorized")]
        public virtual IActionResult PatchBillingCreditCardVerify([FromBody]IdVerifyBody body, [FromRoute][Required]int? id)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(SuccessTextResponse));
