...
class BillingApi(baseUrl: String) {
   ...
   */
  def getAffiliateDownload(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(st: Option[String] = None, ex: Option[String] = None, year: Option[Int] = None
   ...
   */
  def getAffiliateSignups(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(st: Option[String] = None
): Request[Either[ResponseException[String, Exception], GetAffiliateSignups200Response], Any] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : JValue (Current shopping cart contents and available payment methods.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   * 
   * Expected answers:
   *   code 200 : JValue (Prepay balances and metadata.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   */
  def patchBillingCreditCardVerify(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest
): Request[Either[ResponseException[String, Exception], SuccessTextResponse], Any] =
    basicRequest
