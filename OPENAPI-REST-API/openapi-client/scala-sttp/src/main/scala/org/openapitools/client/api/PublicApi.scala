...
class PublicApi(baseUrl: String) {
   ...
   */
  def getAccountCurrencies(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getAccountLocales(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(
): Request[Either[ResponseException[String, Exception], Map[String, GetAccountLocales200ResponseValue]], Any] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : JValue (The list of countries with both 2 letter abbreviations and the country names.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
