...
class ServersApi(baseUrl: String) {
   ...
   */
  def addServer(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(serverOrderPostRequest: ServerOrderPostRequest
   ...
   */
  def serverBulkIpmiPowerGet(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(ids: String
): Request[Either[ResponseException[String, Exception], ServerBulkIpmiPowerResponse], Any] =
    basicRequest
