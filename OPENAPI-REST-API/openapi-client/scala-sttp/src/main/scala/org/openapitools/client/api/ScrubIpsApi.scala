...
class ScrubIpsApi(baseUrl: String) {
   ...
   * @param scrubIpPlaceOrder 
   */
  def putScrubIps(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(scrubIpPlaceOrder: ScrubIpPlaceOrder
): Request[Either[ResponseException[String, Exception], PutScrubIps200Response], Any] =
    basicRequest
