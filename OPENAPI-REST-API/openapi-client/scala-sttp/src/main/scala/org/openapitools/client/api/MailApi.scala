...
class MailApi(baseUrl: String) {
   ...
   */
  def addMail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(mailOrderRequest: MailOrderRequest
   ...
   */
  def deleteMailAlert(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, deleteMailAlertRequest: DeleteMailAlertRequest
): Request[Either[ResponseException[String, Exception], SuccessTextResponse], Any] =
    basicRequest
   ...
   * @param mailOrderRequest 
   */
  def putMail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(mailOrderRequest: MailOrderRequest
   ...
   * @param denyRuleNew 
   */
  def updateRule(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, rule: String, denyRuleNew: DenyRuleNew
): Request[Either[ResponseException[String, Exception], GenericResponse], Any] =
    basicRequest
