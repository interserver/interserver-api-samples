...
class QuickServersApi(baseUrl: String) {
   ...
   */
  def addQs(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(qsOrderRequest: QsOrderRequest
   ...
   * @param id QuickServer ID number
   */
  def getQsBackup(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], QueueResponse], Any] =
    basicRequest
   ...
   * @param qsOrderRequest 
   */
  def putQs(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(qsOrderRequest: QsOrderRequest
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
