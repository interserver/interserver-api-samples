...
class SSLCertificatesApi(baseUrl: String) {
   ...
   */
  def addSsl(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(sslOrderRequest: SslOrderRequest
   ...
   * 
   * Expected answers:
   *   code 200 : JValue (Available SSL certificate types and pricing for ordering.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   * 
   * Expected answers:
   *   code 200 : JValue (Detailed SSL certificate information.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   * @param sslOrderRequest 
   */
  def putSsl(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(sslOrderRequest: SslOrderRequest
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
