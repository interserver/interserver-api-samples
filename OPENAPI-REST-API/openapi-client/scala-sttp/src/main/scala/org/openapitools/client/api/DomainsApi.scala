...
class DomainsApi(baseUrl: String) {
   ...
   */
  def addDomain(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(domainOrderRequest: DomainOrderRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def deleteDomainDnssec(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], SuccessTextResponse], Any] =
    basicRequest
   ...
   * @param domainOrderRequest 
   */
  def patchDomains(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(domainOrderRequest: DomainOrderRequest
   ...
   * @param name The base domain name to search (for example `example` or `example.com`).
   */
  def postDomainSearch(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(name: String
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param domainOrderRequest 
   */
  def putDomains(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(domainOrderRequest: DomainOrderRequest
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def updateDomainInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], SuccessTextResponse], Any] =
    basicRequest
