...
class WebhostingApi(baseUrl: String) {
   ...
   */
  def addWebsite(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(websiteOrderPostRequest: WebsiteOrderPostRequest
   ...
   */
  def putWebsites(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(websiteOrderPutRequest: WebsiteOrderPutRequest
