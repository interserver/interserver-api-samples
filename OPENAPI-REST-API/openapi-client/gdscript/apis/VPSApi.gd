...
# Operation getVpsBackup → GET /vps/{id}/backup
...
func get_vps_backup_threaded(
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "get_vps_backup")
	bzz_callable.bind(
		id,
		on_success,
		on_failure,
...
# Operation getVpsChangeHostname → GET /vps/{id}/change_hostname
...
func get_vps_change_hostname_threaded(
	# id: int   Eg: 56
	# VPS ID number
	id: int,
	on_success: Callable = Callable(),  # func(response: ApiResponse)
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "get_vps_change_hostname")
	bzz_callable.bind(
		id,
		on_success,
		on_failure,
...
# Operation getVpsChangeRootPassword → GET /vps/{id}/change_root_password
...
func get_vps_change_root_password(
	# id: int   Eg: 56
	# VPS ID number
	id: int,
	on_success: Callable = Callable(),  # func(response: ApiResponse)
...
func get_vps_change_root_password_threaded(
	# id: int   Eg: 56
	# VPS ID number
	id: int,
	on_success: Callable = Callable(),  # func(response: ApiResponse)
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "get_vps_change_root_password")
	bzz_callable.bind(
		id,
		on_success,
		on_failure,
...
# Operation getVpsInsertCd → GET /vps/{id}/insert_cd
...
func get_vps_insert_cd_threaded(
	# id: int   Eg: 56
	# VPS ID number
	id: int,
	on_success: Callable = Callable(),  # func(response: ApiResponse)
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "get_vps_insert_cd")
	bzz_callable.bind(
		id,
		on_success,
		on_failure,
...
# Operation getVpsResetPassword → GET /vps/{id}/reset_password
...
func get_vps_reset_password_threaded(
	# id: int   Eg: 56
	# VPS ID number
	id: int,
	on_success: Callable = Callable(),  # func(response: ApiResponse)
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "get_vps_reset_password")
	bzz_callable.bind(
		id,
		on_success,
		on_failure,
...
# Operation postVpsTrafficUsage → POST /vps/{id}/traffic_usage
...
func post_vps_traffic_usage_threaded(
	# id: int   Eg: 56
	# VPS ID number
	id: int,
	on_success: Callable = Callable(),  # func(response: ApiResponse)
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "post_vps_traffic_usage")
	bzz_callable.bind(
		id,
		on_success,
		on_failure,
...
# Operation putVpsBuyHdSpace → PUT /vps/{id}/buy_hd_space
...
func put_vps_buy_hd_space_threaded(
	# id: int   Eg: 56
	# VPS ID number
	id: int,
	on_success: Callable = Callable(),  # func(response: ApiResponse)
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "put_vps_buy_hd_space")
	bzz_callable.bind(
		id,
		on_success,
		on_failure,
