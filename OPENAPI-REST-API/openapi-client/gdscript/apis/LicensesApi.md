...
------------- | ------------- | -------------
[**add_license**](#add_license) | **POST** `/licenses/order` | Order a new software license and create the recurring invoice
[**get_license_info**](#get_license_info) | **GET** `/licenses/{id}` | Get full details for one license including status, IP, and links
[**get_license_invoices**](#get_license_invoices) | **GET** `/licenses/{id}/invoices` | List all billing invoices tied to one software license service
[**get_license_list**](#get_license_list) | **GET** `/licenses` | List all software licenses owned by the authenticated customer
[**get_licenses_welcome_email**](#get_licenses_welcome_email) | **GET** `/licenses/{id}/welcome_email` | Resend the license welcome email with the key and activation steps
[**get_new_license**](#get_new_license) | **GET** `/licenses/order` | Get available license types, packages, and pricing for ordering
[**licenses_cancel**](#licenses_cancel) | **DELETE** `/licenses/{id}` | Cancel a license service and stop future billing (irreversible)
[**post_license_change_ip**](#post_license_change_ip) | **POST** `/licenses/{id}/change_ip` | Rebind a license to a new IP address (may incur a vendor fee)
[**put_licenses**](#put_licenses) | **PUT** `/licenses/order` | Validate a software license order before placing it (dry run preview)
[**update_license_info**](#update_license_info) | **POST** `/licenses/{id}` | Update mutable fields on a license service (e.g. assigned IP)

# **add_license**   { #add_license }
<a name="add_license"></a>

> `add_license(licenseOrderRequest: LicenseOrderRequest, on_success: Callable, on_failure: Callable)`
...
var licenseOrderRequest = LicenseOrderRequest.new()
# … fill model licenseOrderRequest with data
...
> `put_licenses(licenseOrderRequest: LicenseOrderRequest, on_success: Callable, on_failure: Callable)`
