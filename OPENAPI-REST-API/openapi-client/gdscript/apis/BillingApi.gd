...
# Operation getAffiliateDownload → GET /affiliate/download
...
func get_affiliate_download(
	...
	# Compute the URL path to the API resource
	var bzz_path := "/apiv2/affiliate/download"
...
func get_affiliate_download_threaded(
	# st: String = ""   Eg: st_example
	# Filter by status.
	st = "",
	# ex: String = ""   Eg: ex_example
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "get_affiliate_download")
	bzz_callable.bind(
		st,
		ex,
		year,
...
# Operation getAffiliateSignups → GET /affiliate/signups
...
func get_affiliate_signups(
	...
	# Compute the URL path to the API resource
	var bzz_path := "/apiv2/affiliate/signups"
	...
	self._bzz_request(
		bzz_method, bzz_path, bzz_headers, bzz_query, bzz_body,
		func(bzz_response):
			bzz_response.data = GetAffiliateSignups200Response.bzz_denormalize_single(bzz_response.data)
			on_success.call(bzz_response)
			,
		func(bzz_error):
			on_failure.call(bzz_error)
...
func get_affiliate_signups_threaded(
	# st: String = ""   Eg: st_example
	# Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.
	st = "",
	on_success: Callable = Callable(),  # func(response: ApiResponse)
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "get_affiliate_signups")
	bzz_callable.bind(
		st,
		on_success,
		on_failure,
...
# Operation initiatePayment → GET /billing/pay/{method}/{invoices}
...
func initiate_payment(
	...
	# Compute the URL path to the API resource
	var bzz_path := "/apiv2/billing/pay/{method}/{invoices}".replace("{" + "method" + "}", _bzz_urlize_path_param(method)).replace("{" + "invoices" + "}", _bzz_urlize_path_param(invoices))
...
# Operation patchBillingCreditCardVerify → PATCH /billing/creditcards/{id}/verify
...
func patch_billing_credit_card_verify(
	# id: int   Eg: 56
	# The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
	id: int,
	...
	if not bzz_found_producible_mime:
		var error := ApiError.new()
		error.identifier = "patch_billing_credit_card_verify.headers.content_type"
		error.message = "That endpoint only accepts %s as content type(s) and none are supported by this client."
		on_failure.call(error)
		return
	var bzz_mimes_produced_by_server := ['application/json']
	...
	var bzz_body = null
	bzz_body = patchBillingCreditCardVerifyRequest
...
func patch_billing_credit_card_verify_threaded(
	# id: int   Eg: 56
	# The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
	id: int,
	# patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest
	...
	var bzz_thread := Thread.new()
	var bzz_callable := Callable(self, "patch_billing_credit_card_verify")
	bzz_callable.bind(
		id,
