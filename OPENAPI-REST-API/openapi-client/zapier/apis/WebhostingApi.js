...
const WebsiteOrderPostRequest = require('../models/WebsiteOrderPostRequest');
const WebsiteOrderPutRequest = require('../models/WebsiteOrderPutRequest');
...
module.exports = {
    addWebsite: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Place a new webhosting order, create the invoice, and queue provisioning',
        ...
        operation: {
            inputFields: [
                ...WebsiteOrderPostRequest.fields(),
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...WebsiteOrderPostRequest.mapping(bundle),
                    },
                }
    ...
    getNewWebsite: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Read the webhosting order catalog — plans, packages, promo offers, pricing',
    ...
    getWebsiteBuyIp: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Read website IPs, current reverse DNS, and additional-IP pricing',
    ...
    getWebsiteInfo: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Read full configuration and status detail for one webhosting service',
    ...
    getWebsiteInvoices: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'List all billing invoices and recurring charges scoped to one website',
    ...
    getWebsiteList: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'List the caller&#39;s webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services',
    ...
    getWebsitesBackups: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'List off-site cpmove backups stored in Swift — list or inline-download archive',
    ...
    getWebsitesWelcomeEmail: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Resend the webhosting welcome email with control-panel credentials and URL',
    ...
    gettWebsiteReverseDns: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Read current reverse-DNS (PTR) records for the website&#39;s IPs',
    ...
    postWebsiteBuyIp: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Buy an additional IP for the website OR update reverse DNS records',
    ...
    postWebsiteMigration: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Submit a request for InterServer staff to migrate a website from another host',
    ...
    postWebsitesReverseDns: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Bulk-update reverse-DNS (PTR) records for one or more website IPs',
    ...
    putWebsites: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Validate a webhosting order and preview cost — dry run, no charge',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...WebsiteOrderPutRequest.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
    ...
    updateWebsiteInfo: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'POST mutation hook for the website detail page (use dedicated ops where possible)',
    ...
    webhostingCancel: {
        ...
        noun: 'Webhosting',
        display: {
            label: 'Schedule termination of a webhosting service — wipes panel account at cycle end',
