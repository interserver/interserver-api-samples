...
const getAffiliateSignups_200_response = require('../models/getAffiliateSignups_200_response');
const initiatePayment_200_response = require('../models/initiatePayment_200_response');
const patchBillingCreditCardVerify_request = require('../models/patchBillingCreditCardVerify_request');
...
module.exports = {
    addBillingCreditCard: {
        ...
        noun: 'Billing',
        display: {
            label: 'Store a credit card on the account — may return a verification flow',
    ...
    addBillingPrepay: {
        ...
        noun: 'Billing',
        display: {
            label: 'Create a prepay deposit and return an invoice id to fund it',
    ...
    deleteBillingCreditCard: {
        ...
        noun: 'Billing',
        display: {
            label: 'Remove a stored credit card from the account',
    ...
    deleteBillingInvoice: {
        ...
        noun: 'Billing',
        display: {
            label: 'Cancel a pending unpaid invoice — and its pending service or repeat invoice',
    ...
    deleteBillingPrepay: {
        ...
        noun: 'Billing',
        display: {
            label: 'Delete an unfunded prepay or strip its unpaid funding invoices',
    ...
    getAffiliateBanners: {
        ...
        noun: 'Billing',
        display: {
            label: 'List affiliate banner image assets with filename and dimensions',
    ...
    getAffiliateDownload: {
        key: 'getAffiliateDownload',
        noun: 'Billing',
        display: {
            label: 'Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download',
        ...
        operation: {
            inputFields: [
                ...
                {
                    key: 'ex',
                    label: 'Export format: csv, xls, xlsx, or pdf. Defaults to csv.',
                    type: 'string',
                    choices: [
                        'csv',
                        'xls',
                ...
                {
                    key: 'year',
                    label: 'Year to filter the report. Defaults to the current year.',
                    type: 'integer',
                },
            ],
            outputFields: [
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://my.interserver.net/apiv2/affiliate/download'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
                    ...
                    params: {
                        'st': bundle.inputData?.['st'],
                        'ex': bundle.inputData?.['ex'],
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getAffiliateDownload', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    getAffiliateRichReport: {
        ...
        noun: 'Billing',
        display: {
            label: 'Read a combined affiliate performance summary (HTML payload)',
    ...
    getAffiliateSalesGraph: {
        ...
        noun: 'Billing',
        display: {
            label: 'Read aggregated affiliate sales time-series (monthly buckets) for chart rendering',
    ...
    getAffiliateSignups: {
        key: 'getAffiliateSignups',
        noun: 'Billing',
        display: {
            label: 'Read affiliate signup stats and per-customer conversion data',
        ...
        operation: {
            inputFields: [
                {
                    key: 'st',
                    label: 'Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results.',
                    type: 'string',
                },
            ],
            outputFields: [
                ...getAffiliateSignups_200_response.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://my.interserver.net/apiv2/affiliate/signups'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getAffiliateSignups', response.json);
                    return results;
                })
            },
            sample: samples['getAffiliateSignups_200_responseSample']
        }
    },
    getAffiliateTrafficGraph: {
        ...
        noun: 'Billing',
        display: {
            label: 'Read aggregated affiliate referral click/visit time-series for chart rendering',
    ...
    getAffiliateWebTraffic: {
        ...
        noun: 'Billing',
        display: {
            label: 'List the 20 most recent affiliate referral visits with IP, referrer, timestamp',
    ...
    getBillingCart: {
        ...
        noun: 'Billing',
        display: {
            label: 'Read the current shopping cart contents, totals, and available payment methods',
    ...
    getBillingCreditCardVerify: {
        ...
        noun: 'Billing',
        display: {
            label: 'Probe whether a stored card still needs micro-charge verification',
    ...
    getBillingInvoice: {
        ...
        noun: 'Billing',
        display: {
            label: 'Read full invoice detail — line items, totals, paid status, customer info',
    ...
    getBillingInvoices: {
        ...
        noun: 'Billing',
        display: {
            label: 'List every invoice on the account with summary totals and paid/unpaid status',
    ...
    getBillingPrePays: {
        ...
        noun: 'Billing',
        display: {
            label: 'List prepay deposits on the account — remaining balance and auto-use flags',
    ...
    initiatePayment: {
        ...
        operation: {
            inputFields: [
                ...
                {
                    key: 'invoices',
                    label: 'A comma-separated list of invoice IDs or invoice Tags to pay. These IDs are returned by order endpoints (e.g. &#x60;/backups/order&#x60;, &#x60;/vps/order&#x60;) and by &#x60;/billing/invoices&#x60;. Invoice tags accepted are SERVICE&lt;module&gt;&lt;id&gt;, RINV&lt;module&gt;&lt;repeat invoice id&gt;, INV&lt;module&gt;&lt;invoice id&gt;, PREPAY&lt;prepay id&gt;&lt;invoice id&gt;, and &lt;invoice id&gt;.',
                    type: 'string',
                    required: true,
                },
            ],
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://my.interserver.net/apiv2/billing/pay/{method}/{invoices}'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
    ...
    patchBillingCreditCardVerify: {
        key: 'patchBillingCreditCardVerify',
        noun: 'Billing',
        display: {
            label: 'Place two micro-charges on the card to start CVV verification (step 1 of 2)',
        ...
        operation: {
            inputFields: [
                ...
                ...patchBillingCreditCardVerify_request.fields(),
            ],
            outputFields: [
                ...SuccessTextResponse.fields('', false),
            ],
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...patchBillingCreditCardVerify_request.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'patchBillingCreditCardVerify', response.json);
                    return results;
                })
            },
            sample: samples['SuccessTextResponseSample']
    ...
    postBillingCreditCardVerify: {
        ...
        noun: 'Billing',
        display: {
            label: 'Submit two micro-charge amounts to finalize card verification (step 2 of 2)',
    ...
    updateAffiliateDockSetup: {
        ...
        noun: 'Billing',
        display: {
            label: 'Configure the affiliate landing dock title, description, and referrer coupon',
    ...
    updateAffiliatePaymentSetup: {
        ...
        noun: 'Billing',
        display: {
            label: 'Configure how affiliate commissions get paid out (PayPal or internal prepay)',
    ...
    updateBillingCreditCard: {
        ...
        noun: 'Billing',
        display: {
            label: 'Refresh stored card expiration and re-trigger MaxMind fraud scoring',
    ...
    updateBillingPaymentMethod: {
        ...
        noun: 'Billing',
        display: {
            label: 'Set the account&#39;s default payment method for recurring/auto charges',
