...
module.exports = {
    addDnsDomain: {
        ...
        noun: 'DNS',
        display: {
            label: 'Create a new authoritative DNS zone seeded with apex A + NS + SOA records',
    ...
    addDnsRecord: {
        ...
        noun: 'DNS',
        display: {
            label: 'Add a DNS record (A, AAAA, MX, TXT, CNAME, NS, SRV, CAA, ...) to a zone',
    ...
    deleteDnsDomain: {
        ...
        noun: 'DNS',
        display: {
            label: 'Permanently delete a DNS zone and every record it contains',
    ...
    deleteDnsRecord: {
        ...
        noun: 'DNS',
        display: {
            label: 'Permanently delete one DNS record from a zone — zone itself is preserved',
    ...
    getDnsDomain: {
        ...
        noun: 'DNS',
        display: {
            label: 'List every DNS record in one zone with the IDs needed to edit or delete them',
    ...
    getDnsList: {
        ...
        noun: 'DNS',
        display: {
            label: 'List DNS zones hosted on the account with each zone&#39;s apex A-record IP',
    ...
    updateDnsRecord: {
        ...
        noun: 'DNS',
        display: {
            label: 'Replace values on an existing DNS record (name, type, content, ttl, priority)',
