...
module.exports = {
    addVps: {
        ...
        noun: 'VPS',
        display: {
            label: 'Place a new VPS order, create the invoice, and queue provisioning',
    ...
    deleteVpsBackup: {
        ...
        noun: 'VPS',
        display: {
            label: 'Permanently delete a VPS backup file by name (irreversible)',
    ...
    doVpsBlockSmtp: {
        ...
        noun: 'VPS',
        display: {
            label: 'Block outbound SMTP (port 25) on the VPS to prevent spam/abuse',
    ...
    doVpsDisableCd: {
        ...
        noun: 'VPS',
        display: {
            label: 'Remove the virtual CD/DVD device entirely from the VPS configuration',
    ...
    doVpsDisableQuota: {
        ...
        noun: 'VPS',
        display: {
            label: 'Disable per-user disk quota enforcement inside the VPS guest OS',
    ...
    doVpsEjectCd: {
        ...
        noun: 'VPS',
        display: {
            label: 'Eject the mounted ISO from the VPS virtual CD drive (keep the drive)',
    ...
    doVpsRestart: {
        ...
        noun: 'VPS',
        display: {
            label: 'Reboot the VPS — preferred over stop+start for software changes',
    ...
    doVpsStart: {
        ...
        noun: 'VPS',
        display: {
            label: 'Power on a stopped VPS instance',
    ...
    doVpsStop: {
        ...
        noun: 'VPS',
        display: {
            label: 'Power off a running VPS — billing continues until cancellation',
    ...
    downloadVpsBackup: {
        ...
        noun: 'VPS',
        display: {
            label: 'Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup',
    ...
    getNewVps: {
        ...
        noun: 'VPS',
        display: {
            label: 'Get the VPS order catalog — platforms, OS templates, locations, pricing',
    ...
    getVpsBackup: {
        ...
        noun: 'VPS',
        display: {
            label: 'Trigger a manual on-demand snapshot/backup of the VPS',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getVpsBackup', response.json);
                    return results;
                })
            },
            sample: samples['QueueResponseSample']
    ...
    getVpsBackups: {
        ...
        noun: 'VPS',
        display: {
            label: 'List existing backups for the VPS across Swift, MinIO, and ZFS',
    ...
    getVpsBuyHdSpace: {
        ...
        noun: 'VPS',
        display: {
            label: 'Get current additional disk size and per-GB monthly cost for the VPS',
    ...
    getVpsBuyIp: {
        ...
        noun: 'VPS',
        display: {
            label: 'Read current additional IPs, cap, and per-IP monthly cost for the VPS',
    ...
    getVpsChangeHostname: {
        key: 'getVpsChangeHostname',
        noun: 'VPS',
        display: {
            label: 'Read the VPS&#39;s current hostname before changing it',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getVpsChangeHostname', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    getVpsChangeRootPassword: {
        key: 'getVpsChangeRootPassword',
        noun: 'VPS',
        display: {
            label: 'Pre-flight check before changing the VPS root password',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getVpsChangeRootPassword', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    getVpsChangeTimezone: {
        ...
        noun: 'VPS',
        display: {
            label: 'List IANA timezones supported by the VPS guest OS',
    ...
    getVpsInfo: {
        ...
        noun: 'VPS',
        display: {
            label: 'Get full details for one VPS — IPs, hostname, OS, slices, status, addons',
    ...
    getVpsInsertCd: {
        ...
        noun: 'VPS',
        display: {
            label: 'List ISO templates that can be mounted in the VPS virtual CD drive',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getVpsInsertCd', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    getVpsInvoices: {
        ...
        noun: 'VPS',
        display: {
            label: 'List all billing invoices associated with this specific VPS',
    ...
    getVpsList: {
        ...
        noun: 'VPS',
        display: {
            label: 'List all VPS services on the customer&#39;s account',
    ...
    getVpsReinstallOs: {
        ...
        noun: 'VPS',
        display: {
            label: 'List OS templates compatible with this VPS&#39;s hypervisor for reinstall',
    ...
    getVpsResetPassword: {
        key: 'getVpsResetPassword',
        noun: 'VPS',
        display: {
            label: 'Pre-flight check before resetting the VPS root password to a random value',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getVpsResetPassword', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    getVpsReverseDns: {
        ...
        noun: 'VPS',
        display: {
            label: 'Read the current PTR (reverse-DNS) records for every IP on the VPS',
    ...
    getVpsSetupVnc: {
        ...
        noun: 'VPS',
        display: {
            label: 'Read current VNC console connection info for the VPS',
    ...
    getVpsSlices: {
        ...
        noun: 'VPS',
        display: {
            label: 'Read current slice count, min/max range, and prorated per-slice upgrade cost',
    ...
    getVpsTrafficUsage: {
        ...
        noun: 'VPS',
        display: {
            label: 'Read bandwidth traffic usage data for the VPS',
    ...
    getVpsViewDesktop: {
        ...
        noun: 'VPS',
        display: {
            label: 'Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS',
    ...
    getVpsWelcomeEmail: {
        ...
        noun: 'VPS',
        display: {
            label: 'Resend the welcome email containing VPS IP, hostname, and root credentials',
    ...
    postVpsBuyHdSpace: {
        ...
        noun: 'VPS',
        display: {
            label: 'Buy or resize the VPS additional-disk addon and create a prorated invoice',
    ...
    postVpsBuyIp: {
        ...
        noun: 'VPS',
        display: {
            label: 'Purchase one additional IP for the VPS and create the invoice',
    ...
    postVpsChangeHostname: {
        ...
        noun: 'VPS',
        display: {
            label: 'Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP',
    ...
    postVpsChangeRootPassword: {
        ...
        noun: 'VPS',
        display: {
            label: 'Set a specific new root/Administrator password on the VPS',
    ...
    postVpsChangeWebuzoPassword: {
        ...
        noun: 'VPS',
        display: {
            label: 'Rotate the Webuzo control panel admin password (re-auth required)',
    ...
    postVpsInsertCd: {
        ...
        noun: 'VPS',
        display: {
            label: 'Mount an ISO image in the VPS virtual CD drive from a URL',
    ...
    postVpsReinstallOs: {
        ...
        noun: 'VPS',
        display: {
            label: 'Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)',
    ...
    postVpsResetPassword: {
        ...
        noun: 'VPS',
        display: {
            label: 'Reset the VPS root password to a server-generated random value',
            description: 'Resets the VPS root/Administrator password to a fresh random value generated on the hypervisor — typical when the customer has lost the existing password and cannot recover it. Queues a &#x60;reset_password&#x60; action on the hypervisor (&#x60;vpsqueue&#x60;). The new password is delivered via the standard hypervisor password-change channel (logged to &#x60;history_log&#x60; and surfaced through &#x60;getVpsWelcomeEmail&#x60; / dashboard credential views). **No rollback** — to undo, set a new password via &#x60;postVpsChangeRootPassword&#x60; or call &#x60;postVpsResetPassword&#x60; again. Sibling ops: &#x60;getVpsResetPassword&#x60;, &#x60;postVpsChangeRootPassword&#x60;, &#x60;postVpsChangeWebuzoPassword&#x60;.  **Path param:** - &#x60;id&#x60; (integer, required) — VPS id from &#x60;getVpsList.vps_id&#x60;.  **Body:** None — password is generated server-side.  **Returns:** &#x60;{ text, queueId }&#x60; — allow ~2 minutes.  **Side effects:** - Inserts &#x60;vpsqueue&#x60; &#x60;reset_password&#x60; row; hypervisor agent generates and applies the new password.  **Auth:** Session/API key. Ownership enforced.  **Errors:** - &#x60;401&#x60; — unauthenticated. - &#x60;404 Invalid VPS Passed&#x60;. - &#x60;409 VPS is not active&#x60;.  **Related calls:** - **Specific password instead:** &#x60;postVpsChangeRootPassword&#x60;. - **Retrieve the new credentials:** &#x60;getVpsWelcomeEmail&#x60; (resends with current credentials). ',
            hidden: false,
        },
        operation: {
            inputFields: [
    ...
    postVpsRestore: {
        ...
        noun: 'VPS',
        display: {
            label: 'Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)',
    ...
    postVpsReverseDns: {
        ...
        noun: 'VPS',
        display: {
            label: 'Bulk-update PTR (reverse-DNS) records for one or more VPS IPs',
    ...
    postVpsSetupVnc: {
        ...
        noun: 'VPS',
        display: {
            label: 'Provision or refresh the VNC console endpoint for the VPS',
    ...
    postVpsSlices: {
        ...
        noun: 'VPS',
        display: {
            label: 'Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)',
    ...
    postVpsTrafficUsage: {
        key: 'postVpsTrafficUsage',
        noun: 'VPS',
        display: {
            label: 'Search/filter VPS bandwidth usage with custom criteria (reserved)',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'postVpsTrafficUsage', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    postVpsViewDesktop: {
        ...
        noun: 'VPS',
        display: {
            label: 'Refresh the remote-desktop session connection info after IP/hostname changes',
    ...
    putVpsBuyHdSpace: {
        key: 'putVpsBuyHdSpace',
        noun: 'VPS',
        display: {
            label: 'Preview cost to set additional VPS disk to a target GB size — dry run',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'putVpsBuyHdSpace', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    updateVpsInfo: {
        ...
        noun: 'VPS',
        display: {
            label: 'Update editable settings on a VPS service record',
    ...
    vPSCancel: {
        ...
        noun: 'VPS',
        display: {
            label: 'Cancel a VPS service at the end of the current billing cycle',
