...
const getAccountLocales_200_response_value = require('../models/getAccountLocales_200_response_value');
...
module.exports = {
    getAccountCurrencies: {
        ...
        noun: 'Public',
        display: {
            label: 'List enabled currency codes accepted for billing and preferences',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://my.interserver.net/apiv2/account/currencies'),
                    method: 'GET',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    ...
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getAccountCurrencies', response.json);
                    return { data: results };
                })
            },
            sample: { data: {} }
    ...
    getAccountLocales: {
        key: 'getAccountLocales',
        noun: 'Public',
        display: {
            label: 'List supported UI locales with English and native display names',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    url: utils.replacePathParameters('https://my.interserver.net/apiv2/account/locales'),
                    method: 'GET',
                    removeMissingValuesFrom: { params: true, body: true },
                    headers: {
                        'Content-Type': '',
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'getAccountLocales', response.json);
                    return results;
                })
            },
            sample: samples['getAccountLocales_200_response_valueSample']
        }
    },
    getCaptcha: {
        key: 'getCaptcha',
        noun: 'Public',
        display: {
            label: 'Fetch a base64 JPEG captcha challenge for human verification',
    ...
    getCountries: {
        ...
        noun: 'Public',
        display: {
            label: 'List enabled countries keyed by ISO-2/ISO-3/numeric code',
    ...
    getLoginInfo: {
        ...
        noun: 'Public',
        display: {
            label: 'Fetch logo, captcha, language, and stats for rendering a login page',
    ...
    getTimezones: {
        ...
        noun: 'Public',
        display: {
            label: 'List all PHP timezone identifiers usable on accounts and services',
    ...
    patchOauthTwoFactor: {
        ...
        noun: 'Public',
        display: {
            label: 'Submit 2FA code to finish OAuth login when account has 2FA enabled',
    ...
    postOauthCallback: {
        ...
        noun: 'Public',
        display: {
            label: 'Complete OAuth login by linking provider to existing or new account',
    ...
    submitSignup: {
        ...
        noun: 'Public',
        display: {
            label: 'Create a new customer account (email + password + captcha + ToS)',
