...
const DomainOrderRequest = require('../models/DomainOrderRequest');
...
module.exports = {
    addDomain: {
        ...
        noun: 'Domains',
        display: {
            label: 'Place a new domain registration or transfer order, generate billing invoice',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...DomainOrderRequest.mapping(bundle),
                    },
                }
    ...
    addDomainDnssec: {
        ...
        noun: 'Domains',
        display: {
            label: 'Register DNSSEC DS records on the domain at OpenSRS',
    ...
    addDomainNameserver: {
        ...
        noun: 'Domains',
        display: {
            label: 'Register a new nameserver host with glue IP at the registry (registered nameserver)',
    ...
    cancelDomain: {
        ...
        noun: 'Domains',
        display: {
            label: 'Cancel a domain order in the billing system to stop auto-renewals',
    ...
    deleteDomainDnssec: {
        ...
        noun: 'Domains',
        display: {
            label: 'Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)',
    ...
    deleteDomainNameserver: {
        ...
        noun: 'Domains',
        display: {
            label: 'Remove one registered nameserver glue record from the domain',
    ...
    getDomainContact: {
        ...
        noun: 'Domains',
        display: {
            label: 'Read the current registrant/admin/tech/billing contact field set for a domain',
    ...
    getDomainInfo: {
        ...
        noun: 'Domains',
        display: {
            label: 'Read full billing, registrar, and service detail for one domain',
    ...
    getDomainInvoices: {
        ...
        noun: 'Domains',
        display: {
            label: 'List all billing invoices scoped to one domain order',
    ...
    getDomainLookup: {
        ...
        noun: 'Domains',
        display: {
            label: 'Check availability, premium status, and pricing for a specific domain',
    ...
    getDomainNameservers: {
        ...
        noun: 'Domains',
        display: {
            label: 'List registered nameserver hosts and glue IP addresses for a domain',
    ...
    getDomainRenewal: {
        ...
        noun: 'Domains',
        display: {
            label: 'Read renewal pricing, expiry, and whether a renewal invoice already exists',
    ...
    getDomainSearch: {
        ...
        noun: 'Domains',
        display: {
            label: 'Get registrar-suggested domain alternatives and bulk availability for a search term',
    ...
    getDomainWhoisPrivacy: {
        ...
        noun: 'Domains',
        display: {
            label: 'Read Whois privacy availability, current state, and add-on pricing for a domain',
    ...
    getDomainsList: {
        ...
        noun: 'Domains',
        display: {
            label: 'List every domain registration on the account with billing and registration metadata',
    ...
    getDomainsWelcomeEmail: {
        ...
        noun: 'Domains',
        display: {
            label: 'Resend the domain welcome email with registration details and management instructions',
    ...
    getNewDomain: {
        ...
        noun: 'Domains',
        display: {
            label: 'Read the buyable domain TLD service catalog and Whois privacy pricing',
    ...
    patchDomains: {
        ...
        noun: 'Domains',
        display: {
            label: 'Validate posted domain-order field values before committing — dry run',
    ...
    postDomainRenewal: {
        ...
        noun: 'Domains',
        display: {
            label: 'Submit a domain renewal request and generate the renewal invoice',
    ...
    postDomainSearch: {
        key: 'postDomainSearch',
        noun: 'Domains',
        display: {
            label: 'Get the full order form data for a hostname in one round-trip (search → order preview)',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                ...
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
                    const results = utils.responseOptionsMiddleware(z, bundle, 'postDomainSearch', response.json);
                    return results;
                })
            },
            sample: { data: {} }
    ...
    postDomainTransfer: {
        ...
        noun: 'Domains',
        display: {
            label: 'Re-poll OpenSRS transfer status for a domain order via POST',
    ...
    putDomains: {
        ...
        noun: 'Domains',
        display: {
            label: 'Preview per-TLD field requirements for a domain order — no commit',
    ...
    updateDomainContact: {
        ...
        noun: 'Domains',
        display: {
            label: 'Update registrant/admin contact details and push them to OpenSRS',
    ...
    updateDomainInfo: {
        ...
        noun: 'Domains',
        display: {
            label: 'POST mutation hook for the domain detail page (use dedicated ops where possible)',
            description: 'Account-level write-back hook for the domain service record. Runs the same &#x60;View::go()&#x60; handler as &#x60;getDomainInfo&#x60; — it does NOT push registrar-side changes by itself. **For specific changes use the dedicated endpoints** — they push to OpenSRS where appropriate. Sibling ops: &#x60;getDomainInfo&#x60;, &#x60;updateDomainContact&#x60;, &#x60;updateDomainNameservers&#x60;, &#x60;addDomainDnssec&#x60;, &#x60;updateDomainWhoisPrivacy&#x60;.  **Path param:** - &#x60;id&#x60; (integer, required) — &#x60;domain_id&#x60; from &#x60;getDomainsList&#x60;.  **Body:** Form fields matching the domain service record.  **Returns:** &#x60;SuccessTextResponse&#x60;.  **Auth:** Session/API key. Ownership enforced.  **Errors:** - &#x60;401&#x60; — unauthenticated. - &#x60;404&#x60; — &#x60;id&#x60; not owned by caller.  **Prefer these dedicated endpoints:** - **Registrant/admin contact:** &#x60;updateDomainContact&#x60; (pushes to OpenSRS). - **Nameservers:** &#x60;updateDomainNameservers&#x60;, &#x60;addDomainNameserver&#x60;, &#x60;deleteDomainNameserver&#x60;. - **DNSSEC:** &#x60;addDomainDnssec&#x60;, &#x60;deleteDomainDnssec&#x60;. - **Whois privacy:** &#x60;updateDomainWhoisPrivacy&#x60;. - **Renew:** &#x60;postDomainRenewal&#x60;. - **Cancel:** &#x60;CancelDomain&#x60;. ',
            hidden: false,
        },
        operation: {
            inputFields: [
    ...
    updateDomainNameservers: {
        ...
        noun: 'Domains',
        display: {
            label: 'Replace the full authoritative-nameserver delegation list at the registrar',
    ...
    updateDomainWhoisPrivacy: {
        ...
        noun: 'Domains',
        display: {
            label: 'Order, enable, or cancel the Whois privacy add-on for a domain',
