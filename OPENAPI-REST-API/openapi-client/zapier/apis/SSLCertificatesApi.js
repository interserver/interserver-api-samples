...
const SslOrderRequest = require('../models/SslOrderRequest');
...
module.exports = {
    addSsl: {
        ...
        display: {
            label: 'Place a new SSL certificate order - creates invoice and queues issuance',
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...SslOrderRequest.mapping(bundle),
                    },
                }
    ...
    getNewSsl: {
        ...
        noun: 'SSL-Certificates',
        display: {
            label: 'Get available SSL certificate packages and pricing for placing a new order',
    ...
    getSslInfo: {
        ...
        noun: 'SSL-Certificates',
        display: {
            label: 'Get full details for one SSL certificate by id - status, expiration, links',
    ...
    getSslInvoices: {
        ...
        noun: 'SSL-Certificates',
        display: {
            label: 'List all billing invoices and charges tied to one SSL certificate by id',
    ...
    getSslList: {
        ...
        noun: 'SSL-Certificates',
        display: {
            label: 'List all SSL certificates on the authenticated customer account with status and hostname',
    ...
    getSslWelcomeEmail: {
        ...
        noun: 'SSL-Certificates',
        display: {
            label: 'Resend the SSL welcome email with cert credentials and install instructions',
    ...
    putSsl: {
        ...
        noun: 'SSL-Certificates',
        display: {
            label: 'Validate an SSL certificate order without charging - dry-run before addSsl',
    ...
    sslCancel: {
        ...
        noun: 'SSL-Certificates',
        display: {
            label: 'Cancel an SSL certificate service - stops renewals at end of billing cycle',
    ...
    updateSslInfo: {
        ...
        noun: 'SSL-Certificates',
        display: {
            label: 'Update mutable settings on an existing SSL certificate order by id',
