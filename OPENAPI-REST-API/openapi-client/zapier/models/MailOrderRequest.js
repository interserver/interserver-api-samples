        ...
        return [
            {
                ...
                label: `Mail plan service type id from getNewMail.serviceTypes (must be buyable). - [${labelPrefix}serviceType]`,
                required: true,
                type: 'integer',
            },
            {
            ...
            },
            {
                ...
                label: `Free-form note saved on the service row (used on addMail). - [${labelPrefix}comment]`,
                type: 'string',
            },
        ]
    },
