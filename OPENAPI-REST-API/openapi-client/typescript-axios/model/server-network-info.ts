...
// @ts-ignore
import type { ServerNetworkInfoAssets } from './server-network-info-assets.js';
// May contain unused imports in some cases
// @ts-ignore
import type { ServerNetworkInfoSwitchports } from './server-network-info-switchports.js';
