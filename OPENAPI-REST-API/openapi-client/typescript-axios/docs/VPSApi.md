...
|------------- | ------------- | -------------|
|[**addVps**](#addvps) | **POST** /vps/order | Place a new VPS order, create the invoice, and queue provisioning|
|[**deleteVpsBackup**](#deletevpsbackup) | **DELETE** /vps/{id}/backups | Permanently delete a VPS backup file by name (irreversible)|
|[**doVpsBlockSmtp**](#dovpsblocksmtp) | **GET** /vps/{id}/block_smtp | Block outbound SMTP (port 25) on the VPS to prevent spam/abuse|
|[**doVpsDisableCd**](#dovpsdisablecd) | **GET** /vps/{id}/disable_cd | Remove the virtual CD/DVD device entirely from the VPS configuration|
|[**doVpsDisableQuota**](#dovpsdisablequota) | **GET** /vps/{id}/disable_quota | Disable per-user disk quota enforcement inside the VPS guest OS|
|[**doVpsEjectCd**](#dovpsejectcd) | **GET** /vps/{id}/eject_cd | Eject the mounted ISO from the VPS virtual CD drive (keep the drive)|
|[**doVpsEnableQuota**](#dovpsenablequota) | **GET** /vps/{id}/enable_quota | Enable per-user disk quota enforcement inside the VPS guest OS|
|[**doVpsRestart**](#dovpsrestart) | **GET** /vps/{id}/restart | Reboot the VPS — preferred over stop+start for software changes|
|[**doVpsStart**](#dovpsstart) | **GET** /vps/{id}/start | Power on a stopped VPS instance|
|[**doVpsStop**](#dovpsstop) | **GET** /vps/{id}/stop | Power off a running VPS — billing continues until cancellation|
|[**downloadVpsBackup**](#downloadvpsbackup) | **PATCH** /vps/{id}/backups | Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup|
|[**getNewVps**](#getnewvps) | **GET** /vps/order | Get the VPS order catalog — platforms, OS templates, locations, pricing|
|[**getVpsBackup**](#getvpsbackup) | **GET** /vps/{id}/backup | Trigger a manual on-demand snapshot/backup of the VPS|
|[**getVpsBackups**](#getvpsbackups) | **GET** /vps/{id}/backups | List existing backups for the VPS across Swift, MinIO, and ZFS|
|[**getVpsBuyHdSpace**](#getvpsbuyhdspace) | **GET** /vps/{id}/buy_hd_space | Get current additional disk size and per-GB monthly cost for the VPS|
|[**getVpsBuyIp**](#getvpsbuyip) | **GET** /vps/{id}/buy_ip | Read current additional IPs, cap, and per-IP monthly cost for the VPS|
|[**getVpsChangeHostname**](#getvpschangehostname) | **GET** /vps/{id}/change_hostname | Read the VPS\&#39;s current hostname before changing it|
|[**getVpsChangeRootPassword**](#getvpschangerootpassword) | **GET** /vps/{id}/change_root_password | Pre-flight check before changing the VPS root password|
|[**getVpsChangeTimezone**](#getvpschangetimezone) | **GET** /vps/{id}/change_timezone | List IANA timezones supported by the VPS guest OS|
|[**getVpsInfo**](#getvpsinfo) | **GET** /vps/{id} | Get full details for one VPS — IPs, hostname, OS, slices, status, addons|
|[**getVpsInsertCd**](#getvpsinsertcd) | **GET** /vps/{id}/insert_cd | List ISO templates that can be mounted in the VPS virtual CD drive|
|[**getVpsInvoices**](#getvpsinvoices) | **GET** /vps/{id}/invoices | List all billing invoices associated with this specific VPS|
|[**getVpsList**](#getvpslist) | **GET** /vps | List all VPS services on the customer\&#39;s account|
|[**getVpsReinstallOs**](#getvpsreinstallos) | **GET** /vps/{id}/reinstall_os | List OS templates compatible with this VPS\&#39;s hypervisor for reinstall|
|[**getVpsResetPassword**](#getvpsresetpassword) | **GET** /vps/{id}/reset_password | Pre-flight check before resetting the VPS root password to a random value|
|[**getVpsReverseDns**](#getvpsreversedns) | **GET** /vps/{id}/reverse_dns | Read the current PTR (reverse-DNS) records for every IP on the VPS|
|[**getVpsSetupVnc**](#getvpssetupvnc) | **GET** /vps/{id}/setup_vnc | Read current VNC console connection info for the VPS|
|[**getVpsSlices**](#getvpsslices) | **GET** /vps/{id}/slices | Read current slice count, min/max range, and prorated per-slice upgrade cost|
|[**getVpsTrafficUsage**](#getvpstrafficusage) | **GET** /vps/{id}/traffic_usage | Read bandwidth traffic usage data for the VPS|
|[**getVpsViewDesktop**](#getvpsviewdesktop) | **GET** /vps/{id}/view_desktop | Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS|
|[**getVpsWelcomeEmail**](#getvpswelcomeemail) | **GET** /vps/{id}/welcome_email | Resend the welcome email containing VPS IP, hostname, and root credentials|
|[**postVpsBuyHdSpace**](#postvpsbuyhdspace) | **POST** /vps/{id}/buy_hd_space | Buy or resize the VPS additional-disk addon and create a prorated invoice|
|[**postVpsBuyIp**](#postvpsbuyip) | **POST** /vps/{id}/buy_ip | Purchase one additional IP for the VPS and create the invoice|
|[**postVpsChangeHostname**](#postvpschangehostname) | **POST** /vps/{id}/change_hostname | Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP|
|[**postVpsChangeRootPassword**](#postvpschangerootpassword) | **POST** /vps/{id}/change_root_password | Set a specific new root/Administrator password on the VPS|
|[**postVpsChangeTimezone**](#postvpschangetimezone) | **POST** /vps/{id}/change_timezone | Set the system timezone on the VPS guest OS|
|[**postVpsChangeWebuzoPassword**](#postvpschangewebuzopassword) | **POST** /vps/{id}/change_webuzo_password | Rotate the Webuzo control panel admin password (re-auth required)|
|[**postVpsInsertCd**](#postvpsinsertcd) | **POST** /vps/{id}/insert_cd | Mount an ISO image in the VPS virtual CD drive from a URL|
|[**postVpsReinstallOs**](#postvpsreinstallos) | **POST** /vps/{id}/reinstall_os | Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)|
|[**postVpsResetPassword**](#postvpsresetpassword) | **POST** /vps/{id}/reset_password | Reset the VPS root password to a server-generated random value|
|[**postVpsRestore**](#postvpsrestore) | **POST** /vps/{id}/restore | Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)|
|[**postVpsReverseDns**](#postvpsreversedns) | **POST** /vps/{id}/reverse_dns | Bulk-update PTR (reverse-DNS) records for one or more VPS IPs|
|[**postVpsSetupVnc**](#postvpssetupvnc) | **POST** /vps/{id}/setup_vnc | Provision or refresh the VNC console endpoint for the VPS|
|[**postVpsSlices**](#postvpsslices) | **POST** /vps/{id}/slices | Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)|
|[**postVpsTrafficUsage**](#postvpstrafficusage) | **POST** /vps/{id}/traffic_usage | Search/filter VPS bandwidth usage with custom criteria (reserved)|
|[**postVpsViewDesktop**](#postvpsviewdesktop) | **POST** /vps/{id}/view_desktop | Refresh the remote-desktop session connection info after IP/hostname changes|
|[**putVps**](#putvps) | **PUT** /vps/order | Validate a VPS order configuration and quote the cost — dry run, no charge|
|[**putVpsBuyHdSpace**](#putvpsbuyhdspace) | **PUT** /vps/{id}/buy_hd_space | Preview cost to set additional VPS disk to a target GB size — dry run|
|[**updateVpsInfo**](#updatevpsinfo) | **POST** /vps/{id} | Update editable settings on a VPS service record|
|[**vPSCancel**](#vpscancel) | **DELETE** /vps/{id} | Cancel a VPS service at the end of the current billing cycle|
...
| **all** | [**&#39;0&#39; | &#39;1&#39;**]**Array<&#39;0&#39; &#124; &#39;1&#39; &#124; &#39;11184809&#39;>** | Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given VPS. | (optional) defaults to undefined|
...
const { status, data } = await apiInstance.getVpsBackup(
    id
);
```
...
const { status, data } = await apiInstance.getVpsChangeHostname(
    id
);
```
...
const { status, data } = await apiInstance.getVpsChangeRootPassword(
    id
);
```
...
const { status, data } = await apiInstance.getVpsInsertCd(
    id
);
```
...
const { status, data } = await apiInstance.getVpsResetPassword(
    id
);
```
...
const { status, data } = await apiInstance.postVpsTrafficUsage(
    id
);
```
...
const { status, data } = await apiInstance.putVpsBuyHdSpace(
    id
);
```
