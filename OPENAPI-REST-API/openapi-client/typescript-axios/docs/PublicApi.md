...
|------------- | ------------- | -------------|
|[**getAccountCurrencies**](#getaccountcurrencies) | **GET** /account/currencies | List enabled currency codes accepted for billing and preferences|
|[**getAccountLocales**](#getaccountlocales) | **GET** /account/locales | List supported UI locales with English and native display names|
|[**getCaptcha**](#getcaptcha) | **GET** /captcha | Fetch a base64 JPEG captcha challenge for human verification|
|[**getCountries**](#getcountries) | **GET** /account/countries | List enabled countries keyed by ISO-2/ISO-3/numeric code|
|[**getInfo**](#getinfo) | **GET** /info | Discover available modules, service packages, categories, and types|
|[**getLoginInfo**](#getlogininfo) | **GET** /login | Fetch logo, captcha, language, and stats for rendering a login page|
...
|[**getOauthRedirect**](#getoauthredirect) | **GET** /oauth | Begin OAuth login flow — redirect user to provider for authentication|
|[**getTimezones**](#gettimezones) | **GET** /account/timezones | List all PHP timezone identifiers usable on accounts and services|
|[**patchOauthTwoFactor**](#patchoauthtwofactor) | **PATCH** /oauth | Submit 2FA code to finish OAuth login when account has 2FA enabled|
|[**pingServer**](#pingserver) | **GET** /ping | Liveness check — returns the JSON string \&quot;pong\&quot; to confirm API is up|
|[**postOauthCallback**](#postoauthcallback) | **POST** /oauth | Complete OAuth login by linking provider to existing or new account|
|[**submitLogin**](#submitlogin) | **POST** /login | Authenticate with email + password and return a session token|
|[**submitSignup**](#submitsignup) | **POST** /signup | Create a new customer account (email + password + captcha + ToS)|

# **getAccountCurrencies**
> Array<string> getAccountCurrencies()
...
const { status, data } = await apiInstance.getAccountCurrencies();
```
...
# **getAccountLocales**
> { [key: string]: GetAccountLocales200ResponseValue; } getAccountLocales()
...
const { status, data } = await apiInstance.getAccountLocales();
```
...
**{ [key: string]: GetAccountLocales200ResponseValue; }**
