...
|------------- | ------------- | -------------|
|[**addNewTicket**](#addnewticket) | **POST** /tickets/new | Open a new helpdesk ticket, optionally linked to a service and attachments|
|[**closeTicket**](#closeticket) | **GET** /tickets/{id}/close | Close an open support ticket via simple GET request (no body required)|
|[**deleteTicketInfo**](#deleteticketinfo) | **DELETE** /tickets/{id} | Close a customer ticket via DELETE verb (closes only, never destroys data)|
|[**getNewTicket**](#getnewticket) | **GET** /tickets/new | Fetch services and product options to populate the new-ticket form|
|[**getTicketInfo**](#getticketinfo) | **GET** /tickets/{id} | Get full ticket details including subject, status, and the reply thread|
|[**getTicketsList**](#getticketslist) | **GET** /tickets | List the authenticated account\&#39;s support tickets with status and date filters|
|[**postTicketInfo**](#postticketinfo) | **POST** /tickets/{id} | Append a reply (and optional attachment, server-access fields) to a ticket|
|[**postTicketsList**](#postticketslist) | **POST** /tickets | Search the authenticated account\&#39;s tickets by subject, email, or mask ID|
|[**putTicketInfo**](#putticketinfo) | **PUT** /tickets/{id} | Update a ticket\&#39;s properties such as subject or status (stub, not implemented)|
|[**replyTicket**](#replyticket) | **POST** /tickets/{id}/reply | Post a simple text reply to an existing ticket thread (no attachments)|
|[**updateTicketInfo**](#updateticketinfo) | **POST** /tickets/{id}/update | Update a ticket\&#39;s custom field values (server-access details, etc.)|
