...
case class PublicApi[Auth <: org.openapitools.client.core.Authorization] private (baseUrl: String, authConfig: org.openapitools.client.core.Authorization):
   ...
   */
  def getAccountCurrencies(using Auth <:< org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], Seq[String]]] =
    val requestURL =
      uri"$baseUrl/account/currencies"
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getAccountLocales(using Auth <:< org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], Map[String, GetAccountLocales200ResponseValue]]] =
    val requestURL =
      uri"$baseUrl/account/locales"
