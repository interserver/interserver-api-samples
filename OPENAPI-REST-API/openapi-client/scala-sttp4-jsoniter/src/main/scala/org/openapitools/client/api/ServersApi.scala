...
case class ServersApi[Auth <: org.openapitools.client.core.Authorization] private (baseUrl: String, authConfig: org.openapitools.client.core.Authorization):
   ...
   */
  def addServer(serverOrderPostRequest: ServerOrderPostRequest)(using Auth <:< org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], AddServer200Response]] =
    val requestURL =
   ...
   */
  def serverBulkIpmiPowerGet(ids: String)(using Auth <:< org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], ServerBulkIpmiPowerResponse]] =
    val requestURL =
      uri"$baseUrl/servers/bulk/ipmi_power"
        .addParams(FormSerializable.serialize("ids", ids, FormStyleFormat.FORM, true): _*)
