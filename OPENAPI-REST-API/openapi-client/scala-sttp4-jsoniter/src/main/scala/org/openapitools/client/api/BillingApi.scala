...
case class BillingApi[Auth <: org.openapitools.client.core.Authorization] private (baseUrl: String, authConfig: org.openapitools.client.core.Authorization):
   ...
   */
  def getAffiliateDownload(st: Option[String] = scala.None, ex: Option[String] = scala.None, year: Option[Int] = scala.None)(using Auth <:< org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], Unit]] =
    val requestURL =
      uri"$baseUrl/affiliate/download"
        .addParams(FormSerializable.serialize("st", st, FormStyleFormat.FORM, true): _*)
        .addParams(FormSerializable.serialize("ex", ex, FormStyleFormat.FORM, true): _*)
        .addParams(FormSerializable.serialize("year", year, FormStyleFormat.FORM, true): _*)
   ...
   */
  def getAffiliateSignups(st: Option[String] = scala.None)(using Auth <:< org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], GetAffiliateSignups200Response]] =
    val requestURL =
      uri"$baseUrl/affiliate/signups"
        .addParams(FormSerializable.serialize("st", st, FormStyleFormat.FORM, true): _*)
  ...
  def initiatePayment(method: String, invoices: String)(using Auth <:< org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], InitiatePayment200Response]] =
    ...
    val requestURL =
      uri"$baseUrl/billing/pay/${methodPathParam}/${invoicesPathParam}"
   ...
   */
  def patchBillingCreditCardVerify(id: Int, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest)(using Auth <:< org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey | org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], SuccessTextResponse]] =
    val idPathParam = PathSerializable.serialize("id", id, PathStyleFormat.SIMPLE, false)
    val requestURL =
      uri"$baseUrl/billing/creditcards/${idPathParam}/verify"
