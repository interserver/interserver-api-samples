...
public interface VpsApi  {
    ...
    @ApiOperation(value = "Place a new VPS order, create the invoice, and queue provisioning", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/backups")
    @Produces({ "application/json" })
    @ApiOperation(value = "Permanently delete a VPS backup file by name (irreversible)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/block_smtp")
    @Produces({ "application/json" })
    @ApiOperation(value = "Block outbound SMTP (port 25) on the VPS to prevent spam/abuse", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/disable_cd")
    @Produces({ "application/json" })
    @ApiOperation(value = "Remove the virtual CD/DVD device entirely from the VPS configuration", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Disable per-user disk quota enforcement inside the VPS guest OS", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/eject_cd")
    @Produces({ "application/json" })
    @ApiOperation(value = "Eject the mounted ISO from the VPS virtual CD drive (keep the drive)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Enable per-user disk quota enforcement inside the VPS guest OS", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/restart")
    @Produces({ "application/json" })
    @ApiOperation(value = "Reboot the VPS — preferred over stop+start for software changes", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/start")
    @Produces({ "application/json" })
    @ApiOperation(value = "Power on a stopped VPS instance", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/stop")
    @Produces({ "application/json" })
    @ApiOperation(value = "Power off a running VPS — billing continues until cancellation", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/order")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get the VPS order catalog — platforms, OS templates, locations, pricing", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/backup")
    @Produces({ "application/json" })
    @ApiOperation(value = "Trigger a manual on-demand snapshot/backup of the VPS", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/backups")
    @Produces({ "application/json" })
    @ApiOperation(value = "List existing backups for the VPS across Swift, MinIO, and ZFS", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get current additional disk size and per-GB monthly cost for the VPS", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/buy_ip")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read current additional IPs, cap, and per-IP monthly cost for the VPS", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Read the VPS's current hostname before changing it", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Current hostname information for the VPS."),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Pre-flight check before changing the VPS root password", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Password requirements and current state."),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List IANA timezones supported by the VPS guest OS", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get full details for one VPS — IPs, hostname, OS, slices, status, addons", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/insert_cd")
    @Produces({ "application/json" })
    @ApiOperation(value = "List ISO templates that can be mounted in the VPS virtual CD drive", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Available CD/ISO images for the VPS."),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/invoices")
    @Produces({ "application/json" })
    @ApiOperation(value = "List all billing invoices associated with this specific VPS", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List all VPS services on the customer's account", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List OS templates compatible with this VPS's hypervisor for reinstall", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Pre-flight check before resetting the VPS root password to a random value", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Password reset requirements and current state."),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/reverse_dns")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read the current PTR (reverse-DNS) records for every IP on the VPS", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/setup_vnc")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read current VNC console connection info for the VPS", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/slices")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read current slice count, min/max range, and prorated per-slice upgrade cost", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Read bandwidth traffic usage data for the VPS", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Resend the welcome email containing VPS IP, hostname, and root credentials", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/buy_hd_space")
    @Produces({ "application/json" })
    @ApiOperation(value = "Buy or resize the VPS additional-disk addon and create a prorated invoice", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/buy_ip")
    @Produces({ "application/json" })
    @ApiOperation(value = "Purchase one additional IP for the VPS and create the invoice", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Set a specific new root/Administrator password on the VPS", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Set the system timezone on the VPS guest OS", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Rotate the Webuzo control panel admin password (re-auth required)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Mount an ISO image in the VPS virtual CD drive from a URL", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/reset_password")
    @Produces({ "application/json" })
    @ApiOperation(value = "Reset the VPS root password to a server-generated random value", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Bulk-update PTR (reverse-DNS) records for one or more VPS IPs", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/setup_vnc")
    @Produces({ "application/json" })
    @ApiOperation(value = "Provision or refresh the VNC console endpoint for the VPS", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response message from sending a service queue.", response = QueueResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/slices")
    @Produces({ "application/json" })
    @ApiOperation(value = "Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/traffic_usage")
    @Produces({ "application/json" })
    @ApiOperation(value = "Search/filter VPS bandwidth usage with custom criteria (reserved)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Filtered traffic usage search results."),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/view_desktop")
    @Produces({ "application/json" })
    @ApiOperation(value = "Refresh the remote-desktop session connection info after IP/hostname changes", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Validate a VPS order configuration and quote the cost — dry run, no charge", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/buy_hd_space")
    @Produces({ "application/json" })
    @ApiOperation(value = "Preview cost to set additional VPS disk to a target GB size — dry run", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Pricing preview for the requested HD space size."),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Update editable settings on a VPS service record", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Cancel a VPS service at the end of the current billing cycle", tags={  })
    @ApiResponses(value = { 
