...
public interface ScrubIpsApi  {
    ...
    @ApiOperation(value = "Cancel a Scrub IP service and stop its recurring DDoS billing", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Apply a predefined scrubbing filter (DNS/HTTP/synproxy) to a port", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Add a geographic firewall rule (block/allow by country code or ASN)", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Add an L3/L4 firewall rule (allow/drop by IP, port, and protocol)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Create firewall rule for scrub ip", response = CreateRule201Response.class),
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Remove a scrubbing filter by matching filter_type and port", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/disable")
    @Produces({ "application/json" })
    @ApiOperation(value = "Disable DDoS scrubbing and remove the BGP announcement on the IP", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/enable")
    @Produces({ "application/json" })
    @ApiOperation(value = "Enable DDoS scrubbing (BGP announcement) on the service's protected IP", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/order")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get plans, pricing, and eligible IPs for a new Scrub IP order", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get full Scrub IP service detail (rules + geo + filters)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/filter_types")
    @Produces({ "application/json" })
    @ApiOperation(value = "List enabled traffic filter profiles available for createFilter", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/invoices")
    @Produces({ "application/json" })
    @ApiOperation(value = "List recurring and one-time invoices billed for this Scrub IP service", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/logs")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get last 50000 packet/event log entries for the protected IP", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List all Scrub IP DDoS protection services on the authenticated account", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Place a new Scrub IP DDoS protection order and generate an invoice", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Validate a Scrub IP order and return effective pricing without billing", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Scrub IP order validation result.", response = PutScrubIps200Response.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    public PutScrubIps200Response putScrubIps(ScrubIpPlaceOrder scrubIpPlaceOrder);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete a geo firewall rule by rule_id from getScrubIpDetails", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete an L3/L4 firewall rule by rule_id from getScrubIpDetails", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Delete firewall rule for scrub ip", response = ScrubIpsDeleteRule200Response.class),
        @ApiResponse(code = 400, message = "Bad Request", response = ScrubIpsDeleteRule400Response.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class),
