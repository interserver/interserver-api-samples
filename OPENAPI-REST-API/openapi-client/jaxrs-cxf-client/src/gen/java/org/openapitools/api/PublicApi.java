...
import org.openapitools.model.GetAccountLocales200ResponseValue;
...
public interface PublicApi  {
    ...
    @ApiOperation(value = "List enabled currency codes accepted for billing and preferences", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "An array of enabled currency codes.", response = String.class, responseContainer = "List"),
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List supported UI locales with English and native display names", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Map of locale identifiers to display names.", response = GetAccountLocales200ResponseValue.class, responseContainer = "Map"),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    public Map<String, GetAccountLocales200ResponseValue> getAccountLocales();
    ...
    @Path("/captcha")
    @Produces({ "application/json" })
    @ApiOperation(value = "Fetch a base64 JPEG captcha challenge for human verification", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List enabled countries keyed by ISO-2/ISO-3/numeric code", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/info")
    @Produces({ "application/json" })
    @ApiOperation(value = "Discover available modules, service packages, categories, and types", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/login")
    @Produces({ "application/json" })
    @ApiOperation(value = "Fetch logo, captcha, language, and stats for rendering a login page", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/oauth")
    @Produces({ "application/json" })
    @ApiOperation(value = "Begin OAuth login flow — redirect user to provider for authentication", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List all PHP timezone identifiers usable on accounts and services", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Submit 2FA code to finish OAuth login when account has 2FA enabled", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/ping")
    @Produces({ "application/json" })
    @ApiOperation(value = "Liveness check — returns the JSON string \"pong\" to confirm API is up", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Complete OAuth login by linking provider to existing or new account", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Authenticate with email + password and return a session token", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Create a new customer account (email + password + captcha + ToS)", tags={  })
    @ApiResponses(value = { 
