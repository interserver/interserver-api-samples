...
import org.openapitools.model.DomainOrderRequest;
...
public interface DomainsApi  {
    ...
    @ApiOperation(value = "Place a new domain registration or transfer order, generate billing invoice", tags={  })
    @ApiResponses(value = { 
    ...
    public ServiceOrderPostResponse addDomain(DomainOrderRequest domainOrderRequest);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Register DNSSEC DS records on the domain at OpenSRS", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Register a new nameserver host with glue IP at the registry (registered nameserver)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Cancel a domain order in the billing system to stop auto-renewals", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/dnssec")
    @Produces({ "application/json" })
    @ApiOperation(value = "Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/nameservers")
    @Produces({ "application/json" })
    @ApiOperation(value = "Remove one registered nameserver glue record from the domain", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response with a text message field.", response = TextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/contact")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read the current registrant/admin/tech/billing contact field set for a domain", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/dnssec")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read the DNSSEC DS record set currently registered with the registrar", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read full billing, registrar, and service detail for one domain", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/invoices")
    @Produces({ "application/json" })
    @ApiOperation(value = "List all billing invoices scoped to one domain order", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/lookup/{name}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Check availability, premium status, and pricing for a specific domain", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/nameservers")
    @Produces({ "application/json" })
    @ApiOperation(value = "List registered nameserver hosts and glue IP addresses for a domain", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/renew")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read renewal pricing, expiry, and whether a renewal invoice already exists", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/search/{name}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get registrar-suggested domain alternatives and bulk availability for a search term", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/transfer")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read OpenSRS transfer status for an in-progress domain transfer order", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/whois")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read Whois privacy availability, current state, and add-on pricing for a domain", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List every domain registration on the account with billing and registration metadata", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Resend the domain welcome email with registration details and management instructions", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/order")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read the buyable domain TLD service catalog and Whois privacy pricing", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Validate posted domain-order field values before committing — dry run", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Validate Domain order response"),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    public void patchDomains(DomainOrderRequest domainOrderRequest);
    ...
    @Path("/{id}/renew")
    @Produces({ "application/json" })
    @ApiOperation(value = "Submit a domain renewal request and generate the renewal invoice", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/search/{name}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get the full order form data for a hostname in one round-trip (search → order preview)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Domain availability and pricing check results."),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}/transfer")
    @Produces({ "application/json" })
    @ApiOperation(value = "Re-poll OpenSRS transfer status for a domain order via POST", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Preview per-TLD field requirements for a domain order — no commit", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Validate Domain Order response"),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    public void putDomains(DomainOrderRequest domainOrderRequest);
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update registrant/admin contact details and push them to OpenSRS", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "POST mutation hook for the domain detail page (use dedicated ops where possible)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Replace the full authoritative-nameserver delegation list at the registrar", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response with a text message field.", response = TextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Order, enable, or cancel the Whois privacy add-on for a domain", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
