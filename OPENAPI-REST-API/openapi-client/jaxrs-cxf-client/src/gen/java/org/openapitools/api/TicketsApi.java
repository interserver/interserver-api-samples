...
public interface TicketsApi  {
    ...
    @ApiOperation(value = "Open a new helpdesk ticket, optionally linked to a service and attachments", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/close")
    @Produces({ "application/json" })
    @ApiOperation(value = "Close an open support ticket via simple GET request (no body required)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Close a customer ticket via DELETE verb (closes only, never destroys data)", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/new")
    @Produces({ "application/json" })
    @ApiOperation(value = "Fetch services and product options to populate the new-ticket form", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get full ticket details including subject, status, and the reply thread", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Ticket Information", response = ViewTicketResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class),
        @ApiResponse(code = 200, message = "Default response") })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List the authenticated account's support tickets with status and date filters", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Append a reply (and optional attachment, server-access fields) to a ticket", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Ticket Information", response = ViewTicketResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class),
        @ApiResponse(code = 200, message = "Default response") })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Search the authenticated account's tickets by subject, email, or mask ID", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Update a ticket's properties such as subject or status (stub, not implemented)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Ticket Information", response = ViewTicketResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class),
        @ApiResponse(code = 200, message = "Default response") })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Post a simple text reply to an existing ticket thread (no attachments)", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update a ticket's custom field values (server-access details, etc.)", tags={  })
    @ApiResponses(value = { 
