...
public interface BillingApi  {
    ...
    @ApiOperation(value = "Store a credit card on the account — may return a verification flow", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Create a prepay deposit and return an invoice id to fund it", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Remove a stored credit card from the account", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Cancel a pending unpaid invoice — and its pending service or repeat invoice", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete an unfunded prepay or strip its unpaid funding invoices", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List affiliate banner image assets with filename and dimensions", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Affiliate report file download. The response Content-Type matches the requested format (text/csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, or application/pdf)."),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    public void getAffiliateDownload(@QueryParam("st") String st, @QueryParam("ex") String ex, @QueryParam("year") Integer year);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Read a combined affiliate performance summary (HTML payload)", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Read aggregated affiliate sales time-series (monthly buckets) for chart rendering", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Read affiliate signup stats and per-customer conversion data", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Affiliate signup statistics.", response = GetAffiliateSignups200Response.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    public GetAffiliateSignups200Response getAffiliateSignups(@QueryParam("st") String st);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Read aggregated affiliate referral click/visit time-series for chart rendering", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List the 20 most recent affiliate referral visits with IP, referrer, timestamp", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/billing/cart")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read the current shopping cart contents, totals, and available payment methods", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Probe whether a stored card still needs micro-charge verification", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/billing/invoices/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Read full invoice detail — line items, totals, paid status, customer info", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List every invoice on the account with summary totals and paid/unpaid status", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/billing/prepays")
    @Produces({ "application/json" })
    @ApiOperation(value = "List prepay deposits on the account — remaining balance and auto-use flags", tags={  })
    @ApiResponses(value = { 
     ...
     */
    @GET
    @Path("/billing/pay/{method}/{invoices}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Pay invoices through the chosen gateway — returns the next-step action", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Place two micro-charges on the card to start CVV verification (step 1 of 2)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    public SuccessTextResponse patchBillingCreditCardVerify(@PathParam("id") Integer id, PatchBillingCreditCardVerifyRequest patchBillingCreditCardVerifyRequest);
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Submit two micro-charge amounts to finalize card verification (step 2 of 2)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Configure the affiliate landing dock title, description, and referrer coupon", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response with a text message field.", response = TextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Configure how affiliate commissions get paid out (PayPal or internal prepay)", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Response with a text message field.", response = TextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/billing/creditcards/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Refresh stored card expiration and re-trigger MaxMind fraud scoring", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Set the account's default payment method for recurring/auto charges", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
