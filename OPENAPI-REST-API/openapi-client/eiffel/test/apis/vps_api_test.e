...
feature -- Test routines
    ...
    test_post_vps_traffic_usage
        ...
        do
            ...
            -- api.post_vps_traffic_usage(l_id)
            assert ("not_implemented", False)
        end
    ...
    test_vps_backup
        ...
        do
            ...
            -- l_response := api.vps_backup(l_id)
            assert ("not_implemented", False)
        end
    ...
    test_vps_change_hostname
        ...
        do
            ...
            -- api.vps_change_hostname(l_id)
            assert ("not_implemented", False)
        end

    test_vps_change_root_password
        ...
        do
            ...
            -- api.vps_change_root_password(l_id)
            assert ("not_implemented", False)
        end
