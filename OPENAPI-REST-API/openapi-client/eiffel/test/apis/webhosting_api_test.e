...
feature -- Test routines
    ...
    test_add_website
        ...
        local
            ...
            l_website_order_post_request: WEBSITE_ORDER_POST_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_website_order_post_request

            -- l_response := api.add_website(l_website_order_post_request)
    ...
    test_put_websites
        ...
        local
            l_website_order_put_request: WEBSITE_ORDER_PUT_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_website_order_put_request

            -- api.put_websites(l_website_order_put_request)
            assert ("not_implemented", False)
        end
