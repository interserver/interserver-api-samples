...
feature -- Test routines
    ...
    test_add_license
        ...
        local
            ...
            l_license_order_request: LICENSE_ORDER_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_license_order_request

            -- l_response := api.add_license(l_license_order_request)
    ...
    test_put_licenses
        ...
        do
            ...
            -- api.put_licenses(l_license_order_request)
            assert ("not_implemented", False)
        end
