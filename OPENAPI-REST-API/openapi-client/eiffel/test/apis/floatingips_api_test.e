...
feature -- Test routines
    ...
    test_add_floating_ip
        ...
        local
            ...
            l_floating_ip_order_request: FLOATING_IP_ORDER_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_floating_ip_order_request

            -- l_response := api.add_floating_ip(l_floating_ip_order_request)
    ...
    test_put_floating_ips
        ...
        do
            ...
            -- api.put_floating_ips(l_floating_ip_order_request)
            assert ("not_implemented", False)
        end
