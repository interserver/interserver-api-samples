...
feature -- Test routines
    ...
    test_add_server
        ...
        local
            ...
            l_server_order_post_request: SERVER_ORDER_POST_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_server_order_post_request

            -- l_response := api.add_server(l_server_order_post_request)
    ...
    test_server_bulk_ipmi_power_get
        ...
        local
            l_response: SERVER_BULK_IPMI_POWER_RESPONSE
            l_ids: STRING_32
        do
            -- TODO: Initialize required params.
            -- l_ids

            -- l_response := api.server_bulk_ipmi_power_get(l_ids)
            assert ("not_implemented", False)
        end
