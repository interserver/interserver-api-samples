...
feature -- Test routines
    ...
    test_affiliate_download
        ...
        do
            ...
            -- api.affiliate_download(l_st, l_ex, l_year)
            assert ("not_implemented", False)
        end
    ...
    test_affiliate_signups
        ...
        local
            l_response: GET_AFFILIATE_SIGNUPS_200_RESPONSE
            l_st: STRING_32
        do
            -- TODO: Initialize required params.

            -- l_response := api.affiliate_signups(l_st)
            assert ("not_implemented", False)
        end
    ...
    test_patch_billing_credit_card_verify
        ...
        local
            l_response: SUCCESS_TEXT_RESPONSE
            l_id: INTEGER_32
            l_patch_billing_credit_card_verify_request: PATCH_BILLING_CREDIT_CARD_VERIFY_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_id
            -- l_patch_billing_credit_card_verify_request

            -- l_response := api.patch_billing_credit_card_verify(l_id, l_patch_billing_credit_card_verify_request)
            assert ("not_implemented", False)
        end
