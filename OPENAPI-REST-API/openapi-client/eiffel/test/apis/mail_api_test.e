...
feature -- Test routines
    ...
    test_add_mail
        ...
        local
            ...
            l_mail_order_request: MAIL_ORDER_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_mail_order_request

            -- l_response := api.add_mail(l_mail_order_request)
    ...
    test_delete_mail_alert
        ...
        local
            l_response: SUCCESS_TEXT_RESPONSE
            l_id: INTEGER_32
            l_delete_mail_alert_request: DELETE_MAIL_ALERT_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_id
            -- l_delete_mail_alert_request

            -- l_response := api.delete_mail_alert(l_id, l_delete_mail_alert_request)
            assert ("not_implemented", False)
        end
    ...
    test_put_mail
        ...
        do
            ...
            -- api.put_mail(l_mail_order_request)
            assert ("not_implemented", False)
        end
    ...
    test_update_rule
        ...
        do
            ...
            -- l_response := api.update_rule(l_id, l_rule, l_deny_rule_new)
            assert ("not_implemented", False)
        end
