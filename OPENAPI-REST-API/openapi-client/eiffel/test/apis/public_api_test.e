...
feature -- Test routines
    ...
    test_account_currencies
        ...
        do
            ...
            -- l_response := api.account_currencies
            assert ("not_implemented", False)
        end

    test_account_locales
        ...
        local
            l_response: STRING_TABLE [GET_ACCOUNT_LOCALES_200_RESPONSE_VALUE]
        do
            -- TODO: Initialize required params.

            -- l_response := api.account_locales
            assert ("not_implemented", False)
        end
