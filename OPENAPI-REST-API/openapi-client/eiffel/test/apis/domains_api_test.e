...
feature -- Test routines
    ...
    test_add_domain
        ...
        local
            ...
            l_domain_order_request: DOMAIN_ORDER_REQUEST
        do
            -- TODO: Initialize required params.
            -- l_domain_order_request

            -- l_response := api.add_domain(l_domain_order_request)
    ...
    test_delete_domain_dnssec
        ...
        do
            ...
            -- l_response := api.delete_domain_dnssec(l_id)
            assert ("not_implemented", False)
        end
    ...
    test_patch_domains
        ...
        do
            ...
            -- api.patch_domains(l_domain_order_request)
            assert ("not_implemented", False)
        end
    ...
    test_put_domains
        ...
        do
            ...
            -- api.put_domains(l_domain_order_request)
            assert ("not_implemented", False)
        end
