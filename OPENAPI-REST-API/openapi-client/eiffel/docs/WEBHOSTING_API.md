...
------------- | ------------- | -------------
[**add_website**](WEBHOSTING_API.md#add_website) | **Post** /websites/order | Place a new webhosting order, create the invoice, and queue provisioning
[**gett_website_reverse_dns**](WEBHOSTING_API.md#gett_website_reverse_dns) | **Get** /websites/{id}/reverse_dns | Read current reverse-DNS (PTR) records for the website&#39;s IPs
[**new_website**](WEBHOSTING_API.md#new_website) | **Get** /websites/order | Read the webhosting order catalog — plans, packages, promo offers, pricing
[**post_website_buy_ip**](WEBHOSTING_API.md#post_website_buy_ip) | **Post** /websites/{id}/buy_ip | Buy an additional IP for the website OR update reverse DNS records
[**post_website_migration**](WEBHOSTING_API.md#post_website_migration) | **Post** /websites/{id}/migration | Submit a request for InterServer staff to migrate a website from another host
[**post_websites_reverse_dns**](WEBHOSTING_API.md#post_websites_reverse_dns) | **Post** /websites/{id}/reverse_dns | Bulk-update reverse-DNS (PTR) records for one or more website IPs
[**put_websites**](WEBHOSTING_API.md#put_websites) | **Put** /websites/order | Validate a webhosting order and preview cost — dry run, no charge
[**update_website_info**](WEBHOSTING_API.md#update_website_info) | **Post** /websites/{id} | POST mutation hook for the website detail page (use dedicated ops where possible)
[**webhosting_cancel**](WEBHOSTING_API.md#webhosting_cancel) | **Delete** /websites/{id} | Schedule termination of a webhosting service — wipes panel account at cycle end
[**website_buy_ip**](WEBHOSTING_API.md#website_buy_ip) | **Get** /websites/{id}/buy_ip | Read website IPs, current reverse DNS, and additional-IP pricing
[**website_info**](WEBHOSTING_API.md#website_info) | **Get** /websites/{id} | Read full configuration and status detail for one webhosting service
[**website_invoices**](WEBHOSTING_API.md#website_invoices) | **Get** /websites/{id}/invoices | List all billing invoices and recurring charges scoped to one website
[**website_list**](WEBHOSTING_API.md#website_list) | **Get** /websites | List the caller&#39;s webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services
[**websites_backups**](WEBHOSTING_API.md#websites_backups) | **Get** /websites/{id}/backups | List off-site cpmove backups stored in Swift — list or inline-download archive
[**websites_login**](WEBHOSTING_API.md#websites_login) | **Get** /websites/{id}/login | Get a one-time auto-login URL for the website&#39;s control panel
[**websites_welcome_email**](WEBHOSTING_API.md#websites_welcome_email) | **Get** /websites/{id}/welcome_email | Resend the webhosting welcome email with control-panel credentials and URL


# **add_website**
> add_website (website_order_post_request: WEBSITE_ORDER_POST_REQUEST ): detachable SERVICE_ORDER_POST_RESPONSE
...
------------- | ------------- | ------------- | -------------
 **website_order_post_request** | [**WEBSITE_ORDER_POST_REQUEST**](WEBSITE_ORDER_POST_REQUEST.md)|  | 
...
# **put_websites**
> put_websites (website_order_put_request: WEBSITE_ORDER_PUT_REQUEST )
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **website_order_put_request** | [**WEBSITE_ORDER_PUT_REQUEST**](WEBSITE_ORDER_PUT_REQUEST.md)|  | 
