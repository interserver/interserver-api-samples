...
------------- | ------------- | -------------
[**account_currencies**](PUBLIC_API.md#account_currencies) | **Get** /account/currencies | List enabled currency codes accepted for billing and preferences
[**account_locales**](PUBLIC_API.md#account_locales) | **Get** /account/locales | List supported UI locales with English and native display names
[**captcha**](PUBLIC_API.md#captcha) | **Get** /captcha | Fetch a base64 JPEG captcha challenge for human verification
[**countries**](PUBLIC_API.md#countries) | **Get** /account/countries | List enabled countries keyed by ISO-2/ISO-3/numeric code
[**info**](PUBLIC_API.md#info) | **Get** /info | Discover available modules, service packages, categories, and types
[**login_info**](PUBLIC_API.md#login_info) | **Get** /login | Fetch logo, captcha, language, and stats for rendering a login page
[**mp_servers**](PUBLIC_API.md#mp_servers) | **Get** /buy_now_servers_list | List Rapid Deploy (Buy-It-Now) marketplace dedicated servers with live pricing
[**oauth_redirect**](PUBLIC_API.md#oauth_redirect) | **Get** /oauth | Begin OAuth login flow — redirect user to provider for authentication
[**patch_oauth_two_factor**](PUBLIC_API.md#patch_oauth_two_factor) | **Patch** /oauth | Submit 2FA code to finish OAuth login when account has 2FA enabled
[**ping_server**](PUBLIC_API.md#ping_server) | **Get** /ping | Liveness check — returns the JSON string \&quot;pong\&quot; to confirm API is up
[**post_oauth_callback**](PUBLIC_API.md#post_oauth_callback) | **Post** /oauth | Complete OAuth login by linking provider to existing or new account
[**submit_login**](PUBLIC_API.md#submit_login) | **Post** /login | Authenticate with email + password and return a session token
[**submit_signup**](PUBLIC_API.md#submit_signup) | **Post** /signup | Create a new customer account (email + password + captcha + ToS)
[**timezones**](PUBLIC_API.md#timezones) | **Get** /account/timezones | List all PHP timezone identifiers usable on accounts and services


# **account_currencies**
> account_currencies : detachable LIST [STRING_32]
...
# **account_locales**
> account_locales : detachable STRING_TABLE [GET_ACCOUNT_LOCALES_200_RESPONSE_VALUE]
...
[**STRING_TABLE [GET_ACCOUNT_LOCALES_200_RESPONSE_VALUE]**](getAccountLocales_200_response_value.md)
