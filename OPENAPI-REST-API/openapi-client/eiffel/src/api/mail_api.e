...
feature -- API Access
	...
	add_mail (mail_order_request: MAIL_ORDER_REQUEST): detachable SERVICE_ORDER_POST_RESPONSE
			...
			-- 
			-- argument: mail_order_request  (required)
			-- 
			-- 
		...
		do
			reset_error
			create l_request
			l_request.set_body(mail_order_request)
			l_path := "/mail/order"
	...
	delete_mail_alert (id: INTEGER_32; delete_mail_alert_request: DELETE_MAIL_ALERT_REQUEST): detachable SUCCESS_TEXT_RESPONSE
			...
			-- argument: id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;. (required)
			-- 
			-- argument: delete_mail_alert_request  (required)
			-- 
			-- 
			-- Result SUCCESS_TEXT_RESPONSE
		require
		...
		do
			reset_error
			create l_request
			l_request.set_body(delete_mail_alert_request)
			l_path := "/mail/{id}/alerts"
			l_path.replace_substring_all ("{"+"id"+"}", api_client.url_encode (id.out))
	...
	update_rule (id: INTEGER_32; rule: STRING_32; deny_rule_new: DENY_RULE_NEW): detachable GENERIC_RESPONSE
			...
			-- argument: id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;. (required)
			-- 
			-- argument: rule The ID of the deny rule to update. (required)
			-- 
			-- argument: deny_rule_new  (required)
			-- 
			-- 
			-- Result GENERIC_RESPONSE
		require
