...
feature -- API Access
	...
	affiliate_download (st: STRING_32; ex: STRING_32; year: INTEGER_32)
			...
			-- 
			-- argument: st Filter by status. (optional, default to null)
			-- 
			-- argument: ex Export format: csv, xls, xlsx, or pdf. Defaults to csv. (optional, default to null)
			-- 
			-- argument: year Year to filter the report. Defaults to the current year. (optional, default to null)
			-- 
			-- 
		require
		local
		...
		do
			...
			l_path := "/affiliate/download"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "st", st));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "ex", ex));
	...
	affiliate_signups (st: STRING_32): detachable GET_AFFILIATE_SIGNUPS_200_RESPONSE
			...
			-- 
			-- argument: st Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. (optional, default to null)
			-- 
			-- 
			-- Result GET_AFFILIATE_SIGNUPS_200_RESPONSE
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { GET_AFFILIATE_SIGNUPS_200_RESPONSE } l_response.data ({ GET_AFFILIATE_SIGNUPS_200_RESPONSE }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	initiate_payment (method: STRING_32; invoices: STRING_32): detachable INITIATE_PAYMENT_200_RESPONSE
		...
		do
			...
			l_path := "/billing/pay/{method}/{invoices}"
	...
	patch_billing_credit_card_verify (id: INTEGER_32; patch_billing_credit_card_verify_request: PATCH_BILLING_CREDIT_CARD_VERIFY_REQUEST): detachable SUCCESS_TEXT_RESPONSE
			...
			-- argument: id The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. (required)
			-- 
			-- argument: patch_billing_credit_card_verify_request  (required)
			-- 
			-- 
			-- Result SUCCESS_TEXT_RESPONSE
		require
		...
		do
			reset_error
			create l_request
			l_request.set_body(patch_billing_credit_card_verify_request)
			l_path := "/billing/creditcards/{id}/verify"
			l_path.replace_substring_all ("{"+"id"+"}", api_client.url_encode (id.out))
