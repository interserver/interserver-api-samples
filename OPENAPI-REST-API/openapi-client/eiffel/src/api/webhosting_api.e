...
feature -- API Access
	...
	add_website (website_order_post_request: WEBSITE_ORDER_POST_REQUEST): detachable SERVICE_ORDER_POST_RESPONSE
			...
			-- 
			-- argument: website_order_post_request  (required)
			-- 
			-- 
		...
		do
			reset_error
			create l_request
			l_request.set_body(website_order_post_request)
	...
	put_websites (website_order_put_request: WEBSITE_ORDER_PUT_REQUEST)
			...
			-- 
			-- argument: website_order_put_request  (required)
			-- 
			-- 
		require
		local
		...
		do
			reset_error
			create l_request
			l_request.set_body(website_order_put_request)
			l_path := "/websites/order"
