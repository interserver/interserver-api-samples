...
# **add_dns_domain**
> `add_dns_domain`(_api::`DNSApi`, `domain`::`String`, `ip`::`String`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_dns_domain`(_api::`DNSApi`, response_stream::`Channel`, `domain`::`String`, `ip`::`String`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **add_dns_record**
> `add_dns_record`(_api::`DNSApi`, `id`::`String`, `name`::`String`, `type`::`DnsRecordType`, `content`::`String`; `ttl`=nothing, `prio`=nothing, _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_dns_record`(_api::`DNSApi`, response_stream::`Channel`, `id`::`String`, `name`::`String`, `type`::`DnsRecordType`, `content`::`String`; `ttl`=nothing, `prio`=nothing, _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`ttl`** | **`Int64`** | Time-to-live | [default to 86400]
 **`prio`** | **`Int64`** | Priority | [default to 0]
...
# **delete_dns_domain**
> `delete_dns_domain`(_api::`DNSApi`, `id`::`String`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_dns_domain`(_api::`DNSApi`, response_stream::`Channel`, `id`::`String`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **delete_dns_record**
> `delete_dns_record`(_api::`DNSApi`, `domain_id`::`Int64`, `record_id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_dns_record`(_api::`DNSApi`, response_stream::`Channel`, `domain_id`::`Int64`, `record_id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`DNSApi`** | API context | 
**`domain_id`** | **`Int64`** | The DNS domain ID. Use the &#x60;id&#x60; from &#x60;GET /dns&#x60; to identify the domain. |
**`record_id`** | **`Int64`** | The DNS record ID within the domain. Use the record &#x60;id&#x60; from &#x60;GET /dns/{id}&#x60; to identify the record. |
...
# **get_dns_domain**
> `get_dns_domain`(_api::`DNSApi`, `id`::`Int64`; _mediaType=nothing) -> `Vector{DnsRecord}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_dns_domain`(_api::`DNSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Vector{DnsRecord}` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`DNSApi`** | API context | 
**`id`** | **`Int64`** | The DNS domain ID. Use the &#x60;id&#x60; from &#x60;GET /dns&#x60; to identify the domain. |

### Return type

[**`Vector{DnsRecord}`**](DnsRecord.md)
...
# **get_dns_list**
> `get_dns_list`(_api::`DNSApi`; _mediaType=nothing) -> `Vector{DnsListItem}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_dns_list`(_api::`DNSApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Vector{DnsListItem}` }, `OpenAPI.Clients.ApiResponse`
...
[**`Vector{DnsListItem}`**](DnsListItem.md)
...
# **update_dns_record**
> `update_dns_record`(_api::`DNSApi`, `domain_id`::`Int64`, `record_id`::`Int64`; `name`=nothing, `type`=nothing, `content`=nothing, `ttl`=nothing, `prio`=nothing, `disabled`=nothing, `ordername`=nothing, `auth`=nothing, _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_dns_record`(_api::`DNSApi`, response_stream::`Channel`, `domain_id`::`Int64`, `record_id`::`Int64`; `name`=nothing, `type`=nothing, `content`=nothing, `ttl`=nothing, `prio`=nothing, `disabled`=nothing, `ordername`=nothing, `auth`=nothing, _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
 ...
 **`type`** | [**`DnsRecordType`**](DnsRecordType.md) |  | [default to nothing]
 **`content`** | **`String`** |  | [default to nothing]
 **`ttl`** | **`String`** |  | [default to nothing]
 **`prio`** | **`String`** |  | [default to nothing]
 **`disabled`** | **`String`** |  | [default to nothing]
 **`ordername`** | **`String`** |  | [default to nothing]
