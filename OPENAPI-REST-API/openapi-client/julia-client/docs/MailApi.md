...
# **add_mail**
> `add_mail`(_api::`MailApi`, `mail_order_request`::`MailOrderRequest`; _mediaType=nothing) -> `ServiceOrderPostResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_mail`(_api::`MailApi`, response_stream::`Channel`, `mail_order_request`::`MailOrderRequest`; _mediaType=nothing) -> `Channel`{ `ServiceOrderPostResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **add_rule**
> `add_rule`(_api::`MailApi`, `id`::`Int64`, `deny_rule_new`::`DenyRuleNew`; _mediaType=nothing) -> `GenericResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_rule`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`, `deny_rule_new`::`DenyRuleNew`; _mediaType=nothing) -> `Channel`{ `GenericResponse` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`MailApi`** | API context | 
**`id`** | **`Int64`** | The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;. |
...
# **create_mail_alert**
> `create_mail_alert`(_api::`MailApi`, `id`::`Int64`, `mail_alert_request`::`MailAlertRequest`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `create_mail_alert`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`, `mail_alert_request`::`MailAlertRequest`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **delete_mail_alert**
> `delete_mail_alert`(_api::`MailApi`, `id`::`Int64`, `delete_mail_alert_request`::`DeleteMailAlertRequest`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_mail_alert`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`, `delete_mail_alert_request`::`DeleteMailAlertRequest`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **delete_rule**
> `delete_rule`(_api::`MailApi`, `id`::`Int64`, `rule`::`String`; _mediaType=nothing) -> `GenericResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_rule`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`, `rule`::`String`; _mediaType=nothing) -> `Channel`{ `GenericResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **delist_block**
> `delist_block`(_api::`MailApi`, `id`::`Int64`; `email`=nothing, _mediaType=nothing) -> `GenericResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `delist_block`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; `email`=nothing, _mediaType=nothing) -> `Channel`{ `GenericResponse` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`email`** | **`String`** | an email address | [default to nothing]
...
# **get_mail_alerts**
> `get_mail_alerts`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `MailAlertsResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_mail_alerts`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `MailAlertsResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_mail_blocks**
> `get_mail_blocks`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `MailBlocks`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_mail_blocks`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `MailBlocks` }, `OpenAPI.Clients.ApiResponse`
...
# **get_mail_delist**
> `get_mail_delist`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `MailDelistResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_mail_delist`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `MailDelistResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `get_mail_deliverability`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `MailDeliverabilityResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_mail_deliverability`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `MailDeliverabilityResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_mail_info**
> `get_mail_info`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `MailSchema`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_mail_info`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `MailSchema` }, `OpenAPI.Clients.ApiResponse`
...
# **get_mail_invoices**
> `get_mail_invoices`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `ChargeInvoiceRows`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_mail_invoices`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `ChargeInvoiceRows` }, `OpenAPI.Clients.ApiResponse`
...
# **get_mail_list**
> `get_mail_list`(_api::`MailApi`; _mediaType=nothing) -> `Vector{MailRow}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_mail_list`(_api::`MailApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Vector{MailRow}` }, `OpenAPI.Clients.ApiResponse`
...
> `get_mail_welcome_email`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_mail_welcome_email`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_new_mail**
> `get_new_mail`(_api::`MailApi`; _mediaType=nothing) -> `MailOrder`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_new_mail`(_api::`MailApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `MailOrder` }, `OpenAPI.Clients.ApiResponse`
...
# **get_rules**
> `get_rules`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `Vector{DenyRuleRecord}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_rules`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Vector{DenyRuleRecord}` }, `OpenAPI.Clients.ApiResponse`
...
[**`Vector{DenyRuleRecord}`**](DenyRuleRecord.md)
...
# **get_stats**
> `get_stats`(_api::`MailApi`, `id`::`Int64`; `time`=nothing, _mediaType=nothing) -> `MailStatsType`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_stats`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; `time`=nothing, _mediaType=nothing) -> `Channel`{ `MailStatsType` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`time`** | **`String`** | The timeframe for the statistics. | [default to nothing]
...
# **mail_cancel**
> `mail_cancel`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `MailCancel200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `mail_cancel`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `MailCancel200Response` }, `OpenAPI.Clients.ApiResponse`
...
# **post_mail_delist**
> `post_mail_delist`(_api::`MailApi`, `id`::`Int64`, `mail_delist_request`::`MailDelistRequest`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_mail_delist`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`, `mail_delist_request`::`MailDelistRequest`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **put_mail**
> `put_mail`(_api::`MailApi`, `mail_order_request`::`MailOrderRequest`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `put_mail`(_api::`MailApi`, response_stream::`Channel`, `mail_order_request`::`MailOrderRequest`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **reset_mail_password**
> `reset_mail_password`(_api::`MailApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `reset_mail_password`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **send_adv_mail**
> `send_adv_mail`(_api::`MailApi`, `id`::`Int64`, `send_mail_adv`::`SendMailAdv`; _mediaType=nothing) -> `GenericResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `send_adv_mail`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`, `send_mail_adv`::`SendMailAdv`; _mediaType=nothing) -> `Channel`{ `GenericResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **send_mail**
> `send_mail`(_api::`MailApi`, `id`::`Int64`, `send_mail_param`::`SendMail`; _mediaType=nothing) -> `GenericResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `send_mail`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`, `send_mail_param`::`SendMail`; _mediaType=nothing) -> `Channel`{ `GenericResponse` }, `OpenAPI.Clients.ApiResponse`
 ...
 **_api** | **`MailApi`** | API context | 
**`id`** | **`Int64`** | The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;. |
**`send_mail_param`** | [**`SendMail`**](SendMail.md) |  |
...
# **update_mail_alert**
> `update_mail_alert`(_api::`MailApi`, `id`::`Int64`, `mail_alert_update_request`::`MailAlertUpdateRequest`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_mail_alert`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`, `mail_alert_update_request`::`MailAlertUpdateRequest`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **update_mail_info**
> `update_mail_info`(_api::`MailApi`, `id`::`String`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_mail_info`(_api::`MailApi`, response_stream::`Channel`, `id`::`String`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **update_rule**
> `update_rule`(_api::`MailApi`, `id`::`Int64`, `rule`::`String`, `deny_rule_new`::`DenyRuleNew`; _mediaType=nothing) -> `GenericResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_rule`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`, `rule`::`String`, `deny_rule_new`::`DenyRuleNew`; _mediaType=nothing) -> `Channel`{ `GenericResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **view_mail_log**
> `view_mail_log`(_api::`MailApi`, `id`::`Int64`; `id2`=nothing, `origin`=nothing, `mx`=nothing, `from`=nothing, `to`=nothing, `subject`=nothing, `mailid`=nothing, `message_id`=nothing, `replyto`=nothing, `headerfrom`=nothing, `delivered`=nothing, `skip`=nothing, `limit`=nothing, `start_date`=nothing, `end_date`=nothing, `sort`=nothing, `dir`=nothing, `groupby`=nothing, _mediaType=nothing) -> `MailLog`, `OpenAPI.Clients.ApiResponse` <br/>
> `view_mail_log`(_api::`MailApi`, response_stream::`Channel`, `id`::`Int64`; `id2`=nothing, `origin`=nothing, `mx`=nothing, `from`=nothing, `to`=nothing, `subject`=nothing, `mailid`=nothing, `message_id`=nothing, `replyto`=nothing, `headerfrom`=nothing, `delivered`=nothing, `skip`=nothing, `limit`=nothing, `start_date`=nothing, `end_date`=nothing, `sort`=nothing, `dir`=nothing, `groupby`=nothing, _mediaType=nothing) -> `Channel`{ `MailLog` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`id2`** | **`Int64`** | The numeric ID of the mail order to filter by.  When omitted, logs from the first active mail order are returned.  Obtain valid IDs from &#x60;GET /mail&#x60; or &#x60;GET /mail/{id}&#x60;. | [default to nothing]
 **`origin`** | **`String`** | Filter by the originating IP address from which the message was submitted to the relay.  Must be a valid IPv4 or IPv6 address. | [default to nothing]
 **`mx`** | **`String`** | Filter by the MX hostname the relay attempted delivery to.  For example &#x60;mx.google.com&#x60; would return messages destined for Gmail recipients. Maps to &#x60;mxHostname&#x60; in the &#x60;MailLogEntry&#x60; response. | [default to nothing]
 **`from`** | **`String`** | Filter by SMTP envelope &#x60;MAIL FROM&#x60; address (exact match).  This is the address the relay used for bounce handling and may differ from the &#x60;From:&#x60; message header.  For header-level filtering use &#x60;headerfrom&#x60;. | [default to nothing]
 **`to`** | **`String`** | Filter by SMTP envelope &#x60;RCPT TO&#x60; address (exact match).  This is the delivery address used by the relay and may differ from the &#x60;To:&#x60; header when BCC recipients are involved. | [default to nothing]
 **`subject`** | **`String`** | Filter by email &#x60;Subject&#x60; header (exact match).  MIME-encoded subjects are decoded automatically in the response. | [default to nothing]
 **`mailid`** | **`String`** | Filter by the relay-assigned mail ID string (exact match).  This corresponds to the &#x60;id&#x60; field in &#x60;MailLogEntry&#x60; and to the &#x60;text&#x60; value returned by the sending endpoints on success.  Format is an 18-19 character hexadecimal string such as &#x60;185997065c60008840&#x60;. | [default to nothing]
 **`message_id`** | **`String`** | Filter by the &#x60;Message-ID&#x60; email header using a substring (case-insensitive) match. The &#x60;Message-ID&#x60; is assigned by the sending mail client and is visible in the &#x60;messageId&#x60; field of &#x60;MailLogEntry&#x60;. | [default to nothing]
 **`replyto`** | **`String`** | Filter by the &#x60;Reply-To&#x60; message header address (exact match).  Only returns messages where this header was explicitly set. | [default to nothing]
 **`headerfrom`** | **`String`** | Filter by the &#x60;From&#x60; message header address (exact match).  This is the human-visible sender address and may differ from the SMTP envelope &#x60;from&#x60; parameter when sending on behalf of another address. | [default to nothing]
 **`delivered`** | **`Int64`** | Filter by delivery status.  &#x60;1&#x60; returns only messages that were successfully delivered to the destination MX.  &#x60;0&#x60; returns messages that are still queued, deferred, or failed.  Omit to return all messages regardless of delivery status. | [default to nothing]
 **`skip`** | **`Int64`** | Number of records to skip for pagination.  Use in combination with &#x60;limit&#x60; to page through large result sets.  Defaults to &#x60;0&#x60; (no skip). | [default to 0]
 **`limit`** | **`Int64`** | Maximum number of records to return per page.  Defaults to &#x60;100&#x60;. Maximum allowed value is &#x60;10000&#x60;.  The response also includes a &#x60;total&#x60; field with the full matched count so you can calculate the number of pages. | [default to 100]
 **`start_date`** | [**`ViewMailLogStartDateParameter`**](.md) | Earliest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by &#x60;strtotime()&#x60; such as &#x60;2024-01-15&#x60; or &#x60;last monday&#x60;.  Messages with a &#x60;time&#x60; value **greater than or equal to** this value will be included. | [default to nothing]
 **`end_date`** | [**`ViewMailLogStartDateParameter`**](.md) | Latest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by &#x60;strtotime()&#x60; such as &#x60;2024-01-31&#x60; or &#x60;yesterday&#x60;. Messages with a &#x60;time&#x60; value **less than or equal to** this value will be included. | [default to nothing]
