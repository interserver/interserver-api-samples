...
# **add_floating_ip**
> `add_floating_ip`(_api::`FloatingIPsApi`, `floating_ip_order_request`::`FloatingIpOrderRequest`; _mediaType=nothing) -> `ServiceOrderPostResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_floating_ip`(_api::`FloatingIPsApi`, response_stream::`Channel`, `floating_ip_order_request`::`FloatingIpOrderRequest`; _mediaType=nothing) -> `Channel`{ `ServiceOrderPostResponse` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`FloatingIPsApi`** | API context | 
...
# **floating_ips_cancel**
> `floating_ips_cancel`(_api::`FloatingIPsApi`, `id`::`Int64`; _mediaType=nothing) -> `FloatingIpsCancel200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `floating_ips_cancel`(_api::`FloatingIPsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `FloatingIpsCancel200Response` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`FloatingIPsApi`** | API context | 
**`id`** | **`Int64`** | The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;. |
...
> `get_floating_ip_info`(_api::`FloatingIPsApi`, `id`::`Int64`; _mediaType=nothing) -> `Any`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_floating_ip_info`(_api::`FloatingIPsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Any` }, `OpenAPI.Clients.ApiResponse`
...
> `get_floating_ip_invoices`(_api::`FloatingIPsApi`, `id`::`Int64`; _mediaType=nothing) -> `ChargeInvoiceRows`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_floating_ip_invoices`(_api::`FloatingIPsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `ChargeInvoiceRows` }, `OpenAPI.Clients.ApiResponse`
...
> `get_floating_ips_list`(_api::`FloatingIPsApi`; _mediaType=nothing) -> `Vector{Any}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_floating_ips_list`(_api::`FloatingIPsApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Vector{Any}` }, `OpenAPI.Clients.ApiResponse`
...
> `get_floating_ips_welcome_email`(_api::`FloatingIPsApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_floating_ips_welcome_email`(_api::`FloatingIPsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_new_floating_ip**
> `get_new_floating_ip`(_api::`FloatingIPsApi`; _mediaType=nothing) -> `Any`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_new_floating_ip`(_api::`FloatingIPsApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Any` }, `OpenAPI.Clients.ApiResponse`
...
> `post_floating_ips_change_ip`(_api::`FloatingIPsApi`, `id`::`Int64`, `ip`::`String`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_floating_ips_change_ip`(_api::`FloatingIPsApi`, response_stream::`Channel`, `id`::`Int64`, `ip`::`String`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **put_floating_ips**
> `put_floating_ips`(_api::`FloatingIPsApi`, `floating_ip_order_request`::`FloatingIpOrderRequest`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `put_floating_ips`(_api::`FloatingIPsApi`, response_stream::`Channel`, `floating_ip_order_request`::`FloatingIpOrderRequest`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `update_floating_ip_info`(_api::`FloatingIPsApi`, `id`::`String`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_floating_ip_info`(_api::`FloatingIPsApi`, response_stream::`Channel`, `id`::`String`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
