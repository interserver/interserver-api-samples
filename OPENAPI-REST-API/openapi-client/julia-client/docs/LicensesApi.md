...
# **add_license**
> `add_license`(_api::`LicensesApi`, `license_order_request`::`LicenseOrderRequest`; _mediaType=nothing) -> `ServiceOrderPostResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_license`(_api::`LicensesApi`, response_stream::`Channel`, `license_order_request`::`LicenseOrderRequest`; _mediaType=nothing) -> `Channel`{ `ServiceOrderPostResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_license_info**
> `get_license_info`(_api::`LicensesApi`, `id`::`Int64`; _mediaType=nothing) -> `License`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_license_info`(_api::`LicensesApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `License` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`LicensesApi`** | API context | 
**`id`** | **`Int64`** | The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;. |
...
> `get_license_invoices`(_api::`LicensesApi`, `id`::`Int64`; _mediaType=nothing) -> `ChargeInvoiceRows`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_license_invoices`(_api::`LicensesApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `ChargeInvoiceRows` }, `OpenAPI.Clients.ApiResponse`
...
# **get_license_list**
> `get_license_list`(_api::`LicensesApi`; _mediaType=nothing) -> `Vector{LicenseRow}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_license_list`(_api::`LicensesApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Vector{LicenseRow}` }, `OpenAPI.Clients.ApiResponse`
...
[**`Vector{LicenseRow}`**](LicenseRow.md)
...
> `get_licenses_welcome_email`(_api::`LicensesApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_licenses_welcome_email`(_api::`LicensesApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_new_license**
> `get_new_license`(_api::`LicensesApi`; _mediaType=nothing) -> `LicensesOrder`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_new_license`(_api::`LicensesApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `LicensesOrder` }, `OpenAPI.Clients.ApiResponse`
...
# **licenses_cancel**
> `licenses_cancel`(_api::`LicensesApi`, `id`::`Int64`; _mediaType=nothing) -> `LicensesCancel200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `licenses_cancel`(_api::`LicensesApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `LicensesCancel200Response` }, `OpenAPI.Clients.ApiResponse`
...
> `post_license_change_ip`(_api::`LicensesApi`, `id`::`Int64`, `ip_object`::`IpObject`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_license_change_ip`(_api::`LicensesApi`, response_stream::`Channel`, `id`::`Int64`, `ip_object`::`IpObject`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **put_licenses**
> `put_licenses`(_api::`LicensesApi`, `license_order_request`::`LicenseOrderRequest`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `put_licenses`(_api::`LicensesApi`, response_stream::`Channel`, `license_order_request`::`LicenseOrderRequest`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **update_license_info**
> `update_license_info`(_api::`LicensesApi`, `id`::`String`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_license_info`(_api::`LicensesApi`, response_stream::`Channel`, `id`::`String`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
