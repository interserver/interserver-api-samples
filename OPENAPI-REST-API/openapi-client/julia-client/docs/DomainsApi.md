...
# **add_domain**
> `add_domain`(_api::`DomainsApi`, `domain_order_request`::`DomainOrderRequest`; _mediaType=nothing) -> `ServiceOrderPostResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_domain`(_api::`DomainsApi`, response_stream::`Channel`, `domain_order_request`::`DomainOrderRequest`; _mediaType=nothing) -> `Channel`{ `ServiceOrderPostResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **add_domain_dnssec**
> `add_domain_dnssec`(_api::`DomainsApi`, `id`::`Int64`, `domain_dnssec_request`::`DomainDnssecRequest`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_domain_dnssec`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`, `domain_dnssec_request`::`DomainDnssecRequest`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`DomainsApi`** | API context | 
**`id`** | **`Int64`** | The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. |
...
> `add_domain_nameserver`(_api::`DomainsApi`, `id`::`Int64`, `domain_nameserver_post_request`::`DomainNameserverPostRequest`; _mediaType=nothing) -> `TextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_domain_nameserver`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`, `domain_nameserver_post_request`::`DomainNameserverPostRequest`; _mediaType=nothing) -> `Channel`{ `TextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **cancel_domain**
> `cancel_domain`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `CancelDomain200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `cancel_domain`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `CancelDomain200Response` }, `OpenAPI.Clients.ApiResponse`
...
> `delete_domain_dnssec`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_domain_dnssec`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `delete_domain_nameserver`(_api::`DomainsApi`, `id`::`Int64`, `index`::`Int64`; _mediaType=nothing) -> `TextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_domain_nameserver`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`, `index`::`Int64`; _mediaType=nothing) -> `Channel`{ `TextResponse` }, `OpenAPI.Clients.ApiResponse`
 ...
 **_api** | **`DomainsApi`** | API context | 
**`id`** | **`Int64`** | The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. |
**`index`** | **`Int64`** | The index of the registered nameserver from the registered nameservers list to delete.   |
...
# **get_domain_contact**
> `get_domain_contact`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `DomainContactDetails`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_contact`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `DomainContactDetails` }, `OpenAPI.Clients.ApiResponse`
...
# **get_domain_dnssec**
> `get_domain_dnssec`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `DomainDnssecRecords`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_dnssec`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `DomainDnssecRecords` }, `OpenAPI.Clients.ApiResponse`
...
# **get_domain_info**
> `get_domain_info`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `Domain`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_info`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Domain` }, `OpenAPI.Clients.ApiResponse`
...
# **get_domain_invoices**
> `get_domain_invoices`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `ChargeInvoiceRows`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_invoices`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `ChargeInvoiceRows` }, `OpenAPI.Clients.ApiResponse`
...
# **get_domain_lookup**
> `get_domain_lookup`(_api::`DomainsApi`, `name`::`String`; _mediaType=nothing) -> `DomainLookupResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_lookup`(_api::`DomainsApi`, response_stream::`Channel`, `name`::`String`; _mediaType=nothing) -> `Channel`{ `DomainLookupResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `get_domain_nameservers`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `DomainNameserverGetResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_nameservers`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `DomainNameserverGetResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_domain_renewal**
> `get_domain_renewal`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_renewal`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_domain_search**
> `get_domain_search`(_api::`DomainsApi`, `name`::`String`; _mediaType=nothing) -> `DomainSearchResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_search`(_api::`DomainsApi`, response_stream::`Channel`, `name`::`String`; _mediaType=nothing) -> `Channel`{ `DomainSearchResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_domain_transfer**
> `get_domain_transfer`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_transfer`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `get_domain_whois_privacy`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domain_whois_privacy`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_domains_list**
> `get_domains_list`(_api::`DomainsApi`; _mediaType=nothing) -> `Vector{DomainRow}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domains_list`(_api::`DomainsApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Vector{DomainRow}` }, `OpenAPI.Clients.ApiResponse`
...
> `get_domains_welcome_email`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_domains_welcome_email`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_new_domain**
> `get_new_domain`(_api::`DomainsApi`; _mediaType=nothing) -> `DomainOrder`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_new_domain`(_api::`DomainsApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `DomainOrder` }, `OpenAPI.Clients.ApiResponse`
...
# **patch_domains**
> `patch_domains`(_api::`DomainsApi`, `domain_order_request`::`DomainOrderRequest`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `patch_domains`(_api::`DomainsApi`, response_stream::`Channel`, `domain_order_request`::`DomainOrderRequest`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **post_domain_renewal**
> `post_domain_renewal`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_domain_renewal`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **post_domain_search**
> `post_domain_search`(_api::`DomainsApi`, `name`::`String`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_domain_search`(_api::`DomainsApi`, response_stream::`Channel`, `name`::`String`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `post_domain_transfer`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_domain_transfer`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **put_domains**
> `put_domains`(_api::`DomainsApi`, `domain_order_request`::`DomainOrderRequest`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `put_domains`(_api::`DomainsApi`, response_stream::`Channel`, `domain_order_request`::`DomainOrderRequest`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `update_domain_contact`(_api::`DomainsApi`, `id`::`Int64`, `domain_contact_details`::`DomainContactDetails`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_domain_contact`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`, `domain_contact_details`::`DomainContactDetails`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **update_domain_info**
> `update_domain_info`(_api::`DomainsApi`, `id`::`Int64`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_domain_info`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `update_domain_nameservers`(_api::`DomainsApi`, `id`::`Int64`, `domain_nameserver_put_request`::`DomainNameserverPutRequest`; _mediaType=nothing) -> `TextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_domain_nameservers`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`, `domain_nameserver_put_request`::`DomainNameserverPutRequest`; _mediaType=nothing) -> `Channel`{ `TextResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `update_domain_whois_privacy`(_api::`DomainsApi`, `id`::`Int64`, `domain_whois_privacy_request`::`DomainWhoisPrivacyRequest`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_domain_whois_privacy`(_api::`DomainsApi`, response_stream::`Channel`, `id`::`Int64`, `domain_whois_privacy_request`::`DomainWhoisPrivacyRequest`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
