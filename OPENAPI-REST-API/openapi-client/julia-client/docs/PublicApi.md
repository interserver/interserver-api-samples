...
[**get_m_p_servers**](PublicApi.md#get_m_p_servers) | **GET** /buy_now_servers_list | List Rapid Deploy (Buy-It-Now) marketplace dedicated servers with live pricing
...
> `get_account_currencies`(_api::`PublicApi`; _mediaType=nothing) -> `Vector{String}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_account_currencies`(_api::`PublicApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Vector{String}` }, `OpenAPI.Clients.ApiResponse`
...
# **get_account_locales**
> `get_account_locales`(_api::`PublicApi`; _mediaType=nothing) -> `Dict{String, GetAccountLocales200ResponseValue}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_account_locales`(_api::`PublicApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Dict{String, GetAccountLocales200ResponseValue}` }, `OpenAPI.Clients.ApiResponse`
...
[**`Dict{String, GetAccountLocales200ResponseValue}`**](GetAccountLocales200ResponseValue.md)
...
# **get_captcha**
> `get_captcha`(_api::`PublicApi`; _mediaType=nothing) -> `CaptchaResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_captcha`(_api::`PublicApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `CaptchaResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_countries**
> `get_countries`(_api::`PublicApi`; `fetch_by`=nothing, _mediaType=nothing) -> `Any`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_countries`(_api::`PublicApi`, response_stream::`Channel`; `fetch_by`=nothing, _mediaType=nothing) -> `Channel`{ `Any` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`PublicApi`** | API context | 

### Optional Parameters

Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`fetch_by`** | **`String`** | Get countries by iso2 or iso3 or numcode | [default to nothing]
...
# **get_info**
> `get_info`(_api::`PublicApi`; _mediaType=nothing) -> `ServicesInfo`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_info`(_api::`PublicApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `ServicesInfo` }, `OpenAPI.Clients.ApiResponse`
...
# **get_login_info**
> `get_login_info`(_api::`PublicApi`; _mediaType=nothing) -> `LoginInfo`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_login_info`(_api::`PublicApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `LoginInfo` }, `OpenAPI.Clients.ApiResponse`
...
# **get_m_p_servers**
> `get_m_p_servers`(_api::`PublicApi`; _mediaType=nothing) -> `BuyItNowList`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_m_p_servers`(_api::`PublicApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `BuyItNowList` }, `OpenAPI.Clients.ApiResponse`
...
# **get_oauth_redirect**
> `get_oauth_redirect`(_api::`PublicApi`, `provider`::`String`; _mediaType=nothing) -> `GetOauthRedirect200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_oauth_redirect`(_api::`PublicApi`, response_stream::`Channel`, `provider`::`String`; _mediaType=nothing) -> `Channel`{ `GetOauthRedirect200Response` }, `OpenAPI.Clients.ApiResponse`
...
# **get_timezones**
> `get_timezones`(_api::`PublicApi`; _mediaType=nothing) -> `Vector{String}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_timezones`(_api::`PublicApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Vector{String}` }, `OpenAPI.Clients.ApiResponse`
...
> `patch_oauth_two_factor`(_api::`PublicApi`, `patch_oauth_two_factor_request`::`PatchOauthTwoFactorRequest`; _mediaType=nothing) -> `PatchOauthTwoFactor200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `patch_oauth_two_factor`(_api::`PublicApi`, response_stream::`Channel`, `patch_oauth_two_factor_request`::`PatchOauthTwoFactorRequest`; _mediaType=nothing) -> `Channel`{ `PatchOauthTwoFactor200Response` }, `OpenAPI.Clients.ApiResponse`
...
# **ping_server**
> `ping_server`(_api::`PublicApi`; _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `ping_server`(_api::`PublicApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
# **post_oauth_callback**
> `post_oauth_callback`(_api::`PublicApi`, `provider`::`String`; `post_oauth_callback_request`=nothing, _mediaType=nothing) -> `PostOauthCallback200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_oauth_callback`(_api::`PublicApi`, response_stream::`Channel`, `provider`::`String`; `post_oauth_callback_request`=nothing, _mediaType=nothing) -> `Channel`{ `PostOauthCallback200Response` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`post_oauth_callback_request`** | [**`PostOauthCallbackRequest`**](PostOauthCallbackRequest.md) |  | 
...
# **submit_login**
> `submit_login`(_api::`PublicApi`, `login`::`String`, `passwd`::`String`; `remember`=nothing, `g_recaptcha_response`=nothing, `tfa`=nothing, _mediaType=nothing) -> `LoginSuccessResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `submit_login`(_api::`PublicApi`, response_stream::`Channel`, `login`::`String`, `passwd`::`String`; `remember`=nothing, `g_recaptcha_response`=nothing, `tfa`=nothing, _mediaType=nothing) -> `Channel`{ `LoginSuccessResponse` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`remember`** | **`String`** |  | [default to nothing]
 **`g_recaptcha_response`** | [**`LoginSubmissionExampleGRecaptchaResponse`**](LoginSubmissionExampleGRecaptchaResponse.md) |  | [default to nothing]
 **`tfa`** | **`String`** | Two Factor Authentication Response. | [default to nothing]
...
# **submit_signup**
> `submit_signup`(_api::`PublicApi`; `login_submission_example`=nothing, _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `submit_signup`(_api::`PublicApi`, response_stream::`Channel`; `login_submission_example`=nothing, _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`login_submission_example`** | [**`LoginSubmissionExample`**](LoginSubmissionExample.md) |  | 
