...
# **add_qs**
> `add_qs`(_api::`QuickServersApi`, `qs_order_request`::`QsOrderRequest`; _mediaType=nothing) -> `ServiceOrderPostResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_qs`(_api::`QuickServersApi`, response_stream::`Channel`, `qs_order_request`::`QsOrderRequest`; _mediaType=nothing) -> `Channel`{ `ServiceOrderPostResponse` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`QuickServersApi`** | API context | 
...
# **delete_qs_backup**
> `delete_qs_backup`(_api::`QuickServersApi`, `id`::`Int64`, `file`::`String`; `all`=nothing, _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_qs_backup`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`, `file`::`String`; `all`=nothing, _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`QuickServersApi`** | API context | 
**`id`** | **`Int64`** | QuickServer ID number |
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`all`** | **`String`** | Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given QuickServer. | [default to nothing]
...
# **do_qs_block_smtp**
> `do_qs_block_smtp`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_qs_block_smtp`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_qs_disable_cd**
> `do_qs_disable_cd`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_qs_disable_cd`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_qs_disable_quota**
> `do_qs_disable_quota`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_qs_disable_quota`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_qs_eject_cd**
> `do_qs_eject_cd`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_qs_eject_cd`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_qs_enable_quota**
> `do_qs_enable_quota`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_qs_enable_quota`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_qs_restart**
> `do_qs_restart`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_qs_restart`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_qs_start**
> `do_qs_start`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_qs_start`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_qs_stop**
> `do_qs_stop`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_qs_stop`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **download_qs_backup**
> `download_qs_backup`(_api::`QuickServersApi`, `id`::`Int64`, `download_qs_backup_request`::`DownloadQsBackupRequest`; `all`=nothing, _mediaType=nothing) -> `DownloadQsBackup200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `download_qs_backup`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`, `download_qs_backup_request`::`DownloadQsBackupRequest`; `all`=nothing, _mediaType=nothing) -> `Channel`{ `DownloadQsBackup200Response` }, `OpenAPI.Clients.ApiResponse`
...
# **get_new_qs**
> `get_new_qs`(_api::`QuickServersApi`; _mediaType=nothing) -> `QuickserverOrder`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_new_qs`(_api::`QuickServersApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `QuickserverOrder` }, `OpenAPI.Clients.ApiResponse`
...
# **get_qs_backup**
> `get_qs_backup`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_backup`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_qs_backups**
> `get_qs_backups`(_api::`QuickServersApi`, `id`::`Int64`; `all`=nothing, _mediaType=nothing) -> `VpsBackupRows`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_backups`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; `all`=nothing, _mediaType=nothing) -> `Channel`{ `VpsBackupRows` }, `OpenAPI.Clients.ApiResponse`
...
> `get_qs_change_hostname`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_change_hostname`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `get_qs_change_root_password`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_change_root_password`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `get_qs_change_timezone`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Vector{String}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_change_timezone`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Vector{String}` }, `OpenAPI.Clients.ApiResponse`
...
> `get_qs_change_webuzo_password`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_change_webuzo_password`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_qs_info**
> `get_qs_info`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Quickserver`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_info`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Quickserver` }, `OpenAPI.Clients.ApiResponse`
...
# **get_qs_insert_cd**
> `get_qs_insert_cd`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_insert_cd`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_qs_invoices**
> `get_qs_invoices`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `ChargeInvoiceRows`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_invoices`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `ChargeInvoiceRows` }, `OpenAPI.Clients.ApiResponse`
...
# **get_qs_list**
> `get_qs_list`(_api::`QuickServersApi`; _mediaType=nothing) -> `Vector{QuickserverRow}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_list`(_api::`QuickServersApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Vector{QuickserverRow}` }, `OpenAPI.Clients.ApiResponse`
...
[**`Vector{QuickserverRow}`**](QuickserverRow.md)
...
# **get_qs_reinstall_os**
> `get_qs_reinstall_os`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `VpsTemplatesList`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_reinstall_os`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `VpsTemplatesList` }, `OpenAPI.Clients.ApiResponse`
...
> `get_qs_reset_password`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_reset_password`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_qs_reverse_dns**
> `get_qs_reverse_dns`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `ReverseDnsEntries`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_reverse_dns`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `ReverseDnsEntries` }, `OpenAPI.Clients.ApiResponse`
...
# **get_qs_setup_vnc**
> `get_qs_setup_vnc`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_setup_vnc`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `get_qs_traffic_usage`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_traffic_usage`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_qs_view_desktop**
> `get_qs_view_desktop`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_view_desktop`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `get_qs_welcome_email`(_api::`QuickServersApi`, `id`::`String`; _mediaType=nothing) -> `TextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_qs_welcome_email`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`String`; _mediaType=nothing) -> `Channel`{ `TextResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_qs_change_hostname`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_change_hostname`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_qs_change_root_password`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_change_root_password`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_qs_change_timezone`(_api::`QuickServersApi`, `id`::`Int64`, `timezone`::`String`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_change_timezone`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`, `timezone`::`String`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_qs_change_webuzo_password`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_change_webuzo_password`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **post_qs_insert_cd**
> `post_qs_insert_cd`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_insert_cd`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_qs_reinstall_os`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_reinstall_os`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_qs_reset_password`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_reset_password`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **post_qs_reverse_dns**
> `post_qs_reverse_dns`(_api::`QuickServersApi`, `id`::`Int64`, `reverse_dns_entries`::`ReverseDnsEntries`; _mediaType=nothing) -> `TextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_reverse_dns`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`, `reverse_dns_entries`::`ReverseDnsEntries`; _mediaType=nothing) -> `Channel`{ `TextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **post_qs_setup_vnc**
> `post_qs_setup_vnc`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_setup_vnc`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_qs_traffic_usage`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_traffic_usage`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `post_qs_view_desktop`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_qs_view_desktop`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `post_quick_server_restore`(_api::`QuickServersApi`, `id`::`Int64`, `restore_request`::`RestoreRequest`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_quick_server_restore`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`, `restore_request`::`RestoreRequest`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **put_qs**
> `put_qs`(_api::`QuickServersApi`, `qs_order_request`::`QsOrderRequest`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `put_qs`(_api::`QuickServersApi`, response_stream::`Channel`, `qs_order_request`::`QsOrderRequest`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **quickservers_cancel**
> `quickservers_cancel`(_api::`QuickServersApi`, `id`::`Int64`; _mediaType=nothing) -> `QuickserversCancel200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `quickservers_cancel`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QuickserversCancel200Response` }, `OpenAPI.Clients.ApiResponse`
...
# **update_qs_info**
> `update_qs_info`(_api::`QuickServersApi`, `id`::`String`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_qs_info`(_api::`QuickServersApi`, response_stream::`Channel`, `id`::`String`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
