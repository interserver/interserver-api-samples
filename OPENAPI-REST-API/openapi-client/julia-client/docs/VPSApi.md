...
[**v_p_s_cancel**](VPSApi.md#v_p_s_cancel) | **DELETE** /vps/{id} | Cancel a VPS service at the end of the current billing cycle


# **add_vps**
> `add_vps`(_api::`VPSApi`; `vps_order_post_request`=nothing, _mediaType=nothing) -> `ServiceOrderPostResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `add_vps`(_api::`VPSApi`, response_stream::`Channel`; `vps_order_post_request`=nothing, _mediaType=nothing) -> `Channel`{ `ServiceOrderPostResponse` }, `OpenAPI.Clients.ApiResponse`
...
------------- | ------------- | ------------- | -------------
 **_api** | **`VPSApi`** | API context | 

### Optional Parameters

Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`vps_order_post_request`** | [**`VpsOrderPostRequest`**](VpsOrderPostRequest.md) |  | 
...
# **delete_vps_backup**
> `delete_vps_backup`(_api::`VPSApi`, `id`::`Int64`, `file`::`String`; `all`=nothing, _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_vps_backup`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`, `file`::`String`; `all`=nothing, _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`all`** | **`String`** | Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given VPS. | [default to nothing]
...
# **do_vps_block_smtp**
> `do_vps_block_smtp`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_vps_block_smtp`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_vps_disable_cd**
> `do_vps_disable_cd`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_vps_disable_cd`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `do_vps_disable_quota`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_vps_disable_quota`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_vps_eject_cd**
> `do_vps_eject_cd`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_vps_eject_cd`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_vps_enable_quota**
> `do_vps_enable_quota`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_vps_enable_quota`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_vps_restart**
> `do_vps_restart`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_vps_restart`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_vps_start**
> `do_vps_start`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_vps_start`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **do_vps_stop**
> `do_vps_stop`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `do_vps_stop`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **download_vps_backup**
> `download_vps_backup`(_api::`VPSApi`, `id`::`Int64`, `download_qs_backup_request`::`DownloadQsBackupRequest`; `all`=nothing, _mediaType=nothing) -> `DownloadQsBackup200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `download_vps_backup`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`, `download_qs_backup_request`::`DownloadQsBackupRequest`; `all`=nothing, _mediaType=nothing) -> `Channel`{ `DownloadQsBackup200Response` }, `OpenAPI.Clients.ApiResponse`
...
# **get_new_vps**
> `get_new_vps`(_api::`VPSApi`; _mediaType=nothing) -> `VpsOrder`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_new_vps`(_api::`VPSApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `VpsOrder` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_backup**
> `get_vps_backup`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_backup`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_backups**
> `get_vps_backups`(_api::`VPSApi`, `id`::`Int64`; `all`=nothing, _mediaType=nothing) -> `VpsBackupRows`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_backups`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; `all`=nothing, _mediaType=nothing) -> `Channel`{ `VpsBackupRows` }, `OpenAPI.Clients.ApiResponse`
...
> `get_vps_buy_hd_space`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_buy_hd_space`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_buy_ip**
> `get_vps_buy_ip`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_buy_ip`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `get_vps_change_hostname`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_change_hostname`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `get_vps_change_root_password`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_change_root_password`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `get_vps_change_timezone`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Vector{String}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_change_timezone`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Vector{String}` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_info**
> `get_vps_info`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Vps`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_info`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Vps` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_insert_cd**
> `get_vps_insert_cd`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_insert_cd`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_invoices**
> `get_vps_invoices`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `ChargeInvoiceRows`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_invoices`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `ChargeInvoiceRows` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_list**
> `get_vps_list`(_api::`VPSApi`; _mediaType=nothing) -> `Vector{VpsRow}`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_list`(_api::`VPSApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `Vector{VpsRow}` }, `OpenAPI.Clients.ApiResponse`
...
> `get_vps_reinstall_os`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `VpsTemplatesList`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_reinstall_os`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `VpsTemplatesList` }, `OpenAPI.Clients.ApiResponse`
...
> `get_vps_reset_password`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_reset_password`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_reverse_dns**
> `get_vps_reverse_dns`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `ReverseDnsEntries`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_reverse_dns`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `ReverseDnsEntries` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_setup_vnc**
> `get_vps_setup_vnc`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_setup_vnc`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_vps_slices**
> `get_vps_slices`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_slices`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `get_vps_traffic_usage`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `VpsTrafficResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_traffic_usage`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `VpsTrafficResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `get_vps_view_desktop`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_view_desktop`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `get_vps_welcome_email`(_api::`VPSApi`, `id`::`String`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_vps_welcome_email`(_api::`VPSApi`, response_stream::`Channel`, `id`::`String`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_vps_buy_hd_space`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_buy_hd_space`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **post_vps_buy_ip**
> `post_vps_buy_ip`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_buy_ip`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `post_vps_change_hostname`(_api::`VPSApi`, `id`::`Int64`; `hostname`=nothing, _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_change_hostname`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; `hostname`=nothing, _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_vps_change_root_password`(_api::`VPSApi`, `id`::`Int64`, `password`::`String`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_change_root_password`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`, `password`::`String`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_vps_change_timezone`(_api::`VPSApi`, `id`::`Int64`, `timezone`::`String`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_change_timezone`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`, `timezone`::`String`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_vps_change_webuzo_password`(_api::`VPSApi`, `id`::`Int64`, `password`::`String`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_change_webuzo_password`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`, `password`::`String`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **post_vps_insert_cd**
> `post_vps_insert_cd`(_api::`VPSApi`, `id`::`Int64`; `url`=nothing, _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_insert_cd`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; `url`=nothing, _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_vps_reinstall_os`(_api::`VPSApi`, `id`::`Int64`, `template`::`String`, `local_password`::`String`; `password`=nothing, _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_reinstall_os`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`, `template`::`String`, `local_password`::`String`; `password`=nothing, _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`password`** | **`String`** | Password for Root / Administrator Account. | [default to nothing]
...
> `post_vps_reset_password`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_reset_password`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **post_vps_restore**
> `post_vps_restore`(_api::`VPSApi`, `id`::`Int64`, `restore_request`::`RestoreRequest`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_restore`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`, `restore_request`::`RestoreRequest`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
> `post_vps_reverse_dns`(_api::`VPSApi`, `id`::`Int64`, `reverse_dns_entries`::`ReverseDnsEntries`; _mediaType=nothing) -> `TextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_reverse_dns`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`, `reverse_dns_entries`::`ReverseDnsEntries`; _mediaType=nothing) -> `Channel`{ `TextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **post_vps_setup_vnc**
> `post_vps_setup_vnc`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `QueueResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_setup_vnc`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `QueueResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **post_vps_slices**
> `post_vps_slices`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_slices`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `post_vps_traffic_usage`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_traffic_usage`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `post_vps_view_desktop`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_vps_view_desktop`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **put_vps**
> `put_vps`(_api::`VPSApi`; `vps_order_put_request`=nothing, _mediaType=nothing) -> `VpsOrderPutResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `put_vps`(_api::`VPSApi`, response_stream::`Channel`; `vps_order_put_request`=nothing, _mediaType=nothing) -> `Channel`{ `VpsOrderPutResponse` }, `OpenAPI.Clients.ApiResponse`
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **`vps_order_put_request`** | [**`VpsOrderPutRequest`**](VpsOrderPutRequest.md) |  | 
...
> `put_vps_buy_hd_space`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `put_vps_buy_hd_space`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **update_vps_info**
> `update_vps_info`(_api::`VPSApi`, `id`::`String`; _mediaType=nothing) -> `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse` <br/>
> `update_vps_info`(_api::`VPSApi`, response_stream::`Channel`, `id`::`String`; _mediaType=nothing) -> `Channel`{ `SuccessTextResponse` }, `OpenAPI.Clients.ApiResponse`
...
# **v_p_s_cancel**
> `v_p_s_cancel`(_api::`VPSApi`, `id`::`Int64`; _mediaType=nothing) -> `VPSCancel200Response`, `OpenAPI.Clients.ApiResponse` <br/>
> `v_p_s_cancel`(_api::`VPSApi`, response_stream::`Channel`, `id`::`Int64`; _mediaType=nothing) -> `Channel`{ `VPSCancel200Response` }, `OpenAPI.Clients.ApiResponse`
