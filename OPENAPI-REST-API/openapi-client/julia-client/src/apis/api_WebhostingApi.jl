...
struct WebhostingApi <: OpenAPI.APIClientImpl
    client::OpenAPI.Clients.Client
end

"""
The default API base path for APIs in `WebhostingApi`.
This can be used to construct the `OpenAPI.Clients.Client` instance.
"""
basepath(::Type{ WebhostingApi }) = "https://my.interserver.net/apiv2"

const _returntypes_add_website_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ServiceOrderPostResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_add_website(_api::WebhostingApi, website_order_post_request::WebsiteOrderPostRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_add_website_WebhostingApi, "/websites/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], website_order_post_request)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Place a new webhosting order, create the invoice, and queue provisioning
...
Params:
- `website_order_post_request`::`WebsiteOrderPostRequest` (required)

Return: `ServiceOrderPostResponse`, `OpenAPI.Clients.ApiResponse`
"""
function add_website(_api::WebhostingApi, website_order_post_request::WebsiteOrderPostRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_website(_api, website_order_post_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function add_website(_api::WebhostingApi, response_stream::Channel, website_order_post_request::WebsiteOrderPostRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_website(_api, website_order_post_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_new_website_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => WebsitesOrder,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_new_website(_api::WebhostingApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_new_website_WebhostingApi, "/websites/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Read the webhosting order catalog — plans, packages, promo offers, pricing
...
Return: `WebsitesOrder`, `OpenAPI.Clients.ApiResponse`
"""
function get_new_website(_api::WebhostingApi; _mediaType=nothing)
    _ctx = _oacinternal_get_new_website(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_new_website(_api::WebhostingApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_new_website(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_website_buy_ip_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => GetWebsiteBuyIp200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_website_buy_ip(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_website_buy_ip_WebhostingApi, "/websites/{id}/buy_ip", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
...
@doc raw"""Read website IPs, current reverse DNS, and additional-IP pricing
...
Return: `GetWebsiteBuyIp200Response`, `OpenAPI.Clients.ApiResponse`
"""
function get_website_buy_ip(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_website_buy_ip(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_website_buy_ip(_api::WebhostingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_website_buy_ip(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_website_info_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Website,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_website_info(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_website_info_WebhostingApi, "/websites/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read full configuration and status detail for one webhosting service
...
Return: `Website`, `OpenAPI.Clients.ApiResponse`
"""
function get_website_info(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_website_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_website_info(_api::WebhostingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_website_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_website_invoices_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ChargeInvoiceRows,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_website_invoices(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_website_invoices_WebhostingApi, "/websites/{id}/invoices", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""List all billing invoices and recurring charges scoped to one website
...
"""
function get_website_invoices(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_website_invoices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_website_invoices(_api::WebhostingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_website_invoices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_website_list_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{WebsiteRow},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_website_list(_api::WebhostingApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_website_list_WebhostingApi, "/websites", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", "multipart/form-data", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List the caller's webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services
...
Return: `Vector{WebsiteRow}`, `OpenAPI.Clients.ApiResponse`
"""
function get_website_list(_api::WebhostingApi; _mediaType=nothing)
    _ctx = _oacinternal_get_website_list(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_website_list(_api::WebhostingApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_website_list(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_websites_backups_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => WebsiteBackups,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_websites_backups(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_websites_backups_WebhostingApi, "/websites/{id}/backups", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""List off-site cpmove backups stored in Swift — list or inline-download archive
...
Return: `WebsiteBackups`, `OpenAPI.Clients.ApiResponse`
"""
function get_websites_backups(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_websites_backups(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_websites_backups(_api::WebhostingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_websites_backups(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_websites_login_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => WebsiteLoginResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_websites_login(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_websites_login_WebhostingApi, "/websites/{id}/login", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Get a one-time auto-login URL for the website's control panel
...
Return: `WebsiteLoginResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_websites_login(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_websites_login(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_websites_login(_api::WebhostingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_websites_login(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_websites_welcome_email_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_websites_welcome_email(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_websites_welcome_email_WebhostingApi, "/websites/{id}/welcome_email", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Resend the webhosting welcome email with control-panel credentials and URL
...
"""
function get_websites_welcome_email(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_websites_welcome_email(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_websites_welcome_email(_api::WebhostingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_websites_welcome_email(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_gett_website_reverse_dns_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ReverseDnsEntries,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_gett_website_reverse_dns(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_gett_website_reverse_dns_WebhostingApi, "/websites/{id}/reverse_dns", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read current reverse-DNS (PTR) records for the website's IPs
...
"""
function gett_website_reverse_dns(_api::WebhostingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_gett_website_reverse_dns(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function gett_website_reverse_dns(_api::WebhostingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_gett_website_reverse_dns(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_website_buy_ip_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => PostWebsiteBuyIp200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_website_buy_ip(_api::WebhostingApi, id::Int64, post_website_buy_ip_request::PostWebsiteBuyIpRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_website_buy_ip_WebhostingApi, "/websites/{id}/buy_ip", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], post_website_buy_ip_request)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
...
@doc raw"""Buy an additional IP for the website OR update reverse DNS records
...
Params:
- `id`::`Int64` (required)
- `post_website_buy_ip_request`::`PostWebsiteBuyIpRequest` (required)

Return: `PostWebsiteBuyIp200Response`, `OpenAPI.Clients.ApiResponse`
"""
function post_website_buy_ip(_api::WebhostingApi, id::Int64, post_website_buy_ip_request::PostWebsiteBuyIpRequest; _mediaType=nothing)
    _ctx = _oacinternal_post_website_buy_ip(_api, id, post_website_buy_ip_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_website_buy_ip(_api::WebhostingApi, response_stream::Channel, id::Int64, post_website_buy_ip_request::PostWebsiteBuyIpRequest; _mediaType=nothing)
    _ctx = _oacinternal_post_website_buy_ip(_api, id, post_website_buy_ip_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_website_migration_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => PostWebsiteMigration200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_website_migration(_api::WebhostingApi, id::Int64, post_website_migration_request::PostWebsiteMigrationRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_website_migration_WebhostingApi, "/websites/{id}/migration", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], post_website_migration_request)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Submit a request for InterServer staff to migrate a website from another host
...
Params:
- `id`::`Int64` (required)
- `post_website_migration_request`::`PostWebsiteMigrationRequest` (required)

Return: `PostWebsiteMigration200Response`, `OpenAPI.Clients.ApiResponse`
"""
function post_website_migration(_api::WebhostingApi, id::Int64, post_website_migration_request::PostWebsiteMigrationRequest; _mediaType=nothing)
    _ctx = _oacinternal_post_website_migration(_api, id, post_website_migration_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_website_migration(_api::WebhostingApi, response_stream::Channel, id::Int64, post_website_migration_request::PostWebsiteMigrationRequest; _mediaType=nothing)
    _ctx = _oacinternal_post_website_migration(_api, id, post_website_migration_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_websites_reverse_dns_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => TextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_websites_reverse_dns(_api::WebhostingApi, id::Int64, reverse_dns_entries::ReverseDnsEntries; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_websites_reverse_dns_WebhostingApi, "/websites/{id}/reverse_dns", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], reverse_dns_entries)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Bulk-update reverse-DNS (PTR) records for one or more website IPs
...
"""
function post_websites_reverse_dns(_api::WebhostingApi, id::Int64, reverse_dns_entries::ReverseDnsEntries; _mediaType=nothing)
    _ctx = _oacinternal_post_websites_reverse_dns(_api, id, reverse_dns_entries; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_websites_reverse_dns(_api::WebhostingApi, response_stream::Channel, id::Int64, reverse_dns_entries::ReverseDnsEntries; _mediaType=nothing)
    _ctx = _oacinternal_post_websites_reverse_dns(_api, id, reverse_dns_entries; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_put_websites_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_put_websites(_api::WebhostingApi, website_order_put_request::WebsiteOrderPutRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PUT", _returntypes_put_websites_WebhostingApi, "/websites/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], website_order_put_request)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Validate a webhosting order and preview cost — dry run, no charge
...
Params:
- `website_order_put_request`::`WebsiteOrderPutRequest` (required)

Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function put_websites(_api::WebhostingApi, website_order_put_request::WebsiteOrderPutRequest; _mediaType=nothing)
    _ctx = _oacinternal_put_websites(_api, website_order_put_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function put_websites(_api::WebhostingApi, response_stream::Channel, website_order_put_request::WebsiteOrderPutRequest; _mediaType=nothing)
    _ctx = _oacinternal_put_websites(_api, website_order_put_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_website_info_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_website_info(_api::WebhostingApi, id::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_website_info_WebhostingApi, "/websites/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
...
@doc raw"""POST mutation hook for the website detail page (use dedicated ops where possible)
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_website_info(_api::WebhostingApi, id::String; _mediaType=nothing)
    _ctx = _oacinternal_update_website_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_website_info(_api::WebhostingApi, response_stream::Channel, id::String; _mediaType=nothing)
    _ctx = _oacinternal_update_website_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_webhosting_cancel_WebhostingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => WebhostingCancel200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_webhosting_cancel(_api::WebhostingApi, id::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_webhosting_cancel_WebhostingApi, "/websites/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Schedule termination of a webhosting service — wipes panel account at cycle end
...
Return: `WebhostingCancel200Response`, `OpenAPI.Clients.ApiResponse`
"""
function webhosting_cancel(_api::WebhostingApi, id::String; _mediaType=nothing)
    _ctx = _oacinternal_webhosting_cancel(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function webhosting_cancel(_api::WebhostingApi, response_stream::Channel, id::String; _mediaType=nothing)
    _ctx = _oacinternal_webhosting_cancel(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

export add_website
export get_new_website
export get_website_buy_ip
export get_website_info
export get_website_invoices
export get_website_list
export get_websites_backups
export get_websites_login
export get_websites_welcome_email
export gett_website_reverse_dns
export post_website_buy_ip
export post_website_migration
export post_websites_reverse_dns
export put_websites
export update_website_info
export webhosting_cancel
