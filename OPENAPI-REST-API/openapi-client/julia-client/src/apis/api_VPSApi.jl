...
struct VPSApi <: OpenAPI.APIClientImpl
    client::OpenAPI.Clients.Client
end

"""
The default API base path for APIs in `VPSApi`.
This can be used to construct the `OpenAPI.Clients.Client` instance.
"""
basepath(::Type{ VPSApi }) = "https://my.interserver.net/apiv2"

const _returntypes_add_vps_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ServiceOrderPostResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_add_vps(_api::VPSApi; vps_order_post_request=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_add_vps_VPSApi, "/vps/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], vps_order_post_request)
...
@doc raw"""Place a new VPS order, create the invoice, and queue provisioning
...
Params:
- `vps_order_post_request`::`VpsOrderPostRequest`

Return: `ServiceOrderPostResponse`, `OpenAPI.Clients.ApiResponse`
"""
function add_vps(_api::VPSApi; vps_order_post_request=nothing, _mediaType=nothing)
    _ctx = _oacinternal_add_vps(_api; vps_order_post_request=vps_order_post_request, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function add_vps(_api::VPSApi, response_stream::Channel; vps_order_post_request=nothing, _mediaType=nothing)
    _ctx = _oacinternal_add_vps(_api; vps_order_post_request=vps_order_post_request, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_delete_vps_backup_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_delete_vps_backup(_api::VPSApi, id::Int64, file::String; all=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_delete_vps_backup_VPSApi, "/vps/{id}/backups", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
...
@doc raw"""Permanently delete a VPS backup file by name (irreversible)
...
"""
function delete_vps_backup(_api::VPSApi, id::Int64, file::String; all=nothing, _mediaType=nothing)
    _ctx = _oacinternal_delete_vps_backup(_api, id, file; all=all, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_vps_backup(_api::VPSApi, response_stream::Channel, id::Int64, file::String; all=nothing, _mediaType=nothing)
    _ctx = _oacinternal_delete_vps_backup(_api, id, file; all=all, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_do_vps_block_smtp_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_do_vps_block_smtp(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_do_vps_block_smtp_VPSApi, "/vps/{id}/block_smtp", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Block outbound SMTP (port 25) on the VPS to prevent spam/abuse
...
"""
function do_vps_block_smtp(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_block_smtp(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function do_vps_block_smtp(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_block_smtp(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_do_vps_disable_cd_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_do_vps_disable_cd(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_do_vps_disable_cd_VPSApi, "/vps/{id}/disable_cd", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Remove the virtual CD/DVD device entirely from the VPS configuration
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function do_vps_disable_cd(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_disable_cd(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function do_vps_disable_cd(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_disable_cd(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_do_vps_disable_quota_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_do_vps_disable_quota(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_do_vps_disable_quota_VPSApi, "/vps/{id}/disable_quota", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Disable per-user disk quota enforcement inside the VPS guest OS
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function do_vps_disable_quota(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_disable_quota(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function do_vps_disable_quota(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_disable_quota(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_do_vps_eject_cd_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_do_vps_eject_cd(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_do_vps_eject_cd_VPSApi, "/vps/{id}/eject_cd", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Eject the mounted ISO from the VPS virtual CD drive (keep the drive)
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function do_vps_eject_cd(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_eject_cd(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function do_vps_eject_cd(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_eject_cd(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_do_vps_enable_quota_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_do_vps_enable_quota(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_do_vps_enable_quota_VPSApi, "/vps/{id}/enable_quota", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Enable per-user disk quota enforcement inside the VPS guest OS
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function do_vps_enable_quota(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_enable_quota(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function do_vps_enable_quota(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_enable_quota(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_do_vps_restart_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_do_vps_restart(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_do_vps_restart_VPSApi, "/vps/{id}/restart", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Reboot the VPS — preferred over stop+start for software changes
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function do_vps_restart(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_restart(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function do_vps_restart(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_restart(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_do_vps_start_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_do_vps_start(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_do_vps_start_VPSApi, "/vps/{id}/start", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Power on a stopped VPS instance
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function do_vps_start(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_start(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function do_vps_start(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_start(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_do_vps_stop_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_do_vps_stop(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_do_vps_stop_VPSApi, "/vps/{id}/stop", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Power off a running VPS — billing continues until cancellation
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function do_vps_stop(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_stop(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function do_vps_stop(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_do_vps_stop(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_download_vps_backup_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => DownloadQsBackup200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_download_vps_backup(_api::VPSApi, id::Int64, download_qs_backup_request::DownloadQsBackupRequest; all=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PATCH", _returntypes_download_vps_backup_VPSApi, "/vps/{id}/backups", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], download_qs_backup_request)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.query, "all", all; style="form", is_explode=true)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
...
@doc raw"""Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
...
"""
function download_vps_backup(_api::VPSApi, id::Int64, download_qs_backup_request::DownloadQsBackupRequest; all=nothing, _mediaType=nothing)
    _ctx = _oacinternal_download_vps_backup(_api, id, download_qs_backup_request; all=all, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function download_vps_backup(_api::VPSApi, response_stream::Channel, id::Int64, download_qs_backup_request::DownloadQsBackupRequest; all=nothing, _mediaType=nothing)
    _ctx = _oacinternal_download_vps_backup(_api, id, download_qs_backup_request; all=all, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_new_vps_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => VpsOrder,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_new_vps(_api::VPSApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_new_vps_VPSApi, "/vps/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Get the VPS order catalog — platforms, OS templates, locations, pricing
...
Return: `VpsOrder`, `OpenAPI.Clients.ApiResponse`
"""
function get_new_vps(_api::VPSApi; _mediaType=nothing)
    _ctx = _oacinternal_get_new_vps(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_new_vps(_api::VPSApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_new_vps(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_backup_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_backup(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_backup_VPSApi, "/vps/{id}/backup", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Trigger a manual on-demand snapshot/backup of the VPS
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_backup(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_backup(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_backup(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_backup(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_backups_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => VpsBackupRows,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_backups(_api::VPSApi, id::Int64; all=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_backups_VPSApi, "/vps/{id}/backups", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.query, "all", all; style="form", is_explode=true)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
...
@doc raw"""List existing backups for the VPS across Swift, MinIO, and ZFS
...
"""
function get_vps_backups(_api::VPSApi, id::Int64; all=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_vps_backups(_api, id; all=all, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_backups(_api::VPSApi, response_stream::Channel, id::Int64; all=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_vps_backups(_api, id; all=all, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_buy_hd_space_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_buy_hd_space(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_buy_hd_space_VPSApi, "/vps/{id}/buy_hd_space", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Get current additional disk size and per-GB monthly cost for the VPS
...
"""
function get_vps_buy_hd_space(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_buy_hd_space(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_buy_hd_space(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_buy_hd_space(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_buy_ip_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_buy_ip(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_buy_ip_VPSApi, "/vps/{id}/buy_ip", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read current additional IPs, cap, and per-IP monthly cost for the VPS
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_buy_ip(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_buy_ip(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_buy_ip(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_buy_ip(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_change_hostname_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_change_hostname(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_change_hostname_VPSApi, "/vps/{id}/change_hostname", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read the VPS's current hostname before changing it
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_change_hostname(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_change_hostname(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_change_hostname(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_change_hostname(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_change_root_password_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_change_root_password(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_change_root_password_VPSApi, "/vps/{id}/change_root_password", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Pre-flight check before changing the VPS root password
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_change_root_password(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_change_root_password(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_change_root_password(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_change_root_password(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_change_timezone_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{String},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_change_timezone(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_change_timezone_VPSApi, "/vps/{id}/change_timezone", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""List IANA timezones supported by the VPS guest OS
...
"""
function get_vps_change_timezone(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_change_timezone(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_change_timezone(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_change_timezone(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_info_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vps,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_info(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_info_VPSApi, "/vps/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Get full details for one VPS — IPs, hostname, OS, slices, status, addons
...
Return: `Vps`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_info(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_info(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_insert_cd_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_insert_cd(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_insert_cd_VPSApi, "/vps/{id}/insert_cd", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""List ISO templates that can be mounted in the VPS virtual CD drive
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_insert_cd(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_insert_cd(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_insert_cd(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_insert_cd(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_invoices_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ChargeInvoiceRows,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_invoices(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_invoices_VPSApi, "/vps/{id}/invoices", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""List all billing invoices associated with this specific VPS
...
"""
function get_vps_invoices(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_invoices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_invoices(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_invoices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_list_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{VpsRow},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_list(_api::VPSApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_list_VPSApi, "/vps", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List all VPS services on the customer's account
...
Return: `Vector{VpsRow}`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_list(_api::VPSApi; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_list(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_list(_api::VPSApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_list(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_reinstall_os_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => VpsTemplatesList,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_reinstall_os(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_reinstall_os_VPSApi, "/vps/{id}/reinstall_os", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""List OS templates compatible with this VPS's hypervisor for reinstall
...
"""
function get_vps_reinstall_os(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_reinstall_os(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_reinstall_os(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_reinstall_os(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_reset_password_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_reset_password(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_reset_password_VPSApi, "/vps/{id}/reset_password", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Pre-flight check before resetting the VPS root password to a random value
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_reset_password(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_reset_password(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_reset_password(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_reset_password(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_reverse_dns_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ReverseDnsEntries,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_reverse_dns(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_reverse_dns_VPSApi, "/vps/{id}/reverse_dns", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read the current PTR (reverse-DNS) records for every IP on the VPS
...
"""
function get_vps_reverse_dns(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_reverse_dns(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_reverse_dns(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_reverse_dns(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_setup_vnc_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_setup_vnc(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_setup_vnc_VPSApi, "/vps/{id}/setup_vnc", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read current VNC console connection info for the VPS
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_setup_vnc(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_setup_vnc(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_setup_vnc(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_setup_vnc(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_slices_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_slices(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_slices_VPSApi, "/vps/{id}/slices", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read current slice count, min/max range, and prorated per-slice upgrade cost
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_slices(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_slices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_slices(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_slices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_traffic_usage_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => VpsTrafficResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_traffic_usage(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_traffic_usage_VPSApi, "/vps/{id}/traffic_usage", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read bandwidth traffic usage data for the VPS
...
Return: `VpsTrafficResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_traffic_usage(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_traffic_usage(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_traffic_usage(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_traffic_usage(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_view_desktop_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_view_desktop(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_view_desktop_VPSApi, "/vps/{id}/view_desktop", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_view_desktop(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_view_desktop(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_view_desktop(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_view_desktop(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_vps_welcome_email_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_vps_welcome_email(_api::VPSApi, id::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_vps_welcome_email_VPSApi, "/vps/{id}/welcome_email", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
...
@doc raw"""Resend the welcome email containing VPS IP, hostname, and root credentials
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_vps_welcome_email(_api::VPSApi, id::String; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_welcome_email(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_vps_welcome_email(_api::VPSApi, response_stream::Channel, id::String; _mediaType=nothing)
    _ctx = _oacinternal_get_vps_welcome_email(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_buy_hd_space_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_buy_hd_space(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_buy_hd_space_VPSApi, "/vps/{id}/buy_hd_space", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Buy or resize the VPS additional-disk addon and create a prorated invoice
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_buy_hd_space(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_buy_hd_space(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_buy_hd_space(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_buy_hd_space(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_buy_ip_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_buy_ip(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_buy_ip_VPSApi, "/vps/{id}/buy_ip", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Purchase one additional IP for the VPS and create the invoice
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_buy_ip(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_buy_ip(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_buy_ip(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_buy_ip(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_change_hostname_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_change_hostname(_api::VPSApi, id::Int64; hostname=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_change_hostname_VPSApi, "/vps/{id}/change_hostname", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.form, "hostname", hostname)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["multipart/form-data", "application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_change_hostname(_api::VPSApi, id::Int64; hostname=nothing, _mediaType=nothing)
    _ctx = _oacinternal_post_vps_change_hostname(_api, id; hostname=hostname, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_change_hostname(_api::VPSApi, response_stream::Channel, id::Int64; hostname=nothing, _mediaType=nothing)
    _ctx = _oacinternal_post_vps_change_hostname(_api, id; hostname=hostname, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_change_root_password_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_change_root_password(_api::VPSApi, id::Int64, password::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_change_root_password_VPSApi, "/vps/{id}/change_root_password", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
...
@doc raw"""Set a specific new root/Administrator password on the VPS
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_change_root_password(_api::VPSApi, id::Int64, password::String; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_change_root_password(_api, id, password; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_change_root_password(_api::VPSApi, response_stream::Channel, id::Int64, password::String; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_change_root_password(_api, id, password; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_change_timezone_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_change_timezone(_api::VPSApi, id::Int64, timezone::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_change_timezone_VPSApi, "/vps/{id}/change_timezone", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
...
@doc raw"""Set the system timezone on the VPS guest OS
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_change_timezone(_api::VPSApi, id::Int64, timezone::String; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_change_timezone(_api, id, timezone; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_change_timezone(_api::VPSApi, response_stream::Channel, id::Int64, timezone::String; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_change_timezone(_api, id, timezone; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_change_webuzo_password_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_change_webuzo_password(_api::VPSApi, id::Int64, password::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_change_webuzo_password_VPSApi, "/vps/{id}/change_webuzo_password", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.form, "password", password)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["multipart/form-data", "application/json", ] : [_mediaType])
...
@doc raw"""Rotate the Webuzo control panel admin password (re-auth required)
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_change_webuzo_password(_api::VPSApi, id::Int64, password::String; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_change_webuzo_password(_api, id, password; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_change_webuzo_password(_api::VPSApi, response_stream::Channel, id::Int64, password::String; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_change_webuzo_password(_api, id, password; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_insert_cd_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_insert_cd(_api::VPSApi, id::Int64; url=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_insert_cd_VPSApi, "/vps/{id}/insert_cd", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.form, "url", url)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["multipart/form-data", "application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Mount an ISO image in the VPS virtual CD drive from a URL
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_insert_cd(_api::VPSApi, id::Int64; url=nothing, _mediaType=nothing)
    _ctx = _oacinternal_post_vps_insert_cd(_api, id; url=url, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_insert_cd(_api::VPSApi, response_stream::Channel, id::Int64; url=nothing, _mediaType=nothing)
    _ctx = _oacinternal_post_vps_insert_cd(_api, id; url=url, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_reinstall_os_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_reinstall_os(_api::VPSApi, id::Int64, template::String, local_password::String; password=nothing, _mediaType=nothing)
    OpenAPI.validate_param("password", "post_vps_reinstall_os", :minLength, password, 6)

    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_reinstall_os_VPSApi, "/vps/{id}/reinstall_os", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.form, "template", template)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "password", password)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "localPassword", local_password)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["multipart/form-data", "application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)
...
- `local_password`::`String` (required)
- `password`::`String`

Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_reinstall_os(_api::VPSApi, id::Int64, template::String, local_password::String; password=nothing, _mediaType=nothing)
    _ctx = _oacinternal_post_vps_reinstall_os(_api, id, template, local_password; password=password, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_reinstall_os(_api::VPSApi, response_stream::Channel, id::Int64, template::String, local_password::String; password=nothing, _mediaType=nothing)
    _ctx = _oacinternal_post_vps_reinstall_os(_api, id, template, local_password; password=password, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_reset_password_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_reset_password(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_reset_password_VPSApi, "/vps/{id}/reset_password", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Reset the VPS root password to a server-generated random value
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_reset_password(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_reset_password(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_reset_password(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_reset_password(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_restore_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("400", "x"=>".") * "\$") => TextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_restore(_api::VPSApi, id::Int64, restore_request::RestoreRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_restore_VPSApi, "/vps/{id}/restore", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], restore_request)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_restore(_api::VPSApi, id::Int64, restore_request::RestoreRequest; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_restore(_api, id, restore_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_restore(_api::VPSApi, response_stream::Channel, id::Int64, restore_request::RestoreRequest; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_restore(_api, id, restore_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_reverse_dns_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => TextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_reverse_dns(_api::VPSApi, id::Int64, reverse_dns_entries::ReverseDnsEntries; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_reverse_dns_VPSApi, "/vps/{id}/reverse_dns", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], reverse_dns_entries)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Bulk-update PTR (reverse-DNS) records for one or more VPS IPs
...
"""
function post_vps_reverse_dns(_api::VPSApi, id::Int64, reverse_dns_entries::ReverseDnsEntries; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_reverse_dns(_api, id, reverse_dns_entries; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_reverse_dns(_api::VPSApi, response_stream::Channel, id::Int64, reverse_dns_entries::ReverseDnsEntries; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_reverse_dns(_api, id, reverse_dns_entries; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_setup_vnc_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => QueueResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_setup_vnc(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_setup_vnc_VPSApi, "/vps/{id}/setup_vnc", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Provision or refresh the VNC console endpoint for the VPS
...
Return: `QueueResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_setup_vnc(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_setup_vnc(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_setup_vnc(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_setup_vnc(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_slices_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_slices(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_slices_VPSApi, "/vps/{id}/slices", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_slices(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_slices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_slices(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_slices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_traffic_usage_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_traffic_usage(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_traffic_usage_VPSApi, "/vps/{id}/traffic_usage", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Search/filter VPS bandwidth usage with custom criteria (reserved)
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_traffic_usage(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_traffic_usage(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_traffic_usage(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_traffic_usage(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_vps_view_desktop_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_vps_view_desktop(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_vps_view_desktop_VPSApi, "/vps/{id}/view_desktop", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Refresh the remote-desktop session connection info after IP/hostname changes
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function post_vps_view_desktop(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_view_desktop(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_vps_view_desktop(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_vps_view_desktop(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_put_vps_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => VpsOrderPutResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_put_vps(_api::VPSApi; vps_order_put_request=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PUT", _returntypes_put_vps_VPSApi, "/vps/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], vps_order_put_request)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
end

@doc raw"""Validate a VPS order configuration and quote the cost — dry run, no charge
...
Params:
- `vps_order_put_request`::`VpsOrderPutRequest`

Return: `VpsOrderPutResponse`, `OpenAPI.Clients.ApiResponse`
"""
function put_vps(_api::VPSApi; vps_order_put_request=nothing, _mediaType=nothing)
    _ctx = _oacinternal_put_vps(_api; vps_order_put_request=vps_order_put_request, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function put_vps(_api::VPSApi, response_stream::Channel; vps_order_put_request=nothing, _mediaType=nothing)
    _ctx = _oacinternal_put_vps(_api; vps_order_put_request=vps_order_put_request, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_put_vps_buy_hd_space_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_put_vps_buy_hd_space(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PUT", _returntypes_put_vps_buy_hd_space_VPSApi, "/vps/{id}/buy_hd_space", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Preview cost to set additional VPS disk to a target GB size — dry run
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function put_vps_buy_hd_space(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_put_vps_buy_hd_space(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function put_vps_buy_hd_space(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_put_vps_buy_hd_space(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_vps_info_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_vps_info(_api::VPSApi, id::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_vps_info_VPSApi, "/vps/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Update editable settings on a VPS service record
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_vps_info(_api::VPSApi, id::String; _mediaType=nothing)
    _ctx = _oacinternal_update_vps_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_vps_info(_api::VPSApi, response_stream::Channel, id::String; _mediaType=nothing)
    _ctx = _oacinternal_update_vps_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_v_p_s_cancel_VPSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => VPSCancel200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_v_p_s_cancel(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_v_p_s_cancel_VPSApi, "/vps/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Cancel a VPS service at the end of the current billing cycle
...
Return: `VPSCancel200Response`, `OpenAPI.Clients.ApiResponse`
"""
function v_p_s_cancel(_api::VPSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_v_p_s_cancel(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function v_p_s_cancel(_api::VPSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_v_p_s_cancel(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

export add_vps
export delete_vps_backup
export do_vps_block_smtp
export do_vps_disable_cd
export do_vps_disable_quota
export do_vps_eject_cd
export do_vps_enable_quota
export do_vps_restart
export do_vps_start
export do_vps_stop
export download_vps_backup
export get_new_vps
export get_vps_backup
export get_vps_backups
export get_vps_buy_hd_space
export get_vps_buy_ip
export get_vps_change_hostname
export get_vps_change_root_password
export get_vps_change_timezone
export get_vps_info
export get_vps_insert_cd
export get_vps_invoices
export get_vps_list
export get_vps_reinstall_os
export get_vps_reset_password
export get_vps_reverse_dns
export get_vps_setup_vnc
export get_vps_slices
export get_vps_traffic_usage
export get_vps_view_desktop
export get_vps_welcome_email
export post_vps_buy_hd_space
export post_vps_buy_ip
export post_vps_change_hostname
export post_vps_change_root_password
export post_vps_change_timezone
export post_vps_change_webuzo_password
export post_vps_insert_cd
export post_vps_reinstall_os
export post_vps_reset_password
export post_vps_restore
export post_vps_reverse_dns
export post_vps_setup_vnc
export post_vps_slices
export post_vps_traffic_usage
export post_vps_view_desktop
export put_vps
export put_vps_buy_hd_space
export update_vps_info
export v_p_s_cancel
