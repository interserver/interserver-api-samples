...
struct DNSApi <: OpenAPI.APIClientImpl
    client::OpenAPI.Clients.Client
end

"""
The default API base path for APIs in `DNSApi`.
This can be used to construct the `OpenAPI.Clients.Client` instance.
"""
basepath(::Type{ DNSApi }) = "https://my.interserver.net/apiv2"

const _returntypes_add_dns_domain_DNSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_add_dns_domain(_api::DNSApi, domain::String, ip::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_add_dns_domain_DNSApi, "/dns", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.form, "domain", domain)  # type String
...
@doc raw"""Create a new authoritative DNS zone seeded with apex A + NS + SOA records
...
"""
function add_dns_domain(_api::DNSApi, domain::String, ip::String; _mediaType=nothing)
    _ctx = _oacinternal_add_dns_domain(_api, domain, ip; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function add_dns_domain(_api::DNSApi, response_stream::Channel, domain::String, ip::String; _mediaType=nothing)
    _ctx = _oacinternal_add_dns_domain(_api, domain, ip; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_add_dns_record_DNSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_add_dns_record(_api::DNSApi, id::String, name::String, type::DnsRecordType, content::String; ttl=nothing, prio=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_add_dns_record_DNSApi, "/dns/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "name", name)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "type", type)  # type DnsRecordType
    OpenAPI.Clients.set_param(_ctx.form, "content", content)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "ttl", ttl)  # type Int64
    OpenAPI.Clients.set_param(_ctx.form, "prio", prio)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["multipart/form-data", "application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Add a DNS record (A, AAAA, MX, TXT, CNAME, NS, SRV, CAA, ...) to a zone
...
"""
function add_dns_record(_api::DNSApi, id::String, name::String, type::DnsRecordType, content::String; ttl=nothing, prio=nothing, _mediaType=nothing)
    _ctx = _oacinternal_add_dns_record(_api, id, name, type, content; ttl=ttl, prio=prio, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function add_dns_record(_api::DNSApi, response_stream::Channel, id::String, name::String, type::DnsRecordType, content::String; ttl=nothing, prio=nothing, _mediaType=nothing)
    _ctx = _oacinternal_add_dns_record(_api, id, name, type, content; ttl=ttl, prio=prio, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_delete_dns_domain_DNSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_delete_dns_domain(_api::DNSApi, id::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_delete_dns_domain_DNSApi, "/dns/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
...
@doc raw"""Permanently delete a DNS zone and every record it contains
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function delete_dns_domain(_api::DNSApi, id::String; _mediaType=nothing)
    _ctx = _oacinternal_delete_dns_domain(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_dns_domain(_api::DNSApi, response_stream::Channel, id::String; _mediaType=nothing)
    _ctx = _oacinternal_delete_dns_domain(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_delete_dns_record_DNSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_delete_dns_record(_api::DNSApi, domain_id::Int64, record_id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_delete_dns_record_DNSApi, "/dns/{domainId}/{recordId}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "domainId", domain_id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.path, "recordId", record_id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Permanently delete one DNS record from a zone — zone itself is preserved
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function delete_dns_record(_api::DNSApi, domain_id::Int64, record_id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_dns_record(_api, domain_id, record_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_dns_record(_api::DNSApi, response_stream::Channel, domain_id::Int64, record_id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_dns_record(_api, domain_id, record_id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_dns_domain_DNSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{DnsRecord},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_dns_domain(_api::DNSApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_dns_domain_DNSApi, "/dns/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
...
@doc raw"""List every DNS record in one zone with the IDs needed to edit or delete them
...
Return: `Vector{DnsRecord}`, `OpenAPI.Clients.ApiResponse`
"""
function get_dns_domain(_api::DNSApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_dns_domain(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_dns_domain(_api::DNSApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_dns_domain(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_dns_list_DNSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{DnsListItem},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_dns_list(_api::DNSApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_dns_list_DNSApi, "/dns", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List DNS zones hosted on the account with each zone's apex A-record IP
...
Return: `Vector{DnsListItem}`, `OpenAPI.Clients.ApiResponse`
"""
function get_dns_list(_api::DNSApi; _mediaType=nothing)
    _ctx = _oacinternal_get_dns_list(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_dns_list(_api::DNSApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_dns_list(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_dns_record_DNSApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_dns_record(_api::DNSApi, domain_id::Int64, record_id::Int64; name=nothing, type=nothing, content=nothing, ttl=nothing, prio=nothing, disabled=nothing, ordername=nothing, auth=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_dns_record_DNSApi, "/dns/{domainId}/{recordId}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "domainId", domain_id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.path, "recordId", record_id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.form, "name", name)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "type", type)  # type DnsRecordType
    OpenAPI.Clients.set_param(_ctx.form, "content", content)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "ttl", ttl)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "prio", prio)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "disabled", disabled)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "ordername", ordername)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "auth", auth)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["multipart/form-data", "application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Replace values on an existing DNS record (name, type, content, ttl, priority)
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_dns_record(_api::DNSApi, domain_id::Int64, record_id::Int64; name=nothing, type=nothing, content=nothing, ttl=nothing, prio=nothing, disabled=nothing, ordername=nothing, auth=nothing, _mediaType=nothing)
    _ctx = _oacinternal_update_dns_record(_api, domain_id, record_id; name=name, type=type, content=content, ttl=ttl, prio=prio, disabled=disabled, ordername=ordername, auth=auth, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_dns_record(_api::DNSApi, response_stream::Channel, domain_id::Int64, record_id::Int64; name=nothing, type=nothing, content=nothing, ttl=nothing, prio=nothing, disabled=nothing, ordername=nothing, auth=nothing, _mediaType=nothing)
    _ctx = _oacinternal_update_dns_record(_api, domain_id, record_id; name=name, type=type, content=content, ttl=ttl, prio=prio, disabled=disabled, ordername=ordername, auth=auth, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

export add_dns_domain
export add_dns_record
export delete_dns_domain
export delete_dns_record
export get_dns_domain
export get_dns_list
export update_dns_record
