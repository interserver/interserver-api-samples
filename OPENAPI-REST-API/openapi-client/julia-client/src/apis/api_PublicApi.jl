...
struct PublicApi <: OpenAPI.APIClientImpl
    client::OpenAPI.Clients.Client
end

"""
The default API base path for APIs in `PublicApi`.
This can be used to construct the `OpenAPI.Clients.Client` instance.
"""
basepath(::Type{ PublicApi }) = "https://my.interserver.net/apiv2"

const _returntypes_get_account_currencies_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{String},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_account_currencies(_api::PublicApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_account_currencies_PublicApi, "/account/currencies", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List enabled currency codes accepted for billing and preferences
...
"""
function get_account_currencies(_api::PublicApi; _mediaType=nothing)
    _ctx = _oacinternal_get_account_currencies(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_account_currencies(_api::PublicApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_account_currencies(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_account_locales_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Dict{String, GetAccountLocales200ResponseValue},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_account_locales(_api::PublicApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_account_locales_PublicApi, "/account/locales", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List supported UI locales with English and native display names
...
Return: `Dict{String, GetAccountLocales200ResponseValue}`, `OpenAPI.Clients.ApiResponse`
"""
function get_account_locales(_api::PublicApi; _mediaType=nothing)
    _ctx = _oacinternal_get_account_locales(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_account_locales(_api::PublicApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_account_locales(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_captcha_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => CaptchaResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_captcha(_api::PublicApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_captcha_PublicApi, "/captcha", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Fetch a base64 JPEG captcha challenge for human verification
...
Return: `CaptchaResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_captcha(_api::PublicApi; _mediaType=nothing)
    _ctx = _oacinternal_get_captcha(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_captcha(_api::PublicApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_captcha(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_countries_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Any,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_countries(_api::PublicApi; fetch_by=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_countries_PublicApi, "/account/countries", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.query, "fetch_by", fetch_by; style="form", is_explode=true)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List enabled countries keyed by ISO-2/ISO-3/numeric code
...
"""
function get_countries(_api::PublicApi; fetch_by=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_countries(_api; fetch_by=fetch_by, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_countries(_api::PublicApi, response_stream::Channel; fetch_by=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_countries(_api; fetch_by=fetch_by, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_info_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ServicesInfo,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_info(_api::PublicApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_info_PublicApi, "/info", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Discover available modules, service packages, categories, and types
...
Return: `ServicesInfo`, `OpenAPI.Clients.ApiResponse`
"""
function get_info(_api::PublicApi; _mediaType=nothing)
    _ctx = _oacinternal_get_info(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_info(_api::PublicApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_info(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_login_info_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => LoginInfo,
    Regex("^" * replace("403", "x"=>".") * "\$") => LoginErrorResponse,
)

function _oacinternal_get_login_info(_api::PublicApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_login_info_PublicApi, "/login", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Fetch logo, captcha, language, and stats for rendering a login page
...
Return: `LoginInfo`, `OpenAPI.Clients.ApiResponse`
"""
function get_login_info(_api::PublicApi; _mediaType=nothing)
    _ctx = _oacinternal_get_login_info(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_login_info(_api::PublicApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_login_info(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_m_p_servers_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => BuyItNowList,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_m_p_servers(_api::PublicApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_m_p_servers_PublicApi, "/buy_now_servers_list", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end
...
"""
function get_m_p_servers(_api::PublicApi; _mediaType=nothing)
    _ctx = _oacinternal_get_m_p_servers(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_m_p_servers(_api::PublicApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_m_p_servers(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_oauth_redirect_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => GetOauthRedirect200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_oauth_redirect(_api::PublicApi, provider::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_oauth_redirect_PublicApi, "/oauth", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.query, "provider", provider; style="form", is_explode=true)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Begin OAuth login flow — redirect user to provider for authentication
...
Return: `GetOauthRedirect200Response`, `OpenAPI.Clients.ApiResponse`
"""
function get_oauth_redirect(_api::PublicApi, provider::String; _mediaType=nothing)
    _ctx = _oacinternal_get_oauth_redirect(_api, provider; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_oauth_redirect(_api::PublicApi, response_stream::Channel, provider::String; _mediaType=nothing)
    _ctx = _oacinternal_get_oauth_redirect(_api, provider; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_timezones_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{String},
)

function _oacinternal_get_timezones(_api::PublicApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_timezones_PublicApi, "/account/timezones", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List all PHP timezone identifiers usable on accounts and services
...
Return: `Vector{String}`, `OpenAPI.Clients.ApiResponse`
"""
function get_timezones(_api::PublicApi; _mediaType=nothing)
    _ctx = _oacinternal_get_timezones(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_timezones(_api::PublicApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_timezones(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_patch_oauth_two_factor_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => PatchOauthTwoFactor200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_patch_oauth_two_factor(_api::PublicApi, patch_oauth_two_factor_request::PatchOauthTwoFactorRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PATCH", _returntypes_patch_oauth_two_factor_PublicApi, "/oauth", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], patch_oauth_two_factor_request)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
end

@doc raw"""Submit 2FA code to finish OAuth login when account has 2FA enabled
...
Params:
- `patch_oauth_two_factor_request`::`PatchOauthTwoFactorRequest` (required)

Return: `PatchOauthTwoFactor200Response`, `OpenAPI.Clients.ApiResponse`
"""
function patch_oauth_two_factor(_api::PublicApi, patch_oauth_two_factor_request::PatchOauthTwoFactorRequest; _mediaType=nothing)
    _ctx = _oacinternal_patch_oauth_two_factor(_api, patch_oauth_two_factor_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function patch_oauth_two_factor(_api::PublicApi, response_stream::Channel, patch_oauth_two_factor_request::PatchOauthTwoFactorRequest; _mediaType=nothing)
    _ctx = _oacinternal_patch_oauth_two_factor(_api, patch_oauth_two_factor_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_ping_server_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => String,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
    Regex("^" * replace("0", "x"=>".") * "\$") => Nothing,
)

function _oacinternal_ping_server(_api::PublicApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_ping_server_PublicApi, "/ping", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Liveness check — returns the JSON string \"pong\" to confirm API is up
...
"""
function ping_server(_api::PublicApi; _mediaType=nothing)
    _ctx = _oacinternal_ping_server(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function ping_server(_api::PublicApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_ping_server(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_oauth_callback_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => PostOauthCallback200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_oauth_callback(_api::PublicApi, provider::String; post_oauth_callback_request=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_oauth_callback_PublicApi, "/oauth", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], post_oauth_callback_request)
    OpenAPI.Clients.set_param(_ctx.query, "provider", provider; style="form", is_explode=true)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Complete OAuth login by linking provider to existing or new account
...
Params:
- `provider`::`String` (required)
- `post_oauth_callback_request`::`PostOauthCallbackRequest`

Return: `PostOauthCallback200Response`, `OpenAPI.Clients.ApiResponse`
"""
function post_oauth_callback(_api::PublicApi, provider::String; post_oauth_callback_request=nothing, _mediaType=nothing)
    _ctx = _oacinternal_post_oauth_callback(_api, provider; post_oauth_callback_request=post_oauth_callback_request, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_oauth_callback(_api::PublicApi, response_stream::Channel, provider::String; post_oauth_callback_request=nothing, _mediaType=nothing)
    _ctx = _oacinternal_post_oauth_callback(_api, provider; post_oauth_callback_request=post_oauth_callback_request, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_submit_login_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => LoginSuccessResponse,
    Regex("^" * replace("402", "x"=>".") * "\$") => LoginErrorResponse,
    Regex("^" * replace("0", "x"=>".") * "\$") => Nothing,
)

function _oacinternal_submit_login(_api::PublicApi, login::String, passwd::String; remember=nothing, g_recaptcha_response=nothing, tfa=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_submit_login_PublicApi, "/login", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.form, "login", login)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "passwd", passwd)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "remember", remember)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "g-recaptcha-response", g_recaptcha_response)  # type LoginSubmissionExampleGRecaptchaResponse
    OpenAPI.Clients.set_param(_ctx.form, "tfa", tfa)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["multipart/form-data", "application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Authenticate with email + password and return a session token
...
Return: `LoginSuccessResponse`, `OpenAPI.Clients.ApiResponse`
"""
function submit_login(_api::PublicApi, login::String, passwd::String; remember=nothing, g_recaptcha_response=nothing, tfa=nothing, _mediaType=nothing)
    _ctx = _oacinternal_submit_login(_api, login, passwd; remember=remember, g_recaptcha_response=g_recaptcha_response, tfa=tfa, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function submit_login(_api::PublicApi, response_stream::Channel, login::String, passwd::String; remember=nothing, g_recaptcha_response=nothing, tfa=nothing, _mediaType=nothing)
    _ctx = _oacinternal_submit_login(_api, login, passwd; remember=remember, g_recaptcha_response=g_recaptcha_response, tfa=tfa, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_submit_signup_PublicApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("402", "x"=>".") * "\$") => LoginErrorResponse,
)

function _oacinternal_submit_signup(_api::PublicApi; login_submission_example=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_submit_signup_PublicApi, "/signup", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], login_submission_example)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Create a new customer account (email + password + captcha + ToS)
...
Params:
- `login_submission_example`::`LoginSubmissionExample`

Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function submit_signup(_api::PublicApi; login_submission_example=nothing, _mediaType=nothing)
    _ctx = _oacinternal_submit_signup(_api; login_submission_example=login_submission_example, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function submit_signup(_api::PublicApi, response_stream::Channel; login_submission_example=nothing, _mediaType=nothing)
    _ctx = _oacinternal_submit_signup(_api; login_submission_example=login_submission_example, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

export get_account_currencies
export get_account_locales
export get_captcha
export get_countries
export get_info
export get_login_info
export get_m_p_servers
export get_oauth_redirect
export get_timezones
export patch_oauth_two_factor
export ping_server
export post_oauth_callback
export submit_login
export submit_signup
