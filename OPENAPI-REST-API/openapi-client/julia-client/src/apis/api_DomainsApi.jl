...
struct DomainsApi <: OpenAPI.APIClientImpl
    client::OpenAPI.Clients.Client
end

"""
The default API base path for APIs in `DomainsApi`.
This can be used to construct the `OpenAPI.Clients.Client` instance.
"""
basepath(::Type{ DomainsApi }) = "https://my.interserver.net/apiv2"

const _returntypes_add_domain_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ServiceOrderPostResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_add_domain(_api::DomainsApi, domain_order_request::DomainOrderRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_add_domain_DomainsApi, "/domains/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], domain_order_request)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Place a new domain registration or transfer order, generate billing invoice
...
Params:
- `domain_order_request`::`DomainOrderRequest` (required)

Return: `ServiceOrderPostResponse`, `OpenAPI.Clients.ApiResponse`
"""
function add_domain(_api::DomainsApi, domain_order_request::DomainOrderRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_domain(_api, domain_order_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function add_domain(_api::DomainsApi, response_stream::Channel, domain_order_request::DomainOrderRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_domain(_api, domain_order_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_add_domain_dnssec_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_add_domain_dnssec(_api::DomainsApi, id::Int64, domain_dnssec_request::DomainDnssecRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_add_domain_dnssec_DomainsApi, "/domains/{id}/dnssec", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], domain_dnssec_request)
...
@doc raw"""Register DNSSEC DS records on the domain at OpenSRS
...
Params:
- `id`::`Int64` (required)
- `domain_dnssec_request`::`DomainDnssecRequest` (required)

Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function add_domain_dnssec(_api::DomainsApi, id::Int64, domain_dnssec_request::DomainDnssecRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_domain_dnssec(_api, id, domain_dnssec_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function add_domain_dnssec(_api::DomainsApi, response_stream::Channel, id::Int64, domain_dnssec_request::DomainDnssecRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_domain_dnssec(_api, id, domain_dnssec_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_add_domain_nameserver_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => TextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_add_domain_nameserver(_api::DomainsApi, id::Int64, domain_nameserver_post_request::DomainNameserverPostRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_add_domain_nameserver_DomainsApi, "/domains/{id}/nameservers", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], domain_nameserver_post_request)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Register a new nameserver host with glue IP at the registry (registered nameserver)
...
Params:
- `id`::`Int64` (required)
- `domain_nameserver_post_request`::`DomainNameserverPostRequest` (required)

Return: `TextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function add_domain_nameserver(_api::DomainsApi, id::Int64, domain_nameserver_post_request::DomainNameserverPostRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_domain_nameserver(_api, id, domain_nameserver_post_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function add_domain_nameserver(_api::DomainsApi, response_stream::Channel, id::Int64, domain_nameserver_post_request::DomainNameserverPostRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_domain_nameserver(_api, id, domain_nameserver_post_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_cancel_domain_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => CancelDomain200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_cancel_domain(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_cancel_domain_DomainsApi, "/domains/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
...
@doc raw"""Cancel a domain order in the billing system to stop auto-renewals
...
Return: `CancelDomain200Response`, `OpenAPI.Clients.ApiResponse`
"""
function cancel_domain(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_cancel_domain(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function cancel_domain(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_cancel_domain(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_delete_domain_dnssec_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_delete_domain_dnssec(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_delete_domain_dnssec_DomainsApi, "/domains/{id}/dnssec", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function delete_domain_dnssec(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_domain_dnssec(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_domain_dnssec(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_domain_dnssec(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_delete_domain_nameserver_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => TextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_delete_domain_nameserver(_api::DomainsApi, id::Int64, index::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_delete_domain_nameserver_DomainsApi, "/domains/{id}/nameservers", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_param(_ctx.query, "index", index; style="form", is_explode=true)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Remove one registered nameserver glue record from the domain
...
Return: `TextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function delete_domain_nameserver(_api::DomainsApi, id::Int64, index::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_domain_nameserver(_api, id, index; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_domain_nameserver(_api::DomainsApi, response_stream::Channel, id::Int64, index::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_domain_nameserver(_api, id, index; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_contact_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => DomainContactDetails,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domain_contact(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_contact_DomainsApi, "/domains/{id}/contact", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read the current registrant/admin/tech/billing contact field set for a domain
...
Return: `DomainContactDetails`, `OpenAPI.Clients.ApiResponse`
"""
function get_domain_contact(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_contact(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_contact(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_contact(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_dnssec_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => DomainDnssecRecords,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domain_dnssec(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_dnssec_DomainsApi, "/domains/{id}/dnssec", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read the DNSSEC DS record set currently registered with the registrar
...
Return: `DomainDnssecRecords`, `OpenAPI.Clients.ApiResponse`
"""
function get_domain_dnssec(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_dnssec(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_dnssec(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_dnssec(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_info_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Domain,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domain_info(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_info_DomainsApi, "/domains/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read full billing, registrar, and service detail for one domain
...
Return: `Domain`, `OpenAPI.Clients.ApiResponse`
"""
function get_domain_info(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_info(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_invoices_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => ChargeInvoiceRows,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domain_invoices(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_invoices_DomainsApi, "/domains/{id}/invoices", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""List all billing invoices scoped to one domain order
...
"""
function get_domain_invoices(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_invoices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_invoices(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_invoices(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_lookup_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => DomainLookupResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
    Regex("^" * replace("422", "x"=>".") * "\$") => TextResponse,
)

function _oacinternal_get_domain_lookup(_api::DomainsApi, name::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_lookup_DomainsApi, "/domains/lookup/{name}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
...
@doc raw"""Check availability, premium status, and pricing for a specific domain
...
Return: `DomainLookupResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_domain_lookup(_api::DomainsApi, name::String; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_lookup(_api, name; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_lookup(_api::DomainsApi, response_stream::Channel, name::String; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_lookup(_api, name; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_nameservers_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => DomainNameserverGetResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domain_nameservers(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_nameservers_DomainsApi, "/domains/{id}/nameservers", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""List registered nameserver hosts and glue IP addresses for a domain
...
Return: `DomainNameserverGetResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_domain_nameservers(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_nameservers(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_nameservers(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_nameservers(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_renewal_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domain_renewal(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_renewal_DomainsApi, "/domains/{id}/renew", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read renewal pricing, expiry, and whether a renewal invoice already exists
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_domain_renewal(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_renewal(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_renewal(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_renewal(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_search_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => DomainSearchResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
    Regex("^" * replace("404", "x"=>".") * "\$") => TextResponse,
)

function _oacinternal_get_domain_search(_api::DomainsApi, name::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_search_DomainsApi, "/domains/search/{name}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "name", name)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Get registrar-suggested domain alternatives and bulk availability for a search term
...
Return: `DomainSearchResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_domain_search(_api::DomainsApi, name::String; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_search(_api, name; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_search(_api::DomainsApi, response_stream::Channel, name::String; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_search(_api, name; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_transfer_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domain_transfer(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_transfer_DomainsApi, "/domains/{id}/transfer", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read OpenSRS transfer status for an in-progress domain transfer order
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_domain_transfer(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_transfer(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_transfer(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_transfer(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domain_whois_privacy_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domain_whois_privacy(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domain_whois_privacy_DomainsApi, "/domains/{id}/whois", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read Whois privacy availability, current state, and add-on pricing for a domain
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_domain_whois_privacy(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_whois_privacy(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domain_whois_privacy(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domain_whois_privacy(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domains_list_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{DomainRow},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domains_list(_api::DomainsApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domains_list_DomainsApi, "/domains", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List every domain registration on the account with billing and registration metadata
...
Return: `Vector{DomainRow}`, `OpenAPI.Clients.ApiResponse`
"""
function get_domains_list(_api::DomainsApi; _mediaType=nothing)
    _ctx = _oacinternal_get_domains_list(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domains_list(_api::DomainsApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_domains_list(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_domains_welcome_email_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_domains_welcome_email(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_domains_welcome_email_DomainsApi, "/domains/{id}/welcome_email", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Resend the domain welcome email with registration details and management instructions
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_domains_welcome_email(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domains_welcome_email(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_domains_welcome_email(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_domains_welcome_email(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_new_domain_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => DomainOrder,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_new_domain(_api::DomainsApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_new_domain_DomainsApi, "/domains/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Read the buyable domain TLD service catalog and Whois privacy pricing
...
Return: `DomainOrder`, `OpenAPI.Clients.ApiResponse`
"""
function get_new_domain(_api::DomainsApi; _mediaType=nothing)
    _ctx = _oacinternal_get_new_domain(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_new_domain(_api::DomainsApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_new_domain(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_patch_domains_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_patch_domains(_api::DomainsApi, domain_order_request::DomainOrderRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PATCH", _returntypes_patch_domains_DomainsApi, "/domains/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], domain_order_request)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Validate posted domain-order field values before committing — dry run
...
"""
function patch_domains(_api::DomainsApi, domain_order_request::DomainOrderRequest; _mediaType=nothing)
    _ctx = _oacinternal_patch_domains(_api, domain_order_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function patch_domains(_api::DomainsApi, response_stream::Channel, domain_order_request::DomainOrderRequest; _mediaType=nothing)
    _ctx = _oacinternal_patch_domains(_api, domain_order_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_domain_renewal_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_domain_renewal(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_domain_renewal_DomainsApi, "/domains/{id}/renew", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Submit a domain renewal request and generate the renewal invoice
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_domain_renewal(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_domain_renewal(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_domain_renewal(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_domain_renewal(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_domain_search_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_domain_search(_api::DomainsApi, name::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_domain_search_DomainsApi, "/domains/search/{name}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "name", name)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Get the full order form data for a hostname in one round-trip (search → order preview)
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function post_domain_search(_api::DomainsApi, name::String; _mediaType=nothing)
    _ctx = _oacinternal_post_domain_search(_api, name; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_domain_search(_api::DomainsApi, response_stream::Channel, name::String; _mediaType=nothing)
    _ctx = _oacinternal_post_domain_search(_api, name; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_domain_transfer_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_domain_transfer(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_domain_transfer_DomainsApi, "/domains/{id}/transfer", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Re-poll OpenSRS transfer status for a domain order via POST
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_domain_transfer(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_domain_transfer(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_domain_transfer(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_post_domain_transfer(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_put_domains_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_put_domains(_api::DomainsApi, domain_order_request::DomainOrderRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PUT", _returntypes_put_domains_DomainsApi, "/domains/order", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], domain_order_request)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Preview per-TLD field requirements for a domain order — no commit
...
Return: `Nothing`, `OpenAPI.Clients.ApiResponse`
"""
function put_domains(_api::DomainsApi, domain_order_request::DomainOrderRequest; _mediaType=nothing)
    _ctx = _oacinternal_put_domains(_api, domain_order_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function put_domains(_api::DomainsApi, response_stream::Channel, domain_order_request::DomainOrderRequest; _mediaType=nothing)
    _ctx = _oacinternal_put_domains(_api, domain_order_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_domain_contact_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_domain_contact(_api::DomainsApi, id::Int64, domain_contact_details::DomainContactDetails; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_domain_contact_DomainsApi, "/domains/{id}/contact", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], domain_contact_details)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Update registrant/admin contact details and push them to OpenSRS
...
Params:
- `id`::`Int64` (required)
- `domain_contact_details`::`DomainContactDetails` (required)

Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_domain_contact(_api::DomainsApi, id::Int64, domain_contact_details::DomainContactDetails; _mediaType=nothing)
    _ctx = _oacinternal_update_domain_contact(_api, id, domain_contact_details; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_domain_contact(_api::DomainsApi, response_stream::Channel, id::Int64, domain_contact_details::DomainContactDetails; _mediaType=nothing)
    _ctx = _oacinternal_update_domain_contact(_api, id, domain_contact_details; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_domain_info_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_domain_info(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_domain_info_DomainsApi, "/domains/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""POST mutation hook for the domain detail page (use dedicated ops where possible)
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_domain_info(_api::DomainsApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_update_domain_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_domain_info(_api::DomainsApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_update_domain_info(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_domain_nameservers_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => TextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_domain_nameservers(_api::DomainsApi, id::Int64, domain_nameserver_put_request::DomainNameserverPutRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PUT", _returntypes_update_domain_nameservers_DomainsApi, "/domains/{id}/nameservers", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], domain_nameserver_put_request)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Replace the full authoritative-nameserver delegation list at the registrar
...
Params:
- `id`::`Int64` (required)
- `domain_nameserver_put_request`::`DomainNameserverPutRequest` (required)

Return: `TextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_domain_nameservers(_api::DomainsApi, id::Int64, domain_nameserver_put_request::DomainNameserverPutRequest; _mediaType=nothing)
    _ctx = _oacinternal_update_domain_nameservers(_api, id, domain_nameserver_put_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_domain_nameservers(_api::DomainsApi, response_stream::Channel, id::Int64, domain_nameserver_put_request::DomainNameserverPutRequest; _mediaType=nothing)
    _ctx = _oacinternal_update_domain_nameservers(_api, id, domain_nameserver_put_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_domain_whois_privacy_DomainsApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_domain_whois_privacy(_api::DomainsApi, id::Int64, domain_whois_privacy_request::DomainWhoisPrivacyRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_domain_whois_privacy_DomainsApi, "/domains/{id}/whois", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], domain_whois_privacy_request)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Order, enable, or cancel the Whois privacy add-on for a domain
...
Params:
- `id`::`Int64` (required)
- `domain_whois_privacy_request`::`DomainWhoisPrivacyRequest` (required)

Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_domain_whois_privacy(_api::DomainsApi, id::Int64, domain_whois_privacy_request::DomainWhoisPrivacyRequest; _mediaType=nothing)
    _ctx = _oacinternal_update_domain_whois_privacy(_api, id, domain_whois_privacy_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_domain_whois_privacy(_api::DomainsApi, response_stream::Channel, id::Int64, domain_whois_privacy_request::DomainWhoisPrivacyRequest; _mediaType=nothing)
    _ctx = _oacinternal_update_domain_whois_privacy(_api, id, domain_whois_privacy_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

export add_domain
export add_domain_dnssec
export add_domain_nameserver
export cancel_domain
export delete_domain_dnssec
export delete_domain_nameserver
export get_domain_contact
export get_domain_dnssec
export get_domain_info
export get_domain_invoices
export get_domain_lookup
export get_domain_nameservers
export get_domain_renewal
export get_domain_search
export get_domain_transfer
export get_domain_whois_privacy
export get_domains_list
export get_domains_welcome_email
export get_new_domain
export patch_domains
export post_domain_renewal
export post_domain_search
export post_domain_transfer
export put_domains
export update_domain_contact
export update_domain_info
export update_domain_nameservers
export update_domain_whois_privacy
