...
"""
basepath(::Type{ BillingApi }) = "https://my.interserver.net/apiv2"

const _returntypes_add_billing_credit_card_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_add_billing_credit_card(_api::BillingApi, billing_add_cc_request::BillingAddCcRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_add_billing_credit_card_BillingApi, "/billing/creditcards", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], billing_add_cc_request)
...
@doc raw"""Store a credit card on the account — may return a verification flow
...
Params:
- `billing_add_cc_request`::`BillingAddCcRequest` (required)

Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function add_billing_credit_card(_api::BillingApi, billing_add_cc_request::BillingAddCcRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_billing_credit_card(_api, billing_add_cc_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function add_billing_credit_card(_api::BillingApi, response_stream::Channel, billing_add_cc_request::BillingAddCcRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_billing_credit_card(_api, billing_add_cc_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_add_billing_prepay_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_add_billing_prepay(_api::BillingApi, billing_prepay_request::BillingPrepayRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_add_billing_prepay_BillingApi, "/billing/prepays", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], billing_prepay_request)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
end

@doc raw"""Create a prepay deposit and return an invoice id to fund it
...
Params:
- `billing_prepay_request`::`BillingPrepayRequest` (required)

Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function add_billing_prepay(_api::BillingApi, billing_prepay_request::BillingPrepayRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_billing_prepay(_api, billing_prepay_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function add_billing_prepay(_api::BillingApi, response_stream::Channel, billing_prepay_request::BillingPrepayRequest; _mediaType=nothing)
    _ctx = _oacinternal_add_billing_prepay(_api, billing_prepay_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_delete_billing_credit_card_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_delete_billing_credit_card(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_delete_billing_credit_card_BillingApi, "/billing/creditcards/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
...
@doc raw"""Remove a stored credit card from the account
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function delete_billing_credit_card(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_billing_credit_card(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_billing_credit_card(_api::BillingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_billing_credit_card(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_delete_billing_invoice_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_delete_billing_invoice(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_delete_billing_invoice_BillingApi, "/billing/invoices/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Cancel a pending unpaid invoice — and its pending service or repeat invoice
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function delete_billing_invoice(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_billing_invoice(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_billing_invoice(_api::BillingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_billing_invoice(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_delete_billing_prepay_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_delete_billing_prepay(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "DELETE", _returntypes_delete_billing_prepay_BillingApi, "/billing/prepays/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Delete an unfunded prepay or strip its unpaid funding invoices
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function delete_billing_prepay(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_billing_prepay(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function delete_billing_prepay(_api::BillingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_delete_billing_prepay(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_affiliate_banners_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{AffiliateBannerRow},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_affiliate_banners(_api::BillingApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_affiliate_banners_BillingApi, "/affiliate/banners", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List affiliate banner image assets with filename and dimensions
...
Return: `Vector{AffiliateBannerRow}`, `OpenAPI.Clients.ApiResponse`
"""
function get_affiliate_banners(_api::BillingApi; _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_banners(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_affiliate_banners(_api::BillingApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_banners(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_affiliate_download_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Nothing,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_affiliate_download(_api::BillingApi; st=nothing, ex=nothing, year=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_affiliate_download_BillingApi, "/affiliate/download", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.query, "st", st; style="form", is_explode=true)  # type String
    OpenAPI.Clients.set_param(_ctx.query, "ex", ex; style="form", is_explode=true)  # type String
...
@doc raw"""Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
...
"""
function get_affiliate_download(_api::BillingApi; st=nothing, ex=nothing, year=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_download(_api; st=st, ex=ex, year=year, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_affiliate_download(_api::BillingApi, response_stream::Channel; st=nothing, ex=nothing, year=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_download(_api; st=st, ex=ex, year=year, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_affiliate_rich_report_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => TextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_affiliate_rich_report(_api::BillingApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_affiliate_rich_report_BillingApi, "/affiliate/rich_report", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Read a combined affiliate performance summary (HTML payload)
...
"""
function get_affiliate_rich_report(_api::BillingApi; _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_rich_report(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_affiliate_rich_report(_api::BillingApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_rich_report(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_affiliate_sales_graph_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => StatusMonthlyBreakdown,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_affiliate_sales_graph(_api::BillingApi; days=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_affiliate_sales_graph_BillingApi, "/affiliate/sales_graph", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.query, "days", days; style="form", is_explode=true)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Read aggregated affiliate sales time-series (monthly buckets) for chart rendering
...
Return: `StatusMonthlyBreakdown`, `OpenAPI.Clients.ApiResponse`
"""
function get_affiliate_sales_graph(_api::BillingApi; days=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_sales_graph(_api; days=days, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_affiliate_sales_graph(_api::BillingApi, response_stream::Channel; days=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_sales_graph(_api; days=days, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_affiliate_signups_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => GetAffiliateSignups200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_affiliate_signups(_api::BillingApi; st=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_affiliate_signups_BillingApi, "/affiliate/signups", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.query, "st", st; style="form", is_explode=true)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read affiliate signup stats and per-customer conversion data
...
Return: `GetAffiliateSignups200Response`, `OpenAPI.Clients.ApiResponse`
"""
function get_affiliate_signups(_api::BillingApi; st=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_signups(_api; st=st, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_affiliate_signups(_api::BillingApi, response_stream::Channel; st=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_signups(_api; st=st, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_affiliate_traffic_graph_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => MonthlyCounts,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_affiliate_traffic_graph(_api::BillingApi; days=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_affiliate_traffic_graph_BillingApi, "/affiliate/traffic_graph", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.query, "days", days; style="form", is_explode=true)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read aggregated affiliate referral click/visit time-series for chart rendering
...
Return: `MonthlyCounts`, `OpenAPI.Clients.ApiResponse`
"""
function get_affiliate_traffic_graph(_api::BillingApi; days=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_traffic_graph(_api; days=days, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_affiliate_traffic_graph(_api::BillingApi, response_stream::Channel; days=nothing, _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_traffic_graph(_api; days=days, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_affiliate_web_traffic_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Vector{AffiliateTrafficRow},
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_affiliate_web_traffic(_api::BillingApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_affiliate_web_traffic_BillingApi, "/affiliate/web_traffic", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List the 20 most recent affiliate referral visits with IP, referrer, timestamp
...
Return: `Vector{AffiliateTrafficRow}`, `OpenAPI.Clients.ApiResponse`
"""
function get_affiliate_web_traffic(_api::BillingApi; _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_web_traffic(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_affiliate_web_traffic(_api::BillingApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_affiliate_web_traffic(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_billing_cart_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Any,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_billing_cart(_api::BillingApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_billing_cart_BillingApi, "/billing/cart", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Read the current shopping cart contents, totals, and available payment methods
...
"""
function get_billing_cart(_api::BillingApi; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_cart(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_billing_cart(_api::BillingApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_cart(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_billing_credit_card_verify_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_billing_credit_card_verify(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_billing_credit_card_verify_BillingApi, "/billing/creditcards/{id}/verify", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Probe whether a stored card still needs micro-charge verification
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function get_billing_credit_card_verify(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_credit_card_verify(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_billing_credit_card_verify(_api::BillingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_credit_card_verify(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_billing_invoice_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => BillingInvoiceDetail,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_billing_invoice(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_billing_invoice_BillingApi, "/billing/invoices/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Read full invoice detail — line items, totals, paid status, customer info
...
Return: `BillingInvoiceDetail`, `OpenAPI.Clients.ApiResponse`
"""
function get_billing_invoice(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_invoice(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_billing_invoice(_api::BillingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_invoice(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_billing_invoices_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => BillingInvoiceList,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_billing_invoices(_api::BillingApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_billing_invoices_BillingApi, "/billing/invoices", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List every invoice on the account with summary totals and paid/unpaid status
...
Return: `BillingInvoiceList`, `OpenAPI.Clients.ApiResponse`
"""
function get_billing_invoices(_api::BillingApi; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_invoices(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_billing_invoices(_api::BillingApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_invoices(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_get_billing_pre_pays_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => Any,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_get_billing_pre_pays(_api::BillingApi; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_get_billing_pre_pays_BillingApi, "/billing/prepays", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""List prepay deposits on the account — remaining balance and auto-use flags
...
Return: `Any`, `OpenAPI.Clients.ApiResponse`
"""
function get_billing_pre_pays(_api::BillingApi; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_pre_pays(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function get_billing_pre_pays(_api::BillingApi, response_stream::Channel; _mediaType=nothing)
    _ctx = _oacinternal_get_billing_pre_pays(_api; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_initiate_payment_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => InitiatePayment200Response,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_initiate_payment(_api::BillingApi, method::String, invoices::String; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "GET", _returntypes_initiate_payment_BillingApi, "/billing/pay/{method}/{invoices}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "method", method)  # type String
    OpenAPI.Clients.set_param(_ctx.path, "invoices", invoices)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
end

@doc raw"""Pay invoices through the chosen gateway — returns the next-step action
...
Return: `InitiatePayment200Response`, `OpenAPI.Clients.ApiResponse`
"""
function initiate_payment(_api::BillingApi, method::String, invoices::String; _mediaType=nothing)
    _ctx = _oacinternal_initiate_payment(_api, method, invoices; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function initiate_payment(_api::BillingApi, response_stream::Channel, method::String, invoices::String; _mediaType=nothing)
    _ctx = _oacinternal_initiate_payment(_api, method, invoices; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_patch_billing_credit_card_verify_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_patch_billing_credit_card_verify(_api::BillingApi, id::Int64, patch_billing_credit_card_verify_request::PatchBillingCreditCardVerifyRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "PATCH", _returntypes_patch_billing_credit_card_verify_BillingApi, "/billing/creditcards/{id}/verify", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], patch_billing_credit_card_verify_request)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Place two micro-charges on the card to start CVV verification (step 1 of 2)
...
Params:
- `id`::`Int64` (required)
- `patch_billing_credit_card_verify_request`::`PatchBillingCreditCardVerifyRequest` (required)

Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function patch_billing_credit_card_verify(_api::BillingApi, id::Int64, patch_billing_credit_card_verify_request::PatchBillingCreditCardVerifyRequest; _mediaType=nothing)
    _ctx = _oacinternal_patch_billing_credit_card_verify(_api, id, patch_billing_credit_card_verify_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function patch_billing_credit_card_verify(_api::BillingApi, response_stream::Channel, id::Int64, patch_billing_credit_card_verify_request::PatchBillingCreditCardVerifyRequest; _mediaType=nothing)
    _ctx = _oacinternal_patch_billing_credit_card_verify(_api, id, patch_billing_credit_card_verify_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_post_billing_credit_card_verify_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_post_billing_credit_card_verify(_api::BillingApi, id::Int64, billing_verify_cc_request::BillingVerifyCcRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_post_billing_credit_card_verify_BillingApi, "/billing/creditcards/{id}/verify", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], billing_verify_cc_request)
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
...
@doc raw"""Submit two micro-charge amounts to finalize card verification (step 2 of 2)
...
Params:
- `id`::`Int64` (required)
- `billing_verify_cc_request`::`BillingVerifyCcRequest` (required)

Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function post_billing_credit_card_verify(_api::BillingApi, id::Int64, billing_verify_cc_request::BillingVerifyCcRequest; _mediaType=nothing)
    _ctx = _oacinternal_post_billing_credit_card_verify(_api, id, billing_verify_cc_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function post_billing_credit_card_verify(_api::BillingApi, response_stream::Channel, id::Int64, billing_verify_cc_request::BillingVerifyCcRequest; _mediaType=nothing)
    _ctx = _oacinternal_post_billing_credit_card_verify(_api, id, billing_verify_cc_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_affiliate_dock_setup_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => TextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_affiliate_dock_setup(_api::BillingApi; affiliate_dock_title=nothing, affiliate_dock_description=nothing, referrer_coupon=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_affiliate_dock_setup_BillingApi, "/affiliate/dock_setup", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.form, "affiliate_dock_title", affiliate_dock_title)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "affiliate_dock_description", affiliate_dock_description)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "referrer_coupon", referrer_coupon)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["multipart/form-data", "application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Configure the affiliate landing dock title, description, and referrer coupon
...
Return: `TextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_affiliate_dock_setup(_api::BillingApi; affiliate_dock_title=nothing, affiliate_dock_description=nothing, referrer_coupon=nothing, _mediaType=nothing)
    _ctx = _oacinternal_update_affiliate_dock_setup(_api; affiliate_dock_title=affiliate_dock_title, affiliate_dock_description=affiliate_dock_description, referrer_coupon=referrer_coupon, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_affiliate_dock_setup(_api::BillingApi, response_stream::Channel; affiliate_dock_title=nothing, affiliate_dock_description=nothing, referrer_coupon=nothing, _mediaType=nothing)
    _ctx = _oacinternal_update_affiliate_dock_setup(_api; affiliate_dock_title=affiliate_dock_title, affiliate_dock_description=affiliate_dock_description, referrer_coupon=referrer_coupon, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_affiliate_payment_setup_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => TextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_affiliate_payment_setup(_api::BillingApi; affiliate_paypal=nothing, affiliate_payment_method=nothing, _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_affiliate_payment_setup_BillingApi, "/affiliate/payment_setup", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.form, "affiliate_paypal", affiliate_paypal)  # type String
    OpenAPI.Clients.set_param(_ctx.form, "affiliate_payment_method", affiliate_payment_method)  # type String
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["multipart/form-data", "application/json", ] : [_mediaType])
    return _ctx
end

@doc raw"""Configure how affiliate commissions get paid out (PayPal or internal prepay)
...
Return: `TextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_affiliate_payment_setup(_api::BillingApi; affiliate_paypal=nothing, affiliate_payment_method=nothing, _mediaType=nothing)
    _ctx = _oacinternal_update_affiliate_payment_setup(_api; affiliate_paypal=affiliate_paypal, affiliate_payment_method=affiliate_payment_method, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_affiliate_payment_setup(_api::BillingApi, response_stream::Channel; affiliate_paypal=nothing, affiliate_payment_method=nothing, _mediaType=nothing)
    _ctx = _oacinternal_update_affiliate_payment_setup(_api; affiliate_paypal=affiliate_paypal, affiliate_payment_method=affiliate_payment_method, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_billing_credit_card_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_billing_credit_card(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_billing_credit_card_BillingApi, "/billing/creditcards/{id}", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ])
    OpenAPI.Clients.set_param(_ctx.path, "id", id)  # type Int64
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? [] : [_mediaType])
    return _ctx
...
@doc raw"""Refresh stored card expiration and re-trigger MaxMind fraud scoring
...
Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_billing_credit_card(_api::BillingApi, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_update_billing_credit_card(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_billing_credit_card(_api::BillingApi, response_stream::Channel, id::Int64; _mediaType=nothing)
    _ctx = _oacinternal_update_billing_credit_card(_api, id; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

const _returntypes_update_billing_payment_method_BillingApi = Dict{Regex,Type}(
    Regex("^" * replace("200", "x"=>".") * "\$") => SuccessTextResponse,
    Regex("^" * replace("401", "x"=>".") * "\$") => GetAccountInfo401Response,
)

function _oacinternal_update_billing_payment_method(_api::BillingApi, billing_payment_method_request::BillingPaymentMethodRequest; _mediaType=nothing)
    _ctx = OpenAPI.Clients.Ctx(_api.client, "POST", _returntypes_update_billing_payment_method_BillingApi, "/billing/payment_method", ["sessionIdCookieAuth", "apiKeyAuth", "sessionIdHeaderAuth", ], billing_payment_method_request)
    OpenAPI.Clients.set_header_accept(_ctx, ["application/json", ])
    OpenAPI.Clients.set_header_content_type(_ctx, (_mediaType === nothing) ? ["application/json", "multipart/form-data", ] : [_mediaType])
    return _ctx
end

@doc raw"""Set the account's default payment method for recurring/auto charges
...
Params:
- `billing_payment_method_request`::`BillingPaymentMethodRequest` (required)

Return: `SuccessTextResponse`, `OpenAPI.Clients.ApiResponse`
"""
function update_billing_payment_method(_api::BillingApi, billing_payment_method_request::BillingPaymentMethodRequest; _mediaType=nothing)
    _ctx = _oacinternal_update_billing_payment_method(_api, billing_payment_method_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function update_billing_payment_method(_api::BillingApi, response_stream::Channel, billing_payment_method_request::BillingPaymentMethodRequest; _mediaType=nothing)
    _ctx = _oacinternal_update_billing_payment_method(_api, billing_payment_method_request; _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end

export add_billing_credit_card
export add_billing_prepay
export delete_billing_credit_card
export delete_billing_invoice
export delete_billing_prepay
export get_affiliate_banners
export get_affiliate_download
export get_affiliate_rich_report
export get_affiliate_sales_graph
export get_affiliate_signups
export get_affiliate_traffic_graph
export get_affiliate_web_traffic
export get_billing_cart
export get_billing_credit_card_verify
export get_billing_invoice
export get_billing_invoices
export get_billing_pre_pays
export initiate_payment
export patch_billing_credit_card_verify
export post_billing_credit_card_verify
export update_affiliate_dock_setup
export update_affiliate_payment_setup
export update_billing_credit_card
export update_billing_payment_method
