...
export class ServersService extends BaseService {
     ...
     */
    public addServer(serverOrderPostRequest: ServerOrderPostRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<AddServer200Response>;
    public addServer(serverOrderPostRequest: ServerOrderPostRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<AddServer200Response>>;
    public addServer(serverOrderPostRequest: ServerOrderPostRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<AddServer200Response>>;
    public addServer(serverOrderPostRequest: ServerOrderPostRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
     ...
     * @endpoint get /servers/bulk/ipmi_power
     ...
     * @param options additional options
     */
    public serverBulkIpmiPowerGet(ids: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<ServerBulkIpmiPowerResponse>;
    public serverBulkIpmiPowerGet(ids: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<ServerBulkIpmiPowerResponse>>;
    public serverBulkIpmiPowerGet(ids: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<ServerBulkIpmiPowerResponse>>;
    public serverBulkIpmiPowerGet(ids: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        ...
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ServerBulkIpmiPowerResponse>('get', `${basePath}${localVarPath}`,
            {
