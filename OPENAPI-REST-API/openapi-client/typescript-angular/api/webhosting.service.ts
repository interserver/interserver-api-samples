...
export class WebhostingService extends BaseService {
     ...
     */
    public addWebsite(websiteOrderPostRequest: WebsiteOrderPostRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<ServiceOrderPostResponse>;
    public addWebsite(websiteOrderPostRequest: WebsiteOrderPostRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<ServiceOrderPostResponse>>;
    public addWebsite(websiteOrderPostRequest: WebsiteOrderPostRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<ServiceOrderPostResponse>>;
    public addWebsite(websiteOrderPostRequest: WebsiteOrderPostRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
     ...
     * @param options additional options
     */
    public putWebsites(websiteOrderPutRequest: WebsiteOrderPutRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<any>;
    public putWebsites(websiteOrderPutRequest: WebsiteOrderPutRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<any>>;
    public putWebsites(websiteOrderPutRequest: WebsiteOrderPutRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<any>>;
    public putWebsites(websiteOrderPutRequest: WebsiteOrderPutRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
