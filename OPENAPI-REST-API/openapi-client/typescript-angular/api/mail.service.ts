...
export class MailService extends BaseService {
     ...
     */
    public addMail(mailOrderRequest: MailOrderRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<ServiceOrderPostResponse>;
    public addMail(mailOrderRequest: MailOrderRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<ServiceOrderPostResponse>>;
    public addMail(mailOrderRequest: MailOrderRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<ServiceOrderPostResponse>>;
    public addMail(mailOrderRequest: MailOrderRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
     ...
     * @param options additional options
     */
    public deleteMailAlert(id: number, deleteMailAlertRequest: DeleteMailAlertRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<SuccessTextResponse>;
    public deleteMailAlert(id: number, deleteMailAlertRequest: DeleteMailAlertRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<SuccessTextResponse>>;
    public deleteMailAlert(id: number, deleteMailAlertRequest: DeleteMailAlertRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<SuccessTextResponse>>;
    public deleteMailAlert(id: number, deleteMailAlertRequest: DeleteMailAlertRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        if (id === null || id === undefined) {
     ...
     * @param options additional options
     */
    public putMail(mailOrderRequest: MailOrderRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<any>;
    public putMail(mailOrderRequest: MailOrderRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<any>>;
    public putMail(mailOrderRequest: MailOrderRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<any>>;
    public putMail(mailOrderRequest: MailOrderRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        if (mailOrderRequest === null || mailOrderRequest === undefined) {
     ...
     * @endpoint put /mail/{id}/rules/{rule}
     * @param id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.
     ...
     * @param options additional options
     */
    public updateRule(id: number, rule: string, denyRuleNew: DenyRuleNew, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<GenericResponse>;
    public updateRule(id: number, rule: string, denyRuleNew: DenyRuleNew, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<GenericResponse>>;
    public updateRule(id: number, rule: string, denyRuleNew: DenyRuleNew, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<GenericResponse>>;
    public updateRule(id: number, rule: string, denyRuleNew: DenyRuleNew, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        if (id === null || id === undefined) {
        ...
        let localVarPath = `/mail/${this.configuration.encodeParam({name: "id", value: id, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: undefined})}/rules/${this.configuration.encodeParam({name: "rule", value: rule, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<GenericResponse>('put', `${basePath}${localVarPath}`,
            {
                body: denyRuleNew,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
