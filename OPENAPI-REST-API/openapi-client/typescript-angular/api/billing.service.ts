...
export class BillingService extends BaseService {
     ...
     * @endpoint get /affiliate/download
     ...
     * @param options additional options
     */
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<any>;
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<any>>;
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<any>>;
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        ...
        let localVarPath = `/affiliate/download`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @endpoint get /affiliate/signups
     * @param st Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param options additional options
     */
    public getAffiliateSignups(st?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<GetAffiliateSignups200Response>;
    public getAffiliateSignups(st?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<GetAffiliateSignups200Response>>;
    public getAffiliateSignups(st?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<GetAffiliateSignups200Response>>;
    public getAffiliateSignups(st?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        ...
        let localVarPath = `/affiliate/signups`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<GetAffiliateSignups200Response>('get', `${basePath}${localVarPath}`,
            {
                params: localVarQueryParameters.toHttpParams(),
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @endpoint get /billing/pay/{method}/{invoices}
    ...
    public initiatePayment(method: 'cc' | 'paypal' | 'prepay' | 'payssion' | 'payu' | 'ccavenue' | 'cashfree' | 'coinbase' | 'btcpay', invoices: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        ...
        let localVarPath = `/billing/pay/${this.configuration.encodeParam({name: "method", value: method, in: "path", style: "simple", explode: false, dataType: "'cc' | 'paypal' | 'prepay' | 'payssion' | 'payu' | 'ccavenue' | 'cashfree' | 'coinbase' | 'btcpay'", dataFormat: undefined})}/${this.configuration.encodeParam({name: "invoices", value: invoices, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @endpoint patch /billing/creditcards/{id}/verify
     * @param id The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;.
     ...
     * @param options additional options
     */
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<SuccessTextResponse>;
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<SuccessTextResponse>>;
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<SuccessTextResponse>>;
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        if (id === null || id === undefined) {
        ...
        if (patchBillingCreditCardVerifyRequest === null || patchBillingCreditCardVerifyRequest === undefined) {
            throw new Error('Required parameter patchBillingCreditCardVerifyRequest was null or undefined when calling patchBillingCreditCardVerify.');
        }
        ...
        let localVarPath = `/billing/creditcards/${this.configuration.encodeParam({name: "id", value: id, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: undefined})}/verify`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<SuccessTextResponse>('patch', `${basePath}${localVarPath}`,
            {
