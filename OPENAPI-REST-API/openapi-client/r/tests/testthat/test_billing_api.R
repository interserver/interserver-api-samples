...
test_that("GetAffiliateDownload", {
  # tests for GetAffiliateDownload
  # base path: https://my.interserver.net/apiv2
  ...
  # @param st character Filter by status. (optional)
  # @param ex character Export format: csv, xls, xlsx, or pdf. Defaults to csv. (optional)
  # @param year integer Year to filter the report. Defaults to the current year. (optional)
  # @return [Void]
...
test_that("GetAffiliateSignups", {
  # tests for GetAffiliateSignups
  # base path: https://my.interserver.net/apiv2
  ...
  # @param st character Filter signups by status. Use `default` to show all or pass a specific status value to narrow results. (optional)
...
test_that("PatchBillingCreditCardVerify", {
  # tests for PatchBillingCreditCardVerify
  # base path: https://my.interserver.net/apiv2
