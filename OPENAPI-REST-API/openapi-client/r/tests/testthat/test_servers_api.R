...
test_that("ServerBulkIpmiPowerGet", {
  # tests for ServerBulkIpmiPowerGet
  # base path: https://my.interserver.net/apiv2
  ...
  # @param ids character Comma-separated list of Server IDs to query (e.g. `2313,2314,2315`). May also be passed as repeated `ids[]` query parameters.
