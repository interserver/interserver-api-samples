#' Create a new WebsiteOrderPutRequest
#'
#' @description
#' request to validate a webhosting order
#'
#' @docType class
#' @title WebsiteOrderPutRequest
#' @description WebsiteOrderPutRequest Class
...
WebsiteOrderPutRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new WebsiteOrderPutRequest class.
    #'
    ...
    #'
    #' @return WebsiteOrderPutRequest as a base R list.
    #' @examples
    #' # convert array of WebsiteOrderPutRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert WebsiteOrderPutRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      WebsiteOrderPutRequestObject <- list()
      if (!is.null(self$`hostname`)) {
        WebsiteOrderPutRequestObject[["hostname"]] <-
          self$`hostname`
      }
      if (!is.null(self$`packageId`)) {
        WebsiteOrderPutRequestObject[["packageId"]] <-
          self$`packageId`
      }
      if (!is.null(self$`rootpass`)) {
        WebsiteOrderPutRequestObject[["rootpass"]] <-
          self$`rootpass`
      }
      if (!is.null(self$`period`)) {
        WebsiteOrderPutRequestObject[["period"]] <-
          self$`period`
      }
      if (!is.null(self$`coupon`)) {
        WebsiteOrderPutRequestObject[["coupon"]] <-
          self$`coupon`
      }
      if (!is.null(self$`serviceOfferId`)) {
        WebsiteOrderPutRequestObject[["serviceOfferId"]] <-
          self$`serviceOfferId`
      }
      if (!is.null(self$`script`)) {
        WebsiteOrderPutRequestObject[["script"]] <-
          self$`script`
      }
      if (!is.null(self$`comment`)) {
        WebsiteOrderPutRequestObject[["comment"]] <-
          self$`comment`
      }
      if (!is.null(self$`registerDomain`)) {
        WebsiteOrderPutRequestObject[["registerDomain"]] <-
          self$`registerDomain`
      }
      return(WebsiteOrderPutRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of WebsiteOrderPutRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of WebsiteOrderPutRequest
    ...
    #' @return WebsiteOrderPutRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to WebsiteOrderPutRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`hostname`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for WebsiteOrderPutRequest: the required field `hostname` is missing."))
      }
      ...
      if (!is.null(input_json$`packageId`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for WebsiteOrderPutRequest: the required field `packageId` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of WebsiteOrderPutRequest
    toString = function() {
      self$toJSONString()
    },
...
# WebsiteOrderPutRequest$unlock()
#
## Below is an example to define the print function
# WebsiteOrderPutRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WebsiteOrderPutRequest$lock()
