...
**backup_name** | **character** | Name of the backup service. | [optional] 
**backup_ip** | **character** | IP address of the backup service. | [optional] 
...
**backup_last_update** | **character** | Last update timestamp of the backup service. | [optional] 
