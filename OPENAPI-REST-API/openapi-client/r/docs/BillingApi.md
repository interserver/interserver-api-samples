...
> GetAffiliateDownload(st = var.st, ex = var.ex, year = var.year)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **character**| Filter by status. | [optional] 
 **ex** | Enum [csv, xls, xlsx, pdf] | Export format: csv, xls, xlsx, or pdf. Defaults to csv. | [optional] 
...
# **GetAffiliateSignups**
> GetAffiliateSignups200Response GetAffiliateSignups(st = var.st)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **character**| Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. | [optional] 

### Return type

[**GetAffiliateSignups200Response**](getAffiliateSignups_200_response.md)
 ...
 **invoices** | **character**| A comma-separated list of invoice IDs or invoice Tags to pay. These IDs are returned by order endpoints (e.g. &#x60;/backups/order&#x60;, &#x60;/vps/order&#x60;) and by &#x60;/billing/invoices&#x60;. Invoice tags accepted are SERVICE&lt;module&gt;&lt;id&gt;, RINV&lt;module&gt;&lt;repeat invoice id&gt;, INV&lt;module&gt;&lt;invoice id&gt;, PREPAY&lt;prepay id&gt;&lt;invoice id&gt;, and &lt;invoice id&gt;. | 
...
> SuccessTextResponse PatchBillingCreditCardVerify(id, patch_billing_credit_card_verify_request)
