  ...
  class PublicApi
    ...
    def get_account_currencies_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PublicApi.get_account_currencies",
    ...
    # @param [Hash] opts the optional parameters
    # @return [Hash<String, GetAccountLocales200ResponseValue>]
    ...
    # Renders the language-picker for account preferences or login pages. Public — no auth required. Cross-references PHP&#39;s Punic locale data with &#x60;locale/google_langs.php&#x60; so only locales with Google Translate support are returned. Result is essentially static — cache client-side. Sibling ops: &#x60;getCountries&#x60;, &#x60;getTimezones&#x60;, &#x60;getAccountCurrencies&#x60;, &#x60;updateAccountInfo&#x60; (consumes the chosen locale).  **Path/Query/Body:** None.  **Returns:** JSON object keyed by BCP-47-style locale code, with &#x60;{ name, local_name }&#x60; per entry — e.g.      {       \&quot;en\&quot;: { \&quot;name\&quot;: \&quot;English\&quot;, \&quot;local_name\&quot;: \&quot;English\&quot; },       \&quot;es\&quot;: { \&quot;name\&quot;: \&quot;Spanish\&quot;, \&quot;local_name\&quot;: \&quot;español\&quot; },       \&quot;fr\&quot;: { \&quot;name\&quot;: \&quot;French\&quot;, \&quot;local_name\&quot;: \&quot;français\&quot; }     }  &#x60;name&#x60; is the English label; &#x60;local_name&#x60; is the locale&#39;s name in its own language (good for accessibility and avoiding the wrong-script problem).  **Auth:** None.  **Errors:** No documented error path.  **Related calls:** - **Apply to account profile:** &#x60;updateAccountInfo&#x60; (sets &#x60;locale&#x60;). - **Other preference catalogs:** &#x60;getCountries&#x60;, &#x60;getTimezones&#x60;, &#x60;getAccountCurrencies&#x60;. 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Hash<String, GetAccountLocales200ResponseValue>, Integer, Hash)>] Hash<String, GetAccountLocales200ResponseValue> data, response status code and response headers
    def get_account_locales_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Hash<String, GetAccountLocales200ResponseValue>'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['sessionIdCookieAuth', 'apiKeyAuth', 'sessionIdHeaderAuth']

      new_options = opts.merge(
        :operation => :"PublicApi.get_account_locales",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_captcha_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CaptchaResponse'
    ...
    def get_info_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ServicesInfo'
    ...
    def get_login_info_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'LoginInfo'
    ...
    def get_oauth_redirect_with_http_info(provider, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetOauthRedirect200Response'
    ...
    def patch_oauth_two_factor(patch_oauth_two_factor_request, opts = {})
      data, _status_code, _headers = patch_oauth_two_factor_with_http_info(patch_oauth_two_factor_request, opts)
      data
    end
    ...
    def patch_oauth_two_factor_with_http_info(patch_oauth_two_factor_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && patch_oauth_two_factor_request.nil?
        fail ArgumentError, "Missing the required parameter 'patch_oauth_two_factor_request' when calling PublicApi.patch_oauth_two_factor"
      end
      # resource path
      local_var_path = '/oauth'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(patch_oauth_two_factor_request)

      # return_type
      return_type = opts[:debug_return_type] || 'PatchOauthTwoFactor200Response'
    ...
    def post_oauth_callback_with_http_info(provider, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'post_oauth_callback_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'PostOauthCallback200Response'
    ...
    def submit_login(login, passwd, opts = {})
      data, _status_code, _headers = submit_login_with_http_info(login, passwd, opts)
      data
    end
    ...
    def submit_login_with_http_info(login, passwd, opts = {})
      if @api_client.config.debugging
      ...
      form_params['remember'] = opts[:'remember'] if !opts[:'remember'].nil?
      form_params['g-recaptcha-response'] = opts[:'g_recaptcha_response'] if !opts[:'g_recaptcha_response'].nil?
      form_params['tfa'] = opts[:'tfa'] if !opts[:'tfa'].nil?

      # http body (model)
      post_body = opts[:debug_body]

      # return_type
      return_type = opts[:debug_return_type] || 'LoginSuccessResponse'
    ...
    def submit_signup_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'login_submission_example'])
