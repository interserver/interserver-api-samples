...
module InterServerClient
  class LicensesApi
    ...
    def add_license(license_order_request, opts = {})
      data, _status_code, _headers = add_license_with_http_info(license_order_request, opts)
      data
    end
    ...
    def add_license_with_http_info(license_order_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LicensesApi.add_license ...'
      end
      # verify the required parameter 'license_order_request' is set
      if @api_client.config.client_side_validation && license_order_request.nil?
        fail ArgumentError, "Missing the required parameter 'license_order_request' when calling LicensesApi.add_license"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(license_order_request)
    ...
    def get_license_invoices_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/licenses/{id}/invoices'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_license_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<LicenseRow>'
    ...
    def get_licenses_welcome_email_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/licenses/{id}/welcome_email'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_new_license_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'LicensesOrder'
    ...
    def licenses_cancel_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'LicensesCancel200Response'
    ...
    # @param [Hash] opts the optional parameters
    # @return [SuccessTextResponse]
    def post_license_change_ip(id, ip_object, opts = {})
      data, _status_code, _headers = post_license_change_ip_with_http_info(id, ip_object, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SuccessTextResponse, Integer, Hash)>] SuccessTextResponse data, response status code and response headers
    def post_license_change_ip_with_http_info(id, ip_object, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && ip_object.nil?
        fail ArgumentError, "Missing the required parameter 'ip_object' when calling LicensesApi.post_license_change_ip"
      end
      # resource path
      local_var_path = '/licenses/{id}/change_ip'.sub('{id}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ip_object)
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def put_licenses(license_order_request, opts = {})
      put_licenses_with_http_info(license_order_request, opts)
      nil
    end
    ...
    def put_licenses_with_http_info(license_order_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LicensesApi.put_licenses ...'
      end
      # verify the required parameter 'license_order_request' is set
      if @api_client.config.client_side_validation && license_order_request.nil?
        fail ArgumentError, "Missing the required parameter 'license_order_request' when calling LicensesApi.put_licenses"
      end
      # resource path
      local_var_path = '/licenses/order'
