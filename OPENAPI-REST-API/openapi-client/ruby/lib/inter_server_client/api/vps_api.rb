...
module InterServerClient
  class VPSApi
    ...
    def add_vps_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'vps_order_post_request'])
    ...
    def delete_vps_backup_with_http_info(id, file, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/backups'.sub('{id}', CGI.escape(id.to_s))
    ...
    def do_vps_block_smtp_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/block_smtp'.sub('{id}', CGI.escape(id.to_s))
    ...
    def do_vps_disable_cd_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/disable_cd'.sub('{id}', CGI.escape(id.to_s))
    ...
    def do_vps_disable_quota_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/disable_quota'.sub('{id}', CGI.escape(id.to_s))
    ...
    def do_vps_eject_cd_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/eject_cd'.sub('{id}', CGI.escape(id.to_s))
    ...
    def do_vps_enable_quota_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/enable_quota'.sub('{id}', CGI.escape(id.to_s))
    ...
    def do_vps_restart_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/restart'.sub('{id}', CGI.escape(id.to_s))
    ...
    def do_vps_start_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/start'.sub('{id}', CGI.escape(id.to_s))
    ...
    def do_vps_stop_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/stop'.sub('{id}', CGI.escape(id.to_s))
    ...
    def download_vps_backup(id, download_qs_backup_request, opts = {})
      data, _status_code, _headers = download_vps_backup_with_http_info(id, download_qs_backup_request, opts)
      data
    end
    ...
    def download_vps_backup_with_http_info(id, download_qs_backup_request, opts = {})
      if @api_client.config.debugging
    ...
    def get_new_vps_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VpsOrder'
    ...
    def get_vps_backup_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/backup'.sub('{id}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"VPSApi.get_vps_backup",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_vps_buy_hd_space_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/buy_hd_space'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_vps_buy_ip_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/buy_ip'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_vps_change_hostname_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/change_hostname'.sub('{id}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"VPSApi.get_vps_change_hostname",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_vps_change_root_password_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/change_root_password'.sub('{id}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"VPSApi.get_vps_change_root_password",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_vps_change_timezone_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/change_timezone'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_vps_info_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Vps'
    ...
    def get_vps_insert_cd_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/insert_cd'.sub('{id}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"VPSApi.get_vps_insert_cd",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_vps_invoices_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/invoices'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_vps_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<VpsRow>'
    ...
    def get_vps_reinstall_os_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/reinstall_os'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_vps_reset_password_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/reset_password'.sub('{id}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"VPSApi.get_vps_reset_password",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_vps_reverse_dns_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/reverse_dns'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_vps_setup_vnc_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/setup_vnc'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_vps_slices_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/slices'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_vps_traffic_usage_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/traffic_usage'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VpsTrafficResponse'
    ...
    def get_vps_view_desktop_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/view_desktop'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_vps_welcome_email_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/vps/{id}/welcome_email'.sub('{id}', CGI.escape(id.to_s))
    ...
    # @return [QueueResponse]
    def post_vps_change_hostname(id, opts = {})
      data, _status_code, _headers = post_vps_change_hostname_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :hostname 
    # @return [Array<(QueueResponse, Integer, Hash)>] QueueResponse data, response status code and response headers
    def post_vps_change_hostname_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [QueueResponse]
    def post_vps_change_root_password(id, password, opts = {})
      data, _status_code, _headers = post_vps_change_root_password_with_http_info(id, password, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(QueueResponse, Integer, Hash)>] QueueResponse data, response status code and response headers
    def post_vps_change_root_password_with_http_info(id, password, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [QueueResponse]
    def post_vps_change_timezone(id, timezone, opts = {})
      data, _status_code, _headers = post_vps_change_timezone_with_http_info(id, timezone, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(QueueResponse, Integer, Hash)>] QueueResponse data, response status code and response headers
    def post_vps_change_timezone_with_http_info(id, timezone, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [QueueResponse]
    def post_vps_change_webuzo_password(id, password, opts = {})
      data, _status_code, _headers = post_vps_change_webuzo_password_with_http_info(id, password, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(QueueResponse, Integer, Hash)>] QueueResponse data, response status code and response headers
    def post_vps_change_webuzo_password_with_http_info(id, password, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/vps/{id}/change_webuzo_password'.sub('{id}', CGI.escape(id.to_s))
    ...
    # @return [QueueResponse]
    def post_vps_insert_cd(id, opts = {})
      data, _status_code, _headers = post_vps_insert_cd_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :url 
    # @return [Array<(QueueResponse, Integer, Hash)>] QueueResponse data, response status code and response headers
    def post_vps_insert_cd_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    # @return [QueueResponse]
    def post_vps_reinstall_os(id, template, local_password, opts = {})
      data, _status_code, _headers = post_vps_reinstall_os_with_http_info(id, template, local_password, opts)
      data
    end
    ...
    # @option opts [String] :password Password for Root / Administrator Account.
    # @return [Array<(QueueResponse, Integer, Hash)>] QueueResponse data, response status code and response headers
    def post_vps_reinstall_os_with_http_info(id, template, local_password, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && !opts[:'password'].nil? && opts[:'password'].to_s.length < 6
        fail ArgumentError, 'invalid value for "opts[:"password"]" when calling VPSApi.post_vps_reinstall_os, the character length must be greater than or equal to 6.'
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [QueueResponse]
    def post_vps_restore(id, restore_request, opts = {})
      data, _status_code, _headers = post_vps_restore_with_http_info(id, restore_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(QueueResponse, Integer, Hash)>] QueueResponse data, response status code and response headers
    def post_vps_restore_with_http_info(id, restore_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && restore_request.nil?
        fail ArgumentError, "Missing the required parameter 'restore_request' when calling VPSApi.post_vps_restore"
      end
      # resource path
      local_var_path = '/vps/{id}/restore'.sub('{id}', CGI.escape(id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [TextResponse]
    def post_vps_reverse_dns(id, reverse_dns_entries, opts = {})
      data, _status_code, _headers = post_vps_reverse_dns_with_http_info(id, reverse_dns_entries, opts)
      data
    end
    ...
    def post_vps_reverse_dns_with_http_info(id, reverse_dns_entries, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && reverse_dns_entries.nil?
        fail ArgumentError, "Missing the required parameter 'reverse_dns_entries' when calling VPSApi.post_vps_reverse_dns"
      end
      # resource path
      local_var_path = '/vps/{id}/reverse_dns'.sub('{id}', CGI.escape(id.to_s))
    ...
    def post_vps_traffic_usage_with_http_info(id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"VPSApi.post_vps_traffic_usage",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def put_vps_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'vps_order_put_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'VpsOrderPutResponse'
    ...
    def put_vps_buy_hd_space_with_http_info(id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"VPSApi.put_vps_buy_hd_space",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def v_ps_cancel_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'VPSCancel200Response'
