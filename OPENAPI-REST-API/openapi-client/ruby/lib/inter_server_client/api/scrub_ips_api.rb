...
module InterServerClient
  class ScrubIpsApi
    ...
    def cancel_scrub_ip_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/scrub_ips/{id}'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CancelScrubIp200Response'
    ...
    def create_filter(id, create_filter, opts = {})
      data, _status_code, _headers = create_filter_with_http_info(id, create_filter, opts)
      data
    end
    ...
    def create_filter_with_http_info(id, create_filter, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && create_filter.nil?
        fail ArgumentError, "Missing the required parameter 'create_filter' when calling ScrubIpsApi.create_filter"
      end
      # resource path
      local_var_path = '/scrub_ips/{id}/create_filter'.sub('{id}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_filter)
    ...
    def create_geo_rule(id, create_geo_firewall_rule, opts = {})
      data, _status_code, _headers = create_geo_rule_with_http_info(id, create_geo_firewall_rule, opts)
      data
    end
    ...
    def create_geo_rule_with_http_info(id, create_geo_firewall_rule, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && create_geo_firewall_rule.nil?
        fail ArgumentError, "Missing the required parameter 'create_geo_firewall_rule' when calling ScrubIpsApi.create_geo_rule"
      end
      # resource path
      local_var_path = '/scrub_ips/{id}/create_geo_rule'.sub('{id}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_geo_firewall_rule)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateRule201Response'
    ...
    # @param [Hash] opts the optional parameters
    # @return [CreateRule201Response]
    def create_rule(id, create_firewall_rule, opts = {})
      data, _status_code, _headers = create_rule_with_http_info(id, create_firewall_rule, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateRule201Response, Integer, Hash)>] CreateRule201Response data, response status code and response headers
    def create_rule_with_http_info(id, create_firewall_rule, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && create_firewall_rule.nil?
        fail ArgumentError, "Missing the required parameter 'create_firewall_rule' when calling ScrubIpsApi.create_rule"
      end
      # resource path
      local_var_path = '/scrub_ips/{id}/create_rule'.sub('{id}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_firewall_rule)
    ...
    def delete_filter(id, create_filter, opts = {})
      data, _status_code, _headers = delete_filter_with_http_info(id, create_filter, opts)
      data
    end
    ...
    def delete_filter_with_http_info(id, create_filter, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'create_filter' is set
      if @api_client.config.client_side_validation && create_filter.nil?
        fail ArgumentError, "Missing the required parameter 'create_filter' when calling ScrubIpsApi.delete_filter"
      end
      # resource path
      local_var_path = '/scrub_ips/{id}/delete_filter'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DeleteFilter200Response'
    ...
    def disable_scrub_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/scrub_ips/{id}/disable'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DisableScrub200Response'
    ...
    def enable_scrub_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/scrub_ips/{id}/enable'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EnableScrub200Response'
    ...
    def get_order_detail_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetOrderDetail200Response'
    ...
    def get_scrub_ip_details_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetScrubIpDetails200Response'
    ...
    def get_scrub_ip_filter_types_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ScrubIpFilterTypes'
    ...
    def get_scrub_ip_invoices_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/scrub_ips/{id}/invoices'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_scrub_ip_logs_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/scrub_ips/{id}/logs'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<ScrubIpsLogRowSchema>'
    ...
    def get_scrub_ips_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<ScrubIpsRowSchema>'
    ...
    def place_scrub_order(scrub_ip_place_order, opts = {})
      data, _status_code, _headers = place_scrub_order_with_http_info(scrub_ip_place_order, opts)
      data
    end
    ...
    def place_scrub_order_with_http_info(scrub_ip_place_order, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && scrub_ip_place_order.nil?
        fail ArgumentError, "Missing the required parameter 'scrub_ip_place_order' when calling ScrubIpsApi.place_scrub_order"
      end
      # resource path
      local_var_path = '/scrub_ips/order'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(scrub_ip_place_order)

      # return_type
      return_type = opts[:debug_return_type] || 'PlaceScrubOrder201Response'
    ...
    def put_scrub_ips(scrub_ip_place_order, opts = {})
      data, _status_code, _headers = put_scrub_ips_with_http_info(scrub_ip_place_order, opts)
      data
    end
    ...
    # @param scrub_ip_place_order [ScrubIpPlaceOrder] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PutScrubIps200Response, Integer, Hash)>] PutScrubIps200Response data, response status code and response headers
    def put_scrub_ips_with_http_info(scrub_ip_place_order, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ScrubIpsApi.put_scrub_ips ...'
      end
      # verify the required parameter 'scrub_ip_place_order' is set
      if @api_client.config.client_side_validation && scrub_ip_place_order.nil?
        fail ArgumentError, "Missing the required parameter 'scrub_ip_place_order' when calling ScrubIpsApi.put_scrub_ips"
      end
      # resource path
      local_var_path = '/scrub_ips/order'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PutScrubIps200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['sessionIdCookieAuth', 'apiKeyAuth', 'sessionIdHeaderAuth']

      new_options = opts.merge(
        :operation => :"ScrubIpsApi.put_scrub_ips",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def scrub_ips_delete_geo_rule(id, delete_geo_firewall_rule, opts = {})
      data, _status_code, _headers = scrub_ips_delete_geo_rule_with_http_info(id, delete_geo_firewall_rule, opts)
      data
    end
    ...
    def scrub_ips_delete_geo_rule_with_http_info(id, delete_geo_firewall_rule, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && delete_geo_firewall_rule.nil?
        fail ArgumentError, "Missing the required parameter 'delete_geo_firewall_rule' when calling ScrubIpsApi.scrub_ips_delete_geo_rule"
      end
      # resource path
      local_var_path = '/scrub_ips/{id}/delete_geo_rule'.sub('{id}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(delete_geo_firewall_rule)

      # return_type
      return_type = opts[:debug_return_type] || 'ScrubIpsDeleteRule200Response'
    ...
    # @param [Hash] opts the optional parameters
    # @return [ScrubIpsDeleteRule200Response]
    def scrub_ips_delete_rule(id, delete_firewall_rule, opts = {})
      data, _status_code, _headers = scrub_ips_delete_rule_with_http_info(id, delete_firewall_rule, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ScrubIpsDeleteRule200Response, Integer, Hash)>] ScrubIpsDeleteRule200Response data, response status code and response headers
    def scrub_ips_delete_rule_with_http_info(id, delete_firewall_rule, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && delete_firewall_rule.nil?
        fail ArgumentError, "Missing the required parameter 'delete_firewall_rule' when calling ScrubIpsApi.scrub_ips_delete_rule"
      end
      # resource path
      local_var_path = '/scrub_ips/{id}/delete_rule'.sub('{id}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(delete_firewall_rule)
