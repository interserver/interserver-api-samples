...
module InterServerClient
  class SSLCertificatesApi
    ...
    # @param ssl_order_request [SslOrderRequest] 
    # @param [Hash] opts the optional parameters
    # @return [ServiceOrderPostResponse]
    def add_ssl(ssl_order_request, opts = {})
      data, _status_code, _headers = add_ssl_with_http_info(ssl_order_request, opts)
      data
    end
    ...
    def add_ssl_with_http_info(ssl_order_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SSLCertificatesApi.add_ssl ...'
      end
      # verify the required parameter 'ssl_order_request' is set
      if @api_client.config.client_side_validation && ssl_order_request.nil?
        fail ArgumentError, "Missing the required parameter 'ssl_order_request' when calling SSLCertificatesApi.add_ssl"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ssl_order_request)
    ...
    def get_ssl_info_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/ssl/{id}'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_ssl_invoices_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/ssl/{id}/invoices'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_ssl_welcome_email_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/ssl/{id}/welcome_email'.sub('{id}', CGI.escape(id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def put_ssl(ssl_order_request, opts = {})
      put_ssl_with_http_info(ssl_order_request, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def put_ssl_with_http_info(ssl_order_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SSLCertificatesApi.put_ssl ...'
      end
      # verify the required parameter 'ssl_order_request' is set
      if @api_client.config.client_side_validation && ssl_order_request.nil?
        fail ArgumentError, "Missing the required parameter 'ssl_order_request' when calling SSLCertificatesApi.put_ssl"
      end
      # resource path
      local_var_path = '/ssl/order'
    ...
    def ssl_cancel_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SslCancel200Response'
