...
module InterServerClient
  class BackupsApi
    ...
    # @option opts [Boolean] :validate_only 
    # @option opts [Integer] :service_type 
    # @option opts [String] :coupon 
    # @return [BackupOrderPostResponse]
    def add_backup(opts = {})
      data, _status_code, _headers = add_backup_with_http_info(opts)
      data
    end
    ...
    def add_backup_with_http_info(opts = {})
      ...
      form_params['validateOnly'] = opts[:'validate_only'] if !opts[:'validate_only'].nil?
      form_params['serviceType'] = opts[:'service_type'] if !opts[:'service_type'].nil?
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BackupOrderPostResponse'
    ...
    def cancel_backup_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/backups/{id}'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CancelBackup200Response'
    ...
    def get_backup_info_with_http_info(id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Backup'
    ...
    def get_backup_invoices_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/backups/{id}/invoices'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_backup_login_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/backups/{id}/login'.sub('{id}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BackupLoginResponse'
    ...
    def get_backups_list_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<BackupRow>'
    ...
    def get_backups_welcome_email_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/backups/{id}/welcome_email'.sub('{id}', CGI.escape(id.to_s))
    ...
    def get_new_backup_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BackupsOrder'
    ...
    def validate_backup_order(opts = {})
      data, _status_code, _headers = validate_backup_order_with_http_info(opts)
      data
    end
    ...
    def validate_backup_order_with_http_info(opts = {})
      if @api_client.config.debugging
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BackupOrderPutResponse'
