...
module InterServerClient
  class AccountApi
    ...
    def delete_account_oauth_name_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/account/oauth/{name}'.sub('{name}', CGI.escape(name.to_s))
    ...
    def delete_ip_limit_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'ip_limit_range'])
    ...
    def get_account_tfa_setup_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAccountTfaSetup200Response'
    ...
    def get_home_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Home'
    ...
    def get_search_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SearchAutocompleteResponse'
    ...
    def logout_account_oauth_with_http_info(name, opts = {})
      ...
      # resource path
      local_var_path = '/account/oauth/{name}/logout'.sub('{name}', CGI.escape(name.to_s))
    ...
    # @return [SuccessTextResponse]
    def update_account_features(opts = {})
      data, _status_code, _headers = update_account_features_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :disable_reinstall 
    # @return [Array<(SuccessTextResponse, Integer, Hash)>] SuccessTextResponse data, response status code and response headers
    def update_account_features_with_http_info(opts = {})
      if @api_client.config.debugging
      ...
      # form parameters
      form_params = opts[:form_params] || {}
      form_params['disable_reset'] = opts[:'disable_reset'] if !opts[:'disable_reset'].nil?
      form_params['disable_reinstall'] = opts[:'disable_reinstall'] if !opts[:'disable_reinstall'].nil?
    ...
    # @return [SuccessTextResponse]
    def update_account_info(name, address, city, state, zip, country, phone, opts = {})
      data, _status_code, _headers = update_account_info_with_http_info(name, address, city, state, zip, country, phone, opts)
      data
    end
    ...
    # @option opts [String] :gstin Your GST identification number (if applicable).
    # @return [Array<(SuccessTextResponse, Integer, Hash)>] SuccessTextResponse data, response status code and response headers
    def update_account_info_with_http_info(name, address, city, state, zip, country, phone, opts = {})
      if @api_client.config.debugging
      ...
      form_params['locale'] = opts[:'locale'] if !opts[:'locale'].nil?
      form_params['email_invoices'] = opts[:'email_invoices'] if !opts[:'email_invoices'].nil?
      form_params['email_abuse'] = opts[:'email_abuse'] if !opts[:'email_abuse'].nil?
      form_params['disable_reset'] = opts[:'disable_reset'] if !opts[:'disable_reset'].nil?
      form_params['disable_reinstall'] = opts[:'disable_reinstall'] if !opts[:'disable_reinstall'].nil?
      form_params['disable_server_notifications'] = opts[:'disable_server_notifications'] if !opts[:'disable_server_notifications'].nil?
      form_params['disable_email_notifications'] = opts[:'disable_email_notifications'] if !opts[:'disable_email_notifications'].nil?
      form_params['gstin'] = opts[:'gstin'] if !opts[:'gstin'].nil?
    ...
    # @return [SuccessTextResponse]
    def update_account_ssh_key(opts = {})
      data, _status_code, _headers = update_account_ssh_key_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :ssh_key 
    # @return [Array<(SuccessTextResponse, Integer, Hash)>] SuccessTextResponse data, response status code and response headers
    def update_account_ssh_key_with_http_info(opts = {})
      if @api_client.config.debugging
      ...
      # form parameters
      form_params = opts[:form_params] || {}
      form_params['ssh_key'] = opts[:'ssh_key'] if !opts[:'ssh_key'].nil?
