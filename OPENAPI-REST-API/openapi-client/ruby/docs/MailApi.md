...
api_instance = InterServerClient::MailApi.new
mail_order_request = InterServerClient::MailOrderRequest.new({service_type: 37}) # MailOrderRequest | 

begin
  # Place a new Mail Baby order, generate invoice, and queue provisioning
  result = api_instance.add_mail(mail_order_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->add_mail: #{e}"
end
```

#### Using the add_mail_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ServiceOrderPostResponse>, Integer, Hash)> add_mail_with_http_info(mail_order_request)

```ruby
begin
  # Place a new Mail Baby order, generate invoice, and queue provisioning
  data, status_code, headers = api_instance.add_mail_with_http_info(mail_order_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ServiceOrderPostResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->add_mail_with_http_info: #{e}"
end
```
...
deny_rule_new = InterServerClient::DenyRuleNew.new({type: 'domain', data: 'domeinwo@server.guesshost.net'}) # DenyRuleNew | These are the fields needed to create a new email deny rule.

begin
  # Create a new deny rule to auto-block matching submissions
  result = api_instance.add_rule(id, deny_rule_new)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->add_rule: #{e}"
end
```

#### Using the add_rule_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GenericResponse>, Integer, Hash)> add_rule_with_http_info(id, deny_rule_new)

```ruby
begin
  # Create a new deny rule to auto-block matching submissions
  data, status_code, headers = api_instance.add_rule_with_http_info(id, deny_rule_new)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GenericResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->add_rule_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::MailApi.new
id = 56 # Integer | The mail service ID. Use `mail_id` from `GET /mail`.
mail_alert_request = InterServerClient::MailAlertRequest.new # MailAlertRequest | 

begin
  # Create a new Mail Baby alert for delivery, bounce, or quota events
  result = api_instance.create_mail_alert(id, mail_alert_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->create_mail_alert: #{e}"
end
```

#### Using the create_mail_alert_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> create_mail_alert_with_http_info(id, mail_alert_request)

```ruby
begin
  # Create a new Mail Baby alert for delivery, bounce, or quota events
  data, status_code, headers = api_instance.create_mail_alert_with_http_info(id, mail_alert_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->create_mail_alert_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::MailApi.new
id = 56 # Integer | The mail service ID. Use `mail_id` from `GET /mail`.
delete_mail_alert_request = InterServerClient::DeleteMailAlertRequest.new({alert_id: 37}) # DeleteMailAlertRequest | 

begin
  # Delete a Mail Baby alert by alert_id (hard delete — no recovery)
  result = api_instance.delete_mail_alert(id, delete_mail_alert_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->delete_mail_alert: #{e}"
end
```

#### Using the delete_mail_alert_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> delete_mail_alert_with_http_info(id, delete_mail_alert_request)

```ruby
begin
  # Delete a Mail Baby alert by alert_id (hard delete — no recovery)
  data, status_code, headers = api_instance.delete_mail_alert_with_http_info(id, delete_mail_alert_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->delete_mail_alert_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->delete_rule: #{e}"
end
```
...
> <Array(<GenericResponse>, Integer, Hash)> delete_rule_with_http_info(id, rule)

```ruby
begin
  # Delete a Mail Baby deny rule by rule ID (hard delete — no recovery)
  data, status_code, headers = api_instance.delete_rule_with_http_info(id, rule)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GenericResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->delete_rule_with_http_info: #{e}"
end
```
...
> <GenericResponse> delist_block(id, opts)
...
begin
  # Delist a sender email from rspamd / mailchannels / mailbaby block lists
  result = api_instance.delist_block(id, opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->delist_block: #{e}"
end
```

#### Using the delist_block_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GenericResponse>, Integer, Hash)> delist_block_with_http_info(id, opts)

```ruby
begin
  # Delist a sender email from rspamd / mailchannels / mailbaby block lists
  data, status_code, headers = api_instance.delist_block_with_http_info(id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GenericResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->delist_block_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_mail_alerts: #{e}"
end
```

#### Using the get_mail_alerts_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<MailAlertsResponse>, Integer, Hash)> get_mail_alerts_with_http_info(id)

```ruby
begin
  # List configured delivery/bounce/quota alerts for one Mail Baby service
  data, status_code, headers = api_instance.get_mail_alerts_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MailAlertsResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_mail_alerts_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_mail_blocks: #{e}"
end
```

#### Using the get_mail_blocks_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<MailBlocks>, Integer, Hash)> get_mail_blocks_with_http_info(id)

```ruby
begin
  # List recent local-blocklist hits and spam-trap captures for the mail user
  data, status_code, headers = api_instance.get_mail_blocks_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MailBlocks>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_mail_blocks_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_mail_delist: #{e}"
end
```

#### Using the get_mail_delist_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<MailDelistResponse>, Integer, Hash)> get_mail_delist_with_http_info(id)

```ruby
begin
  # Read blocklist diagnostics and find senders eligible for delisting
  data, status_code, headers = api_instance.get_mail_delist_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MailDelistResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_mail_delist_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_mail_deliverability: #{e}"
end
```

#### Using the get_mail_deliverability_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<MailDeliverabilityResponse>, Integer, Hash)> get_mail_deliverability_with_http_info(id)

```ruby
begin
  # Read delivered vs bounced totals broken down by sender (or by recipient domain)
  data, status_code, headers = api_instance.get_mail_deliverability_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MailDeliverabilityResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_mail_deliverability_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_mail_info: #{e}"
end
```

#### Using the get_mail_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<MailSchema>, Integer, Hash)> get_mail_info_with_http_info(id)

```ruby
begin
  # Read full detail for one Mail Baby service including SMTP credentials
  data, status_code, headers = api_instance.get_mail_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MailSchema>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_mail_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_mail_invoices: #{e}"
end
```

#### Using the get_mail_invoices_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ChargeInvoiceRows>, Integer, Hash)> get_mail_invoices_with_http_info(id)

```ruby
begin
  # List billing invoices linked to this Mail Baby service
  data, status_code, headers = api_instance.get_mail_invoices_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ChargeInvoiceRows>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_mail_invoices_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_mail_list: #{e}"
end
```

#### Using the get_mail_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<MailRow>>, Integer, Hash)> get_mail_list_with_http_info

```ruby
begin
  # List every Mail Baby SMTP relay service on the account
  data, status_code, headers = api_instance.get_mail_list_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<MailRow>>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_mail_list_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_mail_welcome_email: #{e}"
end
```

#### Using the get_mail_welcome_email_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_mail_welcome_email_with_http_info(id)

```ruby
begin
  # Resend the Mail Baby welcome email with SMTP credentials and setup info
  data, status_code, headers = api_instance.get_mail_welcome_email_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_mail_welcome_email_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_new_mail: #{e}"
end
```

#### Using the get_new_mail_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<MailOrder>, Integer, Hash)> get_new_mail_with_http_info

```ruby
begin
  # Read the Mail Baby order catalog — plans, package costs, service-type metadata
  data, status_code, headers = api_instance.get_new_mail_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MailOrder>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_new_mail_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->get_rules: #{e}"
end
```
...
> <Array(<Array<DenyRuleRecord>>, Integer, Hash)> get_rules_with_http_info(id)

```ruby
begin
  # List configured deny rules (sender/recipient blocks) for a Mail Baby service
  data, status_code, headers = api_instance.get_rules_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<DenyRuleRecord>>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_rules_with_http_info: #{e}"
end
```
...
id = 56 # Integer | The mail service ID. Use `mail_id` from `GET /mail`.
opts = {
  time: 'all' # String | The timeframe for the statistics.
}
...
begin
  ...
  puts "Error when calling MailApi->get_stats: #{e}"
end
```
...
> <Array(<MailStatsType>, Integer, Hash)> get_stats_with_http_info(id, opts)

```ruby
begin
  # Read Mail Baby usage counts, send volume totals, top destinations, and projected cost
  data, status_code, headers = api_instance.get_stats_with_http_info(id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MailStatsType>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->get_stats_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->mail_cancel: #{e}"
end
```

#### Using the mail_cancel_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<MailCancel200Response>, Integer, Hash)> mail_cancel_with_http_info(id)

```ruby
begin
  # Cancel a Mail Baby service and stop the recurring invoice
  data, status_code, headers = api_instance.mail_cancel_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MailCancel200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->mail_cancel_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::MailApi.new
id = 56 # Integer | The mail service ID. Use `mail_id` from `GET /mail`.
mail_delist_request = InterServerClient::MailDelistRequest.new # MailDelistRequest | 

begin
  # Delist a sender from rspamd / mailchannels / mailbaby block lists
  result = api_instance.post_mail_delist(id, mail_delist_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->post_mail_delist: #{e}"
end
```

#### Using the post_mail_delist_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> post_mail_delist_with_http_info(id, mail_delist_request)

```ruby
begin
  # Delist a sender from rspamd / mailchannels / mailbaby block lists
  data, status_code, headers = api_instance.post_mail_delist_with_http_info(id, mail_delist_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->post_mail_delist_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->put_mail: #{e}"
end
```

#### Using the put_mail_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> put_mail_with_http_info(mail_order_request)

```ruby
begin
  # Validate Mail Baby order, quote pricing, and verify coupon — no charge
  data, status_code, headers = api_instance.put_mail_with_http_info(mail_order_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->put_mail_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->reset_mail_password: #{e}"
end
```

#### Using the reset_mail_password_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> reset_mail_password_with_http_info(id)

```ruby
begin
  # Rotate the SMTP password and email the new credential to the account owner
  data, status_code, headers = api_instance.reset_mail_password_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->reset_mail_password_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::MailApi.new
id = 56 # Integer | The mail service ID. Use `mail_id` from `GET /mail`.
send_mail_adv = InterServerClient::SendMailAdv.new({subject: 'Your Package has been Delivered!', body: 'The package you ordered on 2021-01-23 has been delivered. If the package is broken into many pieces, please blaim someone else.', from: InterServerClient::EmailAddressName.new({email: 'user@domain.com'}), to: [{"email": "user@domain.com", "name": "John Smith"}]}) # SendMailAdv | 

begin
  # Send email via Mail Baby SMTP relay with attachments, CC/BCC, and multi-recipient
  result = api_instance.send_adv_mail(id, send_mail_adv)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->send_adv_mail: #{e}"
end
```

#### Using the send_adv_mail_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GenericResponse>, Integer, Hash)> send_adv_mail_with_http_info(id, send_mail_adv)

```ruby
begin
  # Send email via Mail Baby SMTP relay with attachments, CC/BCC, and multi-recipient
  data, status_code, headers = api_instance.send_adv_mail_with_http_info(id, send_mail_adv)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GenericResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->send_adv_mail_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::MailApi.new
id = 56 # Integer | The mail service ID. Use `mail_id` from `GET /mail`.
send_mail = InterServerClient::SendMail.new({to: 'johndoe@company.com', from: 'janedoe@company.com', subject: 'Attention Client', body: 'This is an email to inform you that something noteworthy happened.'}) # SendMail | 

begin
  # Send a simple single-recipient email through the Mail Baby SMTP relay
  result = api_instance.send_mail(id, send_mail)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->send_mail: #{e}"
end
```

#### Using the send_mail_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GenericResponse>, Integer, Hash)> send_mail_with_http_info(id, send_mail)

```ruby
begin
  # Send a simple single-recipient email through the Mail Baby SMTP relay
  data, status_code, headers = api_instance.send_mail_with_http_info(id, send_mail)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GenericResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->send_mail_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::MailApi.new
id = 56 # Integer | The mail service ID. Use `mail_id` from `GET /mail`.
mail_alert_update_request = InterServerClient::MailAlertUpdateRequest.new # MailAlertUpdateRequest | 

begin
  # Update an existing Mail Baby alert by alert_id
  result = api_instance.update_mail_alert(id, mail_alert_update_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->update_mail_alert: #{e}"
end
```

#### Using the update_mail_alert_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_mail_alert_with_http_info(id, mail_alert_update_request)

```ruby
begin
  # Update an existing Mail Baby alert by alert_id
  data, status_code, headers = api_instance.update_mail_alert_with_http_info(id, mail_alert_update_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->update_mail_alert_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MailApi->update_mail_info: #{e}"
end
```

#### Using the update_mail_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_mail_info_with_http_info(id)

```ruby
begin
  # POST mutation hook for the Mail Baby service detail page
  data, status_code, headers = api_instance.update_mail_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->update_mail_info_with_http_info: #{e}"
end
```
...
deny_rule_new = InterServerClient::DenyRuleNew.new({type: 'domain', data: 'domeinwo@server.guesshost.net'}) # DenyRuleNew | 

begin
  # Update an existing Mail Baby deny rule's type and match data
  result = api_instance.update_rule(id, rule, deny_rule_new)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->update_rule: #{e}"
end
```
...
> <Array(<GenericResponse>, Integer, Hash)> update_rule_with_http_info(id, rule, deny_rule_new)

```ruby
begin
  # Update an existing Mail Baby deny rule's type and match data
  data, status_code, headers = api_instance.update_rule_with_http_info(id, rule, deny_rule_new)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GenericResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->update_rule_with_http_info: #{e}"
end
```
...
id = 56 # Integer | The mail service ID. Use `mail_id` from `GET /mail`.
opts = {
  id2: 2604, # Integer | The numeric ID of the mail order to filter by.  When omitted, logs from the first active mail order are returned.  Obtain valid IDs from `GET /mail` or `GET /mail/{id}`.
  ...
  delivered: 0, # Integer | Filter by delivery status.  `1` returns only messages that were successfully delivered to the destination MX.  `0` returns messages that are still queued, deferred, or failed.  Omit to return all messages regardless of delivery status.
  ...
  start_date: nil, # ViewMailLogStartDateParameter | Earliest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by `strtotime()` such as `2024-01-15` or `last monday`.  Messages with a `time` value **greater than or equal to** this value will be included.
  end_date: nil, # ViewMailLogStartDateParameter | Latest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by `strtotime()` such as `2024-01-31` or `yesterday`. Messages with a `time` value **less than or equal to** this value will be included.
  ...
  dir: 'asc', # String | Sort direction.  `desc` returns newest first (default), `asc` returns oldest first.
...
begin
  ...
  puts "Error when calling MailApi->view_mail_log: #{e}"
end
```

#### Using the view_mail_log_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<MailLog>, Integer, Hash)> view_mail_log_with_http_info(id, opts)

```ruby
begin
  # Search and paginate per-message Mail Baby delivery log entries
  data, status_code, headers = api_instance.view_mail_log_with_http_info(id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MailLog>
rescue InterServerClient::ApiError => e
  puts "Error when calling MailApi->view_mail_log_with_http_info: #{e}"
end
```
