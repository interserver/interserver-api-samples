...
> <BackupOrderPostResponse> add_backup(opts)
...
api_instance = InterServerClient::BackupsApi.new
opts = {
...
begin
  # Place a new off-site backup storage order and generate the invoice
  result = api_instance.add_backup(opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->add_backup: #{e}"
end
```

#### Using the add_backup_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<BackupOrderPostResponse>, Integer, Hash)> add_backup_with_http_info(opts)

```ruby
begin
  # Place a new off-site backup storage order and generate the invoice
  data, status_code, headers = api_instance.add_backup_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <BackupOrderPostResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->add_backup_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BackupsApi->cancel_backup: #{e}"
end
```
...
> <Array(<CancelBackup200Response>, Integer, Hash)> cancel_backup_with_http_info(id)

```ruby
begin
  # Cancel an off-site backup storage subscription
  data, status_code, headers = api_instance.cancel_backup_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CancelBackup200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->cancel_backup_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BackupsApi->get_backup_info: #{e}"
end
```

#### Using the get_backup_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Backup>, Integer, Hash)> get_backup_info_with_http_info(id)

```ruby
begin
  # Get details of a specific off-site backup storage service
  data, status_code, headers = api_instance.get_backup_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Backup>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->get_backup_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BackupsApi->get_backup_invoices: #{e}"
end
```

#### Using the get_backup_invoices_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ChargeInvoiceRows>, Integer, Hash)> get_backup_invoices_with_http_info(id)

```ruby
begin
  # List invoices for a single backup-storage subscription
  data, status_code, headers = api_instance.get_backup_invoices_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ChargeInvoiceRows>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->get_backup_invoices_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BackupsApi->get_backup_login: #{e}"
end
```

#### Using the get_backup_login_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<BackupLoginResponse>, Integer, Hash)> get_backup_login_with_http_info(id)

```ruby
begin
  # Open a single sign-on session URL for the backup storage panel
  data, status_code, headers = api_instance.get_backup_login_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <BackupLoginResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->get_backup_login_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BackupsApi->get_backups_list: #{e}"
end
```

#### Using the get_backups_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<BackupRow>>, Integer, Hash)> get_backups_list_with_http_info

```ruby
begin
  # List off-site backup storage subscriptions on the authenticated account
  data, status_code, headers = api_instance.get_backups_list_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<BackupRow>>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->get_backups_list_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BackupsApi->get_backups_welcome_email: #{e}"
end
```

#### Using the get_backups_welcome_email_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_backups_welcome_email_with_http_info(id)

```ruby
begin
  # Resend the welcome email for an off-site backup storage service
  data, status_code, headers = api_instance.get_backups_welcome_email_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->get_backups_welcome_email_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BackupsApi->get_new_backup: #{e}"
end
```

#### Using the get_new_backup_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<BackupsOrder>, Integer, Hash)> get_new_backup_with_http_info

```ruby
begin
  # Get backup-storage order form metadata and pricing tiers
  data, status_code, headers = api_instance.get_new_backup_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <BackupsOrder>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->get_new_backup_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BackupsApi->update_backup_info: #{e}"
end
```

#### Using the update_backup_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_backup_info_with_http_info(id)

```ruby
begin
  # Update stored metadata for a backup-storage subscription
  data, status_code, headers = api_instance.update_backup_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->update_backup_info_with_http_info: #{e}"
end
```
...
> <BackupOrderPutResponse> validate_backup_order(opts)
...
begin
  # Validate a backup-storage order and preview pricing without charging
  result = api_instance.validate_backup_order(opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->validate_backup_order: #{e}"
end
```

#### Using the validate_backup_order_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<BackupOrderPutResponse>, Integer, Hash)> validate_backup_order_with_http_info(opts)

```ruby
begin
  # Validate a backup-storage order and preview pricing without charging
  data, status_code, headers = api_instance.validate_backup_order_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <BackupOrderPutResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BackupsApi->validate_backup_order_with_http_info: #{e}"
end
```
