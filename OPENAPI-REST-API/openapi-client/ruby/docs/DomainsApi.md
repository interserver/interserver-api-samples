...
api_instance = InterServerClient::DomainsApi.new
domain_order_request = InterServerClient::DomainOrderRequest.new({hostname: 'hostname_example'}) # DomainOrderRequest | 

begin
  # Place a new domain registration or transfer order, generate billing invoice
  result = api_instance.add_domain(domain_order_request)
  p result
...
> <Array(<ServiceOrderPostResponse>, Integer, Hash)> add_domain_with_http_info(domain_order_request)

```ruby
begin
  # Place a new domain registration or transfer order, generate billing invoice
  data, status_code, headers = api_instance.add_domain_with_http_info(domain_order_request)
  p status_code # => 2xx
  p headers # => { ... }
...
domain_dnssec_request = InterServerClient::DomainDnssecRequest.new # DomainDnssecRequest | 

begin
  # Register DNSSEC DS records on the domain at OpenSRS
  result = api_instance.add_domain_dnssec(id, domain_dnssec_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->add_domain_dnssec: #{e}"
end
```

#### Using the add_domain_dnssec_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> add_domain_dnssec_with_http_info(id, domain_dnssec_request)

```ruby
begin
  # Register DNSSEC DS records on the domain at OpenSRS
  data, status_code, headers = api_instance.add_domain_dnssec_with_http_info(id, domain_dnssec_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->add_domain_dnssec_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::DomainsApi.new
id = 56 # Integer | The domain service ID. Use `domain_id` from `GET /domains`.
domain_nameserver_post_request = InterServerClient::DomainNameserverPostRequest.new({name: 'ns1.host.com', ip_address: '1.2.3.4Get'}) # DomainNameserverPostRequest | 

begin
  # Register a new nameserver host with glue IP at the registry (registered nameserver)
  result = api_instance.add_domain_nameserver(id, domain_nameserver_post_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->add_domain_nameserver: #{e}"
end
```

#### Using the add_domain_nameserver_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> add_domain_nameserver_with_http_info(id, domain_nameserver_post_request)

```ruby
begin
  # Register a new nameserver host with glue IP at the registry (registered nameserver)
  data, status_code, headers = api_instance.add_domain_nameserver_with_http_info(id, domain_nameserver_post_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->add_domain_nameserver_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->cancel_domain: #{e}"
end
```

#### Using the cancel_domain_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CancelDomain200Response>, Integer, Hash)> cancel_domain_with_http_info(id)

```ruby
begin
  # Cancel a domain order in the billing system to stop auto-renewals
  data, status_code, headers = api_instance.cancel_domain_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CancelDomain200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->cancel_domain_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->delete_domain_dnssec: #{e}"
end
```

#### Using the delete_domain_dnssec_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> delete_domain_dnssec_with_http_info(id)

```ruby
begin
  # Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)
  data, status_code, headers = api_instance.delete_domain_dnssec_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->delete_domain_dnssec_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->delete_domain_nameserver: #{e}"
end
```

#### Using the delete_domain_nameserver_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> delete_domain_nameserver_with_http_info(id, index)

```ruby
begin
  # Remove one registered nameserver glue record from the domain
  data, status_code, headers = api_instance.delete_domain_nameserver_with_http_info(id, index)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->delete_domain_nameserver_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_contact: #{e}"
end
```

#### Using the get_domain_contact_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DomainContactDetails>, Integer, Hash)> get_domain_contact_with_http_info(id)

```ruby
begin
  # Read the current registrant/admin/tech/billing contact field set for a domain
  data, status_code, headers = api_instance.get_domain_contact_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DomainContactDetails>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_contact_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_dnssec: #{e}"
end
```

#### Using the get_domain_dnssec_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DomainDnssecRecords>, Integer, Hash)> get_domain_dnssec_with_http_info(id)

```ruby
begin
  # Read the DNSSEC DS record set currently registered with the registrar
  data, status_code, headers = api_instance.get_domain_dnssec_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DomainDnssecRecords>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_dnssec_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_info: #{e}"
end
```

#### Using the get_domain_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Domain>, Integer, Hash)> get_domain_info_with_http_info(id)

```ruby
begin
  # Read full billing, registrar, and service detail for one domain
  data, status_code, headers = api_instance.get_domain_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Domain>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_invoices: #{e}"
end
```

#### Using the get_domain_invoices_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ChargeInvoiceRows>, Integer, Hash)> get_domain_invoices_with_http_info(id)

```ruby
begin
  # List all billing invoices scoped to one domain order
  data, status_code, headers = api_instance.get_domain_invoices_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ChargeInvoiceRows>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_invoices_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_lookup: #{e}"
end
```

#### Using the get_domain_lookup_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DomainLookupResponse>, Integer, Hash)> get_domain_lookup_with_http_info(name)

```ruby
begin
  # Check availability, premium status, and pricing for a specific domain
  data, status_code, headers = api_instance.get_domain_lookup_with_http_info(name)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DomainLookupResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_lookup_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_nameservers: #{e}"
end
```

#### Using the get_domain_nameservers_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DomainNameserverGetResponse>, Integer, Hash)> get_domain_nameservers_with_http_info(id)

```ruby
begin
  # List registered nameserver hosts and glue IP addresses for a domain
  data, status_code, headers = api_instance.get_domain_nameservers_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DomainNameserverGetResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_nameservers_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_renewal: #{e}"
end
```

#### Using the get_domain_renewal_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_domain_renewal_with_http_info(id)

```ruby
begin
  # Read renewal pricing, expiry, and whether a renewal invoice already exists
  data, status_code, headers = api_instance.get_domain_renewal_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_renewal_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_search: #{e}"
end
```

#### Using the get_domain_search_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DomainSearchResponse>, Integer, Hash)> get_domain_search_with_http_info(name)

```ruby
begin
  # Get registrar-suggested domain alternatives and bulk availability for a search term
  data, status_code, headers = api_instance.get_domain_search_with_http_info(name)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DomainSearchResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_search_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_transfer: #{e}"
end
```

#### Using the get_domain_transfer_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_domain_transfer_with_http_info(id)

```ruby
begin
  # Read OpenSRS transfer status for an in-progress domain transfer order
  data, status_code, headers = api_instance.get_domain_transfer_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_transfer_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domain_whois_privacy: #{e}"
end
```

#### Using the get_domain_whois_privacy_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_domain_whois_privacy_with_http_info(id)

```ruby
begin
  # Read Whois privacy availability, current state, and add-on pricing for a domain
  data, status_code, headers = api_instance.get_domain_whois_privacy_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domain_whois_privacy_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domains_list: #{e}"
end
```

#### Using the get_domains_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<DomainRow>>, Integer, Hash)> get_domains_list_with_http_info

```ruby
begin
  # List every domain registration on the account with billing and registration metadata
  data, status_code, headers = api_instance.get_domains_list_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<DomainRow>>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domains_list_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_domains_welcome_email: #{e}"
end
```

#### Using the get_domains_welcome_email_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_domains_welcome_email_with_http_info(id)

```ruby
begin
  # Resend the domain welcome email with registration details and management instructions
  data, status_code, headers = api_instance.get_domains_welcome_email_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_domains_welcome_email_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->get_new_domain: #{e}"
end
```

#### Using the get_new_domain_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DomainOrder>, Integer, Hash)> get_new_domain_with_http_info

```ruby
begin
  # Read the buyable domain TLD service catalog and Whois privacy pricing
  data, status_code, headers = api_instance.get_new_domain_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DomainOrder>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->get_new_domain_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->patch_domains: #{e}"
end
```

#### Using the patch_domains_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> patch_domains_with_http_info(domain_order_request)

```ruby
begin
  # Validate posted domain-order field values before committing — dry run
  data, status_code, headers = api_instance.patch_domains_with_http_info(domain_order_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->patch_domains_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->post_domain_renewal: #{e}"
end
```

#### Using the post_domain_renewal_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> post_domain_renewal_with_http_info(id)

```ruby
begin
  # Submit a domain renewal request and generate the renewal invoice
  data, status_code, headers = api_instance.post_domain_renewal_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->post_domain_renewal_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->post_domain_search: #{e}"
end
```

#### Using the post_domain_search_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> post_domain_search_with_http_info(name)

```ruby
begin
  # Get the full order form data for a hostname in one round-trip (search → order preview)
  data, status_code, headers = api_instance.post_domain_search_with_http_info(name)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->post_domain_search_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->post_domain_transfer: #{e}"
end
```

#### Using the post_domain_transfer_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> post_domain_transfer_with_http_info(id)

```ruby
begin
  # Re-poll OpenSRS transfer status for a domain order via POST
  data, status_code, headers = api_instance.post_domain_transfer_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->post_domain_transfer_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->put_domains: #{e}"
end
```

#### Using the put_domains_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> put_domains_with_http_info(domain_order_request)

```ruby
begin
  # Preview per-TLD field requirements for a domain order — no commit
  data, status_code, headers = api_instance.put_domains_with_http_info(domain_order_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->put_domains_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::DomainsApi.new
id = 56 # Integer | The domain service ID. Use `domain_id` from `GET /domains`.
domain_contact_details = InterServerClient::DomainContactDetails.new # DomainContactDetails | 

begin
  # Update registrant/admin contact details and push them to OpenSRS
  result = api_instance.update_domain_contact(id, domain_contact_details)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->update_domain_contact: #{e}"
end
```

#### Using the update_domain_contact_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_domain_contact_with_http_info(id, domain_contact_details)

```ruby
begin
  # Update registrant/admin contact details and push them to OpenSRS
  data, status_code, headers = api_instance.update_domain_contact_with_http_info(id, domain_contact_details)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->update_domain_contact_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DomainsApi->update_domain_info: #{e}"
end
```

#### Using the update_domain_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_domain_info_with_http_info(id)

```ruby
begin
  # POST mutation hook for the domain detail page (use dedicated ops where possible)
  data, status_code, headers = api_instance.update_domain_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->update_domain_info_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::DomainsApi.new
id = 56 # Integer | The domain service ID. Use `domain_id` from `GET /domains`.
domain_nameserver_put_request = InterServerClient::DomainNameserverPutRequest.new({nameserver: ['ns1.example.com']}) # DomainNameserverPutRequest | 

begin
  # Replace the full authoritative-nameserver delegation list at the registrar
  result = api_instance.update_domain_nameservers(id, domain_nameserver_put_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->update_domain_nameservers: #{e}"
end
```

#### Using the update_domain_nameservers_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> update_domain_nameservers_with_http_info(id, domain_nameserver_put_request)

```ruby
begin
  # Replace the full authoritative-nameserver delegation list at the registrar
  data, status_code, headers = api_instance.update_domain_nameservers_with_http_info(id, domain_nameserver_put_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->update_domain_nameservers_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::DomainsApi.new
id = 56 # Integer | The domain service ID. Use `domain_id` from `GET /domains`.
domain_whois_privacy_request = InterServerClient::DomainWhoisPrivacyRequest.new # DomainWhoisPrivacyRequest | 

begin
  # Order, enable, or cancel the Whois privacy add-on for a domain
  result = api_instance.update_domain_whois_privacy(id, domain_whois_privacy_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->update_domain_whois_privacy: #{e}"
end
```

#### Using the update_domain_whois_privacy_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_domain_whois_privacy_with_http_info(id, domain_whois_privacy_request)

```ruby
begin
  # Order, enable, or cancel the Whois privacy add-on for a domain
  data, status_code, headers = api_instance.update_domain_whois_privacy_with_http_info(id, domain_whois_privacy_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling DomainsApi->update_domain_whois_privacy_with_http_info: #{e}"
end
```
