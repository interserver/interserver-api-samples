...
> <AddServer200Response> add_server(server_order_post_request)
...
api_instance = InterServerClient::ServersApi.new
server_order_post_request = InterServerClient::ServerOrderPostRequest.new({cpu: 37, hd: nil, memory: 37, bandwidth: 37, ips: 37, os: 37, cp: 37, raid: 37, region: 37, servername: 'servername_example', rootpass: 'rootpass_example', tos: false}) # ServerOrderPostRequest | 

begin
  # Place a custom dedicated server order, creating a real billable invoice
  result = api_instance.add_server(server_order_post_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->add_server: #{e}"
end
```
...
> <Array(<AddServer200Response>, Integer, Hash)> add_server_with_http_info(server_order_post_request)

```ruby
begin
  # Place a custom dedicated server order, creating a real billable invoice
  data, status_code, headers = api_instance.add_server_with_http_info(server_order_post_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <AddServer200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->add_server_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->buy_it_now_server_order: #{e}"
end
```

#### Using the buy_it_now_server_order_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<BuyItNowServerOrder200Response>, Integer, Hash)> buy_it_now_server_order_with_http_info

```ruby
begin
  # Get configurable options for a Rapid Deploy / coupon dedicated server
  data, status_code, headers = api_instance.buy_it_now_server_order_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <BuyItNowServerOrder200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->buy_it_now_server_order_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->get_mp_servers: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->get_mp_servers_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->get_new_server: #{e}"
end
```

#### Using the get_new_server_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ServerOrder>, Integer, Hash)> get_new_server_with_http_info

```ruby
begin
  # Get custom dedicated server ordering options, regions, and pricing
  data, status_code, headers = api_instance.get_new_server_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ServerOrder>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->get_new_server_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->get_server_info: #{e}"
end
```

#### Using the get_server_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Server>, Integer, Hash)> get_server_info_with_http_info(id)

```ruby
begin
  # Get full hardware, network, and lifecycle details for a dedicated server
  data, status_code, headers = api_instance.get_server_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Server>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->get_server_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->get_server_invoices: #{e}"
end
```

#### Using the get_server_invoices_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ChargeInvoiceRows>, Integer, Hash)> get_server_invoices_with_http_info(id)

```ruby
begin
  # List billing invoices (charges + payments) tied to one dedicated server
  data, status_code, headers = api_instance.get_server_invoices_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ChargeInvoiceRows>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->get_server_invoices_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->get_server_list: #{e}"
end
```
...
> <Array(<Array<ServerRow>>, Integer, Hash)> get_server_list_with_http_info
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<ServerRow>>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->get_server_list_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->get_server_reverse_dns: #{e}"
end
```

#### Using the get_server_reverse_dns_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ReverseDnsEntries>, Integer, Hash)> get_server_reverse_dns_with_http_info(id)

```ruby
begin
  # List current reverse-DNS (PTR) records for a dedicated server's IPs
  data, status_code, headers = api_instance.get_server_reverse_dns_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ReverseDnsEntries>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->get_server_reverse_dns_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->get_servers_welcome_email: #{e}"
end
```

#### Using the get_servers_welcome_email_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_servers_welcome_email_with_http_info(id)

```ruby
begin
  # Resend the dedicated server welcome email with setup credentials
  data, status_code, headers = api_instance.get_servers_welcome_email_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->get_servers_welcome_email_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::ServersApi.new
opts = {
  place_buy_now_server_request: InterServerClient::PlaceBuyNowServerRequest.new # PlaceBuyNowServerRequest | 
}
...
begin
  ...
  puts "Error when calling ServersApi->place_buy_now_server: #{e}"
end
```

#### Using the place_buy_now_server_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ServersBuyNowResponse>, Integer, Hash)> place_buy_now_server_with_http_info(opts)

```ruby
begin
  # Place a Rapid Deploy / coupon dedicated server order; creates real invoice
  data, status_code, headers = api_instance.place_buy_now_server_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ServersBuyNowResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->place_buy_now_server_with_http_info: #{e}"
end
```
...
begin
  # Update reverse-DNS (PTR) hostnames on a dedicated server's IPs
  result = api_instance.post_server_reverse_dns(id, reverse_dns_entries)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->post_server_reverse_dns: #{e}"
end
```

#### Using the post_server_reverse_dns_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> post_server_reverse_dns_with_http_info(id, reverse_dns_entries)

```ruby
begin
  # Update reverse-DNS (PTR) hostnames on a dedicated server's IPs
  data, status_code, headers = api_instance.post_server_reverse_dns_with_http_info(id, reverse_dns_entries)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->post_server_reverse_dns_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->server_bulk_ipmi_power_get: #{e}"
end
```

#### Using the server_bulk_ipmi_power_get_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ServerBulkIpmiPowerResponse>, Integer, Hash)> server_bulk_ipmi_power_get_with_http_info(ids)

```ruby
begin
  # Read IPMI chassis power status for many dedicated servers in one call
  data, status_code, headers = api_instance.server_bulk_ipmi_power_get_with_http_info(ids)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ServerBulkIpmiPowerResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->server_bulk_ipmi_power_get_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->server_ipmi_live_get: #{e}"
end
```

#### Using the server_ipmi_live_get_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ServerIpmiLiveInfo>, Integer, Hash)> server_ipmi_live_get_with_http_info(id)

```ruby
begin
  # Read current IPMI Live whitelist + KVM gateway URL for a dedicated server
  data, status_code, headers = api_instance.server_ipmi_live_get_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ServerIpmiLiveInfo>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->server_ipmi_live_get_with_http_info: #{e}"
end
```
...
> <ServerIpmiLiveInfo> server_ipmi_live_post(id, ip, opts)
...
opts = {
  asset: 56 # Integer | Asset ID
}

begin
  # Whitelist an IP for IPMI Live KVM gateway access (3-hour lease)
  result = api_instance.server_ipmi_live_post(id, ip, opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->server_ipmi_live_post: #{e}"
end
```

#### Using the server_ipmi_live_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ServerIpmiLiveInfo>, Integer, Hash)> server_ipmi_live_post_with_http_info(id, ip, opts)

```ruby
begin
  # Whitelist an IP for IPMI Live KVM gateway access (3-hour lease)
  data, status_code, headers = api_instance.server_ipmi_live_post_with_http_info(id, ip, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ServerIpmiLiveInfo>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->server_ipmi_live_post_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->server_ipmi_power_get: #{e}"
end
```

#### Using the server_ipmi_power_get_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> server_ipmi_power_get_with_http_info(id)

```ruby
begin
  # Read IPMI chassis power status for a dedicated server (single)
  data, status_code, headers = api_instance.server_ipmi_power_get_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->server_ipmi_power_get_with_http_info: #{e}"
end
```
...
> <TextResponse> server_ipmi_power_post(id, action, opts)
...
opts = {
  asset: 56 # Integer | The Asset ID
}

begin
  # DESTRUCTIVE — change chassis power state on a bare-metal server
  result = api_instance.server_ipmi_power_post(id, action, opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->server_ipmi_power_post: #{e}"
end
```

#### Using the server_ipmi_power_post_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> server_ipmi_power_post_with_http_info(id, action, opts)

```ruby
begin
  # DESTRUCTIVE — change chassis power state on a bare-metal server
  data, status_code, headers = api_instance.server_ipmi_power_post_with_http_info(id, action, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->server_ipmi_power_post_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->servers_cancel: #{e}"
end
```

#### Using the servers_cancel_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ServersCancel200Response>, Integer, Hash)> servers_cancel_with_http_info(id)

```ruby
begin
  # Cancel a dedicated server service at the end of the current billing cycle
  data, status_code, headers = api_instance.servers_cancel_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ServersCancel200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->servers_cancel_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServersApi->update_server_info: #{e}"
end
```

#### Using the update_server_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_server_info_with_http_info(id)

```ruby
begin
  # Update settings on a dedicated server order (shares handler with view)
  data, status_code, headers = api_instance.update_server_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling ServersApi->update_server_info_with_http_info: #{e}"
end
```
