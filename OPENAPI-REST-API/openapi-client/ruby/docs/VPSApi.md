# InterServerClient::VPSApi

All URIs are relative to *https://my.interserver.net/apiv2*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**add_vps**](VPSApi.md#add_vps) | **POST** /vps/order | Place a new VPS order, create the invoice, and queue provisioning |
| [**delete_vps_backup**](VPSApi.md#delete_vps_backup) | **DELETE** /vps/{id}/backups | Permanently delete a VPS backup file by name (irreversible) |
| [**do_vps_block_smtp**](VPSApi.md#do_vps_block_smtp) | **GET** /vps/{id}/block_smtp | Block outbound SMTP (port 25) on the VPS to prevent spam/abuse |
| [**do_vps_disable_cd**](VPSApi.md#do_vps_disable_cd) | **GET** /vps/{id}/disable_cd | Remove the virtual CD/DVD device entirely from the VPS configuration |
| [**do_vps_disable_quota**](VPSApi.md#do_vps_disable_quota) | **GET** /vps/{id}/disable_quota | Disable per-user disk quota enforcement inside the VPS guest OS |
| [**do_vps_eject_cd**](VPSApi.md#do_vps_eject_cd) | **GET** /vps/{id}/eject_cd | Eject the mounted ISO from the VPS virtual CD drive (keep the drive) |
| [**do_vps_enable_quota**](VPSApi.md#do_vps_enable_quota) | **GET** /vps/{id}/enable_quota | Enable per-user disk quota enforcement inside the VPS guest OS |
| [**do_vps_restart**](VPSApi.md#do_vps_restart) | **GET** /vps/{id}/restart | Reboot the VPS — preferred over stop+start for software changes |
| [**do_vps_start**](VPSApi.md#do_vps_start) | **GET** /vps/{id}/start | Power on a stopped VPS instance |
| [**do_vps_stop**](VPSApi.md#do_vps_stop) | **GET** /vps/{id}/stop | Power off a running VPS — billing continues until cancellation |
| [**download_vps_backup**](VPSApi.md#download_vps_backup) | **PATCH** /vps/{id}/backups | Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup |
| [**get_new_vps**](VPSApi.md#get_new_vps) | **GET** /vps/order | Get the VPS order catalog — platforms, OS templates, locations, pricing |
| [**get_vps_backup**](VPSApi.md#get_vps_backup) | **GET** /vps/{id}/backup | Trigger a manual on-demand snapshot/backup of the VPS |
| [**get_vps_backups**](VPSApi.md#get_vps_backups) | **GET** /vps/{id}/backups | List existing backups for the VPS across Swift, MinIO, and ZFS |
| [**get_vps_buy_hd_space**](VPSApi.md#get_vps_buy_hd_space) | **GET** /vps/{id}/buy_hd_space | Get current additional disk size and per-GB monthly cost for the VPS |
| [**get_vps_buy_ip**](VPSApi.md#get_vps_buy_ip) | **GET** /vps/{id}/buy_ip | Read current additional IPs, cap, and per-IP monthly cost for the VPS |
| [**get_vps_change_hostname**](VPSApi.md#get_vps_change_hostname) | **GET** /vps/{id}/change_hostname | Read the VPS&#39;s current hostname before changing it |
| [**get_vps_change_root_password**](VPSApi.md#get_vps_change_root_password) | **GET** /vps/{id}/change_root_password | Pre-flight check before changing the VPS root password |
| [**get_vps_change_timezone**](VPSApi.md#get_vps_change_timezone) | **GET** /vps/{id}/change_timezone | List IANA timezones supported by the VPS guest OS |
| [**get_vps_info**](VPSApi.md#get_vps_info) | **GET** /vps/{id} | Get full details for one VPS — IPs, hostname, OS, slices, status, addons |
| [**get_vps_insert_cd**](VPSApi.md#get_vps_insert_cd) | **GET** /vps/{id}/insert_cd | List ISO templates that can be mounted in the VPS virtual CD drive |
| [**get_vps_invoices**](VPSApi.md#get_vps_invoices) | **GET** /vps/{id}/invoices | List all billing invoices associated with this specific VPS |
| [**get_vps_list**](VPSApi.md#get_vps_list) | **GET** /vps | List all VPS services on the customer&#39;s account |
| [**get_vps_reinstall_os**](VPSApi.md#get_vps_reinstall_os) | **GET** /vps/{id}/reinstall_os | List OS templates compatible with this VPS&#39;s hypervisor for reinstall |
| [**get_vps_reset_password**](VPSApi.md#get_vps_reset_password) | **GET** /vps/{id}/reset_password | Pre-flight check before resetting the VPS root password to a random value |
| [**get_vps_reverse_dns**](VPSApi.md#get_vps_reverse_dns) | **GET** /vps/{id}/reverse_dns | Read the current PTR (reverse-DNS) records for every IP on the VPS |
| [**get_vps_setup_vnc**](VPSApi.md#get_vps_setup_vnc) | **GET** /vps/{id}/setup_vnc | Read current VNC console connection info for the VPS |
| [**get_vps_slices**](VPSApi.md#get_vps_slices) | **GET** /vps/{id}/slices | Read current slice count, min/max range, and prorated per-slice upgrade cost |
| [**get_vps_traffic_usage**](VPSApi.md#get_vps_traffic_usage) | **GET** /vps/{id}/traffic_usage | Read bandwidth traffic usage data for the VPS |
| [**get_vps_view_desktop**](VPSApi.md#get_vps_view_desktop) | **GET** /vps/{id}/view_desktop | Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS |
| [**get_vps_welcome_email**](VPSApi.md#get_vps_welcome_email) | **GET** /vps/{id}/welcome_email | Resend the welcome email containing VPS IP, hostname, and root credentials |
| [**post_vps_buy_hd_space**](VPSApi.md#post_vps_buy_hd_space) | **POST** /vps/{id}/buy_hd_space | Buy or resize the VPS additional-disk addon and create a prorated invoice |
| [**post_vps_buy_ip**](VPSApi.md#post_vps_buy_ip) | **POST** /vps/{id}/buy_ip | Purchase one additional IP for the VPS and create the invoice |
| [**post_vps_change_hostname**](VPSApi.md#post_vps_change_hostname) | **POST** /vps/{id}/change_hostname | Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP |
| [**post_vps_change_root_password**](VPSApi.md#post_vps_change_root_password) | **POST** /vps/{id}/change_root_password | Set a specific new root/Administrator password on the VPS |
| [**post_vps_change_timezone**](VPSApi.md#post_vps_change_timezone) | **POST** /vps/{id}/change_timezone | Set the system timezone on the VPS guest OS |
| [**post_vps_change_webuzo_password**](VPSApi.md#post_vps_change_webuzo_password) | **POST** /vps/{id}/change_webuzo_password | Rotate the Webuzo control panel admin password (re-auth required) |
| [**post_vps_insert_cd**](VPSApi.md#post_vps_insert_cd) | **POST** /vps/{id}/insert_cd | Mount an ISO image in the VPS virtual CD drive from a URL |
| [**post_vps_reinstall_os**](VPSApi.md#post_vps_reinstall_os) | **POST** /vps/{id}/reinstall_os | Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth) |
| [**post_vps_reset_password**](VPSApi.md#post_vps_reset_password) | **POST** /vps/{id}/reset_password | Reset the VPS root password to a server-generated random value |
| [**post_vps_restore**](VPSApi.md#post_vps_restore) | **POST** /vps/{id}/restore | Restore the VPS from a backup (DESTRUCTIVE — overwrites disk) |
| [**post_vps_reverse_dns**](VPSApi.md#post_vps_reverse_dns) | **POST** /vps/{id}/reverse_dns | Bulk-update PTR (reverse-DNS) records for one or more VPS IPs |
| [**post_vps_setup_vnc**](VPSApi.md#post_vps_setup_vnc) | **POST** /vps/{id}/setup_vnc | Provision or refresh the VNC console endpoint for the VPS |
| [**post_vps_slices**](VPSApi.md#post_vps_slices) | **POST** /vps/{id}/slices | Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade) |
| [**post_vps_traffic_usage**](VPSApi.md#post_vps_traffic_usage) | **POST** /vps/{id}/traffic_usage | Search/filter VPS bandwidth usage with custom criteria (reserved) |
| [**post_vps_view_desktop**](VPSApi.md#post_vps_view_desktop) | **POST** /vps/{id}/view_desktop | Refresh the remote-desktop session connection info after IP/hostname changes |
| [**put_vps**](VPSApi.md#put_vps) | **PUT** /vps/order | Validate a VPS order configuration and quote the cost — dry run, no charge |
| [**put_vps_buy_hd_space**](VPSApi.md#put_vps_buy_hd_space) | **PUT** /vps/{id}/buy_hd_space | Preview cost to set additional VPS disk to a target GB size — dry run |
| [**update_vps_info**](VPSApi.md#update_vps_info) | **POST** /vps/{id} | Update editable settings on a VPS service record |
| [**v_ps_cancel**](VPSApi.md#v_ps_cancel) | **DELETE** /vps/{id} | Cancel a VPS service at the end of the current billing cycle |
...
api_instance = InterServerClient::VPSApi.new
opts = {
  vps_order_post_request: InterServerClient::VpsOrderPostRequest.new({os_distro: 'os_distro_example', slices: 37, vps_platform: 'kvm', period: 37, location: 37, os_version: 'os_version_example', hostname: 'hostname_example', rootpass: 'rootpass_example'}) # VpsOrderPostRequest | 
}
...
begin
  ...
  puts "Error when calling VPSApi->add_vps: #{e}"
end
```

#### Using the add_vps_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ServiceOrderPostResponse>, Integer, Hash)> add_vps_with_http_info(opts)

```ruby
begin
  # Place a new VPS order, create the invoice, and queue provisioning
  data, status_code, headers = api_instance.add_vps_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ServiceOrderPostResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->add_vps_with_http_info: #{e}"
end
```
...
opts = {
  all: '0' # String | Set to `1` to list all backups across all services, not just the ones for the given VPS.
}
...
begin
  ...
  puts "Error when calling VPSApi->delete_vps_backup: #{e}"
end
```

#### Using the delete_vps_backup_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> delete_vps_backup_with_http_info(id, file, opts)

```ruby
begin
  # Permanently delete a VPS backup file by name (irreversible)
  data, status_code, headers = api_instance.delete_vps_backup_with_http_info(id, file, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->delete_vps_backup_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->do_vps_block_smtp: #{e}"
end
```

#### Using the do_vps_block_smtp_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> do_vps_block_smtp_with_http_info(id)

```ruby
begin
  # Block outbound SMTP (port 25) on the VPS to prevent spam/abuse
  data, status_code, headers = api_instance.do_vps_block_smtp_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->do_vps_block_smtp_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->do_vps_disable_cd: #{e}"
end
```

#### Using the do_vps_disable_cd_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> do_vps_disable_cd_with_http_info(id)

```ruby
begin
  # Remove the virtual CD/DVD device entirely from the VPS configuration
  data, status_code, headers = api_instance.do_vps_disable_cd_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->do_vps_disable_cd_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->do_vps_disable_quota: #{e}"
end
```

#### Using the do_vps_disable_quota_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> do_vps_disable_quota_with_http_info(id)

```ruby
begin
  # Disable per-user disk quota enforcement inside the VPS guest OS
  data, status_code, headers = api_instance.do_vps_disable_quota_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->do_vps_disable_quota_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->do_vps_eject_cd: #{e}"
end
```

#### Using the do_vps_eject_cd_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> do_vps_eject_cd_with_http_info(id)

```ruby
begin
  # Eject the mounted ISO from the VPS virtual CD drive (keep the drive)
  data, status_code, headers = api_instance.do_vps_eject_cd_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->do_vps_eject_cd_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->do_vps_enable_quota: #{e}"
end
```

#### Using the do_vps_enable_quota_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> do_vps_enable_quota_with_http_info(id)

```ruby
begin
  # Enable per-user disk quota enforcement inside the VPS guest OS
  data, status_code, headers = api_instance.do_vps_enable_quota_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->do_vps_enable_quota_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->do_vps_restart: #{e}"
end
```

#### Using the do_vps_restart_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> do_vps_restart_with_http_info(id)

```ruby
begin
  # Reboot the VPS — preferred over stop+start for software changes
  data, status_code, headers = api_instance.do_vps_restart_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->do_vps_restart_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->do_vps_start: #{e}"
end
```

#### Using the do_vps_start_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> do_vps_start_with_http_info(id)

```ruby
begin
  # Power on a stopped VPS instance
  data, status_code, headers = api_instance.do_vps_start_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->do_vps_start_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->do_vps_stop: #{e}"
end
```

#### Using the do_vps_stop_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> do_vps_stop_with_http_info(id)

```ruby
begin
  # Power off a running VPS — billing continues until cancellation
  data, status_code, headers = api_instance.do_vps_stop_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->do_vps_stop_with_http_info: #{e}"
end
```
...
> <DownloadQsBackup200Response> download_vps_backup(id, download_qs_backup_request, opts)
...
begin
  # Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
  result = api_instance.download_vps_backup(id, download_qs_backup_request, opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->download_vps_backup: #{e}"
end
```

#### Using the download_vps_backup_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<DownloadQsBackup200Response>, Integer, Hash)> download_vps_backup_with_http_info(id, download_qs_backup_request, opts)

```ruby
begin
  # Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
  data, status_code, headers = api_instance.download_vps_backup_with_http_info(id, download_qs_backup_request, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DownloadQsBackup200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->download_vps_backup_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_new_vps: #{e}"
end
```

#### Using the get_new_vps_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VpsOrder>, Integer, Hash)> get_new_vps_with_http_info

```ruby
begin
  # Get the VPS order catalog — platforms, OS templates, locations, pricing
  data, status_code, headers = api_instance.get_new_vps_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VpsOrder>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_new_vps_with_http_info: #{e}"
end
```
...
> <QueueResponse> get_vps_backup(id)
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_backup: #{e}"
end
```

#### Using the get_vps_backup_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> get_vps_backup_with_http_info(id)

```ruby
begin
  # Trigger a manual on-demand snapshot/backup of the VPS
  data, status_code, headers = api_instance.get_vps_backup_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_backup_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_backups: #{e}"
end
```

#### Using the get_vps_backups_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VpsBackupRows>, Integer, Hash)> get_vps_backups_with_http_info(id, opts)

```ruby
begin
  # List existing backups for the VPS across Swift, MinIO, and ZFS
  data, status_code, headers = api_instance.get_vps_backups_with_http_info(id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VpsBackupRows>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_backups_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_buy_hd_space: #{e}"
end
```

#### Using the get_vps_buy_hd_space_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_vps_buy_hd_space_with_http_info(id)

```ruby
begin
  # Get current additional disk size and per-GB monthly cost for the VPS
  data, status_code, headers = api_instance.get_vps_buy_hd_space_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_buy_hd_space_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_buy_ip: #{e}"
end
```

#### Using the get_vps_buy_ip_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_vps_buy_ip_with_http_info(id)

```ruby
begin
  # Read current additional IPs, cap, and per-IP monthly cost for the VPS
  data, status_code, headers = api_instance.get_vps_buy_ip_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_buy_ip_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_change_hostname: #{e}"
end
```

#### Using the get_vps_change_hostname_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_vps_change_hostname_with_http_info(id)

```ruby
begin
  # Read the VPS's current hostname before changing it
  data, status_code, headers = api_instance.get_vps_change_hostname_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_change_hostname_with_http_info: #{e}"
end
```
...
> get_vps_change_root_password(id)
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_change_root_password: #{e}"
end
```

#### Using the get_vps_change_root_password_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_vps_change_root_password_with_http_info(id)

```ruby
begin
  # Pre-flight check before changing the VPS root password
  data, status_code, headers = api_instance.get_vps_change_root_password_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_change_root_password_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_change_timezone: #{e}"
end
```

#### Using the get_vps_change_timezone_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(Array&lt;String&gt;, Integer, Hash)> get_vps_change_timezone_with_http_info(id)

```ruby
begin
  # List IANA timezones supported by the VPS guest OS
  data, status_code, headers = api_instance.get_vps_change_timezone_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Array&lt;String&gt;
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_change_timezone_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_info: #{e}"
end
```

#### Using the get_vps_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Vps>, Integer, Hash)> get_vps_info_with_http_info(id)

```ruby
begin
  # Get full details for one VPS — IPs, hostname, OS, slices, status, addons
  data, status_code, headers = api_instance.get_vps_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Vps>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_insert_cd: #{e}"
end
```

#### Using the get_vps_insert_cd_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_vps_insert_cd_with_http_info(id)

```ruby
begin
  # List ISO templates that can be mounted in the VPS virtual CD drive
  data, status_code, headers = api_instance.get_vps_insert_cd_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_insert_cd_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_invoices: #{e}"
end
```

#### Using the get_vps_invoices_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ChargeInvoiceRows>, Integer, Hash)> get_vps_invoices_with_http_info(id)

```ruby
begin
  # List all billing invoices associated with this specific VPS
  data, status_code, headers = api_instance.get_vps_invoices_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ChargeInvoiceRows>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_invoices_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_list: #{e}"
end
```

#### Using the get_vps_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<VpsRow>>, Integer, Hash)> get_vps_list_with_http_info

```ruby
begin
  # List all VPS services on the customer's account
  data, status_code, headers = api_instance.get_vps_list_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<VpsRow>>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_list_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_reinstall_os: #{e}"
end
```

#### Using the get_vps_reinstall_os_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VpsTemplatesList>, Integer, Hash)> get_vps_reinstall_os_with_http_info(id)

```ruby
begin
  # List OS templates compatible with this VPS's hypervisor for reinstall
  data, status_code, headers = api_instance.get_vps_reinstall_os_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VpsTemplatesList>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_reinstall_os_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_reset_password: #{e}"
end
```

#### Using the get_vps_reset_password_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_vps_reset_password_with_http_info(id)

```ruby
begin
  # Pre-flight check before resetting the VPS root password to a random value
  data, status_code, headers = api_instance.get_vps_reset_password_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_reset_password_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_reverse_dns: #{e}"
end
```

#### Using the get_vps_reverse_dns_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ReverseDnsEntries>, Integer, Hash)> get_vps_reverse_dns_with_http_info(id)

```ruby
begin
  # Read the current PTR (reverse-DNS) records for every IP on the VPS
  data, status_code, headers = api_instance.get_vps_reverse_dns_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ReverseDnsEntries>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_reverse_dns_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_setup_vnc: #{e}"
end
```

#### Using the get_vps_setup_vnc_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_vps_setup_vnc_with_http_info(id)

```ruby
begin
  # Read current VNC console connection info for the VPS
  data, status_code, headers = api_instance.get_vps_setup_vnc_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_setup_vnc_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_slices: #{e}"
end
```

#### Using the get_vps_slices_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_vps_slices_with_http_info(id)

```ruby
begin
  # Read current slice count, min/max range, and prorated per-slice upgrade cost
  data, status_code, headers = api_instance.get_vps_slices_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_slices_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_traffic_usage: #{e}"
end
```

#### Using the get_vps_traffic_usage_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VpsTrafficResponse>, Integer, Hash)> get_vps_traffic_usage_with_http_info(id)

```ruby
begin
  # Read bandwidth traffic usage data for the VPS
  data, status_code, headers = api_instance.get_vps_traffic_usage_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VpsTrafficResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_traffic_usage_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_view_desktop: #{e}"
end
```

#### Using the get_vps_view_desktop_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_vps_view_desktop_with_http_info(id)

```ruby
begin
  # Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS
  data, status_code, headers = api_instance.get_vps_view_desktop_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_view_desktop_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->get_vps_welcome_email: #{e}"
end
```

#### Using the get_vps_welcome_email_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_vps_welcome_email_with_http_info(id)

```ruby
begin
  # Resend the welcome email containing VPS IP, hostname, and root credentials
  data, status_code, headers = api_instance.get_vps_welcome_email_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->get_vps_welcome_email_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->post_vps_buy_hd_space: #{e}"
end
```

#### Using the post_vps_buy_hd_space_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> post_vps_buy_hd_space_with_http_info(id)

```ruby
begin
  # Buy or resize the VPS additional-disk addon and create a prorated invoice
  data, status_code, headers = api_instance.post_vps_buy_hd_space_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_buy_hd_space_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->post_vps_buy_ip: #{e}"
end
```

#### Using the post_vps_buy_ip_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> post_vps_buy_ip_with_http_info(id)

```ruby
begin
  # Purchase one additional IP for the VPS and create the invoice
  data, status_code, headers = api_instance.post_vps_buy_ip_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_buy_ip_with_http_info: #{e}"
end
```
...
> <QueueResponse> post_vps_change_hostname(id, opts)
...
begin
  # Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP
  result = api_instance.post_vps_change_hostname(id, opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_change_hostname: #{e}"
end
```

#### Using the post_vps_change_hostname_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> post_vps_change_hostname_with_http_info(id, opts)

```ruby
begin
  # Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP
  data, status_code, headers = api_instance.post_vps_change_hostname_with_http_info(id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_change_hostname_with_http_info: #{e}"
end
```
...
begin
  # Set a specific new root/Administrator password on the VPS
  result = api_instance.post_vps_change_root_password(id, password)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_change_root_password: #{e}"
end
```

#### Using the post_vps_change_root_password_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> post_vps_change_root_password_with_http_info(id, password)

```ruby
begin
  # Set a specific new root/Administrator password on the VPS
  data, status_code, headers = api_instance.post_vps_change_root_password_with_http_info(id, password)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_change_root_password_with_http_info: #{e}"
end
```
...
begin
  # Set the system timezone on the VPS guest OS
  result = api_instance.post_vps_change_timezone(id, timezone)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_change_timezone: #{e}"
end
```

#### Using the post_vps_change_timezone_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> post_vps_change_timezone_with_http_info(id, timezone)

```ruby
begin
  # Set the system timezone on the VPS guest OS
  data, status_code, headers = api_instance.post_vps_change_timezone_with_http_info(id, timezone)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_change_timezone_with_http_info: #{e}"
end
```
...
begin
  # Rotate the Webuzo control panel admin password (re-auth required)
  result = api_instance.post_vps_change_webuzo_password(id, password)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_change_webuzo_password: #{e}"
end
```

#### Using the post_vps_change_webuzo_password_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> post_vps_change_webuzo_password_with_http_info(id, password)

```ruby
begin
  # Rotate the Webuzo control panel admin password (re-auth required)
  data, status_code, headers = api_instance.post_vps_change_webuzo_password_with_http_info(id, password)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_change_webuzo_password_with_http_info: #{e}"
end
```
...
> <QueueResponse> post_vps_insert_cd(id, opts)
...
begin
  # Mount an ISO image in the VPS virtual CD drive from a URL
  result = api_instance.post_vps_insert_cd(id, opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_insert_cd: #{e}"
end
```

#### Using the post_vps_insert_cd_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> post_vps_insert_cd_with_http_info(id, opts)

```ruby
begin
  # Mount an ISO image in the VPS virtual CD drive from a URL
  data, status_code, headers = api_instance.post_vps_insert_cd_with_http_info(id, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_insert_cd_with_http_info: #{e}"
end
```
...
> <QueueResponse> post_vps_reinstall_os(id, template, local_password, opts)
...
begin
  # Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)
  result = api_instance.post_vps_reinstall_os(id, template, local_password, opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_reinstall_os: #{e}"
end
```

#### Using the post_vps_reinstall_os_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> post_vps_reinstall_os_with_http_info(id, template, local_password, opts)

```ruby
begin
  # Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)
  data, status_code, headers = api_instance.post_vps_reinstall_os_with_http_info(id, template, local_password, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_reinstall_os_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->post_vps_reset_password: #{e}"
end
```

#### Using the post_vps_reset_password_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> post_vps_reset_password_with_http_info(id)

```ruby
begin
  # Reset the VPS root password to a server-generated random value
  data, status_code, headers = api_instance.post_vps_reset_password_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_reset_password_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::VPSApi.new
id = 56 # Integer | VPS ID number
restore_request = InterServerClient::RestoreRequest.new # RestoreRequest | VPS Restore request

begin
  # Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
  result = api_instance.post_vps_restore(id, restore_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_restore: #{e}"
end
```

#### Using the post_vps_restore_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> post_vps_restore_with_http_info(id, restore_request)

```ruby
begin
  # Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
  data, status_code, headers = api_instance.post_vps_restore_with_http_info(id, restore_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_restore_with_http_info: #{e}"
end
```
...
begin
  # Bulk-update PTR (reverse-DNS) records for one or more VPS IPs
  result = api_instance.post_vps_reverse_dns(id, reverse_dns_entries)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_reverse_dns: #{e}"
end
```

#### Using the post_vps_reverse_dns_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> post_vps_reverse_dns_with_http_info(id, reverse_dns_entries)

```ruby
begin
  # Bulk-update PTR (reverse-DNS) records for one or more VPS IPs
  data, status_code, headers = api_instance.post_vps_reverse_dns_with_http_info(id, reverse_dns_entries)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_reverse_dns_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->post_vps_setup_vnc: #{e}"
end
```

#### Using the post_vps_setup_vnc_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<QueueResponse>, Integer, Hash)> post_vps_setup_vnc_with_http_info(id)

```ruby
begin
  # Provision or refresh the VNC console endpoint for the VPS
  data, status_code, headers = api_instance.post_vps_setup_vnc_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <QueueResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_setup_vnc_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->post_vps_slices: #{e}"
end
```

#### Using the post_vps_slices_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> post_vps_slices_with_http_info(id)

```ruby
begin
  # Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)
  data, status_code, headers = api_instance.post_vps_slices_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_slices_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->post_vps_traffic_usage: #{e}"
end
```

#### Using the post_vps_traffic_usage_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> post_vps_traffic_usage_with_http_info(id)

```ruby
begin
  # Search/filter VPS bandwidth usage with custom criteria (reserved)
  data, status_code, headers = api_instance.post_vps_traffic_usage_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_traffic_usage_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->post_vps_view_desktop: #{e}"
end
```

#### Using the post_vps_view_desktop_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> post_vps_view_desktop_with_http_info(id)

```ruby
begin
  # Refresh the remote-desktop session connection info after IP/hostname changes
  data, status_code, headers = api_instance.post_vps_view_desktop_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->post_vps_view_desktop_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::VPSApi.new
opts = {
  vps_order_put_request: InterServerClient::VpsOrderPutRequest.new({os_distro: 'os_distro_example', slices: 37, vps_platform: 'kvm', period: 37, location: 37, os_version: 'os_version_example', hostname: 'hostname_example', rootpass: 'rootpass_example'}) # VpsOrderPutRequest | 
}
...
begin
  ...
  puts "Error when calling VPSApi->put_vps: #{e}"
end
```

#### Using the put_vps_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VpsOrderPutResponse>, Integer, Hash)> put_vps_with_http_info(opts)

```ruby
begin
  # Validate a VPS order configuration and quote the cost — dry run, no charge
  data, status_code, headers = api_instance.put_vps_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VpsOrderPutResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->put_vps_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->put_vps_buy_hd_space: #{e}"
end
```

#### Using the put_vps_buy_hd_space_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> put_vps_buy_hd_space_with_http_info(id)

```ruby
begin
  # Preview cost to set additional VPS disk to a target GB size — dry run
  data, status_code, headers = api_instance.put_vps_buy_hd_space_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->put_vps_buy_hd_space_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->update_vps_info: #{e}"
end
```

#### Using the update_vps_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_vps_info_with_http_info(id)

```ruby
begin
  # Update editable settings on a VPS service record
  data, status_code, headers = api_instance.update_vps_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->update_vps_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VPSApi->v_ps_cancel: #{e}"
end
```

#### Using the v_ps_cancel_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VPSCancel200Response>, Integer, Hash)> v_ps_cancel_with_http_info(id)

```ruby
begin
  # Cancel a VPS service at the end of the current billing cycle
  data, status_code, headers = api_instance.v_ps_cancel_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VPSCancel200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling VPSApi->v_ps_cancel_with_http_info: #{e}"
end
```
