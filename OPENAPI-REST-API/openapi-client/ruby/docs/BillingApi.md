...
api_instance = InterServerClient::BillingApi.new
billing_add_cc_request = InterServerClient::BillingAddCcRequest.new # BillingAddCcRequest | 

begin
  # Store a credit card on the account — may return a verification flow
  result = api_instance.add_billing_credit_card(billing_add_cc_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->add_billing_credit_card: #{e}"
end
```

#### Using the add_billing_credit_card_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> add_billing_credit_card_with_http_info(billing_add_cc_request)

```ruby
begin
  # Store a credit card on the account — may return a verification flow
  data, status_code, headers = api_instance.add_billing_credit_card_with_http_info(billing_add_cc_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->add_billing_credit_card_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::BillingApi.new
billing_prepay_request = InterServerClient::BillingPrepayRequest.new # BillingPrepayRequest | 

begin
  # Create a prepay deposit and return an invoice id to fund it
  result = api_instance.add_billing_prepay(billing_prepay_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->add_billing_prepay: #{e}"
end
```

#### Using the add_billing_prepay_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> add_billing_prepay_with_http_info(billing_prepay_request)

```ruby
begin
  # Create a prepay deposit and return an invoice id to fund it
  data, status_code, headers = api_instance.add_billing_prepay_with_http_info(billing_prepay_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->add_billing_prepay_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->delete_billing_credit_card: #{e}"
end
```

#### Using the delete_billing_credit_card_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> delete_billing_credit_card_with_http_info(id)

```ruby
begin
  # Remove a stored credit card from the account
  data, status_code, headers = api_instance.delete_billing_credit_card_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->delete_billing_credit_card_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->delete_billing_invoice: #{e}"
end
```

#### Using the delete_billing_invoice_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> delete_billing_invoice_with_http_info(id)

```ruby
begin
  # Cancel a pending unpaid invoice — and its pending service or repeat invoice
  data, status_code, headers = api_instance.delete_billing_invoice_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->delete_billing_invoice_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->delete_billing_prepay: #{e}"
end
```

#### Using the delete_billing_prepay_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> delete_billing_prepay_with_http_info(id)

```ruby
begin
  # Delete an unfunded prepay or strip its unpaid funding invoices
  data, status_code, headers = api_instance.delete_billing_prepay_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->delete_billing_prepay_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->get_affiliate_banners: #{e}"
end
```

#### Using the get_affiliate_banners_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<AffiliateBannerRow>>, Integer, Hash)> get_affiliate_banners_with_http_info

```ruby
begin
  # List affiliate banner image assets with filename and dimensions
  data, status_code, headers = api_instance.get_affiliate_banners_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<AffiliateBannerRow>>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_affiliate_banners_with_http_info: #{e}"
end
```
...
opts = {
  ...
  ex: 'csv', # String | Export format: csv, xls, xlsx, or pdf. Defaults to csv.
...
begin
  ...
  puts "Error when calling BillingApi->get_affiliate_download: #{e}"
end
```

#### Using the get_affiliate_download_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> get_affiliate_download_with_http_info(opts)

```ruby
begin
  # Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
  data, status_code, headers = api_instance.get_affiliate_download_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_affiliate_download_with_http_info: #{e}"
end
```
...
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **st** | **String** | Filter by status. | [optional] |
| **ex** | **String** | Export format: csv, xls, xlsx, or pdf. Defaults to csv. | [optional] |
| **year** | **Integer** | Year to filter the report. Defaults to the current year. | [optional] |
...
begin
  ...
  puts "Error when calling BillingApi->get_affiliate_rich_report: #{e}"
end
```

#### Using the get_affiliate_rich_report_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> get_affiliate_rich_report_with_http_info

```ruby
begin
  # Read a combined affiliate performance summary (HTML payload)
  data, status_code, headers = api_instance.get_affiliate_rich_report_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_affiliate_rich_report_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->get_affiliate_sales_graph: #{e}"
end
```

#### Using the get_affiliate_sales_graph_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<StatusMonthlyBreakdown>, Integer, Hash)> get_affiliate_sales_graph_with_http_info(opts)

```ruby
begin
  # Read aggregated affiliate sales time-series (monthly buckets) for chart rendering
  data, status_code, headers = api_instance.get_affiliate_sales_graph_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <StatusMonthlyBreakdown>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_affiliate_sales_graph_with_http_info: #{e}"
end
```
...
> <GetAffiliateSignups200Response> get_affiliate_signups(opts)
...
begin
  ...
  puts "Error when calling BillingApi->get_affiliate_signups: #{e}"
end
```

#### Using the get_affiliate_signups_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetAffiliateSignups200Response>, Integer, Hash)> get_affiliate_signups_with_http_info(opts)

```ruby
begin
  # Read affiliate signup stats and per-customer conversion data
  data, status_code, headers = api_instance.get_affiliate_signups_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetAffiliateSignups200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_affiliate_signups_with_http_info: #{e}"
end
```
...
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **st** | **String** | Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. | [optional] |
...
begin
  ...
  puts "Error when calling BillingApi->get_affiliate_traffic_graph: #{e}"
end
```

#### Using the get_affiliate_traffic_graph_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<MonthlyCounts>, Integer, Hash)> get_affiliate_traffic_graph_with_http_info(opts)

```ruby
begin
  # Read aggregated affiliate referral click/visit time-series for chart rendering
  data, status_code, headers = api_instance.get_affiliate_traffic_graph_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <MonthlyCounts>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_affiliate_traffic_graph_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->get_affiliate_web_traffic: #{e}"
end
```

#### Using the get_affiliate_web_traffic_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<AffiliateTrafficRow>>, Integer, Hash)> get_affiliate_web_traffic_with_http_info

```ruby
begin
  # List the 20 most recent affiliate referral visits with IP, referrer, timestamp
  data, status_code, headers = api_instance.get_affiliate_web_traffic_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<AffiliateTrafficRow>>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_affiliate_web_traffic_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->get_billing_cart: #{e}"
end
```

#### Using the get_billing_cart_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(Object, Integer, Hash)> get_billing_cart_with_http_info

```ruby
begin
  # Read the current shopping cart contents, totals, and available payment methods
  data, status_code, headers = api_instance.get_billing_cart_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Object
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_billing_cart_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->get_billing_credit_card_verify: #{e}"
end
```

#### Using the get_billing_credit_card_verify_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_billing_credit_card_verify_with_http_info(id)

```ruby
begin
  # Probe whether a stored card still needs micro-charge verification
  data, status_code, headers = api_instance.get_billing_credit_card_verify_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_billing_credit_card_verify_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->get_billing_invoice: #{e}"
end
```

#### Using the get_billing_invoice_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<BillingInvoiceDetail>, Integer, Hash)> get_billing_invoice_with_http_info(id)

```ruby
begin
  # Read full invoice detail — line items, totals, paid status, customer info
  data, status_code, headers = api_instance.get_billing_invoice_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <BillingInvoiceDetail>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_billing_invoice_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->get_billing_invoices: #{e}"
end
```

#### Using the get_billing_invoices_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<BillingInvoiceList>, Integer, Hash)> get_billing_invoices_with_http_info

```ruby
begin
  # List every invoice on the account with summary totals and paid/unpaid status
  data, status_code, headers = api_instance.get_billing_invoices_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <BillingInvoiceList>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_billing_invoices_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->get_billing_pre_pays: #{e}"
end
```

#### Using the get_billing_pre_pays_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(Object, Integer, Hash)> get_billing_pre_pays_with_http_info

```ruby
begin
  # List prepay deposits on the account — remaining balance and auto-use flags
  data, status_code, headers = api_instance.get_billing_pre_pays_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => Object
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->get_billing_pre_pays_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->initiate_payment: #{e}"
end
```

#### Using the initiate_payment_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<InitiatePayment200Response>, Integer, Hash)> initiate_payment_with_http_info(method, invoices)

```ruby
begin
  # Pay invoices through the chosen gateway — returns the next-step action
  data, status_code, headers = api_instance.initiate_payment_with_http_info(method, invoices)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <InitiatePayment200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->initiate_payment_with_http_info: #{e}"
end
```
...
> <SuccessTextResponse> patch_billing_credit_card_verify(id, patch_billing_credit_card_verify_request)
...
api_instance = InterServerClient::BillingApi.new
id = 56 # Integer | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
patch_billing_credit_card_verify_request = InterServerClient::PatchBillingCreditCardVerifyRequest.new({cc_ccv2: 'cc_ccv2_example'}) # PatchBillingCreditCardVerifyRequest | 

begin
  # Place two micro-charges on the card to start CVV verification (step 1 of 2)
  result = api_instance.patch_billing_credit_card_verify(id, patch_billing_credit_card_verify_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->patch_billing_credit_card_verify: #{e}"
end
```

#### Using the patch_billing_credit_card_verify_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> patch_billing_credit_card_verify_with_http_info(id, patch_billing_credit_card_verify_request)

```ruby
begin
  # Place two micro-charges on the card to start CVV verification (step 1 of 2)
  data, status_code, headers = api_instance.patch_billing_credit_card_verify_with_http_info(id, patch_billing_credit_card_verify_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->patch_billing_credit_card_verify_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::BillingApi.new
id = 56 # Integer | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
billing_verify_cc_request = InterServerClient::BillingVerifyCcRequest.new # BillingVerifyCcRequest | 

begin
  # Submit two micro-charge amounts to finalize card verification (step 2 of 2)
  result = api_instance.post_billing_credit_card_verify(id, billing_verify_cc_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->post_billing_credit_card_verify: #{e}"
end
```

#### Using the post_billing_credit_card_verify_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> post_billing_credit_card_verify_with_http_info(id, billing_verify_cc_request)

```ruby
begin
  # Submit two micro-charge amounts to finalize card verification (step 2 of 2)
  data, status_code, headers = api_instance.post_billing_credit_card_verify_with_http_info(id, billing_verify_cc_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->post_billing_credit_card_verify_with_http_info: #{e}"
end
```
...
> <TextResponse> update_affiliate_dock_setup(opts)
...
begin
  # Configure the affiliate landing dock title, description, and referrer coupon
  result = api_instance.update_affiliate_dock_setup(opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->update_affiliate_dock_setup: #{e}"
end
```

#### Using the update_affiliate_dock_setup_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> update_affiliate_dock_setup_with_http_info(opts)

```ruby
begin
  # Configure the affiliate landing dock title, description, and referrer coupon
  data, status_code, headers = api_instance.update_affiliate_dock_setup_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->update_affiliate_dock_setup_with_http_info: #{e}"
end
```
...
> <TextResponse> update_affiliate_payment_setup(opts)
...
begin
  # Configure how affiliate commissions get paid out (PayPal or internal prepay)
  result = api_instance.update_affiliate_payment_setup(opts)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->update_affiliate_payment_setup: #{e}"
end
```

#### Using the update_affiliate_payment_setup_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> update_affiliate_payment_setup_with_http_info(opts)

```ruby
begin
  # Configure how affiliate commissions get paid out (PayPal or internal prepay)
  data, status_code, headers = api_instance.update_affiliate_payment_setup_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->update_affiliate_payment_setup_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling BillingApi->update_billing_credit_card: #{e}"
end
```

#### Using the update_billing_credit_card_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_billing_credit_card_with_http_info(id)

```ruby
begin
  # Refresh stored card expiration and re-trigger MaxMind fraud scoring
  data, status_code, headers = api_instance.update_billing_credit_card_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->update_billing_credit_card_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::BillingApi.new
billing_payment_method_request = InterServerClient::BillingPaymentMethodRequest.new # BillingPaymentMethodRequest | 

begin
  # Set the account's default payment method for recurring/auto charges
  result = api_instance.update_billing_payment_method(billing_payment_method_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->update_billing_payment_method: #{e}"
end
```

#### Using the update_billing_payment_method_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_billing_payment_method_with_http_info(billing_payment_method_request)

```ruby
begin
  # Set the account's default payment method for recurring/auto charges
  data, status_code, headers = api_instance.update_billing_payment_method_with_http_info(billing_payment_method_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling BillingApi->update_billing_payment_method_with_http_info: #{e}"
end
```
