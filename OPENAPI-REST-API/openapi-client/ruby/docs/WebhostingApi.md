# InterServerClient::WebhostingApi
...
> <ServiceOrderPostResponse> add_website(website_order_post_request)
...
api_instance = InterServerClient::WebhostingApi.new
website_order_post_request = InterServerClient::WebsiteOrderPostRequest.new({hostname: 'hostname_example', package_id: 37}) # WebsiteOrderPostRequest | 

begin
  # Place a new webhosting order, create the invoice, and queue provisioning
  result = api_instance.add_website(website_order_post_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->add_website: #{e}"
end
```
...
> <Array(<ServiceOrderPostResponse>, Integer, Hash)> add_website_with_http_info(website_order_post_request)

```ruby
begin
  # Place a new webhosting order, create the invoice, and queue provisioning
  data, status_code, headers = api_instance.add_website_with_http_info(website_order_post_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ServiceOrderPostResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->add_website_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->get_new_website: #{e}"
end
```

#### Using the get_new_website_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<WebsitesOrder>, Integer, Hash)> get_new_website_with_http_info

```ruby
begin
  # Read the webhosting order catalog — plans, packages, promo offers, pricing
  data, status_code, headers = api_instance.get_new_website_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <WebsitesOrder>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->get_new_website_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->get_website_buy_ip: #{e}"
end
```

#### Using the get_website_buy_ip_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetWebsiteBuyIp200Response>, Integer, Hash)> get_website_buy_ip_with_http_info(id)

```ruby
begin
  # Read website IPs, current reverse DNS, and additional-IP pricing
  data, status_code, headers = api_instance.get_website_buy_ip_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetWebsiteBuyIp200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->get_website_buy_ip_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->get_website_info: #{e}"
end
```

#### Using the get_website_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Website>, Integer, Hash)> get_website_info_with_http_info(id)

```ruby
begin
  # Read full configuration and status detail for one webhosting service
  data, status_code, headers = api_instance.get_website_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Website>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->get_website_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->get_website_invoices: #{e}"
end
```

#### Using the get_website_invoices_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ChargeInvoiceRows>, Integer, Hash)> get_website_invoices_with_http_info(id)

```ruby
begin
  # List all billing invoices and recurring charges scoped to one website
  data, status_code, headers = api_instance.get_website_invoices_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ChargeInvoiceRows>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->get_website_invoices_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->get_website_list: #{e}"
end
```

#### Using the get_website_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<WebsiteRow>>, Integer, Hash)> get_website_list_with_http_info

```ruby
begin
  # List the caller's webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services
  data, status_code, headers = api_instance.get_website_list_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<WebsiteRow>>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->get_website_list_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->get_websites_backups: #{e}"
end
```

#### Using the get_websites_backups_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<WebsiteBackups>, Integer, Hash)> get_websites_backups_with_http_info(id)

```ruby
begin
  # List off-site cpmove backups stored in Swift — list or inline-download archive
  data, status_code, headers = api_instance.get_websites_backups_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <WebsiteBackups>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->get_websites_backups_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->get_websites_login: #{e}"
end
```

#### Using the get_websites_login_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<WebsiteLoginResponse>, Integer, Hash)> get_websites_login_with_http_info(id)

```ruby
begin
  # Get a one-time auto-login URL for the website's control panel
  data, status_code, headers = api_instance.get_websites_login_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <WebsiteLoginResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->get_websites_login_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->get_websites_welcome_email: #{e}"
end
```

#### Using the get_websites_welcome_email_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> get_websites_welcome_email_with_http_info(id)

```ruby
begin
  # Resend the webhosting welcome email with control-panel credentials and URL
  data, status_code, headers = api_instance.get_websites_welcome_email_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->get_websites_welcome_email_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->gett_website_reverse_dns: #{e}"
end
```

#### Using the gett_website_reverse_dns_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ReverseDnsEntries>, Integer, Hash)> gett_website_reverse_dns_with_http_info(id)

```ruby
begin
  # Read current reverse-DNS (PTR) records for the website's IPs
  data, status_code, headers = api_instance.gett_website_reverse_dns_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ReverseDnsEntries>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->gett_website_reverse_dns_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::WebhostingApi.new
id = 56 # Integer | The website service ID. Use `website_id` from `GET /websites`.
post_website_buy_ip_request = InterServerClient::PostWebsiteBuyIpRequest.new # PostWebsiteBuyIpRequest | 

begin
  # Buy an additional IP for the website OR update reverse DNS records
  result = api_instance.post_website_buy_ip(id, post_website_buy_ip_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->post_website_buy_ip: #{e}"
end
```

#### Using the post_website_buy_ip_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<PostWebsiteBuyIp200Response>, Integer, Hash)> post_website_buy_ip_with_http_info(id, post_website_buy_ip_request)

```ruby
begin
  # Buy an additional IP for the website OR update reverse DNS records
  data, status_code, headers = api_instance.post_website_buy_ip_with_http_info(id, post_website_buy_ip_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <PostWebsiteBuyIp200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->post_website_buy_ip_with_http_info: #{e}"
end
```
...
api_instance = InterServerClient::WebhostingApi.new
id = 56 # Integer | The website service ID. Use `website_id` from `GET /websites`.
post_website_migration_request = InterServerClient::PostWebsiteMigrationRequest.new # PostWebsiteMigrationRequest | 

begin
  # Submit a request for InterServer staff to migrate a website from another host
  result = api_instance.post_website_migration(id, post_website_migration_request)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->post_website_migration: #{e}"
end
```

#### Using the post_website_migration_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<PostWebsiteMigration200Response>, Integer, Hash)> post_website_migration_with_http_info(id, post_website_migration_request)

```ruby
begin
  # Submit a request for InterServer staff to migrate a website from another host
  data, status_code, headers = api_instance.post_website_migration_with_http_info(id, post_website_migration_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <PostWebsiteMigration200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->post_website_migration_with_http_info: #{e}"
end
```
...
begin
  # Bulk-update reverse-DNS (PTR) records for one or more website IPs
  result = api_instance.post_websites_reverse_dns(id, reverse_dns_entries)
  p result
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->post_websites_reverse_dns: #{e}"
end
```

#### Using the post_websites_reverse_dns_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TextResponse>, Integer, Hash)> post_websites_reverse_dns_with_http_info(id, reverse_dns_entries)

```ruby
begin
  # Bulk-update reverse-DNS (PTR) records for one or more website IPs
  data, status_code, headers = api_instance.post_websites_reverse_dns_with_http_info(id, reverse_dns_entries)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->post_websites_reverse_dns_with_http_info: #{e}"
end
```
...
> put_websites(website_order_put_request)
...
api_instance = InterServerClient::WebhostingApi.new
website_order_put_request = InterServerClient::WebsiteOrderPutRequest.new({hostname: 'hostname_example', package_id: 37}) # WebsiteOrderPutRequest | 

begin
  # Validate a webhosting order and preview cost — dry run, no charge
  api_instance.put_websites(website_order_put_request)
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->put_websites: #{e}"
end
```

#### Using the put_websites_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> put_websites_with_http_info(website_order_put_request)

```ruby
begin
  # Validate a webhosting order and preview cost — dry run, no charge
  data, status_code, headers = api_instance.put_websites_with_http_info(website_order_put_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->put_websites_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->update_website_info: #{e}"
end
```

#### Using the update_website_info_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<SuccessTextResponse>, Integer, Hash)> update_website_info_with_http_info(id)

```ruby
begin
  # POST mutation hook for the website detail page (use dedicated ops where possible)
  data, status_code, headers = api_instance.update_website_info_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SuccessTextResponse>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->update_website_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebhostingApi->webhosting_cancel: #{e}"
end
```

#### Using the webhosting_cancel_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<WebhostingCancel200Response>, Integer, Hash)> webhosting_cancel_with_http_info(id)

```ruby
begin
  # Schedule termination of a webhosting service — wipes panel account at cycle end
  data, status_code, headers = api_instance.webhosting_cancel_with_http_info(id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <WebhostingCancel200Response>
rescue InterServerClient::ApiError => e
  puts "Error when calling WebhostingApi->webhosting_cancel_with_http_info: #{e}"
end
```
