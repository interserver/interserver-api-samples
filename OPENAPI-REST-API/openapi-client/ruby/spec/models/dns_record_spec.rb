...
# Unit tests for InterServerClient::DnsRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InterServerClient::DnsRecord do
  #let(:instance) { InterServerClient::DnsRecord.new }

  describe 'test an instance of DnsRecord' do
    it 'should create an instance of DnsRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InterServerClient::DnsRecord)
    end
  end
