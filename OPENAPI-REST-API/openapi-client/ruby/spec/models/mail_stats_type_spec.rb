...
# Unit tests for InterServerClient::MailStatsType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InterServerClient::MailStatsType do
  #let(:instance) { InterServerClient::MailStatsType.new }

  describe 'test an instance of MailStatsType' do
    it 'should create an instance of MailStatsType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InterServerClient::MailStatsType)
    end
  end
