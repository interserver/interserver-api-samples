...
# Unit tests for InterServerClient::DomainBillingExtra
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InterServerClient::DomainBillingExtra do
  #let(:instance) { InterServerClient::DomainBillingExtra.new }

  describe 'test an instance of DomainBillingExtra' do
    it 'should create an instance of DomainBillingExtra' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InterServerClient::DomainBillingExtra)
    end
  end
