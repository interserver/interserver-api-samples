...
# Unit tests for InterServerClient::UpdateTicket
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InterServerClient::UpdateTicket do
  #let(:instance) { InterServerClient::UpdateTicket.new }

  describe 'test an instance of UpdateTicket' do
    it 'should create an instance of UpdateTicket' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InterServerClient::UpdateTicket)
    end
  end
