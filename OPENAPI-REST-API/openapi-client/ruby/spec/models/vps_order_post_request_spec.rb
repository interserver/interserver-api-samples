...
# Unit tests for InterServerClient::VpsOrderPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InterServerClient::VpsOrderPostRequest do
  #let(:instance) { InterServerClient::VpsOrderPostRequest.new }

  describe 'test an instance of VpsOrderPostRequest' do
    it 'should create an instance of VpsOrderPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InterServerClient::VpsOrderPostRequest)
    end
  end
