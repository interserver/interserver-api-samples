...
# Unit tests for InterServerClient::DomainOrderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InterServerClient::DomainOrderRequest do
  #let(:instance) { InterServerClient::DomainOrderRequest.new }

  describe 'test an instance of DomainOrderRequest' do
    it 'should create an instance of DomainOrderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InterServerClient::DomainOrderRequest)
    end
  end
