...
# Unit tests for InterServerClient::MailLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InterServerClient::MailLog do
  #let(:instance) { InterServerClient::MailLog.new }

  describe 'test an instance of MailLog' do
    it 'should create an instance of MailLog' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InterServerClient::MailLog)
    end
  end
