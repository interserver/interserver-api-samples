...
# Unit tests for InterServerClient::VpsOrderPutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InterServerClient::VpsOrderPutRequest do
  #let(:instance) { InterServerClient::VpsOrderPutRequest.new }

  describe 'test an instance of VpsOrderPutRequest' do
    it 'should create an instance of VpsOrderPutRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InterServerClient::VpsOrderPutRequest)
    end
  end
