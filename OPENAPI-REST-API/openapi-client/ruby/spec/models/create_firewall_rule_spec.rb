...
# Unit tests for InterServerClient::CreateFirewallRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InterServerClient::CreateFirewallRule do
  #let(:instance) { InterServerClient::CreateFirewallRule.new }

  describe 'test an instance of CreateFirewallRule' do
    it 'should create an instance of CreateFirewallRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InterServerClient::CreateFirewallRule)
    end
  end
