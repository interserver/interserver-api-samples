...
module InterserverApiClient
  ...
  class Servers
    ...
    def bulk_ipmi_power(*, ids : String? = nil) : Response(InterserverApiClient::ServerBulkIpmiPowerResponse)
      @conn.request(InterserverApiClient::ServerBulkIpmiPowerResponse,
        method: :GET,
    ...
    def cancel(id : Int32) : Response(InterserverApiClient::ServersCancel200Response)
      @conn.request(InterserverApiClient::ServersCancel200Response,
        method: :DELETE,
        path: "/servers/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def get(id : Int32) : Response(InterserverApiClient::Server)
      @conn.request(InterserverApiClient::Server,
        method: :GET,
        path: "/servers/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def ipmi_live(id : Int32) : Response(InterserverApiClient::ServerIpmiLiveInfo)
      @conn.request(InterserverApiClient::ServerIpmiLiveInfo,
        method: :GET,
        path: "/servers/{id}/ipmi_live".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def ipmi_live_post(id : Int32, asset : Int32? = nil, ip : String? = nil) : Response(InterserverApiClient::ServerIpmiLiveInfo)
      @conn.request(InterserverApiClient::ServerIpmiLiveInfo,
        method: :POST,
        path: "/servers/{id}/ipmi_live".sub("{id}", InterserverApiClient.enc(id)),
        form: Hash(String, Crest::ParamsValue){ "asset" => asset, "ip" => ip },
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def ipmi_power(id : Int32) : Response(InterserverApiClient::TextResponse)
      @conn.request(InterserverApiClient::TextResponse,
        method: :GET,
        path: "/servers/{id}/ipmi_power".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def ipmi_power_post(id : Int32, asset : Int32? = nil, action : String? = nil) : Response(InterserverApiClient::TextResponse)
      @conn.request(InterserverApiClient::TextResponse,
        method: :POST,
        path: "/servers/{id}/ipmi_power".sub("{id}", InterserverApiClient.enc(id)),
        form: Hash(String, Crest::ParamsValue){ "asset" => asset, "action" => action },
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def list() : Response(Array(InterserverApiClient::ServerRow))
      @conn.request(Array(InterserverApiClient::ServerRow),
        method: :GET,
        path: "/servers",
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def order() : Response(InterserverApiClient::ServerOrder)
      @conn.request(InterserverApiClient::ServerOrder,
        method: :GET,
        path: "/servers/order",
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def order_buy_now_server() : Response(InterserverApiClient::BuyItNowServerOrder200Response)
      @conn.request(InterserverApiClient::BuyItNowServerOrder200Response,
        method: :GET,
    ...
    def order_buy_now_server_post(place_buy_now_server_request : InterserverApiClient::PlaceBuyNowServerRequest? = nil) : Response(InterserverApiClient::ServersBuyNowResponse)
      @conn.request(InterserverApiClient::ServersBuyNowResponse,
        method: :POST,
        path: "/servers/order/buy_now_server",
    ...
    def order_post(server_order_post_request : InterserverApiClient::ServerOrderPostRequest) : Response(InterserverApiClient::AddServer200Response)
      @conn.request(InterserverApiClient::AddServer200Response,
        method: :POST,
        path: "/servers/order",
    ...
    def reverse_dns(id : Int32) : Response(InterserverApiClient::ReverseDnsEntries)
      @conn.request(InterserverApiClient::ReverseDnsEntries,
        method: :GET,
        path: "/servers/{id}/reverse_dns".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def welcome_email(id : Int32) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :GET,
        path: "/servers/{id}/welcome_email".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
  end
