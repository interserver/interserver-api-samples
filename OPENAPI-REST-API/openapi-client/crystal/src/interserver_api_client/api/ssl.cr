...
module InterserverApiClient
  ...
  class Ssl
    ...
    def cancel(id : Int32) : Response(InterserverApiClient::SslCancel200Response)
      @conn.request(InterserverApiClient::SslCancel200Response,
        method: :DELETE,
        path: "/ssl/{id}".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def order_post(ssl_order_request : InterserverApiClient::SslOrderRequest) : Response(InterserverApiClient::ServiceOrderPostResponse)
    ...
    def order_put(ssl_order_request : InterserverApiClient::SslOrderRequest) : Response(Nil)
      @conn.request(Nil,
        method: :PUT,
        path: "/ssl/order",
        body: ssl_order_request,
    ...
    def welcome_email(id : Int32) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :GET,
        path: "/ssl/{id}/welcome_email".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
  end
