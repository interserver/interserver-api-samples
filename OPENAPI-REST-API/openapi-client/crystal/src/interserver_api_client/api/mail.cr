...
module InterserverApiClient
  ...
  class Mail
    ...
    def advsend(id : Int32, send_mail_adv : InterserverApiClient::SendMailAdv) : Response(InterserverApiClient::GenericResponse)
      @conn.request(InterserverApiClient::GenericResponse,
        method: :POST,
        path: "/mail/{id}/advsend".sub("{id}", InterserverApiClient.enc(id)),
        body: send_mail_adv,
    ...
    def alerts(id : Int32) : Response(InterserverApiClient::MailAlertsResponse)
      @conn.request(InterserverApiClient::MailAlertsResponse,
        method: :GET,
        path: "/mail/{id}/alerts".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def alerts_delete(id : Int32, delete_mail_alert_request : InterserverApiClient::DeleteMailAlertRequest) : Response(InterserverApiClient::SuccessTextResponse)
    ...
    def alerts_post(id : Int32, mail_alert_request : InterserverApiClient::MailAlertRequest) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :POST,
        path: "/mail/{id}/alerts".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def alerts_put(id : Int32, mail_alert_update_request : InterserverApiClient::MailAlertUpdateRequest) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :PUT,
        path: "/mail/{id}/alerts".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def blocks(id : Int32) : Response(InterserverApiClient::MailBlocks)
      @conn.request(InterserverApiClient::MailBlocks,
        method: :GET,
        path: "/mail/{id}/blocks".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def blocks_delete(id : Int32, email : String? = nil) : Response(InterserverApiClient::GenericResponse)
      @conn.request(InterserverApiClient::GenericResponse,
        method: :POST,
        path: "/mail/{id}/blocks/delete".sub("{id}", InterserverApiClient.enc(id)),
        form: Hash(String, Crest::ParamsValue){ "email" => email },
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def cancel(id : Int32) : Response(InterserverApiClient::MailCancel200Response)
      @conn.request(InterserverApiClient::MailCancel200Response,
        method: :DELETE,
        path: "/mail/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def delist(id : Int32) : Response(InterserverApiClient::MailDelistResponse)
      @conn.request(InterserverApiClient::MailDelistResponse,
        method: :GET,
        path: "/mail/{id}/delist".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def delist_post(id : Int32, mail_delist_request : InterserverApiClient::MailDelistRequest) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :POST,
        path: "/mail/{id}/delist".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def deliverability(id : Int32) : Response(InterserverApiClient::MailDeliverabilityResponse)
      @conn.request(InterserverApiClient::MailDeliverabilityResponse,
        method: :GET,
        path: "/mail/{id}/deliverability".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def get(id : Int32) : Response(InterserverApiClient::MailSchema)
      @conn.request(InterserverApiClient::MailSchema,
        method: :GET,
        path: "/mail/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def list() : Response(Array(InterserverApiClient::MailRow))
      @conn.request(Array(InterserverApiClient::MailRow),
        method: :GET,
        path: "/mail",
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def log(id : Int32, *, id2 : Int64? = nil, origin : String? = nil, mx : String? = nil, from : String? = nil, to : String? = nil, subject : String? = nil, mailid : String? = nil, message_id : String? = nil, replyto : String? = nil, headerfrom : String? = nil, delivered : Int32? = nil, skip : Int32? = nil, limit : Int32? = nil, start_date : InterserverApiClient::ViewMailLogStartDateParameter? = nil, end_date : InterserverApiClient::ViewMailLogStartDateParameter? = nil, sort : String? = nil, dir : String? = nil, groupby : String? = nil) : Response(InterserverApiClient::MailLog)
      @conn.request(InterserverApiClient::MailLog,
        method: :GET,
        path: "/mail/{id}/log".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def order() : Response(InterserverApiClient::MailOrder)
      @conn.request(InterserverApiClient::MailOrder,
        method: :GET,
        path: "/mail/order",
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def order_post(mail_order_request : InterserverApiClient::MailOrderRequest) : Response(InterserverApiClient::ServiceOrderPostResponse)
    ...
    def order_put(mail_order_request : InterserverApiClient::MailOrderRequest) : Response(Nil)
      @conn.request(Nil,
        method: :PUT,
        path: "/mail/order",
        body: mail_order_request,
    ...
    def reset_password(id : Int32) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :GET,
        path: "/mail/{id}/reset_password".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def send(id : Int32, send_mail : InterserverApiClient::SendMail) : Response(InterserverApiClient::GenericResponse)
      @conn.request(InterserverApiClient::GenericResponse,
        method: :POST,
        path: "/mail/{id}/send".sub("{id}", InterserverApiClient.enc(id)),
        body: send_mail,
        accept: %w[application/json],
        content_type: %w[application/json application/x-www-form-urlencoded],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def stats(id : Int32, *, time : String? = nil) : Response(InterserverApiClient::MailStatsType)
      @conn.request(InterserverApiClient::MailStatsType,
        method: :GET,
        path: "/mail/{id}/stats".sub("{id}", InterserverApiClient.enc(id)),
        query: { "time" => time },
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def welcome_email(id : Int32) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :GET,
        path: "/mail/{id}/welcome_email".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
  end
