...
module InterserverApiClient
  ...
  class ScrubIps
    ...
    def create_filter(id : Int32, create_filter : InterserverApiClient::CreateFilter) : Response(InterserverApiClient::CreateFilter201Response)
      @conn.request(InterserverApiClient::CreateFilter201Response,
        method: :POST,
        path: "/scrub_ips/{id}/create_filter".sub("{id}", InterserverApiClient.enc(id)),
        body: create_filter,
    ...
    def create_geo_rule(id : Int32, create_geo_firewall_rule : InterserverApiClient::CreateGeoFirewallRule) : Response(InterserverApiClient::CreateRule201Response)
      @conn.request(InterserverApiClient::CreateRule201Response,
        method: :POST,
        path: "/scrub_ips/{id}/create_geo_rule".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def create_rule(id : Int32, create_firewall_rule : InterserverApiClient::CreateFirewallRule) : Response(InterserverApiClient::CreateRule201Response)
      @conn.request(InterserverApiClient::CreateRule201Response,
        method: :POST,
        path: "/scrub_ips/{id}/create_rule".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def delete(id : Int32) : Response(InterserverApiClient::CancelScrubIp200Response)
      @conn.request(InterserverApiClient::CancelScrubIp200Response,
        method: :DELETE,
        path: "/scrub_ips/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def delete_filter(id : Int32, create_filter : InterserverApiClient::CreateFilter) : Response(InterserverApiClient::DeleteFilter200Response)
      @conn.request(InterserverApiClient::DeleteFilter200Response,
        method: :POST,
        path: "/scrub_ips/{id}/delete_filter".sub("{id}", InterserverApiClient.enc(id)),
        body: create_filter,
        accept: %w[application/json],
        content_type: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def delete_geo_rule(id : Int32, delete_geo_firewall_rule : InterserverApiClient::DeleteGeoFirewallRule) : Response(InterserverApiClient::ScrubIpsDeleteRule200Response)
      @conn.request(InterserverApiClient::ScrubIpsDeleteRule200Response,
        method: :POST,
        path: "/scrub_ips/{id}/delete_geo_rule".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def delete_rule(id : Int32, delete_firewall_rule : InterserverApiClient::DeleteFirewallRule) : Response(InterserverApiClient::ScrubIpsDeleteRule200Response)
      @conn.request(InterserverApiClient::ScrubIpsDeleteRule200Response,
        method: :POST,
        path: "/scrub_ips/{id}/delete_rule".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def disable(id : Int32) : Response(InterserverApiClient::DisableScrub200Response)
      @conn.request(InterserverApiClient::DisableScrub200Response,
        method: :GET,
        path: "/scrub_ips/{id}/disable".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def enable(id : Int32) : Response(InterserverApiClient::EnableScrub200Response)
      @conn.request(InterserverApiClient::EnableScrub200Response,
        method: :GET,
        path: "/scrub_ips/{id}/enable".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def filter_types() : Response(InterserverApiClient::ScrubIpFilterTypes)
      @conn.request(InterserverApiClient::ScrubIpFilterTypes,
        method: :GET,
    ...
    def get(id : Int32) : Response(InterserverApiClient::GetScrubIpDetails200Response)
      @conn.request(InterserverApiClient::GetScrubIpDetails200Response,
        method: :GET,
        path: "/scrub_ips/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def list() : Response(Array(InterserverApiClient::ScrubIpsRowSchema))
      @conn.request(Array(InterserverApiClient::ScrubIpsRowSchema),
        method: :GET,
        path: "/scrub_ips",
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def logs(id : String) : Response(Array(InterserverApiClient::ScrubIpsLogRowSchema))
      @conn.request(Array(InterserverApiClient::ScrubIpsLogRowSchema),
        method: :GET,
        path: "/scrub_ips/{id}/logs".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def order() : Response(InterserverApiClient::GetOrderDetail200Response)
      @conn.request(InterserverApiClient::GetOrderDetail200Response,
        method: :GET,
    ...
    def order_post(scrub_ip_place_order : InterserverApiClient::ScrubIpPlaceOrder) : Response(InterserverApiClient::PlaceScrubOrder201Response)
      @conn.request(InterserverApiClient::PlaceScrubOrder201Response,
        method: :POST,
        path: "/scrub_ips/order",
    ...
    def order_put(scrub_ip_place_order : InterserverApiClient::ScrubIpPlaceOrder) : Response(InterserverApiClient::PutScrubIps200Response)
      @conn.request(InterserverApiClient::PutScrubIps200Response,
        method: :PUT,
        path: "/scrub_ips/order",
        body: scrub_ip_place_order,
        accept: %w[application/json],
