...
module InterserverApiClient
  ...
  class Qs
    ...
    def backup(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :GET,
        path: "/qs/{id}/backup".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def block_smtp(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :GET,
        path: "/qs/{id}/block_smtp".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def change_hostname(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :GET,
        path: "/qs/{id}/change_hostname".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def change_hostname_post(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :POST,
        path: "/qs/{id}/change_hostname".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
    ...
    def change_root_password(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :GET,
        path: "/qs/{id}/change_root_password".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def change_root_password_post(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :POST,
        path: "/qs/{id}/change_root_password".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
    ...
    def change_timezone(id : Int32) : Response(Array(String))
      @conn.request(Array(String),
        method: :GET,
        path: "/qs/{id}/change_timezone".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def change_timezone_post(id : Int32, timezone : String? = nil) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :POST,
        path: "/qs/{id}/change_timezone".sub("{id}", InterserverApiClient.enc(id)),
        form: Hash(String, Crest::ParamsValue){ "timezone" => timezone },
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def change_webuzo_password(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :GET,
        path: "/qs/{id}/change_webuzo_password".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def change_webuzo_password_post(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :POST,
        path: "/qs/{id}/change_webuzo_password".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
    ...
    def create(id : String) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :POST,
        path: "/qs/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def delete(id : Int32) : Response(InterserverApiClient::QuickserversCancel200Response)
      @conn.request(InterserverApiClient::QuickserversCancel200Response,
        method: :DELETE,
        path: "/qs/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def disable_cd(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :GET,
        path: "/qs/{id}/disable_cd".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def disable_quota(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :GET,
        path: "/qs/{id}/disable_quota".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def eject_cd(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :GET,
        path: "/qs/{id}/eject_cd".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def enable_quota(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :GET,
        path: "/qs/{id}/enable_quota".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def get(id : Int32) : Response(InterserverApiClient::Quickserver)
      @conn.request(InterserverApiClient::Quickserver,
        method: :GET,
        path: "/qs/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def insert_cd(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :GET,
        path: "/qs/{id}/insert_cd".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def insert_cd_post(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :POST,
        path: "/qs/{id}/insert_cd".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
    ...
    def list() : Response(Array(InterserverApiClient::QuickserverRow))
      @conn.request(Array(InterserverApiClient::QuickserverRow),
        method: :GET,
        path: "/qs",
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def order() : Response(InterserverApiClient::QuickserverOrder)
      @conn.request(InterserverApiClient::QuickserverOrder,
        method: :GET,
        path: "/qs/order",
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def order_post(qs_order_request : InterserverApiClient::QsOrderRequest) : Response(InterserverApiClient::ServiceOrderPostResponse)
      @conn.request(InterserverApiClient::ServiceOrderPostResponse,
        method: :POST,
        path: "/qs/order",
    ...
    def order_put(qs_order_request : InterserverApiClient::QsOrderRequest) : Response(Nil)
      @conn.request(Nil,
        method: :PUT,
        path: "/qs/order",
        body: qs_order_request,
    ...
    def reinstall_os(id : Int32) : Response(InterserverApiClient::VpsTemplatesList)
      @conn.request(InterserverApiClient::VpsTemplatesList,
        method: :GET,
        path: "/qs/{id}/reinstall_os".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def reinstall_os_post(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :POST,
        path: "/qs/{id}/reinstall_os".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
    ...
    def reset_password(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :GET,
        path: "/qs/{id}/reset_password".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def reset_password_post(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :POST,
        path: "/qs/{id}/reset_password".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
    ...
    def restart(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :GET,
        path: "/qs/{id}/restart".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def restore(id : Int32, restore_request : InterserverApiClient::RestoreRequest) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :POST,
        path: "/qs/{id}/restore".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def reverse_dns(id : Int32) : Response(InterserverApiClient::ReverseDnsEntries)
      @conn.request(InterserverApiClient::ReverseDnsEntries,
        method: :GET,
        path: "/qs/{id}/reverse_dns".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def reverse_dns_post(id : Int32, reverse_dns_entries : InterserverApiClient::ReverseDnsEntries) : Response(InterserverApiClient::TextResponse)
    ...
    def setup_vnc(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :GET,
        path: "/qs/{id}/setup_vnc".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def setup_vnc_post(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :POST,
        path: "/qs/{id}/setup_vnc".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
    ...
    def start(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :GET,
        path: "/qs/{id}/start".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def stop(id : Int32) : Response(InterserverApiClient::QueueResponse)
      @conn.request(InterserverApiClient::QueueResponse,
        method: :GET,
        path: "/qs/{id}/stop".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def traffic_usage(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :GET,
        path: "/qs/{id}/traffic_usage".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def traffic_usage_post(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :POST,
        path: "/qs/{id}/traffic_usage".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
    ...
    def view_desktop(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :GET,
        path: "/qs/{id}/view_desktop".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def view_desktop_post(id : Int32) : Response(Nil)
      @conn.request(Nil,
        method: :POST,
        path: "/qs/{id}/view_desktop".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
    ...
    def welcome_email(id : String) : Response(InterserverApiClient::TextResponse)
      @conn.request(InterserverApiClient::TextResponse,
        method: :GET,
        path: "/qs/{id}/welcome_email".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
  end
