...
module InterserverApiClient
  ...
  class FloatingIps
    ...
    def cancel(id : Int32) : Response(InterserverApiClient::FloatingIpsCancel200Response)
      @conn.request(InterserverApiClient::FloatingIpsCancel200Response,
        method: :DELETE,
        path: "/floating_ips/{id}".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def change_ip(id : Int32, ip : String? = nil) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :POST,
        path: "/floating_ips/{id}/change_ip".sub("{id}", InterserverApiClient.enc(id)),
        form: Hash(String, Crest::ParamsValue){ "ip" => ip },
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
    ...
    def get(id : Int32) : Response(JSON::Any)
    ...
    def list() : Response(Array(JSON::Any))
    ...
    def order_post(floating_ip_order_request : InterserverApiClient::FloatingIpOrderRequest) : Response(InterserverApiClient::ServiceOrderPostResponse)
    ...
    def order_put(floating_ip_order_request : InterserverApiClient::FloatingIpOrderRequest) : Response(Nil)
      @conn.request(Nil,
        method: :PUT,
        path: "/floating_ips/order",
        body: floating_ip_order_request,
    ...
    def welcome_email(id : Int32) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :GET,
        path: "/floating_ips/{id}/welcome_email".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
  end
