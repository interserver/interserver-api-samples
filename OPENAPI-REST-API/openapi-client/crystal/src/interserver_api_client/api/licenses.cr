...
module InterserverApiClient
  ...
  class Licenses
    ...
    def cancel(id : Int32) : Response(InterserverApiClient::LicensesCancel200Response)
      @conn.request(InterserverApiClient::LicensesCancel200Response,
        method: :DELETE,
        path: "/licenses/{id}".sub("{id}", InterserverApiClient.enc(id)),
    ...
    def change_ip(id : Int32, ip_object : InterserverApiClient::IpObject) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :POST,
        path: "/licenses/{id}/change_ip".sub("{id}", InterserverApiClient.enc(id)),
        body: ip_object,
        accept: %w[application/json],
    ...
    def get(id : Int32) : Response(InterserverApiClient::License)
      @conn.request(InterserverApiClient::License,
        method: :GET,
        path: "/licenses/{id}".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def list() : Response(Array(InterserverApiClient::LicenseRow))
      @conn.request(Array(InterserverApiClient::LicenseRow),
        method: :GET,
        path: "/licenses",
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def order() : Response(InterserverApiClient::LicensesOrder)
      @conn.request(InterserverApiClient::LicensesOrder,
        method: :GET,
        path: "/licenses/order",
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    ...
    def order_post(license_order_request : InterserverApiClient::LicenseOrderRequest) : Response(InterserverApiClient::ServiceOrderPostResponse)
    ...
    def order_put(license_order_request : InterserverApiClient::LicenseOrderRequest) : Response(Nil)
      @conn.request(Nil,
        method: :PUT,
        path: "/licenses/order",
        body: license_order_request,
    ...
    def welcome_email(id : Int32) : Response(InterserverApiClient::SuccessTextResponse)
      @conn.request(InterserverApiClient::SuccessTextResponse,
        method: :GET,
        path: "/licenses/{id}/welcome_email".sub("{id}", InterserverApiClient.enc(id)),
        accept: %w[application/json],
        auth: %w[sessionIdCookieAuth apiKeyAuth sessionIdHeaderAuth])
    end
  end
