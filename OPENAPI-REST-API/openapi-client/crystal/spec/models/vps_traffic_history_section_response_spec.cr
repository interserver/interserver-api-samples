...
# Unit tests for InterserverApiClient::VpsTrafficHistorySectionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::VpsTrafficHistorySectionResponse do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::VpsTrafficHistorySectionResponse.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
