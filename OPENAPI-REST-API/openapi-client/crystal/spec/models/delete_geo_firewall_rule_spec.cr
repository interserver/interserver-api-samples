...
Spectator.describe InterserverApiClient::DeleteGeoFirewallRule do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::DeleteGeoFirewallRule.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
