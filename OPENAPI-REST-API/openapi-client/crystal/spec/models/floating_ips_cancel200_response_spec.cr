...
# Unit tests for InterserverApiClient::FloatingIpsCancel200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::FloatingIpsCancel200Response do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::FloatingIpsCancel200Response.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
