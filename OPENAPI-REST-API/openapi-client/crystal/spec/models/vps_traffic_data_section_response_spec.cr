...
Spectator.describe InterserverApiClient::VpsTrafficDataSectionResponse do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::VpsTrafficDataSectionResponse.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
