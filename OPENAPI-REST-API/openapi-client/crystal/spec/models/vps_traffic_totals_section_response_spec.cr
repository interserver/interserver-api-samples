...
Spectator.describe InterserverApiClient::VpsTrafficTotalsSectionResponse do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::VpsTrafficTotalsSectionResponse.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
