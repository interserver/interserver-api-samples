...
Spectator.describe InterserverApiClient::DomainOrderRequest do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::DomainOrderRequest.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
