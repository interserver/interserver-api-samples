...
# Unit tests for InterserverApiClient::WebsiteRow
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::WebsiteRow do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::WebsiteRow.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
