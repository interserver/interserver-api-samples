...
# Unit tests for InterserverApiClient::MailCancel200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::MailCancel200Response do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::MailCancel200Response.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
