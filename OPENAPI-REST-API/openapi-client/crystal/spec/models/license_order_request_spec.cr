...
Spectator.describe InterserverApiClient::LicenseOrderRequest do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::LicenseOrderRequest.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
