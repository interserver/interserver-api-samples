...
Spectator.describe InterserverApiClient::WebsitesOrderServiceOffers do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::WebsitesOrderServiceOffers.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
