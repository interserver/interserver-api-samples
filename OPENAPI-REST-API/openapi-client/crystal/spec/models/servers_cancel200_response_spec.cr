...
# Unit tests for InterserverApiClient::ServersCancel200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::ServersCancel200Response do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::ServersCancel200Response.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
