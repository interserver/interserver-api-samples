...
# Unit tests for InterserverApiClient::DeleteMailAlertRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::DeleteMailAlertRequest do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::DeleteMailAlertRequest.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
