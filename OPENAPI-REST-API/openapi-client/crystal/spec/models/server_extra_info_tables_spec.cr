...
Spectator.describe InterserverApiClient::ServerExtraInfoTables do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::ServerExtraInfoTables.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
