...
Spectator.describe InterserverApiClient::WebsitesOrderJsonServices do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::WebsitesOrderJsonServices.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
