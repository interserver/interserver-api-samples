...
# Unit tests for InterserverApiClient::MailSchema
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::MailSchema do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::MailSchema.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
