...
# Unit tests for InterserverApiClient::SendMailAdv
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::SendMailAdv do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::SendMailAdv.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
