...
Spectator.describe InterserverApiClient::ServerClientLink do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::ServerClientLink.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
