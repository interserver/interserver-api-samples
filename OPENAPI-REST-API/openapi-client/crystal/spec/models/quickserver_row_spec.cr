...
# Unit tests for InterserverApiClient::QuickserverRow
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::QuickserverRow do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::QuickserverRow.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
