...
# Unit tests for InterserverApiClient::SuccessTextResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe InterserverApiClient::SuccessTextResponse do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { InterserverApiClient::SuccessTextResponse.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
