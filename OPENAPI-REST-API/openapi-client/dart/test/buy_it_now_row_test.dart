...
// tests for BuyItNowRow
void main() {
  // final instance = BuyItNowRow();

  group('test BuyItNowRow', () {
    ...
    // List<BuyItNowRowCpuInner> cpu (default value: const [])
    ...
    // Map<String, String> disk (default value: const {})
