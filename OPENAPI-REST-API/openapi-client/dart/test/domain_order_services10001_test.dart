...
// tests for DomainOrderServices10001
void main() {
  // final instance = DomainOrderServices10001();

  group('test DomainOrderServices10001', () {
    // Service ID
    // String servicesId
    ...
    test('to test the property `servicesCurrency`', () async {
      // TODO
    });
