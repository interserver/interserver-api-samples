...
// tests for GetOrderDetail200ResponseServiceTypesInner
void main() {
  // final instance = GetOrderDetail200ResponseServiceTypesInner();

  group('test GetOrderDetail200ResponseServiceTypesInner', () {
    // int servicesId
