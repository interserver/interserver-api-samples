...
void main() {
  // final instance = SslOrderRequest();

  group('test SslOrderRequest', () {
    ...
    // int frequency (default value: 12)
    ...
    // String department (default value: 'Administration')
