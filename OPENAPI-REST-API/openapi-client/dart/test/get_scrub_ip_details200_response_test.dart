...
void main() {
  // final instance = GetScrubIpDetails200Response();

  group('test GetScrubIpDetails200Response', () {
    // GetScrubIpDetails200ResponseServiceInfo serviceInfo
    test('to test the property `serviceInfo`', () async {
      // TODO
    });

    // List<GetScrubIpDetails200ResponseClientLinksInner> clientLinks (default value: const [])
