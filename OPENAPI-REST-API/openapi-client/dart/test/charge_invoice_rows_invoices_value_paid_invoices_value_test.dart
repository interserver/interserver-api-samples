...
// tests for ChargeInvoiceRowsInvoicesValuePaidInvoicesValue
void main() {
  // final instance = ChargeInvoiceRowsInvoicesValuePaidInvoicesValue();

  group('test ChargeInvoiceRowsInvoicesValuePaidInvoicesValue', () {
    // String invoicesId
    ...
    // Map<String, ChargeInvoiceRowsInvoicesValuePaidInvoicesValueRefundInvoicesValue> refundInvoices (default value: const {})
    test('to test the property `refundInvoices`', () async {
      // TODO
    });
