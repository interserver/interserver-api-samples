...
void main() {
  ...
  group('test Domain', () {
    ...
    // Map<String, DomainServiceType> serviceTypes (default value: const {})
    test('to test the property `serviceTypes`', () async {
      // TODO
    });

    // List<DomainClientLink> clientLinks (default value: const [])
    ...
    // List<String> domainLogs (default value: const [])
