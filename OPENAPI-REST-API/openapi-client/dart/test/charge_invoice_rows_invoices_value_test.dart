...
void main() {
  // final instance = ChargeInvoiceRowsInvoicesValue();

  group('test ChargeInvoiceRowsInvoicesValue', () {
    // Unique invoice ID.
    // num invoicesId
    ...
    // Map<String, ChargeInvoiceRowsInvoicesValuePaidInvoicesValue> paidInvoices (default value: const {})
