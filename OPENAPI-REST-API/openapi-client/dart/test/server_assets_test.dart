...
// tests for ServerAssets
void main() {
  // final instance = ServerAssets();

  group('test ServerAssets', () {
    ...
    // List<String> header (default value: const [])
    test('to test the property `header`', () async {
      // TODO
    });

    // The rows of the assets table.
    // List<List<String>> rows (default value: const [])
