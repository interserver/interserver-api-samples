...
class WebhostingApi {
  ...
  /// Parameters:
  ///
  /// * [WebsiteOrderPostRequest] websiteOrderPostRequest (required):
  Future<Response> addWebsiteWithHttpInfo(WebsiteOrderPostRequest websiteOrderPostRequest, { Future<void>? abortTrigger, }) async {
  ...
  ///
  /// * [WebsiteOrderPostRequest] websiteOrderPostRequest (required):
  Future<ServiceOrderPostResponse?> addWebsite(WebsiteOrderPostRequest websiteOrderPostRequest, { Future<void>? abortTrigger, }) async {
    final response = await addWebsiteWithHttpInfo(websiteOrderPostRequest, abortTrigger: abortTrigger,);
  ...
  ///
  /// Note: This method returns the HTTP [Response].
  Future<Response> getNewWebsiteWithHttpInfo({ Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
    final path = r'/websites/order';
  ...
  ///
  /// Step 1 of the webhosting order flow. Returns the full ordering catalog needed to build a valid order: available `serviceTypes` (plans), `serviceOffers` (promotional bundles), `packages`, billing `period` options, the customer's currency symbol, default `serviceOfferId`, and `enableDomainRegistering` (whether free/paid domain registration is bundled). Read-only — no service or invoice created. Sibling discovery endpoints in other modules: `getNewVps`, `getNewMail`, `getNewDomain`. Sibling order-flow ops: `putWebsites`, `addWebsite`.  **Path/Query/Body:** None.  **Returns** (schema `WebsitesOrder`): - `currencySymbol` (string) — locale currency symbol for display. - `step` (integer) — current step in the multi-step order wizard. - `website` (integer) — pre-selected default plan id. - `period` (integer) — pre-selected default billing frequency. - `serviceOfferId` (integer) — pre-selected promo offer. - `serviceTypes` (array) — every plan; `services_ourcost` stripped server-side. Keys per row: `services_id`, `services_name`, `services_cost`, `services_type` (`WEB_CPANEL` / `WEB_DIRECTADMIN` / `WEB_PLESK` / `WEB_VESTA` / `WEB_PPA` / `WEB_WORDPRESS` / `WEB_STORAGE`), etc. - `serviceOffers` (array) — current promotional bundles. - `packages`, `packges` (array — legacy field name preserved alongside `packages`). - `enableDomainRegistering` (bool) — when `true`, the order can also register/transfer a domain. - `jsonServices`, `jsonServiceOffers` (string) — JSON-encoded copies for inline use in HTML.  **Auth:** Session/API key.  **Errors:** - `401` — unauthenticated.  **Related calls:** - **Next:** `putWebsites` (validate + quote — no charge), `addWebsite` (place order).  **Example abridged response:** ```json {   \"currencySymbol\": \"$\",   \"step\": 1,   \"website\": 23,   \"period\": 1,   \"enableDomainRegistering\": true,   \"serviceTypes\": [     {\"services_id\": 23, \"services_name\": \"Standard\", \"services_cost\": 8.00, \"services_type\": 1},     {\"services_id\": 25, \"services_name\": \"Reseller\", \"services_cost\": 24.95, \"services_type\": 1}   ] } ``` 
  Future<WebsitesOrder?> getNewWebsite({ Future<void>? abortTrigger, }) async {
    final response = await getNewWebsiteWithHttpInfo(abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> getWebsiteBuyIpWithHttpInfo(int id, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<GetWebsiteBuyIp200Response?> getWebsiteBuyIp(int id, { Future<void>? abortTrigger, }) async {
    final response = await getWebsiteBuyIpWithHttpInfo(id, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<Response> getWebsiteInfoWithHttpInfo(int id, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<Website?> getWebsiteInfo(int id, { Future<void>? abortTrigger, }) async {
    final response = await getWebsiteInfoWithHttpInfo(id, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<Response> getWebsiteInvoicesWithHttpInfo(int id, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<ChargeInvoiceRows?> getWebsiteInvoices(int id, { Future<void>? abortTrigger, }) async {
    final response = await getWebsiteInvoicesWithHttpInfo(id, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// Note: This method returns the HTTP [Response].
  Future<Response> getWebsiteListWithHttpInfo({ Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// Enumerates every shared/reseller hosting account (\"website\") owned by the authenticated customer. The canonical entry point for discovering a `website_id` to pass into other webhosting endpoints. Filtered server-side by `website_custid = session account_id` — cross-customer leaks are not possible. Empty array means the account has no websites (not an error). Sibling ops: `getWebsiteInfo`, `getWebsitesLogin`, `getWebsitesBackups`, `getWebsiteInvoices`, `webhostingCancel`, `getNewWebsite` (order a new one).  **Path/Query/Body:** None.  **Returns:** Array of `WebsiteRow` — per-website summary: - `website_id` (integer) — canonical id used in `/websites/{id}/_*` paths. - `website_hostname` (string) — primary FQDN. - `website_status` (string enum) — `pending` / `active` / `pending-cancel` / `canceled`. - `services_name` (string) — plan/package label (e.g. `Standard`, `Reseller`). - `repeat_invoices_cost` (decimal) — current recurring cost in the website's billing currency. - `website_comment` (string|null) — customer-provided note.  **Auth:** Session/API key. Ownership filter enforced via `website_custid`.  **Errors:** - `401` — unauthenticated.  **Related calls:** - **Per-website detail:** `getWebsiteInfo` (full). - **Control panel:** `getWebsitesLogin` (auto-login URL). - **Backups + restore points:** `getWebsitesBackups`. - **Billing:** `getWebsiteInvoices`. - **Order a new site:** `getNewWebsite` → `putWebsites` → `addWebsite`. - **Cancel:** `webhostingCancel`. 
  Future<List<WebsiteRow>?> getWebsiteList({ Future<void>? abortTrigger, }) async {
    final response = await getWebsiteListWithHttpInfo(abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<Response> getWebsitesBackupsWithHttpInfo(int id, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<WebsiteBackups?> getWebsitesBackups(int id, { Future<void>? abortTrigger, }) async {
    final response = await getWebsitesBackupsWithHttpInfo(id, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<Response> getWebsitesLoginWithHttpInfo(int id, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<WebsiteLoginResponse?> getWebsitesLogin(int id, { Future<void>? abortTrigger, }) async {
    final response = await getWebsitesLoginWithHttpInfo(id, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<Response> getWebsitesWelcomeEmailWithHttpInfo(int id, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<SuccessTextResponse?> getWebsitesWelcomeEmail(int id, { Future<void>? abortTrigger, }) async {
    final response = await getWebsitesWelcomeEmailWithHttpInfo(id, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<Response> gettWebsiteReverseDnsWithHttpInfo(int id, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [int] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<ReverseDnsEntries?> gettWebsiteReverseDns(int id, { Future<void>? abortTrigger, }) async {
    final response = await gettWebsiteReverseDnsWithHttpInfo(id, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postWebsiteBuyIpWithHttpInfo(int id, PostWebsiteBuyIpRequest postWebsiteBuyIpRequest, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
    final path = r'/websites/{id}/buy_ip'
      .replaceAll('{id}', id.toString());
  ...
  ///
  /// * [PostWebsiteBuyIpRequest] postWebsiteBuyIpRequest (required):
  Future<PostWebsiteBuyIp200Response?> postWebsiteBuyIp(int id, PostWebsiteBuyIpRequest postWebsiteBuyIpRequest, { Future<void>? abortTrigger, }) async {
    final response = await postWebsiteBuyIpWithHttpInfo(id, postWebsiteBuyIpRequest, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postWebsiteMigrationWithHttpInfo(int id, PostWebsiteMigrationRequest postWebsiteMigrationRequest, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [PostWebsiteMigrationRequest] postWebsiteMigrationRequest (required):
  Future<PostWebsiteMigration200Response?> postWebsiteMigration(int id, PostWebsiteMigrationRequest postWebsiteMigrationRequest, { Future<void>? abortTrigger, }) async {
    final response = await postWebsiteMigrationWithHttpInfo(id, postWebsiteMigrationRequest, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> postWebsitesReverseDnsWithHttpInfo(int id, ReverseDnsEntries reverseDnsEntries, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
    final path = r'/websites/{id}/reverse_dns'
      .replaceAll('{id}', id.toString());
  ...
  ///
  /// * [ReverseDnsEntries] reverseDnsEntries (required):
  Future<TextResponse?> postWebsitesReverseDns(int id, ReverseDnsEntries reverseDnsEntries, { Future<void>? abortTrigger, }) async {
    final response = await postWebsitesReverseDnsWithHttpInfo(id, reverseDnsEntries, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Parameters:
  ///
  /// * [WebsiteOrderPutRequest] websiteOrderPutRequest (required):
  Future<Response> putWebsitesWithHttpInfo(WebsiteOrderPutRequest websiteOrderPutRequest, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
    final path = r'/websites/order';
  ...
  ///
  /// * [WebsiteOrderPutRequest] websiteOrderPutRequest (required):
  Future<void> putWebsites(WebsiteOrderPutRequest websiteOrderPutRequest, { Future<void>? abortTrigger, }) async {
    final response = await putWebsitesWithHttpInfo(websiteOrderPutRequest, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// * [String] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<Response> updateWebsiteInfoWithHttpInfo(String id, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
    final path = r'/websites/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<SuccessTextResponse?> updateWebsiteInfo(String id, { Future<void>? abortTrigger, }) async {
    final response = await updateWebsiteInfoWithHttpInfo(id, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<Response> webhostingCancelWithHttpInfo(String id, { Future<void>? abortTrigger, }) async {
    // ignore: prefer_const_declarations
    final path = r'/websites/{id}'
      .replaceAll('{id}', id);
  ...
  /// * [String] id (required):
  ///   The website service ID. Use `website_id` from `GET /websites`.
  Future<WebhostingCancel200Response?> webhostingCancel(String id, { Future<void>? abortTrigger, }) async {
    final response = await webhostingCancelWithHttpInfo(id, abortTrigger: abortTrigger,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
