  ...
  VpsOrderPostRequestVpsPlatformEnum? decode(dynamic data, {bool allowNull = true}) {
    ...
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return VpsOrderPostRequestVpsPlatformEnum.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
  ...
  VpsOrderPostRequestControlpanelEnum? decode(dynamic data, {bool allowNull = true}) {
    ...
    if (data != null) {
      switch (data) {
        ...
        case r'unknown_default_open_api': return VpsOrderPostRequestControlpanelEnum.unknownDefaultOpenApi;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
