...
try {
    final result = api_instance.addMail(mailOrderRequest);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.deleteMailAlert(id, deleteMailAlertRequest);
    print(result);
} catch (e) {
...
try {
    api_instance.putMail(mailOrderRequest);
} catch (e) {
...
final api_instance = MailApi();
final id = 56; // int | The mail service ID. Use `mail_id` from `GET /mail`.
final rule = rule_example; // String | The ID of the deny rule to update.
final denyRuleNew = DenyRuleNew(); // DenyRuleNew | 

try {
    final result = api_instance.updateRule(id, rule, denyRuleNew);
    print(result);
} catch (e) {
