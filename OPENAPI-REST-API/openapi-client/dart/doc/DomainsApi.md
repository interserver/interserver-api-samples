...
try {
    final result = api_instance.addDomain(domainOrderRequest);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.deleteDomainDnssec(id);
    print(result);
} catch (e) {
...
try {
    api_instance.patchDomains(domainOrderRequest);
} catch (e) {
...
try {
    api_instance.postDomainSearch(name);
} catch (e) {
...
try {
    api_instance.putDomains(domainOrderRequest);
} catch (e) {
