...
# **addDomain**
```swift
    open class func addDomain(domainOrderRequest: DomainOrderRequest, completion: @escaping (_ data: ServiceOrderPostResponse?, _ error: Error?) -> Void)
```
...
let domainOrderRequest = DomainOrderRequest(hostname: "hostname_example", type: "type_example", coupon: "coupon_example", whoisPrivacy: "whoisPrivacy_example") // DomainOrderRequest | 

// Place a new domain registration or transfer order, generate billing invoice
DomainsAPI.addDomain(domainOrderRequest: domainOrderRequest) { (response, error) in
...
# **addDomainDnssec**
```swift
    open class func addDomainDnssec(_id: Int, domainDnssecRequest: DomainDnssecRequest, completion: @escaping (_ data: SuccessTextResponse?, _ error: Error?) -> Void)
```
...
let _id = 987 // Int | The domain service ID. Use `domain_id` from `GET /domains`.
...
// Register DNSSEC DS records on the domain at OpenSRS
DomainsAPI.addDomainDnssec(_id: _id, domainDnssecRequest: domainDnssecRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **Int** | The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. | 
...
# **addDomainNameserver**
```swift
    open class func addDomainNameserver(_id: Int, domainNameserverPostRequest: DomainNameserverPostRequest, completion: @escaping (_ data: TextResponse?, _ error: Error?) -> Void)
```
...
// Register a new nameserver host with glue IP at the registry (registered nameserver)
DomainsAPI.addDomainNameserver(_id: _id, domainNameserverPostRequest: domainNameserverPostRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **cancelDomain**
```swift
    open class func cancelDomain(_id: Int, completion: @escaping (_ data: CancelDomain200Response?, _ error: Error?) -> Void)
```
...
// Cancel a domain order in the billing system to stop auto-renewals
DomainsAPI.cancelDomain(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)
DomainsAPI.deleteDomainDnssec(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Remove one registered nameserver glue record from the domain
DomainsAPI.deleteDomainNameserver(_id: _id, index: index) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Read the current registrant/admin/tech/billing contact field set for a domain
DomainsAPI.getDomainContact(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Read the DNSSEC DS record set currently registered with the registrar
DomainsAPI.getDomainDnssec(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Read full billing, registrar, and service detail for one domain
DomainsAPI.getDomainInfo(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// List all billing invoices scoped to one domain order
DomainsAPI.getDomainInvoices(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// List registered nameserver hosts and glue IP addresses for a domain
DomainsAPI.getDomainNameservers(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Read renewal pricing, expiry, and whether a renewal invoice already exists
DomainsAPI.getDomainRenewal(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Read OpenSRS transfer status for an in-progress domain transfer order
DomainsAPI.getDomainTransfer(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Read Whois privacy availability, current state, and add-on pricing for a domain
DomainsAPI.getDomainWhoisPrivacy(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Resend the domain welcome email with registration details and management instructions
DomainsAPI.getDomainsWelcomeEmail(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchDomains**
```swift
    open class func patchDomains(domainOrderRequest: DomainOrderRequest, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Validate posted domain-order field values before committing — dry run
DomainsAPI.patchDomains(domainOrderRequest: domainOrderRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Submit a domain renewal request and generate the renewal invoice
DomainsAPI.postDomainRenewal(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get the full order form data for a hostname in one round-trip (search → order preview)
DomainsAPI.postDomainSearch(name: name) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Re-poll OpenSRS transfer status for a domain order via POST
DomainsAPI.postDomainTransfer(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **putDomains**
```swift
    open class func putDomains(domainOrderRequest: DomainOrderRequest, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Preview per-TLD field requirements for a domain order — no commit
DomainsAPI.putDomains(domainOrderRequest: domainOrderRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updateDomainContact**
```swift
    open class func updateDomainContact(_id: Int, domainContactDetails: DomainContactDetails, completion: @escaping (_ data: SuccessTextResponse?, _ error: Error?) -> Void)
```
...
// Update registrant/admin contact details and push them to OpenSRS
DomainsAPI.updateDomainContact(_id: _id, domainContactDetails: domainContactDetails) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// POST mutation hook for the domain detail page (use dedicated ops where possible)
DomainsAPI.updateDomainInfo(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func updateDomainNameservers(_id: Int, domainNameserverPutRequest: DomainNameserverPutRequest, completion: @escaping (_ data: TextResponse?, _ error: Error?) -> Void)
```
...
// Replace the full authoritative-nameserver delegation list at the registrar
DomainsAPI.updateDomainNameservers(_id: _id, domainNameserverPutRequest: domainNameserverPutRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updateDomainWhoisPrivacy**
```swift
    open class func updateDomainWhoisPrivacy(_id: Int, domainWhoisPrivacyRequest: DomainWhoisPrivacyRequest, completion: @escaping (_ data: SuccessTextResponse?, _ error: Error?) -> Void)
```
...
// Order, enable, or cancel the Whois privacy add-on for a domain
DomainsAPI.updateDomainWhoisPrivacy(_id: _id, domainWhoisPrivacyRequest: domainWhoisPrivacyRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
