...
let _id = 987 // Int | The credit card ID to remove. Use IDs from `GET /billing/creditcards`.

// Remove a stored credit card from the account
BillingAPI.deleteBillingCreditCard(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **Int** | The credit card ID to remove. Use IDs from &#x60;GET /billing/creditcards&#x60;. | 
...
let _id = 987 // Int | The invoice ID to delete. Only unpaid invoices can be deleted.

// Cancel a pending unpaid invoice — and its pending service or repeat invoice
BillingAPI.deleteBillingInvoice(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **Int** | The invoice ID to delete. Only unpaid invoices can be deleted. | 
...
let _id = 987 // Int | The prepay balance ID to delete.

// Delete an unfunded prepay or strip its unpaid funding invoices
BillingAPI.deleteBillingPrepay(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **Int** | The prepay balance ID to delete. | 
...
let st = "st_example" // String | Filter by status. (optional)
let ex = "ex_example" // String | Export format: csv, xls, xlsx, or pdf. Defaults to csv. (optional)
let year = 987 // Int | Year to filter the report. Defaults to the current year. (optional)

// Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
BillingAPI.getAffiliateDownload(st: st, ex: ex, year: year) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getAffiliateSignups**
```swift
    open class func getAffiliateSignups(st: String? = nil, completion: @escaping (_ data: GetAffiliateSignups200Response?, _ error: Error?) -> Void)
```
...
let st = "st_example" // String | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results. (optional)

// Read affiliate signup stats and per-customer conversion data
BillingAPI.getAffiliateSignups(st: st) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
let _id = 987 // Int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.

// Probe whether a stored card still needs micro-charge verification
BillingAPI.getBillingCreditCardVerify(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **Int** | The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. | 
...
let _id = 987 // Int | The invoice ID. Use IDs from `GET /billing/invoices` or from order responses.

// Read full invoice detail — line items, totals, paid status, customer info
BillingAPI.getBillingInvoice(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **Int** | The invoice ID. Use IDs from &#x60;GET /billing/invoices&#x60; or from order responses. | 
...
```swift
    open class func patchBillingCreditCardVerify(_id: Int, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, completion: @escaping (_ data: SuccessTextResponse?, _ error: Error?) -> Void)
```
...
let _id = 987 // Int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
let patchBillingCreditCardVerifyRequest = patchBillingCreditCardVerify_request(ccCcv2: "ccCcv2_example") // PatchBillingCreditCardVerifyRequest | 

// Place two micro-charges on the card to start CVV verification (step 1 of 2)
BillingAPI.patchBillingCreditCardVerify(_id: _id, patchBillingCreditCardVerifyRequest: patchBillingCreditCardVerifyRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func postBillingCreditCardVerify(_id: Int, billingVerifyCcRequest: BillingVerifyCcRequest, completion: @escaping (_ data: SuccessTextResponse?, _ error: Error?) -> Void)
```
...
// Submit two micro-charge amounts to finalize card verification (step 2 of 2)
BillingAPI.postBillingCreditCardVerify(_id: _id, billingVerifyCcRequest: billingVerifyCcRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
let _id = 987 // Int | The credit card ID. Use IDs from `GET /billing/creditcards` or the response from `POST /billing/creditcards`.

// Refresh stored card expiration and re-trigger MaxMind fraud scoring
BillingAPI.updateBillingCreditCard(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **Int** | The credit card ID. Use IDs from &#x60;GET /billing/creditcards&#x60; or the response from &#x60;POST /billing/creditcards&#x60;. | 
