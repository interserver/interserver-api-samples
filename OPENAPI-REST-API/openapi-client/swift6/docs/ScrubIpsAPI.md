...
# **cancelScrubIp**
```swift
    open class func cancelScrubIp(_id: Int, completion: @escaping (_ data: CancelScrubIp200Response?, _ error: Error?) -> Void)
```
...
let _id = 987 // Int | ScrubIp ID number

// Cancel a Scrub IP service and stop its recurring DDoS billing
ScrubIpsAPI.cancelScrubIp(_id: _id) { (response, error) in
...
# **createFilter**
```swift
    open class func createFilter(_id: Int, createFilter: CreateFilter, completion: @escaping (_ data: CreateFilter201Response?, _ error: Error?) -> Void)
```
...
// Apply a predefined scrubbing filter (DNS/HTTP/synproxy) to a port
ScrubIpsAPI.createFilter(_id: _id, createFilter: createFilter) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **createGeoRule**
```swift
    open class func createGeoRule(_id: Int, createGeoFirewallRule: CreateGeoFirewallRule, completion: @escaping (_ data: CreateRule201Response?, _ error: Error?) -> Void)
```
...
// Add a geographic firewall rule (block/allow by country code or ASN)
ScrubIpsAPI.createGeoRule(_id: _id, createGeoFirewallRule: createGeoFirewallRule) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **createRule**
```swift
    open class func createRule(_id: Int, createFirewallRule: CreateFirewallRule, completion: @escaping (_ data: CreateRule201Response?, _ error: Error?) -> Void)
```
...
// Add an L3/L4 firewall rule (allow/drop by IP, port, and protocol)
ScrubIpsAPI.createRule(_id: _id, createFirewallRule: createFirewallRule) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **deleteFilter**
```swift
    open class func deleteFilter(_id: Int, createFilter: CreateFilter, completion: @escaping (_ data: DeleteFilter200Response?, _ error: Error?) -> Void)
```
...
// Remove a scrubbing filter by matching filter_type and port
ScrubIpsAPI.deleteFilter(_id: _id, createFilter: createFilter) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **disableScrub**
```swift
    open class func disableScrub(_id: Int, completion: @escaping (_ data: DisableScrub200Response?, _ error: Error?) -> Void)
```
...
// Disable DDoS scrubbing and remove the BGP announcement on the IP
ScrubIpsAPI.disableScrub(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **enableScrub**
```swift
    open class func enableScrub(_id: Int, completion: @escaping (_ data: EnableScrub200Response?, _ error: Error?) -> Void)
```
...
// Enable DDoS scrubbing (BGP announcement) on the service's protected IP
ScrubIpsAPI.enableScrub(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getScrubIpDetails**
```swift
    open class func getScrubIpDetails(_id: Int, completion: @escaping (_ data: GetScrubIpDetails200Response?, _ error: Error?) -> Void)
```
...
// Get full Scrub IP service detail (rules + geo + filters)
ScrubIpsAPI.getScrubIpDetails(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// List recurring and one-time invoices billed for this Scrub IP service
ScrubIpsAPI.getScrubIpInvoices(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
let _id = "_id_example" // String | Scrub Order ID

// Get last 50000 packet/event log entries for the protected IP
ScrubIpsAPI.getScrubIpLogs(_id: _id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **putScrubIps**
```swift
    open class func putScrubIps(scrubIpPlaceOrder: ScrubIpPlaceOrder, completion: @escaping (_ data: PutScrubIps200Response?, _ error: Error?) -> Void)
```
...
// Validate a Scrub IP order and return effective pricing without billing
ScrubIpsAPI.putScrubIps(scrubIpPlaceOrder: scrubIpPlaceOrder) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func scrubIpsDeleteGeoRule(_id: Int, deleteGeoFirewallRule: DeleteGeoFirewallRule, completion: @escaping (_ data: ScrubIpsDeleteRule200Response?, _ error: Error?) -> Void)
```
...
// Delete a geo firewall rule by rule_id from getScrubIpDetails
ScrubIpsAPI.scrubIpsDeleteGeoRule(_id: _id, deleteGeoFirewallRule: deleteGeoFirewallRule) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **scrubIpsDeleteRule**
```swift
    open class func scrubIpsDeleteRule(_id: Int, deleteFirewallRule: DeleteFirewallRule, completion: @escaping (_ data: ScrubIpsDeleteRule200Response?, _ error: Error?) -> Void)
```
...
// Delete an L3/L4 firewall rule by rule_id from getScrubIpDetails
ScrubIpsAPI.scrubIpsDeleteRule(_id: _id, deleteFirewallRule: deleteFirewallRule) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
