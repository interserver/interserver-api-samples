...
open class InterserverAPIClientAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = InterserverAPIClientAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: InterserverAPIClientAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared
    ) {
        self.method = method
