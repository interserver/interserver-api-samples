...
@objcMembers public final class HomeTicketStatusView: NSObject, Codable, @unchecked Sendable {

    /** Status corresponding to view number 4. */
    public private(set) var _4: String?
    /** Status corresponding to view number 5. */
    public private(set) var _5: String?
    /** Status corresponding to view number 6. */
    public private(set) var _6: String?
