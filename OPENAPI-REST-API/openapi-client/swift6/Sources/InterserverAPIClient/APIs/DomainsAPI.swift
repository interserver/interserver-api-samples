...
@objcMembers open class DomainsAPI : NSObject {
     ...
     */
    open class func addDomain(domainOrderRequest: DomainOrderRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> ServiceOrderPostResponse {
        return try await addDomainWithRequestBuilder(domainOrderRequest: domainOrderRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func addDomainWithRequestBuilder(domainOrderRequest: DomainOrderRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<ServiceOrderPostResponse> {
        let localVariablePath = "/domains/order"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: domainOrderRequest, codableHelper: apiConfiguration.codableHelper)
     ...
     */
    open class func addDomainDnssec(_id: Int, domainDnssecRequest: DomainDnssecRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await addDomainDnssecWithRequestBuilder(_id: _id, domainDnssecRequest: domainDnssecRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func addDomainDnssecWithRequestBuilder(_id: Int, domainDnssecRequest: DomainDnssecRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
     ...
     */
    open class func addDomainNameserver(_id: Int, domainNameserverPostRequest: DomainNameserverPostRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> TextResponse {
        return try await addDomainNameserverWithRequestBuilder(_id: _id, domainNameserverPostRequest: domainNameserverPostRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func addDomainNameserverWithRequestBuilder(_id: Int, domainNameserverPostRequest: DomainNameserverPostRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<TextResponse> {
     ...
     */
    open class func cancelDomain(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> CancelDomain200Response {
        return try await cancelDomainWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func cancelDomainWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<CancelDomain200Response> {
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func deleteDomainDnssec(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await deleteDomainDnssecWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func deleteDomainDnssecWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
        var localVariablePath = "/domains/{id}/dnssec"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: TextResponse
     */
    open class func deleteDomainNameserver(_id: Int, index: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> TextResponse {
        return try await deleteDomainNameserverWithRequestBuilder(_id: _id, index: index, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<TextResponse> 
     */
    open class func deleteDomainNameserverWithRequestBuilder(_id: Int, index: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<TextResponse> {
        var localVariablePath = "/domains/{id}/nameservers"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
     ...
     */
    open class func getDomainContact(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> DomainContactDetails {
        return try await getDomainContactWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getDomainContactWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<DomainContactDetails> {
     ...
     */
    open class func getDomainDnssec(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> DomainDnssecRecords {
        return try await getDomainDnssecWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getDomainDnssecWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<DomainDnssecRecords> {
        var localVariablePath = "/domains/{id}/dnssec"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: Domain
     */
    open class func getDomainInfo(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> Domain {
        return try await getDomainInfoWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getDomainInfoWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<Domain> {
        var localVariablePath = "/domains/{id}"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
     ...
     */
    open class func getDomainInvoices(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> ChargeInvoiceRows {
        return try await getDomainInvoicesWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getDomainInvoicesWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<ChargeInvoiceRows> {
     ...
     */
    open class func getDomainLookup(name: String, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> DomainLookupResponse {
     ...
     */
    open class func getDomainLookupWithRequestBuilder(name: String, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<DomainLookupResponse> {
     ...
     */
    open class func getDomainNameservers(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> DomainNameserverGetResponse {
        return try await getDomainNameserversWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func getDomainNameserversWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<DomainNameserverGetResponse> {
        var localVariablePath = "/domains/{id}/nameservers"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func getDomainRenewal(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await getDomainRenewalWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func getDomainRenewalWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
     ...
     */
    open class func getDomainSearch(name: String, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> DomainSearchResponse {
     ...
     */
    open class func getDomainSearchWithRequestBuilder(name: String, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<DomainSearchResponse> {
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func getDomainTransfer(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await getDomainTransferWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func getDomainTransferWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func getDomainWhoisPrivacy(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await getDomainWhoisPrivacyWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func getDomainWhoisPrivacyWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
    ...
    /**
     ...
     - returns: [DomainRow]
     */
    open class func getDomainsList(apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> [DomainRow] {
     ...
     */
    open class func getDomainsListWithRequestBuilder(apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<[DomainRow]> {
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func getDomainsWelcomeEmail(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await getDomainsWelcomeEmailWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func getDomainsWelcomeEmailWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
    ...
    /**
     ...
     - returns: DomainOrder
     */
    open class func getNewDomain(apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> DomainOrder {
     ...
     */
    open class func getNewDomainWithRequestBuilder(apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<DomainOrder> {
        let localVariablePath = "/domains/order"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters: [String: any Sendable]? = nil
    ...
    /**
     ...
     - returns: Void
     */
    open class func patchDomains(domainOrderRequest: DomainOrderRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await patchDomainsWithRequestBuilder(domainOrderRequest: domainOrderRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func patchDomainsWithRequestBuilder(domainOrderRequest: DomainOrderRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<Void> {
        let localVariablePath = "/domains/order"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: domainOrderRequest, codableHelper: apiConfiguration.codableHelper)
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func postDomainRenewal(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await postDomainRenewalWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func postDomainRenewalWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
        var localVariablePath = "/domains/{id}/renew"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: Void
     */
    open class func postDomainSearch(name: String, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await postDomainSearchWithRequestBuilder(name: name, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func postDomainSearchWithRequestBuilder(name: String, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<Void> {
        var localVariablePath = "/domains/search/{name}"
        let namePreEscape = "\(APIHelper.mapValueToPathItem(name))"
        let namePostEscape = namePreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{name}", with: namePostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func postDomainTransfer(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await postDomainTransferWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func postDomainTransferWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
        var localVariablePath = "/domains/{id}/transfer"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: Void
     */
    open class func putDomains(domainOrderRequest: DomainOrderRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await putDomainsWithRequestBuilder(domainOrderRequest: domainOrderRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func putDomainsWithRequestBuilder(domainOrderRequest: DomainOrderRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<Void> {
        let localVariablePath = "/domains/order"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: domainOrderRequest, codableHelper: apiConfiguration.codableHelper)
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func updateDomainContact(_id: Int, domainContactDetails: DomainContactDetails, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await updateDomainContactWithRequestBuilder(_id: _id, domainContactDetails: domainContactDetails, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func updateDomainContactWithRequestBuilder(_id: Int, domainContactDetails: DomainContactDetails, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
        var localVariablePath = "/domains/{id}/contact"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func updateDomainInfo(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await updateDomainInfoWithRequestBuilder(_id: _id, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func updateDomainInfoWithRequestBuilder(_id: Int, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
        var localVariablePath = "/domains/{id}"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: TextResponse
     */
    open class func updateDomainNameservers(_id: Int, domainNameserverPutRequest: DomainNameserverPutRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> TextResponse {
        return try await updateDomainNameserversWithRequestBuilder(_id: _id, domainNameserverPutRequest: domainNameserverPutRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<TextResponse> 
     */
    open class func updateDomainNameserversWithRequestBuilder(_id: Int, domainNameserverPutRequest: DomainNameserverPutRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<TextResponse> {
        var localVariablePath = "/domains/{id}/nameservers"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - returns: SuccessTextResponse
     */
    open class func updateDomainWhoisPrivacy(_id: Int, domainWhoisPrivacyRequest: DomainWhoisPrivacyRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> SuccessTextResponse {
        return try await updateDomainWhoisPrivacyWithRequestBuilder(_id: _id, domainWhoisPrivacyRequest: domainWhoisPrivacyRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func updateDomainWhoisPrivacyWithRequestBuilder(_id: Int, domainWhoisPrivacyRequest: DomainWhoisPrivacyRequest, apiConfiguration: InterserverAPIClientAPIConfiguration = InterserverAPIClientAPIConfiguration.shared) -> RequestBuilder<SuccessTextResponse> {
        var localVariablePath = "/domains/{id}/whois"
        let _idPreEscape = "\(APIHelper.mapValueToPathItem(_id))"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
