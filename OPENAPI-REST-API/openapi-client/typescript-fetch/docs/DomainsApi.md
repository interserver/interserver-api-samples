...
async function example() {
  ...
  const body = {
    // DomainOrderRequest
    domainOrderRequest: ...,
  } satisfies AddDomainRequest;

  try {
    const data = await api.addDomain(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
async function example() {
  ...
  const body = {
    // DomainOrderRequest
    domainOrderRequest: ...,
  } satisfies PatchDomainsRequest;

  try {
    const data = await api.patchDomains(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { PostDomainSearchRequest } from '';
...
async function example() {
  ...
  const body = {
    // string | The base domain name to search (for example `example` or `example.com`).
    name: name_example,
  } satisfies PostDomainSearchRequest;

  try {
    const data = await api.postDomainSearch(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
async function example() {
  ...
  const body = {
    // DomainOrderRequest
    domainOrderRequest: ...,
  } satisfies PutDomainsRequest;

  try {
    const data = await api.putDomains(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
