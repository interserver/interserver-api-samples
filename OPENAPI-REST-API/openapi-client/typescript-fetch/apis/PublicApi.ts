...
} from '../models/LoginSubmissionExample';
import {
...
export class PublicApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getAccountCurrencies without sending the request
     */
    async getAccountCurrenciesRequestOpts(): Promise<runtime.RequestOpts> {
        ...
        let urlPath = `/account/currencies`;
     ...
     */
    async getAccountCurrenciesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<string>>> {
        const requestOptions = await this.getAccountCurrenciesRequestOpts();
     ...
     * List enabled currency codes accepted for billing and preferences
     */
    async getAccountCurrencies(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<string>> {
        const response = await this.getAccountCurrenciesRaw(initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for getAccountLocales without sending the request
     */
    async getAccountLocalesRequestOpts(): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
     ...
     */
    async getAccountLocalesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: GetAccountLocales200ResponseValue; }>> {
        const requestOptions = await this.getAccountLocalesRequestOpts();
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => runtime.mapValues(jsonValue, GetAccountLocales200ResponseValueFromJSON));
    }
     ...
     * List supported UI locales with English and native display names
     */
    async getAccountLocales(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: GetAccountLocales200ResponseValue; }> {
        const response = await this.getAccountLocalesRaw(initOverrides);
        return await response.value();
    }
