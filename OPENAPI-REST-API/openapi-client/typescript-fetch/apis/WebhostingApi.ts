...
import {
    type WebhostingCancel200Response,
    WebhostingCancel200ResponseFromJSON,
    WebhostingCancel200ResponseToJSON,
} from '../models/WebhostingCancel200Response';
import {
    type Website,
    WebsiteFromJSON,
    WebsiteToJSON,
...
} from '../models/WebsiteBackups';
import {
    type WebsiteLoginResponse,
    WebsiteLoginResponseFromJSON,
    WebsiteLoginResponseToJSON,
} from '../models/WebsiteLoginResponse';
import {
    type WebsiteOrderPostRequest,
    WebsiteOrderPostRequestFromJSON,
    WebsiteOrderPostRequestToJSON,
} from '../models/WebsiteOrderPostRequest';
import {
    type WebsiteOrderPutRequest,
    WebsiteOrderPutRequestFromJSON,
    WebsiteOrderPutRequestToJSON,
} from '../models/WebsiteOrderPutRequest';
import {
    type WebsiteRow,
    WebsiteRowFromJSON,
    WebsiteRowToJSON,
} from '../models/WebsiteRow';
import {
    type WebsitesOrder,
    WebsitesOrderFromJSON,
    WebsitesOrderToJSON,
} from '../models/WebsitesOrder';
...
export class WebhostingApi extends runtime.BaseAPI {
     ...
     */
    async addWebsiteRequestOpts(requestParameters: AddWebsiteRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['websiteOrderPostRequest'] == null) {
            throw new runtime.RequiredError(
                'websiteOrderPostRequest',
                'Required parameter "websiteOrderPostRequest" was null or undefined when calling addWebsite().'
            );
        }
        ...
        return {
            ...
            body: WebsiteOrderPostRequestToJSON(requestParameters['websiteOrderPostRequest']),
        };
    }
     ...
     */
    async addWebsiteRaw(requestParameters: AddWebsiteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ServiceOrderPostResponse>> {
        const requestOptions = await this.addWebsiteRequestOpts(requestParameters);
     ...
     * Place a new webhosting order, create the invoice, and queue provisioning
     */
    async addWebsite(requestParameters: AddWebsiteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ServiceOrderPostResponse> {
        const response = await this.addWebsiteRaw(requestParameters, initOverrides);
     ...
     */
    async putWebsitesRequestOpts(requestParameters: PutWebsitesRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['websiteOrderPutRequest'] == null) {
            throw new runtime.RequiredError(
                'websiteOrderPutRequest',
                'Required parameter "websiteOrderPutRequest" was null or undefined when calling putWebsites().'
            );
        }
        ...
        return {
            ...
            headers: headerParameters,
            query: queryParameters,
            body: WebsiteOrderPutRequestToJSON(requestParameters['websiteOrderPutRequest']),
        };
    }
     ...
     */
    async putWebsitesRaw(requestParameters: PutWebsitesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.putWebsitesRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Validate a webhosting order and preview cost — dry run, no charge
     */
    async putWebsites(requestParameters: PutWebsitesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.putWebsitesRaw(requestParameters, initOverrides);
    }
