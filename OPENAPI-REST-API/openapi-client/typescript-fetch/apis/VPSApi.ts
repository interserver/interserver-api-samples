...
import {
    type VPSCancel200Response,
    VPSCancel200ResponseFromJSON,
    VPSCancel200ResponseToJSON,
} from '../models/VPSCancel200Response';
import {
    type Vps,
    VpsFromJSON,
    VpsToJSON,
...
import {
    type VpsTrafficResponse,
    VpsTrafficResponseFromJSON,
    VpsTrafficResponseToJSON,
} from '../models/VpsTrafficResponse';
...
export interface GetVpsBackupRequest {
    id: number;
}
...
export interface GetVpsChangeHostnameRequest {
    id: number;
}

export interface GetVpsChangeRootPasswordRequest {
    id: number;
}
...
export interface GetVpsInsertCdRequest {
    id: number;
}
...
export interface GetVpsResetPasswordRequest {
    id: number;
}
...
export interface PostVpsTrafficUsageRequest {
    id: number;
}
...
export interface PutVpsBuyHdSpaceRequest {
    id: number;
}
...
export class VPSApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getVpsBackup without sending the request
     */
    async getVpsBackupRequestOpts(requestParameters: GetVpsBackupRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getVpsBackup().'
            );
        }
     ...
     */
    async getVpsBackupRaw(requestParameters: GetVpsBackupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<QueueResponse>> {
        const requestOptions = await this.getVpsBackupRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Trigger a manual on-demand snapshot/backup of the VPS
     */
    async getVpsBackup(requestParameters: GetVpsBackupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<QueueResponse> {
        const response = await this.getVpsBackupRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     * Creates request options for getVpsChangeHostname without sending the request
     */
    async getVpsChangeHostnameRequestOpts(requestParameters: GetVpsChangeHostnameRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getVpsChangeHostname().'
            );
        }
     ...
     */
    async getVpsChangeHostnameRaw(requestParameters: GetVpsChangeHostnameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.getVpsChangeHostnameRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Read the VPS\'s current hostname before changing it
     */
    async getVpsChangeHostname(requestParameters: GetVpsChangeHostnameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getVpsChangeHostnameRaw(requestParameters, initOverrides);
    }

    /**
     * Creates request options for getVpsChangeRootPassword without sending the request
     */
    async getVpsChangeRootPasswordRequestOpts(requestParameters: GetVpsChangeRootPasswordRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getVpsChangeRootPassword().'
            );
        }
     ...
     */
    async getVpsChangeRootPasswordRaw(requestParameters: GetVpsChangeRootPasswordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.getVpsChangeRootPasswordRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Pre-flight check before changing the VPS root password
     */
    async getVpsChangeRootPassword(requestParameters: GetVpsChangeRootPasswordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getVpsChangeRootPasswordRaw(requestParameters, initOverrides);
    }
    ...
    /**
     * Creates request options for getVpsInsertCd without sending the request
     */
    async getVpsInsertCdRequestOpts(requestParameters: GetVpsInsertCdRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getVpsInsertCd().'
            );
        }
     ...
     */
    async getVpsInsertCdRaw(requestParameters: GetVpsInsertCdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.getVpsInsertCdRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * List ISO templates that can be mounted in the VPS virtual CD drive
     */
    async getVpsInsertCd(requestParameters: GetVpsInsertCdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getVpsInsertCdRaw(requestParameters, initOverrides);
    }
    ...
    /**
     * Creates request options for getVpsResetPassword without sending the request
     */
    async getVpsResetPasswordRequestOpts(requestParameters: GetVpsResetPasswordRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getVpsResetPassword().'
            );
        }
     ...
     */
    async getVpsResetPasswordRaw(requestParameters: GetVpsResetPasswordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.getVpsResetPasswordRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Pre-flight check before resetting the VPS root password to a random value
     */
    async getVpsResetPassword(requestParameters: GetVpsResetPasswordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getVpsResetPasswordRaw(requestParameters, initOverrides);
    }
    ...
    /**
     * Creates request options for postVpsTrafficUsage without sending the request
     */
    async postVpsTrafficUsageRequestOpts(requestParameters: PostVpsTrafficUsageRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling postVpsTrafficUsage().'
            );
        }
     ...
     */
    async postVpsTrafficUsageRaw(requestParameters: PostVpsTrafficUsageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.postVpsTrafficUsageRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Search/filter VPS bandwidth usage with custom criteria (reserved)
     */
    async postVpsTrafficUsage(requestParameters: PostVpsTrafficUsageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.postVpsTrafficUsageRaw(requestParameters, initOverrides);
    }
    ...
    /**
     * Creates request options for putVpsBuyHdSpace without sending the request
     */
    async putVpsBuyHdSpaceRequestOpts(requestParameters: PutVpsBuyHdSpaceRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling putVpsBuyHdSpace().'
            );
        }
     ...
     */
    async putVpsBuyHdSpaceRaw(requestParameters: PutVpsBuyHdSpaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.putVpsBuyHdSpaceRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Preview cost to set additional VPS disk to a target GB size — dry run
     */
    async putVpsBuyHdSpace(requestParameters: PutVpsBuyHdSpaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.putVpsBuyHdSpaceRaw(requestParameters, initOverrides);
    }
