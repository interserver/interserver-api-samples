...
import {
    type CancelDomain200Response,
    CancelDomain200ResponseFromJSON,
    CancelDomain200ResponseToJSON,
} from '../models/CancelDomain200Response';
import {
...
export interface PatchDomainsRequest {
    domainOrderRequest: DomainOrderRequest;
}
...
export interface PostDomainSearchRequest {
    name: string;
}
...
export interface PutDomainsRequest {
    domainOrderRequest: DomainOrderRequest;
}
...
export class DomainsApi extends runtime.BaseAPI {
     ...
     */
    async addDomainRequestOpts(requestParameters: AddDomainRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['domainOrderRequest'] == null) {
            throw new runtime.RequiredError(
                'domainOrderRequest',
                'Required parameter "domainOrderRequest" was null or undefined when calling addDomain().'
            );
        }
        ...
        return {
            ...
            body: DomainOrderRequestToJSON(requestParameters['domainOrderRequest']),
        };
    }
     ...
     */
    async addDomainRaw(requestParameters: AddDomainRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ServiceOrderPostResponse>> {
        const requestOptions = await this.addDomainRequestOpts(requestParameters);
     ...
     * Place a new domain registration or transfer order, generate billing invoice
     */
    async addDomain(requestParameters: AddDomainRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ServiceOrderPostResponse> {
        const response = await this.addDomainRaw(requestParameters, initOverrides);
     ...
     */
    async patchDomainsRequestOpts(requestParameters: PatchDomainsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['domainOrderRequest'] == null) {
            throw new runtime.RequiredError(
                'domainOrderRequest',
                'Required parameter "domainOrderRequest" was null or undefined when calling patchDomains().'
            );
        }
     ...
     */
    async patchDomainsRaw(requestParameters: PatchDomainsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.patchDomainsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Validate posted domain-order field values before committing — dry run
     */
    async patchDomains(requestParameters: PatchDomainsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.patchDomainsRaw(requestParameters, initOverrides);
    }
    ...
    /**
     * Creates request options for postDomainSearch without sending the request
     */
    async postDomainSearchRequestOpts(requestParameters: PostDomainSearchRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling postDomainSearch().'
            );
        }
     ...
     */
    async postDomainSearchRaw(requestParameters: PostDomainSearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.postDomainSearchRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Get the full order form data for a hostname in one round-trip (search → order preview)
     */
    async postDomainSearch(requestParameters: PostDomainSearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.postDomainSearchRaw(requestParameters, initOverrides);
    }
     ...
     */
    async putDomainsRequestOpts(requestParameters: PutDomainsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['domainOrderRequest'] == null) {
            throw new runtime.RequiredError(
                'domainOrderRequest',
                'Required parameter "domainOrderRequest" was null or undefined when calling putDomains().'
            );
        }
     ...
     */
    async putDomainsRaw(requestParameters: PutDomainsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const requestOptions = await this.putDomainsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Preview per-TLD field requirements for a domain order — no commit
     */
    async putDomains(requestParameters: PutDomainsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.putDomainsRaw(requestParameters, initOverrides);
    }
