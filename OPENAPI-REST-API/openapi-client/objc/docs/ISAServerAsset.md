...
------------ | ------------- | ------------- | -------------
**_id** | **NSNumber*** | Unique identifier for the asset. | 
**orderId** | **NSString*** | Order identifier for the asset. | 
**hostname** | **NSString*** | Hostname associated with the asset. | 
...
**rack** | **NSString*** | Rack identifier for the asset. | 
**row** | **NSString*** | Row identifier for the asset. | 
**col** | **NSString*** | Column identifier for the asset. | 
**unitStart** | **NSString*** | Starting unit identifier for the asset. | 
**unitEnd** | **NSString*** | Ending unit identifier for the asset. | 
...
**make** | **NSString*** | Make of the asset. | 
**model** | **NSString*** | Model of the asset. | 
**_description** | **NSString*** | Description of the asset. | 
**customerId** | **NSString*** | Customer identifier for the asset. | 
...
**rackName** | **NSString*** | Rack name associated with the asset. | 
**rackLocation** | **NSString*** | Location of the rack associated with the asset. | 
