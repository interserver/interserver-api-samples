...
------------- | ------------- | -------------
[**addWebsite**](ISAWebhostingApi.md#addwebsite) | **POST** /websites/order | Place a new webhosting order, create the invoice, and queue provisioning
[**getNewWebsite**](ISAWebhostingApi.md#getnewwebsite) | **GET** /websites/order | Read the webhosting order catalog — plans, packages, promo offers, pricing
[**getWebsiteBuyIp**](ISAWebhostingApi.md#getwebsitebuyip) | **GET** /websites/{id}/buy_ip | Read website IPs, current reverse DNS, and additional-IP pricing
[**getWebsiteInfo**](ISAWebhostingApi.md#getwebsiteinfo) | **GET** /websites/{id} | Read full configuration and status detail for one webhosting service
[**getWebsiteInvoices**](ISAWebhostingApi.md#getwebsiteinvoices) | **GET** /websites/{id}/invoices | List all billing invoices and recurring charges scoped to one website
[**getWebsiteList**](ISAWebhostingApi.md#getwebsitelist) | **GET** /websites | List the caller&#39;s webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services
[**getWebsitesBackups**](ISAWebhostingApi.md#getwebsitesbackups) | **GET** /websites/{id}/backups | List off-site cpmove backups stored in Swift — list or inline-download archive
[**getWebsitesLogin**](ISAWebhostingApi.md#getwebsiteslogin) | **GET** /websites/{id}/login | Get a one-time auto-login URL for the website&#39;s control panel
[**getWebsitesWelcomeEmail**](ISAWebhostingApi.md#getwebsiteswelcomeemail) | **GET** /websites/{id}/welcome_email | Resend the webhosting welcome email with control-panel credentials and URL
[**gettWebsiteReverseDns**](ISAWebhostingApi.md#gettwebsitereversedns) | **GET** /websites/{id}/reverse_dns | Read current reverse-DNS (PTR) records for the website&#39;s IPs
[**postWebsiteBuyIp**](ISAWebhostingApi.md#postwebsitebuyip) | **POST** /websites/{id}/buy_ip | Buy an additional IP for the website OR update reverse DNS records
[**postWebsiteMigration**](ISAWebhostingApi.md#postwebsitemigration) | **POST** /websites/{id}/migration | Submit a request for InterServer staff to migrate a website from another host
[**postWebsitesReverseDns**](ISAWebhostingApi.md#postwebsitesreversedns) | **POST** /websites/{id}/reverse_dns | Bulk-update reverse-DNS (PTR) records for one or more website IPs
[**putWebsites**](ISAWebhostingApi.md#putwebsites) | **PUT** /websites/order | Validate a webhosting order and preview cost — dry run, no charge
[**updateWebsiteInfo**](ISAWebhostingApi.md#updatewebsiteinfo) | **POST** /websites/{id} | POST mutation hook for the website detail page (use dedicated ops where possible)
[**webhostingCancel**](ISAWebhostingApi.md#webhostingcancel) | **DELETE** /websites/{id} | Schedule termination of a webhosting service — wipes panel account at cycle end


# **addWebsite**
```objc
-(NSURLSessionTask*) addWebsiteWithWebsiteOrderPostRequest: (ISAWebsiteOrderPostRequest*) websiteOrderPostRequest
...
ISAWebsiteOrderPostRequest* websiteOrderPostRequest = [[ISAWebsiteOrderPostRequest alloc] init]; // 

ISAWebhostingApi*apiInstance = [[ISAWebhostingApi alloc] init];

// Place a new webhosting order, create the invoice, and queue provisioning
[apiInstance addWebsiteWithWebsiteOrderPostRequest:websiteOrderPostRequest
          completionHandler: ^(ISAServiceOrderPostResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->addWebsite: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **websiteOrderPostRequest** | [**ISAWebsiteOrderPostRequest***](ISAWebsiteOrderPostRequest.md)|  | 
...
# **getNewWebsite**
```objc
-(NSURLSessionTask*) getNewWebsiteWithCompletionHandler: 
        (void (^)(ISAWebsitesOrder* output, NSError* error)) handler;
```
...
// Read the webhosting order catalog — plans, packages, promo offers, pricing
[apiInstance getNewWebsiteWithCompletionHandler: 
          ^(ISAWebsitesOrder* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->getNewWebsite: %@", error);
                        }
                    }];
```
...
[**ISAWebsitesOrder***](ISAWebsitesOrder.md)
...
# **getWebsiteBuyIp**
```objc
-(NSURLSessionTask*) getWebsiteBuyIpWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAGetWebsiteBuyIp200Response* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The website service ID. Use `website_id` from `GET /websites`.

ISAWebhostingApi*apiInstance = [[ISAWebhostingApi alloc] init];

// Read website IPs, current reverse DNS, and additional-IP pricing
[apiInstance getWebsiteBuyIpWithId:_id
          completionHandler: ^(ISAGetWebsiteBuyIp200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->getWebsiteBuyIp: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;. | 

### Return type

[**ISAGetWebsiteBuyIp200Response***](ISAGetWebsiteBuyIp200Response.md)
...
# **getWebsiteInfo**
```objc
-(NSURLSessionTask*) getWebsiteInfoWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAWebsite* output, NSError* error)) handler;
```
...
// Read full configuration and status detail for one webhosting service
[apiInstance getWebsiteInfoWithId:_id
          completionHandler: ^(ISAWebsite* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->getWebsiteInfo: %@", error);
                        }
                    }];
```
...
# **getWebsiteInvoices**
```objc
-(NSURLSessionTask*) getWebsiteInvoicesWithId: (NSNumber*) _id
...
// List all billing invoices and recurring charges scoped to one website
[apiInstance getWebsiteInvoicesWithId:_id
          completionHandler: ^(ISAChargeInvoiceRows* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->getWebsiteInvoices: %@", error);
                        }
                    }];
```
...
# **getWebsiteList**
```objc
-(NSURLSessionTask*) getWebsiteListWithCompletionHandler: 
        (void (^)(NSArray<ISAWebsiteRow>* output, NSError* error)) handler;
```
...
// List the caller's webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services
[apiInstance getWebsiteListWithCompletionHandler: 
          ^(NSArray<ISAWebsiteRow>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->getWebsiteList: %@", error);
                        }
                    }];
```
...
[**NSArray<ISAWebsiteRow>***](ISAWebsiteRow.md)
...
# **getWebsitesBackups**
```objc
-(NSURLSessionTask*) getWebsitesBackupsWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAWebsiteBackups* output, NSError* error)) handler;
```
...
// List off-site cpmove backups stored in Swift — list or inline-download archive
[apiInstance getWebsitesBackupsWithId:_id
          completionHandler: ^(ISAWebsiteBackups* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->getWebsitesBackups: %@", error);
                        }
                    }];
```
...
[**ISAWebsiteBackups***](ISAWebsiteBackups.md)
...
# **getWebsitesLogin**
```objc
-(NSURLSessionTask*) getWebsitesLoginWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAWebsiteLoginResponse* output, NSError* error)) handler;
```
...
// Get a one-time auto-login URL for the website's control panel
[apiInstance getWebsitesLoginWithId:_id
          completionHandler: ^(ISAWebsiteLoginResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->getWebsitesLogin: %@", error);
                        }
                    }];
```
...
[**ISAWebsiteLoginResponse***](ISAWebsiteLoginResponse.md)
...
```objc
-(NSURLSessionTask*) getWebsitesWelcomeEmailWithId: (NSNumber*) _id
...
// Resend the webhosting welcome email with control-panel credentials and URL
[apiInstance getWebsitesWelcomeEmailWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->getWebsitesWelcomeEmail: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) gettWebsiteReverseDnsWithId: (NSNumber*) _id
...
// Read current reverse-DNS (PTR) records for the website's IPs
[apiInstance gettWebsiteReverseDnsWithId:_id
          completionHandler: ^(ISAReverseDnsEntries* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->gettWebsiteReverseDns: %@", error);
                        }
                    }];
```
...
# **postWebsiteBuyIp**
```objc
-(NSURLSessionTask*) postWebsiteBuyIpWithId: (NSNumber*) _id
    postWebsiteBuyIpRequest: (ISAPostWebsiteBuyIpRequest*) postWebsiteBuyIpRequest
        completionHandler: (void (^)(ISAPostWebsiteBuyIp200Response* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The website service ID. Use `website_id` from `GET /websites`.
ISAPostWebsiteBuyIpRequest* postWebsiteBuyIpRequest = [[ISAPostWebsiteBuyIpRequest alloc] init]; // 

ISAWebhostingApi*apiInstance = [[ISAWebhostingApi alloc] init];

// Buy an additional IP for the website OR update reverse DNS records
[apiInstance postWebsiteBuyIpWithId:_id
              postWebsiteBuyIpRequest:postWebsiteBuyIpRequest
          completionHandler: ^(ISAPostWebsiteBuyIp200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->postWebsiteBuyIp: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;. | 
 **postWebsiteBuyIpRequest** | [**ISAPostWebsiteBuyIpRequest***](ISAPostWebsiteBuyIpRequest.md)|  | 

### Return type

[**ISAPostWebsiteBuyIp200Response***](ISAPostWebsiteBuyIp200Response.md)
...
```objc
-(NSURLSessionTask*) postWebsiteMigrationWithId: (NSNumber*) _id
    postWebsiteMigrationRequest: (ISAPostWebsiteMigrationRequest*) postWebsiteMigrationRequest
        completionHandler: (void (^)(ISAPostWebsiteMigration200Response* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The website service ID. Use `website_id` from `GET /websites`.
ISAPostWebsiteMigrationRequest* postWebsiteMigrationRequest = [[ISAPostWebsiteMigrationRequest alloc] init]; // 

ISAWebhostingApi*apiInstance = [[ISAWebhostingApi alloc] init];

// Submit a request for InterServer staff to migrate a website from another host
[apiInstance postWebsiteMigrationWithId:_id
              postWebsiteMigrationRequest:postWebsiteMigrationRequest
          completionHandler: ^(ISAPostWebsiteMigration200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->postWebsiteMigration: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;. | 
 **postWebsiteMigrationRequest** | [**ISAPostWebsiteMigrationRequest***](ISAPostWebsiteMigrationRequest.md)|  | 

### Return type

[**ISAPostWebsiteMigration200Response***](ISAPostWebsiteMigration200Response.md)
...
# **postWebsitesReverseDns**
```objc
-(NSURLSessionTask*) postWebsitesReverseDnsWithId: (NSNumber*) _id
...
// Bulk-update reverse-DNS (PTR) records for one or more website IPs
[apiInstance postWebsitesReverseDnsWithId:_id
          ...
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->postWebsitesReverseDns: %@", error);
                        }
                    }];
```
...
# **putWebsites**
```objc
-(NSURLSessionTask*) putWebsitesWithWebsiteOrderPutRequest: (ISAWebsiteOrderPutRequest*) websiteOrderPutRequest
...
ISAWebsiteOrderPutRequest* websiteOrderPutRequest = [[ISAWebsiteOrderPutRequest alloc] init]; // 

ISAWebhostingApi*apiInstance = [[ISAWebhostingApi alloc] init];

// Validate a webhosting order and preview cost — dry run, no charge
[apiInstance putWebsitesWithWebsiteOrderPutRequest:websiteOrderPutRequest
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->putWebsites: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **websiteOrderPutRequest** | [**ISAWebsiteOrderPutRequest***](ISAWebsiteOrderPutRequest.md)|  | 
...
# **updateWebsiteInfo**
```objc
-(NSURLSessionTask*) updateWebsiteInfoWithId: (NSString*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSString* _id = @"_id_example"; // The website service ID. Use `website_id` from `GET /websites`.

ISAWebhostingApi*apiInstance = [[ISAWebhostingApi alloc] init];

// POST mutation hook for the website detail page (use dedicated ops where possible)
[apiInstance updateWebsiteInfoWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->updateWebsiteInfo: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSString***| The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;. | 
...
# **webhostingCancel**
```objc
-(NSURLSessionTask*) webhostingCancelWithId: (NSString*) _id
        completionHandler: (void (^)(ISAWebhostingCancel200Response* output, NSError* error)) handler;
```
...
NSString* _id = 123; // The website service ID. Use `website_id` from `GET /websites`.

ISAWebhostingApi*apiInstance = [[ISAWebhostingApi alloc] init];

// Schedule termination of a webhosting service — wipes panel account at cycle end
[apiInstance webhostingCancelWithId:_id
          completionHandler: ^(ISAWebhostingCancel200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAWebhostingApi->webhostingCancel: %@", error);
                        }
                    }];
```
...
[**ISAWebhostingCancel200Response***](ISAWebhostingCancel200Response.md)
