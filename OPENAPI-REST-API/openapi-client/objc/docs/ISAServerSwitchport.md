...
------------ | ------------- | ------------- | -------------
**switchportId** | **NSNumber*** | Unique identifier for the switchport. | 
**switchId** | **NSString*** | Unique identifier for the switch associated with the switchport. | 
**_switch** | **NSString*** | Name of the switch associated with the switchport. | 
**port** | **NSString*** | Port name on the switch. | 
