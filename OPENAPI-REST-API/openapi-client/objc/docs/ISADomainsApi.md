...
------------- | ------------- | -------------
[**addDomain**](ISADomainsApi.md#adddomain) | **POST** /domains/order | Place a new domain registration or transfer order, generate billing invoice
[**addDomainDnssec**](ISADomainsApi.md#adddomaindnssec) | **POST** /domains/{id}/dnssec | Register DNSSEC DS records on the domain at OpenSRS
[**addDomainNameserver**](ISADomainsApi.md#adddomainnameserver) | **POST** /domains/{id}/nameservers | Register a new nameserver host with glue IP at the registry (registered nameserver)
[**cancelDomain**](ISADomainsApi.md#canceldomain) | **DELETE** /domains/{id} | Cancel a domain order in the billing system to stop auto-renewals
[**deleteDomainDnssec**](ISADomainsApi.md#deletedomaindnssec) | **DELETE** /domains/{id}/dnssec | Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)
[**deleteDomainNameserver**](ISADomainsApi.md#deletedomainnameserver) | **DELETE** /domains/{id}/nameservers | Remove one registered nameserver glue record from the domain
[**getDomainContact**](ISADomainsApi.md#getdomaincontact) | **GET** /domains/{id}/contact | Read the current registrant/admin/tech/billing contact field set for a domain
[**getDomainDnssec**](ISADomainsApi.md#getdomaindnssec) | **GET** /domains/{id}/dnssec | Read the DNSSEC DS record set currently registered with the registrar
[**getDomainInfo**](ISADomainsApi.md#getdomaininfo) | **GET** /domains/{id} | Read full billing, registrar, and service detail for one domain
[**getDomainInvoices**](ISADomainsApi.md#getdomaininvoices) | **GET** /domains/{id}/invoices | List all billing invoices scoped to one domain order
[**getDomainLookup**](ISADomainsApi.md#getdomainlookup) | **GET** /domains/lookup/{name} | Check availability, premium status, and pricing for a specific domain
[**getDomainNameservers**](ISADomainsApi.md#getdomainnameservers) | **GET** /domains/{id}/nameservers | List registered nameserver hosts and glue IP addresses for a domain
[**getDomainRenewal**](ISADomainsApi.md#getdomainrenewal) | **GET** /domains/{id}/renew | Read renewal pricing, expiry, and whether a renewal invoice already exists
[**getDomainSearch**](ISADomainsApi.md#getdomainsearch) | **GET** /domains/search/{name} | Get registrar-suggested domain alternatives and bulk availability for a search term
[**getDomainTransfer**](ISADomainsApi.md#getdomaintransfer) | **GET** /domains/{id}/transfer | Read OpenSRS transfer status for an in-progress domain transfer order
[**getDomainWhoisPrivacy**](ISADomainsApi.md#getdomainwhoisprivacy) | **GET** /domains/{id}/whois | Read Whois privacy availability, current state, and add-on pricing for a domain
[**getDomainsList**](ISADomainsApi.md#getdomainslist) | **GET** /domains | List every domain registration on the account with billing and registration metadata
[**getDomainsWelcomeEmail**](ISADomainsApi.md#getdomainswelcomeemail) | **GET** /domains/{id}/welcome_email | Resend the domain welcome email with registration details and management instructions
[**getNewDomain**](ISADomainsApi.md#getnewdomain) | **GET** /domains/order | Read the buyable domain TLD service catalog and Whois privacy pricing
[**patchDomains**](ISADomainsApi.md#patchdomains) | **PATCH** /domains/order | Validate posted domain-order field values before committing — dry run
[**postDomainRenewal**](ISADomainsApi.md#postdomainrenewal) | **POST** /domains/{id}/renew | Submit a domain renewal request and generate the renewal invoice
[**postDomainSearch**](ISADomainsApi.md#postdomainsearch) | **POST** /domains/search/{name} | Get the full order form data for a hostname in one round-trip (search → order preview)
[**postDomainTransfer**](ISADomainsApi.md#postdomaintransfer) | **POST** /domains/{id}/transfer | Re-poll OpenSRS transfer status for a domain order via POST
[**putDomains**](ISADomainsApi.md#putdomains) | **PUT** /domains/order | Preview per-TLD field requirements for a domain order — no commit
[**updateDomainContact**](ISADomainsApi.md#updatedomaincontact) | **POST** /domains/{id}/contact | Update registrant/admin contact details and push them to OpenSRS
[**updateDomainInfo**](ISADomainsApi.md#updatedomaininfo) | **POST** /domains/{id} | POST mutation hook for the domain detail page (use dedicated ops where possible)
[**updateDomainNameservers**](ISADomainsApi.md#updatedomainnameservers) | **PUT** /domains/{id}/nameservers | Replace the full authoritative-nameserver delegation list at the registrar
[**updateDomainWhoisPrivacy**](ISADomainsApi.md#updatedomainwhoisprivacy) | **POST** /domains/{id}/whois | Order, enable, or cancel the Whois privacy add-on for a domain


# **addDomain**
```objc
-(NSURLSessionTask*) addDomainWithDomainOrderRequest: (ISADomainOrderRequest*) domainOrderRequest
...
ISADomainOrderRequest* domainOrderRequest = [[ISADomainOrderRequest alloc] init]; // 

ISADomainsApi*apiInstance = [[ISADomainsApi alloc] init];

// Place a new domain registration or transfer order, generate billing invoice
[apiInstance addDomainWithDomainOrderRequest:domainOrderRequest
          completionHandler: ^(ISAServiceOrderPostResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->addDomain: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **domainOrderRequest** | [**ISADomainOrderRequest***](ISADomainOrderRequest.md)|  | 
...
# **addDomainDnssec**
```objc
-(NSURLSessionTask*) addDomainDnssecWithId: (NSNumber*) _id
    domainDnssecRequest: (ISADomainDnssecRequest*) domainDnssecRequest
...
NSNumber* _id = @56; // The domain service ID. Use `domain_id` from `GET /domains`.
ISADomainDnssecRequest* domainDnssecRequest = [[ISADomainDnssecRequest alloc] init]; // 

ISADomainsApi*apiInstance = [[ISADomainsApi alloc] init];

// Register DNSSEC DS records on the domain at OpenSRS
[apiInstance addDomainDnssecWithId:_id
          ...
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->addDomainDnssec: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. | 
 **domainDnssecRequest** | [**ISADomainDnssecRequest***](ISADomainDnssecRequest.md)|  | 
...
# **addDomainNameserver**
```objc
-(NSURLSessionTask*) addDomainNameserverWithId: (NSNumber*) _id
    domainNameserverPostRequest: (ISADomainNameserverPostRequest*) domainNameserverPostRequest
...
NSNumber* _id = @56; // The domain service ID. Use `domain_id` from `GET /domains`.
ISADomainNameserverPostRequest* domainNameserverPostRequest = [[ISADomainNameserverPostRequest alloc] init]; // 

ISADomainsApi*apiInstance = [[ISADomainsApi alloc] init];

// Register a new nameserver host with glue IP at the registry (registered nameserver)
[apiInstance addDomainNameserverWithId:_id
          ...
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->addDomainNameserver: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. | 
 **domainNameserverPostRequest** | [**ISADomainNameserverPostRequest***](ISADomainNameserverPostRequest.md)|  | 
...
# **cancelDomain**
```objc
-(NSURLSessionTask*) cancelDomainWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISACancelDomain200Response* output, NSError* error)) handler;
```
...
// Cancel a domain order in the billing system to stop auto-renewals
[apiInstance cancelDomainWithId:_id
          completionHandler: ^(ISACancelDomain200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->cancelDomain: %@", error);
                        }
                    }];
```
...
[**ISACancelDomain200Response***](ISACancelDomain200Response.md)
...
# **deleteDomainDnssec**
```objc
-(NSURLSessionTask*) deleteDomainDnssecWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
// Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)
[apiInstance deleteDomainDnssecWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->deleteDomainDnssec: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) deleteDomainNameserverWithId: (NSNumber*) _id
...
NSNumber* _id = @56; // The domain service ID. Use `domain_id` from `GET /domains`.
NSNumber* index = @56; // The index of the registered nameserver from the registered nameservers list to delete.  

ISADomainsApi*apiInstance = [[ISADomainsApi alloc] init];

// Remove one registered nameserver glue record from the domain
[apiInstance deleteDomainNameserverWithId:_id
              index:index
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        ...
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->deleteDomainNameserver: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. | 
 **index** | **NSNumber***| The index of the registered nameserver from the registered nameservers list to delete.   | 
...
# **getDomainContact**
```objc
-(NSURLSessionTask*) getDomainContactWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISADomainContactDetails* output, NSError* error)) handler;
```
...
// Read the current registrant/admin/tech/billing contact field set for a domain
[apiInstance getDomainContactWithId:_id
          completionHandler: ^(ISADomainContactDetails* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainContact: %@", error);
                        }
                    }];
```
...
[**ISADomainContactDetails***](ISADomainContactDetails.md)
...
# **getDomainDnssec**
```objc
-(NSURLSessionTask*) getDomainDnssecWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISADomainDnssecRecords* output, NSError* error)) handler;
```
...
// Read the DNSSEC DS record set currently registered with the registrar
[apiInstance getDomainDnssecWithId:_id
          completionHandler: ^(ISADomainDnssecRecords* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainDnssec: %@", error);
                        }
                    }];
```
...
[**ISADomainDnssecRecords***](ISADomainDnssecRecords.md)
...
# **getDomainInfo**
```objc
-(NSURLSessionTask*) getDomainInfoWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISADomain* output, NSError* error)) handler;
```
...
// Read full billing, registrar, and service detail for one domain
[apiInstance getDomainInfoWithId:_id
          completionHandler: ^(ISADomain* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainInfo: %@", error);
                        }
                    }];
```
...
# **getDomainInvoices**
```objc
-(NSURLSessionTask*) getDomainInvoicesWithId: (NSNumber*) _id
...
// List all billing invoices scoped to one domain order
[apiInstance getDomainInvoicesWithId:_id
          completionHandler: ^(ISAChargeInvoiceRows* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainInvoices: %@", error);
                        }
                    }];
```
...
# **getDomainLookup**
```objc
-(NSURLSessionTask*) getDomainLookupWithName: (NSString*) name
        completionHandler: (void (^)(ISADomainLookupResponse* output, NSError* error)) handler;
```
...
NSString* name = @"name_example"; // The full domain name to look up (for example `example.com`).

ISADomainsApi*apiInstance = [[ISADomainsApi alloc] init];

// Check availability, premium status, and pricing for a specific domain
[apiInstance getDomainLookupWithName:name
          completionHandler: ^(ISADomainLookupResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainLookup: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **NSString***| The full domain name to look up (for example &#x60;example.com&#x60;). | 

### Return type

[**ISADomainLookupResponse***](ISADomainLookupResponse.md)
...
```objc
-(NSURLSessionTask*) getDomainNameserversWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISADomainNameserverGetResponse* output, NSError* error)) handler;
```
...
// List registered nameserver hosts and glue IP addresses for a domain
[apiInstance getDomainNameserversWithId:_id
          completionHandler: ^(ISADomainNameserverGetResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainNameservers: %@", error);
                        }
                    }];
```
...
[**ISADomainNameserverGetResponse***](ISADomainNameserverGetResponse.md)
...
# **getDomainRenewal**
```objc
-(NSURLSessionTask*) getDomainRenewalWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
// Read renewal pricing, expiry, and whether a renewal invoice already exists
[apiInstance getDomainRenewalWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainRenewal: %@", error);
                        }
                    }];
```
...
# **getDomainSearch**
```objc
-(NSURLSessionTask*) getDomainSearchWithName: (NSString*) name
        completionHandler: (void (^)(ISADomainSearchResponse* output, NSError* error)) handler;
```
...
NSString* name = @"name_example"; // The base domain name to search (for example `example` or `example.com`).

ISADomainsApi*apiInstance = [[ISADomainsApi alloc] init];

// Get registrar-suggested domain alternatives and bulk availability for a search term
[apiInstance getDomainSearchWithName:name
          completionHandler: ^(ISADomainSearchResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainSearch: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **name** | **NSString***| The base domain name to search (for example &#x60;example&#x60; or &#x60;example.com&#x60;). | 

### Return type

[**ISADomainSearchResponse***](ISADomainSearchResponse.md)
...
# **getDomainTransfer**
```objc
-(NSURLSessionTask*) getDomainTransferWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
// Read OpenSRS transfer status for an in-progress domain transfer order
[apiInstance getDomainTransferWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainTransfer: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) getDomainWhoisPrivacyWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
// Read Whois privacy availability, current state, and add-on pricing for a domain
[apiInstance getDomainWhoisPrivacyWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainWhoisPrivacy: %@", error);
                        }
                    }];
```
...
# **getDomainsList**
```objc
-(NSURLSessionTask*) getDomainsListWithCompletionHandler: 
        (void (^)(NSArray<ISADomainRow>* output, NSError* error)) handler;
```
...
// List every domain registration on the account with billing and registration metadata
[apiInstance getDomainsListWithCompletionHandler: 
          ^(NSArray<ISADomainRow>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainsList: %@", error);
                        }
                    }];
```
...
[**NSArray<ISADomainRow>***](ISADomainRow.md)
...
```objc
-(NSURLSessionTask*) getDomainsWelcomeEmailWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
// Resend the domain welcome email with registration details and management instructions
[apiInstance getDomainsWelcomeEmailWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getDomainsWelcomeEmail: %@", error);
                        }
                    }];
```
...
# **getNewDomain**
```objc
-(NSURLSessionTask*) getNewDomainWithCompletionHandler: 
        (void (^)(ISADomainOrder* output, NSError* error)) handler;
```
...
// Read the buyable domain TLD service catalog and Whois privacy pricing
[apiInstance getNewDomainWithCompletionHandler: 
          ^(ISADomainOrder* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->getNewDomain: %@", error);
                        }
                    }];
```
...
[**ISADomainOrder***](ISADomainOrder.md)
...
# **patchDomains**
```objc
-(NSURLSessionTask*) patchDomainsWithDomainOrderRequest: (ISADomainOrderRequest*) domainOrderRequest
...
// Validate posted domain-order field values before committing — dry run
[apiInstance patchDomainsWithDomainOrderRequest:domainOrderRequest
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->patchDomains: %@", error);
                        }
                    }];
```
...
# **postDomainRenewal**
```objc
-(NSURLSessionTask*) postDomainRenewalWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
// Submit a domain renewal request and generate the renewal invoice
[apiInstance postDomainRenewalWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->postDomainRenewal: %@", error);
                        }
                    }];
```
...
# **postDomainSearch**
```objc
-(NSURLSessionTask*) postDomainSearchWithName: (NSString*) name
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Get the full order form data for a hostname in one round-trip (search → order preview)
[apiInstance postDomainSearchWithName:name
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->postDomainSearch: %@", error);
                        }
                    }];
```
...
# **postDomainTransfer**
```objc
-(NSURLSessionTask*) postDomainTransferWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
// Re-poll OpenSRS transfer status for a domain order via POST
[apiInstance postDomainTransferWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->postDomainTransfer: %@", error);
                        }
                    }];
```
...
# **putDomains**
```objc
-(NSURLSessionTask*) putDomainsWithDomainOrderRequest: (ISADomainOrderRequest*) domainOrderRequest
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Preview per-TLD field requirements for a domain order — no commit
[apiInstance putDomainsWithDomainOrderRequest:domainOrderRequest
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->putDomains: %@", error);
                        }
                    }];
```
...
# **updateDomainContact**
```objc
-(NSURLSessionTask*) updateDomainContactWithId: (NSNumber*) _id
    domainContactDetails: (ISADomainContactDetails*) domainContactDetails
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The domain service ID. Use `domain_id` from `GET /domains`.
ISADomainContactDetails* domainContactDetails = [[ISADomainContactDetails alloc] init]; // 

ISADomainsApi*apiInstance = [[ISADomainsApi alloc] init];

// Update registrant/admin contact details and push them to OpenSRS
[apiInstance updateDomainContactWithId:_id
          ...
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->updateDomainContact: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. | 
 **domainContactDetails** | [**ISADomainContactDetails***](ISADomainContactDetails.md)|  | 
...
# **updateDomainInfo**
```objc
-(NSURLSessionTask*) updateDomainInfoWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
// POST mutation hook for the domain detail page (use dedicated ops where possible)
[apiInstance updateDomainInfoWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->updateDomainInfo: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) updateDomainNameserversWithId: (NSNumber*) _id
    domainNameserverPutRequest: (ISADomainNameserverPutRequest*) domainNameserverPutRequest
        completionHandler: (void (^)(ISATextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The domain service ID. Use `domain_id` from `GET /domains`.
ISADomainNameserverPutRequest* domainNameserverPutRequest = [[ISADomainNameserverPutRequest alloc] init]; // 

ISADomainsApi*apiInstance = [[ISADomainsApi alloc] init];

// Replace the full authoritative-nameserver delegation list at the registrar
[apiInstance updateDomainNameserversWithId:_id
          ...
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->updateDomainNameservers: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. | 
 **domainNameserverPutRequest** | [**ISADomainNameserverPutRequest***](ISADomainNameserverPutRequest.md)|  | 
...
# **updateDomainWhoisPrivacy**
```objc
-(NSURLSessionTask*) updateDomainWhoisPrivacyWithId: (NSNumber*) _id
    domainWhoisPrivacyRequest: (ISADomainWhoisPrivacyRequest*) domainWhoisPrivacyRequest
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The domain service ID. Use `domain_id` from `GET /domains`.
ISADomainWhoisPrivacyRequest* domainWhoisPrivacyRequest = [[ISADomainWhoisPrivacyRequest alloc] init]; // 

ISADomainsApi*apiInstance = [[ISADomainsApi alloc] init];

// Order, enable, or cancel the Whois privacy add-on for a domain
[apiInstance updateDomainWhoisPrivacyWithId:_id
          ...
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISADomainsApi->updateDomainWhoisPrivacy: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. | 
 **domainWhoisPrivacyRequest** | [**ISADomainWhoisPrivacyRequest***](ISADomainWhoisPrivacyRequest.md)|  | 
