...
------------- | ------------- | -------------
[**addBillingCreditCard**](ISABillingApi.md#addbillingcreditcard) | **POST** /billing/creditcards | Store a credit card on the account — may return a verification flow
[**addBillingPrepay**](ISABillingApi.md#addbillingprepay) | **POST** /billing/prepays | Create a prepay deposit and return an invoice id to fund it
[**deleteBillingCreditCard**](ISABillingApi.md#deletebillingcreditcard) | **DELETE** /billing/creditcards/{id} | Remove a stored credit card from the account
[**deleteBillingInvoice**](ISABillingApi.md#deletebillinginvoice) | **DELETE** /billing/invoices/{id} | Cancel a pending unpaid invoice — and its pending service or repeat invoice
[**deleteBillingPrepay**](ISABillingApi.md#deletebillingprepay) | **DELETE** /billing/prepays/{id} | Delete an unfunded prepay or strip its unpaid funding invoices
[**getAffiliateBanners**](ISABillingApi.md#getaffiliatebanners) | **GET** /affiliate/banners | List affiliate banner image assets with filename and dimensions
[**getAffiliateDownload**](ISABillingApi.md#getaffiliatedownload) | **GET** /affiliate/download | Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
[**getAffiliateRichReport**](ISABillingApi.md#getaffiliaterichreport) | **GET** /affiliate/rich_report | Read a combined affiliate performance summary (HTML payload)
[**getAffiliateSalesGraph**](ISABillingApi.md#getaffiliatesalesgraph) | **GET** /affiliate/sales_graph | Read aggregated affiliate sales time-series (monthly buckets) for chart rendering
[**getAffiliateSignups**](ISABillingApi.md#getaffiliatesignups) | **GET** /affiliate/signups | Read affiliate signup stats and per-customer conversion data
[**getAffiliateTrafficGraph**](ISABillingApi.md#getaffiliatetrafficgraph) | **GET** /affiliate/traffic_graph | Read aggregated affiliate referral click/visit time-series for chart rendering
[**getAffiliateWebTraffic**](ISABillingApi.md#getaffiliatewebtraffic) | **GET** /affiliate/web_traffic | List the 20 most recent affiliate referral visits with IP, referrer, timestamp
[**getBillingCart**](ISABillingApi.md#getbillingcart) | **GET** /billing/cart | Read the current shopping cart contents, totals, and available payment methods
[**getBillingCreditCardVerify**](ISABillingApi.md#getbillingcreditcardverify) | **GET** /billing/creditcards/{id}/verify | Probe whether a stored card still needs micro-charge verification
[**getBillingInvoice**](ISABillingApi.md#getbillinginvoice) | **GET** /billing/invoices/{id} | Read full invoice detail — line items, totals, paid status, customer info
[**getBillingInvoices**](ISABillingApi.md#getbillinginvoices) | **GET** /billing/invoices | List every invoice on the account with summary totals and paid/unpaid status
[**getBillingPrePays**](ISABillingApi.md#getbillingprepays) | **GET** /billing/prepays | List prepay deposits on the account — remaining balance and auto-use flags
[**initiatePayment**](ISABillingApi.md#initiatepayment) | **GET** /billing/pay/{method}/{invoices} | Pay invoices through the chosen gateway — returns the next-step action
[**patchBillingCreditCardVerify**](ISABillingApi.md#patchbillingcreditcardverify) | **PATCH** /billing/creditcards/{id}/verify | Place two micro-charges on the card to start CVV verification (step 1 of 2)
[**postBillingCreditCardVerify**](ISABillingApi.md#postbillingcreditcardverify) | **POST** /billing/creditcards/{id}/verify | Submit two micro-charge amounts to finalize card verification (step 2 of 2)
[**updateAffiliateDockSetup**](ISABillingApi.md#updateaffiliatedocksetup) | **POST** /affiliate/dock_setup | Configure the affiliate landing dock title, description, and referrer coupon
[**updateAffiliatePaymentSetup**](ISABillingApi.md#updateaffiliatepaymentsetup) | **POST** /affiliate/payment_setup | Configure how affiliate commissions get paid out (PayPal or internal prepay)
[**updateBillingCreditCard**](ISABillingApi.md#updatebillingcreditcard) | **POST** /billing/creditcards/{id} | Refresh stored card expiration and re-trigger MaxMind fraud scoring
[**updateBillingPaymentMethod**](ISABillingApi.md#updatebillingpaymentmethod) | **POST** /billing/payment_method | Set the account&#39;s default payment method for recurring/auto charges


# **addBillingCreditCard**
```objc
-(NSURLSessionTask*) addBillingCreditCardWithBillingAddCcRequest: (ISABillingAddCcRequest*) billingAddCcRequest
...
ISABillingAddCcRequest* billingAddCcRequest = [[ISABillingAddCcRequest alloc] init]; // 

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Store a credit card on the account — may return a verification flow
[apiInstance addBillingCreditCardWithBillingAddCcRequest:billingAddCcRequest
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->addBillingCreditCard: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **billingAddCcRequest** | [**ISABillingAddCcRequest***](ISABillingAddCcRequest.md)|  | 
...
# **addBillingPrepay**
```objc
-(NSURLSessionTask*) addBillingPrepayWithBillingPrepayRequest: (ISABillingPrepayRequest*) billingPrepayRequest
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
ISABillingPrepayRequest* billingPrepayRequest = [[ISABillingPrepayRequest alloc] init]; // 

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Create a prepay deposit and return an invoice id to fund it
[apiInstance addBillingPrepayWithBillingPrepayRequest:billingPrepayRequest
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->addBillingPrepay: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **billingPrepayRequest** | [**ISABillingPrepayRequest***](ISABillingPrepayRequest.md)|  | 
...
```objc
-(NSURLSessionTask*) deleteBillingCreditCardWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The credit card ID to remove. Use IDs from `GET /billing/creditcards`.

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Remove a stored credit card from the account
[apiInstance deleteBillingCreditCardWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->deleteBillingCreditCard: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The credit card ID to remove. Use IDs from &#x60;GET /billing/creditcards&#x60;. | 
...
```objc
-(NSURLSessionTask*) deleteBillingInvoiceWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The invoice ID to delete. Only unpaid invoices can be deleted.

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Cancel a pending unpaid invoice — and its pending service or repeat invoice
[apiInstance deleteBillingInvoiceWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->deleteBillingInvoice: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The invoice ID to delete. Only unpaid invoices can be deleted. | 
...
# **deleteBillingPrepay**
```objc
-(NSURLSessionTask*) deleteBillingPrepayWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The prepay balance ID to delete.

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Delete an unfunded prepay or strip its unpaid funding invoices
[apiInstance deleteBillingPrepayWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->deleteBillingPrepay: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The prepay balance ID to delete. | 
...
# **getAffiliateBanners**
```objc
-(NSURLSessionTask*) getAffiliateBannersWithCompletionHandler: 
        (void (^)(NSArray<ISAAffiliateBannerRow>* output, NSError* error)) handler;
```
...
// List affiliate banner image assets with filename and dimensions
[apiInstance getAffiliateBannersWithCompletionHandler: 
          ^(NSArray<ISAAffiliateBannerRow>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getAffiliateBanners: %@", error);
                        }
                    }];
```
...
[**NSArray<ISAAffiliateBannerRow>***](ISAAffiliateBannerRow.md)
...
```objc
-(NSURLSessionTask*) getAffiliateDownloadWithSt: (NSString*) st
    ex: (NSString*) ex
    year: (NSNumber*) year
...
NSString* st = @"st_example"; // Filter by status. (optional)
NSString* ex = @"ex_example"; // Export format: csv, xls, xlsx, or pdf. Defaults to csv. (optional)
NSNumber* year = @56; // Year to filter the report. Defaults to the current year. (optional)

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
[apiInstance getAffiliateDownloadWithSt:st
              ex:ex
              year:year
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getAffiliateDownload: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **NSString***| Filter by status. | [optional] 
 **ex** | **NSString***| Export format: csv, xls, xlsx, or pdf. Defaults to csv. | [optional] 
 **year** | **NSNumber***| Year to filter the report. Defaults to the current year. | [optional] 
...
```objc
-(NSURLSessionTask*) getAffiliateRichReportWithCompletionHandler: 
        (void (^)(ISATextResponse* output, NSError* error)) handler;
```
...
// Read a combined affiliate performance summary (HTML payload)
[apiInstance getAffiliateRichReportWithCompletionHandler: 
          ^(ISATextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getAffiliateRichReport: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) getAffiliateSalesGraphWithDays: (NSNumber*) days
        completionHandler: (void (^)(ISAStatusMonthlyBreakdown* output, NSError* error)) handler;
```
...
NSNumber* days = @56; // Number of days of sales history to include in the graph data. Determines the time window for the returned data points. (optional)

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Read aggregated affiliate sales time-series (monthly buckets) for chart rendering
[apiInstance getAffiliateSalesGraphWithDays:days
          completionHandler: ^(ISAStatusMonthlyBreakdown* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getAffiliateSalesGraph: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **days** | **NSNumber***| Number of days of sales history to include in the graph data. Determines the time window for the returned data points. | [optional] 

### Return type

[**ISAStatusMonthlyBreakdown***](ISAStatusMonthlyBreakdown.md)
...
# **getAffiliateSignups**
```objc
-(NSURLSessionTask*) getAffiliateSignupsWithSt: (NSString*) st
        completionHandler: (void (^)(ISAGetAffiliateSignups200Response* output, NSError* error)) handler;
```
...
NSString* st = @"st_example"; // Filter signups by status. Use `default` to show all or pass a specific status value to narrow results. (optional)

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Read affiliate signup stats and per-customer conversion data
[apiInstance getAffiliateSignupsWithSt:st
          completionHandler: ^(ISAGetAffiliateSignups200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getAffiliateSignups: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **NSString***| Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. | [optional] 

### Return type

[**ISAGetAffiliateSignups200Response***](ISAGetAffiliateSignups200Response.md)
...
```objc
-(NSURLSessionTask*) getAffiliateTrafficGraphWithDays: (NSNumber*) days
        completionHandler: (void (^)(ISAMonthlyCounts* output, NSError* error)) handler;
```
...
NSNumber* days = @56; // Number of days of traffic history to include in the graph data. Determines the time window for the returned data points. (optional)

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Read aggregated affiliate referral click/visit time-series for chart rendering
[apiInstance getAffiliateTrafficGraphWithDays:days
          completionHandler: ^(ISAMonthlyCounts* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getAffiliateTrafficGraph: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **days** | **NSNumber***| Number of days of traffic history to include in the graph data. Determines the time window for the returned data points. | [optional] 

### Return type

[**ISAMonthlyCounts***](ISAMonthlyCounts.md)
...
```objc
-(NSURLSessionTask*) getAffiliateWebTrafficWithCompletionHandler: 
        (void (^)(NSArray<ISAAffiliateTrafficRow>* output, NSError* error)) handler;
```
...
// List the 20 most recent affiliate referral visits with IP, referrer, timestamp
[apiInstance getAffiliateWebTrafficWithCompletionHandler: 
          ^(NSArray<ISAAffiliateTrafficRow>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getAffiliateWebTraffic: %@", error);
                        }
                    }];
```
...
[**NSArray<ISAAffiliateTrafficRow>***](ISAAffiliateTrafficRow.md)
...
# **getBillingCart**
```objc
-(NSURLSessionTask*) getBillingCartWithCompletionHandler: 
...
// Read the current shopping cart contents, totals, and available payment methods
[apiInstance getBillingCartWithCompletionHandler: 
          ^(NSObject* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getBillingCart: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) getBillingCreditCardVerifyWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Probe whether a stored card still needs micro-charge verification
[apiInstance getBillingCreditCardVerifyWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getBillingCreditCardVerify: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. | 
...
# **getBillingInvoice**
```objc
-(NSURLSessionTask*) getBillingInvoiceWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISABillingInvoiceDetail* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The invoice ID. Use IDs from `GET /billing/invoices` or from order responses.

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Read full invoice detail — line items, totals, paid status, customer info
[apiInstance getBillingInvoiceWithId:_id
          completionHandler: ^(ISABillingInvoiceDetail* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getBillingInvoice: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The invoice ID. Use IDs from &#x60;GET /billing/invoices&#x60; or from order responses. | 

### Return type

[**ISABillingInvoiceDetail***](ISABillingInvoiceDetail.md)
...
# **getBillingInvoices**
```objc
-(NSURLSessionTask*) getBillingInvoicesWithCompletionHandler: 
        (void (^)(ISABillingInvoiceList* output, NSError* error)) handler;
```
...
// List every invoice on the account with summary totals and paid/unpaid status
[apiInstance getBillingInvoicesWithCompletionHandler: 
          ^(ISABillingInvoiceList* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getBillingInvoices: %@", error);
                        }
                    }];
```
...
[**ISABillingInvoiceList***](ISABillingInvoiceList.md)
...
# **getBillingPrePays**
```objc
-(NSURLSessionTask*) getBillingPrePaysWithCompletionHandler: 
        (void (^)(NSObject* output, NSError* error)) handler;
```
...
// List prepay deposits on the account — remaining balance and auto-use flags
[apiInstance getBillingPrePaysWithCompletionHandler: 
          ^(NSObject* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->getBillingPrePays: %@", error);
                        }
                    }];
```
...
# **initiatePayment**
```objc
-(NSURLSessionTask*) initiatePaymentWithMethod: (NSString*) method
    invoices: (NSString*) invoices
        completionHandler: (void (^)(ISAInitiatePayment200Response* output, NSError* error)) handler;
```
...
NSString* method = @"method_example"; // The payment method to use. Valid values: `cc` (credit card), `paypal`, `prepay`, `payssion`, `payu`, `ccavenue`, `cashfree`, `coinbase`, `btcpay`.
NSString* invoices = @"invoices_example"; // A comma-separated list of invoice IDs or invoice Tags to pay. These IDs are returned by order endpoints (e.g. `/backups/order`, `/vps/order`) and by `/billing/invoices`. Invoice tags accepted are SERVICE<module><id>, RINV<module><repeat invoice id>, INV<module><invoice id>, PREPAY<prepay id><invoice id>, and <invoice id>.

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Pay invoices through the chosen gateway — returns the next-step action
[apiInstance initiatePaymentWithMethod:method
              invoices:invoices
          completionHandler: ^(ISAInitiatePayment200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->initiatePayment: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **method** | **NSString***| The payment method to use. Valid values: &#x60;cc&#x60; (credit card), &#x60;paypal&#x60;, &#x60;prepay&#x60;, &#x60;payssion&#x60;, &#x60;payu&#x60;, &#x60;ccavenue&#x60;, &#x60;cashfree&#x60;, &#x60;coinbase&#x60;, &#x60;btcpay&#x60;. | 
 **invoices** | **NSString***| A comma-separated list of invoice IDs or invoice Tags to pay. These IDs are returned by order endpoints (e.g. &#x60;/backups/order&#x60;, &#x60;/vps/order&#x60;) and by &#x60;/billing/invoices&#x60;. Invoice tags accepted are SERVICE&lt;module&gt;&lt;id&gt;, RINV&lt;module&gt;&lt;repeat invoice id&gt;, INV&lt;module&gt;&lt;invoice id&gt;, PREPAY&lt;prepay id&gt;&lt;invoice id&gt;, and &lt;invoice id&gt;. | 

### Return type

[**ISAInitiatePayment200Response***](ISAInitiatePayment200Response.md)
...
```objc
-(NSURLSessionTask*) patchBillingCreditCardVerifyWithId: (NSNumber*) _id
    patchBillingCreditCardVerifyRequest: (ISAPatchBillingCreditCardVerifyRequest*) patchBillingCreditCardVerifyRequest
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
ISAPatchBillingCreditCardVerifyRequest* patchBillingCreditCardVerifyRequest = [[ISAPatchBillingCreditCardVerifyRequest alloc] init]; // 

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Place two micro-charges on the card to start CVV verification (step 1 of 2)
[apiInstance patchBillingCreditCardVerifyWithId:_id
          ...
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->patchBillingCreditCardVerify: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. | 
 **patchBillingCreditCardVerifyRequest** | [**ISAPatchBillingCreditCardVerifyRequest***](ISAPatchBillingCreditCardVerifyRequest.md)|  | 
...
```objc
-(NSURLSessionTask*) postBillingCreditCardVerifyWithId: (NSNumber*) _id
    billingVerifyCcRequest: (ISABillingVerifyCcRequest*) billingVerifyCcRequest
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
ISABillingVerifyCcRequest* billingVerifyCcRequest = [[ISABillingVerifyCcRequest alloc] init]; // 

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Submit two micro-charge amounts to finalize card verification (step 2 of 2)
[apiInstance postBillingCreditCardVerifyWithId:_id
          ...
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->postBillingCreditCardVerify: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. | 
 **billingVerifyCcRequest** | [**ISABillingVerifyCcRequest***](ISABillingVerifyCcRequest.md)|  | 
...
```objc
-(NSURLSessionTask*) updateAffiliateDockSetupWithAffiliateDockTitle: (NSString*) affiliateDockTitle
    affiliateDockDescription: (NSString*) affiliateDockDescription
    referrerCoupon: (NSString*) referrerCoupon
...
NSString* affiliateDockTitle = @"affiliateDockTitle_example"; //  (optional)
NSString* affiliateDockDescription = @"affiliateDockDescription_example"; //  (optional)
NSString* referrerCoupon = @"referrerCoupon_example"; //  (optional)

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Configure the affiliate landing dock title, description, and referrer coupon
[apiInstance updateAffiliateDockSetupWithAffiliateDockTitle:affiliateDockTitle
          ...
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->updateAffiliateDockSetup: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) updateAffiliatePaymentSetupWithAffiliatePaypal: (NSString*) affiliatePaypal
    affiliatePaymentMethod: (NSString*) affiliatePaymentMethod
        completionHandler: (void (^)(ISATextResponse* output, NSError* error)) handler;
```
...
NSString* affiliatePaypal = @"affiliatePaypal_example"; //  (optional)
NSString* affiliatePaymentMethod = @"affiliatePaymentMethod_example"; //  (optional)

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Configure how affiliate commissions get paid out (PayPal or internal prepay)
[apiInstance updateAffiliatePaymentSetupWithAffiliatePaypal:affiliatePaypal
          ...
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->updateAffiliatePaymentSetup: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) updateBillingCreditCardWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // The credit card ID. Use IDs from `GET /billing/creditcards` or the response from `POST /billing/creditcards`.

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Refresh stored card expiration and re-trigger MaxMind fraud scoring
[apiInstance updateBillingCreditCardWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->updateBillingCreditCard: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The credit card ID. Use IDs from &#x60;GET /billing/creditcards&#x60; or the response from &#x60;POST /billing/creditcards&#x60;. | 
...
```objc
-(NSURLSessionTask*) updateBillingPaymentMethodWithBillingPaymentMethodRequest: (ISABillingPaymentMethodRequest*) billingPaymentMethodRequest
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
ISABillingPaymentMethodRequest* billingPaymentMethodRequest = [[ISABillingPaymentMethodRequest alloc] init]; // 

ISABillingApi*apiInstance = [[ISABillingApi alloc] init];

// Set the account's default payment method for recurring/auto charges
[apiInstance updateBillingPaymentMethodWithBillingPaymentMethodRequest:billingPaymentMethodRequest
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISABillingApi->updateBillingPaymentMethod: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **billingPaymentMethodRequest** | [**ISABillingPaymentMethodRequest***](ISABillingPaymentMethodRequest.md)|  | 
