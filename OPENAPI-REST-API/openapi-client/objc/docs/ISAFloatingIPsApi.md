...
------------- | ------------- | -------------
[**addFloatingIp**](ISAFloatingIPsApi.md#addfloatingip) | **POST** /floating_ips/order | Place a real Floating IP order, create billing records, and provision the service
[**floatingIpsCancel**](ISAFloatingIPsApi.md#floatingipscancel) | **DELETE** /floating_ips/{id} | Cancel a Floating IP service and release the IP — destructive, billing stops
[**getFloatingIpInfo**](ISAFloatingIPsApi.md#getfloatingipinfo) | **GET** /floating_ips/{id} | Fetch full details for one Floating IP service, including current target IP
[**getFloatingIpInvoices**](ISAFloatingIPsApi.md#getfloatingipinvoices) | **GET** /floating_ips/{id}/invoices | List all billing invoices charged against a specific Floating IP service
[**getFloatingIpsList**](ISAFloatingIPsApi.md#getfloatingipslist) | **GET** /floating_ips | List all Floating IP services on the authenticated customer&#39;s account
[**getFloatingIpsWelcomeEmail**](ISAFloatingIPsApi.md#getfloatingipswelcomeemail) | **GET** /floating_ips/{id}/welcome_email | Resend the Floating IP welcome / setup email to the account contact
[**getNewFloatingIp**](ISAFloatingIPsApi.md#getnewfloatingip) | **GET** /floating_ips/order | Get pricing and service-type options for ordering a new Floating IP
[**postFloatingIpsChangeIp**](ISAFloatingIPsApi.md#postfloatingipschangeip) | **POST** /floating_ips/{id}/change_ip | Re-point a Floating IP to a different target IP on one of the customer&#39;s services
[**putFloatingIps**](ISAFloatingIPsApi.md#putfloatingips) | **PUT** /floating_ips/order | Validate a Floating IP order and price it without charging the customer
[**updateFloatingIpInfo**](ISAFloatingIPsApi.md#updatefloatingipinfo) | **POST** /floating_ips/{id} | Update a Floating IP service&#39;s editable settings (label / metadata)
...
ISAFloatingIpOrderRequest* floatingIpOrderRequest = [[ISAFloatingIpOrderRequest alloc] init]; // 

ISAFloatingIPsApi*apiInstance = [[ISAFloatingIPsApi alloc] init];

// Place a real Floating IP order, create billing records, and provision the service
[apiInstance addFloatingIpWithFloatingIpOrderRequest:floatingIpOrderRequest
          completionHandler: ^(ISAServiceOrderPostResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->addFloatingIp: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **floatingIpOrderRequest** | [**ISAFloatingIpOrderRequest***](ISAFloatingIpOrderRequest.md)|  | 
...
NSNumber* _id = @56; // The Floating IP service ID. Use the ID from `GET /floating_ips`.

ISAFloatingIPsApi*apiInstance = [[ISAFloatingIPsApi alloc] init];

// Cancel a Floating IP service and release the IP — destructive, billing stops
[apiInstance floatingIpsCancelWithId:_id
          completionHandler: ^(ISAFloatingIpsCancel200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->floatingIpsCancel: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;. | 

### Return type

[**ISAFloatingIpsCancel200Response***](ISAFloatingIpsCancel200Response.md)
...
// Fetch full details for one Floating IP service, including current target IP
[apiInstance getFloatingIpInfoWithId:_id
          completionHandler: ^(NSObject* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->getFloatingIpInfo: %@", error);
                        }
                    }];
```
...
// List all billing invoices charged against a specific Floating IP service
[apiInstance getFloatingIpInvoicesWithId:_id
          completionHandler: ^(ISAChargeInvoiceRows* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->getFloatingIpInvoices: %@", error);
                        }
                    }];
```
...
// List all Floating IP services on the authenticated customer's account
[apiInstance getFloatingIpsListWithCompletionHandler: 
          ^(NSArray<NSObject*>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->getFloatingIpsList: %@", error);
                        }
                    }];
```
...
// Resend the Floating IP welcome / setup email to the account contact
[apiInstance getFloatingIpsWelcomeEmailWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->getFloatingIpsWelcomeEmail: %@", error);
                        }
                    }];
```
...
// Get pricing and service-type options for ordering a new Floating IP
[apiInstance getNewFloatingIpWithCompletionHandler: 
          ^(NSObject* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->getNewFloatingIp: %@", error);
                        }
                    }];
```
...
NSNumber* _id = @56; // The Floating IP service ID. Use the ID from `GET /floating_ips`.
NSString* ip = @"ip_example"; // IP Address

ISAFloatingIPsApi*apiInstance = [[ISAFloatingIPsApi alloc] init];

// Re-point a Floating IP to a different target IP on one of the customer's services
[apiInstance postFloatingIpsChangeIpWithId:_id
              ip:ip
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->postFloatingIpsChangeIp: %@", error);
                        }
                    }];
```
...
// Validate a Floating IP order and price it without charging the customer
[apiInstance putFloatingIpsWithFloatingIpOrderRequest:floatingIpOrderRequest
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->putFloatingIps: %@", error);
                        }
                    }];
```
...
NSString* _id = @"_id_example"; // The Floating IP service ID. Use the ID from `GET /floating_ips`.

ISAFloatingIPsApi*apiInstance = [[ISAFloatingIPsApi alloc] init];

// Update a Floating IP service's editable settings (label / metadata)
[apiInstance updateFloatingIpInfoWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAFloatingIPsApi->updateFloatingIpInfo: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSString***| The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;. | 
