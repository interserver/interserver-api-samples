...
------------- | ------------- | -------------
[**addServer**](ISAServersApi.md#addserver) | **POST** /servers/order | Place a custom dedicated server order, creating a real billable invoice
[**buyItNowServerOrder**](ISAServersApi.md#buyitnowserverorder) | **GET** /servers/order/buy_now_server | Get configurable options for a Rapid Deploy / coupon dedicated server
[**getMPServers**](ISAServersApi.md#getmpservers) | **GET** /buy_now_servers_list | List Rapid Deploy (Buy-It-Now) marketplace dedicated servers with live pricing
[**getNewServer**](ISAServersApi.md#getnewserver) | **GET** /servers/order | Get custom dedicated server ordering options, regions, and pricing
[**getServerInfo**](ISAServersApi.md#getserverinfo) | **GET** /servers/{id} | Get full hardware, network, and lifecycle details for a dedicated server
[**getServerInvoices**](ISAServersApi.md#getserverinvoices) | **GET** /servers/{id}/invoices | List billing invoices (charges + payments) tied to one dedicated server
[**getServerList**](ISAServersApi.md#getserverlist) | **GET** /servers | List all dedicated servers owned by the authenticated customer
[**getServerReverseDns**](ISAServersApi.md#getserverreversedns) | **GET** /servers/{id}/reverse_dns | List current reverse-DNS (PTR) records for a dedicated server&#39;s IPs
[**getServersWelcomeEmail**](ISAServersApi.md#getserverswelcomeemail) | **GET** /servers/{id}/welcome_email | Resend the dedicated server welcome email with setup credentials
[**placeBuyNowServer**](ISAServersApi.md#placebuynowserver) | **POST** /servers/order/buy_now_server | Place a Rapid Deploy / coupon dedicated server order; creates real invoice
[**postServerReverseDns**](ISAServersApi.md#postserverreversedns) | **POST** /servers/{id}/reverse_dns | Update reverse-DNS (PTR) hostnames on a dedicated server&#39;s IPs
[**serverBulkIpmiPowerGet**](ISAServersApi.md#serverbulkipmipowerget) | **GET** /servers/bulk/ipmi_power | Read IPMI chassis power status for many dedicated servers in one call
[**serverIpmiLiveGet**](ISAServersApi.md#serveripmiliveget) | **GET** /servers/{id}/ipmi_live | Read current IPMI Live whitelist + KVM gateway URL for a dedicated server
[**serverIpmiLivePost**](ISAServersApi.md#serveripmilivepost) | **POST** /servers/{id}/ipmi_live | Whitelist an IP for IPMI Live KVM gateway access (3-hour lease)
[**serverIpmiPowerGet**](ISAServersApi.md#serveripmipowerget) | **GET** /servers/{id}/ipmi_power | Read IPMI chassis power status for a dedicated server (single)
[**serverIpmiPowerPost**](ISAServersApi.md#serveripmipowerpost) | **POST** /servers/{id}/ipmi_power | DESTRUCTIVE — change chassis power state on a bare-metal server
[**serversCancel**](ISAServersApi.md#serverscancel) | **DELETE** /servers/{id} | Cancel a dedicated server service at the end of the current billing cycle
[**updateServerInfo**](ISAServersApi.md#updateserverinfo) | **POST** /servers/{id} | Update settings on a dedicated server order (shares handler with view)


# **addServer**
```objc
-(NSURLSessionTask*) addServerWithServerOrderPostRequest: (ISAServerOrderPostRequest*) serverOrderPostRequest
        completionHandler: (void (^)(ISAAddServer200Response* output, NSError* error)) handler;
```
...
ISAServerOrderPostRequest* serverOrderPostRequest = [[ISAServerOrderPostRequest alloc] init]; // 

ISAServersApi*apiInstance = [[ISAServersApi alloc] init];

// Place a custom dedicated server order, creating a real billable invoice
[apiInstance addServerWithServerOrderPostRequest:serverOrderPostRequest
          completionHandler: ^(ISAAddServer200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->addServer: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **serverOrderPostRequest** | [**ISAServerOrderPostRequest***](ISAServerOrderPostRequest.md)|  | 

### Return type

[**ISAAddServer200Response***](ISAAddServer200Response.md)
...
# **buyItNowServerOrder**
```objc
-(NSURLSessionTask*) buyItNowServerOrderWithCompletionHandler: 
        (void (^)(ISABuyItNowServerOrder200Response* output, NSError* error)) handler;
```
...
// Get configurable options for a Rapid Deploy / coupon dedicated server
[apiInstance buyItNowServerOrderWithCompletionHandler: 
          ^(ISABuyItNowServerOrder200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->buyItNowServerOrder: %@", error);
                        }
                    }];
```
...
[**ISABuyItNowServerOrder200Response***](ISABuyItNowServerOrder200Response.md)
...
[apiInstance getMPServersWithCompletionHandler: 
          ^(ISABuyItNowList* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->getMPServers: %@", error);
                        }
                    }];
```
...
# **getNewServer**
```objc
-(NSURLSessionTask*) getNewServerWithCompletionHandler: 
        (void (^)(ISAServerOrder* output, NSError* error)) handler;
```
...
// Get custom dedicated server ordering options, regions, and pricing
[apiInstance getNewServerWithCompletionHandler: 
          ^(ISAServerOrder* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->getNewServer: %@", error);
                        }
                    }];
```
...
[**ISAServerOrder***](ISAServerOrder.md)
...
# **getServerInfo**
```objc
-(NSURLSessionTask*) getServerInfoWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAServer* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // Server ID number.

ISAServersApi*apiInstance = [[ISAServersApi alloc] init];

// Get full hardware, network, and lifecycle details for a dedicated server
[apiInstance getServerInfoWithId:_id
          completionHandler: ^(ISAServer* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->getServerInfo: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| Server ID number. | 

### Return type

[**ISAServer***](ISAServer.md)
...
# **getServerInvoices**
```objc
-(NSURLSessionTask*) getServerInvoicesWithId: (NSNumber*) _id
...
// List billing invoices (charges + payments) tied to one dedicated server
[apiInstance getServerInvoicesWithId:_id
          completionHandler: ^(ISAChargeInvoiceRows* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->getServerInvoices: %@", error);
                        }
                    }];
```
...
# **getServerList**
```objc
-(NSURLSessionTask*) getServerListWithCompletionHandler: 
        (void (^)(NSArray<ISAServerRow>* output, NSError* error)) handler;
```
...
[apiInstance getServerListWithCompletionHandler: 
          ^(NSArray<ISAServerRow>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->getServerList: %@", error);
                        }
                    }];
```
...
[**NSArray<ISAServerRow>***](ISAServerRow.md)
...
# **getServerReverseDns**
```objc
-(NSURLSessionTask*) getServerReverseDnsWithId: (NSNumber*) _id
...
// List current reverse-DNS (PTR) records for a dedicated server's IPs
[apiInstance getServerReverseDnsWithId:_id
          completionHandler: ^(ISAReverseDnsEntries* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->getServerReverseDns: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) getServersWelcomeEmailWithId: (NSNumber*) _id
...
// Resend the dedicated server welcome email with setup credentials
[apiInstance getServersWelcomeEmailWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->getServersWelcomeEmail: %@", error);
                        }
                    }];
```
...
# **placeBuyNowServer**
```objc
-(NSURLSessionTask*) placeBuyNowServerWithPlaceBuyNowServerRequest: (ISAPlaceBuyNowServerRequest*) placeBuyNowServerRequest
        completionHandler: (void (^)(ISAServersBuyNowResponse* output, NSError* error)) handler;
```
...
ISAPlaceBuyNowServerRequest* placeBuyNowServerRequest = [[ISAPlaceBuyNowServerRequest alloc] init]; //  (optional)

ISAServersApi*apiInstance = [[ISAServersApi alloc] init];

// Place a Rapid Deploy / coupon dedicated server order; creates real invoice
[apiInstance placeBuyNowServerWithPlaceBuyNowServerRequest:placeBuyNowServerRequest
          completionHandler: ^(ISAServersBuyNowResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->placeBuyNowServer: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **placeBuyNowServerRequest** | [**ISAPlaceBuyNowServerRequest***](ISAPlaceBuyNowServerRequest.md)|  | [optional] 

### Return type

[**ISAServersBuyNowResponse***](ISAServersBuyNowResponse.md)
...
```objc
-(NSURLSessionTask*) postServerReverseDnsWithId: (NSNumber*) _id
...
// Update reverse-DNS (PTR) hostnames on a dedicated server's IPs
[apiInstance postServerReverseDnsWithId:_id
          ...
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->postServerReverseDns: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) serverBulkIpmiPowerGetWithIds: (NSString*) ids
        completionHandler: (void (^)(ISAServerBulkIpmiPowerResponse* output, NSError* error)) handler;
```
...
NSString* ids = 2313,2314,2315; // Comma-separated list of Server IDs to query (e.g. `2313,2314,2315`). May also be passed as repeated `ids[]` query parameters.

ISAServersApi*apiInstance = [[ISAServersApi alloc] init];

// Read IPMI chassis power status for many dedicated servers in one call
[apiInstance serverBulkIpmiPowerGetWithIds:ids
          completionHandler: ^(ISAServerBulkIpmiPowerResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->serverBulkIpmiPowerGet: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ids** | **NSString***| Comma-separated list of Server IDs to query (e.g. &#x60;2313,2314,2315&#x60;). May also be passed as repeated &#x60;ids[]&#x60; query parameters. | 

### Return type

[**ISAServerBulkIpmiPowerResponse***](ISAServerBulkIpmiPowerResponse.md)
...
# **serverIpmiLiveGet**
```objc
-(NSURLSessionTask*) serverIpmiLiveGetWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAServerIpmiLiveInfo* output, NSError* error)) handler;
```
...
// Read current IPMI Live whitelist + KVM gateway URL for a dedicated server
[apiInstance serverIpmiLiveGetWithId:_id
          completionHandler: ^(ISAServerIpmiLiveInfo* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->serverIpmiLiveGet: %@", error);
                        }
                    }];
```
...
[**ISAServerIpmiLiveInfo***](ISAServerIpmiLiveInfo.md)
...
# **serverIpmiLivePost**
```objc
-(NSURLSessionTask*) serverIpmiLivePostWithId: (NSNumber*) _id
    ip: (NSString*) ip
...
NSNumber* _id = @56; // Server ID number
NSString* ip = @"ip_example"; // Your IP Address you wish to connect to the IPMI system from.
NSNumber* asset = @56; // Asset ID (optional)

ISAServersApi*apiInstance = [[ISAServersApi alloc] init];

// Whitelist an IP for IPMI Live KVM gateway access (3-hour lease)
[apiInstance serverIpmiLivePostWithId:_id
              ip:ip
              asset:asset
          completionHandler: ^(ISAServerIpmiLiveInfo* output, NSError* error) {
                        if (output) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->serverIpmiLivePost: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| Server ID number | 
 **ip** | **NSString***| Your IP Address you wish to connect to the IPMI system from. | 
 **asset** | **NSNumber***| Asset ID | [optional] 
...
# **serverIpmiPowerGet**
```objc
-(NSURLSessionTask*) serverIpmiPowerGetWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISATextResponse* output, NSError* error)) handler;
```
...
// Read IPMI chassis power status for a dedicated server (single)
[apiInstance serverIpmiPowerGetWithId:_id
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->serverIpmiPowerGet: %@", error);
                        }
                    }];
```
...
# **serverIpmiPowerPost**
```objc
-(NSURLSessionTask*) serverIpmiPowerPostWithId: (NSNumber*) _id
...
NSNumber* _id = @56; // Server ID number
NSString* action = @"action_example"; // The power action to send to the ipmi controller.
NSNumber* asset = @56; // The Asset ID (optional)

ISAServersApi*apiInstance = [[ISAServersApi alloc] init];

// DESTRUCTIVE — change chassis power state on a bare-metal server
[apiInstance serverIpmiPowerPostWithId:_id
              action:action
              asset:asset
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        if (output) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->serverIpmiPowerPost: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| Server ID number | 
 **action** | **NSString***| The power action to send to the ipmi controller. | 
 **asset** | **NSNumber***| The Asset ID | [optional] 
...
# **serversCancel**
```objc
-(NSURLSessionTask*) serversCancelWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAServersCancel200Response* output, NSError* error)) handler;
```
...
// Cancel a dedicated server service at the end of the current billing cycle
[apiInstance serversCancelWithId:_id
          completionHandler: ^(ISAServersCancel200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->serversCancel: %@", error);
                        }
                    }];
```
...
[**ISAServersCancel200Response***](ISAServersCancel200Response.md)
...
# **updateServerInfo**
```objc
-(NSURLSessionTask*) updateServerInfoWithId: (NSString*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSString* _id = @"_id_example"; // Server ID number.

ISAServersApi*apiInstance = [[ISAServersApi alloc] init];

// Update settings on a dedicated server order (shares handler with view)
[apiInstance updateServerInfoWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAServersApi->updateServerInfo: %@", error);
                        }
                    }];
```
