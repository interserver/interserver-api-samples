...
------------- | ------------- | -------------
[**addVps**](ISAVPSApi.md#addvps) | **POST** /vps/order | Place a new VPS order, create the invoice, and queue provisioning
[**deleteVpsBackup**](ISAVPSApi.md#deletevpsbackup) | **DELETE** /vps/{id}/backups | Permanently delete a VPS backup file by name (irreversible)
[**doVpsBlockSmtp**](ISAVPSApi.md#dovpsblocksmtp) | **GET** /vps/{id}/block_smtp | Block outbound SMTP (port 25) on the VPS to prevent spam/abuse
[**doVpsDisableCd**](ISAVPSApi.md#dovpsdisablecd) | **GET** /vps/{id}/disable_cd | Remove the virtual CD/DVD device entirely from the VPS configuration
[**doVpsDisableQuota**](ISAVPSApi.md#dovpsdisablequota) | **GET** /vps/{id}/disable_quota | Disable per-user disk quota enforcement inside the VPS guest OS
[**doVpsEjectCd**](ISAVPSApi.md#dovpsejectcd) | **GET** /vps/{id}/eject_cd | Eject the mounted ISO from the VPS virtual CD drive (keep the drive)
[**doVpsEnableQuota**](ISAVPSApi.md#dovpsenablequota) | **GET** /vps/{id}/enable_quota | Enable per-user disk quota enforcement inside the VPS guest OS
[**doVpsRestart**](ISAVPSApi.md#dovpsrestart) | **GET** /vps/{id}/restart | Reboot the VPS — preferred over stop+start for software changes
[**doVpsStart**](ISAVPSApi.md#dovpsstart) | **GET** /vps/{id}/start | Power on a stopped VPS instance
[**doVpsStop**](ISAVPSApi.md#dovpsstop) | **GET** /vps/{id}/stop | Power off a running VPS — billing continues until cancellation
[**downloadVpsBackup**](ISAVPSApi.md#downloadvpsbackup) | **PATCH** /vps/{id}/backups | Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
[**getNewVps**](ISAVPSApi.md#getnewvps) | **GET** /vps/order | Get the VPS order catalog — platforms, OS templates, locations, pricing
[**getVpsBackup**](ISAVPSApi.md#getvpsbackup) | **GET** /vps/{id}/backup | Trigger a manual on-demand snapshot/backup of the VPS
[**getVpsBackups**](ISAVPSApi.md#getvpsbackups) | **GET** /vps/{id}/backups | List existing backups for the VPS across Swift, MinIO, and ZFS
[**getVpsBuyHdSpace**](ISAVPSApi.md#getvpsbuyhdspace) | **GET** /vps/{id}/buy_hd_space | Get current additional disk size and per-GB monthly cost for the VPS
[**getVpsBuyIp**](ISAVPSApi.md#getvpsbuyip) | **GET** /vps/{id}/buy_ip | Read current additional IPs, cap, and per-IP monthly cost for the VPS
[**getVpsChangeHostname**](ISAVPSApi.md#getvpschangehostname) | **GET** /vps/{id}/change_hostname | Read the VPS&#39;s current hostname before changing it
[**getVpsChangeRootPassword**](ISAVPSApi.md#getvpschangerootpassword) | **GET** /vps/{id}/change_root_password | Pre-flight check before changing the VPS root password
[**getVpsChangeTimezone**](ISAVPSApi.md#getvpschangetimezone) | **GET** /vps/{id}/change_timezone | List IANA timezones supported by the VPS guest OS
[**getVpsInfo**](ISAVPSApi.md#getvpsinfo) | **GET** /vps/{id} | Get full details for one VPS — IPs, hostname, OS, slices, status, addons
[**getVpsInsertCd**](ISAVPSApi.md#getvpsinsertcd) | **GET** /vps/{id}/insert_cd | List ISO templates that can be mounted in the VPS virtual CD drive
[**getVpsInvoices**](ISAVPSApi.md#getvpsinvoices) | **GET** /vps/{id}/invoices | List all billing invoices associated with this specific VPS
[**getVpsList**](ISAVPSApi.md#getvpslist) | **GET** /vps | List all VPS services on the customer&#39;s account
[**getVpsReinstallOs**](ISAVPSApi.md#getvpsreinstallos) | **GET** /vps/{id}/reinstall_os | List OS templates compatible with this VPS&#39;s hypervisor for reinstall
[**getVpsResetPassword**](ISAVPSApi.md#getvpsresetpassword) | **GET** /vps/{id}/reset_password | Pre-flight check before resetting the VPS root password to a random value
[**getVpsReverseDns**](ISAVPSApi.md#getvpsreversedns) | **GET** /vps/{id}/reverse_dns | Read the current PTR (reverse-DNS) records for every IP on the VPS
[**getVpsSetupVnc**](ISAVPSApi.md#getvpssetupvnc) | **GET** /vps/{id}/setup_vnc | Read current VNC console connection info for the VPS
[**getVpsSlices**](ISAVPSApi.md#getvpsslices) | **GET** /vps/{id}/slices | Read current slice count, min/max range, and prorated per-slice upgrade cost
[**getVpsTrafficUsage**](ISAVPSApi.md#getvpstrafficusage) | **GET** /vps/{id}/traffic_usage | Read bandwidth traffic usage data for the VPS
[**getVpsViewDesktop**](ISAVPSApi.md#getvpsviewdesktop) | **GET** /vps/{id}/view_desktop | Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS
[**getVpsWelcomeEmail**](ISAVPSApi.md#getvpswelcomeemail) | **GET** /vps/{id}/welcome_email | Resend the welcome email containing VPS IP, hostname, and root credentials
[**postVpsBuyHdSpace**](ISAVPSApi.md#postvpsbuyhdspace) | **POST** /vps/{id}/buy_hd_space | Buy or resize the VPS additional-disk addon and create a prorated invoice
[**postVpsBuyIp**](ISAVPSApi.md#postvpsbuyip) | **POST** /vps/{id}/buy_ip | Purchase one additional IP for the VPS and create the invoice
[**postVpsChangeHostname**](ISAVPSApi.md#postvpschangehostname) | **POST** /vps/{id}/change_hostname | Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP
[**postVpsChangeRootPassword**](ISAVPSApi.md#postvpschangerootpassword) | **POST** /vps/{id}/change_root_password | Set a specific new root/Administrator password on the VPS
[**postVpsChangeTimezone**](ISAVPSApi.md#postvpschangetimezone) | **POST** /vps/{id}/change_timezone | Set the system timezone on the VPS guest OS
[**postVpsChangeWebuzoPassword**](ISAVPSApi.md#postvpschangewebuzopassword) | **POST** /vps/{id}/change_webuzo_password | Rotate the Webuzo control panel admin password (re-auth required)
[**postVpsInsertCd**](ISAVPSApi.md#postvpsinsertcd) | **POST** /vps/{id}/insert_cd | Mount an ISO image in the VPS virtual CD drive from a URL
[**postVpsReinstallOs**](ISAVPSApi.md#postvpsreinstallos) | **POST** /vps/{id}/reinstall_os | Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)
[**postVpsResetPassword**](ISAVPSApi.md#postvpsresetpassword) | **POST** /vps/{id}/reset_password | Reset the VPS root password to a server-generated random value
[**postVpsRestore**](ISAVPSApi.md#postvpsrestore) | **POST** /vps/{id}/restore | Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
[**postVpsReverseDns**](ISAVPSApi.md#postvpsreversedns) | **POST** /vps/{id}/reverse_dns | Bulk-update PTR (reverse-DNS) records for one or more VPS IPs
[**postVpsSetupVnc**](ISAVPSApi.md#postvpssetupvnc) | **POST** /vps/{id}/setup_vnc | Provision or refresh the VNC console endpoint for the VPS
[**postVpsSlices**](ISAVPSApi.md#postvpsslices) | **POST** /vps/{id}/slices | Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)
[**postVpsTrafficUsage**](ISAVPSApi.md#postvpstrafficusage) | **POST** /vps/{id}/traffic_usage | Search/filter VPS bandwidth usage with custom criteria (reserved)
[**postVpsViewDesktop**](ISAVPSApi.md#postvpsviewdesktop) | **POST** /vps/{id}/view_desktop | Refresh the remote-desktop session connection info after IP/hostname changes
[**putVps**](ISAVPSApi.md#putvps) | **PUT** /vps/order | Validate a VPS order configuration and quote the cost — dry run, no charge
[**putVpsBuyHdSpace**](ISAVPSApi.md#putvpsbuyhdspace) | **PUT** /vps/{id}/buy_hd_space | Preview cost to set additional VPS disk to a target GB size — dry run
[**updateVpsInfo**](ISAVPSApi.md#updatevpsinfo) | **POST** /vps/{id} | Update editable settings on a VPS service record
[**vPSCancel**](ISAVPSApi.md#vpscancel) | **DELETE** /vps/{id} | Cancel a VPS service at the end of the current billing cycle


# **addVps**
```objc
-(NSURLSessionTask*) addVpsWithVpsOrderPostRequest: (ISAVpsOrderPostRequest*) vpsOrderPostRequest
...
ISAVpsOrderPostRequest* vpsOrderPostRequest = [[ISAVpsOrderPostRequest alloc] init]; //  (optional)

ISAVPSApi*apiInstance = [[ISAVPSApi alloc] init];

// Place a new VPS order, create the invoice, and queue provisioning
[apiInstance addVpsWithVpsOrderPostRequest:vpsOrderPostRequest
          completionHandler: ^(ISAServiceOrderPostResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->addVps: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **vpsOrderPostRequest** | [**ISAVpsOrderPostRequest***](ISAVpsOrderPostRequest.md)|  | [optional] 
...
# **deleteVpsBackup**
```objc
-(NSURLSessionTask*) deleteVpsBackupWithId: (NSNumber*) _id
    file: (NSString*) file
    all: (NSString*) all
...
NSNumber* _id = @56; // VPS ID number
NSString* file = @"file_example"; // The backup filename to delete.
NSString* all = @"all_example"; // Set to `1` to list all backups across all services, not just the ones for the given VPS. (optional)

ISAVPSApi*apiInstance = [[ISAVPSApi alloc] init];

// Permanently delete a VPS backup file by name (irreversible)
[apiInstance deleteVpsBackupWithId:_id
              file:file
              all:all
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->deleteVpsBackup: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| VPS ID number | 
 **file** | **NSString***| The backup filename to delete. | 
 **all** | **NSString***| Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given VPS. | [optional] 
...
# **doVpsBlockSmtp**
```objc
-(NSURLSessionTask*) doVpsBlockSmtpWithId: (NSNumber*) _id
...
// Block outbound SMTP (port 25) on the VPS to prevent spam/abuse
[apiInstance doVpsBlockSmtpWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->doVpsBlockSmtp: %@", error);
                        }
                    }];
```
...
# **doVpsDisableCd**
```objc
-(NSURLSessionTask*) doVpsDisableCdWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Remove the virtual CD/DVD device entirely from the VPS configuration
[apiInstance doVpsDisableCdWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->doVpsDisableCd: %@", error);
                        }
                    }];
```
...
# **doVpsDisableQuota**
```objc
-(NSURLSessionTask*) doVpsDisableQuotaWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Disable per-user disk quota enforcement inside the VPS guest OS
[apiInstance doVpsDisableQuotaWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->doVpsDisableQuota: %@", error);
                        }
                    }];
```
...
# **doVpsEjectCd**
```objc
-(NSURLSessionTask*) doVpsEjectCdWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Eject the mounted ISO from the VPS virtual CD drive (keep the drive)
[apiInstance doVpsEjectCdWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->doVpsEjectCd: %@", error);
                        }
                    }];
```
...
# **doVpsEnableQuota**
```objc
-(NSURLSessionTask*) doVpsEnableQuotaWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Enable per-user disk quota enforcement inside the VPS guest OS
[apiInstance doVpsEnableQuotaWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->doVpsEnableQuota: %@", error);
                        }
                    }];
```
...
# **doVpsRestart**
```objc
-(NSURLSessionTask*) doVpsRestartWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Reboot the VPS — preferred over stop+start for software changes
[apiInstance doVpsRestartWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->doVpsRestart: %@", error);
                        }
                    }];
```
...
# **doVpsStart**
```objc
-(NSURLSessionTask*) doVpsStartWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Power on a stopped VPS instance
[apiInstance doVpsStartWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->doVpsStart: %@", error);
                        }
                    }];
```
...
# **doVpsStop**
```objc
-(NSURLSessionTask*) doVpsStopWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Power off a running VPS — billing continues until cancellation
[apiInstance doVpsStopWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->doVpsStop: %@", error);
                        }
                    }];
```
...
# **downloadVpsBackup**
```objc
-(NSURLSessionTask*) downloadVpsBackupWithId: (NSNumber*) _id
...
// Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
[apiInstance downloadVpsBackupWithId:_id
          ...
          completionHandler: ^(ISADownloadQsBackup200Response* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->downloadVpsBackup: %@", error);
                        }
                    }];
```
...
# **getNewVps**
```objc
-(NSURLSessionTask*) getNewVpsWithCompletionHandler: 
        (void (^)(ISAVpsOrder* output, NSError* error)) handler;
```
...
// Get the VPS order catalog — platforms, OS templates, locations, pricing
[apiInstance getNewVpsWithCompletionHandler: 
          ^(ISAVpsOrder* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getNewVps: %@", error);
                        }
                    }];
```
...
# **getVpsBackup**
```objc
-(NSURLSessionTask*) getVpsBackupWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Trigger a manual on-demand snapshot/backup of the VPS
[apiInstance getVpsBackupWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsBackup: %@", error);
                        }
                    }];
```
...
# **getVpsBackups**
```objc
-(NSURLSessionTask*) getVpsBackupsWithId: (NSNumber*) _id
    all: (NSString*) all
...
// List existing backups for the VPS across Swift, MinIO, and ZFS
[apiInstance getVpsBackupsWithId:_id
              all:all
          completionHandler: ^(ISAVpsBackupRows* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsBackups: %@", error);
                        }
                    }];
```
...
# **getVpsBuyHdSpace**
```objc
-(NSURLSessionTask*) getVpsBuyHdSpaceWithId: (NSNumber*) _id
...
// Get current additional disk size and per-GB monthly cost for the VPS
[apiInstance getVpsBuyHdSpaceWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsBuyHdSpace: %@", error);
                        }
                    }];
```
...
# **getVpsBuyIp**
```objc
-(NSURLSessionTask*) getVpsBuyIpWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Read current additional IPs, cap, and per-IP monthly cost for the VPS
[apiInstance getVpsBuyIpWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsBuyIp: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) getVpsChangeHostnameWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Read the VPS's current hostname before changing it
[apiInstance getVpsChangeHostnameWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsChangeHostname: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) getVpsChangeRootPasswordWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Pre-flight check before changing the VPS root password
[apiInstance getVpsChangeRootPasswordWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsChangeRootPassword: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) getVpsChangeTimezoneWithId: (NSNumber*) _id
...
// List IANA timezones supported by the VPS guest OS
[apiInstance getVpsChangeTimezoneWithId:_id
          completionHandler: ^(NSArray<NSString*>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsChangeTimezone: %@", error);
                        }
                    }];
```
...
# **getVpsInfo**
```objc
-(NSURLSessionTask*) getVpsInfoWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAVps* output, NSError* error)) handler;
```
...
// Get full details for one VPS — IPs, hostname, OS, slices, status, addons
[apiInstance getVpsInfoWithId:_id
          completionHandler: ^(ISAVps* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsInfo: %@", error);
                        }
                    }];
```
...
# **getVpsInsertCd**
```objc
-(NSURLSessionTask*) getVpsInsertCdWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// List ISO templates that can be mounted in the VPS virtual CD drive
[apiInstance getVpsInsertCdWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsInsertCd: %@", error);
                        }
                    }];
```
...
# **getVpsInvoices**
```objc
-(NSURLSessionTask*) getVpsInvoicesWithId: (NSNumber*) _id
...
// List all billing invoices associated with this specific VPS
[apiInstance getVpsInvoicesWithId:_id
          completionHandler: ^(ISAChargeInvoiceRows* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsInvoices: %@", error);
                        }
                    }];
```
...
# **getVpsList**
```objc
-(NSURLSessionTask*) getVpsListWithCompletionHandler: 
        (void (^)(NSArray<ISAVpsRow>* output, NSError* error)) handler;
```
...
// List all VPS services on the customer's account
[apiInstance getVpsListWithCompletionHandler: 
          ^(NSArray<ISAVpsRow>* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsList: %@", error);
                        }
                    }];
```
...
[**NSArray<ISAVpsRow>***](ISAVpsRow.md)
...
# **getVpsReinstallOs**
```objc
-(NSURLSessionTask*) getVpsReinstallOsWithId: (NSNumber*) _id
...
// List OS templates compatible with this VPS's hypervisor for reinstall
[apiInstance getVpsReinstallOsWithId:_id
          completionHandler: ^(ISAVpsTemplatesList* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsReinstallOs: %@", error);
                        }
                    }];
```
...
# **getVpsResetPassword**
```objc
-(NSURLSessionTask*) getVpsResetPasswordWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Pre-flight check before resetting the VPS root password to a random value
[apiInstance getVpsResetPasswordWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsResetPassword: %@", error);
                        }
                    }];
```
...
# **getVpsReverseDns**
```objc
-(NSURLSessionTask*) getVpsReverseDnsWithId: (NSNumber*) _id
...
// Read the current PTR (reverse-DNS) records for every IP on the VPS
[apiInstance getVpsReverseDnsWithId:_id
          completionHandler: ^(ISAReverseDnsEntries* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsReverseDns: %@", error);
                        }
                    }];
```
...
# **getVpsSetupVnc**
```objc
-(NSURLSessionTask*) getVpsSetupVncWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Read current VNC console connection info for the VPS
[apiInstance getVpsSetupVncWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsSetupVnc: %@", error);
                        }
                    }];
```
...
# **getVpsSlices**
```objc
-(NSURLSessionTask*) getVpsSlicesWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Read current slice count, min/max range, and prorated per-slice upgrade cost
[apiInstance getVpsSlicesWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsSlices: %@", error);
                        }
                    }];
```
...
# **getVpsTrafficUsage**
```objc
-(NSURLSessionTask*) getVpsTrafficUsageWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAVpsTrafficResponse* output, NSError* error)) handler;
```
...
// Read bandwidth traffic usage data for the VPS
[apiInstance getVpsTrafficUsageWithId:_id
          completionHandler: ^(ISAVpsTrafficResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsTrafficUsage: %@", error);
                        }
                    }];
```
...
[**ISAVpsTrafficResponse***](ISAVpsTrafficResponse.md)
...
# **getVpsViewDesktop**
```objc
-(NSURLSessionTask*) getVpsViewDesktopWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS
[apiInstance getVpsViewDesktopWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsViewDesktop: %@", error);
                        }
                    }];
```
...
# **getVpsWelcomeEmail**
```objc
-(NSURLSessionTask*) getVpsWelcomeEmailWithId: (NSString*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSString* _id = 4813; // VPS ID

ISAVPSApi*apiInstance = [[ISAVPSApi alloc] init];

// Resend the welcome email containing VPS IP, hostname, and root credentials
[apiInstance getVpsWelcomeEmailWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->getVpsWelcomeEmail: %@", error);
                        }
                    }];
```
...
# **postVpsBuyHdSpace**
```objc
-(NSURLSessionTask*) postVpsBuyHdSpaceWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Buy or resize the VPS additional-disk addon and create a prorated invoice
[apiInstance postVpsBuyHdSpaceWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsBuyHdSpace: %@", error);
                        }
                    }];
```
...
# **postVpsBuyIp**
```objc
-(NSURLSessionTask*) postVpsBuyIpWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Purchase one additional IP for the VPS and create the invoice
[apiInstance postVpsBuyIpWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsBuyIp: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) postVpsChangeHostnameWithId: (NSNumber*) _id
...
NSNumber* _id = @56; // VPS ID number
NSString* hostname = @"hostname_example"; //  (optional)

ISAVPSApi*apiInstance = [[ISAVPSApi alloc] init];

// Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP
[apiInstance postVpsChangeHostnameWithId:_id
              hostname:hostname
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsChangeHostname: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) postVpsChangeRootPasswordWithId: (NSNumber*) _id
...
// Set a specific new root/Administrator password on the VPS
[apiInstance postVpsChangeRootPasswordWithId:_id
              password:password
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsChangeRootPassword: %@", error);
                        }
                    }];
```
...
# **postVpsChangeTimezone**
```objc
-(NSURLSessionTask*) postVpsChangeTimezoneWithId: (NSNumber*) _id
...
// Set the system timezone on the VPS guest OS
[apiInstance postVpsChangeTimezoneWithId:_id
              timezone:timezone
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsChangeTimezone: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) postVpsChangeWebuzoPasswordWithId: (NSNumber*) _id
    password: (NSString*) password
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Rotate the Webuzo control panel admin password (re-auth required)
[apiInstance postVpsChangeWebuzoPasswordWithId:_id
              password:password
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsChangeWebuzoPassword: %@", error);
                        }
                    }];
```
...
# **postVpsInsertCd**
```objc
-(NSURLSessionTask*) postVpsInsertCdWithId: (NSNumber*) _id
    url: (NSString*) url
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // VPS ID number
NSString* url = @"url_example"; //  (optional)

ISAVPSApi*apiInstance = [[ISAVPSApi alloc] init];

// Mount an ISO image in the VPS virtual CD drive from a URL
[apiInstance postVpsInsertCdWithId:_id
              url:url
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsInsertCd: %@", error);
                        }
                    }];
```
...
# **postVpsReinstallOs**
```objc
-(NSURLSessionTask*) postVpsReinstallOsWithId: (NSNumber*) _id
    template: (NSString*) template
    localPassword: (NSString*) localPassword
    password: (NSString*) password
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
NSNumber* _id = @56; // VPS ID number
NSString* template = @"template_example"; // OS Template Filename
NSString* localPassword = @"localPassword_example"; // Password for this account.
NSString* password = @"password_example"; // Password for Root / Administrator Account. (optional)

ISAVPSApi*apiInstance = [[ISAVPSApi alloc] init];

// Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)
[apiInstance postVpsReinstallOsWithId:_id
              template:template
          ...
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsReinstallOs: %@", error);
                        }
                    }];
```
...
```objc
-(NSURLSessionTask*) postVpsResetPasswordWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Reset the VPS root password to a server-generated random value
[apiInstance postVpsResetPasswordWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsResetPassword: %@", error);
                        }
                    }];
```
...
# **postVpsRestore**
```objc
-(NSURLSessionTask*) postVpsRestoreWithId: (NSNumber*) _id
...
NSNumber* _id = @56; // VPS ID number
ISARestoreRequest* restoreRequest = [[ISARestoreRequest alloc] init]; // VPS Restore request

ISAVPSApi*apiInstance = [[ISAVPSApi alloc] init];

// Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
[apiInstance postVpsRestoreWithId:_id
          ...
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsRestore: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **_id** | **NSNumber***| VPS ID number | 
 **restoreRequest** | [**ISARestoreRequest***](ISARestoreRequest.md)| VPS Restore request | 
...
# **postVpsReverseDns**
```objc
-(NSURLSessionTask*) postVpsReverseDnsWithId: (NSNumber*) _id
...
// Bulk-update PTR (reverse-DNS) records for one or more VPS IPs
[apiInstance postVpsReverseDnsWithId:_id
          ...
          completionHandler: ^(ISATextResponse* output, NSError* error) {
                        ...
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsReverseDns: %@", error);
                        }
                    }];
```
...
# **postVpsSetupVnc**
```objc
-(NSURLSessionTask*) postVpsSetupVncWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAQueueResponse* output, NSError* error)) handler;
```
...
// Provision or refresh the VNC console endpoint for the VPS
[apiInstance postVpsSetupVncWithId:_id
          completionHandler: ^(ISAQueueResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsSetupVnc: %@", error);
                        }
                    }];
```
...
# **postVpsSlices**
```objc
-(NSURLSessionTask*) postVpsSlicesWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)
[apiInstance postVpsSlicesWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsSlices: %@", error);
                        }
                    }];
```
...
# **postVpsTrafficUsage**
```objc
-(NSURLSessionTask*) postVpsTrafficUsageWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Search/filter VPS bandwidth usage with custom criteria (reserved)
[apiInstance postVpsTrafficUsageWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsTrafficUsage: %@", error);
                        }
                    }];
```
...
# **postVpsViewDesktop**
```objc
-(NSURLSessionTask*) postVpsViewDesktopWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Refresh the remote-desktop session connection info after IP/hostname changes
[apiInstance postVpsViewDesktopWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->postVpsViewDesktop: %@", error);
                        }
                    }];
```
...
# **putVps**
```objc
-(NSURLSessionTask*) putVpsWithVpsOrderPutRequest: (ISAVpsOrderPutRequest*) vpsOrderPutRequest
        completionHandler: (void (^)(ISAVpsOrderPutResponse* output, NSError* error)) handler;
```
...
ISAVpsOrderPutRequest* vpsOrderPutRequest = [[ISAVpsOrderPutRequest alloc] init]; //  (optional)

ISAVPSApi*apiInstance = [[ISAVPSApi alloc] init];

// Validate a VPS order configuration and quote the cost — dry run, no charge
[apiInstance putVpsWithVpsOrderPutRequest:vpsOrderPutRequest
          completionHandler: ^(ISAVpsOrderPutResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->putVps: %@", error);
                        }
                    }];
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **vpsOrderPutRequest** | [**ISAVpsOrderPutRequest***](ISAVpsOrderPutRequest.md)|  | [optional] 

### Return type

[**ISAVpsOrderPutResponse***](ISAVpsOrderPutResponse.md)
...
# **putVpsBuyHdSpace**
```objc
-(NSURLSessionTask*) putVpsBuyHdSpaceWithId: (NSNumber*) _id
        completionHandler: (void (^)(NSError* error)) handler;
```
...
// Preview cost to set additional VPS disk to a target GB size — dry run
[apiInstance putVpsBuyHdSpaceWithId:_id
          completionHandler: ^(NSError* error) {
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->putVpsBuyHdSpace: %@", error);
                        }
                    }];
```
...
# **updateVpsInfo**
```objc
-(NSURLSessionTask*) updateVpsInfoWithId: (NSString*) _id
        completionHandler: (void (^)(ISASuccessTextResponse* output, NSError* error)) handler;
```
...
NSString* _id = @"_id_example"; // VPS ID number.

ISAVPSApi*apiInstance = [[ISAVPSApi alloc] init];

// Update editable settings on a VPS service record
[apiInstance updateVpsInfoWithId:_id
          completionHandler: ^(ISASuccessTextResponse* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->updateVpsInfo: %@", error);
                        }
                    }];
```
...
# **vPSCancel**
```objc
-(NSURLSessionTask*) vPSCancelWithId: (NSNumber*) _id
        completionHandler: (void (^)(ISAVPSCancel200Response* output, NSError* error)) handler;
```
...
// Cancel a VPS service at the end of the current billing cycle
[apiInstance vPSCancelWithId:_id
          completionHandler: ^(ISAVPSCancel200Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ISAVPSApi->vPSCancel: %@", error);
                        }
                    }];
```
...
[**ISAVPSCancel200Response***](ISAVPSCancel200Response.md)
