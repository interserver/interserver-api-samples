...
@interface ISAFloatingIPsApi: NSObject <ISAApi>

extern NSString* kISAFloatingIPsApiErrorDomain;
extern NSInteger kISAFloatingIPsApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Floating Ip Cancel",
///  code:401 message:"Unauthorized"
///
/// @return ISAFloatingIpsCancel200Response*
...
/// @param _id The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;.
/// 
///  code:200 message:"Detailed Floating IP service information.",
///  code:401 message:"Unauthorized"
///
/// @return NSObject*
...
///
/// 
///  code:200 message:"Available options and pricing for ordering a Floating IP.",
///  code:401 message:"Unauthorized"
///
/// @return NSObject*
