#import "ISAScrubIpsApi.h"
#import "ISAQueryParamCollection.h"
#import "ISAApiClient.h"
#import "ISACancelScrubIp200Response.h"
#import "ISAChargeInvoiceRows.h"
#import "ISACreateFilter.h"
#import "ISACreateFilter201Response.h"
#import "ISACreateFilter400Response.h"
#import "ISACreateFilter500Response.h"
#import "ISACreateFirewallRule.h"
#import "ISACreateGeoFirewallRule.h"
#import "ISACreateGeoRule400Response.h"
#import "ISACreateRule201Response.h"
#import "ISACreateRule400Response.h"
#import "ISACreateRule500Response.h"
#import "ISADeleteFilter200Response.h"
#import "ISADeleteFilter400Response.h"
#import "ISADeleteFilter500Response.h"
#import "ISADeleteFirewallRule.h"
#import "ISADeleteGeoFirewallRule.h"
#import "ISADisableScrub200Response.h"
#import "ISADisableScrub400Response.h"
#import "ISADisableScrub500Response.h"
#import "ISAEnableScrub200Response.h"
#import "ISAEnableScrub500Response.h"
#import "ISAGetAccountInfo401Response.h"
#import "ISAGetOrderDetail200Response.h"
#import "ISAGetScrubIpDetails200Response.h"
#import "ISAPlaceScrubOrder201Response.h"
#import "ISAPutScrubIps200Response.h"
#import "ISAScrubIpFilterTypes.h"
#import "ISAScrubIpPlaceOrder.h"
#import "ISAScrubIpsDeleteRule200Response.h"
#import "ISAScrubIpsDeleteRule400Response.h"
#import "ISAScrubIpsDeleteRule500Response.h"
#import "ISAScrubIpsLogRowSchema.h"
#import "ISAScrubIpsRowSchema.h"


@interface ISAScrubIpsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ISAScrubIpsApi

NSString* kISAScrubIpsApiErrorDomain = @"ISAScrubIpsApiErrorDomain";
NSInteger kISAScrubIpsApiMissingParamErrorCode = 234513;
...
///  @param _id ScrubIp ID number 
///
///  @returns ISACancelScrubIp200Response*
///
-(NSURLSessionTask*) cancelScrubIpWithId: (NSNumber*) _id
    completionHandler: (void (^)(ISACancelScrubIp200Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"_id"] };
            NSError* error = [NSError errorWithDomain:kISAScrubIpsApiErrorDomain code:kISAScrubIpsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"ISACancelScrubIp200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISACancelScrubIp200Response*)data, error);
                                }
                            }];
}
...
///  @param createFilter  
///
///  @returns ISACreateFilter201Response*
///
-(NSURLSessionTask*) createFilterWithId: (NSNumber*) _id
    createFilter: (ISACreateFilter*) createFilter
    completionHandler: (void (^)(ISACreateFilter201Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
        if(handler) {
    ...
    if (createFilter == nil) {
        NSParameterAssert(createFilter);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"createFilter"] };
            NSError* error = [NSError errorWithDomain:kISAScrubIpsApiErrorDomain code:kISAScrubIpsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/create_filter"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISACreateFilter201Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISACreateFilter201Response*)data, error);
                                }
                            }];
}
...
///
///  @returns ISACreateRule201Response*
///
-(NSURLSessionTask*) createGeoRuleWithId: (NSNumber*) _id
    createGeoFirewallRule: (ISACreateGeoFirewallRule*) createGeoFirewallRule
    completionHandler: (void (^)(ISACreateRule201Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
        if(handler) {
    ...
    if (createGeoFirewallRule == nil) {
        NSParameterAssert(createGeoFirewallRule);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"createGeoFirewallRule"] };
            NSError* error = [NSError errorWithDomain:kISAScrubIpsApiErrorDomain code:kISAScrubIpsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/create_geo_rule"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = createGeoFirewallRule;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISACreateRule201Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISACreateRule201Response*)data, error);
                                }
                            }];
}
...
///  @returns ISACreateRule201Response*
///
-(NSURLSessionTask*) createRuleWithId: (NSNumber*) _id
    createFirewallRule: (ISACreateFirewallRule*) createFirewallRule
    completionHandler: (void (^)(ISACreateRule201Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
    ...
    if (createFirewallRule == nil) {
        NSParameterAssert(createFirewallRule);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"createFirewallRule"] };
            NSError* error = [NSError errorWithDomain:kISAScrubIpsApiErrorDomain code:kISAScrubIpsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/create_rule"];
...
///  @param createFilter  
///
///  @returns ISADeleteFilter200Response*
///
-(NSURLSessionTask*) deleteFilterWithId: (NSNumber*) _id
    createFilter: (ISACreateFilter*) createFilter
    completionHandler: (void (^)(ISADeleteFilter200Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
        if(handler) {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/delete_filter"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADeleteFilter200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADeleteFilter200Response*)data, error);
                                }
                            }];
}
...
///  @param _id ScrubIp ID number 
///
///  @returns ISADisableScrub200Response*
///
-(NSURLSessionTask*) disableScrubWithId: (NSNumber*) _id
    completionHandler: (void (^)(ISADisableScrub200Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
        if(handler) {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/disable"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADisableScrub200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADisableScrub200Response*)data, error);
                                }
                            }];
}
...
///  @param _id ScrubIp ID number 
///
///  @returns ISAEnableScrub200Response*
///
-(NSURLSessionTask*) enableScrubWithId: (NSNumber*) _id
    completionHandler: (void (^)(ISAEnableScrub200Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
        if(handler) {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/enable"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAEnableScrub200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAEnableScrub200Response*)data, error);
                                }
                            }];
}
...
///  @returns ISAGetOrderDetail200Response*
///
-(NSURLSessionTask*) getOrderDetailWithCompletionHandler: 
    (void (^)(ISAGetOrderDetail200Response* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/order"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAGetOrderDetail200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAGetOrderDetail200Response*)data, error);
                                }
                            }];
}
...
///  @param _id ScrubIp ID number 
///
///  @returns ISAGetScrubIpDetails200Response*
///
-(NSURLSessionTask*) getScrubIpDetailsWithId: (NSNumber*) _id
    completionHandler: (void (^)(ISAGetScrubIpDetails200Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
        if(handler) {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAGetScrubIpDetails200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAGetScrubIpDetails200Response*)data, error);
                                }
                            }];
}
...
///  @returns ISAScrubIpFilterTypes*
///
-(NSURLSessionTask*) getScrubIpFilterTypesWithCompletionHandler: 
    (void (^)(ISAScrubIpFilterTypes* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/filter_types"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAScrubIpFilterTypes*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAScrubIpFilterTypes*)data, error);
                                }
                            }];
}
...
///
-(NSURLSessionTask*) getScrubIpInvoicesWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/invoices"];
...
///  @param _id Scrub Order ID 
///
///  @returns NSArray<ISAScrubIpsLogRowSchema>*
///
-(NSURLSessionTask*) getScrubIpLogsWithId: (NSString*) _id
    completionHandler: (void (^)(NSArray<ISAScrubIpsLogRowSchema>* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
        if(handler) {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/logs"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<ISAScrubIpsLogRowSchema>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<ISAScrubIpsLogRowSchema>*)data, error);
                                }
                            }];
}
...
///  @returns NSArray<ISAScrubIpsRowSchema>*
///
-(NSURLSessionTask*) getScrubIpsListWithCompletionHandler: 
    (void (^)(NSArray<ISAScrubIpsRowSchema>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<ISAScrubIpsRowSchema>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<ISAScrubIpsRowSchema>*)data, error);
                                }
                            }];
}
...
///
///  @returns ISAPlaceScrubOrder201Response*
///
-(NSURLSessionTask*) placeScrubOrderWithScrubIpPlaceOrder: (ISAScrubIpPlaceOrder*) scrubIpPlaceOrder
    completionHandler: (void (^)(ISAPlaceScrubOrder201Response* output, NSError* error)) handler {
    // verify the required parameter 'scrubIpPlaceOrder' is set
    if (scrubIpPlaceOrder == nil) {
        NSParameterAssert(scrubIpPlaceOrder);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"scrubIpPlaceOrder"] };
            NSError* error = [NSError errorWithDomain:kISAScrubIpsApiErrorDomain code:kISAScrubIpsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAPlaceScrubOrder201Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAPlaceScrubOrder201Response*)data, error);
                                }
                            }];
}
...
///  @param scrubIpPlaceOrder  
///
///  @returns ISAPutScrubIps200Response*
///
-(NSURLSessionTask*) putScrubIpsWithScrubIpPlaceOrder: (ISAScrubIpPlaceOrder*) scrubIpPlaceOrder
    completionHandler: (void (^)(ISAPutScrubIps200Response* output, NSError* error)) handler {
    // verify the required parameter 'scrubIpPlaceOrder' is set
    if (scrubIpPlaceOrder == nil) {
        NSParameterAssert(scrubIpPlaceOrder);
        if(handler) {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAPutScrubIps200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAPutScrubIps200Response*)data, error);
                                }
                            }];
}
...
///
///  @returns ISAScrubIpsDeleteRule200Response*
///
-(NSURLSessionTask*) scrubIpsDeleteGeoRuleWithId: (NSNumber*) _id
    deleteGeoFirewallRule: (ISADeleteGeoFirewallRule*) deleteGeoFirewallRule
    completionHandler: (void (^)(ISAScrubIpsDeleteRule200Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
        if(handler) {
    ...
    if (deleteGeoFirewallRule == nil) {
        NSParameterAssert(deleteGeoFirewallRule);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"deleteGeoFirewallRule"] };
            NSError* error = [NSError errorWithDomain:kISAScrubIpsApiErrorDomain code:kISAScrubIpsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/delete_geo_rule"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = deleteGeoFirewallRule;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAScrubIpsDeleteRule200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAScrubIpsDeleteRule200Response*)data, error);
                                }
                            }];
}
...
///  @returns ISAScrubIpsDeleteRule200Response*
///
-(NSURLSessionTask*) scrubIpsDeleteRuleWithId: (NSNumber*) _id
    deleteFirewallRule: (ISADeleteFirewallRule*) deleteFirewallRule
    completionHandler: (void (^)(ISAScrubIpsDeleteRule200Response* output, NSError* error)) handler {
    // verify the required parameter '_id' is set
    if (_id == nil) {
        NSParameterAssert(_id);
    ...
    if (deleteFirewallRule == nil) {
        NSParameterAssert(deleteFirewallRule);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"deleteFirewallRule"] };
            NSError* error = [NSError errorWithDomain:kISAScrubIpsApiErrorDomain code:kISAScrubIpsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/scrub_ips/{id}/delete_rule"];
