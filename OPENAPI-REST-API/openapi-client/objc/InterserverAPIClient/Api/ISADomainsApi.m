#import "ISADomainsApi.h"
#import "ISAQueryParamCollection.h"
#import "ISAApiClient.h"
#import "ISACancelDomain200Response.h"
#import "ISAChargeInvoiceRows.h"
#import "ISADomain.h"
#import "ISADomainContactDetails.h"
#import "ISADomainDnssecRecords.h"
#import "ISADomainDnssecRequest.h"
#import "ISADomainLookupResponse.h"
#import "ISADomainNameserverGetResponse.h"
#import "ISADomainNameserverPostRequest.h"
#import "ISADomainNameserverPutRequest.h"
#import "ISADomainOrder.h"
...
@interface ISADomainsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ISADomainsApi

NSString* kISADomainsApiErrorDomain = @"ISADomainsApiErrorDomain";
NSInteger kISADomainsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addDomainWithDomainOrderRequest: (ISADomainOrderRequest*) domainOrderRequest
    ...
    if (domainOrderRequest == nil) {
        NSParameterAssert(domainOrderRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"domainOrderRequest"] };
            NSError* error = [NSError errorWithDomain:kISADomainsApiErrorDomain code:kISADomainsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/order"];
...
///  @param _id The domain service ID. Use `domain_id` from `GET /domains`. 
///
...
-(NSURLSessionTask*) addDomainDnssecWithId: (NSNumber*) _id
    ...
    if (domainDnssecRequest == nil) {
        NSParameterAssert(domainDnssecRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"domainDnssecRequest"] };
            NSError* error = [NSError errorWithDomain:kISADomainsApiErrorDomain code:kISADomainsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/{id}/dnssec"];
...
-(NSURLSessionTask*) addDomainNameserverWithId: (NSNumber*) _id
    ...
    if (domainNameserverPostRequest == nil) {
        NSParameterAssert(domainNameserverPostRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"domainNameserverPostRequest"] };
            NSError* error = [NSError errorWithDomain:kISADomainsApiErrorDomain code:kISADomainsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/{id}/nameservers"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = domainNameserverPostRequest;
...
///  @param _id The domain service ID. Use `domain_id` from `GET /domains`. 
///
///  @returns ISACancelDomain200Response*
///
-(NSURLSessionTask*) cancelDomainWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISACancelDomain200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISACancelDomain200Response*)data, error);
                                }
                            }];
}
...
///  @param _id The domain service ID. Use `domain_id` from `GET /domains`. 
///
///  @returns ISADomainContactDetails*
///
-(NSURLSessionTask*) getDomainContactWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/{id}/contact"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADomainContactDetails*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADomainContactDetails*)data, error);
                                }
                            }];
}
...
///  @param _id The domain service ID. Use `domain_id` from `GET /domains`. 
///
///  @returns ISADomainDnssecRecords*
///
-(NSURLSessionTask*) getDomainDnssecWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADomainDnssecRecords*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADomainDnssecRecords*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getDomainInfoWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADomain*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADomain*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getDomainInvoicesWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/{id}/invoices"];
...
///
///  @returns ISADomainLookupResponse*
///
-(NSURLSessionTask*) getDomainLookupWithName: (NSString*) name
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/lookup/{name}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADomainLookupResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADomainLookupResponse*)data, error);
                                }
                            }];
}
...
///  @param _id The domain service ID. Use `domain_id` from `GET /domains`. 
///
///  @returns ISADomainNameserverGetResponse*
///
-(NSURLSessionTask*) getDomainNameserversWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADomainNameserverGetResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADomainNameserverGetResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getDomainRenewalWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/{id}/renew"];
...
///
///  @returns ISADomainSearchResponse*
///
-(NSURLSessionTask*) getDomainSearchWithName: (NSString*) name
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/search/{name}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADomainSearchResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADomainSearchResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getDomainTransferWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/{id}/transfer"];
...
-(NSURLSessionTask*) getDomainWhoisPrivacyWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/{id}/whois"];
...
-(NSURLSessionTask*) getDomainsListWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<ISADomainRow>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<ISADomainRow>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getDomainsWelcomeEmailWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/domains/{id}/welcome_email"];
...
-(NSURLSessionTask*) getNewDomainWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADomainOrder*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADomainOrder*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) updateDomainContactWithId: (NSNumber*) _id
    ...
    if (domainContactDetails == nil) {
        NSParameterAssert(domainContactDetails);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"domainContactDetails"] };
            NSError* error = [NSError errorWithDomain:kISADomainsApiErrorDomain code:kISADomainsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = domainContactDetails;
...
-(NSURLSessionTask*) updateDomainNameserversWithId: (NSNumber*) _id
    ...
    if (domainNameserverPutRequest == nil) {
        NSParameterAssert(domainNameserverPutRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"domainNameserverPutRequest"] };
            NSError* error = [NSError errorWithDomain:kISADomainsApiErrorDomain code:kISADomainsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = domainNameserverPutRequest;
...
-(NSURLSessionTask*) updateDomainWhoisPrivacyWithId: (NSNumber*) _id
    ...
    if (domainWhoisPrivacyRequest == nil) {
        NSParameterAssert(domainWhoisPrivacyRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"domainWhoisPrivacyRequest"] };
            NSError* error = [NSError errorWithDomain:kISADomainsApiErrorDomain code:kISADomainsApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = domainWhoisPrivacyRequest;
