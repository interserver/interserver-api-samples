...
@interface ISAPublicApi: NSObject <ISAApi>

extern NSString* kISAPublicApiErrorDomain;
extern NSInteger kISAPublicApiMissingParamErrorCode;
...
///
/// 
///  code:200 message:"An array of enabled currency codes.",
...
///
/// 
///  code:200 message:"Map of locale identifiers to display names.",
///  code:401 message:"Unauthorized"
///
/// @return NSDictionary<ISAGetAccountLocales200ResponseValue>*
...
///
/// 
///  code:200 message:"An array containing a `captcha` field containing a string with a base64 encoded captcha image.",
///  code:401 message:"Unauthorized"
///
/// @return ISACaptchaResponse*
...
/// 
///  code:200 message:"The list of countries with both 2 letter abbreviations and the country names.",
///  code:401 message:"Unauthorized"
///
/// @return NSObject*
...
///
/// 
///  code:200 message:"The modules and services information from the server.",
///  code:401 message:"Unauthorized"
///
/// @return ISAServicesInfo*
...
///
/// 
///  code:200 message:"Various pieces of information useful for rendering a login page.",
///  code:403 message:"Error response to a login request."
///
/// @return ISALoginInfo*
...
/// 
///  code:200 message:"OAuth redirect URL for the requested provider.",
///  code:401 message:"Unauthorized"
///
/// @return ISAGetOauthRedirect200Response*
...
///
/// 
///  code:200 message:"An array of all available timezone identifiers."
///
/// @return NSArray<NSString*>*
...
/// 
///  code:200 message:"OAuth 2FA verification result.",
///  code:401 message:"Unauthorized"
///
/// @return ISAPatchOauthTwoFactor200Response*
...
///
/// 
///  code:200 message:"A simple response of \"pong\" for use with simple tests to see if a service is up. ",
///  code:401 message:"Unauthorized",
...
/// 
///  code:200 message:"OAuth callback result.",
///  code:401 message:"Unauthorized"
///
/// @return ISAPostOauthCallback200Response*
...
/// 
///  code:200 message:"Successful login response containing the session token.",
///  code:402 message:"Error response to a login request.",
///  code:0 message:"Default response"
///
/// @return ISALoginSuccessResponse*
