#import "ISAWebhostingApi.h"
#import "ISAQueryParamCollection.h"
#import "ISAApiClient.h"
#import "ISAChargeInvoiceRows.h"
#import "ISAGetAccountInfo401Response.h"
#import "ISAGetWebsiteBuyIp200Response.h"
#import "ISAPostWebsiteBuyIp200Response.h"
#import "ISAPostWebsiteBuyIpRequest.h"
#import "ISAPostWebsiteMigration200Response.h"
#import "ISAPostWebsiteMigrationRequest.h"
#import "ISAPostWebsiteMigrationRequest1.h"
#import "ISAReverseDnsEntries.h"
#import "ISAServiceOrderPostResponse.h"
#import "ISASuccessTextResponse.h"
#import "ISATextResponse.h"
#import "ISAWebhostingCancel200Response.h"
#import "ISAWebsite.h"
#import "ISAWebsiteBackups.h"
#import "ISAWebsiteLoginResponse.h"
#import "ISAWebsiteOrderPostRequest.h"
#import "ISAWebsiteOrderPutRequest.h"
#import "ISAWebsiteRow.h"
#import "ISAWebsitesOrder.h"


@interface ISAWebhostingApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ISAWebhostingApi

NSString* kISAWebhostingApiErrorDomain = @"ISAWebhostingApiErrorDomain";
NSInteger kISAWebhostingApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addWebsiteWithWebsiteOrderPostRequest: (ISAWebsiteOrderPostRequest*) websiteOrderPostRequest
    ...
    if (websiteOrderPostRequest == nil) {
        NSParameterAssert(websiteOrderPostRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"websiteOrderPostRequest"] };
            NSError* error = [NSError errorWithDomain:kISAWebhostingApiErrorDomain code:kISAWebhostingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/websites/order"];
    ...
    bodyParam = websiteOrderPostRequest;
...
-(NSURLSessionTask*) getNewWebsiteWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAWebsitesOrder*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAWebsitesOrder*)data, error);
                                }
                            }];
}
...
///  @param _id The website service ID. Use `website_id` from `GET /websites`. 
///
///  @returns ISAGetWebsiteBuyIp200Response*
///
-(NSURLSessionTask*) getWebsiteBuyIpWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/websites/{id}/buy_ip"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAGetWebsiteBuyIp200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAGetWebsiteBuyIp200Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getWebsiteInfoWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/websites/{id}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAWebsite*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAWebsite*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getWebsiteInvoicesWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/websites/{id}/invoices"];
...
-(NSURLSessionTask*) getWebsiteListWithCompletionHandler: 
    ...
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
    NSString *acceptHeader = [self.apiClient.sanitizer selectHeaderAccept:@[@"application/json", @"multipart/form-data"]];
    if(acceptHeader.length > 0) {
        headerParams[@"Accept"] = acceptHeader;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<ISAWebsiteRow>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<ISAWebsiteRow>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getWebsitesBackupsWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/websites/{id}/backups"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAWebsiteBackups*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAWebsiteBackups*)data, error);
                                }
                            }];
}
...
///  @param _id The website service ID. Use `website_id` from `GET /websites`. 
///
///  @returns ISAWebsiteLoginResponse*
///
-(NSURLSessionTask*) getWebsitesLoginWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/websites/{id}/login"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAWebsiteLoginResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAWebsiteLoginResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getWebsitesWelcomeEmailWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/websites/{id}/welcome_email"];
...
-(NSURLSessionTask*) gettWebsiteReverseDnsWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/websites/{id}/reverse_dns"];
...
///
///  @returns ISAPostWebsiteBuyIp200Response*
///
-(NSURLSessionTask*) postWebsiteBuyIpWithId: (NSNumber*) _id
    ...
    if (postWebsiteBuyIpRequest == nil) {
        NSParameterAssert(postWebsiteBuyIpRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"postWebsiteBuyIpRequest"] };
            NSError* error = [NSError errorWithDomain:kISAWebhostingApiErrorDomain code:kISAWebhostingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = postWebsiteBuyIpRequest;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAPostWebsiteBuyIp200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAPostWebsiteBuyIp200Response*)data, error);
                                }
                            }];
}
...
///
///  @returns ISAPostWebsiteMigration200Response*
///
-(NSURLSessionTask*) postWebsiteMigrationWithId: (NSNumber*) _id
    ...
    if (postWebsiteMigrationRequest == nil) {
        NSParameterAssert(postWebsiteMigrationRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"postWebsiteMigrationRequest"] };
            NSError* error = [NSError errorWithDomain:kISAWebhostingApiErrorDomain code:kISAWebhostingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/websites/{id}/migration"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = postWebsiteMigrationRequest;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAPostWebsiteMigration200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAPostWebsiteMigration200Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) putWebsitesWithWebsiteOrderPutRequest: (ISAWebsiteOrderPutRequest*) websiteOrderPutRequest
    ...
    if (websiteOrderPutRequest == nil) {
        NSParameterAssert(websiteOrderPutRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"websiteOrderPutRequest"] };
            NSError* error = [NSError errorWithDomain:kISAWebhostingApiErrorDomain code:kISAWebhostingApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = websiteOrderPutRequest;
...
///  @param _id The website service ID. Use `website_id` from `GET /websites`. 
///
///  @returns ISAWebhostingCancel200Response*
///
-(NSURLSessionTask*) webhostingCancelWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAWebhostingCancel200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAWebhostingCancel200Response*)data, error);
                                }
                            }];
}
