...
@interface ISAQuickServersApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ISAQuickServersApi

NSString* kISAQuickServersApiErrorDomain = @"ISAQuickServersApiErrorDomain";
NSInteger kISAQuickServersApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addQsWithQsOrderRequest: (ISAQsOrderRequest*) qsOrderRequest
    ...
    if (qsOrderRequest == nil) {
        NSParameterAssert(qsOrderRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"qsOrderRequest"] };
            NSError* error = [NSError errorWithDomain:kISAQuickServersApiErrorDomain code:kISAQuickServersApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/order"];
...
-(NSURLSessionTask*) deleteQsBackupWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/backups"];
...
-(NSURLSessionTask*) doQsBlockSmtpWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/block_smtp"];
...
-(NSURLSessionTask*) doQsDisableCdWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/disable_cd"];
...
-(NSURLSessionTask*) doQsDisableQuotaWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/disable_quota"];
...
-(NSURLSessionTask*) doQsEjectCdWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/eject_cd"];
...
-(NSURLSessionTask*) doQsEnableQuotaWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/enable_quota"];
...
-(NSURLSessionTask*) doQsRestartWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/restart"];
...
-(NSURLSessionTask*) doQsStartWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/start"];
...
-(NSURLSessionTask*) doQsStopWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/stop"];
...
-(NSURLSessionTask*) getNewQsWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAQuickserverOrder*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAQuickserverOrder*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getQsBackupWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/backup"];
...
-(NSURLSessionTask*) getQsChangeHostnameWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/change_hostname"];
...
-(NSURLSessionTask*) getQsChangeRootPasswordWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/change_root_password"];
...
-(NSURLSessionTask*) getQsChangeTimezoneWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/change_timezone"];
...
-(NSURLSessionTask*) getQsChangeWebuzoPasswordWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/change_webuzo_password"];
...
-(NSURLSessionTask*) getQsInfoWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAQuickserver*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAQuickserver*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getQsInsertCdWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/insert_cd"];
...
-(NSURLSessionTask*) getQsInvoicesWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/invoices"];
...
-(NSURLSessionTask*) getQsListWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<ISAQuickserverRow>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<ISAQuickserverRow>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getQsReinstallOsWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/reinstall_os"];
...
-(NSURLSessionTask*) getQsResetPasswordWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/reset_password"];
...
-(NSURLSessionTask*) getQsReverseDnsWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/reverse_dns"];
...
-(NSURLSessionTask*) getQsSetupVncWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/setup_vnc"];
...
-(NSURLSessionTask*) getQsTrafficUsageWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/traffic_usage"];
...
-(NSURLSessionTask*) getQsViewDesktopWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/view_desktop"];
...
-(NSURLSessionTask*) getQsWelcomeEmailWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/welcome_email"];
...
-(NSURLSessionTask*) postQuickServerRestoreWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/qs/{id}/restore"];
...
///  @param _id QuickServer ID number 
///
///  @returns ISAQuickserversCancel200Response*
///
-(NSURLSessionTask*) quickserversCancelWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAQuickserversCancel200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAQuickserversCancel200Response*)data, error);
                                }
                            }];
}
