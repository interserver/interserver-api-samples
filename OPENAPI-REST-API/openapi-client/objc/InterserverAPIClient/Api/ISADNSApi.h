...
@interface ISADNSApi: NSObject <ISAApi>

extern NSString* kISADNSApiErrorDomain;
extern NSInteger kISADNSApiMissingParamErrorCode;
...
/// 
///  code:200 message:"The DNS records for the specified domain.",
///  code:401 message:"Unauthorized"
///
/// @return NSArray<ISADnsRecord>*
...
///
/// 
///  code:200 message:"Listing of DNS domains on the account with their primary A record.",
///  code:401 message:"Unauthorized"
///
/// @return NSArray<ISADnsListItem>*
