#import "ISASSLCertificatesApi.h"
...
@interface ISASSLCertificatesApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ISASSLCertificatesApi

NSString* kISASSLCertificatesApiErrorDomain = @"ISASSLCertificatesApiErrorDomain";
NSInteger kISASSLCertificatesApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addSslWithSslOrderRequest: (ISASslOrderRequest*) sslOrderRequest
    ...
    if (sslOrderRequest == nil) {
        NSParameterAssert(sslOrderRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"sslOrderRequest"] };
            NSError* error = [NSError errorWithDomain:kISASSLCertificatesApiErrorDomain code:kISASSLCertificatesApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ssl/order"];
...
///  @param _id SSL certificate ID number. 
///
///  @returns NSObject*
///
-(NSURLSessionTask*) getSslInfoWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ssl/{id}"];
...
-(NSURLSessionTask*) getSslInvoicesWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ssl/{id}/invoices"];
...
-(NSURLSessionTask*) getSslListWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ssl"];
...
-(NSURLSessionTask*) getSslWelcomeEmailWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/ssl/{id}/welcome_email"];
...
///  @param _id SSL Cert ID number 
///
///  @returns ISASslCancel200Response*
///
-(NSURLSessionTask*) sslCancelWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISASslCancel200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISASslCancel200Response*)data, error);
                                }
                            }];
}
