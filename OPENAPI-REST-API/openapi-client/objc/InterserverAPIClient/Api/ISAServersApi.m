...
@interface ISAServersApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ISAServersApi

NSString* kISAServersApiErrorDomain = @"ISAServersApiErrorDomain";
NSInteger kISAServersApiMissingParamErrorCode = 234513;
...
///
///  @returns ISAAddServer200Response*
///
-(NSURLSessionTask*) addServerWithServerOrderPostRequest: (ISAServerOrderPostRequest*) serverOrderPostRequest
    ...
    if (serverOrderPostRequest == nil) {
        NSParameterAssert(serverOrderPostRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"serverOrderPostRequest"] };
            NSError* error = [NSError errorWithDomain:kISAServersApiErrorDomain code:kISAServersApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/servers/order"];
    ...
    bodyParam = serverOrderPostRequest;
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"ISAAddServer200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAAddServer200Response*)data, error);
                                }
                            }];
}
...
///  @returns ISABuyItNowServerOrder200Response*
///
-(NSURLSessionTask*) buyItNowServerOrderWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/servers/order/buy_now_server"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISABuyItNowServerOrder200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISABuyItNowServerOrder200Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getNewServerWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAServerOrder*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAServerOrder*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getServerInfoWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/servers/{id}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAServer*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAServer*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getServerInvoicesWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/servers/{id}/invoices"];
...
-(NSURLSessionTask*) getServerListWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<ISAServerRow>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<ISAServerRow>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getServerReverseDnsWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/servers/{id}/reverse_dns"];
...
-(NSURLSessionTask*) getServersWelcomeEmailWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/servers/{id}/welcome_email"];
...
///
///  @returns ISAServersBuyNowResponse*
///
-(NSURLSessionTask*) placeBuyNowServerWithPlaceBuyNowServerRequest: (ISAPlaceBuyNowServerRequest*) placeBuyNowServerRequest
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = placeBuyNowServerRequest;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAServersBuyNowResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAServersBuyNowResponse*)data, error);
                                }
                            }];
}
...
///
///  @returns ISAServerBulkIpmiPowerResponse*
///
-(NSURLSessionTask*) serverBulkIpmiPowerGetWithIds: (NSString*) ids
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/servers/bulk/ipmi_power"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAServerBulkIpmiPowerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAServerBulkIpmiPowerResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) serverIpmiLiveGetWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/servers/{id}/ipmi_live"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAServerIpmiLiveInfo*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAServerIpmiLiveInfo*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) serverIpmiPowerGetWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/servers/{id}/ipmi_power"];
...
///  @param _id Server ID number 
///
///  @returns ISAServersCancel200Response*
///
-(NSURLSessionTask*) serversCancelWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAServersCancel200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAServersCancel200Response*)data, error);
                                }
                            }];
}
