...
@implementation ISAVPSApi

NSString* kISAVPSApiErrorDomain = @"ISAVPSApiErrorDomain";
NSInteger kISAVPSApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addVpsWithVpsOrderPostRequest: (ISAVpsOrderPostRequest*) vpsOrderPostRequest
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/order"];
...
-(NSURLSessionTask*) deleteVpsBackupWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kISAVPSApiErrorDomain code:kISAVPSApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/backups"];
...
-(NSURLSessionTask*) doVpsBlockSmtpWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/block_smtp"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAQueueResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAQueueResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) doVpsDisableCdWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/disable_cd"];
...
-(NSURLSessionTask*) doVpsDisableQuotaWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/disable_quota"];
...
-(NSURLSessionTask*) doVpsEjectCdWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/eject_cd"];
...
-(NSURLSessionTask*) doVpsEnableQuotaWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/enable_quota"];
...
-(NSURLSessionTask*) doVpsRestartWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/restart"];
...
-(NSURLSessionTask*) doVpsStartWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/start"];
...
-(NSURLSessionTask*) doVpsStopWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/stop"];
...
///  @param all Set to `1` to list all backups across all services, not just the ones for the given VPS. (optional)
///
///  @returns ISADownloadQsBackup200Response*
///
-(NSURLSessionTask*) downloadVpsBackupWithId: (NSNumber*) _id
    ...
    if (downloadQsBackupRequest == nil) {
        NSParameterAssert(downloadQsBackupRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"downloadQsBackupRequest"] };
            NSError* error = [NSError errorWithDomain:kISAVPSApiErrorDomain code:kISAVPSApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = downloadQsBackupRequest;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISADownloadQsBackup200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISADownloadQsBackup200Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getNewVpsWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAVpsOrder*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAVpsOrder*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getVpsBackupWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/backup"];
...
-(NSURLSessionTask*) getVpsBackupsWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAVpsBackupRows*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAVpsBackupRows*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getVpsBuyHdSpaceWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/buy_hd_space"];
...
-(NSURLSessionTask*) getVpsBuyIpWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/buy_ip"];
...
-(NSURLSessionTask*) getVpsChangeHostnameWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/change_hostname"];
...
-(NSURLSessionTask*) getVpsChangeRootPasswordWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/change_root_password"];
...
-(NSURLSessionTask*) getVpsChangeTimezoneWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/change_timezone"];
...
-(NSURLSessionTask*) getVpsInfoWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}"];
...
-(NSURLSessionTask*) getVpsInsertCdWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/insert_cd"];
...
-(NSURLSessionTask*) getVpsInvoicesWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/invoices"];
...
-(NSURLSessionTask*) getVpsListWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<ISAVpsRow>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<ISAVpsRow>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getVpsReinstallOsWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/reinstall_os"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAVpsTemplatesList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAVpsTemplatesList*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getVpsResetPasswordWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/reset_password"];
...
-(NSURLSessionTask*) getVpsReverseDnsWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/reverse_dns"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAReverseDnsEntries*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAReverseDnsEntries*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getVpsSetupVncWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/setup_vnc"];
...
-(NSURLSessionTask*) getVpsSlicesWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/slices"];
...
-(NSURLSessionTask*) getVpsTrafficUsageWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/traffic_usage"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAVpsTrafficResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAVpsTrafficResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getVpsViewDesktopWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/view_desktop"];
...
-(NSURLSessionTask*) getVpsWelcomeEmailWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/welcome_email"];
...
-(NSURLSessionTask*) postVpsChangeWebuzoPasswordWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/change_webuzo_password"];
...
-(NSURLSessionTask*) postVpsReinstallOsWithId: (NSNumber*) _id
    ...
    if (localPassword == nil) {
        NSParameterAssert(localPassword);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"localPassword"] };
            NSError* error = [NSError errorWithDomain:kISAVPSApiErrorDomain code:kISAVPSApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
...
-(NSURLSessionTask*) postVpsRestoreWithId: (NSNumber*) _id
    ...
    if (restoreRequest == nil) {
        NSParameterAssert(restoreRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"restoreRequest"] };
            NSError* error = [NSError errorWithDomain:kISAVPSApiErrorDomain code:kISAVPSApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/vps/{id}/restore"];
...
-(NSURLSessionTask*) postVpsReverseDnsWithId: (NSNumber*) _id
    ...
    if (reverseDnsEntries == nil) {
        NSParameterAssert(reverseDnsEntries);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"reverseDnsEntries"] };
            NSError* error = [NSError errorWithDomain:kISAVPSApiErrorDomain code:kISAVPSApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
...
///
///  @returns ISAVpsOrderPutResponse*
///
-(NSURLSessionTask*) putVpsWithVpsOrderPutRequest: (ISAVpsOrderPutRequest*) vpsOrderPutRequest
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAVpsOrderPutResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAVpsOrderPutResponse*)data, error);
                                }
                            }];
}
...
///  @param _id VPS ID number 
///
///  @returns ISAVPSCancel200Response*
///
-(NSURLSessionTask*) vPSCancelWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAVPSCancel200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAVPSCancel200Response*)data, error);
                                }
                            }];
}
