#import "ISABillingApi.h"
#import "ISAQueryParamCollection.h"
#import "ISAApiClient.h"
#import "ISAAffiliateBannerRow.h"
#import "ISAAffiliateTrafficRow.h"
#import "ISABillingAddCcRequest.h"
#import "ISABillingInvoiceDetail.h"
#import "ISABillingInvoiceList.h"
#import "ISABillingPaymentMethodRequest.h"
#import "ISABillingPrepayRequest.h"
#import "ISABillingVerifyCcRequest.h"
#import "ISAGetAccountInfo401Response.h"
#import "ISAGetAffiliateSignups200Response.h"
#import "ISAInitiatePayment200Response.h"
#import "ISAMonthlyCounts.h"
#import "ISAPatchBillingCreditCardVerifyRequest.h"
#import "ISAStatusMonthlyBreakdown.h"
#import "ISASuccessTextResponse.h"
#import "ISATextResponse.h"


@interface ISABillingApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ISABillingApi

NSString* kISABillingApiErrorDomain = @"ISABillingApiErrorDomain";
NSInteger kISABillingApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addBillingCreditCardWithBillingAddCcRequest: (ISABillingAddCcRequest*) billingAddCcRequest
    ...
    if (billingAddCcRequest == nil) {
        NSParameterAssert(billingAddCcRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"billingAddCcRequest"] };
            NSError* error = [NSError errorWithDomain:kISABillingApiErrorDomain code:kISABillingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/billing/creditcards"];
...
-(NSURLSessionTask*) addBillingPrepayWithBillingPrepayRequest: (ISABillingPrepayRequest*) billingPrepayRequest
    ...
    if (billingPrepayRequest == nil) {
        NSParameterAssert(billingPrepayRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"billingPrepayRequest"] };
            NSError* error = [NSError errorWithDomain:kISABillingApiErrorDomain code:kISABillingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/billing/prepays"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = billingPrepayRequest;
...
///  @param _id The credit card ID to remove. Use IDs from `GET /billing/creditcards`. 
///
///  @returns ISASuccessTextResponse*
///
-(NSURLSessionTask*) deleteBillingCreditCardWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/billing/creditcards/{id}"];
...
///  @param _id The invoice ID to delete. Only unpaid invoices can be deleted. 
///
///  @returns ISASuccessTextResponse*
///
-(NSURLSessionTask*) deleteBillingInvoiceWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/billing/invoices/{id}"];
...
///  @param _id The prepay balance ID to delete. 
///
///  @returns ISASuccessTextResponse*
///
-(NSURLSessionTask*) deleteBillingPrepayWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/billing/prepays/{id}"];
...
-(NSURLSessionTask*) getAffiliateBannersWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<ISAAffiliateBannerRow>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<ISAAffiliateBannerRow>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getAffiliateDownloadWithSt: (NSString*) st
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/affiliate/download"];
...
-(NSURLSessionTask*) getAffiliateRichReportWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/affiliate/rich_report"];
...
///
///  @returns ISAStatusMonthlyBreakdown*
///
-(NSURLSessionTask*) getAffiliateSalesGraphWithDays: (NSNumber*) days
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/affiliate/sales_graph"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAStatusMonthlyBreakdown*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAStatusMonthlyBreakdown*)data, error);
                                }
                            }];
}
...
///
///  @returns ISAGetAffiliateSignups200Response*
///
-(NSURLSessionTask*) getAffiliateSignupsWithSt: (NSString*) st
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/affiliate/signups"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAGetAffiliateSignups200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAGetAffiliateSignups200Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getAffiliateTrafficGraphWithDays: (NSNumber*) days
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/affiliate/traffic_graph"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAMonthlyCounts*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAMonthlyCounts*)data, error);
                                }
                            }];
}
...
///  @returns NSArray<ISAAffiliateTrafficRow>*
///
-(NSURLSessionTask*) getAffiliateWebTrafficWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/affiliate/web_traffic"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<ISAAffiliateTrafficRow>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<ISAAffiliateTrafficRow>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getBillingCartWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/billing/cart"];
...
///  @param _id The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`. 
///
///  @returns ISASuccessTextResponse*
///
-(NSURLSessionTask*) getBillingCreditCardVerifyWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/billing/creditcards/{id}/verify"];
...
///  @param _id The invoice ID. Use IDs from `GET /billing/invoices` or from order responses. 
///
///  @returns ISABillingInvoiceDetail*
///
-(NSURLSessionTask*) getBillingInvoiceWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISABillingInvoiceDetail*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISABillingInvoiceDetail*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getBillingInvoicesWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISABillingInvoiceList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISABillingInvoiceList*)data, error);
                                }
                            }];
}
...
///
///  @returns ISAInitiatePayment200Response*
///
-(NSURLSessionTask*) initiatePaymentWithMethod: (NSString*) method
    ...
    if (invoices == nil) {
        NSParameterAssert(invoices);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"invoices"] };
            NSError* error = [NSError errorWithDomain:kISABillingApiErrorDomain code:kISABillingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/billing/pay/{method}/{invoices}"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (method != nil) {
        pathParams[@"method"] = method;
    }
    if (invoices != nil) {
        pathParams[@"invoices"] = invoices;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ISAInitiatePayment200Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ISAInitiatePayment200Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) patchBillingCreditCardVerifyWithId: (NSNumber*) _id
    ...
    if (patchBillingCreditCardVerifyRequest == nil) {
        NSParameterAssert(patchBillingCreditCardVerifyRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"patchBillingCreditCardVerifyRequest"] };
            NSError* error = [NSError errorWithDomain:kISABillingApiErrorDomain code:kISABillingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = patchBillingCreditCardVerifyRequest;
...
-(NSURLSessionTask*) postBillingCreditCardVerifyWithId: (NSNumber*) _id
    ...
    if (billingVerifyCcRequest == nil) {
        NSParameterAssert(billingVerifyCcRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"billingVerifyCcRequest"] };
            NSError* error = [NSError errorWithDomain:kISABillingApiErrorDomain code:kISABillingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = billingVerifyCcRequest;
...
-(NSURLSessionTask*) updateAffiliateDockSetupWithAffiliateDockTitle: (NSString*) affiliateDockTitle
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/affiliate/dock_setup"];
    ...
    if (affiliateDockTitle) {
        formParams[@"affiliate_dock_title"] = affiliateDockTitle;
    }
    if (affiliateDockDescription) {
        formParams[@"affiliate_dock_description"] = affiliateDockDescription;
    }
    if (referrerCoupon) {
        formParams[@"referrer_coupon"] = referrerCoupon;
    }
...
-(NSURLSessionTask*) updateAffiliatePaymentSetupWithAffiliatePaypal: (NSString*) affiliatePaypal
    ...
    completionHandler: (void (^)(ISATextResponse* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/affiliate/payment_setup"];
    ...
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    if (affiliatePaypal) {
        formParams[@"affiliate_paypal"] = affiliatePaypal;
    }
    if (affiliatePaymentMethod) {
        formParams[@"affiliate_payment_method"] = affiliatePaymentMethod;
    }
...
///  @param _id The credit card ID. Use IDs from `GET /billing/creditcards` or the response from `POST /billing/creditcards`. 
///
///  @returns ISASuccessTextResponse*
///
...
-(NSURLSessionTask*) updateBillingPaymentMethodWithBillingPaymentMethodRequest: (ISABillingPaymentMethodRequest*) billingPaymentMethodRequest
    ...
    if (billingPaymentMethodRequest == nil) {
        NSParameterAssert(billingPaymentMethodRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"billingPaymentMethodRequest"] };
            NSError* error = [NSError errorWithDomain:kISABillingApiErrorDomain code:kISABillingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/billing/payment_method"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = billingPaymentMethodRequest;
