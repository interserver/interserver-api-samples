...
@interface ISAMailApi: NSObject <ISAApi>

extern NSString* kISAMailApiErrorDomain;
extern NSInteger kISAMailApiMissingParamErrorCode;
...
/// 
///  code:200 message:"Deny rule created successfully.",
...
/// 
///  code:200 message:"Deny rule deleted successfully.",
///  code:400 message:"The specified resource was not found",
///  code:401 message:"Unauthorized",
///  code:404 message:"The specified resource was not found"
///
...
/// 
///  code:200 message:"Email address removed from block list successfully.",
///  code:400 message:"The specified resource was not found",
///  code:401 message:"Unauthorized",
///  code:404 message:"The specified resource was not found"
///
...
/// @param _id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.
/// 
///  code:200 message:"Alert configuration for the mail service.",
///  code:401 message:"Unauthorized"
///
/// @return ISAMailAlertsResponse*
...
///  code:200 message:"OK",
///  code:401 message:"Unauthorized",
///  code:404 message:"Unauthorized"
///
/// @return ISAMailBlocks*
...
/// @param _id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.
/// 
///  code:200 message:"Blocklist entries and delist details for the mail service.",
///  code:401 message:"Unauthorized"
///
/// @return ISAMailDelistResponse*
...
/// @param _id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.
/// 
///  code:200 message:"Deliverability metrics for the mail service.",
///  code:401 message:"Unauthorized"
///
/// @return ISAMailDeliverabilityResponse*
...
/// @param _id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.
/// 
///  code:200 message:"Mail Information.",
///  code:401 message:"Unauthorized"
///
/// @return ISAMailSchema*
...
///
/// 
///  code:200 message:"The listing of `Mail` services on your account.",
///  code:401 message:"Unauthorized"
///
/// @return NSArray<ISAMailRow>*
...
///
/// 
///  code:200 message:"Mail ordering information.",
///  code:401 message:"Unauthorized"
///
/// @return ISAMailOrder*
...
/// @param _id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.
/// 
///  code:200 message:"List of configured deny rules.",
///  code:401 message:"Unauthorized",
///  code:404 message:"Unauthorized"
///
/// @return NSArray<ISADenyRuleRecord>*
...
/// 
///  code:200 message:"Mail service usage statistics.",
///  code:401 message:"Unauthorized",
///  code:404 message:"Unauthorized"
///
/// @return ISAMailStatsType*
...
/// @param _id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.
/// 
///  code:200 message:"Mail Cancel",
///  code:401 message:"Unauthorized"
///
/// @return ISAMailCancel200Response*
...
/// @param sendMailAdv 
/// 
///  code:200 message:"Email queued successfully.",
///  code:400 message:"The specified resource was not found",
///  code:401 message:"Unauthorized",
///  code:404 message:"The specified resource was not found"
///
...
/// @param denyRuleNew 
/// 
///  code:200 message:"Deny rule updated successfully.",
///  code:400 message:"The specified resource was not found",
///  code:401 message:"Unauthorized",
///  code:404 message:"The specified resource was not found"
///
...
/// 
///  code:200 message:"Paginated list of mail log entries matching the specified filters.",
