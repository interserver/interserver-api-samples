...
NSString *const ISADeserializationErrorDomainKey = @"ISADeserializationErrorDomainKey";

NSInteger const ISATypeMismatchErrorCode = 143553;

NSInteger const ISAEmptyValueOccurredErrorCode = 143509;

NSInteger const ISAUnknownResponseObjectErrorCode = 143528;


@interface ISAResponseDeserializer ()
...
@implementation ISAResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:ISADeserializationErrorDomainKey code:ISATypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:ISADeserializationErrorDomainKey code:ISAEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:ISADeserializationErrorDomainKey code:ISAUnknownResponseObjectErrorCode userInfo:userInfo];
}
