...
extern NSString * ISAPercentEscapedStringFromString(NSString *string);

extern NSString * const kISAApplicationJSONType;

@protocol ISASanitizer <NSObject>
...
@interface ISASanitizer : NSObject <ISASanitizer>
