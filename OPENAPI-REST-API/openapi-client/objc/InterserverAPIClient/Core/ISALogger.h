...
#ifndef ISADebugLogResponse
#define ISADebugLogResponse(response, responseObject,request, error) [[ISALogger sharedLogger] logResponse:response responseObject:responseObject request:request error:error];
#endif
 ...
 */
#ifndef ISADebugLog
#define ISADebugLog(format, ...) [[ISALogger sharedLogger] debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];
#endif
...
/**
 * Enabled switch, default NO - default set by ISAConfiguration debug property
 */
