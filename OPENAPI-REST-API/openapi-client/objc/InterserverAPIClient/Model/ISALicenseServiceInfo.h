...
@interface ISALicenseServiceInfo : ISAObject
...
/* License currency 
 */
@property(nonatomic) NSString* licenseCurrency;
/* License order date 
 */
@property(nonatomic) NSDate* licenseOrderDate;
/* Customer ID 
 */
@property(nonatomic) NSString* licenseCustid;
/* License IP 
 */
