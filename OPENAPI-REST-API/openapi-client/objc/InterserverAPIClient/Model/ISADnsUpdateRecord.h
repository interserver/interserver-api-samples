...
@protocol ISADnsRecordType;
@class ISADnsRecordType;



@protocol ISADnsUpdateRecord
@end

@interface ISADnsUpdateRecord : ISAObject


@property(nonatomic) NSString* name;

@property(nonatomic) ISADnsRecordType* type;

@property(nonatomic) NSString* content;

@property(nonatomic) NSString* ttl;

@property(nonatomic) NSString* prio;
