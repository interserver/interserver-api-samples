...
#include "InterserverApiClient/model/LicenseIpInfoRow.h"
...
void LicenseIpInfoRow::validate()
{
    // TODO: implement validation
}

web::json::value LicenseIpInfoRow::toJson() const
{
...
bool LicenseIpInfoRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LicenseIpInfoRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LicenseIpInfoRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LicenseIpInfoRow::getDesc() const
{
    return m_Desc;
}


void LicenseIpInfoRow::setDesc(const utility::string_t& value)
{
    m_Desc = value;
    m_DescIsSet = true;
}

bool LicenseIpInfoRow::descIsSet() const
{
    return m_DescIsSet;
}

void LicenseIpInfoRow::unsetDesc()
{
    m_DescIsSet = false;
}
utility::string_t LicenseIpInfoRow::getValue() const
{
    return m_Value;
}


void LicenseIpInfoRow::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool LicenseIpInfoRow::valueIsSet() const
{
    return m_ValueIsSet;
}

void LicenseIpInfoRow::unsetValue()
{
    m_ValueIsSet = false;
}
