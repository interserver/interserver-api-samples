...
void LicenseClientLink::validate()
{
    // TODO: implement validation
}

web::json::value LicenseClientLink::toJson() const
{
...
bool LicenseClientLink::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LicenseClientLink::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LicenseClientLink::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t LicenseClientLink::getLabel() const
{
    return m_Label;
}


void LicenseClientLink::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool LicenseClientLink::labelIsSet() const
{
    return m_LabelIsSet;
}

void LicenseClientLink::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t LicenseClientLink::getLink() const
{
    return m_Link;
}


void LicenseClientLink::setLink(const utility::string_t& value)
{
    m_Link = value;
    m_LinkIsSet = true;
}

bool LicenseClientLink::linkIsSet() const
{
    return m_LinkIsSet;
}

void LicenseClientLink::unsetLink()
{
    m_LinkIsSet = false;
}
utility::string_t LicenseClientLink::getIcon() const
{
    return m_Icon;
}


void LicenseClientLink::setIcon(const utility::string_t& value)
{
    m_Icon = value;
    m_IconIsSet = true;
}

bool LicenseClientLink::iconIsSet() const
{
    return m_IconIsSet;
}

void LicenseClientLink::unsetIcon()
{
    m_IconIsSet = false;
}
...
void LicenseClientLink::setHelpText(const utility::string_t& value)
{
    m_Help_text = value;
    m_Help_textIsSet = true;
}

bool LicenseClientLink::helpTextIsSet() const
{
...
void LicenseClientLink::setOtherAttr(const utility::string_t& value)
{
    m_Other_attr = value;
    m_Other_attrIsSet = true;
}

bool LicenseClientLink::otherAttrIsSet() const
{
    return m_Other_attrIsSet;
}

void LicenseClientLink::unsetOther_attr()
{
    m_Other_attrIsSet = false;
}
