...
void MailClientLink::validate()
{
    // TODO: implement validation
}

web::json::value MailClientLink::toJson() const
{
...
bool MailClientLink::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MailClientLink::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MailClientLink::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MailClientLink::getLabel() const
{
    return m_Label;
}


void MailClientLink::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool MailClientLink::labelIsSet() const
{
    return m_LabelIsSet;
}

void MailClientLink::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t MailClientLink::getLink() const
{
    return m_Link;
}


void MailClientLink::setLink(const utility::string_t& value)
{
    m_Link = value;
    m_LinkIsSet = true;
}

bool MailClientLink::linkIsSet() const
{
    return m_LinkIsSet;
}

void MailClientLink::unsetLink()
{
    m_LinkIsSet = false;
}
utility::string_t MailClientLink::getIcon() const
{
    return m_Icon;
}


void MailClientLink::setIcon(const utility::string_t& value)
{
    m_Icon = value;
    m_IconIsSet = true;
}

bool MailClientLink::iconIsSet() const
{
    return m_IconIsSet;
}

void MailClientLink::unsetIcon()
{
    m_IconIsSet = false;
}
utility::string_t MailClientLink::getIconText() const
{
    return m_Icon_text;
}


void MailClientLink::setIconText(const utility::string_t& value)
{
    m_Icon_text = value;
    m_Icon_textIsSet = true;
}

bool MailClientLink::iconTextIsSet() const
{
    return m_Icon_textIsSet;
}

void MailClientLink::unsetIcon_text()
{
    m_Icon_textIsSet = false;
}
utility::string_t MailClientLink::getHelpText() const
{
    return m_Help_text;
}


void MailClientLink::setHelpText(const utility::string_t& value)
{
    m_Help_text = value;
    m_Help_textIsSet = true;
}

bool MailClientLink::helpTextIsSet() const
{
    return m_Help_textIsSet;
}

void MailClientLink::unsetHelp_text()
{
    m_Help_textIsSet = false;
}
utility::string_t MailClientLink::getOtherAttr() const
{
    return m_Other_attr;
}


void MailClientLink::setOtherAttr(const utility::string_t& value)
{
    m_Other_attr = value;
    m_Other_attrIsSet = true;
}

bool MailClientLink::otherAttrIsSet() const
{
    return m_Other_attrIsSet;
}

void MailClientLink::unsetOther_attr()
{
    m_Other_attrIsSet = false;
}
