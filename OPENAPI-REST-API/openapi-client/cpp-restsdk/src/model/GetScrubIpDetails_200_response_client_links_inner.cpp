...
void GetScrubIpDetails_200_response_client_links_inner::validate()
{
    // TODO: implement validation
}

web::json::value GetScrubIpDetails_200_response_client_links_inner::toJson() const
{
...
bool GetScrubIpDetails_200_response_client_links_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetScrubIpDetails_200_response_client_links_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetScrubIpDetails_200_response_client_links_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t GetScrubIpDetails_200_response_client_links_inner::getLabel() const
{
    return m_Label;
}


void GetScrubIpDetails_200_response_client_links_inner::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool GetScrubIpDetails_200_response_client_links_inner::labelIsSet() const
{
    return m_LabelIsSet;
}

void GetScrubIpDetails_200_response_client_links_inner::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t GetScrubIpDetails_200_response_client_links_inner::getLink() const
{
    return m_Link;
}


void GetScrubIpDetails_200_response_client_links_inner::setLink(const utility::string_t& value)
{
    m_Link = value;
    m_LinkIsSet = true;
}

bool GetScrubIpDetails_200_response_client_links_inner::linkIsSet() const
{
    return m_LinkIsSet;
}

void GetScrubIpDetails_200_response_client_links_inner::unsetLink()
{
    m_LinkIsSet = false;
}
utility::string_t GetScrubIpDetails_200_response_client_links_inner::getIcon() const
{
    return m_Icon;
}


void GetScrubIpDetails_200_response_client_links_inner::setIcon(const utility::string_t& value)
{
    m_Icon = value;
    m_IconIsSet = true;
}

bool GetScrubIpDetails_200_response_client_links_inner::iconIsSet() const
{
    return m_IconIsSet;
}

void GetScrubIpDetails_200_response_client_links_inner::unsetIcon()
{
    m_IconIsSet = false;
}
utility::string_t GetScrubIpDetails_200_response_client_links_inner::getIconText() const
{
    return m_Icon_text;
}


void GetScrubIpDetails_200_response_client_links_inner::setIconText(const utility::string_t& value)
{
    m_Icon_text = value;
    m_Icon_textIsSet = true;
}

bool GetScrubIpDetails_200_response_client_links_inner::iconTextIsSet() const
{
    return m_Icon_textIsSet;
}

void GetScrubIpDetails_200_response_client_links_inner::unsetIcon_text()
{
    m_Icon_textIsSet = false;
}
utility::string_t GetScrubIpDetails_200_response_client_links_inner::getHelpText() const
{
    return m_Help_text;
}


void GetScrubIpDetails_200_response_client_links_inner::setHelpText(const utility::string_t& value)
{
    m_Help_text = value;
    m_Help_textIsSet = true;
}

bool GetScrubIpDetails_200_response_client_links_inner::helpTextIsSet() const
{
    return m_Help_textIsSet;
}

void GetScrubIpDetails_200_response_client_links_inner::unsetHelp_text()
{
    m_Help_textIsSet = false;
}
utility::string_t GetScrubIpDetails_200_response_client_links_inner::getOtherAttr() const
{
    return m_Other_attr;
}


void GetScrubIpDetails_200_response_client_links_inner::setOtherAttr(const utility::string_t& value)
{
    m_Other_attr = value;
    m_Other_attrIsSet = true;
}

bool GetScrubIpDetails_200_response_client_links_inner::otherAttrIsSet() const
{
    return m_Other_attrIsSet;
}

void GetScrubIpDetails_200_response_client_links_inner::unsetOther_attr()
{
    m_Other_attrIsSet = false;
}
