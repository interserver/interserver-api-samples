...
void ServerClientLink::validate()
{
    // TODO: implement validation
}

web::json::value ServerClientLink::toJson() const
{
...
bool ServerClientLink::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ServerClientLink::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ServerClientLink::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ServerClientLink::getLabel() const
{
    return m_Label;
}


void ServerClientLink::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool ServerClientLink::labelIsSet() const
{
    return m_LabelIsSet;
}

void ServerClientLink::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t ServerClientLink::getLink() const
{
    return m_Link;
}


void ServerClientLink::setLink(const utility::string_t& value)
{
    m_Link = value;
    m_LinkIsSet = true;
}

bool ServerClientLink::linkIsSet() const
{
    return m_LinkIsSet;
}

void ServerClientLink::unsetLink()
{
    m_LinkIsSet = false;
}
utility::string_t ServerClientLink::getIcon() const
{
    return m_Icon;
}


void ServerClientLink::setIcon(const utility::string_t& value)
{
    m_Icon = value;
    m_IconIsSet = true;
}

bool ServerClientLink::iconIsSet() const
{
    return m_IconIsSet;
}

void ServerClientLink::unsetIcon()
{
    m_IconIsSet = false;
}
utility::string_t ServerClientLink::getIconText() const
{
    return m_Icon_text;
}


void ServerClientLink::setIconText(const utility::string_t& value)
{
    m_Icon_text = value;
    m_Icon_textIsSet = true;
}

bool ServerClientLink::iconTextIsSet() const
{
    return m_Icon_textIsSet;
}

void ServerClientLink::unsetIcon_text()
{
    m_Icon_textIsSet = false;
}
utility::string_t ServerClientLink::getHelpText() const
{
    return m_Help_text;
}


void ServerClientLink::setHelpText(const utility::string_t& value)
{
    m_Help_text = value;
    m_Help_textIsSet = true;
}

bool ServerClientLink::helpTextIsSet() const
{
    return m_Help_textIsSet;
}

void ServerClientLink::unsetHelp_text()
{
    m_Help_textIsSet = false;
}
