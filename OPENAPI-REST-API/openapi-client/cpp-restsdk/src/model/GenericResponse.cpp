...
utility::string_t GenericResponse::getText() const
{
    return m_Text;
}


void GenericResponse::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool GenericResponse::textIsSet() const
{
    return m_TextIsSet;
}

void GenericResponse::unsetText()
{
    m_TextIsSet = false;
}
