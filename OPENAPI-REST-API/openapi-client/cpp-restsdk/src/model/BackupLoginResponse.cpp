...
void BackupLoginResponse::validate()
{
    // TODO: implement validation
}

web::json::value BackupLoginResponse::toJson() const
{
...
bool BackupLoginResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BackupLoginResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BackupLoginResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool BackupLoginResponse::successIsSet() const
{
    return m_SuccessIsSet;
}

void BackupLoginResponse::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t BackupLoginResponse::getText() const
{
    return m_Text;
}


void BackupLoginResponse::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool BackupLoginResponse::textIsSet() const
{
    return m_TextIsSet;
}

void BackupLoginResponse::unsetText()
{
    m_TextIsSet = false;
}
