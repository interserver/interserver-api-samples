...
#include "InterserverApiClient/model/QuickserverAddonsRow.h"
...
void QuickserverAddonsRow::validate()
{
    // TODO: implement validation
}

web::json::value QuickserverAddonsRow::toJson() const
{
...
bool QuickserverAddonsRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QuickserverAddonsRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QuickserverAddonsRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QuickserverAddonsRow::getDesc() const
{
    return m_Desc;
}


void QuickserverAddonsRow::setDesc(const utility::string_t& value)
{
    m_Desc = value;
    m_DescIsSet = true;
}

bool QuickserverAddonsRow::descIsSet() const
{
    return m_DescIsSet;
}

void QuickserverAddonsRow::unsetDesc()
{
    m_DescIsSet = false;
}
utility::string_t QuickserverAddonsRow::getValue() const
{
    return m_Value;
}


void QuickserverAddonsRow::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool QuickserverAddonsRow::valueIsSet() const
{
    return m_ValueIsSet;
}

void QuickserverAddonsRow::unsetValue()
{
    m_ValueIsSet = false;
}
