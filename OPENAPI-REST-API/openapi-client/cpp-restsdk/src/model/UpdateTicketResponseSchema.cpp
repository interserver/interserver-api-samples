...
void UpdateTicketResponseSchema::validate()
{
    // TODO: implement validation
}

web::json::value UpdateTicketResponseSchema::toJson() const
{
...
bool UpdateTicketResponseSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateTicketResponseSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateTicketResponseSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool UpdateTicketResponseSchema::successIsSet() const
{
    return m_SuccessIsSet;
}

void UpdateTicketResponseSchema::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t UpdateTicketResponseSchema::getMessage() const
{
    return m_Message;
}


void UpdateTicketResponseSchema::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool UpdateTicketResponseSchema::messageIsSet() const
{
    return m_MessageIsSet;
}

void UpdateTicketResponseSchema::unsetMessage()
{
    m_MessageIsSet = false;
}
