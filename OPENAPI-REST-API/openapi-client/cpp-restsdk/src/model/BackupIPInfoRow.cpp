...
#include "InterserverApiClient/model/BackupIPInfoRow.h"
...
void BackupIPInfoRow::validate()
{
    // TODO: implement validation
}

web::json::value BackupIPInfoRow::toJson() const
{
...
bool BackupIPInfoRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BackupIPInfoRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BackupIPInfoRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t BackupIPInfoRow::getDesc() const
{
    return m_Desc;
}


void BackupIPInfoRow::setDesc(const utility::string_t& value)
{
    m_Desc = value;
    m_DescIsSet = true;
}

bool BackupIPInfoRow::descIsSet() const
{
    return m_DescIsSet;
}

void BackupIPInfoRow::unsetDesc()
{
    m_DescIsSet = false;
}
utility::string_t BackupIPInfoRow::getValue() const
{
    return m_Value;
}


void BackupIPInfoRow::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool BackupIPInfoRow::valueIsSet() const
{
    return m_ValueIsSet;
}

void BackupIPInfoRow::unsetValue()
{
    m_ValueIsSet = false;
}
