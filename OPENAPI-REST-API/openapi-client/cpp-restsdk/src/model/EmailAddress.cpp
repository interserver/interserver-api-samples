...
#include "InterserverApiClient/model/EmailAddress.h"
...
void EmailAddress::validate()
{
    // TODO: implement validation
}

web::json::value EmailAddress::toJson() const
{
...
bool EmailAddress::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void EmailAddress::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool EmailAddress::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t EmailAddress::getEmail() const
{
    return m_Email;
}


void EmailAddress::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool EmailAddress::emailIsSet() const
{
    return m_EmailIsSet;
}

void EmailAddress::unsetEmail()
{
    m_EmailIsSet = false;
}
