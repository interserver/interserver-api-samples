...
#include "InterserverApiClient/model/VpsIPInfoRow.h"
...
void VpsIPInfoRow::validate()
{
    // TODO: implement validation
}

web::json::value VpsIPInfoRow::toJson() const
{
...
bool VpsIPInfoRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void VpsIPInfoRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VpsIPInfoRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t VpsIPInfoRow::getDesc() const
{
    return m_Desc;
}


void VpsIPInfoRow::setDesc(const utility::string_t& value)
{
    m_Desc = value;
    m_DescIsSet = true;
}

bool VpsIPInfoRow::descIsSet() const
{
    return m_DescIsSet;
}

void VpsIPInfoRow::unsetDesc()
{
    m_DescIsSet = false;
}
utility::string_t VpsIPInfoRow::getValue() const
{
    return m_Value;
}


void VpsIPInfoRow::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool VpsIPInfoRow::valueIsSet() const
{
    return m_ValueIsSet;
}

void VpsIPInfoRow::unsetValue()
{
    m_ValueIsSet = false;
}
