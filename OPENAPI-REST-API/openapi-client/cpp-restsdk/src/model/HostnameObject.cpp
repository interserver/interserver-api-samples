...
#include "InterserverApiClient/model/HostnameObject.h"
...
void HostnameObject::validate()
{
    // TODO: implement validation
}

web::json::value HostnameObject::toJson() const
{
...
bool HostnameObject::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void HostnameObject::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool HostnameObject::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t HostnameObject::getHostname() const
{
    return m_Hostname;
}


void HostnameObject::setHostname(const utility::string_t& value)
{
    m_Hostname = value;
    m_HostnameIsSet = true;
}

bool HostnameObject::hostnameIsSet() const
{
    return m_HostnameIsSet;
}

void HostnameObject::unsetHostname()
{
    m_HostnameIsSet = false;
}
