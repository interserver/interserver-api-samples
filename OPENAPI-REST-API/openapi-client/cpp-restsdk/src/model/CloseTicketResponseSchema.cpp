...
void CloseTicketResponseSchema::validate()
{
    // TODO: implement validation
}

web::json::value CloseTicketResponseSchema::toJson() const
{
...
bool CloseTicketResponseSchema::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CloseTicketResponseSchema::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CloseTicketResponseSchema::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool CloseTicketResponseSchema::successIsSet() const
{
    return m_SuccessIsSet;
}

void CloseTicketResponseSchema::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t CloseTicketResponseSchema::getText() const
{
    return m_Text;
}


void CloseTicketResponseSchema::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool CloseTicketResponseSchema::textIsSet() const
{
    return m_TextIsSet;
}

void CloseTicketResponseSchema::unsetText()
{
    m_TextIsSet = false;
}
