...
void GetAccountInfo_401_response::validate()
{
    // TODO: implement validation
}

web::json::value GetAccountInfo_401_response::toJson() const
{
...
bool GetAccountInfo_401_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetAccountInfo_401_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetAccountInfo_401_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool GetAccountInfo_401_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetAccountInfo_401_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetAccountInfo_401_response::getMessage() const
{
    return m_Message;
}


void GetAccountInfo_401_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool GetAccountInfo_401_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void GetAccountInfo_401_response::unsetMessage()
{
    m_MessageIsSet = false;
}
