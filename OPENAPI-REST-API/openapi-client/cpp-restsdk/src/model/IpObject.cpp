...
void IpObject::validate()
{
    // TODO: implement validation
}

web::json::value IpObject::toJson() const
{
...
bool IpObject::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void IpObject::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool IpObject::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t IpObject::getIp() const
{
    return m_Ip;
}


void IpObject::setIp(const utility::string_t& value)
{
    m_Ip = value;
    m_IpIsSet = true;
}

bool IpObject::ipIsSet() const
{
    return m_IpIsSet;
}

void IpObject::unsetIp()
{
    m_IpIsSet = false;
}
