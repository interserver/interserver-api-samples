...
void SuccessTextResponse::validate()
{
    // TODO: implement validation
}

web::json::value SuccessTextResponse::toJson() const
{
...
bool SuccessTextResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SuccessTextResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SuccessTextResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool SuccessTextResponse::successIsSet() const
{
    return m_SuccessIsSet;
}

void SuccessTextResponse::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t SuccessTextResponse::getText() const
{
    return m_Text;
}


void SuccessTextResponse::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool SuccessTextResponse::textIsSet() const
{
    return m_TextIsSet;
}

void SuccessTextResponse::unsetText()
{
    m_TextIsSet = false;
}
utility::string_t SuccessTextResponse::getAction() const
{
    return m_Action;
}


void SuccessTextResponse::setAction(const utility::string_t& value)
{
    m_Action = value;
    m_ActionIsSet = true;
}

bool SuccessTextResponse::actionIsSet() const
{
    return m_ActionIsSet;
}

void SuccessTextResponse::unsetAction()
{
    m_ActionIsSet = false;
}
