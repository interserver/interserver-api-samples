...
void CancelBackup_200_response::validate()
{
    // TODO: implement validation
}

web::json::value CancelBackup_200_response::toJson() const
{
...
bool CancelBackup_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CancelBackup_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CancelBackup_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool CancelBackup_200_response::successIsSet() const
{
    return m_SuccessIsSet;
}

void CancelBackup_200_response::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t CancelBackup_200_response::getText() const
{
    return m_Text;
}


void CancelBackup_200_response::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool CancelBackup_200_response::textIsSet() const
{
    return m_TextIsSet;
}

void CancelBackup_200_response::unsetText()
{
    m_TextIsSet = false;
}
