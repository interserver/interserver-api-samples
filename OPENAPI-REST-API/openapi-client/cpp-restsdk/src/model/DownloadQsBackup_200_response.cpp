...
void DownloadQsBackup_200_response::validate()
{
    // TODO: implement validation
}

web::json::value DownloadQsBackup_200_response::toJson() const
{
...
bool DownloadQsBackup_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DownloadQsBackup_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DownloadQsBackup_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t DownloadQsBackup_200_response::getText() const
{
    return m_Text;
}


void DownloadQsBackup_200_response::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool DownloadQsBackup_200_response::textIsSet() const
{
    return m_TextIsSet;
}

void DownloadQsBackup_200_response::unsetText()
{
    m_TextIsSet = false;
}
utility::string_t DownloadQsBackup_200_response::getUrl() const
{
    return m_Url;
}


void DownloadQsBackup_200_response::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool DownloadQsBackup_200_response::urlIsSet() const
{
    return m_UrlIsSet;
}

void DownloadQsBackup_200_response::unsetUrl()
{
    m_UrlIsSet = false;
}
