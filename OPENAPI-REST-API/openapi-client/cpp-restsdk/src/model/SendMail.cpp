...
utility::string_t SendMail::getTo() const
{
    return m_To;
}


void SendMail::setTo(const utility::string_t& value)
{
    m_To = value;
    m_ToIsSet = true;
}
...
utility::string_t SendMail::getFrom() const
{
    return m_From;
}


void SendMail::setFrom(const utility::string_t& value)
{
    m_From = value;
    m_FromIsSet = true;
}
