...
void CaptchaResponse::validate()
{
    // TODO: implement validation
}

web::json::value CaptchaResponse::toJson() const
{
...
bool CaptchaResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CaptchaResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CaptchaResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CaptchaResponse::getCaptcha() const
{
    return m_Captcha;
}


void CaptchaResponse::setCaptcha(const utility::string_t& value)
{
    m_Captcha = value;
    m_CaptchaIsSet = true;
}

bool CaptchaResponse::captchaIsSet() const
{
    return m_CaptchaIsSet;
}

void CaptchaResponse::unsetCaptcha()
{
    m_CaptchaIsSet = false;
}
