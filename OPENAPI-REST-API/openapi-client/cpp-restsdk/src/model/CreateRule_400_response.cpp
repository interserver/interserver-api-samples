...
void CreateRule_400_response::validate()
{
    // TODO: implement validation
}

web::json::value CreateRule_400_response::toJson() const
{
...
bool CreateRule_400_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateRule_400_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateRule_400_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool CreateRule_400_response::successIsSet() const
{
    return m_SuccessIsSet;
}

void CreateRule_400_response::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t CreateRule_400_response::getText() const
{
    return m_Text;
}


void CreateRule_400_response::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool CreateRule_400_response::textIsSet() const
{
    return m_TextIsSet;
}

void CreateRule_400_response::unsetText()
{
    m_TextIsSet = false;
}
std::vector<utility::string_t> CreateRule_400_response::getErrors() const
{
    return m_Errors;
}


void CreateRule_400_response::setErrors(const std::vector<utility::string_t>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool CreateRule_400_response::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void CreateRule_400_response::unsetErrors()
{
    m_ErrorsIsSet = false;
}
