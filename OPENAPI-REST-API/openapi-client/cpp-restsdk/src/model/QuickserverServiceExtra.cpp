...
void QuickserverServiceExtra::validate()
{
    // TODO: implement validation
}

web::json::value QuickserverServiceExtra::toJson() const
{
...
bool QuickserverServiceExtra::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QuickserverServiceExtra::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QuickserverServiceExtra::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QuickserverServiceExtra::getPlatform() const
{
    return m_Platform;
}


void QuickserverServiceExtra::setPlatform(const utility::string_t& value)
{
    m_Platform = value;
    m_PlatformIsSet = true;
}

bool QuickserverServiceExtra::platformIsSet() const
{
    return m_PlatformIsSet;
}

void QuickserverServiceExtra::unsetPlatform()
{
    m_PlatformIsSet = false;
}
