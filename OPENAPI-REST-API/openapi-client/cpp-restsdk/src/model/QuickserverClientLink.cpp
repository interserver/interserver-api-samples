...
void QuickserverClientLink::validate()
{
    // TODO: implement validation
}

web::json::value QuickserverClientLink::toJson() const
{
...
bool QuickserverClientLink::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QuickserverClientLink::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QuickserverClientLink::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QuickserverClientLink::getLabel() const
{
    return m_Label;
}


void QuickserverClientLink::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool QuickserverClientLink::labelIsSet() const
{
    return m_LabelIsSet;
}

void QuickserverClientLink::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t QuickserverClientLink::getLink() const
{
    return m_Link;
}


void QuickserverClientLink::setLink(const utility::string_t& value)
{
    m_Link = value;
    m_LinkIsSet = true;
}

bool QuickserverClientLink::linkIsSet() const
{
    return m_LinkIsSet;
}

void QuickserverClientLink::unsetLink()
{
    m_LinkIsSet = false;
}
utility::string_t QuickserverClientLink::getIcon() const
{
    return m_Icon;
}


void QuickserverClientLink::setIcon(const utility::string_t& value)
{
    m_Icon = value;
    m_IconIsSet = true;
}

bool QuickserverClientLink::iconIsSet() const
{
    return m_IconIsSet;
}

void QuickserverClientLink::unsetIcon()
{
    m_IconIsSet = false;
}
utility::string_t QuickserverClientLink::getIconText() const
{
    return m_Icon_text;
}


void QuickserverClientLink::setIconText(const utility::string_t& value)
{
    m_Icon_text = value;
    m_Icon_textIsSet = true;
}

bool QuickserverClientLink::iconTextIsSet() const
{
    return m_Icon_textIsSet;
}

void QuickserverClientLink::unsetIcon_text()
{
    m_Icon_textIsSet = false;
}
utility::string_t QuickserverClientLink::getHelpText() const
{
    return m_Help_text;
}


void QuickserverClientLink::setHelpText(const utility::string_t& value)
{
    m_Help_text = value;
    m_Help_textIsSet = true;
}

bool QuickserverClientLink::helpTextIsSet() const
{
    return m_Help_textIsSet;
}

void QuickserverClientLink::unsetHelp_text()
{
    m_Help_textIsSet = false;
}
utility::string_t QuickserverClientLink::getOtherAttr() const
{
    return m_Other_attr;
}


void QuickserverClientLink::setOtherAttr(const utility::string_t& value)
{
    m_Other_attr = value;
    m_Other_attrIsSet = true;
}

bool QuickserverClientLink::otherAttrIsSet() const
{
    return m_Other_attrIsSet;
}

void QuickserverClientLink::unsetOther_attr()
{
    m_Other_attrIsSet = false;
}
