...
void DomainClientLink::validate()
{
    // TODO: implement validation
}

web::json::value DomainClientLink::toJson() const
{
...
bool DomainClientLink::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DomainClientLink::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DomainClientLink::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t DomainClientLink::getLabel() const
{
    return m_Label;
}


void DomainClientLink::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool DomainClientLink::labelIsSet() const
{
    return m_LabelIsSet;
}

void DomainClientLink::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t DomainClientLink::getLink() const
{
    return m_Link;
}


void DomainClientLink::setLink(const utility::string_t& value)
{
    m_Link = value;
    m_LinkIsSet = true;
}

bool DomainClientLink::linkIsSet() const
{
    return m_LinkIsSet;
}

void DomainClientLink::unsetLink()
{
    m_LinkIsSet = false;
}
utility::string_t DomainClientLink::getIcon() const
{
    return m_Icon;
}


void DomainClientLink::setIcon(const utility::string_t& value)
{
    m_Icon = value;
    m_IconIsSet = true;
}

bool DomainClientLink::iconIsSet() const
{
    return m_IconIsSet;
}

void DomainClientLink::unsetIcon()
{
    m_IconIsSet = false;
}
utility::string_t DomainClientLink::getIconText() const
{
    return m_Icon_text;
}


void DomainClientLink::setIconText(const utility::string_t& value)
{
    m_Icon_text = value;
    m_Icon_textIsSet = true;
}

bool DomainClientLink::iconTextIsSet() const
{
    return m_Icon_textIsSet;
}

void DomainClientLink::unsetIcon_text()
{
    m_Icon_textIsSet = false;
}
utility::string_t DomainClientLink::getHelpText() const
{
    return m_Help_text;
}


void DomainClientLink::setHelpText(const utility::string_t& value)
{
    m_Help_text = value;
    m_Help_textIsSet = true;
}

bool DomainClientLink::helpTextIsSet() const
{
    return m_Help_textIsSet;
}

void DomainClientLink::unsetHelp_text()
{
    m_Help_textIsSet = false;
}
