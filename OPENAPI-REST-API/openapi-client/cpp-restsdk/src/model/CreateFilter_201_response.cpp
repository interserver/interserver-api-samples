...
void CreateFilter_201_response::validate()
{
    // TODO: implement validation
}

web::json::value CreateFilter_201_response::toJson() const
{
...
bool CreateFilter_201_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateFilter_201_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateFilter_201_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool CreateFilter_201_response::successIsSet() const
{
    return m_SuccessIsSet;
}

void CreateFilter_201_response::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t CreateFilter_201_response::getText() const
{
    return m_Text;
}


void CreateFilter_201_response::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool CreateFilter_201_response::textIsSet() const
{
    return m_TextIsSet;
}

void CreateFilter_201_response::unsetText()
{
    m_TextIsSet = false;
}
