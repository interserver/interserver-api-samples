...
void MailAlertUpdateRequest::validate()
{
    // TODO: implement validation
}

web::json::value MailAlertUpdateRequest::toJson() const
{
...
bool MailAlertUpdateRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MailAlertUpdateRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MailAlertUpdateRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool MailAlertUpdateRequest::alertIdIsSet() const
{
    return m_Alert_idIsSet;
}

void MailAlertUpdateRequest::unsetAlert_id()
{
    m_Alert_idIsSet = false;
}
utility::string_t MailAlertUpdateRequest::getType() const
{
    return m_Type;
}


void MailAlertUpdateRequest::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool MailAlertUpdateRequest::typeIsSet() const
{
    return m_TypeIsSet;
}

void MailAlertUpdateRequest::unsetType()
{
    m_TypeIsSet = false;
}
utility::string_t MailAlertUpdateRequest::getValue() const
{
    return m_Value;
}


void MailAlertUpdateRequest::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool MailAlertUpdateRequest::valueIsSet() const
{
    return m_ValueIsSet;
}

void MailAlertUpdateRequest::unsetValue()
{
    m_ValueIsSet = false;
}
utility::string_t MailAlertUpdateRequest::getTo() const
{
    return m_To;
}


void MailAlertUpdateRequest::setTo(const utility::string_t& value)
{
    m_To = value;
    m_ToIsSet = true;
}

bool MailAlertUpdateRequest::toIsSet() const
{
    return m_ToIsSet;
}

void MailAlertUpdateRequest::unsetTo()
{
    m_ToIsSet = false;
}
utility::string_t MailAlertUpdateRequest::getEnabled() const
{
    return m_Enabled;
}


void MailAlertUpdateRequest::setEnabled(const utility::string_t& value)
{
    m_Enabled = value;
    m_EnabledIsSet = true;
}

bool MailAlertUpdateRequest::enabledIsSet() const
{
    return m_EnabledIsSet;
}

void MailAlertUpdateRequest::unsetEnabled()
{
    m_EnabledIsSet = false;
}
