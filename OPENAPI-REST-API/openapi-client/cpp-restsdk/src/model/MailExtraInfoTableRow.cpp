...
#include "InterserverApiClient/model/MailExtraInfoTableRow.h"
...
void MailExtraInfoTableRow::validate()
{
    // TODO: implement validation
}

web::json::value MailExtraInfoTableRow::toJson() const
{
...
bool MailExtraInfoTableRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MailExtraInfoTableRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MailExtraInfoTableRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MailExtraInfoTableRow::getDesc() const
{
    return m_Desc;
}


void MailExtraInfoTableRow::setDesc(const utility::string_t& value)
{
    m_Desc = value;
    m_DescIsSet = true;
}

bool MailExtraInfoTableRow::descIsSet() const
{
    return m_DescIsSet;
}

void MailExtraInfoTableRow::unsetDesc()
{
    m_DescIsSet = false;
}
utility::string_t MailExtraInfoTableRow::getValue() const
{
    return m_Value;
}


void MailExtraInfoTableRow::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool MailExtraInfoTableRow::valueIsSet() const
{
    return m_ValueIsSet;
}

void MailExtraInfoTableRow::unsetValue()
{
    m_ValueIsSet = false;
}
