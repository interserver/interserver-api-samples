...
void ServersBuyNowError::validate()
{
    // TODO: implement validation
}

web::json::value ServersBuyNowError::toJson() const
{
...
bool ServersBuyNowError::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ServersBuyNowError::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ServersBuyNowError::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool ServersBuyNowError::successIsSet() const
{
    return m_SuccessIsSet;
}

void ServersBuyNowError::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t ServersBuyNowError::getText() const
{
    return m_Text;
}


void ServersBuyNowError::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool ServersBuyNowError::textIsSet() const
{
    return m_TextIsSet;
}

void ServersBuyNowError::unsetText()
{
    m_TextIsSet = false;
}
std::vector<utility::string_t> ServersBuyNowError::getErrors() const
{
    return m_Errors;
}


void ServersBuyNowError::setErrors(const std::vector<utility::string_t>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool ServersBuyNowError::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void ServersBuyNowError::unsetErrors()
{
    m_ErrorsIsSet = false;
}
