...
#include "InterserverApiClient/model/MailTutorialsTableRow.h"
...
void MailTutorialsTableRow::validate()
{
    // TODO: implement validation
}

web::json::value MailTutorialsTableRow::toJson() const
{
...
bool MailTutorialsTableRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void MailTutorialsTableRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool MailTutorialsTableRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t MailTutorialsTableRow::getDesc() const
{
    return m_Desc;
}


void MailTutorialsTableRow::setDesc(const utility::string_t& value)
{
    m_Desc = value;
    m_DescIsSet = true;
}

bool MailTutorialsTableRow::descIsSet() const
{
    return m_DescIsSet;
}

void MailTutorialsTableRow::unsetDesc()
{
    m_DescIsSet = false;
}
utility::string_t MailTutorialsTableRow::getValue() const
{
    return m_Value;
}


void MailTutorialsTableRow::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool MailTutorialsTableRow::valueIsSet() const
{
    return m_ValueIsSet;
}

void MailTutorialsTableRow::unsetValue()
{
    m_ValueIsSet = false;
}
