...
void ScrubIpsDeleteRule_500_response::validate()
{
    // TODO: implement validation
}

web::json::value ScrubIpsDeleteRule_500_response::toJson() const
{
...
bool ScrubIpsDeleteRule_500_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ScrubIpsDeleteRule_500_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ScrubIpsDeleteRule_500_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool ScrubIpsDeleteRule_500_response::successIsSet() const
{
    return m_SuccessIsSet;
}

void ScrubIpsDeleteRule_500_response::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t ScrubIpsDeleteRule_500_response::getText() const
{
    return m_Text;
}


void ScrubIpsDeleteRule_500_response::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool ScrubIpsDeleteRule_500_response::textIsSet() const
{
    return m_TextIsSet;
}

void ScrubIpsDeleteRule_500_response::unsetText()
{
    m_TextIsSet = false;
}
