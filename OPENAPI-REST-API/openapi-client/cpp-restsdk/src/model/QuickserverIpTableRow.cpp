...
#include "InterserverApiClient/model/QuickserverIpTableRow.h"
...
void QuickserverIpTableRow::validate()
{
    // TODO: implement validation
}

web::json::value QuickserverIpTableRow::toJson() const
{
...
bool QuickserverIpTableRow::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void QuickserverIpTableRow::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool QuickserverIpTableRow::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t QuickserverIpTableRow::getDesc() const
{
    return m_Desc;
}


void QuickserverIpTableRow::setDesc(const utility::string_t& value)
{
    m_Desc = value;
    m_DescIsSet = true;
}

bool QuickserverIpTableRow::descIsSet() const
{
    return m_DescIsSet;
}

void QuickserverIpTableRow::unsetDesc()
{
    m_DescIsSet = false;
}
utility::string_t QuickserverIpTableRow::getValue() const
{
    return m_Value;
}


void QuickserverIpTableRow::setValue(const utility::string_t& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}

bool QuickserverIpTableRow::valueIsSet() const
{
    return m_ValueIsSet;
}

void QuickserverIpTableRow::unsetValue()
{
    m_ValueIsSet = false;
}
