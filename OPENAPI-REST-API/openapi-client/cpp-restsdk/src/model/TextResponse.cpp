...
void TextResponse::validate()
{
    // TODO: implement validation
}

web::json::value TextResponse::toJson() const
{
...
bool TextResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TextResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TextResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t TextResponse::getText() const
{
    return m_Text;
}


void TextResponse::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool TextResponse::textIsSet() const
{
    return m_TextIsSet;
}

void TextResponse::unsetText()
{
    m_TextIsSet = false;
}
utility::string_t TextResponse::getMessage() const
{
    return m_Message;
}


void TextResponse::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool TextResponse::messageIsSet() const
{
    return m_MessageIsSet;
}

void TextResponse::unsetMessage()
{
    m_MessageIsSet = false;
}
