...
#include "InterserverApiClient/model/UrlRequest.h"
...
void UrlRequest::validate()
{
    // TODO: implement validation
}

web::json::value UrlRequest::toJson() const
{
...
bool UrlRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UrlRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UrlRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t UrlRequest::getUrl() const
{
    return m_Url;
}


void UrlRequest::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool UrlRequest::urlIsSet() const
{
    return m_UrlIsSet;
}

void UrlRequest::unsetUrl()
{
    m_UrlIsSet = false;
}
