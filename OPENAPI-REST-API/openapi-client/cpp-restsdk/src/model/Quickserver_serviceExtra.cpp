...
void Quickserver_serviceExtra::validate()
{
    // TODO: implement validation
}

web::json::value Quickserver_serviceExtra::toJson() const
{
...
bool Quickserver_serviceExtra::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Quickserver_serviceExtra::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Quickserver_serviceExtra::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t Quickserver_serviceExtra::getPlatform() const
{
    return m_Platform;
}


void Quickserver_serviceExtra::setPlatform(const utility::string_t& value)
{
    m_Platform = value;
    m_PlatformIsSet = true;
}

bool Quickserver_serviceExtra::platformIsSet() const
{
    return m_PlatformIsSet;
}

void Quickserver_serviceExtra::unsetPlatform()
{
    m_PlatformIsSet = false;
}
