...
void VpsClientLink::validate()
{
    // TODO: implement validation
}

web::json::value VpsClientLink::toJson() const
{
...
bool VpsClientLink::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void VpsClientLink::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VpsClientLink::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t VpsClientLink::getLabel() const
{
    return m_Label;
}


void VpsClientLink::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool VpsClientLink::labelIsSet() const
{
    return m_LabelIsSet;
}

void VpsClientLink::unsetLabel()
{
    m_LabelIsSet = false;
}
utility::string_t VpsClientLink::getLink() const
{
    return m_Link;
}


void VpsClientLink::setLink(const utility::string_t& value)
{
    m_Link = value;
    m_LinkIsSet = true;
}

bool VpsClientLink::linkIsSet() const
{
    return m_LinkIsSet;
}

void VpsClientLink::unsetLink()
{
    m_LinkIsSet = false;
}
utility::string_t VpsClientLink::getIcon() const
{
    return m_Icon;
}


void VpsClientLink::setIcon(const utility::string_t& value)
{
    m_Icon = value;
    m_IconIsSet = true;
}

bool VpsClientLink::iconIsSet() const
{
    return m_IconIsSet;
}

void VpsClientLink::unsetIcon()
{
    m_IconIsSet = false;
}
utility::string_t VpsClientLink::getIconText() const
{
    return m_Icon_text;
}


void VpsClientLink::setIconText(const utility::string_t& value)
{
    m_Icon_text = value;
    m_Icon_textIsSet = true;
}

bool VpsClientLink::iconTextIsSet() const
{
    return m_Icon_textIsSet;
}

void VpsClientLink::unsetIcon_text()
{
    m_Icon_textIsSet = false;
}
utility::string_t VpsClientLink::getHelpText() const
{
    return m_Help_text;
}


void VpsClientLink::setHelpText(const utility::string_t& value)
{
    m_Help_text = value;
    m_Help_textIsSet = true;
}

bool VpsClientLink::helpTextIsSet() const
{
    return m_Help_textIsSet;
}

void VpsClientLink::unsetHelp_text()
{
    m_Help_textIsSet = false;
}
