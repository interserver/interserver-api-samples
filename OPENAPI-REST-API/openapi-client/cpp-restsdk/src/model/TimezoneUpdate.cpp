...
#include "InterserverApiClient/model/TimezoneUpdate.h"
...
void TimezoneUpdate::validate()
{
    // TODO: implement validation
}

web::json::value TimezoneUpdate::toJson() const
{
...
bool TimezoneUpdate::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void TimezoneUpdate::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool TimezoneUpdate::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t TimezoneUpdate::getTimezone() const
{
    return m_Timezone;
}


void TimezoneUpdate::setTimezone(const utility::string_t& value)
{
    m_Timezone = value;
    m_TimezoneIsSet = true;
}

bool TimezoneUpdate::timezoneIsSet() const
{
    return m_TimezoneIsSet;
}

void TimezoneUpdate::unsetTimezone()
{
    m_TimezoneIsSet = false;
}
