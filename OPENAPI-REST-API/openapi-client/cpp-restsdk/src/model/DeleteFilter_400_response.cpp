...
void DeleteFilter_400_response::validate()
{
    // TODO: implement validation
}

web::json::value DeleteFilter_400_response::toJson() const
{
...
bool DeleteFilter_400_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteFilter_400_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteFilter_400_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool DeleteFilter_400_response::successIsSet() const
{
    return m_SuccessIsSet;
}

void DeleteFilter_400_response::unsetSuccess()
{
    m_SuccessIsSet = false;
}
utility::string_t DeleteFilter_400_response::getText() const
{
    return m_Text;
}


void DeleteFilter_400_response::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool DeleteFilter_400_response::textIsSet() const
{
    return m_TextIsSet;
}

void DeleteFilter_400_response::unsetText()
{
    m_TextIsSet = false;
}
