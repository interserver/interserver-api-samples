...
#ifndef NET_INTERSERVER_API_FloatingIPsApi_H_
#define NET_INTERSERVER_API_FloatingIPsApi_H_
...
#include "InterserverApiClient/model/Floating_ipsCancel_200_response.h"
...
public:
    ...
    explicit FloatingIPsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    /// <param name="floatingIpOrderRequest"></param>
    pplx::task<std::shared_ptr<ServiceOrderPostResponse>> addFloatingIp(
    ...
    pplx::task<std::shared_ptr<Floating_ipsCancel_200_response>> floatingIpsCancel(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;.</param>
    pplx::task<std::shared_ptr<Object>> getFloatingIpInfo(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;.</param>
    pplx::task<std::shared_ptr<ChargeInvoiceRows>> getFloatingIpInvoices(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<Object>>> getFloatingIpsList(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getFloatingIpsWelcomeEmail(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Object>> getNewFloatingIp(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> postFloatingIpsChangeIp(
        int32_t id,
        utility::string_t ip
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateFloatingIpInfo(
        utility::string_t id
    ) const;
...
#endif /* NET_INTERSERVER_API_FloatingIPsApi_H_ */
