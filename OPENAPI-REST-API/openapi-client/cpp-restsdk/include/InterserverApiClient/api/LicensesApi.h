...
#ifndef NET_INTERSERVER_API_LicensesApi_H_
#define NET_INTERSERVER_API_LicensesApi_H_
...
#include "InterserverApiClient/model/IpObject.h"
...
public:
    ...
    pplx::task<std::shared_ptr<ServiceOrderPostResponse>> addLicense(
    ...
    pplx::task<std::shared_ptr<License>> getLicenseInfo(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;.</param>
    pplx::task<std::shared_ptr<ChargeInvoiceRows>> getLicenseInvoices(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<LicenseRow>>> getLicenseList(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getLicensesWelcomeEmail(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<LicensesOrder>> getNewLicense(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;.</param>
    pplx::task<std::shared_ptr<LicensesCancel_200_response>> licensesCancel(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> postLicenseChangeIp(
        int32_t id,
        std::shared_ptr<IpObject> ipObject
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateLicenseInfo(
        utility::string_t id
    ) const;
...
#endif /* NET_INTERSERVER_API_LicensesApi_H_ */
