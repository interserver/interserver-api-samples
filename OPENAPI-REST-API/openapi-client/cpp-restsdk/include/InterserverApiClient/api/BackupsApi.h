...
#ifndef NET_INTERSERVER_API_BackupsApi_H_
#define NET_INTERSERVER_API_BackupsApi_H_
...
#include "InterserverApiClient/model/BackupLoginResponse.h"
...
#include "InterserverApiClient/model/CancelBackup_200_response.h"
...
public:
    ...
    explicit BackupsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// <param name="coupon"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<BackupOrderPostResponse>> addBackup(
        boost::optional<bool> validateOnly,
        boost::optional<int32_t> serviceType,
        boost::optional<utility::string_t> coupon
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<CancelBackup_200_response>> cancelBackup(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
    pplx::task<std::shared_ptr<Backup>> getBackupInfo(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
    pplx::task<std::shared_ptr<ChargeInvoiceRows>> getBackupInvoices(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
    pplx::task<std::shared_ptr<BackupLoginResponse>> getBackupLogin(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<BackupRow>>> getBackupsList(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getBackupsWelcomeEmail(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<BackupsOrder>> getNewBackup(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateBackupInfo(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// <param name="serviceType"> (optional, default to 0)</param>
    /// <param name="coupon"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<BackupOrderPutResponse>> validateBackupOrder(
        boost::optional<bool> validateOnly,
        boost::optional<int32_t> serviceType,
        boost::optional<utility::string_t> coupon
    ) const;
...
#endif /* NET_INTERSERVER_API_BackupsApi_H_ */
