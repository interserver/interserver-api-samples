...
#ifndef NET_INTERSERVER_API_TicketsApi_H_
#define NET_INTERSERVER_API_TicketsApi_H_



#include "InterserverApiClient/ApiClient.h"

#include "InterserverApiClient/model/CloseTicketResponseSchema.h"
...
#include "InterserverApiClient/model/UpdateTicketResponseSchema.h"
...
public:
    ...
    explicit TicketsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<TicketNewResponse>> addNewTicket(
    ...
    pplx::task<std::shared_ptr<CloseTicketResponseSchema>> closeTicket(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ViewTicketResponse>> deleteTicketInfo(
        double id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">Ticket ID number.</param>
    pplx::task<std::shared_ptr<ViewTicketResponse>> getTicketInfo(
        double id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="page">Page number for paginated results. (optional, default to 0)</param>
    /// <param name="period">How far back to show tickets from. Value is in days. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="view">The status of tickets to view. Possible values are Open, Closed, On Hold, and In Progress.  If not specified it will show all types. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Tickets>> getTicketsList(
    ...
    /// </remarks>
    /// <param name="id">Ticket ID number.</param>
    pplx::task<std::shared_ptr<ViewTicketResponse>> postTicketInfo(
        double id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Tickets>> postTicketsList(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">Ticket ID number.</param>
    pplx::task<std::shared_ptr<ViewTicketResponse>> putTicketInfo(
        double id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ReplyTicketResponseSchema>> replyTicket(
        double id,
        boost::optional<std::shared_ptr<ReplyTicketRequest>> replyTicketRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<UpdateTicketResponseSchema>> updateTicketInfo(
        double id,
        boost::optional<std::shared_ptr<UpdateTicket>> updateTicket
    ) const;
...
#endif /* NET_INTERSERVER_API_TicketsApi_H_ */
