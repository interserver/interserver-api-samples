...
#ifndef NET_INTERSERVER_API_BillingApi_H_
#define NET_INTERSERVER_API_BillingApi_H_
...
#include "InterserverApiClient/model/BillingInvoiceDetail.h"
...
#include "InterserverApiClient/model/GetAffiliateSignups_200_response.h"
...
public:
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> addBillingCreditCard(
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> addBillingPrepay(
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> deleteBillingCreditCard(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> deleteBillingInvoice(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> deleteBillingPrepay(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<AffiliateBannerRow>>> getAffiliateBanners(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="st">Filter by status. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="ex">Export format: csv, xls, xlsx, or pdf. Defaults to csv. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="year">Year to filter the report. Defaults to the current year. (optional, default to 0)</param>
    pplx::task<void> getAffiliateDownload(
        boost::optional<utility::string_t> st,
        boost::optional<utility::string_t> ex,
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<TextResponse>> getAffiliateRichReport(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<StatusMonthlyBreakdown>> getAffiliateSalesGraph(
    ...
    /// </remarks>
    /// <param name="st">Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<GetAffiliateSignups_200_response>> getAffiliateSignups(
        boost::optional<utility::string_t> st
    ) const;
    /// <summary>
    ...
    pplx::task<MonthlyCounts<utility::string_t, int32_t>> getAffiliateTrafficGraph(
        boost::optional<int32_t> days
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<AffiliateTrafficRow>>> getAffiliateWebTraffic(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Object>> getBillingCart(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> getBillingCreditCardVerify(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<BillingInvoiceDetail<utility::string_t, utility::string_t>> getBillingInvoice(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<BillingInvoiceList>> getBillingInvoices(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Object>> getBillingPrePays(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<InitiatePayment_200_response>> initiatePayment(
        utility::string_t method,
        utility::string_t invoices
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;.</param>
    /// <param name="patchBillingCreditCardVerifyRequest"></param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> patchBillingCreditCardVerify(
        int32_t id,
        std::shared_ptr<PatchBillingCreditCardVerify_request> patchBillingCreditCardVerifyRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> postBillingCreditCardVerify(
        int32_t id,
        std::shared_ptr<BillingVerifyCcRequest> billingVerifyCcRequest
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="affiliateDockTitle"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="affiliateDockDescription"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="referrerCoupon"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<TextResponse>> updateAffiliateDockSetup(
        boost::optional<utility::string_t> affiliateDockTitle,
        boost::optional<utility::string_t> affiliateDockDescription,
        boost::optional<utility::string_t> referrerCoupon
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="affiliatePaypal"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="affiliatePaymentMethod"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<TextResponse>> updateAffiliatePaymentSetup(
        boost::optional<utility::string_t> affiliatePaypal,
        boost::optional<utility::string_t> affiliatePaymentMethod
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateBillingCreditCard(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateBillingPaymentMethod(
...
#endif /* NET_INTERSERVER_API_BillingApi_H_ */
