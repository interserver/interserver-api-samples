...
#ifndef NET_INTERSERVER_API_ServersApi_H_
#define NET_INTERSERVER_API_ServersApi_H_
...
#include "InterserverApiClient/model/ServersBuyNowError.h"
#include "InterserverApiClient/model/ServersBuyNowResponse.h"
#include "InterserverApiClient/model/ServersCancel_200_response.h"
...
public:
    ...
    explicit ServersApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    /// <param name="serverOrderPostRequest"></param>
    pplx::task<std::shared_ptr<AddServer_200_response>> addServer(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<BuyItNowServerOrder_200_response>> buyItNowServerOrder(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ServerOrder>> getNewServer(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Server>> getServerInfo(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">Server ID number</param>
    pplx::task<std::shared_ptr<ChargeInvoiceRows>> getServerInvoices(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<ServerRow>>> getServerList(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">Server ID number</param>
    pplx::task<std::shared_ptr<ReverseDnsEntries>> getServerReverseDns(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">Server ID number</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getServersWelcomeEmail(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ServersBuyNowResponse>> placeBuyNowServer(
        boost::optional<std::shared_ptr<PlaceBuyNowServer_request>> placeBuyNowServerRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TextResponse>> postServerReverseDns(
        int32_t id,
    ...
    pplx::task<std::shared_ptr<ServerBulkIpmiPowerResponse>> serverBulkIpmiPowerGet(
    ...
    /// </remarks>
    /// <param name="id">Server ID number</param>
    pplx::task<std::shared_ptr<ServerIpmiLiveInfo>> serverIpmiLiveGet(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ServerIpmiLiveInfo>> serverIpmiLivePost(
        int32_t id,
        utility::string_t ip,
        boost::optional<int32_t> asset
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">Server ID number</param>
    pplx::task<std::shared_ptr<TextResponse>> serverIpmiPowerGet(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TextResponse>> serverIpmiPowerPost(
        int32_t id,
    ...
    /// </remarks>
    /// <param name="id">Server ID number</param>
    pplx::task<std::shared_ptr<ServersCancel_200_response>> serversCancel(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">Server ID number.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateServerInfo(
        utility::string_t id
    ) const;
...
#endif /* NET_INTERSERVER_API_ServersApi_H_ */
