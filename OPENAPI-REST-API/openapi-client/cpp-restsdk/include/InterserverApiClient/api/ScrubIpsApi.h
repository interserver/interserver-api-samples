...
#ifndef NET_INTERSERVER_API_ScrubIpsApi_H_
#define NET_INTERSERVER_API_ScrubIpsApi_H_



#include "InterserverApiClient/ApiClient.h"

#include "InterserverApiClient/model/CancelScrubIp_200_response.h"
#include "InterserverApiClient/model/ChargeInvoiceRows.h"
#include "InterserverApiClient/model/CreateFilter.h"
#include "InterserverApiClient/model/CreateFilter_201_response.h"
#include "InterserverApiClient/model/CreateFilter_400_response.h"
#include "InterserverApiClient/model/CreateFilter_500_response.h"
#include "InterserverApiClient/model/CreateFirewallRule.h"
#include "InterserverApiClient/model/CreateGeoFirewallRule.h"
#include "InterserverApiClient/model/CreateGeoRule_400_response.h"
#include "InterserverApiClient/model/CreateRule_201_response.h"
#include "InterserverApiClient/model/CreateRule_400_response.h"
#include "InterserverApiClient/model/CreateRule_500_response.h"
#include "InterserverApiClient/model/DeleteFilter_200_response.h"
#include "InterserverApiClient/model/DeleteFilter_400_response.h"
#include "InterserverApiClient/model/DeleteFilter_500_response.h"
#include "InterserverApiClient/model/Delete_Firewall_Rule.h"
#include "InterserverApiClient/model/Delete_Geo_Firewall_Rule.h"
#include "InterserverApiClient/model/DisableScrub_200_response.h"
#include "InterserverApiClient/model/DisableScrub_400_response.h"
#include "InterserverApiClient/model/DisableScrub_500_response.h"
#include "InterserverApiClient/model/EnableScrub_200_response.h"
#include "InterserverApiClient/model/EnableScrub_500_response.h"
...
#include "InterserverApiClient/model/PlaceScrubOrder_201_response.h"
#include "InterserverApiClient/model/PutScrubIps_200_response.h"
#include "InterserverApiClient/model/ScrubIpFilterTypes.h"
#include "InterserverApiClient/model/ScrubIpPlaceOrder.h"
#include "InterserverApiClient/model/ScrubIpsDeleteRule_200_response.h"
#include "InterserverApiClient/model/ScrubIpsDeleteRule_400_response.h"
#include "InterserverApiClient/model/ScrubIpsDeleteRule_500_response.h"
...
public:
    ...
    explicit ScrubIpsApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    pplx::task<std::shared_ptr<CancelScrubIp_200_response>> cancelScrubIp(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<CreateFilter_201_response>> createFilter(
        int32_t id,
        std::shared_ptr<CreateFilter> createFilter
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<CreateRule_201_response>> createGeoRule(
        int32_t id,
        std::shared_ptr<CreateGeoFirewallRule> createGeoFirewallRule
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<CreateRule_201_response>> createRule(
        int32_t id,
        std::shared_ptr<CreateFirewallRule> createFirewallRule
    ) const;
    /// <summary>
    ...
    /// <param name="id">ScrubIp ID number</param>
    /// <param name="createFilter"></param>
    pplx::task<std::shared_ptr<DeleteFilter_200_response>> deleteFilter(
        int32_t id,
        std::shared_ptr<CreateFilter> createFilter
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ScrubIp ID number</param>
    pplx::task<std::shared_ptr<DisableScrub_200_response>> disableScrub(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ScrubIp ID number</param>
    pplx::task<std::shared_ptr<EnableScrub_200_response>> enableScrub(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<GetOrderDetail_200_response>> getOrderDetail(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ScrubIp ID number</param>
    pplx::task<std::shared_ptr<GetScrubIpDetails_200_response>> getScrubIpDetails(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ScrubIpFilterTypes>> getScrubIpFilterTypes(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">ScrubIp ID number</param>
    pplx::task<std::shared_ptr<ChargeInvoiceRows>> getScrubIpInvoices(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::vector<std::shared_ptr<ScrubIpsLogRowSchema>>> getScrubIpLogs(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<ScrubIpsRowSchema>>> getScrubIpsList(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PlaceScrubOrder_201_response>> placeScrubOrder(
    ...
    /// </remarks>
    /// <param name="scrubIpPlaceOrder"></param>
    pplx::task<std::shared_ptr<PutScrubIps_200_response>> putScrubIps(
        std::shared_ptr<ScrubIpPlaceOrder> scrubIpPlaceOrder
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ScrubIpsDeleteRule_200_response>> scrubIpsDeleteGeoRule(
        int32_t id,
        std::shared_ptr<Delete_Geo_Firewall_Rule> deleteGeoFirewallRule
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<ScrubIpsDeleteRule_200_response>> scrubIpsDeleteRule(
        int32_t id,
        std::shared_ptr<Delete_Firewall_Rule> deleteFirewallRule
    ) const;
...
#endif /* NET_INTERSERVER_API_ScrubIpsApi_H_ */
