...
#ifndef NET_INTERSERVER_API_WebhostingApi_H_
#define NET_INTERSERVER_API_WebhostingApi_H_
...
#include "InterserverApiClient/model/GetWebsiteBuyIp_200_response.h"
#include "InterserverApiClient/model/PostWebsiteBuyIp_200_response.h"
#include "InterserverApiClient/model/PostWebsiteBuyIp_request.h"
...
#include "InterserverApiClient/model/PostWebsiteMigration_request_1.h"
...
#include "InterserverApiClient/model/WebhostingCancel_200_response.h"
#include "InterserverApiClient/model/Website.h"
#include "InterserverApiClient/model/WebsiteBackups.h"
...
public:
    ...
    explicit WebhostingApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    /// <param name="websiteOrderPostRequest"></param>
    pplx::task<std::shared_ptr<ServiceOrderPostResponse>> addWebsite(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<WebsitesOrder>> getNewWebsite(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GetWebsiteBuyIp_200_response>> getWebsiteBuyIp(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;.</param>
    pplx::task<std::shared_ptr<Website>> getWebsiteInfo(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;.</param>
    pplx::task<std::shared_ptr<ChargeInvoiceRows>> getWebsiteInvoices(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<WebsiteRow>>> getWebsiteList(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;.</param>
    pplx::task<WebsiteBackups<std::shared_ptr<WebsiteBackups_inner>>> getWebsitesBackups(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;.</param>
    pplx::task<std::shared_ptr<WebsiteLoginResponse>> getWebsitesLogin(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getWebsitesWelcomeEmail(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;.</param>
    pplx::task<std::shared_ptr<ReverseDnsEntries>> gettWebsiteReverseDns(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PostWebsiteBuyIp_200_response>> postWebsiteBuyIp(
        int32_t id,
        std::shared_ptr<PostWebsiteBuyIp_request> postWebsiteBuyIpRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PostWebsiteMigration_200_response>> postWebsiteMigration(
        int32_t id,
        std::shared_ptr<PostWebsiteMigration_request> postWebsiteMigrationRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TextResponse>> postWebsitesReverseDns(
        int32_t id,
    ...
    /// </remarks>
    /// <param name="websiteOrderPutRequest"></param>
    pplx::task<void> putWebsites(
    ...
    /// </remarks>
    /// <param name="id">The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateWebsiteInfo(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;.</param>
    pplx::task<std::shared_ptr<WebhostingCancel_200_response>> webhostingCancel(
        utility::string_t id
    ) const;
...
#endif /* NET_INTERSERVER_API_WebhostingApi_H_ */
