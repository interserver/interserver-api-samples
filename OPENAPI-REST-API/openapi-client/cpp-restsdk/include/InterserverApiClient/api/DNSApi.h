...
#ifndef NET_INTERSERVER_API_DNSApi_H_
#define NET_INTERSERVER_API_DNSApi_H_
...
public:
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> addDnsDomain(
    ...
    /// <param name="ttl">Time-to-live (optional, default to 0)</param>
    /// <param name="prio">Priority (optional, default to 0)</param>
    pplx::task<void> addDnsRecord(
        utility::string_t id,
        utility::string_t name,
        std::shared_ptr<DnsRecordType> type,
        utility::string_t content,
        boost::optional<int32_t> ttl,
        boost::optional<int32_t> prio
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> deleteDnsDomain(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> deleteDnsRecord(
        int32_t domainId,
        int32_t recordId
    ) const;
    /// <summary>
    ...
    pplx::task<std::vector<std::shared_ptr<DnsRecord>>> getDnsDomain(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<DnsListItem>>> getDnsList(
    ) const;
    /// <summary>
    ...
    /// <param name="type"> (optional, default to new DnsRecordType())</param>
    /// <param name="content"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="ttl"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="prio"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="disabled"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="ordername"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="auth"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateDnsRecord(
        int32_t domainId,
        int32_t recordId,
        boost::optional<utility::string_t> name,
        boost::optional<std::shared_ptr<DnsRecordType>> type,
        boost::optional<utility::string_t> content,
        boost::optional<utility::string_t> ttl,
        boost::optional<utility::string_t> prio,
        boost::optional<utility::string_t> disabled,
        boost::optional<utility::string_t> ordername,
        boost::optional<utility::string_t> auth
    ) const;
...
#endif /* NET_INTERSERVER_API_DNSApi_H_ */
