...
#ifndef NET_INTERSERVER_API_DomainsApi_H_
#define NET_INTERSERVER_API_DomainsApi_H_



#include "InterserverApiClient/ApiClient.h"

#include "InterserverApiClient/model/CancelDomain_200_response.h"
...
#include "InterserverApiClient/model/DomainDnssecRecords.h"
#include "InterserverApiClient/model/DomainDnssecRequest.h"
#include "InterserverApiClient/model/DomainLookupResponse.h"
#include "InterserverApiClient/model/DomainNameserverGetResponse.h"
#include "InterserverApiClient/model/DomainNameserverPostRequest.h"
...
public:
    ...
    /// </remarks>
    /// <param name="domainOrderRequest"></param>
    pplx::task<std::shared_ptr<ServiceOrderPostResponse>> addDomain(
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> addDomainDnssec(
        int32_t id,
        std::shared_ptr<DomainDnssecRequest> domainDnssecRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TextResponse>> addDomainNameserver(
        int32_t id,
        std::shared_ptr<DomainNameserverPostRequest> domainNameserverPostRequest
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<CancelDomain_200_response>> cancelDomain(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> deleteDomainDnssec(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TextResponse>> deleteDomainNameserver(
        int32_t id,
        int32_t index
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<DomainContactDetails>> getDomainContact(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<DomainDnssecRecords<std::shared_ptr<DomainDnssecRecords_inner>>> getDomainDnssec(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<Domain>> getDomainInfo(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<ChargeInvoiceRows>> getDomainInvoices(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<DomainLookupResponse>> getDomainLookup(
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<DomainNameserverGetResponse<std::shared_ptr<DomainNameserverGetResponse_inner>>> getDomainNameservers(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getDomainRenewal(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<DomainSearchResponse>> getDomainSearch(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getDomainTransfer(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getDomainWhoisPrivacy(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<DomainRow>>> getDomainsList(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getDomainsWelcomeEmail(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<DomainOrder>> getNewDomain(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> postDomainRenewal(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="name">The base domain name to search (for example &#x60;example&#x60; or &#x60;example.com&#x60;).</param>
    pplx::task<void> postDomainSearch(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> postDomainTransfer(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateDomainContact(
        int32_t id,
        std::shared_ptr<DomainContactDetails> domainContactDetails
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateDomainInfo(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TextResponse>> updateDomainNameservers(
        int32_t id,
        std::shared_ptr<DomainNameserverPutRequest> domainNameserverPutRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateDomainWhoisPrivacy(
        int32_t id,
        std::shared_ptr<DomainWhoisPrivacyRequest> domainWhoisPrivacyRequest
    ) const;
...
#endif /* NET_INTERSERVER_API_DomainsApi_H_ */
