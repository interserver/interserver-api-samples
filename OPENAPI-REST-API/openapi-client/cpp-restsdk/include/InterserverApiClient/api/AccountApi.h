...
#ifndef NET_INTERSERVER_API_AccountApi_H_
#define NET_INTERSERVER_API_AccountApi_H_
...
#include "InterserverApiClient/model/SearchAutocompleteResponse.h"
...
public:
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> deleteAccountOauthName(
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<SuccessTextResponse>> deleteAccountTfa(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GenericResponse>> deleteIpLimit(
        boost::optional<std::shared_ptr<IpLimitRange>> ipLimitRange
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<AccountInfo>> getAccountInfo(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<GetAccountTfaSetup_200_response>> getAccountTfaSetup(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<Home>> getHome(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<SearchAutocompleteResponse<utility::string_t, std::shared_ptr<Object>>> getSearch(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<SuccessTextResponse>> logout(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="name"></param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> logoutAccountOauth(
        utility::string_t name
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateAccountApiKey(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateAccountFeatures(
        boost::optional<int32_t> disableReset,
        boost::optional<int32_t> disableReinstall
    ) const;
    /// <summary>
    ...
    /// <param name="company">Your company name. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="address2">Additional address information. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="locale">Your preferred locale. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="emailInvoices">Your email for invoice notifications. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="emailAbuse">Your email for abuse notifications. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    ...
    /// <param name="gstin">Your GST identification number (if applicable). (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateAccountInfo(
        utility::string_t name,
        utility::string_t address,
        utility::string_t city,
        utility::string_t state,
        utility::string_t zip,
        utility::string_t country,
        utility::string_t phone,
        boost::optional<utility::string_t> company,
        boost::optional<utility::string_t> address2,
        boost::optional<utility::string_t> locale,
        boost::optional<utility::string_t> emailInvoices,
        boost::optional<utility::string_t> emailAbuse,
        boost::optional<bool> disableReset,
        boost::optional<bool> disableReinstall,
        boost::optional<bool> disableServerNotifications,
        boost::optional<bool> disableEmailNotifications,
        boost::optional<utility::string_t> gstin
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateAccountIpLimits(
    ...
    pplx::task<std::shared_ptr<TextResponse>> updateAccountPassword(
    ...
    /// </remarks>
    /// <param name="sshKey"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateAccountSshKey(
        boost::optional<utility::string_t> sshKey
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateAccountTfa(
        utility::string_t r_2fa_google_code
    ) const;
...
#endif /* NET_INTERSERVER_API_AccountApi_H_ */
