...
#ifndef NET_INTERSERVER_API_PublicApi_H_
#define NET_INTERSERVER_API_PublicApi_H_



#include "InterserverApiClient/ApiClient.h"

#include "InterserverApiClient/model/BuyItNowList.h"
#include "InterserverApiClient/model/CaptchaResponse.h"
#include "InterserverApiClient/model/GetAccountInfo_401_response.h"
#include "InterserverApiClient/model/GetAccountLocales_200_response_value.h"
...
#include "InterserverApiClient/model/PatchOauthTwoFactor_200_response.h"
...
public:
    ...
    /// </remarks>
    pplx::task<std::vector<utility::string_t>> getAccountCurrencies(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::map<utility::string_t, std::shared_ptr<GetAccountLocales_200_response_value>>> getAccountLocales(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<CaptchaResponse>> getCaptcha(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="fetchBy">Get countries by iso2 or iso3 or numcode (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<Object>> getCountries(
        boost::optional<utility::string_t> fetchBy
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<ServicesInfo>> getInfo(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<LoginInfo>> getLoginInfo(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<BuyItNowList<std::shared_ptr<BuyItNowRow>>> getMPServers(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GetOauthRedirect_200_response>> getOauthRedirect(
    ...
    /// </remarks>
    pplx::task<std::vector<utility::string_t>> getTimezones(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PatchOauthTwoFactor_200_response>> patchOauthTwoFactor(
    ...
    /// </remarks>
    pplx::task<utility::string_t> pingServer(
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<PostOauthCallback_200_response>> postOauthCallback(
        utility::string_t provider,
        boost::optional<std::shared_ptr<PostOauthCallback_request>> postOauthCallbackRequest
    ) const;
    /// <summary>
    ...
    /// <param name="remember"> (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="gRecaptchaResponse"> (optional, default to new LoginSubmissionExample_g_recaptcha_response())</param>
    /// <param name="tfa">Two Factor Authentication Response. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<LoginSuccessResponse>> submitLogin(
        utility::string_t login,
        utility::string_t passwd,
        boost::optional<utility::string_t> remember,
        boost::optional<std::shared_ptr<LoginSubmissionExample_g_recaptcha_response>> gRecaptchaResponse,
    ...
    pplx::task<void> submitSignup(
        boost::optional<std::shared_ptr<LoginSubmissionExample>> loginSubmissionExample
    ) const;
...
#endif /* NET_INTERSERVER_API_PublicApi_H_ */
