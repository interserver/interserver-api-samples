...
#ifndef NET_INTERSERVER_API_MailApi_H_
#define NET_INTERSERVER_API_MailApi_H_
...
#include "InterserverApiClient/model/DeleteMailAlert_request.h"
#include "InterserverApiClient/model/DenyRuleNew.h"
#include "InterserverApiClient/model/DenyRuleRecord.h"
#include "InterserverApiClient/model/GenericResponse.h"
#include "InterserverApiClient/model/GetAccountInfo_401_response.h"
#include "InterserverApiClient/model/MailAlertRequest.h"
#include "InterserverApiClient/model/MailAlertUpdateRequest.h"
#include "InterserverApiClient/model/MailAlertsResponse.h"
#include "InterserverApiClient/model/MailBlocks.h"
#include "InterserverApiClient/model/MailCancel_200_response.h"
#include "InterserverApiClient/model/MailDelistRequest.h"
...
#include "InterserverApiClient/model/MailOrderRequest.h"
...
#include "InterserverApiClient/model/SendMail.h"
...
public:
    ...
    explicit MailApi( std::shared_ptr<const ApiClient> apiClient );
    ...
    /// </remarks>
    /// <param name="mailOrderRequest"></param>
    pplx::task<std::shared_ptr<ServiceOrderPostResponse>> addMail(
    ...
    pplx::task<std::shared_ptr<GenericResponse>> addRule(
        int32_t id,
        std::shared_ptr<DenyRuleNew> denyRuleNew
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> createMailAlert(
        int32_t id,
        std::shared_ptr<MailAlertRequest> mailAlertRequest
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    /// <param name="deleteMailAlertRequest"></param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> deleteMailAlert(
        int32_t id,
        std::shared_ptr<DeleteMailAlert_request> deleteMailAlertRequest
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GenericResponse>> deleteRule(
        int32_t id,
        utility::string_t rule
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    /// <param name="email">an email address (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<GenericResponse>> delistBlock(
        int32_t id,
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<MailAlertsResponse<std::shared_ptr<MailAlertsResponse_inner>>> getMailAlerts(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::shared_ptr<MailBlocks>> getMailBlocks(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::shared_ptr<MailDelistResponse>> getMailDelist(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::shared_ptr<MailDeliverabilityResponse>> getMailDeliverability(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::shared_ptr<MailSchema>> getMailInfo(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::shared_ptr<ChargeInvoiceRows>> getMailInvoices(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::vector<std::shared_ptr<MailRow>>> getMailList(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> getMailWelcomeEmail(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    pplx::task<std::shared_ptr<MailOrder>> getNewMail(
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::vector<std::shared_ptr<DenyRuleRecord>>> getRules(
        int32_t id
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    /// <param name="time">The timeframe for the statistics. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<MailStatsType>> getStats(
        int32_t id,
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::shared_ptr<MailCancel_200_response>> mailCancel(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> postMailDelist(
        int32_t id,
        std::shared_ptr<MailDelistRequest> mailDelistRequest
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> resetMailPassword(
        int32_t id
    ) const;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<GenericResponse>> sendAdvMail(
        int32_t id,
    ...
    pplx::task<std::shared_ptr<GenericResponse>> sendMail(
        int32_t id,
    ...
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateMailAlert(
        int32_t id,
        std::shared_ptr<MailAlertUpdateRequest> mailAlertUpdateRequest
    ) const;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="id">The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;.</param>
    pplx::task<std::shared_ptr<SuccessTextResponse>> updateMailInfo(
        utility::string_t id
    ) const;
    /// <summary>
    ...
    /// <param name="denyRuleNew"></param>
    pplx::task<std::shared_ptr<GenericResponse>> updateRule(
        int32_t id,
        utility::string_t rule,
        std::shared_ptr<DenyRuleNew> denyRuleNew
    ) const;
    ...
    /// <param name="origin">Filter by the originating IP address from which the message was submitted to the relay.  Must be a valid IPv4 or IPv6 address. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="mx">Filter by the MX hostname the relay attempted delivery to.  For example &#x60;mx.google.com&#x60; would return messages destined for Gmail recipients. Maps to &#x60;mxHostname&#x60; in the &#x60;MailLogEntry&#x60; response. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="from">Filter by SMTP envelope &#x60;MAIL FROM&#x60; address (exact match).  This is the address the relay used for bounce handling and may differ from the &#x60;From:&#x60; message header.  For header-level filtering use &#x60;headerfrom&#x60;. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="to">Filter by SMTP envelope &#x60;RCPT TO&#x60; address (exact match).  This is the delivery address used by the relay and may differ from the &#x60;To:&#x60; header when BCC recipients are involved. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="subject">Filter by email &#x60;Subject&#x60; header (exact match).  MIME-encoded subjects are decoded automatically in the response. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="mailid">Filter by the relay-assigned mail ID string (exact match).  This corresponds to the &#x60;id&#x60; field in &#x60;MailLogEntry&#x60; and to the &#x60;text&#x60; value returned by the sending endpoints on success.  Format is an 18-19 character hexadecimal string such as &#x60;185997065c60008840&#x60;. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="messageId">Filter by the &#x60;Message-ID&#x60; email header using a substring (case-insensitive) match. The &#x60;Message-ID&#x60; is assigned by the sending mail client and is visible in the &#x60;messageId&#x60; field of &#x60;MailLogEntry&#x60;. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="replyto">Filter by the &#x60;Reply-To&#x60; message header address (exact match).  Only returns messages where this header was explicitly set. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="headerfrom">Filter by the &#x60;From&#x60; message header address (exact match).  This is the human-visible sender address and may differ from the SMTP envelope &#x60;from&#x60; parameter when sending on behalf of another address. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    ...
    /// <param name="limit">Maximum number of records to return per page.  Defaults to &#x60;100&#x60;. Maximum allowed value is &#x60;10000&#x60;.  The response also includes a &#x60;total&#x60; field with the full matched count so you can calculate the number of pages. (optional, default to 0)</param>
    ...
    /// <param name="sort">Field to sort results by.  Currently only &#x60;time&#x60; is supported (sorts by internal row ID which corresponds to chronological order). (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="dir">Sort direction.  &#x60;desc&#x60; returns newest first (default), &#x60;asc&#x60; returns oldest first. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    /// <param name="groupby">Controls how results are grouped.  &#x60;recipient&#x60; (default) returns one row per delivery attempt — a message sent to 4 recipients produces 4 rows, each with its own &#x60;recipient&#x60;, &#x60;delivered&#x60;, &#x60;response&#x60;, and delivery metadata.  &#x60;message&#x60; collapses to one row per unique message ID; delivery-level fields will reflect one arbitrary recipient per message.  The &#x60;total&#x60; count in the response matches the grouping mode. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<MailLog>> viewMailLog(
        int32_t id,
        boost::optional<int64_t> id2,
        boost::optional<utility::string_t> origin,
        boost::optional<utility::string_t> mx,
        boost::optional<utility::string_t> from,
        boost::optional<utility::string_t> to,
        boost::optional<utility::string_t> subject,
        boost::optional<utility::string_t> mailid,
        boost::optional<utility::string_t> messageId,
        boost::optional<utility::string_t> replyto,
        boost::optional<utility::string_t> headerfrom,
        boost::optional<int32_t> delivered,
        boost::optional<int32_t> skip,
        boost::optional<int32_t> limit,
        boost::optional<std::shared_ptr<ViewMailLog_startDate_parameter>> startDate,
        boost::optional<std::shared_ptr<ViewMailLog_startDate_parameter>> endDate,
...
#endif /* NET_INTERSERVER_API_MailApi_H_ */
