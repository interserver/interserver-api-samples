...
#ifndef NET_INTERSERVER_API_MODEL_MailLog_H_
#define NET_INTERSERVER_API_MODEL_MailLog_H_
...
public:
    ...
    void unsetEmails();
    void setEmails(const std::vector<std::shared_ptr<MailLogEntry>>& value);
...
#endif /* NET_INTERSERVER_API_MODEL_MailLog_H_ */
