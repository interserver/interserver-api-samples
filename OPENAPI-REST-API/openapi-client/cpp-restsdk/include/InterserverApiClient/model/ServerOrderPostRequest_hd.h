...
#ifndef NET_INTERSERVER_API_MODEL_ServerOrderPostRequest_hd_H_
#define NET_INTERSERVER_API_MODEL_ServerOrderPostRequest_hd_H_
...
public:
    ...
    using VariantType = std::variant<int32_t, std::vector<int32_t>>;
...
#endif /* NET_INTERSERVER_API_MODEL_ServerOrderPostRequest_hd_H_ */
