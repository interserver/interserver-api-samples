...
#ifndef NET_INTERSERVER_API_MODEL_GetScrubIpDetails_200_response_client_links_inner_H_
#define NET_INTERSERVER_API_MODEL_GetScrubIpDetails_200_response_client_links_inner_H_
...
public:
    ...
    utility::string_t getOtherAttr() const;
    bool otherAttrIsSet() const;
    void unsetOther_attr();
    void setOtherAttr(const utility::string_t& value);
...
#endif /* NET_INTERSERVER_API_MODEL_GetScrubIpDetails_200_response_client_links_inner_H_ */
