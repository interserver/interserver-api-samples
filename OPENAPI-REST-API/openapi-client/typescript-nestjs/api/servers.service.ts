...
import { AddServer200Response } from '../model/add-server200-response';
import { BuyItNowList } from '../model/buy-it-now-list';
import { BuyItNowServerOrder200Response } from '../model/buy-it-now-server-order200-response';
...
import { PlaceBuyNowServerRequest } from '../model/place-buy-now-server-request';
import { ReverseDnsEntries } from '../model/reverse-dns-entries';
import { Server } from '../model/server';
import { ServerBulkIpmiPowerResponse } from '../model/server-bulk-ipmi-power-response';
import { ServerIpmiLiveInfo } from '../model/server-ipmi-live-info';
import { ServerOrder } from '../model/server-order';
import { ServerOrderPostRequest } from '../model/server-order-post-request';
import { ServerRow } from '../model/server-row';
import { ServersBuyNowError } from '../model/servers-buy-now-error';
import { ServersBuyNowResponse } from '../model/servers-buy-now-response';
import { ServersCancel200Response } from '../model/servers-cancel200-response';
import { SuccessTextResponse } from '../model/success-text-response';
import { TextResponse } from '../model/text-response';
import { Configuration } from '../configuration';
import { COLLECTION_FORMATS } from '../variables';
import { ServersServiceInterface } from './servers.serviceInterface';


@Injectable()
export class ServersService implements ServersServiceInterface {
     ...
     */
    public addServer(serverOrderPostRequest: ServerOrderPostRequest, addServerOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<AddServer200Response>>;
    public addServer(serverOrderPostRequest: ServerOrderPostRequest, addServerOpts?: { config?: AxiosRequestConfig }): Observable<any> {
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [serverBulkIpmiPowerGetOpts.config] Override http request option.
     */
    public serverBulkIpmiPowerGet(ids: string, serverBulkIpmiPowerGetOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<ServerBulkIpmiPowerResponse>>;
    public serverBulkIpmiPowerGet(ids: string, serverBulkIpmiPowerGetOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        if (ids !== undefined && ids !== null) {
            queryParameters.append('ids', <any>ids);
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<ServerBulkIpmiPowerResponse>(`${this.basePath}/servers/bulk/ipmi_power`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...serverBulkIpmiPowerGetOpts?.config,
                        headers: {...headers, ...serverBulkIpmiPowerGetOpts?.config?.headers},
                    }
                );
            })
        );
