...
import { VPSCancel200Response } from '../model/vps-cancel200-response';
import { Vps } from '../model/vps';
import { VpsBackupRows } from '../model/vps-backup-rows';
import { VpsOrder } from '../model/vps-order';
import { VpsOrderPostRequest } from '../model/vps-order-post-request';
import { VpsOrderPutRequest } from '../model/vps-order-put-request';
import { VpsOrderPutResponse } from '../model/vps-order-put-response';
import { VpsRow } from '../model/vps-row';
import { VpsTemplatesList } from '../model/vps-templates-list';
import { VpsTrafficResponse } from '../model/vps-traffic-response';
import { Configuration } from '../configuration';
import { COLLECTION_FORMATS } from '../variables';
import { VPSServiceInterface } from './vps.serviceInterface';


@Injectable()
export class VPSService implements VPSServiceInterface {
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [getVpsBackupOpts.config] Override http request option.
     */
    public getVpsBackup(id: number, getVpsBackupOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<QueueResponse>>;
    public getVpsBackup(id: number, getVpsBackupOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<QueueResponse>(`${this.basePath}/vps/${encodeURIComponent(String(id))}/backup`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...getVpsBackupOpts?.config,
                        headers: {...headers, ...getVpsBackupOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [getVpsChangeHostnameOpts.config] Override http request option.
     */
    public getVpsChangeHostname(id: number, getVpsChangeHostnameOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public getVpsChangeHostname(id: number, getVpsChangeHostnameOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<any>(`${this.basePath}/vps/${encodeURIComponent(String(id))}/change_hostname`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...getVpsChangeHostnameOpts?.config,
                        headers: {...headers, ...getVpsChangeHostnameOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [getVpsChangeRootPasswordOpts.config] Override http request option.
     */
    public getVpsChangeRootPassword(id: number, getVpsChangeRootPasswordOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public getVpsChangeRootPassword(id: number, getVpsChangeRootPasswordOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<any>(`${this.basePath}/vps/${encodeURIComponent(String(id))}/change_root_password`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...getVpsChangeRootPasswordOpts?.config,
                        headers: {...headers, ...getVpsChangeRootPasswordOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [getVpsInsertCdOpts.config] Override http request option.
     */
    public getVpsInsertCd(id: number, getVpsInsertCdOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public getVpsInsertCd(id: number, getVpsInsertCdOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<any>(`${this.basePath}/vps/${encodeURIComponent(String(id))}/insert_cd`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...getVpsInsertCdOpts?.config,
                        headers: {...headers, ...getVpsInsertCdOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [getVpsResetPasswordOpts.config] Override http request option.
     */
    public getVpsResetPassword(id: number, getVpsResetPasswordOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public getVpsResetPassword(id: number, getVpsResetPasswordOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<any>(`${this.basePath}/vps/${encodeURIComponent(String(id))}/reset_password`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...getVpsResetPasswordOpts?.config,
                        headers: {...headers, ...getVpsResetPasswordOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [postVpsTrafficUsageOpts.config] Override http request option.
     */
    public postVpsTrafficUsage(id: number, postVpsTrafficUsageOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public postVpsTrafficUsage(id: number, postVpsTrafficUsageOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<any>(`${this.basePath}/vps/${encodeURIComponent(String(id))}/traffic_usage`,
                    null,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...postVpsTrafficUsageOpts?.config,
                        headers: {...headers, ...postVpsTrafficUsageOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [putVpsBuyHdSpaceOpts.config] Override http request option.
     */
    public putVpsBuyHdSpace(id: number, putVpsBuyHdSpaceOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public putVpsBuyHdSpace(id: number, putVpsBuyHdSpaceOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.put<any>(`${this.basePath}/vps/${encodeURIComponent(String(id))}/buy_hd_space`,
                    null,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...putVpsBuyHdSpaceOpts?.config,
                        headers: {...headers, ...putVpsBuyHdSpaceOpts?.config?.headers},
                    }
                );
            })
        );
