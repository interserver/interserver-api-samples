...
import { CancelDomain200Response } from '../model/cancel-domain200-response';
import { ChargeInvoiceRows } from '../model/charge-invoice-rows';
import { Domain } from '../model/domain';
import { DomainContactDetails } from '../model/domain-contact-details';
import { DomainDnssecRecords } from '../model/domain-dnssec-records';
import { DomainDnssecRequest } from '../model/domain-dnssec-request';
import { DomainLookupResponse } from '../model/domain-lookup-response';
import { DomainNameserverGetResponse } from '../model/domain-nameserver-get-response';
import { DomainNameserverPostRequest } from '../model/domain-nameserver-post-request';
import { DomainNameserverPutRequest } from '../model/domain-nameserver-put-request';
import { DomainOrder } from '../model/domain-order';
import { DomainOrderRequest } from '../model/domain-order-request';
import { DomainRow } from '../model/domain-row';
import { DomainSearchResponse } from '../model/domain-search-response';
import { DomainWhoisPrivacyRequest } from '../model/domain-whois-privacy-request';
...
export class DomainsService implements DomainsServiceInterface {
     ...
     */
    public addDomain(domainOrderRequest: DomainOrderRequest, addDomainOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<ServiceOrderPostResponse>>;
    public addDomain(domainOrderRequest: DomainOrderRequest, addDomainOpts?: { config?: AxiosRequestConfig }): Observable<any> {
     ...
     */
    public deleteDomainDnssec(id: number, deleteDomainDnssecOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<SuccessTextResponse>>;
    public deleteDomainDnssec(id: number, deleteDomainDnssecOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
     ...
     */
    public patchDomains(domainOrderRequest: DomainOrderRequest, patchDomainsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public patchDomains(domainOrderRequest: DomainOrderRequest, patchDomainsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (domainOrderRequest === null || domainOrderRequest === undefined) {
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [postDomainSearchOpts.config] Override http request option.
     */
    public postDomainSearch(name: string, postDomainSearchOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public postDomainSearch(name: string, postDomainSearchOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (name === null || name === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<any>(`${this.basePath}/domains/search/${encodeURIComponent(String(name))}`,
                    null,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...postDomainSearchOpts?.config,
                        headers: {...headers, ...postDomainSearchOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public putDomains(domainOrderRequest: DomainOrderRequest, putDomainsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public putDomains(domainOrderRequest: DomainOrderRequest, putDomainsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (domainOrderRequest === null || domainOrderRequest === undefined) {
     ...
     */
    public updateDomainInfo(id: number, updateDomainInfoOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<SuccessTextResponse>>;
    public updateDomainInfo(id: number, updateDomainInfoOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
