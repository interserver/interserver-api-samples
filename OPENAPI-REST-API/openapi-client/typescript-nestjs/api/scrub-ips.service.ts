...
import { CancelScrubIp200Response } from '../model/cancel-scrub-ip200-response';
import { ChargeInvoiceRows } from '../model/charge-invoice-rows';
import { CreateFilter } from '../model/create-filter';
import { CreateFilter201Response } from '../model/create-filter201-response';
import { CreateFilter400Response } from '../model/create-filter400-response';
import { CreateFilter500Response } from '../model/create-filter500-response';
import { CreateFirewallRule } from '../model/create-firewall-rule';
import { CreateGeoFirewallRule } from '../model/create-geo-firewall-rule';
import { CreateGeoRule400Response } from '../model/create-geo-rule400-response';
import { CreateRule201Response } from '../model/create-rule201-response';
import { CreateRule400Response } from '../model/create-rule400-response';
import { CreateRule500Response } from '../model/create-rule500-response';
import { DeleteFilter200Response } from '../model/delete-filter200-response';
import { DeleteFilter400Response } from '../model/delete-filter400-response';
import { DeleteFilter500Response } from '../model/delete-filter500-response';
import { DeleteFirewallRule } from '../model/delete-firewall-rule';
import { DeleteGeoFirewallRule } from '../model/delete-geo-firewall-rule';
import { DisableScrub200Response } from '../model/disable-scrub200-response';
import { DisableScrub400Response } from '../model/disable-scrub400-response';
import { DisableScrub500Response } from '../model/disable-scrub500-response';
import { EnableScrub200Response } from '../model/enable-scrub200-response';
import { EnableScrub500Response } from '../model/enable-scrub500-response';
import { GetAccountInfo401Response } from '../model/get-account-info401-response';
import { GetOrderDetail200Response } from '../model/get-order-detail200-response';
import { GetScrubIpDetails200Response } from '../model/get-scrub-ip-details200-response';
import { PlaceScrubOrder201Response } from '../model/place-scrub-order201-response';
import { PutScrubIps200Response } from '../model/put-scrub-ips200-response';
import { ScrubIpFilterTypes } from '../model/scrub-ip-filter-types';
import { ScrubIpPlaceOrder } from '../model/scrub-ip-place-order';
import { ScrubIpsDeleteRule200Response } from '../model/scrub-ips-delete-rule200-response';
import { ScrubIpsDeleteRule400Response } from '../model/scrub-ips-delete-rule400-response';
import { ScrubIpsDeleteRule500Response } from '../model/scrub-ips-delete-rule500-response';
import { ScrubIpsLogRowSchema } from '../model/scrub-ips-log-row-schema';
import { ScrubIpsRowSchema } from '../model/scrub-ips-row-schema';
import { Configuration } from '../configuration';
import { COLLECTION_FORMATS } from '../variables';
import { ScrubIpsServiceInterface } from './scrub-ips.serviceInterface';


@Injectable()
export class ScrubIpsService implements ScrubIpsServiceInterface {
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [putScrubIpsOpts.config] Override http request option.
     */
    public putScrubIps(scrubIpPlaceOrder: ScrubIpPlaceOrder, putScrubIpsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<PutScrubIps200Response>>;
    public putScrubIps(scrubIpPlaceOrder: ScrubIpPlaceOrder, putScrubIpsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (scrubIpPlaceOrder === null || scrubIpPlaceOrder === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.put<PutScrubIps200Response>(`${this.basePath}/scrub_ips/order`,
                    scrubIpPlaceOrder,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...putScrubIpsOpts?.config,
                        headers: {...headers, ...putScrubIpsOpts?.config?.headers},
                    }
                );
            })
        );
