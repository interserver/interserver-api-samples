...
import { DeleteMailAlertRequest } from '../model/delete-mail-alert-request';
import { DenyRuleNew } from '../model/deny-rule-new';
import { DenyRuleRecord } from '../model/deny-rule-record';
import { GenericResponse } from '../model/generic-response';
import { GetAccountInfo401Response } from '../model/get-account-info401-response';
import { MailAlertRequest } from '../model/mail-alert-request';
import { MailAlertUpdateRequest } from '../model/mail-alert-update-request';
import { MailAlertsResponse } from '../model/mail-alerts-response';
import { MailBlocks } from '../model/mail-blocks';
import { MailCancel200Response } from '../model/mail-cancel200-response';
import { MailDelistRequest } from '../model/mail-delist-request';
import { MailDelistResponse } from '../model/mail-delist-response';
import { MailDeliverabilityResponse } from '../model/mail-deliverability-response';
import { MailLog } from '../model/mail-log';
import { MailOrder } from '../model/mail-order';
import { MailOrderRequest } from '../model/mail-order-request';
import { MailRow } from '../model/mail-row';
import { MailSchema } from '../model/mail-schema';
import { MailStatsType } from '../model/mail-stats-type';
import { SendMail } from '../model/send-mail';
import { SendMailAdv } from '../model/send-mail-adv';
...
import { ViewMailLogStartDateParameter } from '../model/view-mail-log-start-date-parameter';
import { Configuration } from '../configuration';
import { COLLECTION_FORMATS } from '../variables';
import { MailServiceInterface } from './mail.serviceInterface';
...
export class MailService implements MailServiceInterface {
     ...
     */
    public addMail(mailOrderRequest: MailOrderRequest, addMailOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<ServiceOrderPostResponse>>;
    public addMail(mailOrderRequest: MailOrderRequest, addMailOpts?: { config?: AxiosRequestConfig }): Observable<any> {
     ...
     */
    public deleteMailAlert(id: number, deleteMailAlertRequest: DeleteMailAlertRequest, deleteMailAlertOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<SuccessTextResponse>>;
    public deleteMailAlert(id: number, deleteMailAlertRequest: DeleteMailAlertRequest, deleteMailAlertOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
     ...
     */
    public putMail(mailOrderRequest: MailOrderRequest, putMailOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public putMail(mailOrderRequest: MailOrderRequest, putMailOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (mailOrderRequest === null || mailOrderRequest === undefined) {
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [updateRuleOpts.config] Override http request option.
     */
    public updateRule(id: number, rule: string, denyRuleNew: DenyRuleNew, updateRuleOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<GenericResponse>>;
    public updateRule(id: number, rule: string, denyRuleNew: DenyRuleNew, updateRuleOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.put<GenericResponse>(`${this.basePath}/mail/${encodeURIComponent(String(id))}/rules/${encodeURIComponent(String(rule))}`,
                    denyRuleNew,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...updateRuleOpts?.config,
                        headers: {...headers, ...updateRuleOpts?.config?.headers},
                    }
                );
            })
        );
