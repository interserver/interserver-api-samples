...
import { GetAccountLocales200ResponseValue } from '../model/get-account-locales200-response-value';
import { GetOauthRedirect200Response } from '../model/get-oauth-redirect200-response';
import { LoginErrorResponse } from '../model/login-error-response';
import { LoginInfo } from '../model/login-info';
import { LoginSubmissionExample } from '../model/login-submission-example';
import { LoginSubmissionExampleGRecaptchaResponse } from '../model/login-submission-example-g-recaptcha-response';
import { LoginSuccessResponse } from '../model/login-success-response';
import { PatchOauthTwoFactor200Response } from '../model/patch-oauth-two-factor200-response';
import { PatchOauthTwoFactorRequest } from '../model/patch-oauth-two-factor-request';
import { PostOauthCallback200Response } from '../model/post-oauth-callback200-response';
import { PostOauthCallbackRequest } from '../model/post-oauth-callback-request';
import { ServicesInfo } from '../model/services-info';
import { Configuration } from '../configuration';
import { COLLECTION_FORMATS } from '../variables';
import { PublicServiceInterface } from './public.serviceInterface';
...
export class PublicService implements PublicServiceInterface {
     ...
     * @param {*} [getAccountCurrenciesOpts.config] Override http request option.
     */
    public getAccountCurrencies(getAccountCurrenciesOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<Array<string>>>;
    public getAccountCurrencies(getAccountCurrenciesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<Array<string>>(`${this.basePath}/account/currencies`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...getAccountCurrenciesOpts?.config,
                        headers: {...headers, ...getAccountCurrenciesOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [getAccountLocalesOpts.config] Override http request option.
     */
    public getAccountLocales(getAccountLocalesOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<{ [key: string]: GetAccountLocales200ResponseValue; }>>;
    public getAccountLocales(getAccountLocalesOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        let headers = {...this.defaultHeaders};
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<{ [key: string]: GetAccountLocales200ResponseValue; }>(`${this.basePath}/account/locales`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...getAccountLocalesOpts?.config,
                        headers: {...headers, ...getAccountLocalesOpts?.config?.headers},
                    }
                );
            })
        );
