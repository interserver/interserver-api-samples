...
import { AffiliateBannerRow } from '../model/affiliate-banner-row';
import { AffiliateTrafficRow } from '../model/affiliate-traffic-row';
import { BillingAddCcRequest } from '../model/billing-add-cc-request';
import { BillingInvoiceDetail } from '../model/billing-invoice-detail';
import { BillingInvoiceList } from '../model/billing-invoice-list';
import { BillingPaymentMethodRequest } from '../model/billing-payment-method-request';
import { BillingPrepayRequest } from '../model/billing-prepay-request';
import { BillingVerifyCcRequest } from '../model/billing-verify-cc-request';
import { GetAccountInfo401Response } from '../model/get-account-info401-response';
import { GetAffiliateSignups200Response } from '../model/get-affiliate-signups200-response';
import { InitiatePayment200Response } from '../model/initiate-payment200-response';
import { MonthlyCounts } from '../model/monthly-counts';
import { PatchBillingCreditCardVerifyRequest } from '../model/patch-billing-credit-card-verify-request';
import { StatusMonthlyBreakdown } from '../model/status-monthly-breakdown';
import { SuccessTextResponse } from '../model/success-text-response';
import { TextResponse } from '../model/text-response';
import { Configuration } from '../configuration';
import { COLLECTION_FORMATS } from '../variables';
import { BillingServiceInterface } from './billing.serviceInterface';
...
export class BillingService implements BillingServiceInterface {
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [getAffiliateDownloadOpts.config] Override http request option.
     */
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, getAffiliateDownloadOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<any>>;
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, getAffiliateDownloadOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        let queryParameters = new URLSearchParams();
        if (st !== undefined && st !== null) {
            queryParameters.append('st', <any>st);
        }
        if (ex !== undefined && ex !== null) {
            queryParameters.append('ex', <any>ex);
        }
        if (year !== undefined && year !== null) {
            queryParameters.append('year', <any>year);
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<any>(`${this.basePath}/affiliate/download`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getAffiliateDownloadOpts?.config,
                        headers: {...headers, ...getAffiliateDownloadOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [getAffiliateSignupsOpts.config] Override http request option.
     */
    public getAffiliateSignups(st?: string, getAffiliateSignupsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<GetAffiliateSignups200Response>>;
    public getAffiliateSignups(st?: string, getAffiliateSignupsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        let queryParameters = new URLSearchParams();
        if (st !== undefined && st !== null) {
            queryParameters.append('st', <any>st);
        }
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<GetAffiliateSignups200Response>(`${this.basePath}/affiliate/signups`,
                    {
                        params: queryParameters,
                        withCredentials: this.configuration.withCredentials,
                        ...getAffiliateSignupsOpts?.config,
                        headers: {...headers, ...getAffiliateSignupsOpts?.config?.headers},
                    }
                );
            })
        );
    ...
    public initiatePayment(method: 'cc' | 'paypal' | 'prepay' | 'payssion' | 'payu' | 'ccavenue' | 'cashfree' | 'coinbase' | 'btcpay', invoices: string, initiatePaymentOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.get<InitiatePayment200Response>(`${this.basePath}/billing/pay/${encodeURIComponent(String(method))}/${encodeURIComponent(String(invoices))}`,
                    {
                        withCredentials: this.configuration.withCredentials,
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [patchBillingCreditCardVerifyOpts.config] Override http request option.
     */
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, patchBillingCreditCardVerifyOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<SuccessTextResponse>>;
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, patchBillingCreditCardVerifyOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.patch<SuccessTextResponse>(`${this.basePath}/billing/creditcards/${encodeURIComponent(String(id))}/verify`,
                    patchBillingCreditCardVerifyRequest,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...patchBillingCreditCardVerifyOpts?.config,
                        headers: {...headers, ...patchBillingCreditCardVerifyOpts?.config?.headers},
                    }
                );
            })
        );
