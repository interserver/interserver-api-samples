...
export interface TicketsServiceInterface {
    ...
    * @param ticketNew 
    */
    addNewTicket(ticketNew: TicketNew, extraHttpRequestParams?: any): Observable<TicketNewResponse>;
    ...
    * @param id Ticket ID
    */
    closeTicket(id: string, extraHttpRequestParams?: any): Observable<CloseTicketResponseSchema>;
    ...
    */
    deleteTicketInfo(id: number, extraHttpRequestParams?: any): Observable<ViewTicketResponse>;
    ...
    */
    getNewTicket(extraHttpRequestParams?: any): Observable<{}>;
    ...
    * @param id Ticket ID number.
    */
    getTicketInfo(id: number, extraHttpRequestParams?: any): Observable<ViewTicketResponse>;
    ...
    */
    getTicketsList(page?: number, period?: '30' | '90' | '365' | '1825' | 'all', view?: 'Open' | 'Closed' | 'On Hold' | 'In Progress', extraHttpRequestParams?: any): Observable<Tickets>;
    ...
    * @param id Ticket ID number.
    */
    postTicketInfo(id: number, extraHttpRequestParams?: any): Observable<ViewTicketResponse>;
    ...
    */
    postTicketsList(extraHttpRequestParams?: any): Observable<Tickets>;
    ...
    * @param id Ticket ID number.
    */
    putTicketInfo(id: number, extraHttpRequestParams?: any): Observable<ViewTicketResponse>;
    ...
    */
    replyTicket(id: number, replyTicketRequest?: ReplyTicketRequest, extraHttpRequestParams?: any): Observable<ReplyTicketResponseSchema>;
    ...
    * @param updateTicket 
    */
    updateTicketInfo(id: number, updateTicket?: UpdateTicket, extraHttpRequestParams?: any): Observable<UpdateTicketResponseSchema>;
