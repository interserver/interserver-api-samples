...
export interface DNSServiceInterface {
    ...
    */
    addDnsDomain(domain: string, ip: string, extraHttpRequestParams?: any): Observable<SuccessTextResponse>;
    ...
    * @param prio Priority
    */
    addDnsRecord(id: string, name: string, type: DnsRecordType, content: string, ttl?: number, prio?: number, extraHttpRequestParams?: any): Observable<{}>;
    ...
    */
    deleteDnsDomain(id: string, extraHttpRequestParams?: any): Observable<SuccessTextResponse>;
    ...
    */
    deleteDnsRecord(domainId: number, recordId: number, extraHttpRequestParams?: any): Observable<SuccessTextResponse>;
    ...
    */
    getDnsDomain(id: number, extraHttpRequestParams?: any): Observable<Array<DnsRecord>>;
    ...
    */
    getDnsList(extraHttpRequestParams?: any): Observable<Array<DnsListItem>>;
    ...
    * @param auth 
    */
    updateDnsRecord(domainId: number, recordId: number, name?: string, type?: DnsRecordType, content?: string, ttl?: string, prio?: string, disabled?: string, ordername?: string, auth?: string, extraHttpRequestParams?: any): Observable<SuccessTextResponse>;
