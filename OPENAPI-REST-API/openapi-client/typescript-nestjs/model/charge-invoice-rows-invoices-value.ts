 ...
 */
import { ChargeInvoiceRowsInvoicesValuePaidInvoicesValue } from './charge-invoice-rows-invoices-value-paid-invoices-value';
...
export enum ChargeInvoiceRowsInvoicesValueInvoicesPaid {
    NUMBER_0 = 0,
    NUMBER_1 = 1,
