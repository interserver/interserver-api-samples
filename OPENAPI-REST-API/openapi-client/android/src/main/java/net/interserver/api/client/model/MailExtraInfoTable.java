...
import java.util.*;
import net.interserver.api.client.model.MailExtraInfoTableRow;
...
public class MailExtraInfoTable implements Serializable {
   ...
   **/
  @ApiModelProperty(value = "The title of the extra info table.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.title == null ? mailExtraInfoTable.title == null : this.title.equals(mailExtraInfoTable.title)) &&
        (this.rows == null ? mailExtraInfoTable.rows == null : this.rows.equals(mailExtraInfoTable.rows));
  }
