...
public class WebsiteBillingDetails implements Serializable {
  ...
  private Object serviceExtra = null;
   ...
   **/
  @ApiModelProperty(value = "Currency for the service")
   ...
   **/
  @ApiModelProperty(value = "Currency symbol for the service")
  ...
  public boolean equals(Object o) {
    ...
    return (this.serviceLastInvoiceDate == null ? websiteBillingDetails.serviceLastInvoiceDate == null : this.serviceLastInvoiceDate.equals(websiteBillingDetails.serviceLastInvoiceDate)) &&
        (this.servicePaymentStatus == null ? websiteBillingDetails.servicePaymentStatus == null : this.servicePaymentStatus.equals(websiteBillingDetails.servicePaymentStatus)) &&
        (this.serviceFrequency == null ? websiteBillingDetails.serviceFrequency == null : this.serviceFrequency.equals(websiteBillingDetails.serviceFrequency)) &&
        (this.nextDate == null ? websiteBillingDetails.nextDate == null : this.nextDate.equals(websiteBillingDetails.nextDate)) &&
        (this.serviceNextInvoiceDate == null ? websiteBillingDetails.serviceNextInvoiceDate == null : this.serviceNextInvoiceDate.equals(websiteBillingDetails.serviceNextInvoiceDate)) &&
        (this.serviceCurrency == null ? websiteBillingDetails.serviceCurrency == null : this.serviceCurrency.equals(websiteBillingDetails.serviceCurrency)) &&
        (this.serviceCurrencySymbol == null ? websiteBillingDetails.serviceCurrencySymbol == null : this.serviceCurrencySymbol.equals(websiteBillingDetails.serviceCurrencySymbol)) &&
        (this.serviceCoupon == null ? websiteBillingDetails.serviceCoupon == null : this.serviceCoupon.equals(websiteBillingDetails.serviceCoupon)) &&
        (this.serviceCostInfo == null ? websiteBillingDetails.serviceCostInfo == null : this.serviceCostInfo.equals(websiteBillingDetails.serviceCostInfo)) &&
        (this.serviceExtra == null ? websiteBillingDetails.serviceExtra == null : this.serviceExtra.equals(websiteBillingDetails.serviceExtra)) &&
        (this.serviceExtraJson == null ? websiteBillingDetails.serviceExtraJson == null : this.serviceExtraJson.equals(websiteBillingDetails.serviceExtraJson));
  }
