...
import java.util.*;
import net.interserver.api.client.model.BackupIPInfoRow;
...
public class BackupIPInfo implements Serializable {
   ...
   **/
  @ApiModelProperty(value = "Title of the IP information table.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.title == null ? backupIPInfo.title == null : this.title.equals(backupIPInfo.title)) &&
        (this.rows == null ? backupIPInfo.rows == null : this.rows.equals(backupIPInfo.rows));
  }
