...
public class ServerIpmiPowerRequest implements Serializable {
   ...
   **/
  @ApiModelProperty(required = true, value = "The power action to send to the ipmi controller.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.action == null ? serverIpmiPowerRequest.action == null : this.action.equals(serverIpmiPowerRequest.action)) &&
        (this.asset == null ? serverIpmiPowerRequest.asset == null : this.asset.equals(serverIpmiPowerRequest.asset));
  }
