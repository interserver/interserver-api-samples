...
import java.util.*;
import net.interserver.api.client.model.WebsiteTableRow;
...
public class WebsiteTable implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.title == null ? websiteTable.title == null : this.title.equals(websiteTable.title)) &&
        (this.rows == null ? websiteTable.rows == null : this.rows.equals(websiteTable.rows));
  }
