...
public class DnsNewDomain implements Serializable {
   ...
   **/
  @ApiModelProperty(required = true, value = "IP Address to point the domain to.")
  public String getIp() {
    return ip;
  }
  ...
  public boolean equals(Object o) {
    ...
    return (this.domain == null ? dnsNewDomain.domain == null : this.domain.equals(dnsNewDomain.domain)) &&
        (this.ip == null ? dnsNewDomain.ip == null : this.ip.equals(dnsNewDomain.ip));
  }
