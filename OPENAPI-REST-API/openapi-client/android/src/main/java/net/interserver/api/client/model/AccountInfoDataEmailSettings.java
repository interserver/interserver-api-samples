...
public class AccountInfoDataEmailSettings implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.adminCcBadResponse == null ? accountInfoDataEmailSettings.adminCcBadResponse == null : this.adminCcBadResponse.equals(accountInfoDataEmailSettings.adminCcBadResponse)) &&
        (this.adminMassCommunicationsTpl == null ? accountInfoDataEmailSettings.adminMassCommunicationsTpl == null : this.adminMassCommunicationsTpl.equals(accountInfoDataEmailSettings.adminMassCommunicationsTpl));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.adminCcBadResponse == null ? 0: this.adminCcBadResponse.hashCode());
    result = 31 * result + (this.adminMassCommunicationsTpl == null ? 0: this.adminMassCommunicationsTpl.hashCode());
    return result;
  }
