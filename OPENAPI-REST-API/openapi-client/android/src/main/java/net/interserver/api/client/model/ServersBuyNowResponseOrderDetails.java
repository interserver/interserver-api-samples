...
public class ServersBuyNowResponseOrderDetails implements Serializable {
   ...
   **/
  @ApiModelProperty(value = "The newly created service ID for the ordered server.")
   ...
   **/
  @ApiModelProperty(value = "The invoice ID generated for the order.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.serviceId == null ? serversBuyNowResponseOrderDetails.serviceId == null : this.serviceId.equals(serversBuyNowResponseOrderDetails.serviceId)) &&
        (this.invoiceId == null ? serversBuyNowResponseOrderDetails.invoiceId == null : this.invoiceId.equals(serversBuyNowResponseOrderDetails.invoiceId));
  }
