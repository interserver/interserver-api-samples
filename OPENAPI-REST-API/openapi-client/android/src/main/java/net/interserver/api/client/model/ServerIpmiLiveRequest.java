...
public class ServerIpmiLiveRequest implements Serializable {
   ...
   **/
  @ApiModelProperty(required = true, value = "Your IP Address you wish to connect to the IPMI system from.")
  public String getIp() {
    return ip;
  }
  ...
  public boolean equals(Object o) {
    ...
    return (this.ip == null ? serverIpmiLiveRequest.ip == null : this.ip.equals(serverIpmiLiveRequest.ip)) &&
        (this.asset == null ? serverIpmiLiveRequest.asset == null : this.asset.equals(serverIpmiLiveRequest.asset));
  }
