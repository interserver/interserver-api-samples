...
public class WebsiteOrderPostRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.hostname == null ? websiteOrderPostRequest.hostname == null : this.hostname.equals(websiteOrderPostRequest.hostname)) &&
        (this.packageId == null ? websiteOrderPostRequest.packageId == null : this.packageId.equals(websiteOrderPostRequest.packageId)) &&
        (this.rootpass == null ? websiteOrderPostRequest.rootpass == null : this.rootpass.equals(websiteOrderPostRequest.rootpass)) &&
        (this.period == null ? websiteOrderPostRequest.period == null : this.period.equals(websiteOrderPostRequest.period)) &&
        (this.coupon == null ? websiteOrderPostRequest.coupon == null : this.coupon.equals(websiteOrderPostRequest.coupon)) &&
        (this.serviceOfferId == null ? websiteOrderPostRequest.serviceOfferId == null : this.serviceOfferId.equals(websiteOrderPostRequest.serviceOfferId)) &&
        (this.script == null ? websiteOrderPostRequest.script == null : this.script.equals(websiteOrderPostRequest.script)) &&
        (this.comment == null ? websiteOrderPostRequest.comment == null : this.comment.equals(websiteOrderPostRequest.comment)) &&
        (this.registerDomain == null ? websiteOrderPostRequest.registerDomain == null : this.registerDomain.equals(websiteOrderPostRequest.registerDomain));
  }
