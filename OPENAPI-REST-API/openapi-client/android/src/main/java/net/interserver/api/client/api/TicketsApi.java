...
import net.interserver.api.client.model.CloseTicketResponseSchema;
import net.interserver.api.client.model.GetAccountInfo401Response;
import net.interserver.api.client.model.ReplyTicketRequest;
import net.interserver.api.client.model.ReplyTicketResponseSchema;
import net.interserver.api.client.model.TicketNew;
import net.interserver.api.client.model.TicketNewResponse;
import net.interserver.api.client.model.Tickets;
import net.interserver.api.client.model.UpdateTicket;
import net.interserver.api.client.model.UpdateTicketResponseSchema;
import net.interserver.api.client.model.ViewTicketResponse;
...
public class TicketsApi {
  ...
  */
  public TicketNewResponse addNewTicket (TicketNew ticketNew) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = ticketNew;
    // verify the required parameter 'ticketNew' is set
    if (ticketNew == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ticketNew' when calling addNewTicket",
        new ApiException(400, "Missing the required parameter 'ticketNew' when calling addNewTicket"));
    }

    // create path and map variables
    String path = "/tickets/new";
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (TicketNewResponse) ApiInvoker.deserialize(localVarResponse, "", TicketNewResponse.class);
      } else {
         return null;
      }
   ...
   * @param ticketNew 
  */
  public void addNewTicket (TicketNew ticketNew, final Response.Listener<TicketNewResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = ticketNew;
      ...
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((TicketNewResponse) ApiInvoker.deserialize(localVarResponse,  "", TicketNewResponse.class));
  ...
  */
  public CloseTicketResponseSchema closeTicket (String id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling closeTicket",
        new ApiException(400, "Missing the required parameter 'id' when calling closeTicket"));
    }

    // create path and map variables
    String path = "/tickets/{id}/close".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (CloseTicketResponseSchema) ApiInvoker.deserialize(localVarResponse, "", CloseTicketResponseSchema.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param id Ticket ID
  */
  public void closeTicket (String id, final Response.Listener<CloseTicketResponseSchema> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/tickets/{id}/close".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((CloseTicketResponseSchema) ApiInvoker.deserialize(localVarResponse,  "", CloseTicketResponseSchema.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public ViewTicketResponse deleteTicketInfo (BigDecimal id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling deleteTicketInfo",
        new ApiException(400, "Missing the required parameter 'id' when calling deleteTicketInfo"));
    }

    // create path and map variables
    String path = "/tickets/{id}".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (ViewTicketResponse) ApiInvoker.deserialize(localVarResponse, "", ViewTicketResponse.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param id Ticket ID number.
  */
  public void deleteTicketInfo (BigDecimal id, final Response.Listener<ViewTicketResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/tickets/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "DELETE", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ViewTicketResponse) ApiInvoker.deserialize(localVarResponse,  "", ViewTicketResponse.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * Use to populate dropdowns before calling addNewTicket. Returns the customer&#39;s services grouped by product type so the user can attach a ticket to a specific resource. Iterates all enabled modules (vps, webhosting, domains, mail, etc.; mailbaby instances see only mail) and filters out services with status canceled, deleted, or fraud. Params: none. Body: none. Returns: object keyed by product TITLE (e.g. &#39;Vps&#39;, &#39;Webhosting&#39;), each value a map of &#39;{module}-{service_id}&#39; to a description string including title, type/plan, VPS hypervisor name where applicable, and uppercase status tag. Errors: 401 unauthorized. Use the returned product key as the &#39;product&#39; field on addNewTicket.  Sibling ops: &#x60;addNewTicket&#x60; (consumes the product key), &#x60;getTicketsList&#x60;.
   * @return void
  */
  public void getNewTicket () throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void getNewTicket (final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Use to render a ticket page or feed full context to an LLM. Path: id (int, ticket ID, e.g. 1511222). Returns ticket header (subject, status, department, dates), the ordered post/reply history, attachments, and any custom-field values. Resolved via Ticket::getTicket(id, account_lid) so cross-account access returns Invalid ticket. Body: none. Errors: 401 unauthorized; 404/422 &#39;Invalid ticket!&#39; when the id is unknown or owned by another account. Caveats: the same path with POST appends a reply (postTicketInfo) and DELETE closes the ticket (deleteTicketInfo) — it does not destroy data. Siblings: ReplyTicket, updateTicketInfo, CloseTicket, getTicketsList.
   ...
   * @return ViewTicketResponse
  */
  public ViewTicketResponse getTicketInfo (BigDecimal id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getTicketInfo",
        new ApiException(400, "Missing the required parameter 'id' when calling getTicketInfo"));
    }
   ...
   * @param id Ticket ID number.
  */
  public void getTicketInfo (BigDecimal id, final Response.Listener<ViewTicketResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Use to browse the customer&#39;s helpdesk tickets, paginated, with optional status and recency filters. Returns tickets where email matches the session account_lid. Query params: page (int, default 1, 50 per page), period (string: &#39;30&#39;, &#39;90&#39;, &#39;365&#39;, &#39;1825&#39;, or &#39;all&#39; days back; default &#39;30&#39;), view (string: &#39;Open&#39;, &#39;Closed&#39;, &#39;On Hold&#39;, &#39;In Progress&#39;; omit for all). Body: none. Returns: object with tickets[], total, pages, currentPage, st_count[] (counts grouped by status: Open/On Hold/Closed), selected_period, view. Errors: 401 unauthorized session. Note ticketstatusid mapping (Open&#x3D;4, On Hold&#x3D;5, Closed&#x3D;6, In Progress&#x3D;7). To search by subject/email/mask use postTicketsList. To open a ticket detail use getTicketInfo with the returned id. To create a new ticket see addNewTicket.  Sibling ops: &#x60;getTicketInfo&#x60; (detail), &#x60;postTicketsList&#x60; (search), &#x60;addNewTicket&#x60; (open new).
   ...
   * @return Tickets
  */
  public Tickets getTicketsList (Integer page, String period, String view) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    queryParams.addAll(ApiInvoker.parameterToPairs("", "view", view));
    String[] contentTypes = {
    };
    String contentType = contentTypes.length > 0 ? contentTypes[0] : "application/json";
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (Tickets) ApiInvoker.deserialize(localVarResponse, "", Tickets.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * List the authenticated account&#39;s support tickets with status and date filters
   * Use to browse the customer&#39;s helpdesk tickets, paginated, with optional status and recency filters. Returns tickets where email matches the session account_lid. Query params: page (int, default 1, 50 per page), period (string: &#39;30&#39;, &#39;90&#39;, &#39;365&#39;, &#39;1825&#39;, or &#39;all&#39; days back; default &#39;30&#39;), view (string: &#39;Open&#39;, &#39;Closed&#39;, &#39;On Hold&#39;, &#39;In Progress&#39;; omit for all). Body: none. Returns: object with tickets[], total, pages, currentPage, st_count[] (counts grouped by status: Open/On Hold/Closed), selected_period, view. Errors: 401 unauthorized session. Note ticketstatusid mapping (Open&#x3D;4, On Hold&#x3D;5, Closed&#x3D;6, In Progress&#x3D;7). To search by subject/email/mask use postTicketsList. To open a ticket detail use getTicketInfo with the returned id. To create a new ticket see addNewTicket.  Sibling ops: &#x60;getTicketInfo&#x60; (detail), &#x60;postTicketsList&#x60; (search), &#x60;addNewTicket&#x60; (open new).
   * @param page Page number for paginated results.   * @param period How far back to show tickets from. Value is in days.   * @param view The status of tickets to view. Possible values are Open, Closed, On Hold, and In Progress.  If not specified it will show all types.
  */
  public void getTicketsList (Integer page, String period, String view, final Response.Listener<Tickets> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((Tickets) ApiInvoker.deserialize(localVarResponse,  "", Tickets.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * Use to post a customer reply on an existing ticket. Path: id (int ticket ID). Body: body (string reply text; trimmed to first 500 words), file_attachment (multipart upload, optional), and the server-access custom fields ip/root_pass/sudo_user/sudo_pass/port_no/server_access (passwords AES-encrypted with auth_key&#x3D;7). Either body OR an attachment is required. Notifies any swticketwatchers staff via templated email after posting. Returns: {status: &#39;success&#39;, message: &#39;Reply posted successfully&#39;}. Errors: 400 &#39;Please enter a message or attach a file&#39;; 401 unauthorized; 404/422 &#39;Invalid ticket!&#39; when id missing or cross-account. Sibling: ReplyTicket (cleaner JSON-only reply at /tickets/{id}/reply), updateTicketInfo, getTicketInfo, deleteTicketInfo.
   ...
   * @return ViewTicketResponse
  */
  public ViewTicketResponse postTicketInfo (BigDecimal id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling postTicketInfo",
        new ApiException(400, "Missing the required parameter 'id' when calling postTicketInfo"));
    }
   ...
   * @param id Ticket ID number.
  */
  public void postTicketInfo (BigDecimal id, final Response.Listener<ViewTicketResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Use when the user supplies a search term (subject keyword, email substring, or full ticket mask ID like &#39;ABC-123-456&#39;). Scoped to tickets owned by the session account_lid. Body (form): search (string, required). If the term contains exactly two hyphens it is treated as an exact ticketmaskid match; otherwise a LIKE search runs across subject, email, and ticketmaskid. Returns: array of up to 25 matching ticket rows ordered by lastactivity DESC, each enriched with lastactivity_time (human-relative). Errors: 400 if search is empty or missing; 401 unauthorized. Caveat: this is a POST that reads, not a creator. To create see addNewTicket. To paginate full inbox use getTicketsList. To open one use getTicketInfo.  Sibling ops: &#x60;getTicketsList&#x60; (full inbox), &#x60;getTicketInfo&#x60; (detail), &#x60;addNewTicket&#x60; (open new).
   * @return Tickets
  */
  public Tickets postTicketsList () throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
  ...
  */
  public void postTicketsList (final Response.Listener<Tickets> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Reserved for future use to update ticket subject/status. The PHP handler is currently an empty stub that returns no body, so callers should not rely on it in production. Path: id (int). Body: would carry subject/status fields when implemented. Returns: undefined behavior today. Errors: 401 unauthorized; expect 404/422 when implemented if id is invalid or not owned. Caveats: prefer updateTicketInfo (POST /tickets/{id}/update) for editing custom-field values today, postTicketInfo to add a reply, CloseTicket or deleteTicketInfo to close. Avoid scripting against this endpoint until the handler ships. Siblings: getTicketInfo, ReplyTicket.
   ...
   * @return ViewTicketResponse
  */
  public ViewTicketResponse putTicketInfo (BigDecimal id) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling putTicketInfo",
        new ApiException(400, "Missing the required parameter 'id' when calling putTicketInfo"));
    }
   ...
   * @param id Ticket ID number.
  */
  public void putTicketInfo (BigDecimal id, final Response.Listener<ViewTicketResponse> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public ReplyTicketResponseSchema replyTicket (BigDecimal id, ReplyTicketRequest replyTicketRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = replyTicketRequest;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling replyTicket",
        new ApiException(400, "Missing the required parameter 'id' when calling replyTicket"));
    }

    // create path and map variables
    String path = "/tickets/{id}/reply".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (ReplyTicketResponseSchema) ApiInvoker.deserialize(localVarResponse, "", ReplyTicketResponseSchema.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Post a simple text reply to an existing ticket thread (no attachments)
   * Use this lightweight endpoint to add a reply to an existing ticket without attachments or server-access fields. Cleaner alternative to postTicketInfo when only text is being submitted. Path: id (int ticket ID). Body (form): content (string, required reply body). Returns: {success: true, post_id: int} on success or {success: false, text: &#39;Reply content cannot be empty!&#39; | &#39;Unable to reply ticket&#39;}. Errors: 401 unauthorized; 404 implied via &#39;Unable to reply ticket&#39; when id is invalid or owned by another account. Siblings: postTicketInfo (POST /tickets/{id}, supports attachments + custom fields), updateTicketInfo (custom fields only), CloseTicket, getTicketInfo to verify the new post_id appears in the thread.
   * @param id The ticket ID number.   * @param replyTicketRequest 
  */
  public void replyTicket (BigDecimal id, ReplyTicketRequest replyTicketRequest, final Response.Listener<ReplyTicketResponseSchema> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = replyTicketRequest;
    ...
    // create path and map variables
    String path = "/tickets/{id}/reply".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ReplyTicketResponseSchema) ApiInvoker.deserialize(localVarResponse,  "", ReplyTicketResponseSchema.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  */
  public UpdateTicketResponseSchema updateTicketInfo (BigDecimal id, UpdateTicket updateTicket) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = updateTicket;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling updateTicketInfo",
        new ApiException(400, "Missing the required parameter 'id' when calling updateTicketInfo"));
    }

    // create path and map variables
    String path = "/tickets/{id}/update".replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (UpdateTicketResponseSchema) ApiInvoker.deserialize(localVarResponse, "", UpdateTicketResponseSchema.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Update a ticket&#39;s custom field values (server-access details, etc.)
   * Use to save or change the structured custom-field values attached to a ticket — typically server-access details supplied by the customer. Path: id (int ticket ID). Body (form): one field per custom-field title, lowercased with spaces replaced by underscores (e.g. ip, root_pass, sudo_user, sudo_pass, port_no, server_access). Field id 7 (auth_key) is skipped — never set it directly. Returns: {success: true, text: &#39;Ticket is updated!&#39;} or {success: false, text: &#39;Unable to update ticket&#39;}. Errors: 401 unauthorized; 404 invalid or non-owned ticket. Caveats: this updates metadata only — to add a reply use ReplyTicket, to close use CloseTicket, to read current state use getTicketInfo.  Sibling ops: &#x60;getTicketInfo&#x60; (read), &#x60;ReplyTicket&#x60; (reply), &#x60;CloseTicket&#x60; (close).
   * @param id The ticket ID number.   * @param updateTicket 
  */
  public void updateTicketInfo (BigDecimal id, UpdateTicket updateTicket, final Response.Listener<UpdateTicketResponseSchema> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = updateTicket;
    ...
    // create path and map variables
    String path = "/tickets/{id}/update".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((UpdateTicketResponseSchema) ApiInvoker.deserialize(localVarResponse,  "", UpdateTicketResponseSchema.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
