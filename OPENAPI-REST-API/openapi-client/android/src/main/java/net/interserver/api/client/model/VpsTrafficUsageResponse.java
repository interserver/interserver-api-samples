...
import net.interserver.api.client.model.VpsTrafficUsageAverageResponse;
...
public class VpsTrafficUsageResponse implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.current == null ? vpsTrafficUsageResponse.current == null : this.current.equals(vpsTrafficUsageResponse.current)) &&
        (this.peak == null ? vpsTrafficUsageResponse.peak == null : this.peak.equals(vpsTrafficUsageResponse.peak)) &&
        (this.average == null ? vpsTrafficUsageResponse.average == null : this.average.equals(vpsTrafficUsageResponse.average));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.peak == null ? 0: this.peak.hashCode());
