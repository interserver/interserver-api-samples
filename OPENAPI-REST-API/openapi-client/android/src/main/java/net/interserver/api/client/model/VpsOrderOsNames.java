...
public class VpsOrderOsNames implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.opensuse == null ? vpsOrderOsNames.opensuse == null : this.opensuse.equals(vpsOrderOsNames.opensuse)) &&
        (this.ubuntu == null ? vpsOrderOsNames.ubuntu == null : this.ubuntu.equals(vpsOrderOsNames.ubuntu));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.opensuse == null ? 0: this.opensuse.hashCode());
    result = 31 * result + (this.ubuntu == null ? 0: this.ubuntu.hashCode());
    return result;
  }
