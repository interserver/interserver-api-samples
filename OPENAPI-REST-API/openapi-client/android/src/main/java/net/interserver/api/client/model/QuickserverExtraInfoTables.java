...
import net.interserver.api.client.model.QuickserverAddons;
import net.interserver.api.client.model.QuickserverIpInfo;
...
public class QuickserverExtraInfoTables implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return (this.ipInfo == null ? quickserverExtraInfoTables.ipInfo == null : this.ipInfo.equals(quickserverExtraInfoTables.ipInfo)) &&
        (this.addons == null ? quickserverExtraInfoTables.addons == null : this.addons.equals(quickserverExtraInfoTables.addons));
  }

  @Override
  public int hashCode() {
    int result = 17;
    result = 31 * result + (this.ipInfo == null ? 0: this.ipInfo.hashCode());
