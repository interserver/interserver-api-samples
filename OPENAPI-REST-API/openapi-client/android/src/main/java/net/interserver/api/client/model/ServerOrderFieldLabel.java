...
public class ServerOrderFieldLabel implements Serializable {
   ...
   **/
  @ApiModelProperty(value = "Name of the field label.")
   ...
   **/
  @ApiModelProperty(value = "Active status of the field label.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? serverOrderFieldLabel.name == null : this.name.equals(serverOrderFieldLabel.name)) &&
        (this.active == null ? serverOrderFieldLabel.active == null : this.active.equals(serverOrderFieldLabel.active));
  }
