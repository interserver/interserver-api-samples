...
import net.interserver.api.client.auth.Authentication;
import net.interserver.api.client.auth.ApiKeyAuth;
import net.interserver.api.client.auth.HttpBasicAuth;
import net.interserver.api.client.request.GetRequest;
import net.interserver.api.client.request.PostRequest;
import net.interserver.api.client.request.PutRequest;
import net.interserver.api.client.request.DeleteRequest;
import net.interserver.api.client.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("sessionIdHeaderAuth", new ApiKeyAuth("header", "sessionid"));
    INSTANCE.authentications.put("sessionIdCookieAuth", new ApiKeyAuth("query", "sessionid"));
