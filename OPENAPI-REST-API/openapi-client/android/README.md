...
```xml
<dependency>
    <groupId>net.interserver</groupId>
    <artifactId>interserver-api-android</artifactId>
...
```groovy
compile "net.interserver:interserver-api-android:1.0.0"
```
...
- target/interserver-api-android-1.0.0.jar
- target/lib/*.jar
