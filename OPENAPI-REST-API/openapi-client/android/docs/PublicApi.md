...
```java
// Import classes:
//import net.interserver.api.client.api.PublicApi;

PublicApi apiInstance = new PublicApi();
try {
    List<String> result = apiInstance.getAccountCurrencies();
...
PublicApi apiInstance = new PublicApi();
try {
    Map<String, GetAccountLocales200ResponseValue> result = apiInstance.getAccountLocales();
    System.out.println(result);
} catch (ApiException e) {
...
PublicApi apiInstance = new PublicApi();
String fetchBy = null; // String | Get countries by iso2 or iso3 or numcode
try {
...
------------- | ------------- | ------------- | -------------
 **fetchBy** | **String**| Get countries by iso2 or iso3 or numcode | [optional] [default to null] [enum: iso2, iso3, numcode]
...
PublicApi apiInstance = new PublicApi();
String provider = null; // String | The OAuth provider name (e.g. `Google`).
try {
...
PublicApi apiInstance = new PublicApi();
String login = null; // String | 
String passwd = null; // String | 
String remember = null; // String | 
LoginSubmissionExampleGRecaptchaResponse gRecaptchaResponse = null; // LoginSubmissionExampleGRecaptchaResponse | 
String tfa = null; // String | Two Factor Authentication Response.
try {
...
PublicApi apiInstance = new PublicApi();
LoginSubmissionExample loginSubmissionExample = {"login":"user@domain.com","passwd":"mypassword","remember":"true","g-recaptcha-response":{"__v_isShallow":false,"dep":{"w":0,"n":0},"__v_isRef":true,"_rawValue":"zzzzz","_value":"zzzzz"}}; // LoginSubmissionExample | 
try {
