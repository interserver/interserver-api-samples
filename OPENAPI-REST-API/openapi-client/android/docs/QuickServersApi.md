...
```java
// Import classes:
//import net.interserver.api.client.api.QuickServersApi;

QuickServersApi apiInstance = new QuickServersApi();
QsOrderRequest qsOrderRequest = new QsOrderRequest(); // QsOrderRequest | 
try {
    ServiceOrderPostResponse result = apiInstance.addQs(qsOrderRequest);
...
QuickServersApi apiInstance = new QuickServersApi();
Integer id = null; // Integer | QuickServer ID number
String file = null; // String | The backup filename to delete.
String all = null; // String | Set to `1` to list all backups across all services, not just the ones for the given QuickServer.
try {
...
QuickServersApi apiInstance = new QuickServersApi();
String id = null; // String | QuickServer ID number.
try {
