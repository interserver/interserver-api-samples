...
```java
// Import classes:
//import net.interserver.api.client.api.DomainsApi;

DomainsApi apiInstance = new DomainsApi();
DomainOrderRequest domainOrderRequest = new DomainOrderRequest(); // DomainOrderRequest | 
try {
    ServiceOrderPostResponse result = apiInstance.addDomain(domainOrderRequest);
...
DomainsApi apiInstance = new DomainsApi();
Integer id = null; // Integer | The domain service ID. Use `domain_id` from `GET /domains`.
...
Integer id = null; // Integer | The domain service ID. Use `domain_id` from `GET /domains`.
try {
    SuccessTextResponse result = apiInstance.deleteDomainDnssec(id);
    System.out.println(result);
} catch (ApiException e) {
...
DomainsApi apiInstance = new DomainsApi();
Integer id = null; // Integer | The domain service ID. Use `domain_id` from `GET /domains`.
Integer index = null; // Integer | The index of the registered nameserver from the registered nameservers list to delete.  
try {
...
DomainsApi apiInstance = new DomainsApi();
String name = null; // String | The full domain name to look up (for example `example.com`).
try {
...
DomainsApi apiInstance = new DomainsApi();
String name = null; // String | The base domain name to search (for example `example` or `example.com`).
try {
