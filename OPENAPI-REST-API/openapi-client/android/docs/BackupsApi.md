...
```java
// Import classes:
//import net.interserver.api.client.api.BackupsApi;

BackupsApi apiInstance = new BackupsApi();
Boolean validateOnly = null; // Boolean | 
Integer serviceType = null; // Integer | 
String coupon = null; // String | 
try {
...
BackupsApi apiInstance = new BackupsApi();
Integer id = null; // Integer | The backup service ID. Use the `backup_id` from `GET /backups` to identify the service.
try {
