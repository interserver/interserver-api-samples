...
```java
// Import classes:
//import net.interserver.api.client.api.SSLCertificatesApi;
...
SSLCertificatesApi apiInstance = new SSLCertificatesApi();
Integer id = null; // Integer | SSL certificate ID number.
try {
...
SSLCertificatesApi apiInstance = new SSLCertificatesApi();
Integer id = null; // Integer | SSL Cert ID number
try {
...
SSLCertificatesApi apiInstance = new SSLCertificatesApi();
String id = null; // String | SSL certificate ID number.
try {
