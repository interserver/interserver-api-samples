...
```java
// Import classes:
//import net.interserver.api.client.api.BillingApi;
...
BillingApi apiInstance = new BillingApi();
Integer id = null; // Integer | The credit card ID to remove. Use IDs from `GET /billing/creditcards`.
try {
...
BillingApi apiInstance = new BillingApi();
Integer id = null; // Integer | The invoice ID to delete. Only unpaid invoices can be deleted.
try {
...
BillingApi apiInstance = new BillingApi();
Integer id = null; // Integer | The prepay balance ID to delete.
try {
...
BillingApi apiInstance = new BillingApi();
String st = null; // String | Filter by status.
String ex = null; // String | Export format: csv, xls, xlsx, or pdf. Defaults to csv.
Integer year = null; // Integer | Year to filter the report. Defaults to the current year.
try {
 ...
 **ex** | **String**| Export format: csv, xls, xlsx, or pdf. Defaults to csv. | [optional] [default to null] [enum: csv, xls, xlsx, pdf]
...
BillingApi apiInstance = new BillingApi();
Integer days = null; // Integer | Number of days of sales history to include in the graph data. Determines the time window for the returned data points.
try {
...
> GetAffiliateSignups200Response getAffiliateSignups(st)
...
BillingApi apiInstance = new BillingApi();
String st = null; // String | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.
try {
    GetAffiliateSignups200Response result = apiInstance.getAffiliateSignups(st);
    System.out.println(result);
} catch (ApiException e) {
...
BillingApi apiInstance = new BillingApi();
Integer days = null; // Integer | Number of days of traffic history to include in the graph data. Determines the time window for the returned data points.
try {
...
BillingApi apiInstance = new BillingApi();
Integer id = null; // Integer | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
try {
...
BillingApi apiInstance = new BillingApi();
Integer id = null; // Integer | The invoice ID. Use IDs from `GET /billing/invoices` or from order responses.
try {
...
BillingApi apiInstance = new BillingApi();
String method = null; // String | The payment method to use. Valid values: `cc` (credit card), `paypal`, `prepay`, `payssion`, `payu`, `ccavenue`, `cashfree`, `coinbase`, `btcpay`.
String invoices = null; // String | A comma-separated list of invoice IDs or invoice Tags to pay. These IDs are returned by order endpoints (e.g. `/backups/order`, `/vps/order`) and by `/billing/invoices`. Invoice tags accepted are SERVICE<module><id>, RINV<module><repeat invoice id>, INV<module><invoice id>, PREPAY<prepay id><invoice id>, and <invoice id>.
try {
...
> SuccessTextResponse patchBillingCreditCardVerify(id, patchBillingCreditCardVerifyRequest)
...
BillingApi apiInstance = new BillingApi();
Integer id = null; // Integer | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
PatchBillingCreditCardVerifyRequest patchBillingCreditCardVerifyRequest = new PatchBillingCreditCardVerifyRequest(); // PatchBillingCreditCardVerifyRequest | 
try {
    SuccessTextResponse result = apiInstance.patchBillingCreditCardVerify(id, patchBillingCreditCardVerifyRequest);
    System.out.println(result);
} catch (ApiException e) {
...
BillingApi apiInstance = new BillingApi();
String affiliateDockTitle = null; // String | 
String affiliateDockDescription = null; // String | 
String referrerCoupon = null; // String | 
try {
...
BillingApi apiInstance = new BillingApi();
String affiliatePaypal = null; // String | 
String affiliatePaymentMethod = null; // String | 
try {
...
BillingApi apiInstance = new BillingApi();
Integer id = null; // Integer | The credit card ID. Use IDs from `GET /billing/creditcards` or the response from `POST /billing/creditcards`.
try {
