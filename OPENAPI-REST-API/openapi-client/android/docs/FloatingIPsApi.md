...
```java
// Import classes:
//import net.interserver.api.client.api.FloatingIPsApi;

FloatingIPsApi apiInstance = new FloatingIPsApi();
FloatingIpOrderRequest floatingIpOrderRequest = new FloatingIpOrderRequest(); // FloatingIpOrderRequest | 
try {
    ServiceOrderPostResponse result = apiInstance.addFloatingIp(floatingIpOrderRequest);
...
FloatingIPsApi apiInstance = new FloatingIPsApi();
Integer id = null; // Integer | The Floating IP service ID. Use the ID from `GET /floating_ips`.
try {
...
FloatingIPsApi apiInstance = new FloatingIPsApi();
Integer id = null; // Integer | The Floating IP service ID. Use the ID from `GET /floating_ips`.
String ip = null; // String | IP Address
try {
...
FloatingIPsApi apiInstance = new FloatingIPsApi();
String id = null; // String | The Floating IP service ID. Use the ID from `GET /floating_ips`.
try {
