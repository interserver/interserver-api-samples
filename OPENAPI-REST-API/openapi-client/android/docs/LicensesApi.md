...
```java
// Import classes:
//import net.interserver.api.client.api.LicensesApi;

LicensesApi apiInstance = new LicensesApi();
LicenseOrderRequest licenseOrderRequest = new LicenseOrderRequest(); // LicenseOrderRequest | 
try {
    ServiceOrderPostResponse result = apiInstance.addLicense(licenseOrderRequest);
...
LicensesApi apiInstance = new LicensesApi();
Integer id = null; // Integer | The license service ID. Use `license_id` from `GET /licenses`.
try {
...
LicensesApi apiInstance = new LicensesApi();
String id = null; // String | The license service ID. Use `license_id` from `GET /licenses`.
try {
