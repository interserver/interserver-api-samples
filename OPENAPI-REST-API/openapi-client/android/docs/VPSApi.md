...
```java
// Import classes:
//import net.interserver.api.client.api.VPSApi;
...
VPSApi apiInstance = new VPSApi();
Integer id = null; // Integer | VPS ID number
String file = null; // String | The backup filename to delete.
String all = null; // String | Set to `1` to list all backups across all services, not just the ones for the given VPS.
try {
...
VPSApi apiInstance = new VPSApi();
Integer id = null; // Integer | VPS ID number
String timezone = null; // String | The time zone
try {
...
VPSApi apiInstance = new VPSApi();
Integer id = null; // Integer | VPS ID number
String template = null; // String | OS Template Filename
String localPassword = null; // String | Password for this account.
String password = null; // String | Password for Root / Administrator Account.
try {
...
VPSApi apiInstance = new VPSApi();
String id = null; // String | VPS ID number.
try {
