...
```java
// Import classes:
//import net.interserver.api.client.api.ServersApi;

ServersApi apiInstance = new ServersApi();
ServerOrderPostRequest serverOrderPostRequest = new ServerOrderPostRequest(); // ServerOrderPostRequest | 
try {
    AddServer200Response result = apiInstance.addServer(serverOrderPostRequest);
...
ServersApi apiInstance = new ServersApi();
Integer id = null; // Integer | Server ID number.
try {
...
ServersApi apiInstance = new ServersApi();
String ids = 2313,2314,2315; // String | Comma-separated list of Server IDs to query (e.g. `2313,2314,2315`). May also be passed as repeated `ids[]` query parameters.
try {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ids** | **String**| Comma-separated list of Server IDs to query (e.g. &#x60;2313,2314,2315&#x60;). May also be passed as repeated &#x60;ids[]&#x60; query parameters. | [default to null]
...
ServersApi apiInstance = new ServersApi();
Integer id = null; // Integer | Server ID number
String ip = null; // String | Your IP Address you wish to connect to the IPMI system from.
Integer asset = null; // Integer | Asset ID
try {
...
ServersApi apiInstance = new ServersApi();
Integer id = null; // Integer | Server ID number
String action = null; // String | The power action to send to the ipmi controller.
Integer asset = null; // Integer | The Asset ID
try {
...
ServersApi apiInstance = new ServersApi();
String id = null; // String | Server ID number.
try {
