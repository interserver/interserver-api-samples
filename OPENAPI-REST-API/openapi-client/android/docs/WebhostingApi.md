...
```java
// Import classes:
//import net.interserver.api.client.api.WebhostingApi;

WebhostingApi apiInstance = new WebhostingApi();
WebsiteOrderPostRequest websiteOrderPostRequest = new WebsiteOrderPostRequest(); // WebsiteOrderPostRequest | 
try {
    ServiceOrderPostResponse result = apiInstance.addWebsite(websiteOrderPostRequest);
...
WebhostingApi apiInstance = new WebhostingApi();
Integer id = null; // Integer | The website service ID. Use `website_id` from `GET /websites`.
try {
...
WebhostingApi apiInstance = new WebhostingApi();
WebsiteOrderPutRequest websiteOrderPutRequest = new WebsiteOrderPutRequest(); // WebsiteOrderPutRequest | 
try {
...
WebhostingApi apiInstance = new WebhostingApi();
String id = null; // String | The website service ID. Use `website_id` from `GET /websites`.
try {
