...
```java
// Import classes:
//import net.interserver.api.client.api.TicketsApi;
...
TicketsApi apiInstance = new TicketsApi();
BigDecimal id = null; // BigDecimal | Ticket ID number.
try {
...
String view = null; // String | The status of tickets to view. Possible values are Open, Closed, On Hold, and In Progress.  If not specified it will show all types.
try {
...
TicketsApi apiInstance = new TicketsApi();
BigDecimal id = null; // BigDecimal | The ticket ID number.
