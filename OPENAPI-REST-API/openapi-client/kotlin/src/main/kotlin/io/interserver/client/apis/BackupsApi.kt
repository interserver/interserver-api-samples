...
open class BackupsApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    suspend fun addBackup(validateOnly: kotlin.Boolean? = null, serviceType: kotlin.Int? = null, coupon: kotlin.String? = null) : BackupOrderPostResponse = withContext(Dispatchers.IO) {
    ...
    suspend fun addBackupWithHttpInfo(validateOnly: kotlin.Boolean?, serviceType: kotlin.Int?, coupon: kotlin.String?) : ApiResponse<BackupOrderPostResponse?> = withContext(Dispatchers.IO) {
        val localVariableConfig = addBackupRequestConfig(validateOnly = validateOnly, serviceType = serviceType, coupon = coupon)

        return@withContext request<Map<String, PartConfig<*>>, BackupOrderPostResponse>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun cancelBackup(id: kotlin.Int) : CancelBackup200Response = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun cancelBackupWithHttpInfo(id: kotlin.Int) : ApiResponse<CancelBackup200Response?> = withContext(Dispatchers.IO) {
        val localVariableConfig = cancelBackupRequestConfig(id = id)

        return@withContext request<Unit, CancelBackup200Response>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getBackupInfo(id: kotlin.Int) : Backup = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun getBackupInfoWithHttpInfo(id: kotlin.Int) : ApiResponse<Backup?> = withContext(Dispatchers.IO) {
        val localVariableConfig = getBackupInfoRequestConfig(id = id)

        return@withContext request<Unit, Backup>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getBackupInvoices(id: kotlin.Int) : ChargeInvoiceRows = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun getBackupInvoicesWithHttpInfo(id: kotlin.Int) : ApiResponse<ChargeInvoiceRows?> = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getBackupLogin(id: kotlin.Int) : BackupLoginResponse = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun getBackupLoginWithHttpInfo(id: kotlin.Int) : ApiResponse<BackupLoginResponse?> = withContext(Dispatchers.IO) {
        val localVariableConfig = getBackupLoginRequestConfig(id = id)

        return@withContext request<Unit, BackupLoginResponse>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getBackupsList() : kotlin.collections.List<BackupRow> = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun getBackupsListWithHttpInfo() : ApiResponse<kotlin.collections.List<BackupRow>?> = withContext(Dispatchers.IO) {
        val localVariableConfig = getBackupsListRequestConfig()

        return@withContext request<Unit, kotlin.collections.List<BackupRow>>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getBackupsWelcomeEmail(id: kotlin.Int) : SuccessTextResponse = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun getBackupsWelcomeEmailWithHttpInfo(id: kotlin.Int) : ApiResponse<SuccessTextResponse?> = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getNewBackup() : BackupsOrder = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun getNewBackupWithHttpInfo() : ApiResponse<BackupsOrder?> = withContext(Dispatchers.IO) {
        val localVariableConfig = getNewBackupRequestConfig()

        return@withContext request<Unit, BackupsOrder>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun updateBackupInfo(id: kotlin.Int) : SuccessTextResponse = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun updateBackupInfoWithHttpInfo(id: kotlin.Int) : ApiResponse<SuccessTextResponse?> = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun validateBackupOrder(validateOnly: kotlin.Boolean? = null, serviceType: kotlin.Int? = null, coupon: kotlin.String? = null) : BackupOrderPutResponse = withContext(Dispatchers.IO) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun validateBackupOrderWithHttpInfo(validateOnly: kotlin.Boolean?, serviceType: kotlin.Int?, coupon: kotlin.String?) : ApiResponse<BackupOrderPutResponse?> = withContext(Dispatchers.IO) {
        val localVariableConfig = validateBackupOrderRequestConfig(validateOnly = validateOnly, serviceType = serviceType, coupon = coupon)

        return@withContext request<Map<String, PartConfig<*>>, BackupOrderPutResponse>(
            localVariableConfig
        )
    }
