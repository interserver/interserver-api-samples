...
try {
    val result : GetAffiliateSignups200Response = apiInstance.getAffiliateSignups(st)
    println(result)
} catch (e: ClientException) {
...
<a id="patchBillingCreditCardVerify"></a>
...
try {
    val result : SuccessTextResponse = apiInstance.patchBillingCreditCardVerify(id, patchBillingCreditCardVerifyRequest)
    println(result)
} catch (e: ClientException) {
