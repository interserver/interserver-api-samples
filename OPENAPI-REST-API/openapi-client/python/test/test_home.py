    ...
    def make_instance(self, include_optional) -> Home:
        ...
        if include_optional:
            return Home(
                ...
                ticket_status = interserver_api_client.models.home_ticket_status.Home_ticketStatus(
                    open = 4, 
                    on_hold = 5, ),
                ticket_status_view = interserver_api_client.models.home_ticket_status_view.Home_ticketStatusView(
                    4 = 'Open', 
                    5 = 'On Hold', 
                    6 = 'Closed', ),
                details = interserver_api_client.models.home_details.Home_details(
                ...
                services = interserver_api_client.models.home_services.Home_services(
