...
json = "{}"
# create an instance of WebsiteOrderPostRequest from a JSON string
website_order_post_request_instance = WebsiteOrderPostRequest.from_json(json)
# print the JSON string representation of the object
print(WebsiteOrderPostRequest.to_json())

# convert the object into a dict
website_order_post_request_dict = website_order_post_request_instance.to_dict()
# create an instance of WebsiteOrderPostRequest from a dict
website_order_post_request_from_dict = WebsiteOrderPostRequest.from_dict(website_order_post_request_dict)
```
