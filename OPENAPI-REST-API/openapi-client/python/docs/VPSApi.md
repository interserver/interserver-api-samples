...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.VPSApi(api_client)
    vps_order_post_request = interserver_api_client.VpsOrderPostRequest() # VpsOrderPostRequest |  (optional)
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.VPSApi(api_client)
    id = 56 # int | VPS ID number
    download_qs_backup_request = interserver_api_client.DownloadQsBackupRequest() # DownloadQsBackupRequest | 
    all = 'all_example' # str | Set to `1` to list all backups across all services, not just the ones for the given VPS. (optional)
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Trigger a manual on-demand snapshot/backup of the VPS
        api_response = api_instance.get_vps_backup(id)
        print("The response of VPSApi->get_vps_backup:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VPSApi->get_vps_backup: %s\n" % e)
```
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling VPSApi->get_vps_change_hostname: %s\n" % e)
```
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling VPSApi->get_vps_change_root_password: %s\n" % e)
```
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling VPSApi->get_vps_insert_cd: %s\n" % e)
```
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling VPSApi->get_vps_reset_password: %s\n" % e)
```
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.VPSApi(api_client)
    id = 56 # int | VPS ID number
    restore_request = interserver_api_client.RestoreRequest() # RestoreRequest | VPS Restore request
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.VPSApi(api_client)
    id = 56 # int | VPS ID number
    reverse_dns_entries = interserver_api_client.ReverseDnsEntries() # ReverseDnsEntries | 
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling VPSApi->post_vps_traffic_usage: %s\n" % e)
```
...
with interserver_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = interserver_api_client.VPSApi(api_client)
    vps_order_put_request = interserver_api_client.VpsOrderPutRequest() # VpsOrderPutRequest |  (optional)
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling VPSApi->put_vps_buy_hd_space: %s\n" % e)
```
