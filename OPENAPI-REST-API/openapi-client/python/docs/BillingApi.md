# interserver_api_client.BillingApi
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.BillingApi(api_client)
    billing_add_cc_request = interserver_api_client.BillingAddCcRequest() # BillingAddCcRequest | 
...
with interserver_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = interserver_api_client.BillingApi(api_client)
    billing_prepay_request = interserver_api_client.BillingPrepayRequest() # BillingPrepayRequest | 
...
> get_affiliate_download(st=st, ex=ex, year=year)
...
with interserver_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = interserver_api_client.BillingApi(api_client)
    st = 'st_example' # str | Filter by status. (optional)
    ex = 'ex_example' # str | Export format: csv, xls, xlsx, or pdf. Defaults to csv. (optional)
    year = 56 # int | Year to filter the report. Defaults to the current year. (optional)

    try:
        # Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
        api_instance.get_affiliate_download(st=st, ex=ex, year=year)
    except Exception as e:
        print("Exception when calling BillingApi->get_affiliate_download: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **str**| Filter by status. | [optional] 
 **ex** | **str**| Export format: csv, xls, xlsx, or pdf. Defaults to csv. | [optional] 
...
> GetAffiliateSignups200Response get_affiliate_signups(st=st)
...
with interserver_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = interserver_api_client.BillingApi(api_client)
    st = 'st_example' # str | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results. (optional)

    try:
        # Read affiliate signup stats and per-customer conversion data
        api_response = api_instance.get_affiliate_signups(st=st)
        print("The response of BillingApi->get_affiliate_signups:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BillingApi->get_affiliate_signups: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **st** | **str**| Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. | [optional] 
 ...
 **invoices** | **str**| A comma-separated list of invoice IDs or invoice Tags to pay. These IDs are returned by order endpoints (e.g. &#x60;/backups/order&#x60;, &#x60;/vps/order&#x60;) and by &#x60;/billing/invoices&#x60;. Invoice tags accepted are SERVICE&lt;module&gt;&lt;id&gt;, RINV&lt;module&gt;&lt;repeat invoice id&gt;, INV&lt;module&gt;&lt;invoice id&gt;, PREPAY&lt;prepay id&gt;&lt;invoice id&gt;, and &lt;invoice id&gt;. | 
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.BillingApi(api_client)
    id = 56 # int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
    patch_billing_credit_card_verify_request = interserver_api_client.PatchBillingCreditCardVerifyRequest() # PatchBillingCreditCardVerifyRequest | 

    try:
        # Place two micro-charges on the card to start CVV verification (step 1 of 2)
        api_response = api_instance.patch_billing_credit_card_verify(id, patch_billing_credit_card_verify_request)
        print("The response of BillingApi->patch_billing_credit_card_verify:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BillingApi->patch_billing_credit_card_verify: %s\n" % e)
```
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.BillingApi(api_client)
    id = 56 # int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
    billing_verify_cc_request = interserver_api_client.BillingVerifyCcRequest() # BillingVerifyCcRequest | 
...
with interserver_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = interserver_api_client.BillingApi(api_client)
    billing_payment_method_request = interserver_api_client.BillingPaymentMethodRequest() # BillingPaymentMethodRequest | 
