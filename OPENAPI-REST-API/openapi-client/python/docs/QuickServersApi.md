...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.QuickServersApi(api_client)
    qs_order_request = interserver_api_client.QsOrderRequest() # QsOrderRequest | 

    try:
        # Place a QuickServer order, generating a real invoice and queuing provisioning
        api_response = api_instance.add_qs(qs_order_request)
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of QuickServersApi->get_qs_backup:\n")
        pprint(api_response)
    except Exception as e:
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.QuickServersApi(api_client)
    id = 56 # int | QuickServer ID number
    restore_request = interserver_api_client.RestoreRequest() # RestoreRequest | QuickServer Restore request
