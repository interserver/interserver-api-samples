# interserver_api_client.WebhostingApi
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.WebhostingApi(api_client)
    website_order_post_request = interserver_api_client.WebsiteOrderPostRequest() # WebsiteOrderPostRequest | 

    try:
        # Place a new webhosting order, create the invoice, and queue provisioning
        api_response = api_instance.add_website(website_order_post_request)
...
```python
import interserver_api_client
from interserver_api_client.models.post_website_buy_ip200_response import PostWebsiteBuyIp200Response
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.WebhostingApi(api_client)
    id = 56 # int | The website service ID. Use `website_id` from `GET /websites`.
    post_website_buy_ip_request = interserver_api_client.PostWebsiteBuyIpRequest() # PostWebsiteBuyIpRequest | 
...
with interserver_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = interserver_api_client.WebhostingApi(api_client)
    id = 56 # int | The website service ID. Use `website_id` from `GET /websites`.
    post_website_migration_request = interserver_api_client.PostWebsiteMigrationRequest() # PostWebsiteMigrationRequest | 
...
with interserver_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = interserver_api_client.WebhostingApi(api_client)
    website_order_put_request = interserver_api_client.WebsiteOrderPutRequest() # WebsiteOrderPutRequest | 
