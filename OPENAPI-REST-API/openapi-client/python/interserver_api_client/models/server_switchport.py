...
class ServerSwitchport(BaseModel):
    ...
    ServerSwitchport
    """ # noqa: E501
    switchport_id: StrictInt = Field(description="Unique identifier for the switchport.", json_schema_extra={"examples": [10414]})
    switch_id: StrictStr = Field(description="Unique identifier for the switch associated with the switchport.", json_schema_extra={"examples": ["118"]})
    switch: StrictStr = Field(description="Name of the switch associated with the switchport.", json_schema_extra={"examples": ["edge1"]})
    port: StrictStr = Field(description="Port name on the switch.", json_schema_extra={"examples": ["Ethernet1/33"]})
