...
class DomainOrderRequest(BaseModel):
    ...
    """ # noqa: E501
    hostname: StrictStr = Field(description="Fully-qualified domain to register or transfer (e.g. example.com).")
    type: Optional[StrictStr] = Field(default='register', description="Order type.")
    coupon: Optional[StrictStr] = Field(default='', description="Coupon code (addDomain only).")
    whois_privacy: Optional[StrictStr] = Field(default=None, description="Set to \"enable\" to add Whois privacy (addDomain only).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["hostname", "type", "coupon", "whois_privacy"]
    ...
    def whois_privacy_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'register',
