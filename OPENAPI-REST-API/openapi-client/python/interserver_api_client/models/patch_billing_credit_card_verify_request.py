...
class PatchBillingCreditCardVerifyRequest(BaseModel):
    """
    PatchBillingCreditCardVerifyRequest
    """ # noqa: E501
    cc_ccv2: StrictStr = Field(description="The CVV/CVC code on the back of the credit card.")
    __properties: ClassVar[List[str]] = ["cc_ccv2"]
