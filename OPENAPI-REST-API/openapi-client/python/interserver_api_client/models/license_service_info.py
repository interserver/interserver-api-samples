...
class LicenseServiceInfo(BaseModel):
    ...
    LicenseServiceInfo
    """ # noqa: E501
    license_id: StrictStr = Field(description="License ID", json_schema_extra={"examples": ["386522"]})
    license_type: StrictStr = Field(description="License type", json_schema_extra={"examples": ["5034"]})
    license_currency: StrictStr = Field(description="License currency", json_schema_extra={"examples": ["USD"]})
    license_order_date: datetime = Field(description="License order date", json_schema_extra={"examples": ["2020-01-14T10:48:14Z"]})
