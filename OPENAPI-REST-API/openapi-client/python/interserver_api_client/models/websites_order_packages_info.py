...
class WebsitesOrderPackagesInfo(BaseModel):
    ...
    """ # noqa: E501
    services_id: StrictStr = Field(description="The ID of the package.", json_schema_extra={"examples": ["11440"]})
    services_name: StrictStr = Field(description="The name of the package.", json_schema_extra={"examples": ["DA BOOST X"]})
    services_cost: StrictStr = Field(description="The cost of the package.", json_schema_extra={"examples": ["69.95"]})
