...
class MailOrderRequest(BaseModel):
    ...
    """ # noqa: E501
    service_type: StrictInt = Field(description="Mail plan service type id from getNewMail.serviceTypes (must be buyable).", alias="serviceType")
    coupon: Optional[StrictStr] = Field(default='', description="Coupon code.")
    comment: Optional[StrictStr] = Field(default='', description="Free-form note saved on the service row (used on addMail).")
