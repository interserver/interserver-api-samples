...
class LicenseOrderRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    package: StrictInt = Field(description="License service type id from getNewLicense.serviceTypes (must be buyable).")
    ip: StrictStr = Field(description="IP address the license is bound to.")
    tos: StrictBool = Field(description="Terms-of-service acceptance. Must be true to place the order.")
    frequency: Optional[StrictInt] = Field(default=1, description="Billing frequency in months.")
    ...
    __properties: ClassVar[List[str]] = ["package", "ip", "tos", "frequency", "coupon", "comment"]
