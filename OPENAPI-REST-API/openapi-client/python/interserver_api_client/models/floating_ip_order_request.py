...
class FloatingIpOrderRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    service_type: StrictInt = Field(description="Floating IP plan service type id from getNewFloatingIp.serviceTypes (must be buyable).", alias="serviceType")
    coupon: Optional[StrictStr] = Field(default='', description="Coupon code.")
    comment: Optional[StrictStr] = Field(default='', description="Free-form note saved on the service row (used on addFloatingIp).")
    __properties: ClassVar[List[str]] = ["serviceType", "coupon", "comment"]
