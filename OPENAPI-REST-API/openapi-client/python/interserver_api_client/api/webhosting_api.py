...
class WebhostingApi:
    ...
    def add_website(
        ...
        :param website_order_post_request: (required)
        :type website_order_post_request: WebsiteOrderPostRequest
        ...
        _param = self._add_website_serialize(
            website_order_post_request=website_order_post_request,
    ...
    def _add_website_serialize(
        ...
        if website_order_post_request is not None:
            _body_params = website_order_post_request
    ...
    def put_websites(
        ...
        :param website_order_put_request: (required)
        :type website_order_put_request: WebsiteOrderPutRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_websites_serialize(
            website_order_put_request=website_order_put_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _put_websites_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if website_order_put_request is not None:
            _body_params = website_order_put_request
