...
from interserver_api_client.api_response import ApiResponse, T as ApiResponseT
import interserver_api_client.models
from interserver_api_client import rest
from interserver_api_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(interserver_api_client.models, klass)
