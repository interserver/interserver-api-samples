...
function Initialize-MailStatsTypeVolume {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => MailStatsTypeVolume' | Write-Debug
...
function ConvertFrom-JsonToMailStatsTypeVolume {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => MailStatsTypeVolume' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
