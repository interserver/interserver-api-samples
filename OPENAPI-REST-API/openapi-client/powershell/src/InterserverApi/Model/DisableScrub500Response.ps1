...
function Initialize-DisableScrub500Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => DisableScrub500Response' | Write-Debug
...
function ConvertFrom-JsonToDisableScrub500Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => DisableScrub500Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
