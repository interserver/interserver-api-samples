...
function Initialize-ServerIpmiLiveRequest {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => ServerIpmiLiveRequest' | Write-Debug
...
function ConvertFrom-JsonToServerIpmiLiveRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => ServerIpmiLiveRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
