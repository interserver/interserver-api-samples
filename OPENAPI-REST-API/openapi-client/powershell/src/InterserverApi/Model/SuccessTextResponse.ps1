...
function Initialize-SuccessTextResponse {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => SuccessTextResponse' | Write-Debug
...
function ConvertFrom-JsonToSuccessTextResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => SuccessTextResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
