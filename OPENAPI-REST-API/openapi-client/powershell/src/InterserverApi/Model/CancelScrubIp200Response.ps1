...
function Initialize-CancelScrubIp200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => CancelScrubIp200Response' | Write-Debug
...
function ConvertFrom-JsonToCancelScrubIp200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => CancelScrubIp200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
