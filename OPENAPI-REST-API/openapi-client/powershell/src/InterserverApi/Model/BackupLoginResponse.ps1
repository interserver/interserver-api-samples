...
function Initialize-BackupLoginResponse {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => BackupLoginResponse' | Write-Debug
...
function ConvertFrom-JsonToBackupLoginResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => BackupLoginResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
