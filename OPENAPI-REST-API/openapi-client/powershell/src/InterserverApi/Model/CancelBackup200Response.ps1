...
function Initialize-CancelBackup200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => CancelBackup200Response' | Write-Debug
...
function ConvertFrom-JsonToCancelBackup200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => CancelBackup200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
