...
function Initialize-QuickserversCancel200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => QuickserversCancel200Response' | Write-Debug
...
function ConvertFrom-JsonToQuickserversCancel200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => QuickserversCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
