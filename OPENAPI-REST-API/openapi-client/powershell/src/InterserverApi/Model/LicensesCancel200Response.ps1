...
function Initialize-LicensesCancel200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => LicensesCancel200Response' | Write-Debug
...
function ConvertFrom-JsonToLicensesCancel200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => LicensesCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
