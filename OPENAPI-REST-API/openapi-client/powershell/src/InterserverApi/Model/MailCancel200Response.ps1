...
function Initialize-MailCancel200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => MailCancel200Response' | Write-Debug
...
function ConvertFrom-JsonToMailCancel200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => MailCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
