...
function Initialize-WebsiteExtraInfoTables {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => WebsiteExtraInfoTables' | Write-Debug
...
function ConvertFrom-JsonToWebsiteExtraInfoTables {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => WebsiteExtraInfoTables' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
