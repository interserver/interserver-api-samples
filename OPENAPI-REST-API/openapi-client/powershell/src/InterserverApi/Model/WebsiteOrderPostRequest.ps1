...
WebsiteOrderPostRequest<PSCustomObject>
#>

function Initialize-WebsiteOrderPostRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => WebsiteOrderPostRequest' | Write-Debug
...
Convert from JSON to WebsiteOrderPostRequest<PSCustomObject>
...
WebsiteOrderPostRequest<PSCustomObject>
#>
function ConvertFrom-JsonToWebsiteOrderPostRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => WebsiteOrderPostRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebsiteOrderPostRequest
