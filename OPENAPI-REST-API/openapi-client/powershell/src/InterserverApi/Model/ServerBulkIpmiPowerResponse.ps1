...
ServerBulkIpmiPowerResponse<PSCustomObject>
#>

function Initialize-ServerBulkIpmiPowerResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => ServerBulkIpmiPowerResponse' | Write-Debug
...
Convert from JSON to ServerBulkIpmiPowerResponse<PSCustomObject>
...
ServerBulkIpmiPowerResponse<PSCustomObject>
#>
function ConvertFrom-JsonToServerBulkIpmiPowerResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => ServerBulkIpmiPowerResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServerBulkIpmiPowerResponse
