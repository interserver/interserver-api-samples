...
function Initialize-MailStatsTypeVolumeTo {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => MailStatsTypeVolumeTo' | Write-Debug
...
function ConvertFrom-JsonToMailStatsTypeVolumeTo {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => MailStatsTypeVolumeTo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
