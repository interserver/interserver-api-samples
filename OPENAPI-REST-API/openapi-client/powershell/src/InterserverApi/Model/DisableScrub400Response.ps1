...
function Initialize-DisableScrub400Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => DisableScrub400Response' | Write-Debug
...
function ConvertFrom-JsonToDisableScrub400Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => DisableScrub400Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
