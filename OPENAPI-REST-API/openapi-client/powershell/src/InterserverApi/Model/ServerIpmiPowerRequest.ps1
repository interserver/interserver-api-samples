...
function Initialize-ServerIpmiPowerRequest {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => ServerIpmiPowerRequest' | Write-Debug
...
function ConvertFrom-JsonToServerIpmiPowerRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => ServerIpmiPowerRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
