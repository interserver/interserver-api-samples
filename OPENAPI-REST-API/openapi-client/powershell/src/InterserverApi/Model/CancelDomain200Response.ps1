...
function Initialize-CancelDomain200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => CancelDomain200Response' | Write-Debug
...
function ConvertFrom-JsonToCancelDomain200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => CancelDomain200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
