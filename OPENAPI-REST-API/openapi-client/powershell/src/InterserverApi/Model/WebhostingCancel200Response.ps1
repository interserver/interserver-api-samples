...
function Initialize-WebhostingCancel200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => WebhostingCancel200Response' | Write-Debug
...
function ConvertFrom-JsonToWebhostingCancel200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => WebhostingCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
