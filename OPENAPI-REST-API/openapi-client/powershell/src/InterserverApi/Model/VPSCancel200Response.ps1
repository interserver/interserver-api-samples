...
function Initialize-VPSCancel200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => VPSCancel200Response' | Write-Debug
...
function ConvertFrom-JsonToVPSCancel200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => VPSCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
