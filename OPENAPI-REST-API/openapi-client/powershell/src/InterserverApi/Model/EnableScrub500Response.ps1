...
function Initialize-EnableScrub500Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => EnableScrub500Response' | Write-Debug
...
function ConvertFrom-JsonToEnableScrub500Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => EnableScrub500Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
