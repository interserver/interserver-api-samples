...
function Initialize-DomainContactDetails {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => DomainContactDetails' | Write-Debug
...
function ConvertFrom-JsonToDomainContactDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => DomainContactDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
