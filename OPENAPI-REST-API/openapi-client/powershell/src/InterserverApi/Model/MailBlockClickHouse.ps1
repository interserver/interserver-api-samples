...
function Initialize-MailBlockClickHouse {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => MailBlockClickHouse' | Write-Debug
...
function ConvertFrom-JsonToMailBlockClickHouse {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => MailBlockClickHouse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
