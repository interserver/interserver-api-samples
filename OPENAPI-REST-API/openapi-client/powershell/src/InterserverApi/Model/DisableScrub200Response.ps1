...
function Initialize-DisableScrub200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => DisableScrub200Response' | Write-Debug
...
function ConvertFrom-JsonToDisableScrub200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => DisableScrub200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
