...
function Initialize-VpsTrafficUsageAverageSectionResponse {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => VpsTrafficUsageAverageSectionResponse' | Write-Debug
...
function ConvertFrom-JsonToVpsTrafficUsageAverageSectionResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => VpsTrafficUsageAverageSectionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
