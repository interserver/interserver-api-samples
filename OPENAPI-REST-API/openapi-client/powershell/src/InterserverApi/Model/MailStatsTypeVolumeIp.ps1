...
function Initialize-MailStatsTypeVolumeIp {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => MailStatsTypeVolumeIp' | Write-Debug
...
function ConvertFrom-JsonToMailStatsTypeVolumeIp {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => MailStatsTypeVolumeIp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
