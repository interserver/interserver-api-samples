...
function Initialize-BillingAddCcRequest {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => BillingAddCcRequest' | Write-Debug
...
function ConvertFrom-JsonToBillingAddCcRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => BillingAddCcRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
