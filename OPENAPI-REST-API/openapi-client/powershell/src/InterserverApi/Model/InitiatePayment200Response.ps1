...
function Initialize-InitiatePayment200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => InitiatePayment200Response' | Write-Debug
...
function ConvertFrom-JsonToInitiatePayment200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => InitiatePayment200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
