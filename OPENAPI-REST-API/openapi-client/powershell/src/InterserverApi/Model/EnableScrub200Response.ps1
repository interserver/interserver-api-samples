...
function Initialize-EnableScrub200Response {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => EnableScrub200Response' | Write-Debug
...
function ConvertFrom-JsonToEnableScrub200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => EnableScrub200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
