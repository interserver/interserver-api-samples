...
function Initialize-PatchOauthTwoFactorRequest {
    ...
    Process {
        'Creating PSCustomObject: InterserverApi => PatchOauthTwoFactorRequest' | Write-Debug
...
function ConvertFrom-JsonToPatchOauthTwoFactorRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: InterserverApi => PatchOauthTwoFactorRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
