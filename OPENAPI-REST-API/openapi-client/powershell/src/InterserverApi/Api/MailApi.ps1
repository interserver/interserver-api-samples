...
function Add-Mail {
    ...
    Process {
        ...
        if (!$MailOrderRequest) {
            throw "Error! The required parameter `MailOrderRequest` missing when calling addMail."
        }

        $LocalVarBodyParameter = $MailOrderRequest | ConvertTo-Json -Depth 100
...
.PARAMETER DeleteMailAlertRequest
No description available.
...
function Invoke-DeleteMailAlert {
    ...
    Process {
        ...
        if (!$DeleteMailAlertRequest) {
            throw "Error! The required parameter `DeleteMailAlertRequest` missing when calling deleteMailAlert."
        }

        $LocalVarBodyParameter = $DeleteMailAlertRequest | ConvertTo-Json -Depth 100
...
function Send-Mail {
    ...
    Process {
        ...
        if (!$MailOrderRequest) {
            throw "Error! The required parameter `MailOrderRequest` missing when calling putMail."
        }
...
function Update-Rule {
    ...
    Process {
        ...
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
        if (!$Rule) {
            throw "Error! The required parameter `Rule` missing when calling updateRule."
        }
        $LocalVarUri = $LocalVarUri.replace('{rule}', [System.Web.HTTPUtility]::UrlEncode($Rule))

        if (!$DenyRuleNew) {
            throw "Error! The required parameter `DenyRuleNew` missing when calling updateRule."
        }
