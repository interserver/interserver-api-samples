# InterserverApi.InterserverApi\Api.PublicApi

All URIs are relative to *https://my.interserver.net/apiv2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Get-AccountCurrencies**](PublicApi.md#Get-AccountCurrencies) | **GET** /account/currencies | List enabled currency codes accepted for billing and preferences
[**Get-AccountLocales**](PublicApi.md#Get-AccountLocales) | **GET** /account/locales | List supported UI locales with English and native display names
[**Get-Captcha**](PublicApi.md#Get-Captcha) | **GET** /captcha | Fetch a base64 JPEG captcha challenge for human verification
[**Get-Countries**](PublicApi.md#Get-Countries) | **GET** /account/countries | List enabled countries keyed by ISO-2/ISO-3/numeric code
[**Get-Info**](PublicApi.md#Get-Info) | **GET** /info | Discover available modules, service packages, categories, and types
[**Get-LoginInfo**](PublicApi.md#Get-LoginInfo) | **GET** /login | Fetch logo, captcha, language, and stats for rendering a login page
[**Get-MPServers**](PublicApi.md#Get-MPServers) | **GET** /buy_now_servers_list | List Rapid Deploy (Buy-It-Now) marketplace dedicated servers with live pricing
[**Get-OauthRedirect**](PublicApi.md#Get-OauthRedirect) | **GET** /oauth | Begin OAuth login flow — redirect user to provider for authentication
[**Get-Timezones**](PublicApi.md#Get-Timezones) | **GET** /account/timezones | List all PHP timezone identifiers usable on accounts and services
[**Invoke-PatchOauthTwoFactor**](PublicApi.md#Invoke-PatchOauthTwoFactor) | **PATCH** /oauth | Submit 2FA code to finish OAuth login when account has 2FA enabled
[**Ping-Server**](PublicApi.md#Ping-Server) | **GET** /ping | Liveness check — returns the JSON string &quot;&quot;pong&quot;&quot; to confirm API is up
[**Submit-OauthCallback**](PublicApi.md#Submit-OauthCallback) | **POST** /oauth | Complete OAuth login by linking provider to existing or new account
[**Submit-Login**](PublicApi.md#Submit-Login) | **POST** /login | Authenticate with email + password and return a session token
[**Submit-Signup**](PublicApi.md#Submit-Signup) | **POST** /signup | Create a new customer account (email + password + captcha + ToS)


<a id="Get-AccountCurrencies"></a>
# **Get-AccountCurrencies**
> String[] Get-AccountCurrencies<br>
...
# List enabled currency codes accepted for billing and preferences
try {
    $Result = Get-AccountCurrencies
} catch {
    Write-Host ("Exception occurred when calling Get-AccountCurrencies: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
...
<a id="Get-AccountLocales"></a>
# **Get-AccountLocales**
> System.Collections.Hashtable Get-AccountLocales<br>
...
# List supported UI locales with English and native display names
try {
    $Result = Get-AccountLocales
} catch {
    Write-Host ("Exception occurred when calling Get-AccountLocales: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**System.Collections.Hashtable**](GetAccountLocales200ResponseValue.md) (PSCustomObject)
