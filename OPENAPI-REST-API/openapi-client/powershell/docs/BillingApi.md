# InterserverApi.InterserverApi\Api.BillingApi

All URIs are relative to *https://my.interserver.net/apiv2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Add-BillingCreditCard**](BillingApi.md#Add-BillingCreditCard) | **POST** /billing/creditcards | Store a credit card on the account — may return a verification flow
[**Add-BillingPrepay**](BillingApi.md#Add-BillingPrepay) | **POST** /billing/prepays | Create a prepay deposit and return an invoice id to fund it
[**Invoke-DeleteBillingCreditCard**](BillingApi.md#Invoke-DeleteBillingCreditCard) | **DELETE** /billing/creditcards/{id} | Remove a stored credit card from the account
[**Invoke-DeleteBillingInvoice**](BillingApi.md#Invoke-DeleteBillingInvoice) | **DELETE** /billing/invoices/{id} | Cancel a pending unpaid invoice — and its pending service or repeat invoice
[**Invoke-DeleteBillingPrepay**](BillingApi.md#Invoke-DeleteBillingPrepay) | **DELETE** /billing/prepays/{id} | Delete an unfunded prepay or strip its unpaid funding invoices
[**Get-AffiliateBanners**](BillingApi.md#Get-AffiliateBanners) | **GET** /affiliate/banners | List affiliate banner image assets with filename and dimensions
[**Get-AffiliateDownload**](BillingApi.md#Get-AffiliateDownload) | **GET** /affiliate/download | Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
[**Get-AffiliateRichReport**](BillingApi.md#Get-AffiliateRichReport) | **GET** /affiliate/rich_report | Read a combined affiliate performance summary (HTML payload)
[**Get-AffiliateSalesGraph**](BillingApi.md#Get-AffiliateSalesGraph) | **GET** /affiliate/sales_graph | Read aggregated affiliate sales time-series (monthly buckets) for chart rendering
[**Get-AffiliateSignups**](BillingApi.md#Get-AffiliateSignups) | **GET** /affiliate/signups | Read affiliate signup stats and per-customer conversion data
[**Get-AffiliateTrafficGraph**](BillingApi.md#Get-AffiliateTrafficGraph) | **GET** /affiliate/traffic_graph | Read aggregated affiliate referral click/visit time-series for chart rendering
[**Get-AffiliateWebTraffic**](BillingApi.md#Get-AffiliateWebTraffic) | **GET** /affiliate/web_traffic | List the 20 most recent affiliate referral visits with IP, referrer, timestamp
[**Get-BillingCart**](BillingApi.md#Get-BillingCart) | **GET** /billing/cart | Read the current shopping cart contents, totals, and available payment methods
[**Get-BillingCreditCardVerify**](BillingApi.md#Get-BillingCreditCardVerify) | **GET** /billing/creditcards/{id}/verify | Probe whether a stored card still needs micro-charge verification
[**Get-BillingInvoice**](BillingApi.md#Get-BillingInvoice) | **GET** /billing/invoices/{id} | Read full invoice detail — line items, totals, paid status, customer info
[**Get-BillingInvoices**](BillingApi.md#Get-BillingInvoices) | **GET** /billing/invoices | List every invoice on the account with summary totals and paid/unpaid status
[**Get-BillingPrePays**](BillingApi.md#Get-BillingPrePays) | **GET** /billing/prepays | List prepay deposits on the account — remaining balance and auto-use flags
[**ConvertTo-itiatePayment**](BillingApi.md#ConvertTo-itiatePayment) | **GET** /billing/pay/{method}/{invoices} | Pay invoices through the chosen gateway — returns the next-step action
[**Invoke-PatchBillingCreditCardVerify**](BillingApi.md#Invoke-PatchBillingCreditCardVerify) | **PATCH** /billing/creditcards/{id}/verify | Place two micro-charges on the card to start CVV verification (step 1 of 2)
[**Submit-BillingCreditCardVerify**](BillingApi.md#Submit-BillingCreditCardVerify) | **POST** /billing/creditcards/{id}/verify | Submit two micro-charge amounts to finalize card verification (step 2 of 2)
[**Update-AffiliateDockSetup**](BillingApi.md#Update-AffiliateDockSetup) | **POST** /affiliate/dock_setup | Configure the affiliate landing dock title, description, and referrer coupon
[**Update-AffiliatePaymentSetup**](BillingApi.md#Update-AffiliatePaymentSetup) | **POST** /affiliate/payment_setup | Configure how affiliate commissions get paid out (PayPal or internal prepay)
[**Update-BillingCreditCard**](BillingApi.md#Update-BillingCreditCard) | **POST** /billing/creditcards/{id} | Refresh stored card expiration and re-trigger MaxMind fraud scoring
[**Update-BillingPaymentMethod**](BillingApi.md#Update-BillingPaymentMethod) | **POST** /billing/payment_method | Set the account&#39;s default payment method for recurring/auto charges
...
<a id="Get-AffiliateDownload"></a>
# **Get-AffiliateDownload**
> void Get-AffiliateDownload<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-St] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Ex] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Year] <System.Nullable[Int32]><br>
...
$St = "MySt" # String | Filter by status. (optional)
$Ex = "csv" # String | Export format: csv, xls, xlsx, or pdf. Defaults to csv. (optional)
$Year = 56 # Int32 | Year to filter the report. Defaults to the current year. (optional)

# Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
try {
    $Result = Get-AffiliateDownload -St $St -Ex $Ex -Year $Year
} catch {
    Write-Host ("Exception occurred when calling Get-AffiliateDownload: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
 ...
 **Year** | **Int32**| Year to filter the report. Defaults to the current year. | [optional] 
...
<a id="Get-AffiliateSignups"></a>
# **Get-AffiliateSignups**
> GetAffiliateSignups200Response Get-AffiliateSignups<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-St] <String><br>
...
$St = "MySt" # String | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results. (optional)

# Read affiliate signup stats and per-customer conversion data
try {
    $Result = Get-AffiliateSignups -St $St
} catch {
    Write-Host ("Exception occurred when calling Get-AffiliateSignups: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**GetAffiliateSignups200Response**](GetAffiliateSignups200Response.md) (PSCustomObject)
...
<a id="Invoke-PatchBillingCreditCardVerify"></a>
# **Invoke-PatchBillingCreditCardVerify**
> SuccessTextResponse Invoke-PatchBillingCreditCardVerify<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <Int32><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PatchBillingCreditCardVerifyRequest] <PSCustomObject><br>
...
$Id = 56 # Int32 | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
$PatchBillingCreditCardVerifyRequest = Initialize-PatchBillingCreditCardVerifyRequest -CcCcv2 "MyCcCcv2" # PatchBillingCreditCardVerifyRequest | 

# Place two micro-charges on the card to start CVV verification (step 1 of 2)
try {
    $Result = Invoke-PatchBillingCreditCardVerify -Id $Id -PatchBillingCreditCardVerifyRequest $PatchBillingCreditCardVerifyRequest
} catch {
    Write-Host ("Exception occurred when calling Invoke-PatchBillingCreditCardVerify: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
