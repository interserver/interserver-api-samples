...
**hd** | [**server_order_post_request_hd_t**](server_order_post_request_hd.md) \* |  | 
...
**servername** | **char \*** | Server hostname. Must pass valid_hostname(). | 
**rootpass** | **char \*** | Root password for the server. | 
**tos** | **int** | Terms-of-service acceptance. Must be true to place the order. | 
**comment** | **char \*** | Optional free-form order comment. | [optional] [default to '']
