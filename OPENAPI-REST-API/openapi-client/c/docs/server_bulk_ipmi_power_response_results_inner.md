...
**text** | **char \*** | IPMI power-status output for this server. | [optional] 
**error** | **char \*** | Error message for this server, if processing failed (mutually exclusive with &#x60;text&#x60;). | [optional] 
