...
------------- | ------------- | -------------
[**ScrubIpsAPI_cancelScrubIp**](ScrubIpsAPI.md#ScrubIpsAPI_cancelScrubIp) | **DELETE** /scrub_ips/{id} | Cancel a Scrub IP service and stop its recurring DDoS billing
[**ScrubIpsAPI_createFilter**](ScrubIpsAPI.md#ScrubIpsAPI_createFilter) | **POST** /scrub_ips/{id}/create_filter | Apply a predefined scrubbing filter (DNS/HTTP/synproxy) to a port
[**ScrubIpsAPI_createGeoRule**](ScrubIpsAPI.md#ScrubIpsAPI_createGeoRule) | **POST** /scrub_ips/{id}/create_geo_rule | Add a geographic firewall rule (block/allow by country code or ASN)
[**ScrubIpsAPI_createRule**](ScrubIpsAPI.md#ScrubIpsAPI_createRule) | **POST** /scrub_ips/{id}/create_rule | Add an L3/L4 firewall rule (allow/drop by IP, port, and protocol)
[**ScrubIpsAPI_deleteFilter**](ScrubIpsAPI.md#ScrubIpsAPI_deleteFilter) | **POST** /scrub_ips/{id}/delete_filter | Remove a scrubbing filter by matching filter_type and port
[**ScrubIpsAPI_disableScrub**](ScrubIpsAPI.md#ScrubIpsAPI_disableScrub) | **GET** /scrub_ips/{id}/disable | Disable DDoS scrubbing and remove the BGP announcement on the IP
[**ScrubIpsAPI_enableScrub**](ScrubIpsAPI.md#ScrubIpsAPI_enableScrub) | **GET** /scrub_ips/{id}/enable | Enable DDoS scrubbing (BGP announcement) on the service&#39;s protected IP
[**ScrubIpsAPI_getOrderDetail**](ScrubIpsAPI.md#ScrubIpsAPI_getOrderDetail) | **GET** /scrub_ips/order | Get plans, pricing, and eligible IPs for a new Scrub IP order
[**ScrubIpsAPI_getScrubIpDetails**](ScrubIpsAPI.md#ScrubIpsAPI_getScrubIpDetails) | **GET** /scrub_ips/{id} | Get full Scrub IP service detail (rules + geo + filters)
[**ScrubIpsAPI_getScrubIpFilterTypes**](ScrubIpsAPI.md#ScrubIpsAPI_getScrubIpFilterTypes) | **GET** /scrub_ips/filter_types | List enabled traffic filter profiles available for createFilter
[**ScrubIpsAPI_getScrubIpInvoices**](ScrubIpsAPI.md#ScrubIpsAPI_getScrubIpInvoices) | **GET** /scrub_ips/{id}/invoices | List recurring and one-time invoices billed for this Scrub IP service
[**ScrubIpsAPI_getScrubIpLogs**](ScrubIpsAPI.md#ScrubIpsAPI_getScrubIpLogs) | **GET** /scrub_ips/{id}/logs | Get last 50000 packet/event log entries for the protected IP
[**ScrubIpsAPI_getScrubIpsList**](ScrubIpsAPI.md#ScrubIpsAPI_getScrubIpsList) | **GET** /scrub_ips | List all Scrub IP DDoS protection services on the authenticated account
[**ScrubIpsAPI_placeScrubOrder**](ScrubIpsAPI.md#ScrubIpsAPI_placeScrubOrder) | **POST** /scrub_ips/order | Place a new Scrub IP DDoS protection order and generate an invoice
[**ScrubIpsAPI_putScrubIps**](ScrubIpsAPI.md#ScrubIpsAPI_putScrubIps) | **PUT** /scrub_ips/order | Validate a Scrub IP order and return effective pricing without billing
[**ScrubIpsAPI_scrubIpsDeleteGeoRule**](ScrubIpsAPI.md#ScrubIpsAPI_scrubIpsDeleteGeoRule) | **POST** /scrub_ips/{id}/delete_geo_rule | Delete a geo firewall rule by rule_id from getScrubIpDetails
[**ScrubIpsAPI_scrubIpsDeleteRule**](ScrubIpsAPI.md#ScrubIpsAPI_scrubIpsDeleteRule) | **POST** /scrub_ips/{id}/delete_rule | Delete an L3/L4 firewall rule by rule_id from getScrubIpDetails
...
//
put_scrub_ips_200_response_t* ScrubIpsAPI_putScrubIps(apiClient_t *apiClient, scrub_ip_place_order_t *scrub_ip_place_order);
```
...
[put_scrub_ips_200_response_t](put_scrub_ips_200_response.md) *
