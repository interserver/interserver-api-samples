...
------------- | ------------- | -------------
[**MailAPI_addMail**](MailAPI.md#MailAPI_addMail) | **POST** /mail/order | Place a new Mail Baby order, generate invoice, and queue provisioning
[**MailAPI_addRule**](MailAPI.md#MailAPI_addRule) | **POST** /mail/{id}/rules | Create a new deny rule to auto-block matching submissions
[**MailAPI_createMailAlert**](MailAPI.md#MailAPI_createMailAlert) | **POST** /mail/{id}/alerts | Create a new Mail Baby alert for delivery, bounce, or quota events
[**MailAPI_deleteMailAlert**](MailAPI.md#MailAPI_deleteMailAlert) | **DELETE** /mail/{id}/alerts | Delete a Mail Baby alert by alert_id (hard delete — no recovery)
[**MailAPI_deleteRule**](MailAPI.md#MailAPI_deleteRule) | **DELETE** /mail/{id}/rules/{rule} | Delete a Mail Baby deny rule by rule ID (hard delete — no recovery)
[**MailAPI_delistBlock**](MailAPI.md#MailAPI_delistBlock) | **POST** /mail/{id}/blocks/delete | Delist a sender email from rspamd / mailchannels / mailbaby block lists
[**MailAPI_getMailAlerts**](MailAPI.md#MailAPI_getMailAlerts) | **GET** /mail/{id}/alerts | List configured delivery/bounce/quota alerts for one Mail Baby service
[**MailAPI_getMailBlocks**](MailAPI.md#MailAPI_getMailBlocks) | **GET** /mail/{id}/blocks | List recent local-blocklist hits and spam-trap captures for the mail user
[**MailAPI_getMailDelist**](MailAPI.md#MailAPI_getMailDelist) | **GET** /mail/{id}/delist | Read blocklist diagnostics and find senders eligible for delisting
[**MailAPI_getMailDeliverability**](MailAPI.md#MailAPI_getMailDeliverability) | **GET** /mail/{id}/deliverability | Read delivered vs bounced totals broken down by sender (or by recipient domain)
[**MailAPI_getMailInfo**](MailAPI.md#MailAPI_getMailInfo) | **GET** /mail/{id} | Read full detail for one Mail Baby service including SMTP credentials
[**MailAPI_getMailInvoices**](MailAPI.md#MailAPI_getMailInvoices) | **GET** /mail/{id}/invoices | List billing invoices linked to this Mail Baby service
[**MailAPI_getMailList**](MailAPI.md#MailAPI_getMailList) | **GET** /mail | List every Mail Baby SMTP relay service on the account
[**MailAPI_getMailWelcomeEmail**](MailAPI.md#MailAPI_getMailWelcomeEmail) | **GET** /mail/{id}/welcome_email | Resend the Mail Baby welcome email with SMTP credentials and setup info
[**MailAPI_getNewMail**](MailAPI.md#MailAPI_getNewMail) | **GET** /mail/order | Read the Mail Baby order catalog — plans, package costs, service-type metadata
[**MailAPI_getRules**](MailAPI.md#MailAPI_getRules) | **GET** /mail/{id}/rules | List configured deny rules (sender/recipient blocks) for a Mail Baby service
[**MailAPI_getStats**](MailAPI.md#MailAPI_getStats) | **GET** /mail/{id}/stats | Read Mail Baby usage counts, send volume totals, top destinations, and projected cost
[**MailAPI_mailCancel**](MailAPI.md#MailAPI_mailCancel) | **DELETE** /mail/{id} | Cancel a Mail Baby service and stop the recurring invoice
[**MailAPI_postMailDelist**](MailAPI.md#MailAPI_postMailDelist) | **POST** /mail/{id}/delist | Delist a sender from rspamd / mailchannels / mailbaby block lists
[**MailAPI_putMail**](MailAPI.md#MailAPI_putMail) | **PUT** /mail/order | Validate Mail Baby order, quote pricing, and verify coupon — no charge
[**MailAPI_resetMailPassword**](MailAPI.md#MailAPI_resetMailPassword) | **GET** /mail/{id}/reset_password | Rotate the SMTP password and email the new credential to the account owner
[**MailAPI_sendAdvMail**](MailAPI.md#MailAPI_sendAdvMail) | **POST** /mail/{id}/advsend | Send email via Mail Baby SMTP relay with attachments, CC/BCC, and multi-recipient
[**MailAPI_sendMail**](MailAPI.md#MailAPI_sendMail) | **POST** /mail/{id}/send | Send a simple single-recipient email through the Mail Baby SMTP relay
[**MailAPI_updateMailAlert**](MailAPI.md#MailAPI_updateMailAlert) | **PUT** /mail/{id}/alerts | Update an existing Mail Baby alert by alert_id
[**MailAPI_updateMailInfo**](MailAPI.md#MailAPI_updateMailInfo) | **POST** /mail/{id} | POST mutation hook for the Mail Baby service detail page
[**MailAPI_updateRule**](MailAPI.md#MailAPI_updateRule) | **PUT** /mail/{id}/rules/{rule} | Update an existing Mail Baby deny rule&#39;s type and match data
[**MailAPI_viewMailLog**](MailAPI.md#MailAPI_viewMailLog) | **GET** /mail/{id}/log | Search and paginate per-message Mail Baby delivery log entries
...
//
service_order_post_response_t* MailAPI_addMail(apiClient_t *apiClient, mail_order_request_t *mail_order_request);
```
...
**mail_order_request** | **[mail_order_request_t](mail_order_request.md) \*** |  | 
...
//
success_text_response_t* MailAPI_deleteMailAlert(apiClient_t *apiClient, int *id, delete_mail_alert_request_t *delete_mail_alert_request);
```
...
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**id** | **int \*** | The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;. | 
**delete_mail_alert_request** | **[delete_mail_alert_request_t](delete_mail_alert_request.md) \*** |  | 
...
//
void MailAPI_putMail(apiClient_t *apiClient, mail_order_request_t *mail_order_request);
```
...
//
generic_response_t* MailAPI_updateRule(apiClient_t *apiClient, int *id, char *rule, deny_rule_new_t *deny_rule_new);
```
...
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**id** | **int \*** | The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;. | 
**rule** | **char \*** | The ID of the deny rule to update. | 
**deny_rule_new** | **[deny_rule_new_t](deny_rule_new.md) \*** |  | 
