...
------------- | ------------- | -------------
[**BillingAPI_addBillingCreditCard**](BillingAPI.md#BillingAPI_addBillingCreditCard) | **POST** /billing/creditcards | Store a credit card on the account — may return a verification flow
[**BillingAPI_addBillingPrepay**](BillingAPI.md#BillingAPI_addBillingPrepay) | **POST** /billing/prepays | Create a prepay deposit and return an invoice id to fund it
[**BillingAPI_deleteBillingCreditCard**](BillingAPI.md#BillingAPI_deleteBillingCreditCard) | **DELETE** /billing/creditcards/{id} | Remove a stored credit card from the account
[**BillingAPI_deleteBillingInvoice**](BillingAPI.md#BillingAPI_deleteBillingInvoice) | **DELETE** /billing/invoices/{id} | Cancel a pending unpaid invoice — and its pending service or repeat invoice
[**BillingAPI_deleteBillingPrepay**](BillingAPI.md#BillingAPI_deleteBillingPrepay) | **DELETE** /billing/prepays/{id} | Delete an unfunded prepay or strip its unpaid funding invoices
[**BillingAPI_getAffiliateBanners**](BillingAPI.md#BillingAPI_getAffiliateBanners) | **GET** /affiliate/banners | List affiliate banner image assets with filename and dimensions
[**BillingAPI_getAffiliateDownload**](BillingAPI.md#BillingAPI_getAffiliateDownload) | **GET** /affiliate/download | Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
[**BillingAPI_getAffiliateRichReport**](BillingAPI.md#BillingAPI_getAffiliateRichReport) | **GET** /affiliate/rich_report | Read a combined affiliate performance summary (HTML payload)
[**BillingAPI_getAffiliateSalesGraph**](BillingAPI.md#BillingAPI_getAffiliateSalesGraph) | **GET** /affiliate/sales_graph | Read aggregated affiliate sales time-series (monthly buckets) for chart rendering
[**BillingAPI_getAffiliateSignups**](BillingAPI.md#BillingAPI_getAffiliateSignups) | **GET** /affiliate/signups | Read affiliate signup stats and per-customer conversion data
[**BillingAPI_getAffiliateTrafficGraph**](BillingAPI.md#BillingAPI_getAffiliateTrafficGraph) | **GET** /affiliate/traffic_graph | Read aggregated affiliate referral click/visit time-series for chart rendering
[**BillingAPI_getAffiliateWebTraffic**](BillingAPI.md#BillingAPI_getAffiliateWebTraffic) | **GET** /affiliate/web_traffic | List the 20 most recent affiliate referral visits with IP, referrer, timestamp
[**BillingAPI_getBillingCart**](BillingAPI.md#BillingAPI_getBillingCart) | **GET** /billing/cart | Read the current shopping cart contents, totals, and available payment methods
[**BillingAPI_getBillingCreditCardVerify**](BillingAPI.md#BillingAPI_getBillingCreditCardVerify) | **GET** /billing/creditcards/{id}/verify | Probe whether a stored card still needs micro-charge verification
[**BillingAPI_getBillingInvoice**](BillingAPI.md#BillingAPI_getBillingInvoice) | **GET** /billing/invoices/{id} | Read full invoice detail — line items, totals, paid status, customer info
[**BillingAPI_getBillingInvoices**](BillingAPI.md#BillingAPI_getBillingInvoices) | **GET** /billing/invoices | List every invoice on the account with summary totals and paid/unpaid status
[**BillingAPI_getBillingPrePays**](BillingAPI.md#BillingAPI_getBillingPrePays) | **GET** /billing/prepays | List prepay deposits on the account — remaining balance and auto-use flags
[**BillingAPI_initiatePayment**](BillingAPI.md#BillingAPI_initiatePayment) | **GET** /billing/pay/{method}/{invoices} | Pay invoices through the chosen gateway — returns the next-step action
[**BillingAPI_patchBillingCreditCardVerify**](BillingAPI.md#BillingAPI_patchBillingCreditCardVerify) | **PATCH** /billing/creditcards/{id}/verify | Place two micro-charges on the card to start CVV verification (step 1 of 2)
[**BillingAPI_postBillingCreditCardVerify**](BillingAPI.md#BillingAPI_postBillingCreditCardVerify) | **POST** /billing/creditcards/{id}/verify | Submit two micro-charge amounts to finalize card verification (step 2 of 2)
[**BillingAPI_updateAffiliateDockSetup**](BillingAPI.md#BillingAPI_updateAffiliateDockSetup) | **POST** /affiliate/dock_setup | Configure the affiliate landing dock title, description, and referrer coupon
[**BillingAPI_updateAffiliatePaymentSetup**](BillingAPI.md#BillingAPI_updateAffiliatePaymentSetup) | **POST** /affiliate/payment_setup | Configure how affiliate commissions get paid out (PayPal or internal prepay)
[**BillingAPI_updateBillingCreditCard**](BillingAPI.md#BillingAPI_updateBillingCreditCard) | **POST** /billing/creditcards/{id} | Refresh stored card expiration and re-trigger MaxMind fraud scoring
[**BillingAPI_updateBillingPaymentMethod**](BillingAPI.md#BillingAPI_updateBillingPaymentMethod) | **POST** /billing/payment_method | Set the account&#39;s default payment method for recurring/auto charges
...
# **BillingAPI_getAffiliateDownload**
```c
...
//
void BillingAPI_getAffiliateDownload(apiClient_t *apiClient, char *st, interserver_management_api_getAffiliateDownload_ex_e ex, int *year);
```
...
------------- | ------------- | ------------- | -------------
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**st** | **char \*** | Filter by status. | [optional] 
**ex** | **interserver_management_api_getAffiliateDownload_ex_e** | Export format: csv, xls, xlsx, or pdf. Defaults to csv. | [optional] 
...
# **BillingAPI_getAffiliateSignups**
```c
...
//
get_affiliate_signups_200_response_t* BillingAPI_getAffiliateSignups(apiClient_t *apiClient, char *st);
```
...
------------- | ------------- | ------------- | -------------
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**st** | **char \*** | Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. | [optional] 

### Return type

[get_affiliate_signups_200_response_t](get_affiliate_signups_200_response.md) *
...
# **BillingAPI_patchBillingCreditCardVerify**
```c
...
//
success_text_response_t* BillingAPI_patchBillingCreditCardVerify(apiClient_t *apiClient, int *id, patch_billing_credit_card_verify_request_t *patch_billing_credit_card_verify_request);
```
...
**apiClient** | **apiClient_t \*** | context containing the client configuration |
**id** | **int \*** | The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. | 
**patch_billing_credit_card_verify_request** | **[patch_billing_credit_card_verify_request_t](patch_billing_credit_card_verify_request.md) \*** |  | 
