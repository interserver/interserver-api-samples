...
typedef enum  { interserver_management_api_domain_order_request_TYPE_NULL = 0, interserver_management_api_domain_order_request_TYPE__register, interserver_management_api_domain_order_request_TYPE_transfer, interserver_management_api_domain_order_request_TYPE__11184809 } interserver_management_api_domain_order_request_TYPE_e;
...
typedef enum  { interserver_management_api_domain_order_request_WHOISPRIVACY_NULL = 0, interserver_management_api_domain_order_request_WHOISPRIVACY_enable, interserver_management_api_domain_order_request_WHOISPRIVACY_disable, interserver_management_api_domain_order_request_WHOISPRIVACY__11184809 } interserver_management_api_domain_order_request_WHOISPRIVACY_e;
