...
LicensesAPI_addLicense(apiClient_t *apiClient, license_order_request_t *license_order_request)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_license_order_request = NULL;
    if (license_order_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_license_order_request = license_order_request_convertToJSON(license_order_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_license_order_request);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_license_order_request) {
        cJSON_Delete(localVarSingleItemJSON_license_order_request);
        localVarSingleItemJSON_license_order_request = NULL;
    }
...
//
void
LicensesAPI_putLicenses(apiClient_t *apiClient, license_order_request_t *license_order_request)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
