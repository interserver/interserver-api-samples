...
SSLCertificatesAPI_addSsl(apiClient_t *apiClient, ssl_order_request_t *ssl_order_request);
...
//
void
SSLCertificatesAPI_putSsl(apiClient_t *apiClient, ssl_order_request_t *ssl_order_request);
