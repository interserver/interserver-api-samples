...
ScrubIpsAPI_putScrubIps(apiClient_t *apiClient, scrub_ip_place_order_t *scrub_ip_place_order)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //}
    //nonprimitive not container
    put_scrub_ips_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ScrubIpsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = put_scrub_ips_200_response_parseFromJSON(ScrubIpsAPIlocalVarJSON);
        cJSON_Delete(ScrubIpsAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
