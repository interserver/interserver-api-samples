...
QuickServersAPI_addQs(apiClient_t *apiClient, qs_order_request_t *qs_order_request)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_qs_order_request = NULL;
    if (qs_order_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_qs_order_request = qs_order_request_convertToJSON(qs_order_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_qs_order_request);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_qs_order_request) {
        cJSON_Delete(localVarSingleItemJSON_qs_order_request);
        localVarSingleItemJSON_qs_order_request = NULL;
    }
