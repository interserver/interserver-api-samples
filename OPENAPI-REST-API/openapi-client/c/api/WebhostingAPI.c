...
WebhostingAPI_addWebsite(apiClient_t *apiClient, website_order_post_request_t *website_order_post_request)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_website_order_post_request = NULL;
    if (website_order_post_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_website_order_post_request = website_order_post_request_convertToJSON(website_order_post_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_website_order_post_request);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_website_order_post_request) {
        cJSON_Delete(localVarSingleItemJSON_website_order_post_request);
        localVarSingleItemJSON_website_order_post_request = NULL;
    }
...
//
void
WebhostingAPI_putWebsites(apiClient_t *apiClient, website_order_put_request_t *website_order_put_request)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_website_order_put_request = NULL;
    if (website_order_put_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_website_order_put_request = website_order_put_request_convertToJSON(website_order_put_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_website_order_put_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    list_freeList(localVarContentType);
    free(localVarPath);
    if (localVarSingleItemJSON_website_order_put_request) {
        cJSON_Delete(localVarSingleItemJSON_website_order_put_request);
        localVarSingleItemJSON_website_order_put_request = NULL;
    }
    free(localVarBodyParameters);
