...
typedef enum  { interserver_management_api_getTicketsList_PERIOD_NULL = 0, interserver_management_api_getTicketsList_PERIOD__30, interserver_management_api_getTicketsList_PERIOD__90, interserver_management_api_getTicketsList_PERIOD__365, interserver_management_api_getTicketsList_PERIOD__1825, interserver_management_api_getTicketsList_PERIOD_all, interserver_management_api_getTicketsList_PERIOD__11184809 } interserver_management_api_getTicketsList_period_e;

// Enum VIEW for TicketsAPI_getTicketsList
typedef enum  { interserver_management_api_getTicketsList_VIEW_NULL = 0, interserver_management_api_getTicketsList_VIEW_Open, interserver_management_api_getTicketsList_VIEW_Closed, interserver_management_api_getTicketsList_VIEW_On Hold, interserver_management_api_getTicketsList_VIEW_In Progress, interserver_management_api_getTicketsList_VIEW__11184809 } interserver_management_api_getTicketsList_view_e;
