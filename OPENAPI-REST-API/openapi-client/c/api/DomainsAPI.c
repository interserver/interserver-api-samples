...
DomainsAPI_addDomain(apiClient_t *apiClient, domain_order_request_t *domain_order_request)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_domain_order_request = NULL;
    if (domain_order_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_domain_order_request = domain_order_request_convertToJSON(domain_order_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_domain_order_request);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_domain_order_request) {
        cJSON_Delete(localVarSingleItemJSON_domain_order_request);
        localVarSingleItemJSON_domain_order_request = NULL;
    }
...
//
success_text_response_t*
DomainsAPI_deleteDomainDnssec(apiClient_t *apiClient, int *id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
void
DomainsAPI_patchDomains(apiClient_t *apiClient, domain_order_request_t *domain_order_request)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
void
DomainsAPI_postDomainSearch(apiClient_t *apiClient, char *name)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
void
DomainsAPI_putDomains(apiClient_t *apiClient, domain_order_request_t *domain_order_request)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
success_text_response_t*
DomainsAPI_updateDomainInfo(apiClient_t *apiClient, int *id)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
