...
typedef enum  { interserver_management_api_getStats_TIME_NULL = 0, interserver_management_api_getStats_TIME_all, interserver_management_api_getStats_TIME_billing, interserver_management_api_getStats_TIME_month, interserver_management_api_getStats_TIME__7d, interserver_management_api_getStats_TIME__24h, interserver_management_api_getStats_TIME__1d, interserver_management_api_getStats_TIME__1h, interserver_management_api_getStats_TIME__11184809 } interserver_management_api_getStats_time_e;

// Enum DELIVERED for MailAPI_viewMailLog
typedef enum  { interserver_management_api_viewMailLog_DELIVERED_NULL = 0, interserver_management_api_viewMailLog_DELIVERED__0, interserver_management_api_viewMailLog_DELIVERED__1, interserver_management_api_viewMailLog_DELIVERED__11184809 } interserver_management_api_viewMailLog_delivered_e;

// Enum SORT for MailAPI_viewMailLog
typedef enum  { interserver_management_api_viewMailLog_SORT_NULL = 0, interserver_management_api_viewMailLog_SORT_time, interserver_management_api_viewMailLog_SORT__11184809 } interserver_management_api_viewMailLog_sort_e;

// Enum DIR for MailAPI_viewMailLog
typedef enum  { interserver_management_api_viewMailLog_DIR_NULL = 0, interserver_management_api_viewMailLog_DIR_asc, interserver_management_api_viewMailLog_DIR_desc, interserver_management_api_viewMailLog_DIR__11184809 } interserver_management_api_viewMailLog_dir_e;

// Enum GROUPBY for MailAPI_viewMailLog
typedef enum  { interserver_management_api_viewMailLog_GROUPBY_NULL = 0, interserver_management_api_viewMailLog_GROUPBY_message, interserver_management_api_viewMailLog_GROUPBY_recipient, interserver_management_api_viewMailLog_GROUPBY__11184809 } interserver_management_api_viewMailLog_groupby_e;
