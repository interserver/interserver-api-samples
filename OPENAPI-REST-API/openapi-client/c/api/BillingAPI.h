...
// Enum EX for BillingAPI_getAffiliateDownload
typedef enum  { interserver_management_api_getAffiliateDownload_EX_NULL = 0, interserver_management_api_getAffiliateDownload_EX_csv, interserver_management_api_getAffiliateDownload_EX_xls, interserver_management_api_getAffiliateDownload_EX_xlsx, interserver_management_api_getAffiliateDownload_EX_pdf, interserver_management_api_getAffiliateDownload_EX__11184809 } interserver_management_api_getAffiliateDownload_ex_e;

// Enum METHOD for BillingAPI_initiatePayment
typedef enum  { interserver_management_api_initiatePayment_METHOD_NULL = 0, interserver_management_api_initiatePayment_METHOD_cc, interserver_management_api_initiatePayment_METHOD_paypal, interserver_management_api_initiatePayment_METHOD_prepay, interserver_management_api_initiatePayment_METHOD_payssion, interserver_management_api_initiatePayment_METHOD_payu, interserver_management_api_initiatePayment_METHOD_ccavenue, interserver_management_api_initiatePayment_METHOD_cashfree, interserver_management_api_initiatePayment_METHOD_coinbase, interserver_management_api_initiatePayment_METHOD_btcpay, interserver_management_api_initiatePayment_METHOD__11184809 } interserver_management_api_initiatePayment_method_e;
