...
#include "DeleteMailAlert_request.hpp"
...
public:
  ...
  API_CALL("POST", "/mail/order", add_mail, BODY_DTO(oatpp::Object<org::openapitools::client::model::MailOrderRequest>, mailOrderRequest))
  /// <summary>
  ...
  API_CALL("DELETE", "/mail/{id}/alerts", delete_mail_alert, PATH(oatpp::Int32, id), BODY_DTO(oatpp::Object<org::openapitools::client::model::DeleteMailAlert_request>, deleteMailAlertRequest))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="mailOrderRequest"></param>
  API_CALL("PUT", "/mail/order", put_mail, BODY_DTO(oatpp::Object<org::openapitools::client::model::MailOrderRequest>, mailOrderRequest))
  /// <summary>
  ...
  API_CALL("PUT", "/mail/{id}/rules/{rule}", update_rule, PATH(oatpp::Int32, id), PATH(oatpp::String, rule), BODY_DTO(oatpp::Object<org::openapitools::client::model::DenyRuleNew>, denyRuleNew))
  /// <summary>
