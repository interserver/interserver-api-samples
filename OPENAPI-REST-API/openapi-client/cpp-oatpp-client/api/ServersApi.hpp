...
#include "Server.hpp"
#include "ServerBulkIpmiPowerResponse.hpp"
#include "ServerIpmiLiveInfo.hpp"
#include "ServerOrder.hpp"
#include "ServerOrderPostRequest.hpp"
...
public:
  ...
  API_CALL("POST", "/servers/order", add_server, BODY_DTO(oatpp::Object<org::openapitools::client::model::ServerOrderPostRequest>, serverOrderPostRequest))
  /// <summary>
  ...
  API_CALL("GET", "/servers/bulk/ipmi_power", server_bulk_ipmi_power_get, QUERY(oatpp::String, ids))
  /// <summary>
