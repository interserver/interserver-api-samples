...
public:
  ...
  API_CALL("POST", "/ssl/order", add_ssl, BODY_DTO(oatpp::Object<org::openapitools::client::model::SslOrderRequest>, sslOrderRequest))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="sslOrderRequest"></param>
  API_CALL("PUT", "/ssl/order", put_ssl, BODY_DTO(oatpp::Object<org::openapitools::client::model::SslOrderRequest>, sslOrderRequest))
  /// <summary>
