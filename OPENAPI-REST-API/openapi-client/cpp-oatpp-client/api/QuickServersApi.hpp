...
public:
  ...
  API_CALL("POST", "/qs/order", add_qs, BODY_DTO(oatpp::Object<org::openapitools::client::model::QsOrderRequest>, qsOrderRequest))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="id">QuickServer ID number</param>
  API_CALL("GET", "/qs/{id}/backup", get_qs_backup, PATH(oatpp::Int32, id))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="qsOrderRequest"></param>
  API_CALL("PUT", "/qs/order", put_qs, BODY_DTO(oatpp::Object<org::openapitools::client::model::QsOrderRequest>, qsOrderRequest))
  /// <summary>
