...
#include "DomainOrderRequest.hpp"
...
public:
  ...
  API_CALL("POST", "/domains/order", add_domain, BODY_DTO(oatpp::Object<org::openapitools::client::model::DomainOrderRequest>, domainOrderRequest))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
  API_CALL("DELETE", "/domains/{id}/dnssec", delete_domain_dnssec, PATH(oatpp::Int32, id))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="domainOrderRequest"></param>
  API_CALL("PATCH", "/domains/order", patch_domains, BODY_DTO(oatpp::Object<org::openapitools::client::model::DomainOrderRequest>, domainOrderRequest))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="name">The base domain name to search (for example &#x60;example&#x60; or &#x60;example.com&#x60;).</param>
  API_CALL("POST", "/domains/search/{name}", post_domain_search, PATH(oatpp::String, name))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="domainOrderRequest"></param>
  API_CALL("PUT", "/domains/order", put_domains, BODY_DTO(oatpp::Object<org::openapitools::client::model::DomainOrderRequest>, domainOrderRequest))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="id">The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.</param>
  API_CALL("POST", "/domains/{id}", update_domain_info, PATH(oatpp::Int32, id))
  /// <summary>
