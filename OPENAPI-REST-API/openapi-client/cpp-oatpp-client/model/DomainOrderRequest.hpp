...
#ifndef DomainOrderRequest_H_
#define DomainOrderRequest_H_
 ...
 */
class DomainOrderRequest : public oatpp::DTO {

  DTO_INIT(DomainOrderRequest, DTO /* Extends */)
  ...
  DTO_FIELD(oatpp::String, whois_privacy);
