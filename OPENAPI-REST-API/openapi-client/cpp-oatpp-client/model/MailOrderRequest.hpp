...
#ifndef MailOrderRequest_H_
#define MailOrderRequest_H_
 ...
 */
class MailOrderRequest : public oatpp::DTO {

  DTO_INIT(MailOrderRequest, DTO /* Extends */)
