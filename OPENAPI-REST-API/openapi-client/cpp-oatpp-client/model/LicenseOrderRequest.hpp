...
#ifndef LicenseOrderRequest_H_
#define LicenseOrderRequest_H_
 ...
 */
class LicenseOrderRequest : public oatpp::DTO {

  DTO_INIT(LicenseOrderRequest, DTO /* Extends */)

  DTO_FIELD(oatpp::Int32, package);
