...
#ifndef QsOrderRequest_H_
#define QsOrderRequest_H_
 ...
 */
class QsOrderRequest : public oatpp::DTO {

  DTO_INIT(QsOrderRequest, DTO /* Extends */)

  DTO_FIELD(oatpp::Int32, server);
