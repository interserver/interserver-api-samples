...
#
package InterServerAPI::SSLCertificatesApi;
...
#
# @param SslOrderRequest $ssl_order_request  (required)
{
    my $params = {
    'ssl_order_request' => {
        data_type => 'SslOrderRequest',
        description => '',
        required => '1',
    },
    };
...
sub add_ssl {
    ...
    unless (exists $args{'ssl_order_request'}) {
      croak("Missing the required parameter 'ssl_order_request' when calling add_ssl");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'ssl_order_request'}) {
        $_body_data = $args{'ssl_order_request'};
    }
...
sub put_ssl {
    ...
    # verify the required parameter 'ssl_order_request' is set
    unless (exists $args{'ssl_order_request'}) {
      croak("Missing the required parameter 'ssl_order_request' when calling put_ssl");
    }
