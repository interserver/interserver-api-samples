...
#
package InterServerAPI::Object::DomainOrderRequest;
...
__PACKAGE__->method_documentation({
    'hostname' => {
        datatype => 'string',
        base_name => 'hostname',
        description => 'Fully-qualified domain to register or transfer (e.g. example.com).',
        format => '',
        read_only => '',
            },
    'type' => {
    ...
    'coupon' => {
        datatype => 'string',
        base_name => 'coupon',
        description => 'Coupon code (addDomain only).',
        format => '',
        read_only => '',
            },
    'whois_privacy' => {
        ...
        description => 'Set to \&quot;enable\&quot; to add Whois privacy (addDomain only).',
        format => '',
        read_only => '',
            },
});
