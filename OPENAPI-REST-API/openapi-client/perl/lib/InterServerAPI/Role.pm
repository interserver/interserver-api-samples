...
has _cfg => ( is => 'ro',
              isa => 'InterServerAPI::Configuration',
              default => sub { InterServerAPI::Configuration->new() },
              );
...
sub _build_af {
    ...
    return InterServerAPI::ApiFactory->new(%args);
}
