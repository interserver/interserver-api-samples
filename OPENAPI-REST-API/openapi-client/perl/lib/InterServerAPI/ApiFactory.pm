...
#
package InterServerAPI::ApiFactory;
...
usesub InterServerAPI::Object;

use InterServerAPI::ApiClient;

=head1 Name

    InterServerAPI::ApiFactory - constructs APIs to retrieve InterServerAPI objects

=head1 Synopsis

    package My::Petstore::App;

    use InterServerAPI::ApiFactory;

    my $api_factory = InterServerAPI::ApiFactory->new( ... ); # any args for ApiClient constructor

    # later...
    my $pet_api = $api_factory->get_api('Pet');

    # $pet_api isa InterServerAPI::PetApi
...
my %_apis = map { $_ =~ /^InterServerAPI::(.*)$/; $1 => $_ }
            grep {$_ =~ /Api$/}
            usesub 'InterServerAPI';

=head1 new($api_client)

    create a new InterServerAPI::ApiFactory instance with the given InterServerAPI::ApiClient instance.

=head1 new(%parameters)

    Any parameters are optional, and are passed to and stored on the api_client object.

    See L<InterServerAPI::ApiClient> and L<InterServerAPI::Configuration> for valid parameters
