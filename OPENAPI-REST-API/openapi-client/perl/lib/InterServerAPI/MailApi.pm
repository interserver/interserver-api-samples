...
#
package InterServerAPI::MailApi;
...
#
# @param MailOrderRequest $mail_order_request  (required)
{
    my $params = {
    'mail_order_request' => {
        data_type => 'MailOrderRequest',
        description => '',
        required => '1',
    },
    };
...
sub add_mail {
    ...
    unless (exists $args{'mail_order_request'}) {
      croak("Missing the required parameter 'mail_order_request' when calling add_mail");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'mail_order_request'}) {
        $_body_data = $args{'mail_order_request'};
    }
...
#
# @param int $id The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;. (required)
# @param DeleteMailAlertRequest $delete_mail_alert_request  (required)
{
    my $params = {
    'id' => {
        data_type => 'int',
    ...
    'delete_mail_alert_request' => {
        data_type => 'DeleteMailAlertRequest',
        description => '',
        required => '1',
    },
    };
...
sub delete_mail_alert {
    ...
    unless (exists $args{'delete_mail_alert_request'}) {
      croak("Missing the required parameter 'delete_mail_alert_request' when calling delete_mail_alert");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'delete_mail_alert_request'}) {
        $_body_data = $args{'delete_mail_alert_request'};
    }
...
sub put_mail {
    ...
    # verify the required parameter 'mail_order_request' is set
    unless (exists $args{'mail_order_request'}) {
      croak("Missing the required parameter 'mail_order_request' when calling put_mail");
    }
...
# @param DenyRuleNew $deny_rule_new  (required)
{
    my $params = {
    'id' => {
        data_type => 'int',
...
sub update_rule {
    ...
    # verify the required parameter 'id' is set
    unless (exists $args{'id'}) {
      croak("Missing the required parameter 'id' when calling update_rule");
    }

    # verify the required parameter 'rule' is set
    unless (exists $args{'rule'}) {
      croak("Missing the required parameter 'rule' when calling update_rule");
    }

    # verify the required parameter 'deny_rule_new' is set
    unless (exists $args{'deny_rule_new'}) {
      croak("Missing the required parameter 'deny_rule_new' when calling update_rule");
    }
