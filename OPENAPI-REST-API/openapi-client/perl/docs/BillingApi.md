# InterServerAPI::BillingApi

## Load the API package
```perl
use InterServerAPI::Object::BillingApi;
```
...
my $api_instance = InterServerAPI::BillingApi->new(
...
my $billing_add_cc_request = InterServerAPI::Object::BillingAddCcRequest->new(); # BillingAddCcRequest | 
...
my $billing_prepay_request = InterServerAPI::Object::BillingPrepayRequest->new(); # BillingPrepayRequest | 
...
my $st = "st_example"; # string | Filter by status.
my $ex = "ex_example"; # string | Export format: csv, xls, xlsx, or pdf. Defaults to csv.
my $year = 56; # int | Year to filter the report. Defaults to the current year.

eval {
    $api_instance->get_affiliate_download(st => $st, ex => $ex, year => $year);
};
if ($@) {
    warn "Exception when calling BillingApi->get_affiliate_download: $@\n";
}
```
...
my $st = "st_example"; # string | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.

eval {
    my $result = $api_instance->get_affiliate_signups(st => $st);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BillingApi->get_affiliate_signups: $@\n";
}
```
...
> SuccessTextResponse patch_billing_credit_card_verify(id => $id, patch_billing_credit_card_verify_request => $patch_billing_credit_card_verify_request)
...
my $id = 56; # int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
my $patch_billing_credit_card_verify_request = InterServerAPI::Object::PatchBillingCreditCardVerifyRequest->new(); # PatchBillingCreditCardVerifyRequest | 

eval {
    my $result = $api_instance->patch_billing_credit_card_verify(id => $id, patch_billing_credit_card_verify_request => $patch_billing_credit_card_verify_request);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling BillingApi->patch_billing_credit_card_verify: $@\n";
}
```
...
my $id = 56; # int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
my $billing_verify_cc_request = InterServerAPI::Object::BillingVerifyCcRequest->new(); # BillingVerifyCcRequest | 
...
my $billing_payment_method_request = InterServerAPI::Object::BillingPaymentMethodRequest->new(); # BillingPaymentMethodRequest | 
