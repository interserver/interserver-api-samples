# InterServerAPI::PublicApi

## Load the API package
```perl
use InterServerAPI::Object::PublicApi;
```
...
my $api_instance = InterServerAPI::PublicApi->new(
...
eval {
    my $result = $api_instance->get_account_currencies();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PublicApi->get_account_currencies: $@\n";
}
```
...
eval {
    my $result = $api_instance->get_account_locales();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PublicApi->get_account_locales: $@\n";
}
```
...
my $patch_oauth_two_factor_request = InterServerAPI::Object::PatchOauthTwoFactorRequest->new(); # PatchOauthTwoFactorRequest | 
...
my $provider = "provider_example"; # string | The OAuth provider name (e.g. `Google`).
my $post_oauth_callback_request = InterServerAPI::Object::PostOauthCallbackRequest->new(); # PostOauthCallbackRequest | 
...
my $g_recaptcha_response = new InterServerAPI.LoginSubmissionExampleGRecaptchaResponse(); # LoginSubmissionExampleGRecaptchaResponse | 
...
my $login_submission_example = InterServerAPI::Object::LoginSubmissionExample->new(); # LoginSubmissionExample | 
