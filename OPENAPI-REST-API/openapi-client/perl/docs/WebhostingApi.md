# InterServerAPI::WebhostingApi

## Load the API package
```perl
use InterServerAPI::Object::WebhostingApi;
```
...
# **add_website**
> ServiceOrderPostResponse add_website(website_order_post_request => $website_order_post_request)
...
my $api_instance = InterServerAPI::WebhostingApi->new(
...
my $website_order_post_request = InterServerAPI::Object::WebsiteOrderPostRequest->new(); # WebsiteOrderPostRequest | 

eval {
    my $result = $api_instance->add_website(website_order_post_request => $website_order_post_request);
    print Dumper($result);
};
if ($@) {
...
my $id = 56; # int | The website service ID. Use `website_id` from `GET /websites`.
my $post_website_buy_ip_request = InterServerAPI::Object::PostWebsiteBuyIpRequest->new(); # PostWebsiteBuyIpRequest | 
...
my $id = 56; # int | The website service ID. Use `website_id` from `GET /websites`.
my $post_website_migration_request = InterServerAPI::Object::PostWebsiteMigrationRequest->new(); # PostWebsiteMigrationRequest | 
...
my $website_order_put_request = InterServerAPI::Object::WebsiteOrderPutRequest->new(); # WebsiteOrderPutRequest | 

eval {
    $api_instance->put_websites(website_order_put_request => $website_order_put_request);
};
if ($@) {
