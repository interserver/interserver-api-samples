# InterServerAPI::QuickServersApi

## Load the API package
```perl
use InterServerAPI::Object::QuickServersApi;
```
...
# **add_qs**
> ServiceOrderPostResponse add_qs(qs_order_request => $qs_order_request)
...
my $api_instance = InterServerAPI::QuickServersApi->new(
...
my $qs_order_request = InterServerAPI::Object::QsOrderRequest->new(); # QsOrderRequest | 

eval {
    my $result = $api_instance->add_qs(qs_order_request => $qs_order_request);
    print Dumper($result);
};
if ($@) {
...
# **get_qs_backup**
> QueueResponse get_qs_backup(id => $id)
...
eval {
    my $result = $api_instance->get_qs_backup(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_backup: $@\n";
}
```
...
my $id = 56; # int | QuickServer ID number
my $restore_request = InterServerAPI::Object::RestoreRequest->new(); # RestoreRequest | QuickServer Restore request
...
eval {
    $api_instance->put_qs(qs_order_request => $qs_order_request);
};
if ($@) {
