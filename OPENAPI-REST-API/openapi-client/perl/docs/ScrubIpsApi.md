# InterServerAPI::ScrubIpsApi

## Load the API package
```perl
use InterServerAPI::Object::ScrubIpsApi;
```
...
my $api_instance = InterServerAPI::ScrubIpsApi->new(
...
my $id = 56; # int | ScrubIp ID number
my $create_filter = InterServerAPI::Object::CreateFilter->new(); # CreateFilter | 
...
my $id = 56; # int | ScrubIp ID number
my $create_geo_firewall_rule = InterServerAPI::Object::CreateGeoFirewallRule->new(); # CreateGeoFirewallRule | 
...
my $id = 56; # int | ScrubIp ID number
my $create_firewall_rule = InterServerAPI::Object::CreateFirewallRule->new(); # CreateFirewallRule | 
...
my $scrub_ip_place_order = InterServerAPI::Object::ScrubIpPlaceOrder->new(); # ScrubIpPlaceOrder | 
...
# **put_scrub_ips**
> PutScrubIps200Response put_scrub_ips(scrub_ip_place_order => $scrub_ip_place_order)
...
eval {
    my $result = $api_instance->put_scrub_ips(scrub_ip_place_order => $scrub_ip_place_order);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ScrubIpsApi->put_scrub_ips: $@\n";
}
```
...
my $id = 56; # int | ScrubIp ID number
my $delete_geo_firewall_rule = InterServerAPI::Object::DeleteGeoFirewallRule->new(); # DeleteGeoFirewallRule | 
...
my $id = 56; # int | ScrubIp ID number
my $delete_firewall_rule = InterServerAPI::Object::DeleteFirewallRule->new(); # DeleteFirewallRule | 
