# InterServerAPI::DomainsApi

## Load the API package
```perl
use InterServerAPI::Object::DomainsApi;
```
...
# **add_domain**
> ServiceOrderPostResponse add_domain(domain_order_request => $domain_order_request)
...
my $api_instance = InterServerAPI::DomainsApi->new(
...
my $domain_order_request = InterServerAPI::Object::DomainOrderRequest->new(); # DomainOrderRequest | 

eval {
    my $result = $api_instance->add_domain(domain_order_request => $domain_order_request);
    print Dumper($result);
};
if ($@) {
...
my $domain_dnssec_request = InterServerAPI::Object::DomainDnssecRequest->new(); # DomainDnssecRequest | 
...
my $id = 56; # int | The domain service ID. Use `domain_id` from `GET /domains`.
my $domain_nameserver_post_request = InterServerAPI::Object::DomainNameserverPostRequest->new(); # DomainNameserverPostRequest | 
...
> SuccessTextResponse delete_domain_dnssec(id => $id)
...
eval {
    my $result = $api_instance->delete_domain_dnssec(id => $id);
    print Dumper($result);
};
if ($@) {
...
eval {
    $api_instance->patch_domains(domain_order_request => $domain_order_request);
};
if ($@) {
...
eval {
    $api_instance->post_domain_search(name => $name);
};
if ($@) {
    warn "Exception when calling DomainsApi->post_domain_search: $@\n";
}
```
...
eval {
    $api_instance->put_domains(domain_order_request => $domain_order_request);
};
if ($@) {
...
my $id = 56; # int | The domain service ID. Use `domain_id` from `GET /domains`.
my $domain_contact_details = InterServerAPI::Object::DomainContactDetails->new(); # DomainContactDetails | 
...
my $id = 56; # int | The domain service ID. Use `domain_id` from `GET /domains`.
my $domain_nameserver_put_request = InterServerAPI::Object::DomainNameserverPutRequest->new(); # DomainNameserverPutRequest | 
...
my $id = 56; # int | The domain service ID. Use `domain_id` from `GET /domains`.
my $domain_whois_privacy_request = InterServerAPI::Object::DomainWhoisPrivacyRequest->new(); # DomainWhoisPrivacyRequest | 
