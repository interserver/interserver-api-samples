# InterServerAPI::TicketsApi

## Load the API package
```perl
use InterServerAPI::Object::TicketsApi;
```
...
my $api_instance = InterServerAPI::TicketsApi->new(
...
my $ticket_new = InterServerAPI::Object::TicketNew->new(); # TicketNew | 
...
my $reply_ticket_request = InterServerAPI::Object::ReplyTicketRequest->new(); # ReplyTicketRequest | 
...
my $id = 3.4; # double | The ticket ID number.
my $update_ticket = InterServerAPI::Object::UpdateTicket->new(); # UpdateTicket | 
