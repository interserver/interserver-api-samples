# InterServerAPI::MailApi

## Load the API package
```perl
use InterServerAPI::Object::MailApi;
```
...
# **add_mail**
> ServiceOrderPostResponse add_mail(mail_order_request => $mail_order_request)
...
my $api_instance = InterServerAPI::MailApi->new(
...
my $mail_order_request = InterServerAPI::Object::MailOrderRequest->new(); # MailOrderRequest | 

eval {
    my $result = $api_instance->add_mail(mail_order_request => $mail_order_request);
    print Dumper($result);
};
if ($@) {
...
my $deny_rule_new = InterServerAPI::Object::DenyRuleNew->new(); # DenyRuleNew | These are the fields needed to create a new email deny rule.
...
my $id = 56; # int | The mail service ID. Use `mail_id` from `GET /mail`.
my $mail_alert_request = InterServerAPI::Object::MailAlertRequest->new(); # MailAlertRequest | 
...
# **delete_mail_alert**
> SuccessTextResponse delete_mail_alert(id => $id, delete_mail_alert_request => $delete_mail_alert_request)
...
my $id = 56; # int | The mail service ID. Use `mail_id` from `GET /mail`.
my $delete_mail_alert_request = InterServerAPI::Object::DeleteMailAlertRequest->new(); # DeleteMailAlertRequest | 

eval {
    my $result = $api_instance->delete_mail_alert(id => $id, delete_mail_alert_request => $delete_mail_alert_request);
    print Dumper($result);
};
if ($@) {
...
my $id = 56; # int | The mail service ID. Use `mail_id` from `GET /mail`.
my $mail_delist_request = InterServerAPI::Object::MailDelistRequest->new(); # MailDelistRequest | 
...
eval {
    $api_instance->put_mail(mail_order_request => $mail_order_request);
};
if ($@) {
...
my $id = 56; # int | The mail service ID. Use `mail_id` from `GET /mail`.
my $send_mail_adv = InterServerAPI::Object::SendMailAdv->new(); # SendMailAdv | 
...
my $id = 56; # int | The mail service ID. Use `mail_id` from `GET /mail`.
my $send_mail = InterServerAPI::Object::SendMail->new(); # SendMail | 
...
my $id = 56; # int | The mail service ID. Use `mail_id` from `GET /mail`.
my $mail_alert_update_request = InterServerAPI::Object::MailAlertUpdateRequest->new(); # MailAlertUpdateRequest | 
...
# **update_rule**
> GenericResponse update_rule(id => $id, rule => $rule, deny_rule_new => $deny_rule_new)
...
my $id = 56; # int | The mail service ID. Use `mail_id` from `GET /mail`.
my $rule = "rule_example"; # string | The ID of the deny rule to update.
my $deny_rule_new = InterServerAPI::Object::DenyRuleNew->new(); # DenyRuleNew | 

eval {
    my $result = $api_instance->update_rule(id => $id, rule => $rule, deny_rule_new => $deny_rule_new);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling MailApi->update_rule: $@\n";
}
```
