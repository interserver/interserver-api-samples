...
class OAIMailOrderRequest : public OAIObject {
public:
    OAIMailOrderRequest();
    OAIMailOrderRequest(const QString &json);
    ~OAIMailOrderRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMailOrderRequest)

#endif // OAIMailOrderRequest_H
