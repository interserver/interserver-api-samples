...
#ifndef OAIDomainOrderRequest_H
#define OAIDomainOrderRequest_H
...
class OAIDomainOrderRequest : public OAIObject {
public:
    OAIDomainOrderRequest();
    OAIDomainOrderRequest(const QString &json);
    ~OAIDomainOrderRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainOrderRequest)

#endif // OAIDomainOrderRequest_H
