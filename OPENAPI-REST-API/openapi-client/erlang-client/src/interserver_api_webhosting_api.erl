-module(interserver_api_webhosting_api).

-export([add_website/2, add_website/3,
         ...
         put_websites/2, put_websites/3,
         update_website_info/2, update_website_info/3,
         webhosting_cancel/2, webhosting_cancel/3]).

-define(BASE_URL, <<"/apiv2">>).

%% @doc Place a new webhosting order, create the invoice, and queue provisioning
...
-spec add_website(ctx:ctx(), interserver_api_website_order_post_request:interserver_api_website_order_post_request()) -> {ok, interserver_api_service_order_post_response:interserver_api_service_order_post_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_website(Ctx, InterserverApiWebsiteOrderPostRequest) ->
    add_website(Ctx, InterserverApiWebsiteOrderPostRequest, #{}).

-spec add_website(ctx:ctx(), interserver_api_website_order_post_request:interserver_api_website_order_post_request(), maps:map()) -> {ok, interserver_api_service_order_post_response:interserver_api_service_order_post_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_website(Ctx, InterserverApiWebsiteOrderPostRequest, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiWebsiteOrderPostRequest,
...
%% @doc Read the webhosting order catalog — plans, packages, promo offers, pricing
...
-spec get_new_website(ctx:ctx()) -> {ok, interserver_api_websites_order:interserver_api_websites_order(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_new_website(Ctx) ->
    get_new_website(Ctx, #{}).

-spec get_new_website(ctx:ctx(), maps:map()) -> {ok, interserver_api_websites_order:interserver_api_websites_order(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read website IPs, current reverse DNS, and additional-IP pricing
...
-spec get_website_buy_ip(ctx:ctx(), integer()) -> {ok, interserver_api_get_website_buy_ip_200_response:interserver_api_get_website_buy_ip_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_website_buy_ip(Ctx, Id) ->
    get_website_buy_ip(Ctx, Id, #{}).

-spec get_website_buy_ip(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_get_website_buy_ip_200_response:interserver_api_get_website_buy_ip_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read full configuration and status detail for one webhosting service
...
-spec get_website_info(ctx:ctx(), integer()) -> {ok, interserver_api_website:interserver_api_website(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_website_info(Ctx, Id) ->
    get_website_info(Ctx, Id, #{}).

-spec get_website_info(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_website:interserver_api_website(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List all billing invoices and recurring charges scoped to one website
...
-spec get_website_invoices(ctx:ctx(), integer()) -> {ok, interserver_api_charge_invoice_rows:interserver_api_charge_invoice_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_website_invoices(Ctx, Id) ->
    get_website_invoices(Ctx, Id, #{}).

-spec get_website_invoices(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_charge_invoice_rows:interserver_api_charge_invoice_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List the caller's webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services
...
-spec get_website_list(ctx:ctx()) -> {ok, [interserver_api_website_row:interserver_api_website_row()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_website_list(Ctx) ->
    get_website_list(Ctx, #{}).

-spec get_website_list(ctx:ctx(), maps:map()) -> {ok, [interserver_api_website_row:interserver_api_website_row()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List off-site cpmove backups stored in Swift — list or inline-download archive
...
-spec get_websites_backups(ctx:ctx(), integer()) -> {ok, interserver_api_website_backups:interserver_api_website_backups(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_websites_backups(Ctx, Id) ->
    get_websites_backups(Ctx, Id, #{}).

-spec get_websites_backups(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_website_backups:interserver_api_website_backups(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Get a one-time auto-login URL for the website's control panel
...
-spec get_websites_login(ctx:ctx(), integer()) -> {ok, interserver_api_website_login_response:interserver_api_website_login_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_websites_login(Ctx, Id) ->
    get_websites_login(Ctx, Id, #{}).

-spec get_websites_login(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_website_login_response:interserver_api_website_login_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Resend the webhosting welcome email with control-panel credentials and URL
...
-spec get_websites_welcome_email(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_websites_welcome_email(Ctx, Id) ->
    get_websites_welcome_email(Ctx, Id, #{}).

-spec get_websites_welcome_email(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read current reverse-DNS (PTR) records for the website's IPs
...
-spec gett_website_reverse_dns(ctx:ctx(), integer()) -> {ok, interserver_api_reverse_dns_entries:interserver_api_reverse_dns_entries(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
gett_website_reverse_dns(Ctx, Id) ->
    gett_website_reverse_dns(Ctx, Id, #{}).

-spec gett_website_reverse_dns(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_reverse_dns_entries:interserver_api_reverse_dns_entries(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Buy an additional IP for the website OR update reverse DNS records
...
-spec post_website_buy_ip(ctx:ctx(), integer(), interserver_api_post_website_buy_ip_request:interserver_api_post_website_buy_ip_request()) -> {ok, interserver_api_post_website_buy_ip_200_response:interserver_api_post_website_buy_ip_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_website_buy_ip(Ctx, Id, InterserverApiPostWebsiteBuyIpRequest) ->
    post_website_buy_ip(Ctx, Id, InterserverApiPostWebsiteBuyIpRequest, #{}).

-spec post_website_buy_ip(ctx:ctx(), integer(), interserver_api_post_website_buy_ip_request:interserver_api_post_website_buy_ip_request(), maps:map()) -> {ok, interserver_api_post_website_buy_ip_200_response:interserver_api_post_website_buy_ip_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_website_buy_ip(Ctx, Id, InterserverApiPostWebsiteBuyIpRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiPostWebsiteBuyIpRequest,
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"application/json">>, <<"multipart/form-data">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Submit a request for InterServer staff to migrate a website from another host
...
-spec post_website_migration(ctx:ctx(), integer(), interserver_api_post_website_migration_request:interserver_api_post_website_migration_request()) -> {ok, interserver_api_post_website_migration_200_response:interserver_api_post_website_migration_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_website_migration(Ctx, Id, InterserverApiPostWebsiteMigrationRequest) ->
    post_website_migration(Ctx, Id, InterserverApiPostWebsiteMigrationRequest, #{}).

-spec post_website_migration(ctx:ctx(), integer(), interserver_api_post_website_migration_request:interserver_api_post_website_migration_request(), maps:map()) -> {ok, interserver_api_post_website_migration_200_response:interserver_api_post_website_migration_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_website_migration(Ctx, Id, InterserverApiPostWebsiteMigrationRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiPostWebsiteMigrationRequest,
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"application/json">>, <<"multipart/form-data">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Bulk-update reverse-DNS (PTR) records for one or more website IPs
...
-spec post_websites_reverse_dns(ctx:ctx(), integer(), interserver_api_reverse_dns_entries:interserver_api_reverse_dns_entries()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_websites_reverse_dns(Ctx, Id, InterserverApiReverseDnsEntries) ->
    post_websites_reverse_dns(Ctx, Id, InterserverApiReverseDnsEntries, #{}).

-spec post_websites_reverse_dns(ctx:ctx(), integer(), interserver_api_reverse_dns_entries:interserver_api_reverse_dns_entries(), maps:map()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_websites_reverse_dns(Ctx, Id, InterserverApiReverseDnsEntries, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Validate a webhosting order and preview cost — dry run, no charge
...
-spec put_websites(ctx:ctx(), interserver_api_website_order_put_request:interserver_api_website_order_put_request()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_websites(Ctx, InterserverApiWebsiteOrderPutRequest) ->
    put_websites(Ctx, InterserverApiWebsiteOrderPutRequest, #{}).

-spec put_websites(ctx:ctx(), interserver_api_website_order_put_request:interserver_api_website_order_put_request(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_websites(Ctx, InterserverApiWebsiteOrderPutRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiWebsiteOrderPutRequest,
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc POST mutation hook for the website detail page (use dedicated ops where possible)
...
-spec update_website_info(ctx:ctx(), binary()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_website_info(Ctx, Id) ->
    update_website_info(Ctx, Id, #{}).

-spec update_website_info(ctx:ctx(), binary(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Schedule termination of a webhosting service — wipes panel account at cycle end
...
-spec webhosting_cancel(ctx:ctx(), binary()) -> {ok, interserver_api_webhosting_cancel_200_response:interserver_api_webhosting_cancel_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
webhosting_cancel(Ctx, Id) ->
    webhosting_cancel(Ctx, Id, #{}).

-spec webhosting_cancel(ctx:ctx(), binary(), maps:map()) -> {ok, interserver_api_webhosting_cancel_200_response:interserver_api_webhosting_cancel_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
