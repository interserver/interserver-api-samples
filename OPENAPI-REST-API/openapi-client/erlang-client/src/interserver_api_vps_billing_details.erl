-module(interserver_api_vps_billing_details).

-export([encode/1]).

-export_type([interserver_api_vps_billing_details/0]).

-type interserver_api_vps_billing_details() ::
    #{ 'service_last_invoice_date' => binary(),
       ...
       'service_extra' => interserver_api_vps_service_extra:interserver_api_vps_service_extra(),
