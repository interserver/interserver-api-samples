-module(interserver_api_license_billing_details).

-export([encode/1]).

-export_type([interserver_api_license_billing_details/0]).

-type interserver_api_license_billing_details() ::
    #{ 'service_last_invoice_date' => binary(),
       'service_payment_status' => binary(),
       'service_frequency' => binary(),
       'next_date' => interserver_api_date_time:interserver_api_date_time(),
