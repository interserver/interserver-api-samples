-module(interserver_api_licenses_order_service_types11482).

-export([encode/1]).

-export_type([interserver_api_licenses_order_service_types11482/0]).

-type interserver_api_licenses_order_service_types11482() ::
    #{ 'services_id' => binary(),
