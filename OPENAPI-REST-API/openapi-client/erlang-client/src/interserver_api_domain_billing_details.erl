-module(interserver_api_domain_billing_details).

-export([encode/1]).

-export_type([interserver_api_domain_billing_details/0]).

-type interserver_api_domain_billing_details() ::
    #{ 'service_last_invoice_date' => binary(),
       ...
       'service_extra' => interserver_api_domain_billing_extra:interserver_api_domain_billing_extra(),
