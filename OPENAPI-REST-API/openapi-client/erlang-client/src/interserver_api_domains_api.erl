-module(interserver_api_domains_api).
...
-export([add_domain/2, add_domain/3,
         ...
         delete_domain_dnssec/2, delete_domain_dnssec/3,
         ...
         patch_domains/2, patch_domains/3,
         post_domain_renewal/2, post_domain_renewal/3,
         post_domain_search/2, post_domain_search/3,
         post_domain_transfer/2, post_domain_transfer/3,
         put_domains/2, put_domains/3,
...
%% @doc Place a new domain registration or transfer order, generate billing invoice
...
-spec add_domain(ctx:ctx(), interserver_api_domain_order_request:interserver_api_domain_order_request()) -> {ok, interserver_api_service_order_post_response:interserver_api_service_order_post_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_domain(Ctx, InterserverApiDomainOrderRequest) ->
    add_domain(Ctx, InterserverApiDomainOrderRequest, #{}).

-spec add_domain(ctx:ctx(), interserver_api_domain_order_request:interserver_api_domain_order_request(), maps:map()) -> {ok, interserver_api_service_order_post_response:interserver_api_service_order_post_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_domain(Ctx, InterserverApiDomainOrderRequest, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiDomainOrderRequest,
...
%% @doc Register DNSSEC DS records on the domain at OpenSRS
...
-spec add_domain_dnssec(ctx:ctx(), integer(), interserver_api_domain_dnssec_request:interserver_api_domain_dnssec_request()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_domain_dnssec(Ctx, Id, InterserverApiDomainDnssecRequest) ->
    add_domain_dnssec(Ctx, Id, InterserverApiDomainDnssecRequest, #{}).

-spec add_domain_dnssec(ctx:ctx(), integer(), interserver_api_domain_dnssec_request:interserver_api_domain_dnssec_request(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_domain_dnssec(Ctx, Id, InterserverApiDomainDnssecRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiDomainDnssecRequest,
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"application/json">>, <<"multipart/form-data">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Register a new nameserver host with glue IP at the registry (registered nameserver)
...
-spec add_domain_nameserver(ctx:ctx(), integer(), interserver_api_domain_nameserver_post_request:interserver_api_domain_nameserver_post_request()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_domain_nameserver(Ctx, Id, InterserverApiDomainNameserverPostRequest) ->
    add_domain_nameserver(Ctx, Id, InterserverApiDomainNameserverPostRequest, #{}).

-spec add_domain_nameserver(ctx:ctx(), integer(), interserver_api_domain_nameserver_post_request:interserver_api_domain_nameserver_post_request(), maps:map()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_domain_nameserver(Ctx, Id, InterserverApiDomainNameserverPostRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiDomainNameserverPostRequest,
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"application/json">>, <<"multipart/form-data">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Cancel a domain order in the billing system to stop auto-renewals
...
-spec cancel_domain(ctx:ctx(), integer()) -> {ok, interserver_api_cancel_domain_200_response:interserver_api_cancel_domain_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
cancel_domain(Ctx, Id) ->
    cancel_domain(Ctx, Id, #{}).

-spec cancel_domain(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_cancel_domain_200_response:interserver_api_cancel_domain_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)
...
-spec delete_domain_dnssec(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
delete_domain_dnssec(Ctx, Id) ->
    delete_domain_dnssec(Ctx, Id, #{}).

-spec delete_domain_dnssec(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
delete_domain_dnssec(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Remove one registered nameserver glue record from the domain
...
-spec delete_domain_nameserver(ctx:ctx(), integer(), integer()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
delete_domain_nameserver(Ctx, Id, Index) ->
    delete_domain_nameserver(Ctx, Id, Index, #{}).

-spec delete_domain_nameserver(ctx:ctx(), integer(), integer(), maps:map()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
delete_domain_nameserver(Ctx, Id, Index, Optional) ->
    ...
    Method = delete,
    Path = [?BASE_URL, "/domains/", Id, "/nameservers"],
    QS = lists:flatten([{<<"index">>, Index}])++interserver_api_utils:optional_params([], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = interserver_api_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Read the current registrant/admin/tech/billing contact field set for a domain
...
-spec get_domain_contact(ctx:ctx(), integer()) -> {ok, interserver_api_domain_contact_details:interserver_api_domain_contact_details(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_contact(Ctx, Id) ->
    get_domain_contact(Ctx, Id, #{}).

-spec get_domain_contact(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_domain_contact_details:interserver_api_domain_contact_details(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read the DNSSEC DS record set currently registered with the registrar
...
-spec get_domain_dnssec(ctx:ctx(), integer()) -> {ok, interserver_api_domain_dnssec_records:interserver_api_domain_dnssec_records(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_dnssec(Ctx, Id) ->
    get_domain_dnssec(Ctx, Id, #{}).

-spec get_domain_dnssec(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_domain_dnssec_records:interserver_api_domain_dnssec_records(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read full billing, registrar, and service detail for one domain
...
-spec get_domain_info(ctx:ctx(), integer()) -> {ok, interserver_api_domain:interserver_api_domain(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_info(Ctx, Id) ->
    get_domain_info(Ctx, Id, #{}).

-spec get_domain_info(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_domain:interserver_api_domain(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List all billing invoices scoped to one domain order
...
-spec get_domain_invoices(ctx:ctx(), integer()) -> {ok, interserver_api_charge_invoice_rows:interserver_api_charge_invoice_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_invoices(Ctx, Id) ->
    get_domain_invoices(Ctx, Id, #{}).

-spec get_domain_invoices(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_charge_invoice_rows:interserver_api_charge_invoice_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Check availability, premium status, and pricing for a specific domain
...
-spec get_domain_lookup(ctx:ctx(), binary()) -> {ok, interserver_api_domain_lookup_response:interserver_api_domain_lookup_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_lookup(Ctx, Name) ->
    get_domain_lookup(Ctx, Name, #{}).

-spec get_domain_lookup(ctx:ctx(), binary(), maps:map()) -> {ok, interserver_api_domain_lookup_response:interserver_api_domain_lookup_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List registered nameserver hosts and glue IP addresses for a domain
...
-spec get_domain_nameservers(ctx:ctx(), integer()) -> {ok, interserver_api_domain_nameserver_get_response:interserver_api_domain_nameserver_get_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_nameservers(Ctx, Id) ->
    get_domain_nameservers(Ctx, Id, #{}).

-spec get_domain_nameservers(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_domain_nameserver_get_response:interserver_api_domain_nameserver_get_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read renewal pricing, expiry, and whether a renewal invoice already exists
...
-spec get_domain_renewal(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_renewal(Ctx, Id) ->
    get_domain_renewal(Ctx, Id, #{}).

-spec get_domain_renewal(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Get registrar-suggested domain alternatives and bulk availability for a search term
...
-spec get_domain_search(ctx:ctx(), binary()) -> {ok, interserver_api_domain_search_response:interserver_api_domain_search_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_search(Ctx, Name) ->
    get_domain_search(Ctx, Name, #{}).

-spec get_domain_search(ctx:ctx(), binary(), maps:map()) -> {ok, interserver_api_domain_search_response:interserver_api_domain_search_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read OpenSRS transfer status for an in-progress domain transfer order
...
-spec get_domain_transfer(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_transfer(Ctx, Id) ->
    get_domain_transfer(Ctx, Id, #{}).

-spec get_domain_transfer(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read Whois privacy availability, current state, and add-on pricing for a domain
...
-spec get_domain_whois_privacy(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domain_whois_privacy(Ctx, Id) ->
    get_domain_whois_privacy(Ctx, Id, #{}).

-spec get_domain_whois_privacy(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List every domain registration on the account with billing and registration metadata
...
-spec get_domains_list(ctx:ctx()) -> {ok, [interserver_api_domain_row:interserver_api_domain_row()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domains_list(Ctx) ->
    get_domains_list(Ctx, #{}).

-spec get_domains_list(ctx:ctx(), maps:map()) -> {ok, [interserver_api_domain_row:interserver_api_domain_row()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Resend the domain welcome email with registration details and management instructions
...
-spec get_domains_welcome_email(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_domains_welcome_email(Ctx, Id) ->
    get_domains_welcome_email(Ctx, Id, #{}).

-spec get_domains_welcome_email(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read the buyable domain TLD service catalog and Whois privacy pricing
...
-spec get_new_domain(ctx:ctx()) -> {ok, interserver_api_domain_order:interserver_api_domain_order(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_new_domain(Ctx) ->
    get_new_domain(Ctx, #{}).

-spec get_new_domain(ctx:ctx(), maps:map()) -> {ok, interserver_api_domain_order:interserver_api_domain_order(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Validate posted domain-order field values before committing — dry run
...
-spec patch_domains(ctx:ctx(), interserver_api_domain_order_request:interserver_api_domain_order_request()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
patch_domains(Ctx, InterserverApiDomainOrderRequest) ->
    patch_domains(Ctx, InterserverApiDomainOrderRequest, #{}).

-spec patch_domains(ctx:ctx(), interserver_api_domain_order_request:interserver_api_domain_order_request(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
patch_domains(Ctx, InterserverApiDomainOrderRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Submit a domain renewal request and generate the renewal invoice
...
-spec post_domain_renewal(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_domain_renewal(Ctx, Id) ->
    post_domain_renewal(Ctx, Id, #{}).

-spec post_domain_renewal(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Get the full order form data for a hostname in one round-trip (search → order preview)
...
-spec post_domain_search(ctx:ctx(), binary()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_domain_search(Ctx, Name) ->
    post_domain_search(Ctx, Name, #{}).

-spec post_domain_search(ctx:ctx(), binary(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_domain_search(Ctx, Name, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Re-poll OpenSRS transfer status for a domain order via POST
...
-spec post_domain_transfer(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_domain_transfer(Ctx, Id) ->
    post_domain_transfer(Ctx, Id, #{}).

-spec post_domain_transfer(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Preview per-TLD field requirements for a domain order — no commit
...
-spec put_domains(ctx:ctx(), interserver_api_domain_order_request:interserver_api_domain_order_request()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_domains(Ctx, InterserverApiDomainOrderRequest) ->
    put_domains(Ctx, InterserverApiDomainOrderRequest, #{}).

-spec put_domains(ctx:ctx(), interserver_api_domain_order_request:interserver_api_domain_order_request(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_domains(Ctx, InterserverApiDomainOrderRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Update registrant/admin contact details and push them to OpenSRS
...
-spec update_domain_contact(ctx:ctx(), integer(), interserver_api_domain_contact_details:interserver_api_domain_contact_details()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_domain_contact(Ctx, Id, InterserverApiDomainContactDetails) ->
    update_domain_contact(Ctx, Id, InterserverApiDomainContactDetails, #{}).

-spec update_domain_contact(ctx:ctx(), integer(), interserver_api_domain_contact_details:interserver_api_domain_contact_details(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_domain_contact(Ctx, Id, InterserverApiDomainContactDetails, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiDomainContactDetails,
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"application/json">>, <<"multipart/form-data">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc POST mutation hook for the domain detail page (use dedicated ops where possible)
...
-spec update_domain_info(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_domain_info(Ctx, Id) ->
    update_domain_info(Ctx, Id, #{}).

-spec update_domain_info(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Replace the full authoritative-nameserver delegation list at the registrar
...
-spec update_domain_nameservers(ctx:ctx(), integer(), interserver_api_domain_nameserver_put_request:interserver_api_domain_nameserver_put_request()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_domain_nameservers(Ctx, Id, InterserverApiDomainNameserverPutRequest) ->
    update_domain_nameservers(Ctx, Id, InterserverApiDomainNameserverPutRequest, #{}).

-spec update_domain_nameservers(ctx:ctx(), integer(), interserver_api_domain_nameserver_put_request:interserver_api_domain_nameserver_put_request(), maps:map()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_domain_nameservers(Ctx, Id, InterserverApiDomainNameserverPutRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiDomainNameserverPutRequest,
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"application/json">>, <<"multipart/form-data">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Order, enable, or cancel the Whois privacy add-on for a domain
...
-spec update_domain_whois_privacy(ctx:ctx(), integer(), interserver_api_domain_whois_privacy_request:interserver_api_domain_whois_privacy_request()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_domain_whois_privacy(Ctx, Id, InterserverApiDomainWhoisPrivacyRequest) ->
    update_domain_whois_privacy(Ctx, Id, InterserverApiDomainWhoisPrivacyRequest, #{}).

-spec update_domain_whois_privacy(ctx:ctx(), integer(), interserver_api_domain_whois_privacy_request:interserver_api_domain_whois_privacy_request(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_domain_whois_privacy(Ctx, Id, InterserverApiDomainWhoisPrivacyRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiDomainWhoisPrivacyRequest,
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"application/json">>, <<"multipart/form-data">>]),
    Opts = maps:get(hackney_opts, Optional, []),
