-module(interserver_api_licenses_api).

-export([add_license/2, add_license/3,
         ...
         put_licenses/2, put_licenses/3,
         update_license_info/2, update_license_info/3]).

-define(BASE_URL, <<"/apiv2">>).

%% @doc Order a new software license and create the recurring invoice
...
-spec add_license(ctx:ctx(), interserver_api_license_order_request:interserver_api_license_order_request()) -> {ok, interserver_api_service_order_post_response:interserver_api_service_order_post_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_license(Ctx, InterserverApiLicenseOrderRequest) ->
    add_license(Ctx, InterserverApiLicenseOrderRequest, #{}).

-spec add_license(ctx:ctx(), interserver_api_license_order_request:interserver_api_license_order_request(), maps:map()) -> {ok, interserver_api_service_order_post_response:interserver_api_service_order_post_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_license(Ctx, InterserverApiLicenseOrderRequest, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiLicenseOrderRequest,
...
%% @doc Get full details for one license including status, IP, and links
...
-spec get_license_info(ctx:ctx(), integer()) -> {ok, interserver_api_license:interserver_api_license(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_license_info(Ctx, Id) ->
    get_license_info(Ctx, Id, #{}).

-spec get_license_info(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_license:interserver_api_license(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List all billing invoices tied to one software license service
...
-spec get_license_invoices(ctx:ctx(), integer()) -> {ok, interserver_api_charge_invoice_rows:interserver_api_charge_invoice_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_license_invoices(Ctx, Id) ->
    get_license_invoices(Ctx, Id, #{}).

-spec get_license_invoices(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_charge_invoice_rows:interserver_api_charge_invoice_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List all software licenses owned by the authenticated customer
...
-spec get_license_list(ctx:ctx()) -> {ok, [interserver_api_license_row:interserver_api_license_row()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_license_list(Ctx) ->
    get_license_list(Ctx, #{}).

-spec get_license_list(ctx:ctx(), maps:map()) -> {ok, [interserver_api_license_row:interserver_api_license_row()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Resend the license welcome email with the key and activation steps
...
-spec get_licenses_welcome_email(ctx:ctx(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_licenses_welcome_email(Ctx, Id) ->
    get_licenses_welcome_email(Ctx, Id, #{}).

-spec get_licenses_welcome_email(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Get available license types, packages, and pricing for ordering
...
-spec get_new_license(ctx:ctx()) -> {ok, interserver_api_licenses_order:interserver_api_licenses_order(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_new_license(Ctx) ->
    get_new_license(Ctx, #{}).

-spec get_new_license(ctx:ctx(), maps:map()) -> {ok, interserver_api_licenses_order:interserver_api_licenses_order(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Cancel a license service and stop future billing (irreversible)
...
-spec licenses_cancel(ctx:ctx(), integer()) -> {ok, interserver_api_licenses_cancel_200_response:interserver_api_licenses_cancel_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
licenses_cancel(Ctx, Id) ->
    licenses_cancel(Ctx, Id, #{}).

-spec licenses_cancel(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_licenses_cancel_200_response:interserver_api_licenses_cancel_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Rebind a license to a new IP address (may incur a vendor fee)
...
-spec post_license_change_ip(ctx:ctx(), integer(), interserver_api_ip_object:interserver_api_ip_object()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_license_change_ip(Ctx, Id, InterserverApiIpObject) ->
    post_license_change_ip(Ctx, Id, InterserverApiIpObject, #{}).

-spec post_license_change_ip(ctx:ctx(), integer(), interserver_api_ip_object:interserver_api_ip_object(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_license_change_ip(Ctx, Id, InterserverApiIpObject, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
-spec put_licenses(ctx:ctx(), interserver_api_license_order_request:interserver_api_license_order_request()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_licenses(Ctx, InterserverApiLicenseOrderRequest) ->
    put_licenses(Ctx, InterserverApiLicenseOrderRequest, #{}).

-spec put_licenses(ctx:ctx(), interserver_api_license_order_request:interserver_api_license_order_request(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_licenses(Ctx, InterserverApiLicenseOrderRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Update mutable fields on a license service (e.g. assigned IP)
...
-spec update_license_info(ctx:ctx(), binary()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_license_info(Ctx, Id) ->
    update_license_info(Ctx, Id, #{}).

-spec update_license_info(ctx:ctx(), binary(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
