-module(interserver_api_vps_api).
...
-export([add_vps/2, add_vps/3,
         ...
         post_vps_traffic_usage/2, post_vps_traffic_usage/3,
         post_vps_view_desktop/2, post_vps_view_desktop/3,
         put_vps/2, put_vps/3,
         put_vps_buy_hd_space/2, put_vps_buy_hd_space/3,
         update_vps_info/2, update_vps_info/3,
         v_ps_cancel/2, v_ps_cancel/3]).

-define(BASE_URL, <<"/apiv2">>).

%% @doc Place a new VPS order, create the invoice, and queue provisioning
...
-spec add_vps(ctx:ctx()) -> {ok, interserver_api_service_order_post_response:interserver_api_service_order_post_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_vps(Ctx) ->
    add_vps(Ctx, #{}).

-spec add_vps(ctx:ctx(), maps:map()) -> {ok, interserver_api_service_order_post_response:interserver_api_service_order_post_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_vps(Ctx, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiVpsOrderPostRequest,
...
%% @doc Permanently delete a VPS backup file by name (irreversible)
...
-spec delete_vps_backup(ctx:ctx(), integer(), binary()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
delete_vps_backup(Ctx, Id, File) ->
    delete_vps_backup(Ctx, Id, File, #{}).

-spec delete_vps_backup(ctx:ctx(), integer(), binary(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Block outbound SMTP (port 25) on the VPS to prevent spam/abuse
...
-spec do_vps_block_smtp(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
do_vps_block_smtp(Ctx, Id) ->
    do_vps_block_smtp(Ctx, Id, #{}).

-spec do_vps_block_smtp(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Remove the virtual CD/DVD device entirely from the VPS configuration
...
-spec do_vps_disable_cd(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
do_vps_disable_cd(Ctx, Id) ->
    do_vps_disable_cd(Ctx, Id, #{}).

-spec do_vps_disable_cd(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Disable per-user disk quota enforcement inside the VPS guest OS
...
-spec do_vps_disable_quota(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
do_vps_disable_quota(Ctx, Id) ->
    do_vps_disable_quota(Ctx, Id, #{}).

-spec do_vps_disable_quota(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Eject the mounted ISO from the VPS virtual CD drive (keep the drive)
...
-spec do_vps_eject_cd(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
do_vps_eject_cd(Ctx, Id) ->
    do_vps_eject_cd(Ctx, Id, #{}).

-spec do_vps_eject_cd(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Enable per-user disk quota enforcement inside the VPS guest OS
...
-spec do_vps_enable_quota(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
do_vps_enable_quota(Ctx, Id) ->
    do_vps_enable_quota(Ctx, Id, #{}).

-spec do_vps_enable_quota(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Reboot the VPS — preferred over stop+start for software changes
...
-spec do_vps_restart(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
do_vps_restart(Ctx, Id) ->
    do_vps_restart(Ctx, Id, #{}).

-spec do_vps_restart(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Power on a stopped VPS instance
...
-spec do_vps_start(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
do_vps_start(Ctx, Id) ->
    do_vps_start(Ctx, Id, #{}).

-spec do_vps_start(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Power off a running VPS — billing continues until cancellation
...
-spec do_vps_stop(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
do_vps_stop(Ctx, Id) ->
    do_vps_stop(Ctx, Id, #{}).

-spec do_vps_stop(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
...
%% @doc Get the VPS order catalog — platforms, OS templates, locations, pricing
...
-spec get_new_vps(ctx:ctx()) -> {ok, interserver_api_vps_order:interserver_api_vps_order(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_new_vps(Ctx) ->
    get_new_vps(Ctx, #{}).

-spec get_new_vps(ctx:ctx(), maps:map()) -> {ok, interserver_api_vps_order:interserver_api_vps_order(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Trigger a manual on-demand snapshot/backup of the VPS
...
-spec get_vps_backup(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_backup(Ctx, Id) ->
    get_vps_backup(Ctx, Id, #{}).

-spec get_vps_backup(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_backup(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc List existing backups for the VPS across Swift, MinIO, and ZFS
...
-spec get_vps_backups(ctx:ctx(), integer()) -> {ok, interserver_api_vps_backup_rows:interserver_api_vps_backup_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_backups(Ctx, Id) ->
    get_vps_backups(Ctx, Id, #{}).

-spec get_vps_backups(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_vps_backup_rows:interserver_api_vps_backup_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Get current additional disk size and per-GB monthly cost for the VPS
...
-spec get_vps_buy_hd_space(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_buy_hd_space(Ctx, Id) ->
    get_vps_buy_hd_space(Ctx, Id, #{}).

-spec get_vps_buy_hd_space(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read current additional IPs, cap, and per-IP monthly cost for the VPS
...
-spec get_vps_buy_ip(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_buy_ip(Ctx, Id) ->
    get_vps_buy_ip(Ctx, Id, #{}).

-spec get_vps_buy_ip(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read the VPS's current hostname before changing it
...
-spec get_vps_change_hostname(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_change_hostname(Ctx, Id) ->
    get_vps_change_hostname(Ctx, Id, #{}).

-spec get_vps_change_hostname(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_change_hostname(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Pre-flight check before changing the VPS root password
...
-spec get_vps_change_root_password(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_change_root_password(Ctx, Id) ->
    get_vps_change_root_password(Ctx, Id, #{}).

-spec get_vps_change_root_password(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_change_root_password(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc List IANA timezones supported by the VPS guest OS
...
-spec get_vps_change_timezone(ctx:ctx(), integer()) -> {ok, [binary()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_change_timezone(Ctx, Id) ->
    get_vps_change_timezone(Ctx, Id, #{}).

-spec get_vps_change_timezone(ctx:ctx(), integer(), maps:map()) -> {ok, [binary()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Get full details for one VPS — IPs, hostname, OS, slices, status, addons
...
-spec get_vps_info(ctx:ctx(), integer()) -> {ok, interserver_api_vps:interserver_api_vps(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_info(Ctx, Id) ->
    get_vps_info(Ctx, Id, #{}).

-spec get_vps_info(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_vps:interserver_api_vps(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List ISO templates that can be mounted in the VPS virtual CD drive
...
-spec get_vps_insert_cd(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_insert_cd(Ctx, Id) ->
    get_vps_insert_cd(Ctx, Id, #{}).

-spec get_vps_insert_cd(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_insert_cd(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc List all billing invoices associated with this specific VPS
...
-spec get_vps_invoices(ctx:ctx(), integer()) -> {ok, interserver_api_charge_invoice_rows:interserver_api_charge_invoice_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_invoices(Ctx, Id) ->
    get_vps_invoices(Ctx, Id, #{}).

-spec get_vps_invoices(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_charge_invoice_rows:interserver_api_charge_invoice_rows(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List all VPS services on the customer's account
...
-spec get_vps_list(ctx:ctx()) -> {ok, [interserver_api_vps_row:interserver_api_vps_row()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_list(Ctx) ->
    get_vps_list(Ctx, #{}).

-spec get_vps_list(ctx:ctx(), maps:map()) -> {ok, [interserver_api_vps_row:interserver_api_vps_row()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List OS templates compatible with this VPS's hypervisor for reinstall
...
-spec get_vps_reinstall_os(ctx:ctx(), integer()) -> {ok, interserver_api_vps_templates_list:interserver_api_vps_templates_list(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_reinstall_os(Ctx, Id) ->
    get_vps_reinstall_os(Ctx, Id, #{}).

-spec get_vps_reinstall_os(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_vps_templates_list:interserver_api_vps_templates_list(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Pre-flight check before resetting the VPS root password to a random value
...
-spec get_vps_reset_password(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_reset_password(Ctx, Id) ->
    get_vps_reset_password(Ctx, Id, #{}).

-spec get_vps_reset_password(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_reset_password(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Read the current PTR (reverse-DNS) records for every IP on the VPS
...
-spec get_vps_reverse_dns(ctx:ctx(), integer()) -> {ok, interserver_api_reverse_dns_entries:interserver_api_reverse_dns_entries(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_reverse_dns(Ctx, Id) ->
    get_vps_reverse_dns(Ctx, Id, #{}).

-spec get_vps_reverse_dns(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_reverse_dns_entries:interserver_api_reverse_dns_entries(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read current VNC console connection info for the VPS
...
-spec get_vps_setup_vnc(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_setup_vnc(Ctx, Id) ->
    get_vps_setup_vnc(Ctx, Id, #{}).

-spec get_vps_setup_vnc(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read current slice count, min/max range, and prorated per-slice upgrade cost
...
-spec get_vps_slices(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_slices(Ctx, Id) ->
    get_vps_slices(Ctx, Id, #{}).

-spec get_vps_slices(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read bandwidth traffic usage data for the VPS
...
-spec get_vps_traffic_usage(ctx:ctx(), integer()) -> {ok, interserver_api_vps_traffic_response:interserver_api_vps_traffic_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_traffic_usage(Ctx, Id) ->
    get_vps_traffic_usage(Ctx, Id, #{}).

-spec get_vps_traffic_usage(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_vps_traffic_response:interserver_api_vps_traffic_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS
...
-spec get_vps_view_desktop(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_view_desktop(Ctx, Id) ->
    get_vps_view_desktop(Ctx, Id, #{}).

-spec get_vps_view_desktop(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Resend the welcome email containing VPS IP, hostname, and root credentials
...
-spec get_vps_welcome_email(ctx:ctx(), binary()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_vps_welcome_email(Ctx, Id) ->
    get_vps_welcome_email(Ctx, Id, #{}).

-spec get_vps_welcome_email(ctx:ctx(), binary(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Buy or resize the VPS additional-disk addon and create a prorated invoice
...
-spec post_vps_buy_hd_space(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_buy_hd_space(Ctx, Id) ->
    post_vps_buy_hd_space(Ctx, Id, #{}).

-spec post_vps_buy_hd_space(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Purchase one additional IP for the VPS and create the invoice
...
-spec post_vps_buy_ip(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_buy_ip(Ctx, Id) ->
    post_vps_buy_ip(Ctx, Id, #{}).

-spec post_vps_buy_ip(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP
...
-spec post_vps_change_hostname(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_change_hostname(Ctx, Id) ->
    post_vps_change_hostname(Ctx, Id, #{}).

-spec post_vps_change_hostname(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_change_hostname(Ctx, Id, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = {form, []++interserver_api_utils:optional_params(['hostname'], _OptionalParams)},
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"multipart/form-data">>, <<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Set a specific new root/Administrator password on the VPS
...
-spec post_vps_change_root_password(ctx:ctx(), integer(), binary()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_change_root_password(Ctx, Id, Password) ->
    post_vps_change_root_password(Ctx, Id, Password, #{}).

-spec post_vps_change_root_password(ctx:ctx(), integer(), binary(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Set the system timezone on the VPS guest OS
...
-spec post_vps_change_timezone(ctx:ctx(), integer(), binary()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_change_timezone(Ctx, Id, Timezone) ->
    post_vps_change_timezone(Ctx, Id, Timezone, #{}).

-spec post_vps_change_timezone(ctx:ctx(), integer(), binary(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Rotate the Webuzo control panel admin password (re-auth required)
...
-spec post_vps_change_webuzo_password(ctx:ctx(), integer(), binary()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_change_webuzo_password(Ctx, Id, Password) ->
    post_vps_change_webuzo_password(Ctx, Id, Password, #{}).

-spec post_vps_change_webuzo_password(ctx:ctx(), integer(), binary(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Mount an ISO image in the VPS virtual CD drive from a URL
...
-spec post_vps_insert_cd(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_insert_cd(Ctx, Id) ->
    post_vps_insert_cd(Ctx, Id, #{}).

-spec post_vps_insert_cd(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_insert_cd(Ctx, Id, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = {form, []++interserver_api_utils:optional_params(['url'], _OptionalParams)},
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"multipart/form-data">>, <<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)
...
-spec post_vps_reinstall_os(ctx:ctx(), integer(), binary(), binary()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_reinstall_os(Ctx, Id, Template, LocalPassword) ->
    post_vps_reinstall_os(Ctx, Id, Template, LocalPassword, #{}).

-spec post_vps_reinstall_os(ctx:ctx(), integer(), binary(), binary(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_reinstall_os(Ctx, Id, Template, LocalPassword, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = {form, [{<<"template">>, Template}, {<<"localPassword">>, LocalPassword}]++interserver_api_utils:optional_params(['password'], _OptionalParams)},
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"multipart/form-data">>, <<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Reset the VPS root password to a server-generated random value
...
-spec post_vps_reset_password(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_reset_password(Ctx, Id) ->
    post_vps_reset_password(Ctx, Id, #{}).

-spec post_vps_reset_password(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
...
-spec post_vps_restore(ctx:ctx(), integer(), interserver_api_restore_request:interserver_api_restore_request()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_restore(Ctx, Id, InterserverApiRestoreRequest) ->
    post_vps_restore(Ctx, Id, InterserverApiRestoreRequest, #{}).

-spec post_vps_restore(ctx:ctx(), integer(), interserver_api_restore_request:interserver_api_restore_request(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_restore(Ctx, Id, InterserverApiRestoreRequest, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Bulk-update PTR (reverse-DNS) records for one or more VPS IPs
...
-spec post_vps_reverse_dns(ctx:ctx(), integer(), interserver_api_reverse_dns_entries:interserver_api_reverse_dns_entries()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_reverse_dns(Ctx, Id, InterserverApiReverseDnsEntries) ->
    post_vps_reverse_dns(Ctx, Id, InterserverApiReverseDnsEntries, #{}).

-spec post_vps_reverse_dns(ctx:ctx(), integer(), interserver_api_reverse_dns_entries:interserver_api_reverse_dns_entries(), maps:map()) -> {ok, interserver_api_text_response:interserver_api_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_reverse_dns(Ctx, Id, InterserverApiReverseDnsEntries, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Provision or refresh the VNC console endpoint for the VPS
...
-spec post_vps_setup_vnc(ctx:ctx(), integer()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_setup_vnc(Ctx, Id) ->
    post_vps_setup_vnc(Ctx, Id, #{}).

-spec post_vps_setup_vnc(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_queue_response:interserver_api_queue_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)
...
-spec post_vps_slices(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_slices(Ctx, Id) ->
    post_vps_slices(Ctx, Id, #{}).

-spec post_vps_slices(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Search/filter VPS bandwidth usage with custom criteria (reserved)
...
-spec post_vps_traffic_usage(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_traffic_usage(Ctx, Id) ->
    post_vps_traffic_usage(Ctx, Id, #{}).

-spec post_vps_traffic_usage(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_traffic_usage(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Refresh the remote-desktop session connection info after IP/hostname changes
...
-spec post_vps_view_desktop(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
post_vps_view_desktop(Ctx, Id) ->
    post_vps_view_desktop(Ctx, Id, #{}).

-spec post_vps_view_desktop(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Validate a VPS order configuration and quote the cost — dry run, no charge
...
-spec put_vps(ctx:ctx()) -> {ok, interserver_api_vps_order_put_response:interserver_api_vps_order_put_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_vps(Ctx) ->
    put_vps(Ctx, #{}).

-spec put_vps(ctx:ctx(), maps:map()) -> {ok, interserver_api_vps_order_put_response:interserver_api_vps_order_put_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_vps(Ctx, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = InterserverApiVpsOrderPutRequest,
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"application/json">>, <<"multipart/form-data">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Preview cost to set additional VPS disk to a target GB size — dry run
...
-spec put_vps_buy_hd_space(ctx:ctx(), integer()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_vps_buy_hd_space(Ctx, Id) ->
    put_vps_buy_hd_space(Ctx, Id, #{}).

-spec put_vps_buy_hd_space(ctx:ctx(), integer(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
put_vps_buy_hd_space(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(interserver_api_api, config, #{})),
...
%% @doc Update editable settings on a VPS service record
...
-spec update_vps_info(ctx:ctx(), binary()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_vps_info(Ctx, Id) ->
    update_vps_info(Ctx, Id, #{}).

-spec update_vps_info(ctx:ctx(), binary(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Cancel a VPS service at the end of the current billing cycle
...
-spec v_ps_cancel(ctx:ctx(), integer()) -> {ok, interserver_api_v_ps_cancel_200_response:interserver_api_v_ps_cancel_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
v_ps_cancel(Ctx, Id) ->
    v_ps_cancel(Ctx, Id, #{}).

-spec v_ps_cancel(ctx:ctx(), integer(), maps:map()) -> {ok, interserver_api_v_ps_cancel_200_response:interserver_api_v_ps_cancel_200_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
