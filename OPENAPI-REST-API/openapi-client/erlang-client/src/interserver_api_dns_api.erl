-module(interserver_api_dns_api).
...
%% @doc Create a new authoritative DNS zone seeded with apex A + NS + SOA records
...
-spec add_dns_domain(ctx:ctx(), binary(), binary()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_dns_domain(Ctx, Domain, Ip) ->
    add_dns_domain(Ctx, Domain, Ip, #{}).

-spec add_dns_domain(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_dns_domain(Ctx, Domain, Ip, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = {form, [{<<"domain">>, Domain}, {<<"ip">>, Ip}]++interserver_api_utils:optional_params([], _OptionalParams)},
...
%% @doc Add a DNS record (A, AAAA, MX, TXT, CNAME, NS, SRV, CAA, ...) to a zone
...
-spec add_dns_record(ctx:ctx(), binary(), binary(), interserver_api_dns_record_type:interserver_api_dns_record_type(), binary()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_dns_record(Ctx, Id, Name, Type, Content) ->
    add_dns_record(Ctx, Id, Name, Type, Content, #{}).

-spec add_dns_record(ctx:ctx(), binary(), binary(), interserver_api_dns_record_type:interserver_api_dns_record_type(), binary(), maps:map()) -> {ok, [], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
add_dns_record(Ctx, Id, Name, Type, Content, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = {form, [{<<"name">>, Name}, {<<"type">>, Type}, {<<"content">>, Content}]++interserver_api_utils:optional_params(['ttl', 'prio'], _OptionalParams)},
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"multipart/form-data">>, <<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    interserver_api_utils:request(Ctx, Method, Path, QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Permanently delete a DNS zone and every record it contains
...
-spec delete_dns_domain(ctx:ctx(), binary()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
delete_dns_domain(Ctx, Id) ->
    delete_dns_domain(Ctx, Id, #{}).

-spec delete_dns_domain(ctx:ctx(), binary(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Permanently delete one DNS record from a zone — zone itself is preserved
...
-spec delete_dns_record(ctx:ctx(), integer(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
delete_dns_record(Ctx, DomainId, RecordId) ->
    delete_dns_record(Ctx, DomainId, RecordId, #{}).

-spec delete_dns_record(ctx:ctx(), integer(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List every DNS record in one zone with the IDs needed to edit or delete them
...
-spec get_dns_domain(ctx:ctx(), integer()) -> {ok, [interserver_api_dns_record:interserver_api_dns_record()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_dns_domain(Ctx, Id) ->
    get_dns_domain(Ctx, Id, #{}).

-spec get_dns_domain(ctx:ctx(), integer(), maps:map()) -> {ok, [interserver_api_dns_record:interserver_api_dns_record()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc List DNS zones hosted on the account with each zone's apex A-record IP
...
-spec get_dns_list(ctx:ctx()) -> {ok, [interserver_api_dns_list_item:interserver_api_dns_list_item()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
get_dns_list(Ctx) ->
    get_dns_list(Ctx, #{}).

-spec get_dns_list(ctx:ctx(), maps:map()) -> {ok, [interserver_api_dns_list_item:interserver_api_dns_list_item()], interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
...
%% @doc Replace values on an existing DNS record (name, type, content, ttl, priority)
...
-spec update_dns_record(ctx:ctx(), integer(), integer()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_dns_record(Ctx, DomainId, RecordId) ->
    update_dns_record(Ctx, DomainId, RecordId, #{}).

-spec update_dns_record(ctx:ctx(), integer(), integer(), maps:map()) -> {ok, interserver_api_success_text_response:interserver_api_success_text_response(), interserver_api_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), interserver_api_utils:response_info()}.
update_dns_record(Ctx, DomainId, RecordId, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = {form, []++interserver_api_utils:optional_params(['name', 'type', 'content', 'ttl', 'prio', 'disabled', 'ordername', 'auth'], _OptionalParams)},
    ContentTypeHeader = interserver_api_utils:select_header_content_type([<<"multipart/form-data">>, <<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
