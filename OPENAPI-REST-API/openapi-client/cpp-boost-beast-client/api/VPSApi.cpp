...
VPSApiException::VPSApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status VPSApiException::getStatus() const
{
    return m_status;
}

const char* VPSApiException::what() const noexcept
{
    return m_what.c_str();
}
...
VPSApi::addVps(
    const std::shared_ptr<VpsOrderPostRequest>& vpsOrderPostRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/order";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(vpsOrderPostRequest));
    } else {
    ...
    if (statusCode == boost::beast::http::status(401)) {
        throw VPSApiException(statusCode, "Unauthorized");
    }
    throw VPSApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<VpsOrder>
VPSApi::getNewVps(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/order";
    ...
    std::shared_ptr<VpsOrder> deserializedResponse = std::make_shared<VpsOrder>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<VpsOrder>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<VpsOrderPutResponse>
VPSApi::putVps(
    const std::shared_ptr<VpsOrderPutRequest>& vpsOrderPutRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/order";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(vpsOrderPutRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    ...
    std::shared_ptr<VpsOrderPutResponse> deserializedResponse = std::make_shared<VpsOrderPutResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<VpsOrderPutResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
VPSApi::deleteVpsBackup(
    const int32_t& id, const std::string& file, const boost::optional<std::string>& all) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/backups";
    std::map<std::string, std::string> headers;
    // path params
    ...
    if (all) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "all",
            serializeQueryParameterValue(*all));
    }
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
            "file",
            serializeQueryParameterValue(file));
...
std::shared_ptr<DownloadQsBackup_200_response>
VPSApi::downloadVpsBackup(
    const int32_t& id, const std::shared_ptr<DownloadQsBackup_request>& downloadQsBackupRequest, const boost::optional<std::string>& all) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/backups";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(downloadQsBackupRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<DownloadQsBackup_200_response> deserializedResponse = std::make_shared<DownloadQsBackup_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DownloadQsBackup_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<VpsBackupRows>
VPSApi::getVpsBackups(
    const int32_t& id, const boost::optional<std::string>& all) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/backups";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<VpsBackupRows> deserializedResponse = std::make_shared<VpsBackupRows>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<VpsBackupRows>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<QueueResponse>
VPSApi::doVpsBlockSmtp(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/block_smtp";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<QueueResponse> deserializedResponse = std::make_shared<QueueResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<QueueResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<QueueResponse>
VPSApi::doVpsDisableCd(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/disable_cd";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
VPSApi::doVpsDisableQuota(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/disable_quota";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
VPSApi::doVpsEjectCd(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/eject_cd";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
VPSApi::doVpsEnableQuota(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/enable_quota";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
VPSApi::doVpsRestart(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/restart";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
VPSApi::doVpsStart(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/start";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
VPSApi::doVpsStop(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/stop";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
VPSApi::getVpsBackup(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/backup";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
void
VPSApi::getVpsBuyHdSpace(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/buy_hd_space";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
VPSApi::getVpsBuyIp(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/buy_ip";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
void
VPSApi::getVpsChangeHostname(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/change_hostname";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
VPSApi::postVpsChangeHostname(
    const int32_t& id, const std::string& hostname) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/change_hostname";
    std::map<std::string, std::string> headers;
...
void
VPSApi::getVpsChangeRootPassword(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/change_root_password";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
VPSApi::postVpsChangeRootPassword(
    const int32_t& id, const std::string& password) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/change_root_password";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "multipart/form-data","application/json", };
...
VPSApi::getVpsChangeTimezone(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/change_timezone";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
VPSApi::postVpsChangeTimezone(
    const int32_t& id, const std::string& timezone) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/change_timezone";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "multipart/form-data","application/json", };
...
VPSApi::getVpsInfo(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<Vps> deserializedResponse = std::make_shared<Vps>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Vps>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<VPSCancel_200_response>
VPSApi::vPSCancel(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}";
    ...
    std::shared_ptr<VPSCancel_200_response> deserializedResponse = std::make_shared<VPSCancel_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<VPSCancel_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
void
VPSApi::getVpsInsertCd(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/insert_cd";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
VPSApi::postVpsInsertCd(
    const int32_t& id, const std::string& url) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/insert_cd";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "multipart/form-data","application/json", };
...
VPSApi::getVpsInvoices(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/invoices";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::vector<std::shared_ptr<VpsRow>>
VPSApi::getVpsList(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps";
    std::map<std::string, std::string> headers;
    ...
    std::vector<std::shared_ptr<VpsRow>> deserializedResponse = std::vector<std::shared_ptr<VpsRow>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<VpsRow>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<VpsTemplatesList>
VPSApi::getVpsReinstallOs(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/reinstall_os";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<VpsTemplatesList> deserializedResponse = std::make_shared<VpsTemplatesList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<VpsTemplatesList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<QueueResponse>
VPSApi::postVpsReinstallOs(
    const int32_t& id, const std::string& r_template, const std::string& localPassword, const std::string& password) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/reinstall_os";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "multipart/form-data","application/json", };
    ...
    formParameters.emplace_back(
        "template",
        toFormParameterValue(r_template),
        false);
    formParameters.emplace_back(
        "localPassword",
        toFormParameterValue(localPassword),
        false);
    formParameters.emplace_back(
        "password",
        toFormParameterValue(password),
...
void
VPSApi::getVpsResetPassword(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/reset_password";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<ReverseDnsEntries>
VPSApi::getVpsReverseDns(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/reverse_dns";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<ReverseDnsEntries> deserializedResponse = std::make_shared<ReverseDnsEntries>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<ReverseDnsEntries>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
VPSApi::postVpsReverseDns(
    const int32_t& id, const std::shared_ptr<ReverseDnsEntries>& reverseDnsEntries) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/reverse_dns";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(reverseDnsEntries));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
void
VPSApi::getVpsSetupVnc(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/setup_vnc";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
VPSApi::getVpsSlices(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/slices";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<VpsTrafficResponse>
VPSApi::getVpsTrafficUsage(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/traffic_usage";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<VpsTrafficResponse> deserializedResponse = std::make_shared<VpsTrafficResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<VpsTrafficResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
void
VPSApi::getVpsViewDesktop(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/view_desktop";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<SuccessTextResponse>
VPSApi::getVpsWelcomeEmail(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/welcome_email";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
VPSApi::postVpsChangeWebuzoPassword(
    const int32_t& id, const std::string& password) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/change_webuzo_password";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "multipart/form-data","application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
...
std::shared_ptr<QueueResponse>
VPSApi::postVpsRestore(
    const int32_t& id, const std::shared_ptr<RestoreRequest>& restoreRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/vps/{id}/restore";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(restoreRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw VPSApiException(statusCode, "Response with a text message field.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw VPSApiException(statusCode, "Unauthorized");
    }
...
std::string VPSApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void VPSApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void VPSApi::handleStdException(const std::exception&) {
    throw;
}

void VPSApi::handleUncaughtException() {
    throw;
}
