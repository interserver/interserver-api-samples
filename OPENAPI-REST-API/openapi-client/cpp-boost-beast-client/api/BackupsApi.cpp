...
BackupsApiException::BackupsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status BackupsApiException::getStatus() const
{
    return m_status;
}

const char* BackupsApiException::what() const noexcept
{
    return m_what.c_str();
}

std::shared_ptr<BackupOrderPostResponse>
BackupsApi::addBackup(
    const bool& validateOnly, const int32_t& serviceType, const std::string& coupon) {
    std::string serializedRequestBody;
    std::string path = m_context + "/backups/order";
    ...
    formParameters.emplace_back(
        "validateOnly",
        toFormParameterValue(validateOnly),
        false);
    formParameters.emplace_back(
        "serviceType",
        toFormParameterValue(serviceType),
        false);
    formParameters.emplace_back(
        "coupon",
        toFormParameterValue(coupon),
        false);
    ...
    std::shared_ptr<BackupOrderPostResponse> deserializedResponse = std::make_shared<BackupOrderPostResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BackupOrderPostResponse>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(401)) {
        throw BackupsApiException(statusCode, "Unauthorized");
    }
    return deserializedResponse;
}
std::shared_ptr<BackupsOrder>
BackupsApi::getNewBackup(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/backups/order";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<BackupsOrder> deserializedResponse = std::make_shared<BackupsOrder>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BackupsOrder>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
    ...
    throw BackupsApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<BackupOrderPutResponse>
BackupsApi::validateBackupOrder(
    const bool& validateOnly, const int32_t& serviceType, const std::string& coupon) {
    std::string serializedRequestBody;
    std::string path = m_context + "/backups/order";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<BackupOrderPutResponse> deserializedResponse = std::make_shared<BackupOrderPutResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BackupOrderPutResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<CancelBackup_200_response>
BackupsApi::cancelBackup(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/backups/{id}";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<CancelBackup_200_response> deserializedResponse = std::make_shared<CancelBackup_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<CancelBackup_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
BackupsApi::getBackupInfo(
    ...
    std::shared_ptr<Backup> deserializedResponse = std::make_shared<Backup>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Backup>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
BackupsApi::getBackupInvoices(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/backups/{id}/invoices";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<BackupLoginResponse>
BackupsApi::getBackupLogin(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/backups/{id}/login";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<BackupLoginResponse> deserializedResponse = std::make_shared<BackupLoginResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BackupLoginResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::vector<std::shared_ptr<BackupRow>>
BackupsApi::getBackupsList(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/backups";
    std::map<std::string, std::string> headers;
    ...
    std::vector<std::shared_ptr<BackupRow>> deserializedResponse = std::vector<std::shared_ptr<BackupRow>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<BackupRow>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<SuccessTextResponse>
BackupsApi::getBackupsWelcomeEmail(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/backups/{id}/welcome_email";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::string BackupsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void BackupsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void BackupsApi::handleStdException(const std::exception&) {
    throw;
}

void BackupsApi::handleUncaughtException() {
    throw;
}
