...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_WebhostingApi_
#define BOOST_BEAST_OPENAPI_CLIENT_WebhostingApi_
...
///
class WebhostingApiException: public std::exception
{
public:
    WebhostingApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<WebsitesOrder>
    getNewWebsite(
        );
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<GetWebsiteBuyIp_200_response>
    getWebsiteBuyIp(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<PostWebsiteBuyIp_200_response>
    postWebsiteBuyIp(
    ...
    /// </remarks>
    virtual std::shared_ptr<Website>
    getWebsiteInfo(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<WebhostingCancel_200_response>
    webhostingCancel(
        const std::string& id);
    /// <summary>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<WebsiteRow>>
    getWebsiteList(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<WebsiteBackups>
    getWebsitesBackups(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<WebsiteLoginResponse>
    getWebsitesLogin(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<PostWebsiteMigration_200_response>
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_WebhostingApi_ */
