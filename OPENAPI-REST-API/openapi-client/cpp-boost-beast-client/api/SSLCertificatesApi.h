...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_SSLCertificatesApi_
#define BOOST_BEAST_OPENAPI_CLIENT_SSLCertificatesApi_
...
///
class SSLCertificatesApiException: public std::exception
{
public:
    SSLCertificatesApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<SslCancel_200_response>
    sslCancel(
        const int32_t& id);
    /// <summary>
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_SSLCertificatesApi_ */
