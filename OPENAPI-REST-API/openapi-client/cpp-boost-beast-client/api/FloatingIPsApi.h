...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_FloatingIPsApi_
#define BOOST_BEAST_OPENAPI_CLIENT_FloatingIPsApi_
...
///
class FloatingIPsApiException: public std::exception
{
public:
    FloatingIPsApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<Floating_ipsCancel_200_response>
    floatingIpsCancel(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::vector<boost::json::value>
    getFloatingIpsList(
        );
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_FloatingIPsApi_ */
