...
QuickServersApiException::QuickServersApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status QuickServersApiException::getStatus() const
{
    return m_status;
}

const char* QuickServersApiException::what() const noexcept
{
    return m_what.c_str();
}

std::shared_ptr<ServiceOrderPostResponse>
QuickServersApi::addQs(
    const std::shared_ptr<QsOrderRequest>& qsOrderRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/order";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(qsOrderRequest));
    } else {
    ...
    if (statusCode == boost::beast::http::status(401)) {
        throw QuickServersApiException(statusCode, "Unauthorized");
    }
    throw QuickServersApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<QuickserverOrder>
QuickServersApi::getNewQs(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/order";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<QuickserverOrder> deserializedResponse = std::make_shared<QuickserverOrder>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<QuickserverOrder>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
QuickServersApi::downloadQsBackup(
...
QuickServersApi::doQsBlockSmtp(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/block_smtp";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::doQsDisableCd(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/disable_cd";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::doQsDisableQuota(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/disable_quota";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::doQsEjectCd(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/eject_cd";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::doQsEnableQuota(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/enable_quota";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::doQsRestart(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/restart";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::doQsStart(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/start";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::doQsStop(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/stop";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::getQsBackup(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/backup";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
void
QuickServersApi::getQsChangeHostname(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/change_hostname";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::postQsChangeHostname(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/change_hostname";
    std::map<std::string, std::string> headers;
...
void
QuickServersApi::getQsChangeRootPassword(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/change_root_password";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::postQsChangeRootPassword(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/change_root_password";
    std::map<std::string, std::string> headers;
...
QuickServersApi::getQsChangeTimezone(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/change_timezone";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::postQsChangeTimezone(
...
void
QuickServersApi::getQsChangeWebuzoPassword(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/change_webuzo_password";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::postQsChangeWebuzoPassword(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/change_webuzo_password";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<Quickserver>
QuickServersApi::getQsInfo(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<Quickserver> deserializedResponse = std::make_shared<Quickserver>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Quickserver>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<QuickserversCancel_200_response>
QuickServersApi::quickserversCancel(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<QuickserversCancel_200_response> deserializedResponse = std::make_shared<QuickserversCancel_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<QuickserversCancel_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
void
QuickServersApi::getQsInsertCd(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/insert_cd";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::postQsInsertCd(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/insert_cd";
    std::map<std::string, std::string> headers;
...
QuickServersApi::getQsInvoices(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/invoices";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::vector<std::shared_ptr<QuickserverRow>>
QuickServersApi::getQsList(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs";
    std::map<std::string, std::string> headers;
    ...
    std::vector<std::shared_ptr<QuickserverRow>> deserializedResponse = std::vector<std::shared_ptr<QuickserverRow>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<QuickserverRow>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
QuickServersApi::getQsReinstallOs(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/reinstall_os";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::postQsReinstallOs(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/reinstall_os";
    std::map<std::string, std::string> headers;
...
void
QuickServersApi::getQsResetPassword(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/reset_password";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::postQsResetPassword(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/reset_password";
    std::map<std::string, std::string> headers;
...
QuickServersApi::getQsReverseDns(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/reverse_dns";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
QuickServersApi::postQsReverseDns(
...
void
QuickServersApi::getQsSetupVnc(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/setup_vnc";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::postQsSetupVnc(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/setup_vnc";
    std::map<std::string, std::string> headers;
...
void
QuickServersApi::getQsTrafficUsage(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/traffic_usage";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
void
QuickServersApi::postQsTrafficUsage(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/traffic_usage";
    std::map<std::string, std::string> headers;
...
void
QuickServersApi::getQsViewDesktop(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/view_desktop";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
void
QuickServersApi::postQsViewDesktop(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/view_desktop";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<TextResponse>
QuickServersApi::getQsWelcomeEmail(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/welcome_email";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<QueueResponse>
QuickServersApi::postQuickServerRestore(
    const int32_t& id, const std::shared_ptr<RestoreRequest>& restoreRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/qs/{id}/restore";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw QuickServersApiException(statusCode, "Response with a text message field.");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw QuickServersApiException(statusCode, "Unauthorized");
    }
...
std::string QuickServersApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void QuickServersApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void QuickServersApi::handleStdException(const std::exception&) {
    throw;
}

void QuickServersApi::handleUncaughtException() {
    throw;
}
