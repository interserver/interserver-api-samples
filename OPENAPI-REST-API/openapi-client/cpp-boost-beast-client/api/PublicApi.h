...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_PublicApi_
#define BOOST_BEAST_OPENAPI_CLIENT_PublicApi_
...
///
class PublicApiException: public std::exception
{
public:
    PublicApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::map<std::string, std::shared_ptr<GetAccountLocales_200_response_value>>
    getAccountLocales(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<CaptchaResponse>
    getCaptcha(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<ServicesInfo>
    getInfo(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<LoginInfo>
    getLoginInfo(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<LoginSuccessResponse>
    submitLogin(
    ...
    /// </remarks>
    virtual std::shared_ptr<GetOauthRedirect_200_response>
    getOauthRedirect(
    ...
    /// </remarks>
    virtual std::shared_ptr<PatchOauthTwoFactor_200_response>
    patchOauthTwoFactor(
    ...
    /// </remarks>
    virtual std::shared_ptr<PostOauthCallback_200_response>
    postOauthCallback(
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_PublicApi_ */
