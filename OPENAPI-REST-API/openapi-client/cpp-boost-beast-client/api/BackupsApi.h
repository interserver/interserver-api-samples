...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_BackupsApi_
#define BOOST_BEAST_OPENAPI_CLIENT_BackupsApi_
...
///
class BackupsApiException: public std::exception
{
public:
    BackupsApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<BackupOrderPostResponse>
    addBackup(
    ...
    /// </remarks>
    virtual std::shared_ptr<BackupsOrder>
    getNewBackup(
        );
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<BackupOrderPutResponse>
    validateBackupOrder(
        const bool& validateOnly, const int32_t& serviceType, const std::string& coupon);
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<CancelBackup_200_response>
    cancelBackup(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<BackupLoginResponse>
    getBackupLogin(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<BackupRow>>
    getBackupsList(
        );
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_BackupsApi_ */
