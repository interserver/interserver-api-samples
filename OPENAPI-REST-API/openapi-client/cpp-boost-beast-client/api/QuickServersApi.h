...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_QuickServersApi_
#define BOOST_BEAST_OPENAPI_CLIENT_QuickServersApi_
...
///
class QuickServersApiException: public std::exception
{
public:
    QuickServersApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<QuickserverOrder>
    getNewQs(
        );
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<Quickserver>
    getQsInfo(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<QuickserversCancel_200_response>
    quickserversCancel(
        const int32_t& id);
    /// <summary>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<QuickserverRow>>
    getQsList(
        );
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_QuickServersApi_ */
