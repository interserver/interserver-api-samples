...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_LicensesApi_
#define BOOST_BEAST_OPENAPI_CLIENT_LicensesApi_
...
///
class LicensesApiException: public std::exception
{
public:
    LicensesApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<LicensesOrder>
    getNewLicense(
        );
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<License>
    getLicenseInfo(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<LicensesCancel_200_response>
    licensesCancel(
        const int32_t& id);
    /// <summary>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<LicenseRow>>
    getLicenseList(
        );
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_LicensesApi_ */
