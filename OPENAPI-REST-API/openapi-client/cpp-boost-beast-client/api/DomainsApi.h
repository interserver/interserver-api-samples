...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_DomainsApi_
#define BOOST_BEAST_OPENAPI_CLIENT_DomainsApi_
...
///
class DomainsApiException: public std::exception
{
public:
    DomainsApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<DomainOrder>
    getNewDomain(
        );
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<DomainDnssecRecords>
    getDomainDnssec(
        const int32_t& id);
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<DomainNameserverGetResponse>
    ...
    /// </remarks>
    virtual std::shared_ptr<CancelDomain_200_response>
    cancelDomain(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<DomainContactDetails>
    getDomainContact(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<DomainLookupResponse>
    getDomainLookup(
    ...
    /// </remarks>
    virtual std::shared_ptr<DomainSearchResponse>
    getDomainSearch(
        const std::string& name);
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<DomainRow>>
    getDomainsList(
        );
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_DomainsApi_ */
