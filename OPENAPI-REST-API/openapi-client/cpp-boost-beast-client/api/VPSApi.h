...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_VPSApi_
#define BOOST_BEAST_OPENAPI_CLIENT_VPSApi_
...
///
class VPSApiException: public std::exception
{
public:
    VPSApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<VpsOrder>
    getNewVps(
        );
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<VpsOrderPutResponse>
    putVps(
    ...
    /// </remarks>
    virtual std::shared_ptr<DownloadQsBackup_200_response>
    downloadVpsBackup(
    ...
    /// </remarks>
    virtual std::shared_ptr<VpsBackupRows>
    getVpsBackups(
    ...
    /// </remarks>
    virtual std::shared_ptr<QueueResponse>
    doVpsBlockSmtp(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<VPSCancel_200_response>
    vPSCancel(
        const int32_t& id);
    /// <summary>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<VpsRow>>
    getVpsList(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<VpsTemplatesList>
    getVpsReinstallOs(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<ReverseDnsEntries>
    getVpsReverseDns(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<TextResponse>
    postVpsReverseDns(
    ...
    /// </remarks>
    virtual std::shared_ptr<VpsTrafficResponse>
    getVpsTrafficUsage(
        const int32_t& id);
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_VPSApi_ */
