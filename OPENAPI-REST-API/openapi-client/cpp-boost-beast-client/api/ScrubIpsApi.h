...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_ScrubIpsApi_
#define BOOST_BEAST_OPENAPI_CLIENT_ScrubIpsApi_
...
///
class ScrubIpsApiException: public std::exception
{
public:
    ScrubIpsApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<CancelScrubIp_200_response>
    cancelScrubIp(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<GetScrubIpDetails_200_response>
    getScrubIpDetails(
        const int32_t& id);
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<CreateFilter_201_response>
    createFilter(
    ...
    /// </remarks>
    virtual std::shared_ptr<CreateRule_201_response>
    createGeoRule(
    ...
    /// </remarks>
    virtual std::shared_ptr<DeleteFilter_200_response>
    deleteFilter(
        const int32_t& id, const std::shared_ptr<CreateFilter>& createFilter);
    ...
    /// </remarks>
    virtual std::shared_ptr<DisableScrub_200_response>
    disableScrub(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<EnableScrub_200_response>
    enableScrub(
        const int32_t& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<GetOrderDetail_200_response>
    getOrderDetail(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<PlaceScrubOrder_201_response>
    placeScrubOrder(
    ...
    /// </remarks>
    virtual std::shared_ptr<PutScrubIps_200_response>
    putScrubIps(
        const std::shared_ptr<ScrubIpPlaceOrder>& scrubIpPlaceOrder);
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<ScrubIpFilterTypes>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<ScrubIpsLogRowSchema>>
    getScrubIpLogs(
        const std::string& id);
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<ScrubIpsRowSchema>>
    getScrubIpsList(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<ScrubIpsDeleteRule_200_response>
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_ScrubIpsApi_ */
