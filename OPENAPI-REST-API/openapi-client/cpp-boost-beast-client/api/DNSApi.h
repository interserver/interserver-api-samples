...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_DNSApi_
#define BOOST_BEAST_OPENAPI_CLIENT_DNSApi_
...
///
class DNSApiException: public std::exception
{
public:
    DNSApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<DnsListItem>>
    getDnsList(
        );
    /// <summary>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<DnsRecord>>
    getDnsDomain(
        const int32_t& id);
    /// <summary>
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_DNSApi_ */
