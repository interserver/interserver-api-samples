...
BillingApi::addBillingCreditCard(
    const std::shared_ptr<BillingAddCcRequest>& billingAddCcRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/creditcards";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(billingAddCcRequest));
    } else {
    ...
    if (statusCode == boost::beast::http::status(401)) {
        throw BillingApiException(statusCode, "Unauthorized");
    }
    throw BillingApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<SuccessTextResponse>
BillingApi::addBillingPrepay(
    const std::shared_ptr<BillingPrepayRequest>& billingPrepayRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/prepays";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(billingPrepayRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
...
std::shared_ptr<SuccessTextResponse>
BillingApi::deleteBillingCreditCard(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/creditcards/{id}";
    std::map<std::string, std::string> headers;
    // path params
...
std::shared_ptr<SuccessTextResponse>
BillingApi::updateBillingCreditCard(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/creditcards/{id}";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<SuccessTextResponse>
BillingApi::deleteBillingInvoice(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/invoices/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<BillingInvoiceDetail>
BillingApi::getBillingInvoice(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/invoices/{id}";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<BillingInvoiceDetail> deserializedResponse = std::make_shared<BillingInvoiceDetail>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BillingInvoiceDetail>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<SuccessTextResponse>
BillingApi::deleteBillingPrepay(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/prepays/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::vector<std::shared_ptr<AffiliateBannerRow>>
BillingApi::getAffiliateBanners(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/affiliate/banners";
    std::map<std::string, std::string> headers;
    ...
    std::vector<std::shared_ptr<AffiliateBannerRow>> deserializedResponse = std::vector<std::shared_ptr<AffiliateBannerRow>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<AffiliateBannerRow>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
void
BillingApi::getAffiliateDownload(
    const boost::optional<std::string>& st, const boost::optional<std::string>& ex, const boost::optional<int32_t>& year) {
    std::string serializedRequestBody;
    std::string path = m_context + "/affiliate/download";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (st) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "st",
            serializeQueryParameterValue(*st));
    }
    if (ex) {
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
            "ex",
            serializeQueryParameterValue(*ex));
    }
    if (year) {
        appendQueryParameter(
            queryParameterStream,
            queryParameterSeparator,
            "year",
            serializeQueryParameterValue(*year));
    }
...
BillingApi::getAffiliateRichReport(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/affiliate/rich_report";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<StatusMonthlyBreakdown>
BillingApi::getAffiliateSalesGraph(
    const boost::optional<int32_t>& days) {
    std::string serializedRequestBody;
    std::string path = m_context + "/affiliate/sales_graph";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    if (days) {
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "days",
            serializeQueryParameterValue(*days));
    }
    path += queryParameterStream.str();
    ...
    std::shared_ptr<StatusMonthlyBreakdown> deserializedResponse = std::make_shared<StatusMonthlyBreakdown>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<StatusMonthlyBreakdown>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<GetAffiliateSignups_200_response>
BillingApi::getAffiliateSignups(
    const boost::optional<std::string>& st) {
    std::string serializedRequestBody;
    std::string path = m_context + "/affiliate/signups";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<GetAffiliateSignups_200_response> deserializedResponse = std::make_shared<GetAffiliateSignups_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<GetAffiliateSignups_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<MonthlyCounts>
BillingApi::getAffiliateTrafficGraph(
    const boost::optional<int32_t>& days) {
    std::string serializedRequestBody;
    std::string path = m_context + "/affiliate/traffic_graph";
    std::map<std::string, std::string> headers;
    // query params
    std::stringstream queryParameterStream;
    const char* queryParameterSeparator = "?";
    ...
    std::shared_ptr<MonthlyCounts> deserializedResponse = std::make_shared<MonthlyCounts>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<MonthlyCounts>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::vector<std::shared_ptr<AffiliateTrafficRow>>
BillingApi::getAffiliateWebTraffic(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/affiliate/web_traffic";
    std::map<std::string, std::string> headers;
    ...
    std::vector<std::shared_ptr<AffiliateTrafficRow>> deserializedResponse = std::vector<std::shared_ptr<AffiliateTrafficRow>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<AffiliateTrafficRow>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
boost::json::value
BillingApi::getBillingCart(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/cart";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<SuccessTextResponse>
BillingApi::getBillingCreditCardVerify(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/creditcards/{id}/verify";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<SuccessTextResponse>
BillingApi::patchBillingCreditCardVerify(
    const int32_t& id, const std::shared_ptr<PatchBillingCreditCardVerify_request>& patchBillingCreditCardVerifyRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/creditcards/{id}/verify";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(patchBillingCreditCardVerifyRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<SuccessTextResponse>
BillingApi::postBillingCreditCardVerify(
    const int32_t& id, const std::shared_ptr<BillingVerifyCcRequest>& billingVerifyCcRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/creditcards/{id}/verify";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(billingVerifyCcRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<BillingInvoiceList>
BillingApi::getBillingInvoices(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/invoices";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<BillingInvoiceList> deserializedResponse = std::make_shared<BillingInvoiceList>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<BillingInvoiceList>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<InitiatePayment_200_response>
BillingApi::initiatePayment(
    const std::string& method, const std::string& invoices) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/pay/{method}/{invoices}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "method", method);
    replacePathParameter(path, "invoices", invoices);
    ...
    std::shared_ptr<InitiatePayment_200_response> deserializedResponse = std::make_shared<InitiatePayment_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<InitiatePayment_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<TextResponse>
BillingApi::updateAffiliateDockSetup(
    const std::string& affiliateDockTitle, const std::string& affiliateDockDescription, const std::string& referrerCoupon) {
    std::string serializedRequestBody;
    std::string path = m_context + "/affiliate/dock_setup";
    std::map<std::string, std::string> headers;
    ...
    formParameters.emplace_back(
        ...
        toFormParameterValue(affiliateDockTitle),
        false);
    formParameters.emplace_back(
        "affiliate_dock_description",
        toFormParameterValue(affiliateDockDescription),
        false);
    formParameters.emplace_back(
        "referrer_coupon",
        toFormParameterValue(referrerCoupon),
        false);
...
std::shared_ptr<TextResponse>
BillingApi::updateAffiliatePaymentSetup(
    const std::string& affiliatePaypal, const std::string& affiliatePaymentMethod) {
    std::string serializedRequestBody;
    std::string path = m_context + "/affiliate/payment_setup";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "multipart/form-data","application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    ...
    formParameters.emplace_back(
        "affiliate_paypal",
        toFormParameterValue(affiliatePaypal),
        false);
    formParameters.emplace_back(
        "affiliate_payment_method",
        toFormParameterValue(affiliatePaymentMethod),
        false);
    if (normalizeMediaType(requestContentType) == "multipart/form-data") {
        const std::string multipartBoundary = selectMultipartBoundary(formParameters);
        headers["Content-Type"] = requestContentType + "; boundary=" + multipartBoundary;
...
std::shared_ptr<SuccessTextResponse>
BillingApi::updateBillingPaymentMethod(
    const std::shared_ptr<BillingPaymentMethodRequest>& billingPaymentMethodRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/billing/payment_method";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(billingPaymentMethodRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
