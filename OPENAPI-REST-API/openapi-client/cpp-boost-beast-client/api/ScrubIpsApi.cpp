...
ScrubIpsApiException::ScrubIpsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status ScrubIpsApiException::getStatus() const
{
    return m_status;
}

const char* ScrubIpsApiException::what() const noexcept
{
    return m_what.c_str();
}

std::shared_ptr<CancelScrubIp_200_response>
ScrubIpsApi::cancelScrubIp(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}";
    ...
    std::shared_ptr<CancelScrubIp_200_response> deserializedResponse = std::make_shared<CancelScrubIp_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<CancelScrubIp_200_response>>::deserialize(
    ...
    if (statusCode == boost::beast::http::status(401)) {
        throw ScrubIpsApiException(statusCode, "Unauthorized");
    }
    throw ScrubIpsApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<GetScrubIpDetails_200_response>
ScrubIpsApi::getScrubIpDetails(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<GetScrubIpDetails_200_response> deserializedResponse = std::make_shared<GetScrubIpDetails_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<GetScrubIpDetails_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<CreateFilter_201_response>
ScrubIpsApi::createFilter(
    const int32_t& id, const std::shared_ptr<CreateFilter>& createFilter) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/create_filter";
    std::map<std::string, std::string> headers;
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(createFilter));
    } else {
    ...
    std::shared_ptr<CreateFilter_201_response> deserializedResponse = std::make_shared<CreateFilter_201_response>();
    if (statusCode == boost::beast::http::status(201)) {
        ResponseBodyDeserializer<std::shared_ptr<CreateFilter_201_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
    ...
    if (statusCode == boost::beast::http::status(400)) {
        throw ScrubIpsApiException(statusCode, "Bad Request");
    }
    if (statusCode == boost::beast::http::status(401)) {
        throw ScrubIpsApiException(statusCode, "Unauthorized");
    }
    if (statusCode == boost::beast::http::status(500)) {
        throw ScrubIpsApiException(statusCode, "Internal Server Error");
    }
    throw ScrubIpsApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<CreateRule_201_response>
ScrubIpsApi::createGeoRule(
    const int32_t& id, const std::shared_ptr<CreateGeoFirewallRule>& createGeoFirewallRule) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/create_geo_rule";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(createGeoFirewallRule));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<CreateRule_201_response> deserializedResponse = std::make_shared<CreateRule_201_response>();
    if (statusCode == boost::beast::http::status(201)) {
        ResponseBodyDeserializer<std::shared_ptr<CreateRule_201_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<CreateRule_201_response>
ScrubIpsApi::createRule(
    const int32_t& id, const std::shared_ptr<CreateFirewallRule>& createFirewallRule) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/create_rule";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(createFirewallRule));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<DeleteFilter_200_response>
ScrubIpsApi::deleteFilter(
    const int32_t& id, const std::shared_ptr<CreateFilter>& createFilter) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/delete_filter";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    ...
    std::shared_ptr<DeleteFilter_200_response> deserializedResponse = std::make_shared<DeleteFilter_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DeleteFilter_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<DisableScrub_200_response>
ScrubIpsApi::disableScrub(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/disable";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<DisableScrub_200_response> deserializedResponse = std::make_shared<DisableScrub_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DisableScrub_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<EnableScrub_200_response>
ScrubIpsApi::enableScrub(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/enable";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<EnableScrub_200_response> deserializedResponse = std::make_shared<EnableScrub_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<EnableScrub_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<GetOrderDetail_200_response>
ScrubIpsApi::getOrderDetail(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/order";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<GetOrderDetail_200_response> deserializedResponse = std::make_shared<GetOrderDetail_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<GetOrderDetail_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PlaceScrubOrder_201_response>
ScrubIpsApi::placeScrubOrder(
    const std::shared_ptr<ScrubIpPlaceOrder>& scrubIpPlaceOrder) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/order";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(scrubIpPlaceOrder));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    ...
    std::shared_ptr<PlaceScrubOrder_201_response> deserializedResponse = std::make_shared<PlaceScrubOrder_201_response>();
    if (statusCode == boost::beast::http::status(201)) {
        ResponseBodyDeserializer<std::shared_ptr<PlaceScrubOrder_201_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PutScrubIps_200_response>
ScrubIpsApi::putScrubIps(
    const std::shared_ptr<ScrubIpPlaceOrder>& scrubIpPlaceOrder) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/order";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<PutScrubIps_200_response> deserializedResponse = std::make_shared<PutScrubIps_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PutScrubIps_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<ScrubIpFilterTypes>
ScrubIpsApi::getScrubIpFilterTypes(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/filter_types";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<ScrubIpFilterTypes> deserializedResponse = std::make_shared<ScrubIpFilterTypes>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<ScrubIpFilterTypes>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
ScrubIpsApi::getScrubIpInvoices(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/invoices";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::vector<std::shared_ptr<ScrubIpsLogRowSchema>>
ScrubIpsApi::getScrubIpLogs(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/logs";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::vector<std::shared_ptr<ScrubIpsLogRowSchema>> deserializedResponse = std::vector<std::shared_ptr<ScrubIpsLogRowSchema>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<ScrubIpsLogRowSchema>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::vector<std::shared_ptr<ScrubIpsRowSchema>>
ScrubIpsApi::getScrubIpsList(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips";
    std::map<std::string, std::string> headers;
    ...
    std::vector<std::shared_ptr<ScrubIpsRowSchema>> deserializedResponse = std::vector<std::shared_ptr<ScrubIpsRowSchema>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<ScrubIpsRowSchema>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<ScrubIpsDeleteRule_200_response>
ScrubIpsApi::scrubIpsDeleteGeoRule(
    const int32_t& id, const std::shared_ptr<Delete_Geo_Firewall_Rule>& deleteGeoFirewallRule) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/delete_geo_rule";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(deleteGeoFirewallRule));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<ScrubIpsDeleteRule_200_response> deserializedResponse = std::make_shared<ScrubIpsDeleteRule_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<ScrubIpsDeleteRule_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<ScrubIpsDeleteRule_200_response>
ScrubIpsApi::scrubIpsDeleteRule(
    const int32_t& id, const std::shared_ptr<Delete_Firewall_Rule>& deleteFirewallRule) {
    std::string serializedRequestBody;
    std::string path = m_context + "/scrub_ips/{id}/delete_rule";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(deleteFirewallRule));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::string ScrubIpsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void ScrubIpsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void ScrubIpsApi::handleStdException(const std::exception&) {
    throw;
}

void ScrubIpsApi::handleUncaughtException() {
    throw;
}
