...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<BillingInvoiceDetail>
    getBillingInvoice(
        const int32_t& id);
    /// <summary>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<AffiliateBannerRow>>
    getAffiliateBanners(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<StatusMonthlyBreakdown>
    ...
    /// </remarks>
    virtual std::shared_ptr<GetAffiliateSignups_200_response>
    getAffiliateSignups(
    ...
    /// </remarks>
    virtual std::shared_ptr<MonthlyCounts>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<AffiliateTrafficRow>>
    ...
    /// </remarks>
    virtual std::shared_ptr<BillingInvoiceList>
    getBillingInvoices(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<InitiatePayment_200_response>
    initiatePayment(
