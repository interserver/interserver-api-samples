...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_TicketsApi_
#define BOOST_BEAST_OPENAPI_CLIENT_TicketsApi_
...
///
class TicketsApiException: public std::exception
{
public:
    TicketsApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<TicketNewResponse>
    addNewTicket(
    ...
    /// </remarks>
    virtual std::shared_ptr<CloseTicketResponseSchema>
    closeTicket(
        const std::string& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<ViewTicketResponse>
    deleteTicketInfo(
        const double& id);
    ...
    /// </remarks>
    virtual std::shared_ptr<Tickets>
    getTicketsList(
    ...
    /// </remarks>
    virtual std::shared_ptr<ReplyTicketResponseSchema>
    replyTicket(
    ...
    /// </remarks>
    virtual std::shared_ptr<UpdateTicketResponseSchema>
    updateTicketInfo(
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_TicketsApi_ */
