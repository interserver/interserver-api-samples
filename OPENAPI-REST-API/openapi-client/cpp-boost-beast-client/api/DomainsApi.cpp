...
DomainsApiException::DomainsApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status DomainsApiException::getStatus() const
{
    return m_status;
}

const char* DomainsApiException::what() const noexcept
{
    return m_what.c_str();
}

std::shared_ptr<ServiceOrderPostResponse>
DomainsApi::addDomain(
    const std::shared_ptr<DomainOrderRequest>& domainOrderRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/order";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(domainOrderRequest));
    } else {
    ...
    if (statusCode == boost::beast::http::status(401)) {
        throw DomainsApiException(statusCode, "Unauthorized");
    }
    throw DomainsApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<DomainOrder>
DomainsApi::getNewDomain(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/order";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<DomainOrder> deserializedResponse = std::make_shared<DomainOrder>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DomainOrder>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
DomainsApi::addDomainDnssec(
    const int32_t& id, const std::shared_ptr<DomainDnssecRequest>& domainDnssecRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/dnssec";
    std::map<std::string, std::string> headers;
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(domainDnssecRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<DomainDnssecRecords>
DomainsApi::getDomainDnssec(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/dnssec";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<DomainDnssecRecords> deserializedResponse = std::make_shared<DomainDnssecRecords>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DomainDnssecRecords>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
DomainsApi::addDomainNameserver(
    const int32_t& id, const std::shared_ptr<DomainNameserverPostRequest>& domainNameserverPostRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/nameservers";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(domainNameserverPostRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<TextResponse>
DomainsApi::deleteDomainNameserver(
    const int32_t& id, const int32_t& index) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/nameservers";
    std::map<std::string, std::string> headers;
    // path params
    ...
    const char* queryParameterSeparator = "?";
        appendQueryParameter(
            ...
            queryParameterSeparator,
            "index",
            serializeQueryParameterValue(index));
...
std::shared_ptr<DomainNameserverGetResponse>
DomainsApi::getDomainNameservers(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/nameservers";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<DomainNameserverGetResponse> deserializedResponse = std::make_shared<DomainNameserverGetResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DomainNameserverGetResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<TextResponse>
DomainsApi::updateDomainNameservers(
    const int32_t& id, const std::shared_ptr<DomainNameserverPutRequest>& domainNameserverPutRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/nameservers";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(domainNameserverPutRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::shared_ptr<CancelDomain_200_response>
DomainsApi::cancelDomain(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<CancelDomain_200_response> deserializedResponse = std::make_shared<CancelDomain_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<CancelDomain_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
DomainsApi::getDomainInfo(
    ...
    std::shared_ptr<Domain> deserializedResponse = std::make_shared<Domain>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Domain>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<DomainContactDetails>
DomainsApi::getDomainContact(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/contact";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<DomainContactDetails> deserializedResponse = std::make_shared<DomainContactDetails>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DomainContactDetails>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<SuccessTextResponse>
DomainsApi::updateDomainContact(
    const int32_t& id, const std::shared_ptr<DomainContactDetails>& domainContactDetails) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/contact";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(domainContactDetails));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
DomainsApi::getDomainInvoices(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/invoices";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<DomainLookupResponse>
DomainsApi::getDomainLookup(
    const std::string& name) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/lookup/{name}";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<DomainLookupResponse> deserializedResponse = std::make_shared<DomainLookupResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DomainLookupResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
    ...
    if (statusCode == boost::beast::http::status(422)) {
        throw DomainsApiException(statusCode, "The domain input was invalid.");
    }
    throw DomainsApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<SuccessTextResponse>
DomainsApi::getDomainRenewal(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/renew";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<DomainSearchResponse>
DomainsApi::getDomainSearch(
    const std::string& name) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/search/{name}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "name", name);
    ...
    std::shared_ptr<DomainSearchResponse> deserializedResponse = std::make_shared<DomainSearchResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<DomainSearchResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
    ...
    if (statusCode == boost::beast::http::status(404)) {
        throw DomainsApiException(statusCode, "No search suggestions or registrar response available.");
    }
    throw DomainsApiException(statusCode, "Unexpected HTTP status code");
}
void
DomainsApi::postDomainSearch(
    const std::string& name) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/search/{name}";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<SuccessTextResponse>
DomainsApi::getDomainTransfer(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/transfer";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<SuccessTextResponse>
DomainsApi::getDomainWhoisPrivacy(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/whois";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::shared_ptr<SuccessTextResponse>
DomainsApi::updateDomainWhoisPrivacy(
    const int32_t& id, const std::shared_ptr<DomainWhoisPrivacyRequest>& domainWhoisPrivacyRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/whois";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(domainWhoisPrivacyRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
...
std::vector<std::shared_ptr<DomainRow>>
DomainsApi::getDomainsList(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains";
    std::map<std::string, std::string> headers;
    ...
    std::vector<std::shared_ptr<DomainRow>> deserializedResponse = std::vector<std::shared_ptr<DomainRow>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<DomainRow>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<SuccessTextResponse>
DomainsApi::getDomainsWelcomeEmail(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/domains/{id}/welcome_email";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::string DomainsApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void DomainsApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void DomainsApi::handleStdException(const std::exception&) {
    throw;
}

void DomainsApi::handleUncaughtException() {
    throw;
}
