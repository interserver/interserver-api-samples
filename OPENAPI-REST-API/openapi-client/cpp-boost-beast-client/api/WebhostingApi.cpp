...
WebhostingApiException::WebhostingApiException(boost::beast::http::status statusCode, std::string what)
  : m_status(statusCode),
    m_what(what)
{
}

boost::beast::http::status WebhostingApiException::getStatus() const
{
    return m_status;
}

const char* WebhostingApiException::what() const noexcept
{
    return m_what.c_str();
}

std::shared_ptr<ServiceOrderPostResponse>
WebhostingApi::addWebsite(
    const std::shared_ptr<WebsiteOrderPostRequest>& websiteOrderPostRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/order";
    ...
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(websiteOrderPostRequest));
    } else {
    ...
    if (statusCode == boost::beast::http::status(401)) {
        throw WebhostingApiException(statusCode, "Unauthorized");
    }
    throw WebhostingApiException(statusCode, "Unexpected HTTP status code");
}
std::shared_ptr<WebsitesOrder>
WebhostingApi::getNewWebsite(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/order";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<WebsitesOrder> deserializedResponse = std::make_shared<WebsitesOrder>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<WebsitesOrder>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
void
WebhostingApi::putWebsites(
    const std::shared_ptr<WebsiteOrderPutRequest>& websiteOrderPutRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/order";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json", };
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(websiteOrderPutRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
...
std::shared_ptr<GetWebsiteBuyIp_200_response>
WebhostingApi::getWebsiteBuyIp(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}/buy_ip";
    std::map<std::string, std::string> headers;
    // path params
    ...
    std::shared_ptr<GetWebsiteBuyIp_200_response> deserializedResponse = std::make_shared<GetWebsiteBuyIp_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<GetWebsiteBuyIp_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<PostWebsiteBuyIp_200_response>
WebhostingApi::postWebsiteBuyIp(
    const int32_t& id, const std::shared_ptr<PostWebsiteBuyIp_request>& postWebsiteBuyIpRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}/buy_ip";
    std::map<std::string, std::string> headers;
    ...
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(postWebsiteBuyIpRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<PostWebsiteBuyIp_200_response> deserializedResponse = std::make_shared<PostWebsiteBuyIp_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PostWebsiteBuyIp_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<Website>
WebhostingApi::getWebsiteInfo(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<Website> deserializedResponse = std::make_shared<Website>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<Website>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
WebhostingApi::updateWebsiteInfo(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}";
    std::map<std::string, std::string> headers;
...
std::shared_ptr<WebhostingCancel_200_response>
WebhostingApi::webhostingCancel(
    const std::string& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}";
    std::map<std::string, std::string> headers;
    ...
    std::shared_ptr<WebhostingCancel_200_response> deserializedResponse = std::make_shared<WebhostingCancel_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<WebhostingCancel_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
WebhostingApi::getWebsiteInvoices(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}/invoices";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
std::vector<std::shared_ptr<WebsiteRow>>
WebhostingApi::getWebsiteList(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites";
    std::map<std::string, std::string> headers;

    std::string responseContentType = "application/json";
    static const std::vector<std::string> acceptTypes{ "application/json","multipart/form-data", };
    responseContentType = selectPreferredContentType(acceptTypes);
    headers["Accept"] = responseContentType;
    ...
    std::vector<std::shared_ptr<WebsiteRow>> deserializedResponse = std::vector<std::shared_ptr<WebsiteRow>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::vector<std::shared_ptr<WebsiteRow>>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<WebsiteBackups>
WebhostingApi::getWebsitesBackups(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}/backups";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<WebsiteBackups> deserializedResponse = std::make_shared<WebsiteBackups>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<WebsiteBackups>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<WebsiteLoginResponse>
WebhostingApi::getWebsitesLogin(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}/login";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
    ...
    std::shared_ptr<WebsiteLoginResponse> deserializedResponse = std::make_shared<WebsiteLoginResponse>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<WebsiteLoginResponse>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::shared_ptr<SuccessTextResponse>
WebhostingApi::getWebsitesWelcomeEmail(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}/welcome_email";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
WebhostingApi::gettWebsiteReverseDns(
    const int32_t& id) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}/reverse_dns";
    std::map<std::string, std::string> headers;
    // path params
    replacePathParameter(path, "id", id);
...
WebhostingApi::postWebsitesReverseDns(
...
std::shared_ptr<PostWebsiteMigration_200_response>
WebhostingApi::postWebsiteMigration(
    const int32_t& id, const std::shared_ptr<PostWebsiteMigration_request>& postWebsiteMigrationRequest) {
    std::string serializedRequestBody;
    std::string path = m_context + "/websites/{id}/migration";
    std::map<std::string, std::string> headers;
    static const std::vector<std::string> contentTypes{ "application/json","multipart/form-data", };
    std::string requestContentType = selectPreferredContentType(contentTypes);
    headers["Content-Type"] = requestContentType;
    // Body params
    if (isJsonContentType(requestContentType)) {
        serializedRequestBody = boost::json::serialize(toRequestJsonValue(postWebsiteMigrationRequest));
    } else {
        throw std::invalid_argument("Content type '" + requestContentType + "' does not support structured request bodies");
    }
    // path params
    ...
    std::shared_ptr<PostWebsiteMigration_200_response> deserializedResponse = std::make_shared<PostWebsiteMigration_200_response>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::shared_ptr<PostWebsiteMigration_200_response>>::deserialize(
            deserializedResponse,
            responseBody,
            responseContentType,
            false);
...
std::string WebhostingApi::base64encode(const std::string& str) {
    return base64encodeImpl(str);
}

void WebhostingApi::setPreferredMediaTypeHeader(std::map<std::string, std::string>& headers, const std::string& headerName, const std::vector<std::string>& contentTypes) {
    const std::string contentType = selectPreferredContentType(contentTypes);
    headers[headerName] = contentType;
}

void WebhostingApi::handleStdException(const std::exception&) {
    throw;
}

void WebhostingApi::handleUncaughtException() {
    throw;
}
