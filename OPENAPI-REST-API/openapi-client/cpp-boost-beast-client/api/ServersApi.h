...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_ServersApi_
#define BOOST_BEAST_OPENAPI_CLIENT_ServersApi_
...
///
class ServersApiException: public std::exception
{
public:
    ServersApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<AddServer_200_response>
    addServer(
    ...
    /// </remarks>
    virtual std::shared_ptr<ServerOrder>
    getNewServer(
        );
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<BuyItNowServerOrder_200_response>
    buyItNowServerOrder(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<ServersBuyNowResponse>
    placeBuyNowServer(
    ...
    /// </remarks>
    virtual std::shared_ptr<BuyItNowList>
    getMPServers(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<ServersCancel_200_response>
    serversCancel(
        const int32_t& id);
    /// <summary>
    ...
    /// </remarks>
    virtual std::vector<std::shared_ptr<ServerRow>>
    getServerList(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<ServerBulkIpmiPowerResponse>
    ...
    /// </remarks>
    virtual std::shared_ptr<ServerIpmiLiveInfo>
    serverIpmiLiveGet(
        const int32_t& id);
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_ServersApi_ */
