...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_AccountApi_
#define BOOST_BEAST_OPENAPI_CLIENT_AccountApi_
...
///
class AccountApiException: public std::exception
{
public:
    AccountApiException(boost::beast::http::status statusCode, std::string what);
...
public:
    ...
    /// </remarks>
    virtual std::shared_ptr<GetAccountTfaSetup_200_response>
    getAccountTfaSetup(
        );
    /// <summary>
    ...
    /// </remarks>
    virtual std::shared_ptr<AccountInfo>
    getAccountInfo(
        );
    ...
    /// </remarks>
    virtual std::shared_ptr<SearchAutocompleteResponse>
    getSearch(
        );
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_AccountApi_ */
