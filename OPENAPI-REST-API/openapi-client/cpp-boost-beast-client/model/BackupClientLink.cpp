...
BackupClientLink::BackupClientLink(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BackupClientLink::toJsonString(bool prettyJson /* = false */) const
{
...
void BackupClientLink::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BackupClientLink::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BackupClientLink::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BackupClientLink");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BackupClientLink::toJsonObject_internal() const
{
...
void BackupClientLink::fromJsonObject_internal(boost::json::object const& object)
{
    m_LabelIsSet = false;
    m_LinkIsSet = false;
    m_IconIsSet = false;
...
std::string BackupClientLink::getLabel() const
{
    return m_Label;
}

void BackupClientLink::setLabel(std::string value)
{
    
    m_Label = std::move(value);
    m_LabelIsSet = true;
}
std::string BackupClientLink::getLink() const
{
    return m_Link;
}

void BackupClientLink::setLink(std::string value)
{
    
    m_Link = std::move(value);
    m_LinkIsSet = true;
}
std::string BackupClientLink::getIcon() const
{
    return m_Icon;
}

void BackupClientLink::setIcon(std::string value)
{
    
    m_Icon = std::move(value);
    m_IconIsSet = true;
}
std::string BackupClientLink::getIconText() const
{
    return m_Icon_text;
}

void BackupClientLink::setIconText(std::string value)
{
    
    m_Icon_text = std::move(value);
    m_Icon_textIsSet = true;
}
std::string BackupClientLink::getHelpText() const
{
    return m_Help_text;
}

void BackupClientLink::setHelpText(std::string value)
{
    
    m_Help_text = std::move(value);
    m_Help_textIsSet = true;
}
std::string BackupClientLink::getOtherAttr() const
{
    return m_Other_attr;
}

void BackupClientLink::setOtherAttr(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BackupClientLink>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BackupClientLink>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BackupClientLink>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BackupClientLink>>>::fromJsonValue(boost::json::parse(json));
}
