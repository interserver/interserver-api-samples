...
LicenseIpInfoRow::LicenseIpInfoRow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LicenseIpInfoRow::toJsonString(bool prettyJson /* = false */) const
{
...
void LicenseIpInfoRow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LicenseIpInfoRow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LicenseIpInfoRow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LicenseIpInfoRow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LicenseIpInfoRow::toJsonObject_internal() const
{
...
void LicenseIpInfoRow::fromJsonObject_internal(boost::json::object const& object)
{
    m_DescIsSet = false;
    m_ValueIsSet = false;
    {
...
std::string LicenseIpInfoRow::getDesc() const
{
    return m_Desc;
}

void LicenseIpInfoRow::setDesc(std::string value)
{
    
    m_Desc = std::move(value);
    m_DescIsSet = true;
}
std::string LicenseIpInfoRow::getValue() const
{
    return m_Value;
}

void LicenseIpInfoRow::setValue(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LicenseIpInfoRow>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LicenseIpInfoRow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LicenseIpInfoRow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LicenseIpInfoRow>>>::fromJsonValue(boost::json::parse(json));
}
