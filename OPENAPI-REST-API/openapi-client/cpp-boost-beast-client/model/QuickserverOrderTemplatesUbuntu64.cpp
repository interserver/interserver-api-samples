...
QuickserverOrderTemplatesUbuntu64::QuickserverOrderTemplatesUbuntu64(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverOrderTemplatesUbuntu64::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverOrderTemplatesUbuntu64::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverOrderTemplatesUbuntu64::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverOrderTemplatesUbuntu64::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverOrderTemplatesUbuntu64");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverOrderTemplatesUbuntu64::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void QuickserverOrderTemplatesUbuntu64::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverOrderTemplatesUbuntu64>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrderTemplatesUbuntu64>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverOrderTemplatesUbuntu64>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrderTemplatesUbuntu64>>>::fromJsonValue(boost::json::parse(json));
}
