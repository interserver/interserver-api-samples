...
UpdateTicketResponseSchema::UpdateTicketResponseSchema(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdateTicketResponseSchema::toJsonString(bool prettyJson /* = false */) const
{
...
void UpdateTicketResponseSchema::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value UpdateTicketResponseSchema::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdateTicketResponseSchema::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdateTicketResponseSchema");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdateTicketResponseSchema::toJsonObject_internal() const
{
...
void UpdateTicketResponseSchema::fromJsonObject_internal(boost::json::object const& object)
{
...
bool UpdateTicketResponseSchema::isSuccess() const
{
    return m_Success;
}

void UpdateTicketResponseSchema::setSuccess(bool value)
{
    
    m_Success = std::move(value);
    m_SuccessIsSet = true;
}
std::string UpdateTicketResponseSchema::getMessage() const
{
    return m_Message;
}

void UpdateTicketResponseSchema::setMessage(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UpdateTicketResponseSchema>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdateTicketResponseSchema>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdateTicketResponseSchema>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdateTicketResponseSchema>>>::fromJsonValue(boost::json::parse(json));
}
