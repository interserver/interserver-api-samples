...
ScrubIpFilterTypes::ScrubIpFilterTypes(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ScrubIpFilterTypes::toJsonString(bool prettyJson /* = false */) const
{
...
void ScrubIpFilterTypes::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ScrubIpFilterTypes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ScrubIpFilterTypes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ScrubIpFilterTypes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ScrubIpFilterTypes::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_FiltersIsSet) {
            object["filters"] = JsonValueConverter<std::map<std::string, std::shared_ptr<ScrubIpFilterTypes_filters_value>>>::toJsonValue(getFilters());
        }
    return object;
}

void ScrubIpFilterTypes::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (FiltersIt != object.end()) {
            setFilters(JsonValueConverter<std::map<std::string, std::shared_ptr<ScrubIpFilterTypes_filters_value>>>::fromJsonValue(FiltersIt->value()));
        }
    }
}
...
std::map<std::string, std::shared_ptr<ScrubIpFilterTypes_filters_value>> ScrubIpFilterTypes::getFilters() const
{
    return m_Filters;
}

void ScrubIpFilterTypes::setFilters(std::map<std::string, std::shared_ptr<ScrubIpFilterTypes_filters_value>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ScrubIpFilterTypes>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ScrubIpFilterTypes>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ScrubIpFilterTypes>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ScrubIpFilterTypes>>>::fromJsonValue(boost::json::parse(json));
}
