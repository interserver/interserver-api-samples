...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_CreateFirewallRule_MODEL_H_
#define BOOST_BEAST_OPENAPI_CLIENT_CreateFirewallRule_MODEL_H_
...
{
public:
    CreateFirewallRule() = default;
    explicit CreateFirewallRule(boost::json::value const& value);
    virtual ~CreateFirewallRule() = default;
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_CreateFirewallRule_MODEL_H_ */
