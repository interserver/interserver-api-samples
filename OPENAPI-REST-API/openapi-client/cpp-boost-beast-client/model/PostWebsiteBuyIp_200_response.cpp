...
PostWebsiteBuyIp_200_response::PostWebsiteBuyIp_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PostWebsiteBuyIp_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void PostWebsiteBuyIp_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PostWebsiteBuyIp_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PostWebsiteBuyIp_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PostWebsiteBuyIp_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PostWebsiteBuyIp_200_response::toJsonObject_internal() const
{
...
void PostWebsiteBuyIp_200_response::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string PostWebsiteBuyIp_200_response::getMessage() const
{
    return m_Message;
}

void PostWebsiteBuyIp_200_response::setMessage(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PostWebsiteBuyIp_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PostWebsiteBuyIp_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PostWebsiteBuyIp_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PostWebsiteBuyIp_200_response>>>::fromJsonValue(boost::json::parse(json));
}
