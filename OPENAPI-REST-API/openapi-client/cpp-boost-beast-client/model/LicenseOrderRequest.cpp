...
LicenseOrderRequest::LicenseOrderRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LicenseOrderRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void LicenseOrderRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LicenseOrderRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LicenseOrderRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LicenseOrderRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LicenseOrderRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["package"] = JsonValueConverter<int32_t>::toJsonValue(getPackage());
...
void LicenseOrderRequest::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_CommentIsSet = false;
    {
        ...
        if (PackageIt != object.end()) {
            setPackage(JsonValueConverter<int32_t>::fromJsonValue(PackageIt->value()));
        }
    }
    {
...
std::string LicenseOrderRequest::getIp() const
{
    return m_Ip;
}

void LicenseOrderRequest::setIp(std::string value)
{
...
std::string LicenseOrderRequest::getCoupon() const
{
    return m_Coupon;
}

void LicenseOrderRequest::setCoupon(std::string value)
{
    
    m_Coupon = std::move(value);
    m_CouponIsSet = true;
}
std::string LicenseOrderRequest::getComment() const
{
    return m_Comment;
}

void LicenseOrderRequest::setComment(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LicenseOrderRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LicenseOrderRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LicenseOrderRequest>>>::fromJsonValue(boost::json::parse(json));
}
