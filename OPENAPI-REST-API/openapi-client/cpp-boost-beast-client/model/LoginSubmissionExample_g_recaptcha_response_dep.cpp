...
LoginSubmissionExample_g_recaptcha_response_dep::LoginSubmissionExample_g_recaptcha_response_dep(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LoginSubmissionExample_g_recaptcha_response_dep::toJsonString(bool prettyJson /* = false */) const
{
...
void LoginSubmissionExample_g_recaptcha_response_dep::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LoginSubmissionExample_g_recaptcha_response_dep::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LoginSubmissionExample_g_recaptcha_response_dep::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LoginSubmissionExample_g_recaptcha_response_dep");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LoginSubmissionExample_g_recaptcha_response_dep::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_wIsSet) {
            object["w"] = JsonValueConverter<int32_t>::toJsonValue(getW());
        }
        if (m_nIsSet) {
            object["n"] = JsonValueConverter<int32_t>::toJsonValue(getN());
        }
    return object;
}

void LoginSubmissionExample_g_recaptcha_response_dep::fromJsonObject_internal(boost::json::object const& object)
{
    m_wIsSet = false;
    m_nIsSet = false;
    {
        const auto wIt = object.find("w");
        if (wIt != object.end()) {
            setW(JsonValueConverter<int32_t>::fromJsonValue(wIt->value()));
        }
    }
    {
        const auto nIt = object.find("n");
        if (nIt != object.end()) {
            setN(JsonValueConverter<int32_t>::fromJsonValue(nIt->value()));
        }
    }
}

int32_t LoginSubmissionExample_g_recaptcha_response_dep::getW() const
{
    return m_w;
}

void LoginSubmissionExample_g_recaptcha_response_dep::setW(int32_t value)
{
    
    m_w = std::move(value);
    m_wIsSet = true;
}
int32_t LoginSubmissionExample_g_recaptcha_response_dep::getN() const
{
    return m_n;
}

void LoginSubmissionExample_g_recaptcha_response_dep::setN(int32_t value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LoginSubmissionExample_g_recaptcha_response_dep>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LoginSubmissionExample_g_recaptcha_response_dep>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LoginSubmissionExample_g_recaptcha_response_dep>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LoginSubmissionExample_g_recaptcha_response_dep>>>::fromJsonValue(boost::json::parse(json));
}
