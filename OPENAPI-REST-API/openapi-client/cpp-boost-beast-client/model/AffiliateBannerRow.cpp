...
AffiliateBannerRow::AffiliateBannerRow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AffiliateBannerRow::toJsonString(bool prettyJson /* = false */) const
{
...
void AffiliateBannerRow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AffiliateBannerRow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AffiliateBannerRow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AffiliateBannerRow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AffiliateBannerRow::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ImageIsSet) {
            object["image"] = JsonValueConverter<std::string>::toJsonValue(getImage());
        }
        if (m_WidthIsSet) {
            object["width"] = JsonValueConverter<std::string>::toJsonValue(getWidth());
        }
        if (m_HeightIsSet) {
            object["height"] = JsonValueConverter<std::string>::toJsonValue(getHeight());
        }
    return object;
}

void AffiliateBannerRow::fromJsonObject_internal(boost::json::object const& object)
{
    m_ImageIsSet = false;
    m_WidthIsSet = false;
    m_HeightIsSet = false;
    {
        const auto ImageIt = object.find("image");
        if (ImageIt != object.end()) {
            setImage(JsonValueConverter<std::string>::fromJsonValue(ImageIt->value()));
        }
    }
    {
        const auto WidthIt = object.find("width");
        if (WidthIt != object.end()) {
            setWidth(JsonValueConverter<std::string>::fromJsonValue(WidthIt->value()));
        }
    }
    {
        const auto HeightIt = object.find("height");
        if (HeightIt != object.end()) {
            setHeight(JsonValueConverter<std::string>::fromJsonValue(HeightIt->value()));
        }
    }
}

std::string AffiliateBannerRow::getImage() const
{
    return m_Image;
}

void AffiliateBannerRow::setImage(std::string value)
{
    
    m_Image = std::move(value);
    m_ImageIsSet = true;
}
std::string AffiliateBannerRow::getWidth() const
{
    return m_Width;
}

void AffiliateBannerRow::setWidth(std::string value)
{
    
    m_Width = std::move(value);
    m_WidthIsSet = true;
}
std::string AffiliateBannerRow::getHeight() const
{
    return m_Height;
}

void AffiliateBannerRow::setHeight(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AffiliateBannerRow>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AffiliateBannerRow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AffiliateBannerRow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AffiliateBannerRow>>>::fromJsonValue(boost::json::parse(json));
}
