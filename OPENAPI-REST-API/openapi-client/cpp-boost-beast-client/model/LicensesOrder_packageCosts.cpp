...
LicensesOrder_packageCosts::LicensesOrder_packageCosts(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LicensesOrder_packageCosts::toJsonString(bool prettyJson /* = false */) const
{
...
void LicensesOrder_packageCosts::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LicensesOrder_packageCosts::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LicensesOrder_packageCosts::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LicensesOrder_packageCosts");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LicensesOrder_packageCosts::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_LicensesOrderPackageCosts11468IsSet) {
            object["LicensesOrderPackageCosts11468"] = JsonValueConverter<double>::toJsonValue(getLicensesOrderPackageCosts11468());
        }
    return object;
}

void LicensesOrder_packageCosts::fromJsonObject_internal(boost::json::object const& object)
{
    m_LicensesOrderPackageCosts11468IsSet = false;
    {
        const auto LicensesOrderPackageCosts11468It = object.find("LicensesOrderPackageCosts11468");
        if (LicensesOrderPackageCosts11468It != object.end()) {
            setLicensesOrderPackageCosts11468(JsonValueConverter<double>::fromJsonValue(LicensesOrderPackageCosts11468It->value()));
        }
    }
}
...
void LicensesOrder_packageCosts::setLicensesOrderPackageCosts11468(double value)
{
    ...
    m_LicensesOrderPackageCosts11468 = std::move(value);
    m_LicensesOrderPackageCosts11468IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LicensesOrder_packageCosts>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LicensesOrder_packageCosts>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LicensesOrder_packageCosts>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LicensesOrder_packageCosts>>>::fromJsonValue(boost::json::parse(json));
}
