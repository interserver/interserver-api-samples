...
WebsitesOrderJsonServiceOffers::WebsitesOrderJsonServiceOffers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsitesOrderJsonServiceOffers::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsitesOrderJsonServiceOffers::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsitesOrderJsonServiceOffers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsitesOrderJsonServiceOffers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsitesOrderJsonServiceOffers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsitesOrderJsonServiceOffers::toJsonObject_internal() const
{
    boost::json::object object;
        object["1026"] = JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderJsonServiceOffersItem>>>::toJsonValue(getR1026());
    return object;
}

void WebsitesOrderJsonServiceOffers::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto r_1026It = object.find("1026");
        if (r_1026It != object.end()) {
            setR1026(JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderJsonServiceOffersItem>>>::fromJsonValue(r_1026It->value()));
        }
    }
}

std::vector<std::shared_ptr<WebsitesOrderJsonServiceOffersItem>> WebsitesOrderJsonServiceOffers::getR1026() const
{
    return m_r_1026;
}

void WebsitesOrderJsonServiceOffers::setR1026(std::vector<std::shared_ptr<WebsitesOrderJsonServiceOffersItem>> value)
{
    
    m_r_1026 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WebsitesOrderJsonServiceOffers>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderJsonServiceOffers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsitesOrderJsonServiceOffers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderJsonServiceOffers>>>::fromJsonValue(boost::json::parse(json));
}
