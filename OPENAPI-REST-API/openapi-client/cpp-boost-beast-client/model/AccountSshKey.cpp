...
AccountSshKey::AccountSshKey(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AccountSshKey::toJsonString(bool prettyJson /* = false */) const
{
...
void AccountSshKey::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AccountSshKey::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AccountSshKey::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AccountSshKey");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AccountSshKey::toJsonObject_internal() const
{
...
void AccountSshKey::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string AccountSshKey::getSshKey() const
{
    return m_Ssh_key;
}

void AccountSshKey::setSshKey(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AccountSshKey>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AccountSshKey>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AccountSshKey>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AccountSshKey>>>::fromJsonValue(boost::json::parse(json));
}
