...
IpObject::IpObject(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IpObject::toJsonString(bool prettyJson /* = false */) const
{
...
void IpObject::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value IpObject::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IpObject::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IpObject");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IpObject::toJsonObject_internal() const
{
...
void IpObject::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string IpObject::getIp() const
{
    return m_Ip;
}

void IpObject::setIp(std::string value)
{
    
    m_Ip = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<IpObject>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IpObject>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IpObject>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IpObject>>>::fromJsonValue(boost::json::parse(json));
}
