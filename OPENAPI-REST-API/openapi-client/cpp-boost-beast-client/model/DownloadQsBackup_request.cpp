...
DownloadQsBackup_request::DownloadQsBackup_request(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DownloadQsBackup_request::toJsonString(bool prettyJson /* = false */) const
{
...
void DownloadQsBackup_request::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DownloadQsBackup_request::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DownloadQsBackup_request::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DownloadQsBackup_request");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DownloadQsBackup_request::toJsonObject_internal() const
{
    boost::json::object object;
        object["file"] = JsonValueConverter<std::string>::toJsonValue(getFile());
    return object;
}

void DownloadQsBackup_request::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto fileIt = object.find("file");
        if (fileIt != object.end()) {
            setFile(JsonValueConverter<std::string>::fromJsonValue(fileIt->value()));
        }
    }
}

std::string DownloadQsBackup_request::getFile() const
{
    return m_file;
}

void DownloadQsBackup_request::setFile(std::string value)
{
    
    m_file = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DownloadQsBackup_request>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DownloadQsBackup_request>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DownloadQsBackup_request>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DownloadQsBackup_request>>>::fromJsonValue(boost::json::parse(json));
}
