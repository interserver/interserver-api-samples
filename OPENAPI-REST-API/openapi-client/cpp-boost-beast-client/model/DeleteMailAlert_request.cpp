...
DeleteMailAlert_request::DeleteMailAlert_request(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DeleteMailAlert_request::toJsonString(bool prettyJson /* = false */) const
{
...
void DeleteMailAlert_request::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DeleteMailAlert_request::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeleteMailAlert_request::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeleteMailAlert_request");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeleteMailAlert_request::toJsonObject_internal() const
{
...
void DeleteMailAlert_request::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
int32_t DeleteMailAlert_request::getAlertId() const
{
    return m_Alert_id;
}

void DeleteMailAlert_request::setAlertId(int32_t value)
{
    
    m_Alert_id = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DeleteMailAlert_request>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeleteMailAlert_request>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeleteMailAlert_request>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeleteMailAlert_request>>>::fromJsonValue(boost::json::parse(json));
}
