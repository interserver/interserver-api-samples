...
DomainOrder_services::DomainOrder_services(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DomainOrder_services::toJsonString(bool prettyJson /* = false */) const
{
...
void DomainOrder_services::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DomainOrder_services::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DomainOrder_services::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DomainOrder_services");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DomainOrder_services::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_DomainOrderServices10001IsSet) {
            object["DomainOrderServices10001"] = JsonValueConverter<std::shared_ptr<DomainOrderServices10001>>::toJsonValue(getDomainOrderServices10001());
        }
    return object;
}

void DomainOrder_services::fromJsonObject_internal(boost::json::object const& object)
{
    m_DomainOrderServices10001IsSet = false;
    {
        const auto DomainOrderServices10001It = object.find("DomainOrderServices10001");
        if (DomainOrderServices10001It != object.end()) {
            setDomainOrderServices10001(JsonValueConverter<std::shared_ptr<DomainOrderServices10001>>::fromJsonValue(DomainOrderServices10001It->value()));
        }
    }
}

std::shared_ptr<DomainOrderServices10001> DomainOrder_services::getDomainOrderServices10001() const
{
    return m_DomainOrderServices10001;
}

void DomainOrder_services::setDomainOrderServices10001(std::shared_ptr<DomainOrderServices10001> value)
{
    
    m_DomainOrderServices10001 = std::move(value);
    m_DomainOrderServices10001IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DomainOrder_services>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DomainOrder_services>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DomainOrder_services>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DomainOrder_services>>>::fromJsonValue(boost::json::parse(json));
}
