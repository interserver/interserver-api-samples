...
TicketNewResponse::TicketNewResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TicketNewResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void TicketNewResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TicketNewResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TicketNewResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TicketNewResponse");
    }
...
void TicketNewResponse::setText(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TicketNewResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TicketNewResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TicketNewResponse>>>::fromJsonValue(boost::json::parse(json));
}
