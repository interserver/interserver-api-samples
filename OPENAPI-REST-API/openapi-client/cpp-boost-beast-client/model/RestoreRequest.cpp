...
RestoreRequest::RestoreRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string RestoreRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void RestoreRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value RestoreRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void RestoreRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for RestoreRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object RestoreRequest::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_BackupIsSet) {
            object["backup"] = JsonValueConverter<std::string>::toJsonValue(getBackup());
        }
        if (m_PasswordIsSet) {
...
void RestoreRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_BackupIsSet = false;
    m_PasswordIsSet = false;
    {
        const auto BackupIt = object.find("backup");
        if (BackupIt != object.end()) {
            setBackup(JsonValueConverter<std::string>::fromJsonValue(BackupIt->value()));
        }
    }
    {
...
std::string RestoreRequest::getBackup() const
{
    return m_Backup;
}

void RestoreRequest::setBackup(std::string value)
{
    
    m_Backup = std::move(value);
    m_BackupIsSet = true;
}
std::string RestoreRequest::getPassword() const
{
    return m_Password;
}

void RestoreRequest::setPassword(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<RestoreRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<RestoreRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<RestoreRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<RestoreRequest>>>::fromJsonValue(boost::json::parse(json));
}
