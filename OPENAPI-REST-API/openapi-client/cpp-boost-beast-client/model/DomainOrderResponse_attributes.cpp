...
DomainOrderResponse_attributes::DomainOrderResponse_attributes(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DomainOrderResponse_attributes::toJsonString(bool prettyJson /* = false */) const
{
...
void DomainOrderResponse_attributes::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DomainOrderResponse_attributes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DomainOrderResponse_attributes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DomainOrderResponse_attributes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DomainOrderResponse_attributes::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_Admin_emailIsSet) {
            object["admin_email"] = JsonValueConverter<std::string>::toJsonValue(getAdminEmail());
        }
    return object;
}

void DomainOrderResponse_attributes::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    ...
    {
        const auto Admin_emailIt = object.find("admin_email");
        if (Admin_emailIt != object.end()) {
            setAdminEmail(JsonValueConverter<std::string>::fromJsonValue(Admin_emailIt->value()));
        }
    }
}

std::string DomainOrderResponse_attributes::getId() const
{
    return m_Id;
}

void DomainOrderResponse_attributes::setId(std::string value)
{
    
    m_Id = std::move(value);
    m_IdIsSet = true;
}
std::string DomainOrderResponse_attributes::getAdminEmail() const
{
    return m_Admin_email;
}

void DomainOrderResponse_attributes::setAdminEmail(std::string value)
{
    
    m_Admin_email = std::move(value);
    m_Admin_emailIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DomainOrderResponse_attributes>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DomainOrderResponse_attributes>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DomainOrderResponse_attributes>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DomainOrderResponse_attributes>>>::fromJsonValue(boost::json::parse(json));
}
