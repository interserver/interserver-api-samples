...
QsOrderRequest::QsOrderRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QsOrderRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void QsOrderRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QsOrderRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QsOrderRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QsOrderRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QsOrderRequest::toJsonObject_internal() const
{
...
void QsOrderRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_OsIsSet = false;
    m_CommentIsSet = false;
    {
        ...
        if (ServerIt != object.end()) {
            setServer(JsonValueConverter<int32_t>::fromJsonValue(ServerIt->value()));
        }
    }
    {
...
std::string QsOrderRequest::getPassword() const
{
    return m_Password;
}

void QsOrderRequest::setPassword(std::string value)
{
...
void QsOrderRequest::setOs(std::string value)
{
...
void QsOrderRequest::setComment(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QsOrderRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QsOrderRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QsOrderRequest>>>::fromJsonValue(boost::json::parse(json));
}
