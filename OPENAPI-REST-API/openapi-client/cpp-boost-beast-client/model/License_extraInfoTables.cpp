...
License_extraInfoTables::License_extraInfoTables(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string License_extraInfoTables::toJsonString(bool prettyJson /* = false */) const
{
...
void License_extraInfoTables::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value License_extraInfoTables::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void License_extraInfoTables::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for License_extraInfoTables");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object License_extraInfoTables::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Ip_infoIsSet) {
            object["ip_info"] = JsonValueConverter<std::shared_ptr<LicenseIpInfo>>::toJsonValue(getIpInfo());
        }
    return object;
}

void License_extraInfoTables::fromJsonObject_internal(boost::json::object const& object)
{
    m_Ip_infoIsSet = false;
    {
        const auto Ip_infoIt = object.find("ip_info");
        if (Ip_infoIt != object.end()) {
            setIpInfo(JsonValueConverter<std::shared_ptr<LicenseIpInfo>>::fromJsonValue(Ip_infoIt->value()));
        }
    }
}
...
void License_extraInfoTables::setIpInfo(std::shared_ptr<LicenseIpInfo> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<License_extraInfoTables>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<License_extraInfoTables>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<License_extraInfoTables>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<License_extraInfoTables>>>::fromJsonValue(boost::json::parse(json));
}
