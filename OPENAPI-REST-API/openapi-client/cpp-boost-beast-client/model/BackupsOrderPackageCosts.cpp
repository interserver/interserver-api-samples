...
BackupsOrderPackageCosts::BackupsOrderPackageCosts(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BackupsOrderPackageCosts::toJsonString(bool prettyJson /* = false */) const
{
...
void BackupsOrderPackageCosts::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BackupsOrderPackageCosts::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BackupsOrderPackageCosts::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BackupsOrderPackageCosts");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BackupsOrderPackageCosts::toJsonObject_internal() const
{
    boost::json::object object;
        object["11006"] = JsonValueConverter<int32_t>::toJsonValue(getR11006());
    return object;
}

void BackupsOrderPackageCosts::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto r_11006It = object.find("11006");
        if (r_11006It != object.end()) {
            setR11006(JsonValueConverter<int32_t>::fromJsonValue(r_11006It->value()));
        }
    }
}

int32_t BackupsOrderPackageCosts::getR11006() const
{
    return m_r_11006;
}

void BackupsOrderPackageCosts::setR11006(int32_t value)
{
    
    m_r_11006 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BackupsOrderPackageCosts>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BackupsOrderPackageCosts>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BackupsOrderPackageCosts>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BackupsOrderPackageCosts>>>::fromJsonValue(boost::json::parse(json));
}
