...
MonthlyCounts::MonthlyCounts(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MonthlyCounts::toJsonString(bool prettyJson /* = false */) const
{
...
void MonthlyCounts::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MonthlyCounts::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MonthlyCounts::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MonthlyCounts");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MonthlyCounts::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MonthlyCounts::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MonthlyCounts>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MonthlyCounts>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MonthlyCounts>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MonthlyCounts>>>::fromJsonValue(boost::json::parse(json));
}
