...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_VpsOrderPutRequest_MODEL_H_
#define BOOST_BEAST_OPENAPI_CLIENT_VpsOrderPutRequest_MODEL_H_
...
{
public:
    VpsOrderPutRequest() = default;
    explicit VpsOrderPutRequest(boost::json::value const& value);
    virtual ~VpsOrderPutRequest() = default;
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_VpsOrderPutRequest_MODEL_H_ */
