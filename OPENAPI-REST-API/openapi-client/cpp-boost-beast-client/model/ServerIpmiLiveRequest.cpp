...
ServerIpmiLiveRequest::ServerIpmiLiveRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerIpmiLiveRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerIpmiLiveRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerIpmiLiveRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerIpmiLiveRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerIpmiLiveRequest");
    }
...
void ServerIpmiLiveRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_AssetIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerIpmiLiveRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerIpmiLiveRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerIpmiLiveRequest>>>::fromJsonValue(boost::json::parse(json));
}
