...
ServiceCategories::ServiceCategories(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServiceCategories::toJsonString(bool prettyJson /* = false */) const
{
...
void ServiceCategories::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServiceCategories::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServiceCategories::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServiceCategories");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServiceCategories::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ServiceCategories::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServiceCategories>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServiceCategories>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServiceCategories>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServiceCategories>>>::fromJsonValue(boost::json::parse(json));
}
