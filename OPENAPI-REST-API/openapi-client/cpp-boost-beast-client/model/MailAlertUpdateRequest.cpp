...
MailAlertUpdateRequest::MailAlertUpdateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailAlertUpdateRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void MailAlertUpdateRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailAlertUpdateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailAlertUpdateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailAlertUpdateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailAlertUpdateRequest::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_EnabledIsSet) {
            object["enabled"] = JsonValueConverter<std::string>::toJsonValue(getEnabled());
        }
    return object;
}

void MailAlertUpdateRequest::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (EnabledIt != object.end()) {
            setEnabled(JsonValueConverter<std::string>::fromJsonValue(EnabledIt->value()));
        }
    }
}

int32_t MailAlertUpdateRequest::getAlertId() const
{
    return m_Alert_id;
}

void MailAlertUpdateRequest::setAlertId(int32_t value)
{
    
    m_Alert_id = std::move(value);
    m_Alert_idIsSet = true;
}
std::string MailAlertUpdateRequest::getType() const
{
    return m_Type;
}

void MailAlertUpdateRequest::setType(std::string value)
{
    
    m_Type = std::move(value);
    m_TypeIsSet = true;
}
std::string MailAlertUpdateRequest::getValue() const
{
    return m_Value;
}

void MailAlertUpdateRequest::setValue(std::string value)
{
    
    m_Value = std::move(value);
    m_ValueIsSet = true;
}
std::string MailAlertUpdateRequest::getTo() const
{
    return m_To;
}

void MailAlertUpdateRequest::setTo(std::string value)
{
    
    m_To = std::move(value);
    m_ToIsSet = true;
}
std::string MailAlertUpdateRequest::getEnabled() const
{
    return m_Enabled;
}

void MailAlertUpdateRequest::setEnabled(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailAlertUpdateRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailAlertUpdateRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailAlertUpdateRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailAlertUpdateRequest>>>::fromJsonValue(boost::json::parse(json));
}
