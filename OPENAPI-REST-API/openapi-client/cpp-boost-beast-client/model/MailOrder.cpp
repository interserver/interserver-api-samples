...
MailOrder::MailOrder(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailOrder::toJsonString(bool prettyJson /* = false */) const
{
...
void MailOrder::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailOrder::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailOrder::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailOrder");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailOrder::toJsonObject_internal() const
{
...
void MailOrder::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string MailOrder::getStatus() const
{
    return m_Status;
}

void MailOrder::setStatus(std::string value)
{
    
    m_Status = std::move(value);
}
std::string MailOrder::getUsername() const
{
    return m_Username;
}

void MailOrder::setUsername(std::string value)
{
    
    m_Username = std::move(value);
}
std::string MailOrder::getComment() const
{
    return m_Comment;
}

void MailOrder::setComment(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailOrder>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailOrder>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailOrder>>>::fromJsonValue(boost::json::parse(json));
}
