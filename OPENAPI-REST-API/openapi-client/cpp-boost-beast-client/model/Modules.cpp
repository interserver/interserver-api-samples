...
Modules::Modules(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Modules::toJsonString(bool prettyJson /* = false */) const
{
...
void Modules::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Modules::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Modules::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Modules");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Modules::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Modules::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Modules>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Modules>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Modules>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Modules>>>::fromJsonValue(boost::json::parse(json));
}
