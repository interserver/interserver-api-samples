...
AccountInfoOauthConfig::AccountInfoOauthConfig(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AccountInfoOauthConfig::toJsonString(bool prettyJson /* = false */) const
{
...
void AccountInfoOauthConfig::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AccountInfoOauthConfig::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AccountInfoOauthConfig::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AccountInfoOauthConfig");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AccountInfoOauthConfig::toJsonObject_internal() const
{
    boost::json::object object;
        object["callback"] = JsonValueConverter<std::string>::toJsonValue(getCallback());
        object["providers"] = JsonValueConverter<std::shared_ptr<AccountInfoOauthConfigProviders>>::toJsonValue(getProviders());
    return object;
}

void AccountInfoOauthConfig::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto CallbackIt = object.find("callback");
        if (CallbackIt != object.end()) {
            setCallback(JsonValueConverter<std::string>::fromJsonValue(CallbackIt->value()));
        }
    }
    {
        const auto ProvidersIt = object.find("providers");
        if (ProvidersIt != object.end()) {
            setProviders(JsonValueConverter<std::shared_ptr<AccountInfoOauthConfigProviders>>::fromJsonValue(ProvidersIt->value()));
        }
    }
}

std::string AccountInfoOauthConfig::getCallback() const
{
    return m_Callback;
}

void AccountInfoOauthConfig::setCallback(std::string value)
{
    
    m_Callback = std::move(value);
}
std::shared_ptr<AccountInfoOauthConfigProviders> AccountInfoOauthConfig::getProviders() const
{
    return m_Providers;
}

void AccountInfoOauthConfig::setProviders(std::shared_ptr<AccountInfoOauthConfigProviders> value)
{
    
    m_Providers = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AccountInfoOauthConfig>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AccountInfoOauthConfig>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AccountInfoOauthConfig>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AccountInfoOauthConfig>>>::fromJsonValue(boost::json::parse(json));
}
