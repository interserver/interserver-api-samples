...
SearchAutocompleteResponse::SearchAutocompleteResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SearchAutocompleteResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void SearchAutocompleteResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value SearchAutocompleteResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SearchAutocompleteResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SearchAutocompleteResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SearchAutocompleteResponse::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void SearchAutocompleteResponse::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SearchAutocompleteResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SearchAutocompleteResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SearchAutocompleteResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SearchAutocompleteResponse>>>::fromJsonValue(boost::json::parse(json));
}
