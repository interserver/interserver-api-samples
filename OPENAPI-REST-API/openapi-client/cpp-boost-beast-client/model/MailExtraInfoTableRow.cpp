...
MailExtraInfoTableRow::MailExtraInfoTableRow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailExtraInfoTableRow::toJsonString(bool prettyJson /* = false */) const
{
...
void MailExtraInfoTableRow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailExtraInfoTableRow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailExtraInfoTableRow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailExtraInfoTableRow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailExtraInfoTableRow::toJsonObject_internal() const
{
...
void MailExtraInfoTableRow::fromJsonObject_internal(boost::json::object const& object)
{
    m_DescIsSet = false;
    m_ValueIsSet = false;
    {
...
std::string MailExtraInfoTableRow::getDesc() const
{
    return m_Desc;
}

void MailExtraInfoTableRow::setDesc(std::string value)
{
    
    m_Desc = std::move(value);
    m_DescIsSet = true;
}
std::string MailExtraInfoTableRow::getValue() const
{
    return m_Value;
}

void MailExtraInfoTableRow::setValue(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailExtraInfoTableRow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailExtraInfoTableRow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailExtraInfoTableRow>>>::fromJsonValue(boost::json::parse(json));
}
