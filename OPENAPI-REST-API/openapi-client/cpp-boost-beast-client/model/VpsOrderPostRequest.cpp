...
VpsOrderPostRequest::VpsOrderPostRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsOrderPostRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsOrderPostRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsOrderPostRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsOrderPostRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsOrderPostRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsOrderPostRequest::toJsonObject_internal() const
{
...
void VpsOrderPostRequest::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string VpsOrderPostRequest::getOsDistro() const
{
    return m_OsDistro;
}

void VpsOrderPostRequest::setOsDistro(std::string value)
{
...
std::string VpsOrderPostRequest::getVpsPlatform() const
{
...
std::string VpsOrderPostRequest::getOsVersion() const
{
    return m_OsVersion;
}

void VpsOrderPostRequest::setOsVersion(std::string value)
{
    
    m_OsVersion = std::move(value);
}
std::string VpsOrderPostRequest::getHostname() const
{
    return m_Hostname;
}

void VpsOrderPostRequest::setHostname(std::string value)
{
...
void VpsOrderPostRequest::setCoupon(std::string value)
{
...
void VpsOrderPostRequest::setComment(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsOrderPostRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsOrderPostRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsOrderPostRequest>>>::fromJsonValue(boost::json::parse(json));
}
