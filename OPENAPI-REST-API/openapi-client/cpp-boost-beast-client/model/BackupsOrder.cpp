...
BackupsOrder::BackupsOrder(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BackupsOrder::toJsonString(bool prettyJson /* = false */) const
{
...
void BackupsOrder::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BackupsOrder::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BackupsOrder::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BackupsOrder");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BackupsOrder::toJsonObject_internal() const
{
    boost::json::object object;
        object["packageCosts"] = JsonValueConverter<std::shared_ptr<BackupsOrderPackageCosts>>::toJsonValue(getPackageCosts());
        object["serviceTypes"] = JsonValueConverter<std::shared_ptr<BackupsOrder_serviceTypes>>::toJsonValue(getServiceTypes());
    return object;
}

void BackupsOrder::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto PackageCostsIt = object.find("packageCosts");
        if (PackageCostsIt != object.end()) {
            setPackageCosts(JsonValueConverter<std::shared_ptr<BackupsOrderPackageCosts>>::fromJsonValue(PackageCostsIt->value()));
        }
    }
    {
        const auto ServiceTypesIt = object.find("serviceTypes");
        if (ServiceTypesIt != object.end()) {
            setServiceTypes(JsonValueConverter<std::shared_ptr<BackupsOrder_serviceTypes>>::fromJsonValue(ServiceTypesIt->value()));
        }
    }
}
...
void BackupsOrder::setPackageCosts(std::shared_ptr<BackupsOrderPackageCosts> value)
{
...
void BackupsOrder::setServiceTypes(std::shared_ptr<BackupsOrder_serviceTypes> value)
{
    
    m_ServiceTypes = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BackupsOrder>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BackupsOrder>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BackupsOrder>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BackupsOrder>>>::fromJsonValue(boost::json::parse(json));
}
