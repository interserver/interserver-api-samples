...
DnsListItem::DnsListItem(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DnsListItem::toJsonString(bool prettyJson /* = false */) const
{
...
void DnsListItem::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DnsListItem::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DnsListItem::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DnsListItem");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DnsListItem::toJsonObject_internal() const
{
...
void DnsListItem::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    m_NameIsSet = false;
...
std::string DnsListItem::getName() const
{
    return m_Name;
}

void DnsListItem::setName(std::string value)
{
    
    m_Name = std::move(value);
    m_NameIsSet = true;
}
std::string DnsListItem::getContent() const
{
    return m_Content;
}

void DnsListItem::setContent(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DnsListItem>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DnsListItem>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DnsListItem>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DnsListItem>>>::fromJsonValue(boost::json::parse(json));
}
