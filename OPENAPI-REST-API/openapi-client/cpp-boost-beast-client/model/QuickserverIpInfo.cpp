...
QuickserverIpInfo::QuickserverIpInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverIpInfo::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverIpInfo::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverIpInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverIpInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverIpInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverIpInfo::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<std::shared_ptr<QuickserverIpTableRow>>>::toJsonValue(getRows());
        }
    return object;
}

void QuickserverIpInfo::fromJsonObject_internal(boost::json::object const& object)
{
    m_TitleIsSet = false;
    m_RowsIsSet = false;
    {
    ...
    }
    {
        ...
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<std::shared_ptr<QuickserverIpTableRow>>>::fromJsonValue(RowsIt->value()));
        }
    }
}

std::string QuickserverIpInfo::getTitle() const
{
    return m_Title;
}

void QuickserverIpInfo::setTitle(std::string value)
{
    
    m_Title = std::move(value);
    m_TitleIsSet = true;
}
std::vector<std::shared_ptr<QuickserverIpTableRow>> QuickserverIpInfo::getRows() const
{
    return m_Rows;
}

void QuickserverIpInfo::setRows(std::vector<std::shared_ptr<QuickserverIpTableRow>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverIpInfo>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverIpInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverIpInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverIpInfo>>>::fromJsonValue(boost::json::parse(json));
}
