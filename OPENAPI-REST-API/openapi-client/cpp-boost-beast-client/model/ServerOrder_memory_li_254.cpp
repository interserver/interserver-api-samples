...
ServerOrder_memory_li_254::ServerOrder_memory_li_254(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerOrder_memory_li_254::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerOrder_memory_li_254::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerOrder_memory_li_254::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerOrder_memory_li_254::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerOrder_memory_li_254");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerOrder_memory_li_254::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_65IsSet) {
            object["65"] = JsonValueConverter<std::shared_ptr<ServerOrderMemory>>::toJsonValue(getR65());
        }
    return object;
}

void ServerOrder_memory_li_254::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_65IsSet = false;
    {
        const auto r_65It = object.find("65");
        if (r_65It != object.end()) {
            setR65(JsonValueConverter<std::shared_ptr<ServerOrderMemory>>::fromJsonValue(r_65It->value()));
        }
    }
}

std::shared_ptr<ServerOrderMemory> ServerOrder_memory_li_254::getR65() const
{
    return m_r_65;
}

void ServerOrder_memory_li_254::setR65(std::shared_ptr<ServerOrderMemory> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerOrder_memory_li_254>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_memory_li_254>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerOrder_memory_li_254>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_memory_li_254>>>::fromJsonValue(boost::json::parse(json));
}
