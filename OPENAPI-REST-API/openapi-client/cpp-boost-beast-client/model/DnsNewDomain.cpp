...
DnsNewDomain::DnsNewDomain(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DnsNewDomain::toJsonString(bool prettyJson /* = false */) const
{
...
void DnsNewDomain::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DnsNewDomain::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DnsNewDomain::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DnsNewDomain");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DnsNewDomain::toJsonObject_internal() const
{
...
void DnsNewDomain::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string DnsNewDomain::getDomain() const
{
    return m_Domain;
}

void DnsNewDomain::setDomain(std::string value)
{
    
    m_Domain = std::move(value);
}
std::string DnsNewDomain::getIp() const
{
    return m_Ip;
}

void DnsNewDomain::setIp(std::string value)
{
    
    m_Ip = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DnsNewDomain>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DnsNewDomain>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DnsNewDomain>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DnsNewDomain>>>::fromJsonValue(boost::json::parse(json));
}
