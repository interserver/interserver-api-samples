...
PasswordRequest::PasswordRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PasswordRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void PasswordRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PasswordRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PasswordRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PasswordRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PasswordRequest::toJsonObject_internal() const
{
...
void PasswordRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string PasswordRequest::getPassword() const
{
    return m_Password;
}

void PasswordRequest::setPassword(std::string value)
{
    
    m_Password = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PasswordRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PasswordRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PasswordRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PasswordRequest>>>::fromJsonValue(boost::json::parse(json));
}
