...
BackupIPInfoRow::BackupIPInfoRow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BackupIPInfoRow::toJsonString(bool prettyJson /* = false */) const
{
...
void BackupIPInfoRow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BackupIPInfoRow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BackupIPInfoRow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BackupIPInfoRow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BackupIPInfoRow::toJsonObject_internal() const
{
...
void BackupIPInfoRow::fromJsonObject_internal(boost::json::object const& object)
{
    m_DescIsSet = false;
    m_ValueIsSet = false;
    {
...
std::string BackupIPInfoRow::getDesc() const
{
    return m_Desc;
}

void BackupIPInfoRow::setDesc(std::string value)
{
    
    m_Desc = std::move(value);
    m_DescIsSet = true;
}
std::string BackupIPInfoRow::getValue() const
{
    return m_Value;
}

void BackupIPInfoRow::setValue(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BackupIPInfoRow>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BackupIPInfoRow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BackupIPInfoRow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BackupIPInfoRow>>>::fromJsonValue(boost::json::parse(json));
}
