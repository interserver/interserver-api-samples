...
ServerAssets::ServerAssets(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerAssets::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerAssets::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerAssets::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerAssets::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerAssets");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerAssets::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_HeaderIsSet) {
            object["header"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getHeader());
        }
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<std::vector<std::string>>>::toJsonValue(getRows());
        }
    return object;
}

void ServerAssets::fromJsonObject_internal(boost::json::object const& object)
{
    m_TitleIsSet = false;
    m_SizeIsSet = false;
    m_TypeIsSet = false;
    ...
    {
        const auto HeaderIt = object.find("header");
        if (HeaderIt != object.end()) {
            setHeader(JsonValueConverter<std::vector<std::string>>::fromJsonValue(HeaderIt->value()));
        }
    }
    {
        const auto RowsIt = object.find("rows");
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<std::vector<std::string>>>::fromJsonValue(RowsIt->value()));
        }
    }
}

std::string ServerAssets::getTitle() const
{
    return m_Title;
}

void ServerAssets::setTitle(std::string value)
{
...
std::string ServerAssets::getType() const
{
    return m_Type;
}

void ServerAssets::setType(std::string value)
{
    
    m_Type = std::move(value);
    m_TypeIsSet = true;
}
std::vector<std::string> ServerAssets::getHeader() const
{
    return m_Header;
}

void ServerAssets::setHeader(std::vector<std::string> value)
{
    
    m_Header = std::move(value);
    m_HeaderIsSet = true;
}
std::vector<std::vector<std::string>> ServerAssets::getRows() const
{
    return m_Rows;
}

void ServerAssets::setRows(std::vector<std::vector<std::string>> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerAssets>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerAssets>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerAssets>>>::fromJsonValue(boost::json::parse(json));
}
