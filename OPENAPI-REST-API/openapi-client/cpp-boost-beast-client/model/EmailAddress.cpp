...
EmailAddress::EmailAddress(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EmailAddress::toJsonString(bool prettyJson /* = false */) const
{
...
void EmailAddress::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EmailAddress::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EmailAddress::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EmailAddress");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EmailAddress::toJsonObject_internal() const
{
...
void EmailAddress::fromJsonObject_internal(boost::json::object const& object)
{
    m_EmailIsSet = false;
    {
...
std::string EmailAddress::getEmail() const
{
    return m_Email;
}

void EmailAddress::setEmail(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EmailAddress>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EmailAddress>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EmailAddress>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EmailAddress>>>::fromJsonValue(boost::json::parse(json));
}
