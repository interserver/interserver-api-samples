...
ServerOrder_bandwidth_li::ServerOrder_bandwidth_li(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerOrder_bandwidth_li::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerOrder_bandwidth_li::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerOrder_bandwidth_li::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerOrder_bandwidth_li::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerOrder_bandwidth_li");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerOrder_bandwidth_li::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_15IsSet) {
            object["15"] = JsonValueConverter<std::shared_ptr<ServerOrderBandwidth>>::toJsonValue(getR15());
        }
    return object;
}

void ServerOrder_bandwidth_li::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_15IsSet = false;
    {
        const auto r_15It = object.find("15");
        if (r_15It != object.end()) {
            setR15(JsonValueConverter<std::shared_ptr<ServerOrderBandwidth>>::fromJsonValue(r_15It->value()));
        }
    }
}

std::shared_ptr<ServerOrderBandwidth> ServerOrder_bandwidth_li::getR15() const
{
    return m_r_15;
}

void ServerOrder_bandwidth_li::setR15(std::shared_ptr<ServerOrderBandwidth> value)
{
    
    m_r_15 = std::move(value);
    m_r_15IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerOrder_bandwidth_li>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_bandwidth_li>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerOrder_bandwidth_li>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_bandwidth_li>>>::fromJsonValue(boost::json::parse(json));
}
