...
ServerOrder_ips_li::ServerOrder_ips_li(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerOrder_ips_li::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerOrder_ips_li::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerOrder_ips_li::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerOrder_ips_li::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerOrder_ips_li");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerOrder_ips_li::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_9IsSet) {
            object["9"] = JsonValueConverter<std::shared_ptr<ServerOrderIP>>::toJsonValue(getR9());
        }
    return object;
}

void ServerOrder_ips_li::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_9IsSet = false;
    {
        const auto r_9It = object.find("9");
        if (r_9It != object.end()) {
            setR9(JsonValueConverter<std::shared_ptr<ServerOrderIP>>::fromJsonValue(r_9It->value()));
        }
    }
}

std::shared_ptr<ServerOrderIP> ServerOrder_ips_li::getR9() const
{
    return m_r_9;
}

void ServerOrder_ips_li::setR9(std::shared_ptr<ServerOrderIP> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerOrder_ips_li>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_ips_li>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerOrder_ips_li>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_ips_li>>>::fromJsonValue(boost::json::parse(json));
}
