...
AccountInfoLimits::AccountInfoLimits(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AccountInfoLimits::toJsonString(bool prettyJson /* = false */) const
{
...
void AccountInfoLimits::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AccountInfoLimits::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AccountInfoLimits::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AccountInfoLimits");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AccountInfoLimits::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AccountInfoLimits::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AccountInfoLimits>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AccountInfoLimits>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AccountInfoLimits>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AccountInfoLimits>>>::fromJsonValue(boost::json::parse(json));
}
