...
ServersBuyNowResponse::ServersBuyNowResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServersBuyNowResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void ServersBuyNowResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServersBuyNowResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServersBuyNowResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServersBuyNowResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServersBuyNowResponse::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_Order_detailsIsSet) {
            object["order_details"] = JsonValueConverter<std::shared_ptr<ServersBuyNowResponse_order_details>>::toJsonValue(getOrderDetails());
        }
    return object;
}

void ServersBuyNowResponse::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (Order_detailsIt != object.end()) {
            setOrderDetails(JsonValueConverter<std::shared_ptr<ServersBuyNowResponse_order_details>>::fromJsonValue(Order_detailsIt->value()));
        }
    }
}
...
std::string ServersBuyNowResponse::getText() const
{
    return m_Text;
}

void ServersBuyNowResponse::setText(std::string value)
{
...
void ServersBuyNowResponse::setOrderDetails(std::shared_ptr<ServersBuyNowResponse_order_details> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServersBuyNowResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServersBuyNowResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServersBuyNowResponse>>>::fromJsonValue(boost::json::parse(json));
}
