...
MailAlertRequest::MailAlertRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailAlertRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void MailAlertRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailAlertRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailAlertRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailAlertRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailAlertRequest::toJsonObject_internal() const
{
...
void MailAlertRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_TypeIsSet = false;
    m_ValueIsSet = false;
    m_ToIsSet = false;
...
std::string MailAlertRequest::getType() const
{
    return m_Type;
}

void MailAlertRequest::setType(std::string value)
{
    
    m_Type = std::move(value);
    m_TypeIsSet = true;
}
std::string MailAlertRequest::getValue() const
{
    return m_Value;
}

void MailAlertRequest::setValue(std::string value)
{
    
    m_Value = std::move(value);
    m_ValueIsSet = true;
}
std::string MailAlertRequest::getTo() const
{
    return m_To;
}

void MailAlertRequest::setTo(std::string value)
{
    
    m_To = std::move(value);
    m_ToIsSet = true;
}
std::string MailAlertRequest::getEnabled() const
{
    return m_Enabled;
}

void MailAlertRequest::setEnabled(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailAlertRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailAlertRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailAlertRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailAlertRequest>>>::fromJsonValue(boost::json::parse(json));
}
