...
VpsPleskLicense::VpsPleskLicense(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsPleskLicense::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsPleskLicense::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsPleskLicense::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsPleskLicense::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsPleskLicense");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsPleskLicense::toJsonObject_internal() const
{
...
void VpsPleskLicense::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    m_NameIsSet = false;
...
std::string VpsPleskLicense::getName() const
{
    return m_Name;
}

void VpsPleskLicense::setName(std::string value)
{
    
    m_Name = std::move(value);
    m_NameIsSet = true;
}
std::string VpsPleskLicense::getSubName() const
{
    return m_Sub_name;
}

void VpsPleskLicense::setSubName(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsPleskLicense>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsPleskLicense>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsPleskLicense>>>::fromJsonValue(boost::json::parse(json));
}
