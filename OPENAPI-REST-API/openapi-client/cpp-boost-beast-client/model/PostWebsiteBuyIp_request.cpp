...
PostWebsiteBuyIp_request::PostWebsiteBuyIp_request(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PostWebsiteBuyIp_request::toJsonString(bool prettyJson /* = false */) const
{
...
void PostWebsiteBuyIp_request::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PostWebsiteBuyIp_request::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PostWebsiteBuyIp_request::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PostWebsiteBuyIp_request");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PostWebsiteBuyIp_request::toJsonObject_internal() const
{
...
void PostWebsiteBuyIp_request::fromJsonObject_internal(boost::json::object const& object)
{
    m_IpsIsSet = false;
    {
...
std::map<std::string, std::string> PostWebsiteBuyIp_request::getIps() const
{
    return m_Ips;
}

void PostWebsiteBuyIp_request::setIps(std::map<std::string, std::string> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PostWebsiteBuyIp_request>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PostWebsiteBuyIp_request>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PostWebsiteBuyIp_request>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PostWebsiteBuyIp_request>>>::fromJsonValue(boost::json::parse(json));
}
