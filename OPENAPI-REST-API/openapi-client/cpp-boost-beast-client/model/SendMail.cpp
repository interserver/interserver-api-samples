...
SendMail::SendMail(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SendMail::toJsonString(bool prettyJson /* = false */) const
{
...
void SendMail::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value SendMail::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SendMail::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SendMail");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SendMail::toJsonObject_internal() const
{
...
void SendMail::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string SendMail::getTo() const
{
    return m_To;
}

void SendMail::setTo(std::string value)
{
    
    m_To = std::move(value);
}
std::string SendMail::getFrom() const
{
    return m_From;
}

void SendMail::setFrom(std::string value)
{
    
    m_From = std::move(value);
}
std::string SendMail::getSubject() const
{
    return m_Subject;
}

void SendMail::setSubject(std::string value)
{
    
    m_Subject = std::move(value);
}
std::string SendMail::getBody() const
{
    return m_Body;
}

void SendMail::setBody(std::string value)
{
    
    m_Body = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SendMail>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SendMail>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SendMail>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SendMail>>>::fromJsonValue(boost::json::parse(json));
}
