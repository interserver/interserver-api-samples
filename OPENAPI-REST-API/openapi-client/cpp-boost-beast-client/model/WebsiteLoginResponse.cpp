...
WebsiteLoginResponse::WebsiteLoginResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsiteLoginResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsiteLoginResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsiteLoginResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsiteLoginResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsiteLoginResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsiteLoginResponse::toJsonObject_internal() const
{
...
void WebsiteLoginResponse::fromJsonObject_internal(boost::json::object const& object)
{
    m_TypeIsSet = false;
...
std::string WebsiteLoginResponse::getType() const
{
    return m_Type;
}

void WebsiteLoginResponse::setType(std::string value)
{
    
    m_Type = std::move(value);
    m_TypeIsSet = true;
}
std::string WebsiteLoginResponse::getLocation() const
{
    return m_Location;
}

void WebsiteLoginResponse::setLocation(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WebsiteLoginResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsiteLoginResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsiteLoginResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsiteLoginResponse>>>::fromJsonValue(boost::json::parse(json));
}
