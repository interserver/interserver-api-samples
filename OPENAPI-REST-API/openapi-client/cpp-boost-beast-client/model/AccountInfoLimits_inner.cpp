...
AccountInfoLimits_inner::AccountInfoLimits_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AccountInfoLimits_inner::toJsonString(bool prettyJson /* = false */) const
{
...
void AccountInfoLimits_inner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AccountInfoLimits_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AccountInfoLimits_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AccountInfoLimits_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AccountInfoLimits_inner::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_StartIsSet) {
            object["start"] = JsonValueConverter<std::string>::toJsonValue(getStart());
        }
        if (m_EndIsSet) {
            object["end"] = JsonValueConverter<std::string>::toJsonValue(getEnd());
        }
    return object;
}

void AccountInfoLimits_inner::fromJsonObject_internal(boost::json::object const& object)
{
    m_StartIsSet = false;
    m_EndIsSet = false;
    {
        ...
        if (StartIt != object.end()) {
            setStart(JsonValueConverter<std::string>::fromJsonValue(StartIt->value()));
        }
    }
    {
        const auto EndIt = object.find("end");
        if (EndIt != object.end()) {
            setEnd(JsonValueConverter<std::string>::fromJsonValue(EndIt->value()));
        }
    }
}

std::string AccountInfoLimits_inner::getStart() const
{
    return m_Start;
}

void AccountInfoLimits_inner::setStart(std::string value)
{
    
    m_Start = std::move(value);
    m_StartIsSet = true;
}
std::string AccountInfoLimits_inner::getEnd() const
{
    return m_End;
}

void AccountInfoLimits_inner::setEnd(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AccountInfoLimits_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AccountInfoLimits_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AccountInfoLimits_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AccountInfoLimits_inner>>>::fromJsonValue(boost::json::parse(json));
}
