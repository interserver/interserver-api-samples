...
TicketPostDetails::TicketPostDetails(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TicketPostDetails::toJsonString(bool prettyJson /* = false */) const
{
...
void TicketPostDetails::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TicketPostDetails::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TicketPostDetails::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TicketPostDetails");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TicketPostDetails::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void TicketPostDetails::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TicketPostDetails>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TicketPostDetails>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TicketPostDetails>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TicketPostDetails>>>::fromJsonValue(boost::json::parse(json));
}
