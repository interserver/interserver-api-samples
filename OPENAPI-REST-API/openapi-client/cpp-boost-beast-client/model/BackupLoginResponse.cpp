...
BackupLoginResponse::BackupLoginResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BackupLoginResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void BackupLoginResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BackupLoginResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BackupLoginResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BackupLoginResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BackupLoginResponse::toJsonObject_internal() const
{
...
void BackupLoginResponse::fromJsonObject_internal(boost::json::object const& object)
{
...
bool BackupLoginResponse::isSuccess() const
{
    return m_Success;
}

void BackupLoginResponse::setSuccess(bool value)
{
    
    m_Success = std::move(value);
    m_SuccessIsSet = true;
}
std::string BackupLoginResponse::getText() const
{
    return m_Text;
}

void BackupLoginResponse::setText(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BackupLoginResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BackupLoginResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BackupLoginResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BackupLoginResponse>>>::fromJsonValue(boost::json::parse(json));
}
