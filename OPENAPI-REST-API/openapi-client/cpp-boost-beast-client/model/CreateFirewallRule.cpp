...
CreateFirewallRule::CreateFirewallRule(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CreateFirewallRule::toJsonString(bool prettyJson /* = false */) const
{
...
void CreateFirewallRule::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CreateFirewallRule::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreateFirewallRule::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreateFirewallRule");
    }
...
void CreateFirewallRule::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    }
    {
        ...
        if (Destination_portIt != object.end()) {
            setDestinationPort(JsonValueConverter<int32_t>::fromJsonValue(Destination_portIt->value()));
        }
    }
    {
...
std::string CreateFirewallRule::getSourceIp() const
{
    return m_Source_ip;
}

void CreateFirewallRule::setSourceIp(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreateFirewallRule>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreateFirewallRule>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreateFirewallRule>>>::fromJsonValue(boost::json::parse(json));
}
