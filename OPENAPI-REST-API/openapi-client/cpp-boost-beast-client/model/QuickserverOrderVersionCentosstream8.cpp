...
QuickserverOrderVersionCentosstream8::QuickserverOrderVersionCentosstream8(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverOrderVersionCentosstream8::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverOrderVersionCentosstream8::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverOrderVersionCentosstream8::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverOrderVersionCentosstream8::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverOrderVersionCentosstream8");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverOrderVersionCentosstream8::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Centosstream_8IsSet) {
            object["centosstream-8"] = JsonValueConverter<std::string>::toJsonValue(getCentosstream8());
        }
    return object;
}

void QuickserverOrderVersionCentosstream8::fromJsonObject_internal(boost::json::object const& object)
{
    m_Centosstream_8IsSet = false;
    {
        const auto Centosstream_8It = object.find("centosstream-8");
        if (Centosstream_8It != object.end()) {
            setCentosstream8(JsonValueConverter<std::string>::fromJsonValue(Centosstream_8It->value()));
        }
    }
}

std::string QuickserverOrderVersionCentosstream8::getCentosstream8() const
{
    return m_Centosstream_8;
}

void QuickserverOrderVersionCentosstream8::setCentosstream8(std::string value)
{
    
    m_Centosstream_8 = std::move(value);
    m_Centosstream_8IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverOrderVersionCentosstream8>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrderVersionCentosstream8>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverOrderVersionCentosstream8>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrderVersionCentosstream8>>>::fromJsonValue(boost::json::parse(json));
}
