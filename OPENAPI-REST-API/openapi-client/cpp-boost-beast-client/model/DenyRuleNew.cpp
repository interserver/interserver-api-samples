...
DenyRuleNew::DenyRuleNew(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DenyRuleNew::toJsonString(bool prettyJson /* = false */) const
{
...
void DenyRuleNew::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DenyRuleNew::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DenyRuleNew::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DenyRuleNew");
    }
...
std::string DenyRuleNew::getData() const
{
    return m_Data;
}

void DenyRuleNew::setData(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DenyRuleNew>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DenyRuleNew>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DenyRuleNew>>>::fromJsonValue(boost::json::parse(json));
}
