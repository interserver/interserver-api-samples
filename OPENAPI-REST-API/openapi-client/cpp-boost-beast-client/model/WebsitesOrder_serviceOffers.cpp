...
WebsitesOrder_serviceOffers::WebsitesOrder_serviceOffers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsitesOrder_serviceOffers::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsitesOrder_serviceOffers::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsitesOrder_serviceOffers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsitesOrder_serviceOffers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsitesOrder_serviceOffers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsitesOrder_serviceOffers::toJsonObject_internal() const
{
    boost::json::object object;
        object["1026"] = JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderServiceOffer>>>::toJsonValue(getR1026());
    return object;
}

void WebsitesOrder_serviceOffers::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto r_1026It = object.find("1026");
        if (r_1026It != object.end()) {
            setR1026(JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderServiceOffer>>>::fromJsonValue(r_1026It->value()));
        }
    }
}

std::vector<std::shared_ptr<WebsitesOrderServiceOffer>> WebsitesOrder_serviceOffers::getR1026() const
{
    return m_r_1026;
}

void WebsitesOrder_serviceOffers::setR1026(std::vector<std::shared_ptr<WebsitesOrderServiceOffer>> value)
{
    
    m_r_1026 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WebsitesOrder_serviceOffers>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrder_serviceOffers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsitesOrder_serviceOffers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrder_serviceOffers>>>::fromJsonValue(boost::json::parse(json));
}
