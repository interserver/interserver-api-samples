...
BackupsOrder_serviceTypes::BackupsOrder_serviceTypes(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BackupsOrder_serviceTypes::toJsonString(bool prettyJson /* = false */) const
{
...
void BackupsOrder_serviceTypes::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BackupsOrder_serviceTypes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BackupsOrder_serviceTypes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BackupsOrder_serviceTypes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BackupsOrder_serviceTypes::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_11006IsSet) {
            object["11006"] = JsonValueConverter<std::shared_ptr<BackupsOrderServiceTypes>>::toJsonValue(getR11006());
        }
    return object;
}

void BackupsOrder_serviceTypes::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_11006IsSet = false;
    {
        const auto r_11006It = object.find("11006");
        if (r_11006It != object.end()) {
            setR11006(JsonValueConverter<std::shared_ptr<BackupsOrderServiceTypes>>::fromJsonValue(r_11006It->value()));
        }
    }
}

std::shared_ptr<BackupsOrderServiceTypes> BackupsOrder_serviceTypes::getR11006() const
{
    return m_r_11006;
}

void BackupsOrder_serviceTypes::setR11006(std::shared_ptr<BackupsOrderServiceTypes> value)
{
    
    m_r_11006 = std::move(value);
    m_r_11006IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BackupsOrder_serviceTypes>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BackupsOrder_serviceTypes>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BackupsOrder_serviceTypes>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BackupsOrder_serviceTypes>>>::fromJsonValue(boost::json::parse(json));
}
