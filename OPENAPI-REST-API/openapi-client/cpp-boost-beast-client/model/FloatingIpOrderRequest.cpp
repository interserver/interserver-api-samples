...
FloatingIpOrderRequest::FloatingIpOrderRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string FloatingIpOrderRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void FloatingIpOrderRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value FloatingIpOrderRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void FloatingIpOrderRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for FloatingIpOrderRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object FloatingIpOrderRequest::toJsonObject_internal() const
{
...
void FloatingIpOrderRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_CouponIsSet = false;
...
std::string FloatingIpOrderRequest::getCoupon() const
{
    return m_Coupon;
}

void FloatingIpOrderRequest::setCoupon(std::string value)
{
    
    m_Coupon = std::move(value);
    m_CouponIsSet = true;
}
std::string FloatingIpOrderRequest::getComment() const
{
    return m_Comment;
}

void FloatingIpOrderRequest::setComment(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<FloatingIpOrderRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<FloatingIpOrderRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<FloatingIpOrderRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<FloatingIpOrderRequest>>>::fromJsonValue(boost::json::parse(json));
}
