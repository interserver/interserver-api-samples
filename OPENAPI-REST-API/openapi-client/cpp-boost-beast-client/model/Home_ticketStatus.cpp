...
Home_ticketStatus::Home_ticketStatus(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Home_ticketStatus::toJsonString(bool prettyJson /* = false */) const
{
...
void Home_ticketStatus::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Home_ticketStatus::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Home_ticketStatus::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Home_ticketStatus");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Home_ticketStatus::toJsonObject_internal() const
{
...
void Home_ticketStatus::fromJsonObject_internal(boost::json::object const& object)
{
    m_OpenIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Home_ticketStatus>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Home_ticketStatus>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Home_ticketStatus>>>::fromJsonValue(boost::json::parse(json));
}
