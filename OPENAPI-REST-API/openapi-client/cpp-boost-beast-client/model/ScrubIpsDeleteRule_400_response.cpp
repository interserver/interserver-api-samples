...
ScrubIpsDeleteRule_400_response::ScrubIpsDeleteRule_400_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ScrubIpsDeleteRule_400_response::toJsonString(bool prettyJson /* = false */) const
{
...
void ScrubIpsDeleteRule_400_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ScrubIpsDeleteRule_400_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ScrubIpsDeleteRule_400_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ScrubIpsDeleteRule_400_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ScrubIpsDeleteRule_400_response::toJsonObject_internal() const
{
...
void ScrubIpsDeleteRule_400_response::fromJsonObject_internal(boost::json::object const& object)
{
...
bool ScrubIpsDeleteRule_400_response::isSuccess() const
{
    return m_Success;
}

void ScrubIpsDeleteRule_400_response::setSuccess(bool value)
{
    
    m_Success = std::move(value);
    m_SuccessIsSet = true;
}
std::string ScrubIpsDeleteRule_400_response::getText() const
{
    return m_Text;
}

void ScrubIpsDeleteRule_400_response::setText(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ScrubIpsDeleteRule_400_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ScrubIpsDeleteRule_400_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ScrubIpsDeleteRule_400_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ScrubIpsDeleteRule_400_response>>>::fromJsonValue(boost::json::parse(json));
}
