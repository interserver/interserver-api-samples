...
VpsOrder_templates::VpsOrder_templates(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsOrder_templates::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsOrder_templates::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsOrder_templates::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsOrder_templates::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsOrder_templates");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsOrder_templates::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_HypervIsSet) {
            object["hyperv"] = JsonValueConverter<std::shared_ptr<VpsOrder_templates_hyperv>>::toJsonValue(getHyperv());
        }
    return object;
}

void VpsOrder_templates::fromJsonObject_internal(boost::json::object const& object)
{
    m_HypervIsSet = false;
    {
        const auto HypervIt = object.find("hyperv");
        if (HypervIt != object.end()) {
            setHyperv(JsonValueConverter<std::shared_ptr<VpsOrder_templates_hyperv>>::fromJsonValue(HypervIt->value()));
        }
    }
}

std::shared_ptr<VpsOrder_templates_hyperv> VpsOrder_templates::getHyperv() const
{
    return m_Hyperv;
}

void VpsOrder_templates::setHyperv(std::shared_ptr<VpsOrder_templates_hyperv> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsOrder_templates>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_templates>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsOrder_templates>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_templates>>>::fromJsonValue(boost::json::parse(json));
}
