...
ServerBulkIpmiPowerResponse_results_inner::ServerBulkIpmiPowerResponse_results_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerBulkIpmiPowerResponse_results_inner::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerBulkIpmiPowerResponse_results_inner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerBulkIpmiPowerResponse_results_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerBulkIpmiPowerResponse_results_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerBulkIpmiPowerResponse_results_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerBulkIpmiPowerResponse_results_inner::toJsonObject_internal() const
{
...
void ServerBulkIpmiPowerResponse_results_inner::fromJsonObject_internal(boost::json::object const& object)
{
    m_IdIsSet = false;
    m_AssetIsSet = false;
    m_TextIsSet = false;
...
std::string ServerBulkIpmiPowerResponse_results_inner::getText() const
{
    return m_Text;
}

void ServerBulkIpmiPowerResponse_results_inner::setText(std::string value)
{
    
    m_Text = std::move(value);
    m_TextIsSet = true;
}
std::string ServerBulkIpmiPowerResponse_results_inner::getError() const
{
    return m_Error;
}

void ServerBulkIpmiPowerResponse_results_inner::setError(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse_results_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse_results_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse_results_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse_results_inner>>>::fromJsonValue(boost::json::parse(json));
}
