...
QuickserverIpTableRow::QuickserverIpTableRow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverIpTableRow::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverIpTableRow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverIpTableRow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverIpTableRow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverIpTableRow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverIpTableRow::toJsonObject_internal() const
{
...
void QuickserverIpTableRow::fromJsonObject_internal(boost::json::object const& object)
{
    m_DescIsSet = false;
    m_ValueIsSet = false;
    {
...
std::string QuickserverIpTableRow::getDesc() const
{
    return m_Desc;
}

void QuickserverIpTableRow::setDesc(std::string value)
{
    
    m_Desc = std::move(value);
    m_DescIsSet = true;
}
std::string QuickserverIpTableRow::getValue() const
{
    return m_Value;
}

void QuickserverIpTableRow::setValue(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverIpTableRow>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverIpTableRow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverIpTableRow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverIpTableRow>>>::fromJsonValue(boost::json::parse(json));
}
