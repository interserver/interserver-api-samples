...
Home_details::Home_details(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Home_details::toJsonString(bool prettyJson /* = false */) const
{
...
void Home_details::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Home_details::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Home_details::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Home_details");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Home_details::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_ModulesIsSet) {
            object["modules"] = JsonValueConverter<std::shared_ptr<Home_details_modules>>::toJsonValue(getModules());
        }
    return object;
}

void Home_details::fromJsonObject_internal(boost::json::object const& object)
{
    m_ModulesIsSet = false;
    {
        const auto ModulesIt = object.find("modules");
        if (ModulesIt != object.end()) {
            setModules(JsonValueConverter<std::shared_ptr<Home_details_modules>>::fromJsonValue(ModulesIt->value()));
        }
    }
}
...
void Home_details::setModules(std::shared_ptr<Home_details_modules> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Home_details>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Home_details>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Home_details>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Home_details>>>::fromJsonValue(boost::json::parse(json));
}
