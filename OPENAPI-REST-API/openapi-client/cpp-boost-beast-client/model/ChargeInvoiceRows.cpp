...
ChargeInvoiceRows::ChargeInvoiceRows(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ChargeInvoiceRows::toJsonString(bool prettyJson /* = false */) const
{
...
void ChargeInvoiceRows::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ChargeInvoiceRows::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ChargeInvoiceRows::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ChargeInvoiceRows");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ChargeInvoiceRows::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_InvoicesIsSet) {
            object["invoices"] = JsonValueConverter<std::map<std::string, std::shared_ptr<ChargeInvoiceRows_invoices_value>>>::toJsonValue(getInvoices());
        }
    return object;
}

void ChargeInvoiceRows::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    {
        const auto InvoicesIt = object.find("invoices");
        if (InvoicesIt != object.end()) {
            setInvoices(JsonValueConverter<std::map<std::string, std::shared_ptr<ChargeInvoiceRows_invoices_value>>>::fromJsonValue(InvoicesIt->value()));
        }
    }
}

bool ChargeInvoiceRows::isSuccess() const
{
    return m_Success;
}

void ChargeInvoiceRows::setSuccess(bool value)
{
    
    m_Success = std::move(value);
    m_SuccessIsSet = true;
}
std::map<std::string, std::shared_ptr<ChargeInvoiceRows_invoices_value>> ChargeInvoiceRows::getInvoices() const
{
    return m_Invoices;
}

void ChargeInvoiceRows::setInvoices(std::map<std::string, std::shared_ptr<ChargeInvoiceRows_invoices_value>> value)
{
    
    m_Invoices = std::move(value);
    m_InvoicesIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ChargeInvoiceRows>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ChargeInvoiceRows>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ChargeInvoiceRows>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ChargeInvoiceRows>>>::fromJsonValue(boost::json::parse(json));
}
