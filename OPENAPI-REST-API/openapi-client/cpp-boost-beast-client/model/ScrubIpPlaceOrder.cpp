...
ScrubIpPlaceOrder::ScrubIpPlaceOrder(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ScrubIpPlaceOrder::toJsonString(bool prettyJson /* = false */) const
{
...
void ScrubIpPlaceOrder::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ScrubIpPlaceOrder::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ScrubIpPlaceOrder::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ScrubIpPlaceOrder");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ScrubIpPlaceOrder::toJsonObject_internal() const
{
...
void ScrubIpPlaceOrder::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
int32_t ScrubIpPlaceOrder::getServiceType() const
{
    return m_Service_type;
}

void ScrubIpPlaceOrder::setServiceType(int32_t value)
{
    
    m_Service_type = std::move(value);
}
std::string ScrubIpPlaceOrder::getIp() const
{
    return m_Ip;
}

void ScrubIpPlaceOrder::setIp(std::string value)
{
    
    m_Ip = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ScrubIpPlaceOrder>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ScrubIpPlaceOrder>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ScrubIpPlaceOrder>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ScrubIpPlaceOrder>>>::fromJsonValue(boost::json::parse(json));
}
