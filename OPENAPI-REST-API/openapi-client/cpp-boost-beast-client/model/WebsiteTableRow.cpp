...
WebsiteTableRow::WebsiteTableRow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsiteTableRow::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsiteTableRow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsiteTableRow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsiteTableRow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsiteTableRow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsiteTableRow::toJsonObject_internal() const
{
...
void WebsiteTableRow::fromJsonObject_internal(boost::json::object const& object)
{
    m_DescIsSet = false;
    m_ValueIsSet = false;
    {
...
std::string WebsiteTableRow::getDesc() const
{
    return m_Desc;
}

void WebsiteTableRow::setDesc(std::string value)
{
    
    m_Desc = std::move(value);
    m_DescIsSet = true;
}
std::string WebsiteTableRow::getValue() const
{
    return m_Value;
}

void WebsiteTableRow::setValue(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WebsiteTableRow>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsiteTableRow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsiteTableRow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsiteTableRow>>>::fromJsonValue(boost::json::parse(json));
}
