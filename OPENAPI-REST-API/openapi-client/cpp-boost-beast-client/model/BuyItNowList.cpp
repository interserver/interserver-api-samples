...
BuyItNowList::BuyItNowList(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BuyItNowList::toJsonString(bool prettyJson /* = false */) const
{
...
void BuyItNowList::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BuyItNowList::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BuyItNowList::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BuyItNowList");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BuyItNowList::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BuyItNowList::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BuyItNowList>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BuyItNowList>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BuyItNowList>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BuyItNowList>>>::fromJsonValue(boost::json::parse(json));
}
