...
VpsOrder_locationStock::VpsOrder_locationStock(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsOrder_locationStock::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsOrder_locationStock::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsOrder_locationStock::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsOrder_locationStock::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsOrder_locationStock");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsOrder_locationStock::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_1IsSet) {
            object["1"] = JsonValueConverter<std::shared_ptr<VpsOrder_locationStock_1>>::toJsonValue(getR1());
        }
    return object;
}

void VpsOrder_locationStock::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_1IsSet = false;
    {
        const auto r_1It = object.find("1");
        if (r_1It != object.end()) {
            setR1(JsonValueConverter<std::shared_ptr<VpsOrder_locationStock_1>>::fromJsonValue(r_1It->value()));
        }
    }
}
...
void VpsOrder_locationStock::setR1(std::shared_ptr<VpsOrder_locationStock_1> value)
{
    
    m_r_1 = std::move(value);
    m_r_1IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsOrder_locationStock>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_locationStock>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsOrder_locationStock>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_locationStock>>>::fromJsonValue(boost::json::parse(json));
}
