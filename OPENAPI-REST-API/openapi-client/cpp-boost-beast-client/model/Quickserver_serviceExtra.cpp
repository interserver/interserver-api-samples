...
Quickserver_serviceExtra::Quickserver_serviceExtra(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Quickserver_serviceExtra::toJsonString(bool prettyJson /* = false */) const
{
...
void Quickserver_serviceExtra::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Quickserver_serviceExtra::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Quickserver_serviceExtra::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Quickserver_serviceExtra");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Quickserver_serviceExtra::toJsonObject_internal() const
{
...
void Quickserver_serviceExtra::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string Quickserver_serviceExtra::getPlatform() const
{
    return m_Platform;
}

void Quickserver_serviceExtra::setPlatform(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Quickserver_serviceExtra>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Quickserver_serviceExtra>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Quickserver_serviceExtra>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Quickserver_serviceExtra>>>::fromJsonValue(boost::json::parse(json));
}
