...
CaptchaResponse::CaptchaResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CaptchaResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void CaptchaResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CaptchaResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CaptchaResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CaptchaResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CaptchaResponse::toJsonObject_internal() const
{
...
void CaptchaResponse::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string CaptchaResponse::getCaptcha() const
{
    return m_Captcha;
}

void CaptchaResponse::setCaptcha(std::string value)
{
    
    m_Captcha = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CaptchaResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CaptchaResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CaptchaResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CaptchaResponse>>>::fromJsonValue(boost::json::parse(json));
}
