...
VpsOrder_osNames::VpsOrder_osNames(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsOrder_osNames::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsOrder_osNames::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsOrder_osNames::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsOrder_osNames::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsOrder_osNames");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsOrder_osNames::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_OpensuseIsSet) {
            object["opensuse"] = JsonValueConverter<std::string>::toJsonValue(getOpensuse());
        }
        if (m_UbuntuIsSet) {
            object["ubuntu"] = JsonValueConverter<std::string>::toJsonValue(getUbuntu());
        }
    return object;
}

void VpsOrder_osNames::fromJsonObject_internal(boost::json::object const& object)
{
    m_OpensuseIsSet = false;
    m_UbuntuIsSet = false;
    {
        const auto OpensuseIt = object.find("opensuse");
        if (OpensuseIt != object.end()) {
            setOpensuse(JsonValueConverter<std::string>::fromJsonValue(OpensuseIt->value()));
        }
    }
    {
        const auto UbuntuIt = object.find("ubuntu");
        if (UbuntuIt != object.end()) {
            setUbuntu(JsonValueConverter<std::string>::fromJsonValue(UbuntuIt->value()));
        }
    }
}

std::string VpsOrder_osNames::getOpensuse() const
{
    return m_Opensuse;
}

void VpsOrder_osNames::setOpensuse(std::string value)
{
    
    m_Opensuse = std::move(value);
    m_OpensuseIsSet = true;
}
std::string VpsOrder_osNames::getUbuntu() const
{
    return m_Ubuntu;
}

void VpsOrder_osNames::setUbuntu(std::string value)
{
    
    m_Ubuntu = std::move(value);
    m_UbuntuIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsOrder_osNames>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_osNames>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsOrder_osNames>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_osNames>>>::fromJsonValue(boost::json::parse(json));
}
