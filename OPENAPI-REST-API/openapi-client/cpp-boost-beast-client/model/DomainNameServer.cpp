...
DomainNameServer::DomainNameServer(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DomainNameServer::toJsonString(bool prettyJson /* = false */) const
{
...
void DomainNameServer::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DomainNameServer::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DomainNameServer::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DomainNameServer");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DomainNameServer::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_SortorderIsSet) {
            object["sortorder"] = JsonValueConverter<std::string>::toJsonValue(getSortorder());
        }
        if (m_NameIsSet) {
...
void DomainNameServer::fromJsonObject_internal(boost::json::object const& object)
{
    m_SortorderIsSet = false;
    m_NameIsSet = false;
    m_IpaddressIsSet = false;
    {
        const auto SortorderIt = object.find("sortorder");
        if (SortorderIt != object.end()) {
            setSortorder(JsonValueConverter<std::string>::fromJsonValue(SortorderIt->value()));
        }
    }
    {
...
std::string DomainNameServer::getSortorder() const
{
    return m_Sortorder;
}

void DomainNameServer::setSortorder(std::string value)
{
    
    m_Sortorder = std::move(value);
    m_SortorderIsSet = true;
}
std::string DomainNameServer::getName() const
{
    return m_Name;
}

void DomainNameServer::setName(std::string value)
{
    
    m_Name = std::move(value);
    m_NameIsSet = true;
}
std::string DomainNameServer::getIpaddress() const
{
    return m_Ipaddress;
}

void DomainNameServer::setIpaddress(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DomainNameServer>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DomainNameServer>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DomainNameServer>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DomainNameServer>>>::fromJsonValue(boost::json::parse(json));
}
