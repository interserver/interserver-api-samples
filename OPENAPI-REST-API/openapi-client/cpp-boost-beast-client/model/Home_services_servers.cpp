...
Home_services_servers::Home_services_servers(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Home_services_servers::toJsonString(bool prettyJson /* = false */) const
{
...
void Home_services_servers::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Home_services_servers::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Home_services_servers::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Home_services_servers");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Home_services_servers::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_LinksIsSet) {
            object["links"] = JsonValueConverter<std::shared_ptr<HomeServicesServersLinks>>::toJsonValue(getLinks());
        }
        if (m_CountIsSet) {
...
void Home_services_servers::fromJsonObject_internal(boost::json::object const& object)
{
    m_LinksIsSet = false;
    m_CountIsSet = false;
    {
        ...
        if (LinksIt != object.end()) {
            setLinks(JsonValueConverter<std::shared_ptr<HomeServicesServersLinks>>::fromJsonValue(LinksIt->value()));
        }
    }
    {
...
std::shared_ptr<HomeServicesServersLinks> Home_services_servers::getLinks() const
{
    return m_Links;
}

void Home_services_servers::setLinks(std::shared_ptr<HomeServicesServersLinks> value)
{
    
    m_Links = std::move(value);
    m_LinksIsSet = true;
}
int32_t Home_services_servers::getCount() const
{
    return m_Count;
}

void Home_services_servers::setCount(int32_t value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Home_services_servers>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Home_services_servers>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Home_services_servers>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Home_services_servers>>>::fromJsonValue(boost::json::parse(json));
}
