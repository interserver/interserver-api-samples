...
QuickserverOrder_server_details::QuickserverOrder_server_details(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverOrder_server_details::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverOrder_server_details::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverOrder_server_details::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverOrder_server_details::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverOrder_server_details");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverOrder_server_details::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_381IsSet) {
            object["381"] = JsonValueConverter<std::shared_ptr<QuickserverOrderServerDetails381>>::toJsonValue(getR381());
        }
    return object;
}

void QuickserverOrder_server_details::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_381IsSet = false;
    {
        const auto r_381It = object.find("381");
        if (r_381It != object.end()) {
            setR381(JsonValueConverter<std::shared_ptr<QuickserverOrderServerDetails381>>::fromJsonValue(r_381It->value()));
        }
    }
}
...
void QuickserverOrder_server_details::setR381(std::shared_ptr<QuickserverOrderServerDetails381> value)
{
    
    m_r_381 = std::move(value);
    m_r_381IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverOrder_server_details>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrder_server_details>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverOrder_server_details>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrder_server_details>>>::fromJsonValue(boost::json::parse(json));
}
