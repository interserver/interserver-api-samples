...
VpsTrafficHistorySectionDataResponse::VpsTrafficHistorySectionDataResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsTrafficHistorySectionDataResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsTrafficHistorySectionDataResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsTrafficHistorySectionDataResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsTrafficHistorySectionDataResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsTrafficHistorySectionDataResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsTrafficHistorySectionDataResponse::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void VpsTrafficHistorySectionDataResponse::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsTrafficHistorySectionDataResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsTrafficHistorySectionDataResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsTrafficHistorySectionDataResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsTrafficHistorySectionDataResponse>>>::fromJsonValue(boost::json::parse(json));
}
