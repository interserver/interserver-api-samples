...
VpsIPInfo::VpsIPInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsIPInfo::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsIPInfo::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsIPInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsIPInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsIPInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsIPInfo::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<std::shared_ptr<VpsIPInfoRow>>>::toJsonValue(getRows());
        }
    return object;
}

void VpsIPInfo::fromJsonObject_internal(boost::json::object const& object)
{
    m_TitleIsSet = false;
    m_RowsIsSet = false;
    {
    ...
    }
    {
        ...
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<std::shared_ptr<VpsIPInfoRow>>>::fromJsonValue(RowsIt->value()));
        }
    }
}

std::string VpsIPInfo::getTitle() const
{
    return m_Title;
}

void VpsIPInfo::setTitle(std::string value)
{
    
    m_Title = std::move(value);
    m_TitleIsSet = true;
}
std::vector<std::shared_ptr<VpsIPInfoRow>> VpsIPInfo::getRows() const
{
    return m_Rows;
}

void VpsIPInfo::setRows(std::vector<std::shared_ptr<VpsIPInfoRow>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsIPInfo>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsIPInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsIPInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsIPInfo>>>::fromJsonValue(boost::json::parse(json));
}
