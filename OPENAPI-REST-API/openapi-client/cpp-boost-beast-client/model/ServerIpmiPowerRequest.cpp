...
ServerIpmiPowerRequest::ServerIpmiPowerRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerIpmiPowerRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerIpmiPowerRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerIpmiPowerRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerIpmiPowerRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerIpmiPowerRequest");
    }
...
void ServerIpmiPowerRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_AssetIsSet = false;
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerIpmiPowerRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerIpmiPowerRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerIpmiPowerRequest>>>::fromJsonValue(boost::json::parse(json));
}
