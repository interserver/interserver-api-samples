...
ServerClientLink::ServerClientLink(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerClientLink::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerClientLink::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerClientLink::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerClientLink::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerClientLink");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerClientLink::toJsonObject_internal() const
{
...
void ServerClientLink::fromJsonObject_internal(boost::json::object const& object)
{
    m_IconIsSet = false;
...
std::string ServerClientLink::getLabel() const
{
    return m_Label;
}

void ServerClientLink::setLabel(std::string value)
{
    
    m_Label = std::move(value);
}
std::string ServerClientLink::getLink() const
{
    return m_Link;
}

void ServerClientLink::setLink(std::string value)
{
    
    m_Link = std::move(value);
}
std::string ServerClientLink::getIcon() const
{
    return m_Icon;
}

void ServerClientLink::setIcon(std::string value)
{
    
    m_Icon = std::move(value);
    m_IconIsSet = true;
}
std::string ServerClientLink::getIconText() const
{
    return m_Icon_text;
}

void ServerClientLink::setIconText(std::string value)
{
    
    m_Icon_text = std::move(value);
    m_Icon_textIsSet = true;
}
std::string ServerClientLink::getHelpText() const
{
    return m_Help_text;
}

void ServerClientLink::setHelpText(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerClientLink>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerClientLink>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerClientLink>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerClientLink>>>::fromJsonValue(boost::json::parse(json));
}
