...
VPSTrafficDataDataSectionResponse_inner::VPSTrafficDataDataSectionResponse_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VPSTrafficDataDataSectionResponse_inner::toJsonString(bool prettyJson /* = false */) const
{
...
void VPSTrafficDataDataSectionResponse_inner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VPSTrafficDataDataSectionResponse_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VPSTrafficDataDataSectionResponse_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VPSTrafficDataDataSectionResponse_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VPSTrafficDataDataSectionResponse_inner::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void VPSTrafficDataDataSectionResponse_inner::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse_inner>>>::fromJsonValue(boost::json::parse(json));
}
