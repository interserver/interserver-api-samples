...
QuickserverOrder_templates::QuickserverOrder_templates(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverOrder_templates::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverOrder_templates::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverOrder_templates::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverOrder_templates::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverOrder_templates");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverOrder_templates::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_UbuntuIsSet) {
            object["Ubuntu"] = JsonValueConverter<std::shared_ptr<QuickserverOrderTemplatesUbuntu64>>::toJsonValue(getUbuntu());
        }
    return object;
}

void QuickserverOrder_templates::fromJsonObject_internal(boost::json::object const& object)
{
    m_UbuntuIsSet = false;
    {
        const auto UbuntuIt = object.find("Ubuntu");
        if (UbuntuIt != object.end()) {
            setUbuntu(JsonValueConverter<std::shared_ptr<QuickserverOrderTemplatesUbuntu64>>::fromJsonValue(UbuntuIt->value()));
        }
    }
}

std::shared_ptr<QuickserverOrderTemplatesUbuntu64> QuickserverOrder_templates::getUbuntu() const
{
    return m_Ubuntu;
}

void QuickserverOrder_templates::setUbuntu(std::shared_ptr<QuickserverOrderTemplatesUbuntu64> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverOrder_templates>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrder_templates>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverOrder_templates>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrder_templates>>>::fromJsonValue(boost::json::parse(json));
}
