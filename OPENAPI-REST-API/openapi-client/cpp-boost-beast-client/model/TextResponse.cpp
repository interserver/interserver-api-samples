...
TextResponse::TextResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TextResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void TextResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TextResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TextResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TextResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TextResponse::toJsonObject_internal() const
{
...
void TextResponse::fromJsonObject_internal(boost::json::object const& object)
{
    m_TextIsSet = false;
...
std::string TextResponse::getText() const
{
    return m_Text;
}

void TextResponse::setText(std::string value)
{
    
    m_Text = std::move(value);
    m_TextIsSet = true;
}
std::string TextResponse::getMessage() const
{
    return m_Message;
}

void TextResponse::setMessage(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TextResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TextResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TextResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TextResponse>>>::fromJsonValue(boost::json::parse(json));
}
