...
WebsiteTable::WebsiteTable(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsiteTable::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsiteTable::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsiteTable::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsiteTable::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsiteTable");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsiteTable::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<std::shared_ptr<WebsiteTableRow>>>::toJsonValue(getRows());
        }
    return object;
}

void WebsiteTable::fromJsonObject_internal(boost::json::object const& object)
{
    m_TitleIsSet = false;
    m_RowsIsSet = false;
    {
    ...
    }
    {
        ...
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<std::shared_ptr<WebsiteTableRow>>>::fromJsonValue(RowsIt->value()));
        }
    }
}

std::string WebsiteTable::getTitle() const
{
    return m_Title;
}

void WebsiteTable::setTitle(std::string value)
{
    
    m_Title = std::move(value);
    m_TitleIsSet = true;
}
std::vector<std::shared_ptr<WebsiteTableRow>> WebsiteTable::getRows() const
{
    return m_Rows;
}

void WebsiteTable::setRows(std::vector<std::shared_ptr<WebsiteTableRow>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WebsiteTable>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsiteTable>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsiteTable>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsiteTable>>>::fromJsonValue(boost::json::parse(json));
}
