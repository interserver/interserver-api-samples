...
VpsClientLink::VpsClientLink(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsClientLink::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsClientLink::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsClientLink::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsClientLink::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsClientLink");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsClientLink::toJsonObject_internal() const
{
...
void VpsClientLink::fromJsonObject_internal(boost::json::object const& object)
{
    m_LabelIsSet = false;
    m_LinkIsSet = false;
    m_IconIsSet = false;
...
std::string VpsClientLink::getLabel() const
{
    return m_Label;
}

void VpsClientLink::setLabel(std::string value)
{
    
    m_Label = std::move(value);
    m_LabelIsSet = true;
}
std::string VpsClientLink::getLink() const
{
    return m_Link;
}

void VpsClientLink::setLink(std::string value)
{
    
    m_Link = std::move(value);
    m_LinkIsSet = true;
}
std::string VpsClientLink::getIcon() const
{
    return m_Icon;
}

void VpsClientLink::setIcon(std::string value)
{
    
    m_Icon = std::move(value);
    m_IconIsSet = true;
}
std::string VpsClientLink::getIconText() const
{
    return m_Icon_text;
}

void VpsClientLink::setIconText(std::string value)
{
    
    m_Icon_text = std::move(value);
    m_Icon_textIsSet = true;
}
std::string VpsClientLink::getHelpText() const
{
    return m_Help_text;
}

void VpsClientLink::setHelpText(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsClientLink>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsClientLink>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsClientLink>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsClientLink>>>::fromJsonValue(boost::json::parse(json));
}
