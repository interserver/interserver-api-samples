...
InitiatePayment_200_response::InitiatePayment_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string InitiatePayment_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void InitiatePayment_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value InitiatePayment_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void InitiatePayment_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for InitiatePayment_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object InitiatePayment_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_RedirectIsSet) {
            object["redirect"] = JsonValueConverter<std::string>::toJsonValue(getRedirect());
        }
        if (m_ActionIsSet) {
            object["action"] = JsonValueConverter<std::string>::toJsonValue(getAction());
        }
        if (m_MethodIsSet) {
            object["method"] = JsonValueConverter<std::string>::toJsonValue(getMethod());
        }
        if (m_ItemsIsSet) {
            object["items"] = JsonValueConverter<boost::json::value>::toJsonValue(getItems());
        }
        if (m_TextIsSet) {
...
void InitiatePayment_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    m_TypeIsSet = false;
    ...
    {
        const auto RedirectIt = object.find("redirect");
        if (RedirectIt != object.end()) {
            setRedirect(JsonValueConverter<std::string>::fromJsonValue(RedirectIt->value()));
        }
    }
    {
    ...
    }
    {
        ...
        if (MethodIt != object.end()) {
            setMethod(JsonValueConverter<std::string>::fromJsonValue(MethodIt->value()));
        }
    }
    {
        const auto ItemsIt = object.find("items");
        if (ItemsIt != object.end()) {
            setItems(JsonValueConverter<boost::json::value>::fromJsonValue(ItemsIt->value()));
        }
    }
    {
...
std::string InitiatePayment_200_response::getType() const
{
    return m_Type;
}
...
std::string InitiatePayment_200_response::getRedirect() const
{
    return m_Redirect;
}

void InitiatePayment_200_response::setRedirect(std::string value)
{
    
    m_Redirect = std::move(value);
    m_RedirectIsSet = true;
}
std::string InitiatePayment_200_response::getAction() const
{
    return m_Action;
}

void InitiatePayment_200_response::setAction(std::string value)
{
    
    m_Action = std::move(value);
    m_ActionIsSet = true;
}
std::string InitiatePayment_200_response::getMethod() const
{
    return m_Method;
}

void InitiatePayment_200_response::setMethod(std::string value)
{
    
    m_Method = std::move(value);
    m_MethodIsSet = true;
}
boost::json::value InitiatePayment_200_response::getItems() const
{
    return m_Items;
}

void InitiatePayment_200_response::setItems(boost::json::value value)
{
    
    m_Items = std::move(value);
    m_ItemsIsSet = true;
}
std::string InitiatePayment_200_response::getText() const
{
    return m_Text;
}

void InitiatePayment_200_response::setText(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<InitiatePayment_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<InitiatePayment_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<InitiatePayment_200_response>>>::fromJsonValue(boost::json::parse(json));
}
