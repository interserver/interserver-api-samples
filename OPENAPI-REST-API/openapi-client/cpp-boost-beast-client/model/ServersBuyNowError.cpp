...
ServersBuyNowError::ServersBuyNowError(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServersBuyNowError::toJsonString(bool prettyJson /* = false */) const
{
...
void ServersBuyNowError::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServersBuyNowError::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServersBuyNowError::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServersBuyNowError");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServersBuyNowError::toJsonObject_internal() const
{
...
void ServersBuyNowError::fromJsonObject_internal(boost::json::object const& object)
{
...
bool ServersBuyNowError::isSuccess() const
{
    return m_Success;
}

void ServersBuyNowError::setSuccess(bool value)
{
    
    m_Success = std::move(value);
    m_SuccessIsSet = true;
}
std::string ServersBuyNowError::getText() const
{
    return m_Text;
}

void ServersBuyNowError::setText(std::string value)
{
    
    m_Text = std::move(value);
    m_TextIsSet = true;
}
std::vector<std::string> ServersBuyNowError::getErrors() const
{
    return m_Errors;
}

void ServersBuyNowError::setErrors(std::vector<std::string> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServersBuyNowError>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServersBuyNowError>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServersBuyNowError>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServersBuyNowError>>>::fromJsonValue(boost::json::parse(json));
}
