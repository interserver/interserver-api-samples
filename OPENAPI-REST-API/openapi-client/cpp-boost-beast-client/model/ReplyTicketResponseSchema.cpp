...
ReplyTicketResponseSchema::ReplyTicketResponseSchema(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ReplyTicketResponseSchema::toJsonString(bool prettyJson /* = false */) const
{
...
void ReplyTicketResponseSchema::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ReplyTicketResponseSchema::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ReplyTicketResponseSchema::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ReplyTicketResponseSchema");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ReplyTicketResponseSchema::toJsonObject_internal() const
{
...
void ReplyTicketResponseSchema::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ReplyTicketResponseSchema>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ReplyTicketResponseSchema>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ReplyTicketResponseSchema>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ReplyTicketResponseSchema>>>::fromJsonValue(boost::json::parse(json));
}
