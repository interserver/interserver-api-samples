...
ReplyTicketRequest::ReplyTicketRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ReplyTicketRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void ReplyTicketRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ReplyTicketRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ReplyTicketRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ReplyTicketRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ReplyTicketRequest::toJsonObject_internal() const
{
...
void ReplyTicketRequest::fromJsonObject_internal(boost::json::object const& object)
{
...
void ReplyTicketRequest::setContent(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ReplyTicketRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ReplyTicketRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ReplyTicketRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ReplyTicketRequest>>>::fromJsonValue(boost::json::parse(json));
}
