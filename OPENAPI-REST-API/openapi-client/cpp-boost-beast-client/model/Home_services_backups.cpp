...
Home_services_backups::Home_services_backups(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Home_services_backups::toJsonString(bool prettyJson /* = false */) const
{
...
void Home_services_backups::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Home_services_backups::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Home_services_backups::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Home_services_backups");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Home_services_backups::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_LinksIsSet) {
            object["links"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getLinks());
        }
        if (m_CountIsSet) {
...
void Home_services_backups::fromJsonObject_internal(boost::json::object const& object)
{
    m_LinksIsSet = false;
    m_CountIsSet = false;
    {
        ...
        if (LinksIt != object.end()) {
            setLinks(JsonValueConverter<std::vector<std::string>>::fromJsonValue(LinksIt->value()));
        }
    }
    {
...
std::vector<std::string> Home_services_backups::getLinks() const
{
    return m_Links;
}

void Home_services_backups::setLinks(std::vector<std::string> value)
{
    
    m_Links = std::move(value);
    m_LinksIsSet = true;
}
int32_t Home_services_backups::getCount() const
{
    return m_Count;
}

void Home_services_backups::setCount(int32_t value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Home_services_backups>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Home_services_backups>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Home_services_backups>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Home_services_backups>>>::fromJsonValue(boost::json::parse(json));
}
