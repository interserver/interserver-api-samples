...
HostnameObject::HostnameObject(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string HostnameObject::toJsonString(bool prettyJson /* = false */) const
{
...
void HostnameObject::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value HostnameObject::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void HostnameObject::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for HostnameObject");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object HostnameObject::toJsonObject_internal() const
{
...
void HostnameObject::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string HostnameObject::getHostname() const
{
    return m_Hostname;
}

void HostnameObject::setHostname(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<HostnameObject>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<HostnameObject>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<HostnameObject>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<HostnameObject>>>::fromJsonValue(boost::json::parse(json));
}
