...
LoginErrorResponse::LoginErrorResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LoginErrorResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void LoginErrorResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LoginErrorResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LoginErrorResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LoginErrorResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LoginErrorResponse::toJsonObject_internal() const
{
...
void LoginErrorResponse::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string LoginErrorResponse::getMessage() const
{
    return m_Message;
}

void LoginErrorResponse::setMessage(std::string value)
{
    
    m_Message = std::move(value);
    m_MessageIsSet = true;
}
std::string LoginErrorResponse::getField() const
{
    return m_Field;
}

void LoginErrorResponse::setField(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LoginErrorResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LoginErrorResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LoginErrorResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LoginErrorResponse>>>::fromJsonValue(boost::json::parse(json));
}
