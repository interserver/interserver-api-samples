...
DomainNameserverPostRequest::DomainNameserverPostRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DomainNameserverPostRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void DomainNameserverPostRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DomainNameserverPostRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DomainNameserverPostRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DomainNameserverPostRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DomainNameserverPostRequest::toJsonObject_internal() const
{
...
void DomainNameserverPostRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string DomainNameserverPostRequest::getName() const
{
    return m_Name;
}

void DomainNameserverPostRequest::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string DomainNameserverPostRequest::getIpAddress() const
{
    return m_IpAddress;
}

void DomainNameserverPostRequest::setIpAddress(std::string value)
{
    
    m_IpAddress = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DomainNameserverPostRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DomainNameserverPostRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DomainNameserverPostRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DomainNameserverPostRequest>>>::fromJsonValue(boost::json::parse(json));
}
