...
SuccessTextResponse::SuccessTextResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SuccessTextResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void SuccessTextResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value SuccessTextResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SuccessTextResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SuccessTextResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SuccessTextResponse::toJsonObject_internal() const
{
...
void SuccessTextResponse::fromJsonObject_internal(boost::json::object const& object)
{
    m_TextIsSet = false;
    m_ActionIsSet = false;
    {
...
bool SuccessTextResponse::isSuccess() const
{
    return m_Success;
}

void SuccessTextResponse::setSuccess(bool value)
{
    
    m_Success = std::move(value);
}
std::string SuccessTextResponse::getText() const
{
    return m_Text;
}

void SuccessTextResponse::setText(std::string value)
{
    
    m_Text = std::move(value);
    m_TextIsSet = true;
}
std::string SuccessTextResponse::getAction() const
{
    return m_Action;
}

void SuccessTextResponse::setAction(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SuccessTextResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SuccessTextResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SuccessTextResponse>>>::fromJsonValue(boost::json::parse(json));
}
