...
HomeServicesServersLinks::HomeServicesServersLinks(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string HomeServicesServersLinks::toJsonString(bool prettyJson /* = false */) const
{
...
void HomeServicesServersLinks::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value HomeServicesServersLinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void HomeServicesServersLinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for HomeServicesServersLinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object HomeServicesServersLinks::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_16058IsSet) {
            object["16058"] = JsonValueConverter<std::string>::toJsonValue(getR16058());
        }
    return object;
}

void HomeServicesServersLinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_16058IsSet = false;
    {
        const auto r_16058It = object.find("16058");
        if (r_16058It != object.end()) {
            setR16058(JsonValueConverter<std::string>::fromJsonValue(r_16058It->value()));
        }
    }
}

std::string HomeServicesServersLinks::getR16058() const
{
    return m_r_16058;
}

void HomeServicesServersLinks::setR16058(std::string value)
{
    
    m_r_16058 = std::move(value);
    m_r_16058IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<HomeServicesServersLinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<HomeServicesServersLinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<HomeServicesServersLinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<HomeServicesServersLinks>>>::fromJsonValue(boost::json::parse(json));
}
