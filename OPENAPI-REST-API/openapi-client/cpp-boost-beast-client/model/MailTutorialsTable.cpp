...
MailTutorialsTable::MailTutorialsTable(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailTutorialsTable::toJsonString(bool prettyJson /* = false */) const
{
...
void MailTutorialsTable::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailTutorialsTable::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailTutorialsTable::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailTutorialsTable");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailTutorialsTable::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<std::shared_ptr<MailTutorialsTableRow>>>::toJsonValue(getRows());
        }
    return object;
}

void MailTutorialsTable::fromJsonObject_internal(boost::json::object const& object)
{
    m_TitleIsSet = false;
    m_RowsIsSet = false;
    {
    ...
    }
    {
        ...
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<std::shared_ptr<MailTutorialsTableRow>>>::fromJsonValue(RowsIt->value()));
        }
    }
}

std::string MailTutorialsTable::getTitle() const
{
    return m_Title;
}

void MailTutorialsTable::setTitle(std::string value)
{
...
void MailTutorialsTable::setRows(std::vector<std::shared_ptr<MailTutorialsTableRow>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailTutorialsTable>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailTutorialsTable>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailTutorialsTable>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailTutorialsTable>>>::fromJsonValue(boost::json::parse(json));
}
