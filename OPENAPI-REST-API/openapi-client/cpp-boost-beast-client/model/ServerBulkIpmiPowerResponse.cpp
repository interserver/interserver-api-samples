...
ServerBulkIpmiPowerResponse::ServerBulkIpmiPowerResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerBulkIpmiPowerResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerBulkIpmiPowerResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerBulkIpmiPowerResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerBulkIpmiPowerResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerBulkIpmiPowerResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerBulkIpmiPowerResponse::toJsonObject_internal() const
{
    boost::json::object object;
        object["results"] = JsonValueConverter<std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse_results_inner>>>::toJsonValue(getResults());
    return object;
}

void ServerBulkIpmiPowerResponse::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto ResultsIt = object.find("results");
        if (ResultsIt != object.end()) {
            setResults(JsonValueConverter<std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse_results_inner>>>::fromJsonValue(ResultsIt->value()));
        }
    }
}
...
void ServerBulkIpmiPowerResponse::setResults(std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse_results_inner>> value)
{
    
    m_Results = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerBulkIpmiPowerResponse>>>::fromJsonValue(boost::json::parse(json));
}
