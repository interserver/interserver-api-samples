...
VpsTemplatesList::VpsTemplatesList(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsTemplatesList::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsTemplatesList::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsTemplatesList::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsTemplatesList::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsTemplatesList");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsTemplatesList::toJsonObject_internal() const
{
    boost::json::object object;
        object["templates"] = JsonValueConverter<std::vector<std::shared_ptr<VpsTemplateRow>>>::toJsonValue(getTemplates());
    return object;
}

void VpsTemplatesList::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto TemplatesIt = object.find("templates");
        if (TemplatesIt != object.end()) {
            setTemplates(JsonValueConverter<std::vector<std::shared_ptr<VpsTemplateRow>>>::fromJsonValue(TemplatesIt->value()));
        }
    }
}
...
void VpsTemplatesList::setTemplates(std::vector<std::shared_ptr<VpsTemplateRow>> value)
{
    
    m_Templates = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsTemplatesList>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsTemplatesList>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsTemplatesList>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsTemplatesList>>>::fromJsonValue(boost::json::parse(json));
}
