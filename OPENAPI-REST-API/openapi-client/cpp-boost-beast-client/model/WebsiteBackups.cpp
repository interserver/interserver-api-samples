...
WebsiteBackups::WebsiteBackups(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsiteBackups::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsiteBackups::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsiteBackups::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsiteBackups::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsiteBackups");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsiteBackups::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void WebsiteBackups::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WebsiteBackups>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsiteBackups>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsiteBackups>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsiteBackups>>>::fromJsonValue(boost::json::parse(json));
}
