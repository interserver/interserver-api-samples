...
BillingInvoiceList::BillingInvoiceList(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingInvoiceList::toJsonString(bool prettyJson /* = false */) const
{
...
void BillingInvoiceList::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BillingInvoiceList::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingInvoiceList::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingInvoiceList");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingInvoiceList::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<boost::json::value>>::toJsonValue(getRows());
        }
        if (m_SummaryIsSet) {
            object["summary"] = JsonValueConverter<boost::json::value>::toJsonValue(getSummary());
        }
    return object;
}

void BillingInvoiceList::fromJsonObject_internal(boost::json::object const& object)
{
    m_RowsIsSet = false;
    m_SummaryIsSet = false;
    {
        ...
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<boost::json::value>>::fromJsonValue(RowsIt->value()));
        }
    }
    {
        const auto SummaryIt = object.find("summary");
        if (SummaryIt != object.end()) {
            setSummary(JsonValueConverter<boost::json::value>::fromJsonValue(SummaryIt->value()));
        }
    }
}

std::vector<boost::json::value> BillingInvoiceList::getRows() const
{
    return m_Rows;
}

void BillingInvoiceList::setRows(std::vector<boost::json::value> value)
{
    
    m_Rows = std::move(value);
    m_RowsIsSet = true;
}
boost::json::value BillingInvoiceList::getSummary() const
{
    return m_Summary;
}

void BillingInvoiceList::setSummary(boost::json::value value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BillingInvoiceList>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceList>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingInvoiceList>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceList>>>::fromJsonValue(boost::json::parse(json));
}
