...
MailDelistRequest::MailDelistRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailDelistRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void MailDelistRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailDelistRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailDelistRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailDelistRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailDelistRequest::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_UnblockIsSet) {
            object["unblock"] = JsonValueConverter<std::string>::toJsonValue(getUnblock());
        }
    return object;
}

void MailDelistRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_UnblockIsSet = false;
    {
        const auto UnblockIt = object.find("unblock");
        if (UnblockIt != object.end()) {
            setUnblock(JsonValueConverter<std::string>::fromJsonValue(UnblockIt->value()));
        }
    }
}

std::string MailDelistRequest::getUnblock() const
{
    return m_Unblock;
}

void MailDelistRequest::setUnblock(std::string value)
{
    
    m_Unblock = std::move(value);
    m_UnblockIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailDelistRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailDelistRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailDelistRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailDelistRequest>>>::fromJsonValue(boost::json::parse(json));
}
