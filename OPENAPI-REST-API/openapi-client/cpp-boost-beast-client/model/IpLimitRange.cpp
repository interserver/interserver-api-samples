...
IpLimitRange::IpLimitRange(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string IpLimitRange::toJsonString(bool prettyJson /* = false */) const
{
...
void IpLimitRange::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value IpLimitRange::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void IpLimitRange::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for IpLimitRange");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object IpLimitRange::toJsonObject_internal() const
{
...
void IpLimitRange::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string IpLimitRange::getStart() const
{
    return m_Start;
}

void IpLimitRange::setStart(std::string value)
{
    
    m_Start = std::move(value);
}
std::string IpLimitRange::getEnd() const
{
    return m_End;
}

void IpLimitRange::setEnd(std::string value)
{
    
    m_End = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<IpLimitRange>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<IpLimitRange>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<IpLimitRange>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<IpLimitRange>>>::fromJsonValue(boost::json::parse(json));
}
