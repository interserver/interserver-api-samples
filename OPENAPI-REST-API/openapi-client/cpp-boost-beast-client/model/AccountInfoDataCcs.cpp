...
AccountInfoDataCcs::AccountInfoDataCcs(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AccountInfoDataCcs::toJsonString(bool prettyJson /* = false */) const
{
...
void AccountInfoDataCcs::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AccountInfoDataCcs::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AccountInfoDataCcs::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AccountInfoDataCcs");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AccountInfoDataCcs::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AccountInfoDataCcs::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AccountInfoDataCcs>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AccountInfoDataCcs>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AccountInfoDataCcs>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AccountInfoDataCcs>>>::fromJsonValue(boost::json::parse(json));
}
