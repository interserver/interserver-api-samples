...
CreateGeoFirewallRule::CreateGeoFirewallRule(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CreateGeoFirewallRule::toJsonString(bool prettyJson /* = false */) const
{
...
void CreateGeoFirewallRule::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CreateGeoFirewallRule::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreateGeoFirewallRule::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreateGeoFirewallRule");
    }
...
boost::json::object CreateGeoFirewallRule::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_Country_codeIsSet) {
            object["country_code"] = JsonValueConverter<int32_t>::toJsonValue(getCountryCode());
        }
        if (m_AsnIsSet) {
...
void CreateGeoFirewallRule::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    {
        const auto Country_codeIt = object.find("country_code");
        if (Country_codeIt != object.end()) {
            setCountryCode(JsonValueConverter<int32_t>::fromJsonValue(Country_codeIt->value()));
        }
    }
    {
        const auto AsnIt = object.find("asn");
        if (AsnIt != object.end()) {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreateGeoFirewallRule>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreateGeoFirewallRule>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreateGeoFirewallRule>>>::fromJsonValue(boost::json::parse(json));
}
