...
VpsOrder_templates_hyperv::VpsOrder_templates_hyperv(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsOrder_templates_hyperv::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsOrder_templates_hyperv::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsOrder_templates_hyperv::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsOrder_templates_hyperv::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsOrder_templates_hyperv");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsOrder_templates_hyperv::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_WindowsIsSet) {
            object["windows"] = JsonValueConverter<std::shared_ptr<VpsOrder_templates_hyperv_windows>>::toJsonValue(getWindows());
        }
    return object;
}

void VpsOrder_templates_hyperv::fromJsonObject_internal(boost::json::object const& object)
{
    m_WindowsIsSet = false;
    {
        const auto WindowsIt = object.find("windows");
        if (WindowsIt != object.end()) {
            setWindows(JsonValueConverter<std::shared_ptr<VpsOrder_templates_hyperv_windows>>::fromJsonValue(WindowsIt->value()));
        }
    }
}

std::shared_ptr<VpsOrder_templates_hyperv_windows> VpsOrder_templates_hyperv::getWindows() const
{
    return m_Windows;
}

void VpsOrder_templates_hyperv::setWindows(std::shared_ptr<VpsOrder_templates_hyperv_windows> value)
{
    
    m_Windows = std::move(value);
    m_WindowsIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsOrder_templates_hyperv>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_templates_hyperv>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsOrder_templates_hyperv>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_templates_hyperv>>>::fromJsonValue(boost::json::parse(json));
}
