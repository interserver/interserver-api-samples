...
QuickserverOrder_distro_sel::QuickserverOrder_distro_sel(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverOrder_distro_sel::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverOrder_distro_sel::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverOrder_distro_sel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverOrder_distro_sel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverOrder_distro_sel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverOrder_distro_sel::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_UbuntuIsSet) {
            object["Ubuntu"] = JsonValueConverter<std::shared_ptr<QuickserverOrderDistroSelUbuntu>>::toJsonValue(getUbuntu());
        }
    return object;
}

void QuickserverOrder_distro_sel::fromJsonObject_internal(boost::json::object const& object)
{
    m_UbuntuIsSet = false;
    {
        const auto UbuntuIt = object.find("Ubuntu");
        if (UbuntuIt != object.end()) {
            setUbuntu(JsonValueConverter<std::shared_ptr<QuickserverOrderDistroSelUbuntu>>::fromJsonValue(UbuntuIt->value()));
        }
    }
}

std::shared_ptr<QuickserverOrderDistroSelUbuntu> QuickserverOrder_distro_sel::getUbuntu() const
{
    return m_Ubuntu;
}

void QuickserverOrder_distro_sel::setUbuntu(std::shared_ptr<QuickserverOrderDistroSelUbuntu> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverOrder_distro_sel>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrder_distro_sel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverOrder_distro_sel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrder_distro_sel>>>::fromJsonValue(boost::json::parse(json));
}
