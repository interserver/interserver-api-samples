...
QuickserverAddons::QuickserverAddons(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverAddons::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverAddons::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverAddons::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverAddons::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverAddons");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverAddons::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<std::shared_ptr<QuickserverAddonsRow>>>::toJsonValue(getRows());
        }
    return object;
}

void QuickserverAddons::fromJsonObject_internal(boost::json::object const& object)
{
    m_TitleIsSet = false;
    m_RowsIsSet = false;
    {
    ...
    }
    {
        ...
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<std::shared_ptr<QuickserverAddonsRow>>>::fromJsonValue(RowsIt->value()));
        }
    }
}

std::string QuickserverAddons::getTitle() const
{
    return m_Title;
}

void QuickserverAddons::setTitle(std::string value)
{
    
    m_Title = std::move(value);
    m_TitleIsSet = true;
}
std::vector<std::shared_ptr<QuickserverAddonsRow>> QuickserverAddons::getRows() const
{
    return m_Rows;
}

void QuickserverAddons::setRows(std::vector<std::shared_ptr<QuickserverAddonsRow>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverAddons>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverAddons>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverAddons>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverAddons>>>::fromJsonValue(boost::json::parse(json));
}
