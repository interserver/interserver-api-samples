...
BackupExtraInfoTables::BackupExtraInfoTables(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BackupExtraInfoTables::toJsonString(bool prettyJson /* = false */) const
{
...
void BackupExtraInfoTables::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BackupExtraInfoTables::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BackupExtraInfoTables::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BackupExtraInfoTables");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BackupExtraInfoTables::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Ip_infoIsSet) {
            object["ip_info"] = JsonValueConverter<std::shared_ptr<BackupIPInfo>>::toJsonValue(getIpInfo());
        }
    return object;
}

void BackupExtraInfoTables::fromJsonObject_internal(boost::json::object const& object)
{
    m_Ip_infoIsSet = false;
    {
        const auto Ip_infoIt = object.find("ip_info");
        if (Ip_infoIt != object.end()) {
            setIpInfo(JsonValueConverter<std::shared_ptr<BackupIPInfo>>::fromJsonValue(Ip_infoIt->value()));
        }
    }
}

std::shared_ptr<BackupIPInfo> BackupExtraInfoTables::getIpInfo() const
{
    return m_Ip_info;
}

void BackupExtraInfoTables::setIpInfo(std::shared_ptr<BackupIPInfo> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BackupExtraInfoTables>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BackupExtraInfoTables>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BackupExtraInfoTables>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BackupExtraInfoTables>>>::fromJsonValue(boost::json::parse(json));
}
