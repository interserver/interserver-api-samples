...
BillingInvoiceDetail::BillingInvoiceDetail(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingInvoiceDetail::toJsonString(bool prettyJson /* = false */) const
{
...
void BillingInvoiceDetail::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BillingInvoiceDetail::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingInvoiceDetail::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingInvoiceDetail");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingInvoiceDetail::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void BillingInvoiceDetail::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BillingInvoiceDetail>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceDetail>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingInvoiceDetail>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingInvoiceDetail>>>::fromJsonValue(boost::json::parse(json));
}
