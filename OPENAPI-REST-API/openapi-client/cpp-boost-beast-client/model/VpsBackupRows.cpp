...
VpsBackupRows::VpsBackupRows(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsBackupRows::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsBackupRows::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsBackupRows::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsBackupRows::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsBackupRows");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsBackupRows::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void VpsBackupRows::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsBackupRows>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsBackupRows>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsBackupRows>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsBackupRows>>>::fromJsonValue(boost::json::parse(json));
}
