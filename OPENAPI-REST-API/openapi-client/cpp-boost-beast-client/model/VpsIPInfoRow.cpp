...
VpsIPInfoRow::VpsIPInfoRow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsIPInfoRow::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsIPInfoRow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsIPInfoRow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsIPInfoRow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsIPInfoRow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsIPInfoRow::toJsonObject_internal() const
{
...
void VpsIPInfoRow::fromJsonObject_internal(boost::json::object const& object)
{
    m_DescIsSet = false;
    m_ValueIsSet = false;
    {
...
std::string VpsIPInfoRow::getDesc() const
{
    return m_Desc;
}

void VpsIPInfoRow::setDesc(std::string value)
{
    
    m_Desc = std::move(value);
    m_DescIsSet = true;
}
std::string VpsIPInfoRow::getValue() const
{
    return m_Value;
}

void VpsIPInfoRow::setValue(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsIPInfoRow>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsIPInfoRow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsIPInfoRow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsIPInfoRow>>>::fromJsonValue(boost::json::parse(json));
}
