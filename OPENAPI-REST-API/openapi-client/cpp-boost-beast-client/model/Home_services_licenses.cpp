...
Home_services_licenses::Home_services_licenses(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Home_services_licenses::toJsonString(bool prettyJson /* = false */) const
{
...
void Home_services_licenses::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Home_services_licenses::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Home_services_licenses::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Home_services_licenses");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Home_services_licenses::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_LinksIsSet) {
            object["links"] = JsonValueConverter<std::shared_ptr<HomeServicesLicensesLinks>>::toJsonValue(getLinks());
        }
        if (m_CountIsSet) {
...
void Home_services_licenses::fromJsonObject_internal(boost::json::object const& object)
{
    m_LinksIsSet = false;
    m_CountIsSet = false;
    {
        ...
        if (LinksIt != object.end()) {
            setLinks(JsonValueConverter<std::shared_ptr<HomeServicesLicensesLinks>>::fromJsonValue(LinksIt->value()));
        }
    }
    {
...
std::shared_ptr<HomeServicesLicensesLinks> Home_services_licenses::getLinks() const
{
    return m_Links;
}

void Home_services_licenses::setLinks(std::shared_ptr<HomeServicesLicensesLinks> value)
{
    
    m_Links = std::move(value);
    m_LinksIsSet = true;
}
int32_t Home_services_licenses::getCount() const
{
    return m_Count;
}

void Home_services_licenses::setCount(int32_t value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Home_services_licenses>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Home_services_licenses>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Home_services_licenses>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Home_services_licenses>>>::fromJsonValue(boost::json::parse(json));
}
