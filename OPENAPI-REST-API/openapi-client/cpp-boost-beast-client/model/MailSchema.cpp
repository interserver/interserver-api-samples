...
MailSchema::MailSchema(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailSchema::toJsonString(bool prettyJson /* = false */) const
{
...
void MailSchema::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailSchema::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailSchema::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailSchema");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailSchema::toJsonObject_internal() const
{
    boost::json::object object;
        object["serviceInfo"] = JsonValueConverter<std::shared_ptr<MailServiceInfo>>::toJsonValue(getServiceInfo());
        object["client_links"] = JsonValueConverter<std::vector<std::shared_ptr<MailClientLink>>>::toJsonValue(getClientLinks());
        object["billingDetails"] = JsonValueConverter<std::shared_ptr<MailBillingDetails>>::toJsonValue(getBillingDetails());
...
void MailSchema::fromJsonObject_internal(boost::json::object const& object)
{
    m_ServiceExtraIsSet = false;
    {
        const auto ServiceInfoIt = object.find("serviceInfo");
        if (ServiceInfoIt != object.end()) {
            setServiceInfo(JsonValueConverter<std::shared_ptr<MailServiceInfo>>::fromJsonValue(ServiceInfoIt->value()));
        }
    }
    {
        const auto Client_linksIt = object.find("client_links");
        if (Client_linksIt != object.end()) {
            setClientLinks(JsonValueConverter<std::vector<std::shared_ptr<MailClientLink>>>::fromJsonValue(Client_linksIt->value()));
        }
    }
    {
        const auto BillingDetailsIt = object.find("billingDetails");
        if (BillingDetailsIt != object.end()) {
            setBillingDetails(JsonValueConverter<std::shared_ptr<MailBillingDetails>>::fromJsonValue(BillingDetailsIt->value()));
        }
    }
    {
    ...
    }
    {
        ...
        if (ServiceTypeIt != object.end()) {
            setServiceType(JsonValueConverter<std::shared_ptr<MailServiceType>>::fromJsonValue(ServiceTypeIt->value()));
        }
    }
    {
...
void MailSchema::setServiceInfo(std::shared_ptr<MailServiceInfo> value)
{
...
void MailSchema::setClientLinks(std::vector<std::shared_ptr<MailClientLink>> value)
{
...
void MailSchema::setBillingDetails(std::shared_ptr<MailBillingDetails> value)
{
    
    m_BillingDetails = std::move(value);
}
std::string MailSchema::getCustCurrency() const
{
    return m_CustCurrency;
}

void MailSchema::setCustCurrency(std::string value)
{
    
    m_CustCurrency = std::move(value);
}
std::string MailSchema::getCustCurrencySymbol() const
{
    return m_CustCurrencySymbol;
}

void MailSchema::setCustCurrencySymbol(std::string value)
{
    
    m_CustCurrencySymbol = std::move(value);
}
std::string MailSchema::getPackage() const
{
    return m_Package;
}

void MailSchema::setPackage(std::string value)
{
...
void MailSchema::setExtraInfoTables(std::shared_ptr<MailSchema_extraInfoTables> value)
{
...
void MailSchema::setServiceType(std::shared_ptr<MailServiceType> value)
{
    
    m_ServiceType = std::move(value);
}
std::string MailSchema::getUsageCount() const
{
    return m_Usage_count;
}

void MailSchema::setUsageCount(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailSchema>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailSchema>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailSchema>>>::fromJsonValue(boost::json::parse(json));
}
