...
GetAccountLocales_200_response_value::GetAccountLocales_200_response_value(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GetAccountLocales_200_response_value::toJsonString(bool prettyJson /* = false */) const
{
...
void GetAccountLocales_200_response_value::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GetAccountLocales_200_response_value::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GetAccountLocales_200_response_value::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GetAccountLocales_200_response_value");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GetAccountLocales_200_response_value::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_NameIsSet) {
            object["name"] = JsonValueConverter<std::string>::toJsonValue(getName());
        }
        if (m_Local_nameIsSet) {
            object["local_name"] = JsonValueConverter<std::string>::toJsonValue(getLocalName());
        }
    return object;
}

void GetAccountLocales_200_response_value::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_Local_nameIsSet = false;
    {
    ...
    {
        const auto Local_nameIt = object.find("local_name");
        if (Local_nameIt != object.end()) {
            setLocalName(JsonValueConverter<std::string>::fromJsonValue(Local_nameIt->value()));
        }
    }
}

std::string GetAccountLocales_200_response_value::getName() const
{
    return m_Name;
}

void GetAccountLocales_200_response_value::setName(std::string value)
{
    
    m_Name = std::move(value);
    m_NameIsSet = true;
}
std::string GetAccountLocales_200_response_value::getLocalName() const
{
    return m_Local_name;
}

void GetAccountLocales_200_response_value::setLocalName(std::string value)
{
    
    m_Local_name = std::move(value);
    m_Local_nameIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GetAccountLocales_200_response_value>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GetAccountLocales_200_response_value>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GetAccountLocales_200_response_value>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GetAccountLocales_200_response_value>>>::fromJsonValue(boost::json::parse(json));
}
