...
EmailAddressName::EmailAddressName(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string EmailAddressName::toJsonString(bool prettyJson /* = false */) const
{
...
void EmailAddressName::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value EmailAddressName::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void EmailAddressName::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for EmailAddressName");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object EmailAddressName::toJsonObject_internal() const
{
...
void EmailAddressName::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    {
...
std::string EmailAddressName::getEmail() const
{
    return m_Email;
}

void EmailAddressName::setEmail(std::string value)
{
    
    m_Email = std::move(value);
}
std::string EmailAddressName::getName() const
{
    return m_Name;
}

void EmailAddressName::setName(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<EmailAddressName>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<EmailAddressName>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<EmailAddressName>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<EmailAddressName>>>::fromJsonValue(boost::json::parse(json));
}
