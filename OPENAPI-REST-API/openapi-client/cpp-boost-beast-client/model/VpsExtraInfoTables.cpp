...
VpsExtraInfoTables::VpsExtraInfoTables(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsExtraInfoTables::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsExtraInfoTables::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsExtraInfoTables::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsExtraInfoTables::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsExtraInfoTables");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsExtraInfoTables::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Ip_infoIsSet) {
            object["ip_info"] = JsonValueConverter<std::shared_ptr<VpsIPInfo>>::toJsonValue(getIpInfo());
        }
    return object;
}

void VpsExtraInfoTables::fromJsonObject_internal(boost::json::object const& object)
{
    m_Ip_infoIsSet = false;
    {
        const auto Ip_infoIt = object.find("ip_info");
        if (Ip_infoIt != object.end()) {
            setIpInfo(JsonValueConverter<std::shared_ptr<VpsIPInfo>>::fromJsonValue(Ip_infoIt->value()));
        }
    }
}

std::shared_ptr<VpsIPInfo> VpsExtraInfoTables::getIpInfo() const
{
    return m_Ip_info;
}

void VpsExtraInfoTables::setIpInfo(std::shared_ptr<VpsIPInfo> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsExtraInfoTables>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsExtraInfoTables>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsExtraInfoTables>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsExtraInfoTables>>>::fromJsonValue(boost::json::parse(json));
}
