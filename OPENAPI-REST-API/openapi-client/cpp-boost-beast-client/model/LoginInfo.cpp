...
LoginInfo::LoginInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LoginInfo::toJsonString(bool prettyJson /* = false */) const
{
...
void LoginInfo::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LoginInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LoginInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LoginInfo");
    }
...
void LoginInfo::fromJsonObject_internal(boost::json::object const& object)
{
    m_LogoIsSet = false;
    ...
    {
        const auto CountsIt = object.find("counts");
        if (CountsIt != object.end()) {
...
void LoginInfo::setLogo(std::string value)
{
...
void LoginInfo::setLanguage(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LoginInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LoginInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LoginInfo>>>::fromJsonValue(boost::json::parse(json));
}
