...
BackupIPInfo::BackupIPInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BackupIPInfo::toJsonString(bool prettyJson /* = false */) const
{
...
void BackupIPInfo::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BackupIPInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BackupIPInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BackupIPInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BackupIPInfo::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<std::shared_ptr<BackupIPInfoRow>>>::toJsonValue(getRows());
        }
    return object;
}

void BackupIPInfo::fromJsonObject_internal(boost::json::object const& object)
{
    m_TitleIsSet = false;
    m_RowsIsSet = false;
    {
    ...
    }
    {
        ...
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<std::shared_ptr<BackupIPInfoRow>>>::fromJsonValue(RowsIt->value()));
        }
    }
}

std::string BackupIPInfo::getTitle() const
{
    return m_Title;
}

void BackupIPInfo::setTitle(std::string value)
{
    
    m_Title = std::move(value);
    m_TitleIsSet = true;
}
std::vector<std::shared_ptr<BackupIPInfoRow>> BackupIPInfo::getRows() const
{
    return m_Rows;
}

void BackupIPInfo::setRows(std::vector<std::shared_ptr<BackupIPInfoRow>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BackupIPInfo>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BackupIPInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BackupIPInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BackupIPInfo>>>::fromJsonValue(boost::json::parse(json));
}
