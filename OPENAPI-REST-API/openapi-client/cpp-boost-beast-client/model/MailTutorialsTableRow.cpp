...
MailTutorialsTableRow::MailTutorialsTableRow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailTutorialsTableRow::toJsonString(bool prettyJson /* = false */) const
{
...
void MailTutorialsTableRow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailTutorialsTableRow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailTutorialsTableRow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailTutorialsTableRow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailTutorialsTableRow::toJsonObject_internal() const
{
...
void MailTutorialsTableRow::fromJsonObject_internal(boost::json::object const& object)
{
    m_DescIsSet = false;
    m_ValueIsSet = false;
    {
...
std::string MailTutorialsTableRow::getDesc() const
{
    return m_Desc;
}

void MailTutorialsTableRow::setDesc(std::string value)
{
    
    m_Desc = std::move(value);
    m_DescIsSet = true;
}
std::string MailTutorialsTableRow::getValue() const
{
    return m_Value;
}

void MailTutorialsTableRow::setValue(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailTutorialsTableRow>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailTutorialsTableRow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailTutorialsTableRow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailTutorialsTableRow>>>::fromJsonValue(boost::json::parse(json));
}
