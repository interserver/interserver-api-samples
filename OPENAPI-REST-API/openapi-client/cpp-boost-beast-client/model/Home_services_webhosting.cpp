...
Home_services_webhosting::Home_services_webhosting(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Home_services_webhosting::toJsonString(bool prettyJson /* = false */) const
{
...
void Home_services_webhosting::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Home_services_webhosting::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Home_services_webhosting::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Home_services_webhosting");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Home_services_webhosting::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_LinksIsSet) {
            object["links"] = JsonValueConverter<std::shared_ptr<HomeServicesWebhostingLinks>>::toJsonValue(getLinks());
        }
        if (m_CountIsSet) {
...
void Home_services_webhosting::fromJsonObject_internal(boost::json::object const& object)
{
    m_LinksIsSet = false;
    m_CountIsSet = false;
    {
        ...
        if (LinksIt != object.end()) {
            setLinks(JsonValueConverter<std::shared_ptr<HomeServicesWebhostingLinks>>::fromJsonValue(LinksIt->value()));
        }
    }
    {
...
std::shared_ptr<HomeServicesWebhostingLinks> Home_services_webhosting::getLinks() const
{
    return m_Links;
}

void Home_services_webhosting::setLinks(std::shared_ptr<HomeServicesWebhostingLinks> value)
{
    
    m_Links = std::move(value);
    m_LinksIsSet = true;
}
int32_t Home_services_webhosting::getCount() const
{
    return m_Count;
}

void Home_services_webhosting::setCount(int32_t value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Home_services_webhosting>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Home_services_webhosting>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Home_services_webhosting>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Home_services_webhosting>>>::fromJsonValue(boost::json::parse(json));
}
