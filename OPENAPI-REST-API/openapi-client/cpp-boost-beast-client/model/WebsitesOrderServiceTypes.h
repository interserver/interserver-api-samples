...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_WebsitesOrderServiceTypes_MODEL_H_
#define BOOST_BEAST_OPENAPI_CLIENT_WebsitesOrderServiceTypes_MODEL_H_
...
{
public:
    WebsitesOrderServiceTypes() = default;
    explicit WebsitesOrderServiceTypes(boost::json::value const& value);
    virtual ~WebsitesOrderServiceTypes() = default;
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_WebsitesOrderServiceTypes_MODEL_H_ */
