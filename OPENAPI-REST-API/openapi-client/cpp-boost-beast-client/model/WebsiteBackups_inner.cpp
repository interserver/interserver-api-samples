...
WebsiteBackups_inner::WebsiteBackups_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsiteBackups_inner::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsiteBackups_inner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsiteBackups_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsiteBackups_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsiteBackups_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsiteBackups_inner::toJsonObject_internal() const
{
...
void WebsiteBackups_inner::fromJsonObject_internal(boost::json::object const& object)
{
    m_SizeIsSet = false;
    {
...
std::string WebsiteBackups_inner::getName() const
{
    return m_Name;
}

void WebsiteBackups_inner::setName(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WebsiteBackups_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsiteBackups_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsiteBackups_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsiteBackups_inner>>>::fromJsonValue(boost::json::parse(json));
}
