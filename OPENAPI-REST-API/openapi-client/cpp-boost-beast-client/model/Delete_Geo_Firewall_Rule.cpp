...
Delete_Geo_Firewall_Rule::Delete_Geo_Firewall_Rule(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Delete_Geo_Firewall_Rule::toJsonString(bool prettyJson /* = false */) const
{
...
void Delete_Geo_Firewall_Rule::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Delete_Geo_Firewall_Rule::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Delete_Geo_Firewall_Rule::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Delete_Geo_Firewall_Rule");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Delete_Geo_Firewall_Rule::toJsonObject_internal() const
{
    boost::json::object object;
        object["rule_id"] = JsonValueConverter<int32_t>::toJsonValue(getRuleId());
    return object;
}

void Delete_Geo_Firewall_Rule::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto Rule_idIt = object.find("rule_id");
        if (Rule_idIt != object.end()) {
            setRuleId(JsonValueConverter<int32_t>::fromJsonValue(Rule_idIt->value()));
        }
    }
}
...
void Delete_Geo_Firewall_Rule::setRuleId(int32_t value)
{
    ...
    m_Rule_id = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Delete_Geo_Firewall_Rule>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Delete_Geo_Firewall_Rule>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Delete_Geo_Firewall_Rule>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Delete_Geo_Firewall_Rule>>>::fromJsonValue(boost::json::parse(json));
}
