...
TemplateRequest::TemplateRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TemplateRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void TemplateRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TemplateRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TemplateRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TemplateRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TemplateRequest::toJsonObject_internal() const
{
...
void TemplateRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_PasswordIsSet = false;
    {
        const auto r_templateIt = object.find("template");
        if (r_templateIt != object.end()) {
            setRTemplate(JsonValueConverter<std::string>::fromJsonValue(r_templateIt->value()));
        }
    }
    {
...
std::string TemplateRequest::getRTemplate() const
{
    return m_r_template;
}

void TemplateRequest::setRTemplate(std::string value)
{
...
void TemplateRequest::setPassword(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TemplateRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TemplateRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TemplateRequest>>>::fromJsonValue(boost::json::parse(json));
}
