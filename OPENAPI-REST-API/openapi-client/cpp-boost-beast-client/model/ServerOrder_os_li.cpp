...
ServerOrder_os_li::ServerOrder_os_li(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerOrder_os_li::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerOrder_os_li::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerOrder_os_li::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerOrder_os_li::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerOrder_os_li");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerOrder_os_li::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_51IsSet) {
            object["51"] = JsonValueConverter<std::shared_ptr<ServerOrderOS>>::toJsonValue(getR51());
        }
    return object;
}

void ServerOrder_os_li::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_51IsSet = false;
    {
        const auto r_51It = object.find("51");
        if (r_51It != object.end()) {
            setR51(JsonValueConverter<std::shared_ptr<ServerOrderOS>>::fromJsonValue(r_51It->value()));
        }
    }
}
...
void ServerOrder_os_li::setR51(std::shared_ptr<ServerOrderOS> value)
{
    
    m_r_51 = std::move(value);
    m_r_51IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerOrder_os_li>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_os_li>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerOrder_os_li>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_os_li>>>::fromJsonValue(boost::json::parse(json));
}
