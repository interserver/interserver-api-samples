...
VpsSnapshot::VpsSnapshot(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsSnapshot::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsSnapshot::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsSnapshot::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsSnapshot::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsSnapshot");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsSnapshot::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_UsedIsSet) {
            object["used"] = JsonValueConverter<int32_t>::toJsonValue(getUsed());
        }
        if (m_dateIsSet) {
...
void VpsSnapshot::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_UsedIsSet = false;
    m_dateIsSet = false;
    ...
    {
        const auto UsedIt = object.find("used");
        if (UsedIt != object.end()) {
            setUsed(JsonValueConverter<int32_t>::fromJsonValue(UsedIt->value()));
        }
    }
    {
...
std::string VpsSnapshot::getName() const
{
    return m_Name;
}

void VpsSnapshot::setName(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsSnapshot>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsSnapshot>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsSnapshot>>>::fromJsonValue(boost::json::parse(json));
}
