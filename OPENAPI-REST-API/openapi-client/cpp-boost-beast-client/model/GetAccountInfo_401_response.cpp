...
GetAccountInfo_401_response::GetAccountInfo_401_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GetAccountInfo_401_response::toJsonString(bool prettyJson /* = false */) const
{
...
void GetAccountInfo_401_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GetAccountInfo_401_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GetAccountInfo_401_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GetAccountInfo_401_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GetAccountInfo_401_response::toJsonObject_internal() const
{
...
void GetAccountInfo_401_response::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
int32_t GetAccountInfo_401_response::getCode() const
{
    return m_Code;
}

void GetAccountInfo_401_response::setCode(int32_t value)
{
    
    m_Code = std::move(value);
}
std::string GetAccountInfo_401_response::getMessage() const
{
    return m_Message;
}

void GetAccountInfo_401_response::setMessage(std::string value)
{
    
    m_Message = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GetAccountInfo_401_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GetAccountInfo_401_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GetAccountInfo_401_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GetAccountInfo_401_response>>>::fromJsonValue(boost::json::parse(json));
}
