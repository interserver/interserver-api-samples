...
VpsOrder_serviceTypes::VpsOrder_serviceTypes(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsOrder_serviceTypes::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsOrder_serviceTypes::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsOrder_serviceTypes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsOrder_serviceTypes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsOrder_serviceTypes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsOrder_serviceTypes::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_32IsSet) {
            object["32"] = JsonValueConverter<std::shared_ptr<VpsOrder_serviceTypes_32>>::toJsonValue(getR32());
        }
    return object;
}

void VpsOrder_serviceTypes::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_32IsSet = false;
    {
        const auto r_32It = object.find("32");
        if (r_32It != object.end()) {
            setR32(JsonValueConverter<std::shared_ptr<VpsOrder_serviceTypes_32>>::fromJsonValue(r_32It->value()));
        }
    }
}
...
void VpsOrder_serviceTypes::setR32(std::shared_ptr<VpsOrder_serviceTypes_32> value)
{
    
    m_r_32 = std::move(value);
    m_r_32IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsOrder_serviceTypes>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_serviceTypes>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsOrder_serviceTypes>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsOrder_serviceTypes>>>::fromJsonValue(boost::json::parse(json));
}
