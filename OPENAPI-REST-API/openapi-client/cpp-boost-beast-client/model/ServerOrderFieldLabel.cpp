...
ServerOrderFieldLabel::ServerOrderFieldLabel(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerOrderFieldLabel::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerOrderFieldLabel::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerOrderFieldLabel::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerOrderFieldLabel::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerOrderFieldLabel");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerOrderFieldLabel::toJsonObject_internal() const
{
...
void ServerOrderFieldLabel::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_ActiveIsSet = false;
    {
...
std::string ServerOrderFieldLabel::getName() const
{
    return m_Name;
}

void ServerOrderFieldLabel::setName(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerOrderFieldLabel>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerOrderFieldLabel>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerOrderFieldLabel>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerOrderFieldLabel>>>::fromJsonValue(boost::json::parse(json));
}
