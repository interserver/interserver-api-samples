...
DnsRecordType::DnsRecordType(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DnsRecordType::toJsonString(bool prettyJson /* = false */) const
{
...
void DnsRecordType::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DnsRecordType::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DnsRecordType::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DnsRecordType");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DnsRecordType::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void DnsRecordType::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DnsRecordType>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DnsRecordType>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DnsRecordType>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DnsRecordType>>>::fromJsonValue(boost::json::parse(json));
}
