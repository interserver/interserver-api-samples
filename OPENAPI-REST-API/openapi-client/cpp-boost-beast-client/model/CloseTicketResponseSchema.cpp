...
CloseTicketResponseSchema::CloseTicketResponseSchema(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CloseTicketResponseSchema::toJsonString(bool prettyJson /* = false */) const
{
...
void CloseTicketResponseSchema::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CloseTicketResponseSchema::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CloseTicketResponseSchema::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CloseTicketResponseSchema");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CloseTicketResponseSchema::toJsonObject_internal() const
{
...
void CloseTicketResponseSchema::fromJsonObject_internal(boost::json::object const& object)
{
...
bool CloseTicketResponseSchema::isSuccess() const
{
    return m_Success;
}

void CloseTicketResponseSchema::setSuccess(bool value)
{
    
    m_Success = std::move(value);
    m_SuccessIsSet = true;
}
std::string CloseTicketResponseSchema::getText() const
{
    return m_Text;
}

void CloseTicketResponseSchema::setText(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CloseTicketResponseSchema>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CloseTicketResponseSchema>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CloseTicketResponseSchema>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CloseTicketResponseSchema>>>::fromJsonValue(boost::json::parse(json));
}
