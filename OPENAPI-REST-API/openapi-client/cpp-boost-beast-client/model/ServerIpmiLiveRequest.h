...
#ifndef BOOST_BEAST_OPENAPI_CLIENT_ServerIpmiLiveRequest_MODEL_H_
#define BOOST_BEAST_OPENAPI_CLIENT_ServerIpmiLiveRequest_MODEL_H_
...
{
public:
    ServerIpmiLiveRequest() = default;
    explicit ServerIpmiLiveRequest(boost::json::value const& value);
    virtual ~ServerIpmiLiveRequest() = default;
...
#endif /* BOOST_BEAST_OPENAPI_CLIENT_ServerIpmiLiveRequest_MODEL_H_ */
