...
CreateFilter_201_response::CreateFilter_201_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CreateFilter_201_response::toJsonString(bool prettyJson /* = false */) const
{
...
void CreateFilter_201_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CreateFilter_201_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CreateFilter_201_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CreateFilter_201_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CreateFilter_201_response::toJsonObject_internal() const
{
...
void CreateFilter_201_response::fromJsonObject_internal(boost::json::object const& object)
{
...
bool CreateFilter_201_response::isSuccess() const
{
    return m_Success;
}

void CreateFilter_201_response::setSuccess(bool value)
{
    
    m_Success = std::move(value);
    m_SuccessIsSet = true;
}
std::string CreateFilter_201_response::getText() const
{
    return m_Text;
}

void CreateFilter_201_response::setText(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CreateFilter_201_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CreateFilter_201_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CreateFilter_201_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CreateFilter_201_response>>>::fromJsonValue(boost::json::parse(json));
}
