...
QuickserverAddonsRow::QuickserverAddonsRow(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverAddonsRow::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverAddonsRow::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverAddonsRow::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverAddonsRow::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverAddonsRow");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverAddonsRow::toJsonObject_internal() const
{
...
void QuickserverAddonsRow::fromJsonObject_internal(boost::json::object const& object)
{
    m_DescIsSet = false;
    m_ValueIsSet = false;
    {
...
std::string QuickserverAddonsRow::getDesc() const
{
    return m_Desc;
}

void QuickserverAddonsRow::setDesc(std::string value)
{
    
    m_Desc = std::move(value);
    m_DescIsSet = true;
}
std::string QuickserverAddonsRow::getValue() const
{
    return m_Value;
}

void QuickserverAddonsRow::setValue(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverAddonsRow>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverAddonsRow>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverAddonsRow>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverAddonsRow>>>::fromJsonValue(boost::json::parse(json));
}
