...
LicenseIpInfo::LicenseIpInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LicenseIpInfo::toJsonString(bool prettyJson /* = false */) const
{
...
void LicenseIpInfo::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LicenseIpInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LicenseIpInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LicenseIpInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LicenseIpInfo::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<std::shared_ptr<LicenseIpInfoRow>>>::toJsonValue(getRows());
        }
    return object;
}

void LicenseIpInfo::fromJsonObject_internal(boost::json::object const& object)
{
    m_TitleIsSet = false;
    m_RowsIsSet = false;
    {
    ...
    }
    {
        ...
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<std::shared_ptr<LicenseIpInfoRow>>>::fromJsonValue(RowsIt->value()));
        }
    }
}

std::string LicenseIpInfo::getTitle() const
{
    return m_Title;
}

void LicenseIpInfo::setTitle(std::string value)
{
    
    m_Title = std::move(value);
    m_TitleIsSet = true;
}
std::vector<std::shared_ptr<LicenseIpInfoRow>> LicenseIpInfo::getRows() const
{
    return m_Rows;
}

void LicenseIpInfo::setRows(std::vector<std::shared_ptr<LicenseIpInfoRow>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LicenseIpInfo>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LicenseIpInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LicenseIpInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LicenseIpInfo>>>::fromJsonValue(boost::json::parse(json));
}
