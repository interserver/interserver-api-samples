...
TimezoneUpdate::TimezoneUpdate(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string TimezoneUpdate::toJsonString(bool prettyJson /* = false */) const
{
...
void TimezoneUpdate::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value TimezoneUpdate::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TimezoneUpdate::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TimezoneUpdate");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TimezoneUpdate::toJsonObject_internal() const
{
...
void TimezoneUpdate::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string TimezoneUpdate::getTimezone() const
{
    return m_Timezone;
}

void TimezoneUpdate::setTimezone(std::string value)
{
    
    m_Timezone = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<TimezoneUpdate>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TimezoneUpdate>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TimezoneUpdate>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TimezoneUpdate>>>::fromJsonValue(boost::json::parse(json));
}
