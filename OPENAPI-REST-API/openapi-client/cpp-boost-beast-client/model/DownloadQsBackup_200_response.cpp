...
DownloadQsBackup_200_response::DownloadQsBackup_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DownloadQsBackup_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void DownloadQsBackup_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DownloadQsBackup_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DownloadQsBackup_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DownloadQsBackup_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DownloadQsBackup_200_response::toJsonObject_internal() const
{
...
void DownloadQsBackup_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    m_TextIsSet = false;
    m_UrlIsSet = false;
    {
...
std::string DownloadQsBackup_200_response::getText() const
{
    return m_Text;
}

void DownloadQsBackup_200_response::setText(std::string value)
{
    
    m_Text = std::move(value);
    m_TextIsSet = true;
}
std::string DownloadQsBackup_200_response::getUrl() const
{
    return m_Url;
}

void DownloadQsBackup_200_response::setUrl(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DownloadQsBackup_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DownloadQsBackup_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DownloadQsBackup_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DownloadQsBackup_200_response>>>::fromJsonValue(boost::json::parse(json));
}
