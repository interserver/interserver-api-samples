...
Home_ticketStatusView::Home_ticketStatusView(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Home_ticketStatusView::toJsonString(bool prettyJson /* = false */) const
{
...
void Home_ticketStatusView::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Home_ticketStatusView::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Home_ticketStatusView::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Home_ticketStatusView");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Home_ticketStatusView::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_4IsSet) {
            object["4"] = JsonValueConverter<std::string>::toJsonValue(getR4());
        }
        if (m_r_5IsSet) {
            object["5"] = JsonValueConverter<std::string>::toJsonValue(getR5());
        }
        if (m_r_6IsSet) {
            object["6"] = JsonValueConverter<std::string>::toJsonValue(getR6());
        }
    return object;
}

void Home_ticketStatusView::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_4IsSet = false;
    m_r_5IsSet = false;
    m_r_6IsSet = false;
    {
        const auto r_4It = object.find("4");
        if (r_4It != object.end()) {
            setR4(JsonValueConverter<std::string>::fromJsonValue(r_4It->value()));
        }
    }
    {
        const auto r_5It = object.find("5");
        if (r_5It != object.end()) {
            setR5(JsonValueConverter<std::string>::fromJsonValue(r_5It->value()));
        }
    }
    {
        const auto r_6It = object.find("6");
        if (r_6It != object.end()) {
            setR6(JsonValueConverter<std::string>::fromJsonValue(r_6It->value()));
        }
    }
}

std::string Home_ticketStatusView::getR4() const
{
    return m_r_4;
}

void Home_ticketStatusView::setR4(std::string value)
{
    
    m_r_4 = std::move(value);
    m_r_4IsSet = true;
}
std::string Home_ticketStatusView::getR5() const
{
    return m_r_5;
}

void Home_ticketStatusView::setR5(std::string value)
{
    
    m_r_5 = std::move(value);
    m_r_5IsSet = true;
}
std::string Home_ticketStatusView::getR6() const
{
    return m_r_6;
}

void Home_ticketStatusView::setR6(std::string value)
{
    
    m_r_6 = std::move(value);
    m_r_6IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Home_ticketStatusView>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Home_ticketStatusView>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Home_ticketStatusView>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Home_ticketStatusView>>>::fromJsonValue(boost::json::parse(json));
}
