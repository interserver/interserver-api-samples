...
GetWebsiteBuyIp_200_response::GetWebsiteBuyIp_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GetWebsiteBuyIp_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void GetWebsiteBuyIp_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GetWebsiteBuyIp_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GetWebsiteBuyIp_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GetWebsiteBuyIp_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GetWebsiteBuyIp_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_IpsIsSet) {
            object["ips"] = JsonValueConverter<std::map<std::string, std::string>>::toJsonValue(getIps());
        }
    return object;
}

void GetWebsiteBuyIp_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    m_IpsIsSet = false;
    {
        const auto IpsIt = object.find("ips");
        if (IpsIt != object.end()) {
            setIps(JsonValueConverter<std::map<std::string, std::string>>::fromJsonValue(IpsIt->value()));
        }
    }
}

std::map<std::string, std::string> GetWebsiteBuyIp_200_response::getIps() const
{
    return m_Ips;
}

void GetWebsiteBuyIp_200_response::setIps(std::map<std::string, std::string> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GetWebsiteBuyIp_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GetWebsiteBuyIp_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GetWebsiteBuyIp_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GetWebsiteBuyIp_200_response>>>::fromJsonValue(boost::json::parse(json));
}
