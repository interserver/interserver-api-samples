...
AccountInfoMaxMindResponse_riskScore::AccountInfoMaxMindResponse_riskScore(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AccountInfoMaxMindResponse_riskScore::toJsonString(bool prettyJson /* = false */) const
{
...
void AccountInfoMaxMindResponse_riskScore::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AccountInfoMaxMindResponse_riskScore::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AccountInfoMaxMindResponse_riskScore::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AccountInfoMaxMindResponse_riskScore");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AccountInfoMaxMindResponse_riskScore::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AccountInfoMaxMindResponse_riskScore::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AccountInfoMaxMindResponse_riskScore>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AccountInfoMaxMindResponse_riskScore>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AccountInfoMaxMindResponse_riskScore>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AccountInfoMaxMindResponse_riskScore>>>::fromJsonValue(boost::json::parse(json));
}
