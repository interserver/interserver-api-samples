...
VpsCPData::VpsCPData(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsCPData::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsCPData::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsCPData::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsCPData::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsCPData");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsCPData::toJsonObject_internal() const
{
...
void VpsCPData::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_CostIsSet = false;
    {
...
std::string VpsCPData::getName() const
{
    return m_Name;
}

void VpsCPData::setName(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsCPData>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsCPData>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsCPData>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsCPData>>>::fromJsonValue(boost::json::parse(json));
}
