...
ServerLocation1::ServerLocation1(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerLocation1::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerLocation1::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerLocation1::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerLocation1::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerLocation1");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerLocation1::toJsonObject_internal() const
{
...
void ServerLocation1::fromJsonObject_internal(boost::json::object const& object)
{
    m_Location_descriptionIsSet = false;
    m_Location_ipmi_groupIsSet = false;
    {
        const auto Location_idIt = object.find("location_id");
        if (Location_idIt != object.end()) {
            setLocationId(JsonValueConverter<int32_t>::fromJsonValue(Location_idIt->value()));
        }
    }
    {
        const auto Location_nameIt = object.find("location_name");
        if (Location_nameIt != object.end()) {
            setLocationName(JsonValueConverter<std::string>::fromJsonValue(Location_nameIt->value()));
        }
    }
    {
    ...
    {
        const auto Location_ipmi_groupIt = object.find("location_ipmi_group");
        if (Location_ipmi_groupIt != object.end()) {
            setLocationIpmiGroup(JsonValueConverter<int32_t>::fromJsonValue(Location_ipmi_groupIt->value()));
        }
    }
}
...
void ServerLocation1::setLocationId(int32_t value)
{
    ...
    m_Location_id = std::move(value);
}
std::string ServerLocation1::getLocationName() const
{
    return m_Location_name;
}

void ServerLocation1::setLocationName(std::string value)
{
...
void ServerLocation1::setLocationLat(std::string value)
{
    
    m_Location_lat = std::move(value);
}
std::string ServerLocation1::getLocationLong() const
{
    return m_Location_long;
}

void ServerLocation1::setLocationLong(std::string value)
{
...
void ServerLocation1::setLocationIpmiGroup(int32_t value)
{
    ...
    m_Location_ipmi_group = std::move(value);
    m_Location_ipmi_groupIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerLocation1>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerLocation1>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerLocation1>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerLocation1>>>::fromJsonValue(boost::json::parse(json));
}
