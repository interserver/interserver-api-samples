...
WebsitesOrderJsonServices::WebsitesOrderJsonServices(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsitesOrderJsonServices::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsitesOrderJsonServices::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsitesOrderJsonServices::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsitesOrderJsonServices::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsitesOrderJsonServices");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsitesOrderJsonServices::toJsonObject_internal() const
{
    boost::json::object object;
        object["11447"] = JsonValueConverter<std::string>::toJsonValue(getR11447());
    return object;
}

void WebsitesOrderJsonServices::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto r_11447It = object.find("11447");
        if (r_11447It != object.end()) {
            setR11447(JsonValueConverter<std::string>::fromJsonValue(r_11447It->value()));
        }
    }
}

std::string WebsitesOrderJsonServices::getR11447() const
{
    return m_r_11447;
}

void WebsitesOrderJsonServices::setR11447(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderJsonServices>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsitesOrderJsonServices>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderJsonServices>>>::fromJsonValue(boost::json::parse(json));
}
