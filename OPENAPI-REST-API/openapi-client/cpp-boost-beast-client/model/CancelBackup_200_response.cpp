...
CancelBackup_200_response::CancelBackup_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string CancelBackup_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void CancelBackup_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value CancelBackup_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void CancelBackup_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for CancelBackup_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object CancelBackup_200_response::toJsonObject_internal() const
{
...
void CancelBackup_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
bool CancelBackup_200_response::isSuccess() const
{
    return m_Success;
}

void CancelBackup_200_response::setSuccess(bool value)
{
    
    m_Success = std::move(value);
}
std::string CancelBackup_200_response::getText() const
{
    return m_Text;
}

void CancelBackup_200_response::setText(std::string value)
{
    
    m_Text = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<CancelBackup_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<CancelBackup_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<CancelBackup_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<CancelBackup_200_response>>>::fromJsonValue(boost::json::parse(json));
}
