...
AccountInfoCountryCurrencies::AccountInfoCountryCurrencies(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AccountInfoCountryCurrencies::toJsonString(bool prettyJson /* = false */) const
{
...
void AccountInfoCountryCurrencies::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AccountInfoCountryCurrencies::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AccountInfoCountryCurrencies::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AccountInfoCountryCurrencies");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AccountInfoCountryCurrencies::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AccountInfoCountryCurrencies::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AccountInfoCountryCurrencies>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AccountInfoCountryCurrencies>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AccountInfoCountryCurrencies>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AccountInfoCountryCurrencies>>>::fromJsonValue(boost::json::parse(json));
}
