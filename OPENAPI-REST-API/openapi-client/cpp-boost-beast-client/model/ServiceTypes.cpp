...
ServiceTypes::ServiceTypes(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServiceTypes::toJsonString(bool prettyJson /* = false */) const
{
...
void ServiceTypes::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServiceTypes::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServiceTypes::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServiceTypes");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServiceTypes::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ServiceTypes::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServiceTypes>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServiceTypes>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServiceTypes>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServiceTypes>>>::fromJsonValue(boost::json::parse(json));
}
