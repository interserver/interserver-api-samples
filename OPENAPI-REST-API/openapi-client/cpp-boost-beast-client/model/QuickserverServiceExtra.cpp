...
QuickserverServiceExtra::QuickserverServiceExtra(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverServiceExtra::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverServiceExtra::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverServiceExtra::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverServiceExtra::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverServiceExtra");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverServiceExtra::toJsonObject_internal() const
{
...
void QuickserverServiceExtra::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string QuickserverServiceExtra::getPlatform() const
{
    return m_Platform;
}

void QuickserverServiceExtra::setPlatform(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverServiceExtra>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverServiceExtra>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverServiceExtra>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverServiceExtra>>>::fromJsonValue(boost::json::parse(json));
}
