...
PatchBillingCreditCardVerify_request::PatchBillingCreditCardVerify_request(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PatchBillingCreditCardVerify_request::toJsonString(bool prettyJson /* = false */) const
{
...
void PatchBillingCreditCardVerify_request::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PatchBillingCreditCardVerify_request::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PatchBillingCreditCardVerify_request::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PatchBillingCreditCardVerify_request");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PatchBillingCreditCardVerify_request::toJsonObject_internal() const
{
...
void PatchBillingCreditCardVerify_request::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string PatchBillingCreditCardVerify_request::getCcCcv2() const
{
    return m_Cc_ccv2;
}

void PatchBillingCreditCardVerify_request::setCcCcv2(std::string value)
{
    
    m_Cc_ccv2 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PatchBillingCreditCardVerify_request>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PatchBillingCreditCardVerify_request>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PatchBillingCreditCardVerify_request>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PatchBillingCreditCardVerify_request>>>::fromJsonValue(boost::json::parse(json));
}
