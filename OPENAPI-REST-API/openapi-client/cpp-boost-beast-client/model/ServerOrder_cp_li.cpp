...
ServerOrder_cp_li::ServerOrder_cp_li(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerOrder_cp_li::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerOrder_cp_li::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerOrder_cp_li::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerOrder_cp_li::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerOrder_cp_li");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerOrder_cp_li::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_9IsSet) {
            object["9"] = JsonValueConverter<std::shared_ptr<ServerOrderControlPanel>>::toJsonValue(getR9());
        }
    return object;
}

void ServerOrder_cp_li::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_9IsSet = false;
    {
        const auto r_9It = object.find("9");
        if (r_9It != object.end()) {
            setR9(JsonValueConverter<std::shared_ptr<ServerOrderControlPanel>>::fromJsonValue(r_9It->value()));
        }
    }
}
...
void ServerOrder_cp_li::setR9(std::shared_ptr<ServerOrderControlPanel> value)
{
    
    m_r_9 = std::move(value);
    m_r_9IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerOrder_cp_li>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_cp_li>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerOrder_cp_li>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_cp_li>>>::fromJsonValue(boost::json::parse(json));
}
