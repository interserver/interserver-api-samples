...
DomainNameserverGetResponse_inner::DomainNameserverGetResponse_inner(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DomainNameserverGetResponse_inner::toJsonString(bool prettyJson /* = false */) const
{
...
void DomainNameserverGetResponse_inner::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DomainNameserverGetResponse_inner::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DomainNameserverGetResponse_inner::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DomainNameserverGetResponse_inner");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DomainNameserverGetResponse_inner::toJsonObject_internal() const
{
    boost::json::object object;
        object["name"] = JsonValueConverter<std::string>::toJsonValue(getName());
        object["ipaddress"] = JsonValueConverter<std::string>::toJsonValue(getIpaddress());
        object["can_delete"] = JsonValueConverter<std::string>::toJsonValue(getCanDelete());
    return object;
}

void DomainNameserverGetResponse_inner::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    {
        const auto IpaddressIt = object.find("ipaddress");
        if (IpaddressIt != object.end()) {
            setIpaddress(JsonValueConverter<std::string>::fromJsonValue(IpaddressIt->value()));
        }
    }
    {
        const auto Can_deleteIt = object.find("can_delete");
        if (Can_deleteIt != object.end()) {
            setCanDelete(JsonValueConverter<std::string>::fromJsonValue(Can_deleteIt->value()));
        }
    }
}

std::string DomainNameserverGetResponse_inner::getName() const
{
    return m_Name;
}

void DomainNameserverGetResponse_inner::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::string DomainNameserverGetResponse_inner::getIpaddress() const
{
    return m_Ipaddress;
}

void DomainNameserverGetResponse_inner::setIpaddress(std::string value)
{
    
    m_Ipaddress = std::move(value);
}
std::string DomainNameserverGetResponse_inner::getCanDelete() const
{
    return m_Can_delete;
}
...
void DomainNameserverGetResponse_inner::setCanDelete(std::string value)
{
    ...
    m_Can_delete = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DomainNameserverGetResponse_inner>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DomainNameserverGetResponse_inner>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DomainNameserverGetResponse_inner>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DomainNameserverGetResponse_inner>>>::fromJsonValue(boost::json::parse(json));
}
