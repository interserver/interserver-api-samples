...
AccountInfo_oauthproviders::AccountInfo_oauthproviders(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AccountInfo_oauthproviders::toJsonString(bool prettyJson /* = false */) const
{
...
void AccountInfo_oauthproviders::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AccountInfo_oauthproviders::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AccountInfo_oauthproviders::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AccountInfo_oauthproviders");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AccountInfo_oauthproviders::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AccountInfo_oauthproviders::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AccountInfo_oauthproviders>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AccountInfo_oauthproviders>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AccountInfo_oauthproviders>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AccountInfo_oauthproviders>>>::fromJsonValue(boost::json::parse(json));
}
