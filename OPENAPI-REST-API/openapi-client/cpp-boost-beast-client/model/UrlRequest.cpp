...
UrlRequest::UrlRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UrlRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void UrlRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value UrlRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UrlRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UrlRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UrlRequest::toJsonObject_internal() const
{
...
void UrlRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_UrlIsSet = false;
    {
...
std::string UrlRequest::getUrl() const
{
    return m_Url;
}

void UrlRequest::setUrl(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UrlRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UrlRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UrlRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UrlRequest>>>::fromJsonValue(boost::json::parse(json));
}
