...
ViewMailLog_startDate_parameter::ViewMailLog_startDate_parameter(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ViewMailLog_startDate_parameter::toJsonString(bool prettyJson /* = false */) const
{
...
void ViewMailLog_startDate_parameter::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ViewMailLog_startDate_parameter::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ViewMailLog_startDate_parameter::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ViewMailLog_startDate_parameter");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ViewMailLog_startDate_parameter::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void ViewMailLog_startDate_parameter::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ViewMailLog_startDate_parameter>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ViewMailLog_startDate_parameter>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ViewMailLog_startDate_parameter>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ViewMailLog_startDate_parameter>>>::fromJsonValue(boost::json::parse(json));
}
