...
DomainDnssecRecords::DomainDnssecRecords(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DomainDnssecRecords::toJsonString(bool prettyJson /* = false */) const
{
...
void DomainDnssecRecords::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DomainDnssecRecords::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DomainDnssecRecords::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DomainDnssecRecords");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DomainDnssecRecords::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void DomainDnssecRecords::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DomainDnssecRecords>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DomainDnssecRecords>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DomainDnssecRecords>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DomainDnssecRecords>>>::fromJsonValue(boost::json::parse(json));
}
