...
MailBlockRspamd::MailBlockRspamd(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailBlockRspamd::toJsonString(bool prettyJson /* = false */) const
{
...
void MailBlockRspamd::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailBlockRspamd::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailBlockRspamd::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailBlockRspamd");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailBlockRspamd::toJsonObject_internal() const
{
...
void MailBlockRspamd::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string MailBlockRspamd::getFrom() const
{
    return m_From;
}

void MailBlockRspamd::setFrom(std::string value)
{
    
    m_From = std::move(value);
}
std::string MailBlockRspamd::getSubject() const
{
    return m_Subject;
}

void MailBlockRspamd::setSubject(std::string value)
{
    
    m_Subject = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailBlockRspamd>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailBlockRspamd>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailBlockRspamd>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailBlockRspamd>>>::fromJsonValue(boost::json::parse(json));
}
