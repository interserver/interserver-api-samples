...
QuickserverOrder_version::QuickserverOrder_version(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverOrder_version::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverOrder_version::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverOrder_version::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverOrder_version::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverOrder_version");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverOrder_version::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Centosstream_8IsSet) {
            object["centosstream-8"] = JsonValueConverter<std::shared_ptr<QuickserverOrderVersionCentosstream8>>::toJsonValue(getCentosstream8());
        }
    return object;
}

void QuickserverOrder_version::fromJsonObject_internal(boost::json::object const& object)
{
    m_Centosstream_8IsSet = false;
    {
        const auto Centosstream_8It = object.find("centosstream-8");
        if (Centosstream_8It != object.end()) {
            setCentosstream8(JsonValueConverter<std::shared_ptr<QuickserverOrderVersionCentosstream8>>::fromJsonValue(Centosstream_8It->value()));
        }
    }
}

std::shared_ptr<QuickserverOrderVersionCentosstream8> QuickserverOrder_version::getCentosstream8() const
{
    return m_Centosstream_8;
}

void QuickserverOrder_version::setCentosstream8(std::shared_ptr<QuickserverOrderVersionCentosstream8> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverOrder_version>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrder_version>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverOrder_version>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrder_version>>>::fromJsonValue(boost::json::parse(json));
}
