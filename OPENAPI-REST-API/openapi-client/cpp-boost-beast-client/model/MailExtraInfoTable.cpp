...
MailExtraInfoTable::MailExtraInfoTable(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailExtraInfoTable::toJsonString(bool prettyJson /* = false */) const
{
...
void MailExtraInfoTable::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailExtraInfoTable::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailExtraInfoTable::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailExtraInfoTable");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailExtraInfoTable::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_RowsIsSet) {
            object["rows"] = JsonValueConverter<std::vector<std::shared_ptr<MailExtraInfoTableRow>>>::toJsonValue(getRows());
        }
    return object;
}

void MailExtraInfoTable::fromJsonObject_internal(boost::json::object const& object)
{
    m_TitleIsSet = false;
    m_RowsIsSet = false;
    {
    ...
    }
    {
        ...
        if (RowsIt != object.end()) {
            setRows(JsonValueConverter<std::vector<std::shared_ptr<MailExtraInfoTableRow>>>::fromJsonValue(RowsIt->value()));
        }
    }
}

std::string MailExtraInfoTable::getTitle() const
{
    return m_Title;
}

void MailExtraInfoTable::setTitle(std::string value)
{
    
    m_Title = std::move(value);
    m_TitleIsSet = true;
}
std::vector<std::shared_ptr<MailExtraInfoTableRow>> MailExtraInfoTable::getRows() const
{
    return m_Rows;
}

void MailExtraInfoTable::setRows(std::vector<std::shared_ptr<MailExtraInfoTableRow>> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailExtraInfoTable>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailExtraInfoTable>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailExtraInfoTable>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailExtraInfoTable>>>::fromJsonValue(boost::json::parse(json));
}
