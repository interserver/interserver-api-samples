...
DomainClientLink::DomainClientLink(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DomainClientLink::toJsonString(bool prettyJson /* = false */) const
{
...
void DomainClientLink::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DomainClientLink::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DomainClientLink::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DomainClientLink");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DomainClientLink::toJsonObject_internal() const
{
...
void DomainClientLink::fromJsonObject_internal(boost::json::object const& object)
{
    m_LabelIsSet = false;
    m_LinkIsSet = false;
    m_IconIsSet = false;
...
std::string DomainClientLink::getLabel() const
{
    return m_Label;
}

void DomainClientLink::setLabel(std::string value)
{
    
    m_Label = std::move(value);
    m_LabelIsSet = true;
}
std::string DomainClientLink::getLink() const
{
    return m_Link;
}

void DomainClientLink::setLink(std::string value)
{
    
    m_Link = std::move(value);
    m_LinkIsSet = true;
}
std::string DomainClientLink::getIcon() const
{
    return m_Icon;
}

void DomainClientLink::setIcon(std::string value)
{
    
    m_Icon = std::move(value);
    m_IconIsSet = true;
}
std::string DomainClientLink::getIconText() const
{
    return m_Icon_text;
}

void DomainClientLink::setIconText(std::string value)
{
    
    m_Icon_text = std::move(value);
    m_Icon_textIsSet = true;
}
std::string DomainClientLink::getHelpText() const
{
    return m_Help_text;
}

void DomainClientLink::setHelpText(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DomainClientLink>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DomainClientLink>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DomainClientLink>>>::fromJsonValue(boost::json::parse(json));
}
