...
AccountInfoOauthConfigProviders::AccountInfoOauthConfigProviders(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AccountInfoOauthConfigProviders::toJsonString(bool prettyJson /* = false */) const
{
...
void AccountInfoOauthConfigProviders::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AccountInfoOauthConfigProviders::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AccountInfoOauthConfigProviders::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AccountInfoOauthConfigProviders");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AccountInfoOauthConfigProviders::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void AccountInfoOauthConfigProviders::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<AccountInfoOauthConfigProviders>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AccountInfoOauthConfigProviders>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AccountInfoOauthConfigProviders>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AccountInfoOauthConfigProviders>>>::fromJsonValue(boost::json::parse(json));
}
