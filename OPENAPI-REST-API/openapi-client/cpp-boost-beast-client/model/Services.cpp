...
Services::Services(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Services::toJsonString(bool prettyJson /* = false */) const
{
...
void Services::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Services::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Services::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Services");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Services::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void Services::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Services>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Services>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Services>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Services>>>::fromJsonValue(boost::json::parse(json));
}
