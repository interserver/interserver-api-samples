...
DeleteFilter_500_response::DeleteFilter_500_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DeleteFilter_500_response::toJsonString(bool prettyJson /* = false */) const
{
...
void DeleteFilter_500_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DeleteFilter_500_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DeleteFilter_500_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DeleteFilter_500_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DeleteFilter_500_response::toJsonObject_internal() const
{
...
void DeleteFilter_500_response::fromJsonObject_internal(boost::json::object const& object)
{
...
bool DeleteFilter_500_response::isSuccess() const
{
    return m_Success;
}

void DeleteFilter_500_response::setSuccess(bool value)
{
    
    m_Success = std::move(value);
    m_SuccessIsSet = true;
}
std::string DeleteFilter_500_response::getText() const
{
    return m_Text;
}

void DeleteFilter_500_response::setText(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DeleteFilter_500_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DeleteFilter_500_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DeleteFilter_500_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DeleteFilter_500_response>>>::fromJsonValue(boost::json::parse(json));
}
