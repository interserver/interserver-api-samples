...
ServerNetworkInfo::ServerNetworkInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerNetworkInfo::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerNetworkInfo::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerNetworkInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerNetworkInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerNetworkInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerNetworkInfo::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        object["assets"] = JsonValueConverter<std::shared_ptr<ServerNetworkInfo_assets>>::toJsonValue(getAssets());
        object["switchports"] = JsonValueConverter<std::shared_ptr<ServerNetworkInfo_switchports>>::toJsonValue(getSwitchports());
    return object;
}

void ServerNetworkInfo::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (AssetsIt != object.end()) {
            setAssets(JsonValueConverter<std::shared_ptr<ServerNetworkInfo_assets>>::fromJsonValue(AssetsIt->value()));
        }
    }
    {
        const auto SwitchportsIt = object.find("switchports");
        if (SwitchportsIt != object.end()) {
            setSwitchports(JsonValueConverter<std::shared_ptr<ServerNetworkInfo_switchports>>::fromJsonValue(SwitchportsIt->value()));
        }
    }
}

std::vector<std::string> ServerNetworkInfo::getVlans() const
{
    return m_Vlans;
}

void ServerNetworkInfo::setVlans(std::vector<std::string> value)
{
    
    m_Vlans = std::move(value);
}
std::vector<std::string> ServerNetworkInfo::getVlans6() const
{
    return m_Vlans6;
}

void ServerNetworkInfo::setVlans6(std::vector<std::string> value)
{
...
void ServerNetworkInfo::setAssets(std::shared_ptr<ServerNetworkInfo_assets> value)
{
...
void ServerNetworkInfo::setSwitchports(std::shared_ptr<ServerNetworkInfo_switchports> value)
{
    
    m_Switchports = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerNetworkInfo>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerNetworkInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerNetworkInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerNetworkInfo>>>::fromJsonValue(boost::json::parse(json));
}
