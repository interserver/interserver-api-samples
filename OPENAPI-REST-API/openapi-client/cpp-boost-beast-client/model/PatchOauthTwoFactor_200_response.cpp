...
PatchOauthTwoFactor_200_response::PatchOauthTwoFactor_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PatchOauthTwoFactor_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void PatchOauthTwoFactor_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PatchOauthTwoFactor_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PatchOauthTwoFactor_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PatchOauthTwoFactor_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PatchOauthTwoFactor_200_response::toJsonObject_internal() const
{
...
void PatchOauthTwoFactor_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    m_LoginIsSet = false;
    {
...
bool PatchOauthTwoFactor_200_response::isLogin() const
{
    return m_Login;
}

void PatchOauthTwoFactor_200_response::setLogin(bool value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PatchOauthTwoFactor_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PatchOauthTwoFactor_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PatchOauthTwoFactor_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PatchOauthTwoFactor_200_response>>>::fromJsonValue(boost::json::parse(json));
}
