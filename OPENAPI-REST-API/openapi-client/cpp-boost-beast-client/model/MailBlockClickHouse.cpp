...
MailBlockClickHouse::MailBlockClickHouse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailBlockClickHouse::toJsonString(bool prettyJson /* = false */) const
{
...
void MailBlockClickHouse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailBlockClickHouse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailBlockClickHouse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailBlockClickHouse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailBlockClickHouse::toJsonObject_internal() const
{
...
void MailBlockClickHouse::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string MailBlockClickHouse::getDate() const
{
    return m_date;
}

void MailBlockClickHouse::setDate(std::string value)
{
    
    m_date = std::move(value);
}
std::string MailBlockClickHouse::getFrom() const
{
    return m_From;
}

void MailBlockClickHouse::setFrom(std::string value)
{
    
    m_From = std::move(value);
}
std::string MailBlockClickHouse::getMessageId() const
{
    return m_MessageId;
}

void MailBlockClickHouse::setMessageId(std::string value)
{
    
    m_MessageId = std::move(value);
}
std::string MailBlockClickHouse::getSubject() const
{
    return m_Subject;
}

void MailBlockClickHouse::setSubject(std::string value)
{
    
    m_Subject = std::move(value);
}
std::string MailBlockClickHouse::getTo() const
{
    return m_To;
}

void MailBlockClickHouse::setTo(std::string value)
{
    
    m_To = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailBlockClickHouse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailBlockClickHouse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailBlockClickHouse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailBlockClickHouse>>>::fromJsonValue(boost::json::parse(json));
}
