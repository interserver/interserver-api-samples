...
ServerNetworkInfo_switchports::ServerNetworkInfo_switchports(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerNetworkInfo_switchports::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerNetworkInfo_switchports::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerNetworkInfo_switchports::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerNetworkInfo_switchports::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerNetworkInfo_switchports");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerNetworkInfo_switchports::toJsonObject_internal() const
{
    boost::json::object object;
        object["10414"] = JsonValueConverter<std::shared_ptr<ServerSwitchport>>::toJsonValue(getR10414());
    return object;
}

void ServerNetworkInfo_switchports::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto r_10414It = object.find("10414");
        if (r_10414It != object.end()) {
            setR10414(JsonValueConverter<std::shared_ptr<ServerSwitchport>>::fromJsonValue(r_10414It->value()));
        }
    }
}

std::shared_ptr<ServerSwitchport> ServerNetworkInfo_switchports::getR10414() const
{
    return m_r_10414;
}

void ServerNetworkInfo_switchports::setR10414(std::shared_ptr<ServerSwitchport> value)
{
    
    m_r_10414 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerNetworkInfo_switchports>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerNetworkInfo_switchports>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerNetworkInfo_switchports>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerNetworkInfo_switchports>>>::fromJsonValue(boost::json::parse(json));
}
