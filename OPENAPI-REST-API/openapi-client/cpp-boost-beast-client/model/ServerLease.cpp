...
ServerLease::ServerLease(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerLease::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerLease::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerLease::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerLease::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerLease");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerLease::toJsonObject_internal() const
{
    boost::json::object object;
        object["mac"] = JsonValueConverter<std::string>::toJsonValue(getMac());
        object["authenticated"] = JsonValueConverter<bool>::toJsonValue(isAuthenticated());
        object["group"] = JsonValueConverter<std::string>::toJsonValue(getGroup());
    return object;
}

void ServerLease::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    {
        const auto AuthenticatedIt = object.find("authenticated");
        if (AuthenticatedIt != object.end()) {
            setAuthenticated(JsonValueConverter<bool>::fromJsonValue(AuthenticatedIt->value()));
        }
    }
    {
...
std::string ServerLease::getMac() const
{
    return m_Mac;
}

void ServerLease::setMac(std::string value)
{
...
void ServerLease::setAuthenticated(bool value)
{
    ...
    m_Authenticated = std::move(value);
}
std::string ServerLease::getGroup() const
{
    return m_Group;
}

void ServerLease::setGroup(std::string value)
{
    
    m_Group = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerLease>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerLease>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerLease>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerLease>>>::fromJsonValue(boost::json::parse(json));
}
