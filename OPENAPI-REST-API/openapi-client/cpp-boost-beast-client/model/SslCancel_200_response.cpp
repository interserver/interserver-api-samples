...
SslCancel_200_response::SslCancel_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SslCancel_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void SslCancel_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value SslCancel_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SslCancel_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SslCancel_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SslCancel_200_response::toJsonObject_internal() const
{
...
void SslCancel_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
bool SslCancel_200_response::isSuccess() const
{
    return m_Success;
}

void SslCancel_200_response::setSuccess(bool value)
{
    
    m_Success = std::move(value);
}
std::string SslCancel_200_response::getText() const
{
    return m_Text;
}

void SslCancel_200_response::setText(std::string value)
{
    
    m_Text = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SslCancel_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SslCancel_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SslCancel_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SslCancel_200_response>>>::fromJsonValue(boost::json::parse(json));
}
