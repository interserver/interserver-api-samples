...
AddServer_200_response::AddServer_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string AddServer_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void AddServer_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value AddServer_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void AddServer_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for AddServer_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object AddServer_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_InvoiceIsSet) {
            object["invoice"] = JsonValueConverter<int32_t>::toJsonValue(getInvoice());
        }
        if (m_OrderIsSet) {
...
void AddServer_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    m_TextIsSet = false;
    ...
    {
        const auto InvoiceIt = object.find("invoice");
        if (InvoiceIt != object.end()) {
            setInvoice(JsonValueConverter<int32_t>::fromJsonValue(InvoiceIt->value()));
        }
    }
    {
...
std::string AddServer_200_response::getText() const
{
    return m_Text;
}

void AddServer_200_response::setText(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<AddServer_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<AddServer_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<AddServer_200_response>>>::fromJsonValue(boost::json::parse(json));
}
