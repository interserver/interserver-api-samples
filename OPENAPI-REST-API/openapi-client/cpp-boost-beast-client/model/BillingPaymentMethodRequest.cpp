...
BillingPaymentMethodRequest::BillingPaymentMethodRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string BillingPaymentMethodRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void BillingPaymentMethodRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value BillingPaymentMethodRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BillingPaymentMethodRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BillingPaymentMethodRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BillingPaymentMethodRequest::toJsonObject_internal() const
{
...
void BillingPaymentMethodRequest::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string BillingPaymentMethodRequest::getPaymentMethod() const
{
    return m_Payment_method;
}

void BillingPaymentMethodRequest::setPaymentMethod(std::string value)
{
    
    m_Payment_method = std::move(value);
    m_Payment_methodIsSet = true;
}
std::string BillingPaymentMethodRequest::getCcAuto() const
{
    return m_Cc_auto;
}

void BillingPaymentMethodRequest::setCcAuto(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<BillingPaymentMethodRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BillingPaymentMethodRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BillingPaymentMethodRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BillingPaymentMethodRequest>>>::fromJsonValue(boost::json::parse(json));
}
