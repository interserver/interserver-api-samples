...
DomainNameserverGetResponse::DomainNameserverGetResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DomainNameserverGetResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void DomainNameserverGetResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DomainNameserverGetResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DomainNameserverGetResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DomainNameserverGetResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DomainNameserverGetResponse::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void DomainNameserverGetResponse::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DomainNameserverGetResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DomainNameserverGetResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DomainNameserverGetResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DomainNameserverGetResponse>>>::fromJsonValue(boost::json::parse(json));
}
