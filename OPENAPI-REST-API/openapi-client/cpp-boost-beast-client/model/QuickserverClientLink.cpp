...
QuickserverClientLink::QuickserverClientLink(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverClientLink::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverClientLink::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverClientLink::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverClientLink::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverClientLink");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverClientLink::toJsonObject_internal() const
{
...
void QuickserverClientLink::fromJsonObject_internal(boost::json::object const& object)
{
    m_LabelIsSet = false;
    m_LinkIsSet = false;
    m_IconIsSet = false;
...
std::string QuickserverClientLink::getLabel() const
{
    return m_Label;
}

void QuickserverClientLink::setLabel(std::string value)
{
    
    m_Label = std::move(value);
    m_LabelIsSet = true;
}
std::string QuickserverClientLink::getLink() const
{
    return m_Link;
}

void QuickserverClientLink::setLink(std::string value)
{
    
    m_Link = std::move(value);
    m_LinkIsSet = true;
}
std::string QuickserverClientLink::getIcon() const
{
    return m_Icon;
}

void QuickserverClientLink::setIcon(std::string value)
{
    
    m_Icon = std::move(value);
    m_IconIsSet = true;
}
std::string QuickserverClientLink::getIconText() const
{
    return m_Icon_text;
}

void QuickserverClientLink::setIconText(std::string value)
{
    
    m_Icon_text = std::move(value);
    m_Icon_textIsSet = true;
}
std::string QuickserverClientLink::getHelpText() const
{
    return m_Help_text;
}

void QuickserverClientLink::setHelpText(std::string value)
{
    
    m_Help_text = std::move(value);
    m_Help_textIsSet = true;
}
std::string QuickserverClientLink::getOtherAttr() const
{
    return m_Other_attr;
}

void QuickserverClientLink::setOtherAttr(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverClientLink>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverClientLink>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverClientLink>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverClientLink>>>::fromJsonValue(boost::json::parse(json));
}
