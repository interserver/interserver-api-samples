...
MailAttachment::MailAttachment(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailAttachment::toJsonString(bool prettyJson /* = false */) const
{
...
void MailAttachment::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailAttachment::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailAttachment::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailAttachment");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailAttachment::toJsonObject_internal() const
{
...
void MailAttachment::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string MailAttachment::getFilename() const
{
    return m_Filename;
}

void MailAttachment::setFilename(std::string value)
{
    
    m_Filename = std::move(value);
}
std::string MailAttachment::getData() const
{
    return m_Data;
}

void MailAttachment::setData(std::string value)
{
    
    m_Data = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailAttachment>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailAttachment>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailAttachment>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailAttachment>>>::fromJsonValue(boost::json::parse(json));
}
