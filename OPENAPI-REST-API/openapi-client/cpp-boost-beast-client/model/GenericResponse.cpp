...
GenericResponse::GenericResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GenericResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void GenericResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GenericResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GenericResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GenericResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GenericResponse::toJsonObject_internal() const
{
...
void GenericResponse::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string GenericResponse::getStatus() const
{
    return m_Status;
}

void GenericResponse::setStatus(std::string value)
{
    
    m_Status = std::move(value);
}
std::string GenericResponse::getText() const
{
    return m_Text;
}

void GenericResponse::setText(std::string value)
{
    
    m_Text = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<GenericResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GenericResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<GenericResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GenericResponse>>>::fromJsonValue(boost::json::parse(json));
}
