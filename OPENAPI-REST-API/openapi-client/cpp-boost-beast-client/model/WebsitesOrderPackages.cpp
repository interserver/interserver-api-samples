...
WebsitesOrderPackages::WebsitesOrderPackages(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsitesOrderPackages::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsitesOrderPackages::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsitesOrderPackages::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsitesOrderPackages::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsitesOrderPackages");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsitesOrderPackages::toJsonObject_internal() const
{
...
void WebsitesOrderPackages::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string WebsitesOrderPackages::getR11447() const
{
    return m_r_11447;
}

void WebsitesOrderPackages::setR11447(std::string value)
{
    
    m_r_11447 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WebsitesOrderPackages>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderPackages>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsitesOrderPackages>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderPackages>>>::fromJsonValue(boost::json::parse(json));
}
