...
DomainNameserverPutRequest::DomainNameserverPutRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DomainNameserverPutRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void DomainNameserverPutRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DomainNameserverPutRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DomainNameserverPutRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DomainNameserverPutRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object DomainNameserverPutRequest::toJsonObject_internal() const
{
    boost::json::object object;
        object["nameserver"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getNameserver());
    return object;
}

void DomainNameserverPutRequest::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto NameserverIt = object.find("nameserver");
        if (NameserverIt != object.end()) {
            setNameserver(JsonValueConverter<std::vector<std::string>>::fromJsonValue(NameserverIt->value()));
        }
    }
}

std::vector<std::string> DomainNameserverPutRequest::getNameserver() const
{
    return m_Nameserver;
}

void DomainNameserverPutRequest::setNameserver(std::vector<std::string> value)
{
    
    m_Nameserver = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<DomainNameserverPutRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DomainNameserverPutRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DomainNameserverPutRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DomainNameserverPutRequest>>>::fromJsonValue(boost::json::parse(json));
}
