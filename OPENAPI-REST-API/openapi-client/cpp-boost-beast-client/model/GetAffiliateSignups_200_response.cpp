...
GetAffiliateSignups_200_response::GetAffiliateSignups_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string GetAffiliateSignups_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void GetAffiliateSignups_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value GetAffiliateSignups_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void GetAffiliateSignups_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for GetAffiliateSignups_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object GetAffiliateSignups_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_DataIsSet) {
            object["data"] = JsonValueConverter<boost::json::value>::toJsonValue(getData());
        }
    return object;
}

void GetAffiliateSignups_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    m_DataIsSet = false;
    {
        const auto DataIt = object.find("data");
        if (DataIt != object.end()) {
            setData(JsonValueConverter<boost::json::value>::fromJsonValue(DataIt->value()));
        }
    }
}

boost::json::value GetAffiliateSignups_200_response::getData() const
{
    return m_Data;
}

void GetAffiliateSignups_200_response::setData(boost::json::value value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<GetAffiliateSignups_200_response>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<GetAffiliateSignups_200_response>>>::fromJsonValue(boost::json::parse(json));
}
