...
PostWebsiteMigration_200_response::PostWebsiteMigration_200_response(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PostWebsiteMigration_200_response::toJsonString(bool prettyJson /* = false */) const
{
...
void PostWebsiteMigration_200_response::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PostWebsiteMigration_200_response::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PostWebsiteMigration_200_response::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PostWebsiteMigration_200_response");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PostWebsiteMigration_200_response::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_TicketIsSet) {
            object["ticket"] = JsonValueConverter<int32_t>::toJsonValue(getTicket());
        }
    return object;
}

void PostWebsiteMigration_200_response::fromJsonObject_internal(boost::json::object const& object)
{
    m_TextIsSet = false;
    m_TicketIsSet = false;
    {
    ...
    }
    {
        ...
        if (TicketIt != object.end()) {
            setTicket(JsonValueConverter<int32_t>::fromJsonValue(TicketIt->value()));
        }
    }
}

std::string PostWebsiteMigration_200_response::getText() const
{
    return m_Text;
}

void PostWebsiteMigration_200_response::setText(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PostWebsiteMigration_200_response>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PostWebsiteMigration_200_response>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PostWebsiteMigration_200_response>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PostWebsiteMigration_200_response>>>::fromJsonValue(boost::json::parse(json));
}
