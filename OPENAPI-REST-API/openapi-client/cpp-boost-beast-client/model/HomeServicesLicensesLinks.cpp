...
HomeServicesLicensesLinks::HomeServicesLicensesLinks(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string HomeServicesLicensesLinks::toJsonString(bool prettyJson /* = false */) const
{
...
void HomeServicesLicensesLinks::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value HomeServicesLicensesLinks::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void HomeServicesLicensesLinks::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for HomeServicesLicensesLinks");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object HomeServicesLicensesLinks::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_386522IsSet) {
            object["386522"] = JsonValueConverter<std::string>::toJsonValue(getR386522());
        }
    return object;
}

void HomeServicesLicensesLinks::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_386522IsSet = false;
    {
        const auto r_386522It = object.find("386522");
        if (r_386522It != object.end()) {
            setR386522(JsonValueConverter<std::string>::fromJsonValue(r_386522It->value()));
        }
    }
}

std::string HomeServicesLicensesLinks::getR386522() const
{
    return m_r_386522;
}

void HomeServicesLicensesLinks::setR386522(std::string value)
{
    
    m_r_386522 = std::move(value);
    m_r_386522IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<HomeServicesLicensesLinks>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<HomeServicesLicensesLinks>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<HomeServicesLicensesLinks>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<HomeServicesLicensesLinks>>>::fromJsonValue(boost::json::parse(json));
}
