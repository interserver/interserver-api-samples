...
UpdateAccountTfa_request::UpdateAccountTfa_request(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string UpdateAccountTfa_request::toJsonString(bool prettyJson /* = false */) const
{
...
void UpdateAccountTfa_request::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value UpdateAccountTfa_request::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void UpdateAccountTfa_request::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for UpdateAccountTfa_request");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object UpdateAccountTfa_request::toJsonObject_internal() const
{
    boost::json::object object;
        object["2fa_google_code"] = JsonValueConverter<std::string>::toJsonValue(getR2faGoogleCode());
    return object;
}

void UpdateAccountTfa_request::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto r_2fa_google_codeIt = object.find("2fa_google_code");
        if (r_2fa_google_codeIt != object.end()) {
            setR2faGoogleCode(JsonValueConverter<std::string>::fromJsonValue(r_2fa_google_codeIt->value()));
        }
    }
}

std::string UpdateAccountTfa_request::getR2faGoogleCode() const
{
    return m_r_2fa_google_code;
}

void UpdateAccountTfa_request::setR2faGoogleCode(std::string value)
{
    
    m_r_2fa_google_code = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<UpdateAccountTfa_request>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<UpdateAccountTfa_request>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<UpdateAccountTfa_request>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<UpdateAccountTfa_request>>>::fromJsonValue(boost::json::parse(json));
}
