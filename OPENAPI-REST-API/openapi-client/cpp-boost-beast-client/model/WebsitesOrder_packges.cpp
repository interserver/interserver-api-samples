...
WebsitesOrder_packges::WebsitesOrder_packges(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsitesOrder_packges::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsitesOrder_packges::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsitesOrder_packges::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsitesOrder_packges::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsitesOrder_packges");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsitesOrder_packges::toJsonObject_internal() const
{
    boost::json::object object;
        object["11440"] = JsonValueConverter<std::shared_ptr<WebsitesOrderPackagesInfo>>::toJsonValue(getR11440());
    return object;
}

void WebsitesOrder_packges::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto r_11440It = object.find("11440");
        if (r_11440It != object.end()) {
            setR11440(JsonValueConverter<std::shared_ptr<WebsitesOrderPackagesInfo>>::fromJsonValue(r_11440It->value()));
        }
    }
}

std::shared_ptr<WebsitesOrderPackagesInfo> WebsitesOrder_packges::getR11440() const
{
    return m_r_11440;
}

void WebsitesOrder_packges::setR11440(std::shared_ptr<WebsitesOrderPackagesInfo> value)
{
    
    m_r_11440 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<WebsitesOrder_packges>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrder_packges>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsitesOrder_packges>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrder_packges>>>::fromJsonValue(boost::json::parse(json));
}
