...
Home_services_domains::Home_services_domains(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Home_services_domains::toJsonString(bool prettyJson /* = false */) const
{
...
void Home_services_domains::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Home_services_domains::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Home_services_domains::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Home_services_domains");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Home_services_domains::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_LinksIsSet) {
            object["links"] = JsonValueConverter<std::shared_ptr<HomeServicesDomainsLinks>>::toJsonValue(getLinks());
        }
        if (m_CountIsSet) {
...
void Home_services_domains::fromJsonObject_internal(boost::json::object const& object)
{
    m_LinksIsSet = false;
    m_CountIsSet = false;
    {
        ...
        if (LinksIt != object.end()) {
            setLinks(JsonValueConverter<std::shared_ptr<HomeServicesDomainsLinks>>::fromJsonValue(LinksIt->value()));
        }
    }
    {
...
std::shared_ptr<HomeServicesDomainsLinks> Home_services_domains::getLinks() const
{
    return m_Links;
}

void Home_services_domains::setLinks(std::shared_ptr<HomeServicesDomainsLinks> value)
{
    
    m_Links = std::move(value);
    m_LinksIsSet = true;
}
int32_t Home_services_domains::getCount() const
{
    return m_Count;
}

void Home_services_domains::setCount(int32_t value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Home_services_domains>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Home_services_domains>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Home_services_domains>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Home_services_domains>>>::fromJsonValue(boost::json::parse(json));
}
