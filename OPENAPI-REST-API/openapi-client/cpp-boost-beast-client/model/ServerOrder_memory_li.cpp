...
ServerOrder_memory_li::ServerOrder_memory_li(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerOrder_memory_li::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerOrder_memory_li::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerOrder_memory_li::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerOrder_memory_li::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerOrder_memory_li");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerOrder_memory_li::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_r_254IsSet) {
            object["254"] = JsonValueConverter<std::shared_ptr<ServerOrder_memory_li_254>>::toJsonValue(getR254());
        }
    return object;
}

void ServerOrder_memory_li::fromJsonObject_internal(boost::json::object const& object)
{
    m_r_254IsSet = false;
    {
        const auto r_254It = object.find("254");
        if (r_254It != object.end()) {
            setR254(JsonValueConverter<std::shared_ptr<ServerOrder_memory_li_254>>::fromJsonValue(r_254It->value()));
        }
    }
}
...
void ServerOrder_memory_li::setR254(std::shared_ptr<ServerOrder_memory_li_254> value)
{
    
    m_r_254 = std::move(value);
    m_r_254IsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerOrder_memory_li>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_memory_li>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerOrder_memory_li>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerOrder_memory_li>>>::fromJsonValue(boost::json::parse(json));
}
