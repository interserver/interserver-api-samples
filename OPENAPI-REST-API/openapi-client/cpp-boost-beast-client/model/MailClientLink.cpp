...
MailClientLink::MailClientLink(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailClientLink::toJsonString(bool prettyJson /* = false */) const
{
...
void MailClientLink::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailClientLink::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailClientLink::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailClientLink");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailClientLink::toJsonObject_internal() const
{
...
void MailClientLink::fromJsonObject_internal(boost::json::object const& object)
{
    m_LabelIsSet = false;
    m_LinkIsSet = false;
    m_IconIsSet = false;
...
std::string MailClientLink::getLabel() const
{
    return m_Label;
}

void MailClientLink::setLabel(std::string value)
{
    
    m_Label = std::move(value);
    m_LabelIsSet = true;
}
std::string MailClientLink::getLink() const
{
    return m_Link;
}

void MailClientLink::setLink(std::string value)
{
    
    m_Link = std::move(value);
    m_LinkIsSet = true;
}
std::string MailClientLink::getIcon() const
{
    return m_Icon;
}

void MailClientLink::setIcon(std::string value)
{
    
    m_Icon = std::move(value);
    m_IconIsSet = true;
}
std::string MailClientLink::getIconText() const
{
    return m_Icon_text;
}

void MailClientLink::setIconText(std::string value)
{
    
    m_Icon_text = std::move(value);
    m_Icon_textIsSet = true;
}
std::string MailClientLink::getHelpText() const
{
    return m_Help_text;
}

void MailClientLink::setHelpText(std::string value)
{
    
    m_Help_text = std::move(value);
    m_Help_textIsSet = true;
}
std::string MailClientLink::getOtherAttr() const
{
    return m_Other_attr;
}

void MailClientLink::setOtherAttr(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailClientLink>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailClientLink>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailClientLink>>>::fromJsonValue(boost::json::parse(json));
}
