...
MailOrderRequest::MailOrderRequest(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailOrderRequest::toJsonString(bool prettyJson /* = false */) const
{
...
void MailOrderRequest::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailOrderRequest::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailOrderRequest::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailOrderRequest");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailOrderRequest::toJsonObject_internal() const
{
...
void MailOrderRequest::fromJsonObject_internal(boost::json::object const& object)
{
    m_CouponIsSet = false;
...
int32_t MailOrderRequest::getServiceType() const
{
    return m_ServiceType;
}

void MailOrderRequest::setServiceType(int32_t value)
{
    
    m_ServiceType = std::move(value);
}
std::string MailOrderRequest::getCoupon() const
{
    return m_Coupon;
}

void MailOrderRequest::setCoupon(std::string value)
{
    
    m_Coupon = std::move(value);
    m_CouponIsSet = true;
}
std::string MailOrderRequest::getComment() const
{
    return m_Comment;
}

void MailOrderRequest::setComment(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailOrderRequest>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailOrderRequest>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailOrderRequest>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailOrderRequest>>>::fromJsonValue(boost::json::parse(json));
}
