...
VpsTrafficDataSectionResponse::VpsTrafficDataSectionResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VpsTrafficDataSectionResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void VpsTrafficDataSectionResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VpsTrafficDataSectionResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VpsTrafficDataSectionResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VpsTrafficDataSectionResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VpsTrafficDataSectionResponse::toJsonObject_internal() const
{
    boost::json::object object;
        object["name"] = JsonValueConverter<std::string>::toJsonValue(getName());
        object["data"] = JsonValueConverter<std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse>>>::toJsonValue(getData());
    return object;
}

void VpsTrafficDataSectionResponse::fromJsonObject_internal(boost::json::object const& object)
{
    {
    ...
    }
    {
        ...
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse>>>::fromJsonValue(DataIt->value()));
        }
    }
}

std::string VpsTrafficDataSectionResponse::getName() const
{
    return m_Name;
}

void VpsTrafficDataSectionResponse::setName(std::string value)
{
    
    m_Name = std::move(value);
}
std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse>> VpsTrafficDataSectionResponse::getData() const
{
    return m_Data;
}

void VpsTrafficDataSectionResponse::setData(std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse>> value)
{
    
    m_Data = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VpsTrafficDataSectionResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VpsTrafficDataSectionResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VpsTrafficDataSectionResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VpsTrafficDataSectionResponse>>>::fromJsonValue(boost::json::parse(json));
}
