...
ReverseDnsEntries::ReverseDnsEntries(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ReverseDnsEntries::toJsonString(bool prettyJson /* = false */) const
{
...
void ReverseDnsEntries::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ReverseDnsEntries::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ReverseDnsEntries::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ReverseDnsEntries");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ReverseDnsEntries::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_IpsIsSet) {
            object["ips"] = JsonValueConverter<std::map<std::string, boost::json::value>>::toJsonValue(getIps());
        }
    return object;
}

void ReverseDnsEntries::fromJsonObject_internal(boost::json::object const& object)
{
    m_IpsIsSet = false;
    {
        const auto IpsIt = object.find("ips");
        if (IpsIt != object.end()) {
            setIps(JsonValueConverter<std::map<std::string, boost::json::value>>::fromJsonValue(IpsIt->value()));
        }
    }
}

std::map<std::string, boost::json::value> ReverseDnsEntries::getIps() const
{
    return m_Ips;
}

void ReverseDnsEntries::setIps(std::map<std::string, boost::json::value> value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ReverseDnsEntries>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ReverseDnsEntries>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ReverseDnsEntries>>>::fromJsonValue(boost::json::parse(json));
}
