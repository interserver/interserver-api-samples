...
VPSTrafficDataDataSectionResponse::VPSTrafficDataDataSectionResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string VPSTrafficDataDataSectionResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void VPSTrafficDataDataSectionResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value VPSTrafficDataDataSectionResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void VPSTrafficDataDataSectionResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for VPSTrafficDataDataSectionResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object VPSTrafficDataDataSectionResponse::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void VPSTrafficDataDataSectionResponse::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<VPSTrafficDataDataSectionResponse>>>::fromJsonValue(boost::json::parse(json));
}
