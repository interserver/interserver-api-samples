...
DenyRuleRecord::DenyRuleRecord(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string DenyRuleRecord::toJsonString(bool prettyJson /* = false */) const
{
...
void DenyRuleRecord::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value DenyRuleRecord::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void DenyRuleRecord::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for DenyRuleRecord");
    }
...
std::string DenyRuleRecord::getData() const
{
    return m_Data;
}

void DenyRuleRecord::setData(std::string value)
{
...
std::string DenyRuleRecord::getCreated() const
{
    return m_Created;
}

void DenyRuleRecord::setCreated(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<DenyRuleRecord>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<DenyRuleRecord>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<DenyRuleRecord>>>::fromJsonValue(boost::json::parse(json));
}
