...
LicenseClientLink::LicenseClientLink(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string LicenseClientLink::toJsonString(bool prettyJson /* = false */) const
{
...
void LicenseClientLink::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value LicenseClientLink::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void LicenseClientLink::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for LicenseClientLink");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object LicenseClientLink::toJsonObject_internal() const
{
...
void LicenseClientLink::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string LicenseClientLink::getLabel() const
{
    return m_Label;
}

void LicenseClientLink::setLabel(std::string value)
{
    
    m_Label = std::move(value);
}
std::string LicenseClientLink::getLink() const
{
    return m_Link;
}

void LicenseClientLink::setLink(std::string value)
{
    
    m_Link = std::move(value);
}
std::string LicenseClientLink::getIcon() const
{
    return m_Icon;
}

void LicenseClientLink::setIcon(std::string value)
{
...
void LicenseClientLink::setIconText(std::string value)
{
...
void LicenseClientLink::setOtherAttr(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<LicenseClientLink>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<LicenseClientLink>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<LicenseClientLink>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<LicenseClientLink>>>::fromJsonValue(boost::json::parse(json));
}
