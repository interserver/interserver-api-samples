...
WebsitesOrderPackagesInfo::WebsitesOrderPackagesInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string WebsitesOrderPackagesInfo::toJsonString(bool prettyJson /* = false */) const
{
...
void WebsitesOrderPackagesInfo::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value WebsitesOrderPackagesInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void WebsitesOrderPackagesInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for WebsitesOrderPackagesInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object WebsitesOrderPackagesInfo::toJsonObject_internal() const
{
...
void WebsitesOrderPackagesInfo::fromJsonObject_internal(boost::json::object const& object)
{
...
std::string WebsitesOrderPackagesInfo::getServicesId() const
{
    return m_Services_id;
}

void WebsitesOrderPackagesInfo::setServicesId(std::string value)
{
    
    m_Services_id = std::move(value);
}
std::string WebsitesOrderPackagesInfo::getServicesName() const
{
    return m_Services_name;
}

void WebsitesOrderPackagesInfo::setServicesName(std::string value)
{
    
    m_Services_name = std::move(value);
}
std::string WebsitesOrderPackagesInfo::getServicesCost() const
{
    return m_Services_cost;
}

void WebsitesOrderPackagesInfo::setServicesCost(std::string value)
{
    
    m_Services_cost = std::move(value);
}
std::string WebsitesOrderPackagesInfo::getServicesCategory() const
{
    return m_Services_category;
}

void WebsitesOrderPackagesInfo::setServicesCategory(std::string value)
{
    
    m_Services_category = std::move(value);
}
std::string WebsitesOrderPackagesInfo::getServicesBuyable() const
{
    return m_Services_buyable;
}

void WebsitesOrderPackagesInfo::setServicesBuyable(std::string value)
{
    
    m_Services_buyable = std::move(value);
}
std::string WebsitesOrderPackagesInfo::getServicesType() const
{
    return m_Services_type;
}

void WebsitesOrderPackagesInfo::setServicesType(std::string value)
{
...
void WebsitesOrderPackagesInfo::setServicesField1(std::string value)
{
    
    m_Services_field1 = std::move(value);
    m_Services_field1IsSet = true;
}
std::string WebsitesOrderPackagesInfo::getServicesField2() const
{
    return m_Services_field2;
}

void WebsitesOrderPackagesInfo::setServicesField2(std::string value)
{
...
void WebsitesOrderPackagesInfo::setServicesHtml(std::string value)
{
...
void WebsitesOrderPackagesInfo::setServicesMoreinfoUrl(std::string value)
{
    
    m_Services_moreinfo_url = std::move(value);
    m_Services_moreinfo_urlIsSet = true;
}
std::string WebsitesOrderPackagesInfo::getServicesHidden() const
{
    return m_Services_hidden;
}

void WebsitesOrderPackagesInfo::setServicesHidden(std::string value)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderPackagesInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<WebsitesOrderPackagesInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<WebsitesOrderPackagesInfo>>>::fromJsonValue(boost::json::parse(json));
}
