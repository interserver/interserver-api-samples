...
PatchOauthTwoFactor_request::PatchOauthTwoFactor_request(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string PatchOauthTwoFactor_request::toJsonString(bool prettyJson /* = false */) const
{
...
void PatchOauthTwoFactor_request::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value PatchOauthTwoFactor_request::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void PatchOauthTwoFactor_request::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for PatchOauthTwoFactor_request");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object PatchOauthTwoFactor_request::toJsonObject_internal() const
{
...
void PatchOauthTwoFactor_request::fromJsonObject_internal(boost::json::object const& object)
{
    {
...
std::string PatchOauthTwoFactor_request::getCode() const
{
    return m_Code;
}

void PatchOauthTwoFactor_request::setCode(std::string value)
{
    
    m_Code = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<PatchOauthTwoFactor_request>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<PatchOauthTwoFactor_request>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<PatchOauthTwoFactor_request>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<PatchOauthTwoFactor_request>>>::fromJsonValue(boost::json::parse(json));
}
