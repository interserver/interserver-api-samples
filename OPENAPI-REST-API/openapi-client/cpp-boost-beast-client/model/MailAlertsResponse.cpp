...
MailAlertsResponse::MailAlertsResponse(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string MailAlertsResponse::toJsonString(bool prettyJson /* = false */) const
{
...
void MailAlertsResponse::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value MailAlertsResponse::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void MailAlertsResponse::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for MailAlertsResponse");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object MailAlertsResponse::toJsonObject_internal() const
{
    boost::json::object object;
    return object;
}

void MailAlertsResponse::fromJsonObject_internal(boost::json::object const& object)
{
}


std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<MailAlertsResponse>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<MailAlertsResponse>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<MailAlertsResponse>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<MailAlertsResponse>>>::fromJsonValue(boost::json::parse(json));
}
