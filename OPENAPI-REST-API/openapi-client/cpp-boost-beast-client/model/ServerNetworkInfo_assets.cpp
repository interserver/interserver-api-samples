...
ServerNetworkInfo_assets::ServerNetworkInfo_assets(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ServerNetworkInfo_assets::toJsonString(bool prettyJson /* = false */) const
{
...
void ServerNetworkInfo_assets::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ServerNetworkInfo_assets::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ServerNetworkInfo_assets::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ServerNetworkInfo_assets");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ServerNetworkInfo_assets::toJsonObject_internal() const
{
    boost::json::object object;
        object["3497"] = JsonValueConverter<std::shared_ptr<ServerAsset>>::toJsonValue(getR3497());
    return object;
}

void ServerNetworkInfo_assets::fromJsonObject_internal(boost::json::object const& object)
{
    {
        const auto r_3497It = object.find("3497");
        if (r_3497It != object.end()) {
            setR3497(JsonValueConverter<std::shared_ptr<ServerAsset>>::fromJsonValue(r_3497It->value()));
        }
    }
}
...
void ServerNetworkInfo_assets::setR3497(std::shared_ptr<ServerAsset> value)
{
    
    m_r_3497 = std::move(value);
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ServerNetworkInfo_assets>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ServerNetworkInfo_assets>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ServerNetworkInfo_assets>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ServerNetworkInfo_assets>>>::fromJsonValue(boost::json::parse(json));
}
