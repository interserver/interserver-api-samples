...
Home_services_vps::Home_services_vps(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string Home_services_vps::toJsonString(bool prettyJson /* = false */) const
{
...
void Home_services_vps::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value Home_services_vps::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Home_services_vps::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Home_services_vps");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Home_services_vps::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_LinksIsSet) {
            object["links"] = JsonValueConverter<std::shared_ptr<HomeServicesVpsLinks>>::toJsonValue(getLinks());
        }
        if (m_CountIsSet) {
...
void Home_services_vps::fromJsonObject_internal(boost::json::object const& object)
{
    m_LinksIsSet = false;
    m_CountIsSet = false;
    {
        ...
        if (LinksIt != object.end()) {
            setLinks(JsonValueConverter<std::shared_ptr<HomeServicesVpsLinks>>::fromJsonValue(LinksIt->value()));
        }
    }
    {
...
void Home_services_vps::setLinks(std::shared_ptr<HomeServicesVpsLinks> value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Home_services_vps>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Home_services_vps>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Home_services_vps>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Home_services_vps>>>::fromJsonValue(boost::json::parse(json));
}
