...
ScrubIpFilterTypes_filters_value::ScrubIpFilterTypes_filters_value(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string ScrubIpFilterTypes_filters_value::toJsonString(bool prettyJson /* = false */) const
{
...
void ScrubIpFilterTypes_filters_value::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value ScrubIpFilterTypes_filters_value::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void ScrubIpFilterTypes_filters_value::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for ScrubIpFilterTypes_filters_value");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object ScrubIpFilterTypes_filters_value::toJsonObject_internal() const
{
...
void ScrubIpFilterTypes_filters_value::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_DescIsSet = false;
    {
...
std::string ScrubIpFilterTypes_filters_value::getName() const
{
    return m_Name;
}

void ScrubIpFilterTypes_filters_value::setName(std::string value)
{
    
    m_Name = std::move(value);
    m_NameIsSet = true;
}
std::string ScrubIpFilterTypes_filters_value::getDesc() const
{
    return m_Desc;
}

void ScrubIpFilterTypes_filters_value::setDesc(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<ScrubIpFilterTypes_filters_value>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<ScrubIpFilterTypes_filters_value>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<ScrubIpFilterTypes_filters_value>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<ScrubIpFilterTypes_filters_value>>>::fromJsonValue(boost::json::parse(json));
}
