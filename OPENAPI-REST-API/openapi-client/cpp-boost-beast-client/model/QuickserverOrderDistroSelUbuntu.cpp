...
QuickserverOrderDistroSelUbuntu::QuickserverOrderDistroSelUbuntu(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string QuickserverOrderDistroSelUbuntu::toJsonString(bool prettyJson /* = false */) const
{
...
void QuickserverOrderDistroSelUbuntu::fromJsonString(std::string const& jsonString)
{
    fromJsonValue(boost::json::parse(jsonString));
}

boost::json::value QuickserverOrderDistroSelUbuntu::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void QuickserverOrderDistroSelUbuntu::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for QuickserverOrderDistroSelUbuntu");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object QuickserverOrderDistroSelUbuntu::toJsonObject_internal() const
{
...
void QuickserverOrderDistroSelUbuntu::fromJsonObject_internal(boost::json::object const& object)
{
    m_UbuntuIsSet = false;
    {
...
std::string QuickserverOrderDistroSelUbuntu::getUbuntu() const
{
    return m_Ubuntu;
}

void QuickserverOrderDistroSelUbuntu::setUbuntu(std::string value)
{
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<QuickserverOrderDistroSelUbuntu>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrderDistroSelUbuntu>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<QuickserverOrderDistroSelUbuntu>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<QuickserverOrderDistroSelUbuntu>>>::fromJsonValue(boost::json::parse(json));
}
