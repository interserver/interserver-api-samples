...
open class BillingAPI {
    ...
    ///
    public enum GetAffiliateDownloadEx: String, Codable, CaseIterable {
        case csv = "csv"
        case xls = "xls"
        case xlsx = "xlsx"
        case pdf = "pdf"
    }
    public enum GetAffiliateDownloadError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "GetAffiliateDownloadError: Unauthorized: \(object)"
            }
        }
    }
    ...
    open func getAffiliateDownload(st: String? = nil, ex: GetAffiliateDownloadEx? = nil, year: Int? = nil) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                ...
                if let ex = ex { queryItems.append(URLQueryItem(name: "ex", value: ex.rawValue)) } 
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return GetAffiliateDownloadError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
    ...
    public enum GetAffiliateSignupsError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "GetAffiliateSignupsError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - returns: AnyPublisher<GetAffiliateSignups200Response, Error> 
    open func getAffiliateSignups(st: String? = nil) -> AnyPublisher<GetAffiliateSignups200Response, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
        ...
        }.flatMap { request -> AnyPublisher<GetAffiliateSignups200Response, Error> in 
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return GetAffiliateSignupsError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
                ...
                .tryMap { response in
                    try self.decoder.decode(GetAffiliateSignups200Response.self, from: response.data)
                }
                .eraseToAnyPublisher()
        }.eraseToAnyPublisher()
    }
    ...
    public enum PatchBillingCreditCardVerifyError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "PatchBillingCreditCardVerifyError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - returns: AnyPublisher<SuccessTextResponse, Error> 
    open func patchBillingCreditCardVerify(id: Int, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest) -> AnyPublisher<SuccessTextResponse, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                ...
                request.httpBody = try self.encoder.encode(patchBillingCreditCardVerifyRequest)
                request.setValue("application/json", forHTTPHeaderField: "Content-Type")
                return request
            }.publisher
        }.flatMap { request -> AnyPublisher<SuccessTextResponse, Error> in 
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return PatchBillingCreditCardVerifyError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
