...
open class PublicAPI {
    ...
    public enum GetAccountCurrenciesError: Error, CustomStringConvertible {
        // Unauthorized
        ...
        public var description: String {
            ...
            case .code401Error(let object):
                return "GetAccountCurrenciesError: Unauthorized: \(object)"
            }
        }
    }
    ...
    open func getAccountCurrencies() -> AnyPublisher<[String], Error> {
        Deferred {
                ...
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            ...
                            return GetAccountCurrenciesError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
    ...
    public enum GetAccountLocalesError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "GetAccountLocalesError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - type: apiKey sessionid (HEADER)
    /// - name: sessionIdHeaderAuth
    /// - returns: AnyPublisher<[String: GetAccountLocales200ResponseValue], Error> 
    open func getAccountLocales() -> AnyPublisher<[String: GetAccountLocales200ResponseValue], Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
        ...
        }.flatMap { request -> AnyPublisher<[String: GetAccountLocales200ResponseValue], Error> in 
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return GetAccountLocalesError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
                ...
                .tryMap { response in
                    try self.decoder.decode([String: GetAccountLocales200ResponseValue].self, from: response.data)
                }
                .eraseToAnyPublisher()
        }.eraseToAnyPublisher()
    }
