...
open class DomainsAPI {
    ...
    open func addDomain(domainOrderRequest: DomainOrderRequest) -> AnyPublisher<ServiceOrderPostResponse, Error> {
        Deferred {
            Result<URLRequest, Error> {
                ...
                request.httpBody = try self.encoder.encode(domainOrderRequest)
    ...
    /// - parameter id: (path) The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. 
    /// - returns: AnyPublisher<SuccessTextResponse, Error> 
    open func deleteDomainDnssec(id: Int) -> AnyPublisher<SuccessTextResponse, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
    ...
    open func patchDomains(domainOrderRequest: DomainOrderRequest) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
    ...
    public enum PostDomainSearchError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "PostDomainSearchError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - parameter name: (path) The base domain name to search (for example &#x60;example&#x60; or &#x60;example.com&#x60;). 
    /// - returns: AnyPublisher<Void, Error> 
    open func postDomainSearch(name: String) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return PostDomainSearchError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
    ...
    /// - parameter domainOrderRequest: (body)  
    /// - returns: AnyPublisher<Void, Error> 
    open func putDomains(domainOrderRequest: DomainOrderRequest) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
    ...
    /// - parameter id: (path) The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. 
    /// - returns: AnyPublisher<SuccessTextResponse, Error> 
    open func updateDomainInfo(id: Int) -> AnyPublisher<SuccessTextResponse, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
