...
open class WebhostingAPI {
    ...
    open func addWebsite(websiteOrderPostRequest: WebsiteOrderPostRequest) -> AnyPublisher<ServiceOrderPostResponse, Error> {
        Deferred {
            Result<URLRequest, Error> {
                ...
                request.httpBody = try self.encoder.encode(websiteOrderPostRequest)
    ...
    open func putWebsites(websiteOrderPutRequest: WebsiteOrderPutRequest) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
                ...
                request.httpBody = try self.encoder.encode(websiteOrderPutRequest)
                request.setValue("application/json", forHTTPHeaderField: "Content-Type")
                return request
            }.publisher
