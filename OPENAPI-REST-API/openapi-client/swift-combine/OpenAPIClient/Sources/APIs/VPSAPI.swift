...
open class VPSAPI {
    ...
    public enum GetVpsBackupError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "GetVpsBackupError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - parameter id: (path) VPS ID number 
    /// - returns: AnyPublisher<QueueResponse, Error> 
    open func getVpsBackup(id: Int) -> AnyPublisher<QueueResponse, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return GetVpsBackupError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
    ...
    public enum GetVpsChangeHostnameError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "GetVpsChangeHostnameError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - parameter id: (path) VPS ID number 
    /// - returns: AnyPublisher<Void, Error> 
    open func getVpsChangeHostname(id: Int) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return GetVpsChangeHostnameError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
    ...
    public enum GetVpsChangeRootPasswordError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "GetVpsChangeRootPasswordError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - parameter id: (path) VPS ID number 
    /// - returns: AnyPublisher<Void, Error> 
    open func getVpsChangeRootPassword(id: Int) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return GetVpsChangeRootPasswordError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
    ...
    public enum GetVpsInsertCdError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "GetVpsInsertCdError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - parameter id: (path) VPS ID number 
    /// - returns: AnyPublisher<Void, Error> 
    open func getVpsInsertCd(id: Int) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return GetVpsInsertCdError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
    ...
    public enum GetVpsResetPasswordError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "GetVpsResetPasswordError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - parameter id: (path) VPS ID number 
    /// - returns: AnyPublisher<Void, Error> 
    open func getVpsResetPassword(id: Int) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return GetVpsResetPasswordError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
    ...
    public enum PostVpsTrafficUsageError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "PostVpsTrafficUsageError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - parameter id: (path) VPS ID number 
    /// - returns: AnyPublisher<Void, Error> 
    open func postVpsTrafficUsage(id: Int) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return PostVpsTrafficUsageError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
    ...
    public enum PutVpsBuyHdSpaceError: Error, CustomStringConvertible {
        // Unauthorized
        case code401Error(GetAccountInfo401Response)
        ...
        public var description: String {
            switch self {
            case .code401Error(let object):
                return "PutVpsBuyHdSpaceError: Unauthorized: \(object)"
            }
        }
    }
    ...
    /// - parameter id: (path) VPS ID number 
    /// - returns: AnyPublisher<Void, Error> 
    open func putVpsBuyHdSpace(id: Int) -> AnyPublisher<Void, Error> {
        Deferred {
            Result<URLRequest, Error> {
                guard let baseURL = self.transport.baseURL ?? self.baseURL else {
                    throw OpenAPITransportError.badURLError()
            ...
            return self.transport.send(request: request)
                .mapError { transportError -> Error in 
                    if transportError.statusCode == 401 {
                        do {
                            let error = try self.decoder.decode(GetAccountInfo401Response.self, from: transportError.data)
                            return PutVpsBuyHdSpaceError.code401Error(error)
                        } catch {
                            return error
                        }
                    }
