...
type _ServiceOrderPostResponse ServiceOrderPostResponse
...
func (o *ServiceOrderPostResponse) UnmarshalJSON(data []byte) (err error) {
	varServiceOrderPostResponse := _ServiceOrderPostResponse{}

	err = json.Unmarshal(data, &varServiceOrderPostResponse)

	if err != nil {
		return err
	}

	*o = ServiceOrderPostResponse(varServiceOrderPostResponse)
