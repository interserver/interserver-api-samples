...
type _MailStatsTypeVolumeTo MailStatsTypeVolumeTo
...
func (o *MailStatsTypeVolumeTo) UnmarshalJSON(data []byte) (err error) {
	varMailStatsTypeVolumeTo := _MailStatsTypeVolumeTo{}

	err = json.Unmarshal(data, &varMailStatsTypeVolumeTo)

	if err != nil {
		return err
	}

	*o = MailStatsTypeVolumeTo(varMailStatsTypeVolumeTo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "client@domain.com")
		delete(additionalProperties, "user@site.net")
		delete(additionalProperties, "sales@company.com")
		delete(additionalProperties, "client@anothersite.com")
