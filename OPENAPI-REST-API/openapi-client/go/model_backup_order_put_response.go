...
type _BackupOrderPutResponse BackupOrderPutResponse
...
func (o *BackupOrderPutResponse) UnmarshalJSON(data []byte) (err error) {
	varBackupOrderPutResponse := _BackupOrderPutResponse{}

	err = json.Unmarshal(data, &varBackupOrderPutResponse)

	if err != nil {
		return err
	}

	*o = BackupOrderPutResponse(varBackupOrderPutResponse)
