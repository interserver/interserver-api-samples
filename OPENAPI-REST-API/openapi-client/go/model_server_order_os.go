...
type _ServerOrderOS ServerOrderOS
...
func (o *ServerOrderOS) UnmarshalJSON(data []byte) (err error) {
	varServerOrderOS := _ServerOrderOS{}

	err = json.Unmarshal(data, &varServerOrderOS)

	if err != nil {
		return err
	}

	*o = ServerOrderOS(varServerOrderOS)
