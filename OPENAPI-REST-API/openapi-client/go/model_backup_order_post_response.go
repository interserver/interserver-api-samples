...
type _BackupOrderPostResponse BackupOrderPostResponse
...
func (o *BackupOrderPostResponse) UnmarshalJSON(data []byte) (err error) {
	varBackupOrderPostResponse := _BackupOrderPostResponse{}

	err = json.Unmarshal(data, &varBackupOrderPostResponse)

	if err != nil {
		return err
	}

	*o = BackupOrderPostResponse(varBackupOrderPostResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "iid")
		delete(additionalProperties, "iids")
		delete(additionalProperties, "real_iids")
