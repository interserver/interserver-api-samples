...
type VPSAPI interface {

	/*
	AddVps Place a new VPS order, create the invoice, and queue provisioning
...
```
	...
	*/
	AddVps(ctx context.Context) ApiAddVpsRequest

	// AddVpsExecute executes the request
	//  @return ServiceOrderPostResponse
	AddVpsExecute(r ApiAddVpsRequest) (*ServiceOrderPostResponse, *http.Response, error)

	/*
	DeleteVpsBackup Permanently delete a VPS backup file by name (irreversible)
...
- **Restore (don't delete):** `postVpsRestore`.
	...
	*/
	DeleteVpsBackup(ctx context.Context, id int32) ApiDeleteVpsBackupRequest

	// DeleteVpsBackupExecute executes the request
	//  @return SuccessTextResponse
	DeleteVpsBackupExecute(r ApiDeleteVpsBackupRequest) (*SuccessTextResponse, *http.Response, error)

	/*
	DoVpsBlockSmtp Block outbound SMTP (port 25) on the VPS to prevent spam/abuse
...
- **General lifecycle:** `doVpsStart`, `doVpsStop`, `doVpsRestart`.
	...
	*/
	DoVpsBlockSmtp(ctx context.Context, id int32) ApiDoVpsBlockSmtpRequest

	// DoVpsBlockSmtpExecute executes the request
	//  @return QueueResponse
	DoVpsBlockSmtpExecute(r ApiDoVpsBlockSmtpRequest) (*QueueResponse, *http.Response, error)

	/*
	DoVpsDisableCd Remove the virtual CD/DVD device entirely from the VPS configuration
...
- **Just unmount the ISO:** `doVpsEjectCd`.
	...
	*/
	DoVpsDisableCd(ctx context.Context, id int32) ApiDoVpsDisableCdRequest

	// DoVpsDisableCdExecute executes the request
	//  @return QueueResponse
	DoVpsDisableCdExecute(r ApiDoVpsDisableCdRequest) (*QueueResponse, *http.Response, error)

	/*
	DoVpsDisableQuota Disable per-user disk quota enforcement inside the VPS guest OS
...
- **Re-enable:** `doVpsEnableQuota`.
	...
	*/
	DoVpsDisableQuota(ctx context.Context, id int32) ApiDoVpsDisableQuotaRequest

	// DoVpsDisableQuotaExecute executes the request
	//  @return QueueResponse
	DoVpsDisableQuotaExecute(r ApiDoVpsDisableQuotaRequest) (*QueueResponse, *http.Response, error)

	/*
	DoVpsEjectCd Eject the mounted ISO from the VPS virtual CD drive (keep the drive)
...
- **Remove the drive entirely:** `doVpsDisableCd`.
	...
	*/
	DoVpsEjectCd(ctx context.Context, id int32) ApiDoVpsEjectCdRequest

	// DoVpsEjectCdExecute executes the request
	//  @return QueueResponse
	DoVpsEjectCdExecute(r ApiDoVpsEjectCdRequest) (*QueueResponse, *http.Response, error)

	/*
	DoVpsEnableQuota Enable per-user disk quota enforcement inside the VPS guest OS
...
- **Disable later:** `doVpsDisableQuota`.
	...
	*/
	DoVpsEnableQuota(ctx context.Context, id int32) ApiDoVpsEnableQuotaRequest

	// DoVpsEnableQuotaExecute executes the request
	//  @return QueueResponse
	DoVpsEnableQuotaExecute(r ApiDoVpsEnableQuotaRequest) (*QueueResponse, *http.Response, error)

	/*
	DoVpsRestart Reboot the VPS — preferred over stop+start for software changes
...
- **Boot from CD:** `postVpsInsertCd` then `doVpsRestart`.
	...
	*/
	DoVpsRestart(ctx context.Context, id int32) ApiDoVpsRestartRequest

	// DoVpsRestartExecute executes the request
	//  @return QueueResponse
	DoVpsRestartExecute(r ApiDoVpsRestartRequest) (*QueueResponse, *http.Response, error)

	/*
	DoVpsStart Power on a stopped VPS instance
...
- **Current state:** `getVpsInfo`.
	...
	*/
	DoVpsStart(ctx context.Context, id int32) ApiDoVpsStartRequest

	// DoVpsStartExecute executes the request
	//  @return QueueResponse
	DoVpsStartExecute(r ApiDoVpsStartRequest) (*QueueResponse, *http.Response, error)

	/*
	DoVpsStop Power off a running VPS — billing continues until cancellation
...
- **Stop billing too:** `VPSCancel`.
	...
	*/
	DoVpsStop(ctx context.Context, id int32) ApiDoVpsStopRequest

	// DoVpsStopExecute executes the request
	//  @return QueueResponse
	DoVpsStopExecute(r ApiDoVpsStopRequest) (*QueueResponse, *http.Response, error)

	/*
	DownloadVpsBackup Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
...
- **Cleanup after download:** `deleteVpsBackup`.
	...
	*/
	DownloadVpsBackup(ctx context.Context, id int32) ApiDownloadVpsBackupRequest

	// DownloadVpsBackupExecute executes the request
	//  @return DownloadQsBackup200Response
	DownloadVpsBackupExecute(r ApiDownloadVpsBackupRequest) (*DownloadQsBackup200Response, *http.Response, error)

	/*
	GetNewVps Get the VPS order catalog — platforms, OS templates, locations, pricing
...
```
	...
	*/
	GetNewVps(ctx context.Context) ApiGetNewVpsRequest

	// GetNewVpsExecute executes the request
	//  @return VpsOrder
	GetNewVpsExecute(r ApiGetNewVpsRequest) (*VpsOrder, *http.Response, error)

	/*
	GetVpsBackup Trigger a manual on-demand snapshot/backup of the VPS
...
- **Restore from a backup:** `postVpsRestore`.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id VPS ID number
	@return ApiGetVpsBackupRequest
	*/
	GetVpsBackup(ctx context.Context, id int32) ApiGetVpsBackupRequest

	// GetVpsBackupExecute executes the request
	//  @return QueueResponse
	GetVpsBackupExecute(r ApiGetVpsBackupRequest) (*QueueResponse, *http.Response, error)

	/*
	GetVpsBackups List existing backups for the VPS across Swift, MinIO, and ZFS
...
- **Restore:** `postVpsRestore` — pass `backup` as `<type>:<service>:<name>`.
	...
	*/
	GetVpsBackups(ctx context.Context, id int32) ApiGetVpsBackupsRequest

	// GetVpsBackupsExecute executes the request
	//  @return VpsBackupRows
	GetVpsBackupsExecute(r ApiGetVpsBackupsRequest) (*VpsBackupRows, *http.Response, error)

	/*
	GetVpsBuyHdSpace Get current additional disk size and per-GB monthly cost for the VPS
...
- **Alternative path (whole plan):** `getVpsSlices` → `postVpsSlices`.
	...
	*/
	GetVpsBuyHdSpace(ctx context.Context, id int32) ApiGetVpsBuyHdSpaceRequest

	// GetVpsBuyHdSpaceExecute executes the request
	GetVpsBuyHdSpaceExecute(r ApiGetVpsBuyHdSpaceRequest) (*http.Response, error)

	/*
	GetVpsBuyIp Read current additional IPs, cap, and per-IP monthly cost for the VPS
...
- **Cancel an existing extra IP:** follow the `cancel_link` URL (renders the cancel-addon page).
	...
	*/
	GetVpsBuyIp(ctx context.Context, id int32) ApiGetVpsBuyIpRequest

	// GetVpsBuyIpExecute executes the request
	GetVpsBuyIpExecute(r ApiGetVpsBuyIpRequest) (*http.Response, error)

	/*
	GetVpsChangeHostname Read the VPS's current hostname before changing it
...
- **Verify after change:** `getVpsInfo`.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id VPS ID number
	@return ApiGetVpsChangeHostnameRequest
	*/
	GetVpsChangeHostname(ctx context.Context, id int32) ApiGetVpsChangeHostnameRequest

	// GetVpsChangeHostnameExecute executes the request
	GetVpsChangeHostnameExecute(r ApiGetVpsChangeHostnameRequest) (*http.Response, error)

	/*
	GetVpsChangeRootPassword Pre-flight check before changing the VPS root password
...
- **Webuzo control panel password:** `postVpsChangeWebuzoPassword` (separate credential).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id VPS ID number
	@return ApiGetVpsChangeRootPasswordRequest
	*/
	GetVpsChangeRootPassword(ctx context.Context, id int32) ApiGetVpsChangeRootPasswordRequest

	// GetVpsChangeRootPasswordExecute executes the request
	GetVpsChangeRootPasswordExecute(r ApiGetVpsChangeRootPasswordRequest) (*http.Response, error)

	/*
	GetVpsChangeTimezone List IANA timezones supported by the VPS guest OS
...
- **Account-level timezone:** `updateAccountInfo` (sets the default for new VPS).
	...
	*/
	GetVpsChangeTimezone(ctx context.Context, id int32) ApiGetVpsChangeTimezoneRequest

	// GetVpsChangeTimezoneExecute executes the request
	//  @return []string
	GetVpsChangeTimezoneExecute(r ApiGetVpsChangeTimezoneRequest) ([]string, *http.Response, error)

	/*
	GetVpsInfo Get full details for one VPS — IPs, hostname, OS, slices, status, addons
...
- **Metrics:** `getVpsTrafficUsage`.
	...
	*/
	GetVpsInfo(ctx context.Context, id int32) ApiGetVpsInfoRequest

	// GetVpsInfoExecute executes the request
	//  @return Vps
	GetVpsInfoExecute(r ApiGetVpsInfoRequest) (*Vps, *http.Response, error)

	/*
	GetVpsInsertCd List ISO templates that can be mounted in the VPS virtual CD drive
...
- **Boot from CD:** `doVpsRestart` after mounting.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id VPS ID number
	@return ApiGetVpsInsertCdRequest
	*/
	GetVpsInsertCd(ctx context.Context, id int32) ApiGetVpsInsertCdRequest

	// GetVpsInsertCdExecute executes the request
	GetVpsInsertCdExecute(r ApiGetVpsInsertCdRequest) (*http.Response, error)

	/*
	GetVpsInvoices List all billing invoices associated with this specific VPS
...
- **All invoices across account:** `getBillingInvoices`.
	...
	*/
	GetVpsInvoices(ctx context.Context, id int32) ApiGetVpsInvoicesRequest

	// GetVpsInvoicesExecute executes the request
	//  @return ChargeInvoiceRows
	GetVpsInvoicesExecute(r ApiGetVpsInvoicesRequest) (*ChargeInvoiceRows, *http.Response, error)

	/*
	GetVpsList List all VPS services on the customer's account
...
- **Cancel:** `VPSCancel` (end of cycle, customer-initiated).
	...
	*/
	...
	//  @return []VpsRow
	GetVpsListExecute(r ApiGetVpsListRequest) ([]VpsRow, *http.Response, error)

	/*
	GetVpsReinstallOs List OS templates compatible with this VPS's hypervisor for reinstall
...
- **Alternative — restore old backup:** `postVpsRestore`.
	...
	*/
	GetVpsReinstallOs(ctx context.Context, id int32) ApiGetVpsReinstallOsRequest

	// GetVpsReinstallOsExecute executes the request
	//  @return VpsTemplatesList
	GetVpsReinstallOsExecute(r ApiGetVpsReinstallOsRequest) (*VpsTemplatesList, *http.Response, error)

	/*
	GetVpsResetPassword Pre-flight check before resetting the VPS root password to a random value
...
- **Specific password instead:** `postVpsChangeRootPassword`.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id VPS ID number
	@return ApiGetVpsResetPasswordRequest
	*/
	GetVpsResetPassword(ctx context.Context, id int32) ApiGetVpsResetPasswordRequest

	// GetVpsResetPasswordExecute executes the request
	GetVpsResetPasswordExecute(r ApiGetVpsResetPasswordRequest) (*http.Response, error)

	/*
	GetVpsReverseDns Read the current PTR (reverse-DNS) records for every IP on the VPS
...
- **Hostname change (auto-PTR for primary):** `postVpsChangeHostname`.
	...
	*/
	GetVpsReverseDns(ctx context.Context, id int32) ApiGetVpsReverseDnsRequest

	// GetVpsReverseDnsExecute executes the request
	//  @return ReverseDnsEntries
	GetVpsReverseDnsExecute(r ApiGetVpsReverseDnsRequest) (*ReverseDnsEntries, *http.Response, error)

	/*
	GetVpsSetupVnc Read current VNC console connection info for the VPS
...
- **Windows remote desktop:** `getVpsViewDesktop`.
	...
	*/
	GetVpsSetupVnc(ctx context.Context, id int32) ApiGetVpsSetupVncRequest

	// GetVpsSetupVncExecute executes the request
	GetVpsSetupVncExecute(r ApiGetVpsSetupVncRequest) (*http.Response, error)

	/*
	GetVpsSlices Read current slice count, min/max range, and prorated per-slice upgrade cost
...
- **Disk-only:** `getVpsBuyHdSpace`/`putVpsBuyHdSpace`/`postVpsBuyHdSpace`.
	...
	*/
	GetVpsSlices(ctx context.Context, id int32) ApiGetVpsSlicesRequest

	// GetVpsSlicesExecute executes the request
	GetVpsSlicesExecute(r ApiGetVpsSlicesRequest) (*http.Response, error)

	/*
	GetVpsTrafficUsage Read bandwidth traffic usage data for the VPS
...
- **Plan allowance:** `getVpsInfo` returns `bw_total` / `slices` you can compute against.
	...
	*/
	GetVpsTrafficUsage(ctx context.Context, id int32) ApiGetVpsTrafficUsageRequest

	// GetVpsTrafficUsageExecute executes the request
	//  @return VpsTrafficResponse
	GetVpsTrafficUsageExecute(r ApiGetVpsTrafficUsageRequest) (*VpsTrafficResponse, *http.Response, error)

	/*
	GetVpsViewDesktop Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS
...
- **Low-level console:** `getVpsSetupVnc` / `postVpsSetupVnc`.
	...
	*/
	GetVpsViewDesktop(ctx context.Context, id int32) ApiGetVpsViewDesktopRequest

	// GetVpsViewDesktopExecute executes the request
	GetVpsViewDesktopExecute(r ApiGetVpsViewDesktopRequest) (*http.Response, error)

	/*
	GetVpsWelcomeEmail Resend the welcome email containing VPS IP, hostname, and root credentials
...
- **Before resending, rotate password:** `postVpsResetPassword` or `postVpsChangeRootPassword`.
	...
	*/
	GetVpsWelcomeEmail(ctx context.Context, id string) ApiGetVpsWelcomeEmailRequest

	// GetVpsWelcomeEmailExecute executes the request
	//  @return SuccessTextResponse
	GetVpsWelcomeEmailExecute(r ApiGetVpsWelcomeEmailRequest) (*SuccessTextResponse, *http.Response, error)

	/*
	PostVpsBuyHdSpace Buy or resize the VPS additional-disk addon and create a prorated invoice
...
- **Whole-plan upgrades:** `postVpsSlices` (bundles disk + RAM + CPU).
	...
	*/
	PostVpsBuyHdSpace(ctx context.Context, id int32) ApiPostVpsBuyHdSpaceRequest

	// PostVpsBuyHdSpaceExecute executes the request
	PostVpsBuyHdSpaceExecute(r ApiPostVpsBuyHdSpaceRequest) (*http.Response, error)

	/*
	PostVpsBuyIp Purchase one additional IP for the VPS and create the invoice
...
- **Post-activation:** `postVpsReverseDns` to set the PTR for the new IP.
	...
	*/
	PostVpsBuyIp(ctx context.Context, id int32) ApiPostVpsBuyIpRequest

	// PostVpsBuyIpExecute executes the request
	PostVpsBuyIpExecute(r ApiPostVpsBuyIpRequest) (*http.Response, error)

	/*
	PostVpsChangeHostname Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP
...
- **Verify:** `getVpsInfo` (look for updated `vps_hostname`).
	...
	*/
	PostVpsChangeHostname(ctx context.Context, id int32) ApiPostVpsChangeHostnameRequest

	// PostVpsChangeHostnameExecute executes the request
	//  @return QueueResponse
	PostVpsChangeHostnameExecute(r ApiPostVpsChangeHostnameRequest) (*QueueResponse, *http.Response, error)

	/*
	PostVpsChangeRootPassword Set a specific new root/Administrator password on the VPS
...
- **Verify:** `getVpsInfo` (no field change — verification is operational, not via API).
	...
	*/
	PostVpsChangeRootPassword(ctx context.Context, id int32) ApiPostVpsChangeRootPasswordRequest

	// PostVpsChangeRootPasswordExecute executes the request
	//  @return QueueResponse
	PostVpsChangeRootPasswordExecute(r ApiPostVpsChangeRootPasswordRequest) (*QueueResponse, *http.Response, error)

	/*
	PostVpsChangeTimezone Set the system timezone on the VPS guest OS
...
- **Prerequisite:** `getVpsChangeTimezone` (the only valid source for `timezone` values).
	...
	*/
	PostVpsChangeTimezone(ctx context.Context, id int32) ApiPostVpsChangeTimezoneRequest

	// PostVpsChangeTimezoneExecute executes the request
	//  @return QueueResponse
	PostVpsChangeTimezoneExecute(r ApiPostVpsChangeTimezoneRequest) (*QueueResponse, *http.Response, error)

	/*
	PostVpsChangeWebuzoPassword Rotate the Webuzo control panel admin password (re-auth required)
...
- **Account password rotation:** `updateAccountPassword`.
	...
	*/
	PostVpsChangeWebuzoPassword(ctx context.Context, id int32) ApiPostVpsChangeWebuzoPasswordRequest

	// PostVpsChangeWebuzoPasswordExecute executes the request
	//  @return QueueResponse
	PostVpsChangeWebuzoPasswordExecute(r ApiPostVpsChangeWebuzoPasswordRequest) (*QueueResponse, *http.Response, error)

	/*
	PostVpsInsertCd Mount an ISO image in the VPS virtual CD drive from a URL
...
- **Unmount when done:** `doVpsEjectCd`.
	...
	*/
	PostVpsInsertCd(ctx context.Context, id int32) ApiPostVpsInsertCdRequest

	// PostVpsInsertCdExecute executes the request
	//  @return QueueResponse
	PostVpsInsertCdExecute(r ApiPostVpsInsertCdRequest) (*QueueResponse, *http.Response, error)

	/*
	PostVpsReinstallOs Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)
...
- **Verify after reinstall:** `getVpsInfo` (look for updated `vps_os`).
	...
	*/
	PostVpsReinstallOs(ctx context.Context, id int32) ApiPostVpsReinstallOsRequest

	// PostVpsReinstallOsExecute executes the request
	//  @return QueueResponse
	PostVpsReinstallOsExecute(r ApiPostVpsReinstallOsRequest) (*QueueResponse, *http.Response, error)

	/*
	PostVpsResetPassword Reset the VPS root password to a server-generated random value
...
- **Retrieve the new credentials:** `getVpsWelcomeEmail` (resends with current credentials).
	...
	*/
	PostVpsResetPassword(ctx context.Context, id int32) ApiPostVpsResetPasswordRequest

	// PostVpsResetPasswordExecute executes the request
	//  @return QueueResponse
	PostVpsResetPasswordExecute(r ApiPostVpsResetPasswordRequest) (*QueueResponse, *http.Response, error)

	/*
	PostVpsRestore Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
...
- **Verify after restore:** `getVpsInfo`.
	...
	*/
	PostVpsRestore(ctx context.Context, id int32) ApiPostVpsRestoreRequest

	// PostVpsRestoreExecute executes the request
	//  @return QueueResponse
	PostVpsRestoreExecute(r ApiPostVpsRestoreRequest) (*QueueResponse, *http.Response, error)

	/*
	PostVpsReverseDns Bulk-update PTR (reverse-DNS) records for one or more VPS IPs
...
- **Adding IPs:** `getVpsBuyIp` → `postVpsBuyIp` → `postVpsReverseDns`.
	...
	*/
	PostVpsReverseDns(ctx context.Context, id int32) ApiPostVpsReverseDnsRequest

	// PostVpsReverseDnsExecute executes the request
	//  @return TextResponse
	PostVpsReverseDnsExecute(r ApiPostVpsReverseDnsRequest) (*TextResponse, *http.Response, error)

	/*
	PostVpsSetupVnc Provision or refresh the VNC console endpoint for the VPS
...
- **Windows GUI access:** `getVpsViewDesktop`.
	...
	*/
	PostVpsSetupVnc(ctx context.Context, id int32) ApiPostVpsSetupVncRequest

	// PostVpsSetupVncExecute executes the request
	//  @return QueueResponse
	PostVpsSetupVncExecute(r ApiPostVpsSetupVncRequest) (*QueueResponse, *http.Response, error)

	/*
	PostVpsSlices Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)
...
- **Verify:** `getVpsInfo`.
	...
	*/
	PostVpsSlices(ctx context.Context, id int32) ApiPostVpsSlicesRequest

	// PostVpsSlicesExecute executes the request
	PostVpsSlicesExecute(r ApiPostVpsSlicesRequest) (*http.Response, error)

	/*
	PostVpsTrafficUsage Search/filter VPS bandwidth usage with custom criteria (reserved)
...
- **Unfiltered alternative:** `getVpsTrafficUsage`.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id VPS ID number
	@return ApiPostVpsTrafficUsageRequest
	*/
	PostVpsTrafficUsage(ctx context.Context, id int32) ApiPostVpsTrafficUsageRequest

	// PostVpsTrafficUsageExecute executes the request
	PostVpsTrafficUsageExecute(r ApiPostVpsTrafficUsageRequest) (*http.Response, error)

	/*
	PostVpsViewDesktop Refresh the remote-desktop session connection info after IP/hostname changes
...
`getVpsViewDesktop`, `postVpsSetupVnc`.
	...
	*/
	PostVpsViewDesktop(ctx context.Context, id int32) ApiPostVpsViewDesktopRequest

	// PostVpsViewDesktopExecute executes the request
	PostVpsViewDesktopExecute(r ApiPostVpsViewDesktopRequest) (*http.Response, error)

	/*
	PutVps Validate a VPS order configuration and quote the cost — dry run, no charge
...
```
	...
	*/
	PutVps(ctx context.Context) ApiPutVpsRequest

	// PutVpsExecute executes the request
	//  @return VpsOrderPutResponse
	PutVpsExecute(r ApiPutVpsRequest) (*VpsOrderPutResponse, *http.Response, error)

	/*
	PutVpsBuyHdSpace Preview cost to set additional VPS disk to a target GB size — dry run
...
- **Next:** `postVpsBuyHdSpace` (commit; creates invoice when diffCost > 0, queues immediate update otherwise).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id VPS ID number
	@return ApiPutVpsBuyHdSpaceRequest
	*/
	PutVpsBuyHdSpace(ctx context.Context, id int32) ApiPutVpsBuyHdSpaceRequest

	// PutVpsBuyHdSpaceExecute executes the request
	PutVpsBuyHdSpaceExecute(r ApiPutVpsBuyHdSpaceRequest) (*http.Response, error)

	/*
	UpdateVpsInfo Update editable settings on a VPS service record
...
- Cancel service entirely → `VPSCancel`.
	...
	*/
	UpdateVpsInfo(ctx context.Context, id string) ApiUpdateVpsInfoRequest

	// UpdateVpsInfoExecute executes the request
	//  @return SuccessTextResponse
	UpdateVpsInfoExecute(r ApiUpdateVpsInfoRequest) (*SuccessTextResponse, *http.Response, error)

	/*
	VPSCancel Cancel a VPS service at the end of the current billing cycle
...
- **Sibling cancels on other modules:** `CancelDomain`, `mailCancel`, `webhostingCancel`, etc. all use the same `CancelService` handler.
	...
	*/
	VPSCancel(ctx context.Context, id int32) ApiVPSCancelRequest

	// VPSCancelExecute executes the request
	//  @return VPSCancel200Response
	VPSCancelExecute(r ApiVPSCancelRequest) (*VPSCancel200Response, *http.Response, error)
}
...
type ApiGetVpsBackupRequest struct {
	ctx context.Context
	ApiService VPSAPI
	id int32
}

func (r ApiGetVpsBackupRequest) Execute() (*QueueResponse, *http.Response, error) {
	return r.ApiService.GetVpsBackupExecute(r)
}
...
- **Restore from a backup:** `postVpsRestore`.
 ...
 @return ApiGetVpsBackupRequest
*/
func (a *VPSAPIService) GetVpsBackup(ctx context.Context, id int32) ApiGetVpsBackupRequest {
	return ApiGetVpsBackupRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return QueueResponse
func (a *VPSAPIService) GetVpsBackupExecute(r ApiGetVpsBackupRequest) (*QueueResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VPSAPIService.GetVpsBackup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetVpsChangeHostnameRequest struct {
	ctx context.Context
	ApiService VPSAPI
	id int32
}

func (r ApiGetVpsChangeHostnameRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetVpsChangeHostnameExecute(r)
}
...
- **Verify after change:** `getVpsInfo`.
 ...
 @return ApiGetVpsChangeHostnameRequest
*/
func (a *VPSAPIService) GetVpsChangeHostname(ctx context.Context, id int32) ApiGetVpsChangeHostnameRequest {
	return ApiGetVpsChangeHostnameRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *VPSAPIService) GetVpsChangeHostnameExecute(r ApiGetVpsChangeHostnameRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VPSAPIService.GetVpsChangeHostname")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetVpsChangeRootPasswordRequest struct {
	ctx context.Context
	ApiService VPSAPI
	id int32
}

func (r ApiGetVpsChangeRootPasswordRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetVpsChangeRootPasswordExecute(r)
}
...
- **Webuzo control panel password:** `postVpsChangeWebuzoPassword` (separate credential).
 ...
 @return ApiGetVpsChangeRootPasswordRequest
*/
func (a *VPSAPIService) GetVpsChangeRootPassword(ctx context.Context, id int32) ApiGetVpsChangeRootPasswordRequest {
	return ApiGetVpsChangeRootPasswordRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *VPSAPIService) GetVpsChangeRootPasswordExecute(r ApiGetVpsChangeRootPasswordRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VPSAPIService.GetVpsChangeRootPassword")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetVpsInsertCdRequest struct {
	ctx context.Context
	ApiService VPSAPI
	id int32
}

func (r ApiGetVpsInsertCdRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetVpsInsertCdExecute(r)
}
...
- **Boot from CD:** `doVpsRestart` after mounting.
 ...
 @return ApiGetVpsInsertCdRequest
*/
func (a *VPSAPIService) GetVpsInsertCd(ctx context.Context, id int32) ApiGetVpsInsertCdRequest {
	return ApiGetVpsInsertCdRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *VPSAPIService) GetVpsInsertCdExecute(r ApiGetVpsInsertCdRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VPSAPIService.GetVpsInsertCd")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetVpsResetPasswordRequest struct {
	ctx context.Context
	ApiService VPSAPI
	id int32
}

func (r ApiGetVpsResetPasswordRequest) Execute() (*http.Response, error) {
	return r.ApiService.GetVpsResetPasswordExecute(r)
}
...
- **Specific password instead:** `postVpsChangeRootPassword`.
 ...
 @return ApiGetVpsResetPasswordRequest
*/
func (a *VPSAPIService) GetVpsResetPassword(ctx context.Context, id int32) ApiGetVpsResetPasswordRequest {
	return ApiGetVpsResetPasswordRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *VPSAPIService) GetVpsResetPasswordExecute(r ApiGetVpsResetPasswordRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VPSAPIService.GetVpsResetPassword")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPostVpsTrafficUsageRequest struct {
	ctx context.Context
	ApiService VPSAPI
	id int32
}

func (r ApiPostVpsTrafficUsageRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostVpsTrafficUsageExecute(r)
}
...
- **Unfiltered alternative:** `getVpsTrafficUsage`.
 ...
 @return ApiPostVpsTrafficUsageRequest
*/
func (a *VPSAPIService) PostVpsTrafficUsage(ctx context.Context, id int32) ApiPostVpsTrafficUsageRequest {
	return ApiPostVpsTrafficUsageRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *VPSAPIService) PostVpsTrafficUsageExecute(r ApiPostVpsTrafficUsageRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VPSAPIService.PostVpsTrafficUsage")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPutVpsBuyHdSpaceRequest struct {
	ctx context.Context
	ApiService VPSAPI
	id int32
}

func (r ApiPutVpsBuyHdSpaceRequest) Execute() (*http.Response, error) {
	return r.ApiService.PutVpsBuyHdSpaceExecute(r)
}
...
- **Next:** `postVpsBuyHdSpace` (commit; creates invoice when diffCost > 0, queues immediate update otherwise).
 ...
 @return ApiPutVpsBuyHdSpaceRequest
*/
func (a *VPSAPIService) PutVpsBuyHdSpace(ctx context.Context, id int32) ApiPutVpsBuyHdSpaceRequest {
	return ApiPutVpsBuyHdSpaceRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *VPSAPIService) PutVpsBuyHdSpaceExecute(r ApiPutVpsBuyHdSpaceRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VPSAPIService.PutVpsBuyHdSpace")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
