...
type _MailStatsTypeVolume MailStatsTypeVolume
...
func (o *MailStatsTypeVolume) UnmarshalJSON(data []byte) (err error) {
	varMailStatsTypeVolume := _MailStatsTypeVolume{}

	err = json.Unmarshal(data, &varMailStatsTypeVolume)

	if err != nil {
		return err
	}

	*o = MailStatsTypeVolume(varMailStatsTypeVolume)
