...
func (o *BuyItNowRow) UnmarshalJSON(data []byte) (err error) {
	varBuyItNowRow := _BuyItNowRow{}

	err = json.Unmarshal(data, &varBuyItNowRow)

	if err != nil {
		return err
	}

	*o = BuyItNowRow(varBuyItNowRow)
