...
type _ScrubIpsLogRowSchema ScrubIpsLogRowSchema
...
func (o *ScrubIpsLogRowSchema) UnmarshalJSON(data []byte) (err error) {
	varScrubIpsLogRowSchema := _ScrubIpsLogRowSchema{}

	err = json.Unmarshal(data, &varScrubIpsLogRowSchema)

	if err != nil {
		return err
	}

	*o = ScrubIpsLogRowSchema(varScrubIpsLogRowSchema)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "blocked_ip")
		delete(additionalProperties, "target_ip")
