...
type _DomainBillingExtra DomainBillingExtra
...
func (o *DomainBillingExtra) UnmarshalJSON(data []byte) (err error) {
	varDomainBillingExtra := _DomainBillingExtra{}

	err = json.Unmarshal(data, &varDomainBillingExtra)

	if err != nil {
		return err
	}

	*o = DomainBillingExtra(varDomainBillingExtra)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "provProcessPending")
