...
// checks if the WebsiteOrderPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebsiteOrderPostRequest{}
...
type _WebsiteOrderPostRequest WebsiteOrderPostRequest
...
func (o WebsiteOrderPostRequest) MarshalJSON() ([]byte, error) {
...
func (o WebsiteOrderPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *WebsiteOrderPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varWebsiteOrderPostRequest := _WebsiteOrderPostRequest{}

	err = json.Unmarshal(data, &varWebsiteOrderPostRequest)

	if err != nil {
		return err
	}

	*o = WebsiteOrderPostRequest(varWebsiteOrderPostRequest)
...
type NullableWebsiteOrderPostRequest struct {
	value *WebsiteOrderPostRequest
	isSet bool
}

func (v NullableWebsiteOrderPostRequest) Get() *WebsiteOrderPostRequest {
	return v.value
}

func (v *NullableWebsiteOrderPostRequest) Set(val *WebsiteOrderPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteOrderPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteOrderPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteOrderPostRequest(val *WebsiteOrderPostRequest) *NullableWebsiteOrderPostRequest {
	return &NullableWebsiteOrderPostRequest{value: val, isSet: true}
}

func (v NullableWebsiteOrderPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteOrderPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
