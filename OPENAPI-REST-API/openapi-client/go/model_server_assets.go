...
type _ServerAssets ServerAssets
...
func (o *ServerAssets) UnmarshalJSON(data []byte) (err error) {
	varServerAssets := _ServerAssets{}

	err = json.Unmarshal(data, &varServerAssets)

	if err != nil {
		return err
	}

	*o = ServerAssets(varServerAssets)
