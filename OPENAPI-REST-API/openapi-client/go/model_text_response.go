...
type _TextResponse TextResponse
...
func (o *TextResponse) UnmarshalJSON(data []byte) (err error) {
	varTextResponse := _TextResponse{}

	err = json.Unmarshal(data, &varTextResponse)

	if err != nil {
		return err
	}

	*o = TextResponse(varTextResponse)
