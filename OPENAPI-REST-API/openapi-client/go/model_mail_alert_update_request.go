...
type _MailAlertUpdateRequest MailAlertUpdateRequest
...
func (o *MailAlertUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	varMailAlertUpdateRequest := _MailAlertUpdateRequest{}

	err = json.Unmarshal(data, &varMailAlertUpdateRequest)

	if err != nil {
		return err
	}

	*o = MailAlertUpdateRequest(varMailAlertUpdateRequest)
