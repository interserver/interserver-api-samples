...
type _QuickserverServiceInfo QuickserverServiceInfo
...
func (o *QuickserverServiceInfo) UnmarshalJSON(data []byte) (err error) {
	varQuickserverServiceInfo := _QuickserverServiceInfo{}

	err = json.Unmarshal(data, &varQuickserverServiceInfo)

	if err != nil {
		return err
	}

	*o = QuickserverServiceInfo(varQuickserverServiceInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "qs_id")
		delete(additionalProperties, "qs_custid")
		delete(additionalProperties, "qs_server")
		delete(additionalProperties, "qs_ip")
		delete(additionalProperties, "qs_ipv6")
		delete(additionalProperties, "qs_vzid")
		delete(additionalProperties, "qs_currency")
		delete(additionalProperties, "qs_type")
		delete(additionalProperties, "qs_order_date")
		delete(additionalProperties, "qs_status")
		delete(additionalProperties, "qs_invoice")
		delete(additionalProperties, "qs_coupon")
		delete(additionalProperties, "qs_extra")
		delete(additionalProperties, "qs_hostname")
		delete(additionalProperties, "qs_server_status")
		delete(additionalProperties, "qs_comment")
		delete(additionalProperties, "qs_slices")
		delete(additionalProperties, "qs_vnc")
		delete(additionalProperties, "qs_vnc_port")
		delete(additionalProperties, "qs_rootpass")
		delete(additionalProperties, "qs_mac")
		delete(additionalProperties, "qs_os")
		delete(additionalProperties, "qs_version")
		delete(additionalProperties, "qs_location")
		delete(additionalProperties, "qs_platform")
