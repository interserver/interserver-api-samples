...
type _ServerOrderMemory ServerOrderMemory
...
func (o *ServerOrderMemory) UnmarshalJSON(data []byte) (err error) {
	varServerOrderMemory := _ServerOrderMemory{}

	err = json.Unmarshal(data, &varServerOrderMemory)

	if err != nil {
		return err
	}

	*o = ServerOrderMemory(varServerOrderMemory)
