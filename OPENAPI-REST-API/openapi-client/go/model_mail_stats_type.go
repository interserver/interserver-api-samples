...
type _MailStatsType MailStatsType
...
func (o *MailStatsType) UnmarshalJSON(data []byte) (err error) {
	varMailStatsType := _MailStatsType{}

	err = json.Unmarshal(data, &varMailStatsType)

	if err != nil {
		return err
	}

	*o = MailStatsType(varMailStatsType)
