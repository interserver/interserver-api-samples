...
type _EmailAddress EmailAddress
...
func (o *EmailAddress) UnmarshalJSON(data []byte) (err error) {
	varEmailAddress := _EmailAddress{}

	err = json.Unmarshal(data, &varEmailAddress)

	if err != nil {
		return err
	}

	*o = EmailAddress(varEmailAddress)
