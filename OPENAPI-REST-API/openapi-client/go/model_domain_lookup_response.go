...
type _DomainLookupResponse DomainLookupResponse
...
func (o *DomainLookupResponse) UnmarshalJSON(data []byte) (err error) {
	varDomainLookupResponse := _DomainLookupResponse{}

	err = json.Unmarshal(data, &varDomainLookupResponse)

	if err != nil {
		return err
	}

	*o = DomainLookupResponse(varDomainLookupResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "domain_service")
