...
type _MailStatsTypeVolumeFrom MailStatsTypeVolumeFrom
...
func (o *MailStatsTypeVolumeFrom) UnmarshalJSON(data []byte) (err error) {
	varMailStatsTypeVolumeFrom := _MailStatsTypeVolumeFrom{}

	err = json.Unmarshal(data, &varMailStatsTypeVolumeFrom)

	if err != nil {
		return err
	}

	*o = MailStatsTypeVolumeFrom(varMailStatsTypeVolumeFrom)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "billing@somedomain.com")
		delete(additionalProperties, "sales@somedomain.com")
