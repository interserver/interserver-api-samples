...
type _ServerOrderRAID ServerOrderRAID
...
func (o *ServerOrderRAID) UnmarshalJSON(data []byte) (err error) {
	varServerOrderRAID := _ServerOrderRAID{}

	err = json.Unmarshal(data, &varServerOrderRAID)

	if err != nil {
		return err
	}

	*o = ServerOrderRAID(varServerOrderRAID)
