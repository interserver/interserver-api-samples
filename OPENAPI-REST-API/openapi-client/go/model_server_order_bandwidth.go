...
type _ServerOrderBandwidth ServerOrderBandwidth
...
func (o *ServerOrderBandwidth) UnmarshalJSON(data []byte) (err error) {
	varServerOrderBandwidth := _ServerOrderBandwidth{}

	err = json.Unmarshal(data, &varServerOrderBandwidth)

	if err != nil {
		return err
	}

	*o = ServerOrderBandwidth(varServerOrderBandwidth)
