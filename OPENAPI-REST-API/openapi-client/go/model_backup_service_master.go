...
type _BackupServiceMaster BackupServiceMaster
...
func (o *BackupServiceMaster) UnmarshalJSON(data []byte) (err error) {
	varBackupServiceMaster := _BackupServiceMaster{}

	err = json.Unmarshal(data, &varBackupServiceMaster)

	if err != nil {
		return err
	}

	*o = BackupServiceMaster(varBackupServiceMaster)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "backup_hdsize")
		delete(additionalProperties, "backup_hdfree")
		delete(additionalProperties, "backup_last_update")
		delete(additionalProperties, "backup_available")
		delete(additionalProperties, "backup_iowait")
		delete(additionalProperties, "backup_order")
