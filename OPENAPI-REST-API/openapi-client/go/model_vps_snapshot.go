...
func (o *VpsSnapshot) UnmarshalJSON(data []byte) (err error) {
	varVpsSnapshot := _VpsSnapshot{}

	err = json.Unmarshal(data, &varVpsSnapshot)

	if err != nil {
		return err
	}

	*o = VpsSnapshot(varVpsSnapshot)
