...
type _InitiatePayment200Response InitiatePayment200Response
...
func (o *InitiatePayment200Response) UnmarshalJSON(data []byte) (err error) {
	varInitiatePayment200Response := _InitiatePayment200Response{}

	err = json.Unmarshal(data, &varInitiatePayment200Response)

	if err != nil {
		return err
	}

	*o = InitiatePayment200Response(varInitiatePayment200Response)
