...
type _DnsUpdateRecord DnsUpdateRecord
...
func (o *DnsUpdateRecord) UnmarshalJSON(data []byte) (err error) {
	varDnsUpdateRecord := _DnsUpdateRecord{}

	err = json.Unmarshal(data, &varDnsUpdateRecord)

	if err != nil {
		return err
	}

	*o = DnsUpdateRecord(varDnsUpdateRecord)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "prio")
		delete(additionalProperties, "disabled")
		delete(additionalProperties, "ordername")
