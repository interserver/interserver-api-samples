...
type WebhostingAPI interface {
	...
	/*
	AddWebsite Place a new webhosting order, create the invoice, and queue provisioning
...
```
	...
	*/
	AddWebsite(ctx context.Context) ApiAddWebsiteRequest

	// AddWebsiteExecute executes the request
	//  @return ServiceOrderPostResponse
	AddWebsiteExecute(r ApiAddWebsiteRequest) (*ServiceOrderPostResponse, *http.Response, error)

	/*
	GetNewWebsite Read the webhosting order catalog — plans, packages, promo offers, pricing
...
```
	...
	*/
	GetNewWebsite(ctx context.Context) ApiGetNewWebsiteRequest

	// GetNewWebsiteExecute executes the request
	//  @return WebsitesOrder
	GetNewWebsiteExecute(r ApiGetNewWebsiteRequest) (*WebsitesOrder, *http.Response, error)

	/*
	GetWebsiteBuyIp Read website IPs, current reverse DNS, and additional-IP pricing
...
- **Cancel an addon IP:** follow the `cancel_link` URL.
	...
	*/
	GetWebsiteBuyIp(ctx context.Context, id int32) ApiGetWebsiteBuyIpRequest

	// GetWebsiteBuyIpExecute executes the request
	//  @return GetWebsiteBuyIp200Response
	GetWebsiteBuyIpExecute(r ApiGetWebsiteBuyIpRequest) (*GetWebsiteBuyIp200Response, *http.Response, error)

	/*
	GetWebsiteInfo Read full configuration and status detail for one webhosting service
...
- **Cancel:** `webhostingCancel`.
	...
	*/
	GetWebsiteInfo(ctx context.Context, id int32) ApiGetWebsiteInfoRequest

	// GetWebsiteInfoExecute executes the request
	//  @return Website
	GetWebsiteInfoExecute(r ApiGetWebsiteInfoRequest) (*Website, *http.Response, error)

	/*
	GetWebsiteInvoices List all billing invoices and recurring charges scoped to one website
...
- **Account-wide history:** `getBillingInvoices`.
	...
	*/
	GetWebsiteInvoices(ctx context.Context, id int32) ApiGetWebsiteInvoicesRequest

	// GetWebsiteInvoicesExecute executes the request
	//  @return ChargeInvoiceRows
	GetWebsiteInvoicesExecute(r ApiGetWebsiteInvoicesRequest) (*ChargeInvoiceRows, *http.Response, error)

	/*
	GetWebsiteList List the caller's webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services
...
- **Cancel:** `webhostingCancel`.
	...
	*/
	GetWebsiteList(ctx context.Context) ApiGetWebsiteListRequest

	// GetWebsiteListExecute executes the request
	//  @return []WebsiteRow
	GetWebsiteListExecute(r ApiGetWebsiteListRequest) ([]WebsiteRow, *http.Response, error)

	/*
	GetWebsitesBackups List off-site cpmove backups stored in Swift — list or inline-download archive
...
- **Migrate to/from another host:** `postWebsiteMigration`.
	...
	*/
	GetWebsitesBackups(ctx context.Context, id int32) ApiGetWebsitesBackupsRequest

	// GetWebsitesBackupsExecute executes the request
	//  @return WebsiteBackups
	GetWebsitesBackupsExecute(r ApiGetWebsitesBackupsRequest) (*WebsiteBackups, *http.Response, error)

	/*
	GetWebsitesLogin Get a one-time auto-login URL for the website's control panel
...
- **List sites first:** `getWebsiteList`.
	...
	*/
	GetWebsitesLogin(ctx context.Context, id int32) ApiGetWebsitesLoginRequest

	// GetWebsitesLoginExecute executes the request
	//  @return WebsiteLoginResponse
	GetWebsitesLoginExecute(r ApiGetWebsitesLoginRequest) (*WebsiteLoginResponse, *http.Response, error)

	/*
	GetWebsitesWelcomeEmail Resend the webhosting welcome email with control-panel credentials and URL
...
- **List sites first:** `getWebsiteList`.
	...
	*/
	GetWebsitesWelcomeEmail(ctx context.Context, id int32) ApiGetWebsitesWelcomeEmailRequest

	// GetWebsitesWelcomeEmailExecute executes the request
	//  @return SuccessTextResponse
	GetWebsitesWelcomeEmailExecute(r ApiGetWebsitesWelcomeEmailRequest) (*SuccessTextResponse, *http.Response, error)

	/*
	GettWebsiteReverseDns Read current reverse-DNS (PTR) records for the website's IPs
...
- **Add IPs first:** `getWebsiteBuyIp` → `postWebsiteBuyIp`.
	...
	*/
	GettWebsiteReverseDns(ctx context.Context, id int32) ApiGettWebsiteReverseDnsRequest

	// GettWebsiteReverseDnsExecute executes the request
	//  @return ReverseDnsEntries
	GettWebsiteReverseDnsExecute(r ApiGettWebsiteReverseDnsRequest) (*ReverseDnsEntries, *http.Response, error)

	/*
	PostWebsiteBuyIp Buy an additional IP for the website OR update reverse DNS records
...
- **Pay the new addon invoice:** `initiatePayment` with the returned `invoice`.
	...
	*/
	PostWebsiteBuyIp(ctx context.Context, id int32) ApiPostWebsiteBuyIpRequest

	// PostWebsiteBuyIpExecute executes the request
	//  @return PostWebsiteBuyIp200Response
	PostWebsiteBuyIpExecute(r ApiPostWebsiteBuyIpRequest) (*PostWebsiteBuyIp200Response, *http.Response, error)

	/*
	PostWebsiteMigration Submit a request for InterServer staff to migrate a website from another host
...
- **Verify after migration:** `getWebsitesLogin`, `getWebsiteInfo`.
	...
	*/
	PostWebsiteMigration(ctx context.Context, id int32) ApiPostWebsiteMigrationRequest

	// PostWebsiteMigrationExecute executes the request
	//  @return PostWebsiteMigration200Response
	PostWebsiteMigrationExecute(r ApiPostWebsiteMigrationRequest) (*PostWebsiteMigration200Response, *http.Response, error)

	/*
	PostWebsitesReverseDns Bulk-update reverse-DNS (PTR) records for one or more website IPs
...
- **Equivalent endpoint:** `postWebsiteBuyIp` (`action=reverse_dns`).
	...
	*/
	PostWebsitesReverseDns(ctx context.Context, id int32) ApiPostWebsitesReverseDnsRequest

	// PostWebsitesReverseDnsExecute executes the request
	//  @return TextResponse
	PostWebsitesReverseDnsExecute(r ApiPostWebsitesReverseDnsRequest) (*TextResponse, *http.Response, error)

	/*
	PutWebsites Validate a webhosting order and preview cost — dry run, no charge
...
```
	...
	*/
	PutWebsites(ctx context.Context) ApiPutWebsitesRequest

	// PutWebsitesExecute executes the request
	PutWebsitesExecute(r ApiPutWebsitesRequest) (*http.Response, error)

	/*
	UpdateWebsiteInfo POST mutation hook for the website detail page (use dedicated ops where possible)
...
- **Cancel:** `webhostingCancel`.
	...
	*/
	UpdateWebsiteInfo(ctx context.Context, id string) ApiUpdateWebsiteInfoRequest

	// UpdateWebsiteInfoExecute executes the request
	//  @return SuccessTextResponse
	UpdateWebsiteInfoExecute(r ApiUpdateWebsiteInfoRequest) (*SuccessTextResponse, *http.Response, error)

	/*
	WebhostingCancel Schedule termination of a webhosting service — wipes panel account at cycle end
...
- **Sibling cancels on other modules:** `VPSCancel`, `CancelDomain`, `mailCancel`, etc. all use the same `CancelService` handler.
	...
	*/
	WebhostingCancel(ctx context.Context, id string) ApiWebhostingCancelRequest

	// WebhostingCancelExecute executes the request
	//  @return WebhostingCancel200Response
	WebhostingCancelExecute(r ApiWebhostingCancelRequest) (*WebhostingCancel200Response, *http.Response, error)
}
...
type ApiAddWebsiteRequest struct {
	ctx context.Context
	ApiService WebhostingAPI
	websiteOrderPostRequest *WebsiteOrderPostRequest
}

func (r ApiAddWebsiteRequest) WebsiteOrderPostRequest(websiteOrderPostRequest WebsiteOrderPostRequest) ApiAddWebsiteRequest {
	r.websiteOrderPostRequest = &websiteOrderPostRequest
	return r
}
...
func (a *WebhostingAPIService) AddWebsiteExecute(r ApiAddWebsiteRequest) (*ServiceOrderPostResponse, *http.Response, error) {
	...
	if r.websiteOrderPostRequest == nil {
		return localVarReturnValue, nil, reportError("websiteOrderPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.websiteOrderPostRequest
	if r.ctx != nil {
...
func (r ApiPutWebsitesRequest) WebsiteOrderPutRequest(websiteOrderPutRequest WebsiteOrderPutRequest) ApiPutWebsitesRequest {
	r.websiteOrderPutRequest = &websiteOrderPutRequest
	return r
}
...
func (a *WebhostingAPIService) PutWebsitesExecute(r ApiPutWebsitesRequest) (*http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.websiteOrderPutRequest == nil {
		return nil, reportError("websiteOrderPutRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.websiteOrderPutRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKeyAuth"]; ok {
