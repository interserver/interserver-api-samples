...
type DNSAPI interface {
	...
	/*
	AddDnsDomain Create a new authoritative DNS zone seeded with apex A + NS + SOA records
...
```
	...
	*/
	AddDnsDomain(ctx context.Context) ApiAddDnsDomainRequest

	// AddDnsDomainExecute executes the request
	//  @return SuccessTextResponse
	AddDnsDomainExecute(r ApiAddDnsDomainRequest) (*SuccessTextResponse, *http.Response, error)

	/*
	AddDnsRecord Add a DNS record (A, AAAA, MX, TXT, CNAME, NS, SRV, CAA, ...) to a zone
...
- **Delete:** `deleteDnsRecord`.
	...
	*/
	AddDnsRecord(ctx context.Context, id string) ApiAddDnsRecordRequest

	// AddDnsRecordExecute executes the request
	AddDnsRecordExecute(r ApiAddDnsRecordRequest) (*http.Response, error)

	/*
	DeleteDnsDomain Permanently delete a DNS zone and every record it contains
...
- **Update registrar delegation:** `updateDomainNameservers` (Domains tag).
	...
	*/
	DeleteDnsDomain(ctx context.Context, id string) ApiDeleteDnsDomainRequest

	// DeleteDnsDomainExecute executes the request
	//  @return SuccessTextResponse
	DeleteDnsDomainExecute(r ApiDeleteDnsDomainRequest) (*SuccessTextResponse, *http.Response, error)

	/*
	DeleteDnsRecord Permanently delete one DNS record from a zone — zone itself is preserved
...
- **Delete entire zone instead:** `deleteDnsDomain`.
	...
	*/
	DeleteDnsRecord(ctx context.Context, domainId int32, recordId int32) ApiDeleteDnsRecordRequest

	// DeleteDnsRecordExecute executes the request
	//  @return SuccessTextResponse
	DeleteDnsRecordExecute(r ApiDeleteDnsRecordRequest) (*SuccessTextResponse, *http.Response, error)

	/*
	GetDnsDomain List every DNS record in one zone with the IDs needed to edit or delete them
...
- **Delete the whole zone:** `deleteDnsDomain` (DELETE same path).
	...
	*/
	GetDnsDomain(ctx context.Context, id int32) ApiGetDnsDomainRequest

	// GetDnsDomainExecute executes the request
	//  @return []DnsRecord
	GetDnsDomainExecute(r ApiGetDnsDomainRequest) ([]DnsRecord, *http.Response, error)

	/*
	GetDnsList List DNS zones hosted on the account with each zone's apex A-record IP
...
- **Registrar delegation:** `getDomainNameservers` / `updateDomainNameservers` (Domains tag).
	...
	*/
	GetDnsList(ctx context.Context) ApiGetDnsListRequest

	// GetDnsListExecute executes the request
	//  @return []DnsListItem
	GetDnsListExecute(r ApiGetDnsListRequest) ([]DnsListItem, *http.Response, error)

	/*
	UpdateDnsRecord Replace values on an existing DNS record (name, type, content, ttl, priority)
...
- **Create new:** `addDnsRecord`.
	...
	*/
	UpdateDnsRecord(ctx context.Context, domainId int32, recordId int32) ApiUpdateDnsRecordRequest

	// UpdateDnsRecordExecute executes the request
	//  @return SuccessTextResponse
	UpdateDnsRecordExecute(r ApiUpdateDnsRecordRequest) (*SuccessTextResponse, *http.Response, error)
}
