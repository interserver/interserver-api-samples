...
func (o *LicenseRow) UnmarshalJSON(data []byte) (err error) {
	varLicenseRow := _LicenseRow{}

	err = json.Unmarshal(data, &varLicenseRow)

	if err != nil {
		return err
	}

	*o = LicenseRow(varLicenseRow)
