...
type _VpsServiceExtra VpsServiceExtra
...
func (o *VpsServiceExtra) UnmarshalJSON(data []byte) (err error) {
	varVpsServiceExtra := _VpsServiceExtra{}

	err = json.Unmarshal(data, &varVpsServiceExtra)

	if err != nil {
		return err
	}

	*o = VpsServiceExtra(varVpsServiceExtra)
