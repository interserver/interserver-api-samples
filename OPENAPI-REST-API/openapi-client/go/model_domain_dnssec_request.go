...
type _DomainDnssecRequest DomainDnssecRequest
...
func (o *DomainDnssecRequest) UnmarshalJSON(data []byte) (err error) {
	varDomainDnssecRequest := _DomainDnssecRequest{}

	err = json.Unmarshal(data, &varDomainDnssecRequest)

	if err != nil {
		return err
	}

	*o = DomainDnssecRequest(varDomainDnssecRequest)
