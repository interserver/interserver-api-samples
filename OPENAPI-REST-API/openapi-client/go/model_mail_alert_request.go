...
type _MailAlertRequest MailAlertRequest
...
func (o *MailAlertRequest) UnmarshalJSON(data []byte) (err error) {
	varMailAlertRequest := _MailAlertRequest{}

	err = json.Unmarshal(data, &varMailAlertRequest)

	if err != nil {
		return err
	}

	*o = MailAlertRequest(varMailAlertRequest)
