...
type _DomainContactDetails DomainContactDetails
...
func (o *DomainContactDetails) UnmarshalJSON(data []byte) (err error) {
	varDomainContactDetails := _DomainContactDetails{}

	err = json.Unmarshal(data, &varDomainContactDetails)

	if err != nil {
		return err
	}

	*o = DomainContactDetails(varDomainContactDetails)
