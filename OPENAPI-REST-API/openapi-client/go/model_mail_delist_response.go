...
type _MailDelistResponse MailDelistResponse
...
func (o *MailDelistResponse) UnmarshalJSON(data []byte) (err error) {
	varMailDelistResponse := _MailDelistResponse{}

	err = json.Unmarshal(data, &varMailDelistResponse)

	if err != nil {
		return err
	}

	*o = MailDelistResponse(varMailDelistResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "mbtrap")
