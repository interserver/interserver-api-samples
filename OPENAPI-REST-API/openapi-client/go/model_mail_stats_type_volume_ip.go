...
type _MailStatsTypeVolumeIp MailStatsTypeVolumeIp
...
func (o *MailStatsTypeVolumeIp) UnmarshalJSON(data []byte) (err error) {
	varMailStatsTypeVolumeIp := _MailStatsTypeVolumeIp{}

	err = json.Unmarshal(data, &varMailStatsTypeVolumeIp)

	if err != nil {
		return err
	}

	*o = MailStatsTypeVolumeIp(varMailStatsTypeVolumeIp)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "1.1.1.1")
		delete(additionalProperties, "2.2.2.2")
		delete(additionalProperties, "3.3.3.3")
		delete(additionalProperties, "4.4.4.4")
