...
type _AccountInfoDataCc AccountInfoDataCc
...
func (o *AccountInfoDataCc) UnmarshalJSON(data []byte) (err error) {
	varAccountInfoDataCc := _AccountInfoDataCc{}

	err = json.Unmarshal(data, &varAccountInfoDataCc)

	if err != nil {
		return err
	}

	*o = AccountInfoDataCc(varAccountInfoDataCc)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "maxmind_riskscore")
