...
type _ServersBuyNowResponse ServersBuyNowResponse
...
func (o *ServersBuyNowResponse) UnmarshalJSON(data []byte) (err error) {
	varServersBuyNowResponse := _ServersBuyNowResponse{}

	err = json.Unmarshal(data, &varServersBuyNowResponse)

	if err != nil {
		return err
	}

	*o = ServersBuyNowResponse(varServersBuyNowResponse)
