...
type _ServerServiceInfo ServerServiceInfo
...
func (o *ServerServiceInfo) UnmarshalJSON(data []byte) (err error) {
	varServerServiceInfo := _ServerServiceInfo{}

	err = json.Unmarshal(data, &varServerServiceInfo)

	if err != nil {
		return err
	}

	*o = ServerServiceInfo(varServerServiceInfo)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "server_id")
		delete(additionalProperties, "server_hostname")
		delete(additionalProperties, "server_custid")
		delete(additionalProperties, "server_type")
		delete(additionalProperties, "server_currency")
		delete(additionalProperties, "server_order_date")
		delete(additionalProperties, "server_invoice")
		delete(additionalProperties, "server_coupon")
		delete(additionalProperties, "server_status")
		delete(additionalProperties, "server_root")
		delete(additionalProperties, "server_dedicated_tag")
		delete(additionalProperties, "server_custom_tag")
		delete(additionalProperties, "server_comment")
		delete(additionalProperties, "server_initial_bill")
		delete(additionalProperties, "server_hardware")
		delete(additionalProperties, "server_ips")
		delete(additionalProperties, "server_monthly_bill")
		delete(additionalProperties, "server_setup")
		delete(additionalProperties, "server_discount")
		delete(additionalProperties, "server_rep")
		delete(additionalProperties, "server_date")
		delete(additionalProperties, "server_total_cost")
		delete(additionalProperties, "server_location")
		delete(additionalProperties, "server_hardware_ordered")
		delete(additionalProperties, "server_billed")
		delete(additionalProperties, "server_welcome_email")
		delete(additionalProperties, "server_dedicated_cpu")
		delete(additionalProperties, "server_dedicated_memory")
		delete(additionalProperties, "server_dedicated_hd1")
		delete(additionalProperties, "server_dedicated_hd2")
		delete(additionalProperties, "server_dedicated_bandwidth")
		delete(additionalProperties, "server_dedicated_ips")
		delete(additionalProperties, "server_dedicated_os")
		delete(additionalProperties, "server_dedicated_cp")
		delete(additionalProperties, "server_dedicated_raid")
		delete(additionalProperties, "server_extra")
