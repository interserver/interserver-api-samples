...
func (o *DomainRow) UnmarshalJSON(data []byte) (err error) {
	varDomainRow := _DomainRow{}

	err = json.Unmarshal(data, &varDomainRow)

	if err != nil {
		return err
	}

	*o = DomainRow(varDomainRow)
