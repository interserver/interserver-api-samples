...
type _PostOauthCallback200Response PostOauthCallback200Response
...
func (o *PostOauthCallback200Response) UnmarshalJSON(data []byte) (err error) {
	varPostOauthCallback200Response := _PostOauthCallback200Response{}

	err = json.Unmarshal(data, &varPostOauthCallback200Response)

	if err != nil {
		return err
	}

	*o = PostOauthCallback200Response(varPostOauthCallback200Response)
