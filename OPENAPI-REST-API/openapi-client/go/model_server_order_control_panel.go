...
type _ServerOrderControlPanel ServerOrderControlPanel
...
func (o *ServerOrderControlPanel) UnmarshalJSON(data []byte) (err error) {
	varServerOrderControlPanel := _ServerOrderControlPanel{}

	err = json.Unmarshal(data, &varServerOrderControlPanel)

	if err != nil {
		return err
	}

	*o = ServerOrderControlPanel(varServerOrderControlPanel)
