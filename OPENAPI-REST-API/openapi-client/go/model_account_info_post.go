...
func (o *AccountInfoPost) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAccountInfoPost)
	...
	*o = AccountInfoPost(varAccountInfoPost)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "disable_server_notifications")
		delete(additionalProperties, "disable_email_notifications")
		delete(additionalProperties, "gstin")
