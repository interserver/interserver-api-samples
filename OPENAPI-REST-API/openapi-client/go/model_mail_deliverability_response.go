...
type _MailDeliverabilityResponse MailDeliverabilityResponse
...
func (o *MailDeliverabilityResponse) UnmarshalJSON(data []byte) (err error) {
	varMailDeliverabilityResponse := _MailDeliverabilityResponse{}

	err = json.Unmarshal(data, &varMailDeliverabilityResponse)

	if err != nil {
		return err
	}

	*o = MailDeliverabilityResponse(varMailDeliverabilityResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "table_data")
