...
type _ServerOrderIP ServerOrderIP
...
func (o *ServerOrderIP) UnmarshalJSON(data []byte) (err error) {
	varServerOrderIP := _ServerOrderIP{}

	err = json.Unmarshal(data, &varServerOrderIP)

	if err != nil {
		return err
	}

	*o = ServerOrderIP(varServerOrderIP)
