...
type _DomainSearchResponse DomainSearchResponse
...
func (o *DomainSearchResponse) UnmarshalJSON(data []byte) (err error) {
	varDomainSearchResponse := _DomainSearchResponse{}

	err = json.Unmarshal(data, &varDomainSearchResponse)

	if err != nil {
		return err
	}

	*o = DomainSearchResponse(varDomainSearchResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "suggest")
		delete(additionalProperties, "tlds")
