...
defmodule InterserverApi.Api.Public do
  @moduledoc """
  ...
  """
  @spec get_account_currencies(Tesla.Env.client, keyword()) :: {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:ok, [String.t]} | {:error, Tesla.Env.t}
  def get_account_currencies(connection, _opts \\ []) do
    request =
      %{}
      |> method(:get)
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_account_locales(Tesla.Env.client, keyword()) :: {:ok, %{optional(String.t) => InterserverApi.Model.GetAccountLocales200ResponseValue.t}} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_account_locales(connection, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/account/locales")
  ...
  - `{:ok, InterserverApi.Model.CaptchaResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_captcha(Tesla.Env.client, keyword()) :: {:ok, InterserverApi.Model.CaptchaResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_captcha(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.CaptchaResponse},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_countries(Tesla.Env.client, keyword()) :: {:ok, map()} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, InterserverApi.Model.ServicesInfo.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_info(Tesla.Env.client, keyword()) :: {:ok, InterserverApi.Model.ServicesInfo.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_info(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.ServicesInfo},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:ok, InterserverApi.Model.LoginInfo.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_login_info(Tesla.Env.client, keyword()) :: {:ok, InterserverApi.Model.LoginInfo.t} | {:ok, InterserverApi.Model.LoginErrorResponse.t} | {:error, Tesla.Env.t}
  def get_login_info(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.LoginInfo},
      {403, InterserverApi.Model.LoginErrorResponse}
    ])
  end
  ...
  - `{:ok, InterserverApi.Model.GetOauthRedirect200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_oauth_redirect(Tesla.Env.client, String.t, keyword()) :: {:ok, InterserverApi.Model.GetOauthRedirect200Response.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_oauth_redirect(connection, provider, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.GetOauthRedirect200Response},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:ok, InterserverApi.Model.PatchOauthTwoFactor200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec patch_oauth_two_factor(Tesla.Env.client, InterserverApi.Model.PatchOauthTwoFactorRequest.t, keyword()) :: {:ok, InterserverApi.Model.PatchOauthTwoFactor200Response.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def patch_oauth_two_factor(connection, patch_oauth_two_factor_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.PatchOauthTwoFactor200Response},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec ping_server(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:ok, String.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, InterserverApi.Model.PostOauthCallback200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_oauth_callback(Tesla.Env.client, String.t, keyword()) :: {:ok, InterserverApi.Model.PostOauthCallback200Response.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def post_oauth_callback(connection, provider, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.PostOauthCallback200Response},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `opts` (keyword): Optional parameters
    - `:remember` (String.t): 
    - `:"g-recaptcha-response"` (InterserverApi.Model.LoginSubmissionExampleGRecaptchaResponse.t): 
    - `:tfa` (String.t): Two Factor Authentication Response.

  ### Returns

  - `{:ok, InterserverApi.Model.LoginSuccessResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec submit_login(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, nil} | {:ok, InterserverApi.Model.LoginErrorResponse.t} | {:ok, InterserverApi.Model.LoginSuccessResponse.t} | {:error, Tesla.Env.t}
  def submit_login(connection, login, passwd, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.LoginSuccessResponse},
      {402, InterserverApi.Model.LoginErrorResponse},
      {:default, false}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec submit_signup(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, InterserverApi.Model.LoginErrorResponse.t} | {:error, Tesla.Env.t}
