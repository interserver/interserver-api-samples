...
defmodule InterserverApi.Api.SSLCertificates do
  @moduledoc """
  ...
  """
  @spec add_ssl(Tesla.Env.client, InterserverApi.Model.SslOrderRequest.t, keyword()) :: {:ok, InterserverApi.Model.ServiceOrderPostResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def add_ssl(connection, ssl_order_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/ssl/order")
      |> add_param(:body, :body, ssl_order_request)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_new_ssl(Tesla.Env.client, keyword()) :: {:ok, map()} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_ssl_info(Tesla.Env.client, integer(), keyword()) :: {:ok, map()} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_ssl_invoices(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.ChargeInvoiceRows.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_ssl_list(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_ssl_welcome_email(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec put_ssl(Tesla.Env.client, InterserverApi.Model.SslOrderRequest.t, keyword()) :: {:ok, nil} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def put_ssl(connection, ssl_order_request, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/ssl/order")
  ...
  - `{:ok, InterserverApi.Model.SslCancel200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec ssl_cancel(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.SslCancel200Response.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def ssl_cancel(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.SslCancel200Response},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_ssl_info(Tesla.Env.client, String.t, keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
