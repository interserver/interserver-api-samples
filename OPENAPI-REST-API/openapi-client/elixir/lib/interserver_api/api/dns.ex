...
defmodule InterserverApi.Api.DNS do
  @moduledoc """
  ...
  """
  @spec add_dns_domain(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec add_dns_record(Tesla.Env.client, String.t, String.t, InterserverApi.Model.DnsRecordType.t, String.t, keyword()) :: {:ok, nil} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_dns_domain(Tesla.Env.client, String.t, keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_dns_record(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_dns_domain(Tesla.Env.client, integer(), keyword()) :: {:ok, [InterserverApi.Model.DnsRecord.t]} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_dns_domain(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.DnsRecord},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_dns_list(Tesla.Env.client, keyword()) :: {:ok, [InterserverApi.Model.DnsListItem.t]} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_dns_list(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.DnsListItem},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_dns_record(Tesla.Env.client, integer(), integer(), keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
