...
defmodule InterserverApi.Api.Licenses do
  @moduledoc """
  ...
  """
  @spec add_license(Tesla.Env.client, InterserverApi.Model.LicenseOrderRequest.t, keyword()) :: {:ok, InterserverApi.Model.ServiceOrderPostResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def add_license(connection, license_order_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/licenses/order")
      |> add_param(:body, :body, license_order_request)
      |> Enum.into([])
  ...
  - `{:ok, InterserverApi.Model.License.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_license_info(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.License.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_license_info(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.License},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_license_invoices(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.ChargeInvoiceRows.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_license_list(Tesla.Env.client, keyword()) :: {:ok, [InterserverApi.Model.LicenseRow.t]} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_license_list(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.LicenseRow},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_licenses_welcome_email(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, InterserverApi.Model.LicensesOrder.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_new_license(Tesla.Env.client, keyword()) :: {:ok, InterserverApi.Model.LicensesOrder.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_new_license(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.LicensesOrder},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:ok, InterserverApi.Model.LicensesCancel200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec licenses_cancel(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.LicensesCancel200Response.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def licenses_cancel(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.LicensesCancel200Response},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_license_change_ip(Tesla.Env.client, integer(), InterserverApi.Model.IpObject.t, keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec put_licenses(Tesla.Env.client, InterserverApi.Model.LicenseOrderRequest.t, keyword()) :: {:ok, nil} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def put_licenses(connection, license_order_request, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/licenses/order")
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_license_info(Tesla.Env.client, String.t, keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
