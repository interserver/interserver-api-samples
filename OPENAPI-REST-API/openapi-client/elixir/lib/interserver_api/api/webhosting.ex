...
defmodule InterserverApi.Api.Webhosting do
  @moduledoc """
  ...
  - `website_order_post_request` (WebsiteOrderPostRequest): 
  ...
  """
  @spec add_website(Tesla.Env.client, InterserverApi.Model.WebsiteOrderPostRequest.t, keyword()) :: {:ok, InterserverApi.Model.ServiceOrderPostResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def add_website(connection, website_order_post_request, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/websites/order")
      |> add_param(:body, :body, website_order_post_request)
      |> Enum.into([])
  ...
  - `{:ok, InterserverApi.Model.WebsitesOrder.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_new_website(Tesla.Env.client, keyword()) :: {:ok, InterserverApi.Model.WebsitesOrder.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_new_website(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.WebsitesOrder},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:ok, InterserverApi.Model.GetWebsiteBuyIp200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_website_buy_ip(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.GetWebsiteBuyIp200Response.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_website_buy_ip(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.GetWebsiteBuyIp200Response},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:ok, InterserverApi.Model.Website.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_website_info(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.Website.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_website_info(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.Website},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_website_invoices(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.ChargeInvoiceRows.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_website_list(Tesla.Env.client, keyword()) :: {:ok, [InterserverApi.Model.WebsiteRow.t]} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_website_list(connection, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.WebsiteRow},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:ok, InterserverApi.Model.WebsiteBackups.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_websites_backups(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.WebsiteBackups.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_websites_backups(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.WebsiteBackups},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:ok, InterserverApi.Model.WebsiteLoginResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_websites_login(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.WebsiteLoginResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def get_websites_login(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.WebsiteLoginResponse},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_websites_welcome_email(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec gett_website_reverse_dns(Tesla.Env.client, integer(), keyword()) :: {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:ok, InterserverApi.Model.ReverseDnsEntries.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, InterserverApi.Model.PostWebsiteBuyIp200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_website_buy_ip(Tesla.Env.client, integer(), InterserverApi.Model.PostWebsiteBuyIpRequest.t, keyword()) :: {:ok, InterserverApi.Model.PostWebsiteBuyIp200Response.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def post_website_buy_ip(connection, id, post_website_buy_ip_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.PostWebsiteBuyIp200Response},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:ok, InterserverApi.Model.PostWebsiteMigration200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_website_migration(Tesla.Env.client, integer(), InterserverApi.Model.PostWebsiteMigrationRequest.t, keyword()) :: {:ok, InterserverApi.Model.PostWebsiteMigration200Response.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def post_website_migration(connection, id, post_website_migration_request, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.PostWebsiteMigration200Response},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec post_websites_reverse_dns(Tesla.Env.client, integer(), InterserverApi.Model.ReverseDnsEntries.t, keyword()) :: {:ok, InterserverApi.Model.TextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  - `connection` (InterserverApi.Connection): Connection to server
  - `website_order_put_request` (WebsiteOrderPutRequest): 
  - `opts` (keyword): Optional parameters
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec put_websites(Tesla.Env.client, InterserverApi.Model.WebsiteOrderPutRequest.t, keyword()) :: {:ok, nil} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def put_websites(connection, website_order_put_request, _opts \\ []) do
    request =
      %{}
      |> method(:put)
      |> url("/websites/order")
      |> add_param(:body, :body, website_order_put_request)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_website_info(Tesla.Env.client, String.t, keyword()) :: {:ok, InterserverApi.Model.SuccessTextResponse.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  ...
  **DESTRUCTIVE.** Schedules the website for cancellation via the shared `Billing\\CancelService::go($id)` flow with `module='webhosting'`. Marks the service `pending-cancel`, halts the recurring invoice, and queues deprovisioning so cPanel/DirectAdmin/Plesk/Webuzo removes the account and **all hosted files, databases, mailboxes, and DNS** at end-of-cycle. **There is no client-side restore** — take a cpmove backup via `getWebsitesBackups` first (with `download=<name>`) if data must be preserved. Sibling ops: `getWebsitesBackups`, `getWebsiteInfo` (verify status flipped), `getWebsiteInvoices`.  **Path param:** - `id` (integer, required) — `website_id` from `getWebsiteList`.  **Body:** None.  **Returns:** `WebsiteCancelResponse` — cancel-service confirmation payload.  **Side effects:** - Sets `website_status='pending-cancel'`. - Marks the `repeat_invoices` row as non-renewing. - Logs the cancellation in `history_log`. - Queues deprovisioning to run at end-of-cycle (the cPanel/DA/Plesk account, all hosted files, databases, email accounts, and DNS will be removed). - Customer retains panel access until the cycle ends.  **Auth:** Session/API key. Ownership enforced.  **Errors:** - `401` — unauthenticated. - `404` — `id` not owned by caller. - `409` — service in a state that cannot be cancelled (already `canceled`, etc.).  **Related calls:** - **Before cancelling:** `getWebsitesBackups` (download a cpmove archive — irretrievable after deprovisioning). - **After cancelling:** `getWebsiteInfo` (confirm `pending-cancel`), `getWebsiteInvoices` (final invoices). - **Sibling cancels on other modules:** `VPSCancel`, `CancelDomain`, `mailCancel`, etc. all use the same `CancelService` handler. 
  ...
  - `{:ok, InterserverApi.Model.WebhostingCancel200Response.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec webhosting_cancel(Tesla.Env.client, String.t, keyword()) :: {:ok, InterserverApi.Model.WebhostingCancel200Response.t} | {:ok, InterserverApi.Model.GetAccountInfo401Response.t} | {:error, Tesla.Env.t}
  def webhosting_cancel(connection, id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, InterserverApi.Model.WebhostingCancel200Response},
      {401, InterserverApi.Model.GetAccountInfo401Response}
    ])
  end
end
