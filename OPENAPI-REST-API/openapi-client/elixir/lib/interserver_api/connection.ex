...
defmodule InterserverApi.Connection do
  ...
  @doc """
  Configure a InterserverApi client.

  ### Parameters

  - `options`: an optional keyword list of InterserverApi.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:interserver_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - InterserverApi 1.0.0 - elixir"
        )
      )
