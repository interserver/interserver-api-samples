# interserver_api.model.ServerAsset
...
**mac** | **Optional&lt;String?&gt;** | MAC address associated with the asset. | [optional] 
**ipmiAdminUsername** | **Optional&lt;String?&gt;** | IPMI admin username associated with the asset. | [optional] 
**ipmiAdminPassword** | **Optional&lt;String?&gt;** | IPMI admin password associated with the asset. | [optional] 
**ipmiClientUsername** | **Optional&lt;String?&gt;** | IPMI client username associated with the asset. | [optional] 
**ipmiClientPassword** | **Optional&lt;String?&gt;** | IPMI client password associated with the asset. | [optional] 
**ipmiUpdated** | **Optional&lt;String?&gt;** | IPMI update status associated with the asset. | [optional] 
**createTimestamp** | **Optional&lt;String?&gt;** | Timestamp of asset creation. | [optional] 
**updateTimestamp** | **Optional&lt;String?&gt;** | Timestamp of asset update. | [optional] 
**comment** | **Optional&lt;String?&gt;** | Comment associated with the asset. | [optional] 
