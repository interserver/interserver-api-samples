# interserver_api.api.ScrubIpsApi
...
final api = InterserverApi().getScrubIpsApi();
...
# **createFilter**
> CreateFilter201Response createFilter(createFilter, id)
...
try {
    final response = api.createFilter(createFilter, id);
    print(response);
} on DioException catch (e) {
...
# **createGeoRule**
> CreateRule201Response createGeoRule(createGeoFirewallRule, id)
...
try {
    final response = api.createGeoRule(createGeoFirewallRule, id);
    print(response);
} on DioException catch (e) {
...
# **createRule**
> CreateRule201Response createRule(createFirewallRule, id)
...
try {
    final response = api.createRule(createFirewallRule, id);
    print(response);
} on DioException catch (e) {
...
# **deleteFilter**
> DeleteFilter200Response deleteFilter(createFilter, id)
...
try {
    final response = api.deleteFilter(createFilter, id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.putScrubIps(scrubIpPlaceOrder);
    print(response);
} on DioException catch (e) {
...
> ScrubIpsDeleteRule200Response scrubIpsDeleteGeoRule(deleteGeoFirewallRule, id)
...
try {
    final response = api.scrubIpsDeleteGeoRule(deleteGeoFirewallRule, id);
    print(response);
} on DioException catch (e) {
...
# **scrubIpsDeleteRule**
> ScrubIpsDeleteRule200Response scrubIpsDeleteRule(deleteFirewallRule, id)
...
try {
    final response = api.scrubIpsDeleteRule(deleteFirewallRule, id);
    print(response);
} on DioException catch (e) {
