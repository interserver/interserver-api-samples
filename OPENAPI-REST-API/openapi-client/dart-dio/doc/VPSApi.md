...
final api = InterserverApi().getVPSApi();
...
# **downloadVpsBackup**
> DownloadQsBackup200Response downloadVpsBackup(downloadQsBackupRequest, id, all)
...
try {
    final response = api.downloadVpsBackup(downloadQsBackupRequest, id, all);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getVpsBackup(id);
    print(response);
} on DioException catch (e) {
    print('Exception when calling VPSApi->getVpsBackup: $e\n');
}
```
...
try {
    ...
    print('Exception when calling VPSApi->getVpsChangeHostname: $e\n');
}
```
...
try {
    ...
    print('Exception when calling VPSApi->getVpsChangeRootPassword: $e\n');
}
```
...
try {
    ...
    print('Exception when calling VPSApi->getVpsInsertCd: $e\n');
}
```
...
try {
    ...
    print('Exception when calling VPSApi->getVpsResetPassword: $e\n');
}
```
...
try {
    final response = api.postVpsChangeRootPassword(password, id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postVpsChangeTimezone(timezone, id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postVpsChangeWebuzoPassword(password, id);
    print(response);
} on DioException catch (e) {
...
# **postVpsReinstallOs**
> QueueResponse postVpsReinstallOs(template, localPassword, id, password)
...
try {
    final response = api.postVpsReinstallOs(template, localPassword, id, password);
    print(response);
} on DioException catch (e) {
...
# **postVpsRestore**
> QueueResponse postVpsRestore(restoreRequest, id)
...
try {
    final response = api.postVpsRestore(restoreRequest, id);
    print(response);
} on DioException catch (e) {
...
# **postVpsReverseDns**
> TextResponse postVpsReverseDns(reverseDnsEntries, id)
...
try {
    final response = api.postVpsReverseDns(reverseDnsEntries, id);
    print(response);
} on DioException catch (e) {
...
try {
    ...
    print('Exception when calling VPSApi->postVpsTrafficUsage: $e\n');
}
```
...
try {
    ...
    print('Exception when calling VPSApi->putVpsBuyHdSpace: $e\n');
}
```
