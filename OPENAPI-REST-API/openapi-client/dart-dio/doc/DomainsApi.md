# interserver_api.api.DomainsApi
...
final api = InterserverApi().getDomainsApi();
final DomainOrderRequest domainOrderRequest = ; // DomainOrderRequest | 

try {
    final response = api.addDomain(domainOrderRequest);
    print(response);
...
# **addDomainDnssec**
> SuccessTextResponse addDomainDnssec(domainDnssecRequest, id)
...
try {
    final response = api.addDomainDnssec(domainDnssecRequest, id);
    print(response);
} on DioException catch (e) {
...
# **addDomainNameserver**
> TextResponse addDomainNameserver(domainNameserverPostRequest, id)
...
try {
    final response = api.addDomainNameserver(domainNameserverPostRequest, id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.deleteDomainDnssec(id);
    print(response);
} on DioException catch (e) {
...
try {
    api.patchDomains(domainOrderRequest);
} on DioException catch (e) {
...
try {
    api.postDomainSearch(name);
} on DioException catch (e) {
    print('Exception when calling DomainsApi->postDomainSearch: $e\n');
}
```
...
try {
    api.putDomains(domainOrderRequest);
} on DioException catch (e) {
...
# **updateDomainContact**
> SuccessTextResponse updateDomainContact(domainContactDetails, id)
...
try {
    final response = api.updateDomainContact(domainContactDetails, id);
    print(response);
} on DioException catch (e) {
...
> TextResponse updateDomainNameservers(domainNameserverPutRequest, id)
...
try {
    final response = api.updateDomainNameservers(domainNameserverPutRequest, id);
    print(response);
} on DioException catch (e) {
...
# **updateDomainWhoisPrivacy**
> SuccessTextResponse updateDomainWhoisPrivacy(domainWhoisPrivacyRequest, id)
...
try {
    final response = api.updateDomainWhoisPrivacy(domainWhoisPrivacyRequest, id);
    print(response);
} on DioException catch (e) {
