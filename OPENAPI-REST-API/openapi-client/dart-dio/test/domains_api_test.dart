...
void main() {
  final instance = InterserverApi().getDomainsApi();
  ...
  group(DomainsApi, () {
    ...
    //
    //Future<ServiceOrderPostResponse> addDomain(DomainOrderRequest domainOrderRequest) async
    ...
    //
    //Future<SuccessTextResponse> addDomainDnssec(DomainDnssecRequest domainDnssecRequest, int id) async
    ...
    //
    //Future<TextResponse> addDomainNameserver(DomainNameserverPostRequest domainNameserverPostRequest, int id) async
    ...
    //
    //Future<SuccessTextResponse> deleteDomainDnssec(int id) async
    ...
    //
    //Future patchDomains(DomainOrderRequest domainOrderRequest) async
    ...
    //
    //Future postDomainSearch(String name) async
    test('test postDomainSearch', () async {
      // TODO
    });
    ...
    //
    //Future putDomains(DomainOrderRequest domainOrderRequest) async
    ...
    //
    //Future<SuccessTextResponse> updateDomainContact(DomainContactDetails domainContactDetails, int id) async
    ...
    //
    //Future<SuccessTextResponse> updateDomainInfo(int id) async
    ...
    //
    //Future<TextResponse> updateDomainNameservers(DomainNameserverPutRequest domainNameserverPutRequest, int id) async
    ...
    //
    //Future<SuccessTextResponse> updateDomainWhoisPrivacy(DomainWhoisPrivacyRequest domainWhoisPrivacyRequest, int id) async
