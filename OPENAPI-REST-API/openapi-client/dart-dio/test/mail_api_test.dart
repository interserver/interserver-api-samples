...
/// tests for MailApi
void main() {
  final instance = InterserverApi().getMailApi();
  ...
  group(MailApi, () {
    ...
    //
    //Future<GenericResponse> addRule(DenyRuleNew denyRuleNew, int id) async
    ...
    //
    //Future<SuccessTextResponse> createMailAlert(MailAlertRequest mailAlertRequest, int id) async
    ...
    //
    //Future<SuccessTextResponse> deleteMailAlert(DeleteMailAlertRequest deleteMailAlertRequest, int id) async
    ...
    //
    //Future<SuccessTextResponse> postMailDelist(MailDelistRequest mailDelistRequest, int id) async
    ...
    //
    //Future<GenericResponse> sendAdvMail(SendMailAdv sendMailAdv, int id) async
    ...
    //
    //Future<GenericResponse> sendMail(SendMail sendMail, int id) async
    ...
    //
    //Future<SuccessTextResponse> updateMailAlert(MailAlertUpdateRequest mailAlertUpdateRequest, int id) async
    ...
    //
    //Future<GenericResponse> updateRule(DenyRuleNew denyRuleNew, int id, String rule) async
