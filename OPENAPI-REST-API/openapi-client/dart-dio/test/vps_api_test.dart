...
/// tests for VPSApi
void main() {
  final instance = InterserverApi().getVPSApi();
  ...
  group(VPSApi, () {
    ...
    //
    //Future<DownloadQsBackup200Response> downloadVpsBackup(DownloadQsBackupRequest downloadQsBackupRequest, int id, { String all }) async
    ...
    //
    //Future<QueueResponse> getVpsBackup(int id) async
    test('test getVpsBackup', () async {
      // TODO
    });
    ...
    //
    //Future getVpsChangeHostname(int id) async
    test('test getVpsChangeHostname', () async {
      // TODO
    });
    ...
    //
    //Future getVpsChangeRootPassword(int id) async
    test('test getVpsChangeRootPassword', () async {
      // TODO
    });
    ...
    //
    //Future getVpsInsertCd(int id) async
    test('test getVpsInsertCd', () async {
      // TODO
    });
    ...
    //
    //Future getVpsResetPassword(int id) async
    test('test getVpsResetPassword', () async {
      // TODO
    });
    ...
    //
    //Future<QueueResponse> postVpsReinstallOs(String template, String localPassword, int id, { String password }) async
    ...
    //
    //Future<QueueResponse> postVpsRestore(RestoreRequest restoreRequest, int id) async
    ...
    //
    //Future<TextResponse> postVpsReverseDns(ReverseDnsEntries reverseDnsEntries, int id) async
    ...
    //
    //Future postVpsTrafficUsage(int id) async
    test('test postVpsTrafficUsage', () async {
      // TODO
    });
    ...
    //
    //Future putVpsBuyHdSpace(int id) async
    test('test putVpsBuyHdSpace', () async {
      // TODO
    });
