...
void main() {
  final instance = InterserverApi().getScrubIpsApi();
  ...
  group(ScrubIpsApi, () {
    ...
    //
    //Future<CreateFilter201Response> createFilter(CreateFilter createFilter, int id) async
    ...
    //
    //Future<CreateRule201Response> createGeoRule(CreateGeoFirewallRule createGeoFirewallRule, int id) async
    ...
    //
    //Future<CreateRule201Response> createRule(CreateFirewallRule createFirewallRule, int id) async
    ...
    //
    //Future<DeleteFilter200Response> deleteFilter(CreateFilter createFilter, int id) async
    ...
    //
    //Future<PutScrubIps200Response> putScrubIps(ScrubIpPlaceOrder scrubIpPlaceOrder) async
    test('test putScrubIps', () async {
      // TODO
    });
    ...
    //
    //Future<ScrubIpsDeleteRule200Response> scrubIpsDeleteGeoRule(DeleteGeoFirewallRule deleteGeoFirewallRule, int id) async
    ...
    //
    //Future<ScrubIpsDeleteRule200Response> scrubIpsDeleteRule(DeleteFirewallRule deleteFirewallRule, int id) async
