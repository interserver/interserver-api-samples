...
void main() {
  final instance = InterserverApi().getLicensesApi();
  ...
  group(LicensesApi, () {
    ...
    //
    //Future<ServiceOrderPostResponse> addLicense(LicenseOrderRequest licenseOrderRequest) async
    ...
    //
    //Future<SuccessTextResponse> postLicenseChangeIp(IpObject ipObject, int id) async
    ...
    //
    //Future putLicenses(LicenseOrderRequest licenseOrderRequest) async
