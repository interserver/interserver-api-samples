...
void main() {
  final instance = InterserverApi().getFloatingIPsApi();
  ...
  group(FloatingIPsApi, () {
    ...
    //
    //Future<ServiceOrderPostResponse> addFloatingIp(FloatingIpOrderRequest floatingIpOrderRequest) async
    ...
    //
    //Future putFloatingIps(FloatingIpOrderRequest floatingIpOrderRequest) async
