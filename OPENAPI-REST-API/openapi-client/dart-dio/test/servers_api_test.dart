...
void main() {
  final instance = InterserverApi().getServersApi();
  ...
  group(ServersApi, () {
    ...
    //
    //Future<AddServer200Response> addServer(ServerOrderPostRequest serverOrderPostRequest) async
    ...
    //
    //Future<TextResponse> postServerReverseDns(ReverseDnsEntries reverseDnsEntries, int id) async
    ...
    test('test serverBulkIpmiPowerGet', () async {
      // TODO
    });
    ...
    //
    //Future<ServerIpmiLiveInfo> serverIpmiLivePost(String ip, int id, { int asset }) async
    ...
    //
    //Future<TextResponse> serverIpmiPowerPost(String action, int id, { int asset }) async
