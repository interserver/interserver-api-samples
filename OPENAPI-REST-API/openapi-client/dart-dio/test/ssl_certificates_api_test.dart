...
void main() {
  final instance = InterserverApi().getSSLCertificatesApi();
  ...
  group(SSLCertificatesApi, () {
    ...
    //
    //Future<ServiceOrderPostResponse> addSsl(SslOrderRequest sslOrderRequest) async
    ...
    //
    //Future putSsl(SslOrderRequest sslOrderRequest) async
