...
void main() {
  final instance = InterserverApi().getBillingApi();
  ...
  group(BillingApi, () {
    ...
    test('test getAffiliateDownload', () async {
      // TODO
    });
    ...
    //
    //Future<GetAffiliateSignups200Response> getAffiliateSignups({ String st }) async
    test('test getAffiliateSignups', () async {
      // TODO
    });
    ...
    //
    //Future<SuccessTextResponse> patchBillingCreditCardVerify(PatchBillingCreditCardVerifyRequest patchBillingCreditCardVerifyRequest, int id) async
    test('test patchBillingCreditCardVerify', () async {
      // TODO
    });
    ...
    //
    //Future<SuccessTextResponse> postBillingCreditCardVerify(BillingVerifyCcRequest billingVerifyCcRequest, int id) async
