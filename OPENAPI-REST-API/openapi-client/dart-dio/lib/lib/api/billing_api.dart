...
class BillingApi {
  ...
  Future<Response<SuccessTextResponse>> addBillingCreditCard({ 
    ...
    try {
      _bodyData = jsonEncode(billingAddCcRequest);
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> addBillingPrepay({ 
    ...
    try {
      _bodyData = jsonEncode(billingPrepayRequest);
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> deleteBillingCreditCard({ 
    ...
    final _path = r'/billing/creditcards/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> deleteBillingInvoice({ 
    ...
    final _path = r'/billing/invoices/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> deleteBillingPrepay({ 
    ...
    final _path = r'/billing/prepays/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<AffiliateBannerRow>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<AffiliateBannerRow>>> getAffiliateBanners({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    List<AffiliateBannerRow>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<AffiliateBannerRow>, AffiliateBannerRow>(rawData, 'List<AffiliateBannerRow>', growable: true);
    ...
    return Response<List<AffiliateBannerRow>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [st] - Filter by status.
  /// * [ex] - Export format: csv, xls, xlsx, or pdf. Defaults to csv.
  /// * [year] - Year to filter the report. Defaults to the current year.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getAffiliateDownload({ 
    String? st,
    String? ex,
    int? year,
    CancelToken? cancelToken,
    ...
    final _path = r'/affiliate/download';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<TextResponse, TextResponse>(rawData, 'TextResponse', growable: true);
  ...
  Future<Response<StatusMonthlyBreakdown>> getAffiliateSalesGraph({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<StatusMonthlyBreakdown, StatusMonthlyBreakdown>(rawData, 'StatusMonthlyBreakdown', growable: true);
  ...
  ///
  /// Parameters:
  /// * [st] - Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetAffiliateSignups200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetAffiliateSignups200Response>> getAffiliateSignups({ 
    String? st,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/affiliate/signups';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetAffiliateSignups200Response? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<GetAffiliateSignups200Response, GetAffiliateSignups200Response>(rawData, 'GetAffiliateSignups200Response', growable: true);
    ...
    return Response<GetAffiliateSignups200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<MonthlyCounts>> getAffiliateTrafficGraph({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MonthlyCounts, MonthlyCounts>(rawData, 'MonthlyCounts', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<AffiliateTrafficRow>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<AffiliateTrafficRow>>> getAffiliateWebTraffic({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    List<AffiliateTrafficRow>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<AffiliateTrafficRow>, AffiliateTrafficRow>(rawData, 'List<AffiliateTrafficRow>', growable: true);
    ...
    return Response<List<AffiliateTrafficRow>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Object>> getBillingCart({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<Object, Object>(rawData, 'Object', growable: true);
  ...
  Future<Response<SuccessTextResponse>> getBillingCreditCardVerify({ 
    ...
    final _path = r'/billing/creditcards/{id}/verify'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<BillingInvoiceDetail>> getBillingInvoice({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<BillingInvoiceDetail, BillingInvoiceDetail>(rawData, 'BillingInvoiceDetail', growable: true);
  ...
  Future<Response<BillingInvoiceList>> getBillingInvoices({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<BillingInvoiceList, BillingInvoiceList>(rawData, 'BillingInvoiceList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [Object] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Object>> getBillingPrePays({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
...
_responseData = rawData == null ? null : deserialize<Object, Object>(rawData, 'Object', growable: true);
  ...
  Future<Response<InitiatePayment200Response>> initiatePayment({ 
    ...
    final _path = r'/billing/pay/{method}/{invoices}'.replaceAll('{' r'method' '}', method.toString()).replaceAll('{' r'invoices' '}', invoices.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<InitiatePayment200Response, InitiatePayment200Response>(rawData, 'InitiatePayment200Response', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [SuccessTextResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SuccessTextResponse>> patchBillingCreditCardVerify({ 
    required PatchBillingCreditCardVerifyRequest patchBillingCreditCardVerifyRequest,
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      _bodyData = jsonEncode(patchBillingCreditCardVerifyRequest);
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> postBillingCreditCardVerify({ 
    ...
    try {
      _bodyData = jsonEncode(billingVerifyCcRequest);
  ...
  Future<Response<TextResponse>> updateAffiliateDockSetup({ 
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        if (affiliateDockTitle != null) r'affiliate_dock_title': affiliateDockTitle,
        if (affiliateDockDescription != null) r'affiliate_dock_description': affiliateDockDescription,
        if (referrerCoupon != null) r'referrer_coupon': referrerCoupon,
      });
...
_responseData = rawData == null ? null : deserialize<TextResponse, TextResponse>(rawData, 'TextResponse', growable: true);
  ...
  Future<Response<TextResponse>> updateAffiliatePaymentSetup({ 
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        if (affiliatePaypal != null) r'affiliate_paypal': affiliatePaypal,
        if (affiliatePaymentMethod != null) r'affiliate_payment_method': affiliatePaymentMethod,
      });
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> updateBillingPaymentMethod({ 
    ...
    try {
      _bodyData = jsonEncode(billingPaymentMethodRequest);
