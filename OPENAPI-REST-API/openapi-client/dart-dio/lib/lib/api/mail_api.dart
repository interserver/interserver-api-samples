...
class MailApi {
  ...
  Future<Response<ServiceOrderPostResponse>> addMail({ 
    required MailOrderRequest mailOrderRequest,
    ...
    try {
      _bodyData = jsonEncode(mailOrderRequest);
...
_responseData = rawData == null ? null : deserialize<ServiceOrderPostResponse, ServiceOrderPostResponse>(rawData, 'ServiceOrderPostResponse', growable: true);
  ...
  Future<Response<GenericResponse>> addRule({ 
    ...
    final _path = r'/mail/{id}/rules'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = jsonEncode(denyRuleNew);
...
_responseData = rawData == null ? null : deserialize<GenericResponse, GenericResponse>(rawData, 'GenericResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> createMailAlert({ 
    ...
    final _path = r'/mail/{id}/alerts'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = jsonEncode(mailAlertRequest);
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> deleteMailAlert({ 
    required DeleteMailAlertRequest deleteMailAlertRequest,
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      _bodyData = jsonEncode(deleteMailAlertRequest);
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<GenericResponse>> deleteRule({ 
    ...
    final _path = r'/mail/{id}/rules/{rule}'.replaceAll('{' r'id' '}', id.toString()).replaceAll('{' r'rule' '}', rule.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<GenericResponse, GenericResponse>(rawData, 'GenericResponse', growable: true);
  ...
  Future<Response<GenericResponse>> delistBlock({ 
    ...
    final _path = r'/mail/{id}/blocks/delete'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<GenericResponse, GenericResponse>(rawData, 'GenericResponse', growable: true);
  ...
  Future<Response<MailAlertsResponse>> getMailAlerts({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MailAlertsResponse, MailAlertsResponse>(rawData, 'MailAlertsResponse', growable: true);
  ...
  Future<Response<MailBlocks>> getMailBlocks({ 
    ...
    final _path = r'/mail/{id}/blocks'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MailBlocks, MailBlocks>(rawData, 'MailBlocks', growable: true);
  ...
  Future<Response<MailDelistResponse>> getMailDelist({ 
    ...
    final _path = r'/mail/{id}/delist'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MailDelistResponse, MailDelistResponse>(rawData, 'MailDelistResponse', growable: true);
  ...
  Future<Response<MailDeliverabilityResponse>> getMailDeliverability({ 
    ...
    final _path = r'/mail/{id}/deliverability'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MailDeliverabilityResponse, MailDeliverabilityResponse>(rawData, 'MailDeliverabilityResponse', growable: true);
  ...
  Future<Response<MailSchema>> getMailInfo({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MailSchema, MailSchema>(rawData, 'MailSchema', growable: true);
  ...
  Future<Response<ChargeInvoiceRows>> getMailInvoices({ 
    ...
    final _path = r'/mail/{id}/invoices'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ChargeInvoiceRows, ChargeInvoiceRows>(rawData, 'ChargeInvoiceRows', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<MailRow>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<MailRow>>> getMailList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    List<MailRow>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<MailRow>, MailRow>(rawData, 'List<MailRow>', growable: true);
  ...
  Future<Response<SuccessTextResponse>> getMailWelcomeEmail({ 
    ...
    final _path = r'/mail/{id}/welcome_email'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<MailOrder>> getNewMail({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MailOrder, MailOrder>(rawData, 'MailOrder', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<DenyRuleRecord>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<DenyRuleRecord>>> getRules({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    List<DenyRuleRecord>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<DenyRuleRecord>, DenyRuleRecord>(rawData, 'List<DenyRuleRecord>', growable: true);
    ...
    return Response<List<DenyRuleRecord>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<MailStatsType>> getStats({ 
    ...
    final _path = r'/mail/{id}/stats'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MailStatsType, MailStatsType>(rawData, 'MailStatsType', growable: true);
  ...
  Future<Response<MailCancel200Response>> mailCancel({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MailCancel200Response, MailCancel200Response>(rawData, 'MailCancel200Response', growable: true);
  ...
  Future<Response<SuccessTextResponse>> postMailDelist({ 
    ...
    try {
      _bodyData = jsonEncode(mailDelistRequest);
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> resetMailPassword({ 
    ...
    final _path = r'/mail/{id}/reset_password'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<GenericResponse>> sendAdvMail({ 
    ...
    try {
      _bodyData = jsonEncode(sendMailAdv);
...
_responseData = rawData == null ? null : deserialize<GenericResponse, GenericResponse>(rawData, 'GenericResponse', growable: true);
  ...
  Future<Response<SuccessTextResponse>> updateMailAlert({ 
    ...
    try {
      _bodyData = jsonEncode(mailAlertUpdateRequest);
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  /// * [denyRuleNew] 
  /// * [id] - The mail service ID. Use `mail_id` from `GET /mail`.
  /// * [rule] - The ID of the deny rule to update.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [GenericResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponse>> updateRule({ 
    required DenyRuleNew denyRuleNew,
    required int id,
    required String rule,
    CancelToken? cancelToken,
...
_responseData = rawData == null ? null : deserialize<GenericResponse, GenericResponse>(rawData, 'GenericResponse', growable: true);
  ...
  Future<Response<MailLog>> viewMailLog({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (mailid != null) r'mailid': mailid,
      if (messageId != null) r'messageId': messageId,
      if (replyto != null) r'replyto': replyto,
      if (headerfrom != null) r'headerfrom': headerfrom,
      if (delivered != null) r'delivered': delivered,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MailLog, MailLog>(rawData, 'MailLog', growable: true);
