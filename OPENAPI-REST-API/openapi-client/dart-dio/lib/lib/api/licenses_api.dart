...
class LicensesApi {
  ...
  Future<Response<ServiceOrderPostResponse>> addLicense({ 
    required LicenseOrderRequest licenseOrderRequest,
    ...
    try {
      _bodyData = jsonEncode(licenseOrderRequest);
...
_responseData = rawData == null ? null : deserialize<ServiceOrderPostResponse, ServiceOrderPostResponse>(rawData, 'ServiceOrderPostResponse', growable: true);
  ...
  Future<Response<License>> getLicenseInfo({ 
    ...
    final _path = r'/licenses/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<License, License>(rawData, 'License', growable: true);
  ...
  Future<Response<ChargeInvoiceRows>> getLicenseInvoices({ 
    ...
    final _path = r'/licenses/{id}/invoices'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ChargeInvoiceRows, ChargeInvoiceRows>(rawData, 'ChargeInvoiceRows', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<LicenseRow>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<LicenseRow>>> getLicenseList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    List<LicenseRow>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<LicenseRow>, LicenseRow>(rawData, 'List<LicenseRow>', growable: true);
    ...
    return Response<List<LicenseRow>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SuccessTextResponse>> getLicensesWelcomeEmail({ 
    ...
    final _path = r'/licenses/{id}/welcome_email'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<SuccessTextResponse, SuccessTextResponse>(rawData, 'SuccessTextResponse', growable: true);
  ...
  Future<Response<LicensesOrder>> getNewLicense({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<LicensesOrder, LicensesOrder>(rawData, 'LicensesOrder', growable: true);
  ...
  Future<Response<LicensesCancel200Response>> licensesCancel({ 
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<LicensesCancel200Response, LicensesCancel200Response>(rawData, 'LicensesCancel200Response', growable: true);
  ...
  Future<Response<SuccessTextResponse>> postLicenseChangeIp({ 
    ...
    final _path = r'/licenses/{id}/change_ip'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
