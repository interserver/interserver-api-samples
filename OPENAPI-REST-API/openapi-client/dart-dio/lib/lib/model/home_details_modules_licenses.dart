...
class HomeDetailsModulesLicenses {
  ...
  final Optional<String?> listLink;
    ...
    bool operator ==(Object other) {
      ...
      other is HomeDetailsModulesLicenses &&
  ...
  factory HomeDetailsModulesLicenses.fromJson(Map<String, dynamic> json) => _$HomeDetailsModulesLicensesFromJson(json);

  Map<String, dynamic> toJson() => _$HomeDetailsModulesLicensesToJson(this);
