...
class DomainOrderResponse {
  ...
  final Optional<DomainOrderResponseAttributes?> attributes;
  ...
  factory DomainOrderResponse.fromJson(Map<String, dynamic> json) => _$DomainOrderResponseFromJson(json);

  Map<String, dynamic> toJson() => _$DomainOrderResponseToJson(this);
