...
class HomeDetailsModulesDomains {
  ...
  final Optional<String?> listLink;
    ...
    bool operator ==(Object other) {
      ...
      other is HomeDetailsModulesDomains &&
  ...
  factory HomeDetailsModulesDomains.fromJson(Map<String, dynamic> json) => _$HomeDetailsModulesDomainsFromJson(json);

  Map<String, dynamic> toJson() => _$HomeDetailsModulesDomainsToJson(this);
