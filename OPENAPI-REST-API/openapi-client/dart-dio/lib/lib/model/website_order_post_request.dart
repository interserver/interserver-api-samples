...
part 'website_order_post_request.g.dart';
...
class WebsiteOrderPostRequest {
  ...
  final Optional<bool?> registerDomain;
    ...
    bool operator ==(Object other) {
      ...
      other is WebsiteOrderPostRequest &&
  ...
  factory WebsiteOrderPostRequest.fromJson(Map<String, dynamic> json) => _$WebsiteOrderPostRequestFromJson(json);

  Map<String, dynamic> toJson() => _$WebsiteOrderPostRequestToJson(this);
