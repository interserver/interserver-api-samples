...
class HomeDetailsModulesBackups {
  ...
  final Optional<String?> listLink;
    ...
    bool operator ==(Object other) {
      ...
      other is HomeDetailsModulesBackups &&
  ...
  factory HomeDetailsModulesBackups.fromJson(Map<String, dynamic> json) => _$HomeDetailsModulesBackupsFromJson(json);

  Map<String, dynamic> toJson() => _$HomeDetailsModulesBackupsToJson(this);
