...
class QuickserverAddons {
  ...
  final Optional<List<QuickserverAddonsRow>?> rows;
  ...
  factory QuickserverAddons.fromJson(Map<String, dynamic> json) => _$QuickserverAddonsFromJson(json);

  Map<String, dynamic> toJson() => _$QuickserverAddonsToJson(this);
