...
module Interserver.Api.Core where
...
-- | display the config
instance P.Show ApiConfig where
  show c =
    T.printf
...
-- | constructs a default ApiConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"interserver-api-client/0.1.0.0"@
--
newConfig :: IO ApiConfig
newConfig = do
    logCxt <- initLogContext
    return $ ApiConfig
        { configHost = "https://my.interserver.net/apiv2"
        , configUserAgent = "interserver-api-client/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => ApiConfig -> auth -> ApiConfig
addAuthMethod config@ApiConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: ApiConfig -> IO ApiConfig
...
withStderrLogging :: ApiConfig -> IO ApiConfig
...
withNoLogging :: ApiConfig -> ApiConfig
...
data ApiRequest req contentType res accept = ApiRequest
  { rMethod  :: NH.Method   -- ^ Method of ApiRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of ApiRequest
  , rParams   :: Params -- ^ params of ApiRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (ApiRequest req contentType res accept) NH.Method
rMethodL f ApiRequest{..} = (\rMethod -> ApiRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (ApiRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f ApiRequest{..} = (\rUrlPath -> ApiRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (ApiRequest req contentType res accept) Params
rParamsL f ApiRequest{..} = (\rParams -> ApiRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (ApiRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f ApiRequest{..} = (\rAuthTypes -> ApiRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => ApiRequest req contentType res accept -> param -> ApiRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: ApiRequest req contentType res accept -> param -> ApiRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: ApiRequest req contentType res accept -> param -> ApiRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method
          ...
          -> ApiRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = ApiRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     ApiRequest req contentType res accept
  -> [NH.Header]
  -> ApiRequest req contentType res accept
...
removeHeader :: ApiRequest req contentType res accept -> [NH.HeaderName] -> ApiRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => ApiRequest req contentType res accept -> ApiRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => ApiRequest req contentType res accept -> ApiRequest req contentType res accept
...
addForm :: ApiRequest req contentType res accept -> WH.Form -> ApiRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: ApiRequest req contentType res accept -> NH.Part -> ApiRequest req contentType res accept
...
_setBodyBS :: ApiRequest req contentType res accept -> B.ByteString -> ApiRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: ApiRequest req contentType res accept -> BL.ByteString -> ApiRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => ApiRequest req contentType res accept -> P.Proxy authMethod -> ApiRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> ApiRequest req contentType res accept
    -> IO (ApiRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> ApiConfig
  -> IO (ApiRequest req contentType res accept)
_applyAuthMethods req config@(ApiConfig {configAuthMethods = as}) =
  foldlM go req as
  where
