...
module Interserver.Api.API.Billing where
...
-- 
addBillingCreditCard
  :: (Consumes AddBillingCreditCard contentType, MimeRender contentType BillingAddCcRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> BillingAddCcRequest -- ^ "billingAddCcRequest"
  -> ApiRequest AddBillingCreditCard contentType SuccessTextResponse MimeJSON
addBillingCreditCard _ billingAddCcRequest =
  _mkRequest "POST" ["/billing/creditcards"]
    ...
    `setBodyParam` billingAddCcRequest

data AddBillingCreditCard 
instance HasBodyParam AddBillingCreditCard BillingAddCcRequest 

-- | @application/json@
instance Consumes AddBillingCreditCard MimeJSON
-- | @multipart/form-data@
instance Consumes AddBillingCreditCard MimeMultipartFormData

-- | @application/json@
instance Produces AddBillingCreditCard MimeJSON
...
-- 
addBillingPrepay
  :: (Consumes AddBillingPrepay contentType, MimeRender contentType BillingPrepayRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> BillingPrepayRequest -- ^ "billingPrepayRequest"
  -> ApiRequest AddBillingPrepay contentType SuccessTextResponse MimeJSON
addBillingPrepay _ billingPrepayRequest =
  _mkRequest "POST" ["/billing/prepays"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` billingPrepayRequest

data AddBillingPrepay 
instance HasBodyParam AddBillingPrepay BillingPrepayRequest 

-- | @application/json@
instance Consumes AddBillingPrepay MimeJSON
-- | @multipart/form-data@
instance Consumes AddBillingPrepay MimeMultipartFormData

-- | @application/json@
instance Produces AddBillingPrepay MimeJSON
...
-- 
deleteBillingCreditCard
  :: Id -- ^ "id" -  The credit card ID to remove. Use IDs from `GET /billing/creditcards`.
  -> ApiRequest DeleteBillingCreditCard MimeNoContent SuccessTextResponse MimeJSON
deleteBillingCreditCard (Id id) =
  _mkRequest "DELETE" ["/billing/creditcards/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data DeleteBillingCreditCard  
-- | @application/json@
instance Produces DeleteBillingCreditCard MimeJSON
...
-- 
deleteBillingInvoice
  :: Id -- ^ "id" -  The invoice ID to delete. Only unpaid invoices can be deleted.
  -> ApiRequest DeleteBillingInvoice MimeNoContent SuccessTextResponse MimeJSON
deleteBillingInvoice (Id id) =
  _mkRequest "DELETE" ["/billing/invoices/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data DeleteBillingInvoice  
-- | @application/json@
instance Produces DeleteBillingInvoice MimeJSON
...
-- 
deleteBillingPrepay
  :: Id -- ^ "id" -  The prepay balance ID to delete.
  -> ApiRequest DeleteBillingPrepay MimeNoContent SuccessTextResponse MimeJSON
deleteBillingPrepay (Id id) =
  _mkRequest "DELETE" ["/billing/prepays/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data DeleteBillingPrepay  
-- | @application/json@
instance Produces DeleteBillingPrepay MimeJSON
...
-- 
getAffiliateBanners
  :: ApiRequest GetAffiliateBanners MimeNoContent [AffiliateBannerRow] MimeJSON
getAffiliateBanners =
  _mkRequest "GET" ["/affiliate/banners"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetAffiliateBanners  
-- | @application/json@
instance Produces GetAffiliateBanners MimeJSON
...
-- 
getAffiliateDownload
  :: ApiRequest GetAffiliateDownload MimeNoContent NoContent MimeNoContent
getAffiliateDownload =
  _mkRequest "GET" ["/affiliate/download"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetAffiliateDownload  

-- | /Optional Param/ "st" - Filter by status.
instance HasOptionalParam GetAffiliateDownload St where
  applyOptionalParam req (St xs) =
    req `addQuery` toQuery ("st", Just xs)

-- | /Optional Param/ "ex" - Export format: csv, xls, xlsx, or pdf. Defaults to csv.
instance HasOptionalParam GetAffiliateDownload Ex where
  applyOptionalParam req (Ex xs) =
    req `addQuery` toQuery ("ex", Just xs)

-- | /Optional Param/ "year" - Year to filter the report. Defaults to the current year.
instance HasOptionalParam GetAffiliateDownload Year where
  applyOptionalParam req (Year xs) =
    req `addQuery` toQuery ("year", Just xs)
instance Produces GetAffiliateDownload MimeNoContent
...
-- 
getAffiliateRichReport
  :: ApiRequest GetAffiliateRichReport MimeNoContent TextResponse MimeJSON
getAffiliateRichReport =
  _mkRequest "GET" ["/affiliate/rich_report"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetAffiliateRichReport  
-- | @application/json@
instance Produces GetAffiliateRichReport MimeJSON
...
-- 
getAffiliateSalesGraph
  :: ApiRequest GetAffiliateSalesGraph MimeNoContent StatusMonthlyBreakdown MimeJSON
getAffiliateSalesGraph =
  _mkRequest "GET" ["/affiliate/sales_graph"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetAffiliateSalesGraph  

-- | /Optional Param/ "days" - Number of days of sales history to include in the graph data. Determines the time window for the returned data points.
instance HasOptionalParam GetAffiliateSalesGraph Days where
  applyOptionalParam req (Days xs) =
    req `addQuery` toQuery ("days", Just xs)
-- | @application/json@
instance Produces GetAffiliateSalesGraph MimeJSON
...
-- 
getAffiliateSignups
  :: ApiRequest GetAffiliateSignups MimeNoContent GetAffiliateSignups200Response MimeJSON
getAffiliateSignups =
  _mkRequest "GET" ["/affiliate/signups"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetAffiliateSignups  

-- | /Optional Param/ "st" - Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.
instance HasOptionalParam GetAffiliateSignups St where
  applyOptionalParam req (St xs) =
    req `addQuery` toQuery ("st", Just xs)
-- | @application/json@
instance Produces GetAffiliateSignups MimeJSON
...
-- 
getAffiliateTrafficGraph
  :: ApiRequest GetAffiliateTrafficGraph MimeNoContent MonthlyCounts MimeJSON
getAffiliateTrafficGraph =
  _mkRequest "GET" ["/affiliate/traffic_graph"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetAffiliateTrafficGraph  

-- | /Optional Param/ "days" - Number of days of traffic history to include in the graph data. Determines the time window for the returned data points.
instance HasOptionalParam GetAffiliateTrafficGraph Days where
  applyOptionalParam req (Days xs) =
    req `addQuery` toQuery ("days", Just xs)
-- | @application/json@
instance Produces GetAffiliateTrafficGraph MimeJSON
...
-- 
getAffiliateWebTraffic
  :: ApiRequest GetAffiliateWebTraffic MimeNoContent [AffiliateTrafficRow] MimeJSON
getAffiliateWebTraffic =
  _mkRequest "GET" ["/affiliate/web_traffic"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetAffiliateWebTraffic  
-- | @application/json@
instance Produces GetAffiliateWebTraffic MimeJSON
...
-- 
getBillingCart
  :: ApiRequest GetBillingCart MimeNoContent A.Value MimeJSON
getBillingCart =
  _mkRequest "GET" ["/billing/cart"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetBillingCart  
-- | @application/json@
instance Produces GetBillingCart MimeJSON
...
-- 
getBillingCreditCardVerify
  :: Id -- ^ "id" -  The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
  -> ApiRequest GetBillingCreditCardVerify MimeNoContent SuccessTextResponse MimeJSON
getBillingCreditCardVerify (Id id) =
  _mkRequest "GET" ["/billing/creditcards/",toPath id,"/verify"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetBillingCreditCardVerify  
-- | @application/json@
instance Produces GetBillingCreditCardVerify MimeJSON
...
-- 
getBillingInvoice
  :: Id -- ^ "id" -  The invoice ID. Use IDs from `GET /billing/invoices` or from order responses.
  -> ApiRequest GetBillingInvoice MimeNoContent BillingInvoiceDetail MimeJSON
getBillingInvoice (Id id) =
  _mkRequest "GET" ["/billing/invoices/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetBillingInvoice  
-- | @application/json@
instance Produces GetBillingInvoice MimeJSON
...
-- 
getBillingInvoices
  :: ApiRequest GetBillingInvoices MimeNoContent BillingInvoiceList MimeJSON
getBillingInvoices =
  _mkRequest "GET" ["/billing/invoices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetBillingInvoices  
-- | @application/json@
instance Produces GetBillingInvoices MimeJSON
...
-- 
getBillingPrePays
  :: ApiRequest GetBillingPrePays MimeNoContent A.Value MimeJSON
getBillingPrePays =
  _mkRequest "GET" ["/billing/prepays"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetBillingPrePays  
-- | @application/json@
instance Produces GetBillingPrePays MimeJSON
...
-- 
initiatePayment
  :: Method -- ^ "method" -  The payment method to use. Valid values: `cc` (credit card), `paypal`, `prepay`, `payssion`, `payu`, `ccavenue`, `cashfree`, `coinbase`, `btcpay`.
  -> Invoices -- ^ "invoices" -  A comma-separated list of invoice IDs or invoice Tags to pay. These IDs are returned by order endpoints (e.g. `/backups/order`, `/vps/order`) and by `/billing/invoices`. Invoice tags accepted are SERVICE<module><id>, RINV<module><repeat invoice id>, INV<module><invoice id>, PREPAY<prepay id><invoice id>, and <invoice id>.
  -> ApiRequest InitiatePayment MimeNoContent InitiatePayment200Response MimeJSON
initiatePayment (Method method) (Invoices invoices) =
  _mkRequest "GET" ["/billing/pay/",toPath method,"/",toPath invoices]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
-- | @application/json@
instance Produces InitiatePayment MimeJSON
...
-- 
patchBillingCreditCardVerify
  :: (Consumes PatchBillingCreditCardVerify contentType, MimeRender contentType PatchBillingCreditCardVerifyRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
  -> PatchBillingCreditCardVerifyRequest -- ^ "patchBillingCreditCardVerifyRequest"
  -> ApiRequest PatchBillingCreditCardVerify contentType SuccessTextResponse MimeJSON
patchBillingCreditCardVerify _ (Id id) patchBillingCreditCardVerifyRequest =
  _mkRequest "PATCH" ["/billing/creditcards/",toPath id,"/verify"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` patchBillingCreditCardVerifyRequest

data PatchBillingCreditCardVerify 
instance HasBodyParam PatchBillingCreditCardVerify PatchBillingCreditCardVerifyRequest 

-- | @application/json@
instance Consumes PatchBillingCreditCardVerify MimeJSON
-- | @multipart/form-data@
instance Consumes PatchBillingCreditCardVerify MimeMultipartFormData

-- | @application/json@
instance Produces PatchBillingCreditCardVerify MimeJSON
...
-- 
postBillingCreditCardVerify
  :: (Consumes PostBillingCreditCardVerify contentType, MimeRender contentType BillingVerifyCcRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
  -> BillingVerifyCcRequest -- ^ "billingVerifyCcRequest"
  -> ApiRequest PostBillingCreditCardVerify contentType SuccessTextResponse MimeJSON
postBillingCreditCardVerify _ (Id id) billingVerifyCcRequest =
  _mkRequest "POST" ["/billing/creditcards/",toPath id,"/verify"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` billingVerifyCcRequest

data PostBillingCreditCardVerify 
instance HasBodyParam PostBillingCreditCardVerify BillingVerifyCcRequest 

-- | @application/json@
instance Consumes PostBillingCreditCardVerify MimeJSON
-- | @multipart/form-data@
instance Consumes PostBillingCreditCardVerify MimeMultipartFormData

-- | @application/json@
instance Produces PostBillingCreditCardVerify MimeJSON
...
-- 
updateAffiliateDockSetup
  :: (Consumes UpdateAffiliateDockSetup contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> ApiRequest UpdateAffiliateDockSetup contentType TextResponse MimeJSON
updateAffiliateDockSetup _ =
  _mkRequest "POST" ["/affiliate/dock_setup"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data UpdateAffiliateDockSetup  
instance HasOptionalParam UpdateAffiliateDockSetup AffiliateDockTitle where
  applyOptionalParam req (AffiliateDockTitle xs) =
    req `_addMultiFormPart` NH.partLBS "affiliate_dock_title" (mimeRender' MimeMultipartFormData xs)
instance HasOptionalParam UpdateAffiliateDockSetup AffiliateDockDescription where
  applyOptionalParam req (AffiliateDockDescription xs) =
    req `_addMultiFormPart` NH.partLBS "affiliate_dock_description" (mimeRender' MimeMultipartFormData xs)
instance HasOptionalParam UpdateAffiliateDockSetup ReferrerCoupon where
  applyOptionalParam req (ReferrerCoupon xs) =
    req `_addMultiFormPart` NH.partLBS "referrer_coupon" (mimeRender' MimeMultipartFormData xs)

-- | @application/json@
instance Consumes UpdateAffiliateDockSetup MimeJSON
-- | @multipart/form-data@
instance Consumes UpdateAffiliateDockSetup MimeMultipartFormData

-- | @application/json@
instance Produces UpdateAffiliateDockSetup MimeJSON
...
-- 
updateAffiliatePaymentSetup
  :: (Consumes UpdateAffiliatePaymentSetup contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> ApiRequest UpdateAffiliatePaymentSetup contentType TextResponse MimeJSON
updateAffiliatePaymentSetup _ =
  _mkRequest "POST" ["/affiliate/payment_setup"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data UpdateAffiliatePaymentSetup  
instance HasOptionalParam UpdateAffiliatePaymentSetup AffiliatePaypal where
  applyOptionalParam req (AffiliatePaypal xs) =
    req `_addMultiFormPart` NH.partLBS "affiliate_paypal" (mimeRender' MimeMultipartFormData xs)
instance HasOptionalParam UpdateAffiliatePaymentSetup AffiliatePaymentMethod where
  applyOptionalParam req (AffiliatePaymentMethod xs) =
    req `_addMultiFormPart` NH.partLBS "affiliate_payment_method" (mimeRender' MimeMultipartFormData xs)

-- | @application/json@
instance Consumes UpdateAffiliatePaymentSetup MimeJSON
-- | @multipart/form-data@
instance Consumes UpdateAffiliatePaymentSetup MimeMultipartFormData

-- | @application/json@
instance Produces UpdateAffiliatePaymentSetup MimeJSON
...
-- 
updateBillingCreditCard
  :: Id -- ^ "id" -  The credit card ID. Use IDs from `GET /billing/creditcards` or the response from `POST /billing/creditcards`.
  -> ApiRequest UpdateBillingCreditCard MimeNoContent SuccessTextResponse MimeJSON
updateBillingCreditCard (Id id) =
  _mkRequest "POST" ["/billing/creditcards/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data UpdateBillingCreditCard  
-- | @application/json@
instance Produces UpdateBillingCreditCard MimeJSON
...
-- 
updateBillingPaymentMethod
  :: (Consumes UpdateBillingPaymentMethod contentType, MimeRender contentType BillingPaymentMethodRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> BillingPaymentMethodRequest -- ^ "billingPaymentMethodRequest"
  -> ApiRequest UpdateBillingPaymentMethod contentType SuccessTextResponse MimeJSON
updateBillingPaymentMethod _ billingPaymentMethodRequest =
  _mkRequest "POST" ["/billing/payment_method"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` billingPaymentMethodRequest

data UpdateBillingPaymentMethod 
instance HasBodyParam UpdateBillingPaymentMethod BillingPaymentMethodRequest 

-- | @application/json@
instance Consumes UpdateBillingPaymentMethod MimeJSON
-- | @multipart/form-data@
instance Consumes UpdateBillingPaymentMethod MimeMultipartFormData

-- | @application/json@
instance Produces UpdateBillingPaymentMethod MimeJSON
