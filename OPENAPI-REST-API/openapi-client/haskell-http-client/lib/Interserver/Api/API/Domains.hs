...
module Interserver.Api.API.Domains where
...
-- 
addDomain
  :: (Consumes AddDomain MimeJSON, MimeRender MimeJSON DomainOrderRequest)
  => DomainOrderRequest -- ^ "domainOrderRequest"
  -> ApiRequest AddDomain MimeJSON ServiceOrderPostResponse MimeJSON
addDomain domainOrderRequest =
  _mkRequest "POST" ["/domains/order"]
    ...
    `setBodyParam` domainOrderRequest

data AddDomain 
instance HasBodyParam AddDomain DomainOrderRequest 

-- | @application/json@
instance Consumes AddDomain MimeJSON

-- | @application/json@
instance Produces AddDomain MimeJSON
...
-- 
addDomainDnssec
  :: (Consumes AddDomainDnssec contentType, MimeRender contentType DomainDnssecRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> DomainDnssecRequest -- ^ "domainDnssecRequest"
  -> ApiRequest AddDomainDnssec contentType SuccessTextResponse MimeJSON
addDomainDnssec _ (Id id) domainDnssecRequest =
  _mkRequest "POST" ["/domains/",toPath id,"/dnssec"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` domainDnssecRequest

data AddDomainDnssec 
instance HasBodyParam AddDomainDnssec DomainDnssecRequest 

-- | @application/json@
instance Consumes AddDomainDnssec MimeJSON
-- | @multipart/form-data@
instance Consumes AddDomainDnssec MimeMultipartFormData

-- | @application/json@
instance Produces AddDomainDnssec MimeJSON
...
-- 
addDomainNameserver
  :: (Consumes AddDomainNameserver contentType, MimeRender contentType DomainNameserverPostRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> DomainNameserverPostRequest -- ^ "domainNameserverPostRequest"
  -> ApiRequest AddDomainNameserver contentType TextResponse MimeJSON
addDomainNameserver _ (Id id) domainNameserverPostRequest =
  _mkRequest "POST" ["/domains/",toPath id,"/nameservers"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` domainNameserverPostRequest

data AddDomainNameserver 
instance HasBodyParam AddDomainNameserver DomainNameserverPostRequest 

-- | @application/json@
instance Consumes AddDomainNameserver MimeJSON
-- | @multipart/form-data@
instance Consumes AddDomainNameserver MimeMultipartFormData

-- | @application/json@
instance Produces AddDomainNameserver MimeJSON
...
cancelDomain
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest CancelDomain MimeNoContent CancelDomain200Response MimeJSON
cancelDomain (Id id) =
  _mkRequest "DELETE" ["/domains/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data CancelDomain  
-- | @application/json@
instance Produces CancelDomain MimeJSON
...
deleteDomainDnssec
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest DeleteDomainDnssec MimeNoContent SuccessTextResponse MimeJSON
deleteDomainDnssec (Id id) =
  _mkRequest "DELETE" ["/domains/",toPath id,"/dnssec"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data DeleteDomainDnssec  
-- | @application/json@
instance Produces DeleteDomainDnssec MimeJSON
...
deleteDomainNameserver
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> Index -- ^ "index" -  The index of the registered nameserver from the registered nameservers list to delete.  
  -> ApiRequest DeleteDomainNameserver MimeNoContent TextResponse MimeJSON
deleteDomainNameserver (Id id) (Index index) =
  _mkRequest "DELETE" ["/domains/",toPath id,"/nameservers"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `addQuery` toQuery ("index", Just index)

data DeleteDomainNameserver  
-- | @application/json@
instance Produces DeleteDomainNameserver MimeJSON
...
getDomainContact
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest GetDomainContact MimeNoContent DomainContactDetails MimeJSON
getDomainContact (Id id) =
  _mkRequest "GET" ["/domains/",toPath id,"/contact"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainContact  
-- | @application/json@
instance Produces GetDomainContact MimeJSON
...
getDomainDnssec
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest GetDomainDnssec MimeNoContent DomainDnssecRecords MimeJSON
getDomainDnssec (Id id) =
  _mkRequest "GET" ["/domains/",toPath id,"/dnssec"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainDnssec  
-- | @application/json@
instance Produces GetDomainDnssec MimeJSON
...
getDomainInfo
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest GetDomainInfo MimeNoContent Domain MimeJSON
getDomainInfo (Id id) =
  _mkRequest "GET" ["/domains/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetDomainInfo  
-- | @application/json@
instance Produces GetDomainInfo MimeJSON
...
getDomainInvoices
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest GetDomainInvoices MimeNoContent ChargeInvoiceRows MimeJSON
getDomainInvoices (Id id) =
  _mkRequest "GET" ["/domains/",toPath id,"/invoices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainInvoices  
-- | @application/json@
instance Produces GetDomainInvoices MimeJSON
...
-- 
getDomainLookup
  :: Name -- ^ "name" -  The full domain name to look up (for example `example.com`).
  -> ApiRequest GetDomainLookup MimeNoContent DomainLookupResponse MimeJSON
getDomainLookup (Name name) =
  _mkRequest "GET" ["/domains/lookup/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainLookup  
-- | @application/json@
instance Produces GetDomainLookup MimeJSON
...
getDomainNameservers
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest GetDomainNameservers MimeNoContent DomainNameserverGetResponse MimeJSON
getDomainNameservers (Id id) =
  _mkRequest "GET" ["/domains/",toPath id,"/nameservers"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainNameservers  
-- | @application/json@
instance Produces GetDomainNameservers MimeJSON
...
getDomainRenewal
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest GetDomainRenewal MimeNoContent SuccessTextResponse MimeJSON
getDomainRenewal (Id id) =
  _mkRequest "GET" ["/domains/",toPath id,"/renew"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainRenewal  
-- | @application/json@
instance Produces GetDomainRenewal MimeJSON
...
-- 
getDomainSearch
  :: Name -- ^ "name" -  The base domain name to search (for example `example` or `example.com`).
  -> ApiRequest GetDomainSearch MimeNoContent DomainSearchResponse MimeJSON
getDomainSearch (Name name) =
  _mkRequest "GET" ["/domains/search/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainSearch  
-- | @application/json@
instance Produces GetDomainSearch MimeJSON
...
getDomainTransfer
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest GetDomainTransfer MimeNoContent SuccessTextResponse MimeJSON
getDomainTransfer (Id id) =
  _mkRequest "GET" ["/domains/",toPath id,"/transfer"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainTransfer  
-- | @application/json@
instance Produces GetDomainTransfer MimeJSON
...
getDomainWhoisPrivacy
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest GetDomainWhoisPrivacy MimeNoContent SuccessTextResponse MimeJSON
getDomainWhoisPrivacy (Id id) =
  _mkRequest "GET" ["/domains/",toPath id,"/whois"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainWhoisPrivacy  
-- | @application/json@
instance Produces GetDomainWhoisPrivacy MimeJSON
...
-- 
getDomainsList
  :: ApiRequest GetDomainsList MimeNoContent [DomainRow] MimeJSON
getDomainsList =
  _mkRequest "GET" ["/domains"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetDomainsList  
-- | @application/json@
instance Produces GetDomainsList MimeJSON
...
getDomainsWelcomeEmail
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest GetDomainsWelcomeEmail MimeNoContent SuccessTextResponse MimeJSON
getDomainsWelcomeEmail (Id id) =
  _mkRequest "GET" ["/domains/",toPath id,"/welcome_email"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetDomainsWelcomeEmail  
-- | @application/json@
instance Produces GetDomainsWelcomeEmail MimeJSON
...
-- 
getNewDomain
  :: ApiRequest GetNewDomain MimeNoContent DomainOrder MimeJSON
getNewDomain =
  _mkRequest "GET" ["/domains/order"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetNewDomain  
-- | @application/json@
instance Produces GetNewDomain MimeJSON
...
-- 
patchDomains
  :: (Consumes PatchDomains MimeJSON, MimeRender MimeJSON DomainOrderRequest)
  => DomainOrderRequest -- ^ "domainOrderRequest"
  -> ApiRequest PatchDomains MimeJSON NoContent MimeNoContent
patchDomains domainOrderRequest =
  _mkRequest "PATCH" ["/domains/order"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` domainOrderRequest
...
data PatchDomains 
instance HasBodyParam PatchDomains DomainOrderRequest 

-- | @application/json@
instance Consumes PatchDomains MimeJSON

instance Produces PatchDomains MimeNoContent
...
postDomainRenewal
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest PostDomainRenewal MimeNoContent SuccessTextResponse MimeJSON
postDomainRenewal (Id id) =
  _mkRequest "POST" ["/domains/",toPath id,"/renew"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostDomainRenewal  
-- | @application/json@
instance Produces PostDomainRenewal MimeJSON
...
postDomainSearch
  :: Name -- ^ "name" -  The base domain name to search (for example `example` or `example.com`).
  -> ApiRequest PostDomainSearch MimeNoContent NoContent MimeNoContent
postDomainSearch (Name name) =
  _mkRequest "POST" ["/domains/search/",toPath name]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostDomainSearch  
instance Produces PostDomainSearch MimeNoContent
...
postDomainTransfer
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest PostDomainTransfer MimeNoContent SuccessTextResponse MimeJSON
postDomainTransfer (Id id) =
  _mkRequest "POST" ["/domains/",toPath id,"/transfer"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostDomainTransfer  
-- | @application/json@
instance Produces PostDomainTransfer MimeJSON
...
-- 
putDomains
  :: (Consumes PutDomains MimeJSON, MimeRender MimeJSON DomainOrderRequest)
  => DomainOrderRequest -- ^ "domainOrderRequest"
  -> ApiRequest PutDomains MimeJSON NoContent MimeNoContent
putDomains domainOrderRequest =
  _mkRequest "PUT" ["/domains/order"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` domainOrderRequest
...
data PutDomains 
instance HasBodyParam PutDomains DomainOrderRequest 

-- | @application/json@
instance Consumes PutDomains MimeJSON

instance Produces PutDomains MimeNoContent
...
-- 
updateDomainContact
  :: (Consumes UpdateDomainContact contentType, MimeRender contentType DomainContactDetails)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> DomainContactDetails -- ^ "domainContactDetails"
  -> ApiRequest UpdateDomainContact contentType SuccessTextResponse MimeJSON
updateDomainContact _ (Id id) domainContactDetails =
  _mkRequest "POST" ["/domains/",toPath id,"/contact"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` domainContactDetails

data UpdateDomainContact 
instance HasBodyParam UpdateDomainContact DomainContactDetails 

-- | @application/json@
instance Consumes UpdateDomainContact MimeJSON
-- | @multipart/form-data@
instance Consumes UpdateDomainContact MimeMultipartFormData

-- | @application/json@
instance Produces UpdateDomainContact MimeJSON
...
updateDomainInfo
  :: Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> ApiRequest UpdateDomainInfo MimeNoContent SuccessTextResponse MimeJSON
updateDomainInfo (Id id) =
  _mkRequest "POST" ["/domains/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data UpdateDomainInfo  
-- | @application/json@
instance Produces UpdateDomainInfo MimeJSON
...
-- 
updateDomainNameservers
  :: (Consumes UpdateDomainNameservers contentType, MimeRender contentType DomainNameserverPutRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> DomainNameserverPutRequest -- ^ "domainNameserverPutRequest"
  -> ApiRequest UpdateDomainNameservers contentType TextResponse MimeJSON
updateDomainNameservers _ (Id id) domainNameserverPutRequest =
  _mkRequest "PUT" ["/domains/",toPath id,"/nameservers"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` domainNameserverPutRequest

data UpdateDomainNameservers 
instance HasBodyParam UpdateDomainNameservers DomainNameserverPutRequest 

-- | @application/json@
instance Consumes UpdateDomainNameservers MimeJSON
-- | @multipart/form-data@
instance Consumes UpdateDomainNameservers MimeMultipartFormData

-- | @application/json@
instance Produces UpdateDomainNameservers MimeJSON
...
-- 
updateDomainWhoisPrivacy
  :: (Consumes UpdateDomainWhoisPrivacy contentType, MimeRender contentType DomainWhoisPrivacyRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  The domain service ID. Use `domain_id` from `GET /domains`.
  -> DomainWhoisPrivacyRequest -- ^ "domainWhoisPrivacyRequest"
  -> ApiRequest UpdateDomainWhoisPrivacy contentType SuccessTextResponse MimeJSON
updateDomainWhoisPrivacy _ (Id id) domainWhoisPrivacyRequest =
  _mkRequest "POST" ["/domains/",toPath id,"/whois"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` domainWhoisPrivacyRequest

data UpdateDomainWhoisPrivacy 
instance HasBodyParam UpdateDomainWhoisPrivacy DomainWhoisPrivacyRequest 

-- | @application/json@
instance Consumes UpdateDomainWhoisPrivacy MimeJSON
-- | @multipart/form-data@
instance Consumes UpdateDomainWhoisPrivacy MimeMultipartFormData

-- | @application/json@
instance Produces UpdateDomainWhoisPrivacy MimeJSON
