...
module Interserver.Api.API.VPS where
...
-- 
addVps
  :: (Consumes AddVps contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> ApiRequest AddVps contentType ServiceOrderPostResponse MimeJSON
addVps _ =
  _mkRequest "POST" ["/vps/order"]
...
data AddVps 
instance HasBodyParam AddVps VpsOrderPostRequest 

-- | @application/json@
instance Consumes AddVps MimeJSON
-- | @multipart/form-data@
instance Consumes AddVps MimeMultipartFormData

-- | @application/json@
instance Produces AddVps MimeJSON
...
deleteVpsBackup
  ...
  -> ApiRequest DeleteVpsBackup MimeNoContent SuccessTextResponse MimeJSON
deleteVpsBackup (Id id) (File file) =
  _mkRequest "DELETE" ["/vps/",toPath id,"/backups"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `addQuery` toQuery ("file", Just file)

data DeleteVpsBackup  

-- | /Optional Param/ "all" - Set to `1` to list all backups across all services, not just the ones for the given VPS.
instance HasOptionalParam DeleteVpsBackup All where
  applyOptionalParam req (All xs) =
    req `addQuery` toQuery ("all", Just xs)
-- | @application/json@
instance Produces DeleteVpsBackup MimeJSON
...
doVpsBlockSmtp
  :: Id -- ^ "id" -  VPS ID number.
  -> ApiRequest DoVpsBlockSmtp MimeNoContent QueueResponse MimeJSON
doVpsBlockSmtp (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/block_smtp"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data DoVpsBlockSmtp  
-- | @application/json@
instance Produces DoVpsBlockSmtp MimeJSON
...
doVpsDisableCd
  :: Id -- ^ "id" -  VPS ID number.
  -> ApiRequest DoVpsDisableCd MimeNoContent QueueResponse MimeJSON
doVpsDisableCd (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/disable_cd"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data DoVpsDisableCd  
-- | @application/json@
instance Produces DoVpsDisableCd MimeJSON
...
doVpsDisableQuota
  :: Id -- ^ "id" -  VPS ID number.
  -> ApiRequest DoVpsDisableQuota MimeNoContent QueueResponse MimeJSON
doVpsDisableQuota (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/disable_quota"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data DoVpsDisableQuota  
-- | @application/json@
instance Produces DoVpsDisableQuota MimeJSON
...
doVpsEjectCd
  :: Id -- ^ "id" -  VPS ID number.
  -> ApiRequest DoVpsEjectCd MimeNoContent QueueResponse MimeJSON
doVpsEjectCd (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/eject_cd"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data DoVpsEjectCd  
-- | @application/json@
instance Produces DoVpsEjectCd MimeJSON
...
doVpsEnableQuota
  :: Id -- ^ "id" -  VPS ID number.
  -> ApiRequest DoVpsEnableQuota MimeNoContent QueueResponse MimeJSON
doVpsEnableQuota (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/enable_quota"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data DoVpsEnableQuota  
-- | @application/json@
instance Produces DoVpsEnableQuota MimeJSON
...
doVpsRestart
  :: Id -- ^ "id" -  VPS ID number.
  -> ApiRequest DoVpsRestart MimeNoContent QueueResponse MimeJSON
doVpsRestart (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/restart"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data DoVpsRestart  
-- | @application/json@
instance Produces DoVpsRestart MimeJSON
...
doVpsStart
  :: Id -- ^ "id" -  VPS ID number.
  -> ApiRequest DoVpsStart MimeNoContent QueueResponse MimeJSON
doVpsStart (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/start"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data DoVpsStart  
-- | @application/json@
instance Produces DoVpsStart MimeJSON
...
doVpsStop
  :: Id -- ^ "id" -  VPS ID number.
  -> ApiRequest DoVpsStop MimeNoContent QueueResponse MimeJSON
doVpsStop (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/stop"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data DoVpsStop  
-- | @application/json@
instance Produces DoVpsStop MimeJSON
...
-- 
downloadVpsBackup
  :: (Consumes DownloadVpsBackup contentType, MimeRender contentType DownloadQsBackupRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  VPS ID number
  -> DownloadQsBackupRequest -- ^ "downloadQsBackupRequest"
  -> ApiRequest DownloadVpsBackup contentType DownloadQsBackup200Response MimeJSON
downloadVpsBackup _ (Id id) downloadQsBackupRequest =
  _mkRequest "PATCH" ["/vps/",toPath id,"/backups"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` downloadQsBackupRequest

data DownloadVpsBackup 
instance HasBodyParam DownloadVpsBackup DownloadQsBackupRequest 

-- | /Optional Param/ "all" - Set to `1` to list all backups across all services, not just the ones for the given VPS.
instance HasOptionalParam DownloadVpsBackup All where
  applyOptionalParam req (All xs) =
    req `addQuery` toQuery ("all", Just xs)

-- | @application/json@
instance Consumes DownloadVpsBackup MimeJSON
-- | @multipart/form-data@
instance Consumes DownloadVpsBackup MimeMultipartFormData

-- | @application/json@
instance Produces DownloadVpsBackup MimeJSON
...
-- 
getNewVps
  :: ApiRequest GetNewVps MimeNoContent VpsOrder MimeJSON
getNewVps =
  _mkRequest "GET" ["/vps/order"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetNewVps  
-- | @application/json@
instance Produces GetNewVps MimeJSON
...
getVpsBackup
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsBackup MimeNoContent QueueResponse MimeJSON
getVpsBackup (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/backup"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetVpsBackup  
-- | @application/json@
instance Produces GetVpsBackup MimeJSON
...
getVpsBackups
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsBackups MimeNoContent VpsBackupRows MimeJSON
getVpsBackups (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/backups"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
-- | /Optional Param/ "all" - Set to `1` to list all backups across all services, not just the ones for the given VPS.
instance HasOptionalParam GetVpsBackups All where
  applyOptionalParam req (All xs) =
    req `addQuery` toQuery ("all", Just xs)
-- | @application/json@
instance Produces GetVpsBackups MimeJSON
...
getVpsBuyHdSpace
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsBuyHdSpace MimeNoContent NoContent MimeNoContent
getVpsBuyHdSpace (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/buy_hd_space"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsBuyHdSpace  
instance Produces GetVpsBuyHdSpace MimeNoContent
...
getVpsBuyIp
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsBuyIp MimeNoContent NoContent MimeNoContent
getVpsBuyIp (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/buy_ip"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsBuyIp  
instance Produces GetVpsBuyIp MimeNoContent
...
getVpsChangeHostname
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsChangeHostname MimeNoContent NoContent MimeNoContent
getVpsChangeHostname (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/change_hostname"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsChangeHostname  
instance Produces GetVpsChangeHostname MimeNoContent
...
getVpsChangeRootPassword
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsChangeRootPassword MimeNoContent NoContent MimeNoContent
getVpsChangeRootPassword (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/change_root_password"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsChangeRootPassword  
instance Produces GetVpsChangeRootPassword MimeNoContent
...
getVpsChangeTimezone
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsChangeTimezone MimeNoContent [Text] MimeJSON
getVpsChangeTimezone (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/change_timezone"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsChangeTimezone  
-- | @application/json@
instance Produces GetVpsChangeTimezone MimeJSON
...
getVpsInfo
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsInfo MimeNoContent Vps MimeJSON
getVpsInfo (Id id) =
  _mkRequest "GET" ["/vps/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetVpsInfo  
-- | @application/json@
instance Produces GetVpsInfo MimeJSON
...
getVpsInsertCd
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsInsertCd MimeNoContent NoContent MimeNoContent
getVpsInsertCd (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/insert_cd"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsInsertCd  
instance Produces GetVpsInsertCd MimeNoContent
...
getVpsInvoices
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsInvoices MimeNoContent ChargeInvoiceRows MimeJSON
getVpsInvoices (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/invoices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetVpsInvoices  
-- | @application/json@
instance Produces GetVpsInvoices MimeJSON
...
-- 
getVpsList
  :: ApiRequest GetVpsList MimeNoContent [VpsRow] MimeJSON
getVpsList =
  _mkRequest "GET" ["/vps"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
...
data GetVpsList  
-- | @application/json@
instance Produces GetVpsList MimeJSON
...
getVpsReinstallOs
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsReinstallOs MimeNoContent VpsTemplatesList MimeJSON
getVpsReinstallOs (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/reinstall_os"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsReinstallOs  
-- | @application/json@
instance Produces GetVpsReinstallOs MimeJSON
...
getVpsResetPassword
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsResetPassword MimeNoContent NoContent MimeNoContent
getVpsResetPassword (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/reset_password"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsResetPassword  
instance Produces GetVpsResetPassword MimeNoContent
...
getVpsReverseDns
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsReverseDns MimeNoContent ReverseDnsEntries MimeJSON
getVpsReverseDns (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/reverse_dns"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsReverseDns  
-- | @application/json@
instance Produces GetVpsReverseDns MimeJSON
...
getVpsSetupVnc
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsSetupVnc MimeNoContent NoContent MimeNoContent
getVpsSetupVnc (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/setup_vnc"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsSetupVnc  
instance Produces GetVpsSetupVnc MimeNoContent
...
getVpsSlices
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsSlices MimeNoContent NoContent MimeNoContent
getVpsSlices (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/slices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsSlices  
instance Produces GetVpsSlices MimeNoContent
...
getVpsTrafficUsage
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsTrafficUsage MimeNoContent VpsTrafficResponse MimeJSON
getVpsTrafficUsage (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/traffic_usage"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsTrafficUsage  
-- | @application/json@
instance Produces GetVpsTrafficUsage MimeJSON
...
getVpsViewDesktop
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest GetVpsViewDesktop MimeNoContent NoContent MimeNoContent
getVpsViewDesktop (Id id) =
  _mkRequest "GET" ["/vps/",toPath id,"/view_desktop"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsViewDesktop  
instance Produces GetVpsViewDesktop MimeNoContent
...
getVpsWelcomeEmail
  :: IdText -- ^ "id" -  VPS ID
  -> ApiRequest GetVpsWelcomeEmail MimeNoContent SuccessTextResponse MimeJSON
getVpsWelcomeEmail (IdText id) =
  _mkRequest "GET" ["/vps/",toPath id,"/welcome_email"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetVpsWelcomeEmail  
-- | @application/json@
instance Produces GetVpsWelcomeEmail MimeJSON
...
postVpsBuyHdSpace
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest PostVpsBuyHdSpace MimeNoContent NoContent MimeNoContent
postVpsBuyHdSpace (Id id) =
  _mkRequest "POST" ["/vps/",toPath id,"/buy_hd_space"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostVpsBuyHdSpace  
instance Produces PostVpsBuyHdSpace MimeNoContent
...
postVpsBuyIp
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest PostVpsBuyIp MimeNoContent NoContent MimeNoContent
postVpsBuyIp (Id id) =
  _mkRequest "POST" ["/vps/",toPath id,"/buy_ip"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostVpsBuyIp  
instance Produces PostVpsBuyIp MimeNoContent
...
-- 
postVpsChangeHostname
  :: (Consumes PostVpsChangeHostname contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  VPS ID number
  -> ApiRequest PostVpsChangeHostname contentType QueueResponse MimeJSON
postVpsChangeHostname _ (Id id) =
  _mkRequest "POST" ["/vps/",toPath id,"/change_hostname"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostVpsChangeHostname  
instance HasOptionalParam PostVpsChangeHostname Hostname where
  applyOptionalParam req (Hostname xs) =
    req `_addMultiFormPart` NH.partLBS "hostname" (mimeRender' MimeMultipartFormData xs)

-- | @application/json@
instance Consumes PostVpsChangeHostname MimeJSON
-- | @multipart/form-data@
instance Consumes PostVpsChangeHostname MimeMultipartFormData

-- | @application/json@
instance Produces PostVpsChangeHostname MimeJSON
...
-- 
postVpsChangeRootPassword
  :: (Consumes PostVpsChangeRootPassword contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  VPS ID number
  -> Password -- ^ "password"
  -> ApiRequest PostVpsChangeRootPassword contentType QueueResponse MimeJSON
postVpsChangeRootPassword _ (Id id) (Password password) =
  _mkRequest "POST" ["/vps/",toPath id,"/change_root_password"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `_addMultiFormPart` NH.partLBS "password" (mimeRender' MimeMultipartFormData password)

data PostVpsChangeRootPassword  

-- | @application/json@
instance Consumes PostVpsChangeRootPassword MimeJSON
-- | @multipart/form-data@
instance Consumes PostVpsChangeRootPassword MimeMultipartFormData

-- | @application/json@
instance Produces PostVpsChangeRootPassword MimeJSON
...
-- 
postVpsChangeTimezone
  :: (Consumes PostVpsChangeTimezone contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  VPS ID number
  -> Timezone -- ^ "timezone" -  The time zone
  -> ApiRequest PostVpsChangeTimezone contentType QueueResponse MimeJSON
postVpsChangeTimezone _ (Id id) (Timezone timezone) =
  _mkRequest "POST" ["/vps/",toPath id,"/change_timezone"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `_addMultiFormPart` NH.partLBS "timezone" (mimeRender' MimeMultipartFormData timezone)

data PostVpsChangeTimezone  

-- | @application/json@
instance Consumes PostVpsChangeTimezone MimeJSON
-- | @multipart/form-data@
instance Consumes PostVpsChangeTimezone MimeMultipartFormData

-- | @application/json@
instance Produces PostVpsChangeTimezone MimeJSON
...
-- 
postVpsChangeWebuzoPassword
  :: (Consumes PostVpsChangeWebuzoPassword contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  VPS ID number
  -> Password -- ^ "password"
  -> ApiRequest PostVpsChangeWebuzoPassword contentType QueueResponse MimeJSON
postVpsChangeWebuzoPassword _ (Id id) (Password password) =
  _mkRequest "POST" ["/vps/",toPath id,"/change_webuzo_password"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `_addMultiFormPart` NH.partLBS "password" (mimeRender' MimeMultipartFormData password)

data PostVpsChangeWebuzoPassword  

-- | @application/json@
instance Consumes PostVpsChangeWebuzoPassword MimeJSON
-- | @multipart/form-data@
instance Consumes PostVpsChangeWebuzoPassword MimeMultipartFormData

-- | @application/json@
instance Produces PostVpsChangeWebuzoPassword MimeJSON
...
-- 
postVpsInsertCd
  :: (Consumes PostVpsInsertCd contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  VPS ID number
  -> ApiRequest PostVpsInsertCd contentType QueueResponse MimeJSON
postVpsInsertCd _ (Id id) =
  _mkRequest "POST" ["/vps/",toPath id,"/insert_cd"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostVpsInsertCd  
instance HasOptionalParam PostVpsInsertCd Url where
  applyOptionalParam req (Url xs) =
    req `_addMultiFormPart` NH.partLBS "url" (mimeRender' MimeMultipartFormData xs)

-- | @application/json@
instance Consumes PostVpsInsertCd MimeJSON
-- | @multipart/form-data@
instance Consumes PostVpsInsertCd MimeMultipartFormData

-- | @application/json@
instance Produces PostVpsInsertCd MimeJSON
...
-- 
postVpsReinstallOs
  :: (Consumes PostVpsReinstallOs contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  VPS ID number
  -> Template -- ^ "template" -  OS Template Filename
  -> LocalPassword -- ^ "localPassword" -  Password for this account.
  -> ApiRequest PostVpsReinstallOs contentType QueueResponse MimeJSON
postVpsReinstallOs _ (Id id) (Template template) (LocalPassword localPassword) =
  _mkRequest "POST" ["/vps/",toPath id,"/reinstall_os"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `_addMultiFormPart` NH.partLBS "template" (mimeRender' MimeMultipartFormData template)
    `_addMultiFormPart` NH.partLBS "localPassword" (mimeRender' MimeMultipartFormData localPassword)

data PostVpsReinstallOs  

-- | /Optional Param/ "password" - Password for Root / Administrator Account.
instance HasOptionalParam PostVpsReinstallOs Password where
  applyOptionalParam req (Password xs) =
    req `_addMultiFormPart` NH.partLBS "password" (mimeRender' MimeMultipartFormData xs)

-- | @application/json@
instance Consumes PostVpsReinstallOs MimeJSON
-- | @multipart/form-data@
instance Consumes PostVpsReinstallOs MimeMultipartFormData

-- | @application/json@
instance Produces PostVpsReinstallOs MimeJSON
...
postVpsResetPassword
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest PostVpsResetPassword MimeNoContent QueueResponse MimeJSON
postVpsResetPassword (Id id) =
  _mkRequest "POST" ["/vps/",toPath id,"/reset_password"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostVpsResetPassword  
-- | @application/json@
instance Produces PostVpsResetPassword MimeJSON
...
-- 
postVpsRestore
  :: (Consumes PostVpsRestore contentType, MimeRender contentType RestoreRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  VPS ID number
  -> RestoreRequest -- ^ "restoreRequest" -  VPS Restore request
  -> ApiRequest PostVpsRestore contentType QueueResponse MimeJSON
postVpsRestore _ (Id id) restoreRequest =
  _mkRequest "POST" ["/vps/",toPath id,"/restore"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
-- | /Body Param/ "RestoreRequest" - VPS Restore request
instance HasBodyParam PostVpsRestore RestoreRequest 

-- | @application/json@
instance Consumes PostVpsRestore MimeJSON
-- | @multipart/form-data@
instance Consumes PostVpsRestore MimeMultipartFormData

-- | @application/json@
instance Produces PostVpsRestore MimeJSON
...
-- 
postVpsReverseDns
  :: (Consumes PostVpsReverseDns contentType, MimeRender contentType ReverseDnsEntries)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Id -- ^ "id" -  VPS ID number
  -> ReverseDnsEntries -- ^ "reverseDnsEntries"
  -> ApiRequest PostVpsReverseDns contentType TextResponse MimeJSON
postVpsReverseDns _ (Id id) reverseDnsEntries =
  _mkRequest "POST" ["/vps/",toPath id,"/reverse_dns"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` reverseDnsEntries

data PostVpsReverseDns 
instance HasBodyParam PostVpsReverseDns ReverseDnsEntries 

-- | @application/json@
instance Consumes PostVpsReverseDns MimeJSON
-- | @multipart/form-data@
instance Consumes PostVpsReverseDns MimeMultipartFormData

-- | @application/json@
instance Produces PostVpsReverseDns MimeJSON
...
postVpsSetupVnc
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest PostVpsSetupVnc MimeNoContent QueueResponse MimeJSON
postVpsSetupVnc (Id id) =
  _mkRequest "POST" ["/vps/",toPath id,"/setup_vnc"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostVpsSetupVnc  
-- | @application/json@
instance Produces PostVpsSetupVnc MimeJSON
...
postVpsSlices
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest PostVpsSlices MimeNoContent NoContent MimeNoContent
postVpsSlices (Id id) =
  _mkRequest "POST" ["/vps/",toPath id,"/slices"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostVpsSlices  
instance Produces PostVpsSlices MimeNoContent
...
postVpsTrafficUsage
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest PostVpsTrafficUsage MimeNoContent NoContent MimeNoContent
postVpsTrafficUsage (Id id) =
  _mkRequest "POST" ["/vps/",toPath id,"/traffic_usage"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostVpsTrafficUsage  
instance Produces PostVpsTrafficUsage MimeNoContent
...
postVpsViewDesktop
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest PostVpsViewDesktop MimeNoContent NoContent MimeNoContent
postVpsViewDesktop (Id id) =
  _mkRequest "POST" ["/vps/",toPath id,"/view_desktop"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PostVpsViewDesktop  
instance Produces PostVpsViewDesktop MimeNoContent
...
-- 
putVps
  :: (Consumes PutVps contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> ApiRequest PutVps contentType VpsOrderPutResponse MimeJSON
putVps _ =
  _mkRequest "PUT" ["/vps/order"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PutVps 
instance HasBodyParam PutVps VpsOrderPutRequest 

-- | @application/json@
instance Consumes PutVps MimeJSON
-- | @multipart/form-data@
instance Consumes PutVps MimeMultipartFormData

-- | @application/json@
instance Produces PutVps MimeJSON
...
putVpsBuyHdSpace
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest PutVpsBuyHdSpace MimeNoContent NoContent MimeNoContent
putVpsBuyHdSpace (Id id) =
  _mkRequest "PUT" ["/vps/",toPath id,"/buy_hd_space"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data PutVpsBuyHdSpace  
instance Produces PutVpsBuyHdSpace MimeNoContent
...
-- 
updateVpsInfo
  :: IdText -- ^ "id" -  VPS ID number.
  -> ApiRequest UpdateVpsInfo MimeNoContent SuccessTextResponse MimeJSON
updateVpsInfo (IdText id) =
  _mkRequest "POST" ["/vps/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data UpdateVpsInfo  
-- | @application/json@
instance Produces UpdateVpsInfo MimeJSON
...
vPSCancel
  :: Id -- ^ "id" -  VPS ID number
  -> ApiRequest VPSCancel MimeNoContent VPSCancel200Response MimeJSON
vPSCancel (Id id) =
  _mkRequest "DELETE" ["/vps/",toPath id]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data VPSCancel  
-- | @application/json@
instance Produces VPSCancel MimeJSON
