...
module Interserver.Api.API.Public where
...
-- 
getAccountCurrencies
  :: ApiRequest GetAccountCurrencies MimeNoContent [Text] MimeJSON
getAccountCurrencies =
  _mkRequest "GET" ["/account/currencies"]
...
data GetAccountCurrencies  
-- | @application/json@
instance Produces GetAccountCurrencies MimeJSON
...
-- 
getAccountLocales
  :: ApiRequest GetAccountLocales MimeNoContent ((Map.Map String GetAccountLocales200ResponseValue)) MimeJSON
getAccountLocales =
  _mkRequest "GET" ["/account/locales"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data GetAccountLocales  
-- | @application/json@
instance Produces GetAccountLocales MimeJSON
...
-- 
getCaptcha
  :: ApiRequest GetCaptcha MimeNoContent CaptchaResponse MimeJSON
getCaptcha =
  _mkRequest "GET" ["/captcha"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetCaptcha  
-- | @application/json@
instance Produces GetCaptcha MimeJSON
...
-- 
getCountries
  :: ApiRequest GetCountries MimeNoContent A.Value MimeJSON
getCountries =
  _mkRequest "GET" ["/account/countries"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
-- | /Optional Param/ "fetch_by" - Get countries by iso2 or iso3 or numcode
instance HasOptionalParam GetCountries FetchBy where
  applyOptionalParam req (FetchBy xs) =
    req `addQuery` toQuery ("fetch_by", Just xs)
-- | @application/json@
instance Produces GetCountries MimeJSON
...
-- 
getInfo
  :: ApiRequest GetInfo MimeNoContent ServicesInfo MimeJSON
getInfo =
  _mkRequest "GET" ["/info"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
...
data GetInfo  
-- | @application/json@
instance Produces GetInfo MimeJSON
...
-- 
getLoginInfo
  :: ApiRequest GetLoginInfo MimeNoContent LoginInfo MimeJSON
getLoginInfo =
  _mkRequest "GET" ["/login"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetLoginInfo  
-- | @application/json@
instance Produces GetLoginInfo MimeJSON
...
-- 
getMPServers0
  :: ApiRequest GetMPServers0 MimeNoContent BuyItNowList MimeJSON
getMPServers0 =
...
data GetMPServers0  
-- | @application/json@
instance Produces GetMPServers0 MimeJSON
...
-- 
getOauthRedirect
  :: Provider -- ^ "provider" -  The OAuth provider name (e.g. `Google`).
  -> ApiRequest GetOauthRedirect MimeNoContent GetOauthRedirect200Response MimeJSON
getOauthRedirect (Provider provider) =
  _mkRequest "GET" ["/oauth"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `addQuery` toQuery ("provider", Just provider)

data GetOauthRedirect  
-- | @application/json@
instance Produces GetOauthRedirect MimeJSON
...
-- 
getTimezones
  :: ApiRequest GetTimezones MimeNoContent [Text] MimeJSON
getTimezones =
  _mkRequest "GET" ["/account/timezones"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
...
data GetTimezones  
-- | @application/json@
instance Produces GetTimezones MimeJSON
...
-- 
patchOauthTwoFactor
  :: (Consumes PatchOauthTwoFactor contentType, MimeRender contentType PatchOauthTwoFactorRequest)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> PatchOauthTwoFactorRequest -- ^ "patchOauthTwoFactorRequest"
  -> ApiRequest PatchOauthTwoFactor contentType PatchOauthTwoFactor200Response MimeJSON
patchOauthTwoFactor _ patchOauthTwoFactorRequest =
  _mkRequest "PATCH" ["/oauth"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `setBodyParam` patchOauthTwoFactorRequest

data PatchOauthTwoFactor 
instance HasBodyParam PatchOauthTwoFactor PatchOauthTwoFactorRequest 

-- | @application/json@
instance Consumes PatchOauthTwoFactor MimeJSON
-- | @multipart/form-data@
instance Consumes PatchOauthTwoFactor MimeMultipartFormData

-- | @application/json@
instance Produces PatchOauthTwoFactor MimeJSON
...
-- 
pingServer
  :: ApiRequest PingServer MimeNoContent Text MimeJSON
pingServer =
  _mkRequest "GET" ["/ping"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
...
data PingServer  
-- | @application/json@
instance Produces PingServer MimeJSON
...
-- 
postOauthCallback
  :: (Consumes PostOauthCallback contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Provider -- ^ "provider" -  The OAuth provider name (e.g. `Google`).
  -> ApiRequest PostOauthCallback contentType PostOauthCallback200Response MimeJSON
postOauthCallback _ (Provider provider) =
  _mkRequest "POST" ["/oauth"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `addQuery` toQuery ("provider", Just provider)

data PostOauthCallback 
instance HasBodyParam PostOauthCallback PostOauthCallbackRequest 

-- | @application/json@
instance Consumes PostOauthCallback MimeJSON
-- | @multipart/form-data@
instance Consumes PostOauthCallback MimeMultipartFormData

-- | @application/json@
instance Produces PostOauthCallback MimeJSON
...
-- 
submitLogin
  :: (Consumes SubmitLogin contentType)
  => ContentType contentType -- ^ request content-type ('MimeType')
  -> Login -- ^ "login"
  -> Passwd -- ^ "passwd"
  -> ApiRequest SubmitLogin contentType LoginSuccessResponse MimeJSON
submitLogin _ (Login login) (Passwd passwd) =
  _mkRequest "POST" ["/login"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)
    `_addMultiFormPart` NH.partLBS "login" (mimeRender' MimeMultipartFormData login)
    `_addMultiFormPart` NH.partLBS "passwd" (mimeRender' MimeMultipartFormData passwd)

data SubmitLogin  
instance HasOptionalParam SubmitLogin Remember where
  applyOptionalParam req (Remember xs) =
    req `_addMultiFormPart` NH.partLBS "remember" (mimeRender' MimeMultipartFormData xs)
instance HasOptionalParam SubmitLogin GRecaptchaResponse where
  applyOptionalParam req (GRecaptchaResponse xs) =
    req `_addMultiFormPart` NH.partLBS "g-recaptcha-response" (mimeRender' MimeMultipartFormData xs)

-- | /Optional Param/ "tfa" - Two Factor Authentication Response.
instance HasOptionalParam SubmitLogin Tfa where
  applyOptionalParam req (Tfa xs) =
    req `_addMultiFormPart` NH.partLBS "tfa" (mimeRender' MimeMultipartFormData xs)

-- | @application/json@
instance Consumes SubmitLogin MimeJSON
-- | @multipart/form-data@
instance Consumes SubmitLogin MimeMultipartFormData

-- | @application/json@
instance Produces SubmitLogin MimeJSON
...
-- 
submitSignup
  :: (Consumes SubmitSignup MimeJSON)
  => ApiRequest SubmitSignup MimeJSON NoContent MimeNoContent
submitSignup =
  _mkRequest "POST" ["/signup"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdCookieAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyAuth)
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeySessionIdHeaderAuth)

data SubmitSignup 
instance HasBodyParam SubmitSignup LoginSubmissionExample 

-- | @application/json@
instance Consumes SubmitSignup MimeJSON

instance Produces SubmitSignup MimeNoContent
