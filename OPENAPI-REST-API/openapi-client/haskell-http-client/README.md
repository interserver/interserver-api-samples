## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `InterServer Management API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the InterServer Management API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Interserver.Api                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | interserver-api-client                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | ApiConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | ApiRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Interserver.Api.Client    | use the "dispatch" functions to send requests       |
| Interserver.Api.Core      | core functions, config and request types            |
| Interserver.Api.API       | construct api requests                              |
| Interserver.Api.Model     | describes api models                                |
| Interserver.Api.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Interserver.Api.ModelLens | lenses for model fields                             |
| Interserver.Api.Logging   | logging functions and utils                         |
