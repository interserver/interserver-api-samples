...
export class DomainsApi extends BaseAPI {
     ...
     */
    addDomain({ domainOrderRequest }: AddDomainRequest): Observable<ServiceOrderPostResponse>
    addDomain({ domainOrderRequest }: AddDomainRequest, opts?: OperationOpts): Observable<AjaxResponse<ServiceOrderPostResponse>>
    addDomain({ domainOrderRequest }: AddDomainRequest, opts?: OperationOpts): Observable<ServiceOrderPostResponse | AjaxResponse<ServiceOrderPostResponse>> {
        throwIfNullOrUndefined(domainOrderRequest, 'domainOrderRequest', 'addDomain');
     ...
     */
    deleteDomainDnssec({ id }: DeleteDomainDnssecRequest): Observable<SuccessTextResponse>
    deleteDomainDnssec({ id }: DeleteDomainDnssecRequest, opts?: OperationOpts): Observable<AjaxResponse<SuccessTextResponse>>
    deleteDomainDnssec({ id }: DeleteDomainDnssecRequest, opts?: OperationOpts): Observable<SuccessTextResponse | AjaxResponse<SuccessTextResponse>> {
     ...
     */
    patchDomains({ domainOrderRequest }: PatchDomainsRequest): Observable<void>
    patchDomains({ domainOrderRequest }: PatchDomainsRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    patchDomains({ domainOrderRequest }: PatchDomainsRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(domainOrderRequest, 'domainOrderRequest', 'patchDomains');
     ...
     */
    postDomainSearch({ name }: PostDomainSearchRequest): Observable<void>
    postDomainSearch({ name }: PostDomainSearchRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    postDomainSearch({ name }: PostDomainSearchRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(name, 'name', 'postDomainSearch');
     ...
     */
    putDomains({ domainOrderRequest }: PutDomainsRequest): Observable<void>
    putDomains({ domainOrderRequest }: PutDomainsRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    putDomains({ domainOrderRequest }: PutDomainsRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(domainOrderRequest, 'domainOrderRequest', 'putDomains');
