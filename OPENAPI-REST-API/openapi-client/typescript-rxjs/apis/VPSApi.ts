...
export class VPSApi extends BaseAPI {
     ...
     */
    getVpsBackup({ id }: GetVpsBackupRequest): Observable<QueueResponse>
    getVpsBackup({ id }: GetVpsBackupRequest, opts?: OperationOpts): Observable<AjaxResponse<QueueResponse>>
    getVpsBackup({ id }: GetVpsBackupRequest, opts?: OperationOpts): Observable<QueueResponse | AjaxResponse<QueueResponse>> {
        throwIfNullOrUndefined(id, 'id', 'getVpsBackup');
     ...
     */
    getVpsChangeHostname({ id }: GetVpsChangeHostnameRequest): Observable<void>
    getVpsChangeHostname({ id }: GetVpsChangeHostnameRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    getVpsChangeHostname({ id }: GetVpsChangeHostnameRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(id, 'id', 'getVpsChangeHostname');
     ...
     */
    getVpsChangeRootPassword({ id }: GetVpsChangeRootPasswordRequest): Observable<void>
    getVpsChangeRootPassword({ id }: GetVpsChangeRootPasswordRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    getVpsChangeRootPassword({ id }: GetVpsChangeRootPasswordRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(id, 'id', 'getVpsChangeRootPassword');
     ...
     */
    getVpsInsertCd({ id }: GetVpsInsertCdRequest): Observable<void>
    getVpsInsertCd({ id }: GetVpsInsertCdRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    getVpsInsertCd({ id }: GetVpsInsertCdRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(id, 'id', 'getVpsInsertCd');
     ...
     */
    getVpsResetPassword({ id }: GetVpsResetPasswordRequest): Observable<void>
    getVpsResetPassword({ id }: GetVpsResetPasswordRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    getVpsResetPassword({ id }: GetVpsResetPasswordRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(id, 'id', 'getVpsResetPassword');
     ...
     */
    postVpsTrafficUsage({ id }: PostVpsTrafficUsageRequest): Observable<void>
    postVpsTrafficUsage({ id }: PostVpsTrafficUsageRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    postVpsTrafficUsage({ id }: PostVpsTrafficUsageRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(id, 'id', 'postVpsTrafficUsage');
     ...
     */
    putVpsBuyHdSpace({ id }: PutVpsBuyHdSpaceRequest): Observable<void>
    putVpsBuyHdSpace({ id }: PutVpsBuyHdSpaceRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>>
    putVpsBuyHdSpace({ id }: PutVpsBuyHdSpaceRequest, opts?: OperationOpts): Observable<void | AjaxResponse<void>> {
        throwIfNullOrUndefined(id, 'id', 'putVpsBuyHdSpace');
