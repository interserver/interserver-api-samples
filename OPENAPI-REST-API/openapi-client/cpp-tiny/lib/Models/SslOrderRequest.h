...
#ifndef TINY_CPP_CLIENT_SslOrderRequest_H_
#define TINY_CPP_CLIENT_SslOrderRequest_H_
...
public:
	 ...
	 */
    SslOrderRequest();
    SslOrderRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SslOrderRequest_H_ */
