...
#ifndef TINY_CPP_CLIENT_WebsiteOrderPostRequest_H_
#define TINY_CPP_CLIENT_WebsiteOrderPostRequest_H_
...
public:
    ...
    WebsiteOrderPostRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_WebsiteOrderPostRequest_H_ */
