...
pub struct HomeServicesLicensesLinks {
    /// Link to a license.
    #[serde(rename = "386522", skip_serializing_if = "Option::is_none")]
    pub param_386522: Option<String>,
}

impl HomeServicesLicensesLinks {
    /// Map of license service IDs to their IP addresses for the account dashboard.
    pub fn new() -> HomeServicesLicensesLinks {
