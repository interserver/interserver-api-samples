...
pub struct MailDeliverabilityResponse {
    ...
    #[serde(rename = "table_data", skip_serializing_if = "Option::is_none")]
    pub table_data: Option<Vec<Vec<String>>>,
}

impl MailDeliverabilityResponse {
    /// Deliverability statistics for a mail service.
    pub fn new() -> MailDeliverabilityResponse {
