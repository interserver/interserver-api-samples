...
pub struct WebsitesOrderJsonServiceOffers {
    /// Array of service offers
    #[serde(rename = "1026")]
    pub param_1026: Vec<models::WebsitesOrderJsonServiceOffersItem>,
}

impl WebsitesOrderJsonServiceOffers {
    /// Schema for the jsonServiceOffers field in WebsitesOrder
    pub fn new(param_1026: Vec<models::WebsitesOrderJsonServiceOffersItem>) -> WebsitesOrderJsonServiceOffers {
