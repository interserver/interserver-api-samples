...
pub struct ChargeInvoiceRows {
    ...
    pub invoices: Option<std::collections::HashMap<String, models::ChargeInvoiceRowsInvoicesValue>>,
}

impl ChargeInvoiceRows {
    /// Billing invoices associated with a service, including invoice IDs, descriptions, amounts, and payment status.
    pub fn new() -> ChargeInvoiceRows {
        ChargeInvoiceRows {
            success: None,
            invoices: None,
        }
