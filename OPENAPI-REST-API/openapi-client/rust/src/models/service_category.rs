...
pub struct ServiceCategory {
    ...
    #[serde(rename = "category_module")]
    pub category_module: String,
}

impl ServiceCategory {
    /// A Category of Services.  This is the broadest grouping within a module.
    pub fn new(category_id: i32, category_name: String, category_tag: String, category_module: String) -> ServiceCategory {
        ServiceCategory {
            category_id,
            category_name,
            category_tag,
