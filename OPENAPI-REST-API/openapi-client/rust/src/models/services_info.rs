...
pub struct ServicesInfo {
    ...
    pub modules: models::Modules,
    #[serde(rename = "services")]
    pub services: models::Services,
    #[serde(rename = "serviceTypes")]
    pub service_types: models::ServiceTypes,
    #[serde(rename = "serviceCategories")]
    pub service_categories: models::ServiceCategories,
}

impl ServicesInfo {
    /// Contains the complete catalog of available modules, services, service types, and service categories.
    pub fn new(modules: models::Modules, services: models::Services, service_types: models::ServiceTypes, service_categories: models::ServiceCategories) -> ServicesInfo {
        ServicesInfo {
            modules,
            services,
            service_types,
