...
pub struct MailDelistResponse {
    /// Mail service ID.
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<i32>,
    /// Local blocklist entries.
    #[serde(rename = "local", skip_serializing_if = "Option::is_none")]
    pub local: Option<Vec<serde_json::Value>>,
    /// MailBaby trap block entries.
    #[serde(rename = "mbtrap", skip_serializing_if = "Option::is_none")]
    pub mbtrap: Option<Vec<serde_json::Value>>,
    /// Subject-based block entries.
    #[serde(rename = "subject", skip_serializing_if = "Option::is_none")]
    pub subject: Option<Vec<serde_json::Value>>,
    /// Manually blocked entries.
    #[serde(rename = "manual", skip_serializing_if = "Option::is_none")]
    pub manual: Option<Vec<serde_json::Value>>,
}

impl MailDelistResponse {
    /// Blocklist status information for a mail service.
    pub fn new() -> MailDelistResponse {
        MailDelistResponse {
            id: None,
            local: None,
            mbtrap: None,
