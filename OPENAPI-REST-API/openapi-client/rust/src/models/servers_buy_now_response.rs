...
pub struct ServersBuyNowResponse {
    ...
    pub order_details: Option<Box<models::ServersBuyNowResponseOrderDetails>>,
}

impl ServersBuyNowResponse {
    /// Success response after placing a buy-it-now dedicated server order.
    pub fn new() -> ServersBuyNowResponse {
