...
pub struct WebsiteExtraInfoTables {
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<Box<models::WebsiteTable>>,
    #[serde(rename = "preview", skip_serializing_if = "Option::is_none")]
    pub preview: Option<Box<models::WebsiteTable>>,
    #[serde(rename = "dns", skip_serializing_if = "Option::is_none")]
    pub dns: Option<Box<models::WebsiteTable>>,
}

impl WebsiteExtraInfoTables {
    /// Supplementary information tables displayed for a webhosting service (links, DNS, preview).
    pub fn new() -> WebsiteExtraInfoTables {
