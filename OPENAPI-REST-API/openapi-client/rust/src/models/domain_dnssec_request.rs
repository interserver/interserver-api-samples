...
pub struct DomainDnssecRequest {
    ...
    pub key_tag: Option<Vec<i32>>,
}

impl DomainDnssecRequest {
    /// Request payload for adding DNSSEC DS records to a domain.
    pub fn new() -> DomainDnssecRequest {
        DomainDnssecRequest {
            algorithm: None,
            digest_type: None,
            digest: None,
