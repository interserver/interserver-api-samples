...
pub struct LoginSubmissionExample {
    #[serde(rename = "login")]
    pub login: String,
    #[serde(rename = "passwd")]
    pub passwd: String,
    ...
    #[serde(rename = "g-recaptcha-response", skip_serializing_if = "Option::is_none")]
    pub g_recaptcha_response: Option<Box<models::LoginSubmissionExampleGRecaptchaResponse>>,
    /// Two Factor Authentication Response.
    #[serde(rename = "tfa", skip_serializing_if = "Option::is_none")]
    pub tfa: Option<String>,
}

impl LoginSubmissionExample {
    /// The data to submit in the login request.
    pub fn new(login: String, passwd: String) -> LoginSubmissionExample {
