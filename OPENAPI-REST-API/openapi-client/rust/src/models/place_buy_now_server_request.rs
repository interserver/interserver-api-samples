...
pub struct PlaceBuyNowServerRequest {
    ...
    #[serde(rename = "server_root_password", skip_serializing_if = "Option::is_none")]
    pub server_root_password: Option<String>,
}

impl PlaceBuyNowServerRequest {
    pub fn new() -> PlaceBuyNowServerRequest {
