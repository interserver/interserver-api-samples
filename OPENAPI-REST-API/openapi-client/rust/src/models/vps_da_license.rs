...
pub struct VpsDaLicense {
    /// License tier name.
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// License tier sub-name.
    #[serde(rename = "sub_name", skip_serializing_if = "Option::is_none")]
    pub sub_name: Option<String>,
    /// Monthly cost in cents.
    #[serde(rename = "cost", skip_serializing_if = "Option::is_none")]
    pub cost: Option<i32>,
    /// Image path for the disabled state icon.
    #[serde(rename = "img_disabled", skip_serializing_if = "Option::is_none")]
    pub img_disabled: Option<String>,
    /// Image path for the active state icon.
    #[serde(rename = "img_active", skip_serializing_if = "Option::is_none")]
    pub img_active: Option<String>,
}

impl VpsDaLicense {
    /// A DirectAdmin license tier option.
    pub fn new() -> VpsDaLicense {
        VpsDaLicense {
            name: None,
            sub_name: None,
            cost: None,
