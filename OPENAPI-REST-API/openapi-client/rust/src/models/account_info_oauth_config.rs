...
pub struct AccountInfoOauthConfig {
    #[serde(rename = "callback")]
    pub callback: String,
    #[serde(rename = "providers")]
    pub providers: models::AccountInfoOauthConfigProviders,
}

impl AccountInfoOauthConfig {
    /// OAuth integration configuration including callback URL and available providers.
    pub fn new(callback: String, providers: models::AccountInfoOauthConfigProviders) -> AccountInfoOauthConfig {
