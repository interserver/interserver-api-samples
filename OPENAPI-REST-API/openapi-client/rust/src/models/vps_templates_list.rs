...
pub struct VpsTemplatesList {
    /// A listing of the templates.
    #[serde(rename = "templates")]
    pub templates: Vec<models::VpsTemplateRow>,
}

impl VpsTemplatesList {
    /// A listing of the OS Templates available for use.
    pub fn new(templates: Vec<models::VpsTemplateRow>) -> VpsTemplatesList {
        VpsTemplatesList {
            templates,
        }
    }
