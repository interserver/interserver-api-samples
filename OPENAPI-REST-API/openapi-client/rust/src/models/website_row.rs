...
pub struct WebsiteRow {
    ...
    #[serde(rename = "website_comment")]
    pub website_comment: String,
}

impl WebsiteRow {
    /// A result row from the `Webhosting` `GET` request.
    pub fn new(website_id: String, website_hostname: String, repeat_invoices_cost: String, website_status: String, services_name: String, website_comment: String) -> WebsiteRow {
        WebsiteRow {
            website_id,
            website_hostname,
