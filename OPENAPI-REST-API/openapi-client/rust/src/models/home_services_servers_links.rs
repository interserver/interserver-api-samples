...
pub struct HomeServicesServersLinks {
    /// Link to a server.
    #[serde(rename = "16058", skip_serializing_if = "Option::is_none")]
    pub param_16058: Option<String>,
}

impl HomeServicesServersLinks {
    /// Map of dedicated server service IDs to their hostnames for the account dashboard.
    pub fn new() -> HomeServicesServersLinks {
