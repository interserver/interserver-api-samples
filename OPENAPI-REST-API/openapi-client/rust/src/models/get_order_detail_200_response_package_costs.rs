...
pub struct GetOrderDetail200ResponsePackageCosts {
    #[serde(rename = "package_id", skip_serializing_if = "Option::is_none")]
    pub package_id: Option<f64>,
    #[serde(rename = "package_cost", skip_serializing_if = "Option::is_none")]
...
impl GetOrderDetail200ResponsePackageCosts {
    pub fn new() -> GetOrderDetail200ResponsePackageCosts {
