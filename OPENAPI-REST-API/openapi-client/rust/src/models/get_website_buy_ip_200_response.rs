...
pub struct GetWebsiteBuyIp200Response {
    /// A map of IP addresses to their current reverse DNS hostnames.
    #[serde(rename = "ips", skip_serializing_if = "Option::is_none")]
    pub ips: Option<std::collections::HashMap<String, String>>,
}

impl GetWebsiteBuyIp200Response {
    pub fn new() -> GetWebsiteBuyIp200Response {
