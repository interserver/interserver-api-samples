...
pub struct VpsTrafficUsageAverageSectionResponse {
    #[serde(rename = "total")]
    pub total: i32,
    #[serde(rename = "count")]
    pub count: i32,
...
impl VpsTrafficUsageAverageSectionResponse {
    /// VPS Traffic Usage Average Section Response
    pub fn new(total: i32, count: i32, value: i32) -> VpsTrafficUsageAverageSectionResponse {
