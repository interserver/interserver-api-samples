...
pub struct ServerBulkIpmiPowerResponse {
    #[serde(rename = "results")]
    pub results: Vec<models::ServerBulkIpmiPowerResponseResultsInner>,
}

impl ServerBulkIpmiPowerResponse {
    /// Per-server IPMI power-status results for a bulk lookup.
    pub fn new(results: Vec<models::ServerBulkIpmiPowerResponseResultsInner>) -> ServerBulkIpmiPowerResponse {
