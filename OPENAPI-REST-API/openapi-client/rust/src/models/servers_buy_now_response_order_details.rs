...
pub struct ServersBuyNowResponseOrderDetails {
    ...
    pub invoice_id: Option<f64>,
}

impl ServersBuyNowResponseOrderDetails {
    /// Details of the placed order.
    pub fn new() -> ServersBuyNowResponseOrderDetails {
