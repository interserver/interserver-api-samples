...
impl VpsOrderPutRequest {
    /// request to validate a vps order
    pub fn new(os_distro: String, slices: u32, vps_platform: VpsPlatform, period: u32, location: u32, os_version: String, hostname: String, rootpass: String) -> VpsOrderPutRequest {
        VpsOrderPutRequest {
            os_distro,
            slices,
            vps_platform,
