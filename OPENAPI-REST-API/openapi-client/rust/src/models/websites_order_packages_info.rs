...
pub struct WebsitesOrderPackagesInfo {
...
impl WebsitesOrderPackagesInfo {
    pub fn new(services_id: String, services_name: String, services_cost: String, services_category: String, services_buyable: String, services_type: String, services_module: String, services_description: String) -> WebsitesOrderPackagesInfo {
