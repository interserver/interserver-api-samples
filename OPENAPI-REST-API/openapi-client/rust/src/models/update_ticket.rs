...
pub struct UpdateTicket {
    ...
    #[serde(rename = "customer_server_access", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "sudo_username", skip_serializing_if = "Option::is_none")]
