...
pub struct ScrubIpFilterTypes {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "filters", skip_serializing_if = "Option::is_none")]
    pub filters: Option<std::collections::HashMap<String, models::ScrubIpFilterTypesFiltersValue>>,
}

impl ScrubIpFilterTypes {
    /// Available scrub filter types for building firewall rules.
    pub fn new() -> ScrubIpFilterTypes {
        ScrubIpFilterTypes {
            success: None,
            filters: None,
        }
