...
> Vec<String> get_account_currencies()
...
> std::collections::HashMap<String, models::GetAccountLocales200ResponseValue> get_account_locales()
...
[**std::collections::HashMap<String, models::GetAccountLocales200ResponseValue>**](getAccountLocales_200_response_value.md)
...
> models::CaptchaResponse get_captcha()
...
[**models::CaptchaResponse**](CaptchaResponse.md)
...
> serde_json::Value get_countries(fetch_by)
...
------------- | ------------- | ------------- | ------------- | -------------
**fetch_by** | Option<**String**> | Get countries by iso2 or iso3 or numcode |  |
...
[**models::ServicesInfo**](ServicesInfo.md)
...
> models::LoginInfo get_login_info()
...
> models::GetOauthRedirect200Response get_oauth_redirect(provider)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**provider** | **String** | The OAuth provider name (e.g. `Google`). | [required] |

### Return type

[**models::GetOauthRedirect200Response**](getOauthRedirect_200_response.md)
...
> models::PatchOauthTwoFactor200Response patch_oauth_two_factor(patch_oauth_two_factor_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**patch_oauth_two_factor_request** | [**PatchOauthTwoFactorRequest**](PatchOauthTwoFactorRequest.md) |  | [required] |

### Return type

[**models::PatchOauthTwoFactor200Response**](patchOauthTwoFactor_200_response.md)
...
> models::PostOauthCallback200Response post_oauth_callback(provider, post_oauth_callback_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**provider** | **String** | The OAuth provider name (e.g. `Google`). | [required] |
**post_oauth_callback_request** | Option<[**PostOauthCallbackRequest**](PostOauthCallbackRequest.md)> |  |  |

### Return type

[**models::PostOauthCallback200Response**](postOauthCallback_200_response.md)
...
> models::LoginSuccessResponse submit_login(login, passwd, remember, g_recaptcha_response, tfa)
...
**g_recaptcha_response** | Option<[**models::LoginSubmissionExampleGRecaptchaResponse**](LoginSubmissionExampleGRecaptchaResponse.md)> |  |  |
**tfa** | Option<**String**> | Two Factor Authentication Response. |  |

### Return type

[**models::LoginSuccessResponse**](LoginSuccessResponse.md)
...
> submit_signup(login_submission_example)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**login_submission_example** | Option<[**LoginSubmissionExample**](LoginSubmissionExample.md)> |  |  |
