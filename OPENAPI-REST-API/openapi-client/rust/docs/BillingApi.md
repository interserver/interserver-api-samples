...
> models::SuccessTextResponse add_billing_credit_card(billing_add_cc_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**billing_add_cc_request** | [**BillingAddCcRequest**](BillingAddCcRequest.md) |  | [required] |
...
> models::SuccessTextResponse add_billing_prepay(billing_prepay_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**billing_prepay_request** | [**BillingPrepayRequest**](BillingPrepayRequest.md) |  | [required] |
...
> models::SuccessTextResponse delete_billing_credit_card(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The credit card ID to remove. Use IDs from `GET /billing/creditcards`. | [required] |
...
> models::SuccessTextResponse delete_billing_invoice(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The invoice ID to delete. Only unpaid invoices can be deleted. | [required] |
...
> models::SuccessTextResponse delete_billing_prepay(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The prepay balance ID to delete. | [required] |
...
> Vec<models::AffiliateBannerRow> get_affiliate_banners()
...
[**Vec<models::AffiliateBannerRow>**](AffiliateBannerRow.md)
...
> get_affiliate_download(st, ex, year)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**st** | Option<**String**> | Filter by status. |  |
**ex** | Option<**String**> | Export format: csv, xls, xlsx, or pdf. Defaults to csv. |  |
**year** | Option<**i32**> | Year to filter the report. Defaults to the current year. |  |
...
> models::TextResponse get_affiliate_rich_report()
...
> models::StatusMonthlyBreakdown get_affiliate_sales_graph(days)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**days** | Option<**i32**> | Number of days of sales history to include in the graph data. Determines the time window for the returned data points. |  |

### Return type

[**models::StatusMonthlyBreakdown**](StatusMonthlyBreakdown.md)
...
> models::GetAffiliateSignups200Response get_affiliate_signups(st)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**st** | Option<**String**> | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results. |  |

### Return type

[**models::GetAffiliateSignups200Response**](getAffiliateSignups_200_response.md)
...
> models::MonthlyCounts get_affiliate_traffic_graph(days)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**days** | Option<**i32**> | Number of days of traffic history to include in the graph data. Determines the time window for the returned data points. |  |

### Return type

[**models::MonthlyCounts**](MonthlyCounts.md)
...
> Vec<models::AffiliateTrafficRow> get_affiliate_web_traffic()
...
[**Vec<models::AffiliateTrafficRow>**](AffiliateTrafficRow.md)
...
> serde_json::Value get_billing_cart()
...
> models::SuccessTextResponse get_billing_credit_card_verify(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`. | [required] |
...
> models::BillingInvoiceDetail get_billing_invoice(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The invoice ID. Use IDs from `GET /billing/invoices` or from order responses. | [required] |

### Return type

[**models::BillingInvoiceDetail**](BillingInvoiceDetail.md)
...
> models::BillingInvoiceList get_billing_invoices()
...
[**models::BillingInvoiceList**](BillingInvoiceList.md)
...
> serde_json::Value get_billing_pre_pays()
...
> models::InitiatePayment200Response initiate_payment(method, invoices)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**method** | **String** | The payment method to use. Valid values: `cc` (credit card), `paypal`, `prepay`, `payssion`, `payu`, `ccavenue`, `cashfree`, `coinbase`, `btcpay`. | [required] |
...
[**models::InitiatePayment200Response**](initiatePayment_200_response.md)
...
> models::SuccessTextResponse patch_billing_credit_card_verify(id, patch_billing_credit_card_verify_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`. | [required] |
**patch_billing_credit_card_verify_request** | [**PatchBillingCreditCardVerifyRequest**](PatchBillingCreditCardVerifyRequest.md) |  | [required] |
...
> models::SuccessTextResponse post_billing_credit_card_verify(id, billing_verify_cc_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`. | [required] |
**billing_verify_cc_request** | [**BillingVerifyCcRequest**](BillingVerifyCcRequest.md) |  | [required] |
...
> models::TextResponse update_affiliate_dock_setup(affiliate_dock_title, affiliate_dock_description, referrer_coupon)
...
> models::TextResponse update_affiliate_payment_setup(affiliate_paypal, affiliate_payment_method)
...
> models::SuccessTextResponse update_billing_credit_card(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The credit card ID. Use IDs from `GET /billing/creditcards` or the response from `POST /billing/creditcards`. | [required] |
...
> models::SuccessTextResponse update_billing_payment_method(billing_payment_method_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**billing_payment_method_request** | [**BillingPaymentMethodRequest**](BillingPaymentMethodRequest.md) |  | [required] |
