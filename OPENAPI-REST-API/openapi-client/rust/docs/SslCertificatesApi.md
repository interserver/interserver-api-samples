...
> models::ServiceOrderPostResponse add_ssl(ssl_order_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**ssl_order_request** | [**SslOrderRequest**](SslOrderRequest.md) |  | [required] |
...
> serde_json::Value get_ssl_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | SSL certificate ID number. | [required] |
...
> models::ChargeInvoiceRows get_ssl_invoices(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | SSL Cert ID number | [required] |
...
> models::SuccessTextResponse get_ssl_welcome_email(id)
...
> models::SslCancel200Response ssl_cancel(id)
...
[**models::SslCancel200Response**](sslCancel_200_response.md)
...
> models::SuccessTextResponse update_ssl_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | SSL certificate ID number. | [required] |
