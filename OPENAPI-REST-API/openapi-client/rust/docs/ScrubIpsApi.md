...
> models::CancelScrubIp200Response cancel_scrub_ip(id)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | ScrubIp ID number | [required] |

### Return type

[**models::CancelScrubIp200Response**](cancelScrubIp_200_response.md)
...
> models::CreateFilter201Response create_filter(id, create_filter)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | ScrubIp ID number | [required] |
**create_filter** | [**CreateFilter**](CreateFilter.md) |  | [required] |

### Return type

[**models::CreateFilter201Response**](createFilter_201_response.md)
...
> models::CreateRule201Response create_geo_rule(id, create_geo_firewall_rule)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | ScrubIp ID number | [required] |
**create_geo_firewall_rule** | [**CreateGeoFirewallRule**](CreateGeoFirewallRule.md) |  | [required] |

### Return type

[**models::CreateRule201Response**](createRule_201_response.md)
...
> models::CreateRule201Response create_rule(id, create_firewall_rule)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | ScrubIp ID number | [required] |
**create_firewall_rule** | [**CreateFirewallRule**](CreateFirewallRule.md) |  | [required] |
...
> models::DeleteFilter200Response delete_filter(id, create_filter)
...
[**models::DeleteFilter200Response**](deleteFilter_200_response.md)
...
> models::DisableScrub200Response disable_scrub(id)
...
[**models::DisableScrub200Response**](disableScrub_200_response.md)
...
> models::EnableScrub200Response enable_scrub(id)
...
[**models::EnableScrub200Response**](enableScrub_200_response.md)
...
> models::GetOrderDetail200Response get_order_detail()
...
[**models::GetOrderDetail200Response**](getOrderDetail_200_response.md)
...
> models::GetScrubIpDetails200Response get_scrub_ip_details(id)
...
[**models::GetScrubIpDetails200Response**](getScrubIpDetails_200_response.md)
...
> models::ScrubIpFilterTypes get_scrub_ip_filter_types()
...
[**models::ScrubIpFilterTypes**](ScrubIpFilterTypes.md)
...
> models::ChargeInvoiceRows get_scrub_ip_invoices(id)
...
> Vec<models::ScrubIpsLogRowSchema> get_scrub_ip_logs(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | Scrub Order ID | [required] |

### Return type

[**Vec<models::ScrubIpsLogRowSchema>**](ScrubIpsLogRowSchema.md)
...
> Vec<models::ScrubIpsRowSchema> get_scrub_ips_list()
...
[**Vec<models::ScrubIpsRowSchema>**](ScrubIpsRowSchema.md)
...
> models::PlaceScrubOrder201Response place_scrub_order(scrub_ip_place_order)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**scrub_ip_place_order** | [**ScrubIpPlaceOrder**](ScrubIpPlaceOrder.md) |  | [required] |

### Return type

[**models::PlaceScrubOrder201Response**](placeScrubOrder_201_response.md)
...
> models::PutScrubIps200Response put_scrub_ips(scrub_ip_place_order)
...
[**models::PutScrubIps200Response**](putScrubIps_200_response.md)
...
> models::ScrubIpsDeleteRule200Response scrub_ips_delete_geo_rule(id, delete_geo_firewall_rule)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | ScrubIp ID number | [required] |
**delete_geo_firewall_rule** | [**DeleteGeoFirewallRule**](DeleteGeoFirewallRule.md) |  | [required] |

### Return type

[**models::ScrubIpsDeleteRule200Response**](scrubIpsDeleteRule_200_response.md)
...
> models::ScrubIpsDeleteRule200Response scrub_ips_delete_rule(id, delete_firewall_rule)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | ScrubIp ID number | [required] |
**delete_firewall_rule** | [**DeleteFirewallRule**](DeleteFirewallRule.md) |  | [required] |
