...
> models::TicketNewResponse add_new_ticket(ticket_new)
...
------------- | ------------- | ------------- | ------------- | -------------
**ticket_new** | [**TicketNew**](TicketNew.md) |  | [required] |

### Return type

[**models::TicketNewResponse**](TicketNewResponse.md)
...
> models::CloseTicketResponseSchema close_ticket(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | Ticket ID | [required] |

### Return type

[**models::CloseTicketResponseSchema**](CloseTicketResponseSchema.md)
...
> models::ViewTicketResponse delete_ticket_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **f64** | Ticket ID number. | [required] |

### Return type

[**models::ViewTicketResponse**](ViewTicketResponse.md)
...
> models::ViewTicketResponse get_ticket_info(id)
...
> models::Tickets get_tickets_list(page, period, view)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**page** | Option<**i32**> | Page number for paginated results. |  |[default to 1]
**period** | Option<**String**> | How far back to show tickets from. Value is in days. |  |[default to 30]
**view** | Option<**String**> | The status of tickets to view. Possible values are Open, Closed, On Hold, and In Progress.  If not specified it will show all types. |  |

### Return type

[**models::Tickets**](Tickets.md)
...
> models::ViewTicketResponse post_ticket_info(id)
...
> models::Tickets post_tickets_list()
...
> models::ViewTicketResponse put_ticket_info(id)
...
> models::ReplyTicketResponseSchema reply_ticket(id, reply_ticket_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **f64** | The ticket ID number. | [required] |
**reply_ticket_request** | Option<[**ReplyTicketRequest**](ReplyTicketRequest.md)> |  |  |

### Return type

[**models::ReplyTicketResponseSchema**](ReplyTicketResponseSchema.md)
...
> models::UpdateTicketResponseSchema update_ticket_info(id, update_ticket)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **f64** | The ticket ID number. | [required] |
**update_ticket** | Option<[**UpdateTicket**](UpdateTicket.md)> |  |  |

### Return type

[**models::UpdateTicketResponseSchema**](UpdateTicketResponseSchema.md)
