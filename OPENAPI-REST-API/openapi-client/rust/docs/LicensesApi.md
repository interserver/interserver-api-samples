...
> models::ServiceOrderPostResponse add_license(license_order_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**license_order_request** | [**LicenseOrderRequest**](LicenseOrderRequest.md) |  | [required] |
...
> models::License get_license_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The license service ID. Use `license_id` from `GET /licenses`. | [required] |
...
> models::ChargeInvoiceRows get_license_invoices(id)
...
> Vec<models::LicenseRow> get_license_list()
...
[**Vec<models::LicenseRow>**](LicenseRow.md)
...
> models::SuccessTextResponse get_licenses_welcome_email(id)
...
> models::LicensesOrder get_new_license()
...
[**models::LicensesOrder**](LicensesOrder.md)
...
> models::LicensesCancel200Response licenses_cancel(id)
...
[**models::LicensesCancel200Response**](licensesCancel_200_response.md)
...
> models::SuccessTextResponse post_license_change_ip(id, ip_object)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The license service ID. Use `license_id` from `GET /licenses`. | [required] |
**ip_object** | [**IpObject**](IpObject.md) |  | [required] |
...
> models::SuccessTextResponse update_license_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | The license service ID. Use `license_id` from `GET /licenses`. | [required] |
