...
------------ | ------------- | ------------- | -------------
**package** | **i32** | License service type id from getNewLicense.serviceTypes (must be buyable). | 
**ip** | **String** | IP address the license is bound to. | 
**tos** | **bool** | Terms-of-service acceptance. Must be true to place the order. | 
**frequency** | Option<**i32**> | Billing frequency in months. | [optional][default to 1]
