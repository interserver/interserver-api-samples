...
> models::AddServer200Response add_server(server_order_post_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**server_order_post_request** | [**ServerOrderPostRequest**](ServerOrderPostRequest.md) |  | [required] |
...
> models::BuyItNowServerOrder200Response buy_it_now_server_order()
...
[**models::BuyItNowServerOrder200Response**](buyItNowServerOrder_200_response.md)
...
> models::BuyItNowList get_mp_servers()
...
[**models::BuyItNowList**](BuyItNowList.md)
...
> models::ServerOrder get_new_server()
...
[**models::ServerOrder**](ServerOrder.md)
...
> models::Server get_server_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | Server ID number. | [required] |
...
> models::ChargeInvoiceRows get_server_invoices(id)
...
> Vec<models::ServerRow> get_server_list()
...
[**Vec<models::ServerRow>**](ServerRow.md)
...
> models::ReverseDnsEntries get_server_reverse_dns(id)
...
> models::SuccessTextResponse get_servers_welcome_email(id)
...
> models::ServersBuyNowResponse place_buy_now_server(place_buy_now_server_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**place_buy_now_server_request** | Option<[**PlaceBuyNowServerRequest**](PlaceBuyNowServerRequest.md)> |  |  |

### Return type

[**models::ServersBuyNowResponse**](ServersBuyNowResponse.md)
...
> models::TextResponse post_server_reverse_dns(id, reverse_dns_entries)
...
> models::ServerBulkIpmiPowerResponse server_bulk_ipmi_power_get(ids)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**ids** | **String** | Comma-separated list of Server IDs to query (e.g. `2313,2314,2315`). May also be passed as repeated `ids[]` query parameters. | [required] |

### Return type

[**models::ServerBulkIpmiPowerResponse**](ServerBulkIpmiPowerResponse.md)
...
> models::ServerIpmiLiveInfo server_ipmi_live_get(id)
...
[**models::ServerIpmiLiveInfo**](ServerIpmiLiveInfo.md)
...
> models::ServerIpmiLiveInfo server_ipmi_live_post(id, ip, asset)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | Server ID number | [required] |
**ip** | **String** | Your IP Address you wish to connect to the IPMI system from. | [required] |
**asset** | Option<**i32**> | Asset ID |  |
...
> models::TextResponse server_ipmi_power_get(id)
...
> models::TextResponse server_ipmi_power_post(id, action, asset)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | Server ID number | [required] |
**action** | **String** | The power action to send to the ipmi controller. | [required] |
**asset** | Option<**i32**> | The Asset ID |  |
...
> models::ServersCancel200Response servers_cancel(id)
...
[**models::ServersCancel200Response**](serversCancel_200_response.md)
...
> models::SuccessTextResponse update_server_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | Server ID number. | [required] |
