...
> models::BackupOrderPostResponse add_backup(validate_only, service_type, coupon)
...
[**models::BackupOrderPostResponse**](BackupOrderPostResponse.md)
...
> models::CancelBackup200Response cancel_backup(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The backup service ID. Use the `backup_id` from `GET /backups` to identify the service. | [required] |

### Return type

[**models::CancelBackup200Response**](cancelBackup_200_response.md)
...
> models::Backup get_backup_info(id)
...
> models::ChargeInvoiceRows get_backup_invoices(id)
...
> models::BackupLoginResponse get_backup_login(id)
...
[**models::BackupLoginResponse**](BackupLoginResponse.md)
...
> Vec<models::BackupRow> get_backups_list()
...
[**Vec<models::BackupRow>**](BackupRow.md)
...
> models::SuccessTextResponse get_backups_welcome_email(id)
...
> models::BackupsOrder get_new_backup()
...
[**models::BackupsOrder**](BackupsOrder.md)
...
> models::SuccessTextResponse update_backup_info(id)
...
> models::BackupOrderPutResponse validate_backup_order(validate_only, service_type, coupon)
...
[**models::BackupOrderPutResponse**](BackupOrderPutResponse.md)
