...
> models::SuccessTextResponse add_dns_domain(domain, ip)
...
------------- | ------------- | ------------- | ------------- | -------------
**domain** | **String** | The domain name. | [required] |
**ip** | **String** | IP Address to point the domain to. | [required] |
...
> add_dns_record(id, name, r#type, content, ttl, prio)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | The DNS Domain ID. | [required] |
**name** | **String** | Name part of record | [required] |
**r#type** | [**models::DnsRecordType**](DnsRecordType.md) |  | [required] |
**content** | **String** | Content of record | [required] |
**ttl** | Option<**i32**> | Time-to-live |  |[default to 86400]
**prio** | Option<**i32**> | Priority |  |[default to 0]
...
> models::SuccessTextResponse delete_dns_domain(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | The DNS domain ID to delete. Use the `id` from `GET /dns` to identify the domain. | [required] |
...
> models::SuccessTextResponse delete_dns_record(domain_id, record_id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**domain_id** | **i32** | The DNS domain ID. Use the `id` from `GET /dns` to identify the domain. | [required] |
**record_id** | **i32** | The DNS record ID within the domain. Use the record `id` from `GET /dns/{id}` to identify the record. | [required] |
...
> Vec<models::DnsRecord> get_dns_domain(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The DNS domain ID. Use the `id` from `GET /dns` to identify the domain. | [required] |
...
> Vec<models::DnsListItem> get_dns_list()
...
[**Vec<models::DnsListItem>**](DnsListItem.md)
...
> models::SuccessTextResponse update_dns_record(domain_id, record_id, name, r#type, content, ttl, prio, disabled, ordername, auth)
...
**record_id** | **i32** | The DNS record ID within the domain. Use the record `id` from `GET /dns/{id}` to identify the record. | [required] |
**name** | Option<**String**> |  |  |
**r#type** | Option<[**models::DnsRecordType**](DnsRecordType.md)> |  |  |
