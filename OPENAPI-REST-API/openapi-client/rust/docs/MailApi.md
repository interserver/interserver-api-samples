...
> models::ServiceOrderPostResponse add_mail(mail_order_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**mail_order_request** | [**MailOrderRequest**](MailOrderRequest.md) |  | [required] |
...
> models::GenericResponse add_rule(id, deny_rule_new)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The mail service ID. Use `mail_id` from `GET /mail`. | [required] |
**deny_rule_new** | [**DenyRuleNew**](DenyRuleNew.md) | These are the fields needed to create a new email deny rule. | [required] |
...
> models::SuccessTextResponse create_mail_alert(id, mail_alert_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The mail service ID. Use `mail_id` from `GET /mail`. | [required] |
**mail_alert_request** | [**MailAlertRequest**](MailAlertRequest.md) |  | [required] |
...
> models::SuccessTextResponse delete_mail_alert(id, delete_mail_alert_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The mail service ID. Use `mail_id` from `GET /mail`. | [required] |
**delete_mail_alert_request** | [**DeleteMailAlertRequest**](DeleteMailAlertRequest.md) |  | [required] |
...
> models::GenericResponse delete_rule(id, rule)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The mail service ID. Use `mail_id` from `GET /mail`. | [required] |
**rule** | **String** | The ID of the Rules entry. | [required] |
...
> models::GenericResponse delist_block(id, email)
...
> models::MailAlertsResponse get_mail_alerts(id)
...
[**models::MailAlertsResponse**](MailAlertsResponse.md)
...
> models::MailBlocks get_mail_blocks(id)
...
> models::MailDelistResponse get_mail_delist(id)
...
[**models::MailDelistResponse**](MailDelistResponse.md)
...
> models::MailDeliverabilityResponse get_mail_deliverability(id)
...
[**models::MailDeliverabilityResponse**](MailDeliverabilityResponse.md)
...
> models::MailSchema get_mail_info(id)
...
[**models::MailSchema**](MailSchema.md)
...
> models::ChargeInvoiceRows get_mail_invoices(id)
...
> Vec<models::MailRow> get_mail_list()
...
> models::SuccessTextResponse get_mail_welcome_email(id)
...
> Vec<models::DenyRuleRecord> get_rules(id)
...
> models::MailStatsType get_stats(id, time)
...
> models::MailCancel200Response mail_cancel(id)
...
[**models::MailCancel200Response**](mailCancel_200_response.md)
...
> models::SuccessTextResponse post_mail_delist(id, mail_delist_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The mail service ID. Use `mail_id` from `GET /mail`. | [required] |
**mail_delist_request** | [**MailDelistRequest**](MailDelistRequest.md) |  | [required] |
...
> models::SuccessTextResponse reset_mail_password(id)
...
> models::GenericResponse send_adv_mail(id, send_mail_adv)
...
> models::GenericResponse send_mail(id, send_mail)
...
> models::SuccessTextResponse update_mail_alert(id, mail_alert_update_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The mail service ID. Use `mail_id` from `GET /mail`. | [required] |
**mail_alert_update_request** | [**MailAlertUpdateRequest**](MailAlertUpdateRequest.md) |  | [required] |
...
> models::SuccessTextResponse update_mail_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | The mail service ID. Use `mail_id` from `GET /mail`. | [required] |
...
> models::GenericResponse update_rule(id, rule, deny_rule_new)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The mail service ID. Use `mail_id` from `GET /mail`. | [required] |
**rule** | **String** | The ID of the deny rule to update. | [required] |
**deny_rule_new** | [**DenyRuleNew**](DenyRuleNew.md) |  | [required] |
...
> models::MailLog view_mail_log(id, id2, origin, mx, from, to, subject, mailid, message_id, replyto, headerfrom, delivered, skip, limit, start_date, end_date, sort, dir, groupby)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The mail service ID. Use `mail_id` from `GET /mail`. | [required] |
**id2** | Option<**i64**> | The numeric ID of the mail order to filter by.  When omitted, logs from the first active mail order are returned.  Obtain valid IDs from `GET /mail` or `GET /mail/{id}`. |  |
...
**subject** | Option<**String**> | Filter by email `Subject` header (exact match).  MIME-encoded subjects are decoded automatically in the response. |  |
...
**message_id** | Option<**String**> | Filter by the `Message-ID` email header using a substring (case-insensitive) match. The `Message-ID` is assigned by the sending mail client and is visible in the `messageId` field of `MailLogEntry`. |  |
...
**skip** | Option<**u32**> | Number of records to skip for pagination.  Use in combination with `limit` to page through large result sets.  Defaults to `0` (no skip). |  |[default to 0]
**limit** | Option<**u32**> | Maximum number of records to return per page.  Defaults to `100`. Maximum allowed value is `10000`.  The response also includes a `total` field with the full matched count so you can calculate the number of pages. |  |[default to 100]
**start_date** | Option<**String**> | Earliest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by `strtotime()` such as `2024-01-15` or `last monday`.  Messages with a `time` value **greater than or equal to** this value will be included. |  |
**end_date** | Option<**String**> | Latest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by `strtotime()` such as `2024-01-31` or `yesterday`. Messages with a `time` value **less than or equal to** this value will be included. |  |
**sort** | Option<**String**> | Field to sort results by.  Currently only `time` is supported (sorts by internal row ID which corresponds to chronological order). |  |[default to time]
**dir** | Option<**String**> | Sort direction.  `desc` returns newest first (default), `asc` returns oldest first. |  |[default to desc]
**groupby** | Option<**String**> | Controls how results are grouped.  `recipient` (default) returns one row per delivery attempt — a message sent to 4 recipients produces 4 rows, each with its own `recipient`, `delivered`, `response`, and delivery metadata.  `message` collapses to one row per unique message ID; delivery-level fields will reflect one arbitrary recipient per message.  The `total` count in the response matches the grouping mode. |  |[default to recipient]
