...
> models::ServiceOrderPostResponse add_vps(vps_order_post_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**vps_order_post_request** | Option<[**VpsOrderPostRequest**](VpsOrderPostRequest.md)> |  |  |
...
> models::SuccessTextResponse delete_vps_backup(id, file, all)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | VPS ID number | [required] |
**file** | **String** | The backup filename to delete. | [required] |
**all** | Option<**String**> | Set to `1` to list all backups across all services, not just the ones for the given VPS. |  |
...
> models::QueueResponse do_vps_block_smtp(id)
...
> models::QueueResponse do_vps_disable_cd(id)
...
> models::QueueResponse do_vps_disable_quota(id)
...
> models::QueueResponse do_vps_eject_cd(id)
...
> models::QueueResponse do_vps_enable_quota(id)
...
> models::QueueResponse do_vps_restart(id)
...
> models::QueueResponse do_vps_start(id)
...
> models::QueueResponse do_vps_stop(id)
...
> models::DownloadQsBackup200Response download_vps_backup(id, download_qs_backup_request, all)
...
> models::QueueResponse get_vps_backup(id)
...
> models::VpsBackupRows get_vps_backups(id, all)
...
> Vec<String> get_vps_change_timezone(id)
...
> models::ChargeInvoiceRows get_vps_invoices(id)
...
> Vec<models::VpsRow> get_vps_list()
...
> models::VpsTemplatesList get_vps_reinstall_os(id)
...
> models::ReverseDnsEntries get_vps_reverse_dns(id)
...
> models::VpsTrafficResponse get_vps_traffic_usage(id)
...
[**models::VpsTrafficResponse**](VpsTrafficResponse.md)
...
> models::SuccessTextResponse get_vps_welcome_email(id)
...
> models::QueueResponse post_vps_change_hostname(id, hostname)
...
> models::QueueResponse post_vps_change_root_password(id, password)
...
> models::QueueResponse post_vps_change_timezone(id, timezone)
...
> models::QueueResponse post_vps_change_webuzo_password(id, password)
...
> models::QueueResponse post_vps_insert_cd(id, url)
...
> models::QueueResponse post_vps_reinstall_os(id, template, local_password, password)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | VPS ID number | [required] |
**template** | **String** | OS Template Filename | [required] |
**local_password** | **String** | Password for this account. | [required] |
...
> models::QueueResponse post_vps_reset_password(id)
...
> models::QueueResponse post_vps_restore(id, restore_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | VPS ID number | [required] |
**restore_request** | [**RestoreRequest**](RestoreRequest.md) | VPS Restore request | [required] |
...
> models::TextResponse post_vps_reverse_dns(id, reverse_dns_entries)
...
> models::QueueResponse post_vps_setup_vnc(id)
...
> models::VpsOrderPutResponse put_vps(vps_order_put_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**vps_order_put_request** | Option<[**VpsOrderPutRequest**](VpsOrderPutRequest.md)> |  |  |

### Return type

[**models::VpsOrderPutResponse**](VpsOrderPutResponse.md)
...
> models::SuccessTextResponse update_vps_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | VPS ID number. | [required] |
...
> models::VpsCancel200Response v_ps_cancel(id)
...
[**models::VpsCancel200Response**](VPSCancel_200_response.md)
