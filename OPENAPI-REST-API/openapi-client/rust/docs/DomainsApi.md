...
> models::ServiceOrderPostResponse add_domain(domain_order_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**domain_order_request** | [**DomainOrderRequest**](DomainOrderRequest.md) |  | [required] |
...
> models::SuccessTextResponse add_domain_dnssec(id, domain_dnssec_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The domain service ID. Use `domain_id` from `GET /domains`. | [required] |
**domain_dnssec_request** | [**DomainDnssecRequest**](DomainDnssecRequest.md) |  | [required] |
...
> models::TextResponse add_domain_nameserver(id, domain_nameserver_post_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The domain service ID. Use `domain_id` from `GET /domains`. | [required] |
**domain_nameserver_post_request** | [**DomainNameserverPostRequest**](DomainNameserverPostRequest.md) |  | [required] |
...
> models::CancelDomain200Response cancel_domain(id)
...
[**models::CancelDomain200Response**](CancelDomain_200_response.md)
...
> models::SuccessTextResponse delete_domain_dnssec(id)
...
> models::TextResponse delete_domain_nameserver(id, index)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The domain service ID. Use `domain_id` from `GET /domains`. | [required] |
**index** | **i32** | The index of the registered nameserver from the registered nameservers list to delete.   | [required] |
...
> models::DomainContactDetails get_domain_contact(id)
...
[**models::DomainContactDetails**](DomainContactDetails.md)
...
> models::DomainDnssecRecords get_domain_dnssec(id)
...
[**models::DomainDnssecRecords**](DomainDnssecRecords.md)
...
> models::Domain get_domain_info(id)
...
> models::ChargeInvoiceRows get_domain_invoices(id)
...
> models::DomainLookupResponse get_domain_lookup(name)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**name** | **String** | The full domain name to look up (for example `example.com`). | [required] |

### Return type

[**models::DomainLookupResponse**](DomainLookupResponse.md)
...
> models::DomainNameserverGetResponse get_domain_nameservers(id)
...
[**models::DomainNameserverGetResponse**](DomainNameserverGetResponse.md)
...
> models::SuccessTextResponse get_domain_renewal(id)
...
> models::DomainSearchResponse get_domain_search(name)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**name** | **String** | The base domain name to search (for example `example` or `example.com`). | [required] |

### Return type

[**models::DomainSearchResponse**](DomainSearchResponse.md)
...
> models::SuccessTextResponse get_domain_transfer(id)
...
> models::SuccessTextResponse get_domain_whois_privacy(id)
...
> Vec<models::DomainRow> get_domains_list()
...
[**Vec<models::DomainRow>**](DomainRow.md)
...
> models::SuccessTextResponse get_domains_welcome_email(id)
...
> models::DomainOrder get_new_domain()
...
[**models::DomainOrder**](DomainOrder.md)
...
> models::SuccessTextResponse post_domain_renewal(id)
...
> models::SuccessTextResponse post_domain_transfer(id)
...
> models::SuccessTextResponse update_domain_contact(id, domain_contact_details)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The domain service ID. Use `domain_id` from `GET /domains`. | [required] |
**domain_contact_details** | [**DomainContactDetails**](DomainContactDetails.md) |  | [required] |
...
> models::SuccessTextResponse update_domain_info(id)
...
> models::TextResponse update_domain_nameservers(id, domain_nameserver_put_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The domain service ID. Use `domain_id` from `GET /domains`. | [required] |
**domain_nameserver_put_request** | [**DomainNameserverPutRequest**](DomainNameserverPutRequest.md) |  | [required] |
...
> models::SuccessTextResponse update_domain_whois_privacy(id, domain_whois_privacy_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The domain service ID. Use `domain_id` from `GET /domains`. | [required] |
**domain_whois_privacy_request** | [**DomainWhoisPrivacyRequest**](DomainWhoisPrivacyRequest.md) |  | [required] |
