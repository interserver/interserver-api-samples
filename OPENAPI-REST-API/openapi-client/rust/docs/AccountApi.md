...
> models::SuccessTextResponse delete_account_oauth_name(name)
...
> models::SuccessTextResponse delete_account_tfa()
...
> models::GenericResponse delete_ip_limit(ip_limit_range)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**ip_limit_range** | Option<[**IpLimitRange**](IpLimitRange.md)> |  |  |
...
> models::AccountInfo get_account_info()
...
> models::GetAccountTfaSetup200Response get_account_tfa_setup()
...
[**models::GetAccountTfaSetup200Response**](getAccountTfaSetup_200_response.md)
...
> models::SearchAutocompleteResponse get_search()
...
[**models::SearchAutocompleteResponse**](SearchAutocompleteResponse.md)
...
> models::SuccessTextResponse logout()
...
> models::SuccessTextResponse logout_account_oauth(name)
...
> models::SuccessTextResponse update_account_api_key()
...
> models::SuccessTextResponse update_account_features(disable_reset, disable_reinstall)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**disable_reset** | Option<**i32**> |  |  |
**disable_reinstall** | Option<**i32**> |  |  |
...
> models::SuccessTextResponse update_account_info(name, address, city, state, zip, country, phone, company, address2, locale, email_invoices, email_abuse, disable_reset, disable_reinstall, disable_server_notifications, disable_email_notifications, gstin)
...
**address** | **String** | Your address. | [required] |
**city** | **String** | Your city. | [required] |
**state** | **String** | Your state. | [required] |
**zip** | **String** | Your ZIP code. | [required] |
**country** | **String** | Your country. | [required] |
**phone** | **String** | Your phone number. | [required] |
...
**email_invoices** | Option<**String**> | Your email for invoice notifications. |  |
**email_abuse** | Option<**String**> | Your email for abuse notifications. |  |
**disable_reset** | Option<**bool**> | Set to `true` to disable account resets, or `false` to enable them. |  |
**disable_reinstall** | Option<**bool**> | Set to `true` to disable server reinstalls, or `false` to enable them. |  |
**disable_server_notifications** | Option<**bool**> | Set to `true` to disable server notifications, or `false` to enable them. |  |
**disable_email_notifications** | Option<**bool**> | Set to `true` to disable email notifications, or `false` to enable them. |  |
...
> models::SuccessTextResponse update_account_ip_limits(start, end)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**start** | **String** | The begining (or first) IP address in the range. | [required] |
**end** | **String** | The ending (or last) IP address in the range. | [required] |
...
> models::TextResponse update_account_password(password)
...
> models::SuccessTextResponse update_account_ssh_key(ssh_key)
...
> models::SuccessTextResponse update_account_tfa(param_2fa_google_code)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**param_2fa_google_code** | **String** | The 6-digit verification code from your authenticator app. | [required] |
