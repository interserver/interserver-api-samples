...
> models::ServiceOrderPostResponse add_website(website_order_post_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**website_order_post_request** | [**WebsiteOrderPostRequest**](WebsiteOrderPostRequest.md) |  | [required] |
...
> models::WebsitesOrder get_new_website()
...
[**models::WebsitesOrder**](WebsitesOrder.md)
...
> models::GetWebsiteBuyIp200Response get_website_buy_ip(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The website service ID. Use `website_id` from `GET /websites`. | [required] |

### Return type

[**models::GetWebsiteBuyIp200Response**](getWebsiteBuyIp_200_response.md)
...
> models::Website get_website_info(id)
...
> models::ChargeInvoiceRows get_website_invoices(id)
...
> Vec<models::WebsiteRow> get_website_list()
...
[**Vec<models::WebsiteRow>**](WebsiteRow.md)
...
> models::WebsiteBackups get_websites_backups(id)
...
[**models::WebsiteBackups**](WebsiteBackups.md)
...
> models::WebsiteLoginResponse get_websites_login(id)
...
[**models::WebsiteLoginResponse**](WebsiteLoginResponse.md)
...
> models::SuccessTextResponse get_websites_welcome_email(id)
...
> models::ReverseDnsEntries gett_website_reverse_dns(id)
...
> models::PostWebsiteBuyIp200Response post_website_buy_ip(id, post_website_buy_ip_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The website service ID. Use `website_id` from `GET /websites`. | [required] |
**post_website_buy_ip_request** | [**PostWebsiteBuyIpRequest**](PostWebsiteBuyIpRequest.md) |  | [required] |

### Return type

[**models::PostWebsiteBuyIp200Response**](postWebsiteBuyIp_200_response.md)
...
> models::PostWebsiteMigration200Response post_website_migration(id, post_website_migration_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**id** | **i32** | The website service ID. Use `website_id` from `GET /websites`. | [required] |
**post_website_migration_request** | [**PostWebsiteMigrationRequest**](PostWebsiteMigrationRequest.md) |  | [required] |

### Return type

[**models::PostWebsiteMigration200Response**](postWebsiteMigration_200_response.md)
...
> models::TextResponse post_websites_reverse_dns(id, reverse_dns_entries)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**website_order_put_request** | [**WebsiteOrderPutRequest**](WebsiteOrderPutRequest.md) |  | [required] |
...
> models::SuccessTextResponse update_website_info(id)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**id** | **String** | The website service ID. Use `website_id` from `GET /websites`. | [required] |
...
> models::WebhostingCancel200Response webhosting_cancel(id)
...
[**models::WebhostingCancel200Response**](webhostingCancel_200_response.md)
