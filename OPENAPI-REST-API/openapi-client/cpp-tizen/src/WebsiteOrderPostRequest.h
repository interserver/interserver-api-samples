...
#ifndef _WebsiteOrderPostRequest_H_
#define _WebsiteOrderPostRequest_H_
...
/*! \brief request to place a webhosting order
 *
 *  \ingroup Models
 *
 */

class WebsiteOrderPostRequest : public Object {
public:
	/*! \brief Constructor.
	 */
	WebsiteOrderPostRequest();
	WebsiteOrderPostRequest(char* str);

	/*! \brief Destructor.
	 */
	virtual ~WebsiteOrderPostRequest();
...
#endif /* _WebsiteOrderPostRequest_H_ */
