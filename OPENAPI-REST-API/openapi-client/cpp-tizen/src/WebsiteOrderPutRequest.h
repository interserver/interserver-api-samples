...
#ifndef _WebsiteOrderPutRequest_H_
#define _WebsiteOrderPutRequest_H_
...
class WebsiteOrderPutRequest : public Object {
public:
	/*! \brief Constructor.
	 */
	WebsiteOrderPutRequest();
	WebsiteOrderPutRequest(char* str);
...
#endif /* _WebsiteOrderPutRequest_H_ */
