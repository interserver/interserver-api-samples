...
[**addDomainWithHttpInfo**](DomainsApi.md#addDomainWithHttpInfo) | **POST** /domains/order | Place a new domain registration or transfer order, generate billing invoice
[**addDomainDnssec**](DomainsApi.md#addDomainDnssec) | **POST** /domains/{id}/dnssec | Register DNSSEC DS records on the domain at OpenSRS
[**addDomainDnssecWithHttpInfo**](DomainsApi.md#addDomainDnssecWithHttpInfo) | **POST** /domains/{id}/dnssec | Register DNSSEC DS records on the domain at OpenSRS
...
[**addDomainNameserverWithHttpInfo**](DomainsApi.md#addDomainNameserverWithHttpInfo) | **POST** /domains/{id}/nameservers | Register a new nameserver host with glue IP at the registry (registered nameserver)
...
[**cancelDomainWithHttpInfo**](DomainsApi.md#cancelDomainWithHttpInfo) | **DELETE** /domains/{id} | Cancel a domain order in the billing system to stop auto-renewals
...
[**deleteDomainDnssecWithHttpInfo**](DomainsApi.md#deleteDomainDnssecWithHttpInfo) | **DELETE** /domains/{id}/dnssec | Clear all DNSSEC DS records on the domain (disable DNSSEC at the registrar)
...
[**deleteDomainNameserverWithHttpInfo**](DomainsApi.md#deleteDomainNameserverWithHttpInfo) | **DELETE** /domains/{id}/nameservers | Remove one registered nameserver glue record from the domain
...
[**getDomainContactWithHttpInfo**](DomainsApi.md#getDomainContactWithHttpInfo) | **GET** /domains/{id}/contact | Read the current registrant/admin/tech/billing contact field set for a domain
...
[**getDomainDnssecWithHttpInfo**](DomainsApi.md#getDomainDnssecWithHttpInfo) | **GET** /domains/{id}/dnssec | Read the DNSSEC DS record set currently registered with the registrar
[**getDomainInfo**](DomainsApi.md#getDomainInfo) | **GET** /domains/{id} | Read full billing, registrar, and service detail for one domain
[**getDomainInfoWithHttpInfo**](DomainsApi.md#getDomainInfoWithHttpInfo) | **GET** /domains/{id} | Read full billing, registrar, and service detail for one domain
...
[**getDomainInvoicesWithHttpInfo**](DomainsApi.md#getDomainInvoicesWithHttpInfo) | **GET** /domains/{id}/invoices | List all billing invoices scoped to one domain order
...
[**getDomainLookupWithHttpInfo**](DomainsApi.md#getDomainLookupWithHttpInfo) | **GET** /domains/lookup/{name} | Check availability, premium status, and pricing for a specific domain
...
[**getDomainNameserversWithHttpInfo**](DomainsApi.md#getDomainNameserversWithHttpInfo) | **GET** /domains/{id}/nameservers | List registered nameserver hosts and glue IP addresses for a domain
...
[**getDomainRenewalWithHttpInfo**](DomainsApi.md#getDomainRenewalWithHttpInfo) | **GET** /domains/{id}/renew | Read renewal pricing, expiry, and whether a renewal invoice already exists
...
[**getDomainSearchWithHttpInfo**](DomainsApi.md#getDomainSearchWithHttpInfo) | **GET** /domains/search/{name} | Get registrar-suggested domain alternatives and bulk availability for a search term
...
[**getDomainTransferWithHttpInfo**](DomainsApi.md#getDomainTransferWithHttpInfo) | **GET** /domains/{id}/transfer | Read OpenSRS transfer status for an in-progress domain transfer order
...
[**getDomainWhoisPrivacyWithHttpInfo**](DomainsApi.md#getDomainWhoisPrivacyWithHttpInfo) | **GET** /domains/{id}/whois | Read Whois privacy availability, current state, and add-on pricing for a domain
...
[**getDomainsListWithHttpInfo**](DomainsApi.md#getDomainsListWithHttpInfo) | **GET** /domains | List every domain registration on the account with billing and registration metadata
...
[**getDomainsWelcomeEmailWithHttpInfo**](DomainsApi.md#getDomainsWelcomeEmailWithHttpInfo) | **GET** /domains/{id}/welcome_email | Resend the domain welcome email with registration details and management instructions
...
[**getNewDomainWithHttpInfo**](DomainsApi.md#getNewDomainWithHttpInfo) | **GET** /domains/order | Read the buyable domain TLD service catalog and Whois privacy pricing
...
[**patchDomainsWithHttpInfo**](DomainsApi.md#patchDomainsWithHttpInfo) | **PATCH** /domains/order | Validate posted domain-order field values before committing — dry run
...
[**postDomainRenewalWithHttpInfo**](DomainsApi.md#postDomainRenewalWithHttpInfo) | **POST** /domains/{id}/renew | Submit a domain renewal request and generate the renewal invoice
...
[**postDomainSearchWithHttpInfo**](DomainsApi.md#postDomainSearchWithHttpInfo) | **POST** /domains/search/{name} | Get the full order form data for a hostname in one round-trip (search → order preview)
...
[**postDomainTransferWithHttpInfo**](DomainsApi.md#postDomainTransferWithHttpInfo) | **POST** /domains/{id}/transfer | Re-poll OpenSRS transfer status for a domain order via POST
[**putDomains**](DomainsApi.md#putDomains) | **PUT** /domains/order | Preview per-TLD field requirements for a domain order — no commit
[**putDomainsWithHttpInfo**](DomainsApi.md#putDomainsWithHttpInfo) | **PUT** /domains/order | Preview per-TLD field requirements for a domain order — no commit
...
[**updateDomainContactWithHttpInfo**](DomainsApi.md#updateDomainContactWithHttpInfo) | **POST** /domains/{id}/contact | Update registrant/admin contact details and push them to OpenSRS
...
[**updateDomainInfoWithHttpInfo**](DomainsApi.md#updateDomainInfoWithHttpInfo) | **POST** /domains/{id} | POST mutation hook for the domain detail page (use dedicated ops where possible)
...
[**updateDomainNameserversWithHttpInfo**](DomainsApi.md#updateDomainNameserversWithHttpInfo) | **PUT** /domains/{id}/nameservers | Replace the full authoritative-nameserver delegation list at the registrar
...
[**updateDomainWhoisPrivacyWithHttpInfo**](DomainsApi.md#updateDomainWhoisPrivacyWithHttpInfo) | **POST** /domains/{id}/whois | Order, enable, or cancel the Whois privacy add-on for a domain



## addDomain

> addDomain(addDomainRequest): ApiRequest[ServiceOrderPostResponse]
...
object Example extends App {
    ...
    val request = apiInstance.addDomain(domainOrderRequest)
...
object Example extends App {
    ...
    val request = apiInstance.deleteDomainDnssec(id)
    val response = apiInvoker.execute(request)
...
> patchDomains(patchDomainsRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.patchDomains(domainOrderRequest)
    val response = apiInvoker.execute(request)
...
> postDomainSearch(postDomainSearchRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.postDomainSearch(name)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling DomainsApi#postDomainSearch")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
...
> putDomains(putDomainsRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.putDomains(domainOrderRequest)
    val response = apiInvoker.execute(request)
