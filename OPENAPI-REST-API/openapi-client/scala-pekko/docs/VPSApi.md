...
[**addVpsWithHttpInfo**](VPSApi.md#addVpsWithHttpInfo) | **POST** /vps/order | Place a new VPS order, create the invoice, and queue provisioning
...
[**deleteVpsBackupWithHttpInfo**](VPSApi.md#deleteVpsBackupWithHttpInfo) | **DELETE** /vps/{id}/backups | Permanently delete a VPS backup file by name (irreversible)
...
[**doVpsBlockSmtpWithHttpInfo**](VPSApi.md#doVpsBlockSmtpWithHttpInfo) | **GET** /vps/{id}/block_smtp | Block outbound SMTP (port 25) on the VPS to prevent spam/abuse
...
[**doVpsDisableCdWithHttpInfo**](VPSApi.md#doVpsDisableCdWithHttpInfo) | **GET** /vps/{id}/disable_cd | Remove the virtual CD/DVD device entirely from the VPS configuration
...
[**doVpsDisableQuotaWithHttpInfo**](VPSApi.md#doVpsDisableQuotaWithHttpInfo) | **GET** /vps/{id}/disable_quota | Disable per-user disk quota enforcement inside the VPS guest OS
...
[**doVpsEjectCdWithHttpInfo**](VPSApi.md#doVpsEjectCdWithHttpInfo) | **GET** /vps/{id}/eject_cd | Eject the mounted ISO from the VPS virtual CD drive (keep the drive)
...
[**doVpsEnableQuotaWithHttpInfo**](VPSApi.md#doVpsEnableQuotaWithHttpInfo) | **GET** /vps/{id}/enable_quota | Enable per-user disk quota enforcement inside the VPS guest OS
[**doVpsRestart**](VPSApi.md#doVpsRestart) | **GET** /vps/{id}/restart | Reboot the VPS — preferred over stop+start for software changes
[**doVpsRestartWithHttpInfo**](VPSApi.md#doVpsRestartWithHttpInfo) | **GET** /vps/{id}/restart | Reboot the VPS — preferred over stop+start for software changes
[**doVpsStart**](VPSApi.md#doVpsStart) | **GET** /vps/{id}/start | Power on a stopped VPS instance
[**doVpsStartWithHttpInfo**](VPSApi.md#doVpsStartWithHttpInfo) | **GET** /vps/{id}/start | Power on a stopped VPS instance
[**doVpsStop**](VPSApi.md#doVpsStop) | **GET** /vps/{id}/stop | Power off a running VPS — billing continues until cancellation
[**doVpsStopWithHttpInfo**](VPSApi.md#doVpsStopWithHttpInfo) | **GET** /vps/{id}/stop | Power off a running VPS — billing continues until cancellation
...
[**downloadVpsBackupWithHttpInfo**](VPSApi.md#downloadVpsBackupWithHttpInfo) | **PATCH** /vps/{id}/backups | Issue a 24-hour pre-signed URL to download a MinIO-backed VPS backup
[**getNewVps**](VPSApi.md#getNewVps) | **GET** /vps/order | Get the VPS order catalog — platforms, OS templates, locations, pricing
[**getNewVpsWithHttpInfo**](VPSApi.md#getNewVpsWithHttpInfo) | **GET** /vps/order | Get the VPS order catalog — platforms, OS templates, locations, pricing
[**getVpsBackup**](VPSApi.md#getVpsBackup) | **GET** /vps/{id}/backup | Trigger a manual on-demand snapshot/backup of the VPS
[**getVpsBackupWithHttpInfo**](VPSApi.md#getVpsBackupWithHttpInfo) | **GET** /vps/{id}/backup | Trigger a manual on-demand snapshot/backup of the VPS
[**getVpsBackups**](VPSApi.md#getVpsBackups) | **GET** /vps/{id}/backups | List existing backups for the VPS across Swift, MinIO, and ZFS
[**getVpsBackupsWithHttpInfo**](VPSApi.md#getVpsBackupsWithHttpInfo) | **GET** /vps/{id}/backups | List existing backups for the VPS across Swift, MinIO, and ZFS
...
[**getVpsBuyHdSpaceWithHttpInfo**](VPSApi.md#getVpsBuyHdSpaceWithHttpInfo) | **GET** /vps/{id}/buy_hd_space | Get current additional disk size and per-GB monthly cost for the VPS
[**getVpsBuyIp**](VPSApi.md#getVpsBuyIp) | **GET** /vps/{id}/buy_ip | Read current additional IPs, cap, and per-IP monthly cost for the VPS
[**getVpsBuyIpWithHttpInfo**](VPSApi.md#getVpsBuyIpWithHttpInfo) | **GET** /vps/{id}/buy_ip | Read current additional IPs, cap, and per-IP monthly cost for the VPS
...
[**getVpsChangeHostnameWithHttpInfo**](VPSApi.md#getVpsChangeHostnameWithHttpInfo) | **GET** /vps/{id}/change_hostname | Read the VPS&#39;s current hostname before changing it
...
[**getVpsChangeRootPasswordWithHttpInfo**](VPSApi.md#getVpsChangeRootPasswordWithHttpInfo) | **GET** /vps/{id}/change_root_password | Pre-flight check before changing the VPS root password
...
[**getVpsChangeTimezoneWithHttpInfo**](VPSApi.md#getVpsChangeTimezoneWithHttpInfo) | **GET** /vps/{id}/change_timezone | List IANA timezones supported by the VPS guest OS
[**getVpsInfo**](VPSApi.md#getVpsInfo) | **GET** /vps/{id} | Get full details for one VPS — IPs, hostname, OS, slices, status, addons
[**getVpsInfoWithHttpInfo**](VPSApi.md#getVpsInfoWithHttpInfo) | **GET** /vps/{id} | Get full details for one VPS — IPs, hostname, OS, slices, status, addons
...
[**getVpsInsertCdWithHttpInfo**](VPSApi.md#getVpsInsertCdWithHttpInfo) | **GET** /vps/{id}/insert_cd | List ISO templates that can be mounted in the VPS virtual CD drive
[**getVpsInvoices**](VPSApi.md#getVpsInvoices) | **GET** /vps/{id}/invoices | List all billing invoices associated with this specific VPS
[**getVpsInvoicesWithHttpInfo**](VPSApi.md#getVpsInvoicesWithHttpInfo) | **GET** /vps/{id}/invoices | List all billing invoices associated with this specific VPS
[**getVpsList**](VPSApi.md#getVpsList) | **GET** /vps | List all VPS services on the customer&#39;s account
[**getVpsListWithHttpInfo**](VPSApi.md#getVpsListWithHttpInfo) | **GET** /vps | List all VPS services on the customer&#39;s account
...
[**getVpsReinstallOsWithHttpInfo**](VPSApi.md#getVpsReinstallOsWithHttpInfo) | **GET** /vps/{id}/reinstall_os | List OS templates compatible with this VPS&#39;s hypervisor for reinstall
...
[**getVpsResetPasswordWithHttpInfo**](VPSApi.md#getVpsResetPasswordWithHttpInfo) | **GET** /vps/{id}/reset_password | Pre-flight check before resetting the VPS root password to a random value
...
[**getVpsReverseDnsWithHttpInfo**](VPSApi.md#getVpsReverseDnsWithHttpInfo) | **GET** /vps/{id}/reverse_dns | Read the current PTR (reverse-DNS) records for every IP on the VPS
[**getVpsSetupVnc**](VPSApi.md#getVpsSetupVnc) | **GET** /vps/{id}/setup_vnc | Read current VNC console connection info for the VPS
[**getVpsSetupVncWithHttpInfo**](VPSApi.md#getVpsSetupVncWithHttpInfo) | **GET** /vps/{id}/setup_vnc | Read current VNC console connection info for the VPS
...
[**getVpsSlicesWithHttpInfo**](VPSApi.md#getVpsSlicesWithHttpInfo) | **GET** /vps/{id}/slices | Read current slice count, min/max range, and prorated per-slice upgrade cost
[**getVpsTrafficUsage**](VPSApi.md#getVpsTrafficUsage) | **GET** /vps/{id}/traffic_usage | Read bandwidth traffic usage data for the VPS
[**getVpsTrafficUsageWithHttpInfo**](VPSApi.md#getVpsTrafficUsageWithHttpInfo) | **GET** /vps/{id}/traffic_usage | Read bandwidth traffic usage data for the VPS
...
[**getVpsViewDesktopWithHttpInfo**](VPSApi.md#getVpsViewDesktopWithHttpInfo) | **GET** /vps/{id}/view_desktop | Read remote-desktop (RDP/HTML5) connection info for a Windows/GUI VPS
...
[**getVpsWelcomeEmailWithHttpInfo**](VPSApi.md#getVpsWelcomeEmailWithHttpInfo) | **GET** /vps/{id}/welcome_email | Resend the welcome email containing VPS IP, hostname, and root credentials
...
[**postVpsBuyHdSpaceWithHttpInfo**](VPSApi.md#postVpsBuyHdSpaceWithHttpInfo) | **POST** /vps/{id}/buy_hd_space | Buy or resize the VPS additional-disk addon and create a prorated invoice
[**postVpsBuyIp**](VPSApi.md#postVpsBuyIp) | **POST** /vps/{id}/buy_ip | Purchase one additional IP for the VPS and create the invoice
[**postVpsBuyIpWithHttpInfo**](VPSApi.md#postVpsBuyIpWithHttpInfo) | **POST** /vps/{id}/buy_ip | Purchase one additional IP for the VPS and create the invoice
...
[**postVpsChangeHostnameWithHttpInfo**](VPSApi.md#postVpsChangeHostnameWithHttpInfo) | **POST** /vps/{id}/change_hostname | Rename the VPS hostname (OpenVZ/Virtuozzo only) and auto-set PTR for the primary IP
...
[**postVpsChangeRootPasswordWithHttpInfo**](VPSApi.md#postVpsChangeRootPasswordWithHttpInfo) | **POST** /vps/{id}/change_root_password | Set a specific new root/Administrator password on the VPS
...
[**postVpsChangeTimezoneWithHttpInfo**](VPSApi.md#postVpsChangeTimezoneWithHttpInfo) | **POST** /vps/{id}/change_timezone | Set the system timezone on the VPS guest OS
...
[**postVpsChangeWebuzoPasswordWithHttpInfo**](VPSApi.md#postVpsChangeWebuzoPasswordWithHttpInfo) | **POST** /vps/{id}/change_webuzo_password | Rotate the Webuzo control panel admin password (re-auth required)
...
[**postVpsInsertCdWithHttpInfo**](VPSApi.md#postVpsInsertCdWithHttpInfo) | **POST** /vps/{id}/insert_cd | Mount an ISO image in the VPS virtual CD drive from a URL
...
[**postVpsReinstallOsWithHttpInfo**](VPSApi.md#postVpsReinstallOsWithHttpInfo) | **POST** /vps/{id}/reinstall_os | Reinstall the VPS OS (DESTRUCTIVE — wipes disk; requires re-auth)
...
[**postVpsResetPasswordWithHttpInfo**](VPSApi.md#postVpsResetPasswordWithHttpInfo) | **POST** /vps/{id}/reset_password | Reset the VPS root password to a server-generated random value
[**postVpsRestore**](VPSApi.md#postVpsRestore) | **POST** /vps/{id}/restore | Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
[**postVpsRestoreWithHttpInfo**](VPSApi.md#postVpsRestoreWithHttpInfo) | **POST** /vps/{id}/restore | Restore the VPS from a backup (DESTRUCTIVE — overwrites disk)
...
[**postVpsReverseDnsWithHttpInfo**](VPSApi.md#postVpsReverseDnsWithHttpInfo) | **POST** /vps/{id}/reverse_dns | Bulk-update PTR (reverse-DNS) records for one or more VPS IPs
...
[**postVpsSetupVncWithHttpInfo**](VPSApi.md#postVpsSetupVncWithHttpInfo) | **POST** /vps/{id}/setup_vnc | Provision or refresh the VNC console endpoint for the VPS
...
[**postVpsSlicesWithHttpInfo**](VPSApi.md#postVpsSlicesWithHttpInfo) | **POST** /vps/{id}/slices | Upgrade or downgrade the VPS slice count (creates prorated invoice on upgrade)
...
[**postVpsTrafficUsageWithHttpInfo**](VPSApi.md#postVpsTrafficUsageWithHttpInfo) | **POST** /vps/{id}/traffic_usage | Search/filter VPS bandwidth usage with custom criteria (reserved)
...
[**postVpsViewDesktopWithHttpInfo**](VPSApi.md#postVpsViewDesktopWithHttpInfo) | **POST** /vps/{id}/view_desktop | Refresh the remote-desktop session connection info after IP/hostname changes
[**putVps**](VPSApi.md#putVps) | **PUT** /vps/order | Validate a VPS order configuration and quote the cost — dry run, no charge
[**putVpsWithHttpInfo**](VPSApi.md#putVpsWithHttpInfo) | **PUT** /vps/order | Validate a VPS order configuration and quote the cost — dry run, no charge
...
[**putVpsBuyHdSpaceWithHttpInfo**](VPSApi.md#putVpsBuyHdSpaceWithHttpInfo) | **PUT** /vps/{id}/buy_hd_space | Preview cost to set additional VPS disk to a target GB size — dry run
[**updateVpsInfo**](VPSApi.md#updateVpsInfo) | **POST** /vps/{id} | Update editable settings on a VPS service record
[**updateVpsInfoWithHttpInfo**](VPSApi.md#updateVpsInfoWithHttpInfo) | **POST** /vps/{id} | Update editable settings on a VPS service record
[**vPSCancel**](VPSApi.md#vPSCancel) | **DELETE** /vps/{id} | Cancel a VPS service at the end of the current billing cycle
[**vPSCancelWithHttpInfo**](VPSApi.md#vPSCancelWithHttpInfo) | **DELETE** /vps/{id} | Cancel a VPS service at the end of the current billing cycle
...
> getVpsBackup(getVpsBackupRequest): ApiRequest[QueueResponse]
...
object Example extends App {
    ...
    val request = apiInstance.getVpsBackup(id)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling VPSApi#getVpsBackup")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
...
> getVpsChangeHostname(getVpsChangeHostnameRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.getVpsChangeHostname(id)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling VPSApi#getVpsChangeHostname")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
...
> getVpsChangeRootPassword(getVpsChangeRootPasswordRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.getVpsChangeRootPassword(id)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling VPSApi#getVpsChangeRootPassword")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
...
> getVpsInsertCd(getVpsInsertCdRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.getVpsInsertCd(id)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling VPSApi#getVpsInsertCd")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
...
> getVpsResetPassword(getVpsResetPasswordRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.getVpsResetPassword(id)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling VPSApi#getVpsResetPassword")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
...
> postVpsTrafficUsage(postVpsTrafficUsageRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.postVpsTrafficUsage(id)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling VPSApi#postVpsTrafficUsage")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
...
> putVpsBuyHdSpace(putVpsBuyHdSpaceRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.putVpsBuyHdSpace(id)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling VPSApi#putVpsBuyHdSpace")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
