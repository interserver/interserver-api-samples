...
[**addBillingCreditCardWithHttpInfo**](BillingApi.md#addBillingCreditCardWithHttpInfo) | **POST** /billing/creditcards | Store a credit card on the account — may return a verification flow
...
[**addBillingPrepayWithHttpInfo**](BillingApi.md#addBillingPrepayWithHttpInfo) | **POST** /billing/prepays | Create a prepay deposit and return an invoice id to fund it
...
[**deleteBillingCreditCardWithHttpInfo**](BillingApi.md#deleteBillingCreditCardWithHttpInfo) | **DELETE** /billing/creditcards/{id} | Remove a stored credit card from the account
...
[**deleteBillingInvoiceWithHttpInfo**](BillingApi.md#deleteBillingInvoiceWithHttpInfo) | **DELETE** /billing/invoices/{id} | Cancel a pending unpaid invoice — and its pending service or repeat invoice
...
[**deleteBillingPrepayWithHttpInfo**](BillingApi.md#deleteBillingPrepayWithHttpInfo) | **DELETE** /billing/prepays/{id} | Delete an unfunded prepay or strip its unpaid funding invoices
...
[**getAffiliateBannersWithHttpInfo**](BillingApi.md#getAffiliateBannersWithHttpInfo) | **GET** /affiliate/banners | List affiliate banner image assets with filename and dimensions
...
[**getAffiliateDownloadWithHttpInfo**](BillingApi.md#getAffiliateDownloadWithHttpInfo) | **GET** /affiliate/download | Export the affiliate signup report as CSV, XLS, XLSX, or PDF file download
...
[**getAffiliateRichReportWithHttpInfo**](BillingApi.md#getAffiliateRichReportWithHttpInfo) | **GET** /affiliate/rich_report | Read a combined affiliate performance summary (HTML payload)
...
[**getAffiliateSalesGraphWithHttpInfo**](BillingApi.md#getAffiliateSalesGraphWithHttpInfo) | **GET** /affiliate/sales_graph | Read aggregated affiliate sales time-series (monthly buckets) for chart rendering
...
[**getAffiliateSignupsWithHttpInfo**](BillingApi.md#getAffiliateSignupsWithHttpInfo) | **GET** /affiliate/signups | Read affiliate signup stats and per-customer conversion data
...
[**getAffiliateTrafficGraphWithHttpInfo**](BillingApi.md#getAffiliateTrafficGraphWithHttpInfo) | **GET** /affiliate/traffic_graph | Read aggregated affiliate referral click/visit time-series for chart rendering
...
[**getAffiliateWebTrafficWithHttpInfo**](BillingApi.md#getAffiliateWebTrafficWithHttpInfo) | **GET** /affiliate/web_traffic | List the 20 most recent affiliate referral visits with IP, referrer, timestamp
...
[**getBillingCartWithHttpInfo**](BillingApi.md#getBillingCartWithHttpInfo) | **GET** /billing/cart | Read the current shopping cart contents, totals, and available payment methods
...
[**getBillingCreditCardVerifyWithHttpInfo**](BillingApi.md#getBillingCreditCardVerifyWithHttpInfo) | **GET** /billing/creditcards/{id}/verify | Probe whether a stored card still needs micro-charge verification
...
[**getBillingInvoiceWithHttpInfo**](BillingApi.md#getBillingInvoiceWithHttpInfo) | **GET** /billing/invoices/{id} | Read full invoice detail — line items, totals, paid status, customer info
...
[**getBillingInvoicesWithHttpInfo**](BillingApi.md#getBillingInvoicesWithHttpInfo) | **GET** /billing/invoices | List every invoice on the account with summary totals and paid/unpaid status
...
[**getBillingPrePaysWithHttpInfo**](BillingApi.md#getBillingPrePaysWithHttpInfo) | **GET** /billing/prepays | List prepay deposits on the account — remaining balance and auto-use flags
...
[**initiatePaymentWithHttpInfo**](BillingApi.md#initiatePaymentWithHttpInfo) | **GET** /billing/pay/{method}/{invoices} | Pay invoices through the chosen gateway — returns the next-step action
...
[**patchBillingCreditCardVerifyWithHttpInfo**](BillingApi.md#patchBillingCreditCardVerifyWithHttpInfo) | **PATCH** /billing/creditcards/{id}/verify | Place two micro-charges on the card to start CVV verification (step 1 of 2)
...
[**postBillingCreditCardVerifyWithHttpInfo**](BillingApi.md#postBillingCreditCardVerifyWithHttpInfo) | **POST** /billing/creditcards/{id}/verify | Submit two micro-charge amounts to finalize card verification (step 2 of 2)
...
[**updateAffiliateDockSetupWithHttpInfo**](BillingApi.md#updateAffiliateDockSetupWithHttpInfo) | **POST** /affiliate/dock_setup | Configure the affiliate landing dock title, description, and referrer coupon
...
[**updateAffiliatePaymentSetupWithHttpInfo**](BillingApi.md#updateAffiliatePaymentSetupWithHttpInfo) | **POST** /affiliate/payment_setup | Configure how affiliate commissions get paid out (PayPal or internal prepay)
...
[**updateBillingCreditCardWithHttpInfo**](BillingApi.md#updateBillingCreditCardWithHttpInfo) | **POST** /billing/creditcards/{id} | Refresh stored card expiration and re-trigger MaxMind fraud scoring
...
[**updateBillingPaymentMethodWithHttpInfo**](BillingApi.md#updateBillingPaymentMethodWithHttpInfo) | **POST** /billing/payment_method | Set the account&#39;s default payment method for recurring/auto charges
...
> getAffiliateDownload(getAffiliateDownloadRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val apiInvoker = ApiInvoker()
    val apiInstance = BillingApi("https://my.interserver.net/apiv2")
    val st: String = st_example // String | Filter by status.

    val ex: String = ex_example // String | Export format: csv, xls, xlsx, or pdf. Defaults to csv.

    val year: Int = 56 // Int | Year to filter the report. Defaults to the current year.
    
    val request = apiInstance.getAffiliateDownload(st, ex, year)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling BillingApi#getAffiliateDownload")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
 ...
 **ex** | **String**| Export format: csv, xls, xlsx, or pdf. Defaults to csv. | [optional] [enum: csv, xls, xlsx, pdf]
 **year** | **Int**| Year to filter the report. Defaults to the current year. | [optional]
...
> getAffiliateSignups(getAffiliateSignupsRequest): ApiRequest[GetAffiliateSignups200Response]
...
object Example extends App {
    ...
    val apiInvoker = ApiInvoker()
    val apiInstance = BillingApi("https://my.interserver.net/apiv2")
    val st: String = st_example // String | Filter signups by status. Use `default` to show all or pass a specific status value to narrow results.
    
    val request = apiInstance.getAffiliateSignups(st)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling BillingApi#getAffiliateSignups")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
...
ApiRequest[[**GetAffiliateSignups200Response**](GetAffiliateSignups200Response.md)]
...
> patchBillingCreditCardVerify(patchBillingCreditCardVerifyRequest): ApiRequest[SuccessTextResponse]
...
object Example extends App {
    ...
    val patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest =  // PatchBillingCreditCardVerifyRequest | 
    
    val request = apiInstance.patchBillingCreditCardVerify(id, patchBillingCreditCardVerifyRequest)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling BillingApi#patchBillingCreditCardVerify")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
