...
[**cancelScrubIpWithHttpInfo**](ScrubIpsApi.md#cancelScrubIpWithHttpInfo) | **DELETE** /scrub_ips/{id} | Cancel a Scrub IP service and stop its recurring DDoS billing
...
[**createFilterWithHttpInfo**](ScrubIpsApi.md#createFilterWithHttpInfo) | **POST** /scrub_ips/{id}/create_filter | Apply a predefined scrubbing filter (DNS/HTTP/synproxy) to a port
...
[**createGeoRuleWithHttpInfo**](ScrubIpsApi.md#createGeoRuleWithHttpInfo) | **POST** /scrub_ips/{id}/create_geo_rule | Add a geographic firewall rule (block/allow by country code or ASN)
...
[**createRuleWithHttpInfo**](ScrubIpsApi.md#createRuleWithHttpInfo) | **POST** /scrub_ips/{id}/create_rule | Add an L3/L4 firewall rule (allow/drop by IP, port, and protocol)
...
[**deleteFilterWithHttpInfo**](ScrubIpsApi.md#deleteFilterWithHttpInfo) | **POST** /scrub_ips/{id}/delete_filter | Remove a scrubbing filter by matching filter_type and port
...
[**disableScrubWithHttpInfo**](ScrubIpsApi.md#disableScrubWithHttpInfo) | **GET** /scrub_ips/{id}/disable | Disable DDoS scrubbing and remove the BGP announcement on the IP
...
[**enableScrubWithHttpInfo**](ScrubIpsApi.md#enableScrubWithHttpInfo) | **GET** /scrub_ips/{id}/enable | Enable DDoS scrubbing (BGP announcement) on the service&#39;s protected IP
...
[**getOrderDetailWithHttpInfo**](ScrubIpsApi.md#getOrderDetailWithHttpInfo) | **GET** /scrub_ips/order | Get plans, pricing, and eligible IPs for a new Scrub IP order
[**getScrubIpDetails**](ScrubIpsApi.md#getScrubIpDetails) | **GET** /scrub_ips/{id} | Get full Scrub IP service detail (rules + geo + filters)
[**getScrubIpDetailsWithHttpInfo**](ScrubIpsApi.md#getScrubIpDetailsWithHttpInfo) | **GET** /scrub_ips/{id} | Get full Scrub IP service detail (rules + geo + filters)
...
[**getScrubIpFilterTypesWithHttpInfo**](ScrubIpsApi.md#getScrubIpFilterTypesWithHttpInfo) | **GET** /scrub_ips/filter_types | List enabled traffic filter profiles available for createFilter
...
[**getScrubIpInvoicesWithHttpInfo**](ScrubIpsApi.md#getScrubIpInvoicesWithHttpInfo) | **GET** /scrub_ips/{id}/invoices | List recurring and one-time invoices billed for this Scrub IP service
...
[**getScrubIpLogsWithHttpInfo**](ScrubIpsApi.md#getScrubIpLogsWithHttpInfo) | **GET** /scrub_ips/{id}/logs | Get last 50000 packet/event log entries for the protected IP
...
[**getScrubIpsListWithHttpInfo**](ScrubIpsApi.md#getScrubIpsListWithHttpInfo) | **GET** /scrub_ips | List all Scrub IP DDoS protection services on the authenticated account
...
[**placeScrubOrderWithHttpInfo**](ScrubIpsApi.md#placeScrubOrderWithHttpInfo) | **POST** /scrub_ips/order | Place a new Scrub IP DDoS protection order and generate an invoice
...
[**putScrubIpsWithHttpInfo**](ScrubIpsApi.md#putScrubIpsWithHttpInfo) | **PUT** /scrub_ips/order | Validate a Scrub IP order and return effective pricing without billing
...
[**scrubIpsDeleteGeoRuleWithHttpInfo**](ScrubIpsApi.md#scrubIpsDeleteGeoRuleWithHttpInfo) | **POST** /scrub_ips/{id}/delete_geo_rule | Delete a geo firewall rule by rule_id from getScrubIpDetails
...
[**scrubIpsDeleteRuleWithHttpInfo**](ScrubIpsApi.md#scrubIpsDeleteRuleWithHttpInfo) | **POST** /scrub_ips/{id}/delete_rule | Delete an L3/L4 firewall rule by rule_id from getScrubIpDetails
...
> putScrubIps(putScrubIpsRequest): ApiRequest[PutScrubIps200Response]
...
object Example extends App {
    ...
    val request = apiInstance.putScrubIps(scrubIpPlaceOrder)
    val response = apiInvoker.execute(request)
...
ApiRequest[[**PutScrubIps200Response**](PutScrubIps200Response.md)]
