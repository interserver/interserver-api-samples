...
[**addWebsiteWithHttpInfo**](WebhostingApi.md#addWebsiteWithHttpInfo) | **POST** /websites/order | Place a new webhosting order, create the invoice, and queue provisioning
...
[**getNewWebsiteWithHttpInfo**](WebhostingApi.md#getNewWebsiteWithHttpInfo) | **GET** /websites/order | Read the webhosting order catalog — plans, packages, promo offers, pricing
...
[**getWebsiteBuyIpWithHttpInfo**](WebhostingApi.md#getWebsiteBuyIpWithHttpInfo) | **GET** /websites/{id}/buy_ip | Read website IPs, current reverse DNS, and additional-IP pricing
...
[**getWebsiteInfoWithHttpInfo**](WebhostingApi.md#getWebsiteInfoWithHttpInfo) | **GET** /websites/{id} | Read full configuration and status detail for one webhosting service
...
[**getWebsiteInvoicesWithHttpInfo**](WebhostingApi.md#getWebsiteInvoicesWithHttpInfo) | **GET** /websites/{id}/invoices | List all billing invoices and recurring charges scoped to one website
...
[**getWebsiteListWithHttpInfo**](WebhostingApi.md#getWebsiteListWithHttpInfo) | **GET** /websites | List the caller&#39;s webhosting (cPanel/DirectAdmin/Plesk/Webuzo) services
...
[**getWebsitesBackupsWithHttpInfo**](WebhostingApi.md#getWebsitesBackupsWithHttpInfo) | **GET** /websites/{id}/backups | List off-site cpmove backups stored in Swift — list or inline-download archive
...
[**getWebsitesLoginWithHttpInfo**](WebhostingApi.md#getWebsitesLoginWithHttpInfo) | **GET** /websites/{id}/login | Get a one-time auto-login URL for the website&#39;s control panel
...
[**getWebsitesWelcomeEmailWithHttpInfo**](WebhostingApi.md#getWebsitesWelcomeEmailWithHttpInfo) | **GET** /websites/{id}/welcome_email | Resend the webhosting welcome email with control-panel credentials and URL
...
[**gettWebsiteReverseDnsWithHttpInfo**](WebhostingApi.md#gettWebsiteReverseDnsWithHttpInfo) | **GET** /websites/{id}/reverse_dns | Read current reverse-DNS (PTR) records for the website&#39;s IPs
...
[**postWebsiteBuyIpWithHttpInfo**](WebhostingApi.md#postWebsiteBuyIpWithHttpInfo) | **POST** /websites/{id}/buy_ip | Buy an additional IP for the website OR update reverse DNS records
...
[**postWebsiteMigrationWithHttpInfo**](WebhostingApi.md#postWebsiteMigrationWithHttpInfo) | **POST** /websites/{id}/migration | Submit a request for InterServer staff to migrate a website from another host
...
[**postWebsitesReverseDnsWithHttpInfo**](WebhostingApi.md#postWebsitesReverseDnsWithHttpInfo) | **POST** /websites/{id}/reverse_dns | Bulk-update reverse-DNS (PTR) records for one or more website IPs
...
[**putWebsitesWithHttpInfo**](WebhostingApi.md#putWebsitesWithHttpInfo) | **PUT** /websites/order | Validate a webhosting order and preview cost — dry run, no charge
...
[**updateWebsiteInfoWithHttpInfo**](WebhostingApi.md#updateWebsiteInfoWithHttpInfo) | **POST** /websites/{id} | POST mutation hook for the website detail page (use dedicated ops where possible)
...
[**webhostingCancelWithHttpInfo**](WebhostingApi.md#webhostingCancelWithHttpInfo) | **DELETE** /websites/{id} | Schedule termination of a webhosting service — wipes panel account at cycle end



## addWebsite

> addWebsite(addWebsiteRequest): ApiRequest[ServiceOrderPostResponse]
...
object Example extends App {
    ...
    val request = apiInstance.addWebsite(websiteOrderPostRequest)
...
> putWebsites(putWebsitesRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.putWebsites(websiteOrderPutRequest)
    val response = apiInvoker.execute(request)
