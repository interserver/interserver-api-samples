...
[**addServerWithHttpInfo**](ServersApi.md#addServerWithHttpInfo) | **POST** /servers/order | Place a custom dedicated server order, creating a real billable invoice
...
[**buyItNowServerOrderWithHttpInfo**](ServersApi.md#buyItNowServerOrderWithHttpInfo) | **GET** /servers/order/buy_now_server | Get configurable options for a Rapid Deploy / coupon dedicated server
...
[**getMPServersWithHttpInfo**](ServersApi.md#getMPServersWithHttpInfo) | **GET** /buy_now_servers_list | List Rapid Deploy (Buy-It-Now) marketplace dedicated servers with live pricing
...
[**getNewServerWithHttpInfo**](ServersApi.md#getNewServerWithHttpInfo) | **GET** /servers/order | Get custom dedicated server ordering options, regions, and pricing
...
[**getServerInfoWithHttpInfo**](ServersApi.md#getServerInfoWithHttpInfo) | **GET** /servers/{id} | Get full hardware, network, and lifecycle details for a dedicated server
...
[**getServerInvoicesWithHttpInfo**](ServersApi.md#getServerInvoicesWithHttpInfo) | **GET** /servers/{id}/invoices | List billing invoices (charges + payments) tied to one dedicated server
[**getServerList**](ServersApi.md#getServerList) | **GET** /servers | List all dedicated servers owned by the authenticated customer
[**getServerListWithHttpInfo**](ServersApi.md#getServerListWithHttpInfo) | **GET** /servers | List all dedicated servers owned by the authenticated customer
...
[**getServerReverseDnsWithHttpInfo**](ServersApi.md#getServerReverseDnsWithHttpInfo) | **GET** /servers/{id}/reverse_dns | List current reverse-DNS (PTR) records for a dedicated server&#39;s IPs
...
[**getServersWelcomeEmailWithHttpInfo**](ServersApi.md#getServersWelcomeEmailWithHttpInfo) | **GET** /servers/{id}/welcome_email | Resend the dedicated server welcome email with setup credentials
...
[**placeBuyNowServerWithHttpInfo**](ServersApi.md#placeBuyNowServerWithHttpInfo) | **POST** /servers/order/buy_now_server | Place a Rapid Deploy / coupon dedicated server order; creates real invoice
...
[**postServerReverseDnsWithHttpInfo**](ServersApi.md#postServerReverseDnsWithHttpInfo) | **POST** /servers/{id}/reverse_dns | Update reverse-DNS (PTR) hostnames on a dedicated server&#39;s IPs
...
[**serverBulkIpmiPowerGetWithHttpInfo**](ServersApi.md#serverBulkIpmiPowerGetWithHttpInfo) | **GET** /servers/bulk/ipmi_power | Read IPMI chassis power status for many dedicated servers in one call
...
[**serverIpmiLiveGetWithHttpInfo**](ServersApi.md#serverIpmiLiveGetWithHttpInfo) | **GET** /servers/{id}/ipmi_live | Read current IPMI Live whitelist + KVM gateway URL for a dedicated server
...
[**serverIpmiLivePostWithHttpInfo**](ServersApi.md#serverIpmiLivePostWithHttpInfo) | **POST** /servers/{id}/ipmi_live | Whitelist an IP for IPMI Live KVM gateway access (3-hour lease)
...
[**serverIpmiPowerGetWithHttpInfo**](ServersApi.md#serverIpmiPowerGetWithHttpInfo) | **GET** /servers/{id}/ipmi_power | Read IPMI chassis power status for a dedicated server (single)
...
[**serverIpmiPowerPostWithHttpInfo**](ServersApi.md#serverIpmiPowerPostWithHttpInfo) | **POST** /servers/{id}/ipmi_power | DESTRUCTIVE — change chassis power state on a bare-metal server
...
[**serversCancelWithHttpInfo**](ServersApi.md#serversCancelWithHttpInfo) | **DELETE** /servers/{id} | Cancel a dedicated server service at the end of the current billing cycle
...
[**updateServerInfoWithHttpInfo**](ServersApi.md#updateServerInfoWithHttpInfo) | **POST** /servers/{id} | Update settings on a dedicated server order (shares handler with view)



## addServer

> addServer(addServerRequest): ApiRequest[AddServer200Response]
...
object Example extends App {
    ...
    val request = apiInstance.addServer(serverOrderPostRequest)
...
> serverBulkIpmiPowerGet(serverBulkIpmiPowerGetRequest): ApiRequest[ServerBulkIpmiPowerResponse]
...
object Example extends App {
    ...
    val apiInvoker = ApiInvoker()
    val apiInstance = ServersApi("https://my.interserver.net/apiv2")
    val ids: String = 2313,2314,2315 // String | Comma-separated list of Server IDs to query (e.g. `2313,2314,2315`). May also be passed as repeated `ids[]` query parameters.
    
    val request = apiInstance.serverBulkIpmiPowerGet(ids)
    val response = apiInvoker.execute(request)
    ...
    response.onComplete {
        ...
        case Failure(error @ ApiError(code, message, responseContent, cause, headers)) =>
            System.err.println("Exception when calling ServersApi#serverBulkIpmiPowerGet")
            System.err.println(s"Status code: $code}")
            System.err.println(s"Reason: $responseContent")
            System.err.println(s"Response headers: ${headers.mkString(", ")}")
            error.printStackTrace();
...
ApiRequest[[**ServerBulkIpmiPowerResponse**](ServerBulkIpmiPowerResponse.md)]
