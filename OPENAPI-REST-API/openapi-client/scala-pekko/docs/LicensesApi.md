...
[**addLicenseWithHttpInfo**](LicensesApi.md#addLicenseWithHttpInfo) | **POST** /licenses/order | Order a new software license and create the recurring invoice
...
[**getLicenseInfoWithHttpInfo**](LicensesApi.md#getLicenseInfoWithHttpInfo) | **GET** /licenses/{id} | Get full details for one license including status, IP, and links
...
[**getLicenseInvoicesWithHttpInfo**](LicensesApi.md#getLicenseInvoicesWithHttpInfo) | **GET** /licenses/{id}/invoices | List all billing invoices tied to one software license service
[**getLicenseList**](LicensesApi.md#getLicenseList) | **GET** /licenses | List all software licenses owned by the authenticated customer
[**getLicenseListWithHttpInfo**](LicensesApi.md#getLicenseListWithHttpInfo) | **GET** /licenses | List all software licenses owned by the authenticated customer
...
[**getLicensesWelcomeEmailWithHttpInfo**](LicensesApi.md#getLicensesWelcomeEmailWithHttpInfo) | **GET** /licenses/{id}/welcome_email | Resend the license welcome email with the key and activation steps
...
[**getNewLicenseWithHttpInfo**](LicensesApi.md#getNewLicenseWithHttpInfo) | **GET** /licenses/order | Get available license types, packages, and pricing for ordering
...
[**licensesCancelWithHttpInfo**](LicensesApi.md#licensesCancelWithHttpInfo) | **DELETE** /licenses/{id} | Cancel a license service and stop future billing (irreversible)
...
[**postLicenseChangeIpWithHttpInfo**](LicensesApi.md#postLicenseChangeIpWithHttpInfo) | **POST** /licenses/{id}/change_ip | Rebind a license to a new IP address (may incur a vendor fee)
...
[**putLicensesWithHttpInfo**](LicensesApi.md#putLicensesWithHttpInfo) | **PUT** /licenses/order | Validate a software license order before placing it (dry run preview)
...
[**updateLicenseInfoWithHttpInfo**](LicensesApi.md#updateLicenseInfoWithHttpInfo) | **POST** /licenses/{id} | Update mutable fields on a license service (e.g. assigned IP)



## addLicense

> addLicense(addLicenseRequest): ApiRequest[ServiceOrderPostResponse]
...
object Example extends App {
    ...
    val request = apiInstance.addLicense(licenseOrderRequest)
...
> putLicenses(putLicensesRequest): ApiRequest[Unit]
...
object Example extends App {
    ...
    val request = apiInstance.putLicenses(licenseOrderRequest)
    val response = apiInvoker.execute(request)
