...
[**addBackupWithHttpInfo**](BackupsApi.md#addBackupWithHttpInfo) | **POST** /backups/order | Place a new off-site backup storage order and generate the invoice
[**cancelBackup**](BackupsApi.md#cancelBackup) | **DELETE** /backups/{id} | Cancel an off-site backup storage subscription
[**cancelBackupWithHttpInfo**](BackupsApi.md#cancelBackupWithHttpInfo) | **DELETE** /backups/{id} | Cancel an off-site backup storage subscription
[**getBackupInfo**](BackupsApi.md#getBackupInfo) | **GET** /backups/{id} | Get details of a specific off-site backup storage service
[**getBackupInfoWithHttpInfo**](BackupsApi.md#getBackupInfoWithHttpInfo) | **GET** /backups/{id} | Get details of a specific off-site backup storage service
...
[**getBackupInvoicesWithHttpInfo**](BackupsApi.md#getBackupInvoicesWithHttpInfo) | **GET** /backups/{id}/invoices | List invoices for a single backup-storage subscription
...
[**getBackupLoginWithHttpInfo**](BackupsApi.md#getBackupLoginWithHttpInfo) | **GET** /backups/{id}/login | Open a single sign-on session URL for the backup storage panel
...
[**getBackupsListWithHttpInfo**](BackupsApi.md#getBackupsListWithHttpInfo) | **GET** /backups | List off-site backup storage subscriptions on the authenticated account
...
[**getBackupsWelcomeEmailWithHttpInfo**](BackupsApi.md#getBackupsWelcomeEmailWithHttpInfo) | **GET** /backups/{id}/welcome_email | Resend the welcome email for an off-site backup storage service
[**getNewBackup**](BackupsApi.md#getNewBackup) | **GET** /backups/order | Get backup-storage order form metadata and pricing tiers
[**getNewBackupWithHttpInfo**](BackupsApi.md#getNewBackupWithHttpInfo) | **GET** /backups/order | Get backup-storage order form metadata and pricing tiers
[**updateBackupInfo**](BackupsApi.md#updateBackupInfo) | **POST** /backups/{id} | Update stored metadata for a backup-storage subscription
[**updateBackupInfoWithHttpInfo**](BackupsApi.md#updateBackupInfoWithHttpInfo) | **POST** /backups/{id} | Update stored metadata for a backup-storage subscription
...
[**validateBackupOrderWithHttpInfo**](BackupsApi.md#validateBackupOrderWithHttpInfo) | **PUT** /backups/order | Validate a backup-storage order and preview pricing without charging
