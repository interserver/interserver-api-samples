...
class ScrubIpsApi(baseUrl: String) {
   ...
   * @param scrubIpPlaceOrder 
   */
  def putScrubIps(scrubIpPlaceOrder: ScrubIpPlaceOrder)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[PutScrubIps200Response] =
    ApiRequest[PutScrubIps200Response](ApiMethods.PUT, baseUrl, "/scrub_ips/order", "application/json")
      .withApiKey(apiKey, "sessionid", COOKIE)
      .withApiKey(apiKey, "X-API-KEY", HEADER)
      .withApiKey(apiKey, "sessionid", HEADER)
      .withBody(scrubIpPlaceOrder)
      .withSuccessResponse[PutScrubIps200Response](200)
      .withErrorResponse[GetAccountInfo401Response](401)
