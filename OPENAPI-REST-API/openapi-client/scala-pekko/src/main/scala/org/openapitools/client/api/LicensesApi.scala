...
class LicensesApi(baseUrl: String) {
   ...
   */
  def addLicense(licenseOrderRequest: LicenseOrderRequest)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[ServiceOrderPostResponse] =
   ...
   * @param licenseOrderRequest 
   */
  def putLicenses(licenseOrderRequest: LicenseOrderRequest)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Unit] =
