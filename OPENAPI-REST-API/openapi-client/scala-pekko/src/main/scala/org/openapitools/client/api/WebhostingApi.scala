...
class WebhostingApi(baseUrl: String) {
   ...
   */
  def addWebsite(websiteOrderPostRequest: WebsiteOrderPostRequest)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[ServiceOrderPostResponse] =
    ApiRequest[ServiceOrderPostResponse](ApiMethods.POST, baseUrl, "/websites/order", "application/json")
      ...
      .withBody(websiteOrderPostRequest)
   ...
   */
  def putWebsites(websiteOrderPutRequest: WebsiteOrderPutRequest)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.PUT, baseUrl, "/websites/order", "application/json")
      .withApiKey(apiKey, "sessionid", COOKIE)
      .withApiKey(apiKey, "X-API-KEY", HEADER)
      .withApiKey(apiKey, "sessionid", HEADER)
      .withBody(websiteOrderPutRequest)
