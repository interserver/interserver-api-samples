...
class DomainsApi(baseUrl: String) {
   ...
   */
  def addDomain(domainOrderRequest: DomainOrderRequest)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[ServiceOrderPostResponse] =
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def deleteDomainDnssec(id: Int)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[SuccessTextResponse] =
   ...
   * @param domainOrderRequest 
   */
  def patchDomains(domainOrderRequest: DomainOrderRequest)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Unit] =
   ...
   * @param name The base domain name to search (for example `example` or `example.com`).
   */
  def postDomainSearch(name: String)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Unit] =
    ApiRequest[Unit](ApiMethods.POST, baseUrl, "/domains/search/{name}", "application/json")
      .withApiKey(apiKey, "sessionid", COOKIE)
      .withApiKey(apiKey, "X-API-KEY", HEADER)
      .withApiKey(apiKey, "sessionid", HEADER)
      .withPathParam("name", name)
   ...
   * @param domainOrderRequest 
   */
  def putDomains(domainOrderRequest: DomainOrderRequest)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Unit] =
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def updateDomainInfo(id: Int)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[SuccessTextResponse] =
