...
class PublicApi(baseUrl: String) {
   ...
   */
  def getAccountCurrencies()(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[String]] =
    ApiRequest[Seq[String]](ApiMethods.GET, baseUrl, "/account/currencies", "application/json")
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getAccountLocales()(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Map[String, GetAccountLocales200ResponseValue]] =
    ApiRequest[Map[String, GetAccountLocales200ResponseValue]](ApiMethods.GET, baseUrl, "/account/locales", "application/json")
      .withApiKey(apiKey, "sessionid", COOKIE)
      .withApiKey(apiKey, "X-API-KEY", HEADER)
      .withApiKey(apiKey, "sessionid", HEADER)
      .withSuccessResponse[Map[String, GetAccountLocales200ResponseValue]](200)
      .withErrorResponse[GetAccountInfo401Response](401)
