...
class ServersApi(baseUrl: String) {
   ...
   */
  def addServer(serverOrderPostRequest: ServerOrderPostRequest)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[AddServer200Response] =
    ApiRequest[AddServer200Response](ApiMethods.POST, baseUrl, "/servers/order", "application/json")
      ...
      .withBody(serverOrderPostRequest)
   ...
   */
  def serverBulkIpmiPowerGet(ids: String)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[ServerBulkIpmiPowerResponse] =
    ApiRequest[ServerBulkIpmiPowerResponse](ApiMethods.GET, baseUrl, "/servers/bulk/ipmi_power", "application/json")
      .withApiKey(apiKey, "sessionid", COOKIE)
      .withApiKey(apiKey, "X-API-KEY", HEADER)
      .withApiKey(apiKey, "sessionid", HEADER)
      .withQueryParam("ids", ids)
      .withSuccessResponse[ServerBulkIpmiPowerResponse](200)
