...
void OpenAPIServerBulkIpmiPowerResponseResultsInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIServerBulkIpmiPowerResponseResultsInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
