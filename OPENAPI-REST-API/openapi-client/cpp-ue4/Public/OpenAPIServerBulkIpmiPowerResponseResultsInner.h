...
/*
 * OpenAPIServerBulkIpmiPowerResponseResultsInner
 *
 * 
 */
class OPENAPI_API OpenAPIServerBulkIpmiPowerResponseResultsInner : public Model
{
public:
    virtual ~OpenAPIServerBulkIpmiPowerResponseResultsInner() {}
