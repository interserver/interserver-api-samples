...
public:
	...
	OpenAPIDomainOrderRequest OpenAPIDomainOrderRequest;
};
...
*/
class OPENAPI_API OpenAPIDomainsApi::PostDomainSearchRequest : public Request
{
public:
    virtual ~PostDomainSearchRequest() {}
	void SetupHttpRequest(const FHttpRequestRef& HttpRequest) const final;
	FString ComputePath() const final;
...
class OPENAPI_API OpenAPIDomainsApi::PostDomainSearchResponse : public Response
{
public:
    virtual ~PostDomainSearchResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
