...
#include "OpenAPIServerBulkIpmiPowerResponse.h"
...
public:
	...
	OpenAPIServerOrderPostRequest OpenAPIServerOrderPostRequest;
};
...
*/
class OPENAPI_API OpenAPIServersApi::ServerBulkIpmiPowerGetRequest : public Request
{
public:
    virtual ~ServerBulkIpmiPowerGetRequest() {}
	void SetupHttpRequest(const FHttpRequestRef& HttpRequest) const final;
	FString ComputePath() const final;
...
class OPENAPI_API OpenAPIServersApi::ServerBulkIpmiPowerGetResponse : public Response
{
public:
    virtual ~ServerBulkIpmiPowerGetResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;

    OpenAPIServerBulkIpmiPowerResponse Content;
};
