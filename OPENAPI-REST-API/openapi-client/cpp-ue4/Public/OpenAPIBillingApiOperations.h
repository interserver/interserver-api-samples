...
#include "OpenAPIGetAffiliateSignups200Response.h"
#include "OpenAPIInitiatePayment200Response.h"
#include "OpenAPIMonthlyCounts.h"
#include "OpenAPIPatchBillingCreditCardVerifyRequest.h"
...
*/
class OPENAPI_API OpenAPIBillingApi::GetAffiliateDownloadRequest : public Request
{
public:
    virtual ~GetAffiliateDownloadRequest() {}
	void SetupHttpRequest(const FHttpRequestRef& HttpRequest) const final;
	FString ComputePath() const final;

	/* Filter by status. */
	TOptional<FString> St;
	enum class ExEnum
	{
		Csv,
		Xls,
	...
	static bool EnumFromString(const FString& EnumAsString, ExEnum& EnumValue);
...
class OPENAPI_API OpenAPIBillingApi::GetAffiliateDownloadResponse : public Response
{
public:
    virtual ~GetAffiliateDownloadResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
...
*/
class OPENAPI_API OpenAPIBillingApi::GetAffiliateSignupsRequest : public Request
{
public:
    virtual ~GetAffiliateSignupsRequest() {}
	void SetupHttpRequest(const FHttpRequestRef& HttpRequest) const final;
	FString ComputePath() const final;
...
class OPENAPI_API OpenAPIBillingApi::GetAffiliateSignupsResponse : public Response
{
public:
    virtual ~GetAffiliateSignupsResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;

    OpenAPIGetAffiliateSignups200Response Content;
};
...
*/
class OPENAPI_API OpenAPIBillingApi::PatchBillingCreditCardVerifyRequest : public Request
{
public:
    virtual ~PatchBillingCreditCardVerifyRequest() {}
	void SetupHttpRequest(const FHttpRequestRef& HttpRequest) const final;
	FString ComputePath() const final;

	/* The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`. */
	int32 Id = 0;
	OpenAPIPatchBillingCreditCardVerifyRequest OpenAPIPatchBillingCreditCardVerifyRequest;
};

class OPENAPI_API OpenAPIBillingApi::PatchBillingCreditCardVerifyResponse : public Response
{
public:
    virtual ~PatchBillingCreditCardVerifyResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
