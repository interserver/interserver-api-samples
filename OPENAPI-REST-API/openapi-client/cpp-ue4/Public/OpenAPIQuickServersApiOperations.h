...
public:
	...
	OpenAPIQsOrderRequest OpenAPIQsOrderRequest;
};
...
*/
class OPENAPI_API OpenAPIQuickServersApi::GetQsBackupRequest : public Request
{
public:
    virtual ~GetQsBackupRequest() {}
	void SetupHttpRequest(const FHttpRequestRef& HttpRequest) const final;
	FString ComputePath() const final;
...
class OPENAPI_API OpenAPIQuickServersApi::GetQsBackupResponse : public Response
{
public:
    virtual ~GetQsBackupResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
