 ...
 */
class OPENAPI_API OpenAPIDomainOrderRequest : public Model
{
public:
    virtual ~OpenAPIDomainOrderRequest() {}
	...
	static bool EnumFromString(const FString& EnumAsString, WhoisPrivacyEnum& EnumValue);
	/* Set to \"enable\" to add Whois privacy (addDomain only). */
	TOptional<WhoisPrivacyEnum> WhoisPrivacy;
};
