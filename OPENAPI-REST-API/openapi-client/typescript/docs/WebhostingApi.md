...
import type { WebhostingApiAddWebsiteRequest } from '';

const configuration = createConfiguration();
const apiInstance = new WebhostingApi(configuration);

const request: WebhostingApiAddWebsiteRequest = {
...
# **putWebsites**
> void putWebsites(websiteOrderPutRequest)
...
```typescript
import { createConfiguration, WebhostingApi } from '';
import type { WebhostingApiPutWebsitesRequest } from '';

const configuration = createConfiguration();
const apiInstance = new WebhostingApi(configuration);

const request: WebhostingApiPutWebsitesRequest = {
