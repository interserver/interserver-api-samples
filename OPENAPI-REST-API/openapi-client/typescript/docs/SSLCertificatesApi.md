...
import type { SSLCertificatesApiAddSslRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SSLCertificatesApi(configuration);

const request: SSLCertificatesApiAddSslRequest = {
  
  sslOrderRequest: {
    ssl: 1,
    hostname: "hostname_example",
    approver_email: "approver_email_example",
    frequency: 12,
    coupon: "",
    csr_type: "generated",
    csr: "",
    ...
    business_category: "business_category_example",
  },
};
...
```typescript
import { createConfiguration, SSLCertificatesApi } from '';
import type { SSLCertificatesApiPutSslRequest } from '';

const configuration = createConfiguration();
const apiInstance = new SSLCertificatesApi(configuration);

const request: SSLCertificatesApiPutSslRequest = {
