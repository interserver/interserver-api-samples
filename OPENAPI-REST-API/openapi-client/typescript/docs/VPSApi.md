...
```typescript
import { createConfiguration, VPSApi } from '';
import type { VPSApiGetVpsBackupRequest } from '';

const configuration = createConfiguration();
const apiInstance = new VPSApi(configuration);

const request: VPSApiGetVpsBackupRequest = {
    // VPS ID number
  id: 1,
};

const data = await apiInstance.getVpsBackup(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, VPSApi } from '';
import type { VPSApiGetVpsChangeHostnameRequest } from '';

const configuration = createConfiguration();
const apiInstance = new VPSApi(configuration);

const request: VPSApiGetVpsChangeHostnameRequest = {
    // VPS ID number
  id: 1,
};

const data = await apiInstance.getVpsChangeHostname(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, VPSApi } from '';
import type { VPSApiGetVpsChangeRootPasswordRequest } from '';

const configuration = createConfiguration();
const apiInstance = new VPSApi(configuration);

const request: VPSApiGetVpsChangeRootPasswordRequest = {
    // VPS ID number
  id: 1,
};

const data = await apiInstance.getVpsChangeRootPassword(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, VPSApi } from '';
import type { VPSApiGetVpsInsertCdRequest } from '';

const configuration = createConfiguration();
const apiInstance = new VPSApi(configuration);

const request: VPSApiGetVpsInsertCdRequest = {
    // VPS ID number
  id: 1,
};

const data = await apiInstance.getVpsInsertCd(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, VPSApi } from '';
import type { VPSApiGetVpsResetPasswordRequest } from '';

const configuration = createConfiguration();
const apiInstance = new VPSApi(configuration);

const request: VPSApiGetVpsResetPasswordRequest = {
    // VPS ID number
  id: 1,
};

const data = await apiInstance.getVpsResetPassword(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, VPSApi } from '';
import type { VPSApiPostVpsTrafficUsageRequest } from '';

const configuration = createConfiguration();
const apiInstance = new VPSApi(configuration);

const request: VPSApiPostVpsTrafficUsageRequest = {
    // VPS ID number
  id: 1,
};

const data = await apiInstance.postVpsTrafficUsage(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, VPSApi } from '';
import type { VPSApiPutVpsBuyHdSpaceRequest } from '';

const configuration = createConfiguration();
const apiInstance = new VPSApi(configuration);

const request: VPSApiPutVpsBuyHdSpaceRequest = {
    // VPS ID number
  id: 1,
};

const data = await apiInstance.putVpsBuyHdSpace(request);
console.log('API called successfully. Returned data:', data);
```
