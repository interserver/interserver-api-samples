...
import type { DomainsApiAddDomainRequest } from '';

const configuration = createConfiguration();
const apiInstance = new DomainsApi(configuration);

const request: DomainsApiAddDomainRequest = {
...
# **patchDomains**
> void patchDomains(domainOrderRequest)
...
```typescript
import { createConfiguration, DomainsApi } from '';
import type { DomainsApiPatchDomainsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new DomainsApi(configuration);

const request: DomainsApiPatchDomainsRequest = {
...
```typescript
import { createConfiguration, DomainsApi } from '';
import type { DomainsApiPostDomainSearchRequest } from '';

const configuration = createConfiguration();
const apiInstance = new DomainsApi(configuration);

const request: DomainsApiPostDomainSearchRequest = {
    // The base domain name to search (for example `example` or `example.com`).
  name: "name_example",
};

const data = await apiInstance.postDomainSearch(request);
console.log('API called successfully. Returned data:', data);
```
...
# **putDomains**
> void putDomains(domainOrderRequest)
...
```typescript
import { createConfiguration, DomainsApi } from '';
import type { DomainsApiPutDomainsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new DomainsApi(configuration);

const request: DomainsApiPutDomainsRequest = {
