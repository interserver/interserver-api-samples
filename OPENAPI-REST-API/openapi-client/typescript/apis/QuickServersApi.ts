...
export class QuickServersApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async addQs(qsOrderRequest: QsOrderRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'qsOrderRequest' is not null or undefined
        if (qsOrderRequest === null || qsOrderRequest === undefined) {
            throw new RequiredError("QuickServersApi", "addQs", "qsOrderRequest");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(qsOrderRequest, "QsOrderRequest", ""),
            contentType
        );
     ...
     * @param id QuickServer ID number
     */
    public async getQsBackup(id: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("QuickServersApi", "getQsBackup", "id");
        }
     ...
     * @param qsOrderRequest 
     */
    public async putQs(qsOrderRequest: QsOrderRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'qsOrderRequest' is not null or undefined
        if (qsOrderRequest === null || qsOrderRequest === undefined) {
            throw new RequiredError("QuickServersApi", "putQs", "qsOrderRequest");
        }
...
export class QuickServersApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getQsBackup
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getQsBackupWithHttpInfo(response: ResponseContext): Promise<HttpInfo<QueueResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: QueueResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
