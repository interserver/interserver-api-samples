...
export class WebhostingApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async addWebsite(websiteOrderPostRequest: WebsiteOrderPostRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (websiteOrderPostRequest === null || websiteOrderPostRequest === undefined) {
            throw new RequiredError("WebhostingApi", "addWebsite", "websiteOrderPostRequest");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(websiteOrderPostRequest, "WebsiteOrderPostRequest", ""),
            contentType
        );
     ...
     */
    public async putWebsites(websiteOrderPutRequest: WebsiteOrderPutRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (websiteOrderPutRequest === null || websiteOrderPutRequest === undefined) {
            throw new RequiredError("WebhostingApi", "putWebsites", "websiteOrderPutRequest");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(websiteOrderPutRequest, "WebsiteOrderPutRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
