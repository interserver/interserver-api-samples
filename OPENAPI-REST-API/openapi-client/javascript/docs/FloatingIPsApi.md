...
let apiInstance = new InterserverApiClient.FloatingIPsApi();
let FloatingIpOrderRequest = new InterserverApiClient.FloatingIpOrderRequest(); // FloatingIpOrderRequest | 
apiInstance.addFloatingIp(FloatingIpOrderRequest).then((data) => {
...
apiInstance.floatingIpsCancel(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.FloatingIPsApi();
let id = 56; // Number | The Floating IP service ID. Use the ID from `GET /floating_ips`.
apiInstance.getFloatingIpInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.FloatingIPsApi();
let id = 56; // Number | The Floating IP service ID. Use the ID from `GET /floating_ips`.
apiInstance.getFloatingIpInvoices(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.FloatingIPsApi();
apiInstance.getFloatingIpsList().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.FloatingIPsApi();
let id = 56; // Number | The Floating IP service ID. Use the ID from `GET /floating_ips`.
apiInstance.getFloatingIpsWelcomeEmail(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.FloatingIPsApi();
apiInstance.getNewFloatingIp().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.postFloatingIpsChangeIp(id, ip).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.FloatingIPsApi();
let FloatingIpOrderRequest = new InterserverApiClient.FloatingIpOrderRequest(); // FloatingIpOrderRequest | 
apiInstance.putFloatingIps(FloatingIpOrderRequest).then(() => {
...
apiInstance.updateFloatingIpInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
