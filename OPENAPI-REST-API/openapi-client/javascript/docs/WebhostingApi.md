...
let apiInstance = new InterserverApiClient.WebhostingApi();
let WebsiteOrderPostRequest = new InterserverApiClient.WebsiteOrderPostRequest(); // WebsiteOrderPostRequest | 
apiInstance.addWebsite(WebsiteOrderPostRequest).then((data) => {
...
let apiInstance = new InterserverApiClient.WebhostingApi();
apiInstance.getNewWebsite().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getWebsiteBuyIp(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
let id = 56; // Number | The website service ID. Use `website_id` from `GET /websites`.
apiInstance.getWebsiteInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
let id = 56; // Number | The website service ID. Use `website_id` from `GET /websites`.
apiInstance.getWebsiteInvoices(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
apiInstance.getWebsiteList().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
let id = 56; // Number | The website service ID. Use `website_id` from `GET /websites`.
apiInstance.getWebsitesBackups(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
let id = 56; // Number | The website service ID. Use `website_id` from `GET /websites`.
apiInstance.getWebsitesLogin(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
let id = 56; // Number | The website service ID. Use `website_id` from `GET /websites`.
apiInstance.getWebsitesWelcomeEmail(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
let id = 56; // Number | The website service ID. Use `website_id` from `GET /websites`.
apiInstance.gettWebsiteReverseDns(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
let id = 56; // Number | The website service ID. Use `website_id` from `GET /websites`.
let PostWebsiteBuyIpRequest = new InterserverApiClient.PostWebsiteBuyIpRequest(); // PostWebsiteBuyIpRequest | 
apiInstance.postWebsiteBuyIp(id, PostWebsiteBuyIpRequest).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
let id = 56; // Number | The website service ID. Use `website_id` from `GET /websites`.
let PostWebsiteMigrationRequest = new InterserverApiClient.PostWebsiteMigrationRequest(); // PostWebsiteMigrationRequest | 
apiInstance.postWebsiteMigration(id, PostWebsiteMigrationRequest).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.postWebsitesReverseDns(id, ReverseDnsEntries).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.WebhostingApi();
let WebsiteOrderPutRequest = new InterserverApiClient.WebsiteOrderPutRequest(); // WebsiteOrderPutRequest | 
apiInstance.putWebsites(WebsiteOrderPutRequest).then(() => {
...
apiInstance.updateWebsiteInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.webhostingCancel(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
