...
let apiInstance = new InterserverApiClient.PublicApi();
apiInstance.getAccountCurrencies().then((data) => {
...
> {String: GetAccountLocales200ResponseValue} getAccountLocales()
...
let apiInstance = new InterserverApiClient.PublicApi();
apiInstance.getAccountLocales().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.PublicApi();
apiInstance.getCaptcha().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getCountries(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.PublicApi();
apiInstance.getLoginInfo().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getOauthRedirect(provider).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.PublicApi();
apiInstance.getTimezones().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.PublicApi();
let PatchOauthTwoFactorRequest = new InterserverApiClient.PatchOauthTwoFactorRequest(); // PatchOauthTwoFactorRequest | 
apiInstance.patchOauthTwoFactor(PatchOauthTwoFactorRequest).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.PublicApi();
apiInstance.pingServer().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let provider = "provider_example"; // String | The OAuth provider name (e.g. `Google`).
let opts = {
  'PostOauthCallbackRequest': new InterserverApiClient.PostOauthCallbackRequest() // PostOauthCallbackRequest | 
};
apiInstance.postOauthCallback(provider, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let opts = {
  ...
  'g_recaptcha_response': new InterserverApiClient.LoginSubmissionExampleGRecaptchaResponse(), // LoginSubmissionExampleGRecaptchaResponse | 
  'tfa': "tfa_example" // String | Two Factor Authentication Response.
};
apiInstance.submitLogin(login, passwd, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.submitSignup(opts).then(() => {
