...
let apiInstance = new InterserverApiClient.ServersApi();
let ServerOrderPostRequest = new InterserverApiClient.ServerOrderPostRequest(); // ServerOrderPostRequest | 
apiInstance.addServer(ServerOrderPostRequest).then((data) => {
...
let apiInstance = new InterserverApiClient.ServersApi();
apiInstance.buyItNowServerOrder().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
apiInstance.getMPServers().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
apiInstance.getNewServer().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getServerInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
let id = 56; // Number | Server ID number
apiInstance.getServerInvoices(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
apiInstance.getServerList().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
let id = 56; // Number | Server ID number
apiInstance.getServerReverseDns(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
let id = 56; // Number | Server ID number
apiInstance.getServersWelcomeEmail(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
let opts = {
  'PlaceBuyNowServerRequest': new InterserverApiClient.PlaceBuyNowServerRequest() // PlaceBuyNowServerRequest | 
};
apiInstance.placeBuyNowServer(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.postServerReverseDns(id, ReverseDnsEntries).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
let ids = "2313,2314,2315"; // String | Comma-separated list of Server IDs to query (e.g. `2313,2314,2315`). May also be passed as repeated `ids[]` query parameters.
apiInstance.serverBulkIpmiPowerGet(ids).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
let id = 56; // Number | Server ID number
apiInstance.serverIpmiLiveGet(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.serverIpmiLivePost(id, ip, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
let id = 56; // Number | Server ID number
apiInstance.serverIpmiPowerGet(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.serverIpmiPowerPost(id, action, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.ServersApi();
let id = 56; // Number | Server ID number
apiInstance.serversCancel(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateServerInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
