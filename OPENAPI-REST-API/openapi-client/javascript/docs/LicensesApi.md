...
let apiInstance = new InterserverApiClient.LicensesApi();
let LicenseOrderRequest = new InterserverApiClient.LicenseOrderRequest(); // LicenseOrderRequest | 
apiInstance.addLicense(LicenseOrderRequest).then((data) => {
...
apiInstance.getLicenseInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.LicensesApi();
let id = 56; // Number | The license service ID. Use `license_id` from `GET /licenses`.
apiInstance.getLicenseInvoices(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.LicensesApi();
apiInstance.getLicenseList().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.LicensesApi();
let id = 56; // Number | The license service ID. Use `license_id` from `GET /licenses`.
apiInstance.getLicensesWelcomeEmail(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.LicensesApi();
apiInstance.getNewLicense().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.LicensesApi();
let id = 56; // Number | The license service ID. Use `license_id` from `GET /licenses`.
apiInstance.licensesCancel(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.LicensesApi();
let id = 56; // Number | The license service ID. Use `license_id` from `GET /licenses`.
let IpObject = new InterserverApiClient.IpObject(); // IpObject | 
apiInstance.postLicenseChangeIp(id, IpObject).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.LicensesApi();
let LicenseOrderRequest = new InterserverApiClient.LicenseOrderRequest(); // LicenseOrderRequest | 
apiInstance.putLicenses(LicenseOrderRequest).then(() => {
...
apiInstance.updateLicenseInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
