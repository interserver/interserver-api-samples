...
let apiInstance = new InterserverApiClient.BillingApi();
let BillingAddCcRequest = new InterserverApiClient.BillingAddCcRequest(); // BillingAddCcRequest | 
apiInstance.addBillingCreditCard(BillingAddCcRequest).then((data) => {
...
let apiInstance = new InterserverApiClient.BillingApi();
let BillingPrepayRequest = new InterserverApiClient.BillingPrepayRequest(); // BillingPrepayRequest | 
apiInstance.addBillingPrepay(BillingPrepayRequest).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.deleteBillingCreditCard(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.deleteBillingInvoice(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.deleteBillingPrepay(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.BillingApi();
apiInstance.getAffiliateBanners().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let opts = {
  ...
  'year': 56 // Number | Year to filter the report. Defaults to the current year.
};
apiInstance.getAffiliateDownload(opts).then(() => {
 ...
 **year** | **Number**| Year to filter the report. Defaults to the current year. | [optional] 
...
let apiInstance = new InterserverApiClient.BillingApi();
apiInstance.getAffiliateRichReport().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getAffiliateSalesGraph(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
> GetAffiliateSignups200Response getAffiliateSignups(opts)
...
apiInstance.getAffiliateSignups(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getAffiliateTrafficGraph(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.BillingApi();
apiInstance.getAffiliateWebTraffic().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.BillingApi();
apiInstance.getBillingCart().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getBillingCreditCardVerify(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getBillingInvoice(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.BillingApi();
apiInstance.getBillingInvoices().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.BillingApi();
apiInstance.getBillingPrePays().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.initiatePayment(method, invoices).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.BillingApi();
let id = 56; // Number | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
let PatchBillingCreditCardVerifyRequest = new InterserverApiClient.PatchBillingCreditCardVerifyRequest(); // PatchBillingCreditCardVerifyRequest | 
apiInstance.patchBillingCreditCardVerify(id, PatchBillingCreditCardVerifyRequest).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.BillingApi();
let id = 56; // Number | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
let BillingVerifyCcRequest = new InterserverApiClient.BillingVerifyCcRequest(); // BillingVerifyCcRequest | 
apiInstance.postBillingCreditCardVerify(id, BillingVerifyCcRequest).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateAffiliateDockSetup(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateAffiliatePaymentSetup(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateBillingCreditCard(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.BillingApi();
let BillingPaymentMethodRequest = new InterserverApiClient.BillingPaymentMethodRequest(); // BillingPaymentMethodRequest | 
apiInstance.updateBillingPaymentMethod(BillingPaymentMethodRequest).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
