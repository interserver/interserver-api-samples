...
let apiInstance = new InterserverApiClient.TicketsApi();
let TicketNew = new InterserverApiClient.TicketNew(); // TicketNew | 
apiInstance.addNewTicket(TicketNew).then((data) => {
...
apiInstance.closeTicket(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.deleteTicketInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.TicketsApi();
let id = 3.4; // Number | Ticket ID number.
apiInstance.getTicketInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getTicketsList(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.TicketsApi();
let id = 3.4; // Number | Ticket ID number.
apiInstance.postTicketInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.TicketsApi();
apiInstance.postTicketsList().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.TicketsApi();
let id = 3.4; // Number | Ticket ID number.
apiInstance.putTicketInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let opts = {
  'ReplyTicketRequest': new InterserverApiClient.ReplyTicketRequest() // ReplyTicketRequest | 
};
apiInstance.replyTicket(id, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let id = 3.4; // Number | The ticket ID number.
let opts = {
  'UpdateTicket': new InterserverApiClient.UpdateTicket() // UpdateTicket | 
};
apiInstance.updateTicketInfo(id, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
