...
let type = new InterserverApiClient.DnsRecordType(); // DnsRecordType | 
let content = "content_example"; // String | Content of record
let opts = {
  'ttl': 86400, // Number | Time-to-live
  'prio': 0 // Number | Priority
};
apiInstance.addDnsRecord(id, name, type, content, opts).then(() => {
...
apiInstance.deleteDnsDomain(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.deleteDnsRecord(domainId, recordId).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getDnsDomain(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.DNSApi();
apiInstance.getDnsList().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let opts = {
  ...
  'type': new InterserverApiClient.DnsRecordType(), // DnsRecordType | 
...
apiInstance.updateDnsRecord(domainId, recordId, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
