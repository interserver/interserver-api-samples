...
let apiInstance = new InterserverApiClient.AccountApi();
let name = "name_example"; // String | 
apiInstance.deleteAccountOauthName(name).then((data) => {
...
let apiInstance = new InterserverApiClient.AccountApi();
apiInstance.deleteAccountTfa().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.AccountApi();
let opts = {
  'IpLimitRange': new InterserverApiClient.IpLimitRange() // IpLimitRange | 
};
apiInstance.deleteIpLimit(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.AccountApi();
apiInstance.getAccountInfo().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.AccountApi();
apiInstance.getAccountTfaSetup().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.AccountApi();
apiInstance.getSearch().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.AccountApi();
let name = "name_example"; // String | 
apiInstance.logoutAccountOauth(name).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.AccountApi();
apiInstance.updateAccountApiKey().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateAccountFeatures(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateAccountInfo(name, address, city, state, zip, country, phone, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateAccountIpLimits(start, end).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateAccountPassword(password).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateAccountSshKey(opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateAccountTfa(_2fa_google_code).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
