...
let apiInstance = new InterserverApiClient.SSLCertificatesApi();
let SslOrderRequest = new InterserverApiClient.SslOrderRequest(); // SslOrderRequest | 
apiInstance.addSsl(SslOrderRequest).then((data) => {
...
let apiInstance = new InterserverApiClient.SSLCertificatesApi();
apiInstance.getNewSsl().then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getSslInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.getSslInvoices(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.SSLCertificatesApi();
let id = 56; // Number | SSL Cert ID number
apiInstance.getSslWelcomeEmail(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.SSLCertificatesApi();
let SslOrderRequest = new InterserverApiClient.SslOrderRequest(); // SslOrderRequest | 
apiInstance.putSsl(SslOrderRequest).then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
let apiInstance = new InterserverApiClient.SSLCertificatesApi();
let id = 56; // Number | SSL Cert ID number
apiInstance.sslCancel(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
apiInstance.updateSslInfo(id).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
