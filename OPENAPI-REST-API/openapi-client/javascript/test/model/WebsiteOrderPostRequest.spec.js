...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterserverApiClient.WebsiteOrderPostRequest();
  });
  ...
  describe('WebsiteOrderPostRequest', function() {
    it('should create an instance of WebsiteOrderPostRequest', function() {
      // uncomment below and update the code to test WebsiteOrderPostRequest
      //var instance = new InterserverApiClient.WebsiteOrderPostRequest();
      //expect(instance).to.be.a(InterserverApiClient.WebsiteOrderPostRequest);
    });
    ...
    it('should have the property registerDomain (base name: "registerDomain")', function() {
      // uncomment below and update the code to test the property registerDomain
      //var instance = new InterserverApiClient.WebsiteOrderPostRequest();
      //expect(instance).to.be();
    });
