...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterserverApiClient.ServerOrderOS();
  });
  ...
  describe('ServerOrderOS', function() {
    it('should create an instance of ServerOrderOS', function() {
      ...
      //var instance = new InterserverApiClient.ServerOrderOS();
      //expect(instance).to.be.a(InterserverApiClient.ServerOrderOS);
    });
