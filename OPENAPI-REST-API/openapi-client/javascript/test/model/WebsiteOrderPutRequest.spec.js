...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterserverApiClient.WebsiteOrderPutRequest();
  });
  ...
  describe('WebsiteOrderPutRequest', function() {
    it('should create an instance of WebsiteOrderPutRequest', function() {
      // uncomment below and update the code to test WebsiteOrderPutRequest
      //var instance = new InterserverApiClient.WebsiteOrderPutRequest();
      //expect(instance).to.be.a(InterserverApiClient.WebsiteOrderPutRequest);
    });
