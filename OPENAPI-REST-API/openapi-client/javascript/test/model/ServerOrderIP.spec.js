...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterserverApiClient.ServerOrderIP();
  });
  ...
  describe('ServerOrderIP', function() {
    it('should create an instance of ServerOrderIP', function() {
      ...
      //var instance = new InterserverApiClient.ServerOrderIP();
      //expect(instance).to.be.a(InterserverApiClient.ServerOrderIP);
    });
