...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterserverApiClient.GetScrubIpDetails200ResponseBillingDetails();
  });
  ...
  describe('GetScrubIpDetails200ResponseBillingDetails', function() {
    it('should create an instance of GetScrubIpDetails200ResponseBillingDetails', function() {
      ...
      //var instance = new InterserverApiClient.GetScrubIpDetails200ResponseBillingDetails();
      //expect(instance).to.be.a(InterserverApiClient.GetScrubIpDetails200ResponseBillingDetails);
    });
