...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterserverApiClient.MailOrderRequest();
  });
  ...
  describe('MailOrderRequest', function() {
    it('should create an instance of MailOrderRequest', function() {
      // uncomment below and update the code to test MailOrderRequest
      //var instance = new InterserverApiClient.MailOrderRequest();
      //expect(instance).to.be.a(InterserverApiClient.MailOrderRequest);
    });
