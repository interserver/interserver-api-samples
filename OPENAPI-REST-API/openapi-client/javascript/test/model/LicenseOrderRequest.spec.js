...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterserverApiClient.LicenseOrderRequest();
  });
  ...
  describe('LicenseOrderRequest', function() {
    it('should create an instance of LicenseOrderRequest', function() {
      // uncomment below and update the code to test LicenseOrderRequest
      //var instance = new InterserverApiClient.LicenseOrderRequest();
      //expect(instance).to.be.a(InterserverApiClient.LicenseOrderRequest);
    });
