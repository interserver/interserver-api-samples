...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterserverApiClient.SendMailAdv();
  });
  ...
  describe('SendMailAdv', function() {
    it('should create an instance of SendMailAdv', function() {
      ...
      //var instance = new InterserverApiClient.SendMailAdv();
      //expect(instance).to.be.a(InterserverApiClient.SendMailAdv);
    });
