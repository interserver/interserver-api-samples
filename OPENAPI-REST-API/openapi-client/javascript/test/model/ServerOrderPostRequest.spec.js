...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterserverApiClient.ServerOrderPostRequest();
  });
  ...
  describe('ServerOrderPostRequest', function() {
    it('should create an instance of ServerOrderPostRequest', function() {
      // uncomment below and update the code to test ServerOrderPostRequest
      //var instance = new InterserverApiClient.ServerOrderPostRequest();
      //expect(instance).to.be.a(InterserverApiClient.ServerOrderPostRequest);
    });
    ...
    it('should have the property tos (base name: "tos")', function() {
      // uncomment below and update the code to test the property tos
      //var instance = new InterserverApiClient.ServerOrderPostRequest();
      //expect(instance).to.be();
    });
