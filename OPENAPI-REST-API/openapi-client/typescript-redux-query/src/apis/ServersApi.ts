 ...
 */
function addServerRaw<T>(requestParameters: AddServerRequest, requestConfig: runtime.TypedQueryConfig<T, AddServer200Response> = {}): QueryConfig<T> {
    if (requestParameters.serverOrderPostRequest === null || requestParameters.serverOrderPostRequest === undefined) {
        throw new runtime.RequiredError('serverOrderPostRequest','Required parameter requestParameters.serverOrderPostRequest was null or undefined when calling addServer.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || ServerOrderPostRequestToJSON(requestParameters.serverOrderPostRequest),
    };
...
* Place a custom dedicated server order, creating a real billable invoice
*/
export function addServer<T>(requestParameters: AddServerRequest, requestConfig?: runtime.TypedQueryConfig<T, AddServer200Response>): QueryConfig<T> {
    return addServerRaw(requestParameters, requestConfig);
}
 ...
 */
function serverBulkIpmiPowerGetRaw<T>(requestParameters: ServerBulkIpmiPowerGetRequest, requestConfig: runtime.TypedQueryConfig<T, ServerBulkIpmiPowerResponse> = {}): QueryConfig<T> {
    if (requestParameters.ids === null || requestParameters.ids === undefined) {
        throw new runtime.RequiredError('ids','Required parameter requestParameters.ids was null or undefined when calling serverBulkIpmiPowerGet.');
    }
    ...
    meta.authType = ['api_key', 'header'];
    const config: QueryConfig<T> = {
        url: `${runtime.Configuration.basePath}/servers/bulk/ipmi_power`,
        meta,
        update: requestConfig.update,
        queryKey: requestConfig.queryKey,
        optimisticUpdate: requestConfig.optimisticUpdate,
    ...
    const { transform: requestTransform } = requestConfig;
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(ServerBulkIpmiPowerResponseFromJSON(body), text);
    }
...
* Read IPMI chassis power status for many dedicated servers in one call
*/
export function serverBulkIpmiPowerGet<T>(requestParameters: ServerBulkIpmiPowerGetRequest, requestConfig?: runtime.TypedQueryConfig<T, ServerBulkIpmiPowerResponse>): QueryConfig<T> {
    return serverBulkIpmiPowerGetRaw(requestParameters, requestConfig);
}
