 ...
 */
function addDomainRaw<T>(requestParameters: AddDomainRequest, requestConfig: runtime.TypedQueryConfig<T, ServiceOrderPostResponse> = {}): QueryConfig<T> {
    if (requestParameters.domainOrderRequest === null || requestParameters.domainOrderRequest === undefined) {
        throw new runtime.RequiredError('domainOrderRequest','Required parameter requestParameters.domainOrderRequest was null or undefined when calling addDomain.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || DomainOrderRequestToJSON(requestParameters.domainOrderRequest),
    };
...
* Place a new domain registration or transfer order, generate billing invoice
*/
export function addDomain<T>(requestParameters: AddDomainRequest, requestConfig?: runtime.TypedQueryConfig<T, ServiceOrderPostResponse>): QueryConfig<T> {
    return addDomainRaw(requestParameters, requestConfig);
}
 ...
 */
function patchDomainsRaw<T>(requestParameters: PatchDomainsRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
    if (requestParameters.domainOrderRequest === null || requestParameters.domainOrderRequest === undefined) {
        throw new runtime.RequiredError('domainOrderRequest','Required parameter requestParameters.domainOrderRequest was null or undefined when calling patchDomains.');
    }
...
* Validate posted domain-order field values before committing — dry run
*/
export function patchDomains<T>(requestParameters: PatchDomainsRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
    return patchDomainsRaw(requestParameters, requestConfig);
}
 ...
 */
function postDomainSearchRaw<T>(requestParameters: PostDomainSearchRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
    if (requestParameters.name === null || requestParameters.name === undefined) {
        throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling postDomainSearch.');
    }
...
* Get the full order form data for a hostname in one round-trip (search → order preview)
*/
export function postDomainSearch<T>(requestParameters: PostDomainSearchRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
    return postDomainSearchRaw(requestParameters, requestConfig);
}
 ...
 */
function putDomainsRaw<T>(requestParameters: PutDomainsRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
    if (requestParameters.domainOrderRequest === null || requestParameters.domainOrderRequest === undefined) {
        throw new runtime.RequiredError('domainOrderRequest','Required parameter requestParameters.domainOrderRequest was null or undefined when calling putDomains.');
    }
...
* Preview per-TLD field requirements for a domain order — no commit
*/
export function putDomains<T>(requestParameters: PutDomainsRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
    return putDomainsRaw(requestParameters, requestConfig);
}
