 ...
 */
function addWebsiteRaw<T>(requestParameters: AddWebsiteRequest, requestConfig: runtime.TypedQueryConfig<T, ServiceOrderPostResponse> = {}): QueryConfig<T> {
    if (requestParameters.websiteOrderPostRequest === null || requestParameters.websiteOrderPostRequest === undefined) {
        throw new runtime.RequiredError('websiteOrderPostRequest','Required parameter requestParameters.websiteOrderPostRequest was null or undefined when calling addWebsite.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || WebsiteOrderPostRequestToJSON(requestParameters.websiteOrderPostRequest),
    };
...
* Place a new webhosting order, create the invoice, and queue provisioning
*/
export function addWebsite<T>(requestParameters: AddWebsiteRequest, requestConfig?: runtime.TypedQueryConfig<T, ServiceOrderPostResponse>): QueryConfig<T> {
    return addWebsiteRaw(requestParameters, requestConfig);
}
 ...
 */
function putWebsitesRaw<T>(requestParameters: PutWebsitesRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
    if (requestParameters.websiteOrderPutRequest === null || requestParameters.websiteOrderPutRequest === undefined) {
        throw new runtime.RequiredError('websiteOrderPutRequest','Required parameter requestParameters.websiteOrderPutRequest was null or undefined when calling putWebsites.');
    }
    ...
    const config: QueryConfig<T> = {
        ...
        body: queryParameters || WebsiteOrderPutRequestToJSON(requestParameters.websiteOrderPutRequest),
    };
...
* Validate a webhosting order and preview cost — dry run, no charge
*/
export function putWebsites<T>(requestParameters: PutWebsitesRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
    return putWebsitesRaw(requestParameters, requestConfig);
}
