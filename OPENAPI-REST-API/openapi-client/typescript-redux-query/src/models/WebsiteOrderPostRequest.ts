...
export function WebsiteOrderPostRequestFromJSON(json: any): WebsiteOrderPostRequest {
    return {
        ...
        'serviceOfferId': !exists(json, 'serviceOfferId') ? undefined : json['serviceOfferId'],
        'script': !exists(json, 'script') ? undefined : json['script'],
        'comment': !exists(json, 'comment') ? undefined : json['comment'],
        'registerDomain': !exists(json, 'registerDomain') ? undefined : json['registerDomain'],
    };
}

export function WebsiteOrderPostRequestToJSON(value?: WebsiteOrderPostRequest): any {
    if (value === undefined) {
        return undefined;
    }
    return {
