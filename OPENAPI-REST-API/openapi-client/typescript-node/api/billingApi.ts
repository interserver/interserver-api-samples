...
export class BillingApi {
     ...
     */
    public async getAffiliateDownload (st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/affiliate/download';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        if (ex !== undefined) {
            localVarQueryParameters['ex'] = ObjectSerializer.serialize(ex, "'csv' | 'xls' | 'xlsx' | 'pdf'");
        }
     ...
     */
    public async getAffiliateSignups (st?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetAffiliateSignups200Response;  }> {
        const localVarPath = this.basePath + '/affiliate/signups';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetAffiliateSignups200Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "GetAffiliateSignups200Response");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
    ...
    public async initiatePayment (method: 'cc' | 'paypal' | 'prepay' | 'payssion' | 'payu' | 'ccavenue' | 'cashfree' | 'coinbase' | 'btcpay', invoices: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InitiatePayment200Response;  }> {
        const localVarPath = this.basePath + '/billing/pay/{method}/{invoices}'
     ...
     */
    public async patchBillingCreditCardVerify (id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SuccessTextResponse;  }> {
        const localVarPath = this.basePath + '/billing/creditcards/{id}/verify'
            .replace('{id}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(patchBillingCreditCardVerifyRequest, "PatchBillingCreditCardVerifyRequest")
        };
