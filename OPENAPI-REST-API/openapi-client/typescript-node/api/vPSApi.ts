...
export class VPSApi {
     ...
     * @param id VPS ID number
     */
    public async getVpsBackup (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QueueResponse;  }> {
     ...
     * @param id VPS ID number
     */
    public async getVpsChangeHostname (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param id VPS ID number
     */
    public async getVpsChangeRootPassword (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param id VPS ID number
     */
    public async getVpsInsertCd (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param id VPS ID number
     */
    public async getVpsResetPassword (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param id VPS ID number
     */
    public async postVpsTrafficUsage (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/vps/{id}/traffic_usage'
            .replace('{id}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param id VPS ID number
     */
    public async putVpsBuyHdSpace (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/vps/{id}/buy_hd_space'
            .replace('{id}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
