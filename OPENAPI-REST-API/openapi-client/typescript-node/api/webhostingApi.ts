...
export class WebhostingApi {
     ...
     */
    public async addWebsite (websiteOrderPostRequest: WebsiteOrderPostRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ServiceOrderPostResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(websiteOrderPostRequest, "WebsiteOrderPostRequest")
        };
     ...
     */
    public async putWebsites (websiteOrderPutRequest: WebsiteOrderPutRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/websites/order';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(websiteOrderPutRequest, "WebsiteOrderPutRequest")
        };
