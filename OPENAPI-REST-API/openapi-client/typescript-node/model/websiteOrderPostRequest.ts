...
*/
export class WebsiteOrderPostRequest {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "registerDomain",
            "baseName": "registerDomain",
            "type": "boolean"
        }    ];

    static getAttributeTypeMap() {
        return WebsiteOrderPostRequest.attributeTypeMap;
    }
}
