...
module Api.Request.Public exposing
    ( getAccountCurrencies
    , getAccountLocales
    , getCaptcha
    , getCountries, FetchBy(..), fetchByVariants
    , getInfo
    , getLoginInfo
    , getMPServers
    , getOauthRedirect
...
type FetchBy
    ...
    | FetchByIso3
    | FetchByNumcode
    | FetchByUnknownDefaultOpenApi


fetchByVariants : List FetchBy
fetchByVariants =
    [ FetchByIso2
    , FetchByIso3
    , FetchByNumcode
...
stringFromFetchBy : FetchBy -> String
stringFromFetchBy model =
    case model of
        FetchByIso2 ->
            "iso2"
...
-}
getAccountCurrencies : Api.Request (List String)
getAccountCurrencies =
    Api.request
        "GET"
        "/account/currencies"
...
-}
getAccountLocales : Api.Request (Dict.Dict String Api.Data.GetAccountLocales200ResponseValue)
getAccountLocales =
    Api.request
        "GET"
        "/account/locales"
        ...
        []
        Nothing
        (Json.Decode.dict Api.Data.getAccountLocales200ResponseValueDecoder)
...
-}
getCaptcha : Api.Request Api.Data.CaptchaResponse
getCaptcha =
    Api.request
        "GET"
        "/captcha"
        ...
        []
        Nothing
        Api.Data.captchaResponseDecoder
...
-}
getCountries : Maybe FetchBy -> Api.Request (Dict.Dict String Api.Data.Object)
getCountries fetchBy_query =
    Api.request
        "GET"
        "/account/countries"
        []
        [ ( "fetch_by", Maybe.map stringFromFetchBy fetchBy_query ) ]
        []
        Nothing
        (Json.Decode.dict )
...
-}
getInfo : Api.Request Api.Data.ServicesInfo
getInfo =
    Api.request
        "GET"
        "/info"
...
-}
getLoginInfo : Api.Request Api.Data.LoginInfo
getLoginInfo =
    Api.request
        "GET"
        "/login"
...
-}
getOauthRedirect : String -> Api.Request Api.Data.GetOauthRedirect200Response
getOauthRedirect provider_query =
    Api.request
        "GET"
        "/oauth"
        []
        [ ( "provider", Just <| identity provider_query ) ]
        []
        Nothing
        Api.Data.getOauthRedirect200ResponseDecoder
...
-}
getTimezones : Api.Request (List String)
getTimezones =
    Api.request
        "GET"
        "/account/timezones"
...
-}
patchOauthTwoFactor : Api.Data.PatchOauthTwoFactorRequest -> Api.Request Api.Data.PatchOauthTwoFactor200Response
patchOauthTwoFactor patchOauthTwoFactorRequest_body =
    Api.request
        "PATCH"
        "/oauth"
        []
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodePatchOauthTwoFactorRequest patchOauthTwoFactorRequest_body)))
        Api.Data.patchOauthTwoFactor200ResponseDecoder
...
-}
postOauthCallback : String -> Maybe Api.Data.PostOauthCallbackRequest -> Api.Request Api.Data.PostOauthCallback200Response
postOauthCallback provider_query postOauthCallbackRequest_body =
    Api.request
        "POST"
        "/oauth"
        []
        [ ( "provider", Just <| identity provider_query ) ]
        []
        (Maybe.map Http.jsonBody (Maybe.map Api.Data.encodePostOauthCallbackRequest postOauthCallbackRequest_body))
        Api.Data.postOauthCallback200ResponseDecoder
...
-}
submitLogin : String -> String -> Maybe String -> Maybe Api.Data.LoginSubmissionExampleGRecaptchaResponse -> Maybe String -> Api.Request Api.Data.LoginSuccessResponse
submitLogin login passwd remember grecaptcharesponse tfa =
    Api.request
        "POST"
        "/login"
        []
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Just <| Http.stringPart "login" login, Just <| Http.stringPart "passwd" passwd, Maybe.map (Http.stringPart "remember") remember, Maybe.map (Http.stringPart "g-recaptcha-response") grecaptcharesponse, Maybe.map (Http.stringPart "tfa") tfa ])
        Api.Data.loginSuccessResponseDecoder
...
-}
submitSignup : Maybe Api.Data.LoginSubmissionExample -> Api.Request ()
submitSignup loginSubmissionExample_body =
    Api.request
        "POST"
        "/signup"
        []
        []
        []
        (Maybe.map Http.jsonBody (Maybe.map Api.Data.encodeLoginSubmissionExample loginSubmissionExample_body))
        (Json.Decode.succeed ())
