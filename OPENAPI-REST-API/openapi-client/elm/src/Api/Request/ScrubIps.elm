...
module Api.Request.ScrubIps exposing
    ( cancelScrubIp
    , createFilter
    , createGeoRule
    , createRule
...
-}
cancelScrubIp : Int -> Api.Request Api.Data.CancelScrubIp200Response
cancelScrubIp id_path =
    Api.request
        "DELETE"
        "/scrub_ips/{id}"
        ...
        []
        Nothing
        Api.Data.cancelScrubIp200ResponseDecoder
...
-}
createFilter : Int -> Api.Data.CreateFilter -> Api.Request Api.Data.CreateFilter201Response
createFilter id_path createFilter_body =
    Api.request
        "POST"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeCreateFilter createFilter_body)))
        Api.Data.createFilter201ResponseDecoder
...
-}
createGeoRule : Int -> Api.Data.CreateGeoFirewallRule -> Api.Request Api.Data.CreateRule201Response
createGeoRule id_path createGeoFirewallRule_body =
    Api.request
        "POST"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeCreateGeoFirewallRule createGeoFirewallRule_body)))
        Api.Data.createRule201ResponseDecoder
...
-}
createRule : Int -> Api.Data.CreateFirewallRule -> Api.Request Api.Data.CreateRule201Response
createRule id_path createFirewallRule_body =
    Api.request
        "POST"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeCreateFirewallRule createFirewallRule_body)))
        Api.Data.createRule201ResponseDecoder
...
-}
deleteFilter : Int -> Api.Data.CreateFilter -> Api.Request Api.Data.DeleteFilter200Response
deleteFilter id_path createFilter_body =
    Api.request
        "POST"
        ...
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeCreateFilter createFilter_body)))
        Api.Data.deleteFilter200ResponseDecoder
...
-}
disableScrub : Int -> Api.Request Api.Data.DisableScrub200Response
disableScrub id_path =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.disableScrub200ResponseDecoder
...
-}
enableScrub : Int -> Api.Request Api.Data.EnableScrub200Response
enableScrub id_path =
    Api.request
        "GET"
        "/scrub_ips/{id}/enable"
        ...
        []
        Nothing
        Api.Data.enableScrub200ResponseDecoder
...
-}
getOrderDetail : Api.Request Api.Data.GetOrderDetail200Response
getOrderDetail =
    Api.request
        "GET"
        "/scrub_ips/order"
        ...
        []
        Nothing
        Api.Data.getOrderDetail200ResponseDecoder
...
-}
getScrubIpDetails : Int -> Api.Request Api.Data.GetScrubIpDetails200Response
getScrubIpDetails id_path =
    Api.request
        "GET"
        "/scrub_ips/{id}"
        [ ( "id", String.fromInt id_path ) ]
        ...
        []
        Nothing
        Api.Data.getScrubIpDetails200ResponseDecoder
...
-}
getScrubIpFilterTypes : Api.Request Api.Data.ScrubIpFilterTypes
getScrubIpFilterTypes =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.scrubIpFilterTypesDecoder
...
-}
getScrubIpInvoices : Int -> Api.Request Api.Data.ChargeInvoiceRows
getScrubIpInvoices id_path =
    Api.request
        "GET"
...
-}
getScrubIpLogs : String -> Api.Request (List Api.Data.ScrubIpsLogRowSchema)
getScrubIpLogs id_path =
    Api.request
        "GET"
        "/scrub_ips/{id}/logs"
        [ ( "id", identity id_path ) ]
        ...
        []
        Nothing
        (Json.Decode.list Api.Data.scrubIpsLogRowSchemaDecoder)
...
-}
getScrubIpsList : Api.Request (List Api.Data.ScrubIpsRowSchema)
getScrubIpsList =
    Api.request
        "GET"
        "/scrub_ips"
        ...
        []
        Nothing
        (Json.Decode.list Api.Data.scrubIpsRowSchemaDecoder)
...
-}
placeScrubOrder : Api.Data.ScrubIpPlaceOrder -> Api.Request Api.Data.PlaceScrubOrder201Response
placeScrubOrder scrubIpPlaceOrder_body =
    Api.request
        "POST"
        "/scrub_ips/order"
        []
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeScrubIpPlaceOrder scrubIpPlaceOrder_body)))
        Api.Data.placeScrubOrder201ResponseDecoder
...
-}
putScrubIps : Api.Data.ScrubIpPlaceOrder -> Api.Request Api.Data.PutScrubIps200Response
putScrubIps scrubIpPlaceOrder_body =
    Api.request
        "PUT"
        "/scrub_ips/order"
        []
        ...
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeScrubIpPlaceOrder scrubIpPlaceOrder_body)))
        Api.Data.putScrubIps200ResponseDecoder
...
-}
scrubIpsDeleteGeoRule : Int -> Api.Data.DeleteGeoFirewallRule -> Api.Request Api.Data.ScrubIpsDeleteRule200Response
scrubIpsDeleteGeoRule id_path deleteGeoFirewallRule_body =
    Api.request
        "POST"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeDeleteGeoFirewallRule deleteGeoFirewallRule_body)))
        Api.Data.scrubIpsDeleteRule200ResponseDecoder
...
-}
scrubIpsDeleteRule : Int -> Api.Data.DeleteFirewallRule -> Api.Request Api.Data.ScrubIpsDeleteRule200Response
scrubIpsDeleteRule id_path deleteFirewallRule_body =
    Api.request
        "POST"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeDeleteFirewallRule deleteFirewallRule_body)))
        Api.Data.scrubIpsDeleteRule200ResponseDecoder
