...
module Api.Request.Domains exposing
    ( addDomain
    , addDomainDnssec
    , addDomainNameserver
    , cancelDomain
...
-}
addDomain : Api.Data.DomainOrderRequest -> Api.Request Api.Data.ServiceOrderPostResponse
addDomain domainOrderRequest_body =
    Api.request
        "POST"
        "/domains/order"
        []
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeDomainOrderRequest domainOrderRequest_body)))
...
-}
addDomainDnssec : Int -> Api.Data.DomainDnssecRequest -> Api.Request Api.Data.SuccessTextResponse
addDomainDnssec id_path domainDnssecRequest_body =
    Api.request
        "POST"
        "/domains/{id}/dnssec"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeDomainDnssecRequest domainDnssecRequest_body)))
...
-}
addDomainNameserver : Int -> Api.Data.DomainNameserverPostRequest -> Api.Request Api.Data.TextResponse
addDomainNameserver id_path domainNameserverPostRequest_body =
    Api.request
        "POST"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeDomainNameserverPostRequest domainNameserverPostRequest_body)))
...
-}
cancelDomain : Int -> Api.Request Api.Data.CancelDomain200Response
cancelDomain id_path =
    Api.request
        "DELETE"
        "/domains/{id}"
        [ ( "id", String.fromInt id_path ) ]
        ...
        []
        Nothing
        Api.Data.cancelDomain200ResponseDecoder
...
-}
deleteDomainDnssec : Int -> Api.Request Api.Data.SuccessTextResponse
deleteDomainDnssec id_path =
    Api.request
        "DELETE"
        "/domains/{id}/dnssec"
        [ ( "id", String.fromInt id_path ) ]
...
-}
deleteDomainNameserver : Int -> Int -> Api.Request Api.Data.TextResponse
deleteDomainNameserver id_path index_query =
    Api.request
        "DELETE"
        "/domains/{id}/nameservers"
        [ ( "id", String.fromInt id_path ) ]
        [ ( "index", Just <| String.fromInt index_query ) ]
        []
        Nothing
        Api.Data.textResponseDecoder
...
-}
getDomainContact : Int -> Api.Request Api.Data.DomainContactDetails
getDomainContact id_path =
    Api.request
        "GET"
        "/domains/{id}/contact"
        [ ( "id", String.fromInt id_path ) ]
        ...
        []
        Nothing
        Api.Data.domainContactDetailsDecoder
...
-}
getDomainDnssec : Int -> Api.Request Api.Data.DomainDnssecRecords
getDomainDnssec id_path =
    Api.request
        "GET"
        "/domains/{id}/dnssec"
        [ ( "id", String.fromInt id_path ) ]
        ...
        []
        Nothing
        Api.Data.domainDnssecRecordsDecoder
...
-}
getDomainInfo : Int -> Api.Request Api.Data.Domain
getDomainInfo id_path =
    Api.request
        "GET"
        "/domains/{id}"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getDomainInvoices : Int -> Api.Request Api.Data.ChargeInvoiceRows
getDomainInvoices id_path =
    Api.request
        "GET"
        "/domains/{id}/invoices"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getDomainLookup : String -> Api.Request Api.Data.DomainLookupResponse
getDomainLookup name_path =
    Api.request
        "GET"
        "/domains/lookup/{name}"
        ...
        []
        Nothing
        Api.Data.domainLookupResponseDecoder
...
-}
getDomainNameservers : Int -> Api.Request Api.Data.DomainNameserverGetResponse
getDomainNameservers id_path =
    Api.request
        "GET"
        "/domains/{id}/nameservers"
        [ ( "id", String.fromInt id_path ) ]
        ...
        []
        Nothing
        Api.Data.domainNameserverGetResponseDecoder
...
-}
getDomainRenewal : Int -> Api.Request Api.Data.SuccessTextResponse
getDomainRenewal id_path =
    Api.request
        "GET"
        "/domains/{id}/renew"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getDomainSearch : String -> Api.Request Api.Data.DomainSearchResponse
getDomainSearch name_path =
    Api.request
        "GET"
        "/domains/search/{name}"
        [ ( "name", identity name_path ) ]
        ...
        []
        Nothing
        Api.Data.domainSearchResponseDecoder
...
-}
getDomainTransfer : Int -> Api.Request Api.Data.SuccessTextResponse
getDomainTransfer id_path =
    Api.request
        "GET"
        "/domains/{id}/transfer"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getDomainWhoisPrivacy : Int -> Api.Request Api.Data.SuccessTextResponse
getDomainWhoisPrivacy id_path =
    Api.request
        "GET"
        "/domains/{id}/whois"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getDomainsList : Api.Request (List Api.Data.DomainRow)
getDomainsList =
    Api.request
        "GET"
        "/domains"
        ...
        []
        Nothing
        (Json.Decode.list Api.Data.domainRowDecoder)
...
-}
getDomainsWelcomeEmail : Int -> Api.Request Api.Data.SuccessTextResponse
getDomainsWelcomeEmail id_path =
    Api.request
        "GET"
...
-}
getNewDomain : Api.Request Api.Data.DomainOrder
getNewDomain =
    Api.request
        "GET"
        "/domains/order"
...
-}
patchDomains : Api.Data.DomainOrderRequest -> Api.Request ()
patchDomains domainOrderRequest_body =
    Api.request
        "PATCH"
        "/domains/order"
        []
...
-}
postDomainRenewal : Int -> Api.Request Api.Data.SuccessTextResponse
postDomainRenewal id_path =
    Api.request
        "POST"
        "/domains/{id}/renew"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postDomainSearch : String -> Api.Request ()
postDomainSearch name_path =
    Api.request
        "POST"
        "/domains/search/{name}"
        [ ( "name", identity name_path ) ]
...
-}
postDomainTransfer : Int -> Api.Request Api.Data.SuccessTextResponse
postDomainTransfer id_path =
    Api.request
        "POST"
        "/domains/{id}/transfer"
        [ ( "id", String.fromInt id_path ) ]
...
-}
putDomains : Api.Data.DomainOrderRequest -> Api.Request ()
putDomains domainOrderRequest_body =
    Api.request
        "PUT"
        "/domains/order"
        []
...
-}
updateDomainContact : Int -> Api.Data.DomainContactDetails -> Api.Request Api.Data.SuccessTextResponse
updateDomainContact id_path domainContactDetails_body =
    Api.request
        "POST"
        "/domains/{id}/contact"
        [ ( "id", String.fromInt id_path ) ]
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeDomainContactDetails domainContactDetails_body)))
        Api.Data.successTextResponseDecoder
...
-}
updateDomainInfo : Int -> Api.Request Api.Data.SuccessTextResponse
updateDomainInfo id_path =
    Api.request
        "POST"
        "/domains/{id}"
        [ ( "id", String.fromInt id_path ) ]
...
-}
updateDomainNameservers : Int -> Api.Data.DomainNameserverPutRequest -> Api.Request Api.Data.TextResponse
updateDomainNameservers id_path domainNameserverPutRequest_body =
    Api.request
        "PUT"
        "/domains/{id}/nameservers"
        [ ( "id", String.fromInt id_path ) ]
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeDomainNameserverPutRequest domainNameserverPutRequest_body)))
        Api.Data.textResponseDecoder
...
-}
updateDomainWhoisPrivacy : Int -> Api.Data.DomainWhoisPrivacyRequest -> Api.Request Api.Data.SuccessTextResponse
updateDomainWhoisPrivacy id_path domainWhoisPrivacyRequest_body =
    Api.request
        "POST"
        "/domains/{id}/whois"
        [ ( "id", String.fromInt id_path ) ]
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeDomainWhoisPrivacyRequest domainWhoisPrivacyRequest_body)))
        Api.Data.successTextResponseDecoder
