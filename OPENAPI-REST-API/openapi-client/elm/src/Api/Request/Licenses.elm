...
module Api.Request.Licenses exposing
    ( addLicense
    , getLicenseInfo
    , getLicenseInvoices
    , getLicenseList
...
-}
addLicense : Api.Data.LicenseOrderRequest -> Api.Request Api.Data.ServiceOrderPostResponse
addLicense licenseOrderRequest_body =
    Api.request
        "POST"
        "/licenses/order"
        []
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeLicenseOrderRequest licenseOrderRequest_body)))
...
-}
getLicenseInfo : Int -> Api.Request Api.Data.License
getLicenseInfo id_path =
    Api.request
        "GET"
        "/licenses/{id}"
...
-}
getLicenseInvoices : Int -> Api.Request Api.Data.ChargeInvoiceRows
getLicenseInvoices id_path =
    Api.request
        "GET"
...
-}
getLicenseList : Api.Request (List Api.Data.LicenseRow)
getLicenseList =
    Api.request
        "GET"
        "/licenses"
        ...
        []
        Nothing
        (Json.Decode.list Api.Data.licenseRowDecoder)
...
-}
getLicensesWelcomeEmail : Int -> Api.Request Api.Data.SuccessTextResponse
getLicensesWelcomeEmail id_path =
    Api.request
        "GET"
...
-}
getNewLicense : Api.Request Api.Data.LicensesOrder
getNewLicense =
    Api.request
        "GET"
        "/licenses/order"
...
-}
licensesCancel : Int -> Api.Request Api.Data.LicensesCancel200Response
licensesCancel id_path =
    Api.request
        "DELETE"
        "/licenses/{id}"
        [ ( "id", String.fromInt id_path ) ]
        ...
        []
        Nothing
        Api.Data.licensesCancel200ResponseDecoder
...
-}
postLicenseChangeIp : Int -> Api.Data.IpObject -> Api.Request Api.Data.SuccessTextResponse
postLicenseChangeIp id_path ipObject_body =
    Api.request
        "POST"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeIpObject ipObject_body)))
        Api.Data.successTextResponseDecoder
...
-}
putLicenses : Api.Data.LicenseOrderRequest -> Api.Request ()
putLicenses licenseOrderRequest_body =
    Api.request
        "PUT"
        "/licenses/order"
        []
...
-}
updateLicenseInfo : String -> Api.Request Api.Data.SuccessTextResponse
updateLicenseInfo id_path =
    Api.request
        "POST"
        "/licenses/{id}"
        [ ( "id", identity id_path ) ]
