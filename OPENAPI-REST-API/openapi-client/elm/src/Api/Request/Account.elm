...
-}
deleteAccountOauthName : String -> Api.Request Api.Data.SuccessTextResponse
deleteAccountOauthName name_path =
    Api.request
        "DELETE"
        "/account/oauth/{name}"
...
-}
deleteAccountTfa : Api.Request Api.Data.SuccessTextResponse
deleteAccountTfa =
    Api.request
        "DELETE"
        "/account/2fa"
...
-}
deleteIpLimit : Maybe Api.Data.IpLimitRange -> Api.Request Api.Data.GenericResponse
deleteIpLimit ipLimitRange_body =
    Api.request
        "PATCH"
        "/account/iplimits"
        []
        []
        []
        (Maybe.map Http.jsonBody (Maybe.map Api.Data.encodeIpLimitRange ipLimitRange_body))
...
-}
getAccountInfo : Api.Request Api.Data.AccountInfo
getAccountInfo =
    Api.request
        "GET"
        "/account"
...
-}
getAccountTfaSetup : Api.Request Api.Data.GetAccountTfaSetup200Response
getAccountTfaSetup =
    Api.request
        "GET"
        "/account/2fa"
        ...
        []
        Nothing
        Api.Data.getAccountTfaSetup200ResponseDecoder
...
-}
getHome : Api.Request Api.Data.Home
getHome =
    Api.request
        "GET"
        "/home"
...
-}
getSearch : Api.Request Api.Data.SearchAutocompleteResponse
getSearch =
    Api.request
        "GET"
        "/search"
        ...
        []
        Nothing
        Api.Data.searchAutocompleteResponseDecoder
...
-}
logout : Api.Request Api.Data.SuccessTextResponse
logout =
    Api.request
        "GET"
        "/logout"
...
-}
logoutAccountOauth : String -> Api.Request Api.Data.SuccessTextResponse
logoutAccountOauth name_path =
    Api.request
        "GET"
...
-}
updateAccountApiKey : Api.Request Api.Data.SuccessTextResponse
updateAccountApiKey =
    Api.request
        "POST"
        "/account/apikey"
...
-}
updateAccountFeatures : Maybe Int -> Maybe Int -> Api.Request Api.Data.SuccessTextResponse
updateAccountFeatures disableReset disableReinstall =
    Api.request
        "POST"
        "/account/features"
        []
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Maybe.map (Http.stringPart "disable_reset"String.fromInt) disableReset, Maybe.map (Http.stringPart "disable_reinstall"String.fromInt) disableReinstall ])
        Api.Data.successTextResponseDecoder
...
-}
updateAccountInfo : String -> String -> String -> String -> String -> String -> String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe Bool -> Maybe Bool -> Maybe Bool -> Maybe Bool -> Maybe String -> Api.Request Api.Data.SuccessTextResponse
updateAccountInfo name address city state zip country phone company address2 locale emailInvoices emailAbuse disableReset disableReinstall disableServerNotifications disableEmailNotifications gstin =
    Api.request
        ...
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Just <| Http.stringPart "name" name, Maybe.map (Http.stringPart "company") company, Just <| Http.stringPart "address" address, Maybe.map (Http.stringPart "address2") address2, Just <| Http.stringPart "city" city, Just <| Http.stringPart "state" state, Just <| Http.stringPart "zip" zip, Just <| Http.stringPart "country" country, Just <| Http.stringPart "phone" phone, Maybe.map (Http.stringPart "locale") locale, Maybe.map (Http.stringPart "email_invoices") emailInvoices, Maybe.map (Http.stringPart "email_abuse") emailAbuse, Maybe.map (Http.stringPart "disable_reset"(\val -> if val then "true" else "false")) disableReset, Maybe.map (Http.stringPart "disable_reinstall"(\val -> if val then "true" else "false")) disableReinstall, Maybe.map (Http.stringPart "disable_server_notifications"(\val -> if val then "true" else "false")) disableServerNotifications, Maybe.map (Http.stringPart "disable_email_notifications"(\val -> if val then "true" else "false")) disableEmailNotifications, Maybe.map (Http.stringPart "gstin") gstin ])
        Api.Data.successTextResponseDecoder
...
-}
updateAccountIpLimits : String -> String -> Api.Request Api.Data.SuccessTextResponse
updateAccountIpLimits start end =
    Api.request
        ...
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Just <| Http.stringPart "start" start, Just <| Http.stringPart "end" end ])
        Api.Data.successTextResponseDecoder
...
-}
updateAccountPassword : String -> Api.Request Api.Data.TextResponse
...
-}
updateAccountSshKey : Maybe String -> Api.Request Api.Data.SuccessTextResponse
updateAccountSshKey sshKey =
    Api.request
        "POST"
        "/account/sshkey"
        []
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Maybe.map (Http.stringPart "ssh_key") sshKey ])
        Api.Data.successTextResponseDecoder
...
-}
updateAccountTfa : String -> Api.Request Api.Data.SuccessTextResponse
updateAccountTfa 2faGoogleCode =
    Api.request
        "POST"
        "/account/2fa"
        []
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Just <| Http.stringPart "2fa_google_code" 2faGoogleCode ])
        Api.Data.successTextResponseDecoder
