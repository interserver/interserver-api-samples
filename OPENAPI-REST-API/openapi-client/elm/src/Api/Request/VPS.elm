...
module Api.Request.VPS exposing
    ( addVps
    , deleteVpsBackup, All(..), allVariants
    , doVpsBlockSmtp
    , doVpsDisableCd
    , doVpsDisableQuota
    , doVpsEjectCd
    ...
    , doVpsStart
    , doVpsStop
    , downloadVpsBackup, All(..), allVariants
    , getNewVps
    , getVpsBackup
    , getVpsBackups, All(..), allVariants
    , getVpsBuyHdSpace
    , getVpsBuyIp
...
-}
addVps : Maybe Api.Data.VpsOrderPostRequest -> Api.Request Api.Data.ServiceOrderPostResponse
addVps vpsOrderPostRequest_body =
    Api.request
        "POST"
        "/vps/order"
        []
        []
        []
        (Maybe.map Http.jsonBody (Maybe.map Api.Data.encodeVpsOrderPostRequest vpsOrderPostRequest_body))
...
-}
deleteVpsBackup : Int -> String -> Maybe All -> Api.Request Api.Data.SuccessTextResponse
deleteVpsBackup id_path file_query all_query =
    Api.request
        "DELETE"
        "/vps/{id}/backups"
...
-}
doVpsBlockSmtp : Int -> Api.Request Api.Data.QueueResponse
doVpsBlockSmtp id_path =
    Api.request
        "GET"
        "/vps/{id}/block_smtp"
        [ ( "id", String.fromInt id_path ) ]
...
-}
doVpsDisableCd : Int -> Api.Request Api.Data.QueueResponse
doVpsDisableCd id_path =
    Api.request
        "GET"
        "/vps/{id}/disable_cd"
        [ ( "id", String.fromInt id_path ) ]
...
-}
doVpsDisableQuota : Int -> Api.Request Api.Data.QueueResponse
doVpsDisableQuota id_path =
    Api.request
        "GET"
...
-}
doVpsEjectCd : Int -> Api.Request Api.Data.QueueResponse
doVpsEjectCd id_path =
    Api.request
        "GET"
        "/vps/{id}/eject_cd"
        [ ( "id", String.fromInt id_path ) ]
...
-}
doVpsEnableQuota : Int -> Api.Request Api.Data.QueueResponse
doVpsEnableQuota id_path =
    Api.request
        "GET"
        "/vps/{id}/enable_quota"
        [ ( "id", String.fromInt id_path ) ]
...
-}
doVpsRestart : Int -> Api.Request Api.Data.QueueResponse
doVpsRestart id_path =
    Api.request
        "GET"
        "/vps/{id}/restart"
        [ ( "id", String.fromInt id_path ) ]
...
-}
doVpsStart : Int -> Api.Request Api.Data.QueueResponse
doVpsStart id_path =
    Api.request
        "GET"
        "/vps/{id}/start"
...
-}
doVpsStop : Int -> Api.Request Api.Data.QueueResponse
doVpsStop id_path =
    Api.request
        "GET"
        "/vps/{id}/stop"
...
-}
downloadVpsBackup : Int -> Maybe All -> Api.Data.DownloadQsBackupRequest -> Api.Request Api.Data.DownloadQsBackup200Response
downloadVpsBackup id_path all_query downloadQsBackupRequest_body =
    Api.request
        "PATCH"
        "/vps/{id}/backups"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getNewVps : Api.Request Api.Data.VpsOrder
getNewVps =
    Api.request
        "GET"
        "/vps/order"
...
-}
getVpsBackup : Int -> Api.Request Api.Data.QueueResponse
getVpsBackup id_path =
    Api.request
        "GET"
        "/vps/{id}/backup"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsBackups : Int -> Maybe All -> Api.Request Api.Data.VpsBackupRows
getVpsBackups id_path all_query =
    Api.request
        "GET"
        "/vps/{id}/backups"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsBuyHdSpace : Int -> Api.Request ()
getVpsBuyHdSpace id_path =
    Api.request
        "GET"
        "/vps/{id}/buy_hd_space"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsChangeHostname : Int -> Api.Request ()
getVpsChangeHostname id_path =
    Api.request
        "GET"
...
-}
getVpsChangeRootPassword : Int -> Api.Request ()
getVpsChangeRootPassword id_path =
    Api.request
        "GET"
...
-}
getVpsChangeTimezone : Int -> Api.Request (List String)
getVpsChangeTimezone id_path =
    Api.request
        "GET"
...
-}
getVpsInfo : Int -> Api.Request Api.Data.Vps
getVpsInfo id_path =
    Api.request
        "GET"
        "/vps/{id}"
...
-}
getVpsInsertCd : Int -> Api.Request ()
getVpsInsertCd id_path =
    Api.request
        "GET"
        "/vps/{id}/insert_cd"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsInvoices : Int -> Api.Request Api.Data.ChargeInvoiceRows
getVpsInvoices id_path =
    Api.request
        "GET"
        "/vps/{id}/invoices"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsList : Api.Request (List Api.Data.VpsRow)
getVpsList =
    Api.request
        "GET"
        "/vps"
        ...
        []
        Nothing
        (Json.Decode.list Api.Data.vpsRowDecoder)
...
-}
getVpsReinstallOs : Int -> Api.Request Api.Data.VpsTemplatesList
getVpsReinstallOs id_path =
    Api.request
        "GET"
        "/vps/{id}/reinstall_os"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsResetPassword : Int -> Api.Request ()
getVpsResetPassword id_path =
    Api.request
        "GET"
...
-}
getVpsReverseDns : Int -> Api.Request Api.Data.ReverseDnsEntries
getVpsReverseDns id_path =
    Api.request
        "GET"
        "/vps/{id}/reverse_dns"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsSetupVnc : Int -> Api.Request ()
getVpsSetupVnc id_path =
    Api.request
        "GET"
        "/vps/{id}/setup_vnc"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsSlices : Int -> Api.Request ()
getVpsSlices id_path =
    Api.request
        "GET"
        "/vps/{id}/slices"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsTrafficUsage : Int -> Api.Request Api.Data.VpsTrafficResponse
getVpsTrafficUsage id_path =
    Api.request
        "GET"
        ...
        []
        Nothing
        Api.Data.vpsTrafficResponseDecoder
...
-}
getVpsViewDesktop : Int -> Api.Request ()
getVpsViewDesktop id_path =
    Api.request
        "GET"
        "/vps/{id}/view_desktop"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getVpsWelcomeEmail : String -> Api.Request Api.Data.SuccessTextResponse
getVpsWelcomeEmail id_path =
    Api.request
        "GET"
...
-}
postVpsBuyHdSpace : Int -> Api.Request ()
postVpsBuyHdSpace id_path =
    Api.request
        "POST"
        "/vps/{id}/buy_hd_space"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postVpsBuyIp : Int -> Api.Request ()
postVpsBuyIp id_path =
    Api.request
        "POST"
        "/vps/{id}/buy_ip"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postVpsChangeHostname : Int -> Maybe String -> Api.Request Api.Data.QueueResponse
postVpsChangeHostname id_path hostname =
    Api.request
        "POST"
        "/vps/{id}/change_hostname"
        [ ( "id", String.fromInt id_path ) ]
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Maybe.map (Http.stringPart "hostname") hostname ])
        Api.Data.queueResponseDecoder
...
-}
postVpsChangeRootPassword : Int -> String -> Api.Request Api.Data.QueueResponse
postVpsChangeRootPassword id_path password =
    Api.request
        "POST"
        "/vps/{id}/change_root_password"
        [ ( "id", String.fromInt id_path ) ]
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Just <| Http.stringPart "password" password ])
        Api.Data.queueResponseDecoder
...
-}
postVpsChangeTimezone : Int -> String -> Api.Request Api.Data.QueueResponse
postVpsChangeTimezone id_path timezone =
    Api.request
        "POST"
        "/vps/{id}/change_timezone"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postVpsChangeWebuzoPassword : Int -> String -> Api.Request Api.Data.QueueResponse
postVpsChangeWebuzoPassword id_path password =
    Api.request
        "POST"
...
-}
postVpsInsertCd : Int -> Maybe String -> Api.Request Api.Data.QueueResponse
postVpsInsertCd id_path url =
    Api.request
        "POST"
        "/vps/{id}/insert_cd"
        [ ( "id", String.fromInt id_path ) ]
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Maybe.map (Http.stringPart "url") url ])
        Api.Data.queueResponseDecoder
...
-}
postVpsReinstallOs : Int -> String -> String -> Maybe String -> Api.Request Api.Data.QueueResponse
postVpsReinstallOs id_path template localPassword password =
    Api.request
        "POST"
        "/vps/{id}/reinstall_os"
        [ ( "id", String.fromInt id_path ) ]
        []
        []
        (Just <| Http.multipartBody <| List.filterMap identity [ Just <| Http.stringPart "template" template, Maybe.map (Http.stringPart "password") password, Just <| Http.stringPart "localPassword" localPassword ])
        Api.Data.queueResponseDecoder
...
-}
postVpsResetPassword : Int -> Api.Request Api.Data.QueueResponse
postVpsResetPassword id_path =
    Api.request
        "POST"
        "/vps/{id}/reset_password"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postVpsRestore : Int -> Api.Data.RestoreRequest -> Api.Request Api.Data.QueueResponse
postVpsRestore id_path restoreRequest_body =
    Api.request
        "POST"
        "/vps/{id}/restore"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postVpsReverseDns : Int -> Api.Data.ReverseDnsEntries -> Api.Request Api.Data.TextResponse
postVpsReverseDns id_path reverseDnsEntries_body =
    Api.request
        "POST"
        "/vps/{id}/reverse_dns"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postVpsSetupVnc : Int -> Api.Request Api.Data.QueueResponse
postVpsSetupVnc id_path =
    Api.request
        "POST"
        "/vps/{id}/setup_vnc"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postVpsSlices : Int -> Api.Request ()
postVpsSlices id_path =
    Api.request
        "POST"
        "/vps/{id}/slices"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postVpsTrafficUsage : Int -> Api.Request ()
postVpsTrafficUsage id_path =
    Api.request
        "POST"
        "/vps/{id}/traffic_usage"
        [ ( "id", String.fromInt id_path ) ]
...
-}
postVpsViewDesktop : Int -> Api.Request ()
postVpsViewDesktop id_path =
    Api.request
        "POST"
        "/vps/{id}/view_desktop"
        [ ( "id", String.fromInt id_path ) ]
...
-}
putVps : Maybe Api.Data.VpsOrderPutRequest -> Api.Request Api.Data.VpsOrderPutResponse
putVps vpsOrderPutRequest_body =
    Api.request
        "PUT"
        "/vps/order"
        []
        []
        []
        (Maybe.map Http.jsonBody (Maybe.map Api.Data.encodeVpsOrderPutRequest vpsOrderPutRequest_body))
        Api.Data.vpsOrderPutResponseDecoder
...
-}
putVpsBuyHdSpace : Int -> Api.Request ()
putVpsBuyHdSpace id_path =
    Api.request
        "PUT"
        "/vps/{id}/buy_hd_space"
        [ ( "id", String.fromInt id_path ) ]
...
-}
updateVpsInfo : String -> Api.Request Api.Data.SuccessTextResponse
updateVpsInfo id_path =
    Api.request
        "POST"
        "/vps/{id}"
        [ ( "id", identity id_path ) ]
...
-}
vPSCancel : Int -> Api.Request Api.Data.VPSCancel200Response
vPSCancel id_path =
    Api.request
        "DELETE"
        "/vps/{id}"
        ...
        []
        Nothing
        Api.Data.vPSCancel200ResponseDecoder
