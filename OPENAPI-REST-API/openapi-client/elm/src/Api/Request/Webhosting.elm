...
module Api.Request.Webhosting exposing
    ( addWebsite
    , getNewWebsite
    , getWebsiteBuyIp
    , getWebsiteInfo
...
-}
addWebsite : Api.Data.WebsiteOrderPostRequest -> Api.Request Api.Data.ServiceOrderPostResponse
addWebsite websiteOrderPostRequest_body =
    Api.request
        "POST"
        "/websites/order"
        []
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeWebsiteOrderPostRequest websiteOrderPostRequest_body)))
...
-}
getNewWebsite : Api.Request Api.Data.WebsitesOrder
getNewWebsite =
    Api.request
        "GET"
        "/websites/order"
...
-}
getWebsiteBuyIp : Int -> Api.Request Api.Data.GetWebsiteBuyIp200Response
getWebsiteBuyIp id_path =
    Api.request
        "GET"
        "/websites/{id}/buy_ip"
        ...
        []
        Nothing
        Api.Data.getWebsiteBuyIp200ResponseDecoder
...
-}
getWebsiteInfo : Int -> Api.Request Api.Data.Website
getWebsiteInfo id_path =
    Api.request
        "GET"
        "/websites/{id}"
        [ ( "id", String.fromInt id_path ) ]
...
-}
getWebsiteInvoices : Int -> Api.Request Api.Data.ChargeInvoiceRows
getWebsiteInvoices id_path =
    Api.request
        "GET"
...
-}
getWebsiteList : Api.Request (List Api.Data.WebsiteRow)
getWebsiteList =
    Api.request
        "GET"
        "/websites"
        ...
        []
        Nothing
        (Json.Decode.list Api.Data.websiteRowDecoder)
...
-}
getWebsitesBackups : Int -> Api.Request Api.Data.WebsiteBackups
getWebsitesBackups id_path =
    Api.request
        "GET"
        "/websites/{id}/backups"
        [ ( "id", String.fromInt id_path ) ]
        ...
        []
        Nothing
        Api.Data.websiteBackupsDecoder
...
-}
getWebsitesLogin : Int -> Api.Request Api.Data.WebsiteLoginResponse
getWebsitesLogin id_path =
    Api.request
        "GET"
        "/websites/{id}/login"
        [ ( "id", String.fromInt id_path ) ]
        ...
        []
        Nothing
        Api.Data.websiteLoginResponseDecoder
...
-}
getWebsitesWelcomeEmail : Int -> Api.Request Api.Data.SuccessTextResponse
getWebsitesWelcomeEmail id_path =
    Api.request
        "GET"
...
-}
gettWebsiteReverseDns : Int -> Api.Request Api.Data.ReverseDnsEntries
gettWebsiteReverseDns id_path =
    Api.request
        "GET"
...
-}
postWebsiteBuyIp : Int -> Api.Data.PostWebsiteBuyIpRequest -> Api.Request Api.Data.PostWebsiteBuyIp200Response
postWebsiteBuyIp id_path postWebsiteBuyIpRequest_body =
    Api.request
        "POST"
        "/websites/{id}/buy_ip"
        [ ( "id", String.fromInt id_path ) ]
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodePostWebsiteBuyIpRequest postWebsiteBuyIpRequest_body)))
        Api.Data.postWebsiteBuyIp200ResponseDecoder
...
-}
postWebsiteMigration : Int -> Api.Data.PostWebsiteMigrationRequest -> Api.Request Api.Data.PostWebsiteMigration200Response
postWebsiteMigration id_path postWebsiteMigrationRequest_body =
    Api.request
        "POST"
        ...
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodePostWebsiteMigrationRequest postWebsiteMigrationRequest_body)))
        Api.Data.postWebsiteMigration200ResponseDecoder
...
-}
postWebsitesReverseDns : Int -> Api.Data.ReverseDnsEntries -> Api.Request Api.Data.TextResponse
postWebsitesReverseDns id_path reverseDnsEntries_body =
    Api.request
        "POST"
        "/websites/{id}/reverse_dns"
        [ ( "id", String.fromInt id_path ) ]
...
-}
putWebsites : Api.Data.WebsiteOrderPutRequest -> Api.Request ()
putWebsites websiteOrderPutRequest_body =
    Api.request
        "PUT"
        "/websites/order"
        []
        []
        []
        (Maybe.map Http.jsonBody (Just (Api.Data.encodeWebsiteOrderPutRequest websiteOrderPutRequest_body)))
        (Json.Decode.succeed ())
...
-}
updateWebsiteInfo : String -> Api.Request Api.Data.SuccessTextResponse
updateWebsiteInfo id_path =
    Api.request
        "POST"
        "/websites/{id}"
        [ ( "id", identity id_path ) ]
...
-}
webhostingCancel : String -> Api.Request Api.Data.WebhostingCancel200Response
webhostingCancel id_path =
    Api.request
        "DELETE"
        "/websites/{id}"
        [ ( "id", identity id_path ) ]
        ...
        []
        Nothing
        Api.Data.webhostingCancel200ResponseDecoder
