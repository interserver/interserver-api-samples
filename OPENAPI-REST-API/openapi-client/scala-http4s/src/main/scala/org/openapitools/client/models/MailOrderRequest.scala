...
object MailOrderRequest {
  given encoderMailOrderRequest: Encoder[MailOrderRequest] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderMailOrderRequest: Decoder[MailOrderRequest] = Decoder.instance { c =>
    for {
