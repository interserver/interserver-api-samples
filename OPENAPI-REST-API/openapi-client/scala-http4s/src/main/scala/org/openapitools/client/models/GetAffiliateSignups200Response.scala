...
object GetAffiliateSignups200Response {
  given encoderGetAffiliateSignups200Response: Encoder[GetAffiliateSignups200Response] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderGetAffiliateSignups200Response: Decoder[GetAffiliateSignups200Response] = Decoder.instance { c =>
    for {
      data <- c.downField("data").as[Option[Json]]
    } yield GetAffiliateSignups200Response(
      data = data
    )
  }
}
