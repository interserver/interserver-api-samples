...
object WebsiteOrderPutRequest {
  given encoderWebsiteOrderPutRequest: Encoder[WebsiteOrderPutRequest] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderWebsiteOrderPutRequest: Decoder[WebsiteOrderPutRequest] = Decoder.instance { c =>
    for {
