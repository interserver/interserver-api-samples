...
/**
 * serverBulkIpmiPowerGet - parameters interface
 */
export interface IServerBulkIpmiPowerGetParams {
  ids: string;
}
...
export class ServersApi extends Api {
   ...
   * @param params.serverOrderPostRequest 
   */
  async addServer(params: IAddServerParams): Promise<AddServer200Response> {
    // Verify required parameters are set
    this.ensureParamIsSet('addServer', params, 'serverOrderPostRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      .withContent(JSON.stringify(params['serverOrderPostRequest'] || {}))
   ...
   * @param params.ids Comma-separated list of Server IDs to query (e.g. &#x60;2313,2314,2315&#x60;). May also be passed as repeated &#x60;ids[]&#x60; query parameters.
   */
  async serverBulkIpmiPowerGet(params: IServerBulkIpmiPowerGetParams): Promise<ServerBulkIpmiPowerResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('serverBulkIpmiPowerGet', params, 'ids');

    // Create URL to call
    const url = `${this.basePath}/servers/bulk/ipmi_power`;
