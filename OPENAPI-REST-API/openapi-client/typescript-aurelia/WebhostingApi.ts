...
export class WebhostingApi extends Api {
   ...
   * @param params.websiteOrderPostRequest 
   */
  async addWebsite(params: IAddWebsiteParams): Promise<ServiceOrderPostResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('addWebsite', params, 'websiteOrderPostRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      .withContent(JSON.stringify(params['websiteOrderPostRequest'] || {}))
   ...
   * @param params.websiteOrderPutRequest 
   */
  async putWebsites(params: IPutWebsitesParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('putWebsites', params, 'websiteOrderPutRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      // Encode body parameter
      .withHeader('content-type', 'application/json')
      .withContent(JSON.stringify(params['websiteOrderPutRequest'] || {}))
