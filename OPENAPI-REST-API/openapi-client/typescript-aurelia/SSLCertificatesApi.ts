...
export class SSLCertificatesApi extends Api {
   ...
   * @param params.sslOrderRequest 
   */
  async addSsl(params: IAddSslParams): Promise<ServiceOrderPostResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('addSsl', params, 'sslOrderRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      .withContent(JSON.stringify(params['sslOrderRequest'] || {}))
   ...
   * @param params.sslOrderRequest 
   */
  async putSsl(params: IPutSslParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('putSsl', params, 'sslOrderRequest');
