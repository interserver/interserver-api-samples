...
/**
 * getAccountCurrencies - parameters interface
 */
export interface IGetAccountCurrenciesParams {
}

/**
 * getAccountLocales - parameters interface
 */
export interface IGetAccountLocalesParams {
}
...
export class PublicApi extends Api {
   ...
   */
  async getAccountCurrencies(): Promise<Array<string>> {
    // Verify required parameters are set

    // Create URL to call
    const url = `${this.basePath}/account/currencies`;
   ...
   */
  async getAccountLocales(): Promise<{ [key: string]: GetAccountLocales200ResponseValue; }> {
    // Verify required parameters are set

    // Create URL to call
    const url = `${this.basePath}/account/locales`;
