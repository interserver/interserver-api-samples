...
/**
 * getVpsBackup - parameters interface
 */
export interface IGetVpsBackupParams {
  id: number;
}
...
/**
 * getVpsChangeHostname - parameters interface
 */
export interface IGetVpsChangeHostnameParams {
  id: number;
}

/**
 * getVpsChangeRootPassword - parameters interface
 */
export interface IGetVpsChangeRootPasswordParams {
  id: number;
}
...
/**
 * getVpsInsertCd - parameters interface
 */
export interface IGetVpsInsertCdParams {
  id: number;
}
...
/**
 * getVpsResetPassword - parameters interface
 */
export interface IGetVpsResetPasswordParams {
  id: number;
}
...
/**
 * postVpsTrafficUsage - parameters interface
 */
export interface IPostVpsTrafficUsageParams {
  id: number;
}
...
/**
 * putVpsBuyHdSpace - parameters interface
 */
export interface IPutVpsBuyHdSpaceParams {
  id: number;
}
...
export class VPSApi extends Api {
   ...
   * @param params.id VPS ID number
   */
  async getVpsBackup(params: IGetVpsBackupParams): Promise<QueueResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('getVpsBackup', params, 'id');
   ...
   * @param params.id VPS ID number
   */
  async getVpsChangeHostname(params: IGetVpsChangeHostnameParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('getVpsChangeHostname', params, 'id');
   ...
   * @param params.id VPS ID number
   */
  async getVpsChangeRootPassword(params: IGetVpsChangeRootPasswordParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('getVpsChangeRootPassword', params, 'id');
   ...
   * @param params.id VPS ID number
   */
  async getVpsInsertCd(params: IGetVpsInsertCdParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('getVpsInsertCd', params, 'id');
   ...
   * @param params.id VPS ID number
   */
  async getVpsResetPassword(params: IGetVpsResetPasswordParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('getVpsResetPassword', params, 'id');
   ...
   * @param params.id VPS ID number
   */
  async postVpsTrafficUsage(params: IPostVpsTrafficUsageParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('postVpsTrafficUsage', params, 'id');
   ...
   * @param params.id VPS ID number
   */
  async putVpsBuyHdSpace(params: IPutVpsBuyHdSpaceParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('putVpsBuyHdSpace', params, 'id');
