...
/**
 * getQsBackup - parameters interface
 */
export interface IGetQsBackupParams {
  id: number;
}
...
export class QuickServersApi extends Api {
   ...
   * @param params.qsOrderRequest 
   */
  async addQs(params: IAddQsParams): Promise<ServiceOrderPostResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('addQs', params, 'qsOrderRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      .withContent(JSON.stringify(params['qsOrderRequest'] || {}))
   ...
   * @param params.id QuickServer ID number
   */
  async getQsBackup(params: IGetQsBackupParams): Promise<QueueResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('getQsBackup', params, 'id');
   ...
   * @param params.qsOrderRequest 
   */
  async putQs(params: IPutQsParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('putQs', params, 'qsOrderRequest');
