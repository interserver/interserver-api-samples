...
export class LicensesApi extends Api {
   ...
   * @param params.licenseOrderRequest 
   */
  async addLicense(params: IAddLicenseParams): Promise<ServiceOrderPostResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('addLicense', params, 'licenseOrderRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      .withContent(JSON.stringify(params['licenseOrderRequest'] || {}))
   ...
   * @param params.licenseOrderRequest 
   */
  async putLicenses(params: IPutLicensesParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('putLicenses', params, 'licenseOrderRequest');
