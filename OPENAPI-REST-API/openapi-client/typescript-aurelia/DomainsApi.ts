...
/**
 * postDomainSearch - parameters interface
 */
export interface IPostDomainSearchParams {
  name: string;
}
...
export class DomainsApi extends Api {
   ...
   * @param params.domainOrderRequest 
   */
  async addDomain(params: IAddDomainParams): Promise<ServiceOrderPostResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('addDomain', params, 'domainOrderRequest');
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      .withContent(JSON.stringify(params['domainOrderRequest'] || {}))
   ...
   * @param params.domainOrderRequest 
   */
  async patchDomains(params: IPatchDomainsParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('patchDomains', params, 'domainOrderRequest');
   ...
   * @param params.name The base domain name to search (for example &#x60;example&#x60; or &#x60;example.com&#x60;).
   */
  async postDomainSearch(params: IPostDomainSearchParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('postDomainSearch', params, 'name');
   ...
   * @param params.domainOrderRequest 
   */
  async putDomains(params: IPutDomainsParams): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('putDomains', params, 'domainOrderRequest');
