...
```bash
interserver-api deleteAccountOauthName name=value
```
...
```bash
interserver-api deleteAccountTfa
```
...
```bash
interserver-api getAccountInfo
```
...
```bash
interserver-api getAccountTfaSetup
```
...
```bash
interserver-api logoutAccountOauth name=value
```
...
```bash
interserver-api updateAccountApiKey
```
...
```bash
interserver-api updateAccountFeatures
```
...
```bash
interserver-api updateAccountInfo
```
...
```bash
interserver-api updateAccountIpLimits
```
...
```bash
interserver-api updateAccountPassword
```
...
```bash
interserver-api updateAccountSshKey
```
...
```bash
interserver-api updateAccountTfa
```
