...
```bash
interserver-api getSslInfo id=value
```
...
```bash
interserver-api getSslInvoices id=value
```
...
```bash
interserver-api getSslWelcomeEmail id=value
```
...
```bash
interserver-api sslCancel id=value
```
...
```bash
interserver-api updateSslInfo id=value
```
