...
```bash
interserver-api cancelScrubIp id=value
```
...
```bash
interserver-api disableScrub id=value
```
...
```bash
interserver-api enableScrub id=value
```
...
```bash
interserver-api getOrderDetail
```
...
```bash
interserver-api getScrubIpDetails id=value
```
...
```bash
interserver-api getScrubIpFilterTypes
```
...
```bash
interserver-api getScrubIpInvoices id=value
```
...
```bash
interserver-api getScrubIpLogs id=value
```
...
```bash
interserver-api getScrubIpsList
```
...
```bash
interserver-api placeScrubOrder '{
  "service_type" : 102,
  "ip" : "1.2.3.4"
}'
```
...
```bash
interserver-api scrubIpsDeleteGeoRule id=value
```
...
```bash
interserver-api scrubIpsDeleteRule id=value
```
