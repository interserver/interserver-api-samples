...
```bash
interserver-api buyItNowServerOrder
```
...
```bash
interserver-api getServerInfo id=value
```
...
```bash
interserver-api getServerInvoices id=value
```
...
```bash
interserver-api getServerReverseDns id=value
```
...
```bash
interserver-api getServersWelcomeEmail id=value
```
...
```bash
interserver-api placeBuyNowServer
```
...
```bash
interserver-api postServerReverseDns '{
  "ips" : {
...
```bash
interserver-api serverBulkIpmiPowerGet  ids=value
```
...
```bash
interserver-api serverIpmiLiveGet id=value
```
...
```bash
interserver-api serverIpmiLivePost id=value
```
...
```bash
interserver-api serverIpmiPowerGet id=value
```
...
```bash
interserver-api serverIpmiPowerPost id=value
```
...
```bash
interserver-api serversCancel id=value
```
...
```bash
interserver-api updateServerInfo id=value
```
