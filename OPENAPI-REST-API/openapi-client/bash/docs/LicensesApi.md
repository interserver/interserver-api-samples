...
```bash
interserver-api getLicenseInfo id=value
```
...
```bash
interserver-api getLicenseInvoices id=value
```
...
```bash
interserver-api getLicenseList
```
...
```bash
interserver-api getLicensesWelcomeEmail id=value
```
...
```bash
interserver-api licensesCancel id=value
```
...
```bash
interserver-api postLicenseChangeIp '{
  "ip" : "1.2.3.4"
}' id=value
```
...
```bash
interserver-api updateLicenseInfo id=value
```
