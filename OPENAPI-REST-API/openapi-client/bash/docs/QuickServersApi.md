...
```bash
interserver-api deleteQsBackup id=value  file=value  all=value
```
...
```bash
interserver-api doQsBlockSmtp id=value
```
...
```bash
interserver-api doQsDisableCd id=value
```
...
```bash
interserver-api doQsDisableQuota id=value
```
...
```bash
interserver-api doQsEjectCd id=value
```
...
```bash
interserver-api doQsEnableQuota id=value
```
...
```bash
interserver-api doQsRestart id=value
```
...
```bash
interserver-api doQsStart id=value
```
...
```bash
interserver-api doQsStop id=value
```
...
```bash
interserver-api downloadQsBackup id=value  all=value
```
...
```bash
interserver-api getQsBackup id=value
```
...
```bash
interserver-api getQsBackups id=value  all=value
```
...
```bash
interserver-api getQsChangeHostname id=value
```
...
```bash
interserver-api getQsChangeRootPassword id=value
```
...
```bash
interserver-api getQsChangeTimezone id=value
```
...
```bash
interserver-api getQsChangeWebuzoPassword id=value
```
...
```bash
interserver-api getQsInfo id=value
```
...
```bash
interserver-api getQsInsertCd id=value
```
...
```bash
interserver-api getQsInvoices id=value
```
...
```bash
interserver-api getQsReinstallOs id=value
```
...
```bash
interserver-api getQsResetPassword id=value
```
...
```bash
interserver-api getQsReverseDns id=value
```
...
```bash
interserver-api getQsSetupVnc id=value
```
...
```bash
interserver-api getQsTrafficUsage id=value
```
...
```bash
interserver-api getQsViewDesktop id=value
```
...
```bash
interserver-api getQsWelcomeEmail id=value
```
...
```bash
interserver-api postQsChangeHostname id=value
```
...
```bash
interserver-api postQsChangeRootPassword id=value
```
...
```bash
interserver-api postQsChangeTimezone id=value
```
...
```bash
interserver-api postQsChangeWebuzoPassword id=value
```
...
```bash
interserver-api postQsInsertCd id=value
```
...
```bash
interserver-api postQsReinstallOs id=value
```
...
```bash
interserver-api postQsResetPassword id=value
```
...
```bash
interserver-api postQsReverseDns '{
  "ips" : {
...
```bash
interserver-api postQsSetupVnc id=value
```
...
```bash
interserver-api postQsTrafficUsage id=value
```
...
```bash
interserver-api postQsViewDesktop id=value
```
...
```bash
interserver-api postQuickServerRestore '{
...
```bash
interserver-api quickserversCancel id=value
```
...
```bash
interserver-api updateQsInfo id=value
```
