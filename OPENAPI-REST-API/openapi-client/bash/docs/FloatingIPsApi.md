...
```bash
interserver-api floatingIpsCancel id=value
```
...
```bash
interserver-api getFloatingIpInfo id=value
```
...
```bash
interserver-api getFloatingIpInvoices id=value
```
...
```bash
interserver-api getFloatingIpsList
```
...
```bash
interserver-api getFloatingIpsWelcomeEmail id=value
```
...
```bash
interserver-api getNewFloatingIp
```
...
```bash
interserver-api postFloatingIpsChangeIp id=value
```
...
```bash
interserver-api putFloatingIps '{
  "serviceType" : 0,
  "coupon" : "",
  "comment" : ""
}'
...
```bash
interserver-api updateFloatingIpInfo id=value
```
