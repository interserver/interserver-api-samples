...
```php
addWebsite($websiteOrderPostRequest): \Interserver\\MyAdmin\Model\ServiceOrderPostResponse
```
...
$websiteOrderPostRequest = new \Interserver\\MyAdmin\Model\WebsiteOrderPostRequest(); // \Interserver\\MyAdmin\Model\WebsiteOrderPostRequest

try {
    $result = $apiInstance->addWebsite($websiteOrderPostRequest);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **websiteOrderPostRequest** | [**\Interserver\\MyAdmin\Model\WebsiteOrderPostRequest**](../Model/WebsiteOrderPostRequest.md)|  |
...
$websiteOrderPutRequest = new \Interserver\\MyAdmin\Model\WebsiteOrderPutRequest(); // \Interserver\\MyAdmin\Model\WebsiteOrderPutRequest
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **websiteOrderPutRequest** | [**\Interserver\\MyAdmin\Model\WebsiteOrderPutRequest**](../Model/WebsiteOrderPutRequest.md)|  |
