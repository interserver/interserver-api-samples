...
```php
addLicense($licenseOrderRequest): \Interserver\\MyAdmin\Model\ServiceOrderPostResponse
```
...
$licenseOrderRequest = new \Interserver\\MyAdmin\Model\LicenseOrderRequest(); // \Interserver\\MyAdmin\Model\LicenseOrderRequest

try {
    $result = $apiInstance->addLicense($licenseOrderRequest);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **licenseOrderRequest** | [**\Interserver\\MyAdmin\Model\LicenseOrderRequest**](../Model/LicenseOrderRequest.md)|  |
