...
class TicketPostDetailsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CREATOR_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    public function getCreatorAllowableValues()
    {
        return [
            self::CREATOR_USER,
            self::CREATOR_STAFF,
            self::CREATOR_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    public function setCreator($creator)
    {
        ...
        if (!in_array($creator, $allowedValues, true)) {
            $creator = self::CREATOR_UNKNOWN_DEFAULT_OPEN_API;
        }
