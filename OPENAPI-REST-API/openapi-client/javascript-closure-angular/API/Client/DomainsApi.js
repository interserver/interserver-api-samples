...
goog.require('API.Client.DomainOrderRequest');
 ...
 */
API.Client.DomainsApi.prototype.addDomain = function(domainOrderRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  // verify required parameter 'domainOrderRequest' is set
  if (!domainOrderRequest) {
    throw new Error('Missing required parameter domainOrderRequest when calling addDomain');
  }
  /** @type {!Object} */
 ...
 * @return {!angular.$q.Promise<!API.Client.SuccessTextResponse>}
 */
API.Client.DomainsApi.prototype.deleteDomainDnssec = function(id, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/domains/{id}/dnssec'
      .replace('{id}', String(id));
 ...
 */
API.Client.DomainsApi.prototype.patchDomains = function(domainOrderRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/domains/order';
  ...
  // verify required parameter 'domainOrderRequest' is set
  if (!domainOrderRequest) {
    throw new Error('Missing required parameter domainOrderRequest when calling patchDomains');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'PATCH',
 ...
 * @return {!angular.$q.Promise}
 */
API.Client.DomainsApi.prototype.postDomainSearch = function(name, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/domains/search/{name}'
      .replace('{name}', String(name));
  ...
  // verify required parameter 'name' is set
  if (!name) {
    throw new Error('Missing required parameter name when calling postDomainSearch');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'POST',
 ...
 * @return {!angular.$q.Promise}
 */
API.Client.DomainsApi.prototype.putDomains = function(domainOrderRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/domains/order';
  ...
  // verify required parameter 'domainOrderRequest' is set
  if (!domainOrderRequest) {
    throw new Error('Missing required parameter domainOrderRequest when calling putDomains');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'PUT',
