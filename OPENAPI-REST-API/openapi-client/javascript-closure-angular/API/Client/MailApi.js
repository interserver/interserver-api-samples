...
goog.require('API.Client.DeleteMailAlertRequest');
...
goog.require('API.Client.MailOrderRequest');
...
goog.require('API.Client.deleteMailAlert_request');
 ...
 */
API.Client.MailApi.prototype.addMail = function(mailOrderRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  // verify required parameter 'mailOrderRequest' is set
  if (!mailOrderRequest) {
    throw new Error('Missing required parameter mailOrderRequest when calling addMail');
  }
  /** @type {!Object} */
 ...
 * @return {!angular.$q.Promise<!API.Client.SuccessTextResponse>}
 */
API.Client.MailApi.prototype.deleteMailAlert = function(id, deleteMailAlertRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/mail/{id}/alerts'
      .replace('{id}', String(id));
  ...
  // verify required parameter 'deleteMailAlertRequest' is set
  if (!deleteMailAlertRequest) {
    throw new Error('Missing required parameter deleteMailAlertRequest when calling deleteMailAlert');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'DELETE',
 ...
 */
API.Client.MailApi.prototype.putMail = function(mailOrderRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/mail/order';
  ...
  // verify required parameter 'mailOrderRequest' is set
  if (!mailOrderRequest) {
    throw new Error('Missing required parameter mailOrderRequest when calling putMail');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'PUT',
 ...
 * @return {!angular.$q.Promise<!API.Client.GenericResponse>}
 */
API.Client.MailApi.prototype.updateRule = function(id, rule, denyRuleNew, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/mail/{id}/rules/{rule}'
      .replace('{id}', String(id))
      .replace('{rule}', String(rule));
  ...
  // verify required parameter 'id' is set
  if (!id) {
    throw new Error('Missing required parameter id when calling updateRule');
  }
  // verify required parameter 'rule' is set
  if (!rule) {
    throw new Error('Missing required parameter rule when calling updateRule');
  }
  // verify required parameter 'denyRuleNew' is set
  if (!denyRuleNew) {
    throw new Error('Missing required parameter denyRuleNew when calling updateRule');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'PUT',
