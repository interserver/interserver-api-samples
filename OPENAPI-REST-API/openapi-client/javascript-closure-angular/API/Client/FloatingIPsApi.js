...
goog.require('API.Client.FloatingIpOrderRequest');
 ...
 */
API.Client.FloatingIPsApi.prototype.addFloatingIp = function(floatingIpOrderRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  // verify required parameter 'floatingIpOrderRequest' is set
  if (!floatingIpOrderRequest) {
    throw new Error('Missing required parameter floatingIpOrderRequest when calling addFloatingIp');
  }
  /** @type {!Object} */
 ...
 */
API.Client.FloatingIPsApi.prototype.putFloatingIps = function(floatingIpOrderRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/floating_ips/order';
  ...
  // verify required parameter 'floatingIpOrderRequest' is set
  if (!floatingIpOrderRequest) {
    throw new Error('Missing required parameter floatingIpOrderRequest when calling putFloatingIps');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'PUT',
