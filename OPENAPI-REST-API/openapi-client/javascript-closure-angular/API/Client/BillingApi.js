...
goog.require('API.Client.PatchBillingCreditCardVerifyRequest');
...
goog.require('API.Client.getAffiliateSignups_200_response');
goog.require('API.Client.initiatePayment_200_response');
goog.require('API.Client.patchBillingCreditCardVerify_request');
 ...
 * @param {!string=} opt_st Filter by status.
 * @param {!string=} opt_ex Export format: csv, xls, xlsx, or pdf. Defaults to csv.
 * @param {!number=} opt_year Year to filter the report. Defaults to the current year.
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise}
 */
API.Client.BillingApi.prototype.getAffiliateDownload = function(opt_st, opt_ex, opt_year, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/affiliate/download';
  ...
  var headerParams = angular.extend({}, this.defaultHeaders_);
  if (opt_st !== undefined) {
    queryParameters['st'] = opt_st;
  }

  if (opt_ex !== undefined) {
    queryParameters['ex'] = opt_ex;
  }

  if (opt_year !== undefined) {
    queryParameters['year'] = opt_year;
  }
 ...
 * @param {!string=} opt_st Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results.
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.getAffiliateSignups_200_response>}
 */
API.Client.BillingApi.prototype.getAffiliateSignups = function(opt_st, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/affiliate/signups';
...
API.Client.BillingApi.prototype.initiatePayment = function(method, invoices, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/billing/pay/{method}/{invoices}'
 ...
 * @return {!angular.$q.Promise<!API.Client.SuccessTextResponse>}
 */
API.Client.BillingApi.prototype.patchBillingCreditCardVerify = function(id, patchBillingCreditCardVerifyRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/billing/creditcards/{id}/verify'
      .replace('{id}', String(id));
  ...
  // verify required parameter 'id' is set
  if (!id) {
    throw new Error('Missing required parameter id when calling patchBillingCreditCardVerify');
  }
  // verify required parameter 'patchBillingCreditCardVerifyRequest' is set
  if (!patchBillingCreditCardVerifyRequest) {
    throw new Error('Missing required parameter patchBillingCreditCardVerifyRequest when calling patchBillingCreditCardVerify');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'PATCH',
    url: path,
    json: true,
    data: patchBillingCreditCardVerifyRequest,
        params: queryParameters,
    headers: headerParams
  };
