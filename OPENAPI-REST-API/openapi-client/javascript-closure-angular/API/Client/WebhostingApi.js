...
goog.require('API.Client.WebsiteOrderPostRequest');
goog.require('API.Client.WebsiteOrderPutRequest');
 ...
 */
API.Client.WebhostingApi.prototype.addWebsite = function(websiteOrderPostRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  // verify required parameter 'websiteOrderPostRequest' is set
  if (!websiteOrderPostRequest) {
    throw new Error('Missing required parameter websiteOrderPostRequest when calling addWebsite');
  }
  /** @type {!Object} */
 ...
 */
API.Client.WebhostingApi.prototype.putWebsites = function(websiteOrderPutRequest, opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/websites/order';
  ...
  /** @type {!Object} */
  var headerParams = angular.extend({}, this.defaultHeaders_);
  // verify required parameter 'websiteOrderPutRequest' is set
  if (!websiteOrderPutRequest) {
    throw new Error('Missing required parameter websiteOrderPutRequest when calling putWebsites');
  }
  /** @type {!Object} */
  var httpRequestParams = {
    method: 'PUT',
