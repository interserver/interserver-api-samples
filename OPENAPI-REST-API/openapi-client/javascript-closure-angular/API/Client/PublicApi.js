...
goog.require('API.Client.getAccountLocales_200_response_value');
 ...
 */
API.Client.PublicApi.prototype.getAccountCurrencies = function(opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/account/currencies';
 ...
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!Object<!string, API.Client.getAccountLocales_200_response_value>>}
 */
API.Client.PublicApi.prototype.getAccountLocales = function(opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/account/locales';
