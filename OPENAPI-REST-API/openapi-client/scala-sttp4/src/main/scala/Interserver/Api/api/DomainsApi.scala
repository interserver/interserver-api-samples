...
import Interserver.Api.model.CancelDomain200Response
import Interserver.Api.model.ChargeInvoiceRows
import Interserver.Api.model.Domain
import Interserver.Api.model.DomainContactDetails
import Interserver.Api.model.DomainDnssecRecords
import Interserver.Api.model.DomainDnssecRequest
import Interserver.Api.model.DomainLookupResponse
import Interserver.Api.model.DomainNameserverGetResponse
import Interserver.Api.model.DomainNameserverPostRequest
import Interserver.Api.model.DomainNameserverPutRequest
import Interserver.Api.model.DomainOrder
import Interserver.Api.model.DomainOrderRequest
import Interserver.Api.model.DomainRow
import Interserver.Api.model.DomainSearchResponse
import Interserver.Api.model.DomainWhoisPrivacyRequest
...
class DomainsApi(baseUrl: String) {
   ...
   */
  def addDomain(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(domainOrderRequest: DomainOrderRequest): Request[Either[ResponseException[String], ServiceOrderPostResponse]] =
    basicRequest
      ...
      .body(asJson(domainOrderRequest))
   ...
   */
  def addDomainDnssec(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, domainDnssecRequest: DomainDnssecRequest): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def addDomainNameserver(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, domainNameserverPostRequest: DomainNameserverPostRequest): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def cancelDomain(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], CancelDomain200Response]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def deleteDomainDnssec(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/domains/${id}/dnssec")
      .contentType("application/json")
      .cookie("sessionid", apiKeyCookie)
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
   ...
   */
  def deleteDomainNameserver(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, index: Int): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def getDomainContact(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], DomainContactDetails]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def getDomainDnssec(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], DomainDnssecRecords]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def getDomainInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], Domain]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def getDomainInvoices(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], ChargeInvoiceRows]] =
    basicRequest
   ...
   */
  def getDomainLookup(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(name: String): Request[Either[ResponseException[String], DomainLookupResponse]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def getDomainNameservers(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], DomainNameserverGetResponse]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def getDomainRenewal(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def getDomainSearch(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(name: String): Request[Either[ResponseException[String], DomainSearchResponse]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def getDomainTransfer(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def getDomainWhoisPrivacy(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getDomainsList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[DomainRow]]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def getDomainsWelcomeEmail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getNewDomain(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], DomainOrder]] =
    basicRequest
   ...
   * @param domainOrderRequest 
   */
  def patchDomains(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(domainOrderRequest: DomainOrderRequest): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def postDomainRenewal(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 :  (Domain availability and pricing check results.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   * @param name The base domain name to search (for example `example` or `example.com`).
   */
  def postDomainSearch(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(name: String): Request[Either[ResponseException[String], Unit]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/domains/search/${name}")
      .contentType("application/json")
      .cookie("sessionid", apiKeyCookie)
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def postDomainTransfer(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   * @param domainOrderRequest 
   */
  def putDomains(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(domainOrderRequest: DomainOrderRequest): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   */
  def updateDomainContact(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, domainContactDetails: DomainContactDetails): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   * @param id The domain service ID. Use `domain_id` from `GET /domains`.
   */
  def updateDomainInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def updateDomainNameservers(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, domainNameserverPutRequest: DomainNameserverPutRequest): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
   ...
   */
  def updateDomainWhoisPrivacy(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, domainWhoisPrivacyRequest: DomainWhoisPrivacyRequest): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
