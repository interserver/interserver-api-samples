...
import Interserver.Api.model.FloatingIpOrderRequest
import Interserver.Api.model.FloatingIpsCancel200Response
...
class FloatingIPsApi(baseUrl: String) {
   ...
   */
  def addFloatingIp(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(floatingIpOrderRequest: FloatingIpOrderRequest): Request[Either[ResponseException[String], ServiceOrderPostResponse]] =
    basicRequest
      ...
      .body(asJson(floatingIpOrderRequest))
   ...
   */
  def floatingIpsCancel(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], FloatingIpsCancel200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : org.json4s.JObject (Detailed Floating IP service information.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   * @param id The Floating IP service ID. Use the ID from `GET /floating_ips`.
   */
  def getFloatingIpInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], org.json4s.JObject]] =
    basicRequest
   ...
   * @param id The Floating IP service ID. Use the ID from `GET /floating_ips`.
   */
  def getFloatingIpInvoices(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], ChargeInvoiceRows]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : Seq[org.json4s.JObject] (The listing of `Floating IPs` services on your account.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getFloatingIpsList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[org.json4s.JObject]]] =
    basicRequest
      ...
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
      .response(asJson[Seq[org.json4s.JObject]])
   ...
   * @param id The Floating IP service ID. Use the ID from `GET /floating_ips`.
   */
  def getFloatingIpsWelcomeEmail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : org.json4s.JObject (Available options and pricing for ordering a Floating IP.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getNewFloatingIp(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], org.json4s.JObject]] =
    basicRequest
   ...
   * @param ip IP Address
   */
  def postFloatingIpsChangeIp(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, ip: String): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   * @param floatingIpOrderRequest 
   */
  def putFloatingIps(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(floatingIpOrderRequest: FloatingIpOrderRequest): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param id The Floating IP service ID. Use the ID from `GET /floating_ips`.
   */
  def updateFloatingIpInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
