...
import Interserver.Api.model.IpObject
import Interserver.Api.model.License
import Interserver.Api.model.LicenseOrderRequest
import Interserver.Api.model.LicenseRow
import Interserver.Api.model.LicensesCancel200Response
import Interserver.Api.model.LicensesOrder
...
class LicensesApi(baseUrl: String) {
   ...
   */
  def addLicense(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(licenseOrderRequest: LicenseOrderRequest): Request[Either[ResponseException[String], ServiceOrderPostResponse]] =
    basicRequest
   ...
   */
  def getLicenseInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], License]] =
    basicRequest
   ...
   * @param id The license service ID. Use `license_id` from `GET /licenses`.
   */
  def getLicenseInvoices(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], ChargeInvoiceRows]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getLicenseList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[LicenseRow]]] =
    basicRequest
   ...
   * @param id The license service ID. Use `license_id` from `GET /licenses`.
   */
  def getLicensesWelcomeEmail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getNewLicense(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], LicensesOrder]] =
    basicRequest
   ...
   * @param id The license service ID. Use `license_id` from `GET /licenses`.
   */
  def licensesCancel(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], LicensesCancel200Response]] =
    basicRequest
   ...
   * @param ipObject 
   */
  def postLicenseChangeIp(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, ipObject: IpObject): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   * @param licenseOrderRequest 
   */
  def putLicenses(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(licenseOrderRequest: LicenseOrderRequest): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param id The license service ID. Use `license_id` from `GET /licenses`.
   */
  def updateLicenseInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
