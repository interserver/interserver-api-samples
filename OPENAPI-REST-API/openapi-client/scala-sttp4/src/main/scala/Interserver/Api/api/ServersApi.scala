...
import Interserver.Api.model.AddServer200Response
import Interserver.Api.model.BuyItNowList
import Interserver.Api.model.BuyItNowServerOrder200Response
import Interserver.Api.model.ChargeInvoiceRows
import Interserver.Api.model.GetAccountInfo401Response
import Interserver.Api.model.PlaceBuyNowServerRequest
import Interserver.Api.model.ReverseDnsEntries
import Interserver.Api.model.Server
import Interserver.Api.model.ServerBulkIpmiPowerResponse
import Interserver.Api.model.ServerIpmiLiveInfo
import Interserver.Api.model.ServerOrder
import Interserver.Api.model.ServerOrderPostRequest
import Interserver.Api.model.ServerRow
import Interserver.Api.model.ServersBuyNowError
import Interserver.Api.model.ServersBuyNowResponse
import Interserver.Api.model.ServersCancel200Response
...
class ServersApi(baseUrl: String) {
   ...
   */
  def addServer(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(serverOrderPostRequest: ServerOrderPostRequest): Request[Either[ResponseException[String], AddServer200Response]] =
    basicRequest
      ...
      .body(asJson(serverOrderPostRequest))
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def buyItNowServerOrder(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], BuyItNowServerOrder200Response]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getMPServers(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], BuyItNowList]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getNewServer(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], ServerOrder]] =
    basicRequest
   ...
   */
  def getServerInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], Server]] =
    basicRequest
   ...
   * @param id Server ID number
   */
  def getServerInvoices(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], ChargeInvoiceRows]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getServerList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[ServerRow]]] =
    basicRequest
   ...
   * @param id Server ID number
   */
  def getServerReverseDns(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], ReverseDnsEntries]] =
    basicRequest
   ...
   * @param id Server ID number
   */
  def getServersWelcomeEmail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def placeBuyNowServer(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(placeBuyNowServerRequest: Option[PlaceBuyNowServerRequest] = None): Request[Either[ResponseException[String], ServersBuyNowResponse]] =
    basicRequest
   ...
   */
  def postServerReverseDns(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, reverseDnsEntries: ReverseDnsEntries): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : ServerBulkIpmiPowerResponse (Bulk IPMI power status response, one entry per requested server.)
   ...
   */
  def serverBulkIpmiPowerGet(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(ids: String): Request[Either[ResponseException[String], ServerBulkIpmiPowerResponse]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/servers/bulk/ipmi_power?ids=${ ids }")
      .contentType("application/json")
      .cookie("sessionid", apiKeyCookie)
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
      .response(asJson[ServerBulkIpmiPowerResponse])
   ...
   * @param id Server ID number
   */
  def serverIpmiLiveGet(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], ServerIpmiLiveInfo]] =
    basicRequest
   ...
   */
  def serverIpmiLivePost(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, ip: String, asset: Option[Int] = None): Request[Either[ResponseException[String], ServerIpmiLiveInfo]] =
    basicRequest
...
, 
   ...
   * @param id Server ID number
   */
  def serverIpmiPowerGet(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
   ...
   */
  def serverIpmiPowerPost(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, action: String, asset: Option[Int] = None): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
...
, 
   ...
   * @param id Server ID number
   */
  def serversCancel(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], ServersCancel200Response]] =
    basicRequest
   ...
   * @param id Server ID number.
   */
  def updateServerInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
