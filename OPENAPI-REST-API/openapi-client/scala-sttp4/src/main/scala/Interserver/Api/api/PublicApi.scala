...
import Interserver.Api.model.CaptchaResponse
import Interserver.Api.model.GetAccountInfo401Response
import Interserver.Api.model.GetAccountLocales200ResponseValue
import Interserver.Api.model.GetOauthRedirect200Response
import Interserver.Api.model.LoginErrorResponse
import Interserver.Api.model.LoginInfo
import Interserver.Api.model.LoginSubmissionExample
import Interserver.Api.model.LoginSubmissionExampleGRecaptchaResponse
import Interserver.Api.model.LoginSuccessResponse
import Interserver.Api.model.PatchOauthTwoFactor200Response
import Interserver.Api.model.PatchOauthTwoFactorRequest
import Interserver.Api.model.PostOauthCallback200Response
import Interserver.Api.model.PostOauthCallbackRequest
import Interserver.Api.model.ServicesInfo
...
class PublicApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : Seq[String] (An array of enabled currency codes.)
   ...
   */
  def getAccountCurrencies(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[String]]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/account/currencies")
   ...
   * 
   * Expected answers:
   *   code 200 : Map[String, GetAccountLocales200ResponseValue] (Map of locale identifiers to display names.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getAccountLocales(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Map[String, GetAccountLocales200ResponseValue]]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/account/locales")
      .contentType("application/json")
      .cookie("sessionid", apiKeyCookie)
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
      .response(asJson[Map[String, GetAccountLocales200ResponseValue]])
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getCaptcha(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], CaptchaResponse]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : org.json4s.JObject (The list of countries with both 2 letter abbreviations and the country names.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   */
  def getCountries(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(fetchBy: Option[String] = None): Request[Either[ResponseException[String], org.json4s.JObject]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], ServicesInfo]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getLoginInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], LoginInfo]] =
    basicRequest
   ...
   */
  def getOauthRedirect(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(provider: String): Request[Either[ResponseException[String], GetOauthRedirect200Response]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getTimezones(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[String]]] =
    basicRequest
   ...
   */
  def patchOauthTwoFactor(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(patchOauthTwoFactorRequest: PatchOauthTwoFactorRequest): Request[Either[ResponseException[String], PatchOauthTwoFactor200Response]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def pingServer(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], String]] =
    basicRequest
   ...
   */
  def postOauthCallback(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(provider: String, postOauthCallbackRequest: Option[PostOauthCallbackRequest] = None): Request[Either[ResponseException[String], PostOauthCallback200Response]] =
    basicRequest
   ...
   */
  def submitLogin(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(login: String, passwd: String, remember: Option[String] = None, gRecaptchaResponse: Option[LoginSubmissionExampleGRecaptchaResponse] = None, tfa: Option[String] = None): Request[Either[ResponseException[String], LoginSuccessResponse]] =
    basicRequest
...
, 
   ...
   */
  def submitSignup(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(loginSubmissionExample: Option[LoginSubmissionExample] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
