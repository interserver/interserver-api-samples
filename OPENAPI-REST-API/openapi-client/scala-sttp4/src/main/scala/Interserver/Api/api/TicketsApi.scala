...
import Interserver.Api.model.CloseTicketResponseSchema
import Interserver.Api.model.GetAccountInfo401Response
import Interserver.Api.model.ReplyTicketRequest
import Interserver.Api.model.ReplyTicketResponseSchema
import Interserver.Api.model.TicketNew
import Interserver.Api.model.TicketNewResponse
import Interserver.Api.model.Tickets
import Interserver.Api.model.UpdateTicket
import Interserver.Api.model.UpdateTicketResponseSchema
import Interserver.Api.model.ViewTicketResponse
...
class TicketsApi(baseUrl: String) {
   ...
   * @param ticketNew 
   */
  def addNewTicket(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(ticketNew: TicketNew): Request[Either[ResponseException[String], TicketNewResponse]] =
    basicRequest
   ...
   * @param id Ticket ID
   */
  def closeTicket(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String): Request[Either[ResponseException[String], CloseTicketResponseSchema]] =
    basicRequest
   ...
   */
  def deleteTicketInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Double): Request[Either[ResponseException[String], ViewTicketResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getNewTicket(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Unit]] =
    basicRequest
   ...
   * @param id Ticket ID number.
   */
  def getTicketInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Double): Request[Either[ResponseException[String], ViewTicketResponse]] =
    basicRequest
   ...
   */
  def getTicketsList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(page: Option[Int] = None, period: Option[String] = None, view: Option[String] = None): Request[Either[ResponseException[String], Tickets]] =
    basicRequest
   ...
   * @param id Ticket ID number.
   */
  def postTicketInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Double): Request[Either[ResponseException[String], ViewTicketResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def postTicketsList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Tickets]] =
    basicRequest
   ...
   * @param id Ticket ID number.
   */
  def putTicketInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Double): Request[Either[ResponseException[String], ViewTicketResponse]] =
    basicRequest
   ...
   */
  def replyTicket(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Double, replyTicketRequest: Option[ReplyTicketRequest] = None): Request[Either[ResponseException[String], ReplyTicketResponseSchema]] =
    basicRequest
   ...
   * @param updateTicket 
   */
  def updateTicketInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Double, updateTicket: Option[UpdateTicket] = None): Request[Either[ResponseException[String], UpdateTicketResponseSchema]] =
    basicRequest
