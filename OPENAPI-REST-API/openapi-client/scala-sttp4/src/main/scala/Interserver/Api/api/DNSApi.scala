...
import Interserver.Api.model.DnsListItem
import Interserver.Api.model.DnsRecord
import Interserver.Api.model.DnsRecordType._
...
class DNSApi(baseUrl: String) {
   ...
   */
  def addDnsDomain(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(domain: String, ip: String): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
...
, 
   ...
   * @param prio Priority
   */
  def addDnsRecord(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String, name: String, `type`: DnsRecordType, content: String, ttl: Option[Int] = None, prio: Option[Int] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
...
, 
   ...
   */
  def deleteDnsDomain(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def deleteDnsRecord(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(domainId: Int, recordId: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def getDnsDomain(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], Seq[DnsRecord]]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getDnsList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[DnsListItem]]] =
    basicRequest
   ...
   * @param auth 
   */
  def updateDnsRecord(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(domainId: Int, recordId: Int, name: Option[String] = None, `type`: Option[DnsRecordType] = None, content: Option[String] = None, ttl: Option[String] = None, prio: Option[String] = None, disabled: Option[String] = None, ordername: Option[String] = None, auth: Option[String] = None): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
