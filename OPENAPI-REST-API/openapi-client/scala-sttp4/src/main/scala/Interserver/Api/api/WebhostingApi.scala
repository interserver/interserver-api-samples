...
import Interserver.Api.model.GetWebsiteBuyIp200Response
import Interserver.Api.model.PostWebsiteBuyIp200Response
import Interserver.Api.model.PostWebsiteBuyIpRequest
import Interserver.Api.model.PostWebsiteMigration200Response
import Interserver.Api.model.PostWebsiteMigrationRequest
import Interserver.Api.model.PostWebsiteMigrationRequest1
...
import Interserver.Api.model.WebhostingCancel200Response
import Interserver.Api.model.Website
import Interserver.Api.model.WebsiteBackups
import Interserver.Api.model.WebsiteLoginResponse
import Interserver.Api.model.WebsiteOrderPostRequest
import Interserver.Api.model.WebsiteOrderPutRequest
import Interserver.Api.model.WebsiteRow
import Interserver.Api.model.WebsitesOrder
...
class WebhostingApi(baseUrl: String) {
   ...
   */
  def addWebsite(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(websiteOrderPostRequest: WebsiteOrderPostRequest): Request[Either[ResponseException[String], ServiceOrderPostResponse]] =
    basicRequest
      ...
      .body(asJson(websiteOrderPostRequest))
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getNewWebsite(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], WebsitesOrder]] =
    basicRequest
   ...
   */
  def getWebsiteBuyIp(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], GetWebsiteBuyIp200Response]] =
    basicRequest
   ...
   * @param id The website service ID. Use `website_id` from `GET /websites`.
   */
  def getWebsiteInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], Website]] =
    basicRequest
   ...
   * @param id The website service ID. Use `website_id` from `GET /websites`.
   */
  def getWebsiteInvoices(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], ChargeInvoiceRows]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getWebsiteList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[WebsiteRow]]] =
    basicRequest
   ...
   * @param id The website service ID. Use `website_id` from `GET /websites`.
   */
  def getWebsitesBackups(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], WebsiteBackups]] =
    basicRequest
   ...
   * @param id The website service ID. Use `website_id` from `GET /websites`.
   */
  def getWebsitesLogin(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], WebsiteLoginResponse]] =
    basicRequest
   ...
   * @param id The website service ID. Use `website_id` from `GET /websites`.
   */
  def getWebsitesWelcomeEmail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   * @param id The website service ID. Use `website_id` from `GET /websites`.
   */
  def gettWebsiteReverseDns(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], ReverseDnsEntries]] =
    basicRequest
   ...
   */
  def postWebsiteBuyIp(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, postWebsiteBuyIpRequest: PostWebsiteBuyIpRequest): Request[Either[ResponseException[String], PostWebsiteBuyIp200Response]] =
    basicRequest
   ...
   */
  def postWebsiteMigration(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, postWebsiteMigrationRequest: PostWebsiteMigrationRequest): Request[Either[ResponseException[String], PostWebsiteMigration200Response]] =
    basicRequest
   ...
   */
  def postWebsitesReverseDns(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, reverseDnsEntries: ReverseDnsEntries): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
   ...
   */
  def putWebsites(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(websiteOrderPutRequest: WebsiteOrderPutRequest): Request[Either[ResponseException[String], Unit]] =
    basicRequest
      ...
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
      .body(asJson(websiteOrderPutRequest))
   ...
   * @param id The website service ID. Use `website_id` from `GET /websites`.
   */
  def updateWebsiteInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   * @param id The website service ID. Use `website_id` from `GET /websites`.
   */
  def webhostingCancel(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String): Request[Either[ResponseException[String], WebhostingCancel200Response]] =
    basicRequest
