...
import Interserver.Api.model.AffiliateBannerRow
import Interserver.Api.model.AffiliateTrafficRow
import Interserver.Api.model.BillingAddCcRequest
import Interserver.Api.model.BillingInvoiceDetail
import Interserver.Api.model.BillingInvoiceList
import Interserver.Api.model.BillingPaymentMethodRequest
import Interserver.Api.model.BillingPrepayRequest
import Interserver.Api.model.BillingVerifyCcRequest
import Interserver.Api.model.GetAccountInfo401Response
import Interserver.Api.model.GetAffiliateSignups200Response
import Interserver.Api.model.InitiatePayment200Response
import Interserver.Api.model.MonthlyCounts
import Interserver.Api.model.PatchBillingCreditCardVerifyRequest
import Interserver.Api.model.StatusMonthlyBreakdown
...
class BillingApi(baseUrl: String) {
   ...
   */
  def addBillingCreditCard(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(billingAddCcRequest: BillingAddCcRequest): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def addBillingPrepay(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(billingPrepayRequest: BillingPrepayRequest): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def deleteBillingCreditCard(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def deleteBillingInvoice(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def deleteBillingPrepay(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getAffiliateBanners(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[AffiliateBannerRow]]] =
    basicRequest
   ...
   */
  def getAffiliateDownload(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(st: Option[String] = None, ex: Option[String] = None, year: Option[Int] = None): Request[Either[ResponseException[String], Unit]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/affiliate/download?st=${ st }&ex=${ ex }&year=${ year }")
      .contentType("application/json")
      .cookie("sessionid", apiKeyCookie)
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getAffiliateRichReport(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
   ...
   */
  def getAffiliateSalesGraph(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(days: Option[Int] = None): Request[Either[ResponseException[String], StatusMonthlyBreakdown]] =
    basicRequest
   ...
   */
  def getAffiliateSignups(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(st: Option[String] = None): Request[Either[ResponseException[String], GetAffiliateSignups200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/affiliate/signups?st=${ st }")
      .contentType("application/json")
      .cookie("sessionid", apiKeyCookie)
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
      .response(asJson[GetAffiliateSignups200Response])
   ...
   */
  def getAffiliateTrafficGraph(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(days: Option[Int] = None): Request[Either[ResponseException[String], MonthlyCounts]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getAffiliateWebTraffic(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], Seq[AffiliateTrafficRow]]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : org.json4s.JObject (Current shopping cart contents and available payment methods.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getBillingCart(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], org.json4s.JObject]] =
    basicRequest
   ...
   */
  def getBillingCreditCardVerify(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def getBillingInvoice(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], BillingInvoiceDetail]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getBillingInvoices(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], BillingInvoiceList]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : org.json4s.JObject (Prepay balances and metadata.)
   *   code 401 : GetAccountInfo401Response (Unauthorized)
   * 
   * Available security schemes:
   *   sessionIdCookieAuth (apiKey)
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getBillingPrePays(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String], org.json4s.JObject]] =
    basicRequest
   ...
   */
  def initiatePayment(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(method: String, invoices: String): Request[Either[ResponseException[String], InitiatePayment200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/billing/pay/${method}/${invoices}")
      .contentType("application/json")
      .cookie("sessionid", apiKeyCookie)
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
   ...
   */
  def patchBillingCreditCardVerify(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
      .method(Method.PATCH, uri"$baseUrl/billing/creditcards/${id}/verify")
      .contentType("application/json")
      .cookie("sessionid", apiKeyCookie)
      .header("X-API-KEY", apiKeyHeader)
      .header("sessionid", apiKeyHeader)
      .body(asJson(patchBillingCreditCardVerifyRequest))
      .response(asJson[SuccessTextResponse])
   ...
   */
  def postBillingCreditCardVerify(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, billingVerifyCcRequest: BillingVerifyCcRequest): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def updateAffiliateDockSetup(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(affiliateDockTitle: Option[String] = None, affiliateDockDescription: Option[String] = None, referrerCoupon: Option[String] = None): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
...
, 
   ...
   */
  def updateAffiliatePaymentSetup(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(affiliatePaypal: Option[String] = None, affiliatePaymentMethod: Option[String] = None): Request[Either[ResponseException[String], TextResponse]] =
    basicRequest
...
, 
   ...
   */
  def updateBillingCreditCard(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def updateBillingPaymentMethod(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(billingPaymentMethodRequest: BillingPaymentMethodRequest): Request[Either[ResponseException[String], SuccessTextResponse]] =
    basicRequest
