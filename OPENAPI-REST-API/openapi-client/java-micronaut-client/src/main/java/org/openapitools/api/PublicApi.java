...
public interface PublicApi {
     ...
     * @return List&lt;String&gt;
     */
    @Get(uri="/account/currencies")
    @Consumes({"application/json"})
    Mono<List<String>> getAccountCurrencies();
     ...
     */
    @Get(uri="/account/locales")
    @Consumes({"application/json"})
    Mono<Map<String, GetAccountLocales200ResponseValue>> getAccountLocales();
