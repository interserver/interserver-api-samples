 ...
 */
@JsonPropertyOrder({
  WebsiteOrderPutRequest.JSON_PROPERTY_HOSTNAME,
  WebsiteOrderPutRequest.JSON_PROPERTY_PACKAGE_ID,
  WebsiteOrderPutRequest.JSON_PROPERTY_ROOTPASS,
  WebsiteOrderPutRequest.JSON_PROPERTY_PERIOD,
  WebsiteOrderPutRequest.JSON_PROPERTY_COUPON,
  WebsiteOrderPutRequest.JSON_PROPERTY_SERVICE_OFFER_ID,
  WebsiteOrderPutRequest.JSON_PROPERTY_SCRIPT,
  WebsiteOrderPutRequest.JSON_PROPERTY_COMMENT,
  WebsiteOrderPutRequest.JSON_PROPERTY_REGISTER_DOMAIN
})
@JsonTypeName("WebsiteOrderPutRequest")
...
public class WebsiteOrderPutRequest {
    ...
    public WebsiteOrderPutRequest(String hostname, Integer packageId) {
