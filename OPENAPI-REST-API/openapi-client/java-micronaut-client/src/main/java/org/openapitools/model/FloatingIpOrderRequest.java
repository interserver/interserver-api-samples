 ...
 */
@JsonPropertyOrder({
  FloatingIpOrderRequest.JSON_PROPERTY_SERVICE_TYPE,
  FloatingIpOrderRequest.JSON_PROPERTY_COUPON,
  FloatingIpOrderRequest.JSON_PROPERTY_COMMENT
})
@JsonTypeName("FloatingIpOrderRequest")
...
public class FloatingIpOrderRequest {
    ...
    public FloatingIpOrderRequest(Integer serviceType) {
