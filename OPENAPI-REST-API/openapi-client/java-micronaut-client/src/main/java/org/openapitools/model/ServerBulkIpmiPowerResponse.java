 ...
 */
@JsonPropertyOrder({
  ServerBulkIpmiPowerResponse.JSON_PROPERTY_RESULTS
})
@JsonTypeName("ServerBulkIpmiPowerResponse")
...
public class ServerBulkIpmiPowerResponse {
    ...
    private List<@Valid ServerBulkIpmiPowerResponseResultsInner> results = new ArrayList<>();

    public ServerBulkIpmiPowerResponse(List<@Valid ServerBulkIpmiPowerResponseResultsInner> results) {
        this.results = results;
    }

    public ServerBulkIpmiPowerResponse results(List<@Valid ServerBulkIpmiPowerResponseResultsInner> results) {
        this.results = results;
        return this;
    }
    ...
    public List<@Valid ServerBulkIpmiPowerResponseResultsInner> getResults() {
        return results;
    }

    @JsonProperty(JSON_PROPERTY_RESULTS)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setResults(List<@Valid ServerBulkIpmiPowerResponseResultsInner> results) {
        this.results = results;
    }
