...
public interface ServersApi {
    ...
    Mono<AddServer200Response> addServer(
        @Body @NotNull @Valid ServerOrderPostRequest serverOrderPostRequest
    );
     ...
     */
    @Get(uri="/servers/bulk/ipmi_power")
    @Consumes({"application/json"})
    Mono<ServerBulkIpmiPowerResponse> serverBulkIpmiPowerGet(
        @QueryValue(value="ids") @NotNull String ids
    );
