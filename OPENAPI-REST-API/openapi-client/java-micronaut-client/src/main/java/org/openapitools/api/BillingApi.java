...
public interface BillingApi {
     ...
     */
    @Get(uri="/affiliate/download")
    @Consumes({"application/json"})
    Mono<Void> getAffiliateDownload(
        @QueryValue(value="st") @Nullable String st, 
        @QueryValue(value="ex") @Nullable String ex, 
        @QueryValue(value="year") @Nullable Integer year
    );
     ...
     */
    @Get(uri="/affiliate/signups")
    @Consumes({"application/json"})
    Mono<GetAffiliateSignups200Response> getAffiliateSignups(
        @QueryValue(value="st") @Nullable String st
    );
     ...
     */
    @Get(uri="/billing/pay/{method}/{invoices}")
    @Consumes({"application/json"})
     ...
     * @return SuccessTextResponse
     */
    @Patch(uri="/billing/creditcards/{id}/verify")
    @Consumes({"application/json"})
    @Produces({"application/json", "multipart/form-data"})
    Mono<SuccessTextResponse> patchBillingCreditCardVerify(
        @PathVariable(name="id") @NotNull Integer id, 
        @Body @NotNull @Valid PatchBillingCreditCardVerifyRequest patchBillingCreditCardVerifyRequest
    );
