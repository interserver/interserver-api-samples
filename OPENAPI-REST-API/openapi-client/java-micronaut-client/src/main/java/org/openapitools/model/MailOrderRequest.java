 ...
 */
@JsonPropertyOrder({
  MailOrderRequest.JSON_PROPERTY_SERVICE_TYPE,
  MailOrderRequest.JSON_PROPERTY_COUPON,
  MailOrderRequest.JSON_PROPERTY_COMMENT
})
@JsonTypeName("MailOrderRequest")
...
public class MailOrderRequest {
    ...
    public MailOrderRequest(Integer serviceType) {
