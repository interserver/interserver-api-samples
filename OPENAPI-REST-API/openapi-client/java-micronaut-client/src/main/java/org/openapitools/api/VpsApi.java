...
public interface VpsApi {
    ...
    @Consumes({"application/json"})
    Mono<QueueResponse> getVpsBackup(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @param id VPS ID number (required)
     */
    @Get(uri="/vps/{id}/change_hostname")
    @Consumes({"application/json"})
    Mono<Void> getVpsChangeHostname(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @param id VPS ID number (required)
     */
    @Get(uri="/vps/{id}/change_root_password")
    @Consumes({"application/json"})
    Mono<Void> getVpsChangeRootPassword(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @param id VPS ID number (required)
     */
    @Get(uri="/vps/{id}/insert_cd")
    @Consumes({"application/json"})
    Mono<Void> getVpsInsertCd(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @param id VPS ID number (required)
     */
    @Get(uri="/vps/{id}/reset_password")
    @Consumes({"application/json"})
    Mono<Void> getVpsResetPassword(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @param id VPS ID number (required)
     */
    @Post(uri="/vps/{id}/traffic_usage")
    @Consumes({"application/json"})
    Mono<Void> postVpsTrafficUsage(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @param id VPS ID number (required)
     */
    @Put(uri="/vps/{id}/buy_hd_space")
    @Consumes({"application/json"})
    Mono<Void> putVpsBuyHdSpace(
        @PathVariable(name="id") @NotNull Integer id
    );
