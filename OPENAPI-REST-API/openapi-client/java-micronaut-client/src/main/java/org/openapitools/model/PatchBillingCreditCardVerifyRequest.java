 ...
 */
@JsonPropertyOrder({
  PatchBillingCreditCardVerifyRequest.JSON_PROPERTY_CC_CCV2
})
@JsonTypeName("patchBillingCreditCardVerify_request")
...
public class PatchBillingCreditCardVerifyRequest {
    ...
    public PatchBillingCreditCardVerifyRequest(String ccCcv2) {
        this.ccCcv2 = ccCcv2;
    }
