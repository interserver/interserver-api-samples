...
public class ServersApiTest {
    ...
    public void addServerTest() {
        // given
        ServerOrderPostRequest serverOrderPostRequest = new ServerOrderPostRequest(56, null, 56, 56, 56, 56, 56, 56, 56, "example", "example", false);

        // when
        AddServer200Response body = api.addServer(serverOrderPostRequest).block();
    ...
    public void serverBulkIpmiPowerGetTest() {
        // given
        String ids = "2313,2314,2315";

        // when
        ServerBulkIpmiPowerResponse body = api.serverBulkIpmiPowerGet(ids).block();

        // then
        // TODO implement the serverBulkIpmiPowerGetTest()
    }
