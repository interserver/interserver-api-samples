...
public class BillingApiTest {
    ...
    public void getAffiliateDownloadTest() {
        ...
        // when
        api.getAffiliateDownload(st, ex, year).block();

        // then
        // TODO implement the getAffiliateDownloadTest()
    }
    ...
    public void getAffiliateSignupsTest() {
        ...
        // when
        GetAffiliateSignups200Response body = api.getAffiliateSignups(st).block();

        // then
        // TODO implement the getAffiliateSignupsTest()
    }
    ...
    public void patchBillingCreditCardVerifyTest() {
        // given
        Integer id = 56;
        PatchBillingCreditCardVerifyRequest patchBillingCreditCardVerifyRequest = new PatchBillingCreditCardVerifyRequest("example");

        // when
        SuccessTextResponse body = api.patchBillingCreditCardVerify(id, patchBillingCreditCardVerifyRequest).block();

        // then
        // TODO implement the patchBillingCreditCardVerifyTest()
    }
