...
public class VpsApiTest {
    ...
    public void getVpsBackupTest() {
        ...
        // when
        QueueResponse body = api.getVpsBackup(id).block();

        // then
        // TODO implement the getVpsBackupTest()
    }
    ...
    public void getVpsChangeHostnameTest() {
        ...
        // when
        api.getVpsChangeHostname(id).block();

        // then
        // TODO implement the getVpsChangeHostnameTest()
    }
    ...
    public void getVpsChangeRootPasswordTest() {
        ...
        // when
        api.getVpsChangeRootPassword(id).block();

        // then
        // TODO implement the getVpsChangeRootPasswordTest()
    }
    ...
    public void getVpsInsertCdTest() {
        ...
        // when
        api.getVpsInsertCd(id).block();

        // then
        // TODO implement the getVpsInsertCdTest()
    }
    ...
    public void getVpsResetPasswordTest() {
        ...
        // when
        api.getVpsResetPassword(id).block();

        // then
        // TODO implement the getVpsResetPasswordTest()
    }
    ...
    public void postVpsTrafficUsageTest() {
        ...
        // when
        api.postVpsTrafficUsage(id).block();

        // then
        // TODO implement the postVpsTrafficUsageTest()
    }
    ...
    public void putVpsBuyHdSpaceTest() {
        ...
        // when
        api.putVpsBuyHdSpace(id).block();

        // then
        // TODO implement the putVpsBuyHdSpaceTest()
    }
