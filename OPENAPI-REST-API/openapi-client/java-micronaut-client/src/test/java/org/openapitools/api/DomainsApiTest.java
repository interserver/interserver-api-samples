...
public class DomainsApiTest {
    ...
    public void addDomainTest() {
        // given
        DomainOrderRequest domainOrderRequest = new DomainOrderRequest("example");

        // when
        ServiceOrderPostResponse body = api.addDomain(domainOrderRequest).block();
    ...
    public void deleteDomainDnssecTest() {
        ...
        // when
        SuccessTextResponse body = api.deleteDomainDnssec(id).block();
    ...
    public void patchDomainsTest() {
        ...
        // when
        api.patchDomains(domainOrderRequest).block();
    ...
    public void postDomainSearchTest() {
        ...
        // when
        api.postDomainSearch(name).block();

        // then
        // TODO implement the postDomainSearchTest()
    }
    ...
    public void putDomainsTest() {
        ...
        // when
        api.putDomains(domainOrderRequest).block();
