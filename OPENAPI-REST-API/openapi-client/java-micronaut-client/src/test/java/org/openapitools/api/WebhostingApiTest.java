...
public class WebhostingApiTest {
    ...
    public void addWebsiteTest() {
        // given
        WebsiteOrderPostRequest websiteOrderPostRequest = new WebsiteOrderPostRequest("example", 56);

        // when
        ServiceOrderPostResponse body = api.addWebsite(websiteOrderPostRequest).block();
    ...
    public void putWebsitesTest() {
        // given
        WebsiteOrderPutRequest websiteOrderPutRequest = new WebsiteOrderPutRequest("example", 56);

        // when
        api.putWebsites(websiteOrderPutRequest).block();
