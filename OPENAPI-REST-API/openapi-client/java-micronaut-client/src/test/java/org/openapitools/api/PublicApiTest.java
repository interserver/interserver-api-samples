...
public class PublicApiTest {
    ...
    public void getAccountCurrenciesTest() {
        ...
        // when
        List<String> body = api.getAccountCurrencies().block();

        // then
        // TODO implement the getAccountCurrenciesTest()
    }
    ...
    public void getAccountLocalesTest() {
        ...
        // when
        Map<String, GetAccountLocales200ResponseValue> body = api.getAccountLocales().block();

        // then
        // TODO implement the getAccountLocalesTest()
    }
