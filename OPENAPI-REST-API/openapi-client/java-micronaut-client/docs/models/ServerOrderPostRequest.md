...
The class is defined in **[ServerOrderPostRequest.java](../../src/main/java/org/openapitools/model/ServerOrderPostRequest.java)**
...
**comment** | `String` | Optional free-form order comment. |  [optional property]
