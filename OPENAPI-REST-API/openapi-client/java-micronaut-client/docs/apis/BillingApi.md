...
```java
Mono<Void> BillingApi.getAffiliateDownload(stexyear)
```
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **st** | `String`| Filter by status. | [optional parameter] |
| **ex** | `String`| Export format: csv, xls, xlsx, or pdf. Defaults to csv. | [optional parameter] [enum: `csv`, `xls`, `xlsx`, `pdf`] |
| **year** | `Integer`| Year to filter the report. Defaults to the current year. | [optional parameter] |
...
# **getAffiliateSignups**
```java
Mono<GetAffiliateSignups200Response> BillingApi.getAffiliateSignups(st)
```
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **st** | `String`| Filter signups by status. Use &#x60;default&#x60; to show all or pass a specific status value to narrow results. | [optional parameter] |
...
```java
Mono<SuccessTextResponse> BillingApi.patchBillingCreditCardVerify(idpatchBillingCreditCardVerifyRequest)
```
