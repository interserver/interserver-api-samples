...
# **addMail**
```java
Mono<ServiceOrderPostResponse> MailApi.addMail(mailOrderRequest)
```
...
# **deleteMailAlert**
```java
Mono<SuccessTextResponse> MailApi.deleteMailAlert(iddeleteMailAlertRequest)
```
...
# **putMail**
```java
Mono<Void> MailApi.putMail(mailOrderRequest)
```
...
# **updateRule**
```java
Mono<GenericResponse> MailApi.updateRule(idruledenyRuleNew)
```
