...
# **addDomain**
```java
Mono<ServiceOrderPostResponse> DomainsApi.addDomain(domainOrderRequest)
```
...
# **deleteDomainDnssec**
```java
Mono<SuccessTextResponse> DomainsApi.deleteDomainDnssec(id)
```
...
# **patchDomains**
```java
Mono<Void> DomainsApi.patchDomains(domainOrderRequest)
```
...
# **postDomainSearch**
```java
Mono<Void> DomainsApi.postDomainSearch(name)
```
...
# **putDomains**
```java
Mono<Void> DomainsApi.putDomains(domainOrderRequest)
```
