...
# **getVpsBackup**
```java
Mono<QueueResponse> VpsApi.getVpsBackup(id)
```
...
```java
Mono<Void> VpsApi.getVpsChangeHostname(id)
```
...
```java
Mono<Void> VpsApi.getVpsChangeRootPassword(id)
```
...
# **getVpsInsertCd**
```java
Mono<Void> VpsApi.getVpsInsertCd(id)
```
...
# **getVpsResetPassword**
```java
Mono<Void> VpsApi.getVpsResetPassword(id)
```
...
# **postVpsTrafficUsage**
```java
Mono<Void> VpsApi.postVpsTrafficUsage(id)
```
...
# **putVpsBuyHdSpace**
```java
Mono<Void> VpsApi.putVpsBuyHdSpace(id)
```
