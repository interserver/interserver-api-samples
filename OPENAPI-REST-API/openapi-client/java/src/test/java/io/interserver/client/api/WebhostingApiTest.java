...
public class WebhostingApiTest {
    ...
    public void addWebsiteTest() throws ApiException {
        WebsiteOrderPostRequest websiteOrderPostRequest = null;
        ServiceOrderPostResponse response = api.addWebsite(websiteOrderPostRequest);
    ...
    public void putWebsitesTest() throws ApiException {
        WebsiteOrderPutRequest websiteOrderPutRequest = null;
