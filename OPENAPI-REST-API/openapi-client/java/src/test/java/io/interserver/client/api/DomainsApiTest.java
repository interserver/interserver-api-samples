...
public class DomainsApiTest {
    ...
    public void addDomainTest() throws ApiException {
        DomainOrderRequest domainOrderRequest = null;
        ServiceOrderPostResponse response = api.addDomain(domainOrderRequest);
    ...
    public void deleteDomainDnssecTest() throws ApiException {
        Integer id = null;
        SuccessTextResponse response = api.deleteDomainDnssec(id);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void postDomainSearchTest() throws ApiException {
        String name = null;
