...
import io.interserver.client.model.EmailAddressName;
import io.interserver.client.model.MailAttachment;
...
public class SendMailAdv implements Serializable {
   ...
   * @return the SendMailAdv instance itself
   */
  public SendMailAdv putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.subject, sendMailAdv.subject) &&
        ...
        Objects.equals(this.additionalProperties, sendMailAdv.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subject, body, from, to, replyto, cc, bcc, attachments, id, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SendMailAdv>() {
           ...
           public SendMailAdv read(JsonReader in) throws IOException {
             ...
             SendMailAdv instance = thisAdapter.fromJsonTree(jsonObj);
