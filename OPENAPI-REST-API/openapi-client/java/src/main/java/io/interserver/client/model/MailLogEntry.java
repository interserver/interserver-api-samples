...
public class MailLogEntry implements Serializable {
   ...
   * @return the MailLogEntry instance itself
   */
  public MailLogEntry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, mailLogEntry.id) &&
        ...
        Objects.equals(this.additionalProperties, mailLogEntry.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, id, from, to, created, time, user, transtype, origin, _interface, subject, messageId, sendingZone, bodySize, seq, delivered, code, recipient, response, domain, locked, lockTime, assigned, queued, mxHostname, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MailLogEntry>() {
           ...
           public MailLogEntry read(JsonReader in) throws IOException {
             ...
             MailLogEntry instance = thisAdapter.fromJsonTree(jsonObj);
