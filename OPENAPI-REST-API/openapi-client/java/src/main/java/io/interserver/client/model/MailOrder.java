...
public class MailOrder implements Serializable {
   ...
   * @return the MailOrder instance itself
   */
  public MailOrder putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, mailOrder.id) &&
        ...
        Objects.equals(this.additionalProperties, mailOrder.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, status, username, comment, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MailOrder>() {
           ...
           public MailOrder read(JsonReader in) throws IOException {
             ...
             MailOrder instance = thisAdapter.fromJsonTree(jsonObj);
