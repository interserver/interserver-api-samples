...
public class SendMail implements Serializable {
   ...
   * @return the SendMail instance itself
   */
  public SendMail putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.to, sendMail.to) &&
        ...
        Objects.equals(this.additionalProperties, sendMail.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(to, from, subject, body, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SendMail>() {
           ...
           public SendMail read(JsonReader in) throws IOException {
             ...
             SendMail instance = thisAdapter.fromJsonTree(jsonObj);
