...
import io.interserver.client.model.ServerLease;
...
public class ServerAsset implements Serializable {
   ...
   * @return the ServerAsset instance itself
   */
  public ServerAsset putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, serverAsset.id) &&
        ...
        Objects.equals(this.additionalProperties, serverAsset.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, orderId, hostname, status, primaryIpv4, primaryIpv6, datacenter, typeId, assetTag, rack, row, col, unitStart, unitEnd, unitSub, ipmiMac, ipmiIp, ipmiWorking, company, comments, make, model, description, customerId, externalId, billingStatus, overdue, assetId, assetName, rackId, rackName, rackLocation, rackSize, rackX, rackY, switchports, vlans, vlans6, lease, mac, ipmiAdminUsername, ipmiAdminPassword, ipmiClientUsername, ipmiClientPassword, ipmiUpdated, createTimestamp, updateTimestamp, comment, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ServerAsset>() {
           ...
           public ServerAsset read(JsonReader in) throws IOException {
             ...
             ServerAsset instance = thisAdapter.fromJsonTree(jsonObj);
