...
public class DenyRuleNew implements Serializable {
   ...
   * @return the DenyRuleNew instance itself
   */
  public DenyRuleNew putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, denyRuleNew.type) &&
        ...
        Objects.equals(this.additionalProperties, denyRuleNew.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, data, user, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DenyRuleNew>() {
           ...
           public DenyRuleNew read(JsonReader in) throws IOException {
             ...
             DenyRuleNew instance = thisAdapter.fromJsonTree(jsonObj);
