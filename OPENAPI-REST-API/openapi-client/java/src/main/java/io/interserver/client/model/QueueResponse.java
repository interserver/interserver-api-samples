...
public class QueueResponse implements Serializable {
   ...
   * @return the QueueResponse instance itself
   */
  public QueueResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.text, queueResponse.text) &&
        ...
        Objects.equals(this.additionalProperties, queueResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(text, queueId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<QueueResponse>() {
           ...
           public QueueResponse read(JsonReader in) throws IOException {
             ...
             QueueResponse instance = thisAdapter.fromJsonTree(jsonObj);
