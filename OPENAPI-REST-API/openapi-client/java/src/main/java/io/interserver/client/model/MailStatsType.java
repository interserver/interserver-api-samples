...
import io.interserver.client.model.MailStatsTypeVolume;
...
public class MailStatsType implements Serializable {
   ...
   * @return the MailStatsType instance itself
   */
  public MailStatsType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.time, mailStatsType.time) &&
        ...
        Objects.equals(this.additionalProperties, mailStatsType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(time, usage, currency, currencySymbol, cost, received, sent, volume, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MailStatsType>() {
           ...
           public MailStatsType read(JsonReader in) throws IOException {
             ...
             MailStatsType instance = thisAdapter.fromJsonTree(jsonObj);
