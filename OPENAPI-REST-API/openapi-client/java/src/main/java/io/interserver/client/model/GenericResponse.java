...
public class GenericResponse implements Serializable {
   ...
   * @return the GenericResponse instance itself
   */
  public GenericResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, genericResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, genericResponse.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GenericResponse>() {
           ...
           public GenericResponse read(JsonReader in) throws IOException {
             ...
             GenericResponse instance = thisAdapter.fromJsonTree(jsonObj);
