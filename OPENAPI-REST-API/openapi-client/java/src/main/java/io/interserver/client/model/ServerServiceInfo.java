...
public class ServerServiceInfo implements Serializable {
   ...
   * @return the ServerServiceInfo instance itself
   */
  public ServerServiceInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.serverId, serverServiceInfo.serverId) &&
        ...
        Objects.equals(this.additionalProperties, serverServiceInfo.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ServerServiceInfo>() {
           ...
           public ServerServiceInfo read(JsonReader in) throws IOException {
             ...
             ServerServiceInfo instance = thisAdapter.fromJsonTree(jsonObj);
