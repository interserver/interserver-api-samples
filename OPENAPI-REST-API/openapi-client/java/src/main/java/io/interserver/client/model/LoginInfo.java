...
import io.interserver.client.model.LoginServiceCounts;
...
public class LoginInfo implements Serializable {
   ...
   * @return the LoginInfo instance itself
   */
  public LoginInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.captcha, loginInfo.captcha) &&
        ...
        Objects.equals(this.additionalProperties, loginInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(captcha, counts, logo, language, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoginInfo>() {
           ...
           public LoginInfo read(JsonReader in) throws IOException {
             ...
             LoginInfo instance = thisAdapter.fromJsonTree(jsonObj);
