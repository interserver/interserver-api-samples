...
|------------ | ------------- | ------------- | -------------|
|**serverId** | **BigDecimal** | The ID of the buy-it-now server configuration to order. Use the server listing from &#x60;GET /servers/order/buy_now_server&#x60; to find valid IDs. |  [optional] |
