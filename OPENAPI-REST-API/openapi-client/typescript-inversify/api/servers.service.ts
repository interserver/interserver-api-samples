...
export class ServersService {
     ...
     */
    public addServer(serverOrderPostRequest: ServerOrderPostRequest, observe?: 'body', headers?: Headers): Observable<AddServer200Response>;
    public addServer(serverOrderPostRequest: ServerOrderPostRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<AddServer200Response>>;
    public addServer(serverOrderPostRequest: ServerOrderPostRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<AddServer200Response>> = this.httpClient.post(`${this.basePath}/servers/order`, serverOrderPostRequest , headers);
        if (observe === 'body') {
     ...
     */
    public serverBulkIpmiPowerGet(ids: string, observe?: 'body', headers?: Headers): Observable<ServerBulkIpmiPowerResponse>;
    public serverBulkIpmiPowerGet(ids: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<ServerBulkIpmiPowerResponse>>;
    public serverBulkIpmiPowerGet(ids: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<ServerBulkIpmiPowerResponse>> = this.httpClient.get(`${this.basePath}/servers/bulk/ipmi_power?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <ServerBulkIpmiPowerResponse>(httpResponse.response))
               );
        }
        return response;
    }
