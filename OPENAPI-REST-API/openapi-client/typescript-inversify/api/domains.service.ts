...
export class DomainsService {
     ...
     */
    public addDomain(domainOrderRequest: DomainOrderRequest, observe?: 'body', headers?: Headers): Observable<ServiceOrderPostResponse>;
    public addDomain(domainOrderRequest: DomainOrderRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<ServiceOrderPostResponse>>;
    public addDomain(domainOrderRequest: DomainOrderRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<ServiceOrderPostResponse>> = this.httpClient.post(`${this.basePath}/domains/order`, domainOrderRequest , headers);
        if (observe === 'body') {
     ...
     */
    public deleteDomainDnssec(id: number, observe?: 'body', headers?: Headers): Observable<SuccessTextResponse>;
    public deleteDomainDnssec(id: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<SuccessTextResponse>>;
    public deleteDomainDnssec(id: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (id === null || id === undefined){
        ...
        const response: Observable<HttpResponse<SuccessTextResponse>> = this.httpClient.delete(`${this.basePath}/domains/${encodeURIComponent(String(id))}/dnssec`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <SuccessTextResponse>(httpResponse.response))
               );
     ...
     */
    public patchDomains(domainOrderRequest: DomainOrderRequest, observe?: 'body', headers?: Headers): Observable<any>;
    public patchDomains(domainOrderRequest: DomainOrderRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public patchDomains(domainOrderRequest: DomainOrderRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (domainOrderRequest === null || domainOrderRequest === undefined){
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.patch(`${this.basePath}/domains/order`, domainOrderRequest , headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public postDomainSearch(name: string, observe?: 'body', headers?: Headers): Observable<any>;
    public postDomainSearch(name: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public postDomainSearch(name: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (name === null || name === undefined){
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.post(`${this.basePath}/domains/search/${encodeURIComponent(String(name))}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <any>(httpResponse.response))
               );
     ...
     */
    public putDomains(domainOrderRequest: DomainOrderRequest, observe?: 'body', headers?: Headers): Observable<any>;
    public putDomains(domainOrderRequest: DomainOrderRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public putDomains(domainOrderRequest: DomainOrderRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (domainOrderRequest === null || domainOrderRequest === undefined){
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.put(`${this.basePath}/domains/order`, domainOrderRequest , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <any>(httpResponse.response))
               );
     ...
     */
    public updateDomainInfo(id: number, observe?: 'body', headers?: Headers): Observable<SuccessTextResponse>;
    public updateDomainInfo(id: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<SuccessTextResponse>>;
    public updateDomainInfo(id: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (id === null || id === undefined){
