...
export class QuickServersService {
     ...
     */
    public addQs(qsOrderRequest: QsOrderRequest, observe?: 'body', headers?: Headers): Observable<ServiceOrderPostResponse>;
    public addQs(qsOrderRequest: QsOrderRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<ServiceOrderPostResponse>>;
    public addQs(qsOrderRequest: QsOrderRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<ServiceOrderPostResponse>> = this.httpClient.post(`${this.basePath}/qs/order`, qsOrderRequest , headers);
        if (observe === 'body') {
     ...
     */
    public getQsBackup(id: number, observe?: 'body', headers?: Headers): Observable<QueueResponse>;
    public getQsBackup(id: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<QueueResponse>>;
    public getQsBackup(id: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (id === null || id === undefined){
        ...
        const response: Observable<HttpResponse<QueueResponse>> = this.httpClient.get(`${this.basePath}/qs/${encodeURIComponent(String(id))}/backup`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <QueueResponse>(httpResponse.response))
               );
     ...
     */
    public putQs(qsOrderRequest: QsOrderRequest, observe?: 'body', headers?: Headers): Observable<any>;
    public putQs(qsOrderRequest: QsOrderRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public putQs(qsOrderRequest: QsOrderRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (qsOrderRequest === null || qsOrderRequest === undefined){
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.put(`${this.basePath}/qs/order`, qsOrderRequest , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <any>(httpResponse.response))
               );
