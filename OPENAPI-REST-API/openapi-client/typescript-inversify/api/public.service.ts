...
export class PublicService {
     ...
     */
    public getAccountCurrencies(observe?: 'body', headers?: Headers): Observable<Array<string>>;
    public getAccountCurrencies(observe?: 'response', headers?: Headers): Observable<HttpResponse<Array<string>>>;
    public getAccountCurrencies(observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<Array<string>>> = this.httpClient.get(`${this.basePath}/account/currencies`, headers);
        if (observe === 'body') {
     ...
     */
    public getAccountLocales(observe?: 'body', headers?: Headers): Observable<{ [key: string]: GetAccountLocales200ResponseValue; }>;
    public getAccountLocales(observe?: 'response', headers?: Headers): Observable<HttpResponse<{ [key: string]: GetAccountLocales200ResponseValue; }>>;
    public getAccountLocales(observe: any = 'body', headers: Headers = {}): Observable<any> {
        // authentication (sessionIdCookieAuth) required
        // authentication (apiKeyAuth) required
        if (this.APIConfiguration.apiKeys && this.APIConfiguration.apiKeys['X-API-KEY']) {
            headers['X-API-KEY'] = this.APIConfiguration.apiKeys['X-API-KEY'];
        ...
        const response: Observable<HttpResponse<{ [key: string]: GetAccountLocales200ResponseValue; }>> = this.httpClient.get(`${this.basePath}/account/locales`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <{ [key: string]: GetAccountLocales200ResponseValue; }>(httpResponse.response))
               );
        }
        return response;
    }
