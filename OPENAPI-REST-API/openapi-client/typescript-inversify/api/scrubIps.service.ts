...
export class ScrubIpsService {
     ...
     */
    public putScrubIps(scrubIpPlaceOrder: ScrubIpPlaceOrder, observe?: 'body', headers?: Headers): Observable<PutScrubIps200Response>;
    public putScrubIps(scrubIpPlaceOrder: ScrubIpPlaceOrder, observe?: 'response', headers?: Headers): Observable<HttpResponse<PutScrubIps200Response>>;
    public putScrubIps(scrubIpPlaceOrder: ScrubIpPlaceOrder, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (scrubIpPlaceOrder === null || scrubIpPlaceOrder === undefined){
        ...
        const response: Observable<HttpResponse<PutScrubIps200Response>> = this.httpClient.put(`${this.basePath}/scrub_ips/order`, scrubIpPlaceOrder , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <PutScrubIps200Response>(httpResponse.response))
               );
        }
        return response;
    }
