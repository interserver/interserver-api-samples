...
export class MailService {
     ...
     */
    public addMail(mailOrderRequest: MailOrderRequest, observe?: 'body', headers?: Headers): Observable<ServiceOrderPostResponse>;
    public addMail(mailOrderRequest: MailOrderRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<ServiceOrderPostResponse>>;
    public addMail(mailOrderRequest: MailOrderRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<ServiceOrderPostResponse>> = this.httpClient.post(`${this.basePath}/mail/order`, mailOrderRequest , headers);
        if (observe === 'body') {
     ...
     */
    public deleteMailAlert(id: number, deleteMailAlertRequest: DeleteMailAlertRequest, observe?: 'body', headers?: Headers): Observable<SuccessTextResponse>;
    public deleteMailAlert(id: number, deleteMailAlertRequest: DeleteMailAlertRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<SuccessTextResponse>>;
    public deleteMailAlert(id: number, deleteMailAlertRequest: DeleteMailAlertRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (id === null || id === undefined){
        ...
        const response: Observable<HttpResponse<SuccessTextResponse>> = this.httpClient.delete(`${this.basePath}/mail/${encodeURIComponent(String(id))}/alerts`, deleteMailAlertRequest , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <SuccessTextResponse>(httpResponse.response))
               );
     ...
     */
    public putMail(mailOrderRequest: MailOrderRequest, observe?: 'body', headers?: Headers): Observable<any>;
    public putMail(mailOrderRequest: MailOrderRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public putMail(mailOrderRequest: MailOrderRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (mailOrderRequest === null || mailOrderRequest === undefined){
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.put(`${this.basePath}/mail/order`, mailOrderRequest , headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public updateRule(id: number, rule: string, denyRuleNew: DenyRuleNew, observe?: 'body', headers?: Headers): Observable<GenericResponse>;
    public updateRule(id: number, rule: string, denyRuleNew: DenyRuleNew, observe?: 'response', headers?: Headers): Observable<HttpResponse<GenericResponse>>;
    public updateRule(id: number, rule: string, denyRuleNew: DenyRuleNew, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (id === null || id === undefined){
        ...
        const response: Observable<HttpResponse<GenericResponse>> = this.httpClient.put(`${this.basePath}/mail/${encodeURIComponent(String(id))}/rules/${encodeURIComponent(String(rule))}`, denyRuleNew , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <GenericResponse>(httpResponse.response))
               );
