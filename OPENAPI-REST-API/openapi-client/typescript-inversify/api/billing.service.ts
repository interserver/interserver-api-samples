...
export class BillingService {
     ...
     */
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, observe?: 'body', headers?: Headers): Observable<any>;
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<any>>;
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        let queryParameters: string[] = [];
        if (st !== undefined) {
            queryParameters.push('st='+encodeURIComponent(String(st)));
        }
        if (ex !== undefined) {
            queryParameters.push('ex='+encodeURIComponent(String(ex)));
        }
        if (year !== undefined) {
        ...
        const response: Observable<HttpResponse<any>> = this.httpClient.get(`${this.basePath}/affiliate/download?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public getAffiliateSignups(st?: string, observe?: 'body', headers?: Headers): Observable<GetAffiliateSignups200Response>;
    public getAffiliateSignups(st?: string, observe?: 'response', headers?: Headers): Observable<HttpResponse<GetAffiliateSignups200Response>>;
    public getAffiliateSignups(st?: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        let queryParameters: string[] = [];
        if (st !== undefined) {
            queryParameters.push('st='+encodeURIComponent(String(st)));
        }
        ...
        const response: Observable<HttpResponse<GetAffiliateSignups200Response>> = this.httpClient.get(`${this.basePath}/affiliate/signups?${queryParameters.join('&')}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <GetAffiliateSignups200Response>(httpResponse.response))
               );
        }
        return response;
    }
    ...
    public initiatePayment(method: 'cc' | 'paypal' | 'prepay' | 'payssion' | 'payu' | 'ccavenue' | 'cashfree' | 'coinbase' | 'btcpay', invoices: string, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<InitiatePayment200Response>> = this.httpClient.get(`${this.basePath}/billing/pay/${encodeURIComponent(String(method))}/${encodeURIComponent(String(invoices))}`, headers);
        if (observe === 'body') {
               return response.pipe(
     ...
     */
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, observe?: 'body', headers?: Headers): Observable<SuccessTextResponse>;
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, observe?: 'response', headers?: Headers): Observable<HttpResponse<SuccessTextResponse>>;
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: PatchBillingCreditCardVerifyRequest, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (id === null || id === undefined){
        ...
        const response: Observable<HttpResponse<SuccessTextResponse>> = this.httpClient.patch(`${this.basePath}/billing/creditcards/${encodeURIComponent(String(id))}/verify`, patchBillingCreditCardVerifyRequest , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <SuccessTextResponse>(httpResponse.response))
               );
