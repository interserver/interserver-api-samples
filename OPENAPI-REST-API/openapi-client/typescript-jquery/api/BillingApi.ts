...
export class BillingApi {
     ...
     */
    public getAffiliateDownload(st?: string, ex?: 'csv' | 'xls' | 'xlsx' | 'pdf', year?: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/affiliate/download';

        let queryParameters: any = {};
        let headerParams: any = {};
        if (st !== null && st !== undefined) {
            queryParameters['st'] = <string><any>st;
        }
        if (ex !== null && ex !== undefined) {
            queryParameters['ex'] = <string><any>ex;
        }
        if (year !== null && year !== undefined) {
            queryParameters['year'] = <string><any>year;
        }
     ...
     */
    public getAffiliateSignups(st?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.GetAffiliateSignups200Response;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/affiliate/signups';
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.GetAffiliateSignups200Response, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
    ...
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/billing/pay/{method}/{invoices}'.replace('{method}', encodeURIComponent(String(method))).replace('{invoices}', encodeURIComponent(String(invoices)));
     ...
     */
    public patchBillingCreditCardVerify(id: number, patchBillingCreditCardVerifyRequest: models.PatchBillingCreditCardVerifyRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.SuccessTextResponse;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/billing/creditcards/{id}/verify'.replace('{id}', encodeURIComponent(String(id)));
        ...
        requestOptions.data = JSON.stringify(patchBillingCreditCardVerifyRequest);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
