...
export class ScrubIpsApi {
     ...
     * @param scrubIpPlaceOrder 
     */
    public putScrubIps(scrubIpPlaceOrder: models.ScrubIpPlaceOrder, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.PutScrubIps200Response;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/scrub_ips/order';
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.PutScrubIps200Response, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
