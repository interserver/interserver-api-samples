...
export class DomainsApi {
     ...
     */
    public addDomain(domainOrderRequest: models.DomainOrderRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(domainOrderRequest);
     ...
     * @param id The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.
     */
    public deleteDomainDnssec(id: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.SuccessTextResponse;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/domains/{id}/dnssec'.replace('{id}', encodeURIComponent(String(id)));
     ...
     * @param domainOrderRequest 
     */
    public patchDomains(domainOrderRequest: models.DomainOrderRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     * @param name The base domain name to search (for example &#x60;example&#x60; or &#x60;example.com&#x60;).
     */
    public postDomainSearch(name: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/domains/search/{name}'.replace('{name}', encodeURIComponent(String(name)));
     ...
     * @param domainOrderRequest 
     */
    public putDomains(domainOrderRequest: models.DomainOrderRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/domains/order';
     ...
     * @param id The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;.
     */
    public updateDomainInfo(id: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.SuccessTextResponse;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/domains/{id}'.replace('{id}', encodeURIComponent(String(id)));
