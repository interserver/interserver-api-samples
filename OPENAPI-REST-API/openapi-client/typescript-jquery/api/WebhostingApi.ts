...
export class WebhostingApi {
     ...
     */
    public addWebsite(websiteOrderPostRequest: models.WebsiteOrderPostRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(websiteOrderPostRequest);
     ...
     */
    public putWebsites(websiteOrderPutRequest: models.WebsiteOrderPutRequest, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(websiteOrderPutRequest);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
